 ...
 * @internal
 *
 * In monocore implementation tpl_ready_list is an array of FIFO's 
 * indexed by priorities. Each FIFO contains the id of ready jobs of a given priority.
 * 
 * In multicore implementation, tpl_ready_list is an array of pointers to
 * a ready list per core. It is indexed by the core identifier.
 */
