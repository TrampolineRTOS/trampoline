...
FUNC(void, OS_CODE) tpl_schedule_from_running(CORE_ID_OR_VOID(core_id))
{
  ...
  {
    /* Preempts the PROC_RUNNING task */
...
FUNC(void, OS_CODE) tpl_terminate(void)
{
   ...
   * PostTaskHook while the soon descheduled task is PROC_RUNNING
   */
  CALL_POST_TASK_HOOK()
