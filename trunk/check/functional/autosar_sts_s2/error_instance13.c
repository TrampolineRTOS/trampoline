...
static void test_error_instance13(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(28,sched_implicit, OSServiceId_StartScheduleTableRel_ScheduleTableID());
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(28,1 , OSServiceId_StartScheduleTableRel_offset());
