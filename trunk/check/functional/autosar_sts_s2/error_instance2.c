/**
 * @file autosar_sts_s2/error_instance2.c
 *
...
static void test_error_instance2(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(4,sched_implicit , OSServiceId_StartScheduleTableSynchron_ScheduleTableID());
	SCHEDULING_CHECK_AND_EQUAL_INT(4,OSServiceId_StartScheduleTableSynchron, result_inst_1);
...
/* End of file autosar_sts_s2/error_instance2.c */
