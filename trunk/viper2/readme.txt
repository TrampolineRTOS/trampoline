...
* Viper2 can work with pygame or only with the consol. You don't have to install pygame if you don't need it, but some examples need it because of the user interaction (App-GBF, App-Robot*). Pygame versions (http://www.pygame.org/) are according to a proper python version (http://www.python.org/)
