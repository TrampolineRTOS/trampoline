...
arm7_context task_$1_context;')

define(`isr_context',`dnl
arm7_context isr2_$1_context;')
...
ifdef(`header',`dnl
extern unsigned int arm7_registers[TASK_COUNT+ISR_COUNT+1][16];
extern unsigned int registers_it[16];',`dnl
unsigned int idata arm7_registers[TASK_COUNT+ISR_COUNT+1][16];')')
 ...
 */
asm("NOFRAME");
asm("warning disable = 138"); /* disables the "expression with possibly no
									effect" warning */
