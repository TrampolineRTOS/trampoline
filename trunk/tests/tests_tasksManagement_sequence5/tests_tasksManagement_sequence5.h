 /* 
  * @file tests_tasksManagement_sequence5.h
  * 
...
#ifndef TESTS_TASKSMANAGEMENT_SEQUENCE5_H_
#define TESTS_TASKSMANAGEMENT_SEQUENCE5_H_
...
#endif /*TESTS_TASKSMANAGEMENT_SEQUENCE5_H_*/
