 ...
 * isr3 stack
 */
tpl_stack_word stack_zone_of_isr3[32768/sizeof(tpl_stack_word)];

#define STACK_OF_ISR_isr3 { stack_zone_of_isr3, 32768 }

/*
 * isr3 context
 */
tpl_context integer_context_of_isr3;

#define CONTEXT_OF_ISR_isr3 &integer_context_of_isr3
/*
 * ISR isr3 function prototype
 */
void function_of_isr_isr3(void);
...
/*
 * Static descriptor of ISR isr3
 */
tpl_exec_static static_descriptor_of_isr_isr3 = {
    /* context                  */ CONTEXT_OF_ISR_isr3,
    /* stack                    */ STACK_OF_ISR_isr3,
    /* entry point (function)   */ function_of_isr_isr3,
    /* internal ressource       */ NULL,
    /* isr id                   */ 0,
...
tpl_isr_static static_helper_of_isr_isr3 = {
	/* helper */ NULL,
	/* next */   NULL
};

/*
 * Dynamic descriptor of ISR isr3
 */
tpl_isr descriptor_of_isr_isr3 = {
    {       /* beginning of exec_desc part */
    /* static descriptor    */  &static_descriptor_of_isr_isr3,
    /* resources            */  NULL,
    /* activate count       */  0,
    ...
    /* more static desc     */  &static_helper_of_isr_isr3
#ifdef WITH_AUTOSAR
    ,
    /* enabled field        */  TRUE
#endif
