 /* 
  * @file tests_tasksManagement_sequence7.h
  * 
...
#ifndef TESTS_TASKSMANAGEMENT_SEQUENCE7_H_
#define TESTS_TASKSMANAGEMENT_SEQUENCE7_H_
...
#endif /*TESTS_TASKSMANAGEMENT_SEQUENCE7_*/
