 /* 
  * @file tests_InterruptProcessing_sequence2.h
  * 
 * $Date: 2008/06/12 13:51:19 $
 * $Rev$
 * $Author: GuillaumeNuth $
 * $URL$
 */

#ifndef TESTS_INTERRUPTPROCESSING_SEQUENCE2_H_
#define TESTS_INTERRUPTPROCESSING_SEQUENCE2_H_
...
#endif /*TESTS_INTERRUPTPROCESSING_SEQUENCE2_H_*/
