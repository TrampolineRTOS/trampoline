 /* 
  * @file tests_tasksManagement_sequence1.h
  * 
...
#ifndef TESTS_TASKSMANAGEMENT_SEQUENCE1_H_
#define TESTS_TASKSMANAGEMENT_SEQUENCE1_H_
...
#endif /*TESTS_TASKSMANAGEMENT_SEQUENCE1_H_*/
