 /* 
  * @file tests_InterruptProcessing_sequence3.h
  * 
 * $Date: 2008/06/12 13:52:37 $
 * $Rev$
 * $Author: GuillaumeNuth $
 * $URL$
 */

#ifndef TESTS_INTERRUPTPROCESSING_SEQUENCE3_H_
#define TESTS_INTERRUPTPROCESSING_SEQUENCE3_H_
...
#endif /*TESTS_INTERRUPTPROCESSING_SEQUENCE3_H_*/
