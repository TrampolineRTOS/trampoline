...
class GALGAS_sortingKeyList_2E_element ;
class GALGAS_string ;
...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG GALGAS_sortingKeyList reader_subListWithRange (const GALGAS_range & constinOperand0,
                                                                           C_Compiler * inCompiler
                                                                           COMMA_LOCATION_ARGS) const ;
...
//--- Current element access
  public : GALGAS_sortingKeyList_2E_element current (LOCATION_ARGS) const ;
} ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                     @sortingKeyList_2E_element struct                     *
//                                                                           *
//---------------------------------------------------------------------------*

class GALGAS_sortingKeyList_2E_element : public AC_GALGAS_root {
//--------------------------------- Public data members
...
//--------------------------------- Default constructor
  public : GALGAS_sortingKeyList_2E_element (void) ;

//--------------------------------- Virtual destructor (in debug mode)
  public : VIRTUAL_IN_DEBUG ~ GALGAS_sortingKeyList_2E_element (void) ;

//--------------------------------- Native constructor
  public : GALGAS_sortingKeyList_2E_element (const GALGAS_lstring & in_key,
                                             const GALGAS_lsint & in_order) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_sortingKeyList_2E_element extractObject (const GALGAS_object & inObject,
                                                                  C_Compiler * inCompiler,
                                                                  const GALGAS_location & inErrorLocation
                                                                  COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_sortingKeyList_2E_element constructor_new (const GALGAS_lstring & inOperand0,
                                                                    const GALGAS_lsint & inOperand1
                                                                    COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_sortingKeyList_2E_element & inOperand) const ;
...
//--------------------------------- Readers
  ...
  public : VIRTUAL_IN_DEBUG GALGAS_lsint reader_order (LOCATION_ARGS) const ;


//--------------------------------- Introspection
  public : VIRTUAL_IN_DEBUG const C_galgas_type_descriptor * staticTypeDescriptor (void) const ;
 
} ; // End of GALGAS_sortingKeyList_2E_element class


//---------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_sortingKeyList_2E_element ;
