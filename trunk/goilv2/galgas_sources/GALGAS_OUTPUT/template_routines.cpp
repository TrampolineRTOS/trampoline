...
//                    november 13th, 2012, at 14h35'53"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
GALGAS_string function_goil_5F_template (const GALGAS_string & constinArgument_prefix,
  ...
  GALGAS_bool joker_336_0 ; // Joker input parameter
  routine_templateInvocation (GALGAS_lstring::constructor_new (constinArgument_name, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (12)), constinArgument_prefix, GALGAS_string ("templates"), function_rootTemplatesDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (15)), GALGAS_bool (true), constinArgument_cfg, result_result, joker_336_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (11)) ;
  } //-------- @routineCallInstructionForGeneration
//---
...
GALGAS_string function_computeTemplate (const GALGAS_string & constinArgument_prefix,
  ...
  result_result = GALGAS_string::makeEmptyString () ;
  { //-------- @routineCallInstructionForGeneration
  GALGAS_bool joker_620_0 ; // Joker input parameter
  routine_templateInvocation (GALGAS_lstring::constructor_new (constinArgument_name, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (30)), constinArgument_prefix, GALGAS_string ("templates"), function_rootTemplatesDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (33)), GALGAS_bool (true), constinArgument_cfg, result_result, joker_620_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (29)) ;
  } //-------- @routineCallInstructionForGeneration
//---
  return result_result ;
}
