...
static void categoryMethod_boolAttribute_set (const cPtr_object_5F_t * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_subAttrs.reader_count (SOURCE_FILE_AT_LINE (33)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
...
static void categoryMethod_enumAttribute_set (const cPtr_object_5F_t * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_subAttrs.reader_count (SOURCE_FILE_AT_LINE (46)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  while (enumerator_2233.hasCurrentObject ()) {
    ...
    if (enumerator_2233.current_item (HERE).isValid ()) {
      if (enumerator_2233.current_item (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_structAttribute) {
        ...
        const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_subAttrs.reader_count (SOURCE_FILE_AT_LINE (68)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_0) {
...
static GALGAS_TfieldMap categoryReader_applicationDefinition_templateData (const cPtr_applicationDefinition * inObject,
  ...
  while (enumerator_5520.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_5520.current_objectsOfKind (HERE).reader_objects (SOURCE_FILE_AT_LINE (154)).reader_count (SOURCE_FILE_AT_LINE (154)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
      if (kBoolTrue == test_1) {
