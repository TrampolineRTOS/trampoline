...
void routine_searchField (GALGAS_TvarPath inArgument_variable,
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_3) {
      ...
      //-------- @assignmentInstructionForGeneration
      outArgument_variableValue.mAttribute_mStructValue = var_mapList.reader_mMapAtIndex (var_idx.mAttribute_sint.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (472)), inCompiler COMMA_SOURCE_FILE_AT_LINE (472)) ;
      //-------- @assignmentInstructionForGeneration
      outArgument_variableType = GALGAS_Ttype::constructor_structType (SOURCE_FILE_AT_LINE (473)) ;
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, inArgument_variable.reader_length (SOURCE_FILE_AT_LINE (475)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_4) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_structType (SOURCE_FILE_AT_LINE (476)))).boolEnum () ;
    if (kBoolTrue == test_5) {
      { //-------- @routineCallInstructionForGeneration
      routine_searchField (inArgument_variable, outArgument_variableValue.reader_mStructValue (SOURCE_FILE_AT_LINE (477)), outArgument_variableType, outArgument_variableValue, outArgument_variableLocation, inCompiler COMMA_SOURCE_FILE_AT_LINE (477)) ;
      } //-------- @routineCallInstructionForGeneration
      ...
      inCompiler->emitSemanticError (location_6, GALGAS_string ("struct variable expected") COMMA_SOURCE_FILE_AT_LINE (480)) ;
...
void routine_searchFieldIfExists (GALGAS_TvarPath inArgument_variable,
  ...
  GALGAS_lsint var_idx ;
  { //-------- @modifierCallInstructionForGeneration
  inArgument_variable.modifier_popFirst (var_field, var_key, var_idx, inCompiler COMMA_SOURCE_FILE_AT_LINE (497)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inTemplateFieldMap.reader_hasKey (var_field.reader_string (SOURCE_FILE_AT_LINE (499)) COMMA_SOURCE_FILE_AT_LINE (499)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_inTemplateFieldMap.method_searchKey (var_field, outArgument_variableType, outArgument_variableValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (500)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_key.reader_string (SOURCE_FILE_AT_LINE (501)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_mapType (SOURCE_FILE_AT_LINE (502)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_3 = outArgument_variableValue.reader_mStructValue (SOURCE_FILE_AT_LINE (503)).reader_hasKey (var_key.reader_string (SOURCE_FILE_AT_LINE (503)) COMMA_SOURCE_FILE_AT_LINE (503)).boolEnum () ;
        if (kBoolTrue == test_3) {
          //-------- @methodCallInstructionForGeneration
          outArgument_variableValue.reader_mStructValue (SOURCE_FILE_AT_LINE (504)).method_searchKey (var_key, outArgument_variableType, outArgument_variableValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (504)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @assignmentInstructionForGeneration
        ...
        inCompiler->emitSemanticError (location_4, GALGAS_string ("a key is only used in a map") COMMA_SOURCE_FILE_AT_LINE (510)) ;
        outArgument_found.drop () ; // Release error dropped variable
      }
    }else if (kBoolFalse == test_1) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, var_idx.reader_sint (SOURCE_FILE_AT_LINE (512)).objectCompare (GALGAS_sint ((PMSInt32) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (512)))).boolEnum () ;
      if (kBoolTrue == test_5) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_listType (SOURCE_FILE_AT_LINE (513)))).boolEnum () ;
        if (kBoolTrue == test_6) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_7 = GALGAS_bool (kIsStrictInf, var_idx.mAttribute_sint.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (514)).objectCompare (outArgument_variableValue.reader_mMapListValue (SOURCE_FILE_AT_LINE (514)).reader_length (SOURCE_FILE_AT_LINE (514)))).boolEnum () ;
          if (kBoolTrue == test_7) {
            //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
            GALGAS_TfieldMapList var_mapList = outArgument_variableValue.reader_mMapListValue (SOURCE_FILE_AT_LINE (515)) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_variableValue.mAttribute_mStructValue = var_mapList.reader_mMapAtIndex (var_idx.mAttribute_sint.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (516)), inCompiler COMMA_SOURCE_FILE_AT_LINE (516)) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_variableType = GALGAS_Ttype::constructor_structType (SOURCE_FILE_AT_LINE (517)) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_found = GALGAS_bool (true) ;
          ...
          inCompiler->emitSemanticError (location_8, GALGAS_string ("an index is only used in a list") COMMA_SOURCE_FILE_AT_LINE (523)) ;
          outArgument_found.drop () ; // Release error dropped variable
        }
      }else if (kBoolFalse == test_5) {
        //-------- @assignmentInstructionForGeneration
    ...
    //-------- @assignmentInstructionForGeneration
    outArgument_variableType = GALGAS_Ttype::constructor_unconstructedType (SOURCE_FILE_AT_LINE (529)) ;
    //-------- @assignmentInstructionForGeneration
    outArgument_variableValue = function_valueWithVoid (inCompiler COMMA_SOURCE_FILE_AT_LINE (530)) ;
    //-------- @assignmentInstructionForGeneration
    outArgument_found = GALGAS_bool (false) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_9 = GALGAS_bool (kIsStrictSup, inArgument_variable.reader_length (SOURCE_FILE_AT_LINE (533)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (outArgument_found COMMA_SOURCE_FILE_AT_LINE (533)).boolEnum () ;
  if (kBoolTrue == test_9) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_structType (SOURCE_FILE_AT_LINE (534)))).boolEnum () ;
    if (kBoolTrue == test_10) {
      { //-------- @routineCallInstructionForGeneration
      routine_searchFieldIfExists (inArgument_variable, outArgument_variableValue.reader_mStructValue (SOURCE_FILE_AT_LINE (535)), outArgument_variableType, outArgument_variableValue, outArgument_found, inCompiler COMMA_SOURCE_FILE_AT_LINE (535)) ;
      } //-------- @routineCallInstructionForGeneration
