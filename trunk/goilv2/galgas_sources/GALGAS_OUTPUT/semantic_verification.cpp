...
//                    september 27th, 2012, at 20h23'40"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
GALGAS_bool function_attributeAllowsAuto (const GALGAS_impType & constinArgument_type,
  ...
  if (constinArgument_type.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_impAutoDefaultType *> (constinArgument_type.ptr ())) {
      GALGAS_impAutoDefaultType cast_6896_autoType ((cPtr_impAutoDefaultType *) constinArgument_type.ptr ()) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = cast_6896_autoType.reader_withAuto (SOURCE_FILE_AT_LINE (223)).operator_not (SOURCE_FILE_AT_LINE (223)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @assignmentInstructionForGeneration
...
void routine_verifyAllAttributes (const GALGAS_implementation constinArgument_imp,
  ...
  cEnumerator_objectsMap enumerator_7232 (constinArgument_objects, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_7232.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_implementationObject var_impObj = callCategoryReader_impObject ((const cPtr_implementation *) constinArgument_imp.ptr (), enumerator_7232.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (241)), inCompiler COMMA_SOURCE_FILE_AT_LINE (241)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_objectKindMap enumerator_7402 (enumerator_7232.current_objectsOfKind (HERE).reader_objects (SOURCE_FILE_AT_LINE (243)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_7402.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_implementationObjectMap enumerator_7455 (var_impObj.reader_attributes (SOURCE_FILE_AT_LINE (244)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_7455.hasCurrentObject ()) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_0 = enumerator_7402.current_attributes (HERE).reader_objectParams (SOURCE_FILE_AT_LINE (245)).reader_hasKey (enumerator_7455.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (245)) COMMA_SOURCE_FILE_AT_LINE (245)).boolEnum () ;
        if (kBoolTrue == test_0) {
          //-------- @localVariableDeclarationForGeneration
          GALGAS_object_5F_t var_value ;
          //-------- @methodCallInstructionForGeneration
          enumerator_7402.current_attributes (HERE).reader_objectParams (SOURCE_FILE_AT_LINE (249)).method_get (enumerator_7455.current_lkey (HERE), var_value, inCompiler COMMA_SOURCE_FILE_AT_LINE (249)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @structuredCastInstructionForGeneration
          if (var_value.isValid ()) {
            if (var_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_auto) {
              //-------- @ifInstructionForGeneration
              const enumGalgasBool test_1 = function_attributeAllowsAuto (enumerator_7455.current_type (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (253)).operator_not (SOURCE_FILE_AT_LINE (253)).boolEnum () ;
              if (kBoolTrue == test_1) {
                //-------- @errorInstructionForGeneration
                inCompiler->emitSemanticError (var_value.reader_location (SOURCE_FILE_AT_LINE (254)), GALGAS_string ("AUTO value is not allowed for the ").operator_concat (enumerator_7232.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (254)) COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (GALGAS_string (" attribute") COMMA_SOURCE_FILE_AT_LINE (254)) COMMA_SOURCE_FILE_AT_LINE (254)) ;
              }
            }
          }
        }else if (kBoolFalse == test_0) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_2 = function_attributeAllowsAuto (enumerator_7455.current_type (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (259)).operator_not (SOURCE_FILE_AT_LINE (259)).operator_and (enumerator_7455.current_type (HERE).reader_multiple (SOURCE_FILE_AT_LINE (259)).operator_not (SOURCE_FILE_AT_LINE (259)) COMMA_SOURCE_FILE_AT_LINE (259)).boolEnum () ;
          if (kBoolTrue == test_2) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_3 (enumerator_7402.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_3, GALGAS_string ("In ").operator_concat (enumerator_7232.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (260)) COMMA_SOURCE_FILE_AT_LINE (260)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (260)).operator_concat (enumerator_7402.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (260)) COMMA_SOURCE_FILE_AT_LINE (260)).operator_concat (GALGAS_string (", attribute ") COMMA_SOURCE_FILE_AT_LINE (260)).operator_concat (enumerator_7455.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (260)) COMMA_SOURCE_FILE_AT_LINE (260)).operator_concat (GALGAS_string (" is not defined and is not AUTO") COMMA_SOURCE_FILE_AT_LINE (260)) COMMA_SOURCE_FILE_AT_LINE (260)) ;
          }
        }
        //-------- @structuredCastInstructionForGeneration
        if (enumerator_7455.current_type (HERE).isValid ()) {
          if (enumerator_7455.current_type (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impAutoDefaultType) {
          }
        }
