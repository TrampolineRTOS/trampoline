...
GALGAS_object_5F_t function_checkAndGetIntegerNumber (const GALGAS_dataType & constinArgument0,
                                                      const GALGAS_luint_36__34_ & constinArgument1,
...
GALGAS_object_5F_t function_checkAndGetFloatNumber (const GALGAS_dataType & constinArgument0,
                                                    const GALGAS_ldouble & constinArgument1,
                                                    const GALGAS_bool & constinArgument2,
                                                    C_Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) ;
