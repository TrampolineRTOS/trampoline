...
cCollectionElement * cCollectionElement_uint_33__32_List::copy (void) {
  ...
  macroMyNew (result, cCollectionElement_uint_33__32_List (mAttribute_location, mAttribute_value COMMA_HERE)) ;
  return result ;
}
...
void cCollectionElement_uint_33__32_List::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ...
  ioString << "location" ":" ;
  mAttribute_location.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "value" ":" ;
...
typeComparisonResult cCollectionElement_uint_33__32_List::compare (const cCollectionElement * inOperand) const {
  ...
  if (kOperandEqual == result) {
    result = mAttribute_location.objectCompare (operand->mAttribute_location) ;
  }
  if (kOperandEqual == result) {
...
void GALGAS_uint_33__32_List::modifier_popFirst (GALGAS_location & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand0 = p->mAttribute_location ;
    outOperand1 = p->mAttribute_value ;
  }
}
...
GALGAS_uint_33__32_List GALGAS_uint_33__32_List::reader_subListWithRange (const GALGAS_uint & inIndex,
...
cCollectionElement * cCollectionElement_uint_36__34_List::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_uint_36__34_List (mAttribute_location, mAttribute_value COMMA_HERE)) ;
  return result ;
}
...
cCollectionElement * cCollectionElement_sint_33__32_List::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_sint_33__32_List (mAttribute_location, mAttribute_value COMMA_HERE)) ;
  return result ;
}
...
GALGAS_sint_33__32_List GALGAS_sint_33__32_List::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                          const GALGAS_uint & inLength,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) const {
...
cCollectionElement * cCollectionElement_sint_36__34_List::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_sint_36__34_List (mAttribute_location, mAttribute_value COMMA_HERE)) ;
  return result ;
}
...
GALGAS_sint_36__34_List GALGAS_sint_36__34_List::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                          const GALGAS_uint & inLength,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) const {
...
cCollectionElement * cCollectionElement_floatList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_floatList (mAttribute_location, mAttribute_value COMMA_HERE)) ;
  return result ;
}
...
GALGAS_floatList GALGAS_floatList::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                            const GALGAS_uint & inLength,
                                                            C_Compiler * inCompiler
                                                            COMMA_LOCATION_ARGS) const {
...
cCollectionElement * cCollectionElement_numberList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_numberList (mAttribute_location, mAttribute_value COMMA_HERE)) ;
  return result ;
}
...
GALGAS_numberList GALGAS_numberList::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                              const GALGAS_uint & inLength,
                                                              C_Compiler * inCompiler
                                                              COMMA_LOCATION_ARGS) const {
...
cMapElement_implementationMap::cMapElement_implementationMap (const GALGAS_lstring & inKey,
                                                              const GALGAS_implementationObject & in_object
                                                              COMMA_LOCATION_ARGS) :
cMapElement (inKey COMMA_THERE),
mAttribute_object (in_object) {
}

//---------------------------------------------------------------------------*

bool cMapElement_implementationMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_object.isValid () ;
}
...
cMapElement * cMapElement_implementationMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_implementationMap (mAttribute_lkey, mAttribute_object COMMA_HERE)) ;
  return result ;
}
...
void cMapElement_implementationMap::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "object" ":" ;
  mAttribute_object.description (ioString, inIndentation) ;
}
...
typeComparisonResult cMapElement_implementationMap::compare (const cCollectionElement * inOperand) const {
  ...
  typeComparisonResult result = mAttribute_lkey.objectCompare (operand->mAttribute_lkey) ;
  if (kOperandEqual == result) {
    result = mAttribute_object.objectCompare (operand->mAttribute_object) ;
  }
  return result ;
}
...
void GALGAS_implementationMap::method_get (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    outArgument0 = p->mAttribute_object ;
  }
}
...
GALGAS_implementationObject GALGAS_implementationMap::reader_objectForKey (const GALGAS_string & inKey,
                                                                           C_Compiler * inCompiler
                                                                           COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
...
void GALGAS_implementationMap::modifier_setObjectForKey (GALGAS_implementationObject inAttributeValue,
                                                         GALGAS_string inKey,
                                                         C_Compiler * inCompiler
                                                         COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_implementationMap) ;
    p->mAttribute_object = inAttributeValue ;
  }
}
...
GALGAS_implementationObject cEnumerator_implementationMap::current_object (LOCATION_ARGS) const {
  const cMapElement_implementationMap * p = (const cMapElement_implementationMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_implementationMap) ;
  return p->mAttribute_object ;
}
  ...
  if (kBoolTrue == test_0) {
    ...
    if (var_type.isValid ()) {
      if (var_type.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impBoolType) {
        GALGAS_impBoolType cast_26290_boolType ((cPtr_impBoolType *) var_type.ptr ()) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = constinArgument_boolValue.boolEnum () ;
        if (kBoolTrue == test_1) {
          //-------- @assignmentInstructionForGeneration
          result_subImplementation = cast_26290_boolType.reader_trueSubAttributes (SOURCE_FILE_AT_LINE (893)) ;
        }else if (kBoolFalse == test_1) {
          //-------- @assignmentInstructionForGeneration
          result_subImplementation = cast_26290_boolType.reader_falseSubAttributes (SOURCE_FILE_AT_LINE (895)) ;
        }
      }
    }
  }
  ...
  if (kBoolTrue == test_0) {
    ...
    if (var_type.isValid ()) {
      if (var_type.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impEnumType) {
        GALGAS_impEnumType cast_26901_enumType ((cPtr_impEnumType *) var_type.ptr ()) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = cast_26901_enumType.reader_valuesMap (SOURCE_FILE_AT_LINE (913)).reader_hasKey (constinArgument_enumValue COMMA_SOURCE_FILE_AT_LINE (913)).boolEnum () ;
        if (kBoolTrue == test_1) {
          //-------- @methodCallInstructionForGeneration
          cast_26901_enumType.reader_valuesMap (SOURCE_FILE_AT_LINE (914)).method_get (function_lstringWith (constinArgument_enumValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (914)), result_subImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (914)) ;
          //-------- END @methodCallInstructionForGeneration
        }
      }
    }
...
void routine_setDefaultsForType (const GALGAS_implementationObjectMap constinArgument_impObject,
                                 ...
                                 COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_implementationObjectMap enumerator_40237 (constinArgument_impObject, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_40237.hasCurrentObject ()) {
    //-------- @structuredCastInstructionForGeneration
    if (enumerator_40237.current_type (HERE).isValid ()) {
      if (NULL != dynamic_cast <const cPtr_impAutoDefaultType *> (enumerator_40237.current_type (HERE).ptr ())) {
        GALGAS_impAutoDefaultType cast_40296_defaultType ((cPtr_impAutoDefaultType *) enumerator_40237.current_type (HERE).ptr ()) ;
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_setDefault ((const cPtr_impAutoDefaultType *) cast_40296_defaultType.ptr (), ioArgument_objectParams, inCompiler COMMA_SOURCE_FILE_AT_LINE (1147)) ;
        //-------- END @methodCallInstructionForGeneration
      }
    }
    enumerator_40237.gotoNextObject () ;
  }
}
...
static void categoryMethod_implementation_checkObjectReferences (const cPtr_implementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_implementation) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_implementationMap enumerator_23282 (object->mAttribute_imp, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_23282.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_implementationObjectMap enumerator_23317 (enumerator_23282.current_object (HERE).reader_attributes (SOURCE_FILE_AT_LINE (796)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_23317.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      //--- @selfCopyInExpressionForGeneration
      const GALGAS_implementation temp_0 = object ;
      callCategoryMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_23317.current_type (HERE).ptr (), temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (797)) ;
      //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_impBoolType_checkAttributeReferences (const cPtr_impType * inObject,
  ...
  macroValidSharedObject (object, const cPtr_impBoolType) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_implementationObjectMap enumerator_29132 (object->mAttribute_trueSubAttributes, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29132.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_29132.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE_AT_LINE (966)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_29132.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_implementationObjectMap enumerator_29222 (object->mAttribute_falseSubAttributes, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29222.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_29222.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE_AT_LINE (969)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_29222.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_impEnumType_checkAttributeReferences (const cPtr_impType * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_enumValues enumerator_29396 (object->mAttribute_valuesMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29396.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_implementationObjectMap enumerator_29425 (enumerator_29396.current_subAttributes (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_29425.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_29425.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE_AT_LINE (978)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_29425.gotoNextObject () ;
    }
    enumerator_29396.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
