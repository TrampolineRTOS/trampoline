...
//                    september 27th, 2012, at 13h48'24"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
GALGAS_string function_valueList (const GALGAS_enumValues & constinArgument_values,
  ...
  result_result = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_enumValues enumerator_19129 (constinArgument_values, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_19129.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_result.dotAssign_operation (enumerator_19129.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (651)) COMMA_SOURCE_FILE_AT_LINE (651)) ;
    if (enumerator_19129.hasNextObject ()) {
      //-------- @concatInstructionForGeneration
      result_result.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (653)) ;
    }
...
void routine_verifyEnum (const GALGAS_impType constinArgument_anEnum,
  ...
  if (constinArgument_anEnum.isValid ()) {
    if (constinArgument_anEnum.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impEnumType) {
      GALGAS_impEnumType cast_21933_realEnum ((cPtr_impEnumType *) constinArgument_anEnum.ptr ()) ;
      //-------- @structuredCastInstructionForGeneration
      if (cast_21933_realEnum.reader_defaultValue (SOURCE_FILE_AT_LINE (740)).isValid ()) {
        if (cast_21933_realEnum.reader_defaultValue (SOURCE_FILE_AT_LINE (740)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_string_5F_class) {
          GALGAS_string_5F_class cast_22009_defaultValue ((cPtr_string_5F_class *) cast_21933_realEnum.reader_defaultValue (SOURCE_FILE_AT_LINE (740)).ptr ()) ;
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_0 = cast_21933_realEnum.reader_valuesMap (SOURCE_FILE_AT_LINE (742)).reader_hasKey (cast_22009_defaultValue.reader_value (SOURCE_FILE_AT_LINE (742)) COMMA_SOURCE_FILE_AT_LINE (742)).operator_not (SOURCE_FILE_AT_LINE (742)).boolEnum () ;
          if (kBoolTrue == test_0) {
            //-------- @errorInstructionForGeneration
            inCompiler->emitSemanticError (cast_22009_defaultValue.reader_location (SOURCE_FILE_AT_LINE (743)), GALGAS_string ("Default enum value does not match any enum value") COMMA_SOURCE_FILE_AT_LINE (743)) ;
          }
        }
      }
    }else{
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (constinArgument_anEnum.reader_location (SOURCE_FILE_AT_LINE (747)), GALGAS_string ("Internal, not an @impEnumType") COMMA_SOURCE_FILE_AT_LINE (747)) ;
    }
  }
}
...
GALGAS_object_5F_t function_checkAndGetIntegerNumber (const GALGAS_dataType & constinArgument_type,
  ...
  if (kBoolTrue == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_33__32_Number (SOURCE_FILE_AT_LINE (821)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @assignmentInstructionForGeneration
      result_value = GALGAS_sint_33__32__5F_class::constructor_new (constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (822)), constinArgument_number.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (822)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (822)).multiply_operation (GALGAS_sint ((PMSInt32) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (822)), inCompiler COMMA_SOURCE_FILE_AT_LINE (822)) COMMA_SOURCE_FILE_AT_LINE (822)) ;
    }else if (kBoolFalse == test_1) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_36__34_Number (SOURCE_FILE_AT_LINE (823)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @assignmentInstructionForGeneration
        result_value = GALGAS_sint_36__34__5F_class::constructor_new (constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (824)), constinArgument_number.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (824)).reader_sint_36__34_ (inCompiler COMMA_SOURCE_FILE_AT_LINE (824)).multiply_operation (GALGAS_sint_36__34_ ((PMSInt64) 1LL).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (824)), inCompiler COMMA_SOURCE_FILE_AT_LINE (824)) COMMA_SOURCE_FILE_AT_LINE (824)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @assignmentInstructionForGeneration
        result_value = GALGAS_void::constructor_new (constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (826)) COMMA_SOURCE_FILE_AT_LINE (826)) ;
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (constinArgument_number.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, categoryReader_oilType (constinArgument_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (827)).operator_concat (GALGAS_string (" expected, got a SINT") COMMA_SOURCE_FILE_AT_LINE (827)) COMMA_SOURCE_FILE_AT_LINE (827)) ;
      }
    }
  }else if (kBoolFalse == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_33__32_Number (SOURCE_FILE_AT_LINE (830)))).boolEnum () ;
    if (kBoolTrue == test_4) {
      //-------- @assignmentInstructionForGeneration
      result_value = GALGAS_sint_33__32__5F_class::constructor_new (constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (831)), constinArgument_number.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (831)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (831)) COMMA_SOURCE_FILE_AT_LINE (831)) ;
    }else if (kBoolFalse == test_4) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_36__34_Number (SOURCE_FILE_AT_LINE (832)))).boolEnum () ;
      if (kBoolTrue == test_5) {
        //-------- @assignmentInstructionForGeneration
        result_value = GALGAS_sint_36__34__5F_class::constructor_new (constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (833)), constinArgument_number.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (833)).reader_sint_36__34_ (inCompiler COMMA_SOURCE_FILE_AT_LINE (833)) COMMA_SOURCE_FILE_AT_LINE (833)) ;
      }else if (kBoolFalse == test_5) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE_AT_LINE (834)))).boolEnum () ;
        if (kBoolTrue == test_6) {
          //-------- @assignmentInstructionForGeneration
          result_value = GALGAS_uint_33__32__5F_class::constructor_new (constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (835)), constinArgument_number.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (835)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (835)) COMMA_SOURCE_FILE_AT_LINE (835)) ;
        }else if (kBoolFalse == test_6) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (836)))).boolEnum () ;
          if (kBoolTrue == test_7) {
            //-------- @assignmentInstructionForGeneration
            result_value = GALGAS_uint_36__34__5F_class::constructor_new (constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (837)), constinArgument_number.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (837)) COMMA_SOURCE_FILE_AT_LINE (837)) ;
          }else if (kBoolFalse == test_7) {
            //-------- @assignmentInstructionForGeneration
            result_value = GALGAS_void::constructor_new (constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (839)) COMMA_SOURCE_FILE_AT_LINE (839)) ;
            //-------- @errorInstructionForGeneration
            GALGAS_location location_8 (constinArgument_number.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_8, categoryReader_oilType (constinArgument_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (840)).operator_concat (GALGAS_string (" expected, got a UINT") COMMA_SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (840)) ;
          }
        }
      }
    }
...
GALGAS_object_5F_t function_checkAndGetFloatNumber (const GALGAS_dataType & constinArgument_type,
  ...
  if (kBoolTrue == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_floatNumber (SOURCE_FILE_AT_LINE (852)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @assignmentInstructionForGeneration
      result_value = GALGAS_float_5F_class::constructor_new (constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (853)), constinArgument_number.reader_double (SOURCE_FILE_AT_LINE (853)).multiply_operation (GALGAS_double (1).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (853)), inCompiler COMMA_SOURCE_FILE_AT_LINE (853)) COMMA_SOURCE_FILE_AT_LINE (853)) ;
    }else if (kBoolFalse == test_1) {
      //-------- @assignmentInstructionForGeneration
      result_value = GALGAS_void::constructor_new (constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (855)) COMMA_SOURCE_FILE_AT_LINE (855)) ;
      //-------- @errorInstructionForGeneration
      GALGAS_location location_2 (constinArgument_number.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, categoryReader_oilType (constinArgument_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (856)).operator_concat (GALGAS_string (" expected, got a FLOAT") COMMA_SOURCE_FILE_AT_LINE (856)) COMMA_SOURCE_FILE_AT_LINE (856)) ;
    }
  }else if (kBoolFalse == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_floatNumber (SOURCE_FILE_AT_LINE (859)))).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @assignmentInstructionForGeneration
      result_value = GALGAS_float_5F_class::constructor_new (constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (860)), constinArgument_number.reader_double (SOURCE_FILE_AT_LINE (860)) COMMA_SOURCE_FILE_AT_LINE (860)) ;
    }else if (kBoolFalse == test_3) {
      //-------- @assignmentInstructionForGeneration
      result_value = GALGAS_void::constructor_new (constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (862)) ;
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (constinArgument_number.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, categoryReader_oilType (constinArgument_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (863)).operator_concat (GALGAS_string (" expected, got a FLOAT") COMMA_SOURCE_FILE_AT_LINE (863)) COMMA_SOURCE_FILE_AT_LINE (863)) ;
    }
  }
//---
  return result_value ;
...
void routine_checkTypeForAttribute (const GALGAS_implementationObjectMap constinArgument_obj,
                                    ...
                                    COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_obj.reader_hasKey (constinArgument_attributeName COMMA_SOURCE_FILE_AT_LINE (873)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_impType var_type ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_obj.method_get (function_lstringWith (constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (875)), var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (875)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_type.reader_type (SOURCE_FILE_AT_LINE (876)).objectCompare (constinArgument_expectedType)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (var_type.reader_location (SOURCE_FILE_AT_LINE (877)), constinArgument_attributeName.operator_concat (GALGAS_string (" is a ") COMMA_SOURCE_FILE_AT_LINE (877)).operator_concat (categoryReader_oilType (var_type.reader_type (SOURCE_FILE_AT_LINE (877)), inCompiler COMMA_SOURCE_FILE_AT_LINE (877)) COMMA_SOURCE_FILE_AT_LINE (877)) COMMA_SOURCE_FILE_AT_LINE (877)) ;
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (var_type.reader_location (SOURCE_FILE_AT_LINE (878)), constinArgument_attributeName.operator_concat (GALGAS_string (" should be a ") COMMA_SOURCE_FILE_AT_LINE (878)).operator_concat (categoryReader_oilType (constinArgument_expectedType, inCompiler COMMA_SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (878)) ;
    }
  }
}
...
GALGAS_implementationObjectMap function_boolSubAttributes (const GALGAS_implementationObject & constinArgument_obj,
  ...
  //-------- @assignmentInstructionForGeneration
  result_subImplementation = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (889)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_obj.reader_attributes (SOURCE_FILE_AT_LINE (890)).reader_hasKey (constinArgument_attributeName COMMA_SOURCE_FILE_AT_LINE (890)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_impType var_type ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_obj.reader_attributes (SOURCE_FILE_AT_LINE (892)).method_get (function_lstringWith (constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (892)), var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (892)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @structuredCastInstructionForGeneration
    if (var_type.isValid ()) {
      if (var_type.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impBoolType) {
        GALGAS_impBoolType cast_26424_boolType ((cPtr_impBoolType *) var_type.ptr ()) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = constinArgument_boolValue.boolEnum () ;
        if (kBoolTrue == test_1) {
          //-------- @assignmentInstructionForGeneration
          result_subImplementation = cast_26424_boolType.reader_trueSubAttributes (SOURCE_FILE_AT_LINE (896)) ;
        }else if (kBoolFalse == test_1) {
          //-------- @assignmentInstructionForGeneration
          result_subImplementation = cast_26424_boolType.reader_falseSubAttributes (SOURCE_FILE_AT_LINE (898)) ;
        }
      }
    }
  }
...
GALGAS_implementationObjectMap function_enumSubAttributes (const GALGAS_implementationObject & constinArgument_obj,
  ...
  GALGAS_implementationObjectMap result_subImplementation ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_subImplementation = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (910)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_obj.reader_attributes (SOURCE_FILE_AT_LINE (911)).reader_hasKey (constinArgument_attributeName COMMA_SOURCE_FILE_AT_LINE (911)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_impType var_type ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_obj.reader_attributes (SOURCE_FILE_AT_LINE (913)).method_get (function_lstringWith (constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (913)), var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (913)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @structuredCastInstructionForGeneration
    if (var_type.isValid ()) {
      if (var_type.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impEnumType) {
        GALGAS_impEnumType cast_27035_enumType ((cPtr_impEnumType *) var_type.ptr ()) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = cast_27035_enumType.reader_valuesMap (SOURCE_FILE_AT_LINE (916)).reader_hasKey (constinArgument_enumValue COMMA_SOURCE_FILE_AT_LINE (916)).boolEnum () ;
        if (kBoolTrue == test_1) {
          //-------- @methodCallInstructionForGeneration
          cast_27035_enumType.reader_valuesMap (SOURCE_FILE_AT_LINE (917)).method_get (function_lstringWith (constinArgument_enumValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (917)), result_subImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (917)) ;
          //-------- END @methodCallInstructionForGeneration
        }
      }
    }
...
void routine_checkFilters (const GALGAS_implementationObject constinArgument_messageProperty,
  ...
  GALGAS_implementationObjectMap var_filter = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("MASKEDNEWEQUALSX"), inCompiler COMMA_SOURCE_FILE_AT_LINE (929)) ;
  ...
  //-------- @assignmentInstructionForGeneration
  var_filter = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("MASKEDNEWDIFFERSX"), inCompiler COMMA_SOURCE_FILE_AT_LINE (932)) ;
  { //-------- @routineCallInstructionForGeneration
  ...
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("X"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (934)), inCompiler COMMA_SOURCE_FILE_AT_LINE (934)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_filter = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("MASKEDNEWEQUALSMASKEDOLD"), inCompiler COMMA_SOURCE_FILE_AT_LINE (935)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("MASK"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (936)), inCompiler COMMA_SOURCE_FILE_AT_LINE (936)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_filter = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("NEWISWITHIN"), inCompiler COMMA_SOURCE_FILE_AT_LINE (937)) ;
  { //-------- @routineCallInstructionForGeneration
  ...
  //-------- @assignmentInstructionForGeneration
  var_filter = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("NEWISOUTSIDE"), inCompiler COMMA_SOURCE_FILE_AT_LINE (940)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("MIN"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (941)), inCompiler COMMA_SOURCE_FILE_AT_LINE (941)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("MAX"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (942)), inCompiler COMMA_SOURCE_FILE_AT_LINE (942)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_filter = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("ONEEVERYN"), inCompiler COMMA_SOURCE_FILE_AT_LINE (943)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("PERIOD"), GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE_AT_LINE (944)), inCompiler COMMA_SOURCE_FILE_AT_LINE (944)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("OFFSET"), GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE_AT_LINE (945)), inCompiler COMMA_SOURCE_FILE_AT_LINE (945)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
void routine_setDefaultsForType (const GALGAS_implementationObjectMap constinArgument_impObject,
                                 ...
                                 COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_implementationObjectMap enumerator_40371 (constinArgument_impObject, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_40371.hasCurrentObject ()) {
    //-------- @structuredCastInstructionForGeneration
    if (enumerator_40371.current_type (HERE).isValid ()) {
      if (NULL != dynamic_cast <const cPtr_impAutoDefaultType *> (enumerator_40371.current_type (HERE).ptr ())) {
        GALGAS_impAutoDefaultType cast_40430_defaultType ((cPtr_impAutoDefaultType *) enumerator_40371.current_type (HERE).ptr ()) ;
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_setDefault ((const cPtr_impAutoDefaultType *) cast_40430_defaultType.ptr (), ioArgument_objectParams, inCompiler COMMA_SOURCE_FILE_AT_LINE (1150)) ;
        //-------- END @methodCallInstructionForGeneration
      }
    }
    enumerator_40371.gotoNextObject () ;
  }
}
  ...
  if (kBoolTrue == test_0) {
    ...
    if (object->mAttribute_defaultValue.isValid ()) {
      if (object->mAttribute_defaultValue.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_void) {
        ...
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_identifierMap var_attr = ioArgument_attributes.reader_objectParams (SOURCE_FILE_AT_LINE (609)) ;
        { //-------- @modifierCallInstructionForGeneration
        var_attr.modifier_put (object->mAttribute_name, object->mAttribute_defaultValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (610)) ;
        } //-------- END @typeMethodInstructionForGeneration
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_attributes.modifier_setObjectParams (var_attr COMMA_SOURCE_FILE_AT_LINE (611)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }else{
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_identifierMap var_attr = ioArgument_attributes.reader_objectParams (SOURCE_FILE_AT_LINE (614)) ;
        { //-------- @modifierCallInstructionForGeneration
        var_attr.modifier_put (object->mAttribute_name, object->mAttribute_defaultValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (615)) ;
        } //-------- END @typeMethodInstructionForGeneration
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_attributes.modifier_setObjectParams (var_attr COMMA_SOURCE_FILE_AT_LINE (616)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }
    }
  }
...
static void categoryMethod_impBoolType_setDefault (const cPtr_impAutoDefaultType * inObject,
  ...
  if (object->mAttribute_defaultValue.isValid ()) {
    if (object->mAttribute_defaultValue.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_void) {
      ...
      GALGAS_boolAttribute cast_19975_b ((cPtr_boolAttribute *) object->mAttribute_defaultValue.ptr ()) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = ioArgument_attributes.reader_objectParams (SOURCE_FILE_AT_LINE (686)).reader_hasKey (object->mAttribute_name.reader_string (SOURCE_FILE_AT_LINE (686)) COMMA_SOURCE_FILE_AT_LINE (686)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_identifierMap var_userAttributes = ioArgument_attributes.reader_objectParams (SOURCE_FILE_AT_LINE (689)) ;
        //-------- @localVariableDeclarationForGeneration
        GALGAS_object_5F_t var_value ;
        //-------- @methodCallInstructionForGeneration
        var_userAttributes.method_get (object->mAttribute_name, var_value, inCompiler COMMA_SOURCE_FILE_AT_LINE (691)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @structuredCastInstructionForGeneration
        if (var_value.isValid ()) {
          if (var_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_boolAttribute) {
            GALGAS_boolAttribute cast_20411_boolValue ((cPtr_boolAttribute *) var_value.ptr ()) ;
            //-------- @localVariableDeclarationForGeneration
            GALGAS_implementationObjectMap var_subImpAttributes ;
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_1 = cast_20411_boolValue.reader_value (SOURCE_FILE_AT_LINE (695)).boolEnum () ;
            if (kBoolTrue == test_1) {
              //-------- @assignmentInstructionForGeneration
            ...
            //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
            GALGAS_objectAttributes var_subAttributes = cast_20411_boolValue.reader_subAttributes (SOURCE_FILE_AT_LINE (700)) ;
            { //-------- @routineCallInstructionForGeneration
            routine_setDefaultsForType (var_subImpAttributes, var_subAttributes, inCompiler COMMA_SOURCE_FILE_AT_LINE (701)) ;
            } //-------- @routineCallInstructionForGeneration
            //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
            GALGAS_boolAttribute var_bv = cast_20411_boolValue ;
            { //-------- @modifierCallInstructionForGeneration
            var_bv.modifier_setSubAttributes (var_subAttributes COMMA_SOURCE_FILE_AT_LINE (704)) ;
            } //-------- END @typeMethodInstructionForGeneration
            { //-------- @modifierCallInstructionForGeneration
            var_userAttributes.modifier_setValueForKey (var_bv, object->mAttribute_name.reader_string (SOURCE_FILE_AT_LINE (705)), inCompiler COMMA_SOURCE_FILE_AT_LINE (705)) ;
            } //-------- END @typeMethodInstructionForGeneration
            { //-------- @modifierCallInstructionForGeneration
            ioArgument_attributes.modifier_setObjectParams (var_userAttributes COMMA_SOURCE_FILE_AT_LINE (706)) ;
            } //-------- END @typeMethodInstructionForGeneration
          }
        }
      }else if (kBoolFalse == test_0) {
        ...
        GALGAS_implementationObjectMap var_subImpAttributes ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_2 = cast_19975_b.reader_value (SOURCE_FILE_AT_LINE (710)).boolEnum () ;
        if (kBoolTrue == test_2) {
          //-------- @assignmentInstructionForGeneration
          var_subImpAttributes = object->mAttribute_trueSubAttributes ;
        }else if (kBoolFalse == test_2) {
        ...
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_objectAttributes var_subAttributes = function_emptyObject (inCompiler COMMA_SOURCE_FILE_AT_LINE (715)) ;
        { //-------- @routineCallInstructionForGeneration
        routine_setDefaultsForType (var_subImpAttributes, var_subAttributes, inCompiler COMMA_SOURCE_FILE_AT_LINE (716)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_boolAttribute var_defaults = GALGAS_boolAttribute::constructor_new (cast_19975_b.reader_location (SOURCE_FILE_AT_LINE (717)), cast_19975_b.reader_value (SOURCE_FILE_AT_LINE (717)), var_subAttributes COMMA_SOURCE_FILE_AT_LINE (717)) ;
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_identifierMap var_attr = ioArgument_attributes.reader_objectParams (SOURCE_FILE_AT_LINE (718)) ;
        { //-------- @modifierCallInstructionForGeneration
        var_attr.modifier_put (object->mAttribute_name, var_defaults, inCompiler COMMA_SOURCE_FILE_AT_LINE (719)) ;
        } //-------- END @typeMethodInstructionForGeneration
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_attributes.modifier_setObjectParams (var_attr COMMA_SOURCE_FILE_AT_LINE (720)) ;
        } //-------- END @typeMethodInstructionForGeneration
      }
    }
  }
...
static GALGAS_bool categoryReader_implementation_hasKey (const cPtr_implementation * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_result = object->mAttribute_imp.reader_hasKey (constinArgument_key COMMA_SOURCE_FILE_AT_LINE (767)) ;
//---
  return result_result ;
}
...
static GALGAS_bool categoryReader_implementation_hasLKey (const cPtr_implementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_implementation) ;
  //-------- @assignmentInstructionForGeneration
  result_result = object->mAttribute_imp.reader_hasKey (constinArgument_key.reader_string (SOURCE_FILE_AT_LINE (774)) COMMA_SOURCE_FILE_AT_LINE (774)) ;
//---
  return result_result ;
}
...
static GALGAS_implementationObject categoryReader_implementation_impObject (const cPtr_implementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_implementation) ;
  //-------- @assignmentInstructionForGeneration
  result_obj = GALGAS_implementationObject::constructor_new (GALGAS_lbool::constructor_new (GALGAS_bool (false), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (781)), GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (781)) COMMA_SOURCE_FILE_AT_LINE (781)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_imp.reader_hasKey (constinArgument_objKind COMMA_SOURCE_FILE_AT_LINE (782)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    object->mAttribute_imp.method_get (function_lstringWith (constinArgument_objKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (783)), result_obj, inCompiler COMMA_SOURCE_FILE_AT_LINE (783)) ;
    //-------- END @methodCallInstructionForGeneration
  }
//---
  return result_obj ;
...
static void categoryMethod_implementation_checkTypeForKind (const cPtr_implementation * inObject,
  ...
  GALGAS_implementationObject var_obj = callCategoryReader_impObject ((const cPtr_implementation *) temp_0.ptr (), constinArgument_objKind, inCompiler COMMA_SOURCE_FILE_AT_LINE (792)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_obj.reader_attributes (SOURCE_FILE_AT_LINE (793)), constinArgument_attributeName, constinArgument_expectedType, inCompiler COMMA_SOURCE_FILE_AT_LINE (793)) ;
  } //-------- @routineCallInstructionForGeneration
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_implementation_checkObjectReferences (const cPtr_implementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_implementation) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_implementationMap enumerator_23419 (object->mAttribute_imp, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_23419.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_implementationObjectMap enumerator_23451 (enumerator_23419.current_obj (HERE).reader_attributes (SOURCE_FILE_AT_LINE (799)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_23451.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      //--- @selfCopyInExpressionForGeneration
      const GALGAS_implementation temp_0 = object ;
      callCategoryMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_23451.current_type (HERE).ptr (), temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (800)) ;
      //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_refType_checkAttributeReferences (const cPtr_impType * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = callCategoryReader_hasKey ((const cPtr_implementation *) constinArgument_imp.ptr (), object->mAttribute_ref.reader_string (SOURCE_FILE_AT_LINE (960)), inCompiler COMMA_SOURCE_FILE_AT_LINE (960)).operator_not (SOURCE_FILE_AT_LINE (960)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_ref.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, object->mAttribute_ref.reader_string (SOURCE_FILE_AT_LINE (961)).operator_concat (GALGAS_string (" object kind does not exist") COMMA_SOURCE_FILE_AT_LINE (961)) COMMA_SOURCE_FILE_AT_LINE (961)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_impBoolType_checkAttributeReferences (const cPtr_impType * inObject,
  ...
  macroValidSharedObject (object, const cPtr_impBoolType) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_implementationObjectMap enumerator_29266 (object->mAttribute_trueSubAttributes, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29266.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_29266.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE_AT_LINE (969)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_29266.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_implementationObjectMap enumerator_29356 (object->mAttribute_falseSubAttributes, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29356.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_29356.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE_AT_LINE (972)) ;
    //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_impEnumType_checkAttributeReferences (const cPtr_impType * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_enumValues enumerator_29530 (object->mAttribute_valuesMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29530.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_implementationObjectMap enumerator_29559 (enumerator_29530.current_subAttributes (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_29559.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_29559.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE_AT_LINE (981)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_29559.gotoNextObject () ;
    }
    enumerator_29530.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
