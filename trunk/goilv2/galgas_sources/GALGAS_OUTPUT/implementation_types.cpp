...
void routine_verifyEnum (const GALGAS_impType constinArgument_anEnum,
  ...
  if (constinArgument_anEnum.isValid ()) {
    if (constinArgument_anEnum.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impEnumType) {
      GALGAS_impEnumType cast_21947_realEnum ((cPtr_impEnumType *) constinArgument_anEnum.ptr ()) ;
      //-------- @structuredCastInstructionForGeneration
      if (cast_21947_realEnum.reader_defaultValue (SOURCE_FILE_AT_LINE (740)).isValid ()) {
        if (cast_21947_realEnum.reader_defaultValue (SOURCE_FILE_AT_LINE (740)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_string_5F_class) {
          GALGAS_string_5F_class cast_22023_defaultValue ((cPtr_string_5F_class *) cast_21947_realEnum.reader_defaultValue (SOURCE_FILE_AT_LINE (740)).ptr ()) ;
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_0 = cast_21947_realEnum.reader_valuesMap (SOURCE_FILE_AT_LINE (742)).reader_hasKey (cast_22023_defaultValue.reader_value (SOURCE_FILE_AT_LINE (742)) COMMA_SOURCE_FILE_AT_LINE (742)).operator_not (SOURCE_FILE_AT_LINE (742)).boolEnum () ;
          if (kBoolTrue == test_0) {
            //-------- @errorInstructionForGeneration
            inCompiler->emitSemanticError (cast_22023_defaultValue.reader_location (SOURCE_FILE_AT_LINE (743)), GALGAS_string ("Default enum value does not match any enum value") COMMA_SOURCE_FILE_AT_LINE (743)) ;
          }
        }
      }
    }else{
...
GALGAS_object_5F_t function_checkAndGetIntegerNumber (const GALGAS_lstring & constinArgument_oil_5F_desc,
  ...
  if (kBoolTrue == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_33__32_Number (SOURCE_FILE_AT_LINE (822)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @assignmentInstructionForGeneration
      result_value = GALGAS_sint_33__32__5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (823)), constinArgument_number.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (823)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (823)).multiply_operation (GALGAS_sint ((PMSInt32) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (823)), inCompiler COMMA_SOURCE_FILE_AT_LINE (823)) COMMA_SOURCE_FILE_AT_LINE (823)) ;
    }else if (kBoolFalse == test_1) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_36__34_Number (SOURCE_FILE_AT_LINE (824)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @assignmentInstructionForGeneration
        result_value = GALGAS_sint_36__34__5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (825)), constinArgument_number.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (825)).reader_sint_36__34_ (inCompiler COMMA_SOURCE_FILE_AT_LINE (825)).multiply_operation (GALGAS_sint_36__34_ ((PMSInt64) 1LL).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (825)), inCompiler COMMA_SOURCE_FILE_AT_LINE (825)) COMMA_SOURCE_FILE_AT_LINE (825)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @assignmentInstructionForGeneration
        result_value = GALGAS_void::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (827)) COMMA_SOURCE_FILE_AT_LINE (827)) ;
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (constinArgument_number.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, categoryReader_oilType (constinArgument_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (828)).operator_concat (GALGAS_string (" expected, got a SINT") COMMA_SOURCE_FILE_AT_LINE (828)) COMMA_SOURCE_FILE_AT_LINE (828)) ;
      }
    }
  }else if (kBoolFalse == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_33__32_Number (SOURCE_FILE_AT_LINE (831)))).boolEnum () ;
    if (kBoolTrue == test_4) {
      //-------- @assignmentInstructionForGeneration
      result_value = GALGAS_sint_33__32__5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (832)), constinArgument_number.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (832)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (832)) COMMA_SOURCE_FILE_AT_LINE (832)) ;
    }else if (kBoolFalse == test_4) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_36__34_Number (SOURCE_FILE_AT_LINE (833)))).boolEnum () ;
      if (kBoolTrue == test_5) {
        //-------- @assignmentInstructionForGeneration
        result_value = GALGAS_sint_36__34__5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (834)), constinArgument_number.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (834)).reader_sint_36__34_ (inCompiler COMMA_SOURCE_FILE_AT_LINE (834)) COMMA_SOURCE_FILE_AT_LINE (834)) ;
      }else if (kBoolFalse == test_5) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE_AT_LINE (835)))).boolEnum () ;
        if (kBoolTrue == test_6) {
          //-------- @assignmentInstructionForGeneration
          result_value = GALGAS_uint_33__32__5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (836)), constinArgument_number.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (836)).reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (836)) COMMA_SOURCE_FILE_AT_LINE (836)) ;
        }else if (kBoolFalse == test_6) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (837)))).boolEnum () ;
          if (kBoolTrue == test_7) {
            //-------- @assignmentInstructionForGeneration
            result_value = GALGAS_uint_36__34__5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (838)), constinArgument_number.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (838)) COMMA_SOURCE_FILE_AT_LINE (838)) ;
          }else if (kBoolFalse == test_7) {
            //-------- @assignmentInstructionForGeneration
            result_value = GALGAS_void::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (840)) ;
            //-------- @errorInstructionForGeneration
            GALGAS_location location_8 (constinArgument_number.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_8, categoryReader_oilType (constinArgument_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (841)).operator_concat (GALGAS_string (" expected, got a UINT") COMMA_SOURCE_FILE_AT_LINE (841)) COMMA_SOURCE_FILE_AT_LINE (841)) ;
          }
        }
      }
    }
...
static GALGAS_object functionWithGenericHeader_checkAndGetIntegerNumber (C_Compiler * inCompiler,
  ...
  const GALGAS_dataType operand1 = GALGAS_dataType::extractObject (inEffectiveParameterArray.objectAtIndex (1 COMMA_HERE), inCompiler, inErrorLocation COMMA_THERE) ;
  const GALGAS_luint_36__34_ operand2 = GALGAS_luint_36__34_::extractObject (inEffectiveParameterArray.objectAtIndex (2 COMMA_HERE), inCompiler, inErrorLocation COMMA_THERE) ;
  ...
  return function_checkAndGetIntegerNumber (operand0, operand1, operand2, operand3, inCompiler COMMA_THERE).reader_object (THERE) ;
}
...
GALGAS_object_5F_t function_checkAndGetFloatNumber (const GALGAS_lstring & constinArgument_oil_5F_desc,
  ...
  if (kBoolTrue == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_floatNumber (SOURCE_FILE_AT_LINE (854)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @assignmentInstructionForGeneration
      result_value = GALGAS_float_5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (855)), constinArgument_number.reader_double (SOURCE_FILE_AT_LINE (855)).multiply_operation (GALGAS_double (1).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (855)), inCompiler COMMA_SOURCE_FILE_AT_LINE (855)) COMMA_SOURCE_FILE_AT_LINE (855)) ;
    }else if (kBoolFalse == test_1) {
      //-------- @assignmentInstructionForGeneration
      result_value = GALGAS_void::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (857)) COMMA_SOURCE_FILE_AT_LINE (857)) ;
      //-------- @errorInstructionForGeneration
      GALGAS_location location_2 (constinArgument_number.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, categoryReader_oilType (constinArgument_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (858)).operator_concat (GALGAS_string (" expected, got a FLOAT") COMMA_SOURCE_FILE_AT_LINE (858)) COMMA_SOURCE_FILE_AT_LINE (858)) ;
    }
  }else if (kBoolFalse == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_floatNumber (SOURCE_FILE_AT_LINE (861)))).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @assignmentInstructionForGeneration
      result_value = GALGAS_float_5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (862)), constinArgument_number.reader_double (SOURCE_FILE_AT_LINE (862)) COMMA_SOURCE_FILE_AT_LINE (862)) ;
    }else if (kBoolFalse == test_3) {
      //-------- @assignmentInstructionForGeneration
      result_value = GALGAS_void::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (864)) COMMA_SOURCE_FILE_AT_LINE (864)) ;
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (constinArgument_number.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, categoryReader_oilType (constinArgument_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (865)).operator_concat (GALGAS_string (" expected, got a FLOAT") COMMA_SOURCE_FILE_AT_LINE (865)) COMMA_SOURCE_FILE_AT_LINE (865)) ;
    }
  }
//---
  return result_value ;
...
static GALGAS_object functionWithGenericHeader_checkAndGetFloatNumber (C_Compiler * inCompiler,
  ...
  const GALGAS_lstring operand0 = GALGAS_lstring::extractObject (inEffectiveParameterArray.objectAtIndex (0 COMMA_HERE), inCompiler, inErrorLocation COMMA_THERE) ;
  const GALGAS_dataType operand1 = GALGAS_dataType::extractObject (inEffectiveParameterArray.objectAtIndex (1 COMMA_HERE), inCompiler, inErrorLocation COMMA_THERE) ;
  const GALGAS_ldouble operand2 = GALGAS_ldouble::extractObject (inEffectiveParameterArray.objectAtIndex (2 COMMA_HERE), inCompiler, inErrorLocation COMMA_THERE) ;
  const GALGAS_bool operand3 = GALGAS_bool::extractObject (inEffectiveParameterArray.objectAtIndex (3 COMMA_HERE), inCompiler, inErrorLocation COMMA_THERE) ;
  return function_checkAndGetFloatNumber (operand0, operand1, operand2, operand3, inCompiler COMMA_THERE).reader_object (THERE) ;
}
...
void routine_checkTypeForAttribute (const GALGAS_implementationObjectMap constinArgument_obj,
                                    ...
                                    COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_obj.reader_hasKey (constinArgument_attributeName COMMA_SOURCE_FILE_AT_LINE (875)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_impType var_type ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_obj.method_get (function_lstringWith (constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (877)), var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (877)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_type.reader_type (SOURCE_FILE_AT_LINE (878)).objectCompare (constinArgument_expectedType)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (var_type.reader_location (SOURCE_FILE_AT_LINE (879)), constinArgument_attributeName.operator_concat (GALGAS_string (" is a ") COMMA_SOURCE_FILE_AT_LINE (879)).operator_concat (categoryReader_oilType (var_type.reader_type (SOURCE_FILE_AT_LINE (879)), inCompiler COMMA_SOURCE_FILE_AT_LINE (879)) COMMA_SOURCE_FILE_AT_LINE (879)) COMMA_SOURCE_FILE_AT_LINE (879)) ;
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (var_type.reader_location (SOURCE_FILE_AT_LINE (880)), constinArgument_attributeName.operator_concat (GALGAS_string (" should be a ") COMMA_SOURCE_FILE_AT_LINE (880)).operator_concat (categoryReader_oilType (constinArgument_expectedType, inCompiler COMMA_SOURCE_FILE_AT_LINE (880)) COMMA_SOURCE_FILE_AT_LINE (880)) COMMA_SOURCE_FILE_AT_LINE (880)) ;
    }
  }
}
...
GALGAS_implementationObjectMap function_boolSubAttributes (const GALGAS_implementationObject & constinArgument_obj,
  ...
  //-------- @assignmentInstructionForGeneration
  result_subImplementation = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (891)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_obj.reader_attributes (SOURCE_FILE_AT_LINE (892)).reader_hasKey (constinArgument_attributeName COMMA_SOURCE_FILE_AT_LINE (892)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_impType var_type ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_obj.reader_attributes (SOURCE_FILE_AT_LINE (894)).method_get (function_lstringWith (constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (894)), var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (894)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @structuredCastInstructionForGeneration
    if (var_type.isValid ()) {
      if (var_type.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impBoolType) {
        GALGAS_impBoolType cast_26602_boolType ((cPtr_impBoolType *) var_type.ptr ()) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = constinArgument_boolValue.boolEnum () ;
        if (kBoolTrue == test_1) {
          //-------- @assignmentInstructionForGeneration
          result_subImplementation = cast_26602_boolType.reader_trueSubAttributes (SOURCE_FILE_AT_LINE (898)) ;
        }else if (kBoolFalse == test_1) {
          //-------- @assignmentInstructionForGeneration
          result_subImplementation = cast_26602_boolType.reader_falseSubAttributes (SOURCE_FILE_AT_LINE (900)) ;
        }
      }
    }
  }
...
GALGAS_implementationObjectMap function_enumSubAttributes (const GALGAS_implementationObject & constinArgument_obj,
  ...
  GALGAS_implementationObjectMap result_subImplementation ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_subImplementation = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (912)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_obj.reader_attributes (SOURCE_FILE_AT_LINE (913)).reader_hasKey (constinArgument_attributeName COMMA_SOURCE_FILE_AT_LINE (913)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_impType var_type ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_obj.reader_attributes (SOURCE_FILE_AT_LINE (915)).method_get (function_lstringWith (constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (915)), var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (915)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @structuredCastInstructionForGeneration
    if (var_type.isValid ()) {
      if (var_type.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impEnumType) {
        GALGAS_impEnumType cast_27213_enumType ((cPtr_impEnumType *) var_type.ptr ()) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = cast_27213_enumType.reader_valuesMap (SOURCE_FILE_AT_LINE (918)).reader_hasKey (constinArgument_enumValue COMMA_SOURCE_FILE_AT_LINE (918)).boolEnum () ;
        if (kBoolTrue == test_1) {
          //-------- @methodCallInstructionForGeneration
          cast_27213_enumType.reader_valuesMap (SOURCE_FILE_AT_LINE (919)).method_get (function_lstringWith (constinArgument_enumValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (919)), result_subImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (919)) ;
          //-------- END @methodCallInstructionForGeneration
        }
      }
    }
...
void routine_checkFilters (const GALGAS_implementationObject constinArgument_messageProperty,
  ...
  GALGAS_implementationObjectMap var_filter = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("MASKEDNEWEQUALSX"), inCompiler COMMA_SOURCE_FILE_AT_LINE (931)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("MASK"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (932)), inCompiler COMMA_SOURCE_FILE_AT_LINE (932)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("X"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (933)), inCompiler COMMA_SOURCE_FILE_AT_LINE (933)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_filter = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("MASKEDNEWDIFFERSX"), inCompiler COMMA_SOURCE_FILE_AT_LINE (934)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("MASK"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (935)), inCompiler COMMA_SOURCE_FILE_AT_LINE (935)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("X"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (936)), inCompiler COMMA_SOURCE_FILE_AT_LINE (936)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_filter = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("MASKEDNEWEQUALSMASKEDOLD"), inCompiler COMMA_SOURCE_FILE_AT_LINE (937)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("MASK"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (938)), inCompiler COMMA_SOURCE_FILE_AT_LINE (938)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_filter = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("NEWISWITHIN"), inCompiler COMMA_SOURCE_FILE_AT_LINE (939)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("MIN"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (940)), inCompiler COMMA_SOURCE_FILE_AT_LINE (940)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("MAX"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (941)), inCompiler COMMA_SOURCE_FILE_AT_LINE (941)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_filter = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("NEWISOUTSIDE"), inCompiler COMMA_SOURCE_FILE_AT_LINE (942)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("MIN"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (943)), inCompiler COMMA_SOURCE_FILE_AT_LINE (943)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("MAX"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (944)), inCompiler COMMA_SOURCE_FILE_AT_LINE (944)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_filter = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("ONEEVERYN"), inCompiler COMMA_SOURCE_FILE_AT_LINE (945)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("PERIOD"), GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE_AT_LINE (946)), inCompiler COMMA_SOURCE_FILE_AT_LINE (946)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_checkTypeForAttribute (var_filter, GALGAS_string ("OFFSET"), GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE_AT_LINE (947)), inCompiler COMMA_SOURCE_FILE_AT_LINE (947)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
void routine_setDefaultsForType (const GALGAS_implementationObjectMap constinArgument_impObject,
                                 ...
                                 COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_implementationObjectMap enumerator_40549 (constinArgument_impObject, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_40549.hasCurrentObject ()) {
    //-------- @structuredCastInstructionForGeneration
    if (enumerator_40549.current_type (HERE).isValid ()) {
      if (NULL != dynamic_cast <const cPtr_impAutoDefaultType *> (enumerator_40549.current_type (HERE).ptr ())) {
        GALGAS_impAutoDefaultType cast_40608_defaultType ((cPtr_impAutoDefaultType *) enumerator_40549.current_type (HERE).ptr ()) ;
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_setDefault ((const cPtr_impAutoDefaultType *) cast_40608_defaultType.ptr (), ioArgument_objectParams, inCompiler COMMA_SOURCE_FILE_AT_LINE (1152)) ;
        //-------- END @methodCallInstructionForGeneration
      }
    }
    enumerator_40549.gotoNextObject () ;
  }
}
  ...
  if (object->mAttribute_defaultValue.isValid ()) {
    if (object->mAttribute_defaultValue.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_void) {
      ...
      if (kBoolTrue == test_0) {
        ...
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_boolAttribute var_defaults = GALGAS_boolAttribute::constructor_new (cast_19975_b.reader_oil_5F_desc (SOURCE_FILE_AT_LINE (717)), cast_19975_b.reader_location (SOURCE_FILE_AT_LINE (717)), cast_19975_b.reader_value (SOURCE_FILE_AT_LINE (717)), var_subAttributes COMMA_SOURCE_FILE_AT_LINE (717)) ;
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
...
static void categoryMethod_implementation_checkObjectReferences (const cPtr_implementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_implementation) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_implementationMap enumerator_23433 (object->mAttribute_imp, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_23433.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_implementationObjectMap enumerator_23465 (enumerator_23433.current_obj (HERE).reader_attributes (SOURCE_FILE_AT_LINE (799)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_23465.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      //--- @selfCopyInExpressionForGeneration
      const GALGAS_implementation temp_0 = object ;
      callCategoryMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_23465.current_type (HERE).ptr (), temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (800)) ;
      //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_refType_checkAttributeReferences (const cPtr_impType * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = callCategoryReader_hasKey ((const cPtr_implementation *) constinArgument_imp.ptr (), object->mAttribute_ref.reader_string (SOURCE_FILE_AT_LINE (962)), inCompiler COMMA_SOURCE_FILE_AT_LINE (962)).operator_not (SOURCE_FILE_AT_LINE (962)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_ref.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, object->mAttribute_ref.reader_string (SOURCE_FILE_AT_LINE (963)).operator_concat (GALGAS_string (" object kind does not exist") COMMA_SOURCE_FILE_AT_LINE (963)) COMMA_SOURCE_FILE_AT_LINE (963)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_impBoolType_checkAttributeReferences (const cPtr_impType * inObject,
  ...
  macroValidSharedObject (object, const cPtr_impBoolType) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_implementationObjectMap enumerator_29444 (object->mAttribute_trueSubAttributes, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29444.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_29444.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE_AT_LINE (971)) ;
    //-------- END @methodCallInstructionForGeneration
    enumerator_29444.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_implementationObjectMap enumerator_29534 (object->mAttribute_falseSubAttributes, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29534.hasCurrentObject ()) {
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_29534.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE_AT_LINE (974)) ;
    //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_impEnumType_checkAttributeReferences (const cPtr_impType * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_enumValues enumerator_29708 (object->mAttribute_valuesMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29708.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_implementationObjectMap enumerator_29737 (enumerator_29708.current_subAttributes (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_29737.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_29737.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE_AT_LINE (983)) ;
      //-------- END @methodCallInstructionForGeneration
