...
GALGAS_object_5F_t function_checkAndGetIntegerNumber (const GALGAS_lstring & constinArgument_oil_5F_desc,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      result_value = GALGAS_sint_33__32__5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (823)), constinArgument_number.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (823)).reader_sint (inCompiler COMMA_SOURCE_FILE_AT_LINE (823)).multiply_operation (GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (823)), inCompiler COMMA_SOURCE_FILE_AT_LINE (823)) COMMA_SOURCE_FILE_AT_LINE (823)) ;
    }else if (kBoolFalse == test_1) {
      ...
      if (kBoolTrue == test_2) {
        result_value = GALGAS_sint_36__34__5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.reader_location (SOURCE_FILE_AT_LINE (825)), constinArgument_number.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (825)).reader_sint_36__34_ (inCompiler COMMA_SOURCE_FILE_AT_LINE (825)).multiply_operation (GALGAS_sint_36__34_ ((int64_t) 1LL).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (825)), inCompiler COMMA_SOURCE_FILE_AT_LINE (825)) COMMA_SOURCE_FILE_AT_LINE (825)) ;
      }else if (kBoolFalse == test_2) {
