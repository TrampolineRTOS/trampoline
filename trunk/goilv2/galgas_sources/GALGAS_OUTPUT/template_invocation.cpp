...
GALGAS_string function_displayTypeAndValue (const GALGAS_Ttype & constinArgument_inType,
  ...
  if (constinArgument_inType.isValid ()) {
    ...
    case GALGAS_Ttype::kEnum_boolType: {
      ...
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, constinArgument_inValue.reader_mInt_36__34_Value (SOURCE_FILE_AT_LINE (79)).objectCompare (GALGAS_sint_36__34_ ((int64_t) 1LL))).boolEnum () ;
      if (kBoolTrue == test_1) {
    ...
    case GALGAS_Ttype::kEnum_listType: {
      ...
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, constinArgument_inValue.reader_mMapListValue (SOURCE_FILE_AT_LINE (87)).reader_length (SOURCE_FILE_AT_LINE (87)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        ...
        while (enumerator_3896.hasCurrentObject ()) {
          ...
          if (enumerator_3896.current_mType (HERE).isValid ()) {
            ...
            case GALGAS_Ttype::kEnum_boolType: {
              ...
              const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_3896.current_mValue (HERE).reader_mInt_36__34_Value (SOURCE_FILE_AT_LINE (94)).objectCompare (GALGAS_sint_36__34_ ((int64_t) 1LL))).boolEnum () ;
              if (kBoolTrue == test_5) {
...
void routine_findFileInHierarchy (const GALGAS_string constinArgument_file,
  ...
  if (constinArgument_searchPath.reader_length (SOURCE_FILE_AT_LINE (149)).isValid ()) {
    uint32_t variant_5687 = constinArgument_searchPath.reader_length (SOURCE_FILE_AT_LINE (149)).uintValue () ;
    bool loop_5687 = true ;
    while (loop_5687) {
      loop_5687 = GALGAS_bool (kIsStrictSup, var_partialPath.reader_length (SOURCE_FILE_AT_LINE (150)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (ioArgument_found.operator_not (SOURCE_FILE_AT_LINE (150)) COMMA_SOURCE_FILE_AT_LINE (150)).isValid () ;
      if (loop_5687) {
        loop_5687 = GALGAS_bool (kIsStrictSup, var_partialPath.reader_length (SOURCE_FILE_AT_LINE (150)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (ioArgument_found.operator_not (SOURCE_FILE_AT_LINE (150)) COMMA_SOURCE_FILE_AT_LINE (150)).boolValue () ;
      }
...
void routine_findAllFilesInHierarchy (const GALGAS_string constinArgument_file,
  ...
  if (constinArgument_searchPath.reader_length (SOURCE_FILE_AT_LINE (180)).isValid ()) {
    uint32_t variant_6589 = constinArgument_searchPath.reader_length (SOURCE_FILE_AT_LINE (180)).uintValue () ;
    bool loop_6589 = true ;
    while (loop_6589) {
      loop_6589 = GALGAS_bool (kIsStrictSup, var_partialPath.reader_length (SOURCE_FILE_AT_LINE (181)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValid () ;
      if (loop_6589) {
        loop_6589 = GALGAS_bool (kIsStrictSup, var_partialPath.reader_length (SOURCE_FILE_AT_LINE (181)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolValue () ;
      }
...
void routine_templateInvocation (const GALGAS_lstring constinArgument_inTemplateName,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (263)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_string var_templateDir = constinArgument_inTemplateDirectory ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_templateDir.reader_length (SOURCE_FILE_AT_LINE (265)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_3) {
        ...
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, var_targetDir.reader_length (SOURCE_FILE_AT_LINE (277)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_6) {
          ...
          if (kBoolTrue == test_8) {
            ...
            if (var_targetDir.reader_length (SOURCE_FILE_AT_LINE (305)).isValid ()) {
              uint32_t variant_10833 = var_targetDir.reader_length (SOURCE_FILE_AT_LINE (305)).uintValue () ;
              bool loop_10833 = true ;
              while (loop_10833) {
                loop_10833 = GALGAS_bool (kIsStrictSup, var_targetTemplatePartialPath.reader_length (SOURCE_FILE_AT_LINE (306)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (306)) COMMA_SOURCE_FILE_AT_LINE (306)).isValid () ;
                if (loop_10833) {
                  loop_10833 = GALGAS_bool (kIsStrictSup, var_targetTemplatePartialPath.reader_length (SOURCE_FILE_AT_LINE (306)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (306)) COMMA_SOURCE_FILE_AT_LINE (306)).boolValue () ;
                }
