...
void routine_printVariable (GALGAS_uint inArgument_indent,
  ...
  if (constinArgument_variableType.isValid ()) {
    ...
    case GALGAS_Ttype::kEnum_listType: {
      ...
      cEnumerator_TfieldMapList enumerator_42651 (constinArgument_variableValue.reader_mMapListValue (SOURCE_FILE_AT_LINE (1440)), kEnumeration_up) ;
      //--- simple foreach instruction
      GALGAS_uint index_42617 ((PMUInt32) 0) ;
      while (enumerator_42651.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (var_offset.operator_concat (GALGAS_string ("item at ") COMMA_SOURCE_FILE_AT_LINE (1441)).operator_concat (index_42617.reader_string (SOURCE_FILE_AT_LINE (1441)) COMMA_SOURCE_FILE_AT_LINE (1441)).operator_concat (GALGAS_string (":\n") COMMA_SOURCE_FILE_AT_LINE (1441)) COMMA_SOURCE_FILE_AT_LINE (1441)) ;
        { //-------- @routineCallInstructionForGeneration
        routine_printVariable (inArgument_indent, GALGAS_Ttype::constructor_structType (SOURCE_FILE_AT_LINE (1442)), GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((PMSInt64) 0LL), GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (1442)), enumerator_42651.current_mMap (HERE), function_dummyFunction (inCompiler COMMA_SOURCE_FILE_AT_LINE (1442)), function_emptyLString (inCompiler COMMA_SOURCE_FILE_AT_LINE (1442)) COMMA_SOURCE_FILE_AT_LINE (1442)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1442)) ;
        } //-------- @routineCallInstructionForGeneration
        enumerator_42651.gotoNextObject () ;
        index_42617.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1440)) ;
      }
      } break ;
    case GALGAS_Ttype::kEnum_mapType: {
      //-------- @foreachInstructionForGeneration
      cEnumerator_TfieldMap enumerator_42924 (constinArgument_variableValue.reader_mStructValue (SOURCE_FILE_AT_LINE (1445)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_42924.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (var_offset.operator_concat (enumerator_42924.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (1446)) COMMA_SOURCE_FILE_AT_LINE (1446)).operator_concat (GALGAS_string (":\n") COMMA_SOURCE_FILE_AT_LINE (1446)) COMMA_SOURCE_FILE_AT_LINE (1446)) ;
        { //-------- @routineCallInstructionForGeneration
        routine_printVariable (inArgument_indent, enumerator_42924.current_mType (HERE), enumerator_42924.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1447)) ;
        } //-------- @routineCallInstructionForGeneration
    ...
    case GALGAS_Ttype::kEnum_structType: {
      //-------- @foreachInstructionForGeneration
      cEnumerator_TfieldMap enumerator_43081 (constinArgument_variableValue.reader_mStructValue (SOURCE_FILE_AT_LINE (1450)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_43081.hasCurrentObject ()) {
        //-------- @messageInstructionForGeneration
        inCompiler->printMessage (var_offset.operator_concat (enumerator_43081.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (1451)) COMMA_SOURCE_FILE_AT_LINE (1451)).operator_concat (GALGAS_string (":\n") COMMA_SOURCE_FILE_AT_LINE (1451)) COMMA_SOURCE_FILE_AT_LINE (1451)) ;
        { //-------- @routineCallInstructionForGeneration
        routine_printVariable (inArgument_indent, enumerator_43081.current_mType (HERE), enumerator_43081.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1452)) ;
        } //-------- @routineCallInstructionForGeneration
...
void routine_partition (GALGAS_TfieldMapList & ioArgument_t,
  ...
  if (inArgument_max.substract_operation (inArgument_min, inCompiler COMMA_SOURCE_FILE_AT_LINE (1547)).isValid ()) {
    PMUInt32 variant_45654 = inArgument_max.substract_operation (inArgument_min, inCompiler COMMA_SOURCE_FILE_AT_LINE (1547)).uintValue () ;
    bool loop_45654 = true ;
    while (loop_45654) {
      loop_45654 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (inArgument_max)).isValid () ;
      if (loop_45654) {
        loop_45654 = GALGAS_bool (kIsStrictInf, var_i.objectCompare (inArgument_max)).boolValue () ;
      }
      if (loop_45654 && (0 == variant_45654)) {
        loop_45654 = false ;
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i1_ (const GALGAS_string constinArgument_inPrefix,
  ...
  //-------- @nonterminalInstructionForGeneration
  GALGAS_Tvalue joker_5841_0 ; // Joker input parameter
  GALGAS_Ttype joker_5848_0 ; // Joker input parameter
  nt_template_5F_instruction_5F_list_ (constinArgument_inPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, var_templateVariableMap, var_writeBlockResult, joker_5841_0, joker_5848_0, inCompiler) ;
  joker_5841_0.drop () ; // Release temporary input variables (joker in source)
  joker_5848_0.drop () ; // Release temporary input variables (joker in source)
  //-------- @ifInstructionForGeneration
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i3_ (const GALGAS_string constinArgument_inPrefix,
  ...
  case 1: {
    ...
    case 1: {
      ...
      if (var_found.operator_not (SOURCE_FILE_AT_LINE (252)).isValidAndTrue ()) {
        ...
        //-------- @nonterminalInstructionForGeneration
        GALGAS_Tvalue joker_7884_0 ; // Joker input parameter
        GALGAS_Ttype joker_7897_0 ; // Joker input parameter
        nt_template_5F_instruction_5F_list_ (var_nextPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, var_templateVariableMap, ioArgument_ioResultingString, joker_7884_0, joker_7897_0, inCompiler) ;
        joker_7884_0.drop () ; // Release temporary input variables (joker in source)
        joker_7897_0.drop () ; // Release temporary input variables (joker in source)
        //-------- @assignmentInstructionForGeneration
        ioArgument_ioTemplateVariableMap = var_templateVariableMap.reader_overriddenMap (SOURCE_FILE_AT_LINE (263)) ;
      }else{
        //-------- @nonterminalInstructionForGeneration
        nt_template_5F_instruction_5F_list_parse (inCompiler) ;
      }
  ...
  case 2: {
    ...
    { //-------- @routineCallInstructionForGeneration
    GALGAS_bool joker_8549_0 ; // Joker input parameter
    routine_templateInvocation (var_templateName, var_nextPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, GALGAS_bool (true), ioArgument_ioTemplateVariableMap, ioArgument_ioResultingString, joker_8549_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (278)) ;
    } //-------- @routineCallInstructionForGeneration
  } break ;
  default:
    break ;
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i4_ (const GALGAS_string /* constinArgument_inPrefix */,
  ...
  if (ioArgument_ioResultingString.reader_length (SOURCE_FILE_AT_LINE (309)).isValid ()) {
    PMUInt32 variant_9146 = ioArgument_ioResultingString.reader_length (SOURCE_FILE_AT_LINE (309)).uintValue () ;
    bool loop_9146 = true ;
    while (loop_9146) {
      loop_9146 = GALGAS_bool (kIsStrictSup, var_idx.objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (var_searchEndOfLine COMMA_SOURCE_FILE_AT_LINE (310)).isValid () ;
      if (loop_9146) {
        loop_9146 = GALGAS_bool (kIsStrictSup, var_idx.objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (var_searchEndOfLine COMMA_SOURCE_FILE_AT_LINE (310)).boolValue () ;
      }
      if (loop_9146 && (0 == variant_9146)) {
        loop_9146 = false ;
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i6_ (const GALGAS_string constinArgument_inPrefix,
  ...
  if (kBoolTrue == test_1) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_TexpressionList enumerator_11945 (var_args, kEnumeration_up) ;
    cEnumerator_lstringlist enumerator_11996 (var_value.reader_mFunctionValue (SOURCE_FILE_AT_LINE (418)).reader_args (SOURCE_FILE_AT_LINE (418)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_11945.hasCurrentObject () && enumerator_11996.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_locals.modifier_insertKey (enumerator_11996.current_mValue (HERE), enumerator_11945.current_mType (HERE), enumerator_11945.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (419)) ;
      } //-------- END @typeMethodInstructionForGeneration
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i8_ (const GALGAS_string constinArgument_inPrefix,
  ...
  while (repeatFlag_0) {
    ...
    if (var_currentCondition.operator_not (SOURCE_FILE_AT_LINE (510)).isValidAndTrue ()) {
      ...
      if (var_currentCondition.isValidAndTrue ()) {
        ...
        //-------- @nonterminalInstructionForGeneration
        GALGAS_Tvalue joker_15275_0 ; // Joker input parameter
        GALGAS_Ttype joker_15288_0 ; // Joker input parameter
        nt_template_5F_instruction_5F_list_ (constinArgument_inPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, var_templateVariableMap, ioArgument_ioResultingString, joker_15275_0, joker_15288_0, inCompiler) ;
        joker_15275_0.drop () ; // Release temporary input variables (joker in source)
        joker_15288_0.drop () ; // Release temporary input variables (joker in source)
        //-------- @assignmentInstructionForGeneration
        ioArgument_ioTemplateVariableMap = var_templateVariableMap.reader_overriddenMap (SOURCE_FILE_AT_LINE (538)) ;
      }else{
        //-------- @nonterminalInstructionForGeneration
        nt_template_5F_instruction_5F_list_parse (inCompiler) ;
      }
  ...
  case 2: {
    ...
    if (var_currentCondition.operator_not (SOURCE_FILE_AT_LINE (555)).isValidAndTrue ()) {
      ...
      //-------- @nonterminalInstructionForGeneration
      GALGAS_Tvalue joker_15907_0 ; // Joker input parameter
      GALGAS_Ttype joker_15918_0 ; // Joker input parameter
      nt_template_5F_instruction_5F_list_ (constinArgument_inPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, var_templateVariableMap, ioArgument_ioResultingString, joker_15907_0, joker_15918_0, inCompiler) ;
      joker_15907_0.drop () ; // Release temporary input variables (joker in source)
      joker_15918_0.drop () ; // Release temporary input variables (joker in source)
      //-------- @assignmentInstructionForGeneration
      ioArgument_ioTemplateVariableMap = var_templateVariableMap.reader_overriddenMap (SOURCE_FILE_AT_LINE (566)) ;
    }else{
      //-------- @nonterminalInstructionForGeneration
      nt_template_5F_instruction_5F_list_parse (inCompiler) ;
    }
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i11_ (const GALGAS_string constinArgument_inPrefix,
  ...
  if (var_expressionType.isValid ()) {
    ...
    case GALGAS_Ttype::kEnum_mapType: {
      ...
      //-------- @assignmentInstructionForGeneration
      var_keyList = var_enumeratedValue.reader_mStructValue (SOURCE_FILE_AT_LINE (662)).reader_allKeyList (SOURCE_FILE_AT_LINE (662)) ;
      } break ;
  ...
  case 2: {
    ...
    if (GALGAS_bool (kIsStrictSup, var_listLength.objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @nonterminalInstructionForGeneration
      GALGAS_Tvalue joker_18962_0 ; // Joker input parameter
      GALGAS_Ttype joker_18973_0 ; // Joker input parameter
      nt_template_5F_instruction_5F_list_ (constinArgument_inPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, ioArgument_ioTemplateVariableMap, ioArgument_ioResultingString, joker_18962_0, joker_18973_0, inCompiler) ;
      joker_18962_0.drop () ; // Release temporary input variables (joker in source)
      joker_18973_0.drop () ; // Release temporary input variables (joker in source)
    }else{
      //-------- @nonterminalInstructionForGeneration
      nt_template_5F_instruction_5F_list_parse (inCompiler) ;
    }
    ...
    while (loop_1) {
      ...
      if (GALGAS_bool (kIsStrictInf, var_idx.objectCompare (var_listLength)).isValidAndTrue ()) {
        ...
        const C_parsingContext parsingContext = inCompiler->parsingContext () ;
          ...
          //-------- @nonterminalInstructionForGeneration
          GALGAS_Tvalue joker_20256_0 ; // Joker input parameter
          GALGAS_Ttype joker_20265_0 ; // Joker input parameter
          nt_template_5F_instruction_5F_list_ (constinArgument_inPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, var_templateVariableMap, ioArgument_ioResultingString, joker_20256_0, joker_20265_0, inCompiler) ;
          joker_20256_0.drop () ; // Release temporary input variables (joker in source)
          joker_20265_0.drop () ; // Release temporary input variables (joker in source)
          //-------- @incrementInstructionForGeneration
          ...
          case 2: {
            ...
            if (GALGAS_bool (kIsStrictInf, var_idx.objectCompare (var_listLength)).isValidAndTrue ()) {
              //-------- @nonterminalInstructionForGeneration
              GALGAS_Tvalue joker_20541_0 ; // Joker input parameter
              GALGAS_Ttype joker_20554_0 ; // Joker input parameter
              nt_template_5F_instruction_5F_list_ (constinArgument_inPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, var_templateVariableMap, ioArgument_ioResultingString, joker_20541_0, joker_20554_0, inCompiler) ;
              joker_20541_0.drop () ; // Release temporary input variables (joker in source)
              joker_20554_0.drop () ; // Release temporary input variables (joker in source)
            }else{
              //-------- @nonterminalInstructionForGeneration
              nt_template_5F_instruction_5F_list_parse (inCompiler) ;
            }
          ...
          //-------- @assignmentInstructionForGeneration
          ioArgument_ioTemplateVariableMap = var_templateVariableMap.reader_overriddenMap (SOURCE_FILE_AT_LINE (745)) ;
  ...
  case 2: {
    ...
    if (GALGAS_bool (kIsStrictSup, var_listLength.objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
      //-------- @nonterminalInstructionForGeneration
      GALGAS_Tvalue joker_21052_0 ; // Joker input parameter
      GALGAS_Ttype joker_21063_0 ; // Joker input parameter
      nt_template_5F_instruction_5F_list_ (constinArgument_inPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, ioArgument_ioTemplateVariableMap, ioArgument_ioResultingString, joker_21052_0, joker_21063_0, inCompiler) ;
      joker_21052_0.drop () ; // Release temporary input variables (joker in source)
      joker_21063_0.drop () ; // Release temporary input variables (joker in source)
    }else{
      //-------- @nonterminalInstructionForGeneration
      nt_template_5F_instruction_5F_list_parse (inCompiler) ;
    }
    ...
    while (loop_3) {
      ...
      if (GALGAS_bool (kIsStrictSup, var_enumerationList.reader_length (SOURCE_FILE_AT_LINE (815)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
        ...
        const C_parsingContext parsingContext = inCompiler->parsingContext () ;
          ...
          //-------- @nonterminalInstructionForGeneration
          GALGAS_Tvalue joker_23122_0 ; // Joker input parameter
          GALGAS_Ttype joker_23131_0 ; // Joker input parameter
          nt_template_5F_instruction_5F_list_ (constinArgument_inPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, var_templateVariableMap, ioArgument_ioResultingString, joker_23122_0, joker_23131_0, inCompiler) ;
          joker_23122_0.drop () ; // Release temporary input variables (joker in source)
          joker_23131_0.drop () ; // Release temporary input variables (joker in source)
          //-------- @incrementInstructionForGeneration
          ...
          case 2: {
            ...
            if (GALGAS_bool (kIsStrictSup, var_enumerationList.reader_length (SOURCE_FILE_AT_LINE (844)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
              //-------- @nonterminalInstructionForGeneration
              GALGAS_Tvalue joker_23419_0 ; // Joker input parameter
              GALGAS_Ttype joker_23432_0 ; // Joker input parameter
              nt_template_5F_instruction_5F_list_ (constinArgument_inPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, var_templateVariableMap, ioArgument_ioResultingString, joker_23419_0, joker_23432_0, inCompiler) ;
              joker_23419_0.drop () ; // Release temporary input variables (joker in source)
              joker_23432_0.drop () ; // Release temporary input variables (joker in source)
            }else{
              //-------- @nonterminalInstructionForGeneration
              nt_template_5F_instruction_5F_list_parse (inCompiler) ;
            }
          ...
          //-------- @assignmentInstructionForGeneration
          ioArgument_ioTemplateVariableMap = var_templateVariableMap.reader_overriddenMap (SOURCE_FILE_AT_LINE (858)) ;
        inCompiler->setParsingContext (parsingContext) ;
      }
    }
  }
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i13_ (const GALGAS_string constinArgument_inPrefix,
  ...
  case 2: {
    ...
    if (GALGAS_bool (kIsSupOrEqual, var_endValue.reader_mInt_36__34_Value (SOURCE_FILE_AT_LINE (913)).objectCompare (var_startValue.reader_mInt_36__34_Value (SOURCE_FILE_AT_LINE (913)))).isValidAndTrue ()) {
      //-------- @nonterminalInstructionForGeneration
      GALGAS_Tvalue joker_24992_0 ; // Joker input parameter
      GALGAS_Ttype joker_25003_0 ; // Joker input parameter
      nt_template_5F_instruction_5F_list_ (constinArgument_inPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, ioArgument_ioTemplateVariableMap, ioArgument_ioResultingString, joker_24992_0, joker_25003_0, inCompiler) ;
      joker_24992_0.drop () ; // Release temporary input variables (joker in source)
      joker_25003_0.drop () ; // Release temporary input variables (joker in source)
    }else{
      //-------- @nonterminalInstructionForGeneration
      nt_template_5F_instruction_5F_list_parse (inCompiler) ;
    }
    ...
    while (loop_4) {
      ...
      if (GALGAS_bool (kIsInfOrEqual, var_idx.objectCompare (var_stop)).isValidAndTrue ()) {
        ...
        const C_parsingContext parsingContext = inCompiler->parsingContext () ;
          ...
          //-------- @nonterminalInstructionForGeneration
          GALGAS_Tvalue joker_25860_0 ; // Joker input parameter
          GALGAS_Ttype joker_25869_0 ; // Joker input parameter
          nt_template_5F_instruction_5F_list_ (constinArgument_inPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, var_templateVariableMap, ioArgument_ioResultingString, joker_25860_0, joker_25869_0, inCompiler) ;
          joker_25860_0.drop () ; // Release temporary input variables (joker in source)
          joker_25869_0.drop () ; // Release temporary input variables (joker in source)
          //-------- @incrementInstructionForGeneration
          ...
          case 2: {
            ...
            if (GALGAS_bool (kIsInfOrEqual, var_idx.objectCompare (var_stop)).isValidAndTrue ()) {
              //-------- @nonterminalInstructionForGeneration
              GALGAS_Tvalue joker_26140_0 ; // Joker input parameter
              GALGAS_Ttype joker_26153_0 ; // Joker input parameter
              nt_template_5F_instruction_5F_list_ (constinArgument_inPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, var_templateVariableMap, ioArgument_ioResultingString, joker_26140_0, joker_26153_0, inCompiler) ;
              joker_26140_0.drop () ; // Release temporary input variables (joker in source)
              joker_26153_0.drop () ; // Release temporary input variables (joker in source)
            }else{
              //-------- @nonterminalInstructionForGeneration
              nt_template_5F_instruction_5F_list_parse (inCompiler) ;
            }
          ...
          //-------- @assignmentInstructionForGeneration
          ioArgument_ioTemplateVariableMap = var_templateVariableMap.reader_overriddenMap (SOURCE_FILE_AT_LINE (977)) ;
        inCompiler->setParsingContext (parsingContext) ;
      }
    }
  }
  ...
  case 2: {
    ...
    if (GALGAS_bool (kIsSupOrEqual, var_stop.objectCompare (var_start)).isValidAndTrue ()) {
      //-------- @nonterminalInstructionForGeneration
      GALGAS_Tvalue joker_26650_0 ; // Joker input parameter
      GALGAS_Ttype joker_26661_0 ; // Joker input parameter
      nt_template_5F_instruction_5F_list_ (constinArgument_inPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, ioArgument_ioTemplateVariableMap, ioArgument_ioResultingString, joker_26650_0, joker_26661_0, inCompiler) ;
      joker_26650_0.drop () ; // Release temporary input variables (joker in source)
      joker_26661_0.drop () ; // Release temporary input variables (joker in source)
    }else{
      //-------- @nonterminalInstructionForGeneration
      nt_template_5F_instruction_5F_list_parse (inCompiler) ;
    }
