...
GGS_root_obj  function_void_root_obj (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  var_cas_cpu = GGS_root_obj ::constructor_new (inLexique, function_empty_lstring (inLexique COMMA_SOURCE_FILE_AT_LINE (43)), function_void_os_obj (inLexique COMMA_SOURCE_FILE_AT_LINE (44)), function_void_com_obj (inLexique COMMA_SOURCE_FILE_AT_LINE (45)), GGS_task_map ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (46)), GGS_counter_map ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (47)), GGS_alarm_map ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (48)), GGS_resource_map ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (49)), GGS_event_map ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (50)), GGS_isr_map ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (51)), GGS_message_map ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (52)), GGS_netmess_map ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (53)), GGS_scheduletable_map ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (54)), GGS_app_map ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (55)) COMMA_SOURCE_FILE_AT_LINE (42)) ;
  #ifdef DEBUG_TRACE_ENABLED
