...
void routine_goilTemplateInvocation (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_9515 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
  if (cond_9515.isBuiltAndTrue ()) {
    const GGS_string var_cas_templateDir = gOption_goil_5F_options_goil_5F_template_5F_dir.value () ;
    const GGS_bool cond_7278 = (var_cas_templateDir.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
    if (cond_7278.isBuiltAndTrue ()) {
      var_cas_inTemplateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the '--goil-templates' option is required for generating code") COMMA_SOURCE_FILE_AT_LINE (199)) ;
    }else if (cond_7278.isBuiltAndFalse ()) {
      const GGS_bool cond_7453 = (var_cas_templateDir.reader_directoryExists ()).operator_not () ;
      if (cond_7453.isBuiltAndTrue ()) {
        var_cas_inTemplateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("the '--goil-templates' option value is '")).operator_concat (var_cas_templateDir)).operator_concat (GGS_string ("', but is not a valid directory path")) COMMA_SOURCE_FILE_AT_LINE (201)) ;
      }else if (cond_7453.isBuiltAndFalse ()) {
        const GGS_string var_cas_targetDir = gOption_goil_5F_options_target_5F_platform.value () ;
        const GGS_bool cond_7673 = (var_cas_targetDir.reader_length ()).operator_isEqual (GGS_uint (0U)) ;
        if (cond_7673.isBuiltAndTrue ()) {
          var_cas_inTemplateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("the '--target' (or '-t') option is required for generating code") COMMA_SOURCE_FILE_AT_LINE (205)) ;
        }else if (cond_7673.isBuiltAndFalse ()) {
          const GGS_bool cond_7993 = (((var_cas_templateDir).operator_concat (GGS_string ("/"))).operator_concat (var_cas_targetDir).reader_directoryExists ()).operator_not () ;
          if (cond_7993.isBuiltAndTrue ()) {
          ...
          }else if (cond_7993.isBuiltAndFalse ()) {
            GGS_stringlist  var_cas_pathList = GGS_stringlist ::constructor_emptyList () ;
            GGS_bool var_cas_found = GGS_bool (false) ;
            const GGS_bool cond_8475 = (var_cas_inPath).operator_isNotEqual (GGS_string ("")) ;
            if (cond_8475.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_8458 = var_cas_found ;
              if (cond_8458.isBuiltAndTrue ()) {
            ...
            GGS_uint _variant_9187 = var_cas_targetDir.reader_length () ;
            GGS_bool _condition_9187 (_variant_9187.isBuilt (), true) ;
            while (_condition_9187.isBuiltAndTrue ()) {
              _condition_9187 = ((var_cas_targetTemplatePartialPath.reader_length ()).operator_strictSup (GGS_uint (0U))).operator_and ((var_cas_found).operator_not ()) ;
              if (_condition_9187.isBuiltAndTrue ()) {
                if (_variant_9187.uintValue () == 0) {
                  inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (233)) ;
                  _condition_9187 = GGS_bool (false) ;
                }else{
                  _variant_9187.decrement_operation (inLexique COMMA_HERE) ;
                  ...
                  var_cas_pathList.addAssign_operation (var_cas_fullTemplatePath) ;
                  var_cas_found = var_cas_fullTemplatePath.reader_fileExists () ;
                  const GGS_bool cond_9051 = var_cas_found ;
            ...
            const GGS_bool cond_9476 = (var_cas_found).operator_not () ;
            if (cond_9476.isBuiltAndTrue ()) {
              ...
              {
                GGS_stringlist::cEnumerator enumerator_9356 (var_cas_pathList, true) ;
                const GGS_stringlist::cElement * operand_9356 = NULL ;
                while (((operand_9356 = enumerator_9356.nextObject ()))) {
                  macroValidPointer (operand_9356) ;
                  var_cas_m.appendCString ("\n"
                    "  - '") ;
                  var_cas_m.dotAssign_operation (operand_9356->mValue) ;
                  var_cas_m.appendCString ("';") ;
                }
              }
              var_cas_inTemplateName.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, var_cas_m COMMA_SOURCE_FILE_AT_LINE (240)) ;
            }
          }
        }
      }
