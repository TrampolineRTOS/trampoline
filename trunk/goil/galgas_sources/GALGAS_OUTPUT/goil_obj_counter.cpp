...
pr_counter_goil_obj_counter_45_14_ (goil_lexique & _inLexique,
  ...
  if ((var_cas_counters.reader_hasKey (_inLexique, var_cas_counter_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (61)) COMMA_SOURCE_FILE_AT_LINE (61))).isBuiltAndTrue ()) {
    var_cas_counters.modifier_del (_inLexique, var_cas_counter_name, var_cas_counter COMMA_SOURCE_FILE_AT_LINE (62)) ;
    var_cas_max_allowed_value = var_cas_counter.reader_max_allowed_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (63)) ;
    var_cas_ticks_per_base = var_cas_counter.reader_ticks_per_base (_inLexique COMMA_SOURCE_FILE_AT_LINE (64)) ;
    var_cas_min_cycle = var_cas_counter.reader_min_cycle (_inLexique COMMA_SOURCE_FILE_AT_LINE (65)) ;
    var_cas_acc_apps = var_cas_counter.reader_acc_apps (_inLexique COMMA_SOURCE_FILE_AT_LINE (66)) ;
    var_cas_type = var_cas_counter.reader_type (_inLexique COMMA_SOURCE_FILE_AT_LINE (67)) ;
    var_cas_unit = var_cas_counter.reader_unit (_inLexique COMMA_SOURCE_FILE_AT_LINE (68)) ;
    var_cas_desc = var_cas_counter.reader_desc (_inLexique COMMA_SOURCE_FILE_AT_LINE (69)) ;
  }else{
    ...
    var_cas_counter = GGS_counter_obj ::constructor_new (_inLexique, var_cas_desc, var_cas_max_allowed_value, var_cas_ticks_per_base, var_cas_min_cycle, var_cas_acc_apps, var_cas_type, var_cas_unit COMMA_HERE) ;
  }
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7B) COMMA_HERE) ;
  nt_counter_parameters_ (_inLexique, var_cas_max_allowed_value, var_cas_ticks_per_base, var_cas_min_cycle, var_cas_acc_apps, var_cas_type, var_cas_unit) ;
  ...
  var_cas_counter = GGS_counter_obj ::constructor_new (_inLexique, var_cas_desc, var_cas_max_allowed_value, var_cas_ticks_per_base, var_cas_min_cycle, var_cas_acc_apps, var_cas_type, var_cas_unit COMMA_HERE) ;
  var_cas_counters.modifier_put (_inLexique, var_cas_counter_name, var_cas_counter COMMA_SOURCE_FILE_AT_LINE (101)) ;
}
...
void goil_obj_counter::
pr_counter_parameters_goil_obj_counter_104_25_ (goil_lexique & _inLexique,
                                GGS_basic_type  &var_cas_max_allowed_value,
                                GGS_basic_type  &var_cas_ticks_per_base,
                                GGS_basic_type  &var_cas_min_cycle,
                                GGS_lstringlist  &var_cas_acc_apps,
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_goil_obj_counter_0 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_uint32 (_inLexique,  var_cas_max_allowed_value,  var_cas_m,  GGS_string (true, "MAXALLOWEDVALUE") COMMA_SOURCE_FILE_AT_LINE (116)) ;
          } break ;
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_uint32 (_inLexique,  var_cas_ticks_per_base,  var_cas_t,  GGS_string (true, "TICKSPERBASE") COMMA_SOURCE_FILE_AT_LINE (120)) ;
          } break ;
        case 4 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_uint32 (_inLexique,  var_cas_min_cycle,  var_cas_c,  GGS_string (true, "MINCYCLE") COMMA_SOURCE_FILE_AT_LINE (124)) ;
          } break ;
        case 5 : {
          if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (126))))._operator_isEqual (GGS_bool (true, false))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "AUTOSAR flag is off, turn it on to use TYPE attribute in COUNTER object") COMMA_SOURCE_FILE_AT_LINE (128)) ;
          }
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          { const GGS_counter_type _var_3679 = var_cas_type ; // CAST instruction
            if (_var_3679.getPtr () != NULL) {
              macroValidPointer (_var_3679.getPtr ()) ;
              if (typeid (cPtr_void_counter) == typeid (* (_var_3679.getPtr ()))) {
                var_cas_type = var_cas_cpt_type ;
              }else{
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Redefinitiion of TYPE") COMMA_SOURCE_FILE_AT_LINE (136)) ;
                var_cas_type.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (136)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "was defined here") COMMA_SOURCE_FILE_AT_LINE (137)) ;
              }
            }
          }
          } break ;
        case 6 : {
          if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (139))))._operator_isEqual (GGS_bool (true, false))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "AUTOSAR flag is off, turn it on to use UNIT attribute in COUNTER object") COMMA_SOURCE_FILE_AT_LINE (141)) ;
          }
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          if (((var_cas_unit.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (150)))._operator_isEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
            var_cas_unit = var_cas_cpt_unit ;
          }else{
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "UNIT attribute already defined for this counter") COMMA_SOURCE_FILE_AT_LINE (154)) ;
            var_cas_unit.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "was defined here") COMMA_SOURCE_FILE_AT_LINE (155)) ;
          }
          } break ;
        case 7 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_add_lstring_unique (_inLexique,  var_cas_acc_apps,  var_cas_app,  GGS_string (true, "ACCESSING_APPLICATION") COMMA_SOURCE_FILE_AT_LINE (159)) ;
          } break ;
        case 8 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
...
void goil_obj_counter::
pr_counter_type_attrs_goil_obj_counter_165_25_ (goil_lexique & _inLexique,
                                GGS_counter_type  &var_cas_type) {
            ...
            case 2 : {
              ...
              switch (select_goil_obj_counter_5 (_inLexique)) {
                ...
                case 2 : {
                    ...
                    while (syntaxRepeat_6) {
                      switch (select_repeat_goil_obj_counter_6 (_inLexique)) {
                        case 2 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
                          ::routine_set_uint64 (_inLexique,  var_cas_npht,  var_cas_ui,  GGS_string (true, "NS_PER_HW_TICK") COMMA_SOURCE_FILE_AT_LINE (190)) ;
                          } break ;
                        case 3 : {
                          ...
                          ::routine_set_lstring_if_empty (_inLexique,  var_cas_gcn,  var_cas_cn,  GGS_string (true, "GPTCHANNELNAME") COMMA_SOURCE_FILE_AT_LINE (194)) ;
                          } break ;
                        default :
                  ...
                  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
                  { const GGS_basic_type _var_5533 = var_cas_npht ; // CAST instruction
                    if (_var_5533.getPtr () != NULL) {
                      macroValidPointer (_var_5533.getPtr ()) ;
                      if (typeid (cPtr_void) == typeid (* (_var_5533.getPtr ()))) {
                        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "NS_PER_HW_TICK subattribute not defined for this hardware counter GPT") COMMA_SOURCE_FILE_AT_LINE (200)) ;
                      }else{
                      }
                    }
                  }
                  if (((var_cas_gcn.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (201)))._operator_isEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "GPTCHANNELNAME subattribute not defined for this hardware counter GPT") COMMA_SOURCE_FILE_AT_LINE (203)) ;
                  }
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              { const GGS_counter_driver _var_6003 = var_cas_cd ; // CAST instruction
                if (_var_6003.getPtr () != NULL) {
                  macroValidPointer (_var_6003.getPtr ()) ;
                  if (typeid (cPtr_void_driver) == typeid (* (_var_6003.getPtr ()))) {
                    var_cas_cd = var_cas_cpt_cd ;
                  }else{
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "DRIVER subattribute already defined for this hardware counter") COMMA_SOURCE_FILE_AT_LINE (212)) ;
                    var_cas_cd.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (212)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "was defined here") COMMA_SOURCE_FILE_AT_LINE (213)) ;
                  }
                }
              }
              } break ;
                ...
                while (syntaxRepeat_7) {
                  switch (select_repeat_goil_obj_counter_7 (_inLexique)) {
                    case 2 : {
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      ::routine_set_uint64 (_inLexique,  var_cas_ns,  var_cas_ui,  GGS_string (true, "NS") COMMA_SOURCE_FILE_AT_LINE (222)) ;
                      } break ;
                    case 3 : {
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_string) COMMA_HERE) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      ::routine_set_lstring_if_empty (_inLexique,  var_cas_cn,  var_cas_c,  GGS_string (true, "CONSTNAME") COMMA_SOURCE_FILE_AT_LINE (226)) ;
                      } break ;
                    default :
