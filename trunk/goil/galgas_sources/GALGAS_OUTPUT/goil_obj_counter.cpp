...
//                    november 12th, 2009, at 11h41'58"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_counter_goil_obj_counter_56_14_ (goil_lexique & inLexique,
  ...
  const GGS_bool cond_1971 = var_cas_counters.reader_hasKey (inLexique, var_cas_counter_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (73)) COMMA_SOURCE_FILE_AT_LINE (73)) ;
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_goil_obj_counter_0 (inLexique)) {
        ...
        case 5 : {
          const GGS_bool cond_3839 = (gOption_goil_5F_options_autosar_5F_on.value ()).operator_isEqual (GGS_bool (false)) ;
          if (cond_3839.isBuiltAndTrue ()) {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          { const GGS_counter_type _var_4114 = var_cas_type ; // CAST instruction
            if (_var_4114.getPtr () != NULL) {
              macroValidPointer (_var_4114.getPtr ()) ;
              if (typeid (cPtr_void_counter) == typeid (* (_var_4114.getPtr ()))) {
        ...
        case 6 : {
          const GGS_bool cond_4292 = (gOption_goil_5F_options_autosar_5F_on.value ()).operator_isEqual (GGS_bool (false)) ;
          if (cond_4292.isBuiltAndTrue ()) {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          const GGS_bool cond_4509 = (var_cas_unit.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (167))).operator_isEqual (GGS_string ("")) ;
          if (cond_4509.isBuiltAndTrue ()) {
            var_cas_unit = var_cas_cpt_unit ;
          }else if (cond_4509.isBuiltAndFalse ()) {
            ...
            case 2 : {
              ...
              switch (select_goil_obj_counter_5 (inLexique)) {
                ...
                case 2 : {
                  ...
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D_) COMMA_HERE) ;
                  { const GGS_basic_type _var_6100 = var_cas_npht ; // CAST instruction
                    if (_var_6100.getPtr () != NULL) {
                      macroValidPointer (_var_6100.getPtr ()) ;
                      if (typeid (cPtr_void) == typeid (* (_var_6100.getPtr ()))) {
                  ...
                  const GGS_bool cond_6251 = (var_cas_gcn.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222))).operator_isEqual (GGS_string ("")) ;
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
              { const GGS_counter_driver _var_6570 = var_cas_cd ; // CAST instruction
                if (_var_6570.getPtr () != NULL) {
                  macroValidPointer (_var_6570.getPtr ()) ;
                  if (typeid (cPtr_void_driver) == typeid (* (_var_6570.getPtr ()))) {
