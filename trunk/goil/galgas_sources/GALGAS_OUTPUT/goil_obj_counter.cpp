...
pr_counter_goil_obj_counter_56_14_ (goil_lexique & inLexique,
  ...
  const GGS_bool cond_1971 = var_cas_counters.reader_hasKey (var_cas_counter_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (73))) ;
  if (cond_1971.isBuiltAndTrue ()) {
  ...
  }else if (cond_1971.isBuiltAndFalse ()) {
...
void goil_obj_counter::
pr_counter_parameters_goil_obj_counter_120_25_ (goil_lexique & inLexique,
                                GGS_basic_type  &var_cas_max_allowed_value,
                                GGS_basic_type  &var_cas_ticks_per_base,
                                GGS_basic_type  &var_cas_min_cycle,
                                GGS_lstring  &var_cas_source,
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_goil_obj_counter_0 (inLexique)) {
        case 2 : {
          ...
          GGS_lstring  automatic_var_3324_0 ;
          nt_description_ (inLexique, automatic_var_3324_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
        ...
        case 3 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5F_number) COMMA_HERE) ;
          GGS_lstring  automatic_var_3479_0 ;
          nt_description_ (inLexique, automatic_var_3479_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
        ...
        case 4 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5F_number) COMMA_HERE) ;
          GGS_lstring  automatic_var_3624_0 ;
          nt_description_ (inLexique, automatic_var_3624_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          ::routine_set_uint32 (inLexique,  var_cas_min_cycle,  var_cas_c,  GGS_string ("MINCYCLE") COMMA_SOURCE_FILE_AT_LINE (141)) ;
          } break ;
        case 5 : {
          const GGS_bool cond_3845 = (gOption_goil_5F_options_autosar_5F_on.reader_value ()).operator_isEqual (GGS_bool (false)) ;
          if (cond_3845.isBuiltAndTrue ()) {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          { const GGS_counter_type _var_4120 = var_cas_type ; // CAST instruction
            if (_var_4120.getPtr () != NULL) {
              macroValidPointer (_var_4120.getPtr ()) ;
              if (typeid (cPtr_void_counter) == typeid (* (_var_4120.getPtr ()))) {
        ...
        case 6 : {
          const GGS_bool cond_4304 = (gOption_goil_5F_options_autosar_5F_on.reader_value ()).operator_isEqual (GGS_bool (false)) ;
          if (cond_4304.isBuiltAndTrue ()) {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          const GGS_bool cond_4521 = (var_cas_unit.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (167))).operator_isEqual (GGS_string ("")) ;
          if (cond_4521.isBuiltAndTrue ()) {
            var_cas_unit = var_cas_cpt_unit ;
          }else if (cond_4521.isBuiltAndFalse ()) {
        ...
        case 7 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
          GGS_lstring  automatic_var_4721_0 ;
          nt_description_ (inLexique, automatic_var_4721_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
        ...
        case 8 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
          GGS_lstring  automatic_var_4872_0 ;
          nt_description_ (inLexique, automatic_var_4872_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
        ...
        case 9 : {
          ...
          GGS_lstring  automatic_var_5045_0 ;
          nt_description_ (inLexique, automatic_var_5045_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          } break ;
        default :
...
void goil_obj_counter::
pr_counter_type_attrs_goil_obj_counter_186_25_ (goil_lexique & inLexique,
                                GGS_counter_type  &var_cas_type) {
  switch (select_goil_obj_counter_3 (inLexique)) {
    ...
    case 2 : {
      ...
      GGS_counter_driver  var_cas_cd = GGS_void_driver ::constructor_new (inLexique, GGS_location (inLexique) COMMA_HERE) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_HARDWARE) COMMA_HERE) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7B_) COMMA_HERE) ;
      { bool syntaxRepeat_4 = true ;
        while (syntaxRepeat_4) {
          switch (select_goil_obj_counter_4 (inLexique)) {
            case 2 : {
              ...
              switch (select_goil_obj_counter_5 (inLexique)) {
                ...
                case 2 : {
                  ...
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7B_) COMMA_HERE) ;
                  GGS_basic_type  var_cas_npht = GGS_void ::constructor_new (inLexique, GGS_location (inLexique) COMMA_HERE) ;
                  GGS_lstring  var_cas_gcn = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) ;
                  { bool syntaxRepeat_6 = true ;
                    while (syntaxRepeat_6) {
                      switch (select_goil_obj_counter_6 (inLexique)) {
                        case 2 : {
                  ...
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D_) COMMA_HERE) ;
                  { const GGS_basic_type _var_6112 = var_cas_npht ; // CAST instruction
                    if (_var_6112.getPtr () != NULL) {
                      macroValidPointer (_var_6112.getPtr ()) ;
                      if (typeid (cPtr_void) == typeid (* (_var_6112.getPtr ()))) {
                  ...
                  const GGS_bool cond_6263 = (var_cas_gcn.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222))).operator_isEqual (GGS_string ("")) ;
                  if (cond_6263.isBuiltAndTrue ()) {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
              { const GGS_counter_driver _var_6582 = var_cas_cd ; // CAST instruction
                if (_var_6582.getPtr () != NULL) {
                  macroValidPointer (_var_6582.getPtr ()) ;
                  if (typeid (cPtr_void_driver) == typeid (* (_var_6582.getPtr ()))) {
            ...
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7B_) COMMA_HERE) ;
              GGS_basic_type  var_cas_ns = GGS_void ::constructor_new (inLexique, GGS_location (inLexique) COMMA_HERE) ;
              GGS_lstring  var_cas_cn = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE) ;
              { bool syntaxRepeat_7 = true ;
                while (syntaxRepeat_7) {
                  switch (select_goil_obj_counter_7 (inLexique)) {
                    case 2 : {
                      GGS_luint64  var_cas_ui ;
