...
void routine_check_external_sent (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_1128 = (var_cas_netm.reader_hasKey (var_cas_net.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (35)))).operator_not () ;
...
void routine_check_external_received (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_1421 = (var_cas_netm.reader_hasKey (var_cas_net.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (47)))).operator_not () ;
    ...
    if (_var_3317.getPtr () != NULL) {
      ...
      if (typeid (cPtr_true_link) == typeid (* (_var_3317.getPtr ()))) {
        ...
        if (cond_1916.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_2897 = var_cas_messages.reader_hasKey (var_cas_mess.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (70))) ;
        ...
        const GGS_bool cond_3188 = (var_cas_netm.reader_hasKey (var_cas_net.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (94)))).operator_not () ;
