...
cCollectionElement_time_5F_constants * GALGAS_time_5F_constants::makeElement (const GALGAS_basic_5F_type & in_ns,
                                                                              const GALGAS_lstring & in_const_5F_name
                                                                              COMMA_LOCATION_ARGS) {
  cCollectionElement_time_5F_constants * result = NULL ;
  macroMyNew (result, cCollectionElement_time_5F_constants (in_ns,
