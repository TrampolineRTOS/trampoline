...
GGS_uint64  function_maxAllowedValue (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_1705 = var_cas_counter.reader_max_allowed_value (inLexique COMMA_SOURCE_FILE_AT_LINE (68)) ; // CAST instruction
    if (_var_1705.getPtr () != NULL) {
      macroValidPointer (_var_1705.getPtr ()) ;
      if (typeid (cPtr_uint32_class) == typeid (* (_var_1705.getPtr ()))) {
        const GGS_uint32_class var_cas_max (_var_1705.getPtr ()) ;
...
GGS_uint64  function_minCycle (C_Compiler & inLexique,
  ...
  GGS_uint64  var_cas_value ;
  var_cas_value = GGS_uint64 (0ULL) ;
  { const GGS_basic_type _var_1980 = var_cas_counter.reader_min_cycle (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ; // CAST instruction
    if (_var_1980.getPtr () != NULL) {
      macroValidPointer (_var_1980.getPtr ()) ;
      if (typeid (cPtr_uint32_class) == typeid (* (_var_1980.getPtr ()))) {
        const GGS_uint32_class var_cas_min (_var_1980.getPtr ()) ;
...
GGS_uint64  function_ticksPerBase (C_Compiler & inLexique,
  ...
  GGS_uint64  var_cas_value ;
  var_cas_value = GGS_uint64 (0ULL) ;
  { const GGS_basic_type _var_2277 = var_cas_counter.reader_ticks_per_base (inLexique COMMA_SOURCE_FILE_AT_LINE (84)) ; // CAST instruction
    if (_var_2277.getPtr () != NULL) {
      macroValidPointer (_var_2277.getPtr ()) ;
      if (typeid (cPtr_uint32_class) == typeid (* (_var_2277.getPtr ()))) {
        const GGS_uint32_class var_cas_ticks (_var_2277.getPtr ()) ;
