...
//---------------------------------------------------------------------------*
  ...
  #define SOURCE_FILE_AT_LINE(line) "templates_routines.ggs", line
...
GGS_string function_goil_template (C_Compiler & inLexique,
  ...
  ::routine_goilTemplateInvocation (inLexique,  GGS_lstring ::constructor_new (inLexique, var_cas_name, GGS_location (inLexique) COMMA_HERE),  var_cas_prefix,  GGS_string ("templates"),  GGS_goilTemplateVariableMap ::constructor_emptyMap (inLexique COMMA_HERE),  var_cas_result COMMA_SOURCE_FILE_AT_LINE (10)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
kArgumentTypeList_goil_template [2] = {& kTypeDescriptor_GGS_string,
