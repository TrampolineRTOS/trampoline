...
//                    november 30th, 2009, at 10h44'44"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_generate_counter_arm7 (C_Compiler & inLexique,
  ...
  GGS_string var_cas_result = GGS_string ("") ;
  {
    ...
    while (((operand_1928 = enumerator_1928.nextObject ()))) {
      ...
      { const GGS_counter_type _var_2221 = operand_1928->mInfo.counter.reader_type (inLexique COMMA_SOURCE_FILE_AT_LINE (72)) ; // CAST instruction
        if (_var_2221.getPtr () != NULL) {
          macroValidPointer (_var_2221.getPtr ()) ;
          if (typeid (cPtr_software_counter) == typeid (* (_var_2221.getPtr ()))) {
          }else{
            GGS_string var_cas_tmp = function_template_string (inLexique, GGS_string ("code"), GGS_string ("counter_list_specific") COMMA_SOURCE_FILE_AT_LINE (75)) ;
            ::routine_doReplace (inLexique,  var_cas_tmp,  GGS_string ("$COUNTER$"),  (operand_1928->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (76))).operator_concat (GGS_string ("_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (76)) ;
  ...
  ::routine_doReplace (inLexique,  var_cas_code,  GGS_string ("$COUNTER_LIST$"),  var_cas_result COMMA_SOURCE_FILE_AT_LINE (81)) ;
  #ifdef DEBUG_TRACE_ENABLED
