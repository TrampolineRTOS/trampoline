...
#ifndef cfg_5F_lexique_0_DEFINED
#define cfg_5F_lexique_0_DEFINED
...
//--- Assign from attribute (v2)
  public : GALGASap_luint_36__34_ synthetizedAttribute_integer (void) const ;
  public : GALGASap_lstring synthetizedAttribute_keyword (void) const ;
  public : GALGASap_lstring synthetizedAttribute_number (void) const ;
  public : GALGASap_lstring synthetizedAttribute_string (void) const ;
