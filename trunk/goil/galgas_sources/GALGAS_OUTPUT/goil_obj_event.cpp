              ...
              { const GGS_event_mask_obj _var_1812 = var_cas_mask ; // CAST instruction
                if (_var_1812.getPtr () != NULL) {
                  ...
                  if (typeid (cPtr_event_mask_void_obj) == typeid (* (_var_1812.getPtr ()))) {
                    ...
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("MASK attribute already defined for this EVENT") COMMA_SOURCE_FILE_AT_LINE (83)) ;
                    var_cas_mask.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (83)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (84)) ;
                  }
                }
              }
              } break ;
                ...
                if (_var_2929.getPtr () != NULL) {
                  ...
                  if (typeid (cPtr_event_mask_void_obj) == typeid (* (_var_2929.getPtr ()))) {
                    ...
                    if (((var_cas_mask_value.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (91)))._operator_strictSup (GGS_uint ::constructor_max (_inLexique COMMA_HERE).reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (91)))).isBuiltAndTrue ()) {
                      GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("MASK attribute should be a 32 bits integer") COMMA_SOURCE_FILE_AT_LINE (93)) ;
                    }else{
                      ...
                      while (_condition_2556.isBuiltAndTrue ()) {
                        ...
                        if (_condition_2556.isBuiltAndTrue ()) {
                          if (_variant_2556.uintValue () == 0) {
                            ...
                            if ((((var_cas_pof2)._operator_and (var_cas_mask_value.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (98))))._operator_isNotEqual (GGS_uint64 (0U))).isBuiltAndTrue ()) {
                              var_cas_nbbits._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (99)) ;
                            }
                            var_cas_pof2 = var_cas_pof2._left_shift_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (101)) ;
                          }
                        }
                      }
                      if (((var_cas_nbbits)._operator_strictSup (GGS_uint (1U))).isBuiltAndTrue ()) {
                        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string ("MASK attribute uses more than 1 bit") COMMA_SOURCE_FILE_AT_LINE (104)) ;
                      }
                    }
                  }else{
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("MASK attribute already defined for this EVENT") COMMA_SOURCE_FILE_AT_LINE (109)) ;
