        ...
        if (cond_2829.isBuiltAndTrue ()) {
          ...
          GGS_tasks_by_type  var_cas_stasks = GGS_tasks_by_type ::constructor_emptySortedList () ;
          {
            ...
            while (((operand_1019 = enumerator_1019.nextObject ()))) {
              ...
              const GGS_bool cond_1126 = (operand_1019->mInfo.task.reader_events (inLexique COMMA_SOURCE_FILE_AT_LINE (44)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (44))).operator_strictSup (GGS_uint (0U)) ;
          ...
          if (cond_1799.isBuiltAndTrue ()) {
            ...
            GGS_tasks_by_type  var_cas_stasks = GGS_tasks_by_type ::constructor_emptySortedList () ;
            {
              ...
              while (((operand_1424 = enumerator_1424.nextObject ()))) {
                ...
                const GGS_bool cond_1537 = (operand_1424->mInfo.task.reader_events (inLexique COMMA_SOURCE_FILE_AT_LINE (57)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (57))).operator_strictSup (GGS_uint (0U)) ;
