...
void routine_generate_counter_hcs12 (C_Compiler & inLexique,
  ...
  GGS_string var_cas_result = GGS_string ("") ;
  {
    ...
    while (((operand_1940 = enumerator_1940.nextObject ()))) {
      ...
      { const GGS_counter_type _var_2232 = operand_1940->mInfo.counter.reader_type (inLexique COMMA_SOURCE_FILE_AT_LINE (73)) ; // CAST instruction
        if (_var_2232.getPtr () != NULL) {
          macroValidPointer (_var_2232.getPtr ()) ;
          if (typeid (cPtr_software_counter) == typeid (* (_var_2232.getPtr ()))) {
          }else{
            ...
            ::routine_doReplace (inLexique,  var_cas_tmp,  GGS_string ("$COUNTER$"),  (operand_1940->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (77))).operator_concat (GGS_string ("_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (77)) ;
