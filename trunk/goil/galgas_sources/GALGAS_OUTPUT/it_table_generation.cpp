...
void routine_generate_it_table (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_4914 = gOption_goil_5F_options_posix_5F_it.reader_value () ;
  if (cond_4914.isBuiltAndTrue ()) {
    const GGS_bool cond_4904 = var_cas_cfg.reader_hasKey (GGS_string ("it_sources")) ;
    if (cond_4904.isBuiltAndTrue ()) {
      ...
      { const GGS_basic_type _var_4888 = var_cas_interrupt_srcs ; // CAST instruction
        if (_var_4888.getPtr () != NULL) {
          macroValidPointer (_var_4888.getPtr ()) ;
          if (typeid (cPtr_interrupts) == typeid (* (_var_4888.getPtr ()))) {
            const GGS_interrupts var_cas_i (_var_4888.getPtr ()) ;
              ...
              while (((operand_2677 = enumerator_2677.nextObject ()))) {
                ...
                }
                {
                  ...
                  while (enumerator_3648.hasCurrentObject ()) {
                    const GGS_bool cond_4185 = var_cas_i.reader_it_sources (inLexique COMMA_SOURCE_FILE_AT_LINE (116)).reader_hasKey (enumerator_3648._key (HERE)) ;
            ...
            const GGS_bool cond_4458 = var_cas_gen_cfg.reader_with_timingprotection (inLexique COMMA_SOURCE_FILE_AT_LINE (130)) ;
            if (cond_4458.isBuiltAndTrue ()) {
            ...
            {
              GGS_it_table::cEnumerator enumerator_4591 (var_cas_tbl, true) ;
              const GGS_it_table::cElement * operand_4591 = enumerator_4591.nextObject () ;
              if ((operand_4591 != NULL)) {
                bool _foreach_loop_4591 ;
                do{
                  macroValidPointer (operand_4591) ;
                  var_cas_its.appendCString ("  { ") ;
                  var_cas_its.dotAssign_operation (operand_4591->fct) ;
                  var_cas_its.appendCString (", (void *)") ;
                  var_cas_its.dotAssign_operation (operand_4591->param) ;
                  var_cas_its.appendCString (" }") ;
                  operand_4591 = enumerator_4591.nextObject () ;
                  _foreach_loop_4591 = ((operand_4591 != NULL)) ;
                  if (_foreach_loop_4591) {
                    var_cas_its.appendCString (",\n") ;
                  }
                }while (_foreach_loop_4591) ;
                var_cas_its.appendCString ("\n") ;
              }
            }
            var_cas_its.appendCString ("};\n") ;
