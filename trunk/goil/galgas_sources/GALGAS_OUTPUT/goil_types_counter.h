...
//--- Comparison Operators
  public : GGS_bool _operator_isEqual (const GGS_counter_by_source & inOperand) const ;
  public : GGS_bool _operator_isNotEqual (const GGS_counter_by_source & inOperand) const ;
...
//--- Modifier 'popSmallest'
  public : void modifier_popSmallest (C_Compiler & _inLexique,
                                 ...
                                 COMMA_LOCATION_ARGS) ;
//--- Handle '.=' operator
  public : void _dotAssign_operation (const GGS_counter_by_source inOperand) ;
...
//--- Handling '+=' GALGAS operator
  public : void _addAssign_operation (const GGS_string& argument_0,
                                ...
                                const GGS_counter_obj & argument_2) ;
//--- Handling '.' GALGAS operator
  public : GGS_counter_by_source _operator_concat (const GGS_counter_by_source & inOperand) const ;
