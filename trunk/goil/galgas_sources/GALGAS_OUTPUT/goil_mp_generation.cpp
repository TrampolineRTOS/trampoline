...
void routine_generate_mp (C_Compiler & _inLexique,
  ...
  ::routine_getProjectName (_inLexique,  var_cas_directory COMMA_SOURCE_FILE_AT_LINE (159)) ;
  ::routine_doReplace (_inLexique,  var_cas_tpl_mp,  GGS_string (true, "$APPLICATION$"),  var_cas_directory COMMA_SOURCE_FILE_AT_LINE (161)) ;
  ::routine_doReplace (_inLexique,  var_cas_tpl_mp,  GGS_string (true, "$LINKER_SYM$"),  var_cas_ext COMMA_SOURCE_FILE_AT_LINE (162)) ;
  ::routine_doReplace (_inLexique,  var_cas_tpl_mp,  GGS_string (true, "$REGION_DESC$"),  var_cas_dec COMMA_SOURCE_FILE_AT_LINE (163)) ;
  ::routine_doReplace (_inLexique,  var_cas_tpl_mp,  GGS_string (true, "$INIT_CODE$"),  var_cas_init COMMA_SOURCE_FILE_AT_LINE (164)) ;
  ::routine_doReplace (_inLexique,  var_cas_tpl_mp,  GGS_string (true, "$DESC_TABLE$"),  var_cas_mp_table COMMA_SOURCE_FILE_AT_LINE (165)) ;
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (168)))).isBuiltAndTrue ()) {
      _inLexique.printMessage (GGS_string (true, "creating tpl_generated_mp.c\n") COMMA_SOURCE_FILE_AT_LINE (169)) ;
    }
    const GGS_string _temp_6304 = var_cas_tpl_mp ;
    if (_temp_6304._isBuilt ()) {
      _temp_6304 (HERE)->method_makeDirectoryAndWriteToFile (_inLexique, (var_cas_directory)._operator_concat (GGS_string (true, "/tpl_generated_mp.c")) COMMA_SOURCE_FILE_AT_LINE (171)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
