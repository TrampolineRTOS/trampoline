...
void routine_generate_mp (C_Compiler & _inLexique,
  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    if (_temp_6291._isBuilt ()) {
      _temp_6291 (HERE)->method_makeDirectoryAndWriteToFile (_inLexique, (var_cas_directory)._operator_concat (GGS_string (true, "/tpl_generated_mp.c")) COMMA_SOURCE_FILE_AT_LINE (170)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
