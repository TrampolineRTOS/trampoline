...
void routine_generate_schedule_tables (C_Compiler & _inLexique,
  ...
  var_cas_st_table.appendCString ("  tpl_schedtable_table[SCHEDTABLE_COUNT] = {\n") ;
  {
    ...
    if ((operand_840 != NULL)) {
      ...
      do{
        ...
        if (((var_cas_app_for_obj.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (24)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
  ...
  var_cas_st_table.appendCString ("\n"
    "};\n") ;
  if (((var_cas_sts.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (36)))._operator_isNotEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    var_cas_i_result._dotAssign_operation (var_cas_st_table) ;
  }
  ::routine_doReplace (_inLexique,  var_cas_obj_header,  GGS_string ("$SCHEDTABLE_COUNT$"),  var_cas_sts.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (40)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (40)) COMMA_SOURCE_FILE_AT_LINE (40)) ;
  ::routine_doReplace (_inLexique,  var_cas_implementation,  GGS_string ("$SCHEDTABLEIDS$"),  var_cas_h_result COMMA_SOURCE_FILE_AT_LINE (41)) ;
  ::routine_doReplace (_inLexique,  var_cas_implementation,  GGS_string ("$SCHEDULETABLES$"),  var_cas_i_result COMMA_SOURCE_FILE_AT_LINE (42)) ;
  #ifdef DEBUG_TRACE_ENABLED
