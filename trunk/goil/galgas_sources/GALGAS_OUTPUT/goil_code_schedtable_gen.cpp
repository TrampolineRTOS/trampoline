...
void routine_generate_schedule_tables (C_Compiler & inLexique,
  ...
  var_cas_st_table.appendCString ("  tpl_schedtable_table[SCHEDTABLE_COUNT] = {\n") ;
  {
    ...
    if ((operand_839 != NULL)) {
      ...
      do{
        ...
        const GGS_bool cond_1010 = (var_cas_app_for_obj.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (23))).operator_strictSup (GGS_uint (0U)) ;
  ...
  var_cas_st_table.appendCString ("\n"
    "};\n") ;
  const GGS_bool cond_1443 = (var_cas_sts.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (35))).operator_isNotEqual (GGS_uint (0U)) ;
