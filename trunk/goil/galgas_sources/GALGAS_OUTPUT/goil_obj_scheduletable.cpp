...
pr_scheduletable_goil_obj_scheduletable_54_20_ (goil_lexique & inLexique,
  ...
  const GGS_bool cond_1677 = (gOption_goil_5F_options_autosar_5F_on.reader_value ()).operator_isEqual (GGS_bool (false)) ;
  if (cond_1677.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_1873 = var_cas_stm.reader_hasKey (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (67))) ;
...
pr_scheduletable_parameters_goil_obj_scheduletable_82_31_ (goil_lexique & inLexique,
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_goil_obj_scheduletable_0 (inLexique)) {
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
          GGS_lstring  automatic_var_2656_0 ;
          nt_description_ (inLexique, automatic_var_2656_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          const GGS_bool cond_2872 = (var_cas_st_counter.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (99))).operator_isNotEqual (GGS_string ("")) ;
          if (cond_2872.isBuiltAndTrue ()) {
          ...
          }else if (cond_2872.isBuiltAndFalse ()) {
        ...
        case 3 : {
          ...
          GGS_lstring  automatic_var_3512_0 ;
          nt_description_ (inLexique, automatic_var_3512_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          { const GGS_autostart_obj _var_3783 = var_cas_st_autostart ; // CAST instruction
            if (_var_3783.getPtr () != NULL) {
              macroValidPointer (_var_3783.getPtr ()) ;
              if (typeid (cPtr_autostart_void) == typeid (* (_var_3783.getPtr ()))) {
        ...
        case 4 : {
          ...
          GGS_lstring  automatic_var_4054_0 ;
          nt_description_ (inLexique, automatic_var_4054_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          { const GGS_ltgt_sync_obj _var_4343 = var_cas_st_ltgt_sync ; // CAST instruction
            if (_var_4343.getPtr () != NULL) {
              macroValidPointer (_var_4343.getPtr ()) ;
              if (typeid (cPtr_ltgt_sync_void) == typeid (* (_var_4343.getPtr ()))) {
        ...
        case 5 : {
          ...
          GGS_lstring  automatic_var_4438_0 ;
          nt_description_ (inLexique, automatic_var_4438_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          { const GGS_basic_type _var_4747 = var_cas_st_periodic ; // CAST instruction
            if (_var_4747.getPtr () != NULL) {
              macroValidPointer (_var_4747.getPtr ()) ;
              if (typeid (cPtr_void) == typeid (* (_var_4747.getPtr ()))) {
        ...
        case 6 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          { const GGS_basic_type _var_5126 = var_cas_st_length ; // CAST instruction
            if (_var_5126.getPtr () != NULL) {
              macroValidPointer (_var_5126.getPtr ()) ;
              if (typeid (cPtr_void) == typeid (* (_var_5126.getPtr ()))) {
        ...
        case 7 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D_) COMMA_HERE) ;
          GGS_lstring  automatic_var_5390_0 ;
          nt_description_ (inLexique, automatic_var_5390_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          { const GGS_basic_type _var_5592 = var_cas_ep.reader_offset (inLexique COMMA_SOURCE_FILE_AT_LINE (194)) ; // CAST instruction
            if (_var_5592.getPtr () != NULL) {
              macroValidPointer (_var_5592.getPtr ()) ;
              if (typeid (cPtr_uint64_class) == typeid (* (_var_5592.getPtr ()))) {
                const GGS_uint64_class var_cas_off (_var_5592.getPtr ()) ;
        ...
        case 8 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
          GGS_lstring  automatic_var_5688_0 ;
          nt_description_ (inLexique, automatic_var_5688_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
        ...
        case 9 : {
          ...
          GGS_lstring  automatic_var_5864_0 ;
          nt_description_ (inLexique, automatic_var_5864_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          } break ;
        default :
...
pr_st_autostart_rel_params_goil_obj_scheduletable_222_30_ (goil_lexique & inLexique,
  ...
  { bool syntaxRepeat_4 = true ;
    while (syntaxRepeat_4) {
      switch (select_goil_obj_scheduletable_4 (inLexique)) {
        case 2 : {
          const GGS_bool cond_6515 = var_cas_offset_known ;
          if (cond_6515.isBuiltAndTrue ()) {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5F_number) COMMA_HERE) ;
          GGS_lstring  automatic_var_6580_0 ;
          nt_description_ (inLexique, automatic_var_6580_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
        ...
        case 3 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
          GGS_lstring  automatic_var_6675_0 ;
          nt_description_ (inLexique, automatic_var_6675_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
  ...
  const GGS_bool cond_6876 = (var_cas_offset_known).operator_isEqual (GGS_bool (false)) ;
  if (cond_6876.isBuiltAndTrue ()) {
...
pr_st_autostart_abs_params_goil_obj_scheduletable_253_30_ (goil_lexique & inLexique,
  ...
  { bool syntaxRepeat_5 = true ;
    while (syntaxRepeat_5) {
      switch (select_goil_obj_scheduletable_5 (inLexique)) {
        case 2 : {
          const GGS_bool cond_7399 = var_cas_start_known ;
          if (cond_7399.isBuiltAndTrue ()) {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5F_number) COMMA_HERE) ;
          GGS_lstring  automatic_var_7462_0 ;
          nt_description_ (inLexique, automatic_var_7462_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
        ...
        case 3 : {
          ...
          inLexique.assignFromAttribute_att_token (var_cas_app_mode) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
          GGS_lstring  automatic_var_7556_0 ;
          nt_description_ (inLexique, automatic_var_7556_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
  ...
  const GGS_bool cond_7755 = (var_cas_start_known).operator_isEqual (GGS_bool (false)) ;
...
pr_st_autostart_sync_params_goil_obj_scheduletable_284_31_ (goil_lexique & inLexique,
  ...
  { bool syntaxRepeat_6 = true ;
    while (syntaxRepeat_6) {
      switch (select_goil_obj_scheduletable_6 (inLexique)) {
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_APPMODE) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D_) COMMA_HERE) ;
          inLexique.assignFromAttribute_att_token (var_cas_app_mode) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
          GGS_lstring  automatic_var_8073_0 ;
          nt_description_ (inLexique, automatic_var_8073_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
...
pr_ltgt_sync_params_goil_obj_scheduletable_299_23_ (goil_lexique & inLexique,
  ...
  { bool syntaxRepeat_7 = true ;
    while (syntaxRepeat_7) {
      switch (select_goil_obj_scheduletable_7 (inLexique)) {
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5F_number) COMMA_HERE) ;
          { const GGS_basic_type _var_8672 = var_cas_precision ; // CAST instruction
            if (_var_8672.getPtr () != NULL) {
              macroValidPointer (_var_8672.getPtr ()) ;
              if (typeid (cPtr_void) == typeid (* (_var_8672.getPtr ()))) {
        ...
        case 3 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
          const GGS_bool cond_8825 = (var_cas_strategy.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (320))).operator_isEqual (GGS_string ("")) ;
          if (cond_8825.isBuiltAndTrue ()) {
            var_cas_strategy = var_cas_strat ;
          }else if (cond_8825.isBuiltAndFalse ()) {
  ...
  { const GGS_basic_type _var_9184 = var_cas_precision ; // CAST instruction
    if (_var_9184.getPtr () != NULL) {
      macroValidPointer (_var_9184.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_9184.getPtr ()))) {
        const GGS_bool cond_9113 = (var_cas_strategy.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (331))).operator_isEqual (GGS_string ("IMPLICIT")) ;
  ...
  const GGS_bool cond_9289 = (var_cas_strategy.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (338))).operator_isEqual (GGS_string ("")) ;
  if (cond_9289.isBuiltAndTrue ()) {
            ...
            case 1 : {
              ...
              { bool syntaxRepeat_10 = true ;
                while (syntaxRepeat_10) {
                  switch (select_goil_obj_scheduletable_10 (inLexique)) {
                    case 2 : {
    ...
    case 1 : {
      ...
      { bool syntaxRepeat_12 = true ;
        while (syntaxRepeat_12) {
          switch (select_goil_obj_scheduletable_12 (inLexique)) {
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
              const GGS_bool cond_11159 = var_cas_task_known ;
              if (cond_11159.isBuiltAndTrue ()) {
              ...
              }else if (cond_11159.isBuiltAndFalse ()) {
      ...
      const GGS_bool cond_11379 = var_cas_task_known ;
      if (cond_11379.isBuiltAndTrue ()) {
      ...
      }else if (cond_11379.isBuiltAndFalse ()) {
    ...
    case 2 : {
      ...
      { bool syntaxRepeat_13 = true ;
        while (syntaxRepeat_13) {
          switch (select_goil_obj_scheduletable_13 (inLexique)) {
            case 2 : {
              GGS_lstring  var_cas_new_task ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_TASK) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D_) COMMA_HERE) ;
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
              const GGS_bool cond_11915 = var_cas_task_known ;
              if (cond_11915.isBuiltAndTrue ()) {
              ...
              }else if (cond_11915.isBuiltAndFalse ()) {
                var_cas_task = var_cas_new_task ;
                var_cas_task_known = GGS_bool (true) ;
              }
              } break ;
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
              const GGS_bool cond_12261 = var_cas_event_known ;
              if (cond_12261.isBuiltAndTrue ()) {
              ...
              }else if (cond_12261.isBuiltAndFalse ()) {
      ...
      const GGS_bool cond_12497 = (var_cas_task_known).operator_and (var_cas_event_known) ;
