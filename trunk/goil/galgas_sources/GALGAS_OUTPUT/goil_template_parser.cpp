...
pr_template_instruction_goil_template_parser_98_27_ (goil_template_scanner & inLexique,
  ...
  GGS_uint _variant_3917 = var_cas_ioResultingString.reader_length () ;
  ...
  { bool syntaxRepeat_3 = true ;
    while (syntaxRepeat_3) {
        ...
        if (cond_8647.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_8794 = (var_cas_shortestListLentgh).operator_strictSup (var_cas_enumeratedValue.reader_mMapListValue (inLexique COMMA_SOURCE_FILE_AT_LINE (295)).reader_length ()) ;
          if (cond_8794.isBuiltAndTrue ()) {
            var_cas_shortestListLentgh = var_cas_enumeratedValue.reader_mMapListValue (inLexique COMMA_SOURCE_FILE_AT_LINE (296)).reader_length () ;
          }
        }
