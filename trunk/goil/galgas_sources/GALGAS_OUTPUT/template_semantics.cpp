...
appendForMapDescription (const PMSInt32 inElementIndex,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mStructValue.reader_description (inIndentation + 1) ;
}
...
isEqualToMapElement (const AC_galgas_map_element * inOperand) const {
  ...
  return (mInfo.mType.operator_isEqual (ptr->mInfo.mType)).boolValue ()
           ...
           && (mInfo.mStructValue.operator_isEqual (ptr->mInfo.mStructValue)).boolValue () ;
}
...
insertElement (C_Compiler & inLexique,
  ...
  if (isBuilt ()
   ...
   && inKey.isBuilt ()) {
    ...
    info.mStructValue = inParameter4 ;
...
searchElement (C_Compiler & inLexique,
  ...
  if (node == NULL) {
    ...
    outParameter4 = node->mInfo.mStructValue ;
    if (outIndex != NULL) {
...
/* const */ GGS_goilTemplateFieldMap  & GGS_goilTemplateFieldMap::cEnumerator::_mStructValue (LOCATION_ARGS) const {
  return ((cElement *) mObjectArray (mCurrentIndex COMMA_THERE))->mInfo.mStructValue ;
}
...
GGS_goilTemplateFieldMap GGS_goilTemplateFieldMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             ...
                                             COMMA_LOCATION_ARGS) {
  GGS_goilTemplateFieldMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
...
operator_isEqual (const GGS_goilTemplateValue & inOperand) const {
  return mUnsigned64Value.operator_isEqual (inOperand.mUnsigned64Value)
    ...
    .operator_and (mStructValue.operator_isEqual (inOperand.mStructValue)) ;
}
...
operator_isNotEqual (const GGS_goilTemplateValue & inOperand) const {
  return mUnsigned64Value.operator_isNotEqual (inOperand.mUnsigned64Value)
    ...
    .operator_or (mStructValue.operator_isNotEqual (inOperand.mStructValue)) ;
}
...
constructor_new (const GGS_uint64 & argument_0,
  ...
  result.mStructValue = argument_3 ;
  return result ;
}
...
reader_description (const PMSInt32 inIndentation) const {
  ...
  if (isBuilt ()) {
    ...
    _s.writeStringMultiple ("| ", inIndentation + 1) ;
    _s << "mStructValue " ;
    _s << mStructValue.reader_description (inIndentation + 1) ;
  }else{
    _s << "not built" ;
  }
  _s << "\n" ;
...
GGS_goilTemplateVariableMap GGS_goilTemplateVariableMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_goilTemplateType& inValue0,
                                             const GGS_goilTemplateValue& inValue1
                                             COMMA_LOCATION_ARGS) {
  GGS_goilTemplateVariableMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
GGS_goilTemplateValue function_valueWithBool (C_Compiler & inLexique,
  ...
  var_cas_outValue = GGS_goilTemplateValue::constructor_new (var_cas_inValue.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (108)), GGS_string (""), GGS_goilTemplateFieldMapList ::constructor_emptyList (), GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (111))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_goilTemplateValue function_valueWithUnsigned (C_Compiler & inLexique,
                                const GGS_uint64   var_cas_inValue COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER function_valueWithUnsigned at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_goilTemplateValue var_cas_outValue ;
  var_cas_outValue = GGS_goilTemplateValue::constructor_new (var_cas_inValue, GGS_string (""), GGS_goilTemplateFieldMapList ::constructor_emptyList (), GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (125))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_goilTemplateValue function_valueWithString (C_Compiler & inLexique,
                                const GGS_string  var_cas_inValue COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER function_valueWithString at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_goilTemplateValue var_cas_outValue ;
  var_cas_outValue = GGS_goilTemplateValue::constructor_new (GGS_uint64 (0ULL), var_cas_inValue, GGS_goilTemplateFieldMapList ::constructor_emptyList (), GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (139))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_addBoolValue (C_Compiler & inLexique,
                                ...
                                const GGS_bool  var_cas_inValue
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_addBoolValue at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  var_cas_ioTemplateVariableMap.modifier_insertKey (inLexique, var_cas_inVariableName, GGS_goilTemplateType::constructor_boolType (inLexique COMMA_SOURCE_FILE_AT_LINE (152)), function_valueWithBool (inLexique, var_cas_inValue COMMA_SOURCE_FILE_AT_LINE (153)) COMMA_SOURCE_FILE_AT_LINE (150)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_addUnsignedValue (C_Compiler & inLexique,
                                GGS_goilTemplateVariableMap  & var_cas_ioTemplateVariableMap,
                                const GGS_lstring   var_cas_inVariableName,
                                const GGS_uint64   var_cas_inValue
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_addUnsignedValue at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  var_cas_ioTemplateVariableMap.modifier_insertKey (inLexique, var_cas_inVariableName, GGS_goilTemplateType::constructor_unsignedType (inLexique COMMA_SOURCE_FILE_AT_LINE (167)), function_valueWithUnsigned (inLexique, var_cas_inValue COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (165)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_addLUnsignedValue (C_Compiler & inLexique,
                                ...
                                const GGS_luint64   var_cas_inValue
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_addLUnsignedValue at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  ::routine_addUnsignedValue (inLexique,  var_cas_ioTemplateVariableMap,  GGS_lstring ::constructor_new (inLexique, var_cas_inVariableName, var_cas_inValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (180)) COMMA_SOURCE_FILE_AT_LINE (180)),  var_cas_inValue.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (180)) COMMA_SOURCE_FILE_AT_LINE (180)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_addStringValue (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioTemplateVariableMap.modifier_insertKey (inLexique, var_cas_inVariableName, GGS_goilTemplateType::constructor_stringType (inLexique COMMA_SOURCE_FILE_AT_LINE (192)), function_valueWithString (inLexique, var_cas_inValue COMMA_SOURCE_FILE_AT_LINE (193)) COMMA_SOURCE_FILE_AT_LINE (190)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_addLStringValue (C_Compiler & inLexique,
                                GGS_goilTemplateVariableMap  & var_cas_ioTemplateVariableMap,
                                const GGS_string  var_cas_inVariableName,
                                const GGS_lstring   var_cas_inValue
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_addLStringValue at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  ::routine_addStringValue (inLexique,  var_cas_ioTemplateVariableMap,  GGS_lstring ::constructor_new (inLexique, var_cas_inVariableName, var_cas_inValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) COMMA_SOURCE_FILE_AT_LINE (205)),  var_cas_inValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (205)) COMMA_SOURCE_FILE_AT_LINE (205)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_addListValue (C_Compiler & inLexique,
                                GGS_goilTemplateVariableMap  & var_cas_ioTemplateVariableMap,
                                const GGS_lstring   var_cas_inVariableName,
                                const GGS_goilTemplateFieldMapList   var_cas_inValue
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_addListValue at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  var_cas_ioTemplateVariableMap.modifier_insertKey (inLexique, var_cas_inVariableName, GGS_goilTemplateType::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (217)), GGS_goilTemplateValue::constructor_new (GGS_uint64 (0ULL), GGS_string (""), var_cas_inValue, GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (218))) COMMA_SOURCE_FILE_AT_LINE (215)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
//---------------------------------------------------------------------------*
//                                                                           *
//                Implementation of routine "addStructValue"                 *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_addStructValue (C_Compiler & inLexique,
                                GGS_goilTemplateVariableMap  & var_cas_ioTemplateVariableMap,
                                const GGS_lstring   var_cas_inVariableName,
                                const GGS_goilTemplateFieldMap   var_cas_inValue
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_addStructValue at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  var_cas_ioTemplateVariableMap.modifier_insertKey (inLexique, var_cas_inVariableName, GGS_goilTemplateType::constructor_structType (inLexique COMMA_SOURCE_FILE_AT_LINE (231)), GGS_goilTemplateValue::constructor_new (GGS_uint64 (0ULL), GGS_string (""), GGS_goilTemplateFieldMapList ::constructor_emptyList (), var_cas_inValue) COMMA_SOURCE_FILE_AT_LINE (229)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_addStructValue\n") ;
  #endif
}
...
void routine_addBoolFieldValue (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioTemplateFieldMap.modifier_insertKey (inLexique, var_cas_inVariableName, GGS_goilTemplateType::constructor_boolType (inLexique COMMA_SOURCE_FILE_AT_LINE (249)), ((var_cas_inValue).isBuiltAndTrue () ? (GGS_uint64 (1ULL)) : (GGS_uint64 (0ULL))), GGS_string (""), GGS_goilTemplateFieldMapList ::constructor_emptyList (), GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (253)) COMMA_SOURCE_FILE_AT_LINE (247)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_addUnsignedFieldValue (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioTemplateFieldMap.modifier_insertKey (inLexique, var_cas_inVariableName, GGS_goilTemplateType::constructor_unsignedType (inLexique COMMA_SOURCE_FILE_AT_LINE (266)), var_cas_inValue, GGS_string (""), GGS_goilTemplateFieldMapList ::constructor_emptyList (), GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (270)) COMMA_SOURCE_FILE_AT_LINE (264)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_addLUnsignedFieldValue (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addUnsignedFieldValue (inLexique,  var_cas_ioTemplateFieldMap,  GGS_lstring ::constructor_new (inLexique, var_cas_inVariableName, var_cas_inValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (283)) COMMA_SOURCE_FILE_AT_LINE (283)),  var_cas_inValue.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (284)) COMMA_SOURCE_FILE_AT_LINE (281)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_addStringFieldValue (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioTemplateFieldMap.modifier_insertKey (inLexique, var_cas_inVariableName, GGS_goilTemplateType::constructor_stringType (inLexique COMMA_SOURCE_FILE_AT_LINE (296)), GGS_uint64 (0ULL), var_cas_inValue, GGS_goilTemplateFieldMapList ::constructor_emptyList (), GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (300)) COMMA_SOURCE_FILE_AT_LINE (294)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_addLStringFieldValue (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addStringFieldValue (inLexique,  var_cas_ioTemplateFieldMap,  GGS_lstring ::constructor_new (inLexique, var_cas_inVariableName, var_cas_inValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (313)) COMMA_SOURCE_FILE_AT_LINE (313)),  var_cas_inValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (311)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_addListFieldValue (C_Compiler & inLexique,
  ...
  #endif
  var_cas_ioTemplateFieldMap.modifier_insertKey (inLexique, var_cas_inVariableName, GGS_goilTemplateType::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (326)), GGS_uint64 (0ULL), GGS_string (""), var_cas_inValue, GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (330)) COMMA_SOURCE_FILE_AT_LINE (324)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
//---------------------------------------------------------------------------*
//                                                                           *
//             Implementation of routine "addStructFieldValue"               *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_addStructFieldValue (C_Compiler & inLexique,
                                GGS_goilTemplateFieldMap  & var_cas_ioTemplateFieldMap,
                                const GGS_lstring   var_cas_inVariableName,
                                const GGS_goilTemplateFieldMap   var_cas_inValue
                        COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER routine_addStructFieldValue at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  var_cas_ioTemplateFieldMap.modifier_insertKey (inLexique, var_cas_inVariableName, GGS_goilTemplateType::constructor_structType (inLexique COMMA_SOURCE_FILE_AT_LINE (343)), GGS_uint64 (0ULL), GGS_string (""), GGS_goilTemplateFieldMapList ::constructor_emptyList (), var_cas_inValue COMMA_SOURCE_FILE_AT_LINE (341)) ;
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE routine_addStructFieldValue\n") ;
  #endif
}
