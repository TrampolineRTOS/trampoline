...
GALGAS_goilTemplateValue function_valueWithBool (const GALGAS_bool & constinArgument_inValue,
  ...
  result_goilTemplateValue = GALGAS_goilTemplateValue::constructor_new (constinArgument_inValue.reader_uint_36__34_ (SOURCE_FILE_AT_LINE (104)), GALGAS_string::makeEmptyString (), GALGAS_goilTemplateFieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (106)), GALGAS_goilTemplateFieldMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (103)) ;
//---
...
GALGAS_goilTemplateValue function_valueWithUnsigned (const GALGAS_uint_36__34_ & constinArgument_inValue,
  ...
  GALGAS_goilTemplateValue result_goilTemplateValue ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_goilTemplateValue = GALGAS_goilTemplateValue::constructor_new (constinArgument_inValue, GALGAS_string::makeEmptyString (), GALGAS_goilTemplateFieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (120)), GALGAS_goilTemplateFieldMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (121)) COMMA_SOURCE_FILE_AT_LINE (117)) ;
//---
  return result_goilTemplateValue ;
}
...
void routine_addListValue (GALGAS_goilTemplateVariableMap & ioArgument_ioTemplateVariableMap,
                           ...
                           COMMA_UNUSED_LOCATION_ARGS) {
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_goilTemplateType::constructor_listType (SOURCE_FILE_AT_LINE (213)), GALGAS_goilTemplateValue::constructor_new (GALGAS_uint_36__34_ ((PMUInt64) 0ULL), GALGAS_string::makeEmptyString (), constinArgument_inValue, GALGAS_goilTemplateFieldMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (214)), inCompiler COMMA_SOURCE_FILE_AT_LINE (211)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_addStructValue (GALGAS_goilTemplateVariableMap & ioArgument_ioTemplateVariableMap,
                             ...
                             COMMA_UNUSED_LOCATION_ARGS) {
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_goilTemplateType::constructor_structType (SOURCE_FILE_AT_LINE (227)), GALGAS_goilTemplateValue::constructor_new (GALGAS_uint_36__34_ ((PMUInt64) 0ULL), GALGAS_string::makeEmptyString (), GALGAS_goilTemplateFieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (228)), constinArgument_inValue COMMA_SOURCE_FILE_AT_LINE (228)), inCompiler COMMA_SOURCE_FILE_AT_LINE (225)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_addUnsignedFieldValue (GALGAS_goilTemplateFieldMap & ioArgument_ioTemplateFieldMap,
                                    ...
                                    COMMA_UNUSED_LOCATION_ARGS) {
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTemplateFieldMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_goilTemplateType::constructor_unsignedType (SOURCE_FILE_AT_LINE (262)), constinArgument_inValue, GALGAS_string::makeEmptyString (), GALGAS_goilTemplateFieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (265)), GALGAS_goilTemplateFieldMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (266)), inCompiler COMMA_SOURCE_FILE_AT_LINE (260)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_addListFieldValue (GALGAS_goilTemplateFieldMap & ioArgument_ioTemplateFieldMap,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTemplateFieldMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_goilTemplateType::constructor_listType (SOURCE_FILE_AT_LINE (322)), GALGAS_uint_36__34_ ((PMUInt64) 0ULL), GALGAS_string::makeEmptyString (), constinArgument_inValue, GALGAS_goilTemplateFieldMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (326)), inCompiler COMMA_SOURCE_FILE_AT_LINE (320)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_addStructFieldValue (GALGAS_goilTemplateFieldMap & ioArgument_ioTemplateFieldMap,
                                  ...
                                  COMMA_UNUSED_LOCATION_ARGS) {
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTemplateFieldMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_goilTemplateType::constructor_structType (SOURCE_FILE_AT_LINE (339)), GALGAS_uint_36__34_ ((PMUInt64) 0ULL), GALGAS_string::makeEmptyString (), GALGAS_goilTemplateFieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (342)), constinArgument_inValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (337)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
