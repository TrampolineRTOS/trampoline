...
GGS_goilTemplateValue function_valueWithBool (C_Compiler & inLexique,
  ...
  var_cas_outValue = GGS_goilTemplateValue::constructor_new (var_cas_inValue.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (103)), GGS_string (""), GGS_goilTemplateFieldMapList ::constructor_emptyList ()) ;
  #ifdef DEBUG_TRACE_ENABLED
