...
//                    november 25th, 2009, at 14h53'19"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_trace_method ("trace_method", true, NULL) ;
...
C_galgasRootClassRunTimeInformation gClassInfoFor__trace_method ("trace_method", & kTypeDescriptor_GGS_trace_method) ;
...
const C_galgas_type_descriptor * GGS_trace_method::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_trace_void ("trace_void", true, & kTypeDescriptor_GGS_trace_method) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__trace_void ("trace_void", gClassInfoFor__trace_method, & kTypeDescriptor_GGS_trace_void) ;
...
const C_galgas_type_descriptor * GGS_trace_void::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_trace_file ("trace_file", true, & kTypeDescriptor_GGS_trace_method) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__trace_file ("trace_file", gClassInfoFor__trace_method, & kTypeDescriptor_GGS_trace_file) ;
...
const C_galgas_type_descriptor * GGS_trace_file::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_trace ("trace", true, NULL) ;
...
C_galgasRootClassRunTimeInformation gClassInfoFor__trace ("trace", & kTypeDescriptor_GGS_trace) ;
...
const C_galgas_type_descriptor * GGS_trace::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_trace_off ("trace_off", true, & kTypeDescriptor_GGS_trace) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__trace_off ("trace_off", gClassInfoFor__trace, & kTypeDescriptor_GGS_trace_off) ;
...
const C_galgas_type_descriptor * GGS_trace_off::typeDescriptor (void) const {
...
method_generate_c (C_Compiler & inLexique,
  ...
  const GGS_trace_method  temp_2254 = meth ;
  if (temp_2254.isBuilt ()) {
    temp_2254 (HERE)->method_generate_c (inLexique, var_cas_m COMMA_SOURCE_FILE_AT_LINE (85)) ;
  }
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_trace_on ("trace_on", true, & kTypeDescriptor_GGS_trace) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__trace_on ("trace_on", gClassInfoFor__trace, & kTypeDescriptor_GGS_trace_on) ;
...
const C_galgas_type_descriptor * GGS_trace_on::typeDescriptor (void) const {
...
void routine_set_method (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_trace_method _var_2896 = var_cas_t ; // CAST instruction
    if (_var_2896.getPtr () != NULL) {
      macroValidPointer (_var_2896.getPtr ()) ;
      if (typeid (cPtr_trace_void) == typeid (* (_var_2896.getPtr ()))) {
        var_cas_t = var_cas_s ;
      }else{
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidPointerThere (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_no_linker *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
...
AC_galgasClassRunTimeInformation * cPtr_no_linker::galgasRTTI (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_no_linker ("no_linker", true, & kTypeDescriptor_GGS_basic_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__no_linker ("no_linker", gClassInfoFor__basic_type, & kTypeDescriptor_GGS_no_linker) ;
...
const C_galgas_type_descriptor * GGS_no_linker::typeDescriptor (void) const {
...
AC_galgasClassRunTimeInformation * cPtr_yes_linker::galgasRTTI (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_yes_linker ("yes_linker", true, & kTypeDescriptor_GGS_basic_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__yes_linker ("yes_linker", gClassInfoFor__basic_type, & kTypeDescriptor_GGS_yes_linker) ;
...
const C_galgas_type_descriptor * GGS_yes_linker::typeDescriptor (void) const {
...
void routine_set_linker (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_3276 = var_cas_l ; // CAST instruction
    if (_var_3276.getPtr () != NULL) {
      macroValidPointer (_var_3276.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_3276.getPtr ()))) {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_memmap_false ("memmap_false", true, & kTypeDescriptor_GGS_basic_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__memmap_false ("memmap_false", gClassInfoFor__basic_type, & kTypeDescriptor_GGS_memmap_false) ;
...
const C_galgas_type_descriptor * GGS_memmap_false::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_memmap_true ("memmap_true", true, & kTypeDescriptor_GGS_basic_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__memmap_true ("memmap_true", gClassInfoFor__basic_type, & kTypeDescriptor_GGS_memmap_true) ;
...
const C_galgas_type_descriptor * GGS_memmap_true::typeDescriptor (void) const {
...
GGS_string function_link_script_name (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_3761 = var_cas_mm ; // CAST instruction
    if (_var_3761.getPtr () != NULL) {
      macroValidPointer (_var_3761.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_3761.getPtr ()))) {
        const GGS_memmap_true var_cas_m (_var_3761.getPtr ()) ;
        { const GGS_basic_type _var_3686 = var_cas_m.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (152)) ; // CAST instruction
          if (_var_3686.getPtr () != NULL) {
            macroValidPointer (_var_3686.getPtr ()) ;
            if (typeid (cPtr_yes_linker) == typeid (* (_var_3686.getPtr ()))) {
              const GGS_yes_linker var_cas_l (_var_3686.getPtr ()) ;
              var_cas_name = var_cas_l.reader_script (inLexique COMMA_SOURCE_FILE_AT_LINE (154)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (154)) ;
            }else{
...
void routine_set_memmap (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_4016 = var_cas_m ; // CAST instruction
    if (_var_4016.getPtr () != NULL) {
      macroValidPointer (_var_4016.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_4016.getPtr ()))) {
        var_cas_m = var_cas_nm ;
      }else{
        var_cas_nm.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (173)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("Redefinition of ")).operator_concat (var_cas_att) COMMA_SOURCE_FILE_AT_LINE (174)) ;
        var_cas_m.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (174)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (175)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_os_obj ("os_obj", true, & kTypeDescriptor_GGS_oil_obj) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__os_obj ("os_obj", gClassInfoFor__oil_obj, & kTypeDescriptor_GGS_os_obj) ;
...
const C_galgas_type_descriptor * GGS_os_obj::typeDescriptor (void) const {
...
GGS_basic_type  function_memory_protection (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_5551 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (210)) ; // CAST instruction
    if (_var_5551.getPtr () != NULL) {
      macroValidPointer (_var_5551.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_5551.getPtr ()))) {
        const GGS_memmap_true var_cas_mm (_var_5551.getPtr ()) ;
        var_cas_mp = var_cas_mm.reader_memory_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (212)) ;
      }else{
...
GGS_bool function_memory_protection_on (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_mp ;
  { const GGS_basic_type _var_5833 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ; // CAST instruction
    if (_var_5833.getPtr () != NULL) {
      macroValidPointer (_var_5833.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_5833.getPtr ()))) {
        const GGS_memmap_true var_cas_mm (_var_5833.getPtr ()) ;
        { const GGS_basic_type _var_5797 = var_cas_mm.reader_memory_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (224)) ; // CAST instruction
          if (_var_5797.getPtr () != NULL) {
            macroValidPointer (_var_5797.getPtr ()) ;
            if (typeid (cPtr_bool_class) == typeid (* (_var_5797.getPtr ()))) {
              const GGS_bool_class var_cas_b (_var_5797.getPtr ()) ;
              var_cas_mp = var_cas_b.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (226)) ;
            }else{
...
GGS_bool function_memory_mapping (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_mm ;
  { const GGS_basic_type _var_6000 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (239)) ; // CAST instruction
    if (_var_6000.getPtr () != NULL) {
      macroValidPointer (_var_6000.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6000.getPtr ()))) {
...
GGS_string function_compiler (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_6281 = var_cas_os_memmap ; // CAST instruction
    if (_var_6281.getPtr () != NULL) {
      macroValidPointer (_var_6281.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6281.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_6281.getPtr ()) ;
        var_cas_cc = var_cas_s.reader_compiler (inLexique COMMA_SOURCE_FILE_AT_LINE (256)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (256)) ;
      }else{
        var_cas_cc = GGS_string ("") ;
      }
    }
  }
  const GGS_bool cond_6551 = (var_cas_cc).operator_isNotEqual (GGS_string ("")) ;
  if (cond_6551.isBuiltAndTrue ()) {
    var_cas_cc = (GGS_string ("compiler/")).operator_concat (var_cas_cc) ;
    GGS_string var_cas_rtd = function_root_templates_directory (inLexique COMMA_SOURCE_FILE_AT_LINE (261)) ;
    const GGS_bool cond_6517 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
    if (cond_6517.isBuiltAndTrue ()) {
      GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_cc) ;
      const GGS_bool cond_6504 = (var_cas_path.reader_directoryExists ()).operator_not () ;
      if (cond_6504.isBuiltAndTrue ()) {
        var_cas_cc = GGS_string ("") ;
      }
    }else if (cond_6517.isBuiltAndFalse ()) {
      var_cas_cc = GGS_string ("") ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_string function_linker (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_6949 = var_cas_os_memmap ; // CAST instruction
    if (_var_6949.getPtr () != NULL) {
      macroValidPointer (_var_6949.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6949.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_6949.getPtr ()) ;
        { const GGS_basic_type _var_6920 = var_cas_s.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (283)) ; // CAST instruction
          if (_var_6920.getPtr () != NULL) {
            macroValidPointer (_var_6920.getPtr ()) ;
            if (typeid (cPtr_no_linker) == typeid (* (_var_6920.getPtr ()))) {
              var_cas_lk = GGS_string ("") ;
            }else if (typeid (cPtr_yes_linker) == typeid (* (_var_6920.getPtr ()))) {
              const GGS_yes_linker var_cas_l (_var_6920.getPtr ()) ;
              var_cas_lk = var_cas_l.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (285)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (285)) ;
            }else{
              var_cas_lk = GGS_string ("") ;
            }
          }
  ...
  const GGS_bool cond_7217 = (var_cas_lk).operator_isNotEqual (GGS_string ("")) ;
  if (cond_7217.isBuiltAndTrue ()) {
    var_cas_lk = (GGS_string ("linker/")).operator_concat (var_cas_lk) ;
    GGS_string var_cas_rtd = function_root_templates_directory (inLexique COMMA_SOURCE_FILE_AT_LINE (293)) ;
    const GGS_bool cond_7183 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
    if (cond_7183.isBuiltAndTrue ()) {
      GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_lk) ;
      const GGS_bool cond_7170 = (var_cas_path.reader_directoryExists ()).operator_not () ;
      if (cond_7170.isBuiltAndTrue ()) {
        var_cas_lk = GGS_string ("") ;
      }
    }else if (cond_7183.isBuiltAndFalse ()) {
      var_cas_lk = GGS_string ("") ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
const C_galgas_function_descriptor kFunction_descriptor_void_os_obj ("void_os_obj",
