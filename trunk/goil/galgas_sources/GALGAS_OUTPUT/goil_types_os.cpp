...
void routine_set_method (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_trace_method _var_2930 = var_cas_t ; // CAST instruction
    if (_var_2930.getPtr () != NULL) {
      macroValidPointer (_var_2930.getPtr ()) ;
      if (typeid (cPtr_trace_void) == typeid (* (_var_2930.getPtr ()))) {
        var_cas_t = var_cas_s ;
      }else{
...
void routine_set_linker (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_3310 = var_cas_l ; // CAST instruction
...
GGS_string function_link_script_name (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_3820 = var_cas_mm ; // CAST instruction
    if (_var_3820.getPtr () != NULL) {
      macroValidPointer (_var_3820.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_3820.getPtr ()))) {
        const GGS_memmap_true var_cas_m (_var_3820.getPtr ()) ;
        { const GGS_basic_type _var_3745 = var_cas_m.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (153)) ; // CAST instruction
          if (_var_3745.getPtr () != NULL) {
            macroValidPointer (_var_3745.getPtr ()) ;
            if (typeid (cPtr_yes_linker) == typeid (* (_var_3745.getPtr ()))) {
              const GGS_yes_linker var_cas_l (_var_3745.getPtr ()) ;
...
void routine_set_memmap (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_4075 = var_cas_m ; // CAST instruction
    if (_var_4075.getPtr () != NULL) {
      macroValidPointer (_var_4075.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_4075.getPtr ()))) {
...
GGS_lstring  function_applicationName (C_Compiler & inLexique,
  ...
  var_cas_name = var_cas_os.reader_app_name (inLexique COMMA_SOURCE_FILE_AT_LINE (208)) ;
  const GGS_bool cond_5568 = (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (209))).operator_isEqual (GGS_string ("")) ;
  if (cond_5568.isBuiltAndTrue ()) {
    var_cas_name = function_lstringWith (inLexique, GGS_string ("trampoline") COMMA_SOURCE_FILE_AT_LINE (210)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_basic_type  function_memory_protection (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_5786 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (218)) ; // CAST instruction
    if (_var_5786.getPtr () != NULL) {
      macroValidPointer (_var_5786.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_5786.getPtr ()))) {
        const GGS_memmap_true var_cas_mm (_var_5786.getPtr ()) ;
        var_cas_mp = var_cas_mm.reader_memory_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
      }else{
...
GGS_bool function_memory_protection_on (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_mp ;
  { const GGS_basic_type _var_6068 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (230)) ; // CAST instruction
    if (_var_6068.getPtr () != NULL) {
      macroValidPointer (_var_6068.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6068.getPtr ()))) {
        const GGS_memmap_true var_cas_mm (_var_6068.getPtr ()) ;
        { const GGS_basic_type _var_6032 = var_cas_mm.reader_memory_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (232)) ; // CAST instruction
          if (_var_6032.getPtr () != NULL) {
            macroValidPointer (_var_6032.getPtr ()) ;
            if (typeid (cPtr_bool_class) == typeid (* (_var_6032.getPtr ()))) {
              const GGS_bool_class var_cas_b (_var_6032.getPtr ()) ;
              var_cas_mp = var_cas_b.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (234)) ;
            }else{
...
GGS_bool function_memory_mapping (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_mm ;
  { const GGS_basic_type _var_6235 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (247)) ; // CAST instruction
    if (_var_6235.getPtr () != NULL) {
      macroValidPointer (_var_6235.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6235.getPtr ()))) {
...
GGS_string function_compiler (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_6815 = var_cas_os_memmap ; // CAST instruction
    if (_var_6815.getPtr () != NULL) {
      macroValidPointer (_var_6815.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6815.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_6815.getPtr ()) ;
        var_cas_cc = var_cas_s.reader_compiler (inLexique COMMA_SOURCE_FILE_AT_LINE (265)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265)) ;
        var_cas_cc = (GGS_string ("compiler/")).operator_concat (var_cas_cc) ;
        GGS_string var_cas_rtd = function_rootTemplatesDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (267)) ;
        const GGS_bool cond_6764 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
        if (cond_6764.isBuiltAndTrue ()) {
          GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_cc) ;
          const GGS_bool cond_6751 = (var_cas_path.reader_directoryExists ()).operator_not () ;
          if (cond_6751.isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, (GGS_string ("no compiler found at path: ")).operator_concat (var_cas_path) COMMA_SOURCE_FILE_AT_LINE (271)) ;
            var_cas_cc = GGS_string ("") ;
          }
        }else if (cond_6764.isBuiltAndFalse ()) {
          var_cas_cc = GGS_string ("") ;
        }
      }else{
        var_cas_cc = GGS_string ("") ;
...
GGS_string function_linker (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_7215 = var_cas_os_memmap ; // CAST instruction
    if (_var_7215.getPtr () != NULL) {
      macroValidPointer (_var_7215.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_7215.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_7215.getPtr ()) ;
        { const GGS_basic_type _var_7186 = var_cas_s.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (291)) ; // CAST instruction
          if (_var_7186.getPtr () != NULL) {
            macroValidPointer (_var_7186.getPtr ()) ;
            if (typeid (cPtr_no_linker) == typeid (* (_var_7186.getPtr ()))) {
              var_cas_lk = GGS_string ("") ;
            }else if (typeid (cPtr_yes_linker) == typeid (* (_var_7186.getPtr ()))) {
              const GGS_yes_linker var_cas_l (_var_7186.getPtr ()) ;
              var_cas_lk = var_cas_l.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (293)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (293)) ;
            }else{
              var_cas_lk = GGS_string ("") ;
            }
          }
  ...
  const GGS_bool cond_7481 = (var_cas_lk).operator_isNotEqual (GGS_string ("")) ;
  if (cond_7481.isBuiltAndTrue ()) {
    var_cas_lk = (GGS_string ("linker/")).operator_concat (var_cas_lk) ;
    GGS_string var_cas_rtd = function_rootTemplatesDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (301)) ;
    const GGS_bool cond_7447 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
    if (cond_7447.isBuiltAndTrue ()) {
      GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_lk) ;
      const GGS_bool cond_7434 = (var_cas_path.reader_directoryExists ()).operator_not () ;
      if (cond_7434.isBuiltAndTrue ()) {
        var_cas_lk = GGS_string ("") ;
      }
    }else if (cond_7447.isBuiltAndFalse ()) {
      var_cas_lk = GGS_string ("") ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
