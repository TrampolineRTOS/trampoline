...
void routine_set_memmap (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_3316 = var_cas_m ; // CAST instruction
    if (_var_3316.getPtr () != NULL) {
      macroValidPointer (_var_3316.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_3316.getPtr ()))) {
...
GGS_basic_type  function_memory_protection (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_4851 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (172)) ; // CAST instruction
    if (_var_4851.getPtr () != NULL) {
      macroValidPointer (_var_4851.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_4851.getPtr ()))) {
        const GGS_memmap_true var_cas_mm (_var_4851.getPtr ()) ;
...
GGS_bool function_memory_protection_on (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_mp ;
  { const GGS_basic_type _var_5133 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (184)) ; // CAST instruction
    if (_var_5133.getPtr () != NULL) {
      macroValidPointer (_var_5133.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_5133.getPtr ()))) {
        const GGS_memmap_true var_cas_mm (_var_5133.getPtr ()) ;
        { const GGS_basic_type _var_5097 = var_cas_mm.reader_memory_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (186)) ; // CAST instruction
          if (_var_5097.getPtr () != NULL) {
            macroValidPointer (_var_5097.getPtr ()) ;
            if (typeid (cPtr_bool_class) == typeid (* (_var_5097.getPtr ()))) {
              const GGS_bool_class var_cas_b (_var_5097.getPtr ()) ;
...
GGS_bool function_memory_mapping (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_mm ;
  { const GGS_basic_type _var_5300 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ; // CAST instruction
    if (_var_5300.getPtr () != NULL) {
      macroValidPointer (_var_5300.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_5300.getPtr ()))) {
...
GGS_string function_compiler (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_5581 = var_cas_os_memmap ; // CAST instruction
    if (_var_5581.getPtr () != NULL) {
      macroValidPointer (_var_5581.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_5581.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_5581.getPtr ()) ;
  ...
  const GGS_bool cond_5851 = (var_cas_cc).operator_isNotEqual (GGS_string ("")) ;
  if (cond_5851.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_5817 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
    if (cond_5817.isBuiltAndTrue ()) {
      GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_cc) ;
      const GGS_bool cond_5804 = (var_cas_path.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (226))).operator_not () ;
      if (cond_5804.isBuiltAndTrue ()) {
        var_cas_cc = GGS_string ("") ;
      }
    }else if (cond_5817.isBuiltAndFalse ()) {
      var_cas_cc = GGS_string ("") ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_string function_linker (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_6122 = var_cas_os_memmap ; // CAST instruction
    if (_var_6122.getPtr () != NULL) {
      macroValidPointer (_var_6122.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6122.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_6122.getPtr ()) ;
  ...
  const GGS_bool cond_6390 = (var_cas_lk).operator_isNotEqual (GGS_string ("")) ;
  if (cond_6390.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_6356 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
    if (cond_6356.isBuiltAndTrue ()) {
      GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_lk) ;
      const GGS_bool cond_6343 = (var_cas_path.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (252))).operator_not () ;
      if (cond_6343.isBuiltAndTrue ()) {
        var_cas_lk = GGS_string ("") ;
      }
    }else if (cond_6356.isBuiltAndFalse ()) {
      var_cas_lk = GGS_string ("") ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
