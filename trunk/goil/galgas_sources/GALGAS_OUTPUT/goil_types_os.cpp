...
GGS_string function_link_script_name (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_3813 = var_cas_mm ; // CAST instruction
    if (_var_3813.getPtr () != NULL) {
      macroValidPointer (_var_3813.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_3813.getPtr ()))) {
        const GGS_memmap_true var_cas_m (_var_3813.getPtr ()) ;
        { const GGS_basic_type _var_3738 = var_cas_m.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (152)) ; // CAST instruction
          if (_var_3738.getPtr () != NULL) {
            macroValidPointer (_var_3738.getPtr ()) ;
            if (typeid (cPtr_yes_linker) == typeid (* (_var_3738.getPtr ()))) {
              const GGS_yes_linker var_cas_l (_var_3738.getPtr ()) ;
              ...
              var_cas_m.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (156)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("No script file defined") COMMA_SOURCE_FILE_AT_LINE (157)) ;
...
void routine_set_memmap (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_4068 = var_cas_m ; // CAST instruction
    if (_var_4068.getPtr () != NULL) {
      macroValidPointer (_var_4068.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_4068.getPtr ()))) {
...
GGS_basic_type  function_memory_protection (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_5603 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (211)) ; // CAST instruction
    if (_var_5603.getPtr () != NULL) {
      macroValidPointer (_var_5603.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_5603.getPtr ()))) {
        const GGS_memmap_true var_cas_mm (_var_5603.getPtr ()) ;
        var_cas_mp = var_cas_mm.reader_memory_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (213)) ;
      }else{
...
GGS_bool function_memory_protection_on (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_mp ;
  { const GGS_basic_type _var_5885 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (223)) ; // CAST instruction
    if (_var_5885.getPtr () != NULL) {
      macroValidPointer (_var_5885.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_5885.getPtr ()))) {
        const GGS_memmap_true var_cas_mm (_var_5885.getPtr ()) ;
        { const GGS_basic_type _var_5849 = var_cas_mm.reader_memory_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ; // CAST instruction
          if (_var_5849.getPtr () != NULL) {
            macroValidPointer (_var_5849.getPtr ()) ;
            if (typeid (cPtr_bool_class) == typeid (* (_var_5849.getPtr ()))) {
              const GGS_bool_class var_cas_b (_var_5849.getPtr ()) ;
              var_cas_mp = var_cas_b.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (227)) ;
            }else{
...
GGS_bool function_memory_mapping (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_mm ;
  { const GGS_basic_type _var_6052 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (240)) ; // CAST instruction
    if (_var_6052.getPtr () != NULL) {
      macroValidPointer (_var_6052.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6052.getPtr ()))) {
...
GGS_string function_compiler (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_6333 = var_cas_os_memmap ; // CAST instruction
    if (_var_6333.getPtr () != NULL) {
      macroValidPointer (_var_6333.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6333.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_6333.getPtr ()) ;
  ...
  const GGS_bool cond_6603 = (var_cas_cc).operator_isNotEqual (GGS_string ("")) ;
  if (cond_6603.isBuiltAndTrue ()) {
    var_cas_cc = (GGS_string ("compiler/")).operator_concat (var_cas_cc) ;
    GGS_string var_cas_rtd = function_root_templates_directory (inLexique COMMA_SOURCE_FILE_AT_LINE (262)) ;
    const GGS_bool cond_6569 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
    if (cond_6569.isBuiltAndTrue ()) {
      GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_cc) ;
      const GGS_bool cond_6556 = (var_cas_path.reader_directoryExists ()).operator_not () ;
      if (cond_6556.isBuiltAndTrue ()) {
        var_cas_cc = GGS_string ("") ;
      }
    }else if (cond_6569.isBuiltAndFalse ()) {
      var_cas_cc = GGS_string ("") ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_string function_linker (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_7001 = var_cas_os_memmap ; // CAST instruction
    if (_var_7001.getPtr () != NULL) {
      macroValidPointer (_var_7001.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_7001.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_7001.getPtr ()) ;
        { const GGS_basic_type _var_6972 = var_cas_s.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (284)) ; // CAST instruction
          if (_var_6972.getPtr () != NULL) {
            macroValidPointer (_var_6972.getPtr ()) ;
            if (typeid (cPtr_no_linker) == typeid (* (_var_6972.getPtr ()))) {
              var_cas_lk = GGS_string ("") ;
            }else if (typeid (cPtr_yes_linker) == typeid (* (_var_6972.getPtr ()))) {
              const GGS_yes_linker var_cas_l (_var_6972.getPtr ()) ;
              var_cas_lk = var_cas_l.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (286)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (286)) ;
            }else{
              var_cas_lk = GGS_string ("") ;
            }
          }
  ...
  const GGS_bool cond_7269 = (var_cas_lk).operator_isNotEqual (GGS_string ("")) ;
  if (cond_7269.isBuiltAndTrue ()) {
    var_cas_lk = (GGS_string ("linker/")).operator_concat (var_cas_lk) ;
    GGS_string var_cas_rtd = function_root_templates_directory (inLexique COMMA_SOURCE_FILE_AT_LINE (294)) ;
    const GGS_bool cond_7235 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
    if (cond_7235.isBuiltAndTrue ()) {
      GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_lk) ;
      const GGS_bool cond_7222 = (var_cas_path.reader_directoryExists ()).operator_not () ;
      if (cond_7222.isBuiltAndTrue ()) {
        var_cas_lk = GGS_string ("") ;
      }
    }else if (cond_7235.isBuiltAndFalse ()) {
      var_cas_lk = GGS_string ("") ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
