...
C_galgasClassRunTimeInformation gClassInfoFor__no_linker ("no_linker", gClassInfoFor__basic_type) ;
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@yes_linker:"
           ...
           << script.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
C_galgasClassRunTimeInformation gClassInfoFor__yes_linker ("yes_linker", gClassInfoFor__basic_type) ;
...
GGS_string function_link_script_name (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_3812 = var_cas_mm ; // CAST instruction
    if (_var_3812.getPtr () != NULL) {
      macroValidPointer (_var_3812.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_3812.getPtr ()))) {
        const GGS_memmap_true var_cas_m (_var_3812.getPtr ()) ;
        ...
        var_cas_mm.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (160)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("No MEMMAP") COMMA_SOURCE_FILE_AT_LINE (161)) ;
        var_cas_name = GGS_string ("") ;
      }
    }
  }
...
void routine_set_memmap (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_4067 = var_cas_m ; // CAST instruction
    if (_var_4067.getPtr () != NULL) {
      macroValidPointer (_var_4067.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_4067.getPtr ()))) {
...
GGS_basic_type  function_memory_protection (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_5602 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (211)) ; // CAST instruction
    if (_var_5602.getPtr () != NULL) {
      macroValidPointer (_var_5602.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_5602.getPtr ()))) {
        const GGS_memmap_true var_cas_mm (_var_5602.getPtr ()) ;
...
GGS_bool function_memory_protection_on (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_mp ;
  { const GGS_basic_type _var_5884 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (223)) ; // CAST instruction
    if (_var_5884.getPtr () != NULL) {
      macroValidPointer (_var_5884.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_5884.getPtr ()))) {
        const GGS_memmap_true var_cas_mm (_var_5884.getPtr ()) ;
        { const GGS_basic_type _var_5848 = var_cas_mm.reader_memory_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (225)) ; // CAST instruction
          if (_var_5848.getPtr () != NULL) {
            macroValidPointer (_var_5848.getPtr ()) ;
            if (typeid (cPtr_bool_class) == typeid (* (_var_5848.getPtr ()))) {
              const GGS_bool_class var_cas_b (_var_5848.getPtr ()) ;
...
GGS_bool function_memory_mapping (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_mm ;
  { const GGS_basic_type _var_6051 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (240)) ; // CAST instruction
    if (_var_6051.getPtr () != NULL) {
      macroValidPointer (_var_6051.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6051.getPtr ()))) {
...
GGS_string function_compiler (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_6332 = var_cas_os_memmap ; // CAST instruction
    if (_var_6332.getPtr () != NULL) {
      macroValidPointer (_var_6332.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6332.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_6332.getPtr ()) ;
  ...
  const GGS_bool cond_6602 = (var_cas_cc).operator_isNotEqual (GGS_string ("")) ;
  if (cond_6602.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_6568 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
    if (cond_6568.isBuiltAndTrue ()) {
      GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_cc) ;
      const GGS_bool cond_6555 = (var_cas_path.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (265))).operator_not () ;
      if (cond_6555.isBuiltAndTrue ()) {
        var_cas_cc = GGS_string ("") ;
      }
    }else if (cond_6568.isBuiltAndFalse ()) {
      var_cas_cc = GGS_string ("") ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_string function_linker (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_7000 = var_cas_os_memmap ; // CAST instruction
    if (_var_7000.getPtr () != NULL) {
      macroValidPointer (_var_7000.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_7000.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_7000.getPtr ()) ;
        { const GGS_basic_type _var_6971 = var_cas_s.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (284)) ; // CAST instruction
          if (_var_6971.getPtr () != NULL) {
            macroValidPointer (_var_6971.getPtr ()) ;
            if (typeid (cPtr_no_linker) == typeid (* (_var_6971.getPtr ()))) {
              var_cas_lk = GGS_string ("") ;
            }else if (typeid (cPtr_yes_linker) == typeid (* (_var_6971.getPtr ()))) {
              const GGS_yes_linker var_cas_l (_var_6971.getPtr ()) ;
  ...
  const GGS_bool cond_7268 = (var_cas_lk).operator_isNotEqual (GGS_string ("")) ;
  if (cond_7268.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_7234 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
    if (cond_7234.isBuiltAndTrue ()) {
      GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_lk) ;
      const GGS_bool cond_7221 = (var_cas_path.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (297))).operator_not () ;
      if (cond_7221.isBuiltAndTrue ()) {
        var_cas_lk = GGS_string ("") ;
      }
    }else if (cond_7234.isBuiltAndFalse ()) {
      var_cas_lk = GGS_string ("") ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
