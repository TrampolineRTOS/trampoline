...
method_generate_c (C_Compiler & _inLexique,
  ...
  var_cas_res._dotAssign_operation (function_bool_define (_inLexique, GGS_string (true, "TRACE_TASK"), trace_task, GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (77))) ;
  var_cas_res._dotAssign_operation (function_bool_define (_inLexique, GGS_string (true, "TRACE_ISR"), trace_isr, GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (78))) ;
  var_cas_res._dotAssign_operation (function_bool_define (_inLexique, GGS_string (true, "TRACE_RES"), trace_resource, GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (79))) ;
  var_cas_res._dotAssign_operation (function_bool_define (_inLexique, GGS_string (true, "TRACE_ALARM"), trace_alarm, GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (80))) ;
  var_cas_res._dotAssign_operation (function_bool_define (_inLexique, GGS_string (true, "TRACE_U_EVENT"), trace_user_event, GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (81))) ;
  ...
  const GGS_trace_method  _temp_2192 = meth ;
  if (_temp_2192._isBuilt ()) {
    _temp_2192 (HERE)->method_generate_c (_inLexique, var_cas_m COMMA_SOURCE_FILE_AT_LINE (84)) ;
  }
...
void routine_set_method (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_trace_method _var_3508 = var_cas_t ; // CAST instruction
    if (_var_3508.getPtr () != NULL) {
      macroValidPointer (_var_3508.getPtr ()) ;
      if (typeid (cPtr_trace_void) == typeid (* (_var_3508.getPtr ()))) {
        var_cas_t = var_cas_s ;
      }else{
