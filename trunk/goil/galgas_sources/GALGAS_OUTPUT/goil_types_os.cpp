...
method_generate_c (C_Compiler & _inLexique,
  ...
  var_cas_res.appendCstring ("#define    TRACE_BEGIN()          tpl_trace_begin_") ;
  var_cas_res._dotAssign_operation (form.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (71))) ;
  var_cas_res.appendCstring ("();\n") ;
  var_cas_res.appendCstring ("#define    TRACE_END()            tpl_trace_end_") ;
  var_cas_res._dotAssign_operation (form.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (72))) ;
  var_cas_res.appendCstring ("();\n") ;
  var_cas_res.appendCstring ("#define    TRACE_EVENT_BEGIN(a,b) tpl_trace_event_begin_") ;
  var_cas_res._dotAssign_operation (form.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (73))) ;
  var_cas_res.appendCstring ("(a,b);\n") ;
  var_cas_res.appendCstring ("#define    TRACE_EVENT_END()      tpl_trace_event_end_") ;
  var_cas_res._dotAssign_operation (form.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (74))) ;
  var_cas_res.appendCstring ("();\n") ;
  var_cas_res.appendCstring ("#define    TRACE_VALUE(a)         tpl_trace_value_") ;
  var_cas_res._dotAssign_operation (form.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (75))) ;
  var_cas_res.appendCstring ("(a);\n") ;
  GGS_string var_cas_m ;
  const GGS_trace_method  _temp_2053 = meth ;
  if (_temp_2053._isBuilt ()) {
    _temp_2053 (HERE)->method_generate_c (_inLexique, var_cas_m COMMA_SOURCE_FILE_AT_LINE (77)) ;
  }
...
void routine_set_method (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_trace_method _var_3369 = var_cas_t ; // CAST instruction
    if (_var_3369.getPtr () != NULL) {
      macroValidPointer (_var_3369.getPtr ()) ;
      if (typeid (cPtr_trace_void) == typeid (* (_var_3369.getPtr ()))) {
        var_cas_t = var_cas_s ;
      }else{
        var_cas_s.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (128)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "Redefinition of "))._operator_concat (var_cas_att) COMMA_SOURCE_FILE_AT_LINE (129)) ;
        var_cas_t.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (129)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "was defined here") COMMA_SOURCE_FILE_AT_LINE (130)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
