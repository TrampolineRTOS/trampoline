...
GGS_string function_compiler (C_Compiler & inLexique,
  ...
  const GGS_bool cond_5845 = (var_cas_cc).operator_isNotEqual (GGS_string ("")) ;
  if (cond_5845.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_5811 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
    if (cond_5811.isBuiltAndTrue ()) {
      GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_cc) ;
      const GGS_bool cond_5798 = (var_cas_path.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (226))).operator_not () ;
      if (cond_5798.isBuiltAndTrue ()) {
        var_cas_cc = GGS_string ("") ;
      }
    }else if (cond_5811.isBuiltAndFalse ()) {
      var_cas_cc = GGS_string ("") ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_string function_linker (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_6116 = var_cas_os_memmap ; // CAST instruction
    if (_var_6116.getPtr () != NULL) {
      macroValidPointer (_var_6116.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6116.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_6116.getPtr ()) ;
  ...
  const GGS_bool cond_6384 = (var_cas_lk).operator_isNotEqual (GGS_string ("")) ;
  if (cond_6384.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_6350 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
    if (cond_6350.isBuiltAndTrue ()) {
      GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_lk) ;
      const GGS_bool cond_6337 = (var_cas_path.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (252))).operator_not () ;
      if (cond_6337.isBuiltAndTrue ()) {
        var_cas_lk = GGS_string ("") ;
      }
    }else if (cond_6350.isBuiltAndFalse ()) {
      var_cas_lk = GGS_string ("") ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
