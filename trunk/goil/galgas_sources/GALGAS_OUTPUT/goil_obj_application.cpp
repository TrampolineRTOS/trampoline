...
pr_appli_goil_obj_application_41_12_ (goil_lexique & inLexique,
  ...
  if (((GGS_bool (inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (50)))).operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_goil_obj_application_0 (inLexique)) {
        ...
        case 6 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_HAS_5FRESTARTTASK) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          switch (select_goil_obj_application_5 (inLexique)) {
            case 1 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
              inLexique._assignFromAttribute_att_token (var_cas_res_task) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
        ...
        case 7 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          inLexique._assignFromAttribute_att_token (var_cas_task) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
        ...
        case 8 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          inLexique._assignFromAttribute_att_token (var_cas_isr) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
        ...
        case 9 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          inLexique._assignFromAttribute_att_token (var_cas_alarm) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
        ...
        case 10 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          inLexique._assignFromAttribute_att_token (var_cas_st) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
        ...
        case 11 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          inLexique._assignFromAttribute_att_token (var_cas_ct) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
        ...
        case 13 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          inLexique._assignFromAttribute_att_token (var_cas_mes) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
        ...
        while (syntaxRepeat_7) {
          switch (select_repeat_goil_obj_application_7 (inLexique)) {
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_TRUSTED_5FFUNCTION) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
              GGS_bool var_cas_tfok ;
              var_cas_tfok = GGS_bool (false) ;
              switch (select_goil_obj_application_8 (inLexique)) {
                case 1 : {
                  inLexique._assignFromAttribute_att_token (var_cas_f_name) ;
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                ...
                case 2 : {
                  ...
                  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
                  inLexique._assignFromAttribute_a_string (var_cas_f_name) ;
