...
pr_appli_goil_obj_application_41_12_ (goil_lexique & _inLexique,
  ...
  if (((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (50))))._operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("AUTOSAR flag is off, turn it on to use APPLICATION objects") COMMA_SOURCE_FILE_AT_LINE (52)) ;
  }
      ...
      switch (select_repeat_goil_obj_application_0 (_inLexique)) {
          ...
          { const GGS_app_trusted_obj _var_3164 = var_cas_trusted ; // CAST instruction
            if (_var_3164.getPtr () != NULL) {
              ...
              if (typeid (cPtr_app_trusted_void) == typeid (* (_var_3164.getPtr ()))) {
                ...
                var_cas_trust.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (116)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("TRUSTED attribute already defined for Application "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (116))) COMMA_SOURCE_FILE_AT_LINE (117)) ;
                var_cas_trusted.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (117)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Was previously define here") COMMA_SOURCE_FILE_AT_LINE (118)) ;
              }
            }
          }
          } break ;
          ...
          { const GGS_basic_type _var_3636 = var_cas_startuphook ; // CAST instruction
            if (_var_3636.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void) == typeid (* (_var_3636.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("STARTUPHOOK attribute already defined for Application "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (130))) COMMA_SOURCE_FILE_AT_LINE (131)) ;
                var_cas_startuphook.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (131)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Was previously define here") COMMA_SOURCE_FILE_AT_LINE (132)) ;
              }
            }
          }
          ...
          { const GGS_basic_type _var_4145 = var_cas_shutdownhook ; // CAST instruction
            if (_var_4145.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void) == typeid (* (_var_4145.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("SHUTDOWNHOOK attribute already defined for Application "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (145))) COMMA_SOURCE_FILE_AT_LINE (146)) ;
                var_cas_shutdownhook.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (146)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Was previously define here") COMMA_SOURCE_FILE_AT_LINE (147)) ;
              }
            }
          }
          ...
          { const GGS_basic_type _var_4640 = var_cas_errorhook ; // CAST instruction
            if (_var_4640.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void) == typeid (* (_var_4640.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("ERRORHOOK attribute already defined for Application "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (160))) COMMA_SOURCE_FILE_AT_LINE (161)) ;
                var_cas_errorhook.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (161)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Was previously define here") COMMA_SOURCE_FILE_AT_LINE (162)) ;
              }
            }
          }
        ...
        case 6 : {
          ...
          switch (select_goil_obj_application_5 (_inLexique)) {
            ...
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_FALSE) COMMA_HERE) ;
              var_cas_hr = GGS_bool_class ::constructor_new (_inLexique, GGS_location (_inLexique), GGS_bool (false) COMMA_HERE) ;
              } break ;
            default :
              break ;
          }
          { const GGS_basic_type _var_5297 = var_cas_restart ; // CAST instruction
            if (_var_5297.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void) == typeid (* (_var_5297.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("RESTARTTASK attribute already defined for Application "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (178))) COMMA_SOURCE_FILE_AT_LINE (179)) ;
                var_cas_restart.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (179)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Was previously define here") COMMA_SOURCE_FILE_AT_LINE (180)) ;
              }
            }
          }
        ...
        while (syntaxRepeat_7) {
          switch (select_repeat_goil_obj_application_7 (_inLexique)) {
            case 2 : {
              ...
              var_cas_f_name = GGS_lstring ::constructor_new (_inLexique, GGS_string (""), GGS_location (_inLexique) COMMA_HERE) ;
              ...
              switch (select_goil_obj_application_8 (_inLexique)) {
                case 1 : {
                ...
                case 2 : {
                  ...
                  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
                  _inLexique._assignFromAttribute_a_string (var_cas_f_name) ;
              ...
              if ((var_cas_tfok).isBuiltAndTrue ()) {
                var_cas_t_funcs._addAssign_operation (var_cas_f_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (257))) ;
              }
              } break ;
            default :
