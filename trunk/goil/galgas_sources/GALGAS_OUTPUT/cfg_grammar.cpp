...
pr_cfg_attrs_cfg_syntax_109_16_ (inLexique, parameter_1) ;
}
...
pr_cfg_start_cfg_syntax_35_16_ (inLexique, parameter_1) ;
}
...
pr_interrupts_cfg_syntax_121_17_ (inLexique, parameter_1) ;
}
...
sint16 cfg_grammar::select_repeat_cfg_syntax_0 (cfg_lexique & inLexique) {
...
sint16 cfg_grammar::select_repeat_cfg_syntax_1 (cfg_lexique & inLexique) {
  return inLexique.nextProductionIndex () ;
}
...
sint16 cfg_grammar::select_repeat_cfg_syntax_2 (cfg_lexique & inLexique) {
  return inLexique.nextProductionIndex () ;
}
