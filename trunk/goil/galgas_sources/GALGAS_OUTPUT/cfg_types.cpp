...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_config ("config", false, NULL) ;
...
GGS_object GGS_config::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_config * p = NULL ;
    macroMyNew (p, GGS_config (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_config GGS_config::castFromObject (C_Compiler & inLexique,
  ...
  if (NULL != embeddedObject) {
    const GGS_config * p = dynamic_cast <const GGS_config *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_config, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_config::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_config ;
}

//---------------------------------------------------------------------------*

GGS_config GGS_config::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_basic_type & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_config result = constructor_emptyMap (inLexique COMMA_THERE) ;
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_cfg_attrs ("cfg_attrs", false, NULL) ;
...
appendForMapDescription (const PMSInt32 inElementIndex,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.tpl_attr.reader_description (inIndentation + 1) ;
}
...
GGS_object GGS_cfg_attrs::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_cfg_attrs * p = NULL ;
    macroMyNew (p, GGS_cfg_attrs (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_cfg_attrs GGS_cfg_attrs::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_cfg_attrs result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_cfg_attrs * p = dynamic_cast <const GGS_cfg_attrs *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_cfg_attrs, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_cfg_attrs::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_cfg_attrs ;
}

//---------------------------------------------------------------------------*

GGS_cfg_attrs GGS_cfg_attrs::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_lstring & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_cfg_attrs result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_attrs) ;
...
appendForDescription (C_String & ioString,
  ...
  ioString << "->@attrs:"
           ...
           << attrs.reader_description (inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformationEX * cPtr_attrs::galgasRTTI (void) const {
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_attrs ("attrs", true, & kTypeDescriptor_GGS_basic_type) ;
...
C_galgasClassRunTimeInformationEX gClassInfoFor__attrs ("attrs", gClassInfoFor__basic_type, & kTypeDescriptor_GGS_attrs) ;

//---------------------------------------------------------------------------*

GGS_object GGS_attrs::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_attrs * p = NULL ;
    macroMyNew (p, GGS_attrs (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_attrs GGS_attrs::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_attrs result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_attrs * p = dynamic_cast <const GGS_attrs *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_attrs, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_attrs::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_attrs ;
}
...
//---------------------------------------------------------------------------*
  ...
  operator () (LOCATION_ARGS) const {
    macroValidObjectThere (mPointer, cPtr_interrupts) ;
...
appendForDescription (C_String & ioString,
  ...
  ioString << "->@interrupts:"
           << location.reader_description (inIndentation + 1)
           << it_count.reader_description (inIndentation + 1)
           << it_sources.reader_description (inIndentation + 1) ;
}
...
AC_galgasClassRunTimeInformationEX * cPtr_interrupts::galgasRTTI (void) const {
...
const C_galgas_type_descriptorEX kTypeDescriptor_GGS_interrupts ("interrupts", true, & kTypeDescriptor_GGS_basic_type) ;
...
C_galgasClassRunTimeInformationEX gClassInfoFor__interrupts ("interrupts", gClassInfoFor__basic_type, & kTypeDescriptor_GGS_interrupts) ;

//---------------------------------------------------------------------------*

GGS_object GGS_interrupts::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_interrupts * p = NULL ;
    macroMyNew (p, GGS_interrupts (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_interrupts GGS_interrupts::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_interrupts result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_interrupts * p = dynamic_cast <const GGS_interrupts *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_interrupts, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptorEX * GGS_interrupts::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_interrupts ;
}
