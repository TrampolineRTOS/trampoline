...
typeComparisonResult cMapElement_config::compare (const cCollectionElement * inOperand) const {
...
typeComparisonResult cMapElement_cfg_5F_attrs::compare (const cCollectionElement * inOperand) const {
...
typeComparisonResult cPtr_attrs::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_attrs * p = (const cPtr_attrs *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_attrs) ;
  if (kOperandEqual == result) {
    result = mAttribute_location.objectCompare (p->mAttribute_location) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_attrs.objectCompare (p->mAttribute_attrs) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_attrs::objectCompare (const GALGAS_attrs & inOperand) const {
...
typeComparisonResult cPtr_interrupts::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_interrupts * p = (const cPtr_interrupts *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_interrupts) ;
  if (kOperandEqual == result) {
    result = mAttribute_location.objectCompare (p->mAttribute_location) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_it_5F_count.objectCompare (p->mAttribute_it_5F_count) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_it_5F_sources.objectCompare (p->mAttribute_it_5F_sources) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_interrupts::objectCompare (const GALGAS_interrupts & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
