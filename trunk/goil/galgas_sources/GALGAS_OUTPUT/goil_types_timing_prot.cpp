...
method_generate (C_Compiler & inLexique,
  ...
  ::routine_retrieveTemplateString (inLexique,  var_cas_result,  GGS_string ("timing_protection") COMMA_SOURCE_FILE_AT_LINE (99)) ;
  ...
  const GGS_bool cond_4042 = (var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (126))).operator_strictSup (GGS_uint (0U)) ;
  ...
  const GGS_bool cond_4279 = (var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (132))).operator_strictSup (GGS_uint (0U)) ;
...
method_generate (C_Compiler & inLexique,
                                ...
                                GGS_resource_map  var_cas_rez COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_uint64  var_cas_tpn = GGS_uint64 (1ULL) ;
  const GGS_bool cond_5136 = var_cas_cfg.reader_hasKey (inLexique, GGS_string ("wd_ticks_per_ns") COMMA_SOURCE_FILE_AT_LINE (158)) ;
  if (cond_5136.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_val ;
    const GGS_config  temp_4964 = var_cas_cfg ;
    if (temp_4964.isBuilt ()) {
      temp_4964 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("wd_ticks_per_ns"), GGS_location (inLexique) COMMA_HERE), var_cas_val COMMA_SOURCE_FILE_AT_LINE (160)) ;
    }
  ...
  ::routine_retrieveTemplateString (inLexique,  var_cas_result,  GGS_string ("timing_protection") COMMA_SOURCE_FILE_AT_LINE (166)) ;
  ...
  const GGS_bool cond_6608 = (var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (196))).operator_strictSup (GGS_uint (0U)) ;
  if (cond_6608.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_6845 = (var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).operator_strictSup (GGS_uint (0U)) ;
