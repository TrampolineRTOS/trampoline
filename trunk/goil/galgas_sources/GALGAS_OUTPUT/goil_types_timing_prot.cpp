...
void routine_gen_rez_table (C_Compiler & inLexique,
  ...
  var_cas_i = GGS_uint (0U) ;
  {
    ...
    while (((operand_675 = enumerator_675.nextObject ()))) {
      ...
      if ((var_cas_rezlocks.reader_hasKey (inLexique, operand_675->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (24)) COMMA_SOURCE_FILE_AT_LINE (24))).isBuiltAndTrue ()) {
      ...
      if (((var_cas_i).operator_strictInf (var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (31)).substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (31)))).isBuiltAndTrue ()) {
        var_cas_table.appendCString (",\n") ;
      }else{
        var_cas_table.appendCString ("\n") ;
      }
...
method_generate (C_Compiler & inLexique,
                                ...
                                GGS_resource_map  var_cas_rez COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_uint64  var_cas_tpn ;
  var_cas_tpn = GGS_uint64 (1ULL) ;
  if ((var_cas_cfg.reader_hasKey (inLexique, GGS_string ("wd_ticks_per_ns") COMMA_SOURCE_FILE_AT_LINE (91))).isBuiltAndTrue ()) {
  ...
  var_cas_table_name = ((GGS_string ("task_")).operator_concat (var_cas_name)).operator_concat (GGS_string ("_rez_lock_time")) ;
  ...
  if (((var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (126))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (132))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
...
method_generate (C_Compiler & inLexique,
  ...
  GGS_uint64  var_cas_tpn ;
  var_cas_tpn = GGS_uint64 (1ULL) ;
  if ((var_cas_cfg.reader_hasKey (inLexique, GGS_string ("wd_ticks_per_ns") COMMA_SOURCE_FILE_AT_LINE (158))).isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_val ;
  ...
  GGS_string var_cas_table_name ;
  var_cas_table_name = ((GGS_string ("isr_")).operator_concat (var_cas_name)).operator_concat (GGS_string ("_rez_lock_time")) ;
  GGS_string var_cas_table ;
  var_cas_table = GGS_string ("") ;
  ::routine_gen_rez_table (inLexique,  rezlocks,  var_cas_rez,  var_cas_tpn,  var_cas_table COMMA_SOURCE_FILE_AT_LINE (194)) ;
  if (((var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (196))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
  ...
  if (((var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
