...
//                    november 12th, 2009, at 11h41'30"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.time.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
void routine_gen_rez_table (C_Compiler & inLexique,
  ...
  GGS_uint  var_cas_i = GGS_uint (0U) ;
  {
    ...
    while (((operand_675 = enumerator_675.nextObject ()))) {
      ...
      const GGS_bool cond_886 = var_cas_rezlocks.reader_hasKey (inLexique, operand_675->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (24)) COMMA_SOURCE_FILE_AT_LINE (24)) ;
      ...
      const GGS_bool cond_1012 = (var_cas_i).operator_strictInf (var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (31)).substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (31))) ;
...
method_generate (C_Compiler & inLexique,
  ...
  const GGS_bool cond_2672 = var_cas_cfg.reader_hasKey (inLexique, GGS_string ("wd_ticks_per_ns") COMMA_SOURCE_FILE_AT_LINE (91)) ;
  ...
  const GGS_bool cond_4045 = (var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (126))).operator_strictSup (GGS_uint (0U)) ;
  if (cond_4045.isBuiltAndTrue ()) {
    var_cas_table = ((((((GGS_string ("tpl_time ")).operator_concat (var_cas_table_name)).operator_concat (GGS_string ("["))).operator_concat (var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (127)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (127)))).operator_concat (GGS_string ("] = {\n"))).operator_concat (var_cas_table)).operator_concat (GGS_string ("};")) ;
  }
  ...
  const GGS_bool cond_4282 = (var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (132))).operator_strictSup (GGS_uint (0U)) ;
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@timing_prot_task:"
           << location.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << exe_budget.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << time_frame.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << os_it_lock.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << all_it_lock.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << rezlocks.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
method_generate (C_Compiler & inLexique,
                                ...
                                GGS_resource_map  var_cas_rez COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_uint64  var_cas_tpn = GGS_uint64 (1ULL) ;
  const GGS_bool cond_5139 = var_cas_cfg.reader_hasKey (inLexique, GGS_string ("wd_ticks_per_ns") COMMA_SOURCE_FILE_AT_LINE (158)) ;
  ...
  const GGS_bool cond_6614 = (var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (196))).operator_strictSup (GGS_uint (0U)) ;
  if (cond_6614.isBuiltAndTrue ()) {
    var_cas_table = ((((((GGS_string ("tpl_time ")).operator_concat (var_cas_table_name)).operator_concat (GGS_string ("["))).operator_concat (var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (197)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (197)))).operator_concat (GGS_string ("] = {\n"))).operator_concat (var_cas_table)).operator_concat (GGS_string ("};")) ;
  }
  ...
  const GGS_bool cond_6851 = (var_cas_rez.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).operator_strictSup (GGS_uint (0U)) ;
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@timing_prot_isr:"
           << location.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << exe_time.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << count_limit.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << time_frame.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << os_it_lock.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << all_it_lock.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << rezlocks.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
