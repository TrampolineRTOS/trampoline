...
const C_galgas_type_descriptor kTypeDescriptor_GGS_rezlock_map ("rezlock_map", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_rezlock_map::typeDescriptor (void) const {
...
void routine_gen_rez_table (C_Compiler & inLexique,
  ...
  GGS_uint  var_cas_i = GGS_uint (0U) ;
  {
    ...
    while (((operand_675 = enumerator_675.nextObject ()))) {
      ...
      const GGS_bool cond_886 = var_cas_rezlocks.reader_hasKey (operand_675->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (24))) ;
      if (cond_886.isBuiltAndTrue ()) {
        GGS_uint64  var_cas_time ;
        const GGS_rezlock_map  temp_806 = var_cas_rezlocks ;
        if (temp_806.isBuilt ()) {
          temp_806 (HERE)->method_get (inLexique, operand_675->mKey, var_cas_time COMMA_SOURCE_FILE_AT_LINE (26)) ;
        }
        var_cas_table.appendCString ("    ") ;
        var_cas_table.dotAssign_operation (var_cas_time.divide_operation (inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (27)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (27))) ;
      }else if (cond_886.isBuiltAndFalse ()) {
        var_cas_table.appendCString ("    0") ;
      }
      const GGS_bool cond_1012 = (var_cas_i).operator_strictInf (var_cas_rez.reader_count ().substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (31))) ;
      if (cond_1012.isBuiltAndTrue ()) {
        var_cas_table.appendCString (",\n") ;
      }else if (cond_1012.isBuiltAndFalse ()) {
        var_cas_table.appendCString ("\n") ;
      }
      var_cas_i.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (36)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_timing_prot ("timing_prot", true, NULL) ;
...
AC_galgasClassRunTimeInformation * GGS_timing_prot::galgasObjectRunTimeInfo (void) const {
...
C_galgasRootClassRunTimeInformation gClassInfoFor__timing_prot ("timing_prot", & kTypeDescriptor_GGS_timing_prot) ;
...
const C_galgas_type_descriptor * GGS_timing_prot::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_void_timing_prot ("void_timing_prot", true, & kTypeDescriptor_GGS_timing_prot) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__void_timing_prot ("void_timing_prot", gClassInfoFor__timing_prot, & kTypeDescriptor_GGS_void_timing_prot) ;
...
const C_galgas_type_descriptor * GGS_void_timing_prot::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_false_timing_prot ("false_timing_prot", true, & kTypeDescriptor_GGS_timing_prot) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__false_timing_prot ("false_timing_prot", gClassInfoFor__timing_prot, & kTypeDescriptor_GGS_false_timing_prot) ;
...
const C_galgas_type_descriptor * GGS_false_timing_prot::typeDescriptor (void) const {
...
method_generate (C_Compiler & inLexique,
  ...
  const GGS_bool cond_2672 = var_cas_cfg.reader_hasKey (GGS_string ("wd_ticks_per_ns")) ;
  if (cond_2672.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_val ;
    const GGS_config  temp_2500 = var_cas_cfg ;
    if (temp_2500.isBuilt ()) {
      temp_2500 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("wd_ticks_per_ns"), GGS_location (inLexique) COMMA_HERE), var_cas_val COMMA_SOURCE_FILE_AT_LINE (93)) ;
    }
    { const GGS_basic_type _var_2653 = var_cas_val ; // CAST instruction
      if (_var_2653.getPtr () != NULL) {
        ...
        if (typeid (cPtr_uint64_class) == typeid (* (_var_2653.getPtr ()))) {
          ...
          var_cas_tpn = var_cas_ui.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (95)) ;
        }else{
        }
      }
    }
  }
  var_cas_result = function_template_string (inLexique, GGS_string ("code"), GGS_string ("timing_protection") COMMA_SOURCE_FILE_AT_LINE (99)) ;
  { const GGS_basic_type _var_2930 = exe_budget ; // CAST instruction
    if (_var_2930.getPtr () != NULL) {
      macroValidPointer (_var_2930.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_2930.getPtr ()))) {
        const GGS_uint64_class var_cas_eb (_var_2930.getPtr ()) ;
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$EXE_BUDGET$"), var_cas_eb.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (103)).divide_operation (inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (103)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (103)) COMMA_SOURCE_FILE_AT_LINE (103)) ;
      }else{
      }
    }
  }
  var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$COUNT_LIMIT$"), GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (105)) ;
  { const GGS_basic_type _var_3206 = time_frame ; // CAST instruction
    if (_var_3206.getPtr () != NULL) {
      macroValidPointer (_var_3206.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_3206.getPtr ()))) {
        const GGS_uint64_class var_cas_tf (_var_3206.getPtr ()) ;
  ...
  { const GGS_basic_type _var_3401 = os_it_lock ; // CAST instruction
    if (_var_3401.getPtr () != NULL) {
      macroValidPointer (_var_3401.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_3401.getPtr ()))) {
        const GGS_uint64_class var_cas_oil (_var_3401.getPtr ()) ;
  ...
  { const GGS_basic_type _var_3597 = all_it_lock ; // CAST instruction
    if (_var_3597.getPtr () != NULL) {
      macroValidPointer (_var_3597.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_3597.getPtr ()))) {
        const GGS_uint64_class var_cas_ail (_var_3597.getPtr ()) ;
  ...
  var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$TIMING_PROT$"), var_cas_st_name COMMA_SOURCE_FILE_AT_LINE (120)) ;
  ...
  ::routine_gen_rez_table (inLexique,  rezlocks,  var_cas_rez,  var_cas_tpn,  var_cas_table COMMA_SOURCE_FILE_AT_LINE (124)) ;
  const GGS_bool cond_4045 = (var_cas_rez.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_4045.isBuiltAndTrue ()) {
    var_cas_table = ((((((GGS_string ("tpl_time ")).operator_concat (var_cas_table_name)).operator_concat (GGS_string ("["))).operator_concat (var_cas_rez.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (127)))).operator_concat (GGS_string ("] = {\n"))).operator_concat (var_cas_table)).operator_concat (GGS_string ("};")) ;
  }
  var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$LOCK_TIME_TABLE$"), var_cas_table COMMA_SOURCE_FILE_AT_LINE (130)) ;
  const GGS_bool cond_4282 = (var_cas_rez.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_4282.isBuiltAndTrue ()) {
    var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$REZ_LOCK_TIME$"), var_cas_table_name COMMA_SOURCE_FILE_AT_LINE (133)) ;
  }else if (cond_4282.isBuiltAndFalse ()) {
    var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$REZ_LOCK_TIME$"), GGS_string ("NULL") COMMA_SOURCE_FILE_AT_LINE (135)) ;
  }
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_timing_prot_task ("timing_prot_task", true, & kTypeDescriptor_GGS_timing_prot) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__timing_prot_task ("timing_prot_task", gClassInfoFor__timing_prot, & kTypeDescriptor_GGS_timing_prot_task) ;
...
const C_galgas_type_descriptor * GGS_timing_prot_task::typeDescriptor (void) const {
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = location.operator_isEqual (ptr->location).boolValue ()
         ...
         && count_limit.operator_isEqual (ptr->count_limit).boolValue ()
         && time_frame.operator_isEqual (ptr->time_frame).boolValue ()
         && os_it_lock.operator_isEqual (ptr->os_it_lock).boolValue ()
         && all_it_lock.operator_isEqual (ptr->all_it_lock).boolValue ()
         && rezlocks.operator_isEqual (ptr->rezlocks).boolValue () ;
...
method_generate (C_Compiler & inLexique,
                                ...
                                GGS_resource_map  var_cas_rez COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_uint64  var_cas_tpn = GGS_uint64 (1ULL) ;
  const GGS_bool cond_5139 = var_cas_cfg.reader_hasKey (GGS_string ("wd_ticks_per_ns")) ;
  if (cond_5139.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_val ;
    const GGS_config  temp_4967 = var_cas_cfg ;
    if (temp_4967.isBuilt ()) {
      temp_4967 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("wd_ticks_per_ns"), GGS_location (inLexique) COMMA_HERE), var_cas_val COMMA_SOURCE_FILE_AT_LINE (160)) ;
    }
    { const GGS_basic_type _var_5120 = var_cas_val ; // CAST instruction
      if (_var_5120.getPtr () != NULL) {
        macroValidPointer (_var_5120.getPtr ()) ;
        if (typeid (cPtr_uint64_class) == typeid (* (_var_5120.getPtr ()))) {
          const GGS_uint64_class var_cas_ui (_var_5120.getPtr ()) ;
          var_cas_tpn = var_cas_ui.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (162)) ;
        }else{
        }
      }
    }
  }
  var_cas_result = function_template_string (inLexique, GGS_string ("code"), GGS_string ("timing_protection") COMMA_SOURCE_FILE_AT_LINE (166)) ;
  { const GGS_basic_type _var_5395 = exe_time ; // CAST instruction
    if (_var_5395.getPtr () != NULL) {
      macroValidPointer (_var_5395.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_5395.getPtr ()))) {
        const GGS_uint64_class var_cas_et (_var_5395.getPtr ()) ;
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$EXE_BUDGET$"), var_cas_et.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (170)).divide_operation (inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (170)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (170)) COMMA_SOURCE_FILE_AT_LINE (170)) ;
      }else{
      }
    }
  }
  { const GGS_basic_type _var_5585 = count_limit ; // CAST instruction
    if (_var_5585.getPtr () != NULL) {
      macroValidPointer (_var_5585.getPtr ()) ;
      if (typeid (cPtr_uint32_class) == typeid (* (_var_5585.getPtr ()))) {
        const GGS_uint32_class var_cas_cl (_var_5585.getPtr ()) ;
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$COUNT_LIMIT$"), var_cas_cl.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (174)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (174)) ;
      }else{
      }
    }
  }
  { const GGS_basic_type _var_5778 = time_frame ; // CAST instruction
    if (_var_5778.getPtr () != NULL) {
      macroValidPointer (_var_5778.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_5778.getPtr ()))) {
        const GGS_uint64_class var_cas_tf (_var_5778.getPtr ()) ;
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$TIME_FRAME$"), var_cas_tf.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (178)).divide_operation (inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (178)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (178)) COMMA_SOURCE_FILE_AT_LINE (178)) ;
      }else{
      }
    }
  }
  { const GGS_basic_type _var_5973 = os_it_lock ; // CAST instruction
    if (_var_5973.getPtr () != NULL) {
      macroValidPointer (_var_5973.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_5973.getPtr ()))) {
        const GGS_uint64_class var_cas_oil (_var_5973.getPtr ()) ;
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$OS_IT_LOCK$"), var_cas_oil.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (182)).divide_operation (inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (182)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)) ;
      }else{
      }
    }
  }
  { const GGS_basic_type _var_6169 = all_it_lock ; // CAST instruction
    if (_var_6169.getPtr () != NULL) {
      macroValidPointer (_var_6169.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_6169.getPtr ()))) {
        const GGS_uint64_class var_cas_ail (_var_6169.getPtr ()) ;
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$ALL_IT_LOCK$"), var_cas_ail.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (186)).divide_operation (inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (186)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (186)) ;
      }else{
      }
    }
  }
  var_cas_st_name = ((GGS_string ("isr_")).operator_concat (var_cas_name)).operator_concat (GGS_string ("_timing_prot")) ;
  var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$TIMING_PROT$"), var_cas_st_name COMMA_SOURCE_FILE_AT_LINE (190)) ;
  GGS_string var_cas_table_name = ((GGS_string ("isr_")).operator_concat (var_cas_name)).operator_concat (GGS_string ("_rez_lock_time")) ;
  GGS_string var_cas_table = GGS_string ("") ;
  ::routine_gen_rez_table (inLexique,  rezlocks,  var_cas_rez,  var_cas_tpn,  var_cas_table COMMA_SOURCE_FILE_AT_LINE (194)) ;
  const GGS_bool cond_6614 = (var_cas_rez.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_6614.isBuiltAndTrue ()) {
    var_cas_table = ((((((GGS_string ("tpl_time ")).operator_concat (var_cas_table_name)).operator_concat (GGS_string ("["))).operator_concat (var_cas_rez.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (197)))).operator_concat (GGS_string ("] = {\n"))).operator_concat (var_cas_table)).operator_concat (GGS_string ("};")) ;
  }
  var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$LOCK_TIME_TABLE$"), var_cas_table COMMA_SOURCE_FILE_AT_LINE (200)) ;
  const GGS_bool cond_6851 = (var_cas_rez.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_6851.isBuiltAndTrue ()) {
    var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$REZ_LOCK_TIME$"), var_cas_table_name COMMA_SOURCE_FILE_AT_LINE (203)) ;
  }else if (cond_6851.isBuiltAndFalse ()) {
    var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$REZ_LOCK_TIME$"), GGS_string ("NULL") COMMA_SOURCE_FILE_AT_LINE (205)) ;
  }
  var_cas_st_name = (GGS_string ("&")).operator_concat (var_cas_st_name) ;
}
...
appendForDescription (C_String & ioString,
  ...
  ioString << "->@timing_prot_isr:"
           ...
           << count_limit.reader_description (inIndentation + 1)
           << time_frame.reader_description (inIndentation + 1)
           << os_it_lock.reader_description (inIndentation + 1)
           << all_it_lock.reader_description (inIndentation + 1)
           << rezlocks.reader_description (inIndentation + 1) ;
...
cPtr__AC_galgas_class * cPtr_timing_prot_isr::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_timing_prot_isr (location, exe_time, count_limit, time_frame, os_it_lock, all_it_lock, rezlocks COMMA_HERE)) ;
  return result ;
}
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_timing_prot_isr ("timing_prot_isr", true, & kTypeDescriptor_GGS_timing_prot) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__timing_prot_isr ("timing_prot_isr", gClassInfoFor__timing_prot, & kTypeDescriptor_GGS_timing_prot_isr) ;
...
const C_galgas_type_descriptor * GGS_timing_prot_isr::typeDescriptor (void) const {
