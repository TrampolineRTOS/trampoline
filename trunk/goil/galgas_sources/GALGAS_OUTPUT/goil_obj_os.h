...
class goil_obj_os {
  ...
  protected : virtual sint16 select_repeat_goil_obj_os_0 (goil_lexique &) = 0 ;

  protected : virtual sint16 select_goil_obj_os_1 (goil_lexique &) = 0 ;

  protected : virtual sint16 select_goil_obj_os_2 (goil_lexique &) = 0 ;

  protected : virtual sint16 select_goil_obj_os_3 (goil_lexique &) = 0 ;

  protected : virtual sint16 select_repeat_goil_obj_os_4 (goil_lexique &) = 0 ;
