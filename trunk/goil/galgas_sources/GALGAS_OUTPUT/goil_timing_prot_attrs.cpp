    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_goil_timing_prot_attrs_0 (_inLexique)) {
          ...
          { const GGS_basic_type _var_1413 = var_cas_exe_budget ; // CAST instruction
            if (_var_1413.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void) == typeid (* (_var_1413.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("EXECUTIONBUDGET already declared") COMMA_SOURCE_FILE_AT_LINE (44)) ;
                var_cas_exe_budget.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (44)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously declared here") COMMA_SOURCE_FILE_AT_LINE (45)) ;
              }
            }
          }
          } break ;
          ...
          { const GGS_basic_type _var_1770 = var_cas_exe_time ; // CAST instruction
            if (_var_1770.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void) == typeid (* (_var_1770.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("EXECUTIONTIME already declared") COMMA_SOURCE_FILE_AT_LINE (53)) ;
                var_cas_exe_time.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (53)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously declared here") COMMA_SOURCE_FILE_AT_LINE (54)) ;
              }
            }
          }
          } break ;
          ...
          { const GGS_basic_type _var_2137 = var_cas_count_limit ; // CAST instruction
            if (_var_2137.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void) == typeid (* (_var_2137.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("COUNTLIMIT already declared") COMMA_SOURCE_FILE_AT_LINE (62)) ;
                var_cas_count_limit.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (62)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously declared here") COMMA_SOURCE_FILE_AT_LINE (63)) ;
              }
            }
          }
          } break ;
          ...
          { const GGS_basic_type _var_2492 = var_cas_time_frame ; // CAST instruction
            if (_var_2492.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void) == typeid (* (_var_2492.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("TIMEFRAME already declared") COMMA_SOURCE_FILE_AT_LINE (71)) ;
                var_cas_time_frame.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (71)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously declared here") COMMA_SOURCE_FILE_AT_LINE (72)) ;
              }
            }
          }
          } break ;
          ...
          { const GGS_basic_type _var_2882 = var_cas_os_it_lock ; // CAST instruction
            if (_var_2882.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void) == typeid (* (_var_2882.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("MAXOSINTERRUPTLOCKTIME already declared") COMMA_SOURCE_FILE_AT_LINE (80)) ;
                var_cas_os_it_lock.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (80)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously declared here") COMMA_SOURCE_FILE_AT_LINE (81)) ;
              }
            }
          }
          } break ;
          ...
          { const GGS_basic_type _var_3277 = var_cas_all_it_lock ; // CAST instruction
            if (_var_3277.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void) == typeid (* (_var_3277.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("MAXALLINTERRUPTLOCKTIME already declared") COMMA_SOURCE_FILE_AT_LINE (89)) ;
                var_cas_all_it_lock.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (89)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously declared here") COMMA_SOURCE_FILE_AT_LINE (90)) ;
              }
            }
          }
          } break ;
        case 8 : {
          ...
          var_cas_rez = GGS_lstring ::constructor_new (_inLexique, GGS_string (""), GGS_location (_inLexique) COMMA_HERE) ;
            ...
            while (syntaxRepeat_1) {
              switch (select_repeat_goil_timing_prot_attrs_1 (_inLexique)) {
                case 2 : {
                  ...
                  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                  if (((var_cas_rez.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (99)))._operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("RESOURCE already declared") COMMA_SOURCE_FILE_AT_LINE (101)) ;
                    var_cas_rez.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously declared here") COMMA_SOURCE_FILE_AT_LINE (102)) ;
                  }else{
                  ...
                  { const GGS_basic_type _var_4164 = var_cas_lock ; // CAST instruction
                    if (_var_4164.getPtr () != NULL) {
                      ...
                      if (typeid (cPtr_void) == typeid (* (_var_4164.getPtr ()))) {
                        ...
                        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("MAXRESOURCELOCKTIME already declared") COMMA_SOURCE_FILE_AT_LINE (112)) ;
                        var_cas_lock.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (112)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously declared here") COMMA_SOURCE_FILE_AT_LINE (113)) ;
                      }
                    }
                  }
                  } break ;
          ...
          if (((var_cas_rez.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (115)))._operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("No RESOURCE declared for LOCKINGTIME") COMMA_SOURCE_FILE_AT_LINE (117)) ;
          }
          ...
          { const GGS_basic_type _var_4513 = var_cas_lock ; // CAST instruction
            if (_var_4513.getPtr () != NULL) {
              ...
              if (typeid (cPtr_uint64_class) == typeid (* (_var_4513.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("No MAXRESOURCELOCKTIME declared for LOCKINGTIME") COMMA_SOURCE_FILE_AT_LINE (124)) ;
              }
            }
          }
  ...
  { const GGS_basic_type _var_4682 = var_cas_time_frame ; // CAST instruction
    if (_var_4682.getPtr () != NULL) {
      ...
      if (typeid (cPtr_void) == typeid (* (_var_4682.getPtr ()))) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("TIMEFRAME not declared") COMMA_SOURCE_FILE_AT_LINE (129)) ;
      }else{
      }
    }
  }
  { const GGS_basic_type _var_4791 = var_cas_os_it_lock ; // CAST instruction
    if (_var_4791.getPtr () != NULL) {
      ...
      if (typeid (cPtr_void) == typeid (* (_var_4791.getPtr ()))) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("MAXOSINTERRUPTLOCKTIME not declared") COMMA_SOURCE_FILE_AT_LINE (130)) ;
      }else{
      }
    }
  }
  { const GGS_basic_type _var_4901 = var_cas_all_it_lock ; // CAST instruction
    if (_var_4901.getPtr () != NULL) {
      ...
      if (typeid (cPtr_void) == typeid (* (_var_4901.getPtr ()))) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("MAXALLINTERRUPTLOCKTIME not declared") COMMA_SOURCE_FILE_AT_LINE (131)) ;
      }else{
      }
    }
  }
