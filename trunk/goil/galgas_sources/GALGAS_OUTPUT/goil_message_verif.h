...
void routine_check_5F_net_5F_dir (GALGASap_lstring inArgument0,
                                  GALGASap_netmess_5F_map inArgument1,
...
void routine_check_5F_external_5F_sent (GALGASap_lstring inArgument0,
                                        GALGASap_netmess_5F_map inArgument1,
                                        C_Compiler * inCompiler
                                        COMMA_LOCATION_ARGS) ;
...
void routine_check_5F_external_5F_received (GALGASap_lstring inArgument0,
                                            GALGASap_netmess_5F_map inArgument1,
                                            C_Compiler * inCompiler
                                            COMMA_LOCATION_ARGS) ;
...
void routine_check_5F_external_5F_link_5F_received (GALGASap_link_5F_obj inArgument0,
                                                    GALGASap_message_5F_map inArgument1,
                                                    GALGASap_netmess_5F_map inArgument2,
                                                    GALGASap_location inArgument3,
                                                    GALGASap_uint inArgument4,
                                                    C_Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) ;
...
void routine_messages_5F_well_5F_formed (GALGASap_message_5F_map constinArgument0,
                                         C_Compiler * inCompiler
                                         COMMA_LOCATION_ARGS) ;
...
void routine_networkmessages_5F_exist_5F_and_5F_ok (GALGASap_message_5F_map inArgument0,
                                                    GALGASap_netmess_5F_map inArgument1,
                                                    C_Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) ;
...
void routine_networkmessages_5F_well_5F_formed (GALGASap_netmess_5F_map inArgument0,
                                                C_Compiler * inCompiler
                                                COMMA_LOCATION_ARGS) ;
