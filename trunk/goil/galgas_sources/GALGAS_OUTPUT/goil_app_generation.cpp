...
void routine_generate_trusted_functions (C_Compiler & _inLexique,
  ...
  var_cas_tf_id = GGS_uint (true, 0U) ;
  {
    ...
    if (enumerator_11590 .hc ()) {
      var_cas_fct_table = GGS_string (true, "CONST(tpl_trusted_fct, OS_APPL_CODE)\n") ;
  ...
  ::routine_doReplace (_inLexique,  var_cas_imp,  GGS_string (true, "$TRUSTED_IDS$"),  var_cas_fct_ids COMMA_SOURCE_FILE_AT_LINE (407)) ;
  ::routine_doReplace (_inLexique,  var_cas_imp,  GGS_string (true, "$TRUSTED_FCTS$"),  var_cas_fcts COMMA_SOURCE_FILE_AT_LINE (408)) ;
  ::routine_doReplace (_inLexique,  var_cas_imp,  GGS_string (true, "$TRUSTED_TABLE$"),  var_cas_fct_table COMMA_SOURCE_FILE_AT_LINE (409)) ;
  ::routine_doReplace (_inLexique,  var_cas_obj_head,  GGS_string (true, "$TRUSTED_FCT_COUNT$"),  var_cas_tf_id.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (410)) COMMA_SOURCE_FILE_AT_LINE (410)) ;
  #ifdef DEBUG_TRACE_ENABLED
