...
void routine_generate_trusted_functions (C_Compiler & _inLexique,
  ...
  {
    GGS_app_map::cEnumerator enumerator_11291 (var_cas_apps, true) ;
    const GGS_app_map::cElement * operand_11291 = NULL ;
    while (((operand_11291 = enumerator_11291.nextObject ()))) {
      macroValidPointer (operand_11291) ;
      { const GGS_app_trusted_obj _var_11453 = operand_11291->mInfo.app.reader_trusted (_inLexique COMMA_SOURCE_FILE_AT_LINE (376)) ; // CAST instruction
        if (_var_11453.getPtr () != NULL) {
          macroValidPointer (_var_11453.getPtr ()) ;
          if (typeid (cPtr_app_trusted_true) == typeid (* (_var_11453.getPtr ()))) {
            const GGS_app_trusted_true var_cas_t (_var_11453.getPtr ()) ;
            {
              GGS_stringset::cEnumerator enumerator_11370 (var_cas_t.reader_trusted_fcts (_inLexique COMMA_SOURCE_FILE_AT_LINE (378)), true) ;
              while (enumerator_11370.hc ()) {
                var_cas_tfs._addAssign_operation (enumerator_11370._key (HERE)) ;
                enumerator_11370.next () ;
              }
            }
          }else{
          }
  ...
  var_cas_fcts = GGS_string (true, "") ;
  GGS_string var_cas_fct_ids ;
  var_cas_fct_ids = GGS_string (true, "") ;
  GGS_string var_cas_fct_table ;
  var_cas_fct_table = GGS_string (true, "") ;
  GGS_uint  var_cas_tf_id ;
  var_cas_tf_id = GGS_uint (true, 0U) ;
  {
    GGS_stringset::cEnumerator enumerator_11590 (var_cas_tfs, true) ;
    if (enumerator_11590 .hc ()) {
      var_cas_fct_table = GGS_string (true, "CONSTP2CONST(tpl_trusted_fct, AUTOMATIC, OS_APPL_DATA)\n") ;
      var_cas_fct_table.appendCstring ("  tpl_trusted_fct_table[TRUSTED_FCT_COUNT] = {\n") ;
      bool _foreach_loop_11590 ;
      do{
        var_cas_fcts.appendCstring ("void TRUSTED_") ;
        var_cas_fcts._dotAssign_operation (enumerator_11590._key (HERE)) ;
        var_cas_fcts.appendCstring ("(TrustedFunctionIndexType idx, TrustedFunctionParameterRefType params);\n") ;
        var_cas_fct_ids.appendCstring ("#define ") ;
        var_cas_fct_ids._dotAssign_operation (enumerator_11590._key (HERE)) ;
        var_cas_fct_ids.appendCstring ("_id    ") ;
        var_cas_fct_ids._dotAssign_operation (var_cas_tf_id.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (395))) ;
        ...
        var_cas_fct_table._dotAssign_operation (enumerator_11590._key (HERE)) ;
        var_cas_tf_id._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (398)) ;
        enumerator_11590.next () ;
        _foreach_loop_11590 = (enumerator_11590 .hc ()) ;
        if (_foreach_loop_11590) {
          var_cas_fct_table.appendCstring (",\n") ;
        }
      }while (_foreach_loop_11590) ;
      var_cas_fct_table.appendCstring ("\n"
        "};\n") ;
    }
  }
  ::routine_doReplace (_inLexique,  var_cas_imp,  GGS_string (true, "$TRUSTED_IDS$"),  var_cas_fct_ids COMMA_SOURCE_FILE_AT_LINE (405)) ;
  ::routine_doReplace (_inLexique,  var_cas_imp,  GGS_string (true, "$TRUSTED_FCTS$"),  var_cas_fcts COMMA_SOURCE_FILE_AT_LINE (406)) ;
  ::routine_doReplace (_inLexique,  var_cas_imp,  GGS_string (true, "$TRUSTED_TABLE$"),  var_cas_fct_table COMMA_SOURCE_FILE_AT_LINE (407)) ;
  ::routine_doReplace (_inLexique,  var_cas_obj_head,  GGS_string (true, "$TRUSTED_FCT_COUNT$"),  var_cas_tf_id.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (408)) COMMA_SOURCE_FILE_AT_LINE (408)) ;
  #ifdef DEBUG_TRACE_ENABLED
