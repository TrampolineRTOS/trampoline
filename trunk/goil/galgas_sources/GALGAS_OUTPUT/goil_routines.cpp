...
GGS_string function_templateFilePath (C_Compiler & inLexique,
  ...
  GGS_uint _variant_6192 = var_cas_components.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (174)) ;
  GGS_bool _condition_6192 (_variant_6192.isBuilt (), true) ;
  while (_condition_6192.isBuiltAndTrue ()) {
    _condition_6192 = (var_cas_notFound).operator_and (var_cas_notOver) ;
    if (_condition_6192.isBuiltAndTrue ()) {
      if (_variant_6192.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (189)) ;
        _condition_6192 = GGS_bool (false) ;
      }else{
        _variant_6192.decrement_operation (inLexique COMMA_HERE) ;
        GGS_string var_cas_intermediatePath = GGS_string::constructor_componentsJoinedByString (inLexique, var_cas_components, GGS_string ("/") COMMA_HERE) ;
        const GGS_bool cond_5866 = (var_cas_intermediatePath).operator_isNotEqual (GGS_string ("")) ;
        ...
        const GGS_bool cond_6068 = var_cas_targetPath.reader_fileExists () ;
        if (cond_6068.isBuiltAndTrue ()) {
          var_cas_notFound = GGS_bool (false) ;
          var_cas_path = var_cas_targetPath ;
        }
        const GGS_bool cond_6150 = (var_cas_components.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
        if (cond_6150.isBuiltAndTrue ()) {
          GGS_string automatic_var_6140_0 ;
          var_cas_components.modifier_popLast (inLexique, automatic_var_6140_0 COMMA_SOURCE_FILE_AT_LINE (185)) ;
        }else if (cond_6150.isBuiltAndFalse ()) {
...
GGS_stringlist  function_allTemplateFilePaths (C_Compiler & inLexique,
  ...
  GGS_uint _variant_7031 = var_cas_components.reader_length ().add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (202)) ;
  GGS_bool _condition_7031 (_variant_7031.isBuilt (), true) ;
  while (_condition_7031.isBuiltAndTrue ()) {
    _condition_7031 = var_cas_notOver ;
    if (_condition_7031.isBuiltAndTrue ()) {
      if (_variant_7031.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (216)) ;
        _condition_7031 = GGS_bool (false) ;
      }else{
        _variant_7031.decrement_operation (inLexique COMMA_HERE) ;
        GGS_string var_cas_intermediatePath = GGS_string::constructor_componentsJoinedByString (inLexique, var_cas_components, GGS_string ("/") COMMA_HERE) ;
        const GGS_bool cond_6728 = (var_cas_intermediatePath).operator_isNotEqual (GGS_string ("")) ;
        if (cond_6728.isBuiltAndTrue ()) {
          var_cas_intermediatePath.appendCString ("/") ;
        }
        GGS_string var_cas_targetPath = ((var_cas_templateDir).operator_concat (var_cas_intermediatePath)).operator_concat (var_cas_file) ;
        const GGS_bool cond_6907 = var_cas_targetPath.reader_fileExists () ;
        if (cond_6907.isBuiltAndTrue ()) {
          var_cas_paths.addAssign_operation (var_cas_targetPath) ;
        }
        const GGS_bool cond_6989 = (var_cas_components.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
        if (cond_6989.isBuiltAndTrue ()) {
          GGS_string automatic_var_6979_0 ;
          var_cas_components.modifier_popLast (inLexique, automatic_var_6979_0 COMMA_SOURCE_FILE_AT_LINE (212)) ;
        }else if (cond_6989.isBuiltAndFalse ()) {
          var_cas_notOver = GGS_bool (false) ;
        }
      }
    }
...
GGS_lstring  function_extra_config_file (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  const GGS_bool cond_7390 = (var_cas_cfg.reader_fileExists ()).operator_not () ;
  if (cond_7390.isBuiltAndTrue ()) {
...
void routine_prefix (C_Compiler & inLexique,
  ...
  GGS_string automatic_var_7591_0 ;
  const GGS_prefix_map  temp_7576 = var_cas_p ;
  if (temp_7576.isBuilt ()) {
    temp_7576 (HERE)->method_prefix (inLexique, var_cas_lkey, var_cas_val, automatic_var_7591_0 COMMA_SOURCE_FILE_AT_LINE (237)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_performReplace (C_Compiler & inLexique,
  ...
  const GGS_prefix_map  temp_7798 = var_cas_p ;
  if (temp_7798.isBuilt ()) {
    temp_7798 (HERE)->method_prefix (inLexique, var_cas_lkey, var_cas_prefix, var_cas_tag_to_rep COMMA_SOURCE_FILE_AT_LINE (244)) ;
  }
...
void routine_do_replace_default (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_8188 = (var_cas_n).operator_isNotEqual (GGS_string ("")) ;
  ...
  }else if (cond_8188.isBuiltAndFalse ()) {
...
void routine_replace_no_prefix (C_Compiler & inLexique,
  ...
  GGS_lstring  var_cas_lkey = GGS_lstring ::constructor_new (inLexique, var_cas_key, GGS_location (inLexique) COMMA_HERE) ;
  GGS_string var_cas_tag_to_rep ;
  GGS_string automatic_var_8481_0 ;
  const GGS_prefix_map  temp_8459 = var_cas_p ;
  if (temp_8459.isBuilt ()) {
    temp_8459 (HERE)->method_prefix (inLexique, var_cas_lkey, automatic_var_8481_0, var_cas_tag_to_rep COMMA_SOURCE_FILE_AT_LINE (264)) ;
  }
...
void routine_table_core (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_8941 (var_cas_names, true) ;
    while (enumerator_8941.hasCurrentObject ()) {
      var_cas_header = (((((((var_cas_header).operator_concat (GGS_string ("#define "))).operator_concat (var_cas_varname)).operator_concat (GGS_string ("_id_of_"))).operator_concat (enumerator_8941._key (HERE))).operator_concat (GGS_string ("  "))).operator_concat (var_cas_n.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (285)))).operator_concat (GGS_string ("\n")) ;
      var_cas_header = (((((((var_cas_header).operator_concat (GGS_string ("#define "))).operator_concat (enumerator_8941._key (HERE))).operator_concat (GGS_string ("  "))).operator_concat (var_cas_varname)).operator_concat (GGS_string ("_id_of_"))).operator_concat (enumerator_8941._key (HERE))).operator_concat (GGS_string ("\n")) ;
      var_cas_implementation = (((((var_cas_implementation).operator_concat (GGS_string ("    (tpl_"))).operator_concat (var_cas_typename)).operator_concat (GGS_string (" *)&"))).operator_concat (var_cas_obj_prefix)).operator_concat (enumerator_8941._key (HERE)) ;
      var_cas_n.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (295)) ;
      const GGS_bool cond_9592 = (var_cas_n).operator_isNotEqual (var_cas_names.reader_count ()) ;
      if (cond_9592.isBuiltAndTrue ()) {
        var_cas_implementation = (var_cas_implementation).operator_concat (GGS_string (",\n")) ;
      }else if (cond_9592.isBuiltAndFalse ()) {
        var_cas_implementation = (var_cas_implementation).operator_concat (GGS_string ("\n")) ;
      }
      enumerator_8941.next () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_add_to_stringset (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_12715 = var_cas_ss.reader_hasKey (var_cas_new) ;
  if (cond_12715.isBuiltAndTrue ()) {
  ...
  }else if (cond_12715.isBuiltAndFalse ()) {
...
void routine_file_in_path (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_13034 (var_cas_path_list, true) ;
    const GGS_stringlist::cElement * operand_13034 = NULL ;
    while (((operand_13034 = enumerator_13034.nextObject ()))) {
      macroValidPointer (operand_13034) ;
      GGS_string var_cas_full_file_path = operand_13034->mValue ;
      const GGS_bool cond_13295 = (var_cas_full_file_path).operator_isNotEqual (GGS_string ("")) ;
      if (cond_13295.isBuiltAndTrue ()) {
        const GGS_bool cond_13278 = (var_cas_full_file_path.reader_characterAtIndex (inLexique, var_cas_full_file_path.reader_length ().substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (420)) COMMA_SOURCE_FILE_AT_LINE (420))).operator_isNotEqual (GGS_char (TO_UNICODE ('/'))) ;
        if (cond_13278.isBuiltAndTrue ()) {
          var_cas_full_file_path.appendCString ("/") ;
        }
      }
      var_cas_full_file_path.dotAssign_operation (var_cas_file_name.ggs_string ()) ;
      const GGS_bool cond_13505 = (var_cas_full_file_path.reader_fileExists ()).operator_and (var_cas_not_found) ;
      if (cond_13505.isBuiltAndTrue ()) {
...
void routine_is_in_lstringlist (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_13704 (var_cas_l, true) ;
    const GGS_lstringlist::cElement * operand_13704 = NULL ;
    while (((operand_13704 = enumerator_13704.nextObject ()))) {
      macroValidPointer (operand_13704) ;
      const GGS_bool cond_13798 = (operand_13704->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (441))).operator_isEqual (var_cas_e.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (441))) ;
      if (cond_13798.isBuiltAndTrue ()) {
        var_cas_p = GGS_bool (true) ;
        var_cas_f = operand_13704->mValue ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_bool function_isInLstringlist (C_Compiler & inLexique,
  ...
  var_cas_p = GGS_bool (false) ;
  {
    GGS_lstringlist::cEnumerator enumerator_13942 (var_cas_l, true) ;
    const GGS_lstringlist::cElement * operand_13942 = NULL ;
    while (((operand_13942 = enumerator_13942.nextObject ()))) {
      macroValidPointer (operand_13942) ;
      const GGS_bool cond_14021 = (operand_13942->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (455))).operator_isEqual (var_cas_e.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (455))) ;
...
void routine_add_lstring_unique (C_Compiler & inLexique,
  ...
  const GGS_bool cond_14327 = var_cas_found ;
  if (cond_14327.isBuiltAndTrue ()) {
  ...
  }else if (cond_14327.isBuiltAndFalse ()) {
...
void routine_set_lstring_if_empty (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_14491 = (var_cas_s.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (482))).operator_isEqual (GGS_string ("")) ;
...
void routine_add_makefile_flag_if_not_empty (C_Compiler &,
  ...
  #endif
  const GGS_bool cond_14780 = (var_cas_flag_value).operator_isNotEqual (GGS_string ("")) ;
  if (cond_14780.isBuiltAndTrue ()) {
...
GGS_string function_stripString (C_Compiler & inLexique,
  ...
  const GGS_bool cond_15769 = (var_cas_s.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_15769.isBuiltAndTrue ()) {
    ...
    GGS_uint _variant_15320 = var_cas_s.reader_length () ;
    GGS_bool _condition_15320 (_variant_15320.isBuilt (), true) ;
    while (_condition_15320.isBuiltAndTrue ()) {
      _condition_15320 = (var_cas_finished).operator_not () ;
      if (_condition_15320.isBuiltAndTrue ()) {
        if (_variant_15320.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (516)) ;
          _condition_15320 = GGS_bool (false) ;
        }else{
          _variant_15320.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_15285 = (var_cas_s.reader_characterAtIndex (inLexique, var_cas_first COMMA_SOURCE_FILE_AT_LINE (512))).operator_isEqual (GGS_char (TO_UNICODE (' '))) ;
          if (cond_15285.isBuiltAndTrue ()) {
            var_cas_first.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (513)) ;
            const GGS_bool cond_15270 = (var_cas_first).operator_isEqual (var_cas_s.reader_length ()) ;
            if (cond_15270.isBuiltAndTrue ()) {
              var_cas_finished = GGS_bool (true) ;
            }
          }else if (cond_15285.isBuiltAndFalse ()) {
            var_cas_finished = GGS_bool (true) ;
          }
        }
      }
    ...
    GGS_uint _variant_15617 = var_cas_s.reader_length () ;
    GGS_bool _condition_15617 (_variant_15617.isBuilt (), true) ;
    while (_condition_15617.isBuiltAndTrue ()) {
      _condition_15617 = (var_cas_finished).operator_not () ;
      if (_condition_15617.isBuiltAndTrue ()) {
        if (_variant_15617.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (525)) ;
          _condition_15617 = GGS_bool (false) ;
        }else{
          _variant_15617.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_15582 = (var_cas_s.reader_characterAtIndex (inLexique, var_cas_last.substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (521)) COMMA_SOURCE_FILE_AT_LINE (521))).operator_isEqual (GGS_char (TO_UNICODE (' '))) ;
          if (cond_15582.isBuiltAndTrue ()) {
            var_cas_last.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (522)) ;
            const GGS_bool cond_15567 = (var_cas_last).operator_isEqual (GGS_uint (0U)) ;
            if (cond_15567.isBuiltAndTrue ()) {
              var_cas_finished = GGS_bool (true) ;
            }
          }else if (cond_15582.isBuiltAndFalse ()) {
            var_cas_finished = GGS_bool (true) ;
          }
        }
      }
    }
    const GGS_bool cond_15735 = (var_cas_first).operator_strictInf (var_cas_last) ;
    if (cond_15735.isBuiltAndTrue ()) {
    ...
    }else if (cond_15735.isBuiltAndFalse ()) {
      var_cas_r = GGS_string ("") ;
    }
  }else if (cond_15769.isBuiltAndFalse ()) {
    var_cas_r = GGS_string ("") ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_errorNoFileFound (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_16028 (var_cas_searchedPaths, true) ;
    const GGS_stringlist::cElement * operand_16028 = NULL ;
    while (((operand_16028 = enumerator_16028.nextObject ()))) {
      macroValidPointer (operand_16028) ;
      var_cas_m.appendCString ("\n"
        "  - '") ;
      var_cas_m.dotAssign_operation (operand_16028->mValue) ;
      var_cas_m.appendCString ("'") ;
    }
  }
