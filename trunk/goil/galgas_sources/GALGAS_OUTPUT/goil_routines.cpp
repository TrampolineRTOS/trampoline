...
//                    december 18th, 2009, at 11h10'25"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
GGS_string function_project_name (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  const GGS_bool cond_392 = (gOption_goil_5F_options_project_5F_dir.reader_value ()).operator_isNotEqual (GGS_string ("")) ;
  if (cond_392.isBuiltAndTrue ()) {
...
static GGS_object functionForGenericCall_project_name (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
  const GGS_string result = function_project_name (inLexique
                            COMMA_THERE) ;
...
const C_galgas_function_descriptor kFunction_descriptor_project_name ("project_name",
                              functionForGenericCall_project_name,
...
GGS_string function_arch (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  const GGS_stringlist  temp_834 = var_cas_components ;
  if (temp_834.isBuilt ()) {
    temp_834 (HERE)->method_first (inLexique, var_cas_arch_name COMMA_SOURCE_FILE_AT_LINE (24)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_string function_chip (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_stringlist  var_cas_components = gOption_goil_5F_options_target_5F_platform.reader_value ().reader_componentsSeparatedByString (GGS_string ("/")) ;
  const GGS_bool cond_1243 = (var_cas_components.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
  if (cond_1243.isBuiltAndTrue ()) {
    var_cas_chip_name = var_cas_components.reader_mValueAtIndex (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (34)) ;
  }else if (cond_1243.isBuiltAndFalse ()) {
...
GGS_string function_board (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_stringlist  var_cas_components = gOption_goil_5F_options_target_5F_platform.reader_value ().reader_componentsSeparatedByString (GGS_string ("/")) ;
  const GGS_bool cond_1580 = (var_cas_components.reader_length ()).operator_strictSup (GGS_uint (2U)) ;
  if (cond_1580.isBuiltAndTrue ()) {
    var_cas_board_name = var_cas_components.reader_mValueAtIndex (inLexique, GGS_uint (2U) COMMA_SOURCE_FILE_AT_LINE (46)) ;
  }else if (cond_1580.isBuiltAndFalse ()) {
...
GGS_string function_add_path_component (C_Compiler & inLexique,
  ...
  const GGS_bool cond_1874 = (var_cas_path.reader_characterAtIndex (inLexique, var_cas_path.reader_length ().substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (60)) COMMA_SOURCE_FILE_AT_LINE (60))).operator_isNotEqual (GGS_char (TO_UNICODE ('/'))) ;
  if (cond_1874.isBuiltAndTrue ()) {
    var_cas_new_path = ((var_cas_path).operator_concat (GGS_string ("/"))).operator_concat (var_cas_component) ;
  }else if (cond_1874.isBuiltAndFalse ()) {
...
GGS_string function_root_templates_directory (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  const GGS_bool cond_2111 = (gOption_goil_5F_options_template_5F_dir.reader_value ()).operator_isNotEqual (GGS_string ("")) ;
  if (cond_2111.isBuiltAndTrue ()) {
    var_cas_tpl_dir = gOption_goil_5F_options_template_5F_dir.reader_value () ;
  }else if (cond_2111.isBuiltAndFalse ()) {
  ...
  var_cas_tpl_dir = var_cas_tpl_dir.reader_unixPathWithNativePath () ;
  #ifdef DEBUG_TRACE_ENABLED
...
static GGS_object functionForGenericCall_root_templates_directory (C_Compiler & inLexique,
                           const GGS_objectlist & /* inEffectiveParameterArray */,
                           const GGS_location & /* inErrorLocation */
                           COMMA_LOCATION_ARGS) {
  const GGS_string result = function_root_templates_directory (inLexique
                            COMMA_THERE) ;
  return result.reader_object () ;
}
...
const C_galgas_function_descriptor kFunction_descriptor_root_templates_directory ("root_templates_directory",
                              functionForGenericCall_root_templates_directory,
                              & kTypeDescriptor_GGS_string,
                              0,
                              NULL) ;
...
GGS_string function_templates_directory (C_Compiler & inLexique,
  ...
  var_cas_temp_dir = function_root_templates_directory (inLexique COMMA_SOURCE_FILE_AT_LINE (79)) ;
  const GGS_bool cond_3063 = (var_cas_temp_dir).operator_isNotEqual (GGS_string ("")) ;
  if (cond_3063.isBuiltAndTrue ()) {
    var_cas_temp_dir = function_add_path_component (inLexique, var_cas_temp_dir, var_cas_prefix COMMA_SOURCE_FILE_AT_LINE (81)) ;
    const GGS_bool cond_2927 = (var_cas_temp_dir.reader_characterAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (83))).operator_isNotEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_2927.isBuiltAndTrue ()) {
      GGS_string var_cas_curdir = GGS_string::constructor_stringWithCurrentDirectory (inLexique COMMA_HERE) ;
      const GGS_bool cond_2860 = ((var_cas_temp_dir.reader_characterAtIndex (inLexique, GGS_uint (0U) COMMA_SOURCE_FILE_AT_LINE (85))).operator_isEqual (GGS_char (TO_UNICODE ('.')))).operator_and ((var_cas_temp_dir.reader_characterAtIndex (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (85))).operator_isEqual (GGS_char (TO_UNICODE ('/')))) ;
      if (cond_2860.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_3050 = (var_cas_temp_dir.reader_characterAtIndex (inLexique, var_cas_temp_dir.reader_length ().substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (90)) COMMA_SOURCE_FILE_AT_LINE (90))).operator_isNotEqual (GGS_char (TO_UNICODE ('/'))) ;
    if (cond_3050.isBuiltAndTrue ()) {
...
GGS_string function_template_string_if_exist (C_Compiler & inLexique,
  ...
  const GGS_bool cond_3702 = var_cas_targ_tpl.reader_fileExists () ;
  if (cond_3702.isBuiltAndTrue ()) {
    var_cas_tpl = GGS_string::constructor_stringWithContentsOfFile (inLexique, var_cas_targ_tpl COMMA_HERE) ;
  }else if (cond_3702.isBuiltAndFalse ()) {
    ...
    const GGS_bool cond_3868 = var_cas_targ_tpl.reader_fileExists () ;
    if (cond_3868.isBuiltAndTrue ()) {
      var_cas_tpl = GGS_string::constructor_stringWithContentsOfFile (inLexique, var_cas_targ_tpl COMMA_HERE) ;
    }else if (cond_3868.isBuiltAndFalse ()) {
      ...
      const GGS_bool cond_4031 = var_cas_targ_tpl.reader_fileExists () ;
      if (cond_4031.isBuiltAndTrue ()) {
        var_cas_tpl = GGS_string::constructor_stringWithContentsOfFile (inLexique, var_cas_targ_tpl COMMA_HERE) ;
      }else if (cond_4031.isBuiltAndFalse ()) {
        var_cas_targ_tpl = ((var_cas_temp_dir).operator_concat (GGS_string ("all_targets/"))).operator_concat (var_cas_temp_name) ;
        const GGS_bool cond_4242 = var_cas_targ_tpl.reader_fileExists () ;
        if (cond_4242.isBuiltAndTrue ()) {
          var_cas_tpl = GGS_string::constructor_stringWithContentsOfFile (inLexique, var_cas_targ_tpl COMMA_HERE) ;
        }else if (cond_4242.isBuiltAndFalse ()) {
          var_cas_targ_tpl = (var_cas_temp_dir).operator_concat (var_cas_temp_name) ;
          const GGS_bool cond_4410 = var_cas_targ_tpl.reader_fileExists () ;
          if (cond_4410.isBuiltAndTrue ()) {
            var_cas_tpl = GGS_string::constructor_stringWithContentsOfFile (inLexique, var_cas_targ_tpl COMMA_HERE) ;
          }else if (cond_4410.isBuiltAndFalse ()) {
...
GGS_string function_template_string (C_Compiler & inLexique,
  ...
  const GGS_bool cond_4937 = (var_cas_tpl).operator_isEqual (GGS_string ("")) ;
...
GGS_lstring  function_config_file (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  const GGS_bool cond_5193 = (var_cas_cfg.reader_fileExists ()).operator_not () ;
  if (cond_5193.isBuiltAndTrue ()) {
...
GGS_lstring  function_extra_config_file (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  const GGS_bool cond_5412 = (var_cas_cfg.reader_fileExists ()).operator_not () ;
...
void routine_prefix (C_Compiler & inLexique,
  ...
  if (temp_5598.isBuilt ()) {
    temp_5598 (HERE)->method_prefix (inLexique, var_cas_lkey, var_cas_val, automatic_var_0 COMMA_SOURCE_FILE_AT_LINE (179)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_performReplace (C_Compiler & inLexique,
  ...
  const GGS_prefix_map  temp_5820 = var_cas_p ;
  if (temp_5820.isBuilt ()) {
    temp_5820 (HERE)->method_prefix (inLexique, var_cas_lkey, var_cas_prefix, var_cas_tag_to_rep COMMA_SOURCE_FILE_AT_LINE (186)) ;
  }
...
void routine_do_replace_default (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_6210 = (var_cas_n).operator_isNotEqual (GGS_string ("")) ;
  if (cond_6210.isBuiltAndTrue ()) {
    var_cas_s = var_cas_s.reader_stringByReplacingStringByString (inLexique, var_cas_o, var_cas_n COMMA_SOURCE_FILE_AT_LINE (196)) ;
  }else if (cond_6210.isBuiltAndFalse ()) {
...
void routine_replace_no_prefix (C_Compiler & inLexique,
  ...
  const GGS_prefix_map  temp_6481 = var_cas_p ;
  if (temp_6481.isBuilt ()) {
    temp_6481 (HERE)->method_prefix (inLexique, var_cas_lkey, automatic_var_1, var_cas_tag_to_rep COMMA_SOURCE_FILE_AT_LINE (206)) ;
  }
...
void routine_table_core (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_6963 (var_cas_names, true) ;
    while (enumerator_6963.hasCurrentObject ()) {
      var_cas_header = (((((((var_cas_header).operator_concat (GGS_string ("#define "))).operator_concat (var_cas_varname)).operator_concat (GGS_string ("_id_of_"))).operator_concat (enumerator_6963._key (HERE))).operator_concat (GGS_string ("  "))).operator_concat (var_cas_n.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (227)))).operator_concat (GGS_string ("\n")) ;
      var_cas_header = (((((((var_cas_header).operator_concat (GGS_string ("#define "))).operator_concat (enumerator_6963._key (HERE))).operator_concat (GGS_string ("  "))).operator_concat (var_cas_varname)).operator_concat (GGS_string ("_id_of_"))).operator_concat (enumerator_6963._key (HERE))).operator_concat (GGS_string ("\n")) ;
      var_cas_implementation = (((((var_cas_implementation).operator_concat (GGS_string ("    (tpl_"))).operator_concat (var_cas_typename)).operator_concat (GGS_string (" *)&"))).operator_concat (var_cas_obj_prefix)).operator_concat (enumerator_6963._key (HERE)) ;
      var_cas_n.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (237)) ;
      const GGS_bool cond_7614 = (var_cas_n).operator_isNotEqual (var_cas_names.reader_count ()) ;
      if (cond_7614.isBuiltAndTrue ()) {
        var_cas_implementation = (var_cas_implementation).operator_concat (GGS_string (",\n")) ;
      }else if (cond_7614.isBuiltAndFalse ()) {
        var_cas_implementation = (var_cas_implementation).operator_concat (GGS_string ("\n")) ;
      }
      enumerator_6963.next () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_obj_table (C_Compiler & inLexique,
  ...
  var_cas_implementation = (var_cas_implementation).operator_concat (GGS_string ("};\n")) ;
  const GGS_bool cond_8496 = (var_cas_names.reader_count ()).operator_isEqual (GGS_uint (0U)) ;
  if (cond_8496.isBuiltAndTrue ()) {
...
void routine_additional_int_key_required (C_Compiler & inLexique,
  ...
  const GGS_bool cond_9349 = var_cas_others.reader_hasKey (var_cas_key) ;
  if (cond_9349.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_value ;
    const GGS_ident_map  temp_8846 = var_cas_others ;
    if (temp_8846.isBuilt ()) {
      temp_8846 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_key, GGS_location (inLexique) COMMA_HERE), var_cas_value COMMA_SOURCE_FILE_AT_LINE (280)) ;
    }
    { const GGS_basic_type _var_9333 = var_cas_value ; // CAST instruction
      if (_var_9333.getPtr () != NULL) {
        macroValidPointer (_var_9333.getPtr ()) ;
        if (typeid (cPtr_uint64_class) == typeid (* (_var_9333.getPtr ()))) {
          const GGS_uint64_class var_cas_v (_var_9333.getPtr ()) ;
        ...
        }else if (typeid (cPtr_uint32_class) == typeid (* (_var_9333.getPtr ()))) {
          const GGS_uint32_class var_cas_v (_var_9333.getPtr ()) ;
          var_cas_result = var_cas_v.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (285)) ;
        }else if (typeid (cPtr_void_uint32_class) == typeid (* (_var_9333.getPtr ()))) {
        ...
        }else if (typeid (cPtr_auto_uint32_class) == typeid (* (_var_9333.getPtr ()))) {
...
void routine_additional_string_key_required (C_Compiler & inLexique,
  ...
  const GGS_bool cond_9871 = var_cas_others.reader_hasKey (var_cas_key) ;
  if (cond_9871.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_value ;
    const GGS_ident_map  temp_9650 = var_cas_others ;
    if (temp_9650.isBuilt ()) {
      temp_9650 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_key, GGS_location (inLexique) COMMA_HERE), var_cas_value COMMA_SOURCE_FILE_AT_LINE (308)) ;
    }
    { const GGS_basic_type _var_9855 = var_cas_value ; // CAST instruction
      if (_var_9855.getPtr () != NULL) {
        macroValidPointer (_var_9855.getPtr ()) ;
        if (typeid (cPtr_string_class) == typeid (* (_var_9855.getPtr ()))) {
          const GGS_string_class var_cas_s (_var_9855.getPtr ()) ;
  ...
  }else if (cond_9871.isBuiltAndFalse ()) {
...
void routine_additional_bool_key_required (C_Compiler & inLexique,
  ...
  const GGS_bool cond_10405 = var_cas_others.reader_hasKey (var_cas_key) ;
  if (cond_10405.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_value ;
    const GGS_ident_map  temp_10185 = var_cas_others ;
    if (temp_10185.isBuilt ()) {
      temp_10185 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_key, GGS_location (inLexique) COMMA_HERE), var_cas_value COMMA_SOURCE_FILE_AT_LINE (330)) ;
    }
    { const GGS_basic_type _var_10389 = var_cas_value ; // CAST instruction
      if (_var_10389.getPtr () != NULL) {
        macroValidPointer (_var_10389.getPtr ()) ;
        if (typeid (cPtr_bool_class) == typeid (* (_var_10389.getPtr ()))) {
          const GGS_bool_class var_cas_b (_var_10389.getPtr ()) ;
  ...
  }else if (cond_10405.isBuiltAndFalse ()) {
...
void routine_add_to_stringset (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_10642 = var_cas_ss.reader_hasKey (var_cas_new) ;
  if (cond_10642.isBuiltAndTrue ()) {
  ...
  }else if (cond_10642.isBuiltAndFalse ()) {
...
void routine_file_in_path (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_10961 (var_cas_path_list, true) ;
    const GGS_stringlist::cElement * operand_10961 = NULL ;
    while (((operand_10961 = enumerator_10961.nextObject ()))) {
      macroValidPointer (operand_10961) ;
      GGS_string var_cas_full_file_path = operand_10961->mValue ;
      const GGS_bool cond_11222 = (var_cas_full_file_path).operator_isNotEqual (GGS_string ("")) ;
      if (cond_11222.isBuiltAndTrue ()) {
        const GGS_bool cond_11205 = (var_cas_full_file_path.reader_characterAtIndex (inLexique, var_cas_full_file_path.reader_length ().substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (362)) COMMA_SOURCE_FILE_AT_LINE (362))).operator_isNotEqual (GGS_char (TO_UNICODE ('/'))) ;
      ...
      const GGS_bool cond_11432 = (var_cas_full_file_path.reader_fileExists ()).operator_and (var_cas_not_found) ;
      if (cond_11432.isBuiltAndTrue ()) {
...
void routine_is_in_lstringlist (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_11631 (var_cas_l, true) ;
    const GGS_lstringlist::cElement * operand_11631 = NULL ;
    while (((operand_11631 = enumerator_11631.nextObject ()))) {
      macroValidPointer (operand_11631) ;
      const GGS_bool cond_11725 = (operand_11631->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (383))).operator_isEqual (var_cas_e.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (383))) ;
      if (cond_11725.isBuiltAndTrue ()) {
        var_cas_p = GGS_bool (true) ;
        var_cas_f = operand_11631->mValue ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_bool function_isInLstringlist (C_Compiler & inLexique,
  ...
  var_cas_p = GGS_bool (false) ;
  {
    GGS_lstringlist::cEnumerator enumerator_11869 (var_cas_l, true) ;
    const GGS_lstringlist::cElement * operand_11869 = NULL ;
    while (((operand_11869 = enumerator_11869.nextObject ()))) {
      macroValidPointer (operand_11869) ;
      const GGS_bool cond_11948 = (operand_11869->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (397))).operator_isEqual (var_cas_e.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (397))) ;
      if (cond_11948.isBuiltAndTrue ()) {
        var_cas_p = GGS_bool (true) ;
      }
    }
  }
...
void routine_add_lstring_unique (C_Compiler & inLexique,
  ...
  ::routine_is_in_lstringlist (inLexique,  var_cas_l,  var_cas_e,  var_cas_res,  var_cas_found COMMA_SOURCE_FILE_AT_LINE (410)) ;
  const GGS_bool cond_12254 = var_cas_found ;
  if (cond_12254.isBuiltAndTrue ()) {
    var_cas_e.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (((var_cas_att).operator_concat (GGS_string (" "))).operator_concat (var_cas_e.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (412)))).operator_concat (GGS_string (" has already be listed")) COMMA_SOURCE_FILE_AT_LINE (413)) ;
    var_cas_res.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was listed here") COMMA_SOURCE_FILE_AT_LINE (414)) ;
  }else if (cond_12254.isBuiltAndFalse ()) {
...
void routine_set_lstring_if_empty (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_12418 = (var_cas_s.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (424))).operator_isEqual (GGS_string ("")) ;
  if (cond_12418.isBuiltAndTrue ()) {
    var_cas_s = var_cas_ns ;
  }else if (cond_12418.isBuiltAndFalse ()) {
    var_cas_ns.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (var_cas_att).operator_concat (GGS_string (" Redefinition")) COMMA_SOURCE_FILE_AT_LINE (428)) ;
    var_cas_s.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (429)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_add_makefile_flag_if_not_empty (C_Compiler &,
  ...
  #endif
  const GGS_bool cond_12707 = (var_cas_flag_value).operator_isNotEqual (GGS_string ("")) ;
  if (cond_12707.isBuiltAndTrue ()) {
