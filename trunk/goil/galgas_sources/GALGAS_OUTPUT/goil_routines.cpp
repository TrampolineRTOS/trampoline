...
GGS_string function_templateFilePath (C_Compiler & inLexique,
  ...
  GGS_uint _variant_5983 = var_cas_components.reader_length () ;
  GGS_bool _condition_5983 (_variant_5983.isBuilt (), true) ;
  while (_condition_5983.isBuiltAndTrue ()) {
    _condition_5983 = (var_cas_notFound).operator_and ((var_cas_components.reader_length ()).operator_strictSup (GGS_uint (0U))) ;
    if (_condition_5983.isBuiltAndTrue ()) {
      if (_variant_5983.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (182)) ;
        _condition_5983 = GGS_bool (false) ;
      }else{
        _variant_5983.decrement_operation (inLexique COMMA_HERE) ;
        ...
        const GGS_bool cond_5942 = var_cas_targetPath.reader_fileExists () ;
        if (cond_5942.isBuiltAndTrue ()) {
          var_cas_notFound = GGS_bool (false) ;
          var_cas_path = var_cas_targetPath ;
        }
        GGS_string automatic_var_5976_0 ;
        var_cas_components.modifier_popLast (inLexique, automatic_var_5976_0 COMMA_SOURCE_FILE_AT_LINE (181)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_lstring  function_config_file (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  inLexique.printMessage (var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (188)) ;
...
GGS_lstring  function_extra_config_file (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  const GGS_bool cond_6341 = (var_cas_cfg.reader_fileExists ()).operator_not () ;
...
void routine_prefix (C_Compiler & inLexique,
  ...
  GGS_string automatic_var_6542_0 ;
  const GGS_prefix_map  temp_6527 = var_cas_p ;
  if (temp_6527.isBuilt ()) {
    temp_6527 (HERE)->method_prefix (inLexique, var_cas_lkey, var_cas_val, automatic_var_6542_0 COMMA_SOURCE_FILE_AT_LINE (203)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_performReplace (C_Compiler & inLexique,
  ...
  const GGS_prefix_map  temp_6749 = var_cas_p ;
  if (temp_6749.isBuilt ()) {
    temp_6749 (HERE)->method_prefix (inLexique, var_cas_lkey, var_cas_prefix, var_cas_tag_to_rep COMMA_SOURCE_FILE_AT_LINE (210)) ;
  }
...
void routine_do_replace_default (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_7139 = (var_cas_n).operator_isNotEqual (GGS_string ("")) ;
  if (cond_7139.isBuiltAndTrue ()) {
    var_cas_s = var_cas_s.reader_stringByReplacingStringByString (inLexique, var_cas_o, var_cas_n COMMA_SOURCE_FILE_AT_LINE (220)) ;
  }else if (cond_7139.isBuiltAndFalse ()) {
...
void routine_replace_no_prefix (C_Compiler & inLexique,
  ...
  GGS_lstring  var_cas_lkey = GGS_lstring ::constructor_new (inLexique, var_cas_key, GGS_location (inLexique) COMMA_HERE) ;
  GGS_string var_cas_tag_to_rep ;
  GGS_string automatic_var_7432_0 ;
  const GGS_prefix_map  temp_7410 = var_cas_p ;
  if (temp_7410.isBuilt ()) {
    temp_7410 (HERE)->method_prefix (inLexique, var_cas_lkey, automatic_var_7432_0, var_cas_tag_to_rep COMMA_SOURCE_FILE_AT_LINE (230)) ;
  }
...
void routine_table_core (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_7892 (var_cas_names, true) ;
    while (enumerator_7892.hasCurrentObject ()) {
      var_cas_header = (((((((var_cas_header).operator_concat (GGS_string ("#define "))).operator_concat (var_cas_varname)).operator_concat (GGS_string ("_id_of_"))).operator_concat (enumerator_7892._key (HERE))).operator_concat (GGS_string ("  "))).operator_concat (var_cas_n.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (251)))).operator_concat (GGS_string ("\n")) ;
      var_cas_header = (((((((var_cas_header).operator_concat (GGS_string ("#define "))).operator_concat (enumerator_7892._key (HERE))).operator_concat (GGS_string ("  "))).operator_concat (var_cas_varname)).operator_concat (GGS_string ("_id_of_"))).operator_concat (enumerator_7892._key (HERE))).operator_concat (GGS_string ("\n")) ;
      var_cas_implementation = (((((var_cas_implementation).operator_concat (GGS_string ("    (tpl_"))).operator_concat (var_cas_typename)).operator_concat (GGS_string (" *)&"))).operator_concat (var_cas_obj_prefix)).operator_concat (enumerator_7892._key (HERE)) ;
      var_cas_n.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (261)) ;
      const GGS_bool cond_8543 = (var_cas_n).operator_isNotEqual (var_cas_names.reader_count ()) ;
      if (cond_8543.isBuiltAndTrue ()) {
        var_cas_implementation = (var_cas_implementation).operator_concat (GGS_string (",\n")) ;
      }else if (cond_8543.isBuiltAndFalse ()) {
        var_cas_implementation = (var_cas_implementation).operator_concat (GGS_string ("\n")) ;
      }
      enumerator_7892.next () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_add_to_stringset (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_11666 = var_cas_ss.reader_hasKey (var_cas_new) ;
  if (cond_11666.isBuiltAndTrue ()) {
  ...
  }else if (cond_11666.isBuiltAndFalse ()) {
...
void routine_file_in_path (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_11985 (var_cas_path_list, true) ;
    const GGS_stringlist::cElement * operand_11985 = NULL ;
    while (((operand_11985 = enumerator_11985.nextObject ()))) {
      macroValidPointer (operand_11985) ;
      GGS_string var_cas_full_file_path = operand_11985->mValue ;
      const GGS_bool cond_12246 = (var_cas_full_file_path).operator_isNotEqual (GGS_string ("")) ;
      if (cond_12246.isBuiltAndTrue ()) {
        const GGS_bool cond_12229 = (var_cas_full_file_path.reader_characterAtIndex (inLexique, var_cas_full_file_path.reader_length ().substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (386)) COMMA_SOURCE_FILE_AT_LINE (386))).operator_isNotEqual (GGS_char (TO_UNICODE ('/'))) ;
      ...
      const GGS_bool cond_12456 = (var_cas_full_file_path.reader_fileExists ()).operator_and (var_cas_not_found) ;
      if (cond_12456.isBuiltAndTrue ()) {
...
void routine_is_in_lstringlist (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_12655 (var_cas_l, true) ;
    const GGS_lstringlist::cElement * operand_12655 = NULL ;
    while (((operand_12655 = enumerator_12655.nextObject ()))) {
      macroValidPointer (operand_12655) ;
      const GGS_bool cond_12749 = (operand_12655->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (407))).operator_isEqual (var_cas_e.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (407))) ;
      if (cond_12749.isBuiltAndTrue ()) {
        var_cas_p = GGS_bool (true) ;
        var_cas_f = operand_12655->mValue ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_bool function_isInLstringlist (C_Compiler & inLexique,
  ...
  var_cas_p = GGS_bool (false) ;
  {
    GGS_lstringlist::cEnumerator enumerator_12893 (var_cas_l, true) ;
    const GGS_lstringlist::cElement * operand_12893 = NULL ;
    while (((operand_12893 = enumerator_12893.nextObject ()))) {
      macroValidPointer (operand_12893) ;
      const GGS_bool cond_12972 = (operand_12893->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (421))).operator_isEqual (var_cas_e.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (421))) ;
...
void routine_add_lstring_unique (C_Compiler & inLexique,
  ...
  const GGS_bool cond_13278 = var_cas_found ;
  ...
  }else if (cond_13278.isBuiltAndFalse ()) {
...
void routine_set_lstring_if_empty (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_13442 = (var_cas_s.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (448))).operator_isEqual (GGS_string ("")) ;
  if (cond_13442.isBuiltAndTrue ()) {
    var_cas_s = var_cas_ns ;
  }else if (cond_13442.isBuiltAndFalse ()) {
...
void routine_add_makefile_flag_if_not_empty (C_Compiler &,
  ...
  #endif
  const GGS_bool cond_13731 = (var_cas_flag_value).operator_isNotEqual (GGS_string ("")) ;
  if (cond_13731.isBuiltAndTrue ()) {
...
GGS_string function_stripString (C_Compiler & inLexique,
  ...
  const GGS_bool cond_14720 = (var_cas_s.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_14720.isBuiltAndTrue ()) {
    ...
    GGS_uint _variant_14271 = var_cas_s.reader_length () ;
    GGS_bool _condition_14271 (_variant_14271.isBuilt (), true) ;
    while (_condition_14271.isBuiltAndTrue ()) {
      _condition_14271 = (var_cas_finished).operator_not () ;
      if (_condition_14271.isBuiltAndTrue ()) {
        if (_variant_14271.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (482)) ;
          _condition_14271 = GGS_bool (false) ;
        }else{
          _variant_14271.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_14236 = (var_cas_s.reader_characterAtIndex (inLexique, var_cas_first COMMA_SOURCE_FILE_AT_LINE (478))).operator_isEqual (GGS_char (TO_UNICODE (' '))) ;
          if (cond_14236.isBuiltAndTrue ()) {
            var_cas_first.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (479)) ;
            const GGS_bool cond_14221 = (var_cas_first).operator_isEqual (var_cas_s.reader_length ()) ;
            if (cond_14221.isBuiltAndTrue ()) {
              var_cas_finished = GGS_bool (true) ;
            }
          }else if (cond_14236.isBuiltAndFalse ()) {
            var_cas_finished = GGS_bool (true) ;
          }
        }
      }
    ...
    GGS_uint _variant_14568 = var_cas_s.reader_length () ;
    GGS_bool _condition_14568 (_variant_14568.isBuilt (), true) ;
    while (_condition_14568.isBuiltAndTrue ()) {
      _condition_14568 = (var_cas_finished).operator_not () ;
      if (_condition_14568.isBuiltAndTrue ()) {
        if (_variant_14568.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (491)) ;
          _condition_14568 = GGS_bool (false) ;
        }else{
          _variant_14568.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_14533 = (var_cas_s.reader_characterAtIndex (inLexique, var_cas_last.substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (487)) COMMA_SOURCE_FILE_AT_LINE (487))).operator_isEqual (GGS_char (TO_UNICODE (' '))) ;
          if (cond_14533.isBuiltAndTrue ()) {
            var_cas_last.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (488)) ;
            const GGS_bool cond_14518 = (var_cas_last).operator_isEqual (GGS_uint (0U)) ;
            if (cond_14518.isBuiltAndTrue ()) {
              var_cas_finished = GGS_bool (true) ;
            }
          }else if (cond_14533.isBuiltAndFalse ()) {
            var_cas_finished = GGS_bool (true) ;
          }
        }
      }
    }
    const GGS_bool cond_14686 = (var_cas_first).operator_strictInf (var_cas_last) ;
    if (cond_14686.isBuiltAndTrue ()) {
    ...
    }else if (cond_14686.isBuiltAndFalse ()) {
...
void routine_errorNoFileFound (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_14979 (var_cas_searchedPaths, true) ;
    const GGS_stringlist::cElement * operand_14979 = NULL ;
    while (((operand_14979 = enumerator_14979.nextObject ()))) {
      macroValidPointer (operand_14979) ;
      var_cas_m.appendCString ("\n"
        "  - '") ;
      var_cas_m.dotAssign_operation (operand_14979->mValue) ;
      var_cas_m.appendCString ("'") ;
    }
  }
