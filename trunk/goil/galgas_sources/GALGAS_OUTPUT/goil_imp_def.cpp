...
pr_impl_attr_def_goil_imp_def_151_20_ (goil_lexique & inLexique,
  ...
  { const GGS_uint32_class _var_5073 = var_cas_default_number ; // CAST instruction
    if (_var_5073.getPtr () != NULL) {
      macroValidPointer (_var_5073.getPtr ()) ;
      if (typeid (cPtr_uint32_class) == typeid (* (_var_5073.getPtr ()))) {
        const GGS_uint32_class var_cas_dn (_var_5073.getPtr ()) ;
