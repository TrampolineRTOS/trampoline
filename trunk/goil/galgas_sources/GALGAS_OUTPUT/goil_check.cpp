  ...
  { const GGS_uint32_set _var_1236 = var_cas_set ; // CAST instruction
    if (_var_1236.getPtr () != NULL) {
      ...
      if (typeid (cPtr_uint32_range) == typeid (* (_var_1236.getPtr ()))) {
        ...
        if ((((var_cas_val).operator_strictInf (var_cas_r.reader_min (inLexique COMMA_SOURCE_FILE_AT_LINE (38)))).operator_or ((var_cas_val).operator_strictSup (var_cas_r.reader_max (inLexique COMMA_SOURCE_FILE_AT_LINE (38))))).isBuiltAndTrue ()) {
        ...
        var_cas_not_matched = GGS_bool (true) ;
        {
          ...
          while (((operand_913 = enumerator_913.nextObject ()))) {
            ...
            if (((var_cas_val).operator_isEqual (operand_913->val)).isBuiltAndTrue ()) {
