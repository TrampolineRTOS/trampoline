...
void routine_generate_memmap_new (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_cc = var_cas_cfg.reader_compilerKind (inLexique COMMA_SOURCE_FILE_AT_LINE (413)) ;
  const GGS_bool cond_17836 = (var_cas_cc.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (415))).operator_isNotEqual (GGS_string ("")) ;
  if (cond_17836.isBuiltAndTrue ()) {
    GGS_string var_cas_mm = function_goil_template (inLexique, (GGS_string ("compiler/")).operator_concat (var_cas_cc.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (416))), var_cas_cfg, GGS_string ("MemMap.h") COMMA_SOURCE_FILE_AT_LINE (416)) ;
...
void routine_generate_compiler (C_Compiler & inLexique,
  ...
  const GGS_bool cond_18614 = (var_cas_cc).operator_isNotEqual (GGS_string ("")) ;
  if (cond_18614.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_18604 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
    if (cond_18604.isBuiltAndTrue ()) {
      const GGS_bool cond_18365 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
      if (cond_18365.isBuiltAndTrue ()) {
      ...
      const GGS_string temp_18409 = var_cas_comp ;
      if (temp_18409.isBuilt ()) {
        temp_18409 (HERE)->method_makeDirectoryAndWriteToFile (inLexique, var_cas_comp_file COMMA_SOURCE_FILE_AT_LINE (435)) ;
      }
      const GGS_bool cond_18531 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
      ...
      const GGS_string temp_18579 = var_cas_comp_cfg ;
      if (temp_18579.isBuilt ()) {
        temp_18579 (HERE)->method_makeDirectoryAndWriteToFile (inLexique, var_cas_comp_cfg_file COMMA_SOURCE_FILE_AT_LINE (439)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
