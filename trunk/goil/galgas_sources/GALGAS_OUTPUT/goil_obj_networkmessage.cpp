...
pr_ipdu_ref_goil_obj_networkmessage_92_15_ (goil_lexique & inLexique,
  ...
  inLexique._assignFromAttribute_att_token (var_cas_ip) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
  ...
  { const GGS_basic_type _var_5351 = var_cas_initialvalue ; // CAST instruction
    if (_var_5351.getPtr () != NULL) {
      ...
      if (typeid (cPtr_uint64_class) == typeid (* (_var_5351.getPtr ()))) {
        ...
        var_cas_iv = GGS_luint64 ::constructor_new (inLexique, GGS_uint64 (0U), GGS_location (inLexique) COMMA_HERE) ;
      }
    }
  }
...
pr_sizeinbits_goil_obj_networkmessage_255_17_ (goil_lexique & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
  inLexique._assignFromAttribute_integerNumber (var_cas_sib) ;
...
pr_maxsizeinbits_goil_obj_networkmessage_264_20_ (goil_lexique & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
  inLexique._assignFromAttribute_integerNumber (var_cas_msib) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
...
pr_bitposition_goil_obj_networkmessage_286_18_ (goil_lexique & inLexique,
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
  inLexique._assignFromAttribute_integerNumber (var_cas_bp) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
