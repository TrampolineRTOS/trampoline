...
pr_networkmess_goil_obj_networkmessage_55_18_ (goil_lexique & _inLexique,
  ...
  var_cas_nm = GGS_netmess_obj ::constructor_new (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (""), GGS_location (_inLexique) COMMA_HERE), var_cas_ipdu, var_cas_netprop COMMA_HERE) ;
...
pr_ipdu_ref_goil_obj_networkmessage_92_15_ (goil_lexique & _inLexique,
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
  if (((var_cas_ipdu.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (97)))._operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("IPDU is already defined for this network message") COMMA_SOURCE_FILE_AT_LINE (99)) ;
    var_cas_ipdu.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("wad defined here") COMMA_SOURCE_FILE_AT_LINE (100)) ;
  }else{
  ...
  { const GGS_base_netprop _var_3023 = var_cas_netprop ; // CAST instruction
    if (_var_3023.getPtr () != NULL) {
      ...
      if (typeid (cPtr_void_netprop) == typeid (* (_var_3023.getPtr ()))) {
        ...
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("MESSAGEPROPERTY is already defined") COMMA_SOURCE_FILE_AT_LINE (133)) ;
        var_cas_netprop.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (133)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (134)) ;
      }
    }
  }
...
pr_static_mp_goil_obj_networkmessage_138_16_ (goil_lexique & _inLexique,
  ...
  var_cas_sizeinbits = GGS_lsint ::constructor_new (_inLexique, GGS_sint (1L)._operator_unary_minus (_inLexique COMMA_HERE), GGS_location (_inLexique) COMMA_HERE) ;
  GGS_lstring  var_cas_bitordering ;
  var_cas_bitordering = GGS_lstring ::constructor_new (_inLexique, GGS_string (""), GGS_location (_inLexique) COMMA_HERE) ;
  GGS_lsint  var_cas_bitposition ;
  var_cas_bitposition = GGS_lsint ::constructor_new (_inLexique, GGS_sint (1L)._operator_unary_minus (_inLexique COMMA_HERE), GGS_location (_inLexique) COMMA_HERE) ;
  GGS_lstring  var_cas_datainterpretation ;
  var_cas_datainterpretation = GGS_lstring ::constructor_new (_inLexique, GGS_string (""), GGS_location (_inLexique) COMMA_HERE) ;
  ...
  var_cas_direction = GGS_lstring ::constructor_new (_inLexique, GGS_string (""), GGS_location (_inLexique) COMMA_HERE) ;
    ...
    while (syntaxRepeat_2) {
      switch (select_repeat_goil_obj_networkmessage_2 (_inLexique)) {
        case 2 : {
          ...
          if (((var_cas_sizeinbits.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (154)))._operator_isEqual (GGS_sint (1L)._operator_unary_minus (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
            ...
            var_cas_sib.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("SIZEINBITS is already defined") COMMA_SOURCE_FILE_AT_LINE (158)) ;
            var_cas_sizeinbits.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (159)) ;
          }
          } break ;
        case 3 : {
          GGS_lstring  var_cas_bo ;
          nt_bitordering_ (_inLexique, var_cas_bo) ;
          if (((var_cas_bitordering.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (164)))._operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
            var_cas_bitordering = var_cas_bo ;
          }else{
            var_cas_bo.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("BITORDERING is already defined") COMMA_SOURCE_FILE_AT_LINE (168)) ;
            var_cas_bitordering.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was define here") COMMA_SOURCE_FILE_AT_LINE (169)) ;
          }
          } break ;
        case 4 : {
          GGS_luint64  var_cas_bp ;
          nt_bitposition_ (_inLexique, var_cas_bp) ;
          if (((var_cas_bitposition.reader_sint (_inLexique COMMA_SOURCE_FILE_AT_LINE (174)))._operator_isEqual (GGS_sint (1L)._operator_unary_minus (_inLexique COMMA_HERE))).isBuiltAndTrue ()) {
            ...
            var_cas_bp.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("BITPOSITION is already defined") COMMA_SOURCE_FILE_AT_LINE (178)) ;
            var_cas_bitposition.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (179)) ;
          }
          } break ;
        case 5 : {
          GGS_lstring  var_cas_di ;
          nt_datainterpretation_ (_inLexique, var_cas_di) ;
          if (((var_cas_datainterpretation.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (184)))._operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
            var_cas_datainterpretation = var_cas_di ;
          }else{
            var_cas_di.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("DATAINTERPRETATION is already defined") COMMA_SOURCE_FILE_AT_LINE (188)) ;
            var_cas_datainterpretation.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was define here") COMMA_SOURCE_FILE_AT_LINE (189)) ;
          }
          } break ;
        case 6 : {
          ...
          { const GGS_basic_type _var_4782 = var_cas_initialvalue ; // CAST instruction
            if (_var_4782.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void) == typeid (* (_var_4782.getPtr ()))) {
                ...
                var_cas_iv.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (197)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("INITIALVALUE already defined") COMMA_SOURCE_FILE_AT_LINE (198)) ;
                var_cas_initialvalue.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (198)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (199)) ;
              }
            }
          }
          } break ;
        case 7 : {
          GGS_lstring  var_cas_dir ;
          nt_direction_ (_inLexique, var_cas_dir) ;
          if (((var_cas_direction.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (204)))._operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
            var_cas_direction = var_cas_dir ;
          }else{
            var_cas_dir.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("DIRECTION is already defined") COMMA_SOURCE_FILE_AT_LINE (208)) ;
            var_cas_direction.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was define here") COMMA_SOURCE_FILE_AT_LINE (209)) ;
          }
          } break ;
        default :
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
  if (((var_cas_direction.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (215)))._operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("DIRECTION attribute is missing") COMMA_SOURCE_FILE_AT_LINE (217)) ;
  }
  ...
  { const GGS_basic_type _var_5351 = var_cas_initialvalue ; // CAST instruction
    if (_var_5351.getPtr () != NULL) {
      ...
      if (typeid (cPtr_uint64_class) == typeid (* (_var_5351.getPtr ()))) {
        ...
        var_cas_iv = GGS_luint64 ::constructor_new (_inLexique, GGS_uint64 (0U), GGS_location (_inLexique) COMMA_HERE) ;
      }
    }
  }
...
pr_dynamic_mp_goil_obj_networkmessage_239_17_ (goil_lexique & _inLexique,
                                GGS_base_netprop  &var_cas_netprop) {
  GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("DYNAMIC network messages are not supported") COMMA_SOURCE_FILE_AT_LINE (243)) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7B) COMMA_HERE) ;
...
pr_bitordering_goil_obj_networkmessage_273_18_ (goil_lexique & _inLexique,
  ...
  switch (select_goil_obj_networkmessage_4 (_inLexique)) {
    case 1 : {
      ...
      var_cas_bo = GGS_lstring ::constructor_new (_inLexique, GGS_string ("big"), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_LITTLEENDIAN) COMMA_HERE) ;
      var_cas_bo = GGS_lstring ::constructor_new (_inLexique, GGS_string ("little"), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
...
pr_datainterpretation_goil_obj_networkmessage_295_25_ (goil_lexique & _inLexique,
  ...
  switch (select_goil_obj_networkmessage_5 (_inLexique)) {
    case 1 : {
      ...
      var_cas_di = GGS_lstring ::constructor_new (_inLexique, GGS_string ("unsignedinteger"), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_BYTEARRAY) COMMA_HERE) ;
      var_cas_di = GGS_lstring ::constructor_new (_inLexique, GGS_string ("bytearray"), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
...
pr_direction_goil_obj_networkmessage_308_16_ (goil_lexique & _inLexique,
  ...
  switch (select_goil_obj_networkmessage_6 (_inLexique)) {
    case 1 : {
      ...
      var_cas_dir = GGS_lstring ::constructor_new (_inLexique, GGS_string ("sent"), GGS_location (_inLexique) COMMA_HERE) ;
    ...
    case 2 : {
      ...
      var_cas_dir = GGS_lstring ::constructor_new (_inLexique, GGS_string ("received"), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
