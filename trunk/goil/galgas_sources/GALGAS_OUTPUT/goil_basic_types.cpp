...
void routine_get_bool (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_basic_type _var_7758 = var_cas_t ; // CAST instruction
    if (_var_7758.getPtr () != NULL) {
      macroValidPointer (_var_7758.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_7758.getPtr ()))) {
        const GGS_bool_class var_cas_bc (_var_7758.getPtr ()) ;
...
GGS_string function_bool_define (C_Compiler & _inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  { const GGS_basic_type _var_8234 = var_cas_t ; // CAST instruction
    if (_var_8234.getPtr () != NULL) {
      macroValidPointer (_var_8234.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_8234.getPtr ()))) {
      ...
      }else if (typeid (cPtr_bool_class) == typeid (* (_var_8234.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_8234.getPtr ()) ;
...
void routine_bool_flag (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_basic_type _var_8637 = var_cas_b ; // CAST instruction
    if (_var_8637.getPtr () != NULL) {
      macroValidPointer (_var_8637.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_8637.getPtr ()))) {
      }else if (typeid (cPtr_bool_class) == typeid (* (_var_8637.getPtr ()))) {
        const GGS_bool_class var_cas_bo (_var_8637.getPtr ()) ;
