  ...
  { const GGS_basic_type _var_7575 = var_cas_t ; // CAST instruction
    if (_var_7575.getPtr () != NULL) {
      ...
      if (typeid (cPtr_bool_class) == typeid (* (_var_7575.getPtr ()))) {
        var_cas_b.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Redefinition of "))._operator_concat (var_cas_att) COMMA_SOURCE_FILE_AT_LINE (304)) ;
        var_cas_t.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (304)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (305)) ;
      }else{
...
GGS_string function_bool_define (C_Compiler & _inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  var_cas_res = ((((GGS_string ("#define    "))._operator_concat (var_cas_flag))._operator_concat (GGS_string ("    ")))._operator_concat (function_yes_no (_inLexique, var_cas_b COMMA_SOURCE_FILE_AT_LINE (332))))._operator_concat (GGS_string ("\n")) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_string function_bool_class_define (C_Compiler & _inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  { const GGS_basic_type _var_8274 = var_cas_t ; // CAST instruction
    if (_var_8274.getPtr () != NULL) {
      macroValidPointer (_var_8274.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_8274.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_8274.getPtr ()) ;
        var_cas_res = function_bool_define (_inLexique, var_cas_flag, var_cas_b.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (343)) COMMA_SOURCE_FILE_AT_LINE (343)) ;
      }else{
        var_cas_res = function_bool_define (_inLexique, var_cas_flag, var_cas_def COMMA_SOURCE_FILE_AT_LINE (345)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_bool_flag (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_basic_type _var_8677 = var_cas_b ; // CAST instruction
    if (_var_8677.getPtr () != NULL) {
      macroValidPointer (_var_8677.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_8677.getPtr ()))) {
      }else if (typeid (cPtr_bool_class) == typeid (* (_var_8677.getPtr ()))) {
        const GGS_bool_class var_cas_bo (_var_8677.getPtr ()) ;
        if ((var_cas_bo.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (358))).isBuiltAndTrue ()) {
          var_cas_res.appendCString ("#define ") ;
          var_cas_res._dotAssign_operation (var_cas_flag) ;
          var_cas_res.appendCString ("\n") ;
        }
      }else{
        var_cas_b.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (364)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Internal error, wrong datatype") COMMA_SOURCE_FILE_AT_LINE (365)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
