...
void routine_set_uint32 (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_7041 = var_cas_t ; // CAST instruction
    if (_var_7041.getPtr () != NULL) {
      macroValidPointer (_var_7041.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_7041.getPtr ()))) {
        ...
        var_cas_i.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("Redefinition of ")).operator_concat (var_cas_att) COMMA_SOURCE_FILE_AT_LINE (299)) ;
...
void routine_set_uint64 (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_7643 = var_cas_t ; // CAST instruction
    if (_var_7643.getPtr () != NULL) {
      macroValidPointer (_var_7643.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_7643.getPtr ()))) {
        ...
        var_cas_i.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("Redefinition of ")).operator_concat (var_cas_att) COMMA_SOURCE_FILE_AT_LINE (323)) ;
...
void routine_set_lstring (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_8254 = var_cas_t ; // CAST instruction
    if (_var_8254.getPtr () != NULL) {
      macroValidPointer (_var_8254.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_8254.getPtr ()))) {
        ...
        var_cas_s.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("Redefinition of ")).operator_concat (var_cas_att) COMMA_SOURCE_FILE_AT_LINE (347)) ;
...
void routine_set_bool (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_8845 = var_cas_t ; // CAST instruction
    if (_var_8845.getPtr () != NULL) {
      macroValidPointer (_var_8845.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_8845.getPtr ()))) {
...
GGS_bool function_get_bool (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_b ;
  { const GGS_basic_type _var_9032 = var_cas_t ; // CAST instruction
    if (_var_9032.getPtr () != NULL) {
      macroValidPointer (_var_9032.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_9032.getPtr ()))) {
        const GGS_bool_class var_cas_bc (_var_9032.getPtr ()) ;
...
GGS_string function_bool_class_define (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  { const GGS_basic_type _var_9544 = var_cas_t ; // CAST instruction
    if (_var_9544.getPtr () != NULL) {
      macroValidPointer (_var_9544.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_9544.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_9544.getPtr ()) ;
...
void routine_bool_flag (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_9947 = var_cas_b ; // CAST instruction
    if (_var_9947.getPtr () != NULL) {
      macroValidPointer (_var_9947.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_9947.getPtr ()))) {
      }else if (typeid (cPtr_bool_class) == typeid (* (_var_9947.getPtr ()))) {
        const GGS_bool_class var_cas_bo (_var_9947.getPtr ()) ;
...
void routine_p_bt (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  const GGS_basic_type  temp_10031 = var_cas_bt ;
  if (temp_10031.isBuilt ()) {
    temp_10031 (HERE)->method_string (inLexique, var_cas_res COMMA_SOURCE_FILE_AT_LINE (437)) ;
  }
