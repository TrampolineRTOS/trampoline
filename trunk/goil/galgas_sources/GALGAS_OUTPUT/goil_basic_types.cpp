  ...
  { const GGS_basic_type _var_1870 = var_cas_t ; // CAST instruction
    if (_var_1870.getPtr () != NULL) {
      ...
      if (typeid (cPtr_uint64_class) == typeid (* (_var_1870.getPtr ()))) {
        ...
        var_cas_v = GGS_luint64 ::constructor_new (inLexique, var_cas_ui.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (93)), var_cas_ui.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (93)) COMMA_HERE) ;
      }else{
        var_cas_v = GGS_luint64 ::constructor_new (inLexique, GGS_uint64 (0ULL), GGS_location (inLexique) COMMA_HERE) ;
...
void routine_set_uint32 (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_7480 = var_cas_t ; // CAST instruction
    if (_var_7480.getPtr () != NULL) {
      macroValidPointer (_var_7480.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_7480.getPtr ()))) {
        var_cas_t = GGS_uint32_class ::constructor_new (inLexique, var_cas_i.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (313)), var_cas_i.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (313)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (313)) COMMA_HERE) ;
      }else{
...
void routine_set_uint64 (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_8079 = var_cas_t ; // CAST instruction
    if (_var_8079.getPtr () != NULL) {
      macroValidPointer (_var_8079.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_8079.getPtr ()))) {
        var_cas_t = GGS_uint64_class ::constructor_new (inLexique, var_cas_i.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (337)), var_cas_i.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (337)) COMMA_HERE) ;
      }else{
...
void routine_set_lstring (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_8685 = var_cas_t ; // CAST instruction
    if (_var_8685.getPtr () != NULL) {
      macroValidPointer (_var_8685.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_8685.getPtr ()))) {
        var_cas_t = GGS_string_class ::constructor_new (inLexique, var_cas_s.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (361)), var_cas_s.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (361)) COMMA_HERE) ;
      }else{
...
void routine_set_bool (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_9276 = var_cas_t ; // CAST instruction
    if (_var_9276.getPtr () != NULL) {
      ...
      if (typeid (cPtr_bool_class) == typeid (* (_var_9276.getPtr ()))) {
        ...
        var_cas_t = GGS_bool_class ::constructor_new (inLexique, var_cas_b.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (388)), var_cas_b.reader_bool (inLexique COMMA_SOURCE_FILE_AT_LINE (388)) COMMA_HERE) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_bool function_getBool (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_b ;
  { const GGS_basic_type _var_9462 = var_cas_t ; // CAST instruction
    if (_var_9462.getPtr () != NULL) {
      macroValidPointer (_var_9462.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_9462.getPtr ()))) {
        const GGS_bool_class var_cas_bc (_var_9462.getPtr ()) ;
...
GGS_string function_yes_no (C_Compiler &,
  ...
  const GGS_bool cond_9557 = var_cas_b ;
  if (cond_9557.isBuiltAndTrue ()) {
    var_cas_res = GGS_string ("YES") ;
  }else if (cond_9557.isBuiltAndFalse ()) {
...
GGS_string function_true_false (C_Compiler &,
  ...
  #endif
  GGS_string var_cas_res ;
  const GGS_bool cond_9671 = var_cas_b ;
...
GGS_string function_bool_class_define (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  { const GGS_basic_type _var_10232 = var_cas_t ; // CAST instruction
    if (_var_10232.getPtr () != NULL) {
      macroValidPointer (_var_10232.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_10232.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_10232.getPtr ()) ;
...
GGS_string function_bool_class_make_define (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  { const GGS_basic_type _var_10502 = var_cas_t ; // CAST instruction
    if (_var_10502.getPtr () != NULL) {
      macroValidPointer (_var_10502.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_10502.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_10502.getPtr ()) ;
...
void routine_bool_flag (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_10905 = var_cas_b ; // CAST instruction
    if (_var_10905.getPtr () != NULL) {
      macroValidPointer (_var_10905.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_10905.getPtr ()))) {
      }else if (typeid (cPtr_bool_class) == typeid (* (_var_10905.getPtr ()))) {
        const GGS_bool_class var_cas_bo (_var_10905.getPtr ()) ;
        const GGS_bool cond_10775 = var_cas_bo.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (466)) ;
...
void routine_p_bt (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  const GGS_basic_type  temp_10989 = var_cas_bt ;
  if (temp_10989.isBuilt ()) {
    temp_10989 (HERE)->method_string (inLexique, var_cas_res COMMA_SOURCE_FILE_AT_LINE (480)) ;
  }
...
GGS_luint64  function_luint64_value (C_Compiler & inLexique,
  ...
  #endif
  GGS_luint64  var_cas_v ;
  var_cas_v = GGS_luint64 ::constructor_new (inLexique, var_cas_c.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (488)), var_cas_c.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (488)) COMMA_HERE) ;
  #ifdef DEBUG_TRACE_ENABLED
