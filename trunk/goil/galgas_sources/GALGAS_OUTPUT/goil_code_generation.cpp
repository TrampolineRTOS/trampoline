...
void routine_generate_makefile (C_Compiler & inLexique,
  ...
  const GGS_bool cond_18019 = (var_cas_filename.reader_fileExists ()).operator_not () ;
...
void routine_generate_types (C_Compiler & inLexique,
  ...
  GGS_uint  var_cas_max_ev = GGS_uint (0U) ;
  {
    ...
    while (((operand_21326 = enumerator_21326.nextObject ()))) {
      ...
      const GGS_bool cond_21463 = (var_cas_evts.reader_length ()).operator_strictSup (var_cas_max_ev) ;
  ...
  const GGS_bool cond_22988 = (var_cas_alarms.reader_count ()).operator_strictSup (var_cas_schedtables.reader_count ()) ;
  ...
  GGS_string var_cas_alarms_result = GGS_string ("") ;
  {
    ...
    while (((operand_25147 = enumerator_25147.nextObject ()))) {
      ...
      if (cond_27760.isBuiltAndTrue ()) {
        const GGS_bool cond_27744 = (var_cas_app_for_obj.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
...
void routine_compute_actual_task_priority (C_Compiler & inLexique,
  ...
  const GGS_bool cond_30023 = (var_cas_tl.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
...
void routine_compute_actual_isr_priority (C_Compiler & inLexique,
  ...
  const GGS_bool cond_32717 = (var_cas_isrs.reader_count ()).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_32717.isBuiltAndTrue ()) {
    ...
    GGS_uint  var_cas_cur_rel_prio = GGS_uint (0U) ;
    const GGS_bool cond_32111 = (var_cas_il.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
    ...
    while (((operand_37919 = enumerator_37919.nextObject ()))) {
      ...
      GGS_string var_cas_app_name = operand_37919->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1049)) ;
      {
        ...
        while (((operand_37974 = enumerator_37974.nextObject ()))) {
          ...
          const GGS_bool cond_38094 = (var_cas_app_for_obj.reader_hasKey (operand_37974->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1051)))).operator_not () ;
      ...
      }
      {
        ...
        while (((operand_38129 = enumerator_38129.nextObject ()))) {
          ...
          const GGS_bool cond_38248 = (var_cas_app_for_obj.reader_hasKey (operand_38129->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1056)))).operator_not () ;
      ...
      }
      {
        ...
        while (((operand_38283 = enumerator_38283.nextObject ()))) {
          ...
          const GGS_bool cond_38404 = (var_cas_app_for_obj.reader_hasKey (operand_38283->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1061)))).operator_not () ;
      ...
      }
      {
        ...
        while (((operand_38439 = enumerator_38439.nextObject ()))) {
          ...
          const GGS_bool cond_38565 = (var_cas_app_for_obj.reader_hasKey (operand_38439->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1066)))).operator_not () ;
      ...
      }
      {
        ...
        while (((operand_38600 = enumerator_38600.nextObject ()))) {
          ...
          const GGS_bool cond_38723 = (var_cas_app_for_obj.reader_hasKey (operand_38600->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1071)))).operator_not () ;
      ...
      }
      {
        ...
        while (((operand_38758 = enumerator_38758.nextObject ()))) {
          ...
          const GGS_bool cond_38882 = (var_cas_app_for_obj.reader_hasKey (operand_38758->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1076)))).operator_not () ;
...
void routine_generate_tasks (C_Compiler & inLexique,
  ...
  GGS_bool var_cas_non_preemptable_exists = GGS_bool (false) ;
  {
    ...
    while (((operand_39681 = enumerator_39681.nextObject ()))) {
      ...
      const GGS_bool cond_40867 = (operand_39681->mInfo.task.reader_events (inLexique COMMA_SOURCE_FILE_AT_LINE (1126)).reader_length ()).operator_isEqual (GGS_uint (0U)) ;
      ...
      if (cond_44823.isBuiltAndTrue ()) {
        const GGS_bool cond_44736 = (var_cas_app_for_obj.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
  ...
  GGS_string var_cas_isrs_result = GGS_string ("") ;
  {
    ...
    while (((operand_46309 = enumerator_46309.nextObject ()))) {
      ...
      if (cond_48347.isBuiltAndTrue ()) {
        const GGS_bool cond_48331 = (var_cas_app_for_obj.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    ...
    while (((operand_49425 = enumerator_49425.nextObject ()))) {
      ...
      if (cond_52037.isBuiltAndTrue ()) {
        ...
        if (cond_51779.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_52001 = (var_cas_app_for_obj.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
  ...
  GGS_stringset  var_cas_regular_rez = GGS_stringset ::constructor_emptySet () ;
  {
    ...
    while (((operand_54228 = enumerator_54228.nextObject ()))) {
      ...
      if (cond_55591.isBuiltAndTrue ()) {
        const GGS_bool cond_55575 = (var_cas_app_for_obj.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
...
void routine_generate_events (C_Compiler & inLexique,
    ...
    while (((operand_57974 = enumerator_57974.nextObject ()))) {
      ...
      GGS_uint64  var_cas_event_mask = GGS_uint64 (0ULL) ;
      {
        ...
        while (((operand_58147 = enumerator_58147.nextObject ()))) {
          ...
          { const GGS_event_mask_obj _var_59114 = var_cas_mask_obj ; // CAST instruction
            if (_var_59114.getPtr () != NULL) {
              ...
              if (typeid (cPtr_event_mask_user_obj) == typeid (* (_var_59114.getPtr ()))) {
                ...
                const GGS_bool cond_58964 = var_cas_evt_usage.reader_hasKey (operand_58147->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1588))) ;
          ...
          const GGS_bool cond_59324 = var_cas_tasks_for_event.reader_hasKey (operand_58147->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1600))) ;
  ...
  }
  {
    ...
    while (((operand_60351 = enumerator_60351.nextObject ()))) {
      ...
      const GGS_bool cond_61686 = var_cas_tasks_for_event.reader_hasKey (operand_60351->event_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1644))) ;
...
void routine_generate_ready_list (C_Compiler & inLexique,
  ...
  const GGS_bool cond_65099 = var_cas_config.reader_hasKey (GGS_string ("POWEROF2QUEUE")) ;
