...
void routine_generate_all (C_Compiler & inLexique,
  ...
  const GGS_bool cond_75448 = (var_cas_temp_dir).operator_isNotEqual (GGS_string ("")) ;
  if (cond_75448.isBuiltAndTrue ()) {
    GGS_string var_cas_target = gOption_goil_5F_options_target_5F_platform.reader_value () ;
    const GGS_bool cond_75360 = (var_cas_target).operator_isNotEqual (GGS_string ("")) ;
    if (cond_75360.isBuiltAndTrue ()) {
      ...
      ::routine_generate_memmap_new (inLexique,  var_cas_cpu COMMA_SOURCE_FILE_AT_LINE (2045)) ;
      ...
      const GGS_bool cond_75345 = (var_cas_error_count).operator_isEqual (GGS_uint (0U)) ;
      if (cond_75345.isBuiltAndTrue ()) {
        const GGS_bool cond_73881 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
        if (cond_73881.isBuiltAndTrue ()) {
        ...
        const GGS_string temp_73935 = var_cas_header ;
        if (temp_73935.isBuilt ()) {
          temp_73935 (HERE)->method_makeDirectoryAndWriteToFile (inLexique, var_cas_header_file COMMA_SOURCE_FILE_AT_LINE (2083)) ;
        }
        const GGS_bool cond_74085 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
        if (cond_74085.isBuiltAndTrue ()) {
        ...
        const GGS_string temp_74143 = var_cas_obj_header ;
        if (temp_74143.isBuilt ()) {
          temp_74143 (HERE)->method_makeDirectoryAndWriteToFile (inLexique, var_cas_obj_header_file COMMA_SOURCE_FILE_AT_LINE (2087)) ;
        }
        const GGS_bool cond_74301 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
        if (cond_74301.isBuiltAndTrue ()) {
        ...
        const GGS_string temp_74363 = var_cas_implementation ;
        if (temp_74363.isBuilt ()) {
          temp_74363 (HERE)->method_makeDirectoryAndWriteToFile (inLexique, var_cas_implementation_file COMMA_SOURCE_FILE_AT_LINE (2091)) ;
        }
        const GGS_bool cond_74516 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
        if (cond_74516.isBuiltAndTrue ()) {
        ...
        const GGS_string temp_74569 = var_cas_types ;
        if (temp_74569.isBuilt ()) {
          temp_74569 (HERE)->method_makeDirectoryAndWriteToFile (inLexique, var_cas_types_file COMMA_SOURCE_FILE_AT_LINE (2095)) ;
        }
        const GGS_bool cond_75285 = gOption_goil_5F_options_generate_5F_makefile.reader_value () ;
        if (cond_75285.isBuiltAndTrue ()) {
          GGS_string var_cas_makefile_dir = var_cas_directory.reader_stringByDeletingLastPathComponent () ;
          const GGS_bool cond_74861 = (var_cas_makefile_dir).operator_isEqual (GGS_string ("")) ;
          if (cond_74861.isBuiltAndTrue ()) {
            var_cas_makefile_dir = GGS_string (".") ;
          }
          const GGS_bool cond_75015 = gOption_galgas_5F_cli_5F_options_verbose_5F_output.reader_value () ;
          if (cond_75015.isBuiltAndTrue ()) {
