...
void routine_generate_tasks (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_tpl_task,  GGS_string (true, "task") COMMA_SOURCE_FILE_AT_LINE (1062)) ;
  GGS_uint  var_cas_max_prio ;
  ...
  {
    GGS_task_map::cEnumerator enumerator_37925 (var_cas_tasks, true) ;
    const GGS_task_map::cElement * operand_37925 = NULL ;
    while (((operand_37925 = enumerator_37925.nextObject ()))) {
      macroValidPointer (operand_37925) ;
      GGS_string var_cas_tmp ;
      GGS_string var_cas_result ;
      var_cas_result = GGS_string (true, "") ;
      ::routine_generate_context_and_stack (_inLexique,  var_cas_cfg,  operand_37925->mKey,  operand_37925->mInfo.task,  var_cas_result COMMA_SOURCE_FILE_AT_LINE (1071)) ;
      var_cas_result = (var_cas_result)._operator_concat (var_cas_tpl_task) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EXEC_NAME$"),  operand_37925->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1075)) COMMA_SOURCE_FILE_AT_LINE (1075)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EXEC_FUNCTION$"),  (operand_37925->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1076)))._operator_concat (GGS_string (true, "_function")) COMMA_SOURCE_FILE_AT_LINE (1076)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$TASK$"),  (operand_37925->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1077)))._operator_concat (GGS_string (true, "_task_desc")) COMMA_SOURCE_FILE_AT_LINE (1077)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EXEC_STATIC$"),  (operand_37925->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1078)))._operator_concat (GGS_string (true, "_task_stat_desc")) COMMA_SOURCE_FILE_AT_LINE (1078)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EXEC_CONTEXT$"),  (operand_37925->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1079)))._operator_concat (GGS_string (true, "_CONTEXT")) COMMA_SOURCE_FILE_AT_LINE (1079)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EXEC_STACK$"),  (operand_37925->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1080)))._operator_concat (GGS_string (true, "_STACK")) COMMA_SOURCE_FILE_AT_LINE (1080)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$TASK_ID$"),  (operand_37925->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1081)))._operator_concat (GGS_string (true, "_id")) COMMA_SOURCE_FILE_AT_LINE (1081)) ;
      GGS_string var_cas_tpl_evt ;
      var_cas_tpl_evt = GGS_string (true, "") ;
      if (((operand_37925->mInfo.task.reader_events (_inLexique COMMA_SOURCE_FILE_AT_LINE (1088)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (1088)))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TASK_TYPE$"), GGS_string (true, "TASK_BASIC") COMMA_SOURCE_FILE_AT_LINE (1090)) ;
      }else{
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TASK_TYPE$"), GGS_string (true, "TASK_EXTENDED") COMMA_SOURCE_FILE_AT_LINE (1092)) ;
        ::routine_retrieveTemplateString (_inLexique,  var_cas_tpl_evt,  GGS_string (true, "event_masks") COMMA_SOURCE_FILE_AT_LINE (1094)) ;
        ::routine_doReplace (_inLexique,  var_cas_tpl_evt,  GGS_string (true, "$EXEC_NAME$"),  operand_37925->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1095)) COMMA_SOURCE_FILE_AT_LINE (1095)) ;
        ::routine_doReplace (_inLexique,  var_cas_tpl_evt,  GGS_string (true, "$TASK_EVENT_STRUCT$"),  (operand_37925->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1096)))._operator_concat (GGS_string (true, "_task_evts")) COMMA_SOURCE_FILE_AT_LINE (1096)) ;
      }
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$TASK_EVTS$"),  var_cas_tpl_evt COMMA_SOURCE_FILE_AT_LINE (1099)) ;
      GGS_uint  var_cas_actual_prio ;
      GGS_uint  automatic_var_8 ;
      const GGS_prio_map  _temp_39612 = var_cas_actual_priorities ;
      if (_temp_39612._isBuilt ()) {
        _temp_39612 (HERE)->method_get (_inLexique, operand_37925->mKey, var_cas_actual_prio, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (1102)) ;
      }
      if (((var_cas_actual_prio)._operator_strictSup (var_cas_max_prio)).isBuiltAndTrue ()) {
        var_cas_max_prio = var_cas_actual_prio ;
      }
      if (((operand_37925->mInfo.task.reader_schedule (_inLexique COMMA_SOURCE_FILE_AT_LINE (1110)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1110)))._operator_isEqual (GGS_string (true, "NON"))).isBuiltAndTrue ()) {
        var_cas_non_preemptable_exists = GGS_bool (true, true) ;
        ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$RESOURCE_PTR$"),  GGS_string (true, "&INTERNAL_RES_SCHEDULER") COMMA_SOURCE_FILE_AT_LINE (1112)) ;
      }else{
        GGS_lstringlist  var_cas_used_rez ;
        var_cas_used_rez = operand_37925->mInfo.task.reader_resources (_inLexique COMMA_SOURCE_FILE_AT_LINE (1115)) ;
        GGS_bool var_cas_no_internal_rez_found ;
        var_cas_no_internal_rez_found = GGS_bool (true, true) ;
        {
          GGS_lstringlist::cEnumerator enumerator_40287 (var_cas_used_rez, true) ;
          const GGS_lstringlist::cElement * operand_40287 = NULL ;
          while (((operand_40287 = enumerator_40287.nextObject ()))) {
            macroValidPointer (operand_40287) ;
            if ((var_cas_no_internal_rez_found).isBuiltAndTrue ()) {
              GGS_resource_obj  var_cas_rez ;
              const GGS_resource_map  _temp_40431 = var_cas_resources ;
              if (_temp_40431._isBuilt ()) {
                _temp_40431 (HERE)->method_get (_inLexique, operand_40287->mValue, var_cas_rez COMMA_SOURCE_FILE_AT_LINE (1120)) ;
              }
              GGS_resource_property_obj  var_cas_rez_prop ;
              var_cas_rez_prop = var_cas_rez.reader_property (_inLexique COMMA_SOURCE_FILE_AT_LINE (1121)) ;
              { const GGS_resource_property_obj _var_40826 = var_cas_rez_prop ; // CAST instruction
                if (_var_40826.getPtr () != NULL) {
                  macroValidPointer (_var_40826.getPtr ()) ;
                  if (typeid (cPtr_resource_property_internal_obj) == typeid (* (_var_40826.getPtr ()))) {
                    ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$RESOURCE_PTR$"),  ((GGS_string (true, "&"))._operator_concat (operand_40287->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1124))))._operator_concat (GGS_string (true, "_rez_desc")) COMMA_SOURCE_FILE_AT_LINE (1124)) ;
        ...
        if ((var_cas_no_internal_rez_found).isBuiltAndTrue ()) {
          ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$RESOURCE_PTR$"),  GGS_string (true, "NULL") COMMA_SOURCE_FILE_AT_LINE (1131)) ;
        }
      }
      var_cas_tmp = var_cas_actual_prio.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1135)) ;
      var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TASK_PRIORITY$"), var_cas_tmp COMMA_SOURCE_FILE_AT_LINE (1136)) ;
      GGS_basic_type  var_cas_activation_as_basic ;
      var_cas_activation_as_basic = operand_37925->mInfo.task.reader_activation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1139)) ;
      { const GGS_basic_type _var_41445 = var_cas_activation_as_basic ; // CAST instruction
        if (_var_41445.getPtr () != NULL) {
          macroValidPointer (_var_41445.getPtr ()) ;
          if (typeid (cPtr_uint32_class) == typeid (* (_var_41445.getPtr ()))) {
            const GGS_uint32_class var_cas_ui (_var_41445.getPtr ()) ;
            var_cas_tmp = var_cas_ui.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (1141)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1141)) ;
          }else{
            var_cas_activation_as_basic.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1142)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Unknown activation value") COMMA_SOURCE_FILE_AT_LINE (1143)) ;
          }
        }
      }
      var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TASK_MAX_ACT_COUNT$"), var_cas_tmp COMMA_SOURCE_FILE_AT_LINE (1144)) ;
      GGS_task_autostart_obj  var_cas_autostart ;
      var_cas_autostart = operand_37925->mInfo.task.reader_autostart (_inLexique COMMA_SOURCE_FILE_AT_LINE (1147)) ;
      { const GGS_task_autostart_obj _var_41986 = var_cas_autostart ; // CAST instruction
        if (_var_41986.getPtr () != NULL) {
          macroValidPointer (_var_41986.getPtr ()) ;
          if (typeid (cPtr_task_autostart_true) == typeid (* (_var_41986.getPtr ()))) {
            var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TASK_STATE$"), GGS_string (true, "AUTOSTART") COMMA_SOURCE_FILE_AT_LINE (1150)) ;
          }else if (typeid (cPtr_task_autostart_false) == typeid (* (_var_41986.getPtr ()))) {
            var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TASK_STATE$"), GGS_string (true, "SUSPENDED") COMMA_SOURCE_FILE_AT_LINE (1152)) ;
          }else{
            operand_37925->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Unknown autostart found") COMMA_SOURCE_FILE_AT_LINE (1154)) ;
          }
        }
      }
      GGS_timing_prot  var_cas_timing_prot ;
      var_cas_timing_prot = operand_37925->mInfo.task.reader_timing_prot (_inLexique COMMA_SOURCE_FILE_AT_LINE (1157)) ;
      GGS_string var_cas_tp ;
      GGS_string var_cas_tp_ref ;
      const GGS_timing_prot  _temp_42168 = var_cas_timing_prot ;
      if (_temp_42168._isBuilt ()) {
        _temp_42168 (HERE)->method_generate (_inLexique, var_cas_cfg, var_cas_tp, var_cas_tp_ref, operand_37925->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1160)), var_cas_resources COMMA_SOURCE_FILE_AT_LINE (1160)) ;
      }
      var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TIMING_PROT_STRUCT$"), var_cas_tp COMMA_SOURCE_FILE_AT_LINE (1161)) ;
      var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TIMING_PROT_REF$"), var_cas_tp_ref COMMA_SOURCE_FILE_AT_LINE (1162)) ;
      if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (1165)))).isBuiltAndTrue ()) {
        if (((var_cas_app_for_obj.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1166)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          GGS_string var_cas_app_name ;
          const GGS_string_map  _temp_42588 = var_cas_app_for_obj ;
          if (_temp_42588._isBuilt ()) {
            _temp_42588 (HERE)->method_get (_inLexique, operand_37925->mKey, var_cas_app_name COMMA_SOURCE_FILE_AT_LINE (1168)) ;
          }
          ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$APP_ID$"),  (var_cas_app_name)._operator_concat (GGS_string (true, "_id")) COMMA_SOURCE_FILE_AT_LINE (1169)) ;
        }
      }
  ...
  var_cas_implementation = var_cas_implementation.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TASKS$"), var_cas_tasks_result COMMA_SOURCE_FILE_AT_LINE (1187)) ;
  var_cas_obj_header = var_cas_obj_header.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TASK_COUNT$"), var_cas_tasks.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1188)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1188)) COMMA_SOURCE_FILE_AT_LINE (1188)) ;
  var_cas_obj_header = var_cas_obj_header.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$RES_SCHEDULER_PRIORITY$"), var_cas_max_prio.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1189)) COMMA_SOURCE_FILE_AT_LINE (1189)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generate_isrs (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_tpl_isr,  GGS_string (true, "isr") COMMA_SOURCE_FILE_AT_LINE (1210)) ;
  {
    GGS_isr_map::cEnumerator enumerator_44143 (var_cas_isrs, true) ;
    const GGS_isr_map::cElement * operand_44143 = NULL ;
    while (((operand_44143 = enumerator_44143.nextObject ()))) {
      macroValidPointer (operand_44143) ;
      GGS_string var_cas_tmp ;
      var_cas_tmp = GGS_string (true, "") ;
      GGS_string var_cas_result ;
      var_cas_result = GGS_string (true, "") ;
      ::routine_generate_context_and_stack (_inLexique,  var_cas_cfg,  operand_44143->mKey,  operand_44143->mInfo.isr,  var_cas_result COMMA_SOURCE_FILE_AT_LINE (1216)) ;
      var_cas_result = (var_cas_result)._operator_concat (var_cas_tpl_isr) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EXEC_NAME$"),  operand_44143->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1220)) COMMA_SOURCE_FILE_AT_LINE (1220)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EXEC_FUNCTION$"),  (operand_44143->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1221)))._operator_concat (GGS_string (true, "_function")) COMMA_SOURCE_FILE_AT_LINE (1221)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$ISR$"),  (operand_44143->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1222)))._operator_concat (GGS_string (true, "_isr_desc")) COMMA_SOURCE_FILE_AT_LINE (1222)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EXEC_STATIC$"),  (operand_44143->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1223)))._operator_concat (GGS_string (true, "_isr_stat_desc")) COMMA_SOURCE_FILE_AT_LINE (1223)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EXEC_CONTEXT$"),  (operand_44143->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1224)))._operator_concat (GGS_string (true, "_CONTEXT")) COMMA_SOURCE_FILE_AT_LINE (1224)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EXEC_STACK$"),  (operand_44143->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1225)))._operator_concat (GGS_string (true, "_STACK")) COMMA_SOURCE_FILE_AT_LINE (1225)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$ISR_HELPER$"),  (operand_44143->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1226)))._operator_concat (GGS_string (true, "_isr_helper")) COMMA_SOURCE_FILE_AT_LINE (1226)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$ISR_ID$"),  (operand_44143->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1228)))._operator_concat (GGS_string (true, "_id")) COMMA_SOURCE_FILE_AT_LINE (1228)) ;
      GGS_uint  var_cas_actual_prio ;
      GGS_uint  automatic_var_9 ;
      const GGS_prio_map  _temp_44978 = var_cas_actual_priorities ;
      if (_temp_44978._isBuilt ()) {
        _temp_44978 (HERE)->method_get (_inLexique, operand_44143->mKey, var_cas_actual_prio, automatic_var_9 COMMA_SOURCE_FILE_AT_LINE (1231)) ;
      }
      var_cas_tmp = var_cas_actual_prio.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1232)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$ISR_PRIORITY$"),  var_cas_tmp COMMA_SOURCE_FILE_AT_LINE (1233)) ;
      GGS_uint  var_cas_act ;
      const GGS_isr_obj  _temp_45145 = operand_44143->mInfo.isr ;
      if (_temp_45145._isBuilt ()) {
        _temp_45145 (HERE)->method_get_activation (_inLexique, var_cas_act COMMA_SOURCE_FILE_AT_LINE (1235)) ;
      }
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$ISR_MAX_ACT_COUNT$"),  var_cas_act.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1236)) COMMA_SOURCE_FILE_AT_LINE (1236)) ;
      GGS_timing_prot  var_cas_timing_prot ;
      var_cas_timing_prot = operand_44143->mInfo.isr.reader_timing_prot (_inLexique COMMA_SOURCE_FILE_AT_LINE (1239)) ;
      GGS_string var_cas_tp ;
      GGS_string var_cas_tp_ref ;
      const GGS_timing_prot  _temp_45393 = var_cas_timing_prot ;
      if (_temp_45393._isBuilt ()) {
        _temp_45393 (HERE)->method_generate (_inLexique, var_cas_cfg, var_cas_tp, var_cas_tp_ref, operand_44143->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1242)), var_cas_resources COMMA_SOURCE_FILE_AT_LINE (1242)) ;
      }
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$TIMING_PROT_STRUCT$"),  var_cas_tp COMMA_SOURCE_FILE_AT_LINE (1243)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$TIMING_PROT_REF$"),  var_cas_tp_ref COMMA_SOURCE_FILE_AT_LINE (1244)) ;
      if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (1247)))).isBuiltAndTrue ()) {
        if (((var_cas_app_for_obj.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1248)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          GGS_string var_cas_app_name ;
          const GGS_string_map  _temp_45748 = var_cas_app_for_obj ;
          if (_temp_45748._isBuilt ()) {
            _temp_45748 (HERE)->method_get (_inLexique, operand_44143->mKey, var_cas_app_name COMMA_SOURCE_FILE_AT_LINE (1250)) ;
          }
          ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$APP_ID$"),  (var_cas_app_name)._operator_concat (GGS_string (true, "_id")) COMMA_SOURCE_FILE_AT_LINE (1251)) ;
        }
      }
  ...
  ::routine_generate_isr_specific (_inLexique,  var_cas_isrs,  var_cas_specific_code COMMA_SOURCE_FILE_AT_LINE (1266)) ;
  var_cas_isrs_result._dotAssign_operation (var_cas_specific_code) ;
  ::routine_doReplace (_inLexique,  var_cas_obj_header,  GGS_string (true, "$ISR_COUNT$"),  var_cas_isrs.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1270)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1270)) COMMA_SOURCE_FILE_AT_LINE (1270)) ;
  ::routine_doReplace (_inLexique,  var_cas_implementation,  GGS_string (true, "$ISRS$"),  var_cas_isrs_result COMMA_SOURCE_FILE_AT_LINE (1271)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generate_counters (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_tpl_counter,  GGS_string (true, "counter") COMMA_SOURCE_FILE_AT_LINE (1288)) ;
  {
    GGS_counter_map::cEnumerator enumerator_46971 (var_cas_counters, true) ;
    const GGS_counter_map::cElement * operand_46971 = NULL ;
    while (((operand_46971 = enumerator_46971.nextObject ()))) {
      macroValidPointer (operand_46971) ;
      GGS_string var_cas_tmp ;
      var_cas_tmp = GGS_string (true, "") ;
      GGS_string var_cas_result ;
      var_cas_result = var_cas_tpl_counter ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$COUNTER_NAME$"),  operand_46971->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1294)) COMMA_SOURCE_FILE_AT_LINE (1294)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$COUNTER$"),  (operand_46971->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1295)))._operator_concat (GGS_string (true, "_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (1295)) ;
      GGS_basic_type  var_cas_ticks_as_basic ;
      var_cas_ticks_as_basic = operand_46971->mInfo.counter.reader_ticks_per_base (_inLexique COMMA_SOURCE_FILE_AT_LINE (1298)) ;
      { const GGS_basic_type _var_47523 = var_cas_ticks_as_basic ; // CAST instruction
        if (_var_47523.getPtr () != NULL) {
          macroValidPointer (_var_47523.getPtr ()) ;
          if (typeid (cPtr_uint32_class) == typeid (* (_var_47523.getPtr ()))) {
            const GGS_uint32_class var_cas_ui (_var_47523.getPtr ()) ;
            var_cas_tmp = var_cas_ui.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (1300)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1300)) ;
          }else{
            var_cas_ticks_as_basic.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1301)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Unknown COUNTER TICKSPERBASE value") COMMA_SOURCE_FILE_AT_LINE (1302)) ;
          }
        }
      }
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$TICKS_PER_BASE$"),  var_cas_tmp COMMA_SOURCE_FILE_AT_LINE (1303)) ;
      var_cas_counters_cst.appendCstring ("#define OSTICKSPERBASE_") ;
      var_cas_counters_cst._dotAssign_operation (operand_46971->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1304))) ;
      ...
      var_cas_max_as_basic = operand_46971->mInfo.counter.reader_max_allowed_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (1306)) ;
      { const GGS_basic_type _var_47930 = var_cas_max_as_basic ; // CAST instruction
        if (_var_47930.getPtr () != NULL) {
          macroValidPointer (_var_47930.getPtr ()) ;
          if (typeid (cPtr_uint32_class) == typeid (* (_var_47930.getPtr ()))) {
            const GGS_uint32_class var_cas_ui (_var_47930.getPtr ()) ;
            var_cas_tmp = var_cas_ui.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (1308)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1308)) ;
          }else{
            var_cas_max_as_basic.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1309)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Unknown COUNTER MAXALLOWEDVALUE value") COMMA_SOURCE_FILE_AT_LINE (1310)) ;
          }
        }
      }
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$MAX_ALLOWED_VALUE$"),  var_cas_tmp COMMA_SOURCE_FILE_AT_LINE (1311)) ;
      var_cas_counters_cst.appendCstring ("#define OSMAXALLOWEDVALUE_") ;
      var_cas_counters_cst._dotAssign_operation (operand_46971->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1312))) ;
      var_cas_counters_cst.appendCstring (" ") ;
      var_cas_counters_cst._dotAssign_operation (var_cas_tmp) ;
      var_cas_counters_cst.appendCstring ("\n") ;
      GGS_basic_type  var_cas_min_as_basic ;
      var_cas_min_as_basic = operand_46971->mInfo.counter.reader_min_cycle (_inLexique COMMA_SOURCE_FILE_AT_LINE (1314)) ;
      { const GGS_basic_type _var_48328 = var_cas_min_as_basic ; // CAST instruction
        if (_var_48328.getPtr () != NULL) {
          macroValidPointer (_var_48328.getPtr ()) ;
          if (typeid (cPtr_uint32_class) == typeid (* (_var_48328.getPtr ()))) {
            const GGS_uint32_class var_cas_ui (_var_48328.getPtr ()) ;
            var_cas_tmp = var_cas_ui.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (1316)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1316)) ;
          }else{
            var_cas_min_as_basic.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1317)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Unknown COUNTER MINCYCLE value") COMMA_SOURCE_FILE_AT_LINE (1318)) ;
          }
        }
      }
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$MIN_CYCLE$"),  var_cas_tmp COMMA_SOURCE_FILE_AT_LINE (1319)) ;
      var_cas_counters_cst.appendCstring ("#define OSMINCYCLE_") ;
      var_cas_counters_cst._dotAssign_operation (operand_46971->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1320))) ;
      var_cas_counters_cst.appendCstring (" ") ;
      var_cas_counters_cst._dotAssign_operation (var_cas_tmp) ;
      var_cas_counters_cst.appendCstring ("\n"
        "\n") ;
      if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (1326)))).isBuiltAndTrue ()) {
        GGS_counter_type  var_cas_type ;
        var_cas_type = operand_46971->mInfo.counter.reader_type (_inLexique COMMA_SOURCE_FILE_AT_LINE (1327)) ;
        { const GGS_counter_type _var_48952 = var_cas_type ; // CAST instruction
          if (_var_48952.getPtr () != NULL) {
            macroValidPointer (_var_48952.getPtr ()) ;
            if (typeid (cPtr_software_counter) == typeid (* (_var_48952.getPtr ()))) {
              var_cas_tmp = GGS_string (true, "SOFTWARE_COUNTER") ;
            }else if (typeid (cPtr_hardware_counter) == typeid (* (_var_48952.getPtr ()))) {
              var_cas_tmp = GGS_string (true, "HARDWARE_COUNTER") ;
            }else{
              var_cas_type.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1331)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Unknown COUNTER TYPE value") COMMA_SOURCE_FILE_AT_LINE (1332)) ;
            }
          }
        }
        ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$COUNTER_KIND$"),  var_cas_tmp COMMA_SOURCE_FILE_AT_LINE (1333)) ;
        if (((var_cas_app_for_obj.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1336)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          GGS_string var_cas_app_name ;
          const GGS_string_map  _temp_49137 = var_cas_app_for_obj ;
          if (_temp_49137._isBuilt ()) {
            _temp_49137 (HERE)->method_get (_inLexique, operand_46971->mKey, var_cas_app_name COMMA_SOURCE_FILE_AT_LINE (1338)) ;
          }
          ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$APP_ID$"),  (var_cas_app_name)._operator_concat (GGS_string (true, "_id")) COMMA_SOURCE_FILE_AT_LINE (1339)) ;
        }
      }
  ...
  GGS_string var_cas_specific_code ;
  ::routine_generate_counter_specific (_inLexique,  var_cas_counters,  var_cas_specific_code COMMA_SOURCE_FILE_AT_LINE (1347)) ;
  ...
  if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (1355)))).isBuiltAndTrue ()) {
    GGS_string var_cas_counter_table ;
    var_cas_counter_table = GGS_string (true, "") ;
    {
      GGS_counter_map::cEnumerator enumerator_49784 (var_cas_counters, true) ;
      const GGS_counter_map::cElement * operand_49784 = enumerator_49784.nextObject () ;
      if ((operand_49784 != NULL)) {
        GGS_uint var_cas_n (true, 0) ;
        ...
        bool _foreach_loop_49784 ;
        do{
          macroValidPointer (operand_49784) ;
          var_cas_counter_table.appendCstring ("    &") ;
          var_cas_counter_table._dotAssign_operation (operand_49784->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1363))) ;
          var_cas_counter_table.appendCstring ("_counter_desc") ;
          var_cas_counter_ids.appendCstring ("#define ") ;
          var_cas_counter_ids._dotAssign_operation (operand_49784->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1364))) ;
          var_cas_counter_ids.appendCstring ("_id ") ;
          var_cas_counter_ids._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1364))) ;
          var_cas_counter_ids.appendCstring ("\n") ;
          var_cas_counter_ids.appendCstring ("CONST(CounterType, AUTOMATIC) ") ;
          var_cas_counter_ids._dotAssign_operation (operand_49784->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1365))) ;
          var_cas_counter_ids.appendCstring (" = ") ;
          var_cas_counter_ids._dotAssign_operation (operand_49784->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1365))) ;
          var_cas_counter_ids.appendCstring ("_id;") ;
          var_cas_n.mValue ++ ;
          operand_49784 = enumerator_49784.nextObject () ;
          _foreach_loop_49784 = ((operand_49784 != NULL)) ;
          if (_foreach_loop_49784) {
            var_cas_counter_table.appendCstring (",\n") ;
            var_cas_counter_ids.appendCstring ("\n") ;
          }
        }while (_foreach_loop_49784) ;
        var_cas_counter_table.appendCstring ("\n"
          "};\n"
          "#endif\n") ;
      }
  ...
  ::routine_doReplace (_inLexique,  var_cas_obj_header,  GGS_string (true, "$COUNTER_COUNT$"),  var_cas_counters.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1373)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1373)) COMMA_SOURCE_FILE_AT_LINE (1373)) ;
  ::routine_doReplace (_inLexique,  var_cas_header,  GGS_string (true, "$COUNTERS$"),  var_cas_counters_cst COMMA_SOURCE_FILE_AT_LINE (1374)) ;
  ::routine_doReplace (_inLexique,  var_cas_implementation,  GGS_string (true, "$COUNTERIDS$"),  var_cas_counter_ids COMMA_SOURCE_FILE_AT_LINE (1375)) ;
  ::routine_doReplace (_inLexique,  var_cas_implementation,  GGS_string (true, "$COUNTERS$"),  var_cas_counters_result COMMA_SOURCE_FILE_AT_LINE (1376)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generate_resources (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_tpl_resource,  GGS_string (true, "resource") COMMA_SOURCE_FILE_AT_LINE (1396)) ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_tpl_internal_resource,  GGS_string (true, "internal_resource") COMMA_SOURCE_FILE_AT_LINE (1397)) ;
  {
    GGS_resource_map::cEnumerator enumerator_51512 (var_cas_resources, true) ;
    const GGS_resource_map::cElement * operand_51512 = NULL ;
    while (((operand_51512 = enumerator_51512.nextObject ()))) {
      macroValidPointer (operand_51512) ;
      GGS_string var_cas_result ;
      GGS_string var_cas_name ;
      var_cas_name = operand_51512->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1402)) ;
      GGS_resource_property_obj  var_cas_rez_prop ;
      var_cas_rez_prop = operand_51512->mInfo.resource.reader_property (_inLexique COMMA_SOURCE_FILE_AT_LINE (1405)) ;
      GGS_uint  var_cas_prio ;
      GGS_string var_cas_usage ;
      GGS_uint  automatic_var_10 ;
      const GGS_prio_map  _temp_51799 = var_cas_rez_prio ;
      if (_temp_51799._isBuilt ()) {
        _temp_51799 (HERE)->method_get (_inLexique, operand_51512->mKey, var_cas_prio, automatic_var_10 COMMA_SOURCE_FILE_AT_LINE (1409)) ;
      }
      const GGS_string_map  _temp_51852 = var_cas_rez_comments ;
      if (_temp_51852._isBuilt ()) {
        _temp_51852 (HERE)->method_get (_inLexique, operand_51512->mKey, var_cas_usage COMMA_SOURCE_FILE_AT_LINE (1410)) ;
      }
      { const GGS_resource_property_obj _var_52356 = var_cas_rez_prop ; // CAST instruction
        if (_var_52356.getPtr () != NULL) {
          macroValidPointer (_var_52356.getPtr ()) ;
          if (typeid (cPtr_resource_property_standard_obj) == typeid (* (_var_52356.getPtr ()))) {
            var_cas_result = var_cas_tpl_resource ;
            var_cas_regular_rez._addAssign_operation (var_cas_name) ;
          }else if (typeid (cPtr_resource_property_linked_obj) == typeid (* (_var_52356.getPtr ()))) {
            var_cas_result = var_cas_tpl_resource ;
            var_cas_regular_rez._addAssign_operation (var_cas_name) ;
          }else if (typeid (cPtr_resource_property_internal_obj) == typeid (* (_var_52356.getPtr ()))) {
            var_cas_result = var_cas_tpl_internal_resource ;
          }else{
            var_cas_result = GGS_string (true, "") ;
            operand_51512->mKey.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Unknown property found") COMMA_SOURCE_FILE_AT_LINE (1424)) ;
          }
        }
      }
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$RESOURCE_NAME$"),  operand_51512->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1426)) COMMA_SOURCE_FILE_AT_LINE (1426)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$RESOURCE$"),  (operand_51512->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1427)))._operator_concat (GGS_string (true, "_rez_desc")) COMMA_SOURCE_FILE_AT_LINE (1427)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$PRIORITY$"),  var_cas_prio.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1429)) COMMA_SOURCE_FILE_AT_LINE (1429)) ;
      ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$USAGE$"),  var_cas_usage COMMA_SOURCE_FILE_AT_LINE (1430)) ;
      if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (1432)))).isBuiltAndTrue ()) {
        if (((var_cas_app_for_obj.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1433)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          GGS_string var_cas_app_name ;
          const GGS_string_map  _temp_52778 = var_cas_app_for_obj ;
          if (_temp_52778._isBuilt ()) {
            _temp_52778 (HERE)->method_get (_inLexique, operand_51512->mKey, var_cas_app_name COMMA_SOURCE_FILE_AT_LINE (1435)) ;
          }
          ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$APP_ID$"),  (var_cas_app_name)._operator_concat (GGS_string (true, "_id")) COMMA_SOURCE_FILE_AT_LINE (1436)) ;
        }
      }
  ...
  {
      GGS_uint var_cas_n (true, 0) ;
    GGS_stringset::cEnumerator enumerator_53093 (var_cas_regular_rez, true) ;
    while (enumerator_53093.hc ()) {
      var_cas_rez_ids.appendCstring ("#define ") ;
      var_cas_rez_ids._dotAssign_operation (enumerator_53093._key (HERE)) ;
      var_cas_rez_ids.appendCstring ("_id ") ;
      var_cas_rez_ids._dotAssign_operation (var_cas_n.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1448))) ;
      ...
      var_cas_rez_ids.appendCstring ("_id;\n") ;
      var_cas_n.mValue ++ ;
      enumerator_53093.next () ;
    }
  }
  var_cas_regular_rez._addAssign_operation (GGS_string (true, "res_sched")) ;
  {
    GGS_stringset::cEnumerator enumerator_53327 (var_cas_regular_rez, true) ;
    if (enumerator_53327 .hc ()) {
      GGS_uint var_cas_n (true, 0) ;
      var_cas_rez_imp = GGS_string (true, "CONSTP2VAR(tpl_resource, AUTOMATIC, OS_APPL_DATA)\n"
        "  tpl_resource_table[RESOURCE_COUNT] = {\n") ;
      bool _foreach_loop_53327 ;
      do{
        var_cas_rez_imp.appendCstring ("  &") ;
        var_cas_rez_imp._dotAssign_operation (enumerator_53327._key (HERE)) ;
        var_cas_rez_imp.appendCstring ("_rez_desc") ;
        var_cas_n.mValue ++ ;
        enumerator_53327.next () ;
        _foreach_loop_53327 = (enumerator_53327 .hc ()) ;
        if (_foreach_loop_53327) {
          var_cas_rez_imp.appendCstring (",\n") ;
        }
      }while (_foreach_loop_53327) ;
      var_cas_rez_imp.appendCstring ("\n"
        "};\n") ;
    }
  }
  var_cas_resources_result = ((var_cas_resources_result)._operator_concat (GGS_string (true, "\n")))._operator_concat (var_cas_rez_imp) ;
  ::routine_doReplace (_inLexique,  var_cas_implementation,  GGS_string (true, "$REZIDS$"),  var_cas_rez_ids COMMA_SOURCE_FILE_AT_LINE (1467)) ;
  ::routine_doReplace (_inLexique,  var_cas_obj_header,  GGS_string (true, "$RESOURCE_COUNT$"),  var_cas_regular_rez.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (1468)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1468)) COMMA_SOURCE_FILE_AT_LINE (1468)) ;
  ::routine_doReplace (_inLexique,  var_cas_implementation,  GGS_string (true, "$RESOURCES$"),  var_cas_resources_result COMMA_SOURCE_FILE_AT_LINE (1469)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generate_events (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_tpl_event,  GGS_string (true, "event") COMMA_SOURCE_FILE_AT_LINE (1486)) ;
  ...
  {
    GGS_task_map::cEnumerator enumerator_55114 (var_cas_tasks, true) ;
    const GGS_task_map::cElement * operand_55114 = NULL ;
    while (((operand_55114 = enumerator_55114.nextObject ()))) {
      macroValidPointer (operand_55114) ;
      GGS_lstringlist  var_cas_events_used ;
      var_cas_events_used = operand_55114->mInfo.task.reader_events (_inLexique COMMA_SOURCE_FILE_AT_LINE (1506)) ;
      GGS_uint64  var_cas_event_mask ;
      var_cas_event_mask = GGS_uint64 (true, 0LLU) ;
      {
        GGS_lstringlist::cEnumerator enumerator_55290 (var_cas_events_used, true) ;
        const GGS_lstringlist::cElement * operand_55290 = NULL ;
        while (((operand_55290 = enumerator_55290.nextObject ()))) {
          macroValidPointer (operand_55290) ;
          GGS_event_obj  var_cas_event ;
          const GGS_event_map  _temp_55368 = var_cas_events ;
          if (_temp_55368._isBuilt ()) {
            _temp_55368 (HERE)->method_get (_inLexique, operand_55290->mValue, var_cas_event COMMA_SOURCE_FILE_AT_LINE (1510)) ;
          }
          GGS_event_mask_obj  var_cas_mask_obj ;
          var_cas_mask_obj = var_cas_event.reader_mask (_inLexique COMMA_SOURCE_FILE_AT_LINE (1512)) ;
          { const GGS_event_mask_obj _var_56270 = var_cas_mask_obj ; // CAST instruction
            if (_var_56270.getPtr () != NULL) {
              macroValidPointer (_var_56270.getPtr ()) ;
              if (typeid (cPtr_event_mask_user_obj) == typeid (* (_var_56270.getPtr ()))) {
                const GGS_event_mask_user_obj var_cas_emu (_var_56270.getPtr ()) ;
                if ((((var_cas_event_mask)._operator_and (var_cas_emu.reader_mask (_inLexique COMMA_SOURCE_FILE_AT_LINE (1515)).reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (1515))))._operator_isEqual (GGS_uint64 (true, 0LLU))).isBuiltAndTrue ()) {
                  var_cas_event_mask = (var_cas_event_mask)._operator_or (var_cas_emu.reader_mask (_inLexique COMMA_SOURCE_FILE_AT_LINE (1517)).reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (1517))) ;
                }else{
                  var_cas_emu.reader_mask (_inLexique COMMA_SOURCE_FILE_AT_LINE (1519)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "MASK of event "))._operator_concat (operand_55290->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1519))))._operator_concat (GGS_string (true, " conflicts with previous declarations")) COMMA_SOURCE_FILE_AT_LINE (1520)) ;
                }
              }else if (typeid (cPtr_event_mask_auto_obj) == typeid (* (_var_56270.getPtr ()))) {
                GGS_uint  var_cas_count ;
                if ((var_cas_evt_usage.reader_hasKey (_inLexique, operand_55290->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1523)) COMMA_SOURCE_FILE_AT_LINE (1523))).isBuiltAndTrue ()) {
                  var_cas_evt_usage.modifier_delete (_inLexique, operand_55290->mValue, var_cas_count COMMA_SOURCE_FILE_AT_LINE (1525)) ;
                  var_cas_count._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1526)) ;
                }else{
                  var_cas_count = GGS_uint (true, 1U) ;
                }
                var_cas_evt_usage.modifier_insert_count (_inLexique, operand_55290->mValue, var_cas_count COMMA_SOURCE_FILE_AT_LINE (1530)) ;
              }else{
              }
            }
          }
          ...
          if ((var_cas_tasks_for_event.reader_hasKey (_inLexique, operand_55290->mValue.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1535)) COMMA_SOURCE_FILE_AT_LINE (1535))).isBuiltAndTrue ()) {
            var_cas_tasks_for_event.modifier_delete (_inLexique, operand_55290->mValue, var_cas_ref_tasks COMMA_SOURCE_FILE_AT_LINE (1537)) ;
          }
          var_cas_ref_tasks._addAssign_operation (operand_55114->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1539))) ;
          var_cas_tasks_for_event.modifier_add (_inLexique, operand_55290->mValue, var_cas_ref_tasks COMMA_SOURCE_FILE_AT_LINE (1540)) ;
        }
      }
      var_cas_task_mask.modifier_insert_mask (_inLexique, operand_55114->mKey, var_cas_event_mask COMMA_SOURCE_FILE_AT_LINE (1543)) ;
    }
  }
  {
    GGS_event_map::cEnumerator enumerator_56747 (var_cas_events, true) ;
    const GGS_event_map::cElement * operand_56747 = NULL ;
    while (((operand_56747 = enumerator_56747.nextObject ()))) {
      macroValidPointer (operand_56747) ;
      GGS_event_mask_obj  var_cas_evt_mask ;
      var_cas_evt_mask = operand_56747->mInfo.event.reader_mask (_inLexique COMMA_SOURCE_FILE_AT_LINE (1551)) ;
      { const GGS_event_mask_obj _var_57192 = var_cas_evt_mask ; // CAST instruction
        if (_var_57192.getPtr () != NULL) {
          macroValidPointer (_var_57192.getPtr ()) ;
          if (typeid (cPtr_event_mask_user_obj) == typeid (* (_var_57192.getPtr ()))) {
            const GGS_event_mask_user_obj var_cas_emu (_var_57192.getPtr ()) ;
            GGS_string var_cas_result ;
            var_cas_result = var_cas_tpl_event ;
            ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EVENT$"),  (operand_56747->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1555)))._operator_concat (GGS_string (true, "_mask")) COMMA_SOURCE_FILE_AT_LINE (1555)) ;
            ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EVENT_NAME$"),  operand_56747->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1556)) COMMA_SOURCE_FILE_AT_LINE (1556)) ;
            ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EVENT_MASK$"),  var_cas_emu.reader_mask (_inLexique COMMA_SOURCE_FILE_AT_LINE (1557)).reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (1557)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1557)) COMMA_SOURCE_FILE_AT_LINE (1557)) ;
  ...
  {
    GGS_event_usage_map::cEnumerator enumerator_57356 (var_cas_evt_usage, true) ;
    const GGS_event_usage_map::cElement * operand_57356 = NULL ;
    while (((operand_57356 = enumerator_57356.nextObject ()))) {
      macroValidPointer (operand_57356) ;
      var_cas_sort_evts._addAssign_operation (operand_57356->mKey, operand_57356->mInfo.count) ;
    }
  }
  {
    GGS_sorted_events::cEnumerator enumerator_57528 (var_cas_sort_evts, true) ;
    const GGS_sorted_events::cElement * operand_57528 = NULL ;
    while (((operand_57528 = enumerator_57528.nextObject ()))) {
      macroValidPointer (operand_57528) ;
      if ((var_cas_tasks_for_event.reader_hasKey (_inLexique, operand_57528->event_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1579)) COMMA_SOURCE_FILE_AT_LINE (1579))).isBuiltAndTrue ()) {
        GGS_stringset  var_cas_tasks ;
        const GGS_stringset_map  _temp_57641 = var_cas_tasks_for_event ;
        if (_temp_57641._isBuilt ()) {
          _temp_57641 (HERE)->method_get (_inLexique, operand_57528->event_name, var_cas_tasks COMMA_SOURCE_FILE_AT_LINE (1581)) ;
        }
        GGS_uint64  var_cas_mask ;
        var_cas_mask = GGS_uint64 (true, 0LLU) ;
        {
          GGS_stringset::cEnumerator enumerator_57710 (var_cas_tasks, true) ;
          while (enumerator_57710.hc ()) {
            GGS_uint64  var_cas_tm ;
            const GGS_task_mask  _temp_57774 = var_cas_task_mask ;
            if (_temp_57774._isBuilt ()) {
              _temp_57774 (HERE)->method_get_mask (_inLexique, GGS_lstring ::constructor_new (_inLexique, enumerator_57710._key (HERE), GGS_location (_inLexique) COMMA_HERE), var_cas_tm COMMA_SOURCE_FILE_AT_LINE (1585)) ;
            }
            var_cas_mask = (var_cas_mask)._operator_or (var_cas_tm) ;
            enumerator_57710.next () ;
          }
        }
        GGS_uint64  var_cas_bit ;
        var_cas_bit = GGS_uint64 (true, 1LLU) ;
        GGS_uint _variant_58106 = GGS_uint (true, 32U) ;
        GGS_bool _condition_58106 (_variant_58106._isBuilt (), true) ;
        while (_condition_58106.isBuiltAndTrue ()) {
          _condition_58106 = ((var_cas_bit)._operator_strictInf (GGS_uint ::constructor_max (_inLexique COMMA_HERE).reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (1592))))._operator_and (((var_cas_bit)._operator_and ((var_cas_mask)._operator_tilde ()))._operator_isEqual (GGS_uint64 (true, 0LLU))) ;
          if (_condition_58106.isBuiltAndTrue ()) {
            if (_variant_58106.uintValue () == 0) {
              _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1594)) ;
              _condition_58106 = GGS_bool (true, false) ;
            }else{
              _variant_58106._decrement_operation (_inLexique COMMA_HERE) ;
              var_cas_bit = var_cas_bit._left_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1593)) ;
            }
          }
        }
        if (((var_cas_bit)._operator_strictSup (GGS_uint ::constructor_max (_inLexique COMMA_HERE).reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (1595)))).isBuiltAndTrue ()) {
          operand_57528->event_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "All event mask bits are already use, event "))._operator_concat (operand_57528->event_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1596))))._operator_concat (GGS_string (true, " can't be created")) COMMA_SOURCE_FILE_AT_LINE (1597)) ;
        }
        {
          GGS_stringset::cEnumerator enumerator_58405 (var_cas_tasks, true) ;
          while (enumerator_58405.hc ()) {
            GGS_uint64  var_cas_tm ;
            var_cas_task_mask.modifier_del_mask (_inLexique, GGS_lstring ::constructor_new (_inLexique, enumerator_58405._key (HERE), GGS_location (_inLexique) COMMA_HERE), var_cas_tm COMMA_SOURCE_FILE_AT_LINE (1602)) ;
            var_cas_tm = (var_cas_bit)._operator_or (var_cas_tm) ;
            var_cas_task_mask.modifier_insert_mask (_inLexique, GGS_lstring ::constructor_new (_inLexique, enumerator_58405._key (HERE), GGS_location (_inLexique) COMMA_HERE), var_cas_tm COMMA_SOURCE_FILE_AT_LINE (1604)) ;
            enumerator_58405.next () ;
          }
        }
        GGS_string var_cas_result ;
        var_cas_result = var_cas_tpl_event ;
        ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EVENT$"),  (operand_57528->event_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1608)))._operator_concat (GGS_string (true, "_mask")) COMMA_SOURCE_FILE_AT_LINE (1608)) ;
        ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EVENT_NAME$"),  operand_57528->event_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1609)) COMMA_SOURCE_FILE_AT_LINE (1609)) ;
        ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EVENT_MASK$"),  var_cas_bit.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1610)) COMMA_SOURCE_FILE_AT_LINE (1610)) ;
        var_cas_imp_result._dotAssign_operation (var_cas_result) ;
        var_cas_imp_result.appendCstring ("\n") ;
      }
    }
  }
  ::routine_doReplace (_inLexique,  var_cas_implementation,  GGS_string (true, "$EVENTS$"),  var_cas_imp_result COMMA_SOURCE_FILE_AT_LINE (1689)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generate_ready_list (C_Compiler & _inLexique,
  ...
  var_cas_config = var_cas_os.reader_others (_inLexique COMMA_SOURCE_FILE_AT_LINE (1708)) ;
  if ((var_cas_config.reader_hasKey (_inLexique, GGS_string (true, "POWEROF2QUEUE") COMMA_SOURCE_FILE_AT_LINE (1710))).isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_pw ;
    const GGS_ident_map  _temp_62111 = var_cas_config ;
    if (_temp_62111._isBuilt ()) {
      _temp_62111 (HERE)->method_get (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "POWEROF2QUEUE"), GGS_location (_inLexique) COMMA_HERE), var_cas_pw COMMA_SOURCE_FILE_AT_LINE (1712)) ;
    }
    { const GGS_basic_type _var_62340 = var_cas_pw ; // CAST instruction
      if (_var_62340.getPtr () != NULL) {
        macroValidPointer (_var_62340.getPtr ()) ;
        if (typeid (cPtr_bool_class) == typeid (* (_var_62340.getPtr ()))) {
          const GGS_bool_class var_cas_b (_var_62340.getPtr ()) ;
          var_cas_powerof2 = var_cas_b.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (1715)) ;
        }else{
          var_cas_pw.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (1717)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "POWEROF2QUEUE should be a boolean") COMMA_SOURCE_FILE_AT_LINE (1718)) ;
        }
      }
    }
  }
  {
    GGS_prio_list::cEnumerator enumerator_62384 (var_cas_ready_list, true) ;
    const GGS_prio_list::cElement * operand_62384 = NULL ;
    while (((operand_62384 = enumerator_62384.nextObject ()))) {
      macroValidPointer (operand_62384) ;
      GGS_uint  var_cas_max_size ;
      if ((var_cas_powerof2).isBuiltAndTrue ()) {
        var_cas_max_size = GGS_uint (true, 1U) ;
        GGS_uint _variant_62597 = GGS_uint (true, 32U) ;
        GGS_bool _condition_62597 (_variant_62597._isBuilt (), true) ;
        while (_condition_62597.isBuiltAndTrue ()) {
          _condition_62597 = (operand_62384->fifosize)._operator_strictSup (var_cas_max_size) ;
          if (_condition_62597.isBuiltAndTrue ()) {
            if (_variant_62597.uintValue () == 0) {
              _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1728)) ;
              _condition_62597 = GGS_bool (true, false) ;
            }else{
              _variant_62597._decrement_operation (_inLexique COMMA_HERE) ;
              var_cas_max_size = var_cas_max_size._left_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1727)) ;
            }
          }
        }
      }else{
        var_cas_max_size = operand_62384->fifosize ;
      }
      var_cas_fifo.appendCstring ("tpl_proc_id tpl_priority_") ;
      var_cas_fifo._dotAssign_operation (var_cas_prio.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1732))) ;
      var_cas_fifo.appendCstring ("_fifo[") ;
      var_cas_fifo._dotAssign_operation (var_cas_max_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1732))) ;
  ...
  var_cas_fifo._dotAssign_operation (var_cas_max_prio._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1739)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1739))) ;
  var_cas_fifo.appendCstring ("] = {\n") ;
  GGS_uint _variant_63100 = var_cas_max_prio._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1740)) ;
  GGS_bool _condition_63100 (_variant_63100._isBuilt (), true) ;
  while (_condition_63100.isBuiltAndTrue ()) {
    _condition_63100 = (var_cas_prio)._operator_infOrEqual (var_cas_max_prio) ;
    if (_condition_63100.isBuiltAndTrue ()) {
      if (_variant_63100.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1746)) ;
        _condition_63100 = GGS_bool (true, false) ;
      }else{
        _variant_63100._decrement_operation (_inLexique COMMA_HERE) ;
        var_cas_fifo.appendCstring ("    { 0 , 0 }") ;
        if (((var_cas_prio)._operator_strictInf (var_cas_max_prio)).isBuiltAndTrue ()) {
          var_cas_fifo.appendCstring (",") ;
        }
        var_cas_fifo.appendCstring ("\n") ;
        var_cas_prio._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1745)) ;
      }
    }
  }
  var_cas_fifo.appendCstring ("};\n"
  ...
  var_cas_fifo._dotAssign_operation (var_cas_max_prio._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1750)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1750))) ;
  var_cas_fifo.appendCstring ("] = {\n") ;
  {
    GGS_prio_list::cEnumerator enumerator_63255 (var_cas_ready_list, true) ;
    const GGS_prio_list::cElement * operand_63255 = NULL ;
    while (((operand_63255 = enumerator_63255.nextObject ()))) {
      macroValidPointer (operand_63255) ;
      GGS_uint  var_cas_max_size ;
      if ((var_cas_powerof2).isBuiltAndTrue ()) {
        var_cas_max_size = GGS_uint (true, 1U) ;
        GGS_uint _variant_63468 = GGS_uint (true, 32U) ;
        GGS_bool _condition_63468 (_variant_63468._isBuilt (), true) ;
        while (_condition_63468.isBuiltAndTrue ()) {
          _condition_63468 = (operand_63255->fifosize)._operator_strictSup (var_cas_max_size) ;
          if (_condition_63468.isBuiltAndTrue ()) {
            if (_variant_63468.uintValue () == 0) {
              _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1758)) ;
              _condition_63468 = GGS_bool (true, false) ;
            }else{
              _variant_63468._decrement_operation (_inLexique COMMA_HERE) ;
              var_cas_max_size = var_cas_max_size._left_shift_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1757)) ;
            }
          }
        }
        var_cas_max_size._decrement_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1759)) ;
      }else{
        var_cas_max_size = operand_63255->fifosize ;
      }
      var_cas_fifo.appendCstring ("    { tpl_priority_") ;
      var_cas_fifo._dotAssign_operation (var_cas_prio.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1763))) ;
      var_cas_fifo.appendCstring ("_fifo , ") ;
      var_cas_fifo._dotAssign_operation (var_cas_max_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1763))) ;
      var_cas_fifo.appendCstring (" }") ;
      if (((var_cas_prio)._operator_strictInf (var_cas_max_prio)).isBuiltAndTrue ()) {
        var_cas_fifo.appendCstring (",") ;
      }
      var_cas_fifo.appendCstring ("\n") ;
      var_cas_prio._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (1766)) ;
    }
  }
  var_cas_fifo.appendCstring ("};\n"
    "\n") ;
  var_cas_implementation = var_cas_implementation.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$READY_LIST$"), var_cas_fifo COMMA_SOURCE_FILE_AT_LINE (1770)) ;
  var_cas_obj_header = var_cas_obj_header.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$PRIO_LEVEL_COUNT$"), var_cas_max_prio._add_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (1771)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (1771)) COMMA_SOURCE_FILE_AT_LINE (1771)) ;
  #ifdef DEBUG_TRACE_ENABLED
