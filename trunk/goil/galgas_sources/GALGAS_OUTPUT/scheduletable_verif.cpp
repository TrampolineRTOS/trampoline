...
void routine_schedule_tables_well_formed (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_502 = enumerator_502.nextObject ()))) {
      ...
      GGS_uint  var_cas_exp_pt_number = var_cas_eps.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (42)) ;
      ...
      }
      {
        ...
        while (((operand_1855 = enumerator_1855.nextObject ()))) {
          ...
          const GGS_bool cond_2007 = (operand_1855->point.reader_actions (inLexique COMMA_SOURCE_FILE_AT_LINE (49)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (49))).operator_isEqual (GGS_uint (0U)) ;
      ...
      const GGS_bool cond_10252 = var_cas_counters.reader_hasKey (inLexique, operand_502->mInfo.st.reader_counter (inLexique COMMA_SOURCE_FILE_AT_LINE (72)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (72)) COMMA_SOURCE_FILE_AT_LINE (72)) ;
...
void routine_schedule_tables_counters_exist_and_compatible (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_10415 = enumerator_10415.nextObject ()))) {
      ...
      const GGS_bool cond_10659 = ((var_cas_cnts.reader_hasKey (inLexique, var_cas_cnt.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) COMMA_SOURCE_FILE_AT_LINE (222))).operator_not ()).operator_and ((var_cas_cnt.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222))).operator_isNotEqual (GGS_string ("SystemCounter"))) ;
              ...
              { const GGS_action_obj _var_12944 = operand_11735->action ; // CAST instruction
                if (_var_12944.getPtr () != NULL) {
                  ...
                  if (typeid (cPtr_activatetask_action) == typeid (* (_var_12944.getPtr ()))) {
                    ...
                    const GGS_bool cond_12001 = (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (262)).reader_hasKey (inLexique, var_cas_ata.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (262)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (262)) COMMA_SOURCE_FILE_AT_LINE (262))).operator_not () ;
                    ...
                    const GGS_bool cond_12229 = (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (266)).reader_hasKey (inLexique, var_cas_sea.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (266)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (266)) COMMA_SOURCE_FILE_AT_LINE (266))).operator_not () ;
                    ...
                    const GGS_bool cond_12605 = (var_cas_known_events.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (273))).operator_isEqual (GGS_uint (0U)) ;
                    ...
                    const GGS_bool cond_12797 = (var_cas_cpu.reader_events (inLexique COMMA_SOURCE_FILE_AT_LINE (276)).reader_hasKey (inLexique, var_cas_sea.reader_event_name (inLexique COMMA_SOURCE_FILE_AT_LINE (276)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (276)) COMMA_SOURCE_FILE_AT_LINE (276))).operator_not () ;
