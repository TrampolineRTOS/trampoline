...
C_StringCommandLineOption gOption_goil_5F_options_goil_5F_template_5F_dir ("goil_options",
                                         "goil_template_dir",
                                         0,
                                         "goil-templates",
                                         "Specifies template directory (used by goil for code generation, for new-style templates)") ;
