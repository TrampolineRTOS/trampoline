...
//                    november 15th, 2010, at 11h52'21"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void goil_syntax::rule_goil_5F_syntax_start_i0_ (C_Lexique_goil_5F_lexique & inLexique) {
  ...
  GGS_string var_cas_trampoline_base_path = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (254)).reader_tpl_base_path (inLexique COMMA_SOURCE_FILE_AT_LINE (254)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (254)) ;
  ::routine_check_target (inLexique,  var_cas_trampoline_base_path COMMA_SOURCE_FILE_AT_LINE (255)) ;
  ::routine_verify_all (inLexique,  var_cas_cpu COMMA_SOURCE_FILE_AT_LINE (256)) ;
  const GGS_bool cond_6933 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (259))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_6933.isBuiltAndTrue ()) {
    ::routine_generate_all (inLexique,  var_cas_cpu COMMA_SOURCE_FILE_AT_LINE (260)) ;
  }
}
...
void goil_syntax::rule_goil_5F_syntax_file_i1_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  GGS_lstring  var_cas_version = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (269)) ;
  GGS_lstring  var_cas_desc = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (270)) ;
...
void goil_syntax::rule_goil_5F_syntax_description_i2_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  switch (select_goil_5F_syntax_1 (inLexique)) {
    case 1 : {
      var_cas_desc = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (306)) ;
      } break ;
    case 2 : {
...
void goil_syntax::rule_goil_5F_syntax_application_5F_definition_i4_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  GGS_os_obj  var_cas_os = var_cas_file.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (330)) ;
  GGS_com  var_cas_com = var_cas_file.reader_com (inLexique COMMA_SOURCE_FILE_AT_LINE (331)) ;
  GGS_task_map  var_cas_tasks = var_cas_file.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (332)) ;
  GGS_counter_map  var_cas_counters = var_cas_file.reader_counters (inLexique COMMA_SOURCE_FILE_AT_LINE (333)) ;
  GGS_alarm_map  var_cas_alarms = var_cas_file.reader_alarms (inLexique COMMA_SOURCE_FILE_AT_LINE (334)) ;
  GGS_resource_map  var_cas_resources = var_cas_file.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (335)) ;
  GGS_event_map  var_cas_events = var_cas_file.reader_events (inLexique COMMA_SOURCE_FILE_AT_LINE (336)) ;
  GGS_isr_map  var_cas_isrs = var_cas_file.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (337)) ;
  GGS_message_map  var_cas_messages = var_cas_file.reader_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (338)) ;
  GGS_netmess_map  var_cas_net_messages = var_cas_file.reader_net_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (339)) ;
  GGS_scheduletable_map  var_cas_scheduletables = var_cas_file.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (340)) ;
  GGS_app_map  var_cas_applis = var_cas_file.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (341)) ;
  ...
  GGS_lstring  automatic_var_9418_0 ;
  nt_description_ (inLexique, automatic_var_9418_0) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
  var_cas_file = GGS_root_obj ::constructor_new (inLexique, var_cas_cpuName, var_cas_os, var_cas_com, var_cas_tasks, var_cas_counters, var_cas_alarms, var_cas_resources, var_cas_events, var_cas_isrs, var_cas_messages, var_cas_net_messages, var_cas_scheduletables, var_cas_applis COMMA_SOURCE_FILE_AT_LINE (364)) ;
}
...
void goil_syntax::rule_goil_5F_syntax_application_5F_definition_i4_check_5F_appli_5F_exist (C_Lexique_goil_5F_lexique & inLexique,
                                ...
                                GGS_bool &var_cas_appli_exist) {
  GGS_os_obj  var_cas_os = var_cas_file_check.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (384)) ;
  GGS_com  var_cas_com = var_cas_file_check.reader_com (inLexique COMMA_SOURCE_FILE_AT_LINE (385)) ;
  GGS_task_map  var_cas_tasks = var_cas_file_check.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (386)) ;
  GGS_counter_map  var_cas_counters = var_cas_file_check.reader_counters (inLexique COMMA_SOURCE_FILE_AT_LINE (387)) ;
  GGS_alarm_map  var_cas_alarms = var_cas_file_check.reader_alarms (inLexique COMMA_SOURCE_FILE_AT_LINE (388)) ;
  GGS_resource_map  var_cas_resources = var_cas_file_check.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (389)) ;
  GGS_event_map  var_cas_events = var_cas_file_check.reader_events (inLexique COMMA_SOURCE_FILE_AT_LINE (390)) ;
  GGS_isr_map  var_cas_isrs = var_cas_file_check.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (391)) ;
  GGS_message_map  var_cas_messages = var_cas_file_check.reader_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (392)) ;
  GGS_netmess_map  var_cas_net_messages = var_cas_file_check.reader_net_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (393)) ;
  GGS_scheduletable_map  var_cas_scheduletables = var_cas_file_check.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (394)) ;
  GGS_app_map  var_cas_applis = var_cas_file_check.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (395)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_CPU) COMMA_HERE) ;
  GGS_lstring  var_cas_cpuName ;
  inLexique.assignFromAttribute_att_5F_token (var_cas_cpuName) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_idf) COMMA_HERE) ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__7D_) COMMA_HERE) ;
  GGS_lstring  automatic_var_10681_0 ;
  nt_description_ (inLexique, automatic_var_10681_0) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
  var_cas_file_check = GGS_root_obj ::constructor_new (inLexique, var_cas_cpuName, var_cas_os, var_cas_com, var_cas_tasks, var_cas_counters, var_cas_alarms, var_cas_resources, var_cas_events, var_cas_isrs, var_cas_messages, var_cas_net_messages, var_cas_scheduletables, var_cas_applis COMMA_SOURCE_FILE_AT_LINE (405)) ;
}
    ...
    while (syntaxRepeat_2) {
      switch (select_goil_5F_syntax_2 (inLexique)) {
        ...
        case 3 : {
          ...
          GGS_lstring  automatic_var_11461_0 ;
          nt_description_ (inLexique, automatic_var_11461_0) ;
          } break ;
        case 4 : {
        ...
        case 6 : {
          ...
          GGS_lstring  automatic_var_11565_0 ;
          nt_description_ (inLexique, automatic_var_11565_0) ;
          } break ;
        case 7 : {
          nt_resource_ (inLexique, var_cas_resources) ;
          GGS_lstring  automatic_var_11617_0 ;
          nt_description_ (inLexique, automatic_var_11617_0) ;
          } break ;
        case 8 : {
          nt_event_ (inLexique, var_cas_events) ;
          GGS_lstring  automatic_var_11663_0 ;
          nt_description_ (inLexique, automatic_var_11663_0) ;
          } break ;
        case 9 : {
          nt_isr_ (inLexique, var_cas_isrs) ;
          GGS_lstring  automatic_var_11705_0 ;
          nt_description_ (inLexique, automatic_var_11705_0) ;
          } break ;
        case 10 : {
          nt_mess_ (inLexique, var_cas_messages) ;
          GGS_lstring  automatic_var_11752_0 ;
          nt_description_ (inLexique, automatic_var_11752_0) ;
          } break ;
        case 11 : {
        ...
        case 12 : {
          ...
          GGS_lstring  automatic_var_11851_0 ;
          nt_description_ (inLexique, automatic_var_11851_0) ;
          } break ;
        case 13 : {
          nt_ipdu_ (inLexique) ;
          GGS_lstring  automatic_var_11887_0 ;
          nt_description_ (inLexique, automatic_var_11887_0) ;
          } break ;
        case 14 : {
          nt_nm_ (inLexique) ;
          GGS_lstring  automatic_var_11921_0 ;
          nt_description_ (inLexique, automatic_var_11921_0) ;
          } break ;
        case 15 : {
          nt_scheduletable_ (inLexique, var_cas_scheduletables) ;
          GGS_lstring  automatic_var_11983_0 ;
          nt_description_ (inLexique, automatic_var_11983_0) ;
          } break ;
        case 16 : {
          nt_appli_ (inLexique, var_cas_applis) ;
          GGS_lstring  automatic_var_12029_0 ;
          nt_description_ (inLexique, automatic_var_12029_0) ;
          } break ;
        case 17 : {
...
void goil_syntax::rule_goil_5F_syntax_boolean_i7_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  switch (select_goil_5F_syntax_3 (inLexique)) {
    case 1 : {
      ...
      var_cas_val = GGS_lbool ::constructor_new (inLexique, GGS_bool (true), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (512)) ;
      } break ;
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_FALSE) COMMA_HERE) ;
      var_cas_val = GGS_lbool ::constructor_new (inLexique, GGS_bool (false), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (515)) ;
      } break ;
    default :
      break ;
  }
...
void goil_syntax::rule_goil_5F_syntax_free_5F_field_i8_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  switch (select_goil_5F_syntax_4 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_idf) COMMA_HERE) ;
      var_cas_val = GGS_string_class ::constructor_new (inLexique, var_cas_value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (527)), var_cas_value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (527)) COMMA_SOURCE_FILE_AT_LINE (527)) ;
      } break ;
    case 2 : {
      ...
      var_cas_val = GGS_uint64_class ::constructor_new (inLexique, var_cas_value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (531)), var_cas_value.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (531)) COMMA_SOURCE_FILE_AT_LINE (531)) ;
      } break ;
    case 3 : {
      GGS_lbool  var_cas_value ;
      nt_boolean_ (inLexique, var_cas_value) ;
      var_cas_val = GGS_bool_class ::constructor_new (inLexique, var_cas_idf.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (535)), var_cas_value.reader_bool (inLexique COMMA_SOURCE_FILE_AT_LINE (535)) COMMA_SOURCE_FILE_AT_LINE (535)) ;
      } break ;
    default :
      break ;
  }
  var_cas_ids.modifier_put (inLexique, var_cas_idf, var_cas_val COMMA_SOURCE_FILE_AT_LINE (539)) ;
}
...
void goil_syntax::rule_goil_5F_syntax_include_5F_file_5F_level_i9_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  switch (select_goil_5F_syntax_5 (inLexique)) {
    case 1 : {
      ...
      ::routine_file_in_path (inLexique,  var_cas_file_name COMMA_SOURCE_FILE_AT_LINE (550)) ;
      } break ;
    case 2 : {
      inLexique.assignFromAttribute_a_5F_string (var_cas_file_name) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_string) COMMA_HERE) ;
...
void goil_syntax::rule_goil_5F_syntax_include_5F_cpu_5F_level_i10_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  switch (select_goil_5F_syntax_6 (inLexique)) {
    case 1 : {
      inLexique.assignFromAttribute_a_5F_string (var_cas_file_name) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_g_5F_string) COMMA_HERE) ;
      ::routine_file_in_path (inLexique,  var_cas_file_name COMMA_SOURCE_FILE_AT_LINE (578)) ;
      } break ;
    case 2 : {
      inLexique.assignFromAttribute_a_5F_string (var_cas_file_name) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_string) COMMA_HERE) ;
