...
void goil_syntax::rule_goil_5F_syntax_start_i0_ (C_Lexique_goil_5F_lexique & inLexique) {
  GGS_implementation  var_cas_imp = GGS_implementation ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (137)) ;
  GGS_void  var_cas_void_obj = GGS_void ::constructor_new (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (138)) ;
  ...
  const GGS_bool cond_4416 = (var_cas_oilConfigFile).operator_isNotEqual (GGS_string ("")) ;
  if (cond_4416.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_5376 = (GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (176))).operator_isEqual (GGS_uint (0U)) ;
  if (cond_5376.isBuiltAndTrue ()) {
...
void goil_syntax::rule_goil_5F_syntax_file_i1_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  GGS_lstring  var_cas_version = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (186)) ;
  GGS_lstring  var_cas_desc = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (187)) ;
...
void goil_syntax::rule_goil_5F_syntax_description_i2_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  switch (select_goil_5F_syntax_1 (inLexique)) {
    case 1 : {
      var_cas_desc = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (206)) ;
      } break ;
    case 2 : {
...
void goil_syntax::rule_goil_5F_syntax_application_5F_definition_i4_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  GGS_lstring  automatic_var_7443_0 ;
  nt_description_ (inLexique, automatic_var_7443_0) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
  var_cas_file = GGS_root_obj ::constructor_new (inLexique, var_cas_cpuName, var_cas_os, var_cas_com, var_cas_tasks, var_cas_counters, var_cas_alarms, var_cas_resources, var_cas_events, var_cas_isrs, var_cas_messages, var_cas_net_messages, var_cas_scheduletables, var_cas_applis COMMA_SOURCE_FILE_AT_LINE (264)) ;
}
    ...
    while (syntaxRepeat_2) {
      switch (select_goil_5F_syntax_2 (inLexique)) {
        ...
        case 3 : {
          ...
          GGS_lstring  automatic_var_8216_0 ;
          nt_description_ (inLexique, automatic_var_8216_0) ;
          } break ;
        case 4 : {
        ...
        case 6 : {
          ...
          GGS_lstring  automatic_var_8320_0 ;
          nt_description_ (inLexique, automatic_var_8320_0) ;
          } break ;
        case 7 : {
          nt_resource_ (inLexique, var_cas_resources) ;
          GGS_lstring  automatic_var_8372_0 ;
          nt_description_ (inLexique, automatic_var_8372_0) ;
          } break ;
        case 8 : {
          nt_event_ (inLexique, var_cas_events) ;
          GGS_lstring  automatic_var_8418_0 ;
          nt_description_ (inLexique, automatic_var_8418_0) ;
          } break ;
        case 9 : {
          nt_isr_ (inLexique, var_cas_isrs) ;
          GGS_lstring  automatic_var_8460_0 ;
          nt_description_ (inLexique, automatic_var_8460_0) ;
          } break ;
        case 10 : {
          nt_mess_ (inLexique, var_cas_messages) ;
          GGS_lstring  automatic_var_8507_0 ;
          nt_description_ (inLexique, automatic_var_8507_0) ;
          } break ;
        case 11 : {
          nt_networkmess_ (inLexique, var_cas_net_messages) ;
          GGS_lstring  automatic_var_8565_0 ;
          nt_description_ (inLexique, automatic_var_8565_0) ;
          } break ;
        case 12 : {
          nt_com_ (inLexique, var_cas_com) ;
          GGS_lstring  automatic_var_8606_0 ;
          nt_description_ (inLexique, automatic_var_8606_0) ;
          } break ;
        case 13 : {
          nt_ipdu_ (inLexique) ;
          GGS_lstring  automatic_var_8642_0 ;
          nt_description_ (inLexique, automatic_var_8642_0) ;
          } break ;
        case 14 : {
          nt_nm_ (inLexique) ;
          GGS_lstring  automatic_var_8676_0 ;
          nt_description_ (inLexique, automatic_var_8676_0) ;
          } break ;
        case 15 : {
          nt_scheduletable_ (inLexique, var_cas_scheduletables) ;
          GGS_lstring  automatic_var_8738_0 ;
          nt_description_ (inLexique, automatic_var_8738_0) ;
          } break ;
        case 16 : {
          nt_appli_ (inLexique, var_cas_applis) ;
          GGS_lstring  automatic_var_8784_0 ;
          nt_description_ (inLexique, automatic_var_8784_0) ;
          } break ;
        case 17 : {
...
void goil_syntax::rule_goil_5F_syntax_boolean_i7_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  switch (select_goil_5F_syntax_3 (inLexique)) {
    case 1 : {
      ...
      var_cas_val = GGS_lbool ::constructor_new (inLexique, GGS_bool (true), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (343)) ;
      } break ;
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_FALSE) COMMA_HERE) ;
      var_cas_val = GGS_lbool ::constructor_new (inLexique, GGS_bool (false), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (346)) ;
      } break ;
    default :
      break ;
  }
...
void goil_syntax::rule_goil_5F_syntax_free_5F_field_i8_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  switch (select_goil_5F_syntax_4 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_idf) COMMA_HERE) ;
      var_cas_val = GGS_string_class ::constructor_new (inLexique, var_cas_value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (358)), var_cas_value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)) ;
      } break ;
    case 2 : {
      ...
      var_cas_val = GGS_uint64_class ::constructor_new (inLexique, var_cas_value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (362)), var_cas_value.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) COMMA_SOURCE_FILE_AT_LINE (362)) ;
      } break ;
    case 3 : {
      GGS_lbool  var_cas_value ;
      nt_boolean_ (inLexique, var_cas_value) ;
      var_cas_val = GGS_bool_class ::constructor_new (inLexique, var_cas_idf.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (366)), var_cas_value.reader_bool (inLexique COMMA_SOURCE_FILE_AT_LINE (366)) COMMA_SOURCE_FILE_AT_LINE (366)) ;
      } break ;
    default :
      break ;
  }
