    ...
    if (((var_cas_temp_dir)._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      if (((var_cas_target)._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
        ...
        if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (402)))).isBuiltAndTrue ()) {
          ...
          ::routine_generate_trusted_functions (_inLexique,  var_cas_applis,  var_cas_header,  var_cas_obj_header,  var_cas_implementation COMMA_SOURCE_FILE_AT_LINE (424)) ;
        }
        ::routine_generate_ready_list (_inLexique,  var_cas_os,  var_cas_max_prio,  var_cas_ready_list,  var_cas_obj_header,  var_cas_implementation COMMA_SOURCE_FILE_AT_LINE (431)) ;
        ::routine_generate_types (_inLexique,  var_cas_tasks,  var_cas_isrs,  var_cas_alarms,  var_cas_counters,  var_cas_resources,  var_cas_scheduletables,  var_cas_applis,  var_cas_max_prio,  var_cas_types COMMA_SOURCE_FILE_AT_LINE (438)) ;
        GGS_string var_cas_directory ;
        ::routine_getProjectName (_inLexique,  var_cas_directory COMMA_SOURCE_FILE_AT_LINE (455)) ;
        ...
        var_cas_header = var_cas_header.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$HEADER$"), var_cas_header_file COMMA_SOURCE_FILE_AT_LINE (462)) ;
        var_cas_header = var_cas_header.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$IMPLEMENTATION$"), var_cas_implementation_file COMMA_SOURCE_FILE_AT_LINE (463)) ;
        var_cas_header = var_cas_header.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TIMESTAMP$"), var_cas_timestamp COMMA_SOURCE_FILE_AT_LINE (464)) ;
        var_cas_obj_header = var_cas_obj_header.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$OBJ_HEADER$"), var_cas_obj_header_file COMMA_SOURCE_FILE_AT_LINE (465)) ;
        var_cas_obj_header = var_cas_obj_header.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TIMESTAMP$"), var_cas_timestamp COMMA_SOURCE_FILE_AT_LINE (466)) ;
        var_cas_implementation = var_cas_implementation.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$HEADER$"), var_cas_header_file COMMA_SOURCE_FILE_AT_LINE (467)) ;
        var_cas_implementation = var_cas_implementation.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$OBJ_HEADER$"), var_cas_obj_header_file COMMA_SOURCE_FILE_AT_LINE (468)) ;
        var_cas_implementation = var_cas_implementation.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$IMPLEMENTATION$"), var_cas_implementation_file COMMA_SOURCE_FILE_AT_LINE (469)) ;
        var_cas_implementation = var_cas_implementation.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TIMESTAMP$"), var_cas_timestamp COMMA_SOURCE_FILE_AT_LINE (470)) ;
        ...
        if (((var_cas_error_count)._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (480)))).isBuiltAndTrue ()) {
          ...
          const GGS_string _temp_15809 = var_cas_header ;
          if (_temp_15809._isBuilt ()) {
            _temp_15809 (HERE)->method_makeDirectoryAndWriteToFile (_inLexique, var_cas_header_file COMMA_SOURCE_FILE_AT_LINE (483)) ;
          }
          if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (484)))).isBuiltAndTrue ()) {
          ...
          const GGS_string _temp_16037 = var_cas_obj_header ;
          if (_temp_16037._isBuilt ()) {
            _temp_16037 (HERE)->method_makeDirectoryAndWriteToFile (_inLexique, var_cas_obj_header_file COMMA_SOURCE_FILE_AT_LINE (487)) ;
          }
          if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (488)))).isBuiltAndTrue ()) {
          ...
          const GGS_string _temp_16277 = var_cas_implementation ;
          if (_temp_16277._isBuilt ()) {
            _temp_16277 (HERE)->method_makeDirectoryAndWriteToFile (_inLexique, var_cas_implementation_file COMMA_SOURCE_FILE_AT_LINE (491)) ;
          }
          if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (492)))).isBuiltAndTrue ()) {
          ...
          const GGS_string _temp_16504 = var_cas_types ;
          if (_temp_16504._isBuilt ()) {
            _temp_16504 (HERE)->method_makeDirectoryAndWriteToFile (_inLexique, var_cas_types_file COMMA_SOURCE_FILE_AT_LINE (495)) ;
          }
          if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "generate_makefile" COMMA_SOURCE_FILE_AT_LINE (497)))).isBuiltAndTrue ()) {
            GGS_string var_cas_makefile_dir ;
            var_cas_makefile_dir = var_cas_directory.reader_stringByDeletingLastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (498)) ;
            if (((var_cas_makefile_dir)._operator_isEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
              var_cas_makefile_dir = GGS_string (true, ".") ;
            }
            if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (502)))).isBuiltAndTrue ()) {
            ...
            ::routine_generate_makefile (_inLexique,  var_cas_os,  var_cas_makefile_dir,  GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_stringByDeletingPathExtension (_inLexique COMMA_SOURCE_FILE_AT_LINE (509)).reader_lastPathComponent (_inLexique COMMA_SOURCE_FILE_AT_LINE (509)) COMMA_SOURCE_FILE_AT_LINE (505)) ;
          }
        }
      }else{
...
void goil_syntax::
pr_file_goil_syntax_522_11_ (goil_lexique & _inLexique,
                                GGS_implementation  &var_cas_imp,
                                GGS_root_obj  &var_cas_cpu) {
...
void goil_syntax::
pr_description_goil_syntax_544_18_ (goil_lexique & _inLexique,
                                GGS_lstring  &var_cas_desc) {
...
void goil_syntax::
pr_OIL_version_goil_syntax_556_18_ (goil_lexique & _inLexique,
                                GGS_lstring  &var_cas_version,
                                GGS_lstring  &var_cas_desc) {
...
void goil_syntax::
pr_application_definition_goil_syntax_567_29_ (goil_lexique & _inLexique,
                                GGS_root_obj  &var_cas_file) {
  GGS_os_obj  var_cas_os ;
  var_cas_os = var_cas_file.reader_os (_inLexique COMMA_SOURCE_FILE_AT_LINE (570)) ;
  GGS_com  var_cas_com ;
  var_cas_com = var_cas_file.reader_com (_inLexique COMMA_SOURCE_FILE_AT_LINE (571)) ;
  GGS_task_map  var_cas_tasks ;
  var_cas_tasks = var_cas_file.reader_tasks (_inLexique COMMA_SOURCE_FILE_AT_LINE (572)) ;
  GGS_counter_map  var_cas_counters ;
  var_cas_counters = var_cas_file.reader_counters (_inLexique COMMA_SOURCE_FILE_AT_LINE (573)) ;
  GGS_alarm_map  var_cas_alarms ;
  var_cas_alarms = var_cas_file.reader_alarms (_inLexique COMMA_SOURCE_FILE_AT_LINE (574)) ;
  GGS_resource_map  var_cas_resources ;
  var_cas_resources = var_cas_file.reader_resources (_inLexique COMMA_SOURCE_FILE_AT_LINE (575)) ;
  GGS_event_map  var_cas_events ;
  var_cas_events = var_cas_file.reader_events (_inLexique COMMA_SOURCE_FILE_AT_LINE (576)) ;
  GGS_isr_map  var_cas_isrs ;
  var_cas_isrs = var_cas_file.reader_isrs (_inLexique COMMA_SOURCE_FILE_AT_LINE (577)) ;
  GGS_message_map  var_cas_messages ;
  var_cas_messages = var_cas_file.reader_messages (_inLexique COMMA_SOURCE_FILE_AT_LINE (578)) ;
  GGS_netmess_map  var_cas_net_messages ;
  var_cas_net_messages = var_cas_file.reader_net_messages (_inLexique COMMA_SOURCE_FILE_AT_LINE (579)) ;
  GGS_scheduletable_map  var_cas_scheduletables ;
  var_cas_scheduletables = var_cas_file.reader_scheduletables (_inLexique COMMA_SOURCE_FILE_AT_LINE (580)) ;
  GGS_app_map  var_cas_applis ;
  var_cas_applis = var_cas_file.reader_applis (_inLexique COMMA_SOURCE_FILE_AT_LINE (581)) ;
...
void goil_syntax::
pr_object_definition_list_goil_syntax_620_29_ (goil_lexique & _inLexique,
                                GGS_os_obj  &var_cas_os,
                                GGS_com  &var_cas_com,
                                GGS_task_map  &var_cas_tasks,
                                GGS_counter_map  &var_cas_counters,
...
void goil_syntax::
pr_nm_goil_syntax_668_9_ (goil_lexique & _inLexique) {
...
void goil_syntax::
pr_boolean_goil_syntax_679_14_ (goil_lexique & _inLexique,
...
void goil_syntax::
pr_free_field_goil_syntax_689_17_ (goil_lexique & _inLexique,
  ...
  switch (select_goil_syntax_4 (_inLexique)) {
    case 1 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
      var_cas_val = GGS_string_class ::constructor_new (_inLexique, var_cas_value.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (697)), var_cas_value.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (697)) COMMA_HERE) ;
      } break ;
    case 2 : {
      ...
      var_cas_val = GGS_uint64_class ::constructor_new (_inLexique, var_cas_value.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (701)), var_cas_value.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (701)) COMMA_HERE) ;
      } break ;
    case 3 : {
      GGS_lbool  var_cas_value ;
      nt_boolean_ (_inLexique, var_cas_value) ;
      var_cas_val = GGS_bool_class ::constructor_new (_inLexique, var_cas_idf.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (705)), var_cas_value.reader_bool (_inLexique COMMA_SOURCE_FILE_AT_LINE (705)) COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
  var_cas_ids.modifier_put (_inLexique, var_cas_idf, var_cas_val COMMA_SOURCE_FILE_AT_LINE (707)) ;
}
...
void goil_syntax::
pr_include_file_level_goil_syntax_710_25_ (goil_lexique & _inLexique,
                                GGS_implementation  &var_cas_imp,
                                GGS_root_obj  &var_cas_cpu) {
  ...
  switch (select_goil_syntax_5 (_inLexique)) {
    case 1 : {
      ...
      ::routine_file_in_path (_inLexique,  var_cas_file_name COMMA_SOURCE_FILE_AT_LINE (718)) ;
      } break ;
    case 2 : {
      _inLexique._assignFromAttribute_a_string (var_cas_file_name) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_string) COMMA_HERE) ;
...
void goil_syntax::
pr_include_cpu_level_goil_syntax_728_24_ (goil_lexique & _inLexique,
                                GGS_os_obj  &var_cas_os,
                                GGS_com  &var_cas_com,
                                GGS_task_map  &var_cas_tasks,
                                GGS_counter_map  &var_cas_counters,
  ...
  switch (select_goil_syntax_6 (_inLexique)) {
    case 1 : {
      _inLexique._assignFromAttribute_a_string (var_cas_file_name) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_g_5Fstring) COMMA_HERE) ;
      ::routine_file_in_path (_inLexique,  var_cas_file_name COMMA_SOURCE_FILE_AT_LINE (746)) ;
      } break ;
    case 2 : {
      _inLexique._assignFromAttribute_a_string (var_cas_file_name) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_string) COMMA_HERE) ;
