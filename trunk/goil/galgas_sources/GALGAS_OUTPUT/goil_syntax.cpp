...
void cParser_goil_5F_syntax::rule_goil_5F_syntax_include_5F_file_5F_level_i9_ (GALGAS_implementation & ioArgument_imp,
  ...
  case 2: {
    //-------- @terminalCheckInstructionForGeneration
    var_file_5F_name = inCompiler->synthetizedAttribute_a_5F_string () ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_string) COMMA_SOURCE_FILE_AT_LINE (526)) ;
  } break ;
  default:
    break ;
  }
  { //-------- @grammarInstructionWithSourceFileForGeneration
  cGrammar_goil_5F_file_5F_level_5F_include::_performSourceFileParsing_ (inCompiler, var_file_5F_name, ioArgument_imp, ioArgument_cpu COMMA_SOURCE_FILE_AT_LINE (528)) ;
  } //-------- END @grammarInstructionWithSourceFileForGeneration
}
...
void cParser_goil_5F_syntax::rule_goil_5F_syntax_include_5F_cpu_5F_level_i10_ (GALGAS_os_5F_obj & ioArgument_os,
                                                                               ...
                                                                               C_Lexique_goil_5F_lexique * inCompiler) {
  //-------- @terminalCheckInstructionForGeneration
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_include) COMMA_SOURCE_FILE_AT_LINE (548)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_lstring var_file_5F_name ;
  //-------- @selectInstructionForGeneration
  ...
  case 1: {
    //-------- @terminalCheckInstructionForGeneration
    var_file_5F_name = inCompiler->synthetizedAttribute_a_5F_string () ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_g_5F_string) COMMA_SOURCE_FILE_AT_LINE (551)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_file_5F_in_5F_path (var_file_5F_name, inCompiler COMMA_SOURCE_FILE_AT_LINE (552)) ;
    } //-------- @routineCallInstructionForGeneration
  } break ;
  case 2: {
    //-------- @terminalCheckInstructionForGeneration
    var_file_5F_name = inCompiler->synthetizedAttribute_a_5F_string () ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_string) COMMA_SOURCE_FILE_AT_LINE (554)) ;
  } break ;
  default:
    break ;
  }
