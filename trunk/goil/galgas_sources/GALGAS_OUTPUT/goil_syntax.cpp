  ...
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_temp_dir)._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
      ...
      if (((var_cas_target)._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
        ...
        ::routine_generate_tasks (_inLexique,  var_cas_cfg,  var_cas_tasks,  var_cas_applis,  var_cas_resources,  var_cas_tasks_actual_prio,  var_cas_app_for_obj,  var_cas_header,  var_cas_obj_header,  var_cas_implementation COMMA_SOURCE_FILE_AT_LINE (344)) ;
        ::routine_generate_isrs (_inLexique,  var_cas_cfg,  var_cas_isrs,  var_cas_applis,  var_cas_resources,  var_cas_isrs_actual_prio,  var_cas_app_for_obj,  var_cas_header,  var_cas_obj_header,  var_cas_implementation COMMA_SOURCE_FILE_AT_LINE (355)) ;
        ::routine_generate_proc_table (_inLexique,  var_cas_tasks,  var_cas_isrs,  var_cas_header,  var_cas_implementation,  var_cas_obj_header COMMA_SOURCE_FILE_AT_LINE (368)) ;
        ::routine_generate_mp (_inLexique,  var_cas_tasks,  var_cas_isrs,  var_cas_applis,  var_cas_app_for_obj COMMA_SOURCE_FILE_AT_LINE (375)) ;
        ::routine_generate_resources (_inLexique,  var_cas_resources,  var_cas_rez_actual_prio,  var_cas_rez_comments,  var_cas_app_for_obj,  var_cas_header,  var_cas_obj_header,  var_cas_implementation COMMA_SOURCE_FILE_AT_LINE (381)) ;
        ::routine_generate_messages (_inLexique,  var_cas_messages,  var_cas_prefix,  var_cas_header,  var_cas_obj_header,  var_cas_implementation COMMA_SOURCE_FILE_AT_LINE (390)) ;
        ::routine_generate_network_messages (_inLexique,  var_cas_net_messages,  var_cas_messages,  var_cas_header,  var_cas_obj_header,  var_cas_implementation COMMA_SOURCE_FILE_AT_LINE (397)) ;
        if ((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (404)))).isBuiltAndTrue ()) {
          ::routine_generate_schedule_tables (_inLexique,  var_cas_scheduletables,  var_cas_app_for_obj,  var_cas_header,  var_cas_obj_header,  var_cas_implementation COMMA_SOURCE_FILE_AT_LINE (405)) ;
          ::routine_generate_timing_prot (_inLexique,  var_cas_tasks,  var_cas_resources,  var_cas_obj_header COMMA_SOURCE_FILE_AT_LINE (411)) ;
          ::routine_generate_apps (_inLexique,  var_cas_applis,  var_cas_tasks,  var_cas_isrs,  var_cas_alarms,  var_cas_resources,  var_cas_scheduletables,  var_cas_counters,  var_cas_header,  var_cas_obj_header,  var_cas_implementation COMMA_SOURCE_FILE_AT_LINE (415)) ;
          ::routine_generate_trusted_functions (_inLexique,  var_cas_applis,  var_cas_header,  var_cas_obj_header,  var_cas_implementation COMMA_SOURCE_FILE_AT_LINE (426)) ;
        }
        ::routine_generate_ready_list (_inLexique,  var_cas_os,  var_cas_max_prio,  var_cas_ready_list,  var_cas_obj_header,  var_cas_implementation COMMA_SOURCE_FILE_AT_LINE (433)) ;
        ::routine_generate_types (_inLexique,  var_cas_tasks,  var_cas_isrs,  var_cas_alarms,  var_cas_counters,  var_cas_resources,  var_cas_scheduletables,  var_cas_applis,  var_cas_max_prio,  var_cas_types COMMA_SOURCE_FILE_AT_LINE (440)) ;
        GGS_string var_cas_directory ;
        ::routine_getProjectName (_inLexique,  var_cas_directory COMMA_SOURCE_FILE_AT_LINE (457)) ;
        ...
        if (((var_cas_error_count)._operator_isEqual (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
          ...
          const GGS_string _temp_15865 = var_cas_header ;
          if (_temp_15865._isBuilt ()) {
            _temp_15865 (HERE)->method_makeDirectoryAndWriteToFile (_inLexique, var_cas_header_file COMMA_SOURCE_FILE_AT_LINE (485)) ;
          }
          ...
          const GGS_string _temp_16093 = var_cas_obj_header ;
          if (_temp_16093._isBuilt ()) {
            _temp_16093 (HERE)->method_makeDirectoryAndWriteToFile (_inLexique, var_cas_obj_header_file COMMA_SOURCE_FILE_AT_LINE (489)) ;
          }
          ...
          const GGS_string _temp_16333 = var_cas_implementation ;
          if (_temp_16333._isBuilt ()) {
            _temp_16333 (HERE)->method_makeDirectoryAndWriteToFile (_inLexique, var_cas_implementation_file COMMA_SOURCE_FILE_AT_LINE (493)) ;
          }
          ...
          const GGS_string _temp_16560 = var_cas_types ;
          if (_temp_16560._isBuilt ()) {
            _temp_16560 (HERE)->method_makeDirectoryAndWriteToFile (_inLexique, var_cas_types_file COMMA_SOURCE_FILE_AT_LINE (497)) ;
          }
...
void goil_syntax::
pr_file_goil_syntax_524_11_ (goil_lexique & _inLexique,
                                GGS_implementation  &var_cas_imp,
                                GGS_root_obj  &var_cas_cpu) {
...
void goil_syntax::
pr_description_goil_syntax_546_18_ (goil_lexique & _inLexique,
                                GGS_lstring  &var_cas_desc) {
...
void goil_syntax::
pr_OIL_version_goil_syntax_558_18_ (goil_lexique & _inLexique,
                                GGS_lstring  &var_cas_version,
                                GGS_lstring  &var_cas_desc) {
...
void goil_syntax::
pr_application_definition_goil_syntax_569_29_ (goil_lexique & _inLexique,
                                GGS_root_obj  &var_cas_file) {
  GGS_os_obj  var_cas_os ;
  var_cas_os = var_cas_file.reader_os (_inLexique COMMA_SOURCE_FILE_AT_LINE (572)) ;
  GGS_com  var_cas_com ;
  var_cas_com = var_cas_file.reader_com (_inLexique COMMA_SOURCE_FILE_AT_LINE (573)) ;
  GGS_task_map  var_cas_tasks ;
  var_cas_tasks = var_cas_file.reader_tasks (_inLexique COMMA_SOURCE_FILE_AT_LINE (574)) ;
  GGS_counter_map  var_cas_counters ;
  var_cas_counters = var_cas_file.reader_counters (_inLexique COMMA_SOURCE_FILE_AT_LINE (575)) ;
  GGS_alarm_map  var_cas_alarms ;
  var_cas_alarms = var_cas_file.reader_alarms (_inLexique COMMA_SOURCE_FILE_AT_LINE (576)) ;
  GGS_resource_map  var_cas_resources ;
  var_cas_resources = var_cas_file.reader_resources (_inLexique COMMA_SOURCE_FILE_AT_LINE (577)) ;
  GGS_event_map  var_cas_events ;
  var_cas_events = var_cas_file.reader_events (_inLexique COMMA_SOURCE_FILE_AT_LINE (578)) ;
  GGS_isr_map  var_cas_isrs ;
  var_cas_isrs = var_cas_file.reader_isrs (_inLexique COMMA_SOURCE_FILE_AT_LINE (579)) ;
  GGS_message_map  var_cas_messages ;
  var_cas_messages = var_cas_file.reader_messages (_inLexique COMMA_SOURCE_FILE_AT_LINE (580)) ;
  GGS_netmess_map  var_cas_net_messages ;
  var_cas_net_messages = var_cas_file.reader_net_messages (_inLexique COMMA_SOURCE_FILE_AT_LINE (581)) ;
  GGS_scheduletable_map  var_cas_scheduletables ;
  var_cas_scheduletables = var_cas_file.reader_scheduletables (_inLexique COMMA_SOURCE_FILE_AT_LINE (582)) ;
  GGS_app_map  var_cas_applis ;
  var_cas_applis = var_cas_file.reader_applis (_inLexique COMMA_SOURCE_FILE_AT_LINE (583)) ;
...
void goil_syntax::
pr_object_definition_list_goil_syntax_622_29_ (goil_lexique & _inLexique,
                                GGS_os_obj  &var_cas_os,
                                GGS_com  &var_cas_com,
                                GGS_task_map  &var_cas_tasks,
                                GGS_counter_map  &var_cas_counters,
...
void goil_syntax::
pr_nm_goil_syntax_670_9_ (goil_lexique & _inLexique) {
...
void goil_syntax::
pr_boolean_goil_syntax_681_14_ (goil_lexique & _inLexique,
...
void goil_syntax::
pr_free_field_goil_syntax_691_17_ (goil_lexique & _inLexique,
  ...
  switch (select_goil_syntax_4 (_inLexique)) {
    case 1 : {
      ...
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
      var_cas_val = GGS_string_class ::constructor_new (_inLexique, var_cas_value.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (699)), var_cas_value.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (699)) COMMA_HERE) ;
      } break ;
    case 2 : {
      ...
      var_cas_val = GGS_uint64_class ::constructor_new (_inLexique, var_cas_value.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (703)), var_cas_value.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (703)) COMMA_HERE) ;
      } break ;
    case 3 : {
      GGS_lbool  var_cas_value ;
      nt_boolean_ (_inLexique, var_cas_value) ;
      var_cas_val = GGS_bool_class ::constructor_new (_inLexique, var_cas_idf.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (707)), var_cas_value.reader_bool (_inLexique COMMA_SOURCE_FILE_AT_LINE (707)) COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
  var_cas_ids.modifier_put (_inLexique, var_cas_idf, var_cas_val COMMA_SOURCE_FILE_AT_LINE (709)) ;
}
...
void goil_syntax::
pr_include_file_level_goil_syntax_712_25_ (goil_lexique & _inLexique,
                                GGS_implementation  &var_cas_imp,
                                GGS_root_obj  &var_cas_cpu) {
  ...
  switch (select_goil_syntax_5 (_inLexique)) {
    case 1 : {
      ...
      ::routine_file_in_path (_inLexique,  var_cas_file_name COMMA_SOURCE_FILE_AT_LINE (720)) ;
      } break ;
    case 2 : {
      _inLexique._assignFromAttribute_a_string (var_cas_file_name) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_string) COMMA_HERE) ;
...
void goil_syntax::
pr_include_cpu_level_goil_syntax_730_24_ (goil_lexique & _inLexique,
                                GGS_os_obj  &var_cas_os,
                                GGS_com  &var_cas_com,
                                GGS_task_map  &var_cas_tasks,
                                GGS_counter_map  &var_cas_counters,
  ...
  switch (select_goil_syntax_6 (_inLexique)) {
    case 1 : {
      _inLexique._assignFromAttribute_a_string (var_cas_file_name) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_g_5Fstring) COMMA_HERE) ;
      ::routine_file_in_path (_inLexique,  var_cas_file_name COMMA_SOURCE_FILE_AT_LINE (748)) ;
      } break ;
    case 2 : {
      _inLexique._assignFromAttribute_a_string (var_cas_file_name) ;
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_string) COMMA_HERE) ;
