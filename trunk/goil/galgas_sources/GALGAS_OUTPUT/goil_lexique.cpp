...
static const C_unicode_lexique_table_entry ktable_for_timing_prot_attribs [ktable_size_timing_prot_attribs] = {
  ...
  C_unicode_lexique_table_entry (kUnicodeString_COUNTLIMIT, 10, C_Lexique_goil_5F_lexique::kToken_COUNTLIMIT),
...
GALGAS_ldouble * C_Lexique_goil_5F_lexique::synthetizedAttribute_floatNumber (void) const {
  ...
  macroValidObject (ptr, cTokenFor_goil_5F_lexique) ;
  GALGAS_location * currentLocation = GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE) ;
  GALGAS_double * value = GALGAS_double::constructor_new (ptr->mLexicalAttribute_floatNumber COMMA_HERE) ;
...
GALGAS_luint_36__34_ * C_Lexique_goil_5F_lexique::synthetizedAttribute_integerNumber (void) const {
  ...
  macroValidObject (ptr, cTokenFor_goil_5F_lexique) ;
  GALGAS_location * currentLocation = GALGAS_location::constructor_new (ptr->mStartLocation, ptr->mEndLocation, sourceText () COMMA_HERE) ;
  GALGAS_uint_36__34_ * value = GALGAS_uint_36__34_::constructor_new (ptr->mLexicalAttribute_integerNumber COMMA_HERE) ;
