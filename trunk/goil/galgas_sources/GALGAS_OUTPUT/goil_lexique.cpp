...
static const char * gSyntaxErrorMessage_METHOD = "os attribute 'METHOD'" ;

//--- Syntax error message for terminal '$FORMAT$' :
static const char * gSyntaxErrorMessage_FORMAT = "os attribute 'FORMAT'" ;
...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [250] = {"end of source",
...
const sint16 goil_lexique::goil_lexique_table_size_os_attributes = 15 ;

const C_lexique_table_entry goil_lexique::goil_lexique_table_for_os_attributes [15] = {
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [250] = {0,
