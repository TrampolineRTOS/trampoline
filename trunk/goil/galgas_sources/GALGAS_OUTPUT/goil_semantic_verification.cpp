...
void routine_all_alarm_actions_correct (C_Compiler & inLexique,
  ...
  var_cas_defined_task_names = var_cas_tasks.reader_allKeys (inLexique COMMA_SOURCE_FILE_AT_LINE (236)) ;
  {
    ...
    while (((operand_7179 = enumerator_7179.nextObject ()))) {
      ...
      { const GGS_action_obj _var_9034 = var_cas_alarm_action ; // CAST instruction
        if (_var_9034.getPtr () != NULL) {
          macroValidPointer (_var_9034.getPtr ()) ;
          if (typeid (cPtr_setevent_action) == typeid (* (_var_9034.getPtr ()))) {
            const GGS_setevent_action var_cas_act (_var_9034.getPtr ()) ;
            if (((var_cas_defined_task_names.reader_hasKey (inLexique, var_cas_act.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (242)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (242)) COMMA_SOURCE_FILE_AT_LINE (242))).operator_not ()).isBuiltAndTrue ()) {
              ...
              const GGS_task_map  temp_7628 = var_cas_tasks ;
              if (temp_7628.isBuilt ()) {
                temp_7628 (HERE)->method_get (inLexique, var_cas_act.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (247)), var_cas_task_data COMMA_SOURCE_FILE_AT_LINE (247)) ;
              }
          ...
          }else if (typeid (cPtr_activatetask_action) == typeid (* (_var_9034.getPtr ()))) {
            const GGS_activatetask_action var_cas_act (_var_9034.getPtr ()) ;
          ...
          }else if (typeid (cPtr_incrementcounter_action) == typeid (* (_var_9034.getPtr ()))) {
            const GGS_incrementcounter_action var_cas_act (_var_9034.getPtr ()) ;
            if ((var_cas_counters.reader_hasKey (inLexique, var_cas_act.reader_counter_name (inLexique COMMA_SOURCE_FILE_AT_LINE (263)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (263)) COMMA_SOURCE_FILE_AT_LINE (263))).isBuiltAndTrue ()) {
              ...
              const GGS_counter_map  temp_8585 = var_cas_counters ;
              if (temp_8585.isBuilt ()) {
                temp_8585 (HERE)->method_getCounter (inLexique, var_cas_act.reader_counter_name (inLexique COMMA_SOURCE_FILE_AT_LINE (265)), var_cas_cnt COMMA_SOURCE_FILE_AT_LINE (265)) ;
              }
              { const GGS_counter_type _var_8872 = var_cas_cnt.reader_type (inLexique COMMA_SOURCE_FILE_AT_LINE (266)) ; // CAST instruction
                if (_var_8872.getPtr () != NULL) {
                  macroValidPointer (_var_8872.getPtr ()) ;
                  if (typeid (cPtr_software_counter) == typeid (* (_var_8872.getPtr ()))) {
                  }else{
...
void routine_verify_all (C_Compiler & inLexique,
  ...
  if ((GGS_bool (inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (315)))).isBuiltAndTrue ()) {
