...
//                    november 17th, 2010, at 10h57'56"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_verify_all (C_Compiler & inLexique,
  ...
  GGS_resource_map  var_cas_resources = var_cas_cpu.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (309)) ;
  ::routine_resolve_linked_resources (inLexique,  var_cas_resources COMMA_SOURCE_FILE_AT_LINE (310)) ;
  var_cas_cpu.modifier_setResources (inLexique, var_cas_resources COMMA_SOURCE_FILE_AT_LINE (311)) ;
  ::routine_all_events_and_resources_and_messages_defined_and_used (inLexique,  var_cas_cpu COMMA_SOURCE_FILE_AT_LINE (313)) ;
  ::routine_all_alarm_actions_correct (inLexique,  var_cas_cpu.reader_alarms (inLexique COMMA_SOURCE_FILE_AT_LINE (315)),  var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (315)),  var_cas_cpu.reader_counters (inLexique COMMA_SOURCE_FILE_AT_LINE (315)) COMMA_SOURCE_FILE_AT_LINE (315)) ;
  ::routine_counters_of_alarms_defined (inLexique,  var_cas_cpu.reader_alarms (inLexique COMMA_SOURCE_FILE_AT_LINE (316)),  var_cas_cpu.reader_counters (inLexique COMMA_SOURCE_FILE_AT_LINE (316)) COMMA_SOURCE_FILE_AT_LINE (316)) ;
  ::routine_networkmessages_exist_and_ok (inLexique,  var_cas_cpu.reader_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (317)),  var_cas_cpu.reader_net_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (317)) COMMA_SOURCE_FILE_AT_LINE (317)) ;
  const GGS_bool cond_10731 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_10731.isBuiltAndTrue ()) {
    ::routine_schedule_tables_well_formed (inLexique,  var_cas_cpu.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (321)),  var_cas_cpu COMMA_SOURCE_FILE_AT_LINE (321)) ;
    ::routine_schedule_tables_counters_exist_and_compatible (inLexique,  var_cas_cpu.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (322)),  var_cas_cpu.reader_counters (inLexique COMMA_SOURCE_FILE_AT_LINE (322)) COMMA_SOURCE_FILE_AT_LINE (322)) ;
    ::routine_schedule_tables_tasks_and_events_exist (inLexique,  var_cas_cpu,  var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (323)) COMMA_SOURCE_FILE_AT_LINE (323)) ;
    ::routine_apps_well_formed (inLexique,  var_cas_cpu COMMA_SOURCE_FILE_AT_LINE (324)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
