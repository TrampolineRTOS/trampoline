      ...
      { const GGS_basic_type _var_1690 = operand_861->mInfo.task.reader_activation (inLexique COMMA_SOURCE_FILE_AT_LINE (54)) ; // CAST instruction
        if (_var_1690.getPtr () != NULL) {
          ...
          if (typeid (cPtr_void) == typeid (* (_var_1690.getPtr ()))) {
            ...
            const GGS_bool cond_1570 = ((var_cas_defined_events.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (59))).operator_strictSup (GGS_uint (0U))).operator_and ((var_cas_ui.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (59))).operator_strictSup (GGS_uint (1U))) ;
