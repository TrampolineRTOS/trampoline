...
void routine_checkTrampolinePath (C_Compiler & inLexique,
  ...
  const GGS_bool cond_3219 = (var_cas_osPath.reader_directoryExists ()).operator_not () ;
  ...
  const GGS_bool cond_3536 = (var_cas_machinesPath.reader_directoryExists ()).operator_not () ;
...
void routine_check_target (C_Compiler & inLexique,
  ...
  const GGS_bool cond_4065 = (var_cas_arch_path.reader_directoryExists ()).operator_not () ;
  if (cond_4065.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_4178 = (var_cas_chip_path.reader_directoryExists ()).operator_not () ;
    if (cond_4178.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_4291 = (var_cas_board_path.reader_directoryExists ()).operator_not () ;
