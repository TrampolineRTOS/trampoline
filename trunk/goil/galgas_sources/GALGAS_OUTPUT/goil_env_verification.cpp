...
void routine_getAbsoluteSourceFilePath (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_sourceFilePath = GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_stringByDeletingLastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (35)) ;
  const GGS_bool cond_966 = (var_cas_sourceFilePath).operator_isEqual (GGS_string ("")) ;
  if (cond_966.isBuiltAndTrue ()) {
    const GGS_bool cond_956 = (GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_firstCharacterOrNul (inLexique COMMA_SOURCE_FILE_AT_LINE (37))).operator_isNotEqual (GGS_char (TO_UNICODE ('/'))) ;
...
void routine_checkFileExists (C_Compiler & inLexique,
  ...
  const GGS_bool cond_1408 = (var_cas_absoluteFilePath.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (50))).operator_not () ;
...
void routine_checkFileDoesNotExists (C_Compiler & inLexique,
  ...
  const GGS_bool cond_2189 = var_cas_fileName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (65)).reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (65)) ;
  if (cond_2189.isBuiltAndTrue ()) {
    ...
    GGS_string var_cas_projectDir = function_project_name (inLexique COMMA_SOURCE_FILE_AT_LINE (71)) ;
    ...
    const GGS_bool cond_2568 = (var_cas_projectDir).operator_isEqual (var_cas_absoluteFilePath) ;
    if (cond_2568.isBuiltAndTrue ()) {
...
void routine_checkTrampolinePath (C_Compiler & inLexique,
  ...
  const GGS_bool cond_3219 = (var_cas_osPath.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (91))).operator_not () ;
  if (cond_3219.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_3536 = (var_cas_machinesPath.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (97))).operator_not () ;
  if (cond_3536.isBuiltAndTrue ()) {
...
void routine_check_target (C_Compiler & inLexique,
  ...
  const GGS_bool cond_4065 = (var_cas_arch_path.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (114))).operator_not () ;
  if (cond_4065.isBuiltAndTrue ()) {
  ...
  }else if (cond_4065.isBuiltAndFalse ()) {
    const GGS_bool cond_4178 = (var_cas_chip_path.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (116))).operator_not () ;
    ...
    }else if (cond_4178.isBuiltAndFalse ()) {
      const GGS_bool cond_4291 = (var_cas_board_path.reader_directoryExists (inLexique COMMA_SOURCE_FILE_AT_LINE (118))).operator_not () ;
