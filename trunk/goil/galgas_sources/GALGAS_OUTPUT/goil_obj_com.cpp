...
void goil_obj_com::rule_goil_5F_obj_5F_com_com_i0_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  GGS_lstring  automatic_var_1938_0 ;
  nt_description_ (inLexique, automatic_var_1938_0) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
  var_cas_com = GGS_com ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (81)), var_cas_usecom, var_cas_tb, var_cas_eh, var_cas_ugsid, var_cas_upa, var_cas_sce, var_cas_am, var_cas_s, var_cas_u COMMA_SOURCE_FILE_AT_LINE (80)) ;
}
...
void goil_obj_com::rule_goil_5F_obj_5F_com_comtimebase_i1_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  { const GGS_basic_type _var_2392 = var_cas_tb ; // CAST instruction
    if (_var_2392.getPtr () != NULL) {
      macroValidPointer (_var_2392.getPtr ()) ;
      if (typeid (cPtr_float_class) == typeid (* (_var_2392.getPtr ()))) {
        ...
        var_cas_tb = GGS_float_class ::constructor_new (inLexique, var_cas_f.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (104)), var_cas_f.reader_double (inLexique COMMA_SOURCE_FILE_AT_LINE (104)) COMMA_SOURCE_FILE_AT_LINE (104)) ;
      }
    }
  }
  GGS_lstring  automatic_var_2420_0 ;
  nt_description_ (inLexique, automatic_var_2420_0) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
}
...
void goil_obj_com::rule_goil_5F_obj_5F_com_comerrorhook_i2_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  GGS_lstring  automatic_var_2589_0 ;
  nt_description_ (inLexique, automatic_var_2589_0) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
}
...
void goil_obj_com::rule_goil_5F_obj_5F_com_comusegetserviceid_i3_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  GGS_lstring  automatic_var_2781_0 ;
  nt_description_ (inLexique, automatic_var_2781_0) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
}
...
void goil_obj_com::rule_goil_5F_obj_5F_com_comuseparameteraccess_i4_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  GGS_lstring  automatic_var_2978_0 ;
  nt_description_ (inLexique, automatic_var_2978_0) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
}
...
void goil_obj_com::rule_goil_5F_obj_5F_com_comappmode_i6_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  GGS_lstring  automatic_var_3346_0 ;
  nt_description_ (inLexique, automatic_var_3346_0) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
}
...
void goil_obj_com::rule_goil_5F_obj_5F_com_comstatus_i7_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  switch (select_goil_5F_obj_5F_com_1 (inLexique)) {
    case 1 : {
      ...
      var_cas_ss = GGS_lstring ::constructor_new (inLexique, GGS_string ("extended"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (160)) ;
      } break ;
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_COMSTANDARD) COMMA_HERE) ;
      var_cas_ss = GGS_lstring ::constructor_new (inLexique, GGS_string ("standard"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (162)) ;
      } break ;
    default :
      break ;
  }
  ::routine_set_lstring_if_empty (inLexique,  var_cas_s,  var_cas_ss,  GGS_string ("COMSTATUS") COMMA_SOURCE_FILE_AT_LINE (164)) ;
  GGS_lstring  automatic_var_3653_0 ;
  nt_description_ (inLexique, automatic_var_3653_0) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
}
...
void goil_obj_com::rule_goil_5F_obj_5F_com_use_i8_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  GGS_lstring  automatic_var_3811_0 ;
  nt_description_ (inLexique, automatic_var_3811_0) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
}
