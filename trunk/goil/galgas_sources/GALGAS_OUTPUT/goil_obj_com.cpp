...
//                    september 21th, 2009, at 18h18'42"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_comtimebase_goil_obj_com_92_18_ (goil_lexique & inLexique,
  ...
  { const GGS_basic_type _var_2271 = var_cas_tb ; // CAST instruction
    if (_var_2271.getPtr () != NULL) {
      macroValidPointer (_var_2271.getPtr ()) ;
      if (typeid (cPtr_float_class) == typeid (* (_var_2271.getPtr ()))) {
