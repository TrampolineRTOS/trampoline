...
pr_task_goil_obj_task_64_11_ (goil_lexique & _inLexique,
  ...
  if ((var_cas_tasks.reader_hasKey (_inLexique, var_cas_task_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (83)) COMMA_SOURCE_FILE_AT_LINE (83))).isBuiltAndTrue ()) {
    ...
    var_cas_schedule = GGS_lstring ::constructor_new (_inLexique, GGS_string (""), GGS_location (_inLexique) COMMA_HERE) ;
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_goil_obj_task_0 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_uint32 (_inLexique,  var_cas_priority,  var_cas_prio,  GGS_string ("PRIORITY") COMMA_SOURCE_FILE_AT_LINE (170)) ;
          } break ;
        case 3 : {
          ...
          switch (select_goil_obj_task_1 (_inLexique)) {
            case 1 : {
              ...
              var_cas_sc = GGS_lstring ::constructor_new (_inLexique, GGS_string ("FULL"), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_NON) COMMA_HERE) ;
              var_cas_sc = GGS_lstring ::constructor_new (_inLexique, GGS_string ("NON"), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            default :
              break ;
          }
          ::routine_set_lstring_if_empty (_inLexique,  var_cas_schedule,  var_cas_sc,  GGS_string ("SCHEDULE") COMMA_SOURCE_FILE_AT_LINE (177)) ;
          ...
          { const GGS_task_autostart_obj _var_4783 = var_cas_autostart ; // CAST instruction
            if (_var_4783.getPtr () != NULL) {
              ...
              if (typeid (cPtr_task_autostart_void) == typeid (* (_var_4783.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Redefinition of AUTOSTART") COMMA_SOURCE_FILE_AT_LINE (190)) ;
                var_cas_autostart.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (190)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (191)) ;
              }
            }
          }
        ...
        case 5 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_uint32 (_inLexique,  var_cas_activation,  var_cas_act,  GGS_string ("ACTIVATION") COMMA_SOURCE_FILE_AT_LINE (196)) ;
          } break ;
        case 6 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_add_lstring_unique (_inLexique,  var_cas_resources,  var_cas_resource,  GGS_string ("RESOURCE") COMMA_SOURCE_FILE_AT_LINE (200)) ;
          } break ;
        case 7 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_add_lstring_unique (_inLexique,  var_cas_events,  var_cas_event,  GGS_string ("EVENT") COMMA_SOURCE_FILE_AT_LINE (204)) ;
          } break ;
        case 8 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_add_lstring_unique (_inLexique,  var_cas_messages,  var_cas_mess,  GGS_string ("MESSAGE") COMMA_SOURCE_FILE_AT_LINE (208)) ;
          } break ;
        case 9 : {
          if (((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (210))))._operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("AUTOSAR flag is off, turn it on to use TIMINGPROTECTION attribute in TASK object") COMMA_SOURCE_FILE_AT_LINE (212)) ;
          }
              ...
              { const GGS_basic_type _var_6221 = var_cas_count_limit ; // CAST instruction
                if (_var_6221.getPtr () != NULL) {
                  ...
                  if (typeid (cPtr_uint32_class) == typeid (* (_var_6221.getPtr ()))) {
                    ...
                    var_cas_uc.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (229)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("COUNTLIMIT is not an attribute of task timing protection") COMMA_SOURCE_FILE_AT_LINE (230)) ;
                  }else{
                  }
                }
              }
              { const GGS_basic_type _var_6336 = var_cas_exe_budget ; // CAST instruction
                if (_var_6336.getPtr () != NULL) {
                  ...
                  if (typeid (cPtr_void) == typeid (* (_var_6336.getPtr ()))) {
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("EXECUTIONBUDGET not declared") COMMA_SOURCE_FILE_AT_LINE (233)) ;
                  }else{
                  }
                }
              }
              { const GGS_basic_type _var_6507 = var_cas_exe_time ; // CAST instruction
                if (_var_6507.getPtr () != NULL) {
                  ...
                  if (typeid (cPtr_uint64_class) == typeid (* (_var_6507.getPtr ()))) {
                    ...
                    var_cas_et.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (236)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("EXECUTIONTIME is not an attribute of task timing protection") COMMA_SOURCE_FILE_AT_LINE (237)) ;
                  }else{
                  }
                }
              }
        ...
        case 10 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_add_lstring_unique (_inLexique,  var_cas_acc_apps,  var_cas_app,  GGS_string ("ACCESSING_APPLICATION") COMMA_SOURCE_FILE_AT_LINE (251)) ;
          } break ;
        case 11 : {
...
pr_task_autostart_params_goil_obj_task_257_28_ (goil_lexique & _inLexique,
  ...
  var_cas_appmode = GGS_lstring ::constructor_new (_inLexique, GGS_string (""), GGS_location (_inLexique) COMMA_HERE) ;
      ...
      switch (select_repeat_goil_obj_task_4 (_inLexique)) {
        case 2 : {
          ...
          if ((var_cas_appmodes.reader_hasKey (_inLexique, var_cas_appmode.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (265)) COMMA_SOURCE_FILE_AT_LINE (265))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string ("APPMODE "))._operator_concat (var_cas_appmode.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (266))))._operator_concat (GGS_string (" already defined for this task AUTOSTART attribute")) COMMA_SOURCE_FILE_AT_LINE (266)) ;
          }
