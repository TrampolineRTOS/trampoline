...
GGS_string function_trueFalse (C_Compiler &,
  ...
  const GGS_bool cond_982 = var_cas_inBool ;
  if (cond_982.isBuiltAndTrue ()) {
    var_cas_result = GGS_string ("true") ;
  }else if (cond_982.isBuiltAndFalse ()) {
...
GGS_string function_yesNo (C_Compiler &,
  ...
  #endif
  GGS_string var_cas_result ;
  const GGS_bool cond_1123 = var_cas_inBool ;
  if (cond_1123.isBuiltAndTrue ()) {
    var_cas_result = GGS_string ("YES") ;
  }else if (cond_1123.isBuiltAndFalse ()) {
...
GGS_string function_TRUEFALSE (C_Compiler &,
  ...
  #endif
  GGS_string var_cas_result ;
  const GGS_bool cond_1266 = var_cas_inBool ;
  if (cond_1266.isBuiltAndTrue ()) {
    var_cas_result = GGS_string ("TRUE") ;
  }else if (cond_1266.isBuiltAndFalse ()) {
    var_cas_result = GGS_string ("FALSE") ;
  }
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE function_TRUEFALSE\n") ;
