...
void routine_expiry_point (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_exp_st,  GGS_string (true, "expiry_point") COMMA_SOURCE_FILE_AT_LINE (71)) ;
  var_cas_exp_st = var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$EXPIRY_POINT$"), (((var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (72)))._operator_concat (GGS_string (true, "_")))._operator_concat (var_cas_expiry.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (72))))._operator_concat (GGS_string (true, "_expirypoint")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
  if (((var_cas_expiry)._operator_isNotEqual (GGS_uint64 (true, 0LLU))).isBuiltAndTrue ()) {
    var_cas_exp_st = var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$OFFSET$"), var_cas_expiry._substract_operation (_inLexique, var_cas_previous_expiry COMMA_SOURCE_FILE_AT_LINE (74)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (74)) COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  var_cas_exp_st = var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$ACTION_COUNT$"), var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76)) ;
  var_cas_exp_st = var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$ACTION_ARRAY$"), ((var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (77)))._operator_concat (GGS_string (true, "_")))._operator_concat (var_cas_expiry.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (77))) COMMA_SOURCE_FILE_AT_LINE (77)) ;
  GGS_string var_cas_res ;
  var_cas_res = ((((((GGS_string (true, "\n"
    "tpl_action *"))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (80))))._operator_concat (GGS_string (true, "_")))._operator_concat (var_cas_expiry.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (80))))._operator_concat (GGS_string (true, "[")))._operator_concat (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (80))))._operator_concat (GGS_string (true, "] = {\n")) ;
  GGS_uint  var_cas_i ;
  var_cas_i = GGS_uint (true, 0U) ;
  GGS_uint _variant_2573 = var_cas_index ;
  GGS_bool _condition_2573 (_variant_2573._isBuilt (), true) ;
  while (_condition_2573.isBuiltAndTrue ()) {
    ...
    if (_condition_2573.isBuiltAndTrue ()) {
      if (_variant_2573.uintValue () == 0) {
        ...
        _condition_2573 = GGS_bool (true, false) ;
      }else{
        ...
        if (((var_cas_i)._operator_strictInf (var_cas_index._substract_operation (_inLexique, GGS_uint (true, 1U) COMMA_SOURCE_FILE_AT_LINE (85)))).isBuiltAndTrue ()) {
  ...
  var_cas_res.appendCstring ("};\n") ;
  var_cas_i_res._dotAssign_operation (var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$EXPIRY_POINT_ACTIONS$"), var_cas_res COMMA_SOURCE_FILE_AT_LINE (94))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
method_generate (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_stres,  GGS_string (true, "schedule_table") COMMA_SOURCE_FILE_AT_LINE (113)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$SCHEDTABLE_NAME$"),  var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (115)) COMMA_SOURCE_FILE_AT_LINE (115)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$SCHEDTABLE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (116)))._operator_concat (GGS_string (true, "_sched_table")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$COUNTER$"),  ((GGS_string (true, "&"))._operator_concat (counter.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (117))))._operator_concat (GGS_string (true, "_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (117)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$EXPIRY_TABLE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (118)))._operator_concat (GGS_string (true, "_expiry_table")) COMMA_SOURCE_FILE_AT_LINE (118)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$APP_ID$"),  (var_cas_app_name)._operator_concat (GGS_string (true, "_id")) COMMA_SOURCE_FILE_AT_LINE (119)) ;
  ...
  { const GGS_basic_type _var_4084 = periodic ; // CAST instruction
    if (_var_4084.getPtr () != NULL) {
      ...
      if (typeid (cPtr_bool_class) == typeid (* (_var_4084.getPtr ()))) {
        ...
        if (((var_cas_b.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (129)))._operator_isEqual (GGS_bool (true, true))).isBuiltAndTrue ()) {
          var_cas_perio = GGS_string (true, "TRUE") ;
        }else{
          var_cas_perio = GGS_string (true, "FALSE") ;
        }
      }else{
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "Internal error, unexpected type for PERIODIC attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (134))) COMMA_SOURCE_FILE_AT_LINE (135)) ;
      }
    }
  }
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$PERIODIC$"),  var_cas_perio COMMA_SOURCE_FILE_AT_LINE (137)) ;
  { const GGS_autostart_obj _var_4680 = autostart ; // CAST instruction
    if (_var_4680.getPtr () != NULL) {
      ...
      if (typeid (cPtr_sd_autostart_false) == typeid (* (_var_4680.getPtr ()))) {
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$SCHEDTABLE_DATE$"),  GGS_string (true, "0") COMMA_SOURCE_FILE_AT_LINE (141)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$SCHEDTABLE_STATE$"),  GGS_string (true, "SCHEDULETABLE_STOPPED") COMMA_SOURCE_FILE_AT_LINE (142)) ;
      }else if (typeid (cPtr_sd_autostart_true) == typeid (* (_var_4680.getPtr ()))) {
        const GGS_sd_autostart_true var_cas_sa (_var_4680.getPtr ()) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$SCHEDTABLE_DATE$"),  var_cas_sa.reader_offset (_inLexique COMMA_SOURCE_FILE_AT_LINE (144)).reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (144)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (144)) COMMA_SOURCE_FILE_AT_LINE (144)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$SCHEDTABLE_STATE$"),  GGS_string (true, "SCHEDULETABLE_AUTOSTART") COMMA_SOURCE_FILE_AT_LINE (145)) ;
      }else{
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "Internal error, unexpected type for AUTOSTART attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (146))) COMMA_SOURCE_FILE_AT_LINE (147)) ;
      }
    }
  }
  GGS_string var_cas_expiry_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_expiry_tpl,  GGS_string (true, "expiry_point") COMMA_SOURCE_FILE_AT_LINE (151)) ;
  GGS_string var_cas_setevent_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_setevent_tpl,  GGS_string (true, "notification_setevent") COMMA_SOURCE_FILE_AT_LINE (153)) ;
  GGS_string var_cas_activatetask_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_activatetask_tpl,  GGS_string (true, "notification_activatetask") COMMA_SOURCE_FILE_AT_LINE (155)) ;
  GGS_uint64  var_cas_cur_offset ;
  var_cas_cur_offset = GGS_uint64 (true, 0LLU) ;
  GGS_uint64  var_cas_previous_offset ;
  var_cas_previous_offset = GGS_uint64 (true, 0LLU) ;
  GGS_uint  var_cas_index ;
  var_cas_index = GGS_uint (true, 0U) ;
  GGS_uint  var_cas_expiry_count ;
  var_cas_expiry_count = GGS_uint (true, 0U) ;
  GGS_string var_cas_act_table ;
  var_cas_act_table = GGS_string (true, "") ;
  GGS_string var_cas_act_structs ;
  var_cas_act_structs = GGS_string (true, "") ;
  GGS_string var_cas_expiry_table ;
  var_cas_expiry_table = ((GGS_string (true, "tpl_expiry_point *"))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (163))))._operator_concat (GGS_string (true, "_expiry_table[$EXPIRY_TABLE_SIZE$] = {\n")) ;
  GGS_bool var_cas_first_time ;
  var_cas_first_time = GGS_bool (true, true) ;
  {
    ...
    while (((operand_5446 = enumerator_5446.nextObject ()))) {
      ...
      _inLexique.printMessage ((operand_5446->offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (167)))._operator_concat (GGS_string (true, "\n")) COMMA_SOURCE_FILE_AT_LINE (167)) ;
      if (((operand_5446->offset)._operator_isNotEqual (var_cas_cur_offset)).isBuiltAndTrue ()) {
        if (((var_cas_first_time)._operator_not ()).isBuiltAndTrue ()) {
          ...
          var_cas_first_time = GGS_bool (true, false) ;
        }
      ...
      { const GGS_action_obj _var_6734 = operand_5446->act ; // CAST instruction
        if (_var_6734.getPtr () != NULL) {
          ...
          if (typeid (cPtr_activatetask_action) == typeid (* (_var_6734.getPtr ()))) {
            ...
            var_cas_res = var_cas_activatetask_tpl.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TASK$"), (var_cas_ata.reader_task_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (185)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (185)))._operator_concat (GGS_string (true, "_id")) COMMA_SOURCE_FILE_AT_LINE (185)) ;
          }else if (typeid (cPtr_setevent_action) == typeid (* (_var_6734.getPtr ()))) {
            const GGS_setevent_action var_cas_sea (_var_6734.getPtr ()) ;
            var_cas_res = var_cas_setevent_tpl.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$TASK$"), (var_cas_sea.reader_task_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (187)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (187)))._operator_concat (GGS_string (true, "_id")) COMMA_SOURCE_FILE_AT_LINE (187)) ;
            var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$EVENT$"), (var_cas_sea.reader_event_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (188)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (188)))._operator_concat (GGS_string (true, "_mask")) COMMA_SOURCE_FILE_AT_LINE (188)) ;
          }else{
            var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "Internal error, unexpected type for ACTION attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (189))) COMMA_SOURCE_FILE_AT_LINE (190)) ;
          }
        }
      }
      var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$NOTIFICATION_NAME$"), (((GGS_string (true, "expiry point at offset "))._operator_concat (operand_5446->offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (193))))._operator_concat (GGS_string (true, " of schedule table ")))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (193))) COMMA_SOURCE_FILE_AT_LINE (191)) ;
      var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$NOTIFICATION$"), (((((var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (196)))._operator_concat (GGS_string (true, "_")))._operator_concat (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (196))))._operator_concat (GGS_string (true, "_")))._operator_concat (operand_5446->offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (196))))._operator_concat (GGS_string (true, "_expirypoint_action")) COMMA_SOURCE_FILE_AT_LINE (194)) ;
  ...
  { const GGS_basic_type _var_8080 = length ; // CAST instruction
    if (_var_8080.getPtr () != NULL) {
      ...
      if (typeid (cPtr_uint64_class) == typeid (* (_var_8080.getPtr ()))) {
        ...
        var_cas_act_table = var_cas_act_table.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$OFFSET$"), var_cas_delay.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (211)) COMMA_SOURCE_FILE_AT_LINE (211)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$LENGTH$"),  var_cas_len.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (213)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (213)) COMMA_SOURCE_FILE_AT_LINE (213)) ;
      }else{
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "Internal error, unexpected type for LENGTH attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (215))) COMMA_SOURCE_FILE_AT_LINE (216)) ;
      }
    }
  }
  { const GGS_ltgt_sync_obj _var_8884 = ltgt_sync ; // CAST instruction
    if (_var_8884.getPtr () != NULL) {
      ...
      if (typeid (cPtr_ltgt_sync_void) == typeid (* (_var_8884.getPtr ()))) {
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$SYNC_STRATEGY$"),  GGS_string (true, "SCHEDTABLE_NO_SYNC") COMMA_SOURCE_FILE_AT_LINE (221)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$PRECISION$"),  GGS_string (true, "0") COMMA_SOURCE_FILE_AT_LINE (222)) ;
      }else if (typeid (cPtr_ltgt_sync_false) == typeid (* (_var_8884.getPtr ()))) {
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$SYNC_STRATEGY$"),  GGS_string (true, "SCHEDTABLE_NO_SYNC") COMMA_SOURCE_FILE_AT_LINE (224)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$PRECISION$"),  GGS_string (true, "0") COMMA_SOURCE_FILE_AT_LINE (225)) ;
      }else if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_8884.getPtr ()))) {
        const GGS_ltgt_sync_true var_cas_sst (_var_8884.getPtr ()) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$SYNC_STRATEGY$"),  ((GGS_string (true, "SCHEDTABLE_"))._operator_concat (var_cas_sst.reader_strategy (_inLexique COMMA_SOURCE_FILE_AT_LINE (227)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (227))))._operator_concat (GGS_string (true, "_SYNC")) COMMA_SOURCE_FILE_AT_LINE (227)) ;
        { const GGS_basic_type _var_8860 = var_cas_sst.reader_precision (_inLexique COMMA_SOURCE_FILE_AT_LINE (228)) ; // CAST instruction
          if (_var_8860.getPtr () != NULL) {
            ...
            if (typeid (cPtr_uint64_class) == typeid (* (_var_8860.getPtr ()))) {
              ...
              ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$PRECISION$"),  var_cas_p.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (230)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (230)) COMMA_SOURCE_FILE_AT_LINE (230)) ;
            }else{
              var_cas_sst.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (232)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Internal error, wrong type for PRECISION") COMMA_SOURCE_FILE_AT_LINE (233)) ;
            }
          }
        }
      }else{
  ...
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$EXPIRY_POINTS$"),  ((var_cas_act_structs)._operator_concat (var_cas_act_table))._operator_concat (var_cas_expiry_table) COMMA_SOURCE_FILE_AT_LINE (236)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string (true, "$EXPIRY_TABLE_SIZE$"),  var_cas_expiry_count.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (237)) COMMA_SOURCE_FILE_AT_LINE (237)) ;
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " << inElementIndex << ":" << mInfo.st.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
