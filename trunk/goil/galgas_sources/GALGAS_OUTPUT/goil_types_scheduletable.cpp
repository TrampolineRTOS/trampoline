...
method_generate (C_Compiler & _inLexique,
  ...
  { const GGS_basic_type _var_4091 = periodic ; // CAST instruction
    if (_var_4091.getPtr () != NULL) {
      macroValidPointer (_var_4091.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_4091.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_4091.getPtr ()) ;
  ...
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$PERIODIC$"),  var_cas_perio COMMA_SOURCE_FILE_AT_LINE (136)) ;
  { const GGS_autostart_obj _var_4686 = autostart ; // CAST instruction
    if (_var_4686.getPtr () != NULL) {
      macroValidPointer (_var_4686.getPtr ()) ;
      if (typeid (cPtr_sd_autostart_false) == typeid (* (_var_4686.getPtr ()))) {
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_DATE$"),  GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (140)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_STATE$"),  GGS_string ("SCHEDULETABLE_STOPPED") COMMA_SOURCE_FILE_AT_LINE (141)) ;
      }else if (typeid (cPtr_sd_autostart_true) == typeid (* (_var_4686.getPtr ()))) {
        const GGS_sd_autostart_true var_cas_sa (_var_4686.getPtr ()) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_DATE$"),  var_cas_sa.reader_offset (_inLexique COMMA_SOURCE_FILE_AT_LINE (143)).reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (143)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (143)) COMMA_SOURCE_FILE_AT_LINE (143)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_STATE$"),  GGS_string ("SCHEDULETABLE_AUTOSTART") COMMA_SOURCE_FILE_AT_LINE (144)) ;
      }else{
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Internal error, unexpected type for AUTOSTART attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (145))) COMMA_SOURCE_FILE_AT_LINE (146)) ;
      }
    }
  }
  GGS_string var_cas_expiry_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_expiry_tpl,  GGS_string ("expiry_point") COMMA_SOURCE_FILE_AT_LINE (150)) ;
  GGS_string var_cas_setevent_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_setevent_tpl,  GGS_string ("notification_setevent") COMMA_SOURCE_FILE_AT_LINE (152)) ;
  GGS_string var_cas_activatetask_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_activatetask_tpl,  GGS_string ("notification_activatetask") COMMA_SOURCE_FILE_AT_LINE (154)) ;
  GGS_string var_cas_incrementcounter_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_incrementcounter_tpl,  GGS_string ("notification_incrementcounter") COMMA_SOURCE_FILE_AT_LINE (156)) ;
  GGS_string var_cas_finalizescheduletable_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_finalizescheduletable_tpl,  GGS_string ("notification_finalizescheduletable") COMMA_SOURCE_FILE_AT_LINE (158)) ;
  ...
  var_cas_expiry_table = ((GGS_string ("tpl_expiry_point *"))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (166))))._operator_concat (GGS_string ("_expiry_table[$EXPIRY_TABLE_SIZE$] = {\n")) ;
  GGS_bool var_cas_first_time ;
  var_cas_first_time = GGS_bool (true) ;
  {
    GGS_action_list::cEnumerator enumerator_5722 (actions, true) ;
    const GGS_action_list::cElement * operand_5722 = NULL ;
    while (((operand_5722 = enumerator_5722.nextObject ()))) {
      macroValidPointer (operand_5722) ;
      if ((((operand_5722->offset)._operator_isNotEqual (var_cas_cur_offset))._operator_or (((operand_5722->offset)._operator_isEqual (GGS_uint64 (0U)))._operator_and ((var_cas_first_time)._operator_isEqual (GGS_bool (true))))).isBuiltAndTrue ()) {
        if (((var_cas_first_time)._operator_not ()).isBuiltAndTrue ()) {
          ::routine_expiry_point (_inLexique,  var_cas_name,  var_cas_cur_offset,  var_cas_previous_offset,  var_cas_index,  var_cas_act_table COMMA_SOURCE_FILE_AT_LINE (173)) ;
          var_cas_expiry_table.appendCString ("    &") ;
          var_cas_expiry_table._dotAssign_operation (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (174))) ;
          var_cas_expiry_table.appendCString ("_") ;
          var_cas_expiry_table._dotAssign_operation (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (174))) ;
        ...
        var_cas_cur_offset = operand_5722->offset ;
        var_cas_index = GGS_uint (0U) ;
        var_cas_expiry_count._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (181)) ;
      }
      GGS_string var_cas_res ;
      var_cas_res = GGS_string ("") ;
      { const GGS_action_obj _var_7187 = operand_5722->act ; // CAST instruction
        if (_var_7187.getPtr () != NULL) {
          macroValidPointer (_var_7187.getPtr ()) ;
          if (typeid (cPtr_activatetask_action) == typeid (* (_var_7187.getPtr ()))) {
            const GGS_activatetask_action var_cas_ata (_var_7187.getPtr ()) ;
            var_cas_res = var_cas_activatetask_tpl.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$TASK$"), (var_cas_ata.reader_task_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (187)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (187)))._operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (187)) ;
          }else if (typeid (cPtr_setevent_action) == typeid (* (_var_7187.getPtr ()))) {
            const GGS_setevent_action var_cas_sea (_var_7187.getPtr ()) ;
            var_cas_res = var_cas_setevent_tpl.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$TASK$"), (var_cas_sea.reader_task_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (189)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (189)))._operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (189)) ;
            var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$EVENT$"), (var_cas_sea.reader_event_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (190)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (190)))._operator_concat (GGS_string ("_mask")) COMMA_SOURCE_FILE_AT_LINE (190)) ;
          }else if (typeid (cPtr_incrementcounter_action) == typeid (* (_var_7187.getPtr ()))) {
            const GGS_incrementcounter_action var_cas_ica (_var_7187.getPtr ()) ;
            var_cas_res = var_cas_incrementcounter_tpl.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$COUNTER$"), (var_cas_ica.reader_counter_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (192)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (192)))._operator_concat (GGS_string ("_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (192)) ;
          }else{
            var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Internal error, unexpected type for ACTION attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (193))) COMMA_SOURCE_FILE_AT_LINE (194)) ;
          }
        }
      }
      var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$NOTIFICATION_NAME$"), (((GGS_string ("expiry point at offset "))._operator_concat (operand_5722->offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (197))))._operator_concat (GGS_string (" of schedule table ")))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (197))) COMMA_SOURCE_FILE_AT_LINE (195)) ;
      var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$NOTIFICATION$"), (((((var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (200)))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (200))))._operator_concat (GGS_string ("_")))._operator_concat (operand_5722->offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (200))))._operator_concat (GGS_string ("_expirypoint_action")) COMMA_SOURCE_FILE_AT_LINE (198)) ;
      var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (202)) ;
      var_cas_act_structs._dotAssign_operation (var_cas_res) ;
      var_cas_act_structs.appendCString ("\n") ;
    }
  }
  { const GGS_basic_type _var_8473 = length ; // CAST instruction
    if (_var_8473.getPtr () != NULL) {
      macroValidPointer (_var_8473.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_8473.getPtr ()))) {
        const GGS_uint64_class var_cas_len (_var_8473.getPtr ()) ;
        if (((var_cas_cur_offset)._operator_isNotEqual (var_cas_len.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (211)))).isBuiltAndTrue ()) {
          ::routine_expiry_point (_inLexique,  var_cas_name,  var_cas_cur_offset,  var_cas_previous_offset,  var_cas_index,  var_cas_act_table COMMA_SOURCE_FILE_AT_LINE (212)) ;
          var_cas_expiry_table.appendCString ("    &") ;
          var_cas_expiry_table._dotAssign_operation (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (213))) ;
          var_cas_expiry_table.appendCString ("_") ;
          var_cas_expiry_table._dotAssign_operation (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (213))) ;
          var_cas_expiry_table.appendCString ("_expirypoint,\n") ;
          var_cas_previous_offset = var_cas_cur_offset ;
          var_cas_cur_offset = var_cas_len.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (215)) ;
          var_cas_index = GGS_uint (0U) ;
          var_cas_expiry_count._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)) ;
        }
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$LENGTH$"),  var_cas_len.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (219)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (219)) ;
      }else{
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Internal error, unexpected type for LENGTH attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (221))) COMMA_SOURCE_FILE_AT_LINE (222)) ;
      }
    }
  }
  GGS_string var_cas_res ;
  var_cas_res = GGS_string ("") ;
  var_cas_res = var_cas_finalizescheduletable_tpl.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$SCHEDTABLE$"), (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (225)))._operator_concat (GGS_string ("_sched_table")) COMMA_SOURCE_FILE_AT_LINE (225)) ;
  var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$NOTIFICATION_NAME$"), (((GGS_string ("expiry point at offset "))._operator_concat (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (228))))._operator_concat (GGS_string (" of schedule table ")))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (228))) COMMA_SOURCE_FILE_AT_LINE (226)) ;
  var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$NOTIFICATION$"), (((((var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (231)))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (231))))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (231))))._operator_concat (GGS_string ("_expirypoint_action")) COMMA_SOURCE_FILE_AT_LINE (229)) ;
  var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (232)) ;
  var_cas_act_structs._dotAssign_operation (var_cas_res) ;
  var_cas_act_structs.appendCString ("\n") ;
  ::routine_expiry_point (_inLexique,  var_cas_name,  var_cas_cur_offset,  var_cas_previous_offset,  var_cas_index,  var_cas_act_table COMMA_SOURCE_FILE_AT_LINE (234)) ;
  var_cas_expiry_table.appendCString ("    &") ;
  var_cas_expiry_table._dotAssign_operation (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (235))) ;
  var_cas_expiry_table.appendCString ("_") ;
  var_cas_expiry_table._dotAssign_operation (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (235))) ;
  var_cas_expiry_table.appendCString ("_expirypoint\n"
    "};") ;
  { const GGS_ltgt_sync_obj _var_10650 = ltgt_sync ; // CAST instruction
    if (_var_10650.getPtr () != NULL) {
      macroValidPointer (_var_10650.getPtr ()) ;
      if (typeid (cPtr_ltgt_sync_void) == typeid (* (_var_10650.getPtr ()))) {
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  GGS_string ("SCHEDTABLE_NO_SYNC") COMMA_SOURCE_FILE_AT_LINE (253)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (254)) ;
      }else if (typeid (cPtr_ltgt_sync_false) == typeid (* (_var_10650.getPtr ()))) {
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  GGS_string ("SCHEDTABLE_NO_SYNC") COMMA_SOURCE_FILE_AT_LINE (256)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (257)) ;
      }else if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_10650.getPtr ()))) {
        const GGS_ltgt_sync_true var_cas_sst (_var_10650.getPtr ()) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  ((GGS_string ("SCHEDTABLE_"))._operator_concat (var_cas_sst.reader_strategy (_inLexique COMMA_SOURCE_FILE_AT_LINE (259)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (259))))._operator_concat (GGS_string ("_SYNC")) COMMA_SOURCE_FILE_AT_LINE (259)) ;
        { const GGS_basic_type _var_10626 = var_cas_sst.reader_precision (_inLexique COMMA_SOURCE_FILE_AT_LINE (260)) ; // CAST instruction
          if (_var_10626.getPtr () != NULL) {
            macroValidPointer (_var_10626.getPtr ()) ;
            if (typeid (cPtr_uint64_class) == typeid (* (_var_10626.getPtr ()))) {
              const GGS_uint64_class var_cas_p (_var_10626.getPtr ()) ;
              ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  var_cas_p.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (262)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (262)) COMMA_SOURCE_FILE_AT_LINE (262)) ;
            }else{
              var_cas_sst.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (264)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Internal error, wrong type for PRECISION") COMMA_SOURCE_FILE_AT_LINE (265)) ;
            }
          }
        }
      }else{
  ...
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$EXPIRY_POINTS$"),  ((var_cas_act_structs)._operator_concat (var_cas_act_table))._operator_concat (var_cas_expiry_table) COMMA_SOURCE_FILE_AT_LINE (268)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$EXPIRY_TABLE_SIZE$"),  var_cas_expiry_count.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (269)) COMMA_SOURCE_FILE_AT_LINE (269)) ;
