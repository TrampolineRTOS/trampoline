...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    ...
    equal = location._operator_isEqual (_p->location).boolValue ()
         ...
         && mode._operator_isEqual (_p->mode).boolValue () ;
  }
  return equal ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@sd_autostart_true:"
           ...
           << mode.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
cPtr__AC_galgas_class * cPtr_sd_autostart_true::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_sd_autostart_true (location, offset, app_modes, mode COMMA_HERE)) ;
  return result ;
}
...
GGS_uint  GGS_sd_autostart_true::
reader_mode (C_Compiler & /* inLexique */ COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_uint   result ;
  if (mPointer != NULL) {
    macroValidPointer (mPointer) ;
    MF_Assert (dynamic_cast <cPtr_sd_autostart_true *> (mPointer) != NULL,
               "dynamic cast error", 0, 0) ;
    result = ((cPtr_sd_autostart_true *) mPointer)->mode ;
  }
  return result ;
}
...
void routine_expiry_point (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_exp_st,  GGS_string ("expiry_point") COMMA_SOURCE_FILE_AT_LINE (73)) ;
  var_cas_exp_st = var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$EXPIRY_POINT$"), (((var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (74)))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_expiry.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (74))))._operator_concat (GGS_string ("_expirypoint")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
  var_cas_exp_st = var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$OFFSET$"), var_cas_expiry._substract_operation (_inLexique, var_cas_previous_expiry COMMA_SOURCE_FILE_AT_LINE (76)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76)) ;
  var_cas_exp_st = var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$ACTION_COUNT$"), var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)) ;
  var_cas_exp_st = var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$ACTION_ARRAY$"), ((var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (79)))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_expiry.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (79))) COMMA_SOURCE_FILE_AT_LINE (79)) ;
  GGS_string var_cas_res ;
  var_cas_res = ((((((GGS_string ("\n"
    "tpl_action *"))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (82))))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_expiry.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (82))))._operator_concat (GGS_string ("[")))._operator_concat (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (82))))._operator_concat (GGS_string ("] = {\n")) ;
  GGS_uint  var_cas_i ;
  var_cas_i = GGS_uint (0U) ;
  GGS_uint _variant_2615 = var_cas_index ;
  GGS_bool _condition_2615 (_variant_2615.isBuilt (), true) ;
  while (_condition_2615.isBuiltAndTrue ()) {
    _condition_2615 = (var_cas_i)._operator_strictInf (var_cas_index) ;
    if (_condition_2615.isBuiltAndTrue ()) {
      if (_variant_2615.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (93)) ;
        _condition_2615 = GGS_bool (false) ;
      }else{
        _variant_2615._decrement_operation (_inLexique COMMA_HERE) ;
        var_cas_res.appendCString ("    (tpl_action *)&") ;
        var_cas_res._dotAssign_operation (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (86))) ;
        var_cas_res.appendCString ("_") ;
        var_cas_res._dotAssign_operation (var_cas_i.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (86))) ;
        var_cas_res.appendCString ("_") ;
        var_cas_res._dotAssign_operation (var_cas_expiry.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (86))) ;
        var_cas_res.appendCString ("_expirypoint_action") ;
        if (((var_cas_i)._operator_strictInf (var_cas_index._substract_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (87)))).isBuiltAndTrue ()) {
          var_cas_res.appendCString (",\n") ;
        }else{
          var_cas_res.appendCString ("\n") ;
        }
        var_cas_i._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (92)) ;
      }
    }
  }
  var_cas_res.appendCString ("};\n") ;
  var_cas_i_res._dotAssign_operation (var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$EXPIRY_POINT_ACTIONS$"), var_cas_res COMMA_SOURCE_FILE_AT_LINE (96))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
method_generate (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_stres,  GGS_string ("schedule_table") COMMA_SOURCE_FILE_AT_LINE (115)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_NAME$"),  var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (117)) COMMA_SOURCE_FILE_AT_LINE (117)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (118)))._operator_concat (GGS_string ("_sched_table")) COMMA_SOURCE_FILE_AT_LINE (118)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$COUNTER$"),  ((GGS_string ("&"))._operator_concat (counter.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (119))))._operator_concat (GGS_string ("_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (119)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$EXPIRY_TABLE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (120)))._operator_concat (GGS_string ("_expiry_table")) COMMA_SOURCE_FILE_AT_LINE (120)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$APP_ID$"),  (var_cas_app_name)._operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (121)) ;
  GGS_string var_cas_perio ;
  var_cas_perio = GGS_string ("") ;
  { const GGS_basic_type _var_4105 = periodic ; // CAST instruction
    if (_var_4105.getPtr () != NULL) {
      macroValidPointer (_var_4105.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_4105.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_4105.getPtr ()) ;
  ...
  { const GGS_autostart_obj _var_4978 = autostart ; // CAST instruction
    if (_var_4978.getPtr () != NULL) {
      macroValidPointer (_var_4978.getPtr ()) ;
      if (typeid (cPtr_sd_autostart_false) == typeid (* (_var_4978.getPtr ()))) {
      ...
      }else if (typeid (cPtr_sd_autostart_true) == typeid (* (_var_4978.getPtr ()))) {
        const GGS_sd_autostart_true var_cas_sa (_var_4978.getPtr ()) ;
        ...
        if (((var_cas_sa.reader_mode (_inLexique COMMA_SOURCE_FILE_AT_LINE (145)))._operator_isEqual (GGS_uint (1U))).isBuiltAndTrue ()) {
          ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_STATE$"),  GGS_string ("SCHEDULETABLE_AUTOSTART_ABSOLUTE") COMMA_SOURCE_FILE_AT_LINE (146)) ;
        }else if (((var_cas_sa.reader_mode (_inLexique COMMA_SOURCE_FILE_AT_LINE (147)))._operator_isEqual (GGS_uint (2U))).isBuiltAndTrue ()) {
          ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_STATE$"),  GGS_string ("SCHEDULETABLE_AUTOSTART_RELATIVE") COMMA_SOURCE_FILE_AT_LINE (148)) ;
        }else if (((var_cas_sa.reader_mode (_inLexique COMMA_SOURCE_FILE_AT_LINE (149)))._operator_isEqual (GGS_uint (3U))).isBuiltAndTrue ()) {
          ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_STATE$"),  GGS_string ("SCHEDULETABLE_AUTOSTART_SYNCHRON") COMMA_SOURCE_FILE_AT_LINE (150)) ;
        }
      }else{
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Internal error, unexpected type for AUTOSTART attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (152))) COMMA_SOURCE_FILE_AT_LINE (153)) ;
      }
    }
  }
  GGS_string var_cas_expiry_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_expiry_tpl,  GGS_string ("expiry_point") COMMA_SOURCE_FILE_AT_LINE (157)) ;
  GGS_string var_cas_setevent_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_setevent_tpl,  GGS_string ("notification_setevent") COMMA_SOURCE_FILE_AT_LINE (159)) ;
  GGS_string var_cas_activatetask_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_activatetask_tpl,  GGS_string ("notification_activatetask") COMMA_SOURCE_FILE_AT_LINE (161)) ;
  GGS_string var_cas_incrementcounter_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_incrementcounter_tpl,  GGS_string ("notification_incrementcounter") COMMA_SOURCE_FILE_AT_LINE (163)) ;
  GGS_string var_cas_finalizescheduletable_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_finalizescheduletable_tpl,  GGS_string ("notification_finalizescheduletable") COMMA_SOURCE_FILE_AT_LINE (165)) ;
  ...
  var_cas_expiry_table = ((GGS_string ("tpl_expiry_point *"))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (173))))._operator_concat (GGS_string ("_expiry_table[$EXPIRY_TABLE_SIZE$] = {\n")) ;
  GGS_bool var_cas_first_time ;
  var_cas_first_time = GGS_bool (true) ;
  {
    GGS_action_list::cEnumerator enumerator_6014 (actions, true) ;
    const GGS_action_list::cElement * operand_6014 = NULL ;
    while (((operand_6014 = enumerator_6014.nextObject ()))) {
      macroValidPointer (operand_6014) ;
      if ((((operand_6014->offset)._operator_isNotEqual (var_cas_cur_offset))._operator_or (((operand_6014->offset)._operator_isEqual (GGS_uint64 (0U)))._operator_and ((var_cas_first_time)._operator_isEqual (GGS_bool (true))))).isBuiltAndTrue ()) {
        if (((var_cas_first_time)._operator_not ()).isBuiltAndTrue ()) {
          ::routine_expiry_point (_inLexique,  var_cas_name,  var_cas_cur_offset,  var_cas_previous_offset,  var_cas_index,  var_cas_act_table COMMA_SOURCE_FILE_AT_LINE (180)) ;
          var_cas_expiry_table.appendCString ("    &") ;
          var_cas_expiry_table._dotAssign_operation (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (181))) ;
          var_cas_expiry_table.appendCString ("_") ;
          var_cas_expiry_table._dotAssign_operation (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (181))) ;
        ...
        var_cas_cur_offset = operand_6014->offset ;
        var_cas_index = GGS_uint (0U) ;
        var_cas_expiry_count._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (188)) ;
      }
      GGS_string var_cas_res ;
      var_cas_res = GGS_string ("") ;
      { const GGS_action_obj _var_7479 = operand_6014->act ; // CAST instruction
        if (_var_7479.getPtr () != NULL) {
          macroValidPointer (_var_7479.getPtr ()) ;
          if (typeid (cPtr_activatetask_action) == typeid (* (_var_7479.getPtr ()))) {
            const GGS_activatetask_action var_cas_ata (_var_7479.getPtr ()) ;
            var_cas_res = var_cas_activatetask_tpl.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$TASK$"), (var_cas_ata.reader_task_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (194)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (194)))._operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (194)) ;
          }else if (typeid (cPtr_setevent_action) == typeid (* (_var_7479.getPtr ()))) {
            const GGS_setevent_action var_cas_sea (_var_7479.getPtr ()) ;
            var_cas_res = var_cas_setevent_tpl.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$TASK$"), (var_cas_sea.reader_task_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (196)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (196)))._operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (196)) ;
            var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$EVENT$"), (var_cas_sea.reader_event_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (197)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (197)))._operator_concat (GGS_string ("_mask")) COMMA_SOURCE_FILE_AT_LINE (197)) ;
          }else if (typeid (cPtr_incrementcounter_action) == typeid (* (_var_7479.getPtr ()))) {
            const GGS_incrementcounter_action var_cas_ica (_var_7479.getPtr ()) ;
            var_cas_res = var_cas_incrementcounter_tpl.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$COUNTER$"), (var_cas_ica.reader_counter_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (199)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (199)))._operator_concat (GGS_string ("_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (199)) ;
          }else{
            var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Internal error, unexpected type for ACTION attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (200))) COMMA_SOURCE_FILE_AT_LINE (201)) ;
          }
        }
      }
      var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$NOTIFICATION_NAME$"), (((GGS_string ("expiry point at offset "))._operator_concat (operand_6014->offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (204))))._operator_concat (GGS_string (" of schedule table ")))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (204))) COMMA_SOURCE_FILE_AT_LINE (202)) ;
      var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$NOTIFICATION$"), (((((var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (207)))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (207))))._operator_concat (GGS_string ("_")))._operator_concat (operand_6014->offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (207))))._operator_concat (GGS_string ("_expirypoint_action")) COMMA_SOURCE_FILE_AT_LINE (205)) ;
      var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (209)) ;
      var_cas_act_structs._dotAssign_operation (var_cas_res) ;
      var_cas_act_structs.appendCString ("\n") ;
    }
  }
  { const GGS_basic_type _var_8765 = length ; // CAST instruction
    if (_var_8765.getPtr () != NULL) {
      macroValidPointer (_var_8765.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_8765.getPtr ()))) {
        const GGS_uint64_class var_cas_len (_var_8765.getPtr ()) ;
        if (((var_cas_cur_offset)._operator_isNotEqual (var_cas_len.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (218)))).isBuiltAndTrue ()) {
          ::routine_expiry_point (_inLexique,  var_cas_name,  var_cas_cur_offset,  var_cas_previous_offset,  var_cas_index,  var_cas_act_table COMMA_SOURCE_FILE_AT_LINE (219)) ;
          var_cas_expiry_table.appendCString ("    &") ;
          var_cas_expiry_table._dotAssign_operation (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (220))) ;
          var_cas_expiry_table.appendCString ("_") ;
          var_cas_expiry_table._dotAssign_operation (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (220))) ;
          var_cas_expiry_table.appendCString ("_expirypoint,\n") ;
          var_cas_previous_offset = var_cas_cur_offset ;
          var_cas_cur_offset = var_cas_len.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (222)) ;
          var_cas_index = GGS_uint (0U) ;
          var_cas_expiry_count._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (224)) ;
        }
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$LENGTH$"),  var_cas_len.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (226)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (226)) COMMA_SOURCE_FILE_AT_LINE (226)) ;
      }else{
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Internal error, unexpected type for LENGTH attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (228))) COMMA_SOURCE_FILE_AT_LINE (229)) ;
      }
    }
  }
  GGS_string var_cas_res ;
  var_cas_res = GGS_string ("") ;
  var_cas_res = var_cas_finalizescheduletable_tpl.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$SCHEDTABLE$"), (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (232)))._operator_concat (GGS_string ("_sched_table")) COMMA_SOURCE_FILE_AT_LINE (232)) ;
  var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$NOTIFICATION_NAME$"), (((GGS_string ("expiry point at offset "))._operator_concat (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (235))))._operator_concat (GGS_string (" of schedule table ")))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (235))) COMMA_SOURCE_FILE_AT_LINE (233)) ;
  var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$NOTIFICATION$"), (((((var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (238)))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (238))))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (238))))._operator_concat (GGS_string ("_expirypoint_action")) COMMA_SOURCE_FILE_AT_LINE (236)) ;
  var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (239)) ;
  var_cas_act_structs._dotAssign_operation (var_cas_res) ;
  var_cas_act_structs.appendCString ("\n") ;
  ::routine_expiry_point (_inLexique,  var_cas_name,  var_cas_cur_offset,  var_cas_previous_offset,  var_cas_index,  var_cas_act_table COMMA_SOURCE_FILE_AT_LINE (241)) ;
  var_cas_expiry_table.appendCString ("    &") ;
  var_cas_expiry_table._dotAssign_operation (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (242))) ;
  var_cas_expiry_table.appendCString ("_") ;
  var_cas_expiry_table._dotAssign_operation (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (242))) ;
  var_cas_expiry_table.appendCString ("_expirypoint\n"
    "};") ;
  { const GGS_ltgt_sync_obj _var_10942 = ltgt_sync ; // CAST instruction
    if (_var_10942.getPtr () != NULL) {
      macroValidPointer (_var_10942.getPtr ()) ;
      if (typeid (cPtr_ltgt_sync_void) == typeid (* (_var_10942.getPtr ()))) {
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  GGS_string ("SCHEDTABLE_NO_SYNC") COMMA_SOURCE_FILE_AT_LINE (260)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (261)) ;
      }else if (typeid (cPtr_ltgt_sync_false) == typeid (* (_var_10942.getPtr ()))) {
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  GGS_string ("SCHEDTABLE_NO_SYNC") COMMA_SOURCE_FILE_AT_LINE (263)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (264)) ;
      }else if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_10942.getPtr ()))) {
        const GGS_ltgt_sync_true var_cas_sst (_var_10942.getPtr ()) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  ((GGS_string ("SCHEDTABLE_"))._operator_concat (var_cas_sst.reader_strategy (_inLexique COMMA_SOURCE_FILE_AT_LINE (266)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (266))))._operator_concat (GGS_string ("_SYNC")) COMMA_SOURCE_FILE_AT_LINE (266)) ;
        { const GGS_basic_type _var_10918 = var_cas_sst.reader_precision (_inLexique COMMA_SOURCE_FILE_AT_LINE (267)) ; // CAST instruction
          if (_var_10918.getPtr () != NULL) {
            macroValidPointer (_var_10918.getPtr ()) ;
            if (typeid (cPtr_uint64_class) == typeid (* (_var_10918.getPtr ()))) {
              const GGS_uint64_class var_cas_p (_var_10918.getPtr ()) ;
              ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  var_cas_p.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (269)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (269)) COMMA_SOURCE_FILE_AT_LINE (269)) ;
            }else{
              var_cas_sst.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (271)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Internal error, wrong type for PRECISION") COMMA_SOURCE_FILE_AT_LINE (272)) ;
            }
          }
        }
      }else{
  ...
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$EXPIRY_POINTS$"),  ((var_cas_act_structs)._operator_concat (var_cas_act_table))._operator_concat (var_cas_expiry_table) COMMA_SOURCE_FILE_AT_LINE (275)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$EXPIRY_TABLE_SIZE$"),  var_cas_expiry_count.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (276)) COMMA_SOURCE_FILE_AT_LINE (276)) ;
