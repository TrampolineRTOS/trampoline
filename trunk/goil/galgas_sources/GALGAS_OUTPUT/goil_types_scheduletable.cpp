...
void routine_set_adjustable (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_adjustable_obj _var_2663 = var_cas_adj ; // CAST instruction
    if (_var_2663.getPtr () != NULL) {
      macroValidPointer (_var_2663.getPtr ()) ;
      if (typeid (cPtr_adjustable_void) == typeid (* (_var_2663.getPtr ()))) {
      }else{
        var_cas_new_adj.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (100)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("Redefinition of ADJUSTABLE") COMMA_SOURCE_FILE_AT_LINE (101)) ;
        var_cas_adj.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (101)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (102)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_expiry_point_actions (C_Compiler & inLexique,
  ...
  ::routine_retrieveTemplateString (inLexique,  var_cas_setevent_tpl,  GGS_string ("notification_setevent") COMMA_SOURCE_FILE_AT_LINE (125)) ;
  GGS_string var_cas_activatetask_tpl ;
  ::routine_retrieveTemplateString (inLexique,  var_cas_activatetask_tpl,  GGS_string ("notification_activatetask") COMMA_SOURCE_FILE_AT_LINE (127)) ;
  GGS_string var_cas_finalizescheduletable_tpl ;
  ::routine_retrieveTemplateString (inLexique,  var_cas_finalizescheduletable_tpl,  GGS_string ("notification_finalizescheduletable") COMMA_SOURCE_FILE_AT_LINE (129)) ;
  GGS_string var_cas_act_res ;
  var_cas_act_res = GGS_string ("") ;
  GGS_string var_cas_res ;
  var_cas_res = ((((((GGS_string ("\n"
    "tpl_action *")).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (132)))).operator_concat (GGS_string ("_"))).operator_concat (var_cas_off.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (132)))).operator_concat (GGS_string ("["))).operator_concat (var_cas_actions.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (132)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (132)))).operator_concat (GGS_string ("] = {\n")) ;
  {
    GGS_action_list::cEnumerator enumerator_3639 (var_cas_actions, true) ;
    const GGS_action_list::cElement * operand_3639 = enumerator_3639.nextObject () ;
    if ((operand_3639 != NULL)) {
      GGS_uint var_cas_i (true, 0) ;
      bool _foreach_loop_3639 ;
      do{
        macroValidPointer (operand_3639) ;
        var_cas_res.appendCString ("    (tpl_action *)&") ;
        var_cas_res.dotAssign_operation (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134))) ;
        var_cas_res.appendCString ("_") ;
        var_cas_res.dotAssign_operation (var_cas_off.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134))) ;
        var_cas_res.appendCString ("_") ;
        var_cas_res.dotAssign_operation (var_cas_i.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134))) ;
        var_cas_res.appendCString ("_action") ;
        GGS_string var_cas_act ;
        var_cas_act = GGS_string ("") ;
        { const GGS_action_obj _var_4441 = operand_3639->action ; // CAST instruction
          if (_var_4441.getPtr () != NULL) {
            macroValidPointer (_var_4441.getPtr ()) ;
            if (typeid (cPtr_activatetask_action) == typeid (* (_var_4441.getPtr ()))) {
              const GGS_activatetask_action var_cas_ata (_var_4441.getPtr ()) ;
              var_cas_act = var_cas_activatetask_tpl.reader_stringByReplacingStringByString (inLexique, GGS_string ("$TASK$"), (var_cas_ata.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (138)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (138))).operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (138)) ;
            }else if (typeid (cPtr_setevent_action) == typeid (* (_var_4441.getPtr ()))) {
              const GGS_setevent_action var_cas_sea (_var_4441.getPtr ()) ;
              var_cas_act = var_cas_setevent_tpl.reader_stringByReplacingStringByString (inLexique, GGS_string ("$TASK$"), (var_cas_sea.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (140)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (140))).operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (140)) ;
              var_cas_act = var_cas_act.reader_stringByReplacingStringByString (inLexique, GGS_string ("$EVENT$"), (var_cas_sea.reader_event_name (inLexique COMMA_SOURCE_FILE_AT_LINE (141)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (141))).operator_concat (GGS_string ("_mask")) COMMA_SOURCE_FILE_AT_LINE (141)) ;
            }else if (typeid (cPtr_finalize_st_action) == typeid (* (_var_4441.getPtr ()))) {
              var_cas_act = var_cas_finalizescheduletable_tpl.reader_stringByReplacingStringByString (inLexique, GGS_string ("$SCHEDTABLE$"), (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (143))).operator_concat (GGS_string ("_sched_table")) COMMA_SOURCE_FILE_AT_LINE (143)) ;
            }else{
              var_cas_name.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("Internal error, unexpected type for ACTION attribute of schedule table ")).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (145))) COMMA_SOURCE_FILE_AT_LINE (146)) ;
            }
          }
        }
        ::routine_doReplace (inLexique,  var_cas_act,  GGS_string ("$NOTIFICATION_NAME$"),  (((GGS_string ("expiry point at offset ")).operator_concat (var_cas_off.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (150)))).operator_concat (GGS_string (" of schedule table "))).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (150))) COMMA_SOURCE_FILE_AT_LINE (147)) ;
        ::routine_doReplace (inLexique,  var_cas_act,  GGS_string ("$NOTIFICATION$"),  (((((var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (154))).operator_concat (GGS_string ("_"))).operator_concat (var_cas_off.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (154)))).operator_concat (GGS_string ("_"))).operator_concat (var_cas_i.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (154)))).operator_concat (GGS_string ("_action")) COMMA_SOURCE_FILE_AT_LINE (151)) ;
        var_cas_act_res.dotAssign_operation (var_cas_act) ;
        var_cas_i.mValue ++ ;
        operand_3639 = enumerator_3639.nextObject () ;
        _foreach_loop_3639 = ((operand_3639 != NULL)) ;
        if (_foreach_loop_3639) {
          var_cas_res.appendCString (",\n") ;
        }
      }while (_foreach_loop_3639) ;
    }
  }
  var_cas_res = ((var_cas_act_res).operator_concat (var_cas_res)).operator_concat (GGS_string ("\n"
    "};\n")) ;
  ::routine_doReplace (inLexique,  var_cas_i_res,  GGS_string ("$EXPIRY_POINT_ACTIONS$"),  var_cas_res COMMA_SOURCE_FILE_AT_LINE (160)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
method_generate (C_Compiler & inLexique,
  ...
  ::routine_retrieveTemplateString (inLexique,  var_cas_stres,  GGS_string ("schedule_table") COMMA_SOURCE_FILE_AT_LINE (179)) ;
  ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_NAME$"),  var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (181)) COMMA_SOURCE_FILE_AT_LINE (181)) ;
  ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE$"),  (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (182))).operator_concat (GGS_string ("_sched_table")) COMMA_SOURCE_FILE_AT_LINE (182)) ;
  ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$COUNTER$"),  ((GGS_string ("&")).operator_concat (counter.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (183)))).operator_concat (GGS_string ("_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (183)) ;
  ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$EXPIRY_TABLE$"),  (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (184))).operator_concat (GGS_string ("_expiry_table")) COMMA_SOURCE_FILE_AT_LINE (184)) ;
  ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$APP_ID$"),  (var_cas_app_name).operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (185)) ;
  GGS_expiry_point_list  var_cas_epl ;
  var_cas_epl = exp_points ;
  { const GGS_basic_type _var_7394 = length ; // CAST instruction
    if (_var_7394.getPtr () != NULL) {
      macroValidPointer (_var_7394.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_7394.getPtr ()))) {
        const GGS_uint64_class var_cas_len (_var_7394.getPtr ()) ;
        ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$LENGTH$"),  var_cas_len.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (194)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (194)) COMMA_SOURCE_FILE_AT_LINE (194)) ;
        GGS_uint64  var_cas_last_offset ;
        GGS_expiry_point_obj  var_cas_last_point ;
        var_cas_epl.modifier_popGreatest (inLexique, var_cas_last_offset, var_cas_last_point COMMA_SOURCE_FILE_AT_LINE (197)) ;
        if (((var_cas_last_offset).operator_isEqual (var_cas_len.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (198)))).isBuiltAndTrue ()) {
          GGS_action_list  var_cas_acts ;
          var_cas_acts = var_cas_last_point.reader_actions (inLexique COMMA_SOURCE_FILE_AT_LINE (200)) ;
          ...
          var_cas_last_point.modifier_setActions (inLexique, var_cas_acts COMMA_SOURCE_FILE_AT_LINE (202)) ;
        }else{
          ...
          var_cas_finalize_ep = GGS_expiry_point_obj ::constructor_new (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_HERE), GGS_uint64_class ::constructor_new (inLexique, GGS_location (inLexique), var_cas_len.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (210)) COMMA_HERE), GGS_lstring ::constructor_new (inLexique, GGS_string ("finalize"), GGS_location (inLexique) COMMA_HERE), GGS_adjustable_void ::constructor_new (inLexique, function_empty_lstring (inLexique COMMA_SOURCE_FILE_AT_LINE (212)), GGS_location (inLexique) COMMA_HERE), var_cas_finalize_ep_actions COMMA_HERE) ;
          var_cas_epl._addAssign_operation (var_cas_len.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (215)), var_cas_finalize_ep) ;
        }
        var_cas_epl._addAssign_operation (var_cas_last_offset, var_cas_last_point) ;
      }else{
        var_cas_name.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("Internal error, unexpected type for LENGTH attribute of schedule table ")).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (219))) COMMA_SOURCE_FILE_AT_LINE (220)) ;
      }
    }
  }
  GGS_string var_cas_perio ;
  var_cas_perio = GGS_string ("") ;
  { const GGS_basic_type _var_7844 = periodic ; // CAST instruction
    if (_var_7844.getPtr () != NULL) {
      macroValidPointer (_var_7844.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_7844.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_7844.getPtr ()) ;
        if (((var_cas_b.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (227))).operator_isEqual (GGS_bool (true))).isBuiltAndTrue ()) {
          var_cas_perio = GGS_string ("TRUE") ;
        }else{
          var_cas_perio = GGS_string ("FALSE") ;
        }
      }else{
        var_cas_name.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("Internal error, unexpected type for PERIODIC attribute of schedule table ")).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (233))) COMMA_SOURCE_FILE_AT_LINE (234)) ;
      }
    }
  }
  ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$PERIODIC$"),  var_cas_perio COMMA_SOURCE_FILE_AT_LINE (236)) ;
  { const GGS_autostart_obj _var_8786 = autostart ; // CAST instruction
    if (_var_8786.getPtr () != NULL) {
      macroValidPointer (_var_8786.getPtr ()) ;
      if (typeid (cPtr_sd_autostart_false) == typeid (* (_var_8786.getPtr ()))) {
        ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_DATE$"),  GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (240)) ;
        ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_STATE$"),  GGS_string ("SCHEDULETABLE_STOPPED") COMMA_SOURCE_FILE_AT_LINE (241)) ;
      }else if (typeid (cPtr_sd_autostart_synchron) == typeid (* (_var_8786.getPtr ()))) {
        ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_DATE$"),  GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (243)) ;
        ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_STATE$"),  GGS_string ("SCHEDULETABLE_AUTOSTART_SYNCHRON") COMMA_SOURCE_FILE_AT_LINE (244)) ;
      }else if (typeid (cPtr_sd_autostart_relative) == typeid (* (_var_8786.getPtr ()))) {
        const GGS_sd_autostart_relative var_cas_sa (_var_8786.getPtr ()) ;
        ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_DATE$"),  var_cas_sa.reader_offset (inLexique COMMA_SOURCE_FILE_AT_LINE (246)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (246)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (246)) COMMA_SOURCE_FILE_AT_LINE (246)) ;
        ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_STATE$"),  GGS_string ("SCHEDULETABLE_AUTOSTART_RELATIVE") COMMA_SOURCE_FILE_AT_LINE (247)) ;
      }else if (typeid (cPtr_sd_autostart_absolute) == typeid (* (_var_8786.getPtr ()))) {
        const GGS_sd_autostart_absolute var_cas_sa (_var_8786.getPtr ()) ;
        ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_DATE$"),  var_cas_sa.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (249)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (249)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (249)) COMMA_SOURCE_FILE_AT_LINE (249)) ;
        ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_STATE$"),  GGS_string ("SCHEDULETABLE_AUTOSTART_ABSOLUTE") COMMA_SOURCE_FILE_AT_LINE (250)) ;
      }else{
        var_cas_name.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("Internal error, unexpected type for AUTOSTART attribute of schedule table ")).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (251))) COMMA_SOURCE_FILE_AT_LINE (252)) ;
      }
    }
  }
  ...
  var_cas_expiry_table = ((GGS_string ("tpl_expiry_point *")).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (257)))).operator_concat (GGS_string ("_expiry_table[$EXPIRY_TABLE_SIZE$] = {\n")) ;
  GGS_uint64  var_cas_prev_offset ;
  var_cas_prev_offset = GGS_uint64 (0U) ;
  {
    GGS_expiry_point_list::cEnumerator enumerator_9013 (var_cas_epl, true) ;
    const GGS_expiry_point_list::cElement * operand_9013 = enumerator_9013.nextObject () ;
    if ((operand_9013 != NULL)) {
      bool _foreach_loop_9013 ;
      do{
        macroValidPointer (operand_9013) ;
        GGS_string var_cas_exp_st ;
        ::routine_retrieveTemplateString (inLexique,  var_cas_exp_st,  GGS_string ("expiry_point") COMMA_SOURCE_FILE_AT_LINE (263)) ;
        ::routine_doReplace (inLexique,  var_cas_exp_st,  GGS_string ("$EXPIRY_POINT$"),  (((var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (264))).operator_concat (GGS_string ("_"))).operator_concat (operand_9013->off.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (264)))).operator_concat (GGS_string ("_expirypoint")) COMMA_SOURCE_FILE_AT_LINE (264)) ;
        ::routine_doReplace (inLexique,  var_cas_exp_st,  GGS_string ("$OFFSET$"),  operand_9013->off.substract_operation (inLexique, var_cas_prev_offset COMMA_SOURCE_FILE_AT_LINE (265)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265)) COMMA_SOURCE_FILE_AT_LINE (265)) ;
        ::routine_doReplace (inLexique,  var_cas_exp_st,  GGS_string ("$ACTION_COUNT$"),  operand_9013->point.reader_actions (inLexique COMMA_SOURCE_FILE_AT_LINE (266)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (266)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (266)) COMMA_SOURCE_FILE_AT_LINE (266)) ;
        ::routine_doReplace (inLexique,  var_cas_exp_st,  GGS_string ("$ACTION_ARRAY$"),  ((var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (267))).operator_concat (GGS_string ("_"))).operator_concat (operand_9013->off.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (267))) COMMA_SOURCE_FILE_AT_LINE (267)) ;
        ::routine_expiry_point_actions (inLexique,  var_cas_name,  operand_9013->off,  operand_9013->point.reader_actions (inLexique COMMA_SOURCE_FILE_AT_LINE (270)),  var_cas_exp_st COMMA_SOURCE_FILE_AT_LINE (270)) ;
        const GGS_adjustable_obj  temp_9602 = operand_9013->point.reader_adjust (inLexique COMMA_SOURCE_FILE_AT_LINE (271)) ;
        if (temp_9602.isBuilt ()) {
          temp_9602 (HERE)->method_generate (inLexique, var_cas_exp_st COMMA_SOURCE_FILE_AT_LINE (271)) ;
        }
        var_cas_act_structs.dotAssign_operation (var_cas_exp_st) ;
        var_cas_expiry_table.appendCString ("    &") ;
        var_cas_expiry_table.dotAssign_operation (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (273))) ;
        var_cas_expiry_table.appendCString ("_") ;
        var_cas_expiry_table.dotAssign_operation (operand_9013->off.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (273))) ;
        var_cas_expiry_table.appendCString ("_expirypoint") ;
        var_cas_prev_offset = operand_9013->off ;
        operand_9013 = enumerator_9013.nextObject () ;
        _foreach_loop_9013 = ((operand_9013 != NULL)) ;
        if (_foreach_loop_9013) {
          var_cas_expiry_table.appendCString (",\n") ;
        }
      }while (_foreach_loop_9013) ;
      var_cas_expiry_table.appendCString ("\n"
        "};\n") ;
    }
  }
  { const GGS_ltgt_sync_obj _var_10566 = ltgt_sync ; // CAST instruction
    if (_var_10566.getPtr () != NULL) {
      macroValidPointer (_var_10566.getPtr ()) ;
      if (typeid (cPtr_ltgt_sync_void) == typeid (* (_var_10566.getPtr ()))) {
        ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  GGS_string ("SCHEDTABLE_NO_SYNC") COMMA_SOURCE_FILE_AT_LINE (284)) ;
        ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (285)) ;
      }else if (typeid (cPtr_ltgt_sync_false) == typeid (* (_var_10566.getPtr ()))) {
        ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  GGS_string ("SCHEDTABLE_NO_SYNC") COMMA_SOURCE_FILE_AT_LINE (287)) ;
        ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (288)) ;
      }else if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_10566.getPtr ()))) {
        const GGS_ltgt_sync_true var_cas_sst (_var_10566.getPtr ()) ;
        ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  ((GGS_string ("SCHEDTABLE_")).operator_concat (var_cas_sst.reader_strategy (inLexique COMMA_SOURCE_FILE_AT_LINE (290)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (290)))).operator_concat (GGS_string ("_SYNC")) COMMA_SOURCE_FILE_AT_LINE (290)) ;
        { const GGS_basic_type _var_10547 = var_cas_sst.reader_precision (inLexique COMMA_SOURCE_FILE_AT_LINE (291)) ; // CAST instruction
          if (_var_10547.getPtr () != NULL) {
            macroValidPointer (_var_10547.getPtr ()) ;
            if (typeid (cPtr_uint64_class) == typeid (* (_var_10547.getPtr ()))) {
              const GGS_uint64_class var_cas_p (_var_10547.getPtr ()) ;
              ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  var_cas_p.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (293)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (293)) COMMA_SOURCE_FILE_AT_LINE (293)) ;
            }else{
              var_cas_sst.reader_loc (inLexique COMMA_SOURCE_FILE_AT_LINE (295)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("Internal error, wrong type for PRECISION") COMMA_SOURCE_FILE_AT_LINE (296)) ;
            }
          }
        }
      }else{
  ...
  ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$EXPIRY_POINTS$"),  ((var_cas_act_structs).operator_concat (var_cas_act_table)).operator_concat (var_cas_expiry_table) COMMA_SOURCE_FILE_AT_LINE (299)) ;
  ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$EXPIRY_TABLE_SIZE$"),  var_cas_epl.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (300)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (300)) COMMA_SOURCE_FILE_AT_LINE (300)) ;
...
GGS_scheduletable_obj  function_default_scheduletable_obj (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  var_cas_st = GGS_scheduletable_obj ::constructor_new (inLexique, function_empty_lstring (inLexique COMMA_SOURCE_FILE_AT_LINE (317)), function_empty_lstring (inLexique COMMA_SOURCE_FILE_AT_LINE (318)), GGS_autostart_void ::constructor_new (inLexique, GGS_location (inLexique) COMMA_HERE), GGS_ltgt_sync_void ::constructor_new (inLexique, GGS_location (inLexique) COMMA_HERE), GGS_void ::constructor_new (inLexique, GGS_location (inLexique) COMMA_HERE), GGS_void ::constructor_new (inLexique, GGS_location (inLexique) COMMA_HERE), GGS_expiry_point_list ::constructor_emptySortedList (), GGS_lstringlist ::constructor_emptyList () COMMA_HERE) ;
  #ifdef DEBUG_TRACE_ENABLED
