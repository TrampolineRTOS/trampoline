...
cPtr__AC_galgas_class * cPtr_app_obj::makeClone (void) const {
  cPtr__AC_galgas_class * result = NULL ;
  macroMyNew (result, cPtr_app_obj (desc, trusted, startuphook, shutdownhook, errorhook, restart, tasks, isrs, alarms, schedtables, counters, resources, messages COMMA_HERE)) ;
  return result ;
}
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.app.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
