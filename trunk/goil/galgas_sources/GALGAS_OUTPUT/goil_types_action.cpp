...
GGS_finalize_st_action (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
C_galgasClassRunTimeInformation gClassInfoFor__finalize_st_action ("finalize_st_action", gClassInfoFor__action_obj) ;
