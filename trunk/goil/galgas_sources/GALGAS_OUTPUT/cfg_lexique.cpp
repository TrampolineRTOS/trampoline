...
static const char * gSyntaxErrorMessage_interrupts = "Config file keyword 'interrupts'" ;
...
const sint16 cfg_lexique::cfg_lexique_table_size_cfg_keywords = 7 ;

const C_lexique_table_entry cfg_lexique::cfg_lexique_table_for_cfg_keywords [7] = {
  ...
  C_lexique_table_entry ("interrupts", 10, cfg_lexique_1_interrupts),
