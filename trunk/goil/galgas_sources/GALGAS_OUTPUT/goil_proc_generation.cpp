...
void routine_generate_proc_table (C_Compiler & inLexique,
  ...
  var_cas_stasks = GGS_tasks_by_type ::constructor_emptySortedList () ;
  {
    ...
    while (((operand_1195 = enumerator_1195.nextObject ()))) {
      ...
      if (((operand_1195->mInfo.task.reader_events (inLexique COMMA_SOURCE_FILE_AT_LINE (53)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (53))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_stasks._addAssign_operation (GGS_uint (0U), operand_1195->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (54))) ;
        var_cas_ex_t_ct.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (55)) ;
      }else{
        var_cas_stasks._addAssign_operation (GGS_uint (1U), operand_1195->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (57))) ;
      }
    }
  }
  ...
  var_cas_ct = GGS_uint (0U) ;
  {
    ...
    if ((operand_3109 != NULL)) {
      ...
      do{
        ...
        if (((operand_3109->type).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
