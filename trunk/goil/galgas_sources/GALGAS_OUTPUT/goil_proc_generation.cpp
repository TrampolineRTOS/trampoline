...
void routine_generate_proc_table (C_Compiler & _inLexique,
  ...
  var_cas_stasks = GGS_tasks_by_type ::constructor_emptySortedList () ;
  {
    ...
    while (((operand_1191 = enumerator_1191.nextObject ()))) {
      ...
      if (((operand_1191->mInfo.task.reader_events (_inLexique COMMA_SOURCE_FILE_AT_LINE (53)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (53)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_stasks._addAssign_operation (GGS_uint (0U), operand_1191->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (54))) ;
        var_cas_ex_t_ct._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (55)) ;
      }else{
        var_cas_stasks._addAssign_operation (GGS_uint (1U), operand_1191->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (57))) ;
      }
    }
  }
  ::routine_doReplace (_inLexique,  var_cas_obj_head,  GGS_string ("$EXTENDED_TASK_COUNT$"),  var_cas_ex_t_ct.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (61)) COMMA_SOURCE_FILE_AT_LINE (61)) ;
  ...
  }
  {
    ...
    while (((operand_2086 = enumerator_2086.nextObject ()))) {
      ...
      var_cas_proc_ids.appendCString ("\n") ;
      if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (82)))).isBuiltAndTrue ()) {
  ...
  var_cas_ct = GGS_uint (0U) ;
  {
    ...
    if ((operand_3105 != NULL)) {
      ...
      do{
        ...
        if (((operand_3105->type)._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
  ...
  ::routine_doReplace (_inLexique,  var_cas_imp,  GGS_string ("$PROCIDS$"),  var_cas_proc_ids COMMA_SOURCE_FILE_AT_LINE (138)) ;
  ::routine_doReplace (_inLexique,  var_cas_head,  GGS_string ("$PROC_NAMES$"),  var_cas_names_head COMMA_SOURCE_FILE_AT_LINE (139)) ;
  ::routine_doReplace (_inLexique,  var_cas_imp,  GGS_string ("$PROC_NAMES$"),  var_cas_names_imp COMMA_SOURCE_FILE_AT_LINE (140)) ;
  ::routine_doReplace (_inLexique,  var_cas_imp,  GGS_string ("$PROC_STATIC_TABLE$"),  var_cas_proc_stat_imp COMMA_SOURCE_FILE_AT_LINE (141)) ;
  ::routine_doReplace (_inLexique,  var_cas_imp,  GGS_string ("$PROC_DYNAMIC_TABLE$"),  var_cas_proc_dyn_imp COMMA_SOURCE_FILE_AT_LINE (142)) ;
  ::routine_doReplace (_inLexique,  var_cas_imp,  GGS_string ("$TASK_EVENTS_TABLE$"),  var_cas_event_imp COMMA_SOURCE_FILE_AT_LINE (143)) ;
  ::routine_doReplace (_inLexique,  var_cas_imp,  GGS_string ("$ISR_HELPER_TABLE$"),  var_cas_isr_stat_imp COMMA_SOURCE_FILE_AT_LINE (144)) ;
  ::routine_doReplace (_inLexique,  var_cas_imp,  GGS_string ("$ISR_ENABLE_TABLE$"),  var_cas_isr_ena_imp COMMA_SOURCE_FILE_AT_LINE (145)) ;
  #ifdef DEBUG_TRACE_ENABLED
