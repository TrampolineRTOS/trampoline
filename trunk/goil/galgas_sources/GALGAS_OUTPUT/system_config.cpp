...
void routine_setOsapplicationsList (C_Compiler & inLexique,
    ...
    while (((operand_39528 = enumerator_39528.nextObject ()))) {
      ...
      }
      {
        ...
        while (((operand_43806 = enumerator_43806.nextObject ()))) {
          ...
          const GGS_isr_map  temp_44015 = var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1073)) ;
          if (temp_44015.isBuilt ()) {
            temp_44015 (HERE)->method_get (inLexique, operand_43806->mKey, var_cas_isr COMMA_SOURCE_FILE_AT_LINE (1073)) ;
          }
          { const GGS_basic_type _var_44267 = var_cas_isr.reader_category (inLexique COMMA_SOURCE_FILE_AT_LINE (1074)) ; // CAST instruction
            if (_var_44267.getPtr () != NULL) {
              macroValidPointer (_var_44267.getPtr ()) ;
              if (typeid (cPtr_uint64_class) == typeid (* (_var_44267.getPtr ()))) {
                const GGS_uint64_class var_cas_cat (_var_44267.getPtr ()) ;
                const GGS_bool cond_44248 = (var_cas_cat.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (1076))).operator_isEqual (GGS_uint64 (2ULL)) ;
                if (cond_44248.isBuiltAndTrue ()) {
      ...
      {
        GGS_ident_map::cEnumerator enumerator_44626 (operand_39528->mInfo.app.reader_alarms (inLexique COMMA_SOURCE_FILE_AT_LINE (1090)), true) ;
        const GGS_ident_map::cElement * operand_44626 = NULL ;
        while (((operand_44626 = enumerator_44626.nextObject ()))) {
          ...
          ::routine_addStringFieldValue (inLexique,  var_cas_alarmFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), operand_44626->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1092)) COMMA_SOURCE_FILE_AT_LINE (1092)),  operand_44626->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1092)) COMMA_SOURCE_FILE_AT_LINE (1092)) ;
      ...
      {
        GGS_ident_map::cEnumerator enumerator_45157 (operand_39528->mInfo.app.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (1101)), true) ;
        const GGS_ident_map::cElement * operand_45157 = NULL ;
        while (((operand_45157 = enumerator_45157.nextObject ()))) {
          macroValidPointer (operand_45157) ;
          ...
          ::routine_addStringFieldValue (inLexique,  var_cas_resourceFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), operand_45157->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1103)) COMMA_SOURCE_FILE_AT_LINE (1103)),  operand_45157->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1103)) COMMA_SOURCE_FILE_AT_LINE (1103)) ;
          ...
          GGS_resource_obj  var_cas_resource ;
          const GGS_resource_map  temp_45488 = var_cas_allResources ;
          if (temp_45488.isBuilt ()) {
            temp_45488 (HERE)->method_get (inLexique, operand_45157->mKey, var_cas_resource COMMA_SOURCE_FILE_AT_LINE (1107)) ;
          }
          { const GGS_resource_property_obj _var_45710 = var_cas_resource.reader_property (inLexique COMMA_SOURCE_FILE_AT_LINE (1108)) ; // CAST instruction
            if (_var_45710.getPtr () != NULL) {
              macroValidPointer (_var_45710.getPtr ()) ;
              if (typeid (cPtr_resource_property_internal_obj) == typeid (* (_var_45710.getPtr ()))) {
      ...
      {
        GGS_ident_map::cEnumerator enumerator_46109 (operand_39528->mInfo.app.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (1121)), true) ;
        const GGS_ident_map::cElement * operand_46109 = NULL ;
        while (((operand_46109 = enumerator_46109.nextObject ()))) {
          macroValidPointer (operand_46109) ;
          ...
          ::routine_addStringFieldValue (inLexique,  var_cas_scheduletableFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), operand_46109->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1123)) COMMA_SOURCE_FILE_AT_LINE (1123)),  operand_46109->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1123)) COMMA_SOURCE_FILE_AT_LINE (1123)) ;
      ...
      {
        GGS_ident_map::cEnumerator enumerator_46564 (operand_39528->mInfo.app.reader_counters (inLexique COMMA_SOURCE_FILE_AT_LINE (1130)), true) ;
        const GGS_ident_map::cElement * operand_46564 = NULL ;
        while (((operand_46564 = enumerator_46564.nextObject ()))) {
          macroValidPointer (operand_46564) ;
          ...
          ::routine_addStringFieldValue (inLexique,  var_cas_counterFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), operand_46564->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1132)) COMMA_SOURCE_FILE_AT_LINE (1132)),  operand_46564->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1132)) COMMA_SOURCE_FILE_AT_LINE (1132)) ;
      ...
      {
        GGS_ident_map::cEnumerator enumerator_46977 (operand_39528->mInfo.app.reader_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (1139)), true) ;
        const GGS_ident_map::cElement * operand_46977 = NULL ;
        while (((operand_46977 = enumerator_46977.nextObject ()))) {
          macroValidPointer (operand_46977) ;
          ...
          ::routine_addStringFieldValue (inLexique,  var_cas_messageFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), operand_46977->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1141)) COMMA_SOURCE_FILE_AT_LINE (1141)),  operand_46977->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1141)) COMMA_SOURCE_FILE_AT_LINE (1141)) ;
      ...
      { const GGS_app_trusted_obj _var_47547 = operand_39528->mInfo.app.reader_trusted (inLexique COMMA_SOURCE_FILE_AT_LINE (1148)) ; // CAST instruction
        if (_var_47547.getPtr () != NULL) {
          macroValidPointer (_var_47547.getPtr ()) ;
          if (typeid (cPtr_app_trusted_true) == typeid (* (_var_47547.getPtr ()))) {
            const GGS_app_trusted_true var_cas_t (_var_47547.getPtr ()) ;
            {
              GGS_stringset::cEnumerator enumerator_47415 (var_cas_t.reader_trusted_fcts (inLexique COMMA_SOURCE_FILE_AT_LINE (1150)), true) ;
              while (enumerator_47415.hasCurrentObject ()) {
                var_cas_trustedFunctionSet.addAssign_operation (enumerator_47415._key (HERE)) ;
                enumerator_47415.next () ;
              }
            }
          }else{
          }
  ...
  {
    GGS_stringset::cEnumerator enumerator_47736 (var_cas_trustedFunctionSet, true) ;
    while (enumerator_47736.hasCurrentObject ()) {
      ...
      ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("NAME") COMMA_SOURCE_FILE_AT_LINE (1160)),  enumerator_47736._key (HERE) COMMA_SOURCE_FILE_AT_LINE (1160)) ;
      var_cas_trustedfunctionsList.addAssign_operation (var_cas_fieldMap) ;
      enumerator_47736.next () ;
    }
  }
...
void routine_setReadyList (C_Compiler & inLexique,
  ...
  const GGS_bool cond_48691 = var_cas_config.reader_hasKey (GGS_string ("POWEROF2QUEUE")) ;
  if (cond_48691.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_pw ;
    const GGS_ident_map  temp_48480 = var_cas_config ;
    if (temp_48480.isBuilt ()) {
      temp_48480 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("POWEROF2QUEUE"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1183)), var_cas_pw COMMA_SOURCE_FILE_AT_LINE (1183)) ;
    }
    { const GGS_basic_type _var_48679 = var_cas_pw ; // CAST instruction
      if (_var_48679.getPtr () != NULL) {
        macroValidPointer (_var_48679.getPtr ()) ;
        if (typeid (cPtr_bool_class) == typeid (* (_var_48679.getPtr ()))) {
          const GGS_bool_class var_cas_b (_var_48679.getPtr ()) ;
  ...
  {
    GGS_prio_list::cEnumerator enumerator_48718 (var_cas_readyList, true) ;
    const GGS_prio_list::cElement * operand_48718 = NULL ;
    while (((operand_48718 = enumerator_48718.nextObject ()))) {
      macroValidPointer (operand_48718) ;
      ...
      const GGS_bool cond_48949 = var_cas_powerof2 ;
      if (cond_48949.isBuiltAndTrue ()) {
        var_cas_maxSize = GGS_uint (1U) ;
        GGS_uint _variant_48934 = GGS_uint (32U) ;
        GGS_bool _condition_48934 (_variant_48934.isBuilt (), true) ;
        while (_condition_48934.isBuiltAndTrue ()) {
          _condition_48934 = (operand_48718->fifosize).operator_strictSup (var_cas_maxSize) ;
          if (_condition_48934.isBuiltAndTrue ()) {
            if (_variant_48934.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1200)) ;
              _condition_48934 = GGS_bool (false) ;
            }else{
              _variant_48934.decrement_operation (inLexique COMMA_HERE) ;
              var_cas_maxSize = var_cas_maxSize.left_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1199)) ;
            }
          }
        }
      }else if (cond_48949.isBuiltAndFalse ()) {
        var_cas_maxSize = operand_48718->fifosize ;
      }
...
void routine_setProcessCount (C_Compiler & inLexique,
  ...
  {
    GGS_task_map::cEnumerator enumerator_49543 (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (1222)), true) ;
    const GGS_task_map::cElement * operand_49543 = NULL ;
    while (((operand_49543 = enumerator_49543.nextObject ()))) {
      macroValidPointer (operand_49543) ;
      const GGS_bool cond_49626 = (operand_49543->mInfo.task.reader_events (inLexique COMMA_SOURCE_FILE_AT_LINE (1223)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  ...
  {
    GGS_isr_map::cEnumerator enumerator_49684 (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1228)), true) ;
    const GGS_isr_map::cElement * operand_49684 = NULL ;
    while (((operand_49684 = enumerator_49684.nextObject ()))) {
      macroValidPointer (operand_49684) ;
      { const GGS_basic_type _var_49885 = operand_49684->mInfo.isr.reader_category (inLexique COMMA_SOURCE_FILE_AT_LINE (1229)) ; // CAST instruction
        if (_var_49885.getPtr () != NULL) {
          macroValidPointer (_var_49885.getPtr ()) ;
          if (typeid (cPtr_uint64_class) == typeid (* (_var_49885.getPtr ()))) {
            const GGS_uint64_class var_cas_cat (_var_49885.getPtr ()) ;
            const GGS_bool cond_49817 = (var_cas_cat.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (1231))).operator_isEqual (GGS_uint64 (2ULL)) ;
            if (cond_49817.isBuiltAndTrue ()) {
              var_cas_isr2Count.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1232)) ;
            }
          }else{
            operand_49684->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("missing CATEGORY attribute") COMMA_SOURCE_FILE_AT_LINE (1236)) ;
          }
        }
      }
    }
...
void routine_setResourceCount (C_Compiler & inLexique,
  ...
  {
    GGS_resource_map::cEnumerator enumerator_50805 (var_cas_cpu.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (1254)), true) ;
    const GGS_resource_map::cElement * operand_50805 = NULL ;
    while (((operand_50805 = enumerator_50805.nextObject ()))) {
      macroValidPointer (operand_50805) ;
      { const GGS_resource_property_obj _var_51174 = operand_50805->mInfo.resource.reader_property (inLexique COMMA_SOURCE_FILE_AT_LINE (1255)) ; // CAST instruction
        if (_var_51174.getPtr () != NULL) {
          macroValidPointer (_var_51174.getPtr ()) ;
          if (typeid (cPtr_resource_property_standard_obj) == typeid (* (_var_51174.getPtr ()))) {
            var_cas_regularCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1257)) ;
          }else if (typeid (cPtr_resource_property_linked_obj) == typeid (* (_var_51174.getPtr ()))) {
            var_cas_regularCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1259)) ;
          }else if (typeid (cPtr_resource_property_internal_obj) == typeid (* (_var_51174.getPtr ()))) {
            var_cas_internalCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1261)) ;
          }else{
            operand_50805->mInfo.resource.reader_property (inLexique COMMA_SOURCE_FILE_AT_LINE (1263)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1263)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error, RESOURCEPROPERTY type is undefined") COMMA_SOURCE_FILE_AT_LINE (1264)) ;
          }
        }
      }
    }
...
void routine_setSourceFileList (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_51560 (var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1275)).reader_app_src (inLexique COMMA_SOURCE_FILE_AT_LINE (1275)), true) ;
    const GGS_lstringlist::cElement * operand_51560 = NULL ;
    while (((operand_51560 = enumerator_51560.nextObject ()))) {
      ...
      ::routine_addStringFieldValue (inLexique,  var_cas_sourceFileFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("FILE"), operand_51560->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1277)) COMMA_SOURCE_FILE_AT_LINE (1277)),  operand_51560->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1277)) COMMA_SOURCE_FILE_AT_LINE (1277)) ;
...
void routine_setCFlagsList (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_52075 (var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1288)).reader_cflags (inLexique COMMA_SOURCE_FILE_AT_LINE (1288)), true) ;
    const GGS_lstringlist::cElement * operand_52075 = NULL ;
    while (((operand_52075 = enumerator_52075.nextObject ()))) {
      macroValidPointer (operand_52075) ;
      const GGS_bool cond_52358 = (function_stripString (inLexique, operand_52075->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1289)) COMMA_SOURCE_FILE_AT_LINE (1289))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_52358.isBuiltAndTrue ()) {
        ...
        ::routine_addStringFieldValue (inLexique,  var_cas_cFlagFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("CFLAG"), operand_52075->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1291)) COMMA_SOURCE_FILE_AT_LINE (1291)),  operand_52075->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1291)) COMMA_SOURCE_FILE_AT_LINE (1291)) ;
...
void routine_setAsFlagsList (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_52615 (var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1303)).reader_asflags (inLexique COMMA_SOURCE_FILE_AT_LINE (1303)), true) ;
    const GGS_lstringlist::cElement * operand_52615 = NULL ;
    while (((operand_52615 = enumerator_52615.nextObject ()))) {
      macroValidPointer (operand_52615) ;
      const GGS_bool cond_52908 = (function_stripString (inLexique, operand_52615->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1304)) COMMA_SOURCE_FILE_AT_LINE (1304))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_52908.isBuiltAndTrue ()) {
        ...
        ::routine_addStringFieldValue (inLexique,  var_cas_asFlagFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("ASFLAG"), operand_52615->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1306)) COMMA_SOURCE_FILE_AT_LINE (1306)),  operand_52615->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1306)) COMMA_SOURCE_FILE_AT_LINE (1306)) ;
...
void routine_setLdFlagsList (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_53167 (var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1318)).reader_ldflags (inLexique COMMA_SOURCE_FILE_AT_LINE (1318)), true) ;
    const GGS_lstringlist::cElement * operand_53167 = NULL ;
    while (((operand_53167 = enumerator_53167.nextObject ()))) {
      macroValidPointer (operand_53167) ;
      const GGS_bool cond_53460 = (function_stripString (inLexique, operand_53167->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1319)) COMMA_SOURCE_FILE_AT_LINE (1319))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_53460.isBuiltAndTrue ()) {
        ...
        ::routine_addStringFieldValue (inLexique,  var_cas_ldFlagFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("LDFLAG"), operand_53167->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1321)) COMMA_SOURCE_FILE_AT_LINE (1321)),  operand_53167->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1321)) COMMA_SOURCE_FILE_AT_LINE (1321)) ;
...
void routine_setTraceFlag (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_trace _var_55908 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1332)).reader_trace (inLexique COMMA_SOURCE_FILE_AT_LINE (1332)) ; // CAST instruction
    if (_var_55908.getPtr () != NULL) {
      macroValidPointer (_var_55908.getPtr ()) ;
      if (typeid (cPtr_trace) == typeid (* (_var_55908.getPtr ()))) {
        const GGS_trace var_cas_noTrace (_var_55908.getPtr ()) ;
      ...
      }else if (typeid (cPtr_trace_off) == typeid (* (_var_55908.getPtr ()))) {
        const GGS_trace_off var_cas_traceOff (_var_55908.getPtr ()) ;
      ...
      }else if (typeid (cPtr_trace_on) == typeid (* (_var_55908.getPtr ()))) {
        const GGS_trace_on var_cas_traceOn (_var_55908.getPtr ()) ;
        ...
        const GGS_bool cond_54317 = (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (1341)).reader_count ().reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (1341))).operator_strictSup (GGS_uint64 (0ULL)) ;
        if (cond_54317.isBuiltAndTrue ()) {
        ...
        }else if (cond_54317.isBuiltAndFalse ()) {
        ...
        const GGS_bool cond_54646 = (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1347)).reader_count ().reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (1347))).operator_strictSup (GGS_uint64 (0ULL)) ;
        if (cond_54646.isBuiltAndTrue ()) {
        ...
        }else if (cond_54646.isBuiltAndFalse ()) {
        ...
        const GGS_bool cond_54993 = (var_cas_cpu.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (1353)).reader_count ().reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (1353))).operator_strictSup (GGS_uint64 (0ULL)) ;
        if (cond_54993.isBuiltAndTrue ()) {
        ...
        }else if (cond_54993.isBuiltAndFalse ()) {
        ...
        const GGS_bool cond_55338 = (var_cas_cpu.reader_alarms (inLexique COMMA_SOURCE_FILE_AT_LINE (1359)).reader_count ().reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (1359))).operator_strictSup (GGS_uint64 (0ULL)) ;
        if (cond_55338.isBuiltAndTrue ()) {
        ...
        }else if (cond_55338.isBuiltAndFalse ()) {
        ...
        { const GGS_trace_method _var_55891 = var_cas_traceOn.reader_meth (inLexique COMMA_SOURCE_FILE_AT_LINE (1365)) ; // CAST instruction
          if (_var_55891.getPtr () != NULL) {
            macroValidPointer (_var_55891.getPtr ()) ;
            if (typeid (cPtr_trace_file) == typeid (* (_var_55891.getPtr ()))) {
              const GGS_trace_file var_cas_traceFile (_var_55891.getPtr ()) ;
...
void routine_setLinkScript (C_Compiler & inLexique,
  ...
  const GGS_bool cond_56381 = var_cas_useLinkScript ;
  if (cond_56381.isBuiltAndTrue ()) {
...
void routine_setMemoryMapping (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_57361 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1391)).reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (1391)) ; // CAST instruction
    if (_var_57361.getPtr () != NULL) {
      macroValidPointer (_var_57361.getPtr ()) ;
      if (typeid (cPtr_memmap_false) == typeid (* (_var_57361.getPtr ()))) {
        var_cas_useMemoryMapping = GGS_bool (false) ;
        var_cas_useCompilerSettings = GGS_bool (false) ;
      }else if (typeid (cPtr_memmap_true) == typeid (* (_var_57361.getPtr ()))) {
        const GGS_memmap_true var_cas_trueMemmap (_var_57361.getPtr ()) ;
        ...
        const GGS_bool cond_56947 = (var_cas_compiler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1398))).operator_isNotEqual (GGS_string ("")) ;
        if (cond_56947.isBuiltAndTrue ()) {
        ...
        const GGS_bool cond_57099 = (var_cas_assembler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1403))).operator_isNotEqual (GGS_string ("")) ;
        if (cond_57099.isBuiltAndTrue ()) {
          ::routine_addLStringValue (inLexique,  var_cas_cfg,  GGS_string ("ASSEMBLER"),  var_cas_assembler COMMA_SOURCE_FILE_AT_LINE (1404)) ;
        }
        { const GGS_basic_type _var_57344 = var_cas_trueMemmap.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (1406)) ; // CAST instruction
          if (_var_57344.getPtr () != NULL) {
            macroValidPointer (_var_57344.getPtr ()) ;
            if (typeid (cPtr_no_linker) == typeid (* (_var_57344.getPtr ()))) {
            }else if (typeid (cPtr_yes_linker) == typeid (* (_var_57344.getPtr ()))) {
              const GGS_yes_linker var_cas_yesLinker (_var_57344.getPtr ()) ;
...
void routine_setCompiler (C_Compiler & inLexique,
  ...
  const GGS_bool cond_57854 = (var_cas_compiler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1423))).operator_isNotEqual (GGS_string ("")) ;
  if (cond_57854.isBuiltAndTrue ()) {
...
void routine_setAssembler (C_Compiler & inLexique,
  ...
  const GGS_bool cond_58226 = (var_cas_assembler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1433))).operator_isNotEqual (GGS_string ("")) ;
  if (cond_58226.isBuiltAndTrue ()) {
...
void routine_setLinker (C_Compiler & inLexique,
  ...
  const GGS_bool cond_58578 = (var_cas_linker.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1443))).operator_isNotEqual (GGS_string ("")) ;
  if (cond_58578.isBuiltAndTrue ()) {
...
void routine_setTrampolinePath (C_Compiler & inLexique,
  ...
  const GGS_bool cond_59631 = (var_cas_trampolinePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1470))).operator_isEqual (GGS_string ("")) ;
...
GGS_bool function_useCommunication (C_Compiler & inLexique,
  ...
  const GGS_bool cond_61243 = var_cas_comObject.reader_usecom (inLexique COMMA_SOURCE_FILE_AT_LINE (1523)) ;
  if (cond_61243.isBuiltAndTrue ()) {
    var_cas_useCom = GGS_bool (true) ;
  }else if (cond_61243.isBuiltAndFalse ()) {
...
void routine_setUseCom (C_Compiler & inLexique,
  ...
  const GGS_bool cond_62933 = var_cas_useCom ;
  if (cond_62933.isBuiltAndTrue ()) {
    ...
    { const GGS_basic_type _var_61955 = var_cas_comObject.reader_timebase (inLexique COMMA_SOURCE_FILE_AT_LINE (1542)) ; // CAST instruction
      if (_var_61955.getPtr () != NULL) {
        macroValidPointer (_var_61955.getPtr ()) ;
        if (typeid (cPtr_float_class) == typeid (* (_var_61955.getPtr ()))) {
          const GGS_float_class var_cas_timeBase (_var_61955.getPtr ()) ;
    ...
    const GGS_bool cond_62832 = (var_cas_comStatus.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1555))).operator_isEqual (GGS_string ("extended")) ;
    if (cond_62832.isBuiltAndTrue ()) {
...
void routine_scalabilityClass (C_Compiler & inLexique,
  ...
  const GGS_bool cond_66728 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_66728.isBuiltAndTrue ()) {
    {
      GGS_task_map::cEnumerator enumerator_63571 (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (1585)), true) ;
      const GGS_task_map::cElement * operand_63571 = NULL ;
      while (((operand_63571 = enumerator_63571.nextObject ()))) {
        macroValidPointer (operand_63571) ;
        { const GGS_timing_prot _var_63694 = operand_63571->mInfo.task.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (1586)) ; // CAST instruction
          if (_var_63694.getPtr () != NULL) {
            macroValidPointer (_var_63694.getPtr ()) ;
            if (typeid (cPtr_timing_prot_task) == typeid (* (_var_63694.getPtr ()))) {
    ...
    {
      GGS_isr_map::cEnumerator enumerator_63738 (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1591)), true) ;
      const GGS_isr_map::cElement * operand_63738 = NULL ;
      while (((operand_63738 = enumerator_63738.nextObject ()))) {
        macroValidPointer (operand_63738) ;
        { const GGS_timing_prot _var_63858 = operand_63738->mInfo.isr.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (1592)) ; // CAST instruction
          if (_var_63858.getPtr () != NULL) {
            macroValidPointer (_var_63858.getPtr ()) ;
            if (typeid (cPtr_timing_prot_isr) == typeid (* (_var_63858.getPtr ()))) {
              var_cas_useTimingProtection = GGS_bool (true) ;
            }else{
            }
          }
    ...
    {
      GGS_scheduletable_map::cEnumerator enumerator_63900 (var_cas_cpu.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (1597)), true) ;
      const GGS_scheduletable_map::cElement * operand_63900 = NULL ;
      while (((operand_63900 = enumerator_63900.nextObject ()))) {
        macroValidPointer (operand_63900) ;
        { const GGS_ltgt_sync_obj _var_64031 = operand_63900->mInfo.scheduletable.reader_ltgt_sync (inLexique COMMA_SOURCE_FILE_AT_LINE (1598)) ; // CAST instruction
          if (_var_64031.getPtr () != NULL) {
            macroValidPointer (_var_64031.getPtr ()) ;
            if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_64031.getPtr ()))) {
    ...
    { const GGS_basic_type _var_64234 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1605)).reader_protectionhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1605)) ; // CAST instruction
      if (_var_64234.getPtr () != NULL) {
        macroValidPointer (_var_64234.getPtr ()) ;
        if (typeid (cPtr_bool_class) == typeid (* (_var_64234.getPtr ()))) {
          const GGS_bool_class var_cas_ph (_var_64234.getPtr ()) ;
    ...
    const GGS_bool cond_64949 = ((var_cas_setSC).operator_isEqual (GGS_string (""))).operator_or ((var_cas_setSC).operator_isEqual (GGS_string ("AUTO"))) ;
    if (cond_64949.isBuiltAndTrue ()) {
      const GGS_bool cond_64659 = ((var_cas_useTimingProtection).operator_or (var_cas_useProtectionHook)).operator_or (var_cas_useGlobalTime) ;
      if (cond_64659.isBuiltAndTrue ()) {
        var_cas_sc = GGS_uint64 (2ULL) ;
      }
      const GGS_bool cond_64929 = (function_memory_protection_on (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1628)) COMMA_SOURCE_FILE_AT_LINE (1628))).operator_or ((var_cas_cpu.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (1628)).reader_count ()).operator_strictSup (GGS_uint (0U))) ;
      if (cond_64929.isBuiltAndTrue ()) {
        var_cas_sc = var_cas_sc.add_operation (inLexique, GGS_uint64 (2ULL) COMMA_SOURCE_FILE_AT_LINE (1629)) ;
      }
    }else if (cond_64949.isBuiltAndFalse ()) {
      const GGS_bool cond_65749 = (var_cas_setSC).operator_isEqual (GGS_string ("sc1")) ;
      if (cond_65749.isBuiltAndTrue ()) {
        const GGS_bool cond_65500 = var_cas_useTimingProtection ;
        if (cond_65500.isBuiltAndTrue ()) {
          const GGS_bool cond_65335 = var_cas_useOSApplication ;
          if (cond_65335.isBuiltAndTrue ()) {
          ...
          }else if (cond_65335.isBuiltAndFalse ()) {
            var_cas_sc = GGS_uint64 (2ULL) ;
        ...
        }else if (cond_65500.isBuiltAndFalse ()) {
          const GGS_bool cond_65681 = var_cas_useOSApplication ;
          if (cond_65681.isBuiltAndTrue ()) {
          ...
          }else if (cond_65681.isBuiltAndFalse ()) {
            var_cas_sc = GGS_uint64 (1ULL) ;
          }
        }
      }else if (cond_65749.isBuiltAndFalse ()) {
        const GGS_bool cond_66311 = (var_cas_setSC).operator_isEqual (GGS_string ("sc2")) ;
        if (cond_66311.isBuiltAndTrue ()) {
          const GGS_bool cond_66062 = var_cas_useTimingProtection ;
          if (cond_66062.isBuiltAndTrue ()) {
            const GGS_bool cond_66009 = var_cas_useOSApplication ;
            if (cond_66009.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (4ULL) ;
            ...
            }else if (cond_66009.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (2ULL) ;
            }
          }else if (cond_66062.isBuiltAndFalse ()) {
            const GGS_bool cond_66243 = var_cas_useOSApplication ;
            if (cond_66243.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (3ULL) ;
            ...
            }else if (cond_66243.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (2ULL) ;
            }
          }
        }else if (cond_66311.isBuiltAndFalse ()) {
          const GGS_bool cond_66672 = (var_cas_setSC).operator_isEqual (GGS_string ("sc3")) ;
          if (cond_66672.isBuiltAndTrue ()) {
            const GGS_bool cond_66624 = var_cas_useTimingProtection ;
            if (cond_66624.isBuiltAndTrue ()) {
              const GGS_bool cond_66571 = var_cas_useOSApplication ;
              if (cond_66571.isBuiltAndTrue ()) {
                var_cas_sc = GGS_uint64 (4ULL) ;
              ...
              }else if (cond_66571.isBuiltAndFalse ()) {
                var_cas_sc = GGS_uint64 (3ULL) ;
              }
            }else if (cond_66624.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (3ULL) ;
            }
          }else if (cond_66672.isBuiltAndFalse ()) {
            const GGS_bool cond_66706 = (var_cas_setSC).operator_isEqual (GGS_string ("sc4")) ;
            if (cond_66706.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (4ULL) ;
            }
          }
        }
...
void routine_setInterruptSources (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_69984 = var_cas_targetConfiguration.reader_hasKey (GGS_string ("it_sources")) ;
  if (cond_69984.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_interruptSources ;
    const GGS_config  temp_69281 = var_cas_targetConfiguration ;
    if (temp_69281.isBuilt ()) {
      temp_69281 (HERE)->method_get (inLexique, function_lstringWith (inLexique, GGS_string ("it_sources") COMMA_SOURCE_FILE_AT_LINE (1728)), var_cas_interruptSources COMMA_SOURCE_FILE_AT_LINE (1728)) ;
    }
    { const GGS_basic_type _var_69972 = var_cas_interruptSources ; // CAST instruction
      if (_var_69972.getPtr () != NULL) {
        macroValidPointer (_var_69972.getPtr ()) ;
        if (typeid (cPtr_interrupts) == typeid (* (_var_69972.getPtr ()))) {
          const GGS_interrupts var_cas_interrupts (_var_69972.getPtr ()) ;
          ...
          {
            GGS_ident_map::cEnumerator enumerator_69549 (var_cas_interrupts.reader_it_sources (inLexique COMMA_SOURCE_FILE_AT_LINE (1733)), true) ;
            const GGS_ident_map::cElement * operand_69549 = NULL ;
            while (((operand_69549 = enumerator_69549.nextObject ()))) {
              macroValidPointer (operand_69549) ;
              ...
              ::routine_addLStringFieldValue (inLexique,  var_cas_fieldMap,  GGS_string ("NAME"),  operand_69549->mKey COMMA_SOURCE_FILE_AT_LINE (1735)) ;
              ::routine_addUnsignedFieldValue (inLexique,  var_cas_fieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NUMBER"), operand_69549->mInfo.value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1736)) COMMA_SOURCE_FILE_AT_LINE (1736)),  function_uint64OrError (inLexique, operand_69549->mInfo.value, GGS_string ("interrupt source number") COMMA_SOURCE_FILE_AT_LINE (1736)) COMMA_SOURCE_FILE_AT_LINE (1736)) ;
...
void routine_setEnvData (C_Compiler & inLexique,
  ...
  const GGS_bool cond_72334 = (function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1784)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1784)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1784))).operator_not () ;
  if (cond_72334.isBuiltAndTrue ()) {
  ...
  { const GGS_trace _var_72454 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1791)).reader_trace (inLexique COMMA_SOURCE_FILE_AT_LINE (1791)) ; // CAST instruction
    if (_var_72454.getPtr () != NULL) {
      macroValidPointer (_var_72454.getPtr ()) ;
      if (typeid (cPtr_trace_on) == typeid (* (_var_72454.getPtr ()))) {
  ...
  const GGS_bool cond_73104 = function_useCommunication (inLexique, var_cas_cpu COMMA_SOURCE_FILE_AT_LINE (1795)) ;
  if (cond_73104.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_74381 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_74381.isBuiltAndTrue ()) {
    ...
    GGS_uint64  var_cas_sc ;
    GGS_bool automatic_var_73706_0 ;
    GGS_bool automatic_var_73706_1 ;
    ::routine_scalabilityClass (inLexique,  var_cas_cpu,  var_cas_sc,  automatic_var_73706_0,  automatic_var_73706_1 COMMA_SOURCE_FILE_AT_LINE (1815)) ;
    const GGS_bool cond_73899 = ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) ;
    if (cond_73899.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_74371 = (function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1820)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1820)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1820))).operator_not () ;
    if (cond_74371.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_74359 = ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) ;
      if (cond_74359.isBuiltAndTrue ()) {
