...
void routine_setEnvData (C_Compiler & inLexique,
  ...
  const GGS_bool cond_71532 = (function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1755)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1755)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1755))).operator_not () ;
  if (cond_71532.isBuiltAndTrue ()) {
  ...
  { const GGS_trace _var_71652 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1762)).reader_trace (inLexique COMMA_SOURCE_FILE_AT_LINE (1762)) ; // CAST instruction
    if (_var_71652.getPtr () != NULL) {
      macroValidPointer (_var_71652.getPtr ()) ;
      if (typeid (cPtr_trace_on) == typeid (* (_var_71652.getPtr ()))) {
  ...
  const GGS_bool cond_72302 = function_useCommunication (inLexique, var_cas_cpu COMMA_SOURCE_FILE_AT_LINE (1766)) ;
  if (cond_72302.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_73579 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_73579.isBuiltAndTrue ()) {
    ...
    GGS_uint64  var_cas_sc ;
    GGS_bool automatic_var_72904_0 ;
    GGS_bool automatic_var_72904_1 ;
    ::routine_scalabilityClass (inLexique,  var_cas_cpu,  var_cas_sc,  automatic_var_72904_0,  automatic_var_72904_1 COMMA_SOURCE_FILE_AT_LINE (1786)) ;
    const GGS_bool cond_73097 = ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) ;
    if (cond_73097.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_73569 = (function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1791)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1791)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1791))).operator_not () ;
    if (cond_73569.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_73557 = ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) ;
      if (cond_73557.isBuiltAndTrue ()) {
