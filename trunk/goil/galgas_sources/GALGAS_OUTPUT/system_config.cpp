...
void routine_setUseCom (C_Compiler & inLexique,
  ...
  GGS_com  var_cas_comObject = var_cas_cpu.reader_com (inLexique COMMA_SOURCE_FILE_AT_LINE (1490)) ;
  const GGS_bool cond_60046 = var_cas_comObject.reader_usecom (inLexique COMMA_SOURCE_FILE_AT_LINE (1491)) ;
  if (cond_60046.isBuiltAndTrue ()) {
    var_cas_useCom = GGS_bool (true) ;
  }else if (cond_60046.isBuiltAndFalse ()) {
    var_cas_useCom = ((var_cas_cpu.reader_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (1494)).reader_count ()).operator_strictSup (GGS_uint (0U))).operator_or ((var_cas_cpu.reader_net_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (1495)).reader_count ()).operator_strictSup (GGS_uint (0U))) ;
  }
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOM"), GGS_location (inLexique) COMMA_HERE),  var_cas_useCom COMMA_SOURCE_FILE_AT_LINE (1497)) ;
  const GGS_bool cond_61416 = var_cas_useCom ;
  if (cond_61416.isBuiltAndTrue ()) {
    GGS_uint64  var_cas_timeBaseInNanoseconds = GGS_uint64 (1000000ULL) ;
    { const GGS_basic_type _var_60438 = var_cas_comObject.reader_timebase (inLexique COMMA_SOURCE_FILE_AT_LINE (1501)) ; // CAST instruction
      if (_var_60438.getPtr () != NULL) {
        macroValidPointer (_var_60438.getPtr ()) ;
        if (typeid (cPtr_float_class) == typeid (* (_var_60438.getPtr ()))) {
          const GGS_float_class var_cas_timeBase (_var_60438.getPtr ()) ;
          var_cas_timeBaseInNanoseconds = var_cas_timeBase.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (1503)).multiply_operation (inLexique, GGS_double (1.000000e+09) COMMA_SOURCE_FILE_AT_LINE (1503)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (1503)) ;
        }else{
        }
      }
    }
    ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("COMTIMEBASE"), var_cas_comObject.reader_timebase (inLexique COMMA_SOURCE_FILE_AT_LINE (1506)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1506)) COMMA_HERE),  var_cas_timeBaseInNanoseconds COMMA_SOURCE_FILE_AT_LINE (1506)) ;
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOMERRORHOOK"), var_cas_comObject.reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1507)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1507)) COMMA_HERE),  function_getBool (inLexique, var_cas_comObject.reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1507)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1507)) COMMA_SOURCE_FILE_AT_LINE (1507)) ;
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOMGETSERVICEID"), var_cas_comObject.reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1508)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1508)) COMMA_HERE),  function_getBool (inLexique, var_cas_comObject.reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1508)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1508)) COMMA_SOURCE_FILE_AT_LINE (1508)) ;
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOMPARAMETERACCESS"), var_cas_comObject.reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1509)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1509)) COMMA_HERE),  function_getBool (inLexique, var_cas_comObject.reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1509)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1509)) COMMA_SOURCE_FILE_AT_LINE (1509)) ;
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESTARTCOMEXTENSION"), var_cas_comObject.reader_startcomextension (inLexique COMMA_SOURCE_FILE_AT_LINE (1510)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1510)) COMMA_HERE),  function_getBool (inLexique, var_cas_comObject.reader_startcomextension (inLexique COMMA_SOURCE_FILE_AT_LINE (1510)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1510)) COMMA_SOURCE_FILE_AT_LINE (1510)) ;
    GGS_lstring  var_cas_comStatus = var_cas_comObject.reader_status (inLexique COMMA_SOURCE_FILE_AT_LINE (1512)) ;
    GGS_bool var_cas_comExtended = GGS_bool (false) ;
    const GGS_bool cond_61315 = (var_cas_comStatus.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1514))).operator_isEqual (GGS_string ("extended")) ;
    if (cond_61315.isBuiltAndTrue ()) {
      var_cas_comExtended = GGS_bool (true) ;
    }
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("COMEXTENDED"), var_cas_comStatus.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1517)) COMMA_HERE),  var_cas_comExtended COMMA_SOURCE_FILE_AT_LINE (1517)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setExtended (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_extended = (var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1526)).reader_status (inLexique COMMA_SOURCE_FILE_AT_LINE (1526)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1526))).operator_isEqual (GGS_string ("extended")) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("EXTENDED"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1527)).reader_status (inLexique COMMA_SOURCE_FILE_AT_LINE (1527)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1527)) COMMA_HERE),  var_cas_extended COMMA_SOURCE_FILE_AT_LINE (1527)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setScalabilityClass (C_Compiler & inLexique,
  ...
  #endif
  GGS_uint64  var_cas_sc = GGS_uint64 (0ULL) ;
  ...
  const GGS_bool cond_65015 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_65015.isBuiltAndTrue ()) {
    {
      GGS_task_map::cEnumerator enumerator_62101 (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (1541)), true) ;
      const GGS_task_map::cElement * operand_62101 = NULL ;
      while (((operand_62101 = enumerator_62101.nextObject ()))) {
        macroValidPointer (operand_62101) ;
        { const GGS_timing_prot _var_62224 = operand_62101->mInfo.task.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (1542)) ; // CAST instruction
          if (_var_62224.getPtr () != NULL) {
            macroValidPointer (_var_62224.getPtr ()) ;
            if (typeid (cPtr_timing_prot_task) == typeid (* (_var_62224.getPtr ()))) {
    ...
    {
      GGS_isr_map::cEnumerator enumerator_62268 (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1547)), true) ;
      const GGS_isr_map::cElement * operand_62268 = NULL ;
      while (((operand_62268 = enumerator_62268.nextObject ()))) {
        macroValidPointer (operand_62268) ;
        { const GGS_timing_prot _var_62388 = operand_62268->mInfo.isr.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (1548)) ; // CAST instruction
          if (_var_62388.getPtr () != NULL) {
            macroValidPointer (_var_62388.getPtr ()) ;
            if (typeid (cPtr_timing_prot_isr) == typeid (* (_var_62388.getPtr ()))) {
              var_cas_useTimingProtection = GGS_bool (true) ;
            }else{
            }
          }
    ...
    var_cas_useOSApplication = (var_cas_cpu.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (1553)).reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    { const GGS_basic_type _var_62591 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1555)).reader_protectionhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1555)) ; // CAST instruction
      if (_var_62591.getPtr () != NULL) {
        macroValidPointer (_var_62591.getPtr ()) ;
        if (typeid (cPtr_bool_class) == typeid (* (_var_62591.getPtr ()))) {
          const GGS_bool_class var_cas_ph (_var_62591.getPtr ()) ;
          var_cas_useProtectionHook = var_cas_ph.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (1557)) ;
        }else{
        }
      }
    }
    var_cas_sc = GGS_uint64 (1ULL) ;
    GGS_string var_cas_setSC = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1561)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1561)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1561)) ;
    const GGS_bool cond_63236 = ((var_cas_setSC).operator_isEqual (GGS_string (""))).operator_or ((var_cas_setSC).operator_isEqual (GGS_string ("AUTO"))) ;
    if (cond_63236.isBuiltAndTrue ()) {
      const GGS_bool cond_62946 = (var_cas_useTimingProtection).operator_or (var_cas_useProtectionHook) ;
      if (cond_62946.isBuiltAndTrue ()) {
        var_cas_sc = GGS_uint64 (2ULL) ;
      }
      const GGS_bool cond_63216 = (function_memory_protection_on (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1574)) COMMA_SOURCE_FILE_AT_LINE (1574))).operator_or ((var_cas_cpu.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (1574)).reader_count ()).operator_strictSup (GGS_uint (0U))) ;
      if (cond_63216.isBuiltAndTrue ()) {
        var_cas_sc = var_cas_sc.add_operation (inLexique, GGS_uint64 (2ULL) COMMA_SOURCE_FILE_AT_LINE (1575)) ;
      }
    }else if (cond_63236.isBuiltAndFalse ()) {
      const GGS_bool cond_64036 = (var_cas_setSC).operator_isEqual (GGS_string ("sc1")) ;
      if (cond_64036.isBuiltAndTrue ()) {
        const GGS_bool cond_63787 = var_cas_useTimingProtection ;
        if (cond_63787.isBuiltAndTrue ()) {
          const GGS_bool cond_63622 = var_cas_useOSApplication ;
          if (cond_63622.isBuiltAndTrue ()) {
            var_cas_sc = GGS_uint64 (4ULL) ;
            var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1585)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1585)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 4 because Timing Protection and OS Application are used") COMMA_SOURCE_FILE_AT_LINE (1585)) ;
          }else if (cond_63622.isBuiltAndFalse ()) {
            var_cas_sc = GGS_uint64 (2ULL) ;
            var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1588)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1588)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 2 because Timing Protection is used") COMMA_SOURCE_FILE_AT_LINE (1588)) ;
          }
        }else if (cond_63787.isBuiltAndFalse ()) {
          const GGS_bool cond_63968 = var_cas_useOSApplication ;
          if (cond_63968.isBuiltAndTrue ()) {
            var_cas_sc = GGS_uint64 (3ULL) ;
            var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1593)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1593)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 3 because OS Application is used") COMMA_SOURCE_FILE_AT_LINE (1593)) ;
          }else if (cond_63968.isBuiltAndFalse ()) {
            var_cas_sc = GGS_uint64 (1ULL) ;
          }
        }
      }else if (cond_64036.isBuiltAndFalse ()) {
        const GGS_bool cond_64598 = (var_cas_setSC).operator_isEqual (GGS_string ("sc2")) ;
        if (cond_64598.isBuiltAndTrue ()) {
          const GGS_bool cond_64349 = var_cas_useTimingProtection ;
          if (cond_64349.isBuiltAndTrue ()) {
            const GGS_bool cond_64296 = var_cas_useOSApplication ;
            if (cond_64296.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (4ULL) ;
              var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1602)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1602)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 4 because Timing Protection and OS Application are used") COMMA_SOURCE_FILE_AT_LINE (1602)) ;
            }else if (cond_64296.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (2ULL) ;
            }
          }else if (cond_64349.isBuiltAndFalse ()) {
            const GGS_bool cond_64530 = var_cas_useOSApplication ;
            if (cond_64530.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (3ULL) ;
              var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1609)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1609)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 3 because OS Application is used") COMMA_SOURCE_FILE_AT_LINE (1609)) ;
            }else if (cond_64530.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (2ULL) ;
            }
          }
        }else if (cond_64598.isBuiltAndFalse ()) {
          const GGS_bool cond_64959 = (var_cas_setSC).operator_isEqual (GGS_string ("sc3")) ;
          if (cond_64959.isBuiltAndTrue ()) {
            const GGS_bool cond_64911 = var_cas_useTimingProtection ;
            if (cond_64911.isBuiltAndTrue ()) {
              const GGS_bool cond_64858 = var_cas_useOSApplication ;
              if (cond_64858.isBuiltAndTrue ()) {
                var_cas_sc = GGS_uint64 (4ULL) ;
              ...
              }else if (cond_64858.isBuiltAndFalse ()) {
                var_cas_sc = GGS_uint64 (3ULL) ;
              }
            }else if (cond_64911.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (3ULL) ;
            }
          }else if (cond_64959.isBuiltAndFalse ()) {
            const GGS_bool cond_64993 = (var_cas_setSC).operator_isEqual (GGS_string ("sc4")) ;
            if (cond_64993.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (4ULL) ;
            }
          }
        }
  ...
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("SCALABILITYCLASS") COMMA_SOURCE_FILE_AT_LINE (1628)),  var_cas_sc COMMA_SOURCE_FILE_AT_LINE (1628)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USETIMINGPROTECTION") COMMA_SOURCE_FILE_AT_LINE (1629)),  var_cas_useTimingProtection COMMA_SOURCE_FILE_AT_LINE (1629)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEPROTECTIONHOOK") COMMA_SOURCE_FILE_AT_LINE (1630)),  var_cas_useProtectionHook COMMA_SOURCE_FILE_AT_LINE (1630)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEMEMORYPROTECTION") COMMA_SOURCE_FILE_AT_LINE (1631)),  function_memory_protection_on (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1631)) COMMA_SOURCE_FILE_AT_LINE (1631)) COMMA_SOURCE_FILE_AT_LINE (1631)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEOSAPPLICATION") COMMA_SOURCE_FILE_AT_LINE (1632)),  ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) COMMA_SOURCE_FILE_AT_LINE (1632)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setUseHooks (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESTARTUPHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1639)).reader_startuphook (inLexique COMMA_SOURCE_FILE_AT_LINE (1639)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1639)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1639)).reader_startuphook (inLexique COMMA_SOURCE_FILE_AT_LINE (1639)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1639)) COMMA_SOURCE_FILE_AT_LINE (1639)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESHUTDOWNHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1640)).reader_shutdownhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1640)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1640)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1640)).reader_shutdownhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1640)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1640)) COMMA_SOURCE_FILE_AT_LINE (1640)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEERRORHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1641)).reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1641)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1641)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1641)).reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1641)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1641)) COMMA_SOURCE_FILE_AT_LINE (1641)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPRETASKHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1642)).reader_pretaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1642)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1642)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1642)).reader_pretaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1642)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1642)) COMMA_SOURCE_FILE_AT_LINE (1642)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPOSTTASKHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1643)).reader_posttaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1643)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1643)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1643)).reader_posttaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1643)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1643)) COMMA_SOURCE_FILE_AT_LINE (1643)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEGETSERVICEID"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1644)).reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1644)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1644)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1644)).reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1644)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1644)) COMMA_SOURCE_FILE_AT_LINE (1644)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPARAMETERACCESS"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1645)).reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1645)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1645)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1645)).reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1645)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1645)) COMMA_SOURCE_FILE_AT_LINE (1645)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USERESSCHEDULER"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1646)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1646)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1646)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1646)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1646)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1646)) COMMA_SOURCE_FILE_AT_LINE (1646)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESTACKMONITORING"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1647)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1647)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1647)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1647)).reader_stackmonitoring (inLexique COMMA_SOURCE_FILE_AT_LINE (1647)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1647)) COMMA_SOURCE_FILE_AT_LINE (1647)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setOsConfig (C_Compiler & inLexique,
  ...
  #endif
  ::routine_setExtended (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1651)) ;
  ::routine_setUseCom (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1652)) ;
  ::routine_setScalabilityClass (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1653)) ;
  ::routine_setUseHooks (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1654)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setInterruptSources (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_67941 = var_cas_targetConfiguration.reader_hasKey (GGS_string ("it_sources")) ;
  if (cond_67941.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_interruptSources ;
    const GGS_config  temp_67238 = var_cas_targetConfiguration ;
    if (temp_67238.isBuilt ()) {
      temp_67238 (HERE)->method_get (inLexique, function_lstringWith (inLexique, GGS_string ("it_sources") COMMA_SOURCE_FILE_AT_LINE (1663)), var_cas_interruptSources COMMA_SOURCE_FILE_AT_LINE (1663)) ;
    }
    { const GGS_basic_type _var_67929 = var_cas_interruptSources ; // CAST instruction
      if (_var_67929.getPtr () != NULL) {
        macroValidPointer (_var_67929.getPtr ()) ;
        if (typeid (cPtr_interrupts) == typeid (* (_var_67929.getPtr ()))) {
          const GGS_interrupts var_cas_interrupts (_var_67929.getPtr ()) ;
          ::routine_addLUnsignedValue (inLexique,  var_cas_cfg,  GGS_string ("ITSOURCESLENGTH"),  var_cas_interrupts.reader_it_count (inLexique COMMA_SOURCE_FILE_AT_LINE (1666)) COMMA_SOURCE_FILE_AT_LINE (1666)) ;
          GGS_goilTemplateFieldMapList  var_cas_interruptSourcesList = GGS_goilTemplateFieldMapList ::constructor_emptyList () ;
          {
            GGS_ident_map::cEnumerator enumerator_67506 (var_cas_interrupts.reader_it_sources (inLexique COMMA_SOURCE_FILE_AT_LINE (1668)), true) ;
            const GGS_ident_map::cElement * operand_67506 = NULL ;
            while (((operand_67506 = enumerator_67506.nextObject ()))) {
              macroValidPointer (operand_67506) ;
              GGS_goilTemplateFieldMap  var_cas_fieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
              ::routine_addLStringFieldValue (inLexique,  var_cas_fieldMap,  GGS_string ("NAME"),  operand_67506->mKey COMMA_SOURCE_FILE_AT_LINE (1670)) ;
              ::routine_addUnsignedFieldValue (inLexique,  var_cas_fieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NUMBER"), operand_67506->mInfo.value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1671)) COMMA_HERE),  function_uint64OrError (inLexique, operand_67506->mInfo.value, GGS_string ("interrupt source number") COMMA_SOURCE_FILE_AT_LINE (1671)) COMMA_SOURCE_FILE_AT_LINE (1671)) ;
              var_cas_interruptSourcesList.addAssign_operation (var_cas_fieldMap) ;
            }
          }
          ::routine_addListValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("INTERRUPTSOURCES") COMMA_SOURCE_FILE_AT_LINE (1674)),  var_cas_interruptSourcesList COMMA_SOURCE_FILE_AT_LINE (1674)) ;
        }else{
        }
      }
    }
...
void routine_setEnvData (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("OILFILENAME") COMMA_SOURCE_FILE_AT_LINE (1683)),  GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_lastPathComponent () COMMA_SOURCE_FILE_AT_LINE (1683)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("CPUNAME"), GGS_location (inLexique) COMMA_HERE),  var_cas_cpu.reader_name (inLexique COMMA_SOURCE_FILE_AT_LINE (1684)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1684)) COMMA_SOURCE_FILE_AT_LINE (1684)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TIMESTAMP"), GGS_location (inLexique) COMMA_HERE),  GGS_string::constructor_stringWithCurrentDateTime (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1685)) ;
  GGS_lstring  var_cas_appName = function_applicationName (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1686)) COMMA_SOURCE_FILE_AT_LINE (1686)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("APPNAME"), var_cas_appName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1687)) COMMA_HERE),  var_cas_appName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1687)) COMMA_SOURCE_FILE_AT_LINE (1687)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("PROJECT") COMMA_SOURCE_FILE_AT_LINE (1688)),  function_projectName (inLexique COMMA_SOURCE_FILE_AT_LINE (1688)).reader_lastPathComponent () COMMA_SOURCE_FILE_AT_LINE (1688)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("PROJECTPATH") COMMA_SOURCE_FILE_AT_LINE (1689)),  function_projectName (inLexique COMMA_SOURCE_FILE_AT_LINE (1689)) COMMA_SOURCE_FILE_AT_LINE (1689)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEBUILDFILE") COMMA_SOURCE_FILE_AT_LINE (1690)),  gOption_goil_5F_options_generate_5F_makefile.reader_value () COMMA_SOURCE_FILE_AT_LINE (1690)) ;
  #ifdef DEBUG_TRACE_ENABLED
