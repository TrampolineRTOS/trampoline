...
GGS_bool function_useCommunication (C_Compiler & inLexique,
  ...
  const GGS_bool cond_60706 = var_cas_comObject.reader_usecom (inLexique COMMA_SOURCE_FILE_AT_LINE (1506)) ;
  if (cond_60706.isBuiltAndTrue ()) {
    var_cas_useCom = GGS_bool (true) ;
  }else if (cond_60706.isBuiltAndFalse ()) {
...
void routine_setUseCom (C_Compiler & inLexique,
  ...
  const GGS_bool cond_62396 = var_cas_useCom ;
  if (cond_62396.isBuiltAndTrue ()) {
    ...
    { const GGS_basic_type _var_61418 = var_cas_comObject.reader_timebase (inLexique COMMA_SOURCE_FILE_AT_LINE (1525)) ; // CAST instruction
      if (_var_61418.getPtr () != NULL) {
        macroValidPointer (_var_61418.getPtr ()) ;
        if (typeid (cPtr_float_class) == typeid (* (_var_61418.getPtr ()))) {
          const GGS_float_class var_cas_timeBase (_var_61418.getPtr ()) ;
    ...
    const GGS_bool cond_62295 = (var_cas_comStatus.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1538))).operator_isEqual (GGS_string ("extended")) ;
    if (cond_62295.isBuiltAndTrue ()) {
...
void routine_scalabilityClass (C_Compiler & inLexique,
  ...
  const GGS_bool cond_65913 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_65913.isBuiltAndTrue ()) {
    {
      GGS_task_map::cEnumerator enumerator_62999 (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (1566)), true) ;
      const GGS_task_map::cElement * operand_62999 = NULL ;
      while (((operand_62999 = enumerator_62999.nextObject ()))) {
        macroValidPointer (operand_62999) ;
        { const GGS_timing_prot _var_63122 = operand_62999->mInfo.task.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (1567)) ; // CAST instruction
          if (_var_63122.getPtr () != NULL) {
            macroValidPointer (_var_63122.getPtr ()) ;
            if (typeid (cPtr_timing_prot_task) == typeid (* (_var_63122.getPtr ()))) {
    ...
    {
      GGS_isr_map::cEnumerator enumerator_63166 (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1572)), true) ;
      const GGS_isr_map::cElement * operand_63166 = NULL ;
      while (((operand_63166 = enumerator_63166.nextObject ()))) {
        macroValidPointer (operand_63166) ;
        { const GGS_timing_prot _var_63286 = operand_63166->mInfo.isr.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (1573)) ; // CAST instruction
          if (_var_63286.getPtr () != NULL) {
            macroValidPointer (_var_63286.getPtr ()) ;
            if (typeid (cPtr_timing_prot_isr) == typeid (* (_var_63286.getPtr ()))) {
              var_cas_useTimingProtection = GGS_bool (true) ;
            }else{
            }
          }
    ...
    { const GGS_basic_type _var_63489 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1580)).reader_protectionhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1580)) ; // CAST instruction
      if (_var_63489.getPtr () != NULL) {
        macroValidPointer (_var_63489.getPtr ()) ;
        if (typeid (cPtr_bool_class) == typeid (* (_var_63489.getPtr ()))) {
          const GGS_bool_class var_cas_ph (_var_63489.getPtr ()) ;
    ...
    const GGS_bool cond_64134 = ((var_cas_setSC).operator_isEqual (GGS_string (""))).operator_or ((var_cas_setSC).operator_isEqual (GGS_string ("AUTO"))) ;
    if (cond_64134.isBuiltAndTrue ()) {
      const GGS_bool cond_63844 = (var_cas_useTimingProtection).operator_or (var_cas_useProtectionHook) ;
      if (cond_63844.isBuiltAndTrue ()) {
        var_cas_sc = GGS_uint64 (2ULL) ;
      }
      const GGS_bool cond_64114 = (function_memory_protection_on (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1599)) COMMA_SOURCE_FILE_AT_LINE (1599))).operator_or ((var_cas_cpu.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (1599)).reader_count ()).operator_strictSup (GGS_uint (0U))) ;
      if (cond_64114.isBuiltAndTrue ()) {
        var_cas_sc = var_cas_sc.add_operation (inLexique, GGS_uint64 (2ULL) COMMA_SOURCE_FILE_AT_LINE (1600)) ;
      }
    }else if (cond_64134.isBuiltAndFalse ()) {
      const GGS_bool cond_64934 = (var_cas_setSC).operator_isEqual (GGS_string ("sc1")) ;
      if (cond_64934.isBuiltAndTrue ()) {
        const GGS_bool cond_64685 = var_cas_useTimingProtection ;
        if (cond_64685.isBuiltAndTrue ()) {
          const GGS_bool cond_64520 = var_cas_useOSApplication ;
          if (cond_64520.isBuiltAndTrue ()) {
          ...
          }else if (cond_64520.isBuiltAndFalse ()) {
            var_cas_sc = GGS_uint64 (2ULL) ;
        ...
        }else if (cond_64685.isBuiltAndFalse ()) {
          const GGS_bool cond_64866 = var_cas_useOSApplication ;
          if (cond_64866.isBuiltAndTrue ()) {
          ...
          }else if (cond_64866.isBuiltAndFalse ()) {
            var_cas_sc = GGS_uint64 (1ULL) ;
          }
        }
      }else if (cond_64934.isBuiltAndFalse ()) {
        const GGS_bool cond_65496 = (var_cas_setSC).operator_isEqual (GGS_string ("sc2")) ;
        if (cond_65496.isBuiltAndTrue ()) {
          const GGS_bool cond_65247 = var_cas_useTimingProtection ;
          if (cond_65247.isBuiltAndTrue ()) {
            const GGS_bool cond_65194 = var_cas_useOSApplication ;
            if (cond_65194.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (4ULL) ;
            ...
            }else if (cond_65194.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (2ULL) ;
            }
          }else if (cond_65247.isBuiltAndFalse ()) {
            const GGS_bool cond_65428 = var_cas_useOSApplication ;
            if (cond_65428.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (3ULL) ;
            ...
            }else if (cond_65428.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (2ULL) ;
            }
          }
        }else if (cond_65496.isBuiltAndFalse ()) {
          const GGS_bool cond_65857 = (var_cas_setSC).operator_isEqual (GGS_string ("sc3")) ;
          if (cond_65857.isBuiltAndTrue ()) {
            const GGS_bool cond_65809 = var_cas_useTimingProtection ;
            if (cond_65809.isBuiltAndTrue ()) {
              const GGS_bool cond_65756 = var_cas_useOSApplication ;
              if (cond_65756.isBuiltAndTrue ()) {
                var_cas_sc = GGS_uint64 (4ULL) ;
              ...
              }else if (cond_65756.isBuiltAndFalse ()) {
                var_cas_sc = GGS_uint64 (3ULL) ;
              }
            }else if (cond_65809.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (3ULL) ;
            }
          }else if (cond_65857.isBuiltAndFalse ()) {
            const GGS_bool cond_65891 = (var_cas_setSC).operator_isEqual (GGS_string ("sc4")) ;
            if (cond_65891.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (4ULL) ;
            }
          }
        }
...
void routine_setInterruptSources (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_69169 = var_cas_targetConfiguration.reader_hasKey (GGS_string ("it_sources")) ;
  if (cond_69169.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_interruptSources ;
    const GGS_config  temp_68466 = var_cas_targetConfiguration ;
    if (temp_68466.isBuilt ()) {
      temp_68466 (HERE)->method_get (inLexique, function_lstringWith (inLexique, GGS_string ("it_sources") COMMA_SOURCE_FILE_AT_LINE (1699)), var_cas_interruptSources COMMA_SOURCE_FILE_AT_LINE (1699)) ;
    }
    { const GGS_basic_type _var_69157 = var_cas_interruptSources ; // CAST instruction
      if (_var_69157.getPtr () != NULL) {
        macroValidPointer (_var_69157.getPtr ()) ;
        if (typeid (cPtr_interrupts) == typeid (* (_var_69157.getPtr ()))) {
          const GGS_interrupts var_cas_interrupts (_var_69157.getPtr ()) ;
          ...
          {
            GGS_ident_map::cEnumerator enumerator_68734 (var_cas_interrupts.reader_it_sources (inLexique COMMA_SOURCE_FILE_AT_LINE (1704)), true) ;
            const GGS_ident_map::cElement * operand_68734 = NULL ;
            while (((operand_68734 = enumerator_68734.nextObject ()))) {
              macroValidPointer (operand_68734) ;
              GGS_goilTemplateFieldMap  var_cas_fieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
              ::routine_addLStringFieldValue (inLexique,  var_cas_fieldMap,  GGS_string ("NAME"),  operand_68734->mKey COMMA_SOURCE_FILE_AT_LINE (1706)) ;
              ::routine_addUnsignedFieldValue (inLexique,  var_cas_fieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NUMBER"), operand_68734->mInfo.value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1707)) COMMA_HERE),  function_uint64OrError (inLexique, operand_68734->mInfo.value, GGS_string ("interrupt source number") COMMA_SOURCE_FILE_AT_LINE (1707)) COMMA_SOURCE_FILE_AT_LINE (1707)) ;
...
void routine_setEnvData (C_Compiler & inLexique,
  ...
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USELOGFILE") COMMA_SOURCE_FILE_AT_LINE (1739)),  gOption_goil_5F_options_generate_5F_log.reader_value () COMMA_SOURCE_FILE_AT_LINE (1739)) ;
  ...
  const GGS_bool cond_71519 = (function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1755)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1755)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1755))).operator_not () ;
  if (cond_71519.isBuiltAndTrue ()) {
  ...
  { const GGS_trace _var_71639 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1762)).reader_trace (inLexique COMMA_SOURCE_FILE_AT_LINE (1762)) ; // CAST instruction
    if (_var_71639.getPtr () != NULL) {
      macroValidPointer (_var_71639.getPtr ()) ;
      if (typeid (cPtr_trace_on) == typeid (* (_var_71639.getPtr ()))) {
  ...
  const GGS_bool cond_72289 = function_useCommunication (inLexique, var_cas_cpu COMMA_SOURCE_FILE_AT_LINE (1766)) ;
  if (cond_72289.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_73566 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_73566.isBuiltAndTrue ()) {
    ...
    GGS_uint64  var_cas_sc ;
    GGS_bool automatic_var_72891_0 ;
    GGS_bool automatic_var_72891_1 ;
    ::routine_scalabilityClass (inLexique,  var_cas_cpu,  var_cas_sc,  automatic_var_72891_0,  automatic_var_72891_1 COMMA_SOURCE_FILE_AT_LINE (1786)) ;
    const GGS_bool cond_73084 = ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) ;
    ...
    const GGS_bool cond_73556 = (function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1791)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1791)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1791))).operator_not () ;
    if (cond_73556.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_73544 = ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) ;
      if (cond_73544.isBuiltAndTrue ()) {
