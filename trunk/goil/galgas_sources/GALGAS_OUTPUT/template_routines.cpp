...
GGS_string function_goil_template (C_Compiler & inLexique,
  ...
  GGS_bool automatic_var_381_0 ;
  ::routine_goilTemplateInvocation (inLexique,  GGS_lstring ::constructor_new (inLexique, var_cas_name, GGS_location (inLexique) COMMA_HERE),  var_cas_prefix,  GGS_string ("templates"),  function_rootTemplatesDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (15)),  GGS_bool (true),  var_cas_cfg,  var_cas_result,  automatic_var_381_0 COMMA_SOURCE_FILE_AT_LINE (11)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_string function_computeTemplate (C_Compiler & inLexique,
  ...
  GGS_string var_cas_result ;
  var_cas_result = GGS_string ("") ;
  GGS_bool automatic_var_683_0 ;
  ::routine_goilTemplateInvocation (inLexique,  GGS_lstring ::constructor_new (inLexique, var_cas_name, GGS_location (inLexique) COMMA_HERE),  var_cas_prefix,  GGS_string ("templates"),  function_rootTemplatesDirectory (inLexique COMMA_SOURCE_FILE_AT_LINE (33)),  GGS_bool (true),  var_cas_cfg,  var_cas_result,  automatic_var_683_0 COMMA_SOURCE_FILE_AT_LINE (29)) ;
  #ifdef DEBUG_TRACE_ENABLED
