...
void routine_verify_and_set_tasks_defaults (C_Compiler & inLexique,
  ...
  var_cas_tp = var_cas_tasks ;
  {
    ...
    while (((operand_2047 = enumerator_2047.nextObject ()))) {
      ...
      GGS_ident_map  var_cas_others ;
      var_cas_others = operand_2047->mInfo.task.reader_others (inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
      {
        ...
        while (((operand_2178 = enumerator_2178.nextObject ()))) {
          ...
          if (((operand_2178->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (85))).operator_isEqual (GGS_string ("PRIORITY"))).isBuiltAndTrue ()) {
          ...
          }else if (((operand_2178->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (87))).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          }else if (((operand_2178->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (88))).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          }else if (((operand_2178->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (89))).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          }else if (((operand_2178->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (90))).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          }else if (((operand_2178->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (91))).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          }else if (((operand_2178->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (92))).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          }else{
...
void routine_verify_and_set_isrs_defaults (C_Compiler & inLexique,
  ...
  var_cas_ip = var_cas_isrs ;
  {
    ...
    while (((operand_3393 = enumerator_3393.nextObject ()))) {
      ...
      GGS_ident_map  var_cas_others ;
      var_cas_others = operand_3393->mInfo.isr.reader_other_fields (inLexique COMMA_SOURCE_FILE_AT_LINE (126)) ;
      {
        ...
        while (((operand_3526 = enumerator_3526.nextObject ()))) {
          ...
          if (((operand_3526->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (128))).operator_isEqual (GGS_string ("PRIORITY"))).isBuiltAndTrue ()) {
            inLexique.printMessage (GGS_string ("PRIORITY!\n") COMMA_SOURCE_FILE_AT_LINE (129)) ;
          }else if (((operand_3526->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130))).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          }else if (((operand_3526->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (131))).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          }else if (((operand_3526->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (132))).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          }else if (((operand_3526->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (133))).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          }else if (((operand_3526->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (134))).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          }else if (((operand_3526->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (135))).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
          }else{
      ...
      var_cas_updated_isr = GGS_isr_obj ::constructor_new (inLexique, operand_3393->mInfo.isr.reader_desc (inLexique COMMA_SOURCE_FILE_AT_LINE (141)), operand_3393->mInfo.isr.reader_category (inLexique COMMA_SOURCE_FILE_AT_LINE (142)), operand_3393->mInfo.isr.reader_priority (inLexique COMMA_SOURCE_FILE_AT_LINE (143)), operand_3393->mInfo.isr.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (144)), operand_3393->mInfo.isr.reader_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (145)), operand_3393->mInfo.isr.reader_acc_apps (inLexique COMMA_SOURCE_FILE_AT_LINE (146)), operand_3393->mInfo.isr.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (147)), var_cas_others COMMA_HERE) ;
...
void routine_add_system_counter (C_Compiler & inLexique,
  ...
  var_cas_all_apps = var_cas_cpu.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (166)).reader_keyList (inLexique COMMA_SOURCE_FILE_AT_LINE (166)) ;
  {
    ...
    while (((operand_4676 = enumerator_4676.nextObject ()))) {
      ...
      var_cas_all_apps._addAssign_operation (operand_4676->mKey) ;
    }
  }
