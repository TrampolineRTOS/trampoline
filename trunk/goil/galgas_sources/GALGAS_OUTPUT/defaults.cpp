...
void routine_set_defaults (C_Compiler & inLexique,
  ...
  if ((var_cas_imp.reader_hasKey (inLexique, GGS_string ("task") COMMA_SOURCE_FILE_AT_LINE (226))).isBuiltAndTrue ()) {
    ...
    const GGS_implementation  _temp_6782 = var_cas_imp ;
    if (_temp_6782.isBuilt ()) {
      _temp_6782 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("task"), GGS_location (inLexique) COMMA_HERE), var_cas_spec COMMA_SOURCE_FILE_AT_LINE (229)) ;
    }
  ...
  if ((var_cas_imp.reader_hasKey (inLexique, GGS_string ("isr") COMMA_SOURCE_FILE_AT_LINE (236))).isBuiltAndTrue ()) {
    ...
    GGS_implementation_spec  var_cas_spec ;
    const GGS_implementation  _temp_7076 = var_cas_imp ;
    if (_temp_7076.isBuilt ()) {
      _temp_7076 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("isr"), GGS_location (inLexique) COMMA_HERE), var_cas_spec COMMA_SOURCE_FILE_AT_LINE (239)) ;
    }
