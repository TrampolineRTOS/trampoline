...
class goil_obj_isr {
  ...
  protected : void pr_isr_goil_obj_isr_59_10_ (goil_lexique &,
                                GGS_isr_map  &) ;

  protected : void pr_isr_attributes_goil_obj_isr_105_21_ (goil_lexique &,
                                GGS_basic_type  &,
                                GGS_basic_type  &,
                                GGS_lstringlist  &,
                                GGS_lstringlist  &,
  ...
  protected : virtual PMSInt16 select_repeat_goil_obj_isr_0 (goil_lexique &) = 0 ;

  protected : virtual PMSInt16 select_goil_obj_isr_1 (goil_lexique &) = 0 ;
