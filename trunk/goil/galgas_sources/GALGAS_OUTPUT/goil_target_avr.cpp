...
void routine_generate_isr_avr (C_Compiler & _inLexique,
  ...
  var_cas_result = GGS_string ("") ;
  {
    ...
    while (((operand_1737 = enumerator_1737.nextObject ()))) {
      ...
      ::routine_retrieveTemplateString (_inLexique,  var_cas_tmp,  GGS_string ("isr_list_specific") COMMA_SOURCE_FILE_AT_LINE (70)) ;
      ::routine_doReplace (_inLexique,  var_cas_tmp,  GGS_string ("$EXEC_NAME$"),  operand_1737->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (72)) COMMA_SOURCE_FILE_AT_LINE (72)) ;
      var_cas_result._dotAssign_operation (var_cas_tmp) ;
    }
  }
  ::routine_doReplace (_inLexique,  var_cas_code,  GGS_string ("$ISR_LIST$"),  var_cas_result COMMA_SOURCE_FILE_AT_LINE (75)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generate_counter_avr (C_Compiler & _inLexique,
      ...
      { const GGS_counter_type _var_2544 = operand_2236->mInfo.counter.reader_type (_inLexique COMMA_SOURCE_FILE_AT_LINE (84)) ; // CAST instruction
        if (_var_2544.getPtr () != NULL) {
          ...
          if (typeid (cPtr_software_counter) == typeid (* (_var_2544.getPtr ()))) {
            ...
            GGS_string var_cas_tmp ;
            ::routine_retrieveTemplateString (_inLexique,  var_cas_tmp,  GGS_string ("counter_list_specific") COMMA_SOURCE_FILE_AT_LINE (88)) ;
            ::routine_doReplace (_inLexique,  var_cas_tmp,  GGS_string ("$COUNTER$"),  (operand_2236->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (89)))._operator_concat (GGS_string ("_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (89)) ;
            var_cas_result._dotAssign_operation (var_cas_tmp) ;
          }
        }
      }
  ...
  ::routine_doReplace (_inLexique,  var_cas_code,  GGS_string ("$COUNTER_LIST$"),  var_cas_result COMMA_SOURCE_FILE_AT_LINE (94)) ;
  #ifdef DEBUG_TRACE_ENABLED
