...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << mEnumeratedValue.reader_description  (inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
...
_insulateList (void) {
  if (_shared ()) {
    ...
    while (ptr != NULL) {
      macroValidPointer (ptr) ;
      _internalAppendValues (ptr->mEnumeratedValue,
                                ptr->mPrefix
                                COMMA_HERE) ;
      ptr = ptr->nextObject () ;
    }
...
reader_description (C_Compiler & inLexique
                    COMMA_LOCATION_ARGS,
                    const PMSInt32 inIndentation) const {
  return _description (inLexique, "@goilTemplateEnumationList", inIndentation COMMA_THERE) ;
}
...
GGS_goilTemplateValue function_valueWithBool (C_Compiler & inLexique,
  ...
  var_cas_outValue = GGS_goilTemplateValue::constructor_new (var_cas_inValue.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (102)), GGS_string (""), GGS_goilTemplateFieldMapList ::constructor_emptyList ()) ;
  #ifdef DEBUG_TRACE_ENABLED
