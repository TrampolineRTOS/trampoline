    ...
    if (_var_3236.getPtr () != NULL) {
      ...
      if (typeid (cPtr_task_obj) == typeid (* (_var_3236.getPtr ()))) {
        ...
        if (_temp_2519.isBuilt ()) {
          _temp_2519 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("task_attrs"), GGS_location (inLexique) COMMA_HERE), var_cas_b_attrs COMMA_SOURCE_FILE_AT_LINE (70)) ;
        }
        ...
        if (_temp_2965.isBuilt ()) {
          _temp_2965 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("isr_attrs"), GGS_location (inLexique) COMMA_HERE), var_cas_b_attrs COMMA_SOURCE_FILE_AT_LINE (80)) ;
        }
