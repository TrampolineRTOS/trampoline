...
void routine_generate_isr_h8300h (C_Compiler & inLexique,
  ...
  var_cas_result = GGS_string ("") ;
  {
    ...
    while (((operand_2031 = enumerator_2031.nextObject ()))) {
      ...
      var_cas_others = operand_2031->mInfo.isr.reader_other_fields (inLexique COMMA_SOURCE_FILE_AT_LINE (74)) ;
      GGS_uint  var_cas_trap ;
      ...
      ::routine_retrieveTemplateString (inLexique,  var_cas_tmp,  GGS_string ("isr_list_specific") COMMA_SOURCE_FILE_AT_LINE (80)) ;
      ::routine_doReplace (inLexique,  var_cas_tmp,  GGS_string ("$EXCEPTION_HANDLER$"),  var_cas_trap.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (82)) COMMA_SOURCE_FILE_AT_LINE (82)) ;
      ::routine_doReplace (inLexique,  var_cas_tmp,  GGS_string ("$EXEC_NAME$"),  operand_2031->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)) ;
      var_cas_result.dotAssign_operation (var_cas_tmp) ;
    }
  }
  ::routine_doReplace (inLexique,  var_cas_code,  GGS_string ("$ISR_LIST$"),  var_cas_result COMMA_SOURCE_FILE_AT_LINE (87)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generate_counter_h8300h (C_Compiler & inLexique,
  ...
  var_cas_result = GGS_string ("") ;
  {
    ...
    while (((operand_2727 = enumerator_2727.nextObject ()))) {
      ...
      { const GGS_counter_type _var_3035 = operand_2727->mInfo.counter.reader_type (inLexique COMMA_SOURCE_FILE_AT_LINE (96)) ; // CAST instruction
        if (_var_3035.getPtr () != NULL) {
          macroValidPointer (_var_3035.getPtr ()) ;
          if (typeid (cPtr_software_counter) == typeid (* (_var_3035.getPtr ()))) {
          }else{
            GGS_string var_cas_tmp ;
            ::routine_retrieveTemplateString (inLexique,  var_cas_tmp,  GGS_string ("counter_list_specific") COMMA_SOURCE_FILE_AT_LINE (100)) ;
            ::routine_doReplace (inLexique,  var_cas_tmp,  GGS_string ("$COUNTER$"),  (operand_2727->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (101))).operator_concat (GGS_string ("_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (101)) ;
            var_cas_result.dotAssign_operation (var_cas_tmp) ;
          }
        }
      }
  ...
  ::routine_doReplace (inLexique,  var_cas_code,  GGS_string ("$COUNTER_LIST$"),  var_cas_result COMMA_SOURCE_FILE_AT_LINE (106)) ;
  #ifdef DEBUG_TRACE_ENABLED
