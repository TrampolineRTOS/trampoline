  ...
  }
  {
    ...
    while (((operand_1642 = enumerator_1642.nextObject ()))) {
      ...
      if (_temp_1699.isBuilt ()) {
        _temp_1699 (HERE)->method_get (inLexique, operand_1642->key, var_cas_isr COMMA_SOURCE_FILE_AT_LINE (54)) ;
      }
      ...
      if ((var_cas_others.reader_hasKey (inLexique, var_cas_key COMMA_SOURCE_FILE_AT_LINE (60))).isBuiltAndTrue ()) {
        ...
        if (_temp_1946.isBuilt ()) {
          _temp_1946 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_key, GGS_location (inLexique) COMMA_HERE), var_cas_value COMMA_SOURCE_FILE_AT_LINE (63)) ;
        }
