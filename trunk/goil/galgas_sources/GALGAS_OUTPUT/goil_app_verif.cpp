...
//                    september 8th, 2009, at 10h44'57"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_apps_well_formed (C_Compiler & inLexique,
  ...
  if (((var_cas_apps.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (75))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    GGS_bool var_cas_right_app ;
    var_cas_right_app = GGS_bool (false) ;
    GGS_bool var_cas_access_app ;
          ...
          while (((operand_6829 = enumerator_6829.nextObject ()))) {
            macroValidPointer (operand_6829) ;
            {
              ...
              while (((operand_6910 = enumerator_6910.nextObject ()))) {
                ...
                if (((operand_6910->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (176))).operator_isEqual (operand_6693->mInfo.alarm.reader_counter_name (inLexique COMMA_SOURCE_FILE_AT_LINE (176)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (176)))).isBuiltAndTrue ()) {
                  {
                    ...
                    while (((operand_7162 = enumerator_7162.nextObject ()))) {
                      ...
                      if (((operand_7162->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (179))).operator_isEqual (operand_6693->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (179)))).isBuiltAndTrue ()) {
                        var_cas_right_app = GGS_bool (true) ;
                      }
                    }
                  }
                  if (((var_cas_right_app).operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
                    {
                      ...
                      while (((operand_7470 = enumerator_7470.nextObject ()))) {
                        ...
                        if (((operand_7470->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (185))).operator_isEqual (operand_6829->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (185)))).isBuiltAndTrue ()) {
                          var_cas_access_app = GGS_bool (true) ;
                        }
                      }
                    }
                    if (((var_cas_access_app).operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
                ...
                while (((operand_8336 = enumerator_8336.nextObject ()))) {
                  macroValidPointer (operand_8336) ;
                  {
                    ...
                    while (((operand_8421 = enumerator_8421.nextObject ()))) {
                      ...
                      if (((operand_8421->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207))).operator_isEqual (var_cas_sea.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (207)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (207)))).isBuiltAndTrue ()) {
                        {
                          ...
                          while (((operand_8668 = enumerator_8668.nextObject ()))) {
                            ...
                            if (((operand_8668->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (210))).operator_isEqual (operand_6693->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (210)))).isBuiltAndTrue ()) {
                              var_cas_right_app = GGS_bool (true) ;
                            }
                          }
                        }
                        if (((var_cas_right_app).operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
                          {
                            ...
                            while (((operand_9000 = enumerator_9000.nextObject ()))) {
                              ...
                              if (((operand_9000->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (216))).operator_isEqual (operand_8336->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (216)))).isBuiltAndTrue ()) {
                                var_cas_access_app = GGS_bool (true) ;
                              }
                            }
                          }
                ...
                while (((operand_9763 = enumerator_9763.nextObject ()))) {
                  macroValidPointer (operand_9763) ;
                  {
                    ...
                    while (((operand_9848 = enumerator_9848.nextObject ()))) {
                      ...
                      if (((operand_9848->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (233))).operator_isEqual (var_cas_ata.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (233)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (233)))).isBuiltAndTrue ()) {
                        {
                          ...
                          while (((operand_10095 = enumerator_10095.nextObject ()))) {
                            ...
                            if (((operand_10095->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (236))).operator_isEqual (operand_6693->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (236)))).isBuiltAndTrue ()) {
                              var_cas_right_app = GGS_bool (true) ;
                            }
                          }
                        }
                        if (((var_cas_right_app).operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
                          {
                            ...
                            while (((operand_10427 = enumerator_10427.nextObject ()))) {
                              ...
                              if (((operand_10427->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (242))).operator_isEqual (operand_9763->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (242)))).isBuiltAndTrue ()) {
                                var_cas_access_app = GGS_bool (true) ;
                              }
                            }
                          }
                ...
                while (((operand_11205 = enumerator_11205.nextObject ()))) {
                  macroValidPointer (operand_11205) ;
                  {
                    ...
                    while (((operand_11290 = enumerator_11290.nextObject ()))) {
                      ...
                      if (((operand_11290->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (259))).operator_isEqual (var_cas_ica.reader_counter_name (inLexique COMMA_SOURCE_FILE_AT_LINE (259)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (259)))).isBuiltAndTrue ()) {
                        {
                          ...
                          while (((operand_11552 = enumerator_11552.nextObject ()))) {
                            ...
                            if (((operand_11552->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (262))).operator_isEqual (operand_6693->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (262)))).isBuiltAndTrue ()) {
                              var_cas_right_app = GGS_bool (true) ;
                            }
                          }
                        }
                        if (((var_cas_right_app).operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
                          {
                            ...
                            while (((operand_11884 = enumerator_11884.nextObject ()))) {
                              ...
                              if (((operand_11884->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (268))).operator_isEqual (operand_11205->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (268)))).isBuiltAndTrue ()) {
                                var_cas_access_app = GGS_bool (true) ;
                              }
                            }
                          }
    ...
    }
    {
      ...
      while (((operand_12629 = enumerator_12629.nextObject ()))) {
          ...
          while (((operand_12773 = enumerator_12773.nextObject ()))) {
            macroValidPointer (operand_12773) ;
            {
              ...
              while (((operand_12854 = enumerator_12854.nextObject ()))) {
                ...
                if (((operand_12854->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (289))).operator_isEqual (operand_12629->mInfo.st.reader_counter (inLexique COMMA_SOURCE_FILE_AT_LINE (289)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (289)))).isBuiltAndTrue ()) {
                  {
                    ...
                    while (((operand_13110 = enumerator_13110.nextObject ()))) {
                      ...
                      if (((operand_13110->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (292))).operator_isEqual (operand_12629->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (292)))).isBuiltAndTrue ()) {
                        var_cas_right_app = GGS_bool (true) ;
                      }
                    }
                  }
                  if (((var_cas_right_app).operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
                    {
                      ...
                      while (((operand_13422 = enumerator_13422.nextObject ()))) {
                        ...
                        if (((operand_13422->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (298))).operator_isEqual (operand_12773->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (298)))).isBuiltAndTrue ()) {
                          var_cas_access_app = GGS_bool (true) ;
                        }
                      }
                    }
        ...
        var_cas_eps = operand_12629->mInfo.st.reader_exp_points (inLexique COMMA_SOURCE_FILE_AT_LINE (313)) ;
        {
                        ...
                        while (((operand_14603 = enumerator_14603.nextObject ()))) {
                          macroValidPointer (operand_14603) ;
                          {
                            ...
                            while (((operand_14690 = enumerator_14690.nextObject ()))) {
                              ...
                              if (((operand_14690->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (326))).operator_isEqual (var_cas_sea.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (326)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (326)))).isBuiltAndTrue ()) {
                                {
                                  ...
                                  while (((operand_14952 = enumerator_14952.nextObject ()))) {
                                    ...
                                    if (((operand_14952->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (329))).operator_isEqual (operand_12629->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (329)))).isBuiltAndTrue ()) {
                                      var_cas_right_app = GGS_bool (true) ;
                                    }
                                  }
                                }
                                if (((var_cas_right_app).operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
                                  {
                                    ...
                                    while (((operand_15305 = enumerator_15305.nextObject ()))) {
                                      ...
                                      if (((operand_15305->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (335))).operator_isEqual (operand_14603->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (335)))).isBuiltAndTrue ()) {
                                        var_cas_access_app = GGS_bool (true) ;
                                      }
                                    }
                                  }
                        ...
                        while (((operand_16115 = enumerator_16115.nextObject ()))) {
                          macroValidPointer (operand_16115) ;
                          {
                            ...
                            while (((operand_16202 = enumerator_16202.nextObject ()))) {
                              ...
                              if (((operand_16202->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (352))).operator_isEqual (var_cas_ata.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (352)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (352)))).isBuiltAndTrue ()) {
                                {
                                  ...
                                  while (((operand_16464 = enumerator_16464.nextObject ()))) {
                                    ...
                                    if (((operand_16464->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (355))).operator_isEqual (operand_12629->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (355)))).isBuiltAndTrue ()) {
                                      var_cas_right_app = GGS_bool (true) ;
                                    }
                                  }
                                }
                                if (((var_cas_right_app).operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
                                  {
                                    ...
                                    while (((operand_16817 = enumerator_16817.nextObject ()))) {
                                      ...
                                      if (((operand_16817->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (361))).operator_isEqual (operand_16115->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (361)))).isBuiltAndTrue ()) {
                                        var_cas_access_app = GGS_bool (true) ;
                                      }
                                    }
                                  }
