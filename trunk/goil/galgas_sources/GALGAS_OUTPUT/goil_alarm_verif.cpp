...
void routine_counters_of_alarms_defined (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_324 = enumerator_324.nextObject ()))) {
      ...
      const GGS_bool cond_633 = ((var_cas_counters.reader_hasKey (inLexique, var_cas_counter.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (17)) COMMA_SOURCE_FILE_AT_LINE (17))).operator_not ()).operator_and ((var_cas_counter.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (17))).operator_isNotEqual (GGS_string ("SystemCounter"))) ;
