...
void routine_counters_of_alarms_defined (C_Compiler & _inLexique,
  ...
  #endif
  {
    ...
    while (((operand_320 = enumerator_320.nextObject ()))) {
      ...
      if ((((var_cas_counters.reader_hasKey (_inLexique, var_cas_counter.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (18)) COMMA_SOURCE_FILE_AT_LINE (18)))._operator_not ())._operator_and ((var_cas_counter.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (18)))._operator_isNotEqual (GGS_string ("SystemCounter")))).isBuiltAndTrue ()) {
        var_cas_counter.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string ("counter "))._operator_concat (var_cas_counter.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (19))))._operator_concat (GGS_string (" is not defined !")) COMMA_SOURCE_FILE_AT_LINE (20)) ;
      }else{
          ...
          if (_var_2223.getPtr () != NULL) {
            ...
            if (typeid (cPtr_alarm_autostart_true) == typeid (* (_var_2223.getPtr ()))) {
              ...
              if (((var_cas_alarm_time)._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
                if (((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (34))))._operator_isEqual (GGS_bool (true))).isBuiltAndTrue ()) {
                  var_cas_a.reader_alarm_time (_inLexique COMMA_SOURCE_FILE_AT_LINE (35)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("ALARMTIME must be > 0") COMMA_SOURCE_FILE_AT_LINE (36)) ;
                }else{
                  var_cas_a.reader_alarm_time (_inLexique COMMA_SOURCE_FILE_AT_LINE (37)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string ("ALARMTIME equal to 0 has an undefined behavior") COMMA_SOURCE_FILE_AT_LINE (37)) ;
                }
              }
              if (((var_cas_counter.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (42)))._operator_isEqual (GGS_string ("SystemCounter"))).isBuiltAndTrue ()) {
                if (((var_cas_alarm_time)._operator_strictSup (GGS_uint (32767U))).isBuiltAndTrue ()) {
                  var_cas_a.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (44)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("ALARMTIME is greater than counter MAXALLOWEDVALUE") COMMA_SOURCE_FILE_AT_LINE (45)) ;
                }
                if (((var_cas_cycle_time)._operator_strictSup (GGS_uint (32767U))).isBuiltAndTrue ()) {
                  var_cas_a.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (47)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("CYCLETIME is greater than counter MAXALLOWEDVALUE") COMMA_SOURCE_FILE_AT_LINE (48)) ;
                }
              }else{
                GGS_counter_obj  var_cas_ct ;
                const GGS_counter_map  _temp_1763 = var_cas_counters ;
                if (_temp_1763.isBuilt ()) {
                  ...
                  if (_var_2184.getPtr () != NULL) {
                    ...
                    if (typeid (cPtr_uint32_class) == typeid (* (_var_2184.getPtr ()))) {
                      ...
                      if (((var_cas_alarm_time)._operator_strictSup (var_cas_mc.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (54)))).isBuiltAndTrue ()) {
                        var_cas_a.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (55)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("ALARMTIME is greater than counter MAXALLOWEDVALUE") COMMA_SOURCE_FILE_AT_LINE (56)) ;
                      }
                      if (((var_cas_cycle_time)._operator_strictSup (var_cas_mc.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (57)))).isBuiltAndTrue ()) {
                        var_cas_a.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (58)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("CYCLETIME is greater than counter MAXALLOWEDVALUE") COMMA_SOURCE_FILE_AT_LINE (59)) ;
                      }
                    }else{
                    }
                  }
