...
void routine_generate_messages (C_Compiler & inLexique,
  ...
  const GGS_bool cond_9708 = (var_cas_flag_count).operator_strictSup (GGS_uint (0U)) ;
  if (cond_9708.isBuiltAndTrue ()) {
    ...
    {
      GGS_stringset::cEnumerator enumerator_8430 (var_cas_flags, true) ;
      while (enumerator_8430.hasCurrentObject ()) {
        GGS_string var_cas_fm = var_cas_flag_macros ;
        ::routine_doReplace (inLexique,  var_cas_fm,  GGS_string ("$FLAGNAME$"),  enumerator_8430._key (HERE) COMMA_SOURCE_FILE_AT_LINE (258)) ;
        GGS_uint  var_cas_flag_elem = var_cas_flag_order.divide_operation (inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (259)) ;
        GGS_uint  var_cas_flag_bit = var_cas_flag_order.modulo_operation (inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (260)) ;
        GGS_uint  var_cas_flag_mask = GGS_uint (1U).left_shift_operation (inLexique, var_cas_flag_bit COMMA_SOURCE_FILE_AT_LINE (261)) ;
        GGS_uint  var_cas_invert_flag_mask = (var_cas_flag_mask.left_shift_operation (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (262))).operator_tilde ().right_shift_operation (inLexique, GGS_uint (24U) COMMA_SOURCE_FILE_AT_LINE (262)) ;
        GGS_string var_cas_flag_read ;
        GGS_string var_cas_flag_reset ;
        const GGS_bool cond_8940 = (var_cas_flag_bit).operator_isEqual (GGS_uint (0U)) ;
        if (cond_8940.isBuiltAndTrue ()) {
        ...
        }else if (cond_8940.isBuiltAndFalse ()) {
        ...
        ::routine_doReplace (inLexique,  var_cas_ff,  GGS_string ("$FLAGNAME$"),  enumerator_8430._key (HERE) COMMA_SOURCE_FILE_AT_LINE (275)) ;
