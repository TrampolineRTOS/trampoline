...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.event.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.count.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.alarm.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
method_generate_notif (C_Compiler & _inLexique,
  ...
  if (_temp_3102.isBuilt ()) {
    _temp_3102 (HERE)->method_generate (_inLexique, var_cas_name, GGS_string (""), GGS_string ("$NOTIFICATION_PTR$"), var_cas_h_res, var_cas_i_res COMMA_SOURCE_FILE_AT_LINE (132)) ;
  }
  ...
  if (_temp_3259.isBuilt ()) {
    _temp_3259 (HERE)->method_generate (_inLexique, var_cas_name, GGS_string ("_error"), GGS_string ("$NOTIFICATION_PTR$"), var_cas_h_res, var_cas_i_res COMMA_SOURCE_FILE_AT_LINE (136)) ;
  }
}
...
method_generate_dest_list (C_Compiler & _inLexique,
  ...
  var_cas_notfound = GGS_bool (true) ;
  GGS_bool var_cas_nextone ;
  var_cas_nextone = GGS_bool (false) ;
  const GGS_ident_list_map  _temp_3671 = var_cas_dests ;
  if (_temp_3671.isBuilt ()) {
  ...
  }
  {
    ...
    while (((operand_3728 = enumerator_3728.nextObject ()))
      ...
      if ((var_cas_nextone).isBuiltAndTrue ()) {
        ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$TARGET_PTR$"),  ((GGS_string ("&"))._operator_concat (operand_3728->obj_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (155))))._operator_concat (GGS_string ("_message")) COMMA_SOURCE_FILE_AT_LINE (155)) ;
  ...
  if ((var_cas_notfound).isBuiltAndTrue ()) {
    ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$TARGET_PTR$"),  GGS_string ("NULL_PTR") COMMA_SOURCE_FILE_AT_LINE (163)) ;
  }
}
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.mess.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
method_base_generate (C_Compiler & _inLexique,
                                GGS_lstring  var_cas_name,
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$MESSAGE_NAME$"),  var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (188)))._operator_concat (GGS_string ("_filter")) COMMA_SOURCE_FILE_AT_LINE (188)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_PTR$"),  ((GGS_string ("&"))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (189))))._operator_concat (GGS_string ("_filter")) COMMA_SOURCE_FILE_AT_LINE (189)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                GGS_lstring  var_cas_name,
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_PTR$"),  GGS_string ("NULL_PTR") COMMA_SOURCE_FILE_AT_LINE (198)) ;
...
method_generate (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_noparam") COMMA_SOURCE_FILE_AT_LINE (209)) ;
  ...
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_always") COMMA_SOURCE_FILE_AT_LINE (212)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("Always") COMMA_SOURCE_FILE_AT_LINE (213)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_f_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_noparam") COMMA_SOURCE_FILE_AT_LINE (223)) ;
  var_cas_res = (var_cas_f_res)._operator_concat (var_cas_res) ;
  method_base_generate (_inLexique, var_cas_name, var_cas_res COMMA_SOURCE_FILE_AT_LINE (225)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_never") COMMA_SOURCE_FILE_AT_LINE (226)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("Never") COMMA_SOURCE_FILE_AT_LINE (227)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_f_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_mask_x") COMMA_SOURCE_FILE_AT_LINE (239)) ;
  var_cas_res = (var_cas_f_res)._operator_concat (var_cas_res) ;
  method_base_generate (_inLexique, var_cas_name, var_cas_res COMMA_SOURCE_FILE_AT_LINE (241)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_masked_new_equals_x") COMMA_SOURCE_FILE_AT_LINE (242)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("Masked New Equals X") COMMA_SOURCE_FILE_AT_LINE (243)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$MASK$"),  mask.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (244)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (244)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$X$"),  x.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (245)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (245)) COMMA_SOURCE_FILE_AT_LINE (245)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_f_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_mask_x") COMMA_SOURCE_FILE_AT_LINE (257)) ;
  var_cas_res = (var_cas_f_res)._operator_concat (var_cas_res) ;
  method_base_generate (_inLexique, var_cas_name, var_cas_res COMMA_SOURCE_FILE_AT_LINE (259)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_masked_new_differs_x") COMMA_SOURCE_FILE_AT_LINE (260)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("Masked New Differs X") COMMA_SOURCE_FILE_AT_LINE (261)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$MASK$"),  mask.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (262)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (262)) COMMA_SOURCE_FILE_AT_LINE (262)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$X$"),  x.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (263)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (263)) COMMA_SOURCE_FILE_AT_LINE (263)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_f_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_noparam") COMMA_SOURCE_FILE_AT_LINE (273)) ;
  var_cas_res = (var_cas_f_res)._operator_concat (var_cas_res) ;
  method_base_generate (_inLexique, var_cas_name, var_cas_res COMMA_SOURCE_FILE_AT_LINE (275)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_new_is_equal") COMMA_SOURCE_FILE_AT_LINE (276)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("New is Equal") COMMA_SOURCE_FILE_AT_LINE (277)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_f_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_noparam") COMMA_SOURCE_FILE_AT_LINE (287)) ;
  var_cas_res = (var_cas_f_res)._operator_concat (var_cas_res) ;
  method_base_generate (_inLexique, var_cas_name, var_cas_res COMMA_SOURCE_FILE_AT_LINE (289)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_new_is_different") COMMA_SOURCE_FILE_AT_LINE (290)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("New is Different") COMMA_SOURCE_FILE_AT_LINE (291)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_f_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_mask") COMMA_SOURCE_FILE_AT_LINE (302)) ;
  var_cas_res = (var_cas_f_res)._operator_concat (var_cas_res) ;
  method_base_generate (_inLexique, var_cas_name, var_cas_res COMMA_SOURCE_FILE_AT_LINE (304)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_masked_new_equals_masked_old") COMMA_SOURCE_FILE_AT_LINE (305)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("Masked New Equals Masked Old") COMMA_SOURCE_FILE_AT_LINE (306)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$MASK$"),  mask.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (307)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (307)) COMMA_SOURCE_FILE_AT_LINE (307)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_f_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_mask") COMMA_SOURCE_FILE_AT_LINE (318)) ;
  var_cas_res = (var_cas_f_res)._operator_concat (var_cas_res) ;
  method_base_generate (_inLexique, var_cas_name, var_cas_res COMMA_SOURCE_FILE_AT_LINE (320)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_masked_new_differs_masked_old") COMMA_SOURCE_FILE_AT_LINE (321)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("Masked New Differs Masked Old") COMMA_SOURCE_FILE_AT_LINE (322)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$MASK$"),  mask.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (323)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (323)) COMMA_SOURCE_FILE_AT_LINE (323)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_f_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_interval") COMMA_SOURCE_FILE_AT_LINE (335)) ;
  var_cas_res = (var_cas_f_res)._operator_concat (var_cas_res) ;
  method_base_generate (_inLexique, var_cas_name, var_cas_res COMMA_SOURCE_FILE_AT_LINE (337)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_new_is_within") COMMA_SOURCE_FILE_AT_LINE (338)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("New is Within") COMMA_SOURCE_FILE_AT_LINE (339)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$MIN$"),  min.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (340)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (340)) COMMA_SOURCE_FILE_AT_LINE (340)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$MAX$"),  max.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (341)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (341)) COMMA_SOURCE_FILE_AT_LINE (341)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_f_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_interval") COMMA_SOURCE_FILE_AT_LINE (353)) ;
  var_cas_res = (var_cas_f_res)._operator_concat (var_cas_res) ;
  method_base_generate (_inLexique, var_cas_name, var_cas_res COMMA_SOURCE_FILE_AT_LINE (355)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_new_is_outside") COMMA_SOURCE_FILE_AT_LINE (356)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("New is Outside") COMMA_SOURCE_FILE_AT_LINE (357)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$MIN$"),  min.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (358)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$MAX$"),  max.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (359)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (359)) COMMA_SOURCE_FILE_AT_LINE (359)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_f_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_noparam") COMMA_SOURCE_FILE_AT_LINE (369)) ;
  var_cas_res = (var_cas_f_res)._operator_concat (var_cas_res) ;
  method_base_generate (_inLexique, var_cas_name, var_cas_res COMMA_SOURCE_FILE_AT_LINE (371)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_new_is_greater") COMMA_SOURCE_FILE_AT_LINE (372)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("New is Greater") COMMA_SOURCE_FILE_AT_LINE (373)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_f_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_noparam") COMMA_SOURCE_FILE_AT_LINE (383)) ;
  var_cas_res = (var_cas_f_res)._operator_concat (var_cas_res) ;
  method_base_generate (_inLexique, var_cas_name, var_cas_res COMMA_SOURCE_FILE_AT_LINE (385)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_new_is_less_or_equal") COMMA_SOURCE_FILE_AT_LINE (386)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("New is Less or Equal") COMMA_SOURCE_FILE_AT_LINE (387)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_f_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_noparam") COMMA_SOURCE_FILE_AT_LINE (397)) ;
  var_cas_res = (var_cas_f_res)._operator_concat (var_cas_res) ;
  method_base_generate (_inLexique, var_cas_name, var_cas_res COMMA_SOURCE_FILE_AT_LINE (399)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_new_is_less") COMMA_SOURCE_FILE_AT_LINE (400)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("New is Less") COMMA_SOURCE_FILE_AT_LINE (401)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_f_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_noparam") COMMA_SOURCE_FILE_AT_LINE (411)) ;
  var_cas_res = (var_cas_f_res)._operator_concat (var_cas_res) ;
  method_base_generate (_inLexique, var_cas_name, var_cas_res COMMA_SOURCE_FILE_AT_LINE (413)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_new_is_greater_or_equal") COMMA_SOURCE_FILE_AT_LINE (414)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("New is Greater or Equal") COMMA_SOURCE_FILE_AT_LINE (415)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_f_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_f_res,  GGS_string ("filter_occurence") COMMA_SOURCE_FILE_AT_LINE (427)) ;
  var_cas_res = (var_cas_f_res)._operator_concat (var_cas_res) ;
  method_base_generate (_inLexique, var_cas_name, var_cas_res COMMA_SOURCE_FILE_AT_LINE (429)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTERING_FUNC$"),  GGS_string ("tpl_filter_one_every_n") COMMA_SOURCE_FILE_AT_LINE (430)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FILTER_KIND$"),  GGS_string ("One Every N") COMMA_SOURCE_FILE_AT_LINE (431)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$PERIOD$"),  period.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (432)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (432)) COMMA_SOURCE_FILE_AT_LINE (432)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$OFFSET$"),  offset.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (433)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (433)) COMMA_SOURCE_FILE_AT_LINE (433)) ;
}
...
method_s_mess (C_Compiler & _inLexique,
  ...
  var_cas_sd = GGS_lstring ::constructor_new (_inLexique, GGS_string (""), GGS_location (_inLexique) COMMA_HERE) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_h_res = GGS_string ("") ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_i_res,  GGS_string ("message_ssi") COMMA_SOURCE_FILE_AT_LINE (467)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE_NAME$"),  var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (468)) COMMA_SOURCE_FILE_AT_LINE (468)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (469)))._operator_concat (GGS_string ("_message")) COMMA_SOURCE_FILE_AT_LINE (469)) ;
  if ((var_cas_dests.reader_hasKey (_inLexique, var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (470)) COMMA_SOURCE_FILE_AT_LINE (470))).isBuiltAndTrue ()) {
    ...
    if (_temp_14248.isBuilt ()) {
      _temp_14248 (HERE)->method_first (_inLexique, var_cas_target COMMA_SOURCE_FILE_AT_LINE (474)) ;
    }
    ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$TARGET$"),  (var_cas_target.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (475)))._operator_concat (GGS_string ("_message")) COMMA_SOURCE_FILE_AT_LINE (475)) ;
  }
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_h_res = GGS_string ("") ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_i_res,  GGS_string ("message_sse") COMMA_SOURCE_FILE_AT_LINE (498)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE_NAME$"),  var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (499)) COMMA_SOURCE_FILE_AT_LINE (499)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (500)))._operator_concat (GGS_string ("_message")) COMMA_SOURCE_FILE_AT_LINE (500)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$NETWORKMESSAGE$"),  (networkmessage.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (501)))._operator_concat (GGS_string ("_net_message")) COMMA_SOURCE_FILE_AT_LINE (501)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$BUFFER$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (502)))._operator_concat (GGS_string ("_buffer")) COMMA_SOURCE_FILE_AT_LINE (502)) ;
  if (((tranferproperty.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (503)))._operator_isNotEqual (GGS_string ("triggered"))).isBuiltAndTrue ()) {
    tranferproperty.reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, GGS_string ("Only TRIGGERED transfer property is supported in this version") COMMA_SOURCE_FILE_AT_LINE (504)) ;
  }
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$CTYPE$"),  cdatatype.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (506)) COMMA_SOURCE_FILE_AT_LINE (506)) ;
  GGS_string var_cas_iv ;
  const GGS_basic_type  _temp_15789 = initialvalue ;
  if (_temp_15789.isBuilt ()) {
    _temp_15789 (HERE)->method_string (_inLexique, var_cas_iv COMMA_SOURCE_FILE_AT_LINE (512)) ;
  }
  if (((var_cas_iv)._operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
    var_cas_iv = (GGS_string (" = "))._operator_concat (var_cas_iv) ;
  }
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$INITIALVALUE$"),  var_cas_iv COMMA_SOURCE_FILE_AT_LINE (514)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_h_res = GGS_string ("") ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_i_res,  GGS_string ("message_szi") COMMA_SOURCE_FILE_AT_LINE (549)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE_NAME$"),  var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (550)) COMMA_SOURCE_FILE_AT_LINE (550)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (551)))._operator_concat (GGS_string ("_message")) COMMA_SOURCE_FILE_AT_LINE (551)) ;
  if ((var_cas_dests.reader_hasKey (_inLexique, var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (552)) COMMA_SOURCE_FILE_AT_LINE (552))).isBuiltAndTrue ()) {
    ...
    if (_temp_17284.isBuilt ()) {
      _temp_17284 (HERE)->method_first (_inLexique, var_cas_target COMMA_SOURCE_FILE_AT_LINE (556)) ;
    }
    ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$TARGET$"),  (var_cas_target.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (557)))._operator_concat (GGS_string ("_message")) COMMA_SOURCE_FILE_AT_LINE (557)) ;
  }
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_h_res = GGS_string ("") ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_i_res,  GGS_string ("message_sze") COMMA_SOURCE_FILE_AT_LINE (576)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE_NAME$"),  var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (577)) COMMA_SOURCE_FILE_AT_LINE (577)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (578)))._operator_concat (GGS_string ("_message")) COMMA_SOURCE_FILE_AT_LINE (578)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$NETWORKMESSAGE$"),  (networkmessage.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (579)))._operator_concat (GGS_string ("_net_message")) COMMA_SOURCE_FILE_AT_LINE (579)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_h_res = GGS_string ("") ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_i_res,  GGS_string ("message_rzi") COMMA_SOURCE_FILE_AT_LINE (595)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE_NAME$"),  var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (596)) COMMA_SOURCE_FILE_AT_LINE (596)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (597)))._operator_concat (GGS_string ("_message")) COMMA_SOURCE_FILE_AT_LINE (597)) ;
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_h_res = GGS_string ("") ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_i_res,  GGS_string ("message_rui") COMMA_SOURCE_FILE_AT_LINE (640)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE_NAME$"),  var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (641)) COMMA_SOURCE_FILE_AT_LINE (641)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (642)))._operator_concat (GGS_string ("_message")) COMMA_SOURCE_FILE_AT_LINE (642)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$BUFFER$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (643)))._operator_concat (GGS_string ("_buffer")) COMMA_SOURCE_FILE_AT_LINE (643)) ;
  const GGS_filter_prop_obj  _temp_20343 = filter ;
  if (_temp_20343.isBuilt ()) {
  ...
  { const GGS_mess_prop_obj _var_21253 = var_cas_prop ; // CAST instruction
    if (_var_21253.getPtr () != NULL) {
      ...
      if (typeid (cPtr_ssi_mess_prop) == typeid (* (_var_21253.getPtr ()))) {
        ...
        ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$CTYPE$"),  var_cas_ssi.reader_cdatatype (_inLexique COMMA_SOURCE_FILE_AT_LINE (660)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (660)) COMMA_SOURCE_FILE_AT_LINE (660)) ;
        ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$SIZE$"),  ((GGS_string ("sizeof("))._operator_concat (var_cas_ssi.reader_cdatatype (_inLexique COMMA_SOURCE_FILE_AT_LINE (661)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (661))))._operator_concat (GGS_string (")")) COMMA_SOURCE_FILE_AT_LINE (661)) ;
        GGS_string var_cas_iv ;
        const GGS_basic_type  _temp_21047 = initialvalue ;
        if (_temp_21047.isBuilt ()) {
          _temp_21047 (HERE)->method_string (_inLexique, var_cas_iv COMMA_SOURCE_FILE_AT_LINE (663)) ;
        }
        if (((var_cas_iv)._operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
          var_cas_iv = (GGS_string (" = "))._operator_concat (var_cas_iv) ;
        }
        ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$INITIALVALUE$"),  var_cas_iv COMMA_SOURCE_FILE_AT_LINE (665)) ;
      }else{
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Incompatible sending message object") COMMA_SOURCE_FILE_AT_LINE (668)) ;
      }
    }
  }
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_h_res = GGS_string ("") ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_i_res,  GGS_string ("message_rqi") COMMA_SOURCE_FILE_AT_LINE (687)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE_NAME$"),  var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (688)) COMMA_SOURCE_FILE_AT_LINE (688)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (689)))._operator_concat (GGS_string ("_message")) COMMA_SOURCE_FILE_AT_LINE (689)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$BUFFER$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (690)))._operator_concat (GGS_string ("_buffer")) COMMA_SOURCE_FILE_AT_LINE (690)) ;
  const GGS_filter_prop_obj  _temp_22079 = filter ;
  if (_temp_22079.isBuilt ()) {
  ...
  { const GGS_mess_prop_obj _var_22734 = var_cas_prop ; // CAST instruction
    if (_var_22734.getPtr () != NULL) {
      ...
      if (typeid (cPtr_ssi_mess_prop) == typeid (* (_var_22734.getPtr ()))) {
        ...
        ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$CTYPE$"),  var_cas_ssi.reader_cdatatype (_inLexique COMMA_SOURCE_FILE_AT_LINE (707)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (707)) COMMA_SOURCE_FILE_AT_LINE (707)) ;
      }else{
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Incompatible sending message object") COMMA_SOURCE_FILE_AT_LINE (710)) ;
      }
    }
  }
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$QUEUE_SIZE$"),  queuesize.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (713)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (713)) COMMA_SOURCE_FILE_AT_LINE (713)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$DYN_QUEUE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (716)))._operator_concat (GGS_string ("_dyn_queue")) COMMA_SOURCE_FILE_AT_LINE (716)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_h_res = GGS_string ("") ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_i_res,  GGS_string ("message_rue") COMMA_SOURCE_FILE_AT_LINE (736)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE_NAME$"),  var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (737)) COMMA_SOURCE_FILE_AT_LINE (737)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$MESSAGE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (738)))._operator_concat (GGS_string ("_message")) COMMA_SOURCE_FILE_AT_LINE (738)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$BUFFER$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (739)))._operator_concat (GGS_string ("_buffer")) COMMA_SOURCE_FILE_AT_LINE (739)) ;
  const GGS_filter_prop_obj  _temp_23793 = filter ;
  if (_temp_23793.isBuilt ()) {
  ...
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$CTYPE$"),  cdatatype.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (751)) COMMA_SOURCE_FILE_AT_LINE (751)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$SIZE$"),  ((GGS_string ("sizeof("))._operator_concat (cdatatype.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (752))))._operator_concat (GGS_string (")")) COMMA_SOURCE_FILE_AT_LINE (752)) ;
  GGS_string var_cas_iv ;
  const GGS_basic_type  _temp_24287 = initialvalue ;
  if (_temp_24287.isBuilt ()) {
    _temp_24287 (HERE)->method_string (_inLexique, var_cas_iv COMMA_SOURCE_FILE_AT_LINE (754)) ;
  }
  if (((var_cas_iv)._operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
    var_cas_iv = (GGS_string (" = "))._operator_concat (var_cas_iv) ;
  }
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$INITIALVALUE$"),  var_cas_iv COMMA_SOURCE_FILE_AT_LINE (756)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  GGS_string ("$TARGET_PTR$"),  GGS_string ("NULL_PTR") COMMA_SOURCE_FILE_AT_LINE (757)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& /* var_cas_h_res */,
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_doReplace (_inLexique,  var_cas_i_res,  var_cas_key,  GGS_string ("NULL_PTR") COMMA_SOURCE_FILE_AT_LINE (838)) ;
}
