...
method_generate (C_Compiler & inLexique,
  ...
  const GGS_bool cond_14151 = var_cas_dests.reader_hasKey (inLexique, var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (455)) COMMA_SOURCE_FILE_AT_LINE (455)) ;
...
method_generate (C_Compiler & inLexique,
  ...
  const GGS_bool cond_17193 = var_cas_dests.reader_hasKey (inLexique, var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (537)) COMMA_SOURCE_FILE_AT_LINE (537)) ;
