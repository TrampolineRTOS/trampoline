...
method_generate_notif (C_Compiler & inLexique,
  ...
  if (_temp_3102.isBuilt ()) {
    _temp_3102 (HERE)->method_generate (inLexique, var_cas_name, GGS_string (""), GGS_string ("$NOTIFICATION_PTR$"), var_cas_h_res, var_cas_i_res COMMA_SOURCE_FILE_AT_LINE (132)) ;
  }
  ...
  if (_temp_3259.isBuilt ()) {
    _temp_3259 (HERE)->method_generate (inLexique, var_cas_name, GGS_string ("_error"), GGS_string ("$NOTIFICATION_PTR$"), var_cas_h_res, var_cas_i_res COMMA_SOURCE_FILE_AT_LINE (136)) ;
  }
}
...
method_generate_dest_list (C_Compiler & inLexique,
  ...
  if (_temp_3671.isBuilt ()) {
    _temp_3671 (HERE)->method_get (inLexique, var_cas_sendingmessage, var_cas_dest_list COMMA_SOURCE_FILE_AT_LINE (150)) ;
  }
  {
    ...
    while (((operand_3728 = enumerator_3728.nextObject ()))
      ...
      if (((operand_3728->obj_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (158))).operator_isEqual (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (158)))).isBuiltAndTrue ()) {
...
method_generate (C_Compiler & inLexique,
  ...
  if ((var_cas_dests.reader_hasKey (inLexique, var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (470)) COMMA_SOURCE_FILE_AT_LINE (470))).isBuiltAndTrue ()) {
    GGS_ident_list  var_cas_d_mess_list ;
    const GGS_ident_list_map  _temp_14165 = var_cas_dests ;
    if (_temp_14165.isBuilt ()) {
      _temp_14165 (HERE)->method_get (inLexique, var_cas_name, var_cas_d_mess_list COMMA_SOURCE_FILE_AT_LINE (472)) ;
    }
    GGS_lstring  var_cas_target ;
    const GGS_ident_list  _temp_14248 = var_cas_d_mess_list ;
    if (_temp_14248.isBuilt ()) {
      _temp_14248 (HERE)->method_first (inLexique, var_cas_target COMMA_SOURCE_FILE_AT_LINE (474)) ;
    }
...
method_generate (C_Compiler & inLexique,
  ...
  if (((tranferproperty.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (503))).operator_isNotEqual (GGS_string ("triggered"))).isBuiltAndTrue ()) {
  ...
  if (_temp_15789.isBuilt ()) {
    _temp_15789 (HERE)->method_string (inLexique, var_cas_iv COMMA_SOURCE_FILE_AT_LINE (512)) ;
  }
  if (((var_cas_iv).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
...
method_generate (C_Compiler & inLexique,
  ...
  if ((var_cas_dests.reader_hasKey (inLexique, var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (552)) COMMA_SOURCE_FILE_AT_LINE (552))).isBuiltAndTrue ()) {
    GGS_ident_list  var_cas_d_mess_list ;
    const GGS_ident_list_map  _temp_17201 = var_cas_dests ;
    if (_temp_17201.isBuilt ()) {
      _temp_17201 (HERE)->method_get (inLexique, var_cas_name, var_cas_d_mess_list COMMA_SOURCE_FILE_AT_LINE (554)) ;
    }
    GGS_lstring  var_cas_target ;
    const GGS_ident_list  _temp_17284 = var_cas_d_mess_list ;
    if (_temp_17284.isBuilt ()) {
      _temp_17284 (HERE)->method_first (inLexique, var_cas_target COMMA_SOURCE_FILE_AT_LINE (556)) ;
    }
...
method_generate (C_Compiler & inLexique,
  ...
  if (_temp_20343.isBuilt ()) {
    _temp_20343 (HERE)->method_generate (inLexique, var_cas_name, var_cas_i_res COMMA_SOURCE_FILE_AT_LINE (646)) ;
  }
  ...
  if (_temp_20696.isBuilt ()) {
    _temp_20696 (HERE)->method_get (inLexique, sendingmessage, var_cas_sender COMMA_SOURCE_FILE_AT_LINE (656)) ;
  }
  GGS_mess_prop_obj  var_cas_prop ;
  var_cas_prop = var_cas_sender.reader_messageproperty (inLexique COMMA_SOURCE_FILE_AT_LINE (657)) ;
    ...
    if (_var_21253.getPtr () != NULL) {
      ...
      if (typeid (cPtr_ssi_mess_prop) == typeid (* (_var_21253.getPtr ()))) {
        ...
        if (_temp_21047.isBuilt ()) {
          _temp_21047 (HERE)->method_string (inLexique, var_cas_iv COMMA_SOURCE_FILE_AT_LINE (663)) ;
        }
        if (((var_cas_iv).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
          var_cas_iv = (GGS_string (" = ")).operator_concat (var_cas_iv) ;
        }
...
method_generate (C_Compiler & inLexique,
  ...
  if (_temp_22079.isBuilt ()) {
    _temp_22079 (HERE)->method_generate (inLexique, var_cas_name, var_cas_i_res COMMA_SOURCE_FILE_AT_LINE (693)) ;
  }
  ...
  if (_temp_22432.isBuilt ()) {
    _temp_22432 (HERE)->method_get (inLexique, sendingmessage, var_cas_sender COMMA_SOURCE_FILE_AT_LINE (703)) ;
  }
  GGS_mess_prop_obj  var_cas_prop ;
  var_cas_prop = var_cas_sender.reader_messageproperty (inLexique COMMA_SOURCE_FILE_AT_LINE (704)) ;
...
method_generate (C_Compiler & inLexique,
  ...
  if (_temp_23793.isBuilt ()) {
    _temp_23793 (HERE)->method_generate (inLexique, var_cas_name, var_cas_i_res COMMA_SOURCE_FILE_AT_LINE (742)) ;
  }
  ...
  if (_temp_24287.isBuilt ()) {
    _temp_24287 (HERE)->method_string (inLexique, var_cas_iv COMMA_SOURCE_FILE_AT_LINE (754)) ;
  }
  if (((var_cas_iv).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
    var_cas_iv = (GGS_string (" = ")).operator_concat (var_cas_iv) ;
  }
