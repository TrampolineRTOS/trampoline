...
const C_galgas_type_descriptor kTypeDescriptor_GGS_base_netprop ("base_netprop", true, NULL) ;
...
AC_galgasClassRunTimeInformation * GGS_base_netprop::galgasObjectRunTimeInfo (void) const {
...
C_galgasRootClassRunTimeInformation gClassInfoFor__base_netprop ("base_netprop", & kTypeDescriptor_GGS_base_netprop) ;
...
const C_galgas_type_descriptor * GGS_base_netprop::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_void_netprop ("void_netprop", true, & kTypeDescriptor_GGS_base_netprop) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__void_netprop ("void_netprop", gClassInfoFor__base_netprop, & kTypeDescriptor_GGS_void_netprop) ;
...
const C_galgas_type_descriptor * GGS_void_netprop::typeDescriptor (void) const {
...
method_generate (C_Compiler & inLexique,
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_res = function_template_string (inLexique, GGS_string ("code"), (direction.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (25))).operator_concat (GGS_string ("_nm")) COMMA_SOURCE_FILE_AT_LINE (25)) ;
}
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_static_netprop ("static_netprop", true, & kTypeDescriptor_GGS_base_netprop) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__static_netprop ("static_netprop", gClassInfoFor__base_netprop, & kTypeDescriptor_GGS_static_netprop) ;
...
const C_galgas_type_descriptor * GGS_static_netprop::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_dynamic_netprop ("dynamic_netprop", true, & kTypeDescriptor_GGS_base_netprop) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__dynamic_netprop ("dynamic_netprop", gClassInfoFor__base_netprop, & kTypeDescriptor_GGS_dynamic_netprop) ;
...
const C_galgas_type_descriptor * GGS_dynamic_netprop::typeDescriptor (void) const {
...
method_generate (C_Compiler & inLexique,
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_res = function_template_string (inLexique, GGS_string ("code"), (direction.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (43))).operator_concat (GGS_string ("_nm")) COMMA_SOURCE_FILE_AT_LINE (43)) ;
}
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_zero_netprop ("zero_netprop", true, & kTypeDescriptor_GGS_base_netprop) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__zero_netprop ("zero_netprop", gClassInfoFor__base_netprop, & kTypeDescriptor_GGS_zero_netprop) ;
...
const C_galgas_type_descriptor * GGS_zero_netprop::typeDescriptor (void) const {
...
method_generate (C_Compiler & inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_base_netprop  temp_1355 = netprop ;
  if (temp_1355.isBuilt ()) {
    temp_1355 (HERE)->method_generate (inLexique, var_cas_res COMMA_SOURCE_FILE_AT_LINE (51)) ;
  }
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$NAME$"),  var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (52)) COMMA_SOURCE_FILE_AT_LINE (52)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$CTYPE$"),  var_cas_ctype COMMA_SOURCE_FILE_AT_LINE (53)) ;
  const GGS_bool cond_1511 = (var_cas_inval).operator_isNotEqual (GGS_string ("")) ;
  if (cond_1511.isBuiltAndTrue ()) {
    var_cas_inval = (GGS_string (" = ")).operator_concat (var_cas_inval) ;
  }
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$INITIALVALUE$"),  var_cas_inval COMMA_SOURCE_FILE_AT_LINE (57)) ;
}
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_netmess_obj ("netmess_obj", true, & kTypeDescriptor_GGS_oil_obj) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__netmess_obj ("netmess_obj", gClassInfoFor__oil_obj, & kTypeDescriptor_GGS_netmess_obj) ;
...
const C_galgas_type_descriptor * GGS_netmess_obj::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_netmess_map ("netmess_map", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_netmess_map::typeDescriptor (void) const {
