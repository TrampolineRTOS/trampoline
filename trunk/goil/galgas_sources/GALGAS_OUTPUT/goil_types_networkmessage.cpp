...
method_generate (C_Compiler & inLexique,
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_retrieveTemplateString (inLexique,  var_cas_res,  (direction.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (25))).operator_concat (GGS_string ("_nm")) COMMA_SOURCE_FILE_AT_LINE (25)) ;
}
...
method_generate (C_Compiler & inLexique,
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_retrieveTemplateString (inLexique,  var_cas_res,  (direction.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (43))).operator_concat (GGS_string ("_nm")) COMMA_SOURCE_FILE_AT_LINE (43)) ;
}
...
method_generate (C_Compiler & inLexique,
                                ...
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_base_netprop  temp_1349 = netprop ;
  if (temp_1349.isBuilt ()) {
    temp_1349 (HERE)->method_generate (inLexique, var_cas_res COMMA_SOURCE_FILE_AT_LINE (51)) ;
  }
  ...
  const GGS_bool cond_1505 = (var_cas_inval).operator_isNotEqual (GGS_string ("")) ;
  if (cond_1505.isBuiltAndTrue ()) {
