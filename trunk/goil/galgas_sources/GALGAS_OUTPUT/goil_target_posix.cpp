...
void routine_generate_counter_posix (C_Compiler & inLexique,
  ...
  GGS_string var_cas_result = GGS_string ("") ;
  {
    ...
    while (((operand_2246 = enumerator_2246.nextObject ()))) {
      ...
      { const GGS_counter_type _var_2546 = operand_2246->mInfo.counter.reader_type (inLexique COMMA_SOURCE_FILE_AT_LINE (78)) ; // CAST instruction
        if (_var_2546.getPtr () != NULL) {
          macroValidPointer (_var_2546.getPtr ()) ;
          if (typeid (cPtr_software_counter) == typeid (* (_var_2546.getPtr ()))) {
          }else{
            ...
            ::routine_doReplace (inLexique,  var_cas_tmp,  GGS_string ("$COUNTER$"),  (operand_2246->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (83))).operator_concat (GGS_string ("_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (83)) ;
