...
class goil_syntax {
  ...
  protected : void pr_file_goil_syntax_36_12_ (goil_lexique &) ;

  protected : void pr_description_goil_syntax_52_19_ (goil_lexique &,
                                GGS_lstring  &) ;

  protected : virtual sint16 select_goil_syntax_0 (goil_lexique &) = 0 ;

  protected : void pr_OIL_version_goil_syntax_64_19_ (goil_lexique &,
                                GGS_lstring  &,
                                GGS_lstring  &) ;

  protected : void pr_implementation_definition_goil_syntax_76_33_ (goil_lexique &,
                                GGS_implementation  &) ;

  protected : void pr_implementation_spec_list_goil_syntax_86_32_ (goil_lexique &,
                                GGS_implementation  &) ;

  protected : virtual sint16 select_repeat_goil_syntax_1 (goil_lexique &) = 0 ;

  protected : void pr_implementation_spec_goil_syntax_92_27_ (goil_lexique &,
                                GGS_implementation  &) ;

  protected : virtual sint16 select_goil_syntax_2 (goil_lexique &) = 0 ;

  protected : void pr_implementation_list_goil_syntax_123_27_ (goil_lexique &,
                                GGS_implementationSpec  &) ;

  protected : virtual sint16 select_repeat_goil_syntax_3 (goil_lexique &) = 0 ;

  protected : void pr_impl_attr_def_goil_syntax_133_21_ (goil_lexique &,
                                GGS_implementationSpec  &) ;

  protected : virtual sint16 select_goil_syntax_4 (goil_lexique &) = 0 ;

  protected : void pr_impl_attr_def_goil_syntax_148_21_ (goil_lexique &,
                                GGS_implementationSpec  &) ;

  protected : void pr_auto_specifier_goil_syntax_158_22_ (goil_lexique &,
                                GGS_bool &) ;
