...
class goil_syntax {
  ...
  protected : void pr_file_goil_syntax_516_11_ (goil_lexique &,
                                GGS_implementation  &,
                                GGS_root_obj  &) ;

  protected : virtual sint16 select_repeat_goil_syntax_0 (goil_lexique &) = 0 ;

  protected : void pr_description_goil_syntax_538_18_ (goil_lexique &,
                                GGS_lstring  &) ;

  protected : virtual sint16 select_goil_syntax_1 (goil_lexique &) = 0 ;

  protected : void pr_OIL_version_goil_syntax_550_18_ (goil_lexique &,
                                GGS_lstring  &,
                                GGS_lstring  &) ;

  protected : void pr_application_definition_goil_syntax_561_29_ (goil_lexique &,
                                GGS_root_obj  &) ;

  protected : void pr_object_definition_list_goil_syntax_614_29_ (goil_lexique &,
                                GGS_os_obj  &,
                                GGS_com  &,
                                GGS_task_map  &,
                                GGS_counter_map  &,
  ...
  protected : void pr_nm_goil_syntax_662_9_ (goil_lexique &) ;

  protected : void pr_boolean_goil_syntax_673_14_ (goil_lexique &,
                                GGS_lbool  &) ;

  protected : virtual sint16 select_goil_syntax_3 (goil_lexique &) = 0 ;

  protected : void pr_free_field_goil_syntax_683_17_ (goil_lexique &,
                                GGS_ident_map  &) ;

  protected : virtual sint16 select_goil_syntax_4 (goil_lexique &) = 0 ;

  protected : void pr_include_file_level_goil_syntax_704_25_ (goil_lexique &,
                                GGS_implementation  &,
                                GGS_root_obj  &) ;

  protected : virtual sint16 select_goil_syntax_5 (goil_lexique &) = 0 ;

  protected : void pr_include_cpu_level_goil_syntax_722_24_ (goil_lexique &,
                                GGS_os_obj  &,
                                GGS_com  &,
                                GGS_task_map  &,
                                GGS_counter_map  &,
