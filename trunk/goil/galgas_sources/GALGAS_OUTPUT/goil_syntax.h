...
class goil_syntax {
  ...
  protected : void pr_object_definition_list_goil_syntax_270_29_ (goil_lexique &,
                                GGS_os_obj  &,
                                GGS_com  &,
                                GGS_task_map  &,
                                GGS_counter_map  &,
  ...
  protected : void pr_nm_goil_syntax_318_9_ (goil_lexique &) ;

  protected : void pr_boolean_goil_syntax_329_14_ (goil_lexique &,
                                GGS_lbool  &) ;

  protected : virtual PMSInt16 select_goil_syntax_3 (goil_lexique &) = 0 ;

  protected : void pr_free_field_goil_syntax_339_17_ (goil_lexique &,
                                GGS_ident_map  &) ;

  protected : virtual PMSInt16 select_goil_syntax_4 (goil_lexique &) = 0 ;

  protected : void pr_include_file_level_goil_syntax_362_25_ (goil_lexique &,
                                GGS_implementation  &,
                                GGS_root_obj  &) ;

  protected : virtual PMSInt16 select_goil_syntax_5 (goil_lexique &) = 0 ;

  protected : void pr_include_cpu_level_goil_syntax_380_24_ (goil_lexique &,
                                GGS_os_obj  &,
                                GGS_com  &,
                                GGS_task_map  &,
                                GGS_counter_map  &,
