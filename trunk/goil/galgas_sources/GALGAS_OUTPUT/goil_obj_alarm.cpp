...
pr_alarm_goil_obj_alarm_47_12_ (goil_lexique & inLexique,
  ...
  inLexique._assignFromAttribute_att_token (var_cas_alarm_name) ;
...
pr_alarm_action_params_goil_obj_alarm_133_26_ (goil_lexique & inLexique,
  ...
  switch (select_goil_obj_alarm_3 (inLexique)) {
    ...
    case 3 : {
      if ((GGS_bool (inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (168)))).isBuiltAndTrue ()) {
    ...
    case 4 : {
      if (((GGS_bool (inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (177)))).operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
...
pr_alarm_autostart_params_goil_obj_alarm_189_29_ (goil_lexique & inLexique,
  ...
  var_cas_alarm_time = GGS_luint64 ::constructor_new (inLexique, GGS_uint64 (0U), GGS_location (inLexique) COMMA_HERE) ;
  GGS_luint64  var_cas_cycle_time ;
  var_cas_cycle_time = GGS_luint64 ::constructor_new (inLexique, GGS_uint64 (0U), GGS_location (inLexique) COMMA_HERE) ;
    ...
    while (syntaxRepeat_5) {
      switch (select_repeat_goil_obj_alarm_5 (inLexique)) {
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          inLexique._assignFromAttribute_integerNumber (var_cas_alarm_time) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
        ...
        case 3 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          inLexique._assignFromAttribute_integerNumber (var_cas_cycle_time) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
