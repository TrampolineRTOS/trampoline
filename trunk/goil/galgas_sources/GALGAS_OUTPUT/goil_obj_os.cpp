        ...
        case 21 : {
          ...
          switch (select_goil_obj_os_3 (_inLexique)) {
            case 1 : {
                ...
                while (syntaxRepeat_4) {
                  switch (select_repeat_goil_obj_os_4 (_inLexique)) {
                    case 2 : {
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_string) COMMA_HERE) ;
                      ::routine_set_method (_inLexique,  var_cas_m,  GGS_trace_file ::constructor_new (_inLexique, GGS_location (_inLexique), var_cas_file COMMA_HERE),  GGS_string (true, "NAME") COMMA_SOURCE_FILE_AT_LINE (207)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                    ...
                    case 3 : {
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
                      ::routine_set_lstring_if_empty (_inLexique,  var_cas_f,  var_cas_fmt,  GGS_string (true, "FORMAT") COMMA_SOURCE_FILE_AT_LINE (213)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    case 4 : {
                      GGS_lbool  var_cas_b ;
                      ...
                      ::routine_set_bool (_inLexique,  var_cas_tt,  var_cas_b,  GGS_string (true, "TRACE_TASK") COMMA_SOURCE_FILE_AT_LINE (217)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    case 5 : {
                      GGS_lbool  var_cas_b ;
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
                      nt_boolean_ (_inLexique, var_cas_b) ;
                      ::routine_set_bool (_inLexique,  var_cas_ti,  var_cas_b,  GGS_string (true, "TRACE_ISR") COMMA_SOURCE_FILE_AT_LINE (221)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    case 6 : {
                      GGS_lbool  var_cas_b ;
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
                      nt_boolean_ (_inLexique, var_cas_b) ;
                      ::routine_set_bool (_inLexique,  var_cas_tr,  var_cas_b,  GGS_string (true, "TRACE_RESOURCE") COMMA_SOURCE_FILE_AT_LINE (225)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    case 7 : {
                      GGS_lbool  var_cas_b ;
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
                      nt_boolean_ (_inLexique, var_cas_b) ;
                      ::routine_set_bool (_inLexique,  var_cas_ta,  var_cas_b,  GGS_string (true, "TRACE_ALARM") COMMA_SOURCE_FILE_AT_LINE (229)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    case 8 : {
                      GGS_lbool  var_cas_b ;
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
                      nt_boolean_ (_inLexique, var_cas_b) ;
                      ::routine_set_bool (_inLexique,  var_cas_tu,  var_cas_b,  GGS_string (true, "TRACE_USER") COMMA_SOURCE_FILE_AT_LINE (233)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    case 9 : {
                      GGS_lbool  var_cas_b ;
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
                      nt_boolean_ (_inLexique, var_cas_b) ;
                      ::routine_set_bool (_inLexique,  var_cas_ds,  var_cas_b,  GGS_string (true, "DESCRIPTION") COMMA_SOURCE_FILE_AT_LINE (237)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    default :
              ...
              if (((var_cas_f.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (239)))._operator_isEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Missing FORMAT in TRACE") COMMA_SOURCE_FILE_AT_LINE (241)) ;
              }
              { const GGS_trace_method _var_7711 = var_cas_m ; // CAST instruction
                if (_var_7711.getPtr () != NULL) {
                  ...
                  if (typeid (cPtr_trace_void) == typeid (* (_var_7711.getPtr ()))) {
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Missing METHOD in TRACE") COMMA_SOURCE_FILE_AT_LINE (245)) ;
                  }else{
                  }
                }
              }
          ...
          { const GGS_trace _var_8118 = var_cas_trace ; // CAST instruction
            if (_var_8118.getPtr () != NULL) {
              ...
              if (typeid (cPtr_trace) == typeid (* (_var_8118.getPtr ()))) {
                ...
                var_cas_t.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (265)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Redefinition of TRACE") COMMA_SOURCE_FILE_AT_LINE (266)) ;
                var_cas_trace.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (266)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "was defined here") COMMA_SOURCE_FILE_AT_LINE (267)) ;
              }
            }
          }
          } break ;
