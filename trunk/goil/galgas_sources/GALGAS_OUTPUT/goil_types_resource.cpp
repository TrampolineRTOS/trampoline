...
GGS_resource_obj  function_default_resource_obj (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  var_cas_rez = GGS_resource_obj ::constructor_new (inLexique, function_empty_lstring (inLexique COMMA_SOURCE_FILE_AT_LINE (46)), GGS_resource_property_void_obj ::constructor_new (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (47)), GGS_lstringlist ::constructor_emptyList () COMMA_SOURCE_FILE_AT_LINE (45)) ;
  #ifdef DEBUG_TRACE_ENABLED
