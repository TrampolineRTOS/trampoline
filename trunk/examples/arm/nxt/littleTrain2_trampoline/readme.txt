...
- MotorControl which command the motors to be able to follow the same movements as the first robot.
- The ISR2 reveives the first robot movement by bluetooth.
