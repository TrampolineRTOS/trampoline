...
\subsection{...from `functional` directory}
	...
	\lstinputlisting[language=sh,firstline=1]{../../trampoline-trunk/check/tests.sh}
	
\appendix
\section{Test sequence example : alarms\_s11} \label{annexe_testsequenceexample}

\lstinputlisting[language=C,firstline=1]{../../trampoline-trunk/check/functional/alarms_s11/alarms_s11.oil}
\lstinputlisting[language=C,firstline=1]{../../trampoline-trunk/check/functional/alarms_s11/alarms_s11.c}
\lstinputlisting[language=C,firstline=1]{../../trampoline-trunk/check/functional/alarms_s11/task1_instance.c}
\lstinputlisting[language=C,firstline=1]{../../trampoline-trunk/check/functional/alarms_s11/task2_instance.c}
\lstinputlisting[language=C,firstline=1]{../../trampoline-trunk/check/functional/alarms_s11/task3_instance.c}
