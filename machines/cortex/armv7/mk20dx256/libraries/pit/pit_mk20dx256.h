...
/**
 *
 * Enable access to the PIT register on AIPS0 peripheral bridge in
...
/**
 * Acknowledge the PIT timer 0, 1, 2 and 3 interrupt.
 *
 * This is done by writing a 1 in bit TIF in the PIT_TFLG0 register
 * See page 905-906 of the mk20dx256 manual.
 */
