...
*/
 ...
 - tpl_it_handler and tpl_sc_handler are have been also modified to support hw mode for the INTC (interrupt controller for mpc5674f). The purpose of   this modification is to support ISR1 in oil description. Some others functions has been changed to support this mode, ex: tpl_init_interrupts function. 
 
 - For headers, modifications consist mainly on updating values in tpl_registers.h to the mpc5674f microcontroller.  