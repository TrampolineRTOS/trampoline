 ...
 *
 * $Date: 2014-06-06 09:57:51 -0500 (ven. 06 juin 2014) $
 * $Rev: 1530 $
 * $Author: jlb $
...
typedef struct 
{
  P2CONST(tpl_proc_static, TYPEDEF, OS_CONST) s_running; /* The address of the context saving area of the current process */
 ...
 * bit 0 indicates a context switch is needed after calling a service,
 * bit 1 indicated the context of the process that loses the cpu
 * should be saved.
 */
