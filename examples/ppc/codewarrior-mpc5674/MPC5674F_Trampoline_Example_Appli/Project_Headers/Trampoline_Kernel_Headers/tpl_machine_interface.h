 ...
 *
 * $Date: 2014-10-08 07:20:00 -0500 (mer. 08 oct. 2014) $
 * $Rev: 1560 $
 * $Author: mik $
 ...
 * @internal
 *
 * MPC5674F_Porting_Modif : (tpl_sleep->idle_function) is called by the idle task. It should put the system in sleep
 * mode of go in an infinite loop if there is no sleep mode available.
 */
extern FUNC(void, OS_CODE) idle_function(void);
