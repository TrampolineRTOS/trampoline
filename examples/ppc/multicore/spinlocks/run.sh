...
REMOTE_EXAMPLE_DIR="$REMOTE_TRAMPOLINE/examples/ppc/multicore/spinlocks"
...
GOIL_SOURCE="./spinlock.oil"
# Goil output (deleted on clean only)
GOIL_OUTPUT="./make.py ./build.py ./spinlock"
# Build ouptut (deleted on clean, copied from server after compilation)
BUILD_OUTPUT="./build ./spinlock_exe ./spinlock_exe.elf ./mapping"
