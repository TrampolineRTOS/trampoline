...
cflags += ["-I","../../../../../../machines/cortex-a/armv7/bcm2836"]
cppflags += ["-I","../../../../../../machines/cortex-a/armv7/bcm2836"]
...
cSourceList.append(projfile.ProjectFile("machines/cortex-a/armv7/bcm2836/bcm2836_misc.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex-a/armv7/bcm2836/handlers_bcm2836.c", trampoline_base_path))
...
cSourceList.append(projfile.ProjectFile("machines/cortex-a/armv7/bcm2836/rpi2/rpi2_trace.c", trampoline_base_path))
cSourceList.append(projfile.ProjectFile("machines/cortex-a/armv7/bcm2836/rpi2/drivers/rpi2_uart.c", trampoline_base_path))
#----------------------------------------------------------------------
...
if True:
  postCommand = makefile.PostCommand("Generating binary blink_exe.hex from blink_exe")
  postCommand.mCommand.append("arm-none-eabi-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("blink_exe")
  postCommand.mCommand.append("blink_exe.hex")
