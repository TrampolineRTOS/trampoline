...
ldflags += "-Map=checkpoint.map".split()
ldflags += ["-T", "checkpoint/script.ld"]
...
#--- OIL file
oilSourceList.append("checkpoint.oil")
...
cSourceList.append(projfile.ProjectFile("checkpoint.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("checkpoint/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("checkpoint/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("checkpoint/tpl_invoque.S"))
sSourceList.append(projfile.ProjectFile("checkpoint/tpl_irq_handlers.S"))
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("DSLite") != None:
      print("\033[1m\033[95mFlashing checkpoint_exe on msp430x/large/msp430fr5994/launchpad\033[0m")
