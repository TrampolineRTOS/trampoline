...
DeclareTask(task_check_button);
DeclareTask(task_fibo);
DeclareTask(task_serial_TX);
DeclareAlarm(Alarm_task_check_button);
DeclareAlarm(Alarm_task_fibo);
DeclareAlarm(Alarm_task_serial_TX);
