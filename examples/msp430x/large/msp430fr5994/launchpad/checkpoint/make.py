...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file checkpoint.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=msp430x/large/msp430fr5994/launchpad --templates=../../../../../../goil/templates/ checkpoint.oil")
	sys.exit(1)
...
#----------------------------------------------------------------------
oilFile = "checkpoint.oil"
oilFileDep = "build/" + oilFile + ".dep"
oilCompiler = "goil"
oilFlags = ["-t=msp430x/large/msp430fr5994/launchpad", "--templates=../../../../../../goil/templates/"]
...
#--- Add generated files
sourceList.append("checkpoint/tpl_app_config.c")

sourceList.append("checkpoint/tpl_dispatch_table.c")
sourceList.append("checkpoint/tpl_invoque.S")
sourceList.append("checkpoint/tpl_irq_handlers.S")
