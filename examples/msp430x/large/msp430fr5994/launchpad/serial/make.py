...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Make file for application serial
...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file serial.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=msp430x/large/msp430fr5994/launchpad --templates=../../../../../../goil/templates/ serial.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("serial/tpl_app_config.c")

sourceList.append("serial/tpl_dispatch_table.c")
sourceList.append("serial/tpl_invoque.S")
sourceList.append("serial/tpl_irq_handlers.S")
