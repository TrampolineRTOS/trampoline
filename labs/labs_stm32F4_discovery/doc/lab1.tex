...
\title{Trampoline Training\\$\star$\\\href{https://creativecommons.org/licenses/by-sa/3.0/fr/}{\small CC BY-SA 3.0}\\\vspace{5mm}\includegraphics[width=1.8in]{Trampoline_Beaver_by_FancyFerret.jpg}}
\author{}
...
defines the task \lstinline{my_periodic_task} in the code section of task \lstinline{my_periodic_task}.
