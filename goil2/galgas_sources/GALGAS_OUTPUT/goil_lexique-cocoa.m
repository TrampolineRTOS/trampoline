...
static const BOOL kEndOfScriptInTemplateArray_goil_5F_lexique [38] = {
  NO /* comment */,
  NO /* idf */,
  NO /* string */,
  NO /* g_string */,
...
static const C_cocoa_lexique_table_entry ktable_for_goil_5F_lexique_dataTypes [9] = {
...
static SInt32 search_into_goil_5F_lexique_dataTypes (NSString * inSearchedString) {
  return searchStringInTable (inSearchedString, ktable_for_goil_5F_lexique_dataTypes, 9) ;
}
...
- (UInt32) styleIndexForTerminal: (SInt32) inTerminal {
  static const UInt32 kTerminalSymbolStyles [39] = {0,
