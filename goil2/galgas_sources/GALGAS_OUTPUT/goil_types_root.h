...
//--------------------------------- Modifiers
  public : VIRTUAL_IN_DEBUG void modifier_del (GALGAS_lstring constinArgument0,
                                               GALGAS_identifierMap & outArgument1,
                                               C_Compiler * inCompiler
                                               COMMA_LOCATION_ARGS) ;

  public : VIRTUAL_IN_DEBUG void modifier_put (GALGAS_lstring constinArgument0,
                                               GALGAS_identifierMap constinArgument1,
                                               C_Compiler * inCompiler
                                               COMMA_LOCATION_ARGS) ;

  public : VIRTUAL_IN_DEBUG void modifier_setObjectParamsForKey (GALGAS_identifierMap constinArgument0,
...
//--------------------------------- Readers
  public : VIRTUAL_IN_DEBUG GALGAS_identifierMap reader_objectParamsForKey (const GALGAS_string & constinOperand0,
                                                                            C_Compiler * inCompiler
                                                                            COMMA_LOCATION_ARGS) const ;
...
//--- Current element access
  ...
  public : GALGAS_identifierMap current_objectParams (LOCATION_ARGS) const ;
} ;
...
GALGAS_identifierMap function_osObject (const GALGAS_objectsMap & constinArgument0,
                                        C_Compiler * inCompiler
                                        COMMA_LOCATION_ARGS) ;
...
GALGAS_identifierMap function_objectForKindAndName (const GALGAS_objectsMap & constinArgument0,
...
void routine_setObjectForKindAndName (GALGAS_objectsMap & ioArgument0,
                                      const GALGAS_string constinArgument1,
                                      const GALGAS_string constinArgument2,
                                      const GALGAS_identifierMap constinArgument3,
                                      C_Compiler * inCompiler
                                      COMMA_LOCATION_ARGS) ;
...
void routine_setENUMAttributeIfVoid (GALGAS_identifierMap & ioArgument0,
                                     ...
                                     const GALGAS_location constinArgument2,
                                     const GALGAS_string constinArgument3,
                                     const GALGAS_identifierMap constinArgument4,
                                     C_Compiler * inCompiler
                                     COMMA_LOCATION_ARGS) ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_applicationDefinition constructor_new (const GALGAS_lstring & inOperand0,
                                                                const GALGAS_objectsMap & inOperand1
                                                                COMMA_LOCATION_ARGS) ;
