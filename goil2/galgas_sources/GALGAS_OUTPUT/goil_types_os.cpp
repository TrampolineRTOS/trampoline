...
GGS_lstring  function_applicationName (C_Compiler & inLexique,
  ...
  const GGS_bool cond_5618 = (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (210))).operator_isEqual (GGS_string ("")) ;
  if (cond_5618.isBuiltAndTrue ()) {
...
GGS_basic_type  function_memory_protection (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_5836 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (219)) ; // CAST instruction
    if (_var_5836.getPtr () != NULL) {
      macroValidPointer (_var_5836.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_5836.getPtr ()))) {
        const GGS_memmap_true var_cas_mm (_var_5836.getPtr ()) ;
...
GGS_bool function_memory_protection_on (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_mp ;
  { const GGS_basic_type _var_6118 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (231)) ; // CAST instruction
    if (_var_6118.getPtr () != NULL) {
      macroValidPointer (_var_6118.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6118.getPtr ()))) {
        const GGS_memmap_true var_cas_mm (_var_6118.getPtr ()) ;
        { const GGS_basic_type _var_6082 = var_cas_mm.reader_memory_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (233)) ; // CAST instruction
          if (_var_6082.getPtr () != NULL) {
            macroValidPointer (_var_6082.getPtr ()) ;
            if (typeid (cPtr_bool_class) == typeid (* (_var_6082.getPtr ()))) {
              const GGS_bool_class var_cas_b (_var_6082.getPtr ()) ;
...
GGS_bool function_memory_mapping (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_mm ;
  { const GGS_basic_type _var_6285 = var_cas_os.reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (248)) ; // CAST instruction
    if (_var_6285.getPtr () != NULL) {
      macroValidPointer (_var_6285.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6285.getPtr ()))) {
...
GGS_string function_compiler (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_6865 = var_cas_os_memmap ; // CAST instruction
    if (_var_6865.getPtr () != NULL) {
      macroValidPointer (_var_6865.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6865.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_6865.getPtr ()) ;
        ...
        const GGS_bool cond_6814 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
        if (cond_6814.isBuiltAndTrue ()) {
          GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_cc) ;
          const GGS_bool cond_6801 = (var_cas_path.reader_directoryExists ()).operator_not () ;
          if (cond_6801.isBuiltAndTrue ()) {
        ...
        }else if (cond_6814.isBuiltAndFalse ()) {
          var_cas_cc = GGS_string ("") ;
        }
      }else{
        var_cas_cc = GGS_string ("") ;
...
GGS_string function_linker (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_7265 = var_cas_os_memmap ; // CAST instruction
    if (_var_7265.getPtr () != NULL) {
      macroValidPointer (_var_7265.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_7265.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_7265.getPtr ()) ;
        { const GGS_basic_type _var_7236 = var_cas_s.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (292)) ; // CAST instruction
          if (_var_7236.getPtr () != NULL) {
            macroValidPointer (_var_7236.getPtr ()) ;
            if (typeid (cPtr_no_linker) == typeid (* (_var_7236.getPtr ()))) {
              var_cas_lk = GGS_string ("") ;
            }else if (typeid (cPtr_yes_linker) == typeid (* (_var_7236.getPtr ()))) {
              const GGS_yes_linker var_cas_l (_var_7236.getPtr ()) ;
  ...
  const GGS_bool cond_7531 = (var_cas_lk).operator_isNotEqual (GGS_string ("")) ;
  if (cond_7531.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_7497 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
    if (cond_7497.isBuiltAndTrue ()) {
      GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_lk) ;
      const GGS_bool cond_7484 = (var_cas_path.reader_directoryExists ()).operator_not () ;
      if (cond_7484.isBuiltAndTrue ()) {
        var_cas_lk = GGS_string ("") ;
      }
    }else if (cond_7497.isBuiltAndFalse ()) {
      var_cas_lk = GGS_string ("") ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
