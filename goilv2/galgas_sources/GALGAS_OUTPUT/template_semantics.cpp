...
void routine_searchFieldIfExists (GALGAS_TvarPath inArgument_variable,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_key.reader_string (SOURCE_FILE_AT_LINE (472)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_mapType (SOURCE_FILE_AT_LINE (473)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_3 = outArgument_variableValue.reader_mStructValue (SOURCE_FILE_AT_LINE (474)).reader_hasKey (var_key.reader_string (SOURCE_FILE_AT_LINE (474)) COMMA_SOURCE_FILE_AT_LINE (474)).boolEnum () ;
        if (kBoolTrue == test_3) {
          //-------- @methodCallInstructionForGeneration
          outArgument_variableValue.reader_mStructValue (SOURCE_FILE_AT_LINE (475)).method_searchKey (var_key, outArgument_variableType, outArgument_variableValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (475)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @assignmentInstructionForGeneration
        ...
        inCompiler->emitSemanticError (location_4, GALGAS_string ("a key is only used in a map") COMMA_SOURCE_FILE_AT_LINE (481)) ;
        outArgument_found.drop () ; // Release error dropped variable
      }
    }else if (kBoolFalse == test_1) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, var_idx.reader_sint (SOURCE_FILE_AT_LINE (483)).objectCompare (GALGAS_sint ((PMSInt32) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (483)))).boolEnum () ;
      if (kBoolTrue == test_5) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_listType (SOURCE_FILE_AT_LINE (484)))).boolEnum () ;
        if (kBoolTrue == test_6) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_7 = GALGAS_bool (kIsStrictInf, var_idx.mAttribute_sint.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (485)).objectCompare (outArgument_variableValue.reader_mMapListValue (SOURCE_FILE_AT_LINE (485)).reader_length (SOURCE_FILE_AT_LINE (485)))).boolEnum () ;
          if (kBoolTrue == test_7) {
            //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
            GALGAS_TfieldMapList var_mapList = outArgument_variableValue.reader_mMapListValue (SOURCE_FILE_AT_LINE (486)) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_variableValue.mAttribute_mStructValue = var_mapList.reader_mMapAtIndex (var_idx.mAttribute_sint.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (487)), inCompiler COMMA_SOURCE_FILE_AT_LINE (487)) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_variableType = GALGAS_Ttype::constructor_structType (SOURCE_FILE_AT_LINE (488)) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_found = GALGAS_bool (true) ;
          ...
          inCompiler->emitSemanticError (location_8, GALGAS_string ("an index is only used in a list") COMMA_SOURCE_FILE_AT_LINE (494)) ;
          outArgument_found.drop () ; // Release error dropped variable
        }
      }else if (kBoolFalse == test_5) {
        //-------- @assignmentInstructionForGeneration
    ...
    //-------- @assignmentInstructionForGeneration
    outArgument_variableType = GALGAS_Ttype::constructor_unconstructedType (SOURCE_FILE_AT_LINE (500)) ;
    //-------- @assignmentInstructionForGeneration
    outArgument_variableValue = function_valueWithVoid (inCompiler COMMA_SOURCE_FILE_AT_LINE (501)) ;
    //-------- @assignmentInstructionForGeneration
    outArgument_found = GALGAS_bool (false) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_9 = GALGAS_bool (kIsStrictSup, inArgument_variable.reader_length (SOURCE_FILE_AT_LINE (504)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (outArgument_found COMMA_SOURCE_FILE_AT_LINE (504)).boolEnum () ;
  if (kBoolTrue == test_9) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_structType (SOURCE_FILE_AT_LINE (505)))).boolEnum () ;
    if (kBoolTrue == test_10) {
      { //-------- @routineCallInstructionForGeneration
      routine_searchFieldIfExists (inArgument_variable, outArgument_variableValue.reader_mStructValue (SOURCE_FILE_AT_LINE (506)), outArgument_variableType, outArgument_variableValue, outArgument_found, inCompiler COMMA_SOURCE_FILE_AT_LINE (506)) ;
      } //-------- @routineCallInstructionForGeneration
