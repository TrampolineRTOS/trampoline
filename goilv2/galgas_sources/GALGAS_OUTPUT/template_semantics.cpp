...
class cCollectionElement_TtypeList : public cCollectionElement {
  public : GALGAS_TtypeList_2E_element mObject ;
...
GALGAS_TtypeList_2E_element cEnumerator_TtypeList::current (LOCATION_ARGS) const {
...
GALGAS_TfieldMap_2E_element cEnumerator_TfieldMap::current (LOCATION_ARGS) const {
  const cMapElement_TfieldMap * p = (const cMapElement_TfieldMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_TfieldMap) ;
  return GALGAS_TfieldMap_2E_element (p->mAttribute_lkey, p->mAttribute_mType, p->mAttribute_mValue) ;
}
...
class cCollectionElement_TfieldMapList : public cCollectionElement {
  public : GALGAS_TfieldMapList_2E_element mObject ;
...
GALGAS_TfieldMapList_2E_element cEnumerator_TfieldMapList::current (LOCATION_ARGS) const {
...
class cCollectionElement_TexpressionList : public cCollectionElement {
  public : GALGAS_TexpressionList_2E_element mObject ;
...
GALGAS_TexpressionList_2E_element cEnumerator_TexpressionList::current (LOCATION_ARGS) const {
...
class cCollectionElement_TenumationList : public cCollectionElement {
  public : GALGAS_TenumationList_2E_element mObject ;
...
GALGAS_TenumationList_2E_element cEnumerator_TenumationList::current (LOCATION_ARGS) const {
...
GALGAS_Tvalue function_valueWithBool (const GALGAS_bool & constinArgument_inValue,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outValue = GALGAS_Tvalue::constructor_new (constinArgument_inValue.reader_sint_36__34_ (SOURCE_FILE_AT_LINE (121)), GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (124)), GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (125)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE_AT_LINE (126)), constinArgument_description COMMA_SOURCE_FILE_AT_LINE (120)) ;
//---
...
static GALGAS_object functionWithGenericHeader_valueWithBool (C_Compiler * inCompiler,
  ...
  return function_valueWithBool (operand0, operand1, inCompiler COMMA_THERE).reader_object (THERE) ;
}
...
GALGAS_Tvalue function_valueWithUnsigned (const GALGAS_uint_36__34_ & constinArgument_inValue,
  ...
  GALGAS_Tvalue result_outValue ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outValue = GALGAS_Tvalue::constructor_new (constinArgument_inValue.reader_sint_36__34_ (inCompiler COMMA_SOURCE_FILE_AT_LINE (139)), GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (142)), GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (143)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE_AT_LINE (144)), constinArgument_description COMMA_SOURCE_FILE_AT_LINE (138)) ;
//---
  return result_outValue ;
}
...
static GALGAS_object functionWithGenericHeader_valueWithUnsigned (C_Compiler * inCompiler,
  ...
  const GALGAS_lstring operand1 = GALGAS_lstring::extractObject (inEffectiveParameterArray.objectAtIndex (1 COMMA_HERE), inCompiler, inErrorLocation COMMA_THERE) ;
  return function_valueWithUnsigned (operand0, operand1, inCompiler COMMA_THERE).reader_object (THERE) ;
}
...
GALGAS_Tvalue function_valueWithSigned (const GALGAS_sint_36__34_ & constinArgument_inValue,
  ...
  GALGAS_Tvalue result_outValue ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outValue = GALGAS_Tvalue::constructor_new (constinArgument_inValue, GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (160)), GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (161)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE_AT_LINE (162)), constinArgument_description COMMA_SOURCE_FILE_AT_LINE (156)) ;
//---
  return result_outValue ;
}
...
static GALGAS_object functionWithGenericHeader_valueWithSigned (C_Compiler * inCompiler,
  ...
  const GALGAS_lstring operand1 = GALGAS_lstring::extractObject (inEffectiveParameterArray.objectAtIndex (1 COMMA_HERE), inCompiler, inErrorLocation COMMA_THERE) ;
  return function_valueWithSigned (operand0, operand1, inCompiler COMMA_THERE).reader_object (THERE) ;
}
...
GALGAS_Tvalue function_valueWithFloat (const GALGAS_double & constinArgument_inValue,
  ...
  GALGAS_Tvalue result_outValue ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outValue = GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((PMSInt64) 0LL), constinArgument_inValue, GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (178)), GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (179)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE_AT_LINE (180)), constinArgument_description COMMA_SOURCE_FILE_AT_LINE (174)) ;
//---
  return result_outValue ;
}
...
static GALGAS_object functionWithGenericHeader_valueWithFloat (C_Compiler * inCompiler,
  ...
  const GALGAS_lstring operand1 = GALGAS_lstring::extractObject (inEffectiveParameterArray.objectAtIndex (1 COMMA_HERE), inCompiler, inErrorLocation COMMA_THERE) ;
  return function_valueWithFloat (operand0, operand1, inCompiler COMMA_THERE).reader_object (THERE) ;
}
...
GALGAS_Tvalue function_valueWithString (const GALGAS_string & constinArgument_inValue,
  ...
  GALGAS_Tvalue result_outValue ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outValue = GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((PMSInt64) 0LL), GALGAS_double (0), constinArgument_inValue, GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (196)), GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (197)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE_AT_LINE (198)), constinArgument_description COMMA_SOURCE_FILE_AT_LINE (192)) ;
//---
  return result_outValue ;
}
...
static GALGAS_object functionWithGenericHeader_valueWithString (C_Compiler * inCompiler,
  ...
  const GALGAS_lstring operand1 = GALGAS_lstring::extractObject (inEffectiveParameterArray.objectAtIndex (1 COMMA_HERE), inCompiler, inErrorLocation COMMA_THERE) ;
  return function_valueWithString (operand0, operand1, inCompiler COMMA_THERE).reader_object (THERE) ;
}
...
GALGAS_Tvalue function_valueWithStruct (const GALGAS_TfieldMap & constinArgument_inValue,
  ...
  GALGAS_Tvalue result_outValue ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outValue = GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((PMSInt64) 0LL), GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (214)), constinArgument_inValue, function_dummyFunction (inCompiler COMMA_SOURCE_FILE_AT_LINE (216)), constinArgument_description COMMA_SOURCE_FILE_AT_LINE (210)) ;
//---
  return result_outValue ;
}
...
static GALGAS_object functionWithGenericHeader_valueWithStruct (C_Compiler * inCompiler,
  ...
  const GALGAS_lstring operand1 = GALGAS_lstring::extractObject (inEffectiveParameterArray.objectAtIndex (1 COMMA_HERE), inCompiler, inErrorLocation COMMA_THERE) ;
  return function_valueWithStruct (operand0, operand1, inCompiler COMMA_THERE).reader_object (THERE) ;
}
...
GALGAS_Tvalue function_valueWithMap (const GALGAS_TfieldMap & constinArgument_inValue,
  ...
  GALGAS_Tvalue result_outValue ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outValue = GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((PMSInt64) 0LL), GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (232)), constinArgument_inValue, function_dummyFunction (inCompiler COMMA_SOURCE_FILE_AT_LINE (234)), constinArgument_description COMMA_SOURCE_FILE_AT_LINE (228)) ;
//---
  return result_outValue ;
}
...
static GALGAS_object functionWithGenericHeader_valueWithMap (C_Compiler * inCompiler,
  ...
  const GALGAS_TfieldMap operand0 = GALGAS_TfieldMap::extractObject (inEffectiveParameterArray.objectAtIndex (0 COMMA_HERE), inCompiler, inErrorLocation COMMA_THERE) ;
  const GALGAS_lstring operand1 = GALGAS_lstring::extractObject (inEffectiveParameterArray.objectAtIndex (1 COMMA_HERE), inCompiler, inErrorLocation COMMA_THERE) ;
  return function_valueWithMap (operand0, operand1, inCompiler COMMA_THERE).reader_object (THERE) ;
}
...
GALGAS_Tvalue function_valueWithList (const GALGAS_TfieldMapList & constinArgument_inValue,
  ...
  GALGAS_Tvalue result_outValue ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outValue = GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((PMSInt64) 0LL), GALGAS_double (0), GALGAS_string::makeEmptyString (), constinArgument_inValue, GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (251)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE_AT_LINE (252)), constinArgument_description COMMA_SOURCE_FILE_AT_LINE (246)) ;
//---
  return result_outValue ;
}
...
static GALGAS_object functionWithGenericHeader_valueWithList (C_Compiler * inCompiler,
  ...
  const GALGAS_lstring operand1 = GALGAS_lstring::extractObject (inEffectiveParameterArray.objectAtIndex (1 COMMA_HERE), inCompiler, inErrorLocation COMMA_THERE) ;
  return function_valueWithList (operand0, operand1, inCompiler COMMA_THERE).reader_object (THERE) ;
}
...
GALGAS_Tvalue function_valueWithVoid (C_Compiler * inCompiler
  ...
  GALGAS_Tvalue result_outValue ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outValue = GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((PMSInt64) 0LL), GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (266)), GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (267)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE_AT_LINE (268)), GALGAS_lstring::constructor_new (GALGAS_string::makeEmptyString (), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (269)) COMMA_SOURCE_FILE_AT_LINE (262)) ;
//---
  return result_outValue ;
}
...
void routine_addBoolValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
  ...
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_boolType (SOURCE_FILE_AT_LINE (283)), function_valueWithBool (constinArgument_inValue, constinArgument_description, inCompiler COMMA_SOURCE_FILE_AT_LINE (284)), inCompiler COMMA_SOURCE_FILE_AT_LINE (281)) ;
...
void routine_addUnsignedValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                               ...
                               COMMA_UNUSED_LOCATION_ARGS) {
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_intType (SOURCE_FILE_AT_LINE (298)), function_valueWithUnsigned (constinArgument_inValue, constinArgument_description, inCompiler COMMA_SOURCE_FILE_AT_LINE (299)), inCompiler COMMA_SOURCE_FILE_AT_LINE (296)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_addSignedValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                             ...
                             COMMA_UNUSED_LOCATION_ARGS) {
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_intType (SOURCE_FILE_AT_LINE (314)), function_valueWithSigned (constinArgument_inValue, constinArgument_description, inCompiler COMMA_SOURCE_FILE_AT_LINE (315)), inCompiler COMMA_SOURCE_FILE_AT_LINE (312)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_addFloatValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                            ...
                            COMMA_UNUSED_LOCATION_ARGS) {
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_floatType (SOURCE_FILE_AT_LINE (330)), function_valueWithFloat (constinArgument_inValue, constinArgument_description, inCompiler COMMA_SOURCE_FILE_AT_LINE (331)), inCompiler COMMA_SOURCE_FILE_AT_LINE (328)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_addStringValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                             ...
                             COMMA_UNUSED_LOCATION_ARGS) {
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_stringType (SOURCE_FILE_AT_LINE (357)), function_valueWithString (constinArgument_inValue, constinArgument_description, inCompiler COMMA_SOURCE_FILE_AT_LINE (358)), inCompiler COMMA_SOURCE_FILE_AT_LINE (355)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_addLStringValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                              ...
                              COMMA_UNUSED_LOCATION_ARGS) {
  { //-------- @routineCallInstructionForGeneration
  routine_addStringValue (ioArgument_ioTemplateVariableMap, GALGAS_lstring::constructor_new (constinArgument_inVariableName, constinArgument_inValue.reader_location (SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371)), constinArgument_inValue.reader_string (SOURCE_FILE_AT_LINE (371)), constinArgument_description, inCompiler COMMA_SOURCE_FILE_AT_LINE (371)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
void routine_addListValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                           ...
                           COMMA_UNUSED_LOCATION_ARGS) {
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_listType (SOURCE_FILE_AT_LINE (384)), GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((PMSInt64) 0LL), GALGAS_double (0), GALGAS_string::makeEmptyString (), constinArgument_inValue, GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (385)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE_AT_LINE (385)), constinArgument_description COMMA_SOURCE_FILE_AT_LINE (385)), inCompiler COMMA_SOURCE_FILE_AT_LINE (382)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_addStructValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                             ...
                             COMMA_UNUSED_LOCATION_ARGS) {
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_structType (SOURCE_FILE_AT_LINE (400)), GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((PMSInt64) 0LL), GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (401)), constinArgument_inValue, function_dummyFunction (inCompiler COMMA_SOURCE_FILE_AT_LINE (401)), constinArgument_description COMMA_SOURCE_FILE_AT_LINE (401)), inCompiler COMMA_SOURCE_FILE_AT_LINE (398)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_addEnumValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                           ...
                           COMMA_UNUSED_LOCATION_ARGS) {
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_enumType (SOURCE_FILE_AT_LINE (415)), function_valueWithString (constinArgument_inValue, constinArgument_description, inCompiler COMMA_SOURCE_FILE_AT_LINE (416)), inCompiler COMMA_SOURCE_FILE_AT_LINE (413)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
class cCollectionElement_TvarPath : public cCollectionElement {
  public : GALGAS_TvarPath_2E_element mObject ;
...
GALGAS_TvarPath_2E_element cEnumerator_TvarPath::current (LOCATION_ARGS) const {
...
void routine_printPath (const GALGAS_TvarPath constinArgument_path,
  ...
  cEnumerator_TvarPath enumerator_11179 (constinArgument_path, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_11179.hasCurrentObject ()) {
    //-------- @messageInstructionForGeneration
    inCompiler->printMessage (enumerator_11179.current_item (HERE).reader_string (SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_11179.current_key (HERE).reader_string (SOURCE_FILE_AT_LINE (436)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @messageInstructionForGeneration
      inCompiler->printMessage (GALGAS_string ("[\"").operator_concat (enumerator_11179.current_key (HERE).reader_string (SOURCE_FILE_AT_LINE (437)) COMMA_SOURCE_FILE_AT_LINE (437)).operator_concat (GALGAS_string ("\"]") COMMA_SOURCE_FILE_AT_LINE (437)) COMMA_SOURCE_FILE_AT_LINE (437)) ;
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_11179.current_idx (HERE).reader_sint (SOURCE_FILE_AT_LINE (439)).objectCompare (GALGAS_sint ((PMSInt32) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (439)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @messageInstructionForGeneration
      inCompiler->printMessage (GALGAS_string ("[").operator_concat (enumerator_11179.current_idx (HERE).mAttribute_sint.reader_string (SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)) ;
    }
    if (enumerator_11179.hasNextObject ()) {
      //-------- @messageInstructionForGeneration
      inCompiler->printMessage (GALGAS_string ("::") COMMA_SOURCE_FILE_AT_LINE (442)) ;
    }
...
void routine_searchField (GALGAS_TvarPath inArgument_variable,
  ...
  { //-------- @modifierCallInstructionForGeneration
  inArgument_variable.modifier_popFirst (var_field, var_key, var_idx, inCompiler COMMA_SOURCE_FILE_AT_LINE (459)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  constinArgument_inTemplateFieldMap.method_searchKey (var_field, outArgument_variableType, outArgument_variableValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (460)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inTemplateFieldMap.reader_hasKey (var_field.reader_string (SOURCE_FILE_AT_LINE (461)) COMMA_SOURCE_FILE_AT_LINE (461)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @assignmentInstructionForGeneration
    outArgument_variableLocation = constinArgument_inTemplateFieldMap.reader_locationForKey (var_field.reader_string (SOURCE_FILE_AT_LINE (462)), inCompiler COMMA_SOURCE_FILE_AT_LINE (462)) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_key.reader_string (SOURCE_FILE_AT_LINE (464)).objectCompare (GALGAS_string::makeEmptyString ())).operator_and (GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_mapType (SOURCE_FILE_AT_LINE (464)))) COMMA_SOURCE_FILE_AT_LINE (464)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_TfieldMap var_mapMap = outArgument_variableValue.reader_mStructValue (SOURCE_FILE_AT_LINE (465)) ;
    //-------- @methodCallInstructionForGeneration
    var_mapMap.method_searchKey (var_key, outArgument_variableType, outArgument_variableValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (466)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_mapMap.reader_hasKey (var_key.reader_string (SOURCE_FILE_AT_LINE (467)) COMMA_SOURCE_FILE_AT_LINE (467)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @assignmentInstructionForGeneration
      outArgument_variableLocation = var_mapMap.reader_locationForKey (var_key.reader_string (SOURCE_FILE_AT_LINE (468)), inCompiler COMMA_SOURCE_FILE_AT_LINE (468)) ;
    }
  }else if (kBoolFalse == test_1) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_idx.reader_sint (SOURCE_FILE_AT_LINE (470)).objectCompare (GALGAS_sint ((PMSInt32) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (470)))).operator_and (GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_listType (SOURCE_FILE_AT_LINE (470)))) COMMA_SOURCE_FILE_AT_LINE (470)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_TfieldMapList var_mapList = outArgument_variableValue.reader_mMapListValue (SOURCE_FILE_AT_LINE (471)) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = GALGAS_bool (kIsStrictInf, var_idx.mAttribute_sint.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (472)).objectCompare (var_mapList.reader_length (SOURCE_FILE_AT_LINE (472)))).boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        outArgument_variableValue.mAttribute_mStructValue = var_mapList.reader_mMapAtIndex (var_idx.mAttribute_sint.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (473)), inCompiler COMMA_SOURCE_FILE_AT_LINE (473)) ;
        //-------- @assignmentInstructionForGeneration
        outArgument_variableType = GALGAS_Ttype::constructor_structType (SOURCE_FILE_AT_LINE (474)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("index: ").operator_concat (var_idx.reader_sint (SOURCE_FILE_AT_LINE (476)).reader_string (SOURCE_FILE_AT_LINE (476)) COMMA_SOURCE_FILE_AT_LINE (476)).operator_concat (GALGAS_string (" >= length:") COMMA_SOURCE_FILE_AT_LINE (476)).operator_concat (var_mapList.reader_length (SOURCE_FILE_AT_LINE (476)).reader_string (SOURCE_FILE_AT_LINE (476)) COMMA_SOURCE_FILE_AT_LINE (476)) COMMA_SOURCE_FILE_AT_LINE (476)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, inArgument_variable.reader_length (SOURCE_FILE_AT_LINE (479)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_structType (SOURCE_FILE_AT_LINE (480)))).boolEnum () ;
    if (kBoolTrue == test_6) {
      { //-------- @routineCallInstructionForGeneration
      routine_searchField (inArgument_variable, outArgument_variableValue.reader_mStructValue (SOURCE_FILE_AT_LINE (481)), outArgument_variableType, outArgument_variableValue, outArgument_variableLocation, inCompiler COMMA_SOURCE_FILE_AT_LINE (481)) ;
      } //-------- @routineCallInstructionForGeneration
      ...
      inCompiler->emitSemanticError (location_7, GALGAS_string ("struct variable expected") COMMA_SOURCE_FILE_AT_LINE (484)) ;
      outArgument_variableValue.drop () ; // Release error dropped variable
    }
  }
}
...
void routine_searchFieldIfExists (GALGAS_TvarPath inArgument_variable,
  ...
  GALGAS_lsint var_idx ;
  { //-------- @modifierCallInstructionForGeneration
  inArgument_variable.modifier_popFirst (var_field, var_key, var_idx, inCompiler COMMA_SOURCE_FILE_AT_LINE (501)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inTemplateFieldMap.reader_hasKey (var_field.reader_string (SOURCE_FILE_AT_LINE (503)) COMMA_SOURCE_FILE_AT_LINE (503)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_inTemplateFieldMap.method_searchKey (var_field, outArgument_variableType, outArgument_variableValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (504)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_key.reader_string (SOURCE_FILE_AT_LINE (505)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_mapType (SOURCE_FILE_AT_LINE (506)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_3 = outArgument_variableValue.reader_mStructValue (SOURCE_FILE_AT_LINE (507)).reader_hasKey (var_key.reader_string (SOURCE_FILE_AT_LINE (507)) COMMA_SOURCE_FILE_AT_LINE (507)).boolEnum () ;
        if (kBoolTrue == test_3) {
          //-------- @methodCallInstructionForGeneration
          outArgument_variableValue.reader_mStructValue (SOURCE_FILE_AT_LINE (508)).method_searchKey (var_key, outArgument_variableType, outArgument_variableValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (508)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @assignmentInstructionForGeneration
        ...
        inCompiler->emitSemanticError (location_4, GALGAS_string ("a key is only used in a map") COMMA_SOURCE_FILE_AT_LINE (514)) ;
        outArgument_found.drop () ; // Release error dropped variable
      }
    }else if (kBoolFalse == test_1) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, var_idx.reader_sint (SOURCE_FILE_AT_LINE (516)).objectCompare (GALGAS_sint ((PMSInt32) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (516)))).boolEnum () ;
      if (kBoolTrue == test_5) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_listType (SOURCE_FILE_AT_LINE (517)))).boolEnum () ;
        if (kBoolTrue == test_6) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_7 = GALGAS_bool (kIsStrictInf, var_idx.mAttribute_sint.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (518)).objectCompare (outArgument_variableValue.reader_mMapListValue (SOURCE_FILE_AT_LINE (518)).reader_length (SOURCE_FILE_AT_LINE (518)))).boolEnum () ;
          if (kBoolTrue == test_7) {
            //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
            GALGAS_TfieldMapList var_mapList = outArgument_variableValue.reader_mMapListValue (SOURCE_FILE_AT_LINE (519)) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_variableValue.mAttribute_mStructValue = var_mapList.reader_mMapAtIndex (var_idx.mAttribute_sint.reader_uint (inCompiler COMMA_SOURCE_FILE_AT_LINE (520)), inCompiler COMMA_SOURCE_FILE_AT_LINE (520)) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_variableType = GALGAS_Ttype::constructor_structType (SOURCE_FILE_AT_LINE (521)) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_found = GALGAS_bool (true) ;
          ...
          inCompiler->emitSemanticError (location_8, GALGAS_string ("an index is only used in a list") COMMA_SOURCE_FILE_AT_LINE (527)) ;
          outArgument_found.drop () ; // Release error dropped variable
        }
    ...
    //-------- @assignmentInstructionForGeneration
    outArgument_variableType = GALGAS_Ttype::constructor_unconstructedType (SOURCE_FILE_AT_LINE (533)) ;
    //-------- @assignmentInstructionForGeneration
    outArgument_variableValue = function_valueWithVoid (inCompiler COMMA_SOURCE_FILE_AT_LINE (534)) ;
    //-------- @assignmentInstructionForGeneration
    outArgument_found = GALGAS_bool (false) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_9 = GALGAS_bool (kIsStrictSup, inArgument_variable.reader_length (SOURCE_FILE_AT_LINE (537)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (outArgument_found COMMA_SOURCE_FILE_AT_LINE (537)).boolEnum () ;
  if (kBoolTrue == test_9) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_structType (SOURCE_FILE_AT_LINE (538)))).boolEnum () ;
    if (kBoolTrue == test_10) {
      { //-------- @routineCallInstructionForGeneration
      routine_searchFieldIfExists (inArgument_variable, outArgument_variableValue.reader_mStructValue (SOURCE_FILE_AT_LINE (539)), outArgument_variableType, outArgument_variableValue, outArgument_found, inCompiler COMMA_SOURCE_FILE_AT_LINE (539)) ;
      } //-------- @routineCallInstructionForGeneration
...
GALGAS_TtypeList_2E_element::GALGAS_TtypeList_2E_element (void) :
mAttribute_mType () {
}
...
GALGAS_TtypeList_2E_element::GALGAS_TtypeList_2E_element (const GALGAS_Ttype & inOperand0) :
mAttribute_mType (inOperand0) {
}

//---------------------------------------------------------------------------*

GALGAS_TtypeList_2E_element GALGAS_TtypeList_2E_element::constructor_new (const GALGAS_Ttype & inOperand0 
                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_TtypeList_2E_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_TtypeList_2E_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_TtypeList_2E_element::objectCompare (const GALGAS_TtypeList_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_TtypeList_2E_element::isValid (void) const {
  return mAttribute_mType.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_TtypeList_2E_element::drop (void) {
  mAttribute_mType.drop () ;
}

//---------------------------------------------------------------------------*

void GALGAS_TtypeList_2E_element::description (C_String & ioString,
                                               const PMSInt32 inIndentation) const {
...
GALGAS_Ttype GALGAS_TtypeList_2E_element::reader_mType (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_TtypeList_2E_element ("TtypeList.element",
                                             NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_TtypeList_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_TtypeList_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_TtypeList_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_TtypeList_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_TtypeList_2E_element GALGAS_TtypeList_2E_element::extractObject (const GALGAS_object & inObject,
                                                                        C_Compiler * inCompiler,
                                                                        const GALGAS_location & inErrorLocation
                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_TtypeList_2E_element result ;
  const GALGAS_TtypeList_2E_element * p = (const GALGAS_TtypeList_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_TtypeList_2E_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "TtypeList.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_TfieldMap_2E_element::GALGAS_TfieldMap_2E_element (void) :
mAttribute_lkey (),
mAttribute_mType (),
mAttribute_mValue () {
}
...
GALGAS_TfieldMap_2E_element::GALGAS_TfieldMap_2E_element (const GALGAS_lstring & inOperand0,
                                                          const GALGAS_Ttype & inOperand1,
...
GALGAS_TfieldMap_2E_element GALGAS_TfieldMap_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                          const GALGAS_Ttype & inOperand1,
                                                                          const GALGAS_Tvalue & inOperand2 
                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_TfieldMap_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_TfieldMap_2E_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_TfieldMap_2E_element::objectCompare (const GALGAS_TfieldMap_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_TfieldMap_2E_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mType.isValid () && mAttribute_mValue.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_TfieldMap_2E_element::drop (void) {
...
void GALGAS_TfieldMap_2E_element::description (C_String & ioString,
                                               const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_TfieldMap_2E_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_Ttype GALGAS_TfieldMap_2E_element::reader_mType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mType ;
}

//---------------------------------------------------------------------------*

GALGAS_Tvalue GALGAS_TfieldMap_2E_element::reader_mValue (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_TfieldMap_2E_element ("TfieldMap.element",
                                             NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_TfieldMap_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_TfieldMap_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_TfieldMap_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_TfieldMap_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_TfieldMap_2E_element GALGAS_TfieldMap_2E_element::extractObject (const GALGAS_object & inObject,
                                                                        C_Compiler * inCompiler,
                                                                        const GALGAS_location & inErrorLocation
                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_TfieldMap_2E_element result ;
  const GALGAS_TfieldMap_2E_element * p = (const GALGAS_TfieldMap_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_TfieldMap_2E_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "TfieldMap.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_TfieldMapList_2E_element::GALGAS_TfieldMapList_2E_element (void) :
mAttribute_mMap () {
}
...
GALGAS_TfieldMapList_2E_element::GALGAS_TfieldMapList_2E_element (const GALGAS_TfieldMap & inOperand0) :
mAttribute_mMap (inOperand0) {
}

//---------------------------------------------------------------------------*

GALGAS_TfieldMapList_2E_element GALGAS_TfieldMapList_2E_element::constructor_new (const GALGAS_TfieldMap & inOperand0 
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_TfieldMapList_2E_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_TfieldMapList_2E_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_TfieldMapList_2E_element::objectCompare (const GALGAS_TfieldMapList_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_TfieldMapList_2E_element::isValid (void) const {
  return mAttribute_mMap.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_TfieldMapList_2E_element::drop (void) {
  mAttribute_mMap.drop () ;
}

//---------------------------------------------------------------------------*

void GALGAS_TfieldMapList_2E_element::description (C_String & ioString,
                                                   const PMSInt32 inIndentation) const {
...
GALGAS_TfieldMap GALGAS_TfieldMapList_2E_element::reader_mMap (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_TfieldMapList_2E_element ("TfieldMapList.element",
                                                 NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_TfieldMapList_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_TfieldMapList_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_TfieldMapList_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_TfieldMapList_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_TfieldMapList_2E_element GALGAS_TfieldMapList_2E_element::extractObject (const GALGAS_object & inObject,
                                                                                C_Compiler * inCompiler,
                                                                                const GALGAS_location & inErrorLocation
                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_TfieldMapList_2E_element result ;
  const GALGAS_TfieldMapList_2E_element * p = (const GALGAS_TfieldMapList_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_TfieldMapList_2E_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "TfieldMapList.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_TexpressionList_2E_element::GALGAS_TexpressionList_2E_element (void) :
mAttribute_mValue (),
mAttribute_mType () {
}
...
GALGAS_TexpressionList_2E_element::GALGAS_TexpressionList_2E_element (const GALGAS_Tvalue & inOperand0,
                                                                      const GALGAS_Ttype & inOperand1) :
...
GALGAS_TexpressionList_2E_element GALGAS_TexpressionList_2E_element::constructor_new (const GALGAS_Tvalue & inOperand0,
                                                                                      const GALGAS_Ttype & inOperand1 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_TexpressionList_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_TexpressionList_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_TexpressionList_2E_element::objectCompare (const GALGAS_TexpressionList_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mValue.objectCompare (inOperand.mAttribute_mValue) ;
  }
...
bool GALGAS_TexpressionList_2E_element::isValid (void) const {
  return mAttribute_mValue.isValid () && mAttribute_mType.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_TexpressionList_2E_element::drop (void) {
  mAttribute_mValue.drop () ;
  mAttribute_mType.drop () ;
}
...
void GALGAS_TexpressionList_2E_element::description (C_String & ioString,
                                                     const PMSInt32 inIndentation) const {
...
GALGAS_Tvalue GALGAS_TexpressionList_2E_element::reader_mValue (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mValue ;
}

//---------------------------------------------------------------------------*

GALGAS_Ttype GALGAS_TexpressionList_2E_element::reader_mType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mType ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_TexpressionList_2E_element ("TexpressionList.element",
                                                   NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_TexpressionList_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_TexpressionList_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_TexpressionList_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_TexpressionList_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_TexpressionList_2E_element GALGAS_TexpressionList_2E_element::extractObject (const GALGAS_object & inObject,
                                                                                    C_Compiler * inCompiler,
                                                                                    const GALGAS_location & inErrorLocation
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_TexpressionList_2E_element result ;
  const GALGAS_TexpressionList_2E_element * p = (const GALGAS_TexpressionList_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_TexpressionList_2E_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "TexpressionList.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_TenumationList_2E_element::GALGAS_TenumationList_2E_element (void) :
...
GALGAS_TenumationList_2E_element::GALGAS_TenumationList_2E_element (const GALGAS_Tvalue & inOperand0,
                                                                    const GALGAS_string & inOperand1) :
...
GALGAS_TenumationList_2E_element GALGAS_TenumationList_2E_element::constructor_new (const GALGAS_Tvalue & inOperand0,
                                                                                    const GALGAS_string & inOperand1 
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_TenumationList_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_TenumationList_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_TenumationList_2E_element::objectCompare (const GALGAS_TenumationList_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_TenumationList_2E_element::isValid (void) const {
  return mAttribute_mEnumeratedValue.isValid () && mAttribute_mPrefix.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_TenumationList_2E_element::drop (void) {
...
void GALGAS_TenumationList_2E_element::description (C_String & ioString,
                                                    const PMSInt32 inIndentation) const {
...
GALGAS_Tvalue GALGAS_TenumationList_2E_element::reader_mEnumeratedValue (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mEnumeratedValue ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_TenumationList_2E_element::reader_mPrefix (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_TenumationList_2E_element ("TenumationList.element",
                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_TenumationList_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_TenumationList_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_TenumationList_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_TenumationList_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_TenumationList_2E_element GALGAS_TenumationList_2E_element::extractObject (const GALGAS_object & inObject,
                                                                                  C_Compiler * inCompiler,
                                                                                  const GALGAS_location & inErrorLocation
                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_TenumationList_2E_element result ;
  const GALGAS_TenumationList_2E_element * p = (const GALGAS_TenumationList_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_TenumationList_2E_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "TenumationList.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_TvarPath_2E_element::GALGAS_TvarPath_2E_element (void) :
mAttribute_item (),
mAttribute_key (),
mAttribute_idx () {
}
...
GALGAS_TvarPath_2E_element::GALGAS_TvarPath_2E_element (const GALGAS_lstring & inOperand0,
                                                        const GALGAS_lstring & inOperand1,
                                                        const GALGAS_lsint & inOperand2) :
...
GALGAS_TvarPath_2E_element GALGAS_TvarPath_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                        const GALGAS_lstring & inOperand1,
                                                                        const GALGAS_lsint & inOperand2 
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_TvarPath_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_TvarPath_2E_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_TvarPath_2E_element::objectCompare (const GALGAS_TvarPath_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_TvarPath_2E_element::isValid (void) const {
  return mAttribute_item.isValid () && mAttribute_key.isValid () && mAttribute_idx.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_TvarPath_2E_element::drop (void) {
...
void GALGAS_TvarPath_2E_element::description (C_String & ioString,
                                              const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_TvarPath_2E_element::reader_item (UNUSED_LOCATION_ARGS) const {
  return mAttribute_item ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_TvarPath_2E_element::reader_key (UNUSED_LOCATION_ARGS) const {
  return mAttribute_key ;
}

//---------------------------------------------------------------------------*

GALGAS_lsint GALGAS_TvarPath_2E_element::reader_idx (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_TvarPath_2E_element ("TvarPath.element",
                                            NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_TvarPath_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_TvarPath_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_TvarPath_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_TvarPath_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_TvarPath_2E_element GALGAS_TvarPath_2E_element::extractObject (const GALGAS_object & inObject,
                                                                      C_Compiler * inCompiler,
                                                                      const GALGAS_location & inErrorLocation
                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_TvarPath_2E_element result ;
  const GALGAS_TvarPath_2E_element * p = (const GALGAS_TvarPath_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_TvarPath_2E_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "TvarPath.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
