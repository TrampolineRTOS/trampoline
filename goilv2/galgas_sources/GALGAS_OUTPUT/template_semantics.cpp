...
GALGAS_Tfunction function_dummyFunction (C_Compiler * inCompiler
  ...
  result_fct = GALGAS_Tfunction::constructor_new (GALGAS_lstring::constructor_new (GALGAS_string::makeEmptyString (), inCompiler->here ()  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 78)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("template_semantics.gSemantics", 78)), GALGAS_string::makeEmptyString ()  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 78)) ;
//---
  return result_fct ;
}
...
GALGAS_Tvalue function_valueWithBool (const GALGAS_bool & constinArgument_inValue,
  ...
  result_outValue = GALGAS_Tvalue::constructor_new (constinArgument_inValue.reader_sint_36__34_ (SOURCE_FILE ("template_semantics.gSemantics", 121)), GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE ("template_semantics.gSemantics", 124)), GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE ("template_semantics.gSemantics", 125)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 126)), constinArgument_description  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 120)) ;
//---
...
GALGAS_Tvalue function_valueWithUnsigned (const GALGAS_uint_36__34_ & constinArgument_inValue,
                                          ...
                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Tvalue result_outValue ; // Returned variable
  result_outValue = GALGAS_Tvalue::constructor_new (constinArgument_inValue.reader_sint_36__34_ (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 139)), GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE ("template_semantics.gSemantics", 142)), GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE ("template_semantics.gSemantics", 143)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 144)), constinArgument_description  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 138)) ;
//---
  return result_outValue ;
}
...
GALGAS_Tvalue function_valueWithSigned (const GALGAS_sint_36__34_ & constinArgument_inValue,
                                        ...
                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Tvalue result_outValue ; // Returned variable
  result_outValue = GALGAS_Tvalue::constructor_new (constinArgument_inValue, GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE ("template_semantics.gSemantics", 160)), GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE ("template_semantics.gSemantics", 161)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 162)), constinArgument_description  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 156)) ;
//---
  return result_outValue ;
}
...
GALGAS_Tvalue function_valueWithFloat (const GALGAS_double & constinArgument_inValue,
                                       ...
                                       COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Tvalue result_outValue ; // Returned variable
  result_outValue = GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((int64_t) 0LL), constinArgument_inValue, GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE ("template_semantics.gSemantics", 178)), GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE ("template_semantics.gSemantics", 179)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 180)), constinArgument_description  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 174)) ;
//---
  return result_outValue ;
}
...
GALGAS_Tvalue function_valueWithString (const GALGAS_string & constinArgument_inValue,
                                        ...
                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Tvalue result_outValue ; // Returned variable
  result_outValue = GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((int64_t) 0LL), GALGAS_double (0), constinArgument_inValue, GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE ("template_semantics.gSemantics", 196)), GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE ("template_semantics.gSemantics", 197)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 198)), constinArgument_description  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 192)) ;
//---
  return result_outValue ;
}
...
GALGAS_Tvalue function_valueWithStruct (const GALGAS_TfieldMap & constinArgument_inValue,
                                        ...
                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Tvalue result_outValue ; // Returned variable
  result_outValue = GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((int64_t) 0LL), GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE ("template_semantics.gSemantics", 214)), constinArgument_inValue, function_dummyFunction (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 216)), constinArgument_description  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 210)) ;
//---
  return result_outValue ;
}
...
GALGAS_Tvalue function_valueWithMap (const GALGAS_TfieldMap & constinArgument_inValue,
                                     ...
                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Tvalue result_outValue ; // Returned variable
  result_outValue = GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((int64_t) 0LL), GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE ("template_semantics.gSemantics", 232)), constinArgument_inValue, function_dummyFunction (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 234)), constinArgument_description  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 228)) ;
//---
  return result_outValue ;
}
...
GALGAS_Tvalue function_valueWithList (const GALGAS_TfieldMapList & constinArgument_inValue,
                                      ...
                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Tvalue result_outValue ; // Returned variable
  result_outValue = GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((int64_t) 0LL), GALGAS_double (0), GALGAS_string::makeEmptyString (), constinArgument_inValue, GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE ("template_semantics.gSemantics", 251)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 252)), constinArgument_description  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 246)) ;
//---
  return result_outValue ;
}
...
GALGAS_Tvalue function_valueWithVoid (C_Compiler * inCompiler
                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_Tvalue result_outValue ; // Returned variable
  result_outValue = GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((int64_t) 0LL), GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE ("template_semantics.gSemantics", 266)), GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE ("template_semantics.gSemantics", 267)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 268)), GALGAS_lstring::constructor_new (GALGAS_string::makeEmptyString (), inCompiler->here ()  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 269))  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 262)) ;
//---
  return result_outValue ;
}
...
void routine_addBoolValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                           ...
                           COMMA_UNUSED_LOCATION_ARGS) {
  {
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_boolType (SOURCE_FILE ("template_semantics.gSemantics", 283)), function_valueWithBool (constinArgument_inValue, constinArgument_description, inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 284)), inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 281)) ;
  }
}
...
void routine_addUnsignedValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                               ...
                               COMMA_UNUSED_LOCATION_ARGS) {
  {
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_intType (SOURCE_FILE ("template_semantics.gSemantics", 298)), function_valueWithUnsigned (constinArgument_inValue, constinArgument_description, inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 299)), inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 296)) ;
  }
}
...
void routine_addSignedValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                             ...
                             COMMA_UNUSED_LOCATION_ARGS) {
  {
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_intType (SOURCE_FILE ("template_semantics.gSemantics", 314)), function_valueWithSigned (constinArgument_inValue, constinArgument_description, inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 315)), inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 312)) ;
  }
}
...
void routine_addFloatValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                            ...
                            COMMA_UNUSED_LOCATION_ARGS) {
  {
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_floatType (SOURCE_FILE ("template_semantics.gSemantics", 330)), function_valueWithFloat (constinArgument_inValue, constinArgument_description, inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 331)), inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 328)) ;
  }
}
...
void routine_addLUnsignedValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  {
  routine_addUnsignedValue (ioArgument_ioTemplateVariableMap, GALGAS_lstring::constructor_new (constinArgument_inVariableName, constinArgument_inValue.reader_location (SOURCE_FILE ("template_semantics.gSemantics", 344))  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 344)), constinArgument_inValue.reader_uint_36__34_ (SOURCE_FILE ("template_semantics.gSemantics", 344)), constinArgument_description, inCompiler  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 344)) ;
  }
}
...
void routine_addStringValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                             ...
                             COMMA_UNUSED_LOCATION_ARGS) {
  {
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_stringType (SOURCE_FILE ("template_semantics.gSemantics", 357)), function_valueWithString (constinArgument_inValue, constinArgument_description, inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 358)), inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 355)) ;
  }
}
...
void routine_addLStringValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                              ...
                              COMMA_UNUSED_LOCATION_ARGS) {
  {
  routine_addStringValue (ioArgument_ioTemplateVariableMap, GALGAS_lstring::constructor_new (constinArgument_inVariableName, constinArgument_inValue.reader_location (SOURCE_FILE ("template_semantics.gSemantics", 371))  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 371)), constinArgument_inValue.reader_string (SOURCE_FILE ("template_semantics.gSemantics", 371)), constinArgument_description, inCompiler  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 371)) ;
  }
}
...
void routine_addListValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                           ...
                           COMMA_UNUSED_LOCATION_ARGS) {
  {
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_listType (SOURCE_FILE ("template_semantics.gSemantics", 384)), GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((int64_t) 0LL), GALGAS_double (0), GALGAS_string::makeEmptyString (), constinArgument_inValue, GALGAS_TfieldMap::constructor_emptyMap (SOURCE_FILE ("template_semantics.gSemantics", 385)), function_dummyFunction (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 385)), constinArgument_description  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 385)), inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 382)) ;
  }
}
...
void routine_addStructValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                             ...
                             COMMA_UNUSED_LOCATION_ARGS) {
  {
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_structType (SOURCE_FILE ("template_semantics.gSemantics", 400)), GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((int64_t) 0LL), GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE ("template_semantics.gSemantics", 401)), constinArgument_inValue, function_dummyFunction (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 401)), constinArgument_description  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 401)), inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 398)) ;
  }
}
...
void routine_addEnumValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                           ...
                           COMMA_UNUSED_LOCATION_ARGS) {
  {
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_enumType (SOURCE_FILE ("template_semantics.gSemantics", 415)), function_valueWithString (constinArgument_inValue, constinArgument_description, inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 416)), inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 413)) ;
  }
}
...
void routine_printPath (const GALGAS_TvarPath constinArgument_path,
  ...
  while (enumerator_11194.hasCurrentObject ()) {
    inCompiler->printMessage (enumerator_11194.current_item (HERE).reader_string (SOURCE_FILE ("template_semantics.gSemantics", 435))  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 435)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_11194.current_key (HERE).reader_string (SOURCE_FILE ("template_semantics.gSemantics", 436)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      inCompiler->printMessage (GALGAS_string ("[\"").operator_concat (enumerator_11194.current_key (HERE).reader_string (SOURCE_FILE ("template_semantics.gSemantics", 437))  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 437)).operator_concat (GALGAS_string ("\"]")  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 437))  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 437)) ;
    }
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_11194.current_idx (HERE).reader_sint (SOURCE_FILE ("template_semantics.gSemantics", 439)).objectCompare (GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 439)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->printMessage (GALGAS_string ("[").operator_concat (enumerator_11194.current_idx (HERE).mAttribute_sint.reader_string (SOURCE_FILE ("template_semantics.gSemantics", 440))  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 440)).operator_concat (GALGAS_string ("]")  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 440))  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 440)) ;
    }
    if (enumerator_11194.hasNextObject ()) {
      inCompiler->printMessage (GALGAS_string ("::")  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 442)) ;
    }
...
void routine_searchField (GALGAS_TvarPath inArgument_variable,
  ...
  {
  inArgument_variable.modifier_popFirst (var_field, var_key, var_idx, inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 459)) ;
  }
  constinArgument_inTemplateFieldMap.method_searchKey (var_field, outArgument_variableType, outArgument_variableValue, inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 460)) ;
  const enumGalgasBool test_0 = constinArgument_inTemplateFieldMap.reader_hasKey (var_field.reader_string (SOURCE_FILE ("template_semantics.gSemantics", 461)) COMMA_SOURCE_FILE ("template_semantics.gSemantics", 461)).boolEnum () ;
  if (kBoolTrue == test_0) {
    outArgument_variableLocation = constinArgument_inTemplateFieldMap.reader_locationForKey (var_field.reader_string (SOURCE_FILE ("template_semantics.gSemantics", 462)), inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 462)) ;
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_key.reader_string (SOURCE_FILE ("template_semantics.gSemantics", 464)).objectCompare (GALGAS_string::makeEmptyString ())).operator_and (GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_mapType (SOURCE_FILE ("template_semantics.gSemantics", 464)))) COMMA_SOURCE_FILE ("template_semantics.gSemantics", 464)).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_TfieldMap var_mapMap = outArgument_variableValue.reader_mStructValue (SOURCE_FILE ("template_semantics.gSemantics", 465)) ;
    var_mapMap.method_searchKey (var_key, outArgument_variableType, outArgument_variableValue, inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 466)) ;
    const enumGalgasBool test_2 = var_mapMap.reader_hasKey (var_key.reader_string (SOURCE_FILE ("template_semantics.gSemantics", 467)) COMMA_SOURCE_FILE ("template_semantics.gSemantics", 467)).boolEnum () ;
    if (kBoolTrue == test_2) {
      outArgument_variableLocation = var_mapMap.reader_locationForKey (var_key.reader_string (SOURCE_FILE ("template_semantics.gSemantics", 468)), inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 468)) ;
    }
  }else if (kBoolFalse == test_1) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_idx.reader_sint (SOURCE_FILE ("template_semantics.gSemantics", 470)).objectCompare (GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 470)))).operator_and (GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_listType (SOURCE_FILE ("template_semantics.gSemantics", 470)))) COMMA_SOURCE_FILE ("template_semantics.gSemantics", 470)).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_TfieldMapList var_mapList = outArgument_variableValue.reader_mMapListValue (SOURCE_FILE ("template_semantics.gSemantics", 471)) ;
      const enumGalgasBool test_4 = GALGAS_bool (kIsStrictInf, var_idx.mAttribute_sint.reader_uint (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 472)).objectCompare (var_mapList.reader_length (SOURCE_FILE ("template_semantics.gSemantics", 472)))).boolEnum () ;
      if (kBoolTrue == test_4) {
        outArgument_variableValue.mAttribute_mStructValue = var_mapList.reader_mMapAtIndex (var_idx.mAttribute_sint.reader_uint (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 473)), inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 473)) ;
        outArgument_variableType = GALGAS_Ttype::constructor_structType (SOURCE_FILE ("template_semantics.gSemantics", 474)) ;
      }else if (kBoolFalse == test_4) {
        inCompiler->emitSemanticError (inCompiler->here (), GALGAS_string ("index: ").operator_concat (var_idx.reader_sint (SOURCE_FILE ("template_semantics.gSemantics", 476)).reader_string (SOURCE_FILE ("template_semantics.gSemantics", 476))  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 476)).operator_concat (GALGAS_string (" >= length:")  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 476)).operator_concat (var_mapList.reader_length (SOURCE_FILE ("template_semantics.gSemantics", 476)).reader_string (SOURCE_FILE ("template_semantics.gSemantics", 476))  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 476))  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 476)) ;
  ...
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, inArgument_variable.reader_length (SOURCE_FILE ("template_semantics.gSemantics", 479)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_structType (SOURCE_FILE ("template_semantics.gSemantics", 480)))).boolEnum () ;
    if (kBoolTrue == test_6) {
      {
      routine_searchField (inArgument_variable, outArgument_variableValue.reader_mStructValue (SOURCE_FILE ("template_semantics.gSemantics", 481)), outArgument_variableType, outArgument_variableValue, outArgument_variableLocation, inCompiler  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 481)) ;
      }
    }else if (kBoolFalse == test_6) {
      outArgument_variableLocation = inCompiler->here () ;
      GALGAS_location location_7 (var_field.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_7, GALGAS_string ("struct variable expected")  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 484)) ;
      outArgument_variableValue.drop () ; // Release error dropped variable
    }
  }
}
...
void routine_searchFieldIfExists (GALGAS_TvarPath inArgument_variable,
  ...
  GALGAS_lsint var_idx ;
  {
  inArgument_variable.modifier_popFirst (var_field, var_key, var_idx, inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 501)) ;
  }
  const enumGalgasBool test_0 = constinArgument_inTemplateFieldMap.reader_hasKey (var_field.reader_string (SOURCE_FILE ("template_semantics.gSemantics", 503)) COMMA_SOURCE_FILE ("template_semantics.gSemantics", 503)).boolEnum () ;
  if (kBoolTrue == test_0) {
    constinArgument_inTemplateFieldMap.method_searchKey (var_field, outArgument_variableType, outArgument_variableValue, inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 504)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_key.reader_string (SOURCE_FILE ("template_semantics.gSemantics", 505)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_mapType (SOURCE_FILE ("template_semantics.gSemantics", 506)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        const enumGalgasBool test_3 = outArgument_variableValue.reader_mStructValue (SOURCE_FILE ("template_semantics.gSemantics", 507)).reader_hasKey (var_key.reader_string (SOURCE_FILE ("template_semantics.gSemantics", 507)) COMMA_SOURCE_FILE ("template_semantics.gSemantics", 507)).boolEnum () ;
        if (kBoolTrue == test_3) {
          outArgument_variableValue.reader_mStructValue (SOURCE_FILE ("template_semantics.gSemantics", 508)).method_searchKey (var_key, outArgument_variableType, outArgument_variableValue, inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 508)) ;
        ...
        inCompiler->emitSemanticError (location_4, GALGAS_string ("a key is only used in a map")  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 514)) ;
        outArgument_found.drop () ; // Release error dropped variable
      }
    }else if (kBoolFalse == test_1) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, var_idx.reader_sint (SOURCE_FILE ("template_semantics.gSemantics", 516)).objectCompare (GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 516)))).boolEnum () ;
      if (kBoolTrue == test_5) {
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_listType (SOURCE_FILE ("template_semantics.gSemantics", 517)))).boolEnum () ;
        if (kBoolTrue == test_6) {
          const enumGalgasBool test_7 = GALGAS_bool (kIsStrictInf, var_idx.mAttribute_sint.reader_uint (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 518)).objectCompare (outArgument_variableValue.reader_mMapListValue (SOURCE_FILE ("template_semantics.gSemantics", 518)).reader_length (SOURCE_FILE ("template_semantics.gSemantics", 518)))).boolEnum () ;
          if (kBoolTrue == test_7) {
            GALGAS_TfieldMapList var_mapList = outArgument_variableValue.reader_mMapListValue (SOURCE_FILE ("template_semantics.gSemantics", 519)) ;
            outArgument_variableValue.mAttribute_mStructValue = var_mapList.reader_mMapAtIndex (var_idx.mAttribute_sint.reader_uint (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 520)), inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 520)) ;
            outArgument_variableType = GALGAS_Ttype::constructor_structType (SOURCE_FILE ("template_semantics.gSemantics", 521)) ;
            outArgument_found = GALGAS_bool (true) ;
          ...
          inCompiler->emitSemanticError (location_8, GALGAS_string ("an index is only used in a list")  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 527)) ;
          outArgument_found.drop () ; // Release error dropped variable
        }
    ...
    outArgument_variableType = GALGAS_Ttype::constructor_unconstructedType (SOURCE_FILE ("template_semantics.gSemantics", 533)) ;
    outArgument_variableValue = function_valueWithVoid (inCompiler COMMA_SOURCE_FILE ("template_semantics.gSemantics", 534)) ;
    outArgument_found = GALGAS_bool (false) ;
  }
  const enumGalgasBool test_9 = GALGAS_bool (kIsStrictSup, inArgument_variable.reader_length (SOURCE_FILE ("template_semantics.gSemantics", 537)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (outArgument_found COMMA_SOURCE_FILE ("template_semantics.gSemantics", 537)).boolEnum () ;
  if (kBoolTrue == test_9) {
    const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, outArgument_variableType.objectCompare (GALGAS_Ttype::constructor_structType (SOURCE_FILE ("template_semantics.gSemantics", 538)))).boolEnum () ;
    if (kBoolTrue == test_10) {
      {
      routine_searchFieldIfExists (inArgument_variable, outArgument_variableValue.reader_mStructValue (SOURCE_FILE ("template_semantics.gSemantics", 539)), outArgument_variableType, outArgument_variableValue, outArgument_found, inCompiler  COMMA_SOURCE_FILE ("template_semantics.gSemantics", 539)) ;
      }
