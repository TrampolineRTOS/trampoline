...
void routine_addStructValue (GALGAS_TfieldMap & ioArgument_ioTemplateVariableMap,
                             ...
                             COMMA_UNUSED_LOCATION_ARGS) {
  {
  ioArgument_ioTemplateVariableMap.modifier_insertKey (constinArgument_inVariableName, GALGAS_Ttype::constructor_structType (SOURCE_FILE_AT_LINE (400)), GALGAS_Tvalue::constructor_new (GALGAS_sint_36__34_ ((int64_t) 0LL), GALGAS_double (0), GALGAS_string::makeEmptyString (), GALGAS_TfieldMapList::constructor_emptyList (SOURCE_FILE_AT_LINE (401)), constinArgument_inValue, function_dummyFunction (inCompiler COMMA_SOURCE_FILE_AT_LINE (401)), constinArgument_description COMMA_SOURCE_FILE_AT_LINE (401)), inCompiler COMMA_SOURCE_FILE_AT_LINE (398)) ;
  }
}
...
void routine_printPath (const GALGAS_TvarPath constinArgument_path,
                        C_Compiler * inCompiler
                        COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_TvarPath enumerator_11194 (constinArgument_path, kEnumeration_up) ;
  while (enumerator_11194.hasCurrentObject ()) {
    inCompiler->printMessage (enumerator_11194.current_item (HERE).reader_string (SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_11194.current_key (HERE).reader_string (SOURCE_FILE_AT_LINE (436)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      inCompiler->printMessage (GALGAS_string ("[\"").operator_concat (enumerator_11194.current_key (HERE).reader_string (SOURCE_FILE_AT_LINE (437)) COMMA_SOURCE_FILE_AT_LINE (437)).operator_concat (GALGAS_string ("\"]") COMMA_SOURCE_FILE_AT_LINE (437)) COMMA_SOURCE_FILE_AT_LINE (437)) ;
    }
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_11194.current_idx (HERE).reader_sint (SOURCE_FILE_AT_LINE (439)).objectCompare (GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (439)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      inCompiler->printMessage (GALGAS_string ("[").operator_concat (enumerator_11194.current_idx (HERE).mAttribute_sint.reader_string (SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (440)) ;
    }
    if (enumerator_11194.hasNextObject ()) {
...
void routine_searchField (GALGAS_TvarPath inArgument_variable,
  ...
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, inArgument_variable.reader_length (SOURCE_FILE_AT_LINE (479)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
...
void routine_searchFieldIfExists (GALGAS_TvarPath inArgument_variable,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, var_idx.reader_sint (SOURCE_FILE_AT_LINE (516)).objectCompare (GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (516)))).boolEnum () ;
      if (kBoolTrue == test_5) {
  ...
  const enumGalgasBool test_9 = GALGAS_bool (kIsStrictSup, inArgument_variable.reader_length (SOURCE_FILE_AT_LINE (537)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (outArgument_found COMMA_SOURCE_FILE_AT_LINE (537)).boolEnum () ;
  if (kBoolTrue == test_9) {
...
GALGAS_TtypeList_2E_element GALGAS_TtypeList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_TtypeList_2E_element (GALGAS_Ttype::constructor_boolType (HERE)) ;
}
...
GALGAS_TfieldMap_2E_element GALGAS_TfieldMap_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_TfieldMap_2E_element (GALGAS_lstring::constructor_default (HERE),
                                      GALGAS_Ttype::constructor_boolType (HERE),
                                      GALGAS_Tvalue::constructor_default (HERE)) ;
}
...
GALGAS_TfieldMapList_2E_element GALGAS_TfieldMapList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_TfieldMapList_2E_element (GALGAS_TfieldMap::constructor_emptyMap (HERE)) ;
}
...
GALGAS_TexpressionList_2E_element GALGAS_TexpressionList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_TexpressionList_2E_element (GALGAS_Tvalue::constructor_default (HERE),
                                            GALGAS_Ttype::constructor_boolType (HERE)) ;
}
...
GALGAS_TenumationList_2E_element GALGAS_TenumationList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_TenumationList_2E_element (GALGAS_Tvalue::constructor_default (HERE),
                                           GALGAS_string::constructor_default (HERE)) ;
}
...
GALGAS_TvarPath_2E_element GALGAS_TvarPath_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_TvarPath_2E_element (GALGAS_lstring::constructor_default (HERE),
                                     GALGAS_lstring::constructor_default (HERE),
