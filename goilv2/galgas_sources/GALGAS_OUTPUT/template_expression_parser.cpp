          ...
          if (kBoolTrue == test_10) {
            ...
            if (kBoolTrue == test_11) {
              ...
              if (GALGAS_uint ((PMUInt32) 4U).isValid ()) {
                PMUInt32 variant_21292 = GALGAS_uint ((PMUInt32) 4U).uintValue () ;
                bool loop_21292 = true ;
                while (loop_21292) {
                  loop_21292 = GALGAS_bool (kIsStrictInf, var_count.objectCompare (GALGAS_uint ((PMUInt32) 4U))).isValid () ;
                  if (loop_21292) {
                    loop_21292 = GALGAS_bool (kIsStrictInf, var_count.objectCompare (GALGAS_uint ((PMUInt32) 4U))).boolValue () ;
                  }
              ...
              if (kBoolTrue == test_14) {
                ...
                if (GALGAS_uint ((PMUInt32) 64U).isValid ()) {
                  PMUInt32 variant_22092 = GALGAS_uint ((PMUInt32) 64U).uintValue () ;
                  bool loop_22092 = true ;
                  while (loop_22092) {
                    loop_22092 = GALGAS_bool (kIsNotEqual, var_value.objectCompare (GALGAS_sint_36__34_ ((PMSInt64) 0LL))).isValid () ;
                    if (loop_22092) {
                      loop_22092 = GALGAS_bool (kIsNotEqual, var_value.objectCompare (GALGAS_sint_36__34_ ((PMSInt64) 0LL))).boolValue () ;
                    }
                                      ...
                                      if (kBoolTrue == test_32) {
                                        ...
                                        if (kBoolTrue == test_35) {
                                          ...
                                          if (constinArgument_inValue.reader_mStringValue (SOURCE_FILE_AT_LINE (682)).reader_length (SOURCE_FILE_AT_LINE (682)).isValid ()) {
                                            PMUInt32 variant_30378 = constinArgument_inValue.reader_mStringValue (SOURCE_FILE_AT_LINE (682)).reader_length (SOURCE_FILE_AT_LINE (682)).uintValue () ;
        ...
        while (enumerator_59677.hasCurrentObject () && enumerator_59707.hasCurrentObject ()) {
          if (enumerator_59707.current_mType (HERE).isValid ()) {
            ...
            case GALGAS_Ttype::kEnum_boolType: {
              ...
              //--- @ifExpressionForGeneration
              GALGAS_bool temp_10 ;
              const enumGalgasBool test_11 = GALGAS_bool (kIsEqual, enumerator_59707.current_mValue (HERE).reader_mInt_36__34_Value (SOURCE_FILE_AT_LINE (1579)).objectCompare (GALGAS_sint_36__34_ ((PMSInt64) 0LL))).boolEnum () ;
              if (kBoolTrue == test_11) {
...
void cParser_template_5F_expression_5F_parser::rule_template_5F_expression_5F_parser_factor_i14_ (const GALGAS_string constinArgument_inPrefix,
  ...
  case 2: {
    ...
    if (kBoolTrue == test_1) {
      outArgument_outValue = function_valueWithUnsigned (GALGAS_uint_36__34_ ((PMUInt64) 1ULL), function_emptyLString (inCompiler COMMA_SOURCE_FILE_AT_LINE (1675)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1675)) ;
    }else if (kBoolFalse == test_1) {
      outArgument_outValue = function_valueWithUnsigned (GALGAS_uint_36__34_ ((PMUInt64) 0ULL), function_emptyLString (inCompiler COMMA_SOURCE_FILE_AT_LINE (1677)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1677)) ;
    }
  } break ;
  default:
    break ;
...
void cParser_template_5F_expression_5F_parser::rule_template_5F_expression_5F_parser_factor_i16_ (const GALGAS_string /* constinArgument_inPrefix */,
  ...
  case 1: {
    ...
    outArgument_outValue = function_valueWithUnsigned (GALGAS_uint_36__34_ ((PMUInt64) 1ULL), function_emptyLString (inCompiler COMMA_SOURCE_FILE_AT_LINE (1713)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1713)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_template_5F_scanner::kToken_false) COMMA_SOURCE_FILE_AT_LINE (1715)) ;
    outArgument_outValue = function_valueWithUnsigned (GALGAS_uint_36__34_ ((PMUInt64) 0ULL), function_emptyLString (inCompiler COMMA_SOURCE_FILE_AT_LINE (1716)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1716)) ;
  } break ;
  default:
    break ;
  }
