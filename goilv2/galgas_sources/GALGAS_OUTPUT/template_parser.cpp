  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        ...
        if (kBoolTrue == test_3) {
          const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, inArgument_path.reader_length (SOURCE_FILE_AT_LINE (1083)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          if (kBoolTrue == test_4) {
            {
          ...
          const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, inArgument_path.reader_length (SOURCE_FILE_AT_LINE (1098)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          if (kBoolTrue == test_5) {
            {
        ...
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, inArgument_path.reader_length (SOURCE_FILE_AT_LINE (1110)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_6) {
          {
      ...
      if (kBoolTrue == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, var_idx.reader_sint (SOURCE_FILE_AT_LINE (1124)).objectCompare (GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (1124)))).boolEnum () ;
        if (kBoolTrue == test_8) {
          const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, inArgument_path.reader_length (SOURCE_FILE_AT_LINE (1125)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          if (kBoolTrue == test_9) {
          ...
          const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, inArgument_path.reader_length (SOURCE_FILE_AT_LINE (1147)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        ...
        if (kBoolTrue == test_13) {
          const enumGalgasBool test_14 = GALGAS_bool (kIsEqual, inArgument_path.reader_length (SOURCE_FILE_AT_LINE (1160)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
          ...
          if (kBoolTrue == test_15) {
            const enumGalgasBool test_16 = GALGAS_bool (kIsEqual, var_idx.reader_sint (SOURCE_FILE_AT_LINE (1174)).objectCompare (GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (1174)))).boolEnum () ;
            if (kBoolTrue == test_16) {
              const enumGalgasBool test_17 = GALGAS_bool (kIsEqual, inArgument_path.reader_length (SOURCE_FILE_AT_LINE (1175)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
            ...
            const enumGalgasBool test_19 = GALGAS_bool (kIsEqual, inArgument_path.reader_length (SOURCE_FILE_AT_LINE (1192)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    ...
    const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, inArgument_path.reader_length (SOURCE_FILE_AT_LINE (1205)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_20) {
      ...
      if (kBoolTrue == test_21) {
        const enumGalgasBool test_22 = GALGAS_bool (kIsEqual, var_idx.reader_sint (SOURCE_FILE_AT_LINE (1207)).objectCompare (GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (1207)))).boolEnum () ;
      ...
      if (kBoolTrue == test_24) {
        const enumGalgasBool test_25 = GALGAS_bool (kIsEqual, var_idx.reader_sint (SOURCE_FILE_AT_LINE (1220)).objectCompare (GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (1220)))).boolEnum () ;
...
void routine_printVariable (GALGAS_uint inArgument_indent,
                            ...
                            C_Compiler * inCompiler
                            COMMA_UNUSED_LOCATION_ARGS) {
  inArgument_indent = inArgument_indent.add_operation (GALGAS_uint ((uint32_t) 4U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1422)) ;
  ...
  if (constinArgument_variableType.isValid ()) {
    ...
    case GALGAS_Ttype::kEnum_boolType: {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, constinArgument_variableValue.reader_mInt_36__34_Value (SOURCE_FILE_AT_LINE (1426)).objectCompare (GALGAS_sint_36__34_ ((int64_t) 1LL))).boolEnum () ;
      if (kBoolTrue == test_0) {
...
GALGAS_sint function_structCompare (const GALGAS_TfieldMap & constinArgument_s_31_,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, inArgument_fieldList.reader_length (SOURCE_FILE_AT_LINE (1493)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      ...
      if (kBoolTrue == test_2) {
        result_result = GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (1507)).multiply_operation (var_order.reader_sint (SOURCE_FILE_AT_LINE (1507)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1507)) ;
      }else if (kBoolFalse == test_2) {
        ...
        if (kBoolTrue == test_3) {
          result_result = GALGAS_sint ((int32_t) 1L).multiply_operation (var_order.reader_sint (SOURCE_FILE_AT_LINE (1511)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1511)) ;
        }else if (kBoolFalse == test_3) {
...
void routine_partition (GALGAS_TfieldMapList & ioArgument_t,
  ...
  if (inArgument_max.substract_operation (inArgument_min, inCompiler COMMA_SOURCE_FILE_AT_LINE (1547)).isValid ()) {
    uint32_t variant_45629 = inArgument_max.substract_operation (inArgument_min, inCompiler COMMA_SOURCE_FILE_AT_LINE (1547)).uintValue () ;
...
void routine_quickSort (GALGAS_TfieldMapList & ioArgument_t,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_uint var_pivotIndex = constinArgument_max.add_operation (constinArgument_min, inCompiler COMMA_SOURCE_FILE_AT_LINE (1567)).divide_operation (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1567)) ;
    {
    ...
    {
    routine_quickSort (ioArgument_t, var_pivotIndex.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1571)), constinArgument_max, constinArgument_fieldList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1571)) ;
    }
  }
}
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i0_ (const GALGAS_string constinArgument_inPrefix,
  ...
  if (var_resultType.isValid ()) {
    ...
    case GALGAS_Ttype::kEnum_boolType: {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_expression.reader_mInt_36__34_Value (SOURCE_FILE_AT_LINE (117)).objectCompare (GALGAS_sint_36__34_ ((int64_t) 0LL))).boolEnum () ;
      if (kBoolTrue == test_0) {
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i1_ (const GALGAS_string constinArgument_inPrefix,
  ...
  const enumGalgasBool test_0 = var_templateVariableMap.reader_hasKeyAtLevel (GALGAS_string ("FILENAME"), GALGAS_uint ((uint32_t) 0U) COMMA_SOURCE_FILE_AT_LINE (161)).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
  ...
  const enumGalgasBool test_1 = var_templateVariableMap.reader_hasKeyAtLevel (GALGAS_string ("FILEPATH"), GALGAS_uint ((uint32_t) 0U) COMMA_SOURCE_FILE_AT_LINE (164)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
  ...
  const enumGalgasBool test_3 = var_fileNameOk.operator_and (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (187)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE_AT_LINE (187)).boolEnum () ;
  if (kBoolTrue == test_3) {
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i4_ (const GALGAS_string /* constinArgument_inPrefix */,
  ...
  if (ioArgument_ioResultingString.reader_length (SOURCE_FILE_AT_LINE (309)).isValid ()) {
    uint32_t variant_9144 = ioArgument_ioResultingString.reader_length (SOURCE_FILE_AT_LINE (309)).uintValue () ;
    bool loop_9144 = true ;
    while (loop_9144) {
      loop_9144 = GALGAS_bool (kIsStrictSup, var_idx.objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (var_searchEndOfLine COMMA_SOURCE_FILE_AT_LINE (310)).isValid () ;
      if (loop_9144) {
        loop_9144 = GALGAS_bool (kIsStrictSup, var_idx.objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (var_searchEndOfLine COMMA_SOURCE_FILE_AT_LINE (310)).boolValue () ;
      }
      ...
      if (loop_9144) {
        variant_9144 -- ;
        var_searchEndOfLine = GALGAS_bool (kIsNotEqual, ioArgument_ioResultingString.reader_characterAtIndex (var_idx.substract_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (312)), inCompiler COMMA_SOURCE_FILE_AT_LINE (312)).objectCompare (GALGAS_char (TO_UNICODE (10)))) ;
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i8_ (const GALGAS_string constinArgument_inPrefix,
  ...
  while (repeatFlag_0) {
    if (var_currentCondition.operator_not (SOURCE_FILE_AT_LINE (510)).isValidAndTrue ()) {
      ...
      var_currentCondition = GALGAS_bool (kIsEqual, var_expression.reader_mInt_36__34_Value (SOURCE_FILE_AT_LINE (524)).objectCompare (GALGAS_sint_36__34_ ((int64_t) 1LL))) ;
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i12_ (const GALGAS_string constinArgument_inPrefix,
  ...
  if (var_enumerationList.reader_length (SOURCE_FILE_AT_LINE (814)).isValid ()) {
    uint32_t variant_2 = var_enumerationList.reader_length (SOURCE_FILE_AT_LINE (814)).uintValue () ;
    bool loop_3 = true ;
    while (loop_3) {
      loop_3 = false ;
      if (GALGAS_bool (kIsStrictSup, var_enumerationList.reader_length (SOURCE_FILE_AT_LINE (815)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValidAndTrue ()) {
        loop_3 = true ;
        ...
        const C_parsingContext parsingContext = inCompiler->parsingContext () ;
          ...
          case 2: {
            ...
            if (GALGAS_bool (kIsStrictSup, var_enumerationList.reader_length (SOURCE_FILE_AT_LINE (844)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValidAndTrue ()) {
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i13_ (const GALGAS_string constinArgument_inPrefix,
  ...
  if (kBoolTrue == test_2) {
    ...
    var_num = var_stop.substract_operation (var_start, inCompiler COMMA_SOURCE_FILE_AT_LINE (939)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (939)) ;
  }
  if (var_num.isValid ()) {
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i18_ (const GALGAS_string constinArgument_inPrefix,
  ...
  {
  routine_printVariable (GALGAS_uint ((uint32_t) 0U), var_variableType, var_variableValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1475)) ;
  }
...
void cParser_template_5F_parser::rule_template_5F_parser_sorting_5F_order_i19_ (GALGAS_lsint & outArgument_order,
  ...
  case 1: {
    ...
    outArgument_order = GALGAS_lsint::constructor_new (GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (1580)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1580)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_template_5F_scanner::kToken__3C_) COMMA_SOURCE_FILE_AT_LINE (1582)) ;
    outArgument_order = GALGAS_lsint::constructor_new (GALGAS_sint ((int32_t) 1L), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1583)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_template_5F_parser::rule_template_5F_parser_template_5F_instruction_i20_ (const GALGAS_string /* constinArgument_inPrefix */,
  ...
  if (kBoolTrue == test_1) {
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_variable.reader_length (SOURCE_FILE_AT_LINE (1614)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
      routine_quickSort (var_variable, GALGAS_uint ((uint32_t) 0U), var_variable.reader_length (SOURCE_FILE_AT_LINE (1615)).substract_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (1615)), var_keys, inCompiler COMMA_SOURCE_FILE_AT_LINE (1615)) ;
      }
...
void cParser_template_5F_parser::rule_template_5F_parser_variable_i21_ (const GALGAS_string constinArgument_inPrefix,
  ...
  GALGAS_lsint var_idx = GALGAS_lsint::constructor_new (GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (1640)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1640)) ;
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      var_idx = GALGAS_lsint::constructor_new (GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE_AT_LINE (1661)), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (1661)) ;
