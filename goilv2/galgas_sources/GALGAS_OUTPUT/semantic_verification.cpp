...
//                    september 25th, 2012, at 17h50'31"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
GALGAS_bool function_attributeAllowsAuto (const GALGAS_impType & constinArgument_type,
  ...
  if (constinArgument_type.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_impAutoDefaultType *> (constinArgument_type.ptr ())) {
      GALGAS_impAutoDefaultType cast_6844_autoType ((cPtr_impAutoDefaultType *) constinArgument_type.ptr ()) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = cast_6844_autoType.reader_withAuto (SOURCE_FILE_AT_LINE (220)).operator_not (SOURCE_FILE_AT_LINE (220)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @assignmentInstructionForGeneration
...
void routine_verifyAllAttributes (const GALGAS_implementation constinArgument_imp,
  ...
  cEnumerator_objectsMap enumerator_7180 (constinArgument_objects, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_7180.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_implementationObject var_impObj = callCategoryReader_impObject ((const cPtr_implementation *) constinArgument_imp.ptr (), enumerator_7180.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (238)), inCompiler COMMA_SOURCE_FILE_AT_LINE (238)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_objectKindMap enumerator_7350 (enumerator_7180.current_objectsOfKind (HERE).reader_objects (SOURCE_FILE_AT_LINE (240)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_7350.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_implementationObjectMap enumerator_7403 (var_impObj.reader_attributes (SOURCE_FILE_AT_LINE (241)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_7403.hasCurrentObject ()) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_0 = enumerator_7350.current_attributes (HERE).reader_objectParams (SOURCE_FILE_AT_LINE (242)).reader_hasKey (enumerator_7403.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (242)) COMMA_SOURCE_FILE_AT_LINE (242)).boolEnum () ;
        if (kBoolTrue == test_0) {
          //-------- @localVariableDeclarationForGeneration
          GALGAS_object_5F_t var_value ;
          //-------- @methodCallInstructionForGeneration
          enumerator_7350.current_attributes (HERE).reader_objectParams (SOURCE_FILE_AT_LINE (246)).method_get (enumerator_7403.current_lkey (HERE), var_value, inCompiler COMMA_SOURCE_FILE_AT_LINE (246)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @structuredCastInstructionForGeneration
          if (var_value.isValid ()) {
            if (var_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_auto) {
              //-------- @ifInstructionForGeneration
              const enumGalgasBool test_1 = function_attributeAllowsAuto (enumerator_7403.current_type (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (250)).operator_not (SOURCE_FILE_AT_LINE (250)).boolEnum () ;
              if (kBoolTrue == test_1) {
                //-------- @errorInstructionForGeneration
                inCompiler->emitSemanticError (var_value.reader_location (SOURCE_FILE_AT_LINE (251)), GALGAS_string ("AUTO value is not allowed for the ").operator_concat (enumerator_7180.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (251)) COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (GALGAS_string (" attribute") COMMA_SOURCE_FILE_AT_LINE (251)) COMMA_SOURCE_FILE_AT_LINE (251)) ;
              }
            }
          }
        }else if (kBoolFalse == test_0) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_2 = function_attributeAllowsAuto (enumerator_7403.current_type (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (256)).operator_not (SOURCE_FILE_AT_LINE (256)).operator_and (enumerator_7403.current_type (HERE).reader_multiple (SOURCE_FILE_AT_LINE (256)).operator_not (SOURCE_FILE_AT_LINE (256)) COMMA_SOURCE_FILE_AT_LINE (256)).boolEnum () ;
          if (kBoolTrue == test_2) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_3 (enumerator_7350.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_3, GALGAS_string ("In ").operator_concat (enumerator_7180.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (257)) COMMA_SOURCE_FILE_AT_LINE (257)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (257)).operator_concat (enumerator_7350.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (257)) COMMA_SOURCE_FILE_AT_LINE (257)).operator_concat (GALGAS_string (", attribute ") COMMA_SOURCE_FILE_AT_LINE (257)).operator_concat (enumerator_7403.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (257)) COMMA_SOURCE_FILE_AT_LINE (257)).operator_concat (GALGAS_string (" is not defined and is not AUTO") COMMA_SOURCE_FILE_AT_LINE (257)) COMMA_SOURCE_FILE_AT_LINE (257)) ;
          }
        }
        //-------- @structuredCastInstructionForGeneration
        if (enumerator_7403.current_type (HERE).isValid ()) {
          if (enumerator_7403.current_type (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impAutoDefaultType) {
          }
        }
