...
GALGAS_bool function_attributeAllowsAuto (const GALGAS_impType & constinArgument_type,
  ...
  if (constinArgument_type.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_impAutoDefaultType *> (constinArgument_type.ptr ())) {
      ...
      const enumGalgasBool test_0 = cast_6855_autoType.reader_withAuto (SOURCE_FILE ("semantic_verification.gSemantics", 223)).operator_not (SOURCE_FILE ("semantic_verification.gSemantics", 223)).boolEnum () ;
      if (kBoolTrue == test_0) {
...
void routine_verifyAllAttributes (const GALGAS_implementation constinArgument_imp,
  ...
  while (enumerator_7187.hasCurrentObject ()) {
    GALGAS_implementationObject var_impObj = callCategoryReader_impObject ((const cPtr_implementation *) constinArgument_imp.ptr (), enumerator_7187.current_lkey (HERE).reader_string (SOURCE_FILE ("semantic_verification.gSemantics", 241)), inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 241)) ;
    cEnumerator_objectKindMap enumerator_7349 (enumerator_7187.current_objectsOfKind (HERE).reader_objects (SOURCE_FILE ("semantic_verification.gSemantics", 243)), kEnumeration_up) ;
    while (enumerator_7349.hasCurrentObject ()) {
      cEnumerator_implementationObjectMap enumerator_7393 (var_impObj.reader_attributes (SOURCE_FILE ("semantic_verification.gSemantics", 244)), kEnumeration_up) ;
      while (enumerator_7393.hasCurrentObject ()) {
        const enumGalgasBool test_0 = enumerator_7349.current_attributes (HERE).reader_objectParams (SOURCE_FILE ("semantic_verification.gSemantics", 245)).reader_hasKey (enumerator_7393.current_lkey (HERE).reader_string (SOURCE_FILE ("semantic_verification.gSemantics", 245)) COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 245)).boolEnum () ;
        if (kBoolTrue == test_0) {
          GALGAS_object_5F_t var_value ;
          enumerator_7349.current_attributes (HERE).reader_objectParams (SOURCE_FILE ("semantic_verification.gSemantics", 249)).method_get (enumerator_7393.current_lkey (HERE), var_value, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 249)) ;
          if (var_value.isValid ()) {
            if (var_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_auto) {
              const enumGalgasBool test_1 = function_attributeAllowsAuto (enumerator_7393.current_type (HERE), inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 253)).operator_not (SOURCE_FILE ("semantic_verification.gSemantics", 253)).boolEnum () ;
              if (kBoolTrue == test_1) {
                inCompiler->emitSemanticError (var_value.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 254)), GALGAS_string ("AUTO value is not allowed for the ").operator_concat (enumerator_7187.current_lkey (HERE).reader_string (SOURCE_FILE ("semantic_verification.gSemantics", 254))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 254)).operator_concat (GALGAS_string (" attribute")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 254))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 254)) ;
              }
            }
          }
        }else if (kBoolFalse == test_0) {
          const enumGalgasBool test_2 = function_attributeAllowsAuto (enumerator_7393.current_type (HERE), inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 259)).operator_not (SOURCE_FILE ("semantic_verification.gSemantics", 259)).operator_and (enumerator_7393.current_type (HERE).reader_multiple (SOURCE_FILE ("semantic_verification.gSemantics", 259)).operator_not (SOURCE_FILE ("semantic_verification.gSemantics", 259)) COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 259)).boolEnum () ;
          if (kBoolTrue == test_2) {
            GALGAS_location location_3 (enumerator_7349.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_3, GALGAS_string ("In ").operator_concat (enumerator_7187.current_lkey (HERE).reader_string (SOURCE_FILE ("semantic_verification.gSemantics", 260))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 260)).operator_concat (GALGAS_string (" ")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 260)).operator_concat (enumerator_7349.current_lkey (HERE).reader_string (SOURCE_FILE ("semantic_verification.gSemantics", 260))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 260)).operator_concat (GALGAS_string (", attribute ")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 260)).operator_concat (enumerator_7393.current_lkey (HERE).reader_string (SOURCE_FILE ("semantic_verification.gSemantics", 260))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 260)).operator_concat (GALGAS_string (" is not defined and is not AUTO")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 260))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 260)) ;
          }
        }
...
void routine_verifyAll (const GALGAS_implementation constinArgument_imp,
                        ...
                        COMMA_UNUSED_LOCATION_ARGS) {
  {
  routine_verifyAllAttributes (constinArgument_imp, constinArgument_application.reader_objects (SOURCE_FILE ("semantic_verification.gSemantics", 583)), inCompiler  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 583)) ;
  }
  callCategoryMethod_verifyApplication ((const cPtr_implementation *) constinArgument_imp.ptr (), constinArgument_application, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 584)) ;
}
...
static void categoryMethod_implementation_verifyApplication (const cPtr_implementation * inObject,
  ...
  while (enumerator_905.hasCurrentObject ()) {
    const enumGalgasBool test_0 = constinArgument_appDef.reader_objects (SOURCE_FILE ("semantic_verification.gSemantics", 22)).reader_hasKey (enumerator_905.current_lkey (HERE).reader_string (SOURCE_FILE ("semantic_verification.gSemantics", 22)) COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 22)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_objectKind var_obj ;
      constinArgument_appDef.reader_objects (SOURCE_FILE ("semantic_verification.gSemantics", 24)).method_get (enumerator_905.current_lkey (HERE), var_obj, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 24)) ;
      callCategoryMethod_verifyApplication ((const cPtr_implementationObject *) enumerator_905.current_obj (HERE).ptr (), var_obj, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 25)) ;
    }
...
static void categoryMethod_implementationObject_verifyApplication (const cPtr_implementationObject * inObject,
  ...
  cEnumerator_objectKindMap enumerator_1311 (constinArgument_objectsOfKind.reader_objects (SOURCE_FILE ("semantic_verification.gSemantics", 34)), kEnumeration_up) ;
  while (enumerator_1311.hasCurrentObject ()) {
    ...
    while (enumerator_1344.hasCurrentObject ()) {
      callCategoryMethod_verifyApplication ((const cPtr_impType *) enumerator_1344.current_type (HERE).ptr (), enumerator_1311.current_attributes (HERE), inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 36)) ;
...
static void categoryMethod_impType_verifyApplication (const cPtr_impType * inObject,
  ...
  cEnumerator_identifierMap enumerator_1613 (constinArgument_attrs.reader_objectParams (SOURCE_FILE ("semantic_verification.gSemantics", 45)), kEnumeration_up) ;
  while (enumerator_1613.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_1613.current_lkey (HERE).reader_string (SOURCE_FILE ("semantic_verification.gSemantics", 46)).objectCompare (object->mAttribute_name.reader_string (SOURCE_FILE ("semantic_verification.gSemantics", 46)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      const GALGAS_impType temp_1 = object ;
      callCategoryMethod_verifyMultipleType ((const cPtr_impType *) temp_1.ptr (), enumerator_1613.current_value (HERE), inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 47)) ;
    }
...
static void categoryMethod_impType_verifyType (const cPtr_impType * /* inObject */,
                                               ...
                                               C_Compiler * inCompiler
                                               COMMA_UNUSED_LOCATION_ARGS) {
  inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 56)), GALGAS_string ("Internal error, a generic type should not be instantiated")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 56)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_impType_verifyMultipleType (const cPtr_impType * inObject,
  ...
  if (constinArgument_attr.isValid ()) {
    if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_multipleAttribute) {
      ...
      cEnumerator_identifierList enumerator_2171 (cast_2146_ma.reader_items (SOURCE_FILE ("semantic_verification.gSemantics", 65)), kEnumeration_up) ;
      while (enumerator_2171.hasCurrentObject ()) {
        const GALGAS_impType temp_0 = object ;
        callCategoryMethod_verifyType ((const cPtr_impType *) temp_0.ptr (), enumerator_2171.current_item (HERE), inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 66)) ;
        enumerator_2171.gotoNextObject () ;
      }
    }else{
      const GALGAS_impType temp_1 = object ;
      callCategoryMethod_verifyType ((const cPtr_impType *) temp_1.ptr (), constinArgument_attr, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 69)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
  ...
  if (constinArgument_attr.isValid ()) {
    if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_structAttribute) {
      ...
      while (enumerator_2505.hasCurrentObject ()) {
        const enumGalgasBool test_0 = cast_2474_sa.reader_subAttributes (SOURCE_FILE ("semantic_verification.gSemantics", 80)).reader_objectParams (SOURCE_FILE ("semantic_verification.gSemantics", 80)).reader_hasKey (enumerator_2505.current_lkey (HERE).reader_string (SOURCE_FILE ("semantic_verification.gSemantics", 80)) COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 80)).boolEnum () ;
        if (kBoolTrue == test_0) {
          GALGAS_object_5F_t var_subAttr ;
          cast_2474_sa.reader_subAttributes (SOURCE_FILE ("semantic_verification.gSemantics", 82)).reader_objectParams (SOURCE_FILE ("semantic_verification.gSemantics", 82)).method_get (enumerator_2505.current_lkey (HERE), var_subAttr, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 82)) ;
          callCategoryMethod_verifyMultipleType ((const cPtr_impType *) enumerator_2505.current_type (HERE).ptr (), var_subAttr, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 83)) ;
        }
        enumerator_2505.gotoNextObject () ;
      }
    }else{
      inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 87)), GALGAS_string ("STRUCT expected")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 87)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_refType_verifyType (const cPtr_impType * /* inObject */,
  ...
  if (constinArgument_attr.isValid ()) {
    if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_string_5F_class) {
      ...
      inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 98)), GALGAS_string ("object reference expected")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 98)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_impBoolType_verifyType (const cPtr_impType * inObject,
  ...
  if (constinArgument_attr.isValid ()) {
    if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_boolAttribute) {
      ...
      const enumGalgasBool test_0 = cast_3266_b.reader_value (SOURCE_FILE ("semantic_verification.gSemantics", 108)).boolEnum () ;
      if (kBoolTrue == test_0) {
        ...
        while (enumerator_3322.hasCurrentObject ()) {
          const enumGalgasBool test_1 = cast_3266_b.reader_subAttributes (SOURCE_FILE ("semantic_verification.gSemantics", 110)).reader_objectParams (SOURCE_FILE ("semantic_verification.gSemantics", 110)).reader_hasKey (enumerator_3322.current_lkey (HERE).reader_string (SOURCE_FILE ("semantic_verification.gSemantics", 110)) COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 110)).boolEnum () ;
          if (kBoolTrue == test_1) {
            GALGAS_object_5F_t var_subAttrs ;
            cast_3266_b.reader_subAttributes (SOURCE_FILE ("semantic_verification.gSemantics", 112)).reader_objectParams (SOURCE_FILE ("semantic_verification.gSemantics", 112)).method_get (enumerator_3322.current_lkey (HERE), var_subAttrs, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 112)) ;
            callCategoryMethod_verifyMultipleType ((const cPtr_impType *) enumerator_3322.current_type (HERE).ptr (), var_subAttrs, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 113)) ;
          }
        ...
        while (enumerator_3618.hasCurrentObject ()) {
          const enumGalgasBool test_2 = cast_3266_b.reader_subAttributes (SOURCE_FILE ("semantic_verification.gSemantics", 118)).reader_objectParams (SOURCE_FILE ("semantic_verification.gSemantics", 118)).reader_hasKey (enumerator_3618.current_lkey (HERE).reader_string (SOURCE_FILE ("semantic_verification.gSemantics", 118)) COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 118)).boolEnum () ;
          if (kBoolTrue == test_2) {
            GALGAS_object_5F_t var_subAttrs ;
            cast_3266_b.reader_subAttributes (SOURCE_FILE ("semantic_verification.gSemantics", 120)).reader_objectParams (SOURCE_FILE ("semantic_verification.gSemantics", 120)).method_get (enumerator_3618.current_lkey (HERE), var_subAttrs, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 120)) ;
            callCategoryMethod_verifyMultipleType ((const cPtr_impType *) enumerator_3618.current_type (HERE).ptr (), var_subAttrs, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 121)) ;
          }
          enumerator_3618.gotoNextObject () ;
        }
      }
    }else{
      inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 126)), GALGAS_string ("BOOLEAN expected")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 126)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_impEnumType_verifyType (const cPtr_impType * inObject,
  ...
  if (constinArgument_attr.isValid ()) {
    if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_enumAttribute) {
      ...
      const enumGalgasBool test_0 = object->mAttribute_valuesMap.reader_hasKey (cast_4143_e.reader_value (SOURCE_FILE ("semantic_verification.gSemantics", 136)) COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 136)).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_implementationObjectMap var_validVal ;
        object->mAttribute_valuesMap.method_get (function_lstringWith (cast_4143_e.reader_value (SOURCE_FILE ("semantic_verification.gSemantics", 138)), inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 138)), var_validVal, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 138)) ;
        cEnumerator_implementationObjectMap enumerator_4309 (var_validVal, kEnumeration_up) ;
        while (enumerator_4309.hasCurrentObject ()) {
          const enumGalgasBool test_1 = cast_4143_e.reader_subAttributes (SOURCE_FILE ("semantic_verification.gSemantics", 140)).reader_objectParams (SOURCE_FILE ("semantic_verification.gSemantics", 140)).reader_hasKey (enumerator_4309.current_lkey (HERE).reader_string (SOURCE_FILE ("semantic_verification.gSemantics", 140)) COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 140)).boolEnum () ;
          if (kBoolTrue == test_1) {
            GALGAS_object_5F_t var_subAttrs ;
            cast_4143_e.reader_subAttributes (SOURCE_FILE ("semantic_verification.gSemantics", 142)).reader_objectParams (SOURCE_FILE ("semantic_verification.gSemantics", 142)).method_get (enumerator_4309.current_lkey (HERE), var_subAttrs, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 142)) ;
            callCategoryMethod_verifyMultipleType ((const cPtr_impType *) enumerator_4309.current_type (HERE).ptr (), var_subAttrs, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 143)) ;
          }
          enumerator_4309.gotoNextObject () ;
        }
      }else if (kBoolFalse == test_0) {
        inCompiler->emitSemanticError (cast_4143_e.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 147)), cast_4143_e.reader_value (SOURCE_FILE ("semantic_verification.gSemantics", 147)).operator_concat (GALGAS_string (" is not a valid enum value")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 147))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 147)) ;
      }
    }else if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_auto) {
    }else{
      inCompiler->printMessage (GALGAS_string ("**** @impEnumType ****\n")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 151)) ;
      inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 152)), GALGAS_string ("ENUM expected")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 152)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_impAutoDefaultType_verifyType (const cPtr_impType * inObject,
  ...
  if (constinArgument_attr.isValid ()) {
    if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_stringAttribute) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_string (SOURCE_FILE ("semantic_verification.gSemantics", 163)))).operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_identifier (SOURCE_FILE ("semantic_verification.gSemantics", 163)))) COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 163)).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 164)), GALGAS_string ("string of identifier expected")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 164)) ;
      }
    }else if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_string_5F_class) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_identifier (SOURCE_FILE ("semantic_verification.gSemantics", 167)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 168)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 168)).operator_concat (GALGAS_string (" expected")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 168))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 168)) ;
      }
    }else if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_auto) {
    }else{
      inCompiler->printMessage (GALGAS_string ("*** @impAutoDefaultType ***\n")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 172)) ;
      constinArgument_attr.log ("attr"  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 173)) ;
      inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 174)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 174)).operator_concat (GALGAS_string (" expected")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 174))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 174)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_impRangedType_verifyType (const cPtr_impType * inObject,
  ...
  if (constinArgument_attr.isValid ()) {
    if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_33__32__5F_class) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE ("semantic_verification.gSemantics", 185)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 186)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 186)).operator_concat (GALGAS_string (" expected")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 186))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 186)) ;
      }
    }else if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_33__32__5F_class) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_sint_33__32_Number (SOURCE_FILE ("semantic_verification.gSemantics", 189)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 190)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 190)).operator_concat (GALGAS_string (" expected")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 190))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 190)) ;
      }
    }else if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_36__34__5F_class) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("semantic_verification.gSemantics", 193)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 194)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 194)).operator_concat (GALGAS_string (" expected")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 194))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 194)) ;
      }
    }else if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_36__34__5F_class) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_sint_36__34_Number (SOURCE_FILE ("semantic_verification.gSemantics", 197)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 198)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 198)).operator_concat (GALGAS_string (" expected")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 198))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 198)) ;
      }
    }else if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_float_5F_class) {
      const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_floatNumber (SOURCE_FILE ("semantic_verification.gSemantics", 201)))).boolEnum () ;
      if (kBoolTrue == test_4) {
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 202)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 202)).operator_concat (GALGAS_string (" expected")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 202))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 202)) ;
      }
    }else if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_auto) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, object->mAttribute_withAuto.objectCompare (GALGAS_bool (false))).boolEnum () ;
      if (kBoolTrue == test_5) {
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 206)), GALGAS_string ("AUTO is not allowed for ").operator_concat (object->mAttribute_name.reader_string (SOURCE_FILE ("semantic_verification.gSemantics", 206))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 206)).operator_concat (GALGAS_string (" attribute")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 206))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 206)) ;
      }
    }else{
      inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE ("semantic_verification.gSemantics", 210)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 210)).operator_concat (GALGAS_string (" expected")  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 210))  COMMA_SOURCE_FILE ("semantic_verification.gSemantics", 210)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
