...
//                    september 27th, 2012, at 13h52'47"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
GALGAS_bool function_attributeAllowsAuto (const GALGAS_impType & constinArgument_type,
  ...
  if (constinArgument_type.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_impAutoDefaultType *> (constinArgument_type.ptr ())) {
      GALGAS_impAutoDefaultType cast_6877_autoType ((cPtr_impAutoDefaultType *) constinArgument_type.ptr ()) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = cast_6877_autoType.reader_withAuto (SOURCE_FILE_AT_LINE (222)).operator_not (SOURCE_FILE_AT_LINE (222)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @assignmentInstructionForGeneration
...
void routine_verifyAllAttributes (const GALGAS_implementation constinArgument_imp,
  ...
  cEnumerator_objectsMap enumerator_7213 (constinArgument_objects, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_7213.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_implementationObject var_impObj = callCategoryReader_impObject ((const cPtr_implementation *) constinArgument_imp.ptr (), enumerator_7213.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (240)), inCompiler COMMA_SOURCE_FILE_AT_LINE (240)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_objectKindMap enumerator_7383 (enumerator_7213.current_objectsOfKind (HERE).reader_objects (SOURCE_FILE_AT_LINE (242)), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_7383.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_implementationObjectMap enumerator_7436 (var_impObj.reader_attributes (SOURCE_FILE_AT_LINE (243)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_7436.hasCurrentObject ()) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_0 = enumerator_7383.current_attributes (HERE).reader_objectParams (SOURCE_FILE_AT_LINE (244)).reader_hasKey (enumerator_7436.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (244)).boolEnum () ;
        if (kBoolTrue == test_0) {
          //-------- @localVariableDeclarationForGeneration
          GALGAS_object_5F_t var_value ;
          //-------- @methodCallInstructionForGeneration
          enumerator_7383.current_attributes (HERE).reader_objectParams (SOURCE_FILE_AT_LINE (248)).method_get (enumerator_7436.current_lkey (HERE), var_value, inCompiler COMMA_SOURCE_FILE_AT_LINE (248)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @structuredCastInstructionForGeneration
          if (var_value.isValid ()) {
            if (var_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_auto) {
              //-------- @ifInstructionForGeneration
              const enumGalgasBool test_1 = function_attributeAllowsAuto (enumerator_7436.current_type (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (252)).operator_not (SOURCE_FILE_AT_LINE (252)).boolEnum () ;
              if (kBoolTrue == test_1) {
                //-------- @errorInstructionForGeneration
                inCompiler->emitSemanticError (var_value.reader_location (SOURCE_FILE_AT_LINE (253)), GALGAS_string ("AUTO value is not allowed for the ").operator_concat (enumerator_7213.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (253)) COMMA_SOURCE_FILE_AT_LINE (253)).operator_concat (GALGAS_string (" attribute") COMMA_SOURCE_FILE_AT_LINE (253)) COMMA_SOURCE_FILE_AT_LINE (253)) ;
              }
            }
          }
        }else if (kBoolFalse == test_0) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_2 = function_attributeAllowsAuto (enumerator_7436.current_type (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (258)).operator_not (SOURCE_FILE_AT_LINE (258)).operator_and (enumerator_7436.current_type (HERE).reader_multiple (SOURCE_FILE_AT_LINE (258)).operator_not (SOURCE_FILE_AT_LINE (258)) COMMA_SOURCE_FILE_AT_LINE (258)).boolEnum () ;
          if (kBoolTrue == test_2) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_3 (enumerator_7383.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_3, GALGAS_string ("In ").operator_concat (enumerator_7213.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (259)) COMMA_SOURCE_FILE_AT_LINE (259)).operator_concat (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (259)).operator_concat (enumerator_7383.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (259)) COMMA_SOURCE_FILE_AT_LINE (259)).operator_concat (GALGAS_string (", attribute ") COMMA_SOURCE_FILE_AT_LINE (259)).operator_concat (enumerator_7436.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (259)) COMMA_SOURCE_FILE_AT_LINE (259)).operator_concat (GALGAS_string (" is not defined and is not AUTO") COMMA_SOURCE_FILE_AT_LINE (259)) COMMA_SOURCE_FILE_AT_LINE (259)) ;
          }
        }
        //-------- @structuredCastInstructionForGeneration
        if (enumerator_7436.current_type (HERE).isValid ()) {
          if (enumerator_7436.current_type (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impAutoDefaultType) {
          }
        }
...
void routine_verifyAll (const GALGAS_implementation constinArgument_imp,
  ...
  routine_verifyAllAttributes (constinArgument_imp, constinArgument_application.reader_objects (SOURCE_FILE_AT_LINE (582)), inCompiler COMMA_SOURCE_FILE_AT_LINE (582)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  callCategoryMethod_verifyApplication ((const cPtr_implementation *) constinArgument_imp.ptr (), constinArgument_application, inCompiler COMMA_SOURCE_FILE_AT_LINE (583)) ;
  //-------- END @methodCallInstructionForGeneration
}
...
static void categoryMethod_implementation_verifyApplication (const cPtr_implementation * inObject,
  ...
  while (enumerator_916.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_verifyApplication ((const cPtr_implementationObject *) enumerator_916.current_obj (HERE).ptr (), var_obj, inCompiler COMMA_SOURCE_FILE_AT_LINE (25)) ;
      //-------- END @methodCallInstructionForGeneration
    }
...
static void categoryMethod_implementationObject_verifyApplication (const cPtr_implementationObject * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_objectKindMap enumerator_1331 (constinArgument_objectsOfKind.reader_objects (SOURCE_FILE_AT_LINE (34)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_1331.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_implementationObjectMap enumerator_1365 (object->mAttribute_attributes, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_1365.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_verifyApplication ((const cPtr_impType *) enumerator_1365.current_type (HERE).ptr (), enumerator_1331.current_attributes (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (36)) ;
      //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_impType_verifyApplication (const cPtr_impType * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_identifierMap enumerator_1634 (constinArgument_attrs.reader_objectParams (SOURCE_FILE_AT_LINE (45)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_1634.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_1634.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (46)).objectCompare (object->mAttribute_name.reader_string (SOURCE_FILE_AT_LINE (46)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      //--- @selfCopyInExpressionForGeneration
      const GALGAS_impType temp_1 = object ;
      callCategoryMethod_verifyMultipleType ((const cPtr_impType *) temp_1.ptr (), enumerator_1634.current_value (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (47)) ;
      //-------- END @methodCallInstructionForGeneration
    }
...
static void categoryMethod_impType_verifyMultipleType (const cPtr_impType * inObject,
  ...
  if (constinArgument_attr.isValid ()) {
    if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_multipleAttribute) {
      GALGAS_multipleAttribute cast_2165_ma ((cPtr_multipleAttribute *) constinArgument_attr.ptr ()) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_identifierList enumerator_2194 (cast_2165_ma.reader_items (SOURCE_FILE_AT_LINE (65)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_2194.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        //--- @selfCopyInExpressionForGeneration
        const GALGAS_impType temp_0 = object ;
        callCategoryMethod_verifyType ((const cPtr_impType *) temp_0.ptr (), enumerator_2194.current_item (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (66)) ;
        //-------- END @methodCallInstructionForGeneration
...
static void categoryMethod_impStructType_verifyType (const cPtr_impType * inObject,
  ...
  if (constinArgument_attr.isValid ()) {
    if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_structAttribute) {
      GALGAS_structAttribute cast_2495_sa ((cPtr_structAttribute *) constinArgument_attr.ptr ()) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_implementationObjectMap enumerator_2530 (object->mAttribute_structAttributes, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_2530.hasCurrentObject ()) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_0 = cast_2495_sa.reader_subAttributes (SOURCE_FILE_AT_LINE (80)).reader_objectParams (SOURCE_FILE_AT_LINE (80)).reader_hasKey (enumerator_2530.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (80)) COMMA_SOURCE_FILE_AT_LINE (80)).boolEnum () ;
        if (kBoolTrue == test_0) {
          //-------- @localVariableDeclarationForGeneration
          GALGAS_object_5F_t var_subAttr ;
          //-------- @methodCallInstructionForGeneration
          cast_2495_sa.reader_subAttributes (SOURCE_FILE_AT_LINE (82)).reader_objectParams (SOURCE_FILE_AT_LINE (82)).method_get (enumerator_2530.current_lkey (HERE), var_subAttr, inCompiler COMMA_SOURCE_FILE_AT_LINE (82)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @methodCallInstructionForGeneration
          callCategoryMethod_verifyMultipleType ((const cPtr_impType *) enumerator_2530.current_type (HERE).ptr (), var_subAttr, inCompiler COMMA_SOURCE_FILE_AT_LINE (83)) ;
          //-------- END @methodCallInstructionForGeneration
        }
...
static void categoryMethod_impBoolType_verifyType (const cPtr_impType * inObject,
  ...
  if (constinArgument_attr.isValid ()) {
    if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_boolAttribute) {
      GALGAS_boolAttribute cast_3291_b ((cPtr_boolAttribute *) constinArgument_attr.ptr ()) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = cast_3291_b.reader_value (SOURCE_FILE_AT_LINE (108)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_implementationObjectMap enumerator_3351 (object->mAttribute_trueSubAttributes, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_3351.hasCurrentObject ()) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_1 = cast_3291_b.reader_subAttributes (SOURCE_FILE_AT_LINE (110)).reader_objectParams (SOURCE_FILE_AT_LINE (110)).reader_hasKey (enumerator_3351.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (110)) COMMA_SOURCE_FILE_AT_LINE (110)).boolEnum () ;
          if (kBoolTrue == test_1) {
            //-------- @localVariableDeclarationForGeneration
            GALGAS_object_5F_t var_subAttrs ;
            //-------- @methodCallInstructionForGeneration
            cast_3291_b.reader_subAttributes (SOURCE_FILE_AT_LINE (112)).reader_objectParams (SOURCE_FILE_AT_LINE (112)).method_get (enumerator_3351.current_lkey (HERE), var_subAttrs, inCompiler COMMA_SOURCE_FILE_AT_LINE (112)) ;
            //-------- END @methodCallInstructionForGeneration
            //-------- @methodCallInstructionForGeneration
            callCategoryMethod_verifyMultipleType ((const cPtr_impType *) enumerator_3351.current_type (HERE).ptr (), var_subAttrs, inCompiler COMMA_SOURCE_FILE_AT_LINE (113)) ;
            //-------- END @methodCallInstructionForGeneration
          }
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_implementationObjectMap enumerator_3647 (object->mAttribute_falseSubAttributes, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_3647.hasCurrentObject ()) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_2 = cast_3291_b.reader_subAttributes (SOURCE_FILE_AT_LINE (118)).reader_objectParams (SOURCE_FILE_AT_LINE (118)).reader_hasKey (enumerator_3647.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (118)) COMMA_SOURCE_FILE_AT_LINE (118)).boolEnum () ;
          if (kBoolTrue == test_2) {
            //-------- @localVariableDeclarationForGeneration
            GALGAS_object_5F_t var_subAttrs ;
            //-------- @methodCallInstructionForGeneration
            cast_3291_b.reader_subAttributes (SOURCE_FILE_AT_LINE (120)).reader_objectParams (SOURCE_FILE_AT_LINE (120)).method_get (enumerator_3647.current_lkey (HERE), var_subAttrs, inCompiler COMMA_SOURCE_FILE_AT_LINE (120)) ;
            //-------- END @methodCallInstructionForGeneration
            //-------- @methodCallInstructionForGeneration
            callCategoryMethod_verifyMultipleType ((const cPtr_impType *) enumerator_3647.current_type (HERE).ptr (), var_subAttrs, inCompiler COMMA_SOURCE_FILE_AT_LINE (121)) ;
            //-------- END @methodCallInstructionForGeneration
          }
...
static void categoryMethod_impEnumType_verifyType (const cPtr_impType * inObject,
  ...
  if (constinArgument_attr.isValid ()) {
    if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_enumAttribute) {
      GALGAS_enumAttribute cast_4170_e ((cPtr_enumAttribute *) constinArgument_attr.ptr ()) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = object->mAttribute_valuesMap.reader_hasKey (cast_4170_e.reader_value (SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (136)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_implementationObjectMap var_validVal ;
        //-------- @methodCallInstructionForGeneration
        object->mAttribute_valuesMap.method_get (function_lstringWith (cast_4170_e.reader_value (SOURCE_FILE_AT_LINE (138)), inCompiler COMMA_SOURCE_FILE_AT_LINE (138)), var_validVal, inCompiler COMMA_SOURCE_FILE_AT_LINE (138)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @foreachInstructionForGeneration
        cEnumerator_implementationObjectMap enumerator_4340 (var_validVal, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_4340.hasCurrentObject ()) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_1 = cast_4170_e.reader_subAttributes (SOURCE_FILE_AT_LINE (140)).reader_objectParams (SOURCE_FILE_AT_LINE (140)).reader_hasKey (enumerator_4340.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (140)) COMMA_SOURCE_FILE_AT_LINE (140)).boolEnum () ;
          if (kBoolTrue == test_1) {
            //-------- @localVariableDeclarationForGeneration
            GALGAS_object_5F_t var_subAttrs ;
            //-------- @methodCallInstructionForGeneration
            cast_4170_e.reader_subAttributes (SOURCE_FILE_AT_LINE (142)).reader_objectParams (SOURCE_FILE_AT_LINE (142)).method_get (enumerator_4340.current_lkey (HERE), var_subAttrs, inCompiler COMMA_SOURCE_FILE_AT_LINE (142)) ;
            //-------- END @methodCallInstructionForGeneration
            //-------- @methodCallInstructionForGeneration
            callCategoryMethod_verifyMultipleType ((const cPtr_impType *) enumerator_4340.current_type (HERE).ptr (), var_subAttrs, inCompiler COMMA_SOURCE_FILE_AT_LINE (143)) ;
            //-------- END @methodCallInstructionForGeneration
          }
        ...
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (cast_4170_e.reader_location (SOURCE_FILE_AT_LINE (147)), cast_4170_e.reader_value (SOURCE_FILE_AT_LINE (147)).operator_concat (GALGAS_string (" is not a valid enum value") COMMA_SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)) ;
      }
    }else{
...
static void categoryMethod_impAutoDefaultType_verifyType (const cPtr_impType * inObject,
  ...
  if (constinArgument_attr.isValid ()) {
    if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_stringAttribute) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_string (SOURCE_FILE_AT_LINE (162)))).operator_and (GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_identifier (SOURCE_FILE_AT_LINE (162)))) COMMA_SOURCE_FILE_AT_LINE (162)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE_AT_LINE (163)), GALGAS_string ("string of identifier expected") COMMA_SOURCE_FILE_AT_LINE (163)) ;
      }
      ...
      constinArgument_attr.log ("attr" COMMA_SOURCE_FILE_AT_LINE (172)) ;
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE_AT_LINE (173)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (173)).operator_concat (GALGAS_string (" expected") COMMA_SOURCE_FILE_AT_LINE (173)) COMMA_SOURCE_FILE_AT_LINE (173)) ;
    }
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_impRangedType_verifyType (const cPtr_impType * inObject,
  ...
  if (constinArgument_attr.isValid ()) {
    if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_33__32__5F_class) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE_AT_LINE (184)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE_AT_LINE (185)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string (" expected") COMMA_SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)) ;
      }
    }else if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_33__32__5F_class) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_sint_33__32_Number (SOURCE_FILE_AT_LINE (188)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE_AT_LINE (189)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (189)).operator_concat (GALGAS_string (" expected") COMMA_SOURCE_FILE_AT_LINE (189)) COMMA_SOURCE_FILE_AT_LINE (189)) ;
      }
    }else if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_36__34__5F_class) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE_AT_LINE (192)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE_AT_LINE (193)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (193)).operator_concat (GALGAS_string (" expected") COMMA_SOURCE_FILE_AT_LINE (193)) COMMA_SOURCE_FILE_AT_LINE (193)) ;
      }
    }else if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_36__34__5F_class) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_sint_36__34_Number (SOURCE_FILE_AT_LINE (196)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE_AT_LINE (197)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (197)).operator_concat (GALGAS_string (" expected") COMMA_SOURCE_FILE_AT_LINE (197)) COMMA_SOURCE_FILE_AT_LINE (197)) ;
      }
    }else if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_float_5F_class) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, object->mAttribute_type.objectCompare (GALGAS_dataType::constructor_floatNumber (SOURCE_FILE_AT_LINE (200)))).boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE_AT_LINE (201)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (201)).operator_concat (GALGAS_string (" expected") COMMA_SOURCE_FILE_AT_LINE (201)) COMMA_SOURCE_FILE_AT_LINE (201)) ;
      }
    }else if (constinArgument_attr.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_auto) {
      //-------- @ifInstructionForGeneration
      ...
      if (kBoolTrue == test_5) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE_AT_LINE (205)), GALGAS_string ("AUTO is not allowed for ").operator_concat (object->mAttribute_name.reader_string (SOURCE_FILE_AT_LINE (205)) COMMA_SOURCE_FILE_AT_LINE (205)).operator_concat (GALGAS_string (" attribute") COMMA_SOURCE_FILE_AT_LINE (205)) COMMA_SOURCE_FILE_AT_LINE (205)) ;
      }
    }else{
      //-------- @errorInstructionForGeneration
      inCompiler->emitSemanticError (constinArgument_attr.reader_location (SOURCE_FILE_AT_LINE (209)), categoryReader_oilType (object->mAttribute_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (209)).operator_concat (GALGAS_string (" expected") COMMA_SOURCE_FILE_AT_LINE (209)) COMMA_SOURCE_FILE_AT_LINE (209)) ;
    }
  }
}
//---------------------------------------------------------------------------*
