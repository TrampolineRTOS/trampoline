...
static NSUInteger search_into_template_5F_scanner_goilTemplateKeyWordList (NSString * inSearchedString) {
...
- (void) parseLexicalTokenForLexicalColoring {
  ...
  while ((mTokenCode == 0) && (mCurrentChar != '\0')) {
    ...
    if ((mMatchedTemplateDelimiterIndex >= 0) && ([[kTemplateDefinitionArray_template_5F_scanner objectAtIndex:mMatchedTemplateDelimiterIndex] startString].length > 0)) {
      const BOOL foundEndDelimitor = [self testForInputString:[[kTemplateDefinitionArray_template_5F_scanner objectAtIndex:mMatchedTemplateDelimiterIndex] endString] advance:YES] ;
