...
GALGAS_objectKindMap_2E_element cEnumerator_objectKindMap::current (LOCATION_ARGS) const {
  const cMapElement_objectKindMap * p = (const cMapElement_objectKindMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_objectKindMap) ;
  return GALGAS_objectKindMap_2E_element (p->mAttribute_lkey, p->mAttribute_attributes) ;
}
...
GALGAS_objectsMap_2E_element cEnumerator_objectsMap::current (LOCATION_ARGS) const {
  const cMapElement_objectsMap * p = (const cMapElement_objectsMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_objectsMap) ;
  return GALGAS_objectsMap_2E_element (p->mAttribute_lkey, p->mAttribute_objectsOfKind) ;
}
...
GALGAS_objectAttributes function_osObject (const GALGAS_objectsMap & constinArgument_objects,
  ...
  GALGAS_lstringlist var_names = var_objectsForKind.reader_objects (SOURCE_FILE_AT_LINE (50)).reader_keyList (SOURCE_FILE_AT_LINE (50)) ;
...
void routine_setObjectForKindAndName (GALGAS_objectsMap & ioArgument_objects,
  ...
  if (kBoolTrue == test_1) {
    ...
    var_kindMap.modifier_del (var_lname, joker_2397_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (89)) ;
    }
  }
  {
...
GALGAS_objectKindMap_2E_element::GALGAS_objectKindMap_2E_element (void) :
mAttribute_lkey (),
...
GALGAS_objectKindMap_2E_element::GALGAS_objectKindMap_2E_element (const GALGAS_lstring & inOperand0,
...
GALGAS_objectKindMap_2E_element GALGAS_objectKindMap_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_objectKindMap_2E_element (GALGAS_lstring::constructor_default (HERE),
                                          GALGAS_objectAttributes::constructor_default (HERE)) ;
}

//---------------------------------------------------------------------------*

GALGAS_objectKindMap_2E_element GALGAS_objectKindMap_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                  const GALGAS_objectAttributes & inOperand1 
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_objectKindMap_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_objectKindMap_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_objectKindMap_2E_element::objectCompare (const GALGAS_objectKindMap_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
...
bool GALGAS_objectKindMap_2E_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_attributes.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_objectKindMap_2E_element::drop (void) {
...
void GALGAS_objectKindMap_2E_element::description (C_String & ioString,
                                                   const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_objectKindMap_2E_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_objectAttributes GALGAS_objectKindMap_2E_element::reader_attributes (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_objectKindMap_2E_element ("objectKindMap.element",
                                                 NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_objectKindMap_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_objectKindMap_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_objectKindMap_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_objectKindMap_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_objectKindMap_2E_element GALGAS_objectKindMap_2E_element::extractObject (const GALGAS_object & inObject,
                                                                                C_Compiler * inCompiler
                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_objectKindMap_2E_element result ;
  const GALGAS_objectKindMap_2E_element * p = (const GALGAS_objectKindMap_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_objectKindMap_2E_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_objectsMap_2E_element::GALGAS_objectsMap_2E_element (void) :
mAttribute_lkey (),
...
GALGAS_objectsMap_2E_element::GALGAS_objectsMap_2E_element (const GALGAS_lstring & inOperand0,
...
GALGAS_objectsMap_2E_element GALGAS_objectsMap_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_objectsMap_2E_element (GALGAS_lstring::constructor_default (HERE),
                                       GALGAS_objectKind::constructor_default (HERE)) ;
}

//---------------------------------------------------------------------------*

GALGAS_objectsMap_2E_element GALGAS_objectsMap_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                            const GALGAS_objectKind & inOperand1 
                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_objectsMap_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_objectsMap_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_objectsMap_2E_element::objectCompare (const GALGAS_objectsMap_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_objectsMap_2E_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_objectsOfKind.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_objectsMap_2E_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_objectsMap_2E_element::description (C_String & ioString,
                                                const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_objectsMap_2E_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_objectKind GALGAS_objectsMap_2E_element::reader_objectsOfKind (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_objectsMap_2E_element ("objectsMap.element",
                                              NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_objectsMap_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_objectsMap_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_objectsMap_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_objectsMap_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_objectsMap_2E_element GALGAS_objectsMap_2E_element::extractObject (const GALGAS_object & inObject,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_objectsMap_2E_element result ;
  const GALGAS_objectsMap_2E_element * p = (const GALGAS_objectsMap_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_objectsMap_2E_element *> (p)) {
      result = *p ;
    }else{
