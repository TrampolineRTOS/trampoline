...
GALGAS_applicationDefinition function_emptyApplicationDefinition (C_Compiler * inCompiler
  ...
  result_result = GALGAS_applicationDefinition::constructor_new (function_emptyLString (inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 36)), function_emptyLString (inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 37)), function_emptyLString (inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 38)), function_emptyLString (inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 39)), GALGAS_objectsMap::constructor_emptyMap (SOURCE_FILE ("goil_types_root.gSemantics", 40))  COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 35)) ;
//---
...
GALGAS_objectAttributes function_osObject (const GALGAS_objectsMap & constinArgument_objects,
  ...
  constinArgument_objects.method_get (function_lstringWith (GALGAS_string ("OS"), inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 49)), var_objectsForKind, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 49)) ;
  GALGAS_lstringlist var_names = var_objectsForKind.reader_objects (SOURCE_FILE ("goil_types_root.gSemantics", 50)).reader_keyList (SOURCE_FILE ("goil_types_root.gSemantics", 50)) ;
  GALGAS_lstring var_name ;
  var_names.method_first (var_name, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 52)) ;
  var_objectsForKind.reader_objects (SOURCE_FILE ("goil_types_root.gSemantics", 53)).method_get (var_name, result_os, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 53)) ;
//---
  return result_os ;
}
...
GALGAS_objectAttributes function_objectForKindAndName (const GALGAS_objectsMap & constinArgument_objects,
  ...
  const enumGalgasBool test_0 = constinArgument_objects.reader_hasKey (constinArgument_kind COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 62)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_objectKind var_kindObj ;
    constinArgument_objects.method_get (function_lstringWith (constinArgument_kind, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 64)), var_kindObj, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 64)) ;
    const enumGalgasBool test_1 = var_kindObj.reader_objects (SOURCE_FILE ("goil_types_root.gSemantics", 65)).reader_hasKey (constinArgument_name COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 65)).boolEnum () ;
    if (kBoolTrue == test_1) {
      var_kindObj.reader_objects (SOURCE_FILE ("goil_types_root.gSemantics", 66)).method_get (function_lstringWith (constinArgument_name, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 66)), result_object, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 66)) ;
    }else if (kBoolFalse == test_1) {
      result_object = GALGAS_objectAttributes::constructor_new (GALGAS_identifierMap::constructor_emptyMap (SOURCE_FILE ("goil_types_root.gSemantics", 68))  COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 68)) ;
    }
  }else if (kBoolFalse == test_0) {
    result_object = GALGAS_objectAttributes::constructor_new (GALGAS_identifierMap::constructor_emptyMap (SOURCE_FILE ("goil_types_root.gSemantics", 71))  COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 71)) ;
  }
//---
...
void routine_setObjectForKindAndName (GALGAS_objectsMap & ioArgument_objects,
                                      ...
                                      C_Compiler * inCompiler
                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_lkind = function_lstringWith (constinArgument_kind, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 81)) ;
  GALGAS_lstring var_lname = function_lstringWith (constinArgument_name, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 82)) ;
  GALGAS_objectKind var_kindObj = GALGAS_objectKind::constructor_new (GALGAS_objectKindMap::constructor_emptyMap (SOURCE_FILE ("goil_types_root.gSemantics", 83))  COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 83)) ;
  const enumGalgasBool test_0 = ioArgument_objects.reader_hasKey (constinArgument_kind COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 84)).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
    ioArgument_objects.modifier_del (var_lkind, var_kindObj, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 85)) ;
    }
  }
  GALGAS_objectKindMap var_kindMap = var_kindObj.reader_objects (SOURCE_FILE ("goil_types_root.gSemantics", 87)) ;
  const enumGalgasBool test_1 = var_kindMap.reader_hasKey (constinArgument_name COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 88)).boolEnum () ;
  if (kBoolTrue == test_1) {
    {
    GALGAS_objectAttributes joker_2397_0 ; // Joker input parameter
    var_kindMap.modifier_del (var_lname, joker_2397_0, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 89)) ;
    }
  }
  {
  var_kindMap.modifier_put (var_lname, constinArgument_object, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 91)) ;
  }
  {
  var_kindObj.modifier_setObjects (var_kindMap COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 92)) ;
  }
  {
  ioArgument_objects.modifier_put (var_lkind, var_kindObj, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 93)) ;
  }
}
...
GALGAS_objectKind function_objectsForKind (const GALGAS_objectsMap & constinArgument_objects,
  ...
  const enumGalgasBool test_0 = constinArgument_objects.reader_hasKey (constinArgument_kind COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 101)).boolEnum () ;
  if (kBoolTrue == test_0) {
    constinArgument_objects.method_get (function_lstringWith (constinArgument_kind, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 102)), result_result, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 102)) ;
  }else if (kBoolFalse == test_0) {
    result_result = GALGAS_objectKind::constructor_new (GALGAS_objectKindMap::constructor_emptyMap (SOURCE_FILE ("goil_types_root.gSemantics", 104))  COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 104)) ;
  }
//---
  return result_result ;
}
...
GALGAS_identifierList function_listInOS (const GALGAS_objectsMap & constinArgument_objects,
  ...
  GALGAS_objectAttributes var_os = function_osObject (constinArgument_objects, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 114)) ;
  var_os.reader_objectParams (SOURCE_FILE ("goil_types_root.gSemantics", 115)).method_get (function_lstringWith (constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 115)), var_itemsContainer, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 115)) ;
  result_items = function_multipleAttributeOrError (var_itemsContainer, constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE ("goil_types_root.gSemantics", 116)) ;
//---
  return result_items ;
}
