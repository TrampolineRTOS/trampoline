...
GALGAS_identifierList function_multipleAttributeOrError (const GALGAS_object_5F_t & constinArgument_t,
  ...
  if (constinArgument_t.isValid ()) {
    if (constinArgument_t.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_multipleAttribute) {
      GALGAS_multipleAttribute cast_1503_l ((cPtr_multipleAttribute *) constinArgument_t.ptr ()) ;
      //-------- @assignmentInstructionForGeneration
      result_v = cast_1503_l.reader_items (SOURCE_FILE_AT_LINE (75)) ;
    }else{
...
GALGAS_bool function_boolAttributeOrError (GALGAS_object_5F_t inArgument_t,
  ...
  if (inArgument_t.isValid ()) {
    if (inArgument_t.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_boolAttribute) {
      GALGAS_boolAttribute cast_1883_attribute ((cPtr_boolAttribute *) inArgument_t.ptr ()) ;
      //-------- @assignmentInstructionForGeneration
      result_v = cast_1883_attribute.reader_value (SOURCE_FILE_AT_LINE (94)) ;
    }else{
      //-------- @errorInstructionForGeneration
...
GALGAS_uint function_uint_33__32__5F_or_5F_error (GALGAS_object_5F_t inArgument_t,
  ...
  if (inArgument_t.isValid ()) {
    if (inArgument_t.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_33__32__5F_class) {
      GALGAS_uint_33__32__5F_class cast_2389_ui ((cPtr_uint_33__32__5F_class *) inArgument_t.ptr ()) ;
      //-------- @assignmentInstructionForGeneration
      result_v = cast_2389_ui.reader_value (SOURCE_FILE_AT_LINE (122)) ;
    }else{
      //-------- @errorInstructionForGeneration
...
GALGAS_uint function_uint_33__32_OrError (GALGAS_object_5F_t inArgument_t,
  ...
  if (inArgument_t.isValid ()) {
    if (inArgument_t.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_33__32__5F_class) {
      GALGAS_uint_33__32__5F_class cast_2617_ui ((cPtr_uint_33__32__5F_class *) inArgument_t.ptr ()) ;
      //-------- @assignmentInstructionForGeneration
      result_v = cast_2617_ui.reader_value (SOURCE_FILE_AT_LINE (136)) ;
    }else{
      //-------- @errorInstructionForGeneration
...
GALGAS_sint function_sint_33__32_OrError (GALGAS_object_5F_t inArgument_t,
  ...
  if (inArgument_t.isValid ()) {
    if (inArgument_t.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_33__32__5F_class) {
      GALGAS_sint_33__32__5F_class cast_2992_ui ((cPtr_sint_33__32__5F_class *) inArgument_t.ptr ()) ;
      //-------- @assignmentInstructionForGeneration
      result_v = cast_2992_ui.reader_value (SOURCE_FILE_AT_LINE (157)) ;
    }else{
      //-------- @errorInstructionForGeneration
...
GALGAS_uint_36__34_ function_uint_36__34_OrError (GALGAS_object_5F_t inArgument_t,
  ...
  if (inArgument_t.isValid ()) {
    if (inArgument_t.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_36__34__5F_class) {
      GALGAS_uint_36__34__5F_class cast_3367_ui ((cPtr_uint_36__34__5F_class *) inArgument_t.ptr ()) ;
      //-------- @assignmentInstructionForGeneration
      result_v = cast_3367_ui.reader_value (SOURCE_FILE_AT_LINE (178)) ;
    }else{
      //-------- @errorInstructionForGeneration
...
GALGAS_luint_36__34_ function_luint_36__34_OrError (GALGAS_object_5F_t inArgument_t,
  ...
  if (inArgument_t.isValid ()) {
    if (inArgument_t.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_36__34__5F_class) {
      GALGAS_uint_36__34__5F_class cast_3612_ui ((cPtr_uint_36__34__5F_class *) inArgument_t.ptr ()) ;
      //-------- @assignmentInstructionForGeneration
      result_v = GALGAS_luint_36__34_::constructor_new (cast_3612_ui.reader_value (SOURCE_FILE_AT_LINE (191)), cast_3612_ui.reader_location (SOURCE_FILE_AT_LINE (191)) COMMA_SOURCE_FILE_AT_LINE (191)) ;
    }else{
      //-------- @assignmentInstructionForGeneration
...
GALGAS_sint_36__34_ function_sint_36__34_OrError (GALGAS_object_5F_t inArgument_t,
  ...
  if (inArgument_t.isValid ()) {
    if (inArgument_t.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_36__34__5F_class) {
      GALGAS_sint_36__34__5F_class cast_4079_ui ((cPtr_sint_36__34__5F_class *) inArgument_t.ptr ()) ;
      //-------- @assignmentInstructionForGeneration
      result_v = cast_4079_ui.reader_value (SOURCE_FILE_AT_LINE (213)) ;
    }else{
      //-------- @errorInstructionForGeneration
...
GALGAS_double function_floatOrError (GALGAS_object_5F_t inArgument_t,
  ...
  if (inArgument_t.isValid ()) {
    if (inArgument_t.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_float_5F_class) {
      GALGAS_float_5F_class cast_4466_ui ((cPtr_float_5F_class *) inArgument_t.ptr ()) ;
      //-------- @assignmentInstructionForGeneration
      result_v = cast_4466_ui.reader_value (SOURCE_FILE_AT_LINE (234)) ;
    }else{
      //-------- @errorInstructionForGeneration
...
GALGAS_lstring function_stringAttributeOrError (const GALGAS_object_5F_t & constinArgument_attribute,
  ...
  if (constinArgument_attribute.isValid ()) {
    if (constinArgument_attribute.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_stringAttribute) {
      GALGAS_stringAttribute cast_5057_attribute ((cPtr_stringAttribute *) constinArgument_attribute.ptr ()) ;
      //-------- @assignmentInstructionForGeneration
      result_result = GALGAS_lstring::constructor_new (cast_5057_attribute.reader_value (SOURCE_FILE_AT_LINE (262)), cast_5057_attribute.reader_location (SOURCE_FILE_AT_LINE (262)) COMMA_SOURCE_FILE_AT_LINE (262)) ;
    }else{
      //-------- @errorInstructionForGeneration
