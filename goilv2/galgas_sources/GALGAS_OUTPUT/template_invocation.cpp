...
GALGAS_string function_displayTypeAndValue (const GALGAS_Ttype & constinArgument_inType,
  ...
  if (constinArgument_inType.isValid ()) {
    ...
    case GALGAS_Ttype::kEnum_listType: {
      ...
      cEnumerator_TfieldMapList enumerator_3821 (constinArgument_inValue.reader_mMapListValue (SOURCE_FILE_AT_LINE (88)), kEnumeration_up) ;
      //--- simple foreach instruction
      GALGAS_uint index_3793 ((PMUInt32) 0) ;
      while (enumerator_3821.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("\n"
          "  #").operator_concat (index_3793.reader_string (SOURCE_FILE_AT_LINE (89)) COMMA_SOURCE_FILE_AT_LINE (89)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (89)) COMMA_SOURCE_FILE_AT_LINE (89)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_TfieldMap enumerator_3899 (enumerator_3821.current_mMap (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_3899.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          result_outResult.dotAssign_operation (GALGAS_string ("'").operator_concat (enumerator_3899.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)).operator_concat (GALGAS_string ("' ") COMMA_SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)) ;
          //------- @switchInstructionForGeneration
          if (enumerator_3899.current_mType (HERE).isValid ()) {
            switch (enumerator_3899.current_mType (HERE).enumValue ()) {
            case GALGAS_Ttype::kNotBuilt:
              break ;
            case GALGAS_Ttype::kEnum_boolType: {
              //-------- @concatInstructionForGeneration
              ...
              const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_3899.current_mValue (HERE).reader_mInt_36__34_Value (SOURCE_FILE_AT_LINE (94)).objectCompare (GALGAS_sint_36__34_ ((PMSInt64) 1LL))).boolEnum () ;
              if (kBoolTrue == test_5) {
            ...
            case GALGAS_Ttype::kEnum_intType: {
              //-------- @concatInstructionForGeneration
              result_outResult.dotAssign_operation (GALGAS_string ("unsigned: ").operator_concat (enumerator_3899.current_mValue (HERE).reader_mInt_36__34_Value (SOURCE_FILE_AT_LINE (96)).reader_string (SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (96)) COMMA_SOURCE_FILE_AT_LINE (96)) ;
              } break ;
            case GALGAS_Ttype::kEnum_floatType: {
              //-------- @concatInstructionForGeneration
              result_outResult.dotAssign_operation (GALGAS_string ("float: ").operator_concat (enumerator_3899.current_mValue (HERE).reader_mFloatValue (SOURCE_FILE_AT_LINE (98)).reader_string (SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)) ;
              } break ;
            case GALGAS_Ttype::kEnum_stringType: {
              //-------- @concatInstructionForGeneration
              result_outResult.dotAssign_operation (GALGAS_string ("string: '").operator_concat (enumerator_3899.current_mValue (HERE).reader_mStringValue (SOURCE_FILE_AT_LINE (100)) COMMA_SOURCE_FILE_AT_LINE (100)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (100)) COMMA_SOURCE_FILE_AT_LINE (100)) ;
              } break ;
          ...
          if (enumerator_3899.hasNextObject ()) {
            //-------- @concatInstructionForGeneration
        ...
        index_3793.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (88)) ;
      }
      } break ;
...
void routine_displayTemplateVariableMap (const GALGAS_TfieldMap constinArgument_inTemplateVariableMap,
                                         ...
                                         COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @foreachInstructionForGeneration
  cEnumerator_TfieldMap enumerator_5039 (constinArgument_inTemplateVariableMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_5039.hasCurrentObject ()) {
    //-------- @messageInstructionForGeneration
    inCompiler->printMessage (GALGAS_string ("'").operator_concat (enumerator_5039.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)).operator_concat (GALGAS_string ("' ") COMMA_SOURCE_FILE_AT_LINE (124)).operator_concat (function_displayTypeAndValue (enumerator_5039.current_mType (HERE), enumerator_5039.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (124)) COMMA_SOURCE_FILE_AT_LINE (124)) ;
...
void routine_displayPathList (const GALGAS_stringlist constinArgument_pathList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_5276 (constinArgument_pathList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_5276.hasCurrentObject ()) {
    //-------- @messageInstructionForGeneration
    inCompiler->printMessage (GALGAS_string (" - '").operator_concat (enumerator_5276.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (133)).operator_concat (GALGAS_string ("'\n") COMMA_SOURCE_FILE_AT_LINE (133)) COMMA_SOURCE_FILE_AT_LINE (133)) ;
...
void routine_findFileInHierarchy (const GALGAS_string constinArgument_file,
  ...
  if (constinArgument_searchPath.reader_length (SOURCE_FILE_AT_LINE (149)).isValid ()) {
    PMUInt32 variant_5689 = constinArgument_searchPath.reader_length (SOURCE_FILE_AT_LINE (149)).uintValue () ;
    bool loop_5689 = true ;
    while (loop_5689) {
      loop_5689 = GALGAS_bool (kIsStrictSup, var_partialPath.reader_length (SOURCE_FILE_AT_LINE (150)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (ioArgument_found.operator_not (SOURCE_FILE_AT_LINE (150)) COMMA_SOURCE_FILE_AT_LINE (150)).isValid () ;
      if (loop_5689) {
        loop_5689 = GALGAS_bool (kIsStrictSup, var_partialPath.reader_length (SOURCE_FILE_AT_LINE (150)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (ioArgument_found.operator_not (SOURCE_FILE_AT_LINE (150)) COMMA_SOURCE_FILE_AT_LINE (150)).boolValue () ;
      }
      if (loop_5689 && (0 == variant_5689)) {
        loop_5689 = false ;
...
void routine_findAllFilesInHierarchy (const GALGAS_string constinArgument_file,
  ...
  if (constinArgument_searchPath.reader_length (SOURCE_FILE_AT_LINE (180)).isValid ()) {
    PMUInt32 variant_6591 = constinArgument_searchPath.reader_length (SOURCE_FILE_AT_LINE (180)).uintValue () ;
    bool loop_6591 = true ;
    while (loop_6591) {
      loop_6591 = GALGAS_bool (kIsStrictSup, var_partialPath.reader_length (SOURCE_FILE_AT_LINE (181)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValid () ;
      if (loop_6591) {
        loop_6591 = GALGAS_bool (kIsStrictSup, var_partialPath.reader_length (SOURCE_FILE_AT_LINE (181)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolValue () ;
      }
      if (loop_6591 && (0 == variant_6591)) {
        loop_6591 = false ;
...
void routine_findFileInPathList (const GALGAS_string constinArgument_file,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_7607 (constinArgument_rootPathList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_7607.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_findFileInHierarchy (constinArgument_file, enumerator_7607.current_mValue (HERE), constinArgument_searchPath, outArgument_searchedPathList, outArgument_found, outArgument_fullPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (216)) ;
    } //-------- @routineCallInstructionForGeneration
...
void routine_findAllFilesInPathList (const GALGAS_string constinArgument_file,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_8146 (constinArgument_rootPathList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_8146.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_findAllFilesInHierarchy (constinArgument_file, enumerator_8146.current_mValue (HERE), constinArgument_searchPath, outArgument_searchedPathList, outArgument_fullPaths, inCompiler COMMA_SOURCE_FILE_AT_LINE (240)) ;
    } //-------- @routineCallInstructionForGeneration
        ...
        if (kBoolTrue == test_6) {
          ...
          if (kBoolTrue == test_8) {
            ...
            if (var_targetDir.reader_length (SOURCE_FILE_AT_LINE (305)).isValid ()) {
              PMUInt32 variant_10835 = var_targetDir.reader_length (SOURCE_FILE_AT_LINE (305)).uintValue () ;
              bool loop_10835 = true ;
              while (loop_10835) {
                loop_10835 = GALGAS_bool (kIsStrictSup, var_targetTemplatePartialPath.reader_length (SOURCE_FILE_AT_LINE (306)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (306)) COMMA_SOURCE_FILE_AT_LINE (306)).isValid () ;
                if (loop_10835) {
                  loop_10835 = GALGAS_bool (kIsStrictSup, var_targetTemplatePartialPath.reader_length (SOURCE_FILE_AT_LINE (306)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (var_found.operator_not (SOURCE_FILE_AT_LINE (306)) COMMA_SOURCE_FILE_AT_LINE (306)).boolValue () ;
                }
                ...
                if (loop_10835) {
                  ...
                  if (kBoolTrue == test_13) {
                    { //-------- @grammarInstructionWithSourceFileForGeneration
                    GALGAS_Tvalue joker_11387_0 ; // Joker input parameter
                    GALGAS_Ttype joker_11390_0 ; // Joker input parameter
                    cGrammar_template_5F_grammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_fullTemplatePath, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (313)), constinArgument_inPrefix, constinArgument_inPath, constinArgument_inTemplateDirectory, constinArgument_inTemplateVariableMap, ioArgument_ioResultingString, joker_11387_0, joker_11390_0 COMMA_SOURCE_FILE_AT_LINE (313)) ;
                    } //-------- END @grammarInstructionWithSourceFileForGeneration
            ...
            if (kBoolTrue == test_16) {
              ...
              if (kBoolTrue == test_17) {
                ...
                //-------- @foreachInstructionForGeneration
                cEnumerator_stringlist enumerator_12273 (var_pathList, kEnumeration_up) ;
                //--- simple foreach instruction
                while (enumerator_12273.hasCurrentObject ()) {
                  //-------- @concatInstructionForGeneration
                  var_m.dotAssign_operation (GALGAS_string ("\n"
                    "  - '").operator_concat (enumerator_12273.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (332)).operator_concat (GALGAS_string ("';") COMMA_SOURCE_FILE_AT_LINE (332)) COMMA_SOURCE_FILE_AT_LINE (332)) ;
