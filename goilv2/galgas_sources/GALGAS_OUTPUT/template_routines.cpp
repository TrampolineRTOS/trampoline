...
GALGAS_string function_goil_5F_template (const GALGAS_string & constinArgument_prefix,
  ...
  routine_templateInvocation (GALGAS_lstring::constructor_new (constinArgument_name, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (12)), constinArgument_prefix, GALGAS_string ("templates"), function_rootTemplatesDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (15)), GALGAS_bool (true), constinArgument_cfg, result_result, joker_335_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (11)) ;
  }
//---
...
GALGAS_string function_computeTemplate (const GALGAS_string & constinArgument_prefix,
  ...
  routine_templateInvocation (GALGAS_lstring::constructor_new (constinArgument_name, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (30)), constinArgument_prefix, GALGAS_string ("templates"), function_rootTemplatesDirectory (inCompiler COMMA_SOURCE_FILE_AT_LINE (33)), GALGAS_bool (true), constinArgument_cfg, result_result, joker_619_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (29)) ;
  }
//---
  return result_result ;
}
