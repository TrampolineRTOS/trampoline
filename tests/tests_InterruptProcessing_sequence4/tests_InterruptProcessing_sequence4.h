 /* 
  * @file tests_InterruptProcessing_sequence4.h
  * 
 * $Date: 2008/06/12 15:09:12 $
 * $Rev$
 * $Author: GuillaumeNuth $
 * $URL$
 */

#ifndef TESTS_INTERRUPTPROCESSING_SEQUENCE4_H_
#define TESTS_INTERRUPTPROCESSING_SEQUENCE4_H_
...
#endif /*TESTS_INTERRUPTPROCESSING_SEQUENCE4_H_*/
