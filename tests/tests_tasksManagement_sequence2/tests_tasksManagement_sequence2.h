 /* 
  * @file tests_tasksManagement_sequence2.h
  * 
...
#ifndef TESTS_TASKSMANAGEMENT_SEQUENCE2_H_
#define TESTS_TASKSMANAGEMENT_SEQUENCE2_H_
...
#endif /*TESTS_TASKSMANAGEMENT_SEQUENCE2_H_*/
