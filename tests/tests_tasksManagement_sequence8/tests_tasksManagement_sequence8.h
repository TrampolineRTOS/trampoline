 /* 
  * @file tests_tasksManagement_sequence8.h
  * 
...
#ifndef TESTS_TASKSMANAGEMENT_SEQUENCE8_H_
#define TESTS_TASKSMANAGEMENT_SEQUENCE8_H_
...
#endif /*TESTS_TASKSMANAGEMENT_SEQUENCE8_H_*/
