 /* 
  * @file tests_tasksManagement_sequence4.h
  * 
...
#ifndef TESTS_TASKSMANAGEMENT_SEQUENCE4_H_
#define TESTS_TASKSMANAGEMENT_SEQUENCE4_H_
...
#endif /*TESTS_TASKSMANAGEMENT_SEQUENCE4_H_*/
