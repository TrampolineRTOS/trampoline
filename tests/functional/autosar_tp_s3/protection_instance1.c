/**
 * @file autosar_tp_s3/protection_instance1.c
 *
...
static void test_protection_instance1(void)
{
  ...
  SCHEDULING_CHECK_AND_EQUAL_INT(11, E_OS_PROTECTION_TIME, Fatalerrorstatus);	  
}
...
/* End of file autosar_tp_s3/protection_instance1.c */
