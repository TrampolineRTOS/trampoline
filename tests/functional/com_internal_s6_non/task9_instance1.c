/**
 * @file com_internal_s6_non/task9_instance1.c
 *
...
static void test_t9_instance1(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(9,E_OK, result_inst_1);
	SCHEDULING_CHECK_AND_EQUAL_INT(9,3, (int)received_char);
...
/* End of file com_internal_s6_non/task9_instance1.c */
