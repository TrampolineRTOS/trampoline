/**
 * @file com_internal_s6_non/task6_instance2.c
 *
...
static void test_t6_instance2(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(43,E_OK, result_inst_1);
	SCHEDULING_CHECK_AND_EQUAL_INT(43,2, (int)received_char);
...
/* End of file com_internal_s6_non/task6_instance2.c */
