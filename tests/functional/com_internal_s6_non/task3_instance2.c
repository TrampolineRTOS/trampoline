/**
 * @file com_internal_s6_non/task3_instance2.c
 *
...
static void test_t3_instance2(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(37,E_OK, result_inst_1);
	SCHEDULING_CHECK_AND_EQUAL_INT(37,2, (int)received_char);
...
/* End of file com_internal_s6_non/task3_instance2.c */
