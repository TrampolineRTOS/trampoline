/**
 * @file interrupts_s6/error_instance16.c
 *
...
static void test_error_instance16(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(34,OSServiceId_SetAbsAlarm, result_inst_1);
...
/* End of file interrupts_s6/error_instance16.c */
