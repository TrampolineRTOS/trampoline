/**
 * @file interrupts_s6/error_instance10.c
 *
...
static void test_error_instance10(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(22,OSServiceId_ClearEvent, result_inst_1);
...
/* End of file interrupts_s6/error_instance10.c */
