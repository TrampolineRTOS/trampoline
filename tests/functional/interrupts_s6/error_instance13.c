/**
 * @file interrupts_s6/error_instance13.c
 *
...
static void test_error_instance13(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(28,OSServiceId_GetAlarmBase, result_inst_1);
...
/* End of file interrupts_s6/error_instance13.c */
