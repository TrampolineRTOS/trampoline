/**
 * @file interrupts_s6/error_instance17.c
 *
...
static void test_error_instance17(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(36,OSServiceId_CancelAlarm, result_inst_1);
...
/* End of file interrupts_s6/error_instance17.c */
