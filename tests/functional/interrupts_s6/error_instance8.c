/**
 * @file interrupts_s6/error_instance8.c
 *
...
static void test_error_instance8(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(18,OSServiceId_ReleaseResource, result_inst_1);
...
/* End of file interrupts_s6/error_instance8.c */
