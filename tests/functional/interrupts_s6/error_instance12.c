/**
 * @file interrupts_s6/error_instance12.c
 *
...
static void test_error_instance12(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(26,OSServiceId_WaitEvent, result_inst_1);
...
/* End of file interrupts_s6/error_instance12.c */
