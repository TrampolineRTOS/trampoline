/**
 * @file autosar_sts_s7/task1_instance.c
 *
...
static void test_t1_instance(void)
{
	...
	StatusType result_inst_21, result_inst_22, result_inst_23, result_inst_24, result_inst_25, result_inst_26, result_inst_27, result_inst_28, result_inst_29, result_inst_30, result_inst_31, result_inst_32, result_inst_33;
	...
	result_inst_3 = SyncScheduleTable(sched_explicit, 9);
	...
	/*offset = 6 (sc) - 5 (st) -> t2 receive Event1 */
	...
	result_inst_13 = GetScheduleTableStatus(sched_explicit, &ScheduleTableStatusType_inst_3);
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(16, SCHEDULETABLE_RUNNING_AND_SYNCHRONOUS , ScheduleTableStatusType_inst_3);
	SCHEDULING_CHECK_AND_EQUAL_INT(16,E_OK, result_inst_13);
	
	SCHEDULING_CHECK_INIT(17);
	result_inst_14 = SyncScheduleTable(sched_explicit, 0);
	SCHEDULING_CHECK_AND_EQUAL_INT(17,E_OK, result_inst_14);
	
	SCHEDULING_CHECK_INIT(18);
	result_inst_15 = GetScheduleTableStatus(sched_explicit, &ScheduleTableStatusType_inst_4);
	...
	/*offset = 9 (sc) - 1 (st) -> t2 receive Event1 */
	SCHEDULING_CHECK_AND_EQUAL_INT(20,E_OK, result_inst_16);
	
	SCHEDULING_CHECK_INIT(21);
	result_inst_17 = GetScheduleTableStatus(sched_explicit, &ScheduleTableStatusType_inst_5);
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(21, SCHEDULETABLE_RUNNING , ScheduleTableStatusType_inst_5);
	...
	result_inst_27 = IncrementCounter(Software_Counter1);
	/*offset = 19 (sc) - 1 (st) -> t2 activated */
	SCHEDULING_CHECK_AND_EQUAL_INT(32,E_OK, result_inst_27);
	...
	result_inst_29 = IncrementCounter(Software_Counter1);
	/*offset = 21 (sc) - 3 (st) */
	SCHEDULING_CHECK_AND_EQUAL_INT(34,E_OK, result_inst_29);
	
	SCHEDULING_CHECK_INIT(35);
	result_inst_30 = IncrementCounter(Software_Counter1);
	/*offset = 22 (sc) - 4 (st) */
	SCHEDULING_CHECK_AND_EQUAL_INT(35,E_OK, result_inst_30);
	
	SCHEDULING_CHECK_INIT(36);
	result_inst_31 = GetScheduleTableStatus(sched_explicit, &ScheduleTableStatusType_inst_6);
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(36, SCHEDULETABLE_RUNNING , ScheduleTableStatusType_inst_6);
	SCHEDULING_CHECK_AND_EQUAL_INT(36,E_OK, result_inst_31);
		
	SCHEDULING_CHECK_INIT(37);
	result_inst_32 = IncrementCounter(Software_Counter1);
	/*offset = 23 (sc) - 5 (st) -> t2 received Event1 */
	SCHEDULING_CHECK_AND_EQUAL_INT(38,E_OK, result_inst_32);
	
	SCHEDULING_CHECK_INIT(39);
	result_inst_33 = GetScheduleTableStatus(sched_explicit, &ScheduleTableStatusType_inst_7);
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(39, SCHEDULETABLE_RUNNING_AND_SYNCHRONOUS , ScheduleTableStatusType_inst_7);
	SCHEDULING_CHECK_AND_EQUAL_INT(39,E_OK, result_inst_33);
		
}

/*create the test suite with all the test cases*/
TestRef AutosarSTSTest_seq7_t1_instance(void)
{
	EMB_UNIT_TESTFIXTURES(fixtures) {
		new_TestFixture("test_t1_instance",test_t1_instance)
	};
	EMB_UNIT_TESTCALLER(AutosarSTSTest,"AutosarSTTest_sequence7",NULL,NULL,fixtures);
	
	return (TestRef)&AutosarSTSTest;
}

/* End of file autosar_sts_s7/task1_instance.c */
