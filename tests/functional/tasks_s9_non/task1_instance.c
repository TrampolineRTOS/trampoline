/**
 * @file tasks_s9_non/task1_instance.c
 *
...
{
	StatusType result_inst_2,result_inst_4,result_inst_6,result_inst_7,result_inst_8,result_inst_9;
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(4,E_OK , result_inst_7);
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(8,E_OK , result_inst_9);
...
/* End of file tasks_s9_non/task1_instance.c */
