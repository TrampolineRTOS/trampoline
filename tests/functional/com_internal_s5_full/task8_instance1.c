/**
 * @file com_internal_s5_full/task8_instance1.c
 *
...
static void test_t8_instance1(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(28,E_OK, result_inst_1);
	SCHEDULING_CHECK_AND_EQUAL_INT(28,1, (int)received_char);
...
/* End of file com_internal_s5_full/task8_instance1.c */
