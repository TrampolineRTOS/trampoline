/**
 * @file com_internal_s5_full/task2_instance1.c
 *
...
static void test_t2_instance1(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(2,1, (int)received_char);
...
/* End of file com_internal_s5_full/task2_instance1.c */
