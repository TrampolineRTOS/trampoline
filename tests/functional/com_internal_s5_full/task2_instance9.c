/**
 * @file com_internal_s5_full/task2_instance9.c
 *
...
static void test_t2_instance9(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(46,5, (int)received_char);
	SCHEDULING_CHECK_AND_EQUAL_INT(46,E_OK, result_inst_1);
		
	SCHEDULING_CHECK_INIT(47);
	result_inst_2 = TerminateTask();
	SCHEDULING_CHECK_AND_EQUAL_INT(47,E_OK, result_inst_2);
}
...
/* End of file com_internal_s5_full/task2_instance9.c */
