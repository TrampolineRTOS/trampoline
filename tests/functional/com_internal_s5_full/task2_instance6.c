/**
 * @file com_internal_s5_full/task2_instance6.c
 *
...
static void test_t2_instance6(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(31,0, (int)received_char);
...
/* End of file com_internal_s5_full/task2_instance6.c */
