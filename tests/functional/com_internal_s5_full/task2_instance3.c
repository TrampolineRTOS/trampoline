/**
 * @file com_internal_s5_full/task2_instance3.c
 *
...
static void test_t2_instance3(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(14,3, (int)received_char);
...
/* End of file com_internal_s5_full/task2_instance3.c */
