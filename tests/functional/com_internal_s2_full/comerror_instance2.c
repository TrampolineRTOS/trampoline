/**
 * @file com_internal_s2_full/comerror_instance2.c
 *
...
static void test_comerror_instance2(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(18,COMServiceId_ReceiveMessage , result_inst_1);
	
	SCHEDULING_CHECK_INIT(19);
	result_inst_2 = (StatusType)(*COMError_ReceiveMessage_DataRef());
	SCHEDULING_CHECK_AND_EQUAL_INT(19,(StatusType)('1') , result_inst_2);
	
	SCHEDULING_CHECK_INIT(20);
	result_inst_3 = (StatusType)COMError_ReceiveMessage_Message();
	SCHEDULING_CHECK_AND_EQUAL_INT(20,rm , result_inst_3);
...
/* End of file com_internal_s2_full/comerror_instance2.c */
