/**
 * @file com_internal_s2_full/comerror_instance1.c
 *
...
static void test_comerror_instance1(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(5,INVALID_MESSAGE , result_inst_3);
...
/* End of file com_internal_s2_full/comerror_instance1.c */
