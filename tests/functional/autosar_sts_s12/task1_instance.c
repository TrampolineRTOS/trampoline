/**
 * @file autosar_sts_s12/task1_instance.c
 *
...
static void test_t1_instance(void)
{
	...
	StatusType result_inst_11, result_inst_12, result_inst_13, result_inst_14, result_inst_15, result_inst_16, result_inst_17, result_inst_18, result_inst_19, result_inst_20, result_inst_21, result_inst_22, result_inst_23, result_inst_24;
	...
	result_inst_9 = SyncScheduleTable(sched_explicit, 9);
	...
	/*offset = 4 (sc) - 0 (st) -> t2 activated */
	SCHEDULING_CHECK_AND_EQUAL_INT(12,E_OK, result_inst_11);
	
	SCHEDULING_CHECK_INIT(13);
	result_inst_12 = IncrementCounter(Software_Counter1);
	/*offset = 5 (sc) - 1 (st) -> t2 receive Event1 */
	SCHEDULING_CHECK_AND_EQUAL_INT(15,E_OK, result_inst_12);
	
	SCHEDULING_CHECK_INIT(16);
	result_inst_13 = IncrementCounter(Software_Counter1);
	/*offset = 6 (sc) - 2 (st) -> t2 receive Event1 */
	SCHEDULING_CHECK_AND_EQUAL_INT(17,E_OK, result_inst_13);
	
	SCHEDULING_CHECK_INIT(18);
	result_inst_14 = GetScheduleTableStatus(sched_explicit, &ScheduleTableStatusType_inst_5);
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(18, SCHEDULETABLE_RUNNING , ScheduleTableStatusType_inst_5);
	SCHEDULING_CHECK_AND_EQUAL_INT(18,E_OK, result_inst_14);
	
	SCHEDULING_CHECK_INIT(19);
	result_inst_15 = IncrementCounter(Software_Counter1);
	/*offset = 7 (sc) - 3 (st) -> finalize -> t2 activated */
	SCHEDULING_CHECK_AND_EQUAL_INT(20,E_OK, result_inst_15);
	
	SCHEDULING_CHECK_INIT(21);
	result_inst_16 = GetScheduleTableStatus(sched_explicit, &ScheduleTableStatusType_inst_6);
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(21, SCHEDULETABLE_RUNNING_AND_SYNCHRONOUS , ScheduleTableStatusType_inst_6);
	...
	/*offset = 10 (sc) - 5 (st) -> t2 received Event1 */
	SCHEDULING_CHECK_AND_EQUAL_INT(26,E_OK, result_inst_19);
	
	SCHEDULING_CHECK_INIT(27);
	result_inst_20 = GetScheduleTableStatus(sched_explicit, &ScheduleTableStatusType_inst_7);
	...
	/*offset = 12 (sc) - 7 (st) */
	SCHEDULING_CHECK_AND_EQUAL_INT(29,E_OK, result_inst_22);
	
	SCHEDULING_CHECK_INIT(30);
	result_inst_23 = IncrementCounter(Software_Counter1);
	/*offset = 13 (sc) - 8 (st) -> t2 received Event1 */
	SCHEDULING_CHECK_AND_EQUAL_INT(31,E_OK, result_inst_23);
	
	SCHEDULING_CHECK_INIT(32);
	result_inst_24 = GetScheduleTableStatus(sched_explicit, &ScheduleTableStatusType_inst_8);
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(32, SCHEDULETABLE_RUNNING_AND_SYNCHRONOUS , ScheduleTableStatusType_inst_8);
	SCHEDULING_CHECK_AND_EQUAL_INT(32,E_OK, result_inst_24);
	
}

/*create the test suite with all the test cases*/
TestRef AutosarSTSTest_seq12_t1_instance(void)
{
	EMB_UNIT_TESTFIXTURES(fixtures) {
		new_TestFixture("test_t1_instance",test_t1_instance)
	};
	EMB_UNIT_TESTCALLER(AutosarSTSTest,"AutosarSTTest_sequence12",NULL,NULL,fixtures);
	
	return (TestRef)&AutosarSTSTest;
}

/* End of file autosar_sts_s12/task1_instance.c */
