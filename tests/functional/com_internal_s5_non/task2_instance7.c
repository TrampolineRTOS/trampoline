/**
 * @file com_internal_s5_non/task2_instance7.c
 *
...
static void test_t2_instance7(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(45,1, (int)received_char);
...
/* End of file com_internal_s5_non/task2_instance7.c */
