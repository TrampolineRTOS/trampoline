/**
 * @file com_internal_s5_non/task2_instance2.c
 *
...
static void test_t2_instance2(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(11,2, (int)received_char);
...
/* End of file com_internal_s5_non/task2_instance2.c */
