/**
 * @file autosar_sts_s2/error_instance1.c
 *
...
static void test_error_instance1(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(2,INVALID_SCHEDULETABLE , OSError_StartScheduleTableSynchron_ScheduleTableID());
...
/* End of file autosar_sts_s2/error_instance1.c */
