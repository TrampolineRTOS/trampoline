/**
 * @file autosar_sts_s2/error_instance3.c
 *
...
static void test_error_instance3(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(6,sched_nosync , OSError_StartScheduleTableSynchron_ScheduleTableID());
...
/* End of file autosar_sts_s2/error_instance3.c */
