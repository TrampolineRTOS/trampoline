/**
 * @file autosar_sts_s2/error_instance9.c
 *
...
static void test_error_instance9(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(20,sched_explicit, OSError_SyncScheduleTable_ScheduleTableID());
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(20,11 , OSError_SyncScheduleTable_value());
...
/* End of file autosar_sts_s2/error_instance9.c */
