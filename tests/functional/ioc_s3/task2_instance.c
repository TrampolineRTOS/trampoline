...
static void test_t2_instance1(void)
{
  ...
  result_inst_1 = IocReceiveGroup_ioc1(&data1, &data2);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(5,IOC_E_OK, result_inst_1);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(5,0x01, data1);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(5,0x01, data2.a);
  SCHEDULING_CHECK_AND_EQUAL_INT(5,0x02, data2.b);

  SCHEDULING_CHECK_INIT(6);
  result_inst_2 = IocReceiveGroup_ioc1(&data1, &data2);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(6,IOC_E_OK, result_inst_2);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(6,0x02, data1);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(6,0x03, data2.a);
  SCHEDULING_CHECK_AND_EQUAL_INT(6,0x04, data2.b);

  SCHEDULING_CHECK_INIT(7);
  result_inst_3 = IocReceiveGroup_ioc1(&data1, &data2);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(7,IOC_E_OK, result_inst_3);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(7,0x03, data1);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(7,0x05, data2.a);
  SCHEDULING_CHECK_AND_EQUAL_INT(7,0x06, data2.b);

  SCHEDULING_CHECK_INIT(8);
  result_inst_4 = IocReceiveGroup_ioc1(&data1, &data2);
  SCHEDULING_CHECK_AND_EQUAL_INT(8,IOC_E_NO_DATA, result_inst_4);
...
static void test_t2_instance2(void)
{
  ...
  result_inst_1 = IocReceiveGroup_ioc1(&data1, &data2);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(15,IOC_E_LOST_DATA, result_inst_1);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(15,0x01, data1);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(15,0x01, data2.a);
  SCHEDULING_CHECK_AND_EQUAL_INT(15,0x02, data2.b);

  SCHEDULING_CHECK_INIT(16);
  result_inst_2 = IocReceiveGroup_ioc1(&data1, &data2);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(16,IOC_E_OK, result_inst_2);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(16,0x02, data1);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(16,0x03, data2.a);
  SCHEDULING_CHECK_AND_EQUAL_INT(16,0x04, data2.b);
...
static void test_t2_instance3(void)
{
  ...
  result_inst_1 = IocReceiveGroup_ioc1(&data1, &data2);
  SCHEDULING_CHECK_AND_EQUAL_INT(22,IOC_E_NO_DATA, result_inst_1);
