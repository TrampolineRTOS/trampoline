/**
 * @file autosar_tp_s4/autosar_tp_s4.c
 *
...
TestRef AutosarTPTest_seq4_isr1_instance1(void);
TestRef AutosarTPTest_seq4_isr1_instance2(void);
TestRef AutosarTPTest_seq4_isr1_instance3(void);
TestRef AutosarTPTest_seq4_isr2_instance1(void);
TestRef AutosarTPTest_seq4_isr2_instance2(void);
TestRef AutosarTPTest_seq4_protection_instance1(void);
TestRef AutosarTPTest_seq4_protection_instance2(void);
...
{
  TestRunner_start();
  TestRunner_runTest(AutosarTPTest_seq4_t1_instance());
  ShutdownOS(E_OK);
}
...
ISR(softwareInterruptHandler0)
{
  instance_isr1++;
	switch (instance_isr1)
	{
		case 1 :
		{
      TestRunner_runTest(AutosarTPTest_seq4_isr1_instance1());
			break;
		}
		case 2 :
		{
      TestRunner_runTest(AutosarTPTest_seq4_isr1_instance2());
      break;
		}
		case 3 :
		{
      TestRunner_runTest(AutosarTPTest_seq4_isr1_instance3());
      break;
		}
		default:
		{
...
{ 
  instance_isr2++;
	switch (instance_isr2)
	{
		case 1 :
		{
      TestRunner_runTest(AutosarTPTest_seq4_isr2_instance1());
			break;
		}
		case 2 :
		{
      TestRunner_runTest(AutosarTPTest_seq4_isr2_instance2());
      break;
		}
		default:
		{
...
/* End of file autosar_tp_s4/autosar_tp_s4.c */
