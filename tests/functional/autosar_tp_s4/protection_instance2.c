/**
 * @file autosar_tp_s4/protection_instance2.c
 *
...
static void test_protection_instance2(void)
{
  ...
  SCHEDULING_CHECK_AND_EQUAL_INT(12, E_OS_PROTECTION_TIME, Fatalerrorstatus);
}
...
/* End of file autosar_tp_s4/protection_instance2.c */
