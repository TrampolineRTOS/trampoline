/**
 * @file com_internal_s1_full/comerror_instance4.c
 *
...
static void test_comerror_instance4(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(19,INVALID_MESSAGE , result_inst_3);
...
/* End of file com_internal_s1_full/comerror_instance4.c */
