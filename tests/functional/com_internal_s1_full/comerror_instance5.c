/**
 * @file com_internal_s1_full/comerror_instance5.c
 *
...
static void test_comerror_instance5(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(22,COMServiceId_SendMessage , result_inst_1);
	
	SCHEDULING_CHECK_INIT(23);
	result_inst_2 = (StatusType)(*COMError_ReceiveMessage_DataRef());
	SCHEDULING_CHECK_AND_EQUAL_INT(23,(StatusType)('3') , result_inst_2);
	
	SCHEDULING_CHECK_INIT(24);
	result_inst_3 = (StatusType)COMError_ReceiveMessage_Message();
	SCHEDULING_CHECK_AND_EQUAL_INT(24, (StatusType)(-1) , result_inst_3);
...
/* End of file com_internal_s1_full/comerror_instance5.c */
