/**
 * @file autosar_tp_s5/autosar_tp_s5.c
 *
...
TASK(t1)
{
  instance_t1++;
	switch (instance_t1)
	{
		...
		{
      TestRunner_start();
      TestRunner_runTest(AutosarTPTest_seq5_t1_instance1());
			break;
		}
		case 2 :
		{
      TestRunner_runTest(AutosarTPTest_seq5_t1_instance2());
      break;
		}
		case 3 :
		{
      TestRunner_runTest(AutosarTPTest_seq5_t1_instance3());
      ShutdownOS(E_OK);      
      break;
		}
		default:
...
/* End of file autosar_tp_s5/autosar_tp_s5.c */
