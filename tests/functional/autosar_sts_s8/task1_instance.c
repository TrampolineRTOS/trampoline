/**
 * @file autosar_sts_s8/task1_instance.c
 *
...
static void test_t1_instance(void)
{
	...
	StatusType result_inst_21, result_inst_22, result_inst_23, result_inst_24, result_inst_25, result_inst_26, result_inst_27;
	...
	/*offset = 6 (sc) - 1 (st) -> t2 receive Event1 */
	...
	/*offset = 11 (sc) - 6 (st) */
	SCHEDULING_CHECK_AND_EQUAL_INT(21,E_OK, result_inst_18);
	
	SCHEDULING_CHECK_INIT(22);
	result_inst_19 = IncrementCounter(Software_Counter1);
	/*offset = 12 (sc) - 7 (st) */
	SCHEDULING_CHECK_AND_EQUAL_INT(22,E_OK, result_inst_19);
	
	SCHEDULING_CHECK_INIT(23);
	result_inst_20 = GetScheduleTableStatus(sched_explicit, &ScheduleTableStatusType_inst_5);
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(23, SCHEDULETABLE_RUNNING , ScheduleTableStatusType_inst_5);
	SCHEDULING_CHECK_AND_EQUAL_INT(23,E_OK, result_inst_20);
	...
	result_inst_22 = GetScheduleTableStatus(sched_explicit, &ScheduleTableStatusType_inst_6);
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(26, SCHEDULETABLE_RUNNING_AND_SYNCHRONOUS , ScheduleTableStatusType_inst_6);
	...
	/*offset = 17 (sc) - 2 (st) -> t2 activated */
	SCHEDULING_CHECK_AND_EQUAL_INT(31,E_OK, result_inst_26);
		
	SCHEDULING_CHECK_INIT(32);
	result_inst_27 = GetScheduleTableStatus(sched_explicit, &ScheduleTableStatusType_inst_7);
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(32, SCHEDULETABLE_RUNNING_AND_SYNCHRONOUS , ScheduleTableStatusType_inst_7);
...
TestRef AutosarSTSTest_seq8_t1_instance(void)
{
	...
	EMB_UNIT_TESTCALLER(AutosarSTSTest,"AutosarSTTest_sequence8",NULL,NULL,fixtures);
	
	return (TestRef)&AutosarSTSTest;
}

/* End of file autosar_sts_s8/task1_instance.c */
