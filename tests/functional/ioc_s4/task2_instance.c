...
char strTestCallerNamet2[]="TaskManagementTest_sequence4";
...
static void test_t2_instance(void)
{
  ...
  result_inst_1 = IocReadGroup_ioc1(&data1, &data2);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(3,IOC_E_OK, result_inst_1);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(3,0x01, data1);
  SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(3,0x01, data2.a);
  SCHEDULING_CHECK_AND_EQUAL_INT(3,0x02, data2.b);
