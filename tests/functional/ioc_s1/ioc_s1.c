...
TASK(t1)
{
  ...
  /*test ends here, ShutdownOs cannot be called as we are in a non-trusted app*/
  TestRunner_end();
}
...
TASK(t2)
{
  ...
  switch(instance_t2)
  {
    case 1:
    {
      TestRunner_runTest(TaskManagementTest_seq1_t2_instance1());
      break;
    }
    case 2:
    {
      TestRunner_runTest(TaskManagementTest_seq1_t2_instance2());
      break;
    }
    default:
    {
