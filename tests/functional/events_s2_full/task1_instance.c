/**
 * @file events_s2_full/task1_instance.c
 *
...
{
	StatusType result_inst_2, result_inst_3, result_inst_5, result_inst_6, result_inst_7,  result_inst_9, result_inst_10;
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(6,Event1, result_inst_4);
...
/* End of file events_s2_full/task1_instance.c */
