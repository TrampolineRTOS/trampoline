/**
 * @file autosar_sts_s1/error_instance2.c
 *
...
static void test_error_instance2(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(16,OSServiceId_ActivateTask , result_inst_1);
...
/* End of file autosar_sts_s1/error_instance2.c */
