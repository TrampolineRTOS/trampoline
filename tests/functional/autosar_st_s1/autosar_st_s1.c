/**
 * @file autosar_st_s1/autosar_st_s1.c
 *
...
TestRef AutosarSTTest_seq1_error_instance3(void);
TestRef AutosarSTTest_seq1_error_instance4(void);
TestRef AutosarSTTest_seq1_error_instance5(void);
TestRef AutosarSTTest_seq1_error_instance6(void);
TestRef AutosarSTTest_seq1_error_instance7(void);
TestRef AutosarSTTest_seq1_error_instance8(void);
TestRef AutosarSTTest_seq1_error_instance9(void);
...
{
	TestRunner_start();
	TestRunner_runTest(AutosarSTTest_seq1_t1_instance());
	ShutdownOS(E_OK);
}
...
/* End of file autosar_st_s1/autosar_st_s1.c */
