/**
 * @file autosar_sp_s3/error_instance3.c
 *
...
static void test_error_instance3(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(11, E_OS_RESOURCE , error_status);
	SCHEDULING_CHECK_AND_EQUAL_INT(11, OSServiceId_TerminateTask , result_inst_1);
...
/* End of file autosar_sp_s3/error_instance3.c */
