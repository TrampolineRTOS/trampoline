/**
 * @file autosar_sts_s11/task2_instance2.c
 *
...
TestRef AutosarSTSTest_seq11_t2_instance2(void)
{
	...
	EMB_UNIT_TESTCALLER(AutosarSTSTest,"AutosarSTSTest_sequence11",NULL,NULL,fixtures);
	
	return (TestRef)&AutosarSTSTest;
}

/* End of file autosar_sts_s11/task2_instance2.c */
