/**
 * @file autosar_sts_s11/task1_instance.c
 *
...
static void test_t1_instance(void)
{
	...
	StatusType result_inst_12, result_inst_13, result_inst_14, result_inst_15, result_inst_16, result_inst_17, result_inst_18, result_inst_19, result_inst_20, result_inst_21, result_inst_22, result_inst_23;
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(17, SCHEDULETABLE_RUNNING_AND_SYNCHRONOUS , ScheduleTableStatusType_inst_6);
	...
	/*offset = 8 (sc) - 8 (st) -> t2 receive Event1 */
	SCHEDULING_CHECK_AND_EQUAL_INT(21,E_OK, result_inst_17);
	
	SCHEDULING_CHECK_INIT(22);
	result_inst_18 = GetScheduleTableStatus(sched_explicit, &ScheduleTableStatusType_inst_7);
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(22, SCHEDULETABLE_RUNNING_AND_SYNCHRONOUS , ScheduleTableStatusType_inst_7);
	...
	/*offset = 12 (sc) - 2 (st) -> t2 activated */
	SCHEDULING_CHECK_AND_EQUAL_INT(27,E_OK, result_inst_22);
	
	SCHEDULING_CHECK_INIT(28);
	result_inst_23 = GetScheduleTableStatus(sched_explicit, &ScheduleTableStatusType_inst_8);
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(28, SCHEDULETABLE_RUNNING_AND_SYNCHRONOUS , ScheduleTableStatusType_inst_8);
...
TestRef AutosarSTSTest_seq11_t1_instance(void)
{
	EMB_UNIT_TESTFIXTURES(fixtures) {
		new_TestFixture("test_t1_instance",test_t1_instance)
	};
	EMB_UNIT_TESTCALLER(AutosarSTSTest,"AutosarSTTest_sequence11",NULL,NULL,fixtures);
	
	return (TestRef)&AutosarSTSTest;
}

/* End of file autosar_sts_s11/task1_instance.c */
