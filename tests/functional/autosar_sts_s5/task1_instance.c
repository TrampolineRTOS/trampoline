/**
 * @file autosar_sts_s5/task1_instance.c
 *
...
static void test_t1_instance(void)
{
	...
	StatusType result_inst_11, result_inst_12, result_inst_13, result_inst_14, result_inst_15, result_inst_16, result_inst_17, result_inst_18, result_inst_19, result_inst_20, result_inst_21;
	...
	/*offset = 9 (sc) - 5 (st) -> t2 received Event1 */
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(25, SCHEDULETABLE_RUNNING_AND_SYNCHRONOUS , ScheduleTableStatusType_inst_6);
	...
	/*offset = 12 (sc) - 8 (st) -> t2 received Event1 */
	SCHEDULING_CHECK_AND_EQUAL_INT(29,E_OK, result_inst_21);
	
}

/*create the test suite with all the test cases*/
TestRef AutosarSTSTest_seq5_t1_instance(void)
{
	EMB_UNIT_TESTFIXTURES(fixtures) {
		new_TestFixture("test_t1_instance",test_t1_instance)
	};
	EMB_UNIT_TESTCALLER(AutosarSTSTest,"AutosarSTTest_sequence5",NULL,NULL,fixtures);
	
	return (TestRef)&AutosarSTSTest;
}

/* End of file autosar_sts_s5/task1_instance.c */
