/**
 * @file com_internal_s6_full/task9_instance2.c
 *
...
static void test_t9_instance2(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(17,E_OK, result_inst_1);
	SCHEDULING_CHECK_AND_EQUAL_INT(17,12, (int)received_char);
...
/* End of file com_internal_s6_full/task9_instance2.c */
