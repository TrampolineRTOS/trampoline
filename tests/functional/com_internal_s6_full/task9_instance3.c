/**
 * @file com_internal_s6_full/task9_instance3.c
 *
...
static void test_t9_instance3(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(42,E_OK, result_inst_1);
	SCHEDULING_CHECK_AND_EQUAL_INT(42,2, (int)received_char);
...
/* End of file com_internal_s6_full/task9_instance3.c */
