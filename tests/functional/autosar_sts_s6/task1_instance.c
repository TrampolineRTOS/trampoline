/**
 * @file autosar_sts_s6/task1_instance.c
 *
...
static void test_t1_instance(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(9, SCHEDULETABLE_RUNNING_AND_SYNCHRONOUS , ScheduleTableStatusType_inst_3);
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(11, SCHEDULETABLE_RUNNING , ScheduleTableStatusType_inst_4);
	...
	/*offset = 12 (sc) - 0 (st) -> finalize -> t2 activated */
...
TestRef AutosarSTSTest_seq6_t1_instance(void)
{
	EMB_UNIT_TESTFIXTURES(fixtures) {
		new_TestFixture("test_t1_instance",test_t1_instance)
	};
	EMB_UNIT_TESTCALLER(AutosarSTSTest,"AutosarSTTest_sequence6",NULL,NULL,fixtures);
	
	return (TestRef)&AutosarSTSTest;
}

/* End of file autosar_sts_s6/task1_instance.c */
