/**
 * @file resources_s1_non/resources_s1.c
 *
...
TestRef ResourceManagementTest_seq5_isr3_instance(void);
...
{
	TestRunner_start();
	TestRunner_runTest(ResourceManagementTest_seq5_t1_instance());
	ShutdownOS(E_OK);
}
...
/* End of file resources_s1_non/resources_s1.c */
