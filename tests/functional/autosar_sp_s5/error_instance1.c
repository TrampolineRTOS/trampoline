/**
 * @file autosar_sp_s5/error_instance1.c
 *
...
static void test_error_instance1(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(3,OSServiceId_GetApplicationID, result_inst_1);
...
/* End of file autosar_sp_s5/error_instance1.c */
