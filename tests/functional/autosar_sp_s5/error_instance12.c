/**
 * @file autosar_sp_s5/error_instance12.c
 *
...
static void test_error_instance12(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(25,OSServiceId_SetScheduleTableAsync, result_inst_1);
...
/* End of file autosar_sp_s5/error_instance12.c */
