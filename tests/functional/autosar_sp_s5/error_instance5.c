/**
 * @file autosar_sp_s5/error_instance5.c
 *
...
static void test_error_instance5(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(11,OSServiceId_StartScheduleTableRel, result_inst_1);
...
/* End of file autosar_sp_s5/error_instance5.c */
