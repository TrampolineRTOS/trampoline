/**
 * @file autosar_sp_s5/error_instance7.c
 *
...
static void test_error_instance7(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(15,OSServiceId_StopScheduleTable, result_inst_1);
...
/* End of file autosar_sp_s5/error_instance7.c */
