/**
 * @file autosar_sp_s5/error_instance13.c
 *
...
static void test_error_instance13(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(27,OSServiceId_IncrementCounter, result_inst_1);
...
/* End of file autosar_sp_s5/error_instance13.c */
