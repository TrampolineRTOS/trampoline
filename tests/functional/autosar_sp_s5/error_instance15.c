/**
 * @file autosar_sp_s5/error_instance15.c
 *
...
static void test_error_instance15(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(31,OSServiceId_GetElapsedCounterValue, result_inst_1);
...
/* End of file autosar_sp_s5/error_instance15.c */
