/**
 * @file autosar_sp_s5/error_instance14.c
 *
...
static void test_error_instance14(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(29,OSServiceId_GetCounterValue, result_inst_1);
...
/* End of file autosar_sp_s5/error_instance14.c */
