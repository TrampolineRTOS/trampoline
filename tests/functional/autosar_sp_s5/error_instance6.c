/**
 * @file autosar_sp_s5/error_instance6.c
 *
...
static void test_error_instance6(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(13,OSServiceId_StartScheduleTableAbs, result_inst_1);
...
/* End of file autosar_sp_s5/error_instance6.c */
