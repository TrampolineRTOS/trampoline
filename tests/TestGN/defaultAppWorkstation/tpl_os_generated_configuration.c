...
/*
 * Resource descriptor of resource r2
 *
 * Tasks which use this resource :
 * $TASKS$
 *
 ...
 * $ISRS$
 */
tpl_resource descriptor_of_resource_r2 = {
    /* ceiling priority of the resource */  (tpl_priority)4,
    /* owner previous priority          */  (tpl_priority)0,
    /* owner of the resource            */  NULL,
    /* next resource in the list        */  NULL
};
 ...
 */
arm7_context integer_context_of_periodicTask;
 ...
 * t1 stack
 */
tpl_stack_word stack_zone_of_t1[16000/sizeof(tpl_stack_word)];

#define STACK_OF_TASK_t1 { stack_zone_of_t1, 16000 } 
 ...
 * t2 stack
 */
tpl_stack_word stack_zone_of_t2[16000/sizeof(tpl_stack_word)];

#define STACK_OF_TASK_t2 { stack_zone_of_t2, 16000 } 
 ...
 * t3 stack
 */
tpl_stack_word stack_zone_of_t3[16000/sizeof(tpl_stack_word)];

#define STACK_OF_TASK_t3 { stack_zone_of_t3, 16000 } 
 ...
 * trap_SIGUSR1 stack
 */
tpl_stack_word stack_zone_of_trap_SIGUSR1[1000/sizeof(tpl_stack_word)];

#define STACK_OF_ISR_trap_SIGUSR1 { stack_zone_of_trap_SIGUSR1, 1000 }

/*
 * trap_SIGUSR1 context
 */
arm7_context integer_context_of_trap_SIGUSR1;

#define CONTEXT_OF_ISR_trap_SIGUSR1 &integer_context_of_trap_SIGUSR1
/*
 * ISR trap_SIGUSR1 function prototype
 */
void function_of_isr_trap_SIGUSR1(void);
...
/*
 * Static descriptor of ISR trap_SIGUSR1
 */
tpl_exec_static static_descriptor_of_isr_trap_SIGUSR1 = {
    /* context                  */ {CONTEXT_OF_ISR_trap_SIGUSR1},
    /* stack                    */ STACK_OF_ISR_trap_SIGUSR1,
    /* entry point (function)   */ function_of_isr_trap_SIGUSR1,
    /* internal ressource       */ NULL,
    /* isr id                   */ 0,
...
tpl_isr_static static_helper_of_isr_trap_SIGUSR1 = {
	/* helper */ NULL,
	/* next */   NULL
};

/*
 * Dynamic descriptor of ISR trap_SIGUSR1
 */
tpl_isr descriptor_of_isr_trap_SIGUSR1 = {
    {       /* beginning of exec_desc part */
    /* static descriptor    */  &static_descriptor_of_isr_trap_SIGUSR1,
    /* resources            */  NULL,
    /* activate count       */  0,
    ...
    /* more static desc     */  &static_helper_of_isr_trap_SIGUSR1
#ifdef WITH_AUTOSAR
    ,
    /* enabled field        */  TRUE
#endif
 ...
 * trap_SIGUSR2 stack
 */
tpl_stack_word stack_zone_of_trap_SIGUSR2[32768/sizeof(tpl_stack_word)];

#define STACK_OF_ISR_trap_SIGUSR2 { stack_zone_of_trap_SIGUSR2, 32768 }

/*
 * trap_SIGUSR2 context
 */
arm7_context integer_context_of_trap_SIGUSR2;

#define CONTEXT_OF_ISR_trap_SIGUSR2 &integer_context_of_trap_SIGUSR2
/*
 * ISR trap_SIGUSR2 function prototype
 */
void function_of_isr_trap_SIGUSR2(void);
...
/*
 * Static descriptor of ISR trap_SIGUSR2
 */
tpl_exec_static static_descriptor_of_isr_trap_SIGUSR2 = {
    /* context                  */ {CONTEXT_OF_ISR_trap_SIGUSR2},
    /* stack                    */ STACK_OF_ISR_trap_SIGUSR2,
    /* entry point (function)   */ function_of_isr_trap_SIGUSR2,
    /* internal ressource       */ NULL,
    /* isr id                   */ 0,
    /* isr base priority        */ (tpl_priority)4,
    /* max activation count     */ 1,
    /* isr type                 */ IS_ROUTINE,
#ifdef WITH_AUTOSAR_TIMING_PROTECTION
    /* pointer to the timing
...
tpl_isr_static static_helper_of_isr_trap_SIGUSR2 = {
	/* helper */ NULL,
	/* next */   NULL
};

/*
 * Dynamic descriptor of ISR trap_SIGUSR2
 */
tpl_isr descriptor_of_isr_trap_SIGUSR2 = {
    {       /* beginning of exec_desc part */
    /* static descriptor    */  &static_descriptor_of_isr_trap_SIGUSR2,
    /* resources            */  NULL,
    /* activate count       */  0,
    ...
    /* more static desc     */  &static_helper_of_isr_trap_SIGUSR2
#ifdef WITH_AUTOSAR
    ,
    /* enabled field        */  TRUE
#endif
