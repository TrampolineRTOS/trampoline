...
static void test_t1_instance(void)
{
	...
	result_inst_2 = EnableInterrupt(isr1);
	result_inst_3 = DisableInterrupt(isr1);
	result_inst_4 = DisableInterrupt(isr1);
	result_inst_5 = EnableInterrupt(isr2);
	result_inst_6 = EnableInterrupt(isr2);
	result_inst_7 = DisableInterrupt(isr2);
	result_inst_8 = DisableInterrupt(isr2);
	TEST_ASSERT_EQUAL_INT((E_OK|E_OS_NOFUNC), result_inst_1);
	TEST_ASSERT_EQUAL_INT(E_OS_NOFUNC, result_inst_2);
	TEST_ASSERT_EQUAL_INT(E_OK, result_inst_3);
	TEST_ASSERT_EQUAL_INT(E_OS_NOFUNC, result_inst_4);
	TEST_ASSERT_EQUAL_INT((E_OK|E_OS_NOFUNC), result_inst_5);
	TEST_ASSERT_EQUAL_INT(E_OS_NOFUNC, result_inst_6);
	TEST_ASSERT_EQUAL_INT(E_OK, result_inst_7);
	TEST_ASSERT_EQUAL_INT(E_OS_NOFUNC, result_inst_8);*/
}
...
TestRef InterruptProcessingTest_seq2_t1_instance(void)
{
	...
	EMB_UNIT_TESTCALLER(InterruptProcessingTest,"InterruptProcessingTest_sequence2",setUp,tearDown,fixtures);
