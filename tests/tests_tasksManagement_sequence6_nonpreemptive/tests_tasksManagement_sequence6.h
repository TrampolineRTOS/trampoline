 /* 
  * @file tests_tasksManagement_sequence6.h
  * 
...
#ifndef TESTS_TASKSMANAGEMENT_SEQUENCE6_H_
#define TESTS_TASKSMANAGEMENT_SEQUENCE6_H_
...
#endif /*TESTS_TASKSMANAGEMENT_SEQUENCE6_H_*/
