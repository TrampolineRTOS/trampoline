...
\service{DeclareTask(\emph{task_id})}
...
\service{DeclareAlarm(\emph{alarm_id})}
...
\service{DeclareEvent(\emph{event_id})}
...
\service{DeclareResource(\emph{rez_id})}
...
\service{DeclareMessage(\emph{mess_id})}
