...
\note{Currently only standard resources are supported}

For each resource, a command named \com{_<resource name>} is generated. This command displays the type (Standard) of the resource, its name and identifier as well as:
