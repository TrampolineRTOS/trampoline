/**
 * @file autosar_st_s1/error_instance6.c
 *
...
static void test_error_instance6(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(17, sched1 , OSServiceId_StopScheduleTable_ScheduleTableID());
...
/* End of file autosar_st_s1/error_instance6.c */
