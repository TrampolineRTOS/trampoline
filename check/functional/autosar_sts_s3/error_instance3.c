/**
 * @file autosar_sts_s3/error_instance3.c
 *
...
static void test_error_instance3(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT_FIRST(10,sched_explicit, OSServiceId_StartScheduleTableAbs_ScheduleTableID());
	SCHEDULING_CHECK_AND_EQUAL_INT(10,1 , OSServiceId_StartScheduleTableAbs_value());
...
/* End of file autosar_sts_s3/error_instance3.c */
