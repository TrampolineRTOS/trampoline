...
static void test_t1_instance(void)
{
	...
	ApplicationType result_app_1, result_app_2, result_app_3, result_app_4, result_app_5, result_app_6, result_app_7, result_app_8, result_app_9, result_app_10, result_app_11, result_app_12, result_app_13, result_app_14, result_app_15;
	...
	result_obj_23 = CheckObjectAccess(app1, OBJECT_COUNTER, SystemCounter); 
	SCHEDULING_CHECK_AND_EQUAL_INT(23, NO_ACCESS, result_obj_23);
	
	
	SCHEDULING_CHECK_INIT(24);
	result_app_1 = CheckObjectOwnership(OBJECT_TYPE_COUNT, t1); 
	SCHEDULING_CHECK_AND_EQUAL_INT(24, INVALID_OSAPPLICATION, result_app_1);
	
	SCHEDULING_CHECK_INIT(25);
	result_app_2 = CheckObjectOwnership(OBJECT_TASK, INVALID_TASK); 
	SCHEDULING_CHECK_AND_EQUAL_INT(25, INVALID_OSAPPLICATION, result_app_2);
	
	SCHEDULING_CHECK_INIT(26);
	result_app_3 = CheckObjectOwnership(OBJECT_TASK, t1); 
	SCHEDULING_CHECK_AND_EQUAL_INT(26, app1, result_app_3);
	
	
	SCHEDULING_CHECK_INIT(27);
	result_app_4 = CheckObjectOwnership(OBJECT_ISR, INVALID_ISR); 
	SCHEDULING_CHECK_AND_EQUAL_INT(27, INVALID_OSAPPLICATION, result_app_4);
	
	SCHEDULING_CHECK_INIT(28);
	result_app_5 = CheckObjectOwnership(OBJECT_ISR, isr1); 
	SCHEDULING_CHECK_AND_EQUAL_INT(28, app2, result_app_5);
	
	
	SCHEDULING_CHECK_INIT(29);
	result_app_6 = CheckObjectOwnership(OBJECT_ALARM, INVALID_ALARM); 
	SCHEDULING_CHECK_AND_EQUAL_INT(29, INVALID_OSAPPLICATION, result_app_6);
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(31, INVALID_OSAPPLICATION, result_app_8);
	
	SCHEDULING_CHECK_INIT(32);
	result_app_9 = CheckObjectOwnership(OBJECT_RESOURCE, Resource1); 
	SCHEDULING_CHECK_AND_EQUAL_INT(32, app1, result_app_9);
	
	SCHEDULING_CHECK_INIT(33);
	result_app_10 = CheckObjectOwnership(OBJECT_RESOURCE, RES_SCHEDULER); 
	SCHEDULING_CHECK_AND_EQUAL_INT(33, INVALID_OSAPPLICATION, result_app_10);
	
	
	SCHEDULING_CHECK_INIT(34);
	result_app_11 = CheckObjectOwnership(OBJECT_SCHEDULETABLE, INVALID_SCHEDULETABLE); 
	SCHEDULING_CHECK_AND_EQUAL_INT(34, INVALID_OSAPPLICATION, result_app_11);
	
	SCHEDULING_CHECK_INIT(35);
	result_app_12 = CheckObjectOwnership(OBJECT_SCHEDULETABLE, sched1); 
	SCHEDULING_CHECK_AND_EQUAL_INT(35, app1, result_app_12);
	
	
	SCHEDULING_CHECK_INIT(36);
	result_app_13 = CheckObjectOwnership(OBJECT_COUNTER, INVALID_COUNTER); 
	SCHEDULING_CHECK_AND_EQUAL_INT(36, INVALID_OSAPPLICATION, result_app_13);
	
	SCHEDULING_CHECK_INIT(37);
	result_app_14 = CheckObjectOwnership(OBJECT_COUNTER, Software_Counter); 
	SCHEDULING_CHECK_AND_EQUAL_INT(37, app1, result_app_14);
	
	SCHEDULING_CHECK_INIT(38);
	result_app_15 = CheckObjectOwnership(OBJECT_COUNTER, SystemCounter); 
	SCHEDULING_CHECK_AND_EQUAL_INT(38, INVALID_OSAPPLICATION, result_app_15);
