/**
 * @file autosar_alarm_s2/error_instance1.c
 *
...
static void test_error_instance1(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(6,OSServiceId_ActivateTask , result_inst_1);
...
/* End of file autosar_alarm_s2/error_instance1.c */
