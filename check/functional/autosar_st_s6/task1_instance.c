...
DeclareScheduleTable(sched_rel_0);
DeclareScheduleTable(sched_rel_1);
DeclareScheduleTable(sched_rel_2);
DeclareScheduleTable(sched_rel_3);
...
static void test_t1_instance(void)
{
	...
	StatusType result_inst_15, result_inst_16, result_inst_17, result_inst_18, result_inst_19, result_inst_20, result_inst_21, result_inst_22, result_inst_23, result_inst_24, result_inst_25;
	...
	result_inst_10 = StartScheduleTableRel(sched_rel_0, 4);
	/* obj in 3+4+6=13= 6 */
	SCHEDULING_CHECK_AND_EQUAL_INT(10,E_OK, result_inst_10);
	
	SCHEDULING_CHECK_INIT(11);
	result_inst_11 = StartScheduleTableRel(sched_rel_1, 3);
	/* obj in 3+3+0= 6(1st) */
	SCHEDULING_CHECK_AND_EQUAL_INT(11,E_OK, result_inst_11);
	
	SCHEDULING_CHECK_INIT(12);
	result_inst_12 = StartScheduleTableRel(sched_rel_2, 3);
	/* obj in 3+3+4=10= 3 */
	SCHEDULING_CHECK_AND_EQUAL_INT(12,E_OK, result_inst_12);
	
	SCHEDULING_CHECK_INIT(13);
	result_inst_13 = StartScheduleTableRel(sched_rel_3, 3);
	/* obj in 3+3+5=11= 4 */
	...
	/*offset = 4 */
	SCHEDULING_CHECK_AND_EQUAL_INT(29,E_OK, result_inst_21);
		
	SCHEDULING_CHECK_INIT(30);
	result_inst_22 = IncrementCounter(Software_Counter);
	/*offset = 5 */
	SCHEDULING_CHECK_AND_EQUAL_INT(31 ,E_OK, result_inst_22);
	
	SCHEDULING_CHECK_INIT(32);
	result_inst_23 = IncrementCounter(Software_Counter);
	/*offset = 6 */
	SCHEDULING_CHECK_AND_EQUAL_INT(33,E_OK, result_inst_23);
	
	SCHEDULING_CHECK_INIT(34);
	result_inst_24 = IncrementCounter(Software_Counter);
	/*offset = 0 */
	SCHEDULING_CHECK_AND_EQUAL_INT(34,E_OK, result_inst_24);
	
	SCHEDULING_CHECK_INIT(35);
	result_inst_25 = IncrementCounter(Software_Counter);
	/*offset = 1 */
	SCHEDULING_CHECK_AND_EQUAL_INT(35,E_OK, result_inst_25);
