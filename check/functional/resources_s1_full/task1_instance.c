...
static void test_t1_instance(void)
{
	...
	SCHEDULING_CHECK_AND_EQUAL_INT(31 , E_OS_NOFUNC, result_inst_15);
	
	SCHEDULING_CHECK_INIT(32);
	result_inst_16 = ReleaseResource(RES_SCHEDULER);
	SCHEDULING_CHECK_AND_EQUAL_INT(32 , E_OS_NOFUNC, result_inst_16);
	
	SCHEDULING_CHECK_INIT(33);
	result_inst_17 = ReleaseResource(INVALID_RESOURCE);
	SCHEDULING_CHECK_AND_EQUAL_INT(33 , E_OS_ID, result_inst_17);
