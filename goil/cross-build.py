...
os.system("cp goil-mac-os-x.zip ~/Dropbox/Public/goil/")
#-----------------------------------------------------------------------------*
...
os.system("cp goil-linux-32.zip ~/Dropbox/Public/goil/")
#-----------------------------------------------------------------------------*
...
os.system("cp goil-linux-64.zip ~/Dropbox/Public/goil/")
#-----------------------------------------------------------------------------*
...
os.system("cp goil-windows.zip ~/Dropbox/Public/goil/")
os.chdir("..")
#-----------------------------------------------------------------------------*
