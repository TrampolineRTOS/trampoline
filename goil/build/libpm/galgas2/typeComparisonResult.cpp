...
//---------------------------------------------------------------------------------------------------------------------*
  ...
  mEnumerationOrder (inEnumerationOrder) {
  }
#endif
...
//---------------------------------------------------------------------------------------------------------------------*
  ...
  typeEnumerationOrder typeEnumerationOrder::down (void) {
    return typeEnumerationOrder (kInternalEnumeration_down) ;
  }
#endif
...
//---------------------------------------------------------------------------------------------------------------------*
  ...
  typeEnumerationOrder typeEnumerationOrder::up (void) {
    return typeEnumerationOrder (kInternalEnumeration_up) ;
  }
#endif
...
//---------------------------------------------------------------------------------------------------------------------*
  ...
  typeEnumerationOrder typeEnumerationOrder::enterOrder (void) {
    return typeEnumerationOrder (kInternalEnumeration_enterOrder) ;
  }
#endif
...
//---------------------------------------------------------------------------------------------------------------------*
  ...
  typeEnumerationOrder typeEnumerationOrder::reverseEnterOrder (void) {
    return typeEnumerationOrder (kInternalEnumeration_reverseEnterOrder) ;
  }
#endif
