...
static void extensionSetter_gtlStruct_performSetter (cPtr_gtlData * inObject,
  ...
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("setDescription").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3424)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      ...
      GALGAS_gtlString var_descriptionToSet_107059 = temp_1 ;
      {
      object->setter_setMeta (callExtensionGetter_lstring ((const cPtr_gtlString *) var_descriptionToSet_107059.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3427)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3427)) ;
      }
  ...
  if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("touch").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3429)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
    ...
    if (kBoolFalse == test_2) {
      ...
      if (kBoolTrue == test_3) {
        test_3 = callExtensionGetter_setterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("struct"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3432)).boolEnum () ;
        if (kBoolTrue == test_3) {
          const GALGAS_gtlStruct temp_4 = object ;
          GALGAS_gtlData var_copy_107357 = temp_4 ;
          callExtensionMethod_callSetter ((const cPtr_gtlSetter *) callExtensionGetter_getSetter ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("struct"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3434)).ptr (), constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 3435)), constinArgument_context, constinArgument_lib, var_copy_107357, constinArgument_arguments, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3434)) ;
          GALGAS_gtlStruct temp_5 ;
          if (var_copy_107357.isValid ()) {
            if (NULL != dynamic_cast <const cPtr_gtlStruct *> (var_copy_107357.ptr ())) {
              temp_5 = (cPtr_gtlStruct *) var_copy_107357.ptr () ;
            }else{
              inCompiler->castError ("gtlStruct", var_copy_107357.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3441)) ;
            }
          }
          object->mProperty_value = temp_5.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 3441)) ;
          object->mProperty_where = var_copy_107357.getter_where (SOURCE_FILE ("gtl_data_types.galgas", 3442)) ;
          object->mProperty_meta = var_copy_107357.getter_meta (SOURCE_FILE ("gtl_data_types.galgas", 3443)) ;
        }
      }
...
static void extensionMethod_gtlStruct_structField (const cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = object->mProperty_value.getter_hasKey (constinArgument_name.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3457)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3457)).boolEnum () ;
    if (kBoolTrue == test_0) {
...
static void extensionSetter_gtlStruct_deleteStructField (cPtr_gtlData * inObject,
  ...
  macroValidSharedObject (object, cPtr_gtlStruct) ;
  {
  GALGAS_gtlData joker_109666 ; // Joker input parameter
  object->mProperty_value.setter_del (constinArgument_name, joker_109666, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3514)) ;
  }
}
//----------------------------------------------------------------------------------------------------------------------
...
static GALGAS_string extensionGetter_gtlList_desc (const cPtr_gtlData * inObject,
  ...
  cEnumerator_list enumerator_110080 (object->mProperty_value, kENUMERATION_UP) ;
  GALGAS_uint index_110068 ((uint32_t) 0) ;
  while (enumerator_110080.hasCurrentObject ()) {
    result_result.plusAssign_operation(GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (32)), constinArgument_tab.add_operation (GALGAS_uint ((uint32_t) 4U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3529))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3529)).add_operation (index_110068.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3530)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3529)).add_operation (GALGAS_string (" :>\n"), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3530)).add_operation (callExtensionGetter_desc ((const cPtr_gtlData *) enumerator_110080.current_value (HERE).ptr (), constinArgument_tab.add_operation (GALGAS_uint ((uint32_t) 8U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3531)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3531)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3530)), inCompiler  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3529)) ;
    enumerator_110080.gotoNextObject () ;
    index_110068.increment_operation (inCompiler  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3528)) ;
  }
...
static GALGAS_gtlData extensionGetter_gtlList_addOp (const cPtr_gtlData * inObject,
  ...
  const cPtr_gtlList * object = (const cPtr_gtlList *) inObject ;
  macroValidSharedObject (object, cPtr_gtlList) ;
  GALGAS_list var_res_111199 = object->mProperty_value ;
  var_res_111199.addAssign_operation (constinArgument_right  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3570)) ;
  result_result = GALGAS_gtlList::constructor_new (object->mProperty_where, function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3571)), var_res_111199  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3571)) ;
//---
  return result_result ;
}
...
static GALGAS_gtlData extensionGetter_gtlList_neqOp (const cPtr_gtlData * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_list var_rValue_112677 = temp_1.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 3620)) ;
      GALGAS_bool var_equal_112721 ;
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        test_2 = GALGAS_bool (kIsNotEqual, object->mProperty_value.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 3622)).objectCompare (var_rValue_112677.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 3622)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          var_equal_112721 = GALGAS_bool (false) ;
        }
      }
      if (kBoolFalse == test_2) {
        var_equal_112721 = GALGAS_bool (true) ;
        cEnumerator_list enumerator_112841 (object->mProperty_value, kENUMERATION_UP) ;
        cEnumerator_list enumerator_112860 (var_rValue_112677, kENUMERATION_UP) ;
        while (enumerator_112841.hasCurrentObject () && enumerator_112860.hasCurrentObject ()) {
          var_equal_112721 = var_equal_112721.operator_and (callExtensionGetter_bool ((const cPtr_gtlData *) callExtensionGetter_eqOp ((const cPtr_gtlData *) enumerator_112841.current_value (HERE).ptr (), enumerator_112860.current_value (HERE), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3627)).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3627)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3627)) ;
          enumerator_112841.gotoNextObject () ;
          enumerator_112860.gotoNextObject () ;
        }
      }
      result_result = GALGAS_gtlBool::constructor_new (object->mProperty_where, function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3630)), var_equal_112721.operator_not (SOURCE_FILE ("gtl_data_types.galgas", 3630))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3630)) ;
    }
  }
  if (kBoolFalse == test_0) {
...
static GALGAS_gtlData extensionGetter_gtlList_eqOp (const cPtr_gtlData * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_list var_rValue_113174 = temp_1.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 3638)) ;
      GALGAS_bool var_equal_113218 ;
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        test_2 = GALGAS_bool (kIsNotEqual, object->mProperty_value.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 3640)).objectCompare (var_rValue_113174.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 3640)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          var_equal_113218 = GALGAS_bool (false) ;
        }
      }
      if (kBoolFalse == test_2) {
        var_equal_113218 = GALGAS_bool (true) ;
        cEnumerator_list enumerator_113338 (object->mProperty_value, kENUMERATION_UP) ;
        cEnumerator_list enumerator_113357 (var_rValue_113174, kENUMERATION_UP) ;
        while (enumerator_113338.hasCurrentObject () && enumerator_113357.hasCurrentObject ()) {
          var_equal_113218 = var_equal_113218.operator_and (callExtensionGetter_bool ((const cPtr_gtlData *) callExtensionGetter_eqOp ((const cPtr_gtlData *) enumerator_113338.current_value (HERE).ptr (), enumerator_113357.current_value (HERE), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3645)).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3645)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3645)) ;
          enumerator_113338.gotoNextObject () ;
          enumerator_113357.gotoNextObject () ;
        }
      }
      result_result = GALGAS_gtlBool::constructor_new (object->mProperty_where, function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3648)), var_equal_113218  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3648)) ;
    }
  }
  if (kBoolFalse == test_0) {
    TC_Array <C_FixItDescription> fixItArray3 ;
...
static GALGAS_gtlData extensionGetter_gtlList_performGetter (const cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("length").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3690)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
  ...
  if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (kIsEqual, GALGAS_string ("first").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3697)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        {
    ...
    if (kBoolFalse == test_1) {
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("last").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3700)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          {
      ...
      if (kBoolFalse == test_2) {
        enumGalgasBool test_3 = kBoolTrue ;
        if (kBoolTrue == test_3) {
          test_3 = GALGAS_bool (kIsEqual, GALGAS_string ("elementAtIndex").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3703)))).boolEnum () ;
          if (kBoolTrue == test_3) {
            {
            ...
            GALGAS_uint var_index_115366 = callExtensionGetter_int ((const cPtr_gtlData *) constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3705)).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3705)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3705)) ;
            enumGalgasBool test_4 = kBoolTrue ;
            if (kBoolTrue == test_4) {
              test_4 = GALGAS_bool (kIsStrictInf, var_index_115366.objectCompare (object->mProperty_value.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 3706)))).boolEnum () ;
              if (kBoolTrue == test_4) {
                result_result = object->mProperty_value.getter_valueAtIndex (var_index_115366, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3707)) ;
              }
            }
        ...
        if (kBoolFalse == test_3) {
          ...
          if (kBoolTrue == test_6) {
            test_6 = GALGAS_bool (kIsEqual, GALGAS_string ("subListTo").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3711)))).boolEnum () ;
            if (kBoolTrue == test_6) {
              {
              ...
              GALGAS_uint var_index_115678 = callExtensionGetter_int ((const cPtr_gtlData *) constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3713)).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3713)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3713)) ;
              enumGalgasBool test_7 = kBoolTrue ;
              if (kBoolTrue == test_7) {
                test_7 = GALGAS_bool (kIsStrictInf, var_index_115678.objectCompare (object->mProperty_value.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 3714)))).boolEnum () ;
                if (kBoolTrue == test_7) {
                  result_result = GALGAS_gtlList::constructor_new (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 3716)), function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3717)), object->mProperty_value.getter_subListToIndex (var_index_115678, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3718))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3715)) ;
                }
              }
          ...
          if (kBoolFalse == test_6) {
            ...
            if (kBoolTrue == test_9) {
              test_9 = GALGAS_bool (kIsEqual, GALGAS_string ("subListFrom").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3723)))).boolEnum () ;
              if (kBoolTrue == test_9) {
                {
                ...
                GALGAS_uint var_index_116032 = callExtensionGetter_int ((const cPtr_gtlData *) constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3725)).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3725)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3725)) ;
                enumGalgasBool test_10 = kBoolTrue ;
                if (kBoolTrue == test_10) {
                  test_10 = GALGAS_bool (kIsStrictInf, var_index_116032.objectCompare (object->mProperty_value.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 3726)))).boolEnum () ;
                  if (kBoolTrue == test_10) {
                    result_result = GALGAS_gtlList::constructor_new (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 3728)), function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3729)), object->mProperty_value.getter_subListFromIndex (var_index_116032, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3730))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3727)) ;
                  }
                }
            ...
            if (kBoolFalse == test_9) {
              ...
              if (kBoolTrue == test_11) {
                test_11 = GALGAS_bool (kIsEqual, GALGAS_string ("subList").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3739)))).boolEnum () ;
                if (kBoolTrue == test_11) {
                  {
                  ...
                  GALGAS_uint var_start_116474 = callExtensionGetter_int ((const cPtr_gtlData *) constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3741)).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3741)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3741)) ;
                  GALGAS_uint var_length_116527 = callExtensionGetter_int ((const cPtr_gtlData *) constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3742)).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3742)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3742)) ;
                  enumGalgasBool test_12 = kBoolTrue ;
                  if (kBoolTrue == test_12) {
                    test_12 = GALGAS_bool (kIsStrictInf, var_start_116474.objectCompare (object->mProperty_value.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 3743)))).boolEnum () ;
                    if (kBoolTrue == test_12) {
                      enumGalgasBool test_13 = kBoolTrue ;
                      if (kBoolTrue == test_13) {
                        test_13 = GALGAS_bool (kIsStrictSup, var_start_116474.add_operation (var_length_116527, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3744)).objectCompare (object->mProperty_value.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 3744)))).boolEnum () ;
                        if (kBoolTrue == test_13) {
                          var_length_116527 = object->mProperty_value.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 3745)).substract_operation (var_start_116474, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3745)) ;
                        }
                      }
                      result_result = GALGAS_gtlList::constructor_new (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 3748)), function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3749)), object->mProperty_value.getter_subListWithRange (GALGAS_range::constructor_new (var_start_116474, var_length_116527  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3750)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3750))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3747)) ;
                    }
                  }
              ...
              if (kBoolFalse == test_11) {
                ...
                if (kBoolTrue == test_14) {
                  test_14 = GALGAS_bool (kIsEqual, GALGAS_string ("mapBy").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3759)))).boolEnum () ;
                  if (kBoolTrue == test_14) {
                    {
                    ...
                    GALGAS_lstring var_key_117086 = callExtensionGetter_lstring ((const cPtr_gtlData *) constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3761)).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3761)) ;
                    GALGAS_gtlVarMap var_resultMap_117150 = GALGAS_gtlVarMap::constructor_emptyMap (SOURCE_FILE ("gtl_data_types.galgas", 3762)) ;
                    const GALGAS_gtlList temp_15 = object ;
                    cEnumerator_list enumerator_117193 (temp_15.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 3763)), kENUMERATION_UP) ;
                    GALGAS_uint index_117170 ((uint32_t) 0) ;
                    while (enumerator_117193.hasCurrentObject ()) {
                      if (enumerator_117193.current_value (HERE).isValid ()) {
                        if (enumerator_117193.current_value (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_gtlStruct) {
                          GALGAS_gtlStruct cast_117256_itemStruct ((cPtr_gtlStruct *) enumerator_117193.current_value (HERE).ptr ()) ;
                          enumGalgasBool test_16 = kBoolTrue ;
                          if (kBoolTrue == test_16) {
                            test_16 = cast_117256_itemStruct.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 3766)).getter_hasKey (var_key_117086.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3766)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3766)).boolEnum () ;
                            if (kBoolTrue == test_16) {
                              GALGAS_gtlData var_keyValue_117373 ;
                              cast_117256_itemStruct.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 3767)).method_get (var_key_117086, var_keyValue_117373, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3767)) ;
                              {
                              var_resultMap_117150.setter_put (callExtensionGetter_lstring ((const cPtr_gtlData *) var_keyValue_117373.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3769)), enumerator_117193.current_value (HERE), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3768)) ;
                              }
                            }
                          }
                          if (kBoolFalse == test_16) {
                            TC_Array <C_FixItDescription> fixItArray17 ;
                            inCompiler->emitSemanticError (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 3773)), GALGAS_string ("item at index ").add_operation (index_117170.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3773)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3773)).add_operation (GALGAS_string (" does not have field named "), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3773)).add_operation (var_key_117086.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3774)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3774)), fixItArray17  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3773)) ;
                          }
                        }else if (enumerator_117193.current_value (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_gtlMap) {
                          GALGAS_gtlMap cast_117622_itemMap ((cPtr_gtlMap *) enumerator_117193.current_value (HERE).ptr ()) ;
                          enumGalgasBool test_18 = kBoolTrue ;
                          if (kBoolTrue == test_18) {
                            test_18 = cast_117622_itemMap.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 3777)).getter_hasKey (var_key_117086.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3777)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3777)).boolEnum () ;
                            if (kBoolTrue == test_18) {
                              GALGAS_gtlData var_keyValue_117733 ;
                              cast_117622_itemMap.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 3778)).method_get (var_key_117086, var_keyValue_117733, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3778)) ;
                              {
                              var_resultMap_117150.setter_put (callExtensionGetter_lstring ((const cPtr_gtlData *) var_keyValue_117733.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3780)), enumerator_117193.current_value (HERE), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3779)) ;
                              }
                            }
                          }
                          if (kBoolFalse == test_18) {
                            TC_Array <C_FixItDescription> fixItArray19 ;
                            inCompiler->emitSemanticError (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 3784)), GALGAS_string ("item at index ").add_operation (index_117170.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3784)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3784)).add_operation (GALGAS_string (" does not have field named "), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3784)).add_operation (var_key_117086.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3785)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3785)), fixItArray19  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3784)) ;
                          }
                        }else{
                      ...
                      enumerator_117193.gotoNextObject () ;
                      index_117170.increment_operation (inCompiler  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3763)) ;
                    }
                    result_result = GALGAS_gtlMap::constructor_new (object->mProperty_where, function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3791)), var_resultMap_117150  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3791)) ;
                  }
                }
                if (kBoolFalse == test_14) {
                  enumGalgasBool test_21 = kBoolTrue ;
                  if (kBoolTrue == test_21) {
                    test_21 = GALGAS_bool (kIsEqual, GALGAS_string ("set").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3792)))).boolEnum () ;
                    if (kBoolTrue == test_21) {
                      {
                      ...
                      GALGAS_lstringset var_resultSet_118232 = GALGAS_lstringset::constructor_emptyMap (SOURCE_FILE ("gtl_data_types.galgas", 3794)) ;
                      cEnumerator_list enumerator_118268 (object->mProperty_value, kENUMERATION_UP) ;
                      while (enumerator_118268.hasCurrentObject ()) {
                        GALGAS_lstring var_itemKey_118294 = callExtensionGetter_lstring ((const cPtr_gtlData *) enumerator_118268.current_value (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3796)) ;
                        enumGalgasBool test_22 = kBoolTrue ;
                        if (kBoolTrue == test_22) {
                          test_22 = var_resultSet_118232.getter_hasKey (var_itemKey_118294.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3797)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3797)).boolEnum () ;
                          if (kBoolTrue == test_22) {
                            {
                            var_resultSet_118232.setter_del (var_itemKey_118294, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3798)) ;
                            }
                          }
                        }
                        {
                        var_resultSet_118232.setter_put (var_itemKey_118294, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3800)) ;
                        }
                        enumerator_118268.gotoNextObject () ;
                      }
                      result_result = GALGAS_gtlSet::constructor_new (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 3803)), function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3803)), var_resultSet_118232  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3802)) ;
                    }
                  }
                  if (kBoolFalse == test_21) {
                    enumGalgasBool test_23 = kBoolTrue ;
                    if (kBoolTrue == test_23) {
                      test_23 = GALGAS_bool (kIsEqual, GALGAS_string ("setBy").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3805)))).boolEnum () ;
                      if (kBoolTrue == test_23) {
                        {
                        ...
                        GALGAS_lstring var_key_118649 = callExtensionGetter_lstring ((const cPtr_gtlData *) constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3807)).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3807)) ;
                        GALGAS_lstringset var_resultSet_118714 = GALGAS_lstringset::constructor_emptyMap (SOURCE_FILE ("gtl_data_types.galgas", 3808)) ;
                        cEnumerator_list enumerator_118750 (object->mProperty_value, kENUMERATION_UP) ;
                        while (enumerator_118750.hasCurrentObject ()) {
                          GALGAS_gtlData var_field_118798 ;
                          GALGAS_bool joker_118800 ; // Joker input parameter
                          callExtensionMethod_structField ((const cPtr_gtlData *) enumerator_118750.current_value (HERE).ptr (), var_key_118649, var_field_118798, joker_118800, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3810)) ;
                          GALGAS_lstring var_resKey_118824 = callExtensionGetter_lstring ((const cPtr_gtlData *) var_field_118798.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3811)) ;
                          enumGalgasBool test_24 = kBoolTrue ;
                          if (kBoolTrue == test_24) {
                            test_24 = var_resultSet_118714.getter_hasKey (var_resKey_118824.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3812)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3812)).boolEnum () ;
                            if (kBoolTrue == test_24) {
                              {
                              var_resultSet_118714.setter_del (var_resKey_118824, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3813)) ;
                              }
                            }
                          }
                          {
                          var_resultSet_118714.setter_put (var_resKey_118824, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3815)) ;
                          }
                          enumerator_118750.gotoNextObject () ;
                        }
                        result_result = GALGAS_gtlSet::constructor_new (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 3818)), function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3818)), var_resultSet_118714  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3817)) ;
                      }
                    }
                    if (kBoolFalse == test_23) {
                      enumGalgasBool test_25 = kBoolTrue ;
                      if (kBoolTrue == test_25) {
                        test_25 = GALGAS_bool (kIsEqual, GALGAS_string ("componentsJoinedByString").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3820)))).boolEnum () ;
                        if (kBoolTrue == test_25) {
                          {
                          ...
                          GALGAS_string var_joiner_119179 = callExtensionGetter_string ((const cPtr_gtlData *) constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3822)).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3822)) ;
                          GALGAS_string var_stringResult_119242 = GALGAS_string::makeEmptyString () ;
                          cEnumerator_list enumerator_119271 (object->mProperty_value, kENUMERATION_UP) ;
                          while (enumerator_119271.hasCurrentObject ()) {
                            var_stringResult_119242 = var_stringResult_119242.add_operation (callExtensionGetter_string ((const cPtr_gtlData *) enumerator_119271.current_value (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3826)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3826)) ;
                            if (enumerator_119271.hasNextObject ()) {
                              var_stringResult_119242 = var_stringResult_119242.add_operation (var_joiner_119179, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3828)) ;
                            }
                            enumerator_119271.gotoNextObject () ;
                          }
                          result_result = GALGAS_gtlString::constructor_new (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 3831)), function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3831)), var_stringResult_119242  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3830)) ;
                        }
                      }
                      if (kBoolFalse == test_25) {
                        enumGalgasBool test_26 = kBoolTrue ;
                        if (kBoolTrue == test_26) {
                          test_26 = GALGAS_bool (kIsEqual, GALGAS_string ("type").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3833)))).boolEnum () ;
                          if (kBoolTrue == test_26) {
                            {
                        ...
                        if (kBoolFalse == test_26) {
                          ...
                          if (kBoolTrue == test_28) {
                            test_28 = GALGAS_bool (kIsEqual, GALGAS_string ("isANumber").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3838)))).boolEnum () ;
                            if (kBoolTrue == test_28) {
                              {
                          ...
                          if (kBoolFalse == test_28) {
                            ...
                            if (kBoolTrue == test_29) {
                              test_29 = GALGAS_bool (kIsEqual, GALGAS_string ("description").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3843)))).boolEnum () ;
                              if (kBoolTrue == test_29) {
                                {
                            ...
                            if (kBoolFalse == test_29) {
                              ...
                              if (kBoolTrue == test_30) {
                                test_30 = GALGAS_bool (kIsEqual, GALGAS_string ("where").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3848)))).boolEnum () ;
                                if (kBoolTrue == test_30) {
                                  ...
                                  if (kBoolFalse == test_31) {
                                    ...
                                    if (kBoolTrue == test_33) {
                                      test_33 = GALGAS_bool (kIsNotEqual, constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3853)).getter_dynamicType (SOURCE_FILE ("gtl_data_types.galgas", 3853)).objectCompare (GALGAS_type (& kTypeDescriptor_GALGAS_gtlExpr))).boolEnum () ;
                                      if (kBoolTrue == test_33) {
                                    ...
                                    if (kBoolFalse == test_33) {
                                      GALGAS_gtlStruct var_vars_120464 ;
                                      enumGalgasBool test_35 = kBoolTrue ;
                                      if (kBoolTrue == test_35) {
                                        test_35 = GALGAS_bool (kIsEqual, constinArgument_arguments.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 3857)).objectCompare (GALGAS_uint ((uint32_t) 2U))).boolEnum () ;
                                        if (kBoolTrue == test_35) {
                                          enumGalgasBool test_36 = kBoolTrue ;
                                          if (kBoolTrue == test_36) {
                                            test_36 = GALGAS_bool (kIsNotEqual, constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3858)).getter_dynamicType (SOURCE_FILE ("gtl_data_types.galgas", 3858)).objectCompare (GALGAS_type (& kTypeDescriptor_GALGAS_gtlStruct))).boolEnum () ;
                                            if (kBoolTrue == test_36) {
                                              ...
                                              var_vars_120464.drop () ; // Release error dropped variable
                                            }
                                          }
                                          if (kBoolFalse == test_36) {
                                            ...
                                            var_vars_120464 = temp_38 ;
                                          }
                                        }
                                      }
                                      if (kBoolFalse == test_35) {
                                        var_vars_120464 = GALGAS_gtlStruct::constructor_new (object->mProperty_where, function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3864)), GALGAS_gtlVarMap::constructor_emptyMap (SOURCE_FILE ("gtl_data_types.galgas", 3864))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3864)) ;
                                      }
                                      ...
                                      GALGAS_gtlExpression var_expr_120851 = temp_39.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 3866)) ;
                                      GALGAS_list var_resultList_120925 = GALGAS_list::constructor_emptyList (SOURCE_FILE ("gtl_data_types.galgas", 3867)) ;
                                      cEnumerator_list enumerator_120966 (object->mProperty_value, kENUMERATION_UP) ;
                                      while (enumerator_120966.hasCurrentObject ()) {
                                        {
                                        var_vars_120464.insulate (HERE) ;
                                        cPtr_gtlStruct * ptr_120995 = (cPtr_gtlStruct *) var_vars_120464.ptr () ;
                                        callExtensionSetter_setStructField ((cPtr_gtlStruct *) ptr_120995, GALGAS_lstring::constructor_new (GALGAS_string ("__item__"), enumerator_120966.current_value (HERE).getter_where (SOURCE_FILE ("gtl_data_types.galgas", 3870))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3870)), enumerator_120966.current_value (HERE), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3870)) ;
                                        }
                                        GALGAS_gtlData var_evalResult_121089 = callExtensionGetter_eval ((const cPtr_gtlExpression *) var_expr_120851.ptr (), constinArgument_context, var_vars_120464, constinArgument_lib, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3871)) ;
                                        enumGalgasBool test_40 = kBoolTrue ;
                                        if (kBoolTrue == test_40) {
                                          test_40 = callExtensionGetter_bool ((const cPtr_gtlData *) var_evalResult_121089.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3872)).boolEnum () ;
                                          if (kBoolTrue == test_40) {
                                            var_resultList_120925.addAssign_operation (enumerator_120966.current_value (HERE)  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3873)) ;
                                          }
                                        }
                                        enumerator_120966.gotoNextObject () ;
                                      }
                                      result_result = GALGAS_gtlList::constructor_new (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 3877)), function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3878)), var_resultList_120925  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3876)) ;
                                    }
                                  }
                                }
                              }
                              if (kBoolFalse == test_30) {
                                ...
                                if (kBoolTrue == test_41) {
                                  test_41 = callExtensionGetter_getterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("list"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3883)).boolEnum () ;
                                  if (kBoolTrue == test_41) {
                                ...
                                if (kBoolFalse == test_41) {
                                  ...
                                  if (kBoolTrue == test_43) {
                                    test_43 = GALGAS_bool (kIsEqual, GALGAS_string ("location").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3891)))).boolEnum () ;
                                    if (kBoolTrue == test_43) {
                                      {
...
static void extensionSetter_gtlList_performSetter (cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("setDescription").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3911)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      ...
      GALGAS_gtlString var_descriptionToSet_122339 = temp_1 ;
      {
      object->setter_setMeta (callExtensionGetter_lstring ((const cPtr_gtlString *) var_descriptionToSet_122339.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3914)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3914)) ;
      }
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("touch").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3916)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
    ...
    if (kBoolFalse == test_2) {
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = GALGAS_bool (kIsEqual, GALGAS_string ("insert").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 3919)))).boolEnum () ;
        if (kBoolTrue == test_3) {
          {
          ...
          GALGAS_uint var_insertIndex_122690 = callExtensionGetter_int ((const cPtr_gtlData *) constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3921)).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3921)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3921)) ;
          GALGAS_gtlData var_node_122743 = constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3922)) ;
          enumGalgasBool test_4 = kBoolTrue ;
          if (kBoolTrue == test_4) {
            test_4 = GALGAS_bool (kIsStrictInf, var_insertIndex_122690.objectCompare (object->mProperty_value.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 3923)))).boolEnum () ;
            if (kBoolTrue == test_4) {
              {
              object->mProperty_value.setter_insertAtIndex (var_node_122743, var_insertIndex_122690, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3924)) ;
              }
            }
          }
          if (kBoolFalse == test_4) {
            object->mProperty_value.addAssign_operation (var_node_122743  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3926)) ;
          }
      ...
      if (kBoolFalse == test_3) {
        ...
        if (kBoolTrue == test_5) {
          test_5 = callExtensionGetter_setterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("list"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3929)).boolEnum () ;
          if (kBoolTrue == test_5) {
            const GALGAS_gtlList temp_6 = object ;
            GALGAS_gtlData var_copy_122993 = temp_6 ;
            callExtensionMethod_callSetter ((const cPtr_gtlSetter *) callExtensionGetter_getSetter ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("list"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3931)).ptr (), constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 3932)), constinArgument_context, constinArgument_lib, var_copy_122993, constinArgument_arguments, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3931)) ;
            GALGAS_gtlList temp_7 ;
            if (var_copy_122993.isValid ()) {
              if (NULL != dynamic_cast <const cPtr_gtlList *> (var_copy_122993.ptr ())) {
                temp_7 = (cPtr_gtlList *) var_copy_122993.ptr () ;
              }else{
                inCompiler->castError ("gtlList", var_copy_122993.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3938)) ;
              }
            }
            object->mProperty_value = temp_7.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 3938)) ;
            object->mProperty_where = var_copy_122993.getter_where (SOURCE_FILE ("gtl_data_types.galgas", 3939)) ;
            object->mProperty_meta = var_copy_122993.getter_meta (SOURCE_FILE ("gtl_data_types.galgas", 3940)) ;
          }
        }
...
static void extensionSetter_gtlList_deleteItemAtIndex (cPtr_gtlData * inObject,
  ...
  cPtr_gtlList * object = (cPtr_gtlList *) inObject ;
  macroValidSharedObject (object, cPtr_gtlList) ;
  GALGAS_uint var_indexUint_123550 = constinArgument_index.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 3956)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3956)) ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsStrictInf, var_indexUint_123550.objectCompare (object->mProperty_value.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 3957)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = GALGAS_bool (kIsEqual, var_indexUint_123550.objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_1) {
      ...
      if (kBoolFalse == test_1) {
        enumGalgasBool test_2 = kBoolTrue ;
        if (kBoolTrue == test_2) {
          test_2 = GALGAS_bool (kIsEqual, var_indexUint_123550.objectCompare (object->mProperty_value.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 3960)).substract_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3960)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            object->mProperty_value = object->mProperty_value.getter_subListToIndex (var_indexUint_123550.substract_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3961)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3961)) ;
          }
        }
        if (kBoolFalse == test_2) {
          object->mProperty_value = object->mProperty_value.getter_subListToIndex (var_indexUint_123550.substract_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3963)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3963)).add_operation (object->mProperty_value.getter_subListFromIndex (var_indexUint_123550.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3964)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3964)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 3963)) ;
        }
      }
    }
  }
...
static GALGAS_string extensionGetter_gtlMap_desc (const cPtr_gtlData * inObject,
  ...
  cEnumerator_gtlVarMap enumerator_124668 (object->mProperty_value, kENUMERATION_UP) ;
  while (enumerator_124668.hasCurrentObject ()) {
    result_result.plusAssign_operation(GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (32)), constinArgument_tab.add_operation (GALGAS_uint ((uint32_t) 4U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4001))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4001)).add_operation (GALGAS_string ("\""), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4001)).add_operation (enumerator_124668.current_lkey (HERE).getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4002)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4002)).add_operation (GALGAS_string ("\" :>\n"), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4002)).add_operation (callExtensionGetter_desc ((const cPtr_gtlData *) enumerator_124668.current_value (HERE).ptr (), constinArgument_tab.add_operation (GALGAS_uint ((uint32_t) 8U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4003)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4003)), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4002)), inCompiler  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4001)) ;
    enumerator_124668.gotoNextObject () ;
  }
...
static GALGAS_gtlData extensionGetter_gtlMap_neqOp (const cPtr_gtlData * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_gtlVarMap var_rValue_127037 = temp_1.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 4082)) ;
      GALGAS_bool var_equal_127080 ;
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        test_2 = GALGAS_bool (kIsNotEqual, object->mProperty_value.getter_count (SOURCE_FILE ("gtl_data_types.galgas", 4084)).objectCompare (var_rValue_127037.getter_count (SOURCE_FILE ("gtl_data_types.galgas", 4084)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          var_equal_127080 = GALGAS_bool (false) ;
        }
      }
      if (kBoolFalse == test_2) {
        var_equal_127080 = GALGAS_bool (true) ;
        cEnumerator_gtlVarMap enumerator_127205 (object->mProperty_value, kENUMERATION_UP) ;
        while (enumerator_127205.hasCurrentObject ()) {
          enumGalgasBool test_3 = kBoolTrue ;
          if (kBoolTrue == test_3) {
            test_3 = var_rValue_127037.getter_hasKey (enumerator_127205.current_lkey (HERE).getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4089)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4089)).boolEnum () ;
            if (kBoolTrue == test_3) {
              GALGAS_gtlData var_rData_127290 ;
              var_rValue_127037.method_get (enumerator_127205.current_lkey (HERE), var_rData_127290, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4090)) ;
              var_equal_127080 = var_equal_127080.operator_and (callExtensionGetter_bool ((const cPtr_gtlData *) callExtensionGetter_eqOp ((const cPtr_gtlData *) enumerator_127205.current_value (HERE).ptr (), var_rData_127290, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4091)).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4091)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4091)) ;
            }
          }
          if (kBoolFalse == test_3) {
            var_equal_127080 = GALGAS_bool (false) ;
          }
          enumerator_127205.gotoNextObject () ;
        }
      }
      result_result = GALGAS_gtlBool::constructor_new (object->mProperty_where, function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4097)), var_equal_127080.operator_not (SOURCE_FILE ("gtl_data_types.galgas", 4097))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4097)) ;
    }
  }
  if (kBoolFalse == test_0) {
...
static GALGAS_gtlData extensionGetter_gtlMap_eqOp (const cPtr_gtlData * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_gtlVarMap var_rValue_127660 = temp_1.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 4105)) ;
      GALGAS_bool var_equal_127703 ;
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        test_2 = GALGAS_bool (kIsNotEqual, object->mProperty_value.getter_count (SOURCE_FILE ("gtl_data_types.galgas", 4107)).objectCompare (var_rValue_127660.getter_count (SOURCE_FILE ("gtl_data_types.galgas", 4107)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          var_equal_127703 = GALGAS_bool (false) ;
        }
      }
      if (kBoolFalse == test_2) {
        var_equal_127703 = GALGAS_bool (true) ;
        cEnumerator_gtlVarMap enumerator_127828 (object->mProperty_value, kENUMERATION_UP) ;
        while (enumerator_127828.hasCurrentObject ()) {
          enumGalgasBool test_3 = kBoolTrue ;
          if (kBoolTrue == test_3) {
            test_3 = var_rValue_127660.getter_hasKey (enumerator_127828.current_lkey (HERE).getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4112)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4112)).boolEnum () ;
            if (kBoolTrue == test_3) {
              GALGAS_gtlData var_rData_127913 ;
              var_rValue_127660.method_get (enumerator_127828.current_lkey (HERE), var_rData_127913, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4113)) ;
              var_equal_127703 = var_equal_127703.operator_and (callExtensionGetter_bool ((const cPtr_gtlData *) callExtensionGetter_eqOp ((const cPtr_gtlData *) enumerator_127828.current_value (HERE).ptr (), var_rData_127913, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4114)).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4114)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4114)) ;
            }
          }
          if (kBoolFalse == test_3) {
            var_equal_127703 = GALGAS_bool (false) ;
          }
          enumerator_127828.gotoNextObject () ;
        }
      }
      result_result = GALGAS_gtlBool::constructor_new (object->mProperty_where, function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4120)), var_equal_127703  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4120)) ;
    }
  }
  if (kBoolFalse == test_0) {
    TC_Array <C_FixItDescription> fixItArray4 ;
...
static GALGAS_gtlData extensionGetter_gtlMap_performGetter (const cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("length").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4162)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (kIsEqual, GALGAS_string ("type").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4169)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        {
    ...
    if (kBoolFalse == test_1) {
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = GALGAS_bool (kIsEqual, GALGAS_string ("isANumber").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4174)))).boolEnum () ;
        if (kBoolTrue == test_3) {
          {
      ...
      if (kBoolFalse == test_3) {
        enumGalgasBool test_4 = kBoolTrue ;
        if (kBoolTrue == test_4) {
          test_4 = GALGAS_bool (kIsEqual, GALGAS_string ("list").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4179)))).boolEnum () ;
          if (kBoolTrue == test_4) {
            {
            ...
            GALGAS_list var_resultList_130082 = GALGAS_list::constructor_emptyList (SOURCE_FILE ("gtl_data_types.galgas", 4181)) ;
            const GALGAS_gtlMap temp_5 = object ;
            cEnumerator_gtlVarMap enumerator_130130 (temp_5.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 4182)), kENUMERATION_UP) ;
            while (enumerator_130130.hasCurrentObject ()) {
              var_resultList_130082.addAssign_operation (enumerator_130130.current_value (HERE)  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4183)) ;
              enumerator_130130.gotoNextObject () ;
            }
            result_result = GALGAS_gtlList::constructor_new (object->mProperty_where, function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4185)), var_resultList_130082  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4185)) ;
          }
        }
        if (kBoolFalse == test_4) {
          enumGalgasBool test_6 = kBoolTrue ;
          if (kBoolTrue == test_6) {
            test_6 = GALGAS_bool (kIsEqual, GALGAS_string ("where").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4186)))).boolEnum () ;
            if (kBoolTrue == test_6) {
              enumGalgasBool test_7 = kBoolTrue ;
              if (kBoolTrue == test_7) {
              ...
              if (kBoolFalse == test_7) {
                enumGalgasBool test_9 = kBoolTrue ;
                if (kBoolTrue == test_9) {
                  test_9 = GALGAS_bool (kIsNotEqual, constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4191)).getter_dynamicType (SOURCE_FILE ("gtl_data_types.galgas", 4191)).objectCompare (GALGAS_type (& kTypeDescriptor_GALGAS_gtlExpr))).boolEnum () ;
                  if (kBoolTrue == test_9) {
                ...
                if (kBoolFalse == test_9) {
                  GALGAS_gtlStruct var_vars_130652 ;
                  enumGalgasBool test_11 = kBoolTrue ;
                  if (kBoolTrue == test_11) {
                    test_11 = GALGAS_bool (kIsEqual, constinArgument_arguments.getter_length (SOURCE_FILE ("gtl_data_types.galgas", 4195)).objectCompare (GALGAS_uint ((uint32_t) 2U))).boolEnum () ;
                    if (kBoolTrue == test_11) {
                      enumGalgasBool test_12 = kBoolTrue ;
                      if (kBoolTrue == test_12) {
                        test_12 = GALGAS_bool (kIsNotEqual, constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4196)).getter_dynamicType (SOURCE_FILE ("gtl_data_types.galgas", 4196)).objectCompare (GALGAS_type (& kTypeDescriptor_GALGAS_gtlStruct))).boolEnum () ;
                        if (kBoolTrue == test_12) {
                          ...
                          var_vars_130652.drop () ; // Release error dropped variable
                        }
                      }
                      if (kBoolFalse == test_12) {
                        ...
                        var_vars_130652 = temp_14 ;
                      }
                    }
                  }
                  if (kBoolFalse == test_11) {
                    var_vars_130652 = GALGAS_gtlStruct::constructor_new (object->mProperty_where, function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4202)), GALGAS_gtlVarMap::constructor_emptyMap (SOURCE_FILE ("gtl_data_types.galgas", 4202))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4202)) ;
                  }
                  ...
                  GALGAS_gtlExpression var_expr_131039 = temp_15.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 4204)) ;
                  GALGAS_gtlVarMap var_resultMap_131117 = GALGAS_gtlVarMap::constructor_emptyMap (SOURCE_FILE ("gtl_data_types.galgas", 4205)) ;
                  cEnumerator_gtlVarMap enumerator_131161 (object->mProperty_value, kENUMERATION_UP) ;
                  while (enumerator_131161.hasCurrentObject ()) {
                    {
                    var_vars_130652.insulate (HERE) ;
                    cPtr_gtlStruct * ptr_131190 = (cPtr_gtlStruct *) var_vars_130652.ptr () ;
                    callExtensionSetter_setStructField ((cPtr_gtlStruct *) ptr_131190, GALGAS_lstring::constructor_new (GALGAS_string ("__item__"), enumerator_131161.current_value (HERE).getter_where (SOURCE_FILE ("gtl_data_types.galgas", 4208))  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4208)), enumerator_131161.current_value (HERE), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4208)) ;
                    }
                    GALGAS_gtlData var_evalResult_131284 = callExtensionGetter_eval ((const cPtr_gtlExpression *) var_expr_131039.ptr (), constinArgument_context, var_vars_130652, constinArgument_lib, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4209)) ;
                    enumGalgasBool test_16 = kBoolTrue ;
                    if (kBoolTrue == test_16) {
                      test_16 = callExtensionGetter_bool ((const cPtr_gtlData *) var_evalResult_131284.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4210)).boolEnum () ;
                      if (kBoolTrue == test_16) {
                        {
                        var_resultMap_131117.setter_put (enumerator_131161.current_lkey (HERE), enumerator_131161.current_value (HERE), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4211)) ;
                        }
                      }
                    }
                    enumerator_131161.gotoNextObject () ;
                  }
                  result_result = GALGAS_gtlMap::constructor_new (constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 4215)), function_emptylstring (inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4216)), var_resultMap_131117  COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4214)) ;
                }
              }
            }
          }
          if (kBoolFalse == test_6) {
            ...
            if (kBoolTrue == test_17) {
              test_17 = GALGAS_bool (kIsEqual, GALGAS_string ("description").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4221)))).boolEnum () ;
              if (kBoolTrue == test_17) {
                {
            ...
            if (kBoolFalse == test_17) {
              enumGalgasBool test_18 = kBoolTrue ;
              if (kBoolTrue == test_18) {
                test_18 = callExtensionGetter_getterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("map"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4226)).boolEnum () ;
                if (kBoolTrue == test_18) {
              ...
              if (kBoolFalse == test_18) {
                ...
                if (kBoolTrue == test_20) {
                  test_20 = GALGAS_bool (kIsEqual, GALGAS_string ("location").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4234)))).boolEnum () ;
                  if (kBoolTrue == test_20) {
                    {
...
static void extensionSetter_gtlMap_performSetter (cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("setDescription").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4254)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      ...
      GALGAS_gtlString var_descriptionToSet_132704 = temp_1 ;
      {
      object->setter_setMeta (callExtensionGetter_lstring ((const cPtr_gtlString *) var_descriptionToSet_132704.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4257)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4257)) ;
      }
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("touch").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4259)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
    ...
    if (kBoolFalse == test_2) {
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = callExtensionGetter_setterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("map"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4262)).boolEnum () ;
        if (kBoolTrue == test_3) {
          const GALGAS_gtlMap temp_4 = object ;
          GALGAS_gtlData var_copy_132999 = temp_4 ;
          callExtensionMethod_callSetter ((const cPtr_gtlSetter *) callExtensionGetter_getSetter ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("map"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4264)).ptr (), constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 4265)), constinArgument_context, constinArgument_lib, var_copy_132999, constinArgument_arguments, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4264)) ;
          GALGAS_gtlMap temp_5 ;
          if (var_copy_132999.isValid ()) {
            if (NULL != dynamic_cast <const cPtr_gtlMap *> (var_copy_132999.ptr ())) {
              temp_5 = (cPtr_gtlMap *) var_copy_132999.ptr () ;
            }else{
              inCompiler->castError ("gtlMap", var_copy_132999.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4271)) ;
            }
          }
          object->mProperty_value = temp_5.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 4271)) ;
          object->mProperty_where = var_copy_132999.getter_where (SOURCE_FILE ("gtl_data_types.galgas", 4272)) ;
          object->mProperty_meta = var_copy_132999.getter_meta (SOURCE_FILE ("gtl_data_types.galgas", 4273)) ;
        }
      }
      if (kBoolFalse == test_3) {
        TC_Array <C_FixItDescription> fixItArray6 ;
...
static void extensionSetter_gtlMap_deleteMapItem (cPtr_gtlData * inObject,
  ...
  macroValidSharedObject (object, cPtr_gtlMap) ;
  {
  GALGAS_gtlData joker_133716 ; // Joker input parameter
  object->mProperty_value.setter_del (constinArgument_name, joker_133716, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4292)) ;
  }
}
//----------------------------------------------------------------------------------------------------------------------
...
static void extensionMethod_gtlMap_mapItem (const cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = object->mProperty_value.getter_hasKey (constinArgument_name.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4299)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4299)).boolEnum () ;
    if (kBoolTrue == test_0) {
...
static GALGAS_gtlData extensionGetter_gtlExpr_performGetter (const cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4578)).objectCompare (GALGAS_string ("eval"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      ...
      GALGAS_gtlData var_vars_141362 = constinArgument_arguments.getter_dataAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4580)) ;
      result_result = callExtensionGetter_eval ((const cPtr_gtlExpression *) object->mProperty_value.ptr (), constinArgument_context, var_vars_141362, constinArgument_lib, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4581)) ;
    }
  }
  if (kBoolFalse == test_0) {
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (kIsEqual, GALGAS_string ("type").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4582)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        {
    ...
    if (kBoolFalse == test_1) {
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = GALGAS_bool (kIsEqual, GALGAS_string ("isANumber").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4587)))).boolEnum () ;
        if (kBoolTrue == test_3) {
          {
      ...
      if (kBoolFalse == test_3) {
        enumGalgasBool test_4 = kBoolTrue ;
        if (kBoolTrue == test_4) {
          test_4 = GALGAS_bool (kIsEqual, GALGAS_string ("description").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4592)))).boolEnum () ;
          if (kBoolTrue == test_4) {
            {
        ...
        if (kBoolFalse == test_4) {
          enumGalgasBool test_5 = kBoolTrue ;
          if (kBoolTrue == test_5) {
            test_5 = GALGAS_bool (kIsEqual, GALGAS_string ("location").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4597)))).boolEnum () ;
            if (kBoolTrue == test_5) {
              {
          ...
          if (kBoolFalse == test_5) {
            enumGalgasBool test_6 = kBoolTrue ;
            if (kBoolTrue == test_6) {
              test_6 = callExtensionGetter_getterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("expression"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4602)).boolEnum () ;
              if (kBoolTrue == test_6) {
...
static void extensionSetter_gtlExpr_performSetter (cPtr_gtlData * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string ("setDescription").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4625)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      ...
      GALGAS_gtlString var_descriptionToSet_143006 = temp_1 ;
      {
      object->setter_setMeta (callExtensionGetter_lstring ((const cPtr_gtlString *) var_descriptionToSet_143006.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4628)) COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4628)) ;
      }
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = GALGAS_bool (kIsEqual, GALGAS_string ("touch").objectCompare (constinArgument_methodName.getter_string (SOURCE_FILE ("gtl_data_types.galgas", 4630)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
    ...
    if (kBoolFalse == test_2) {
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = callExtensionGetter_setterExists ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("expression"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4633)).boolEnum () ;
        if (kBoolTrue == test_3) {
          const GALGAS_gtlExpr temp_4 = object ;
          GALGAS_gtlData var_copy_143308 = temp_4 ;
          callExtensionMethod_callSetter ((const cPtr_gtlSetter *) callExtensionGetter_getSetter ((const cPtr_library *) constinArgument_lib.ptr (), GALGAS_string ("expression"), constinArgument_methodName, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4635)).ptr (), constinArgument_methodName.getter_location (SOURCE_FILE ("gtl_data_types.galgas", 4636)), constinArgument_context, constinArgument_lib, var_copy_143308, constinArgument_arguments, inCompiler COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4635)) ;
          GALGAS_gtlExpr temp_5 ;
          if (var_copy_143308.isValid ()) {
            if (NULL != dynamic_cast <const cPtr_gtlExpr *> (var_copy_143308.ptr ())) {
              temp_5 = (cPtr_gtlExpr *) var_copy_143308.ptr () ;
            }else{
              inCompiler->castError ("gtlExpr", var_copy_143308.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("gtl_data_types.galgas", 4642)) ;
            }
          }
          object->mProperty_value = temp_5.getter_value (SOURCE_FILE ("gtl_data_types.galgas", 4642)) ;
          object->mProperty_where = var_copy_143308.getter_where (SOURCE_FILE ("gtl_data_types.galgas", 4643)) ;
          object->mProperty_meta = var_copy_143308.getter_meta (SOURCE_FILE ("gtl_data_types.galgas", 4644)) ;
        }
      }
      if (kBoolFalse == test_3) {
        TC_Array <C_FixItDescription> fixItArray6 ;
...
static GALGAS_string extensionGetter_gtlString_stringRepresentation (const cPtr_gtlData * inObject,
  ...
  GALGAS_string var_literalString_29982 = callExtensionGetter_string ((const cPtr_gtlString *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 981)) ;
  var_literalString_29982 = var_literalString_29982.getter_stringByReplacingStringByString (GALGAS_string ("\n"), GALGAS_string ("\\n"), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 982)) ;
  var_literalString_29982 = var_literalString_29982.getter_stringByReplacingStringByString (GALGAS_string ("\t"), GALGAS_string ("\\t"), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 983)) ;
  var_literalString_29982 = var_literalString_29982.getter_stringByReplacingStringByString (GALGAS_string ("\f"), GALGAS_string ("\\f"), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 984)) ;
  var_literalString_29982 = var_literalString_29982.getter_stringByReplacingStringByString (GALGAS_string ("\r"), GALGAS_string ("\\r"), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 985)) ;
  var_literalString_29982 = var_literalString_29982.getter_stringByReplacingStringByString (GALGAS_string ("\v"), GALGAS_string ("\\v"), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 986)) ;
  var_literalString_29982 = var_literalString_29982.getter_stringByReplacingStringByString (GALGAS_string ("\\"), GALGAS_string ("\\\\"), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 987)) ;
  var_literalString_29982 = var_literalString_29982.getter_stringByReplacingStringByString (GALGAS_string ("\""), GALGAS_string ("\\\""), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 988)) ;
  result_result = GALGAS_string ("\"").add_operation (var_literalString_29982, inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 989)).add_operation (GALGAS_string ("\""), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 989)) ;
//---
  return result_result ;
}
...
static GALGAS_string extensionGetter_gtlList_stringRepresentation (const cPtr_gtlData * inObject,
  ...
  cEnumerator_list enumerator_31163 (object->mProperty_value, kENUMERATION_UP) ;
  while (enumerator_31163.hasCurrentObject ()) {
    result_result = result_result.add_operation (callExtensionGetter_stringRepresentation ((const cPtr_gtlData *) enumerator_31163.current_value (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1012)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1012)) ;
    if (enumerator_31163.hasNextObject ()) {
      result_result = result_result.add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1014)) ;
    }
    enumerator_31163.gotoNextObject () ;
  }
...
static GALGAS_string extensionGetter_gtlMap_stringRepresentation (const cPtr_gtlData * inObject,
  ...
  macroValidSharedObject (object, cPtr_gtlMap) ;
  result_result = GALGAS_string ("@[ ") ;
  cEnumerator_gtlVarMap enumerator_31476 (object->mProperty_value, kENUMERATION_UP) ;
  while (enumerator_31476.hasCurrentObject ()) {
    result_result = result_result.add_operation (GALGAS_string ("\""), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1025)).add_operation (enumerator_31476.current_lkey (HERE).getter_string (SOURCE_FILE ("gtl_debugger.galgas", 1025)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1025)).add_operation (GALGAS_string ("\": "), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1025)).add_operation (callExtensionGetter_stringRepresentation ((const cPtr_gtlData *) enumerator_31476.current_value (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1025)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1025)) ;
    if (enumerator_31476.hasNextObject ()) {
...
static GALGAS_string extensionGetter_gtlStruct_stringRepresentation (const cPtr_gtlData * inObject,
  ...
  macroValidSharedObject (object, cPtr_gtlStruct) ;
  result_result = GALGAS_string ("@{ ") ;
  cEnumerator_gtlVarMap enumerator_31816 (object->mProperty_value, kENUMERATION_UP) ;
  while (enumerator_31816.hasCurrentObject ()) {
    result_result = result_result.add_operation (enumerator_31816.current_lkey (HERE).getter_string (SOURCE_FILE ("gtl_debugger.galgas", 1038)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1038)).add_operation (GALGAS_string (": "), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1038)).add_operation (callExtensionGetter_stringRepresentation ((const cPtr_gtlData *) enumerator_31816.current_value (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1038)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1038)) ;
    if (enumerator_31816.hasNextObject ()) {
...
static GALGAS_string extensionGetter_gtlSet_stringRepresentation (const cPtr_gtlData * inObject,
  ...
  result_result = GALGAS_string ("@! ") ;
  cEnumerator_lstringset enumerator_32140 (object->mProperty_value, kENUMERATION_UP) ;
  while (enumerator_32140.hasCurrentObject ()) {
    result_result = result_result.add_operation (enumerator_32140.current_lkey (HERE).getter_string (SOURCE_FILE ("gtl_debugger.galgas", 1051)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1051)) ;
    if (enumerator_32140.hasNextObject ()) {
      result_result = result_result.add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1053)) ;
    }
    enumerator_32140.gotoNextObject () ;
  }
...
static void extensionMethod_gtlRepeatStatementInstruction_display (const cPtr_gtlInstruction * inObject,
  ...
  if (object->mProperty_limit.isValid ()) {
    if (object->mProperty_limit.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_gtlTerminal) {
      GALGAS_gtlTerminal cast_41909_term ((cPtr_gtlTerminal *) object->mProperty_limit.ptr ()) ;
      if (cast_41909_term.getter_value (SOURCE_FILE ("gtl_debugger.galgas", 1404)).isValid ()) {
        if (cast_41909_term.getter_value (SOURCE_FILE ("gtl_debugger.galgas", 1404)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_gtlInt) {
          GALGAS_gtlInt cast_41961_intLimit ((cPtr_gtlInt *) cast_41909_term.getter_value (SOURCE_FILE ("gtl_debugger.galgas", 1404)).ptr ()) ;
          enumGalgasBool test_0 = kBoolTrue ;
          if (kBoolTrue == test_0) {
            test_0 = GALGAS_bool (kIsNotEqual, cast_41961_intLimit.getter_value (SOURCE_FILE ("gtl_debugger.galgas", 1406)).getter_uint (inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1406)).objectCompare (GALGAS_uint::constructor_max (SOURCE_FILE ("gtl_debugger.galgas", 1406)))).boolEnum () ;
            if (kBoolTrue == test_0) {
              inCompiler->printMessage (GALGAS_string (" (").add_operation (callExtensionGetter_string ((const cPtr_gtlInt *) cast_41961_intLimit.ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1407)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1407)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1407))  COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1407)) ;
            }
          }
        }
      }
...
static void extensionMethod_gtlStepInstruction_execute (const cPtr_gtlInstruction * /* inObject */,
  ...
  {
  ioArgument_context.insulate (HERE) ;
  cPtr_gtlContext * ptr_44073 = (cPtr_gtlContext *) ioArgument_context.ptr () ;
  callExtensionSetter_setLoopOnCommand ((cPtr_gtlContext *) ptr_44073, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1482)) ;
  }
}
...
static void extensionMethod_gtlDoInstInstruction_execute (const cPtr_gtlInstruction * inObject,
  ...
  {
  ioArgument_context.insulate (HERE) ;
  cPtr_gtlContext * ptr_44637 = (cPtr_gtlContext *) ioArgument_context.ptr () ;
  callExtensionSetter_appendInstructionToStepDo ((cPtr_gtlContext *) ptr_44637, object->mProperty_instructionToDo, inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1504)) ;
  }
}
...
static void extensionMethod_gtlDoNotInstruction_execute (const cPtr_gtlInstruction * inObject,
  ...
  {
  ioArgument_context.insulate (HERE) ;
  cPtr_gtlContext * ptr_45232 = (cPtr_gtlContext *) ioArgument_context.ptr () ;
  callExtensionSetter_deleteStepDoInstruction ((cPtr_gtlContext *) ptr_45232, object->mProperty_numToDelete, inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1527)) ;
  }
}
...
static void extensionMethod_gtlDoNotAllInstruction_execute (const cPtr_gtlInstruction * /* inObject */,
  ...
  {
  ioArgument_context.insulate (HERE) ;
  cPtr_gtlContext * ptr_45800 = (cPtr_gtlContext *) ioArgument_context.ptr () ;
  callExtensionSetter_deleteAllStepDoInstructions ((cPtr_gtlContext *) ptr_45800, inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1548)) ;
  }
}
...
static void extensionMethod_gtlContinueInstruction_execute (const cPtr_gtlInstruction * /* inObject */,
  ...
  {
  ioArgument_context.insulate (HERE) ;
  cPtr_gtlContext * ptr_46841 = (cPtr_gtlContext *) ioArgument_context.ptr () ;
  callExtensionSetter_setBreakOnNext ((cPtr_gtlContext *) ptr_46841, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1590)) ;
  }
  {
  ioArgument_context.insulate (HERE) ;
  cPtr_gtlContext * ptr_46877 = (cPtr_gtlContext *) ioArgument_context.ptr () ;
  callExtensionSetter_setLoopOnCommand ((cPtr_gtlContext *) ptr_46877, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1591)) ;
  }
}
...
static void extensionMethod_gtlBreakpointInstruction_execute (const cPtr_gtlInstruction * inObject,
  ...
  GALGAS_gtlInstructionList var_instructionList_47465 = ioArgument_context.getter_debuggerContext (SOURCE_FILE ("gtl_debugger.galgas", 1614)).getter_instructionList (SOURCE_FILE ("gtl_debugger.galgas", 1614)) ;
  GALGAS_string var_localFileName_47535 = GALGAS_string::makeEmptyString () ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsStrictSup, var_instructionList_47465.getter_length (SOURCE_FILE ("gtl_debugger.galgas", 1616)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      var_localFileName_47535 = callExtensionGetter_location ((const cPtr_gtlInstruction *) var_instructionList_47465.getter_instructionAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1618)).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1618)).getter_file (inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1618)).getter_lastPathComponent (SOURCE_FILE ("gtl_debugger.galgas", 1619)) ;
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = GALGAS_bool (kIsEqual, object->mProperty_fileName.objectCompare (var_localFileName_47535)).operator_or (GALGAS_bool (kIsEqual, object->mProperty_fileName.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1621)).boolEnum () ;
        if (kBoolTrue == test_1) {
          inCompiler->printMessage (GALGAS_string ("Setting breakpoint at ").add_operation (var_localFileName_47535, inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1622)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1622)).add_operation (object->mProperty_lineNum.getter_string (SOURCE_FILE ("gtl_debugger.galgas", 1622)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1622)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1622))  COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1622)) ;
          {
          ioArgument_context.insulate (HERE) ;
          cPtr_gtlContext * ptr_47845 = (cPtr_gtlContext *) ioArgument_context.ptr () ;
          callExtensionSetter_setBreakpoint ((cPtr_gtlContext *) ptr_47845, var_localFileName_47535, object->mProperty_lineNum, inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1623)) ;
          }
        }
      }
      if (kBoolFalse == test_1) {
        ...
        {
        ioArgument_context.insulate (HERE) ;
        cPtr_gtlContext * ptr_47988 = (cPtr_gtlContext *) ioArgument_context.ptr () ;
        callExtensionSetter_setBreakpoint ((cPtr_gtlContext *) ptr_47988, object->mProperty_fileName, object->mProperty_lineNum, inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1626)) ;
        }
      }
    }
  }
...
static void extensionMethod_gtlBreakpointDeleteInstruction_execute (const cPtr_gtlInstruction * inObject,
  ...
  {
  ioArgument_context.insulate (HERE) ;
  cPtr_gtlContext * ptr_49234 = (cPtr_gtlContext *) ioArgument_context.ptr () ;
  callExtensionSetter_deleteBreakpoint ((cPtr_gtlContext *) ptr_49234, object->mProperty_numToDelete, inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1673)) ;
  }
}
...
static void extensionMethod_gtlBreakpointDeleteAllInstruction_execute (const cPtr_gtlInstruction * /* inObject */,
  ...
  {
  ioArgument_context.insulate (HERE) ;
  cPtr_gtlContext * ptr_49842 = (cPtr_gtlContext *) ioArgument_context.ptr () ;
  callExtensionSetter_deleteAllBreakpoints ((cPtr_gtlContext *) ptr_49842, inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1694)) ;
  }
}
...
static void extensionMethod_gtlWatchpointInstruction_execute (const cPtr_gtlInstruction * inObject,
  ...
  {
  ioArgument_context.insulate (HERE) ;
  cPtr_gtlContext * ptr_50434 = (cPtr_gtlContext *) ioArgument_context.ptr () ;
  callExtensionSetter_setWatchpoint ((cPtr_gtlContext *) ptr_50434, object->mProperty_watchExpression, inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1716)) ;
  }
}
...
static void extensionMethod_gtlWatchpointDeleteInstruction_execute (const cPtr_gtlInstruction * inObject,
  ...
  {
  ioArgument_context.insulate (HERE) ;
  cPtr_gtlContext * ptr_51620 = (cPtr_gtlContext *) ioArgument_context.ptr () ;
  callExtensionSetter_deleteWatchpoint ((cPtr_gtlContext *) ptr_51620, object->mProperty_numToDelete, inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1759)) ;
  }
}
