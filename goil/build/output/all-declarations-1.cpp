...
GALGAS_string extensionGetter_stringRepresentation (const GALGAS_gtlVarPath & inObject,
  ...
  cEnumerator_gtlVarPath enumerator_19715 (temp_1.getter_subListFromIndex (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 654)), kENUMERATION_UP) ;
  while (enumerator_19715.hasCurrentObject ()) {
    result_result.plusAssign_operation(callExtensionGetter_stringRepresentation ((const cPtr_gtlVarItem *) enumerator_19715.current_item (HERE).ptr (), GALGAS_string ("::"), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 655)), inCompiler  COMMA_SOURCE_FILE ("gtl_debugger.galgas", 655)) ;
...
GALGAS_string extensionGetter_stringRepresentation (const GALGAS_gtlExpressionList & inObject,
  ...
  cEnumerator_gtlExpressionList enumerator_32639 (temp_0, kENUMERATION_UP) ;
  while (enumerator_32639.hasCurrentObject ()) {
    result_result = result_result.add_operation (callExtensionGetter_stringRepresentation ((const cPtr_gtlExpression *) enumerator_32639.current_expression (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1071)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1071)) ;
    if (enumerator_32639.hasNextObject ()) {
      result_result = result_result.add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1073)) ;
    }
    enumerator_32639.gotoNextObject () ;
  }
//---
  return result_result ;
}
...
GALGAS_string extensionGetter_mapRepresentation (const GALGAS_gtlExpressionMap & inObject,
  ...
  cEnumerator_gtlExpressionMap enumerator_32933 (temp_0, kENUMERATION_UP) ;
  while (enumerator_32933.hasCurrentObject ()) {
    result_result = result_result.add_operation (GALGAS_string ("\""), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1083)).add_operation (enumerator_32933.current_lkey (HERE).getter_string (SOURCE_FILE ("gtl_debugger.galgas", 1083)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1083)).add_operation (GALGAS_string ("\": "), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1083)).add_operation (callExtensionGetter_stringRepresentation ((const cPtr_gtlExpression *) enumerator_32933.current_expression (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1083)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1083)) ;
    if (enumerator_32933.hasNextObject ()) {
      result_result = result_result.add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1085)) ;
    }
    enumerator_32933.gotoNextObject () ;
  }
//---
  return result_result ;
}
...
GALGAS_string extensionGetter_structRepresentation (const GALGAS_gtlExpressionMap & inObject,
  ...
  result_result = GALGAS_string::makeEmptyString () ;
  const GALGAS_gtlExpressionMap temp_0 = inObject ;
  cEnumerator_gtlExpressionMap enumerator_33252 (temp_0, kENUMERATION_UP) ;
  while (enumerator_33252.hasCurrentObject ()) {
    result_result = result_result.add_operation (enumerator_33252.current_lkey (HERE).getter_string (SOURCE_FILE ("gtl_debugger.galgas", 1095)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1095)).add_operation (GALGAS_string (": "), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1095)).add_operation (callExtensionGetter_stringRepresentation ((const cPtr_gtlExpression *) enumerator_33252.current_expression (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1095)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1095)) ;
    if (enumerator_33252.hasNextObject ()) {
      result_result = result_result.add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1097)) ;
    }
    enumerator_33252.gotoNextObject () ;
  }
//---
  return result_result ;
}
...
GALGAS_string extensionGetter_stringRepresentation (const GALGAS_gtlArgumentList & inObject,
  ...
  cEnumerator_gtlArgumentList enumerator_33562 (temp_0, kENUMERATION_UP) ;
  while (enumerator_33562.hasCurrentObject ()) {
    result_result = result_result.add_operation (enumerator_33562.current_name (HERE).getter_string (SOURCE_FILE ("gtl_debugger.galgas", 1107)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1107)) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = enumerator_33562.current_typed (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        result_result = result_result.add_operation (GALGAS_string (" : @"), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1109)).add_operation (extensionGetter_typeName (enumerator_33562.current_type (HERE), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1109)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1109)) ;
      }
    }
    if (enumerator_33562.hasNextObject ()) {
...
GALGAS_string extensionGetter_stringRepresentation (const GALGAS_sortingKeyList & inObject,
  ...
  cEnumerator_sortingKeyList enumerator_34085 (temp_0, kENUMERATION_UP) ;
  while (enumerator_34085.hasCurrentObject ()) {
    result_result = result_result.add_operation (enumerator_34085.current_key (HERE).getter_string (SOURCE_FILE ("gtl_debugger.galgas", 1129)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1129)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1129)).add_operation (extensionGetter_stringRepresentation (enumerator_34085.current_order (HERE), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1129)), inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1129)) ;
