...
static GALGAS_lstring extensionGetter_gtlContext_fullTemplateFileName (const cPtr_gtlContext * inObject,
  ...
  var_prefixedTemplatePath_2562 = extensionGetter_stringByAppendingPath (object->mProperty_userTemplateDirectory, var_fullPref_2480.getter_string (SOURCE_FILE ("gtl_types.galgas", 123)), inCompiler COMMA_SOURCE_FILE ("gtl_types.galgas", 123)) ;
  var_hierarchicalPath_2589 = object->mProperty_path ;
  var_rootPath_2608 = function_pathWithExtension (inArgument_context, extensionGetter_stringByAppendingPath (var_prefixedTemplatePath_2562, inArgument_simpleName.getter_string (SOURCE_FILE ("gtl_types.galgas", 127)), inCompiler COMMA_SOURCE_FILE ("gtl_types.galgas", 127)), inCompiler COMMA_SOURCE_FILE ("gtl_types.galgas", 125)) ;
  if (var_hierarchicalPath_2589.getter_length (SOURCE_FILE ("gtl_types.galgas", 130)).isValid ()) {
    uint32_t variant_2941 = var_hierarchicalPath_2589.getter_length (SOURCE_FILE ("gtl_types.galgas", 130)).uintValue () ;
    bool loop_2941 = true ;
    while (loop_2941) {
        GALGAS_string var_fullPath_2992 = function_pathWithExtension (inArgument_context, extensionGetter_stringByAppendingPath (extensionGetter_stringByAppendingPath (var_prefixedTemplatePath_2562, var_hierarchicalPath_2589, inCompiler COMMA_SOURCE_FILE ("gtl_types.galgas", 133)), inArgument_simpleName.getter_string (SOURCE_FILE ("gtl_types.galgas", 134)), inCompiler COMMA_SOURCE_FILE ("gtl_types.galgas", 133)), inCompiler COMMA_SOURCE_FILE ("gtl_types.galgas", 131)) ;
        enumGalgasBool test_2 = kBoolTrue ;
        if (kBoolTrue == test_2) {
          test_2 = var_fullPath_2992.getter_fileExists (SOURCE_FILE ("gtl_types.galgas", 138)).boolEnum () ;
          if (kBoolTrue == test_2) {
            var_rootPath_2608 = var_fullPath_2992 ;
            var_found_2523 = GALGAS_bool (true) ;
          }
        }
      GALGAS_bool test_3 = var_found_2523.operator_not (SOURCE_FILE ("gtl_types.galgas", 145)) ;
      if (kBoolTrue == test_3.boolEnum ()) {
        test_3 = GALGAS_bool (kIsStrictSup, var_hierarchicalPath_2589.getter_length (SOURCE_FILE ("gtl_types.galgas", 145)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
      }
      loop_2941 = test_3.isValid () ;
      if (loop_2941) {
        loop_2941 = test_3.boolValue () ;
      }
      if (loop_2941 && (0 == variant_2941)) {
        loop_2941 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("gtl_types.galgas", 130)) ;
      }
      if (loop_2941) {
        variant_2941 -- ;
        var_hierarchicalPath_2589 = var_hierarchicalPath_2589.getter_stringByDeletingLastPathComponent (SOURCE_FILE ("gtl_types.galgas", 146)) ;
      }
    }
  }
  enumGalgasBool test_4 = kBoolTrue ;
  if (kBoolTrue == test_4) {
    test_4 = var_found_2523.operator_not (SOURCE_FILE ("gtl_types.galgas", 149)).boolEnum () ;
    if (kBoolTrue == test_4) {
      var_prefixedTemplatePath_2562 = extensionGetter_stringByAppendingPath (object->mProperty_templateDirectory, var_fullPref_2480.getter_string (SOURCE_FILE ("gtl_types.galgas", 154)), inCompiler COMMA_SOURCE_FILE ("gtl_types.galgas", 154)) ;
      var_hierarchicalPath_2589 = object->mProperty_path ;
      var_rootPath_2608 = function_pathWithExtension (inArgument_context, extensionGetter_stringByAppendingPath (var_prefixedTemplatePath_2562, inArgument_simpleName.getter_string (SOURCE_FILE ("gtl_types.galgas", 158)), inCompiler COMMA_SOURCE_FILE ("gtl_types.galgas", 158)), inCompiler COMMA_SOURCE_FILE ("gtl_types.galgas", 156)) ;
      if (var_hierarchicalPath_2589.getter_length (SOURCE_FILE ("gtl_types.galgas", 162)).isValid ()) {
        uint32_t variant_3822 = var_hierarchicalPath_2589.getter_length (SOURCE_FILE ("gtl_types.galgas", 162)).uintValue () ;
        bool loop_3822 = true ;
        while (loop_3822) {
            GALGAS_string var_fullPath_3875 = function_pathWithExtension (inArgument_context, extensionGetter_stringByAppendingPath (extensionGetter_stringByAppendingPath (var_prefixedTemplatePath_2562, var_hierarchicalPath_2589, inCompiler COMMA_SOURCE_FILE ("gtl_types.galgas", 165)), inArgument_simpleName.getter_string (SOURCE_FILE ("gtl_types.galgas", 166)), inCompiler COMMA_SOURCE_FILE ("gtl_types.galgas", 165)), inCompiler COMMA_SOURCE_FILE ("gtl_types.galgas", 163)) ;
            enumGalgasBool test_5 = kBoolTrue ;
            if (kBoolTrue == test_5) {
              test_5 = var_fullPath_3875.getter_fileExists (SOURCE_FILE ("gtl_types.galgas", 170)).boolEnum () ;
              if (kBoolTrue == test_5) {
                var_rootPath_2608 = var_fullPath_3875 ;
                var_found_2523 = GALGAS_bool (true) ;
              }
            }
          GALGAS_bool test_6 = var_found_2523.operator_not (SOURCE_FILE ("gtl_types.galgas", 177)) ;
          if (kBoolTrue == test_6.boolEnum ()) {
            test_6 = GALGAS_bool (kIsStrictSup, var_hierarchicalPath_2589.getter_length (SOURCE_FILE ("gtl_types.galgas", 177)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
          }
          loop_3822 = test_6.isValid () ;
          if (loop_3822) {
            loop_3822 = test_6.boolValue () ;
          }
          if (loop_3822 && (0 == variant_3822)) {
            loop_3822 = false ;
            inCompiler->loopRunTimeVariantError (SOURCE_FILE ("gtl_types.galgas", 162)) ;
          }
          if (loop_3822) {
            variant_3822 -- ;
            var_hierarchicalPath_2589 = var_hierarchicalPath_2589.getter_stringByDeletingLastPathComponent (SOURCE_FILE ("gtl_types.galgas", 178)) ;
          }
        }
      }
    }
  }
  result_fullName = GALGAS_lstring::constructor_new (var_rootPath_2608, inArgument_simpleName.getter_location (SOURCE_FILE ("gtl_types.galgas", 184))  COMMA_SOURCE_FILE ("gtl_types.galgas", 182)) ;
//---
