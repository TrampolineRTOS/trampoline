...
GALGAS_bool function_checkEnums (const GALGAS_impEnumType & constinArgument_previousEnum,
  ...
  GALGAS_stringset var_newValues_18414 = constinArgument_newEnum.getter_valuesMap (SOURCE_FILE ("implementation_parser.galgas", 665)).getter_keySet (SOURCE_FILE ("implementation_parser.galgas", 665)) ;
  GALGAS_stringset var_previousValues_18473 = constinArgument_previousEnum.getter_valuesMap (SOURCE_FILE ("implementation_parser.galgas", 666)).getter_keySet (SOURCE_FILE ("implementation_parser.galgas", 666)) ;
  result_inside = GALGAS_bool (kIsEqual, var_newValues_18414.operator_and (var_previousValues_18473 COMMA_SOURCE_FILE ("implementation_parser.galgas", 667)).objectCompare (var_newValues_18414)) ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = result_inside.operator_not (SOURCE_FILE ("implementation_parser.galgas", 668)).boolEnum () ;
    if (kBoolTrue == test_0) {
      cEnumerator_locationList enumerator_18617 (constinArgument_newEnum.getter_locations (SOURCE_FILE ("implementation_parser.galgas", 669)), kENUMERATION_UP) ;
      while (enumerator_18617.hasCurrentObject ()) {
        TC_Array <C_FixItDescription> fixItArray1 ;
        inCompiler->emitSemanticError (enumerator_18617.current_location (HERE), GALGAS_string ("ENUM is not within previous enum declaration"), fixItArray1  COMMA_SOURCE_FILE ("implementation_parser.galgas", 670)) ;
        enumerator_18617.gotoNextObject () ;
      }
      cEnumerator_locationList enumerator_18736 (constinArgument_previousEnum.getter_locations (SOURCE_FILE ("implementation_parser.galgas", 672)), kENUMERATION_UP) ;
      while (enumerator_18736.hasCurrentObject ()) {
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (enumerator_18736.current_location (HERE), GALGAS_string ("previous ENUM declaration was here"), fixItArray2  COMMA_SOURCE_FILE ("implementation_parser.galgas", 673)) ;
...
GALGAS_bool function_checkRanged (const GALGAS_impRangedType & constinArgument_previousRanged,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = result_inside.operator_not (SOURCE_FILE ("implementation_parser.galgas", 687)).boolEnum () ;
    if (kBoolTrue == test_0) {
      cEnumerator_locationList enumerator_19099 (constinArgument_newRanged.getter_locations (SOURCE_FILE ("implementation_parser.galgas", 688)), kENUMERATION_UP) ;
      while (enumerator_19099.hasCurrentObject ()) {
        TC_Array <C_FixItDescription> fixItArray1 ;
        inCompiler->emitSemanticError (enumerator_19099.current_location (HERE), GALGAS_string ("new range or set is not within previous range or set declaration"), fixItArray1  COMMA_SOURCE_FILE ("implementation_parser.galgas", 689)) ;
        enumerator_19099.gotoNextObject () ;
      }
      cEnumerator_locationList enumerator_19240 (constinArgument_previousRanged.getter_locations (SOURCE_FILE ("implementation_parser.galgas", 691)), kENUMERATION_UP) ;
      while (enumerator_19240.hasCurrentObject ()) {
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (enumerator_19240.current_location (HERE), GALGAS_string ("previous range or set declaration was here"), fixItArray2  COMMA_SOURCE_FILE ("implementation_parser.galgas", 692)) ;
...
GALGAS_bool function_checkNewTypeWithinPreviousType (const GALGAS_lstring & constinArgument_name,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsNotEqual, constinArgument_newType.getter_type (SOURCE_FILE ("implementation_parser.galgas", 703)).objectCompare (constinArgument_previousType.getter_type (SOURCE_FILE ("implementation_parser.galgas", 703)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      cEnumerator_locationList enumerator_19555 (constinArgument_newType.getter_locations (SOURCE_FILE ("implementation_parser.galgas", 704)), kENUMERATION_UP) ;
      while (enumerator_19555.hasCurrentObject ()) {
        TC_Array <C_FixItDescription> fixItArray1 ;
        inCompiler->emitSemanticError (enumerator_19555.current_location (HERE), constinArgument_name.getter_string (SOURCE_FILE ("implementation_parser.galgas", 705)).add_operation (GALGAS_string (" should be a "), inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 705)).add_operation (extensionGetter_oilType (constinArgument_previousType.getter_type (SOURCE_FILE ("implementation_parser.galgas", 705)), inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 705)), inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 705)), fixItArray1  COMMA_SOURCE_FILE ("implementation_parser.galgas", 705)) ;
        enumerator_19555.gotoNextObject () ;
      }
      cEnumerator_locationList enumerator_19687 (constinArgument_previousType.getter_locations (SOURCE_FILE ("implementation_parser.galgas", 707)), kENUMERATION_UP) ;
      while (enumerator_19687.hasCurrentObject ()) {
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (enumerator_19687.current_location (HERE), constinArgument_name.getter_string (SOURCE_FILE ("implementation_parser.galgas", 708)).add_operation (GALGAS_string (" was previouly defined here"), inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 708)), fixItArray2  COMMA_SOURCE_FILE ("implementation_parser.galgas", 708)) ;
  ...
  if (kBoolFalse == test_0) {
    if (constinArgument_previousType.isValid ()) {
      if (constinArgument_previousType.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impEnumType) {
        GALGAS_impEnumType cast_19850_previousEnum ((cPtr_impEnumType *) constinArgument_previousType.ptr ()) ;
        if (constinArgument_newType.isValid ()) {
          if (constinArgument_newType.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impEnumType) {
            GALGAS_impEnumType cast_19906_newEnum ((cPtr_impEnumType *) constinArgument_newType.ptr ()) ;
            result_result = function_checkEnums (cast_19850_previousEnum, cast_19906_newEnum, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 716)) ;
          }
        }
      }else if (constinArgument_previousType.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impRangedType) {
        GALGAS_impRangedType cast_20017_previousRanged ((cPtr_impRangedType *) constinArgument_previousType.ptr ()) ;
        if (constinArgument_newType.isValid ()) {
          if (constinArgument_newType.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impRangedType) {
            GALGAS_impRangedType cast_20077_newRanged ((cPtr_impRangedType *) constinArgument_newType.ptr ()) ;
            result_result = function_checkRanged (cast_20017_previousRanged, cast_20077_newRanged, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 721)) ;
          }
        }
      }else{
...
GALGAS_attributeRange function_buildRange (const GALGAS_dataType & constinArgument_type,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE ("implementation_parser.galgas", 734)))).boolEnum () ;
    if (kBoolTrue == test_0) {
  ...
  if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_33__32_Number (SOURCE_FILE ("implementation_parser.galgas", 736)))).boolEnum () ;
      if (kBoolTrue == test_1) {
    ...
    if (kBoolFalse == test_1) {
      ...
      if (kBoolTrue == test_2) {
        test_2 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_parser.galgas", 738)))).boolEnum () ;
        if (kBoolTrue == test_2) {
      ...
      if (kBoolFalse == test_2) {
        ...
        if (kBoolTrue == test_3) {
          test_3 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_36__34_Number (SOURCE_FILE ("implementation_parser.galgas", 740)))).boolEnum () ;
          if (kBoolTrue == test_3) {
        ...
        if (kBoolFalse == test_3) {
          ...
          if (kBoolTrue == test_4) {
            test_4 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_floatNumber (SOURCE_FILE ("implementation_parser.galgas", 742)))).boolEnum () ;
            if (kBoolTrue == test_4) {
    ...
    if (constinArgument_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_33__32_AttributeSet) {
      ...
      while (enumerator_5020.hasCurrentObject ()) {
        ...
        while (enumerator_5079.hasCurrentObject ()) {
          enumGalgasBool test_0 = kBoolTrue ;
          if (kBoolTrue == test_0) {
            test_0 = GALGAS_bool (kIsEqual, enumerator_5020.current_value (HERE).objectCompare (enumerator_5079.current_value (HERE))).boolEnum () ;
            if (kBoolTrue == test_0) {
    ...
    if (constinArgument_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_36__34_AttributeSet) {
      ...
      while (enumerator_5631.hasCurrentObject ()) {
        ...
        while (enumerator_5690.hasCurrentObject ()) {
          enumGalgasBool test_0 = kBoolTrue ;
          if (kBoolTrue == test_0) {
            test_0 = GALGAS_bool (kIsEqual, enumerator_5631.current_value (HERE).objectCompare (enumerator_5690.current_value (HERE))).boolEnum () ;
            if (kBoolTrue == test_0) {
    ...
    if (constinArgument_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_33__32_AttributeSet) {
      ...
      while (enumerator_6242.hasCurrentObject ()) {
        ...
        while (enumerator_6301.hasCurrentObject ()) {
          enumGalgasBool test_0 = kBoolTrue ;
          if (kBoolTrue == test_0) {
            test_0 = GALGAS_bool (kIsEqual, enumerator_6242.current_value (HERE).objectCompare (enumerator_6301.current_value (HERE))).boolEnum () ;
            if (kBoolTrue == test_0) {
    ...
    if (constinArgument_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_36__34_AttributeSet) {
      ...
      while (enumerator_6852.hasCurrentObject ()) {
        ...
        while (enumerator_6911.hasCurrentObject ()) {
          enumGalgasBool test_0 = kBoolTrue ;
          if (kBoolTrue == test_0) {
            test_0 = GALGAS_bool (kIsEqual, enumerator_6852.current_value (HERE).objectCompare (enumerator_6911.current_value (HERE))).boolEnum () ;
            if (kBoolTrue == test_0) {
    ...
    if (constinArgument_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_floatAttributeSet) {
      ...
      while (enumerator_7460.hasCurrentObject ()) {
        ...
        while (enumerator_7519.hasCurrentObject ()) {
          enumGalgasBool test_0 = kBoolTrue ;
          if (kBoolTrue == test_0) {
            test_0 = GALGAS_bool (kIsEqual, enumerator_7460.current_value (HERE).objectCompare (enumerator_7519.current_value (HERE))).boolEnum () ;
            if (kBoolTrue == test_0) {
  ...
  if (constinArgument_value.isValid ()) {
    if (constinArgument_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_33__32_AttributeMinMax) {
      ...
      while (enumerator_8218.hasCurrentObject ()) {
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = GALGAS_bool (kIsStrictInf, enumerator_8218.current_value (HERE).objectCompare (object->mProperty_min)).operator_or (GALGAS_bool (kIsStrictSup, enumerator_8218.current_value (HERE).objectCompare (object->mProperty_max)) COMMA_SOURCE_FILE ("implementation_types.galgas", 299)).boolEnum () ;
          if (kBoolTrue == test_1) {
            outArgument_isWithin = GALGAS_bool (false) ;
          }
        }
  ...
  if (constinArgument_value.isValid ()) {
    if (constinArgument_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_36__34_AttributeMinMax) {
      ...
      while (enumerator_8877.hasCurrentObject ()) {
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = GALGAS_bool (kIsStrictInf, enumerator_8877.current_value (HERE).objectCompare (object->mProperty_min)).operator_or (GALGAS_bool (kIsStrictSup, enumerator_8877.current_value (HERE).objectCompare (object->mProperty_max)) COMMA_SOURCE_FILE ("implementation_types.galgas", 324)).boolEnum () ;
          if (kBoolTrue == test_1) {
            outArgument_isWithin = GALGAS_bool (false) ;
          }
        }
  ...
  if (constinArgument_value.isValid ()) {
    if (constinArgument_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_33__32_AttributeMinMax) {
      ...
      while (enumerator_9532.hasCurrentObject ()) {
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = GALGAS_bool (kIsStrictInf, enumerator_9532.current_value (HERE).objectCompare (object->mProperty_min)).operator_or (GALGAS_bool (kIsStrictSup, enumerator_9532.current_value (HERE).objectCompare (object->mProperty_max)) COMMA_SOURCE_FILE ("implementation_types.galgas", 349)).boolEnum () ;
          if (kBoolTrue == test_1) {
            outArgument_isWithin = GALGAS_bool (false) ;
          }
        }
  ...
  if (constinArgument_value.isValid ()) {
    if (constinArgument_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_36__34_AttributeMinMax) {
      ...
      while (enumerator_10189.hasCurrentObject ()) {
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = GALGAS_bool (kIsStrictInf, enumerator_10189.current_value (HERE).objectCompare (object->mProperty_min)).operator_or (GALGAS_bool (kIsStrictSup, enumerator_10189.current_value (HERE).objectCompare (object->mProperty_max)) COMMA_SOURCE_FILE ("implementation_types.galgas", 374)).boolEnum () ;
          if (kBoolTrue == test_1) {
            outArgument_isWithin = GALGAS_bool (false) ;
          }
        }
  ...
  if (constinArgument_value.isValid ()) {
    if (constinArgument_value.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_floatAttributeMinMax) {
      ...
      while (enumerator_10843.hasCurrentObject ()) {
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = GALGAS_bool (kIsStrictInf, enumerator_10843.current_value (HERE).objectCompare (object->mProperty_min)).operator_or (GALGAS_bool (kIsStrictSup, enumerator_10843.current_value (HERE).objectCompare (object->mProperty_max)) COMMA_SOURCE_FILE ("implementation_types.galgas", 399)).boolEnum () ;
          if (kBoolTrue == test_1) {
            outArgument_isWithin = GALGAS_bool (false) ;
          }
        }
...
GALGAS_attributeRange function_attributeRangeWithNumberList (const GALGAS_numberList & constinArgument_numbers,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE ("implementation_types.galgas", 414)))).boolEnum () ;
    if (kBoolTrue == test_0) {
  ...
  if (kBoolFalse == test_0) {
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_33__32_Number (SOURCE_FILE ("implementation_types.galgas", 416)))).boolEnum () ;
      if (kBoolTrue == test_1) {
    ...
    if (kBoolFalse == test_1) {
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        test_2 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 418)))).boolEnum () ;
        if (kBoolTrue == test_2) {
      ...
      if (kBoolFalse == test_2) {
        enumGalgasBool test_3 = kBoolTrue ;
        if (kBoolTrue == test_3) {
          test_3 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 420)))).boolEnum () ;
          if (kBoolTrue == test_3) {
        ...
        if (kBoolFalse == test_3) {
          enumGalgasBool test_4 = kBoolTrue ;
          if (kBoolTrue == test_4) {
            test_4 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_floatNumber (SOURCE_FILE ("implementation_types.galgas", 422)))).boolEnum () ;
            if (kBoolTrue == test_4) {
...
static GALGAS_impType extensionGetter_impStructType_mergeWithType (const cPtr_impType * inObject,
  ...
  if (inArgument_typeToMerge.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_impStructType *> (inArgument_typeToMerge.ptr ())) {
      ...
      inCompiler->castError ("impStructType", inArgument_typeToMerge.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("implementation_types.galgas", 470)) ;
    }
  }
  GALGAS_impStructType var_castTypeToMerge_12920 = temp_0 ;
  GALGAS_implementationObjectMap var_mergedAttributes_12996 = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_types.galgas", 471)) ;
  cEnumerator_implementationObjectMap enumerator_13037 (object->mProperty_structAttributes, kENUMERATION_UP) ;
  while (enumerator_13037.hasCurrentObject ()) {
    GALGAS_impType var_mergedAttr_13064 = enumerator_13037.current_type (HERE) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = var_castTypeToMerge_12920.getter_structAttributes (SOURCE_FILE ("implementation_types.galgas", 474)).getter_hasKey (enumerator_13037.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 474)) COMMA_SOURCE_FILE ("implementation_types.galgas", 474)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_impType var_subTypeToMerge_13219 ;
        var_castTypeToMerge_12920.getter_structAttributes (SOURCE_FILE ("implementation_types.galgas", 475)).method_get (enumerator_13037.current_lkey (HERE), var_subTypeToMerge_13219, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 475)) ;
        var_mergedAttr_13064 = callExtensionGetter_mergeWithType ((const cPtr_impType *) enumerator_13037.current_type (HERE).ptr (), var_subTypeToMerge_13219, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 476)) ;
      }
    }
    {
    var_mergedAttributes_12996.setter_put (enumerator_13037.current_lkey (HERE), var_mergedAttr_13064, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 478)) ;
    }
    enumerator_13037.gotoNextObject () ;
  }
  result_mergedType = GALGAS_impStructType::constructor_new (object->mProperty_locations.add_operation (inArgument_typeToMerge.getter_locations (SOURCE_FILE ("implementation_types.galgas", 481)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 481)), object->mProperty_type, object->mProperty_name, object->mProperty_multiple, object->mProperty_descs.add_operation (inArgument_typeToMerge.getter_descs (SOURCE_FILE ("implementation_types.galgas", 485)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 485)), var_mergedAttributes_12996  COMMA_SOURCE_FILE ("implementation_types.galgas", 480)) ;
//---
...
void routine_multiError (GALGAS_locationList inArgument_locations,
                         ...
                         C_Compiler * inCompiler
                         COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_locationList enumerator_14860 (inArgument_locations, kENUMERATION_UP) ;
  while (enumerator_14860.hasCurrentObject ()) {
    TC_Array <C_FixItDescription> fixItArray0 ;
    inCompiler->emitSemanticError (enumerator_14860.current_location (HERE), inArgument_errorMessage, fixItArray0  COMMA_SOURCE_FILE ("implementation_types.galgas", 549)) ;
...
static GALGAS_impType extensionGetter_refType_mergeWithType (const cPtr_impType * inObject,
  ...
  if (inArgument_typeToMerge.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_refType *> (inArgument_typeToMerge.ptr ())) {
      ...
      inCompiler->castError ("refType", inArgument_typeToMerge.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("implementation_types.galgas", 561)) ;
    }
  }
  GALGAS_refType var_castTypeToMerge_15093 = temp_0 ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = GALGAS_bool (kIsNotEqual, object->mProperty_ref.getter_string (SOURCE_FILE ("implementation_types.galgas", 562)).objectCompare (var_castTypeToMerge_15093.getter_ref (SOURCE_FILE ("implementation_types.galgas", 562)).getter_string (SOURCE_FILE ("implementation_types.galgas", 562)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      object->mProperty_ref.log ("ref"  COMMA_SOURCE_FILE ("implementation_types.galgas", 563)) ;
      GALGAS_lstring var_csatRef_15209 = var_castTypeToMerge_15093.getter_ref (SOURCE_FILE ("implementation_types.galgas", 564)) ;
      var_csatRef_15209.log ("csatRef"  COMMA_SOURCE_FILE ("implementation_types.galgas", 565)) ;
      {
      routine_multiError (inArgument_typeToMerge.getter_locations (SOURCE_FILE ("implementation_types.galgas", 566)), GALGAS_string ("Redefinition of ").add_operation (object->mProperty_name.getter_string (SOURCE_FILE ("implementation_types.galgas", 566)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 566)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 566)) ;
      }
      {
      routine_multiError (object->mProperty_locations, GALGAS_string ("Was defined here"), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 567)) ;
      }
    }
  }
  result_mergedType = GALGAS_refType::constructor_new (object->mProperty_locations.add_operation (inArgument_typeToMerge.getter_locations (SOURCE_FILE ("implementation_types.galgas", 570)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 570)), object->mProperty_type, object->mProperty_name, object->mProperty_multiple, object->mProperty_descs.add_operation (inArgument_typeToMerge.getter_descs (SOURCE_FILE ("implementation_types.galgas", 574)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 574)), var_castTypeToMerge_15093.getter_ref (SOURCE_FILE ("implementation_types.galgas", 575))  COMMA_SOURCE_FILE ("implementation_types.galgas", 569)) ;
//---
  return result_mergedType ;
}
...
GALGAS_string function_valueList (const GALGAS_enumValues & constinArgument_values,
  ...
  GALGAS_string result_result ; // Returned variable
  result_result = GALGAS_string::makeEmptyString () ;
  cEnumerator_enumValues enumerator_16189 (constinArgument_values, kENUMERATION_UP) ;
  while (enumerator_16189.hasCurrentObject ()) {
    result_result.plusAssign_operation(enumerator_16189.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 603)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 603)) ;
    if (enumerator_16189.hasNextObject ()) {
      result_result.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 605)) ;
    }
...
static GALGAS_impType extensionGetter_impRangedType_mergeWithType (const cPtr_impType * inObject,
  ...
  if (inArgument_typeToMerge.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_impRangedType *> (inArgument_typeToMerge.ptr ())) {
      ...
      inCompiler->castError ("impRangedType", inArgument_typeToMerge.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("implementation_types.galgas", 617)) ;
    }
  }
  GALGAS_impRangedType var_castTypeToMerge_16463 = temp_0 ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    const GALGAS_impRangedType temp_2 = object ;
    test_1 = function_checkRanged (temp_2, var_castTypeToMerge_16463, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 618)).boolEnum () ;
    if (kBoolTrue == test_1) {
      result_mergedType = inArgument_typeToMerge ;
    }
  }
...
static GALGAS_impType extensionGetter_impBoolType_mergeWithType (const cPtr_impType * inObject,
  ...
  if (inArgument_typeToMerge.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_impBoolType *> (inArgument_typeToMerge.ptr ())) {
      ...
      inCompiler->castError ("impBoolType", inArgument_typeToMerge.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("implementation_types.galgas", 634)) ;
    }
  }
  GALGAS_impBoolType var_castTypeToMerge_16869 = temp_0 ;
  GALGAS_implementationObjectMap var_mergedTrueAttributes_16947 = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_types.galgas", 635)) ;
  GALGAS_implementationObjectMap var_mergedFalseAttributes_17008 = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_types.galgas", 636)) ;
  cEnumerator_implementationObjectMap enumerator_17050 (object->mProperty_trueSubAttributes, kENUMERATION_UP) ;
  while (enumerator_17050.hasCurrentObject ()) {
    GALGAS_impType var_mergedAttr_17077 = enumerator_17050.current_type (HERE) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = var_castTypeToMerge_16869.getter_trueSubAttributes (SOURCE_FILE ("implementation_types.galgas", 639)).getter_hasKey (enumerator_17050.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 639)) COMMA_SOURCE_FILE ("implementation_types.galgas", 639)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_impType var_subTypeToMerge_17234 ;
        var_castTypeToMerge_16869.getter_trueSubAttributes (SOURCE_FILE ("implementation_types.galgas", 640)).method_get (enumerator_17050.current_lkey (HERE), var_subTypeToMerge_17234, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 640)) ;
        var_mergedAttr_17077 = callExtensionGetter_mergeWithType ((const cPtr_impType *) enumerator_17050.current_type (HERE).ptr (), var_subTypeToMerge_17234, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 641)) ;
      }
    }
    {
    var_mergedTrueAttributes_16947.setter_put (enumerator_17050.current_lkey (HERE), var_mergedAttr_17077, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 643)) ;
    }
    enumerator_17050.gotoNextObject () ;
  }
  cEnumerator_implementationObjectMap enumerator_17443 (var_castTypeToMerge_16869.getter_trueSubAttributes (SOURCE_FILE ("implementation_types.galgas", 646)), kENUMERATION_UP) ;
  while (enumerator_17443.hasCurrentObject ()) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = object->mProperty_trueSubAttributes.getter_hasKey (enumerator_17443.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 647)) COMMA_SOURCE_FILE ("implementation_types.galgas", 647)).operator_not (SOURCE_FILE ("implementation_types.galgas", 647)).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        var_mergedTrueAttributes_16947.setter_put (enumerator_17443.current_lkey (HERE), enumerator_17443.current_type (HERE), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 648)) ;
        }
      }
    }
    enumerator_17443.gotoNextObject () ;
  }
  cEnumerator_implementationObjectMap enumerator_17599 (object->mProperty_falseSubAttributes, kENUMERATION_UP) ;
  while (enumerator_17599.hasCurrentObject ()) {
    GALGAS_impType var_mergedAttr_17626 = enumerator_17599.current_type (HERE) ;
    enumGalgasBool test_3 = kBoolTrue ;
    if (kBoolTrue == test_3) {
      test_3 = var_castTypeToMerge_16869.getter_falseSubAttributes (SOURCE_FILE ("implementation_types.galgas", 654)).getter_hasKey (enumerator_17599.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 654)) COMMA_SOURCE_FILE ("implementation_types.galgas", 654)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_impType var_subTypeToMerge_17785 ;
        var_castTypeToMerge_16869.getter_falseSubAttributes (SOURCE_FILE ("implementation_types.galgas", 655)).method_get (enumerator_17599.current_lkey (HERE), var_subTypeToMerge_17785, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 655)) ;
        var_mergedAttr_17626 = callExtensionGetter_mergeWithType ((const cPtr_impType *) enumerator_17599.current_type (HERE).ptr (), var_subTypeToMerge_17785, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 656)) ;
      }
    }
    {
    var_mergedFalseAttributes_17008.setter_put (enumerator_17599.current_lkey (HERE), var_mergedAttr_17626, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 658)) ;
    }
    enumerator_17599.gotoNextObject () ;
  }
  cEnumerator_implementationObjectMap enumerator_17996 (var_castTypeToMerge_16869.getter_falseSubAttributes (SOURCE_FILE ("implementation_types.galgas", 661)), kENUMERATION_UP) ;
  while (enumerator_17996.hasCurrentObject ()) {
    enumGalgasBool test_4 = kBoolTrue ;
    if (kBoolTrue == test_4) {
      test_4 = object->mProperty_falseSubAttributes.getter_hasKey (enumerator_17996.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 662)) COMMA_SOURCE_FILE ("implementation_types.galgas", 662)).operator_not (SOURCE_FILE ("implementation_types.galgas", 662)).boolEnum () ;
      if (kBoolTrue == test_4) {
        {
        var_mergedTrueAttributes_16947.setter_put (enumerator_17996.current_lkey (HERE), enumerator_17996.current_type (HERE), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 663)) ;
        }
      }
    }
    enumerator_17996.gotoNextObject () ;
  }
  result_mergedType = GALGAS_impBoolType::constructor_new (object->mProperty_locations.add_operation (inArgument_typeToMerge.getter_locations (SOURCE_FILE ("implementation_types.galgas", 668)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 668)), object->mProperty_type, object->mProperty_name, object->mProperty_multiple, object->mProperty_descs.add_operation (inArgument_typeToMerge.getter_descs (SOURCE_FILE ("implementation_types.galgas", 672)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 672)), object->mProperty_withAuto, var_castTypeToMerge_16869.getter_defaultValue (SOURCE_FILE ("implementation_types.galgas", 674)), var_mergedTrueAttributes_16947, var_mergedFalseAttributes_17008  COMMA_SOURCE_FILE ("implementation_types.galgas", 667)) ;
//---
  return result_mergedType ;
}
...
static void extensionMethod_impBoolType_setDefault (const cPtr_impAutoDefaultType * inObject,
  ...
  if (object->mProperty_defaultValue.isValid ()) {
    if (object->mProperty_defaultValue.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_void) {
      ...
      GALGAS_boolAttribute cast_18604_b ((cPtr_boolAttribute *) object->mProperty_defaultValue.ptr ()) ;
      enumGalgasBool test_0 = kBoolTrue ;
      if (kBoolTrue == test_0) {
        test_0 = ioArgument_attributes.getter_objectParams (SOURCE_FILE ("implementation_types.galgas", 688)).getter_hasKey (object->mProperty_name.getter_string (SOURCE_FILE ("implementation_types.galgas", 688)) COMMA_SOURCE_FILE ("implementation_types.galgas", 688)).boolEnum () ;
        if (kBoolTrue == test_0) {
          GALGAS_identifierMap var_userAttributes_18880 = ioArgument_attributes.getter_objectParams (SOURCE_FILE ("implementation_types.galgas", 691)) ;
          GALGAS_object_5F_t var_value_18932 ;
          var_userAttributes_18880.method_get (object->mProperty_name, var_value_18932, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 693)) ;
          if (var_value_18932.isValid ()) {
            if (var_value_18932.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_boolAttribute) {
              GALGAS_boolAttribute cast_19034_boolValue ((cPtr_boolAttribute *) var_value_18932.ptr ()) ;
              GALGAS_implementationObjectMap var_subImpAttributes_19088 ;
              enumGalgasBool test_1 = kBoolTrue ;
              if (kBoolTrue == test_1) {
                test_1 = cast_19034_boolValue.getter_value (SOURCE_FILE ("implementation_types.galgas", 697)).boolEnum () ;
                if (kBoolTrue == test_1) {
                  var_subImpAttributes_19088 = object->mProperty_trueSubAttributes ;
                }
              }
              if (kBoolFalse == test_1) {
                var_subImpAttributes_19088 = object->mProperty_falseSubAttributes ;
              }
              GALGAS_objectAttributes var_subAttributes_19294 = cast_19034_boolValue.getter_subAttributes (SOURCE_FILE ("implementation_types.galgas", 702)) ;
              {
              routine_setDefaultsForType (var_subImpAttributes_19088, var_subAttributes_19294, inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 703)) ;
              }
              GALGAS_boolAttribute var_bv_19449 = cast_19034_boolValue ;
              {
              var_bv_19449.setter_setSubAttributes (var_subAttributes_19294 COMMA_SOURCE_FILE ("implementation_types.galgas", 706)) ;
              }
              {
              var_userAttributes_18880.setter_setValueForKey (var_bv_19449, object->mProperty_name.getter_string (SOURCE_FILE ("implementation_types.galgas", 707)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 707)) ;
              }
              {
              ioArgument_attributes.setter_setObjectParams (var_userAttributes_18880 COMMA_SOURCE_FILE ("implementation_types.galgas", 708)) ;
              }
            }
          }
        }
      ...
      if (kBoolFalse == test_0) {
        GALGAS_implementationObjectMap var_subImpAttributes_19708 ;
        enumGalgasBool test_2 = kBoolTrue ;
        if (kBoolTrue == test_2) {
          test_2 = cast_18604_b.getter_value (SOURCE_FILE ("implementation_types.galgas", 712)).boolEnum () ;
          if (kBoolTrue == test_2) {
            var_subImpAttributes_19708 = object->mProperty_trueSubAttributes ;
          }
        }
        if (kBoolFalse == test_2) {
          var_subImpAttributes_19708 = object->mProperty_falseSubAttributes ;
        }
        GALGAS_objectAttributes var_subAttributes_19894 = function_emptyObject (inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 717)) ;
        {
        routine_setDefaultsForType (var_subImpAttributes_19708, var_subAttributes_19894, inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 718)) ;
        }
        GALGAS_boolAttribute var_defaults_20006 = GALGAS_boolAttribute::constructor_new (cast_18604_b.getter_oil_5F_desc (SOURCE_FILE ("implementation_types.galgas", 719)), cast_18604_b.getter_location (SOURCE_FILE ("implementation_types.galgas", 719)), cast_18604_b.getter_value (SOURCE_FILE ("implementation_types.galgas", 719)), var_subAttributes_19894  COMMA_SOURCE_FILE ("implementation_types.galgas", 719)) ;
        GALGAS_identifierMap var_attr_20113 = ioArgument_attributes.getter_objectParams (SOURCE_FILE ("implementation_types.galgas", 720)) ;
        {
        var_attr_20113.setter_put (object->mProperty_name, var_defaults_20006, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 721)) ;
        }
        {
        ioArgument_attributes.setter_setObjectParams (var_attr_20113 COMMA_SOURCE_FILE ("implementation_types.galgas", 722)) ;
        }
      }
    }
  }
...
static GALGAS_impType extensionGetter_impEnumType_mergeWithType (const cPtr_impType * inObject,
  ...
  if (inArgument_typeToMerge.isValid ()) {
    if (NULL != dynamic_cast <const cPtr_impEnumType *> (inArgument_typeToMerge.ptr ())) {
      ...
      inCompiler->castError ("impEnumType", inArgument_typeToMerge.ptr ()->classDescriptor () COMMA_SOURCE_FILE ("implementation_types.galgas", 757)) ;
    }
  }
  GALGAS_impEnumType var_castTypeToMerge_21055 = temp_0 ;
  result_mergedType = GALGAS_impEnumType::constructor_new (object->mProperty_locations.add_operation (inArgument_typeToMerge.getter_locations (SOURCE_FILE ("implementation_types.galgas", 759)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 759)), object->mProperty_type, object->mProperty_name, object->mProperty_multiple, object->mProperty_descs.add_operation (inArgument_typeToMerge.getter_descs (SOURCE_FILE ("implementation_types.galgas", 763)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 763)), object->mProperty_withAuto, var_castTypeToMerge_21055.getter_defaultValue (SOURCE_FILE ("implementation_types.galgas", 765)), extensionGetter_mergeWithEnum (object->mProperty_valuesMap, var_castTypeToMerge_21055.getter_valuesMap (SOURCE_FILE ("implementation_types.galgas", 766)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 766))  COMMA_SOURCE_FILE ("implementation_types.galgas", 758)) ;
//---
  return result_mergedType ;
}
...
void routine_verifyEnum (const GALGAS_impType constinArgument_anEnum,
  ...
  if (constinArgument_anEnum.isValid ()) {
    if (constinArgument_anEnum.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impEnumType) {
      GALGAS_impEnumType cast_21521_realEnum ((cPtr_impEnumType *) constinArgument_anEnum.ptr ()) ;
      if (cast_21521_realEnum.getter_defaultValue (SOURCE_FILE ("implementation_types.galgas", 778)).isValid ()) {
        if (cast_21521_realEnum.getter_defaultValue (SOURCE_FILE ("implementation_types.galgas", 778)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_string_5F_class) {
          GALGAS_string_5F_class cast_21595_defaultValue ((cPtr_string_5F_class *) cast_21521_realEnum.getter_defaultValue (SOURCE_FILE ("implementation_types.galgas", 778)).ptr ()) ;
          enumGalgasBool test_0 = kBoolTrue ;
          if (kBoolTrue == test_0) {
            test_0 = cast_21521_realEnum.getter_valuesMap (SOURCE_FILE ("implementation_types.galgas", 780)).getter_hasKey (cast_21595_defaultValue.getter_value (SOURCE_FILE ("implementation_types.galgas", 780)) COMMA_SOURCE_FILE ("implementation_types.galgas", 780)).operator_not (SOURCE_FILE ("implementation_types.galgas", 780)).boolEnum () ;
            if (kBoolTrue == test_0) {
              TC_Array <C_FixItDescription> fixItArray1 ;
              inCompiler->emitSemanticError (cast_21595_defaultValue.getter_location (SOURCE_FILE ("implementation_types.galgas", 781)), GALGAS_string ("Default enum value does not match any enum value"), fixItArray1  COMMA_SOURCE_FILE ("implementation_types.galgas", 781)) ;
            }
          }
        }
      }
    }else{
      cEnumerator_locationList enumerator_21820 (constinArgument_anEnum.getter_locations (SOURCE_FILE ("implementation_types.galgas", 785)), kENUMERATION_UP) ;
      while (enumerator_21820.hasCurrentObject ()) {
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (enumerator_21820.current_location (HERE), GALGAS_string ("Internal, not an @impEnumType"), fixItArray2  COMMA_SOURCE_FILE ("implementation_types.galgas", 786)) ;
...
GALGAS_object_5F_t function_checkAndGetIntegerNumber (const GALGAS_lstring & constinArgument_oil_5F_desc,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_33__32_Number (SOURCE_FILE ("implementation_types.galgas", 848)))).boolEnum () ;
        if (kBoolTrue == test_1) {
          result_value = GALGAS_sint_33__32__5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 849)), constinArgument_number.getter_uint_36__34_ (SOURCE_FILE ("implementation_types.galgas", 849)).getter_sint (inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 849)).multiply_operation (GALGAS_sint ((int32_t) 1L).operator_unary_minus (inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 849)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 849))  COMMA_SOURCE_FILE ("implementation_types.galgas", 849)) ;
        }
      }
      if (kBoolFalse == test_1) {
        enumGalgasBool test_2 = kBoolTrue ;
        if (kBoolTrue == test_2) {
          test_2 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 850)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            result_value = GALGAS_sint_36__34__5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 851)), constinArgument_number.getter_uint_36__34_ (SOURCE_FILE ("implementation_types.galgas", 851)).getter_sint_36__34_ (inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 851)).multiply_operation (GALGAS_sint_36__34_ ((int64_t) 1LL).operator_unary_minus (inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 851)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 851))  COMMA_SOURCE_FILE ("implementation_types.galgas", 851)) ;
          }
        }
        if (kBoolFalse == test_2) {
          result_value = GALGAS_void::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 853))  COMMA_SOURCE_FILE ("implementation_types.galgas", 853)) ;
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 854)), extensionGetter_oilType (constinArgument_type, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 854)).add_operation (GALGAS_string (" expected, got a SINT"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 854)), fixItArray3  COMMA_SOURCE_FILE ("implementation_types.galgas", 854)) ;
        }
      }
    }
  }
  if (kBoolFalse == test_0) {
    enumGalgasBool test_4 = kBoolTrue ;
    if (kBoolTrue == test_4) {
      test_4 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_33__32_Number (SOURCE_FILE ("implementation_types.galgas", 857)))).boolEnum () ;
      if (kBoolTrue == test_4) {
        result_value = GALGAS_sint_33__32__5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 858)), constinArgument_number.getter_uint_36__34_ (SOURCE_FILE ("implementation_types.galgas", 858)).getter_sint (inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 858))  COMMA_SOURCE_FILE ("implementation_types.galgas", 858)) ;
      }
    }
    if (kBoolFalse == test_4) {
      enumGalgasBool test_5 = kBoolTrue ;
      if (kBoolTrue == test_5) {
        test_5 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_sint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 859)))).boolEnum () ;
        if (kBoolTrue == test_5) {
          result_value = GALGAS_sint_36__34__5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 860)), constinArgument_number.getter_uint_36__34_ (SOURCE_FILE ("implementation_types.galgas", 860)).getter_sint_36__34_ (inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 860))  COMMA_SOURCE_FILE ("implementation_types.galgas", 860)) ;
        }
      }
      if (kBoolFalse == test_5) {
        enumGalgasBool test_6 = kBoolTrue ;
        if (kBoolTrue == test_6) {
          test_6 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE ("implementation_types.galgas", 861)))).boolEnum () ;
          if (kBoolTrue == test_6) {
            result_value = GALGAS_uint_33__32__5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 862)), constinArgument_number.getter_uint_36__34_ (SOURCE_FILE ("implementation_types.galgas", 862)).getter_uint (inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 862))  COMMA_SOURCE_FILE ("implementation_types.galgas", 862)) ;
          }
        }
        if (kBoolFalse == test_6) {
          enumGalgasBool test_7 = kBoolTrue ;
          if (kBoolTrue == test_7) {
            test_7 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 863)))).boolEnum () ;
            if (kBoolTrue == test_7) {
              result_value = GALGAS_uint_36__34__5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 864)), constinArgument_number.getter_uint_36__34_ (SOURCE_FILE ("implementation_types.galgas", 864))  COMMA_SOURCE_FILE ("implementation_types.galgas", 864)) ;
            }
          }
          if (kBoolFalse == test_7) {
            result_value = GALGAS_void::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 866))  COMMA_SOURCE_FILE ("implementation_types.galgas", 866)) ;
            TC_Array <C_FixItDescription> fixItArray8 ;
            inCompiler->emitSemanticError (constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 867)), extensionGetter_oilType (constinArgument_type, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 867)).add_operation (GALGAS_string (" expected, got a UINT"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 867)), fixItArray8  COMMA_SOURCE_FILE ("implementation_types.galgas", 867)) ;
          }
        }
      }
    }
...
GALGAS_object_5F_t function_checkAndGetFloatNumber (const GALGAS_lstring & constinArgument_oil_5F_desc,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_floatNumber (SOURCE_FILE ("implementation_types.galgas", 879)))).boolEnum () ;
        if (kBoolTrue == test_1) {
          result_value = GALGAS_float_5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 880)), constinArgument_number.getter_double (SOURCE_FILE ("implementation_types.galgas", 880)).multiply_operation (GALGAS_double (1).operator_unary_minus (inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 880)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 880))  COMMA_SOURCE_FILE ("implementation_types.galgas", 880)) ;
        }
      }
      if (kBoolFalse == test_1) {
        result_value = GALGAS_void::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 882))  COMMA_SOURCE_FILE ("implementation_types.galgas", 882)) ;
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 883)), extensionGetter_oilType (constinArgument_type, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 883)).add_operation (GALGAS_string (" expected, got a FLOAT"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 883)), fixItArray2  COMMA_SOURCE_FILE ("implementation_types.galgas", 883)) ;
      }
    }
  }
  if (kBoolFalse == test_0) {
    enumGalgasBool test_3 = kBoolTrue ;
    if (kBoolTrue == test_3) {
      test_3 = GALGAS_bool (kIsEqual, constinArgument_type.objectCompare (GALGAS_dataType::constructor_floatNumber (SOURCE_FILE ("implementation_types.galgas", 886)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        result_value = GALGAS_float_5F_class::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 887)), constinArgument_number.getter_double (SOURCE_FILE ("implementation_types.galgas", 887))  COMMA_SOURCE_FILE ("implementation_types.galgas", 887)) ;
      }
    }
    if (kBoolFalse == test_3) {
      result_value = GALGAS_void::constructor_new (constinArgument_oil_5F_desc, constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 889))  COMMA_SOURCE_FILE ("implementation_types.galgas", 889)) ;
      TC_Array <C_FixItDescription> fixItArray4 ;
      inCompiler->emitSemanticError (constinArgument_number.getter_location (SOURCE_FILE ("implementation_types.galgas", 890)), extensionGetter_oilType (constinArgument_type, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 890)).add_operation (GALGAS_string (" expected, got a FLOAT"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 890)), fixItArray4  COMMA_SOURCE_FILE ("implementation_types.galgas", 890)) ;
    }
  }
//---
  return result_value ;
...
void routine_checkTypeForAttribute (const GALGAS_implementationObjectMap constinArgument_obj,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = constinArgument_obj.getter_hasKey (constinArgument_attributeName COMMA_SOURCE_FILE ("implementation_types.galgas", 899)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_impType var_type_25205 ;
      constinArgument_obj.method_get (function_lstringWith (constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 901)), var_type_25205, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 901)) ;
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = GALGAS_bool (kIsNotEqual, var_type_25205.getter_type (SOURCE_FILE ("implementation_types.galgas", 902)).objectCompare (constinArgument_expectedType)).boolEnum () ;
        if (kBoolTrue == test_1) {
          cEnumerator_locationList enumerator_25327 (var_type_25205.getter_locations (SOURCE_FILE ("implementation_types.galgas", 903)), kENUMERATION_UP) ;
          while (enumerator_25327.hasCurrentObject ()) {
            TC_Array <C_FixItDescription> fixItArray2 ;
            inCompiler->emitSemanticError (enumerator_25327.current_location (HERE), constinArgument_attributeName.add_operation (GALGAS_string (" is a "), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 904)).add_operation (extensionGetter_oilType (var_type_25205.getter_type (SOURCE_FILE ("implementation_types.galgas", 904)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 904)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 904)), fixItArray2  COMMA_SOURCE_FILE ("implementation_types.galgas", 904)) ;
            TC_Array <C_FixItDescription> fixItArray3 ;
            inCompiler->emitSemanticError (enumerator_25327.current_location (HERE), constinArgument_attributeName.add_operation (GALGAS_string (" should be a "), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 905)).add_operation (extensionGetter_oilType (constinArgument_expectedType, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 905)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 905)), fixItArray3  COMMA_SOURCE_FILE ("implementation_types.galgas", 905)) ;
...
GALGAS_implementationObjectMap function_boolSubAttributes (const GALGAS_implementationObject & constinArgument_obj,
  ...
  result_subImplementation = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_types.galgas", 916)) ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = constinArgument_obj.getter_attributes (SOURCE_FILE ("implementation_types.galgas", 917)).getter_hasKey (constinArgument_attributeName COMMA_SOURCE_FILE ("implementation_types.galgas", 917)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_impType var_type_25786 ;
      constinArgument_obj.getter_attributes (SOURCE_FILE ("implementation_types.galgas", 919)).method_get (function_lstringWith (constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 919)), var_type_25786, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 919)) ;
      if (var_type_25786.isValid ()) {
        if (var_type_25786.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impBoolType) {
          GALGAS_impBoolType cast_25896_boolType ((cPtr_impBoolType *) var_type_25786.ptr ()) ;
          enumGalgasBool test_1 = kBoolTrue ;
          if (kBoolTrue == test_1) {
            test_1 = constinArgument_boolValue.boolEnum () ;
            if (kBoolTrue == test_1) {
              result_subImplementation = cast_25896_boolType.getter_trueSubAttributes (SOURCE_FILE ("implementation_types.galgas", 923)) ;
            }
          }
          if (kBoolFalse == test_1) {
            result_subImplementation = cast_25896_boolType.getter_falseSubAttributes (SOURCE_FILE ("implementation_types.galgas", 925)) ;
          }
        }
      }
    }
...
GALGAS_implementationObjectMap function_enumSubAttributes (const GALGAS_implementationObject & constinArgument_obj,
                                                           ...
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_implementationObjectMap result_subImplementation ; // Returned variable
  result_subImplementation = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_types.galgas", 936)) ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = constinArgument_obj.getter_attributes (SOURCE_FILE ("implementation_types.galgas", 937)).getter_hasKey (constinArgument_attributeName COMMA_SOURCE_FILE ("implementation_types.galgas", 937)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_impType var_type_26365 ;
      constinArgument_obj.getter_attributes (SOURCE_FILE ("implementation_types.galgas", 939)).method_get (function_lstringWith (constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 939)), var_type_26365, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 939)) ;
      if (var_type_26365.isValid ()) {
        if (var_type_26365.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impEnumType) {
          GALGAS_impEnumType cast_26475_enumType ((cPtr_impEnumType *) var_type_26365.ptr ()) ;
          enumGalgasBool test_1 = kBoolTrue ;
          if (kBoolTrue == test_1) {
            test_1 = cast_26475_enumType.getter_valuesMap (SOURCE_FILE ("implementation_types.galgas", 942)).getter_hasKey (constinArgument_enumValue COMMA_SOURCE_FILE ("implementation_types.galgas", 942)).boolEnum () ;
            if (kBoolTrue == test_1) {
              cast_26475_enumType.getter_valuesMap (SOURCE_FILE ("implementation_types.galgas", 943)).method_get (function_lstringWith (constinArgument_enumValue, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 943)), result_subImplementation, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 943)) ;
            }
          }
        }
      }
...
void routine_checkFilters (const GALGAS_implementationObject constinArgument_messageProperty,
                           C_Compiler * inCompiler
                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_implementationObjectMap var_filter_26761 = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("MASKEDNEWEQUALSX"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 954)) ;
  {
  routine_checkTypeForAttribute (var_filter_26761, GALGAS_string ("MASK"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 955)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 955)) ;
  }
  {
  routine_checkTypeForAttribute (var_filter_26761, GALGAS_string ("X"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 956)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 956)) ;
  }
  var_filter_26761 = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("MASKEDNEWDIFFERSX"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 957)) ;
  {
  routine_checkTypeForAttribute (var_filter_26761, GALGAS_string ("MASK"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 958)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 958)) ;
  }
  {
  routine_checkTypeForAttribute (var_filter_26761, GALGAS_string ("X"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 959)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 959)) ;
  }
  var_filter_26761 = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("MASKEDNEWEQUALSMASKEDOLD"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 960)) ;
  {
  routine_checkTypeForAttribute (var_filter_26761, GALGAS_string ("MASK"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 961)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 961)) ;
  }
  var_filter_26761 = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("NEWISWITHIN"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 962)) ;
  {
  routine_checkTypeForAttribute (var_filter_26761, GALGAS_string ("MIN"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 963)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 963)) ;
  }
  {
  routine_checkTypeForAttribute (var_filter_26761, GALGAS_string ("MAX"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 964)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 964)) ;
  }
  var_filter_26761 = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("NEWISOUTSIDE"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 965)) ;
  {
  routine_checkTypeForAttribute (var_filter_26761, GALGAS_string ("MIN"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 966)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 966)) ;
  }
  {
  routine_checkTypeForAttribute (var_filter_26761, GALGAS_string ("MAX"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 967)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 967)) ;
  }
  var_filter_26761 = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("ONEEVERYN"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 968)) ;
  {
  routine_checkTypeForAttribute (var_filter_26761, GALGAS_string ("PERIOD"), GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE ("implementation_types.galgas", 969)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 969)) ;
  }
  {
  routine_checkTypeForAttribute (var_filter_26761, GALGAS_string ("OFFSET"), GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE ("implementation_types.galgas", 970)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 970)) ;
  }
}
...
static void extensionMethod_refType_checkAttributeReferences (const cPtr_impType * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = callExtensionGetter_hasKey ((const cPtr_implementation *) constinArgument_imp.ptr (), object->mProperty_ref.getter_string (SOURCE_FILE ("implementation_types.galgas", 985)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 985)).operator_not (SOURCE_FILE ("implementation_types.galgas", 985)).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (object->mProperty_ref.getter_location (SOURCE_FILE ("implementation_types.galgas", 986)), object->mProperty_ref.getter_string (SOURCE_FILE ("implementation_types.galgas", 986)).add_operation (GALGAS_string (" object kind does not exist"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 986)), fixItArray1  COMMA_SOURCE_FILE ("implementation_types.galgas", 986)) ;
    }
  }
}
...
static void extensionMethod_impBoolType_checkAttributeReferences (const cPtr_impType * inObject,
  ...
  const cPtr_impBoolType * object = (const cPtr_impBoolType *) inObject ;
  macroValidSharedObject (object, cPtr_impBoolType) ;
  cEnumerator_implementationObjectMap enumerator_28651 (object->mProperty_trueSubAttributes, kENUMERATION_UP) ;
  while (enumerator_28651.hasCurrentObject ()) {
    callExtensionMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_28651.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 994)) ;
    enumerator_28651.gotoNextObject () ;
  }
  cEnumerator_implementationObjectMap enumerator_28734 (object->mProperty_falseSubAttributes, kENUMERATION_UP) ;
  while (enumerator_28734.hasCurrentObject ()) {
    callExtensionMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_28734.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 997)) ;
    enumerator_28734.gotoNextObject () ;
  }
}
...
static void extensionMethod_impEnumType_checkAttributeReferences (const cPtr_impType * inObject,
  ...
  const cPtr_impEnumType * object = (const cPtr_impEnumType *) inObject ;
  macroValidSharedObject (object, cPtr_impEnumType) ;
  cEnumerator_enumValues enumerator_28894 (object->mProperty_valuesMap, kENUMERATION_UP) ;
  while (enumerator_28894.hasCurrentObject ()) {
    cEnumerator_implementationObjectMap enumerator_28926 (enumerator_28894.current_subAttributes (HERE), kENUMERATION_UP) ;
    while (enumerator_28926.hasCurrentObject ()) {
      callExtensionMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_28926.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1006)) ;
      enumerator_28926.gotoNextObject () ;
    }
    enumerator_28894.gotoNextObject () ;
  }
}
...
void routine_setDefaultsForType (const GALGAS_implementationObjectMap constinArgument_impObject,
                                 ...
                                 C_Compiler * inCompiler
                                 COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_implementationObjectMap enumerator_29118 (constinArgument_impObject, kENUMERATION_UP) ;
  while (enumerator_29118.hasCurrentObject ()) {
    if (enumerator_29118.current_type (HERE).isValid ()) {
      if (NULL != dynamic_cast <const cPtr_impAutoDefaultType *> (enumerator_29118.current_type (HERE).ptr ())) {
        GALGAS_impAutoDefaultType cast_29179_defaultType ((cPtr_impAutoDefaultType *) enumerator_29118.current_type (HERE).ptr ()) ;
        callExtensionMethod_setDefault ((const cPtr_impAutoDefaultType *) cast_29179_defaultType.ptr (), ioArgument_objectParams, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1018)) ;
      }
    }
...
static GALGAS_bool extensionGetter_uint_33__32_AttributeSet_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_33__32__5F_class) {
      GALGAS_uint_33__32__5F_class cast_31550_intVal ((cPtr_uint_33__32__5F_class *) constinArgument_obj.ptr ()) ;
      result_isInside = GALGAS_bool (false) ;
      cEnumerator_uint_33__32_List enumerator_31596 (object->mProperty_valueList, kENUMERATION_UP) ;
      while (enumerator_31596.hasCurrentObject ()) {
        result_isInside = result_isInside.operator_or (GALGAS_bool (kIsEqual, enumerator_31596.current_value (HERE).objectCompare (cast_31550_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1106)))) COMMA_SOURCE_FILE ("implementation_types.galgas", 1106)) ;
        enumerator_31596.gotoNextObject () ;
      }
    }else{
      result_isInside = GALGAS_bool (false) ;
      TC_Array <C_FixItDescription> fixItArray0 ;
      inCompiler->emitSemanticError (constinArgument_obj.getter_location (SOURCE_FILE ("implementation_types.galgas", 1110)), GALGAS_string ("UINT32 expected"), fixItArray0  COMMA_SOURCE_FILE ("implementation_types.galgas", 1110)) ;
    }
  }
//---
  return result_isInside ;
...
static GALGAS_string extensionGetter_uint_33__32_AttributeSet_string (const cPtr_attributeRange * inObject,
  ...
  cEnumerator_uint_33__32_List enumerator_31825 (object->mProperty_valueList, kENUMERATION_UP) ;
  while (enumerator_31825.hasCurrentObject ()) {
    result_desc.plusAssign_operation(enumerator_31825.current_value (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 1118)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1118)) ;
    if (enumerator_31825.hasNextObject ()) {
      result_desc.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1120)) ;
    }
...
static GALGAS_bool extensionGetter_uint_33__32_AttributeMinMax_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_33__32__5F_class) {
      GALGAS_uint_33__32__5F_class cast_32026_intVal ((cPtr_uint_33__32__5F_class *) constinArgument_obj.ptr ()) ;
      GALGAS_bool test_0 = GALGAS_bool (kIsInfOrEqual, object->mProperty_min.objectCompare (cast_32026_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1130)))) ;
      if (kBoolTrue == test_0.boolEnum ()) {
        test_0 = GALGAS_bool (kIsInfOrEqual, cast_32026_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1130)).objectCompare (object->mProperty_max)) ;
      }
      result_isInside = test_0 ;
    }else{
      result_isInside = GALGAS_bool (false) ;
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_obj.getter_location (SOURCE_FILE ("implementation_types.galgas", 1133)), GALGAS_string ("UINT32 expected"), fixItArray1  COMMA_SOURCE_FILE ("implementation_types.galgas", 1133)) ;
    }
  }
//---
  return result_isInside ;
...
static GALGAS_string extensionGetter_uint_33__32_AttributeMinMax_string (const cPtr_attributeRange * inObject,
  ...
  const cPtr_uint_33__32_AttributeMinMax * object = (const cPtr_uint_33__32_AttributeMinMax *) inObject ;
  macroValidSharedObject (object, cPtr_uint_33__32_AttributeMinMax) ;
  result_desc = object->mProperty_min.getter_string (SOURCE_FILE ("implementation_types.galgas", 1139)).add_operation (GALGAS_string (".."), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1139)).add_operation (object->mProperty_max.getter_string (SOURCE_FILE ("implementation_types.galgas", 1139)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1139)) ;
//---
  return result_desc ;
}
...
static GALGAS_bool extensionGetter_sint_33__32_AttributeSet_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_33__32__5F_class) {
      GALGAS_sint_33__32__5F_class cast_32401_intVal ((cPtr_sint_33__32__5F_class *) constinArgument_obj.ptr ()) ;
      result_isInside = GALGAS_bool (true) ;
      cEnumerator_sint_33__32_List enumerator_32446 (object->mProperty_valueList, kENUMERATION_UP) ;
      while (enumerator_32446.hasCurrentObject ()) {
        result_isInside = result_isInside.operator_and (GALGAS_bool (kIsEqual, enumerator_32446.current_value (HERE).objectCompare (cast_32401_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1150)))) COMMA_SOURCE_FILE ("implementation_types.galgas", 1150)) ;
        enumerator_32446.gotoNextObject () ;
      }
    }else{
      result_isInside = GALGAS_bool (false) ;
      TC_Array <C_FixItDescription> fixItArray0 ;
      inCompiler->emitSemanticError (constinArgument_obj.getter_location (SOURCE_FILE ("implementation_types.galgas", 1154)), GALGAS_string ("SINT32 expected"), fixItArray0  COMMA_SOURCE_FILE ("implementation_types.galgas", 1154)) ;
    }
  }
//---
  return result_isInside ;
...
static GALGAS_string extensionGetter_sint_33__32_AttributeSet_string (const cPtr_attributeRange * inObject,
  ...
  macroValidSharedObject (object, cPtr_sint_33__32_AttributeSet) ;
  result_desc = GALGAS_string::makeEmptyString () ;
  cEnumerator_sint_33__32_List enumerator_32675 (object->mProperty_valueList, kENUMERATION_UP) ;
  while (enumerator_32675.hasCurrentObject ()) {
    result_desc.plusAssign_operation(enumerator_32675.current_value (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 1162)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1162)) ;
    if (enumerator_32675.hasNextObject ()) {
      result_desc.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1164)) ;
    }
...
static GALGAS_bool extensionGetter_sint_33__32_AttributeMinMax_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_33__32__5F_class) {
      GALGAS_sint_33__32__5F_class cast_32876_intVal ((cPtr_sint_33__32__5F_class *) constinArgument_obj.ptr ()) ;
      GALGAS_bool test_0 = GALGAS_bool (kIsInfOrEqual, object->mProperty_min.objectCompare (cast_32876_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1174)))) ;
      if (kBoolTrue == test_0.boolEnum ()) {
        test_0 = GALGAS_bool (kIsInfOrEqual, cast_32876_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1174)).objectCompare (object->mProperty_max)) ;
      }
      result_isInside = test_0 ;
    }else{
      result_isInside = GALGAS_bool (false) ;
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_obj.getter_location (SOURCE_FILE ("implementation_types.galgas", 1177)), GALGAS_string ("SINT32 expected"), fixItArray1  COMMA_SOURCE_FILE ("implementation_types.galgas", 1177)) ;
    }
  }
//---
  return result_isInside ;
...
static GALGAS_string extensionGetter_sint_33__32_AttributeMinMax_string (const cPtr_attributeRange * inObject,
  ...
  const cPtr_sint_33__32_AttributeMinMax * object = (const cPtr_sint_33__32_AttributeMinMax *) inObject ;
  macroValidSharedObject (object, cPtr_sint_33__32_AttributeMinMax) ;
  result_desc = object->mProperty_min.getter_string (SOURCE_FILE ("implementation_types.galgas", 1183)).add_operation (GALGAS_string (".."), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1183)).add_operation (object->mProperty_max.getter_string (SOURCE_FILE ("implementation_types.galgas", 1183)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1183)) ;
//---
  return result_desc ;
}
...
static GALGAS_bool extensionGetter_uint_36__34_AttributeSet_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_36__34__5F_class) {
      GALGAS_uint_36__34__5F_class cast_33251_intVal ((cPtr_uint_36__34__5F_class *) constinArgument_obj.ptr ()) ;
      result_isInside = GALGAS_bool (true) ;
      cEnumerator_uint_36__34_List enumerator_33296 (object->mProperty_valueList, kENUMERATION_UP) ;
      while (enumerator_33296.hasCurrentObject ()) {
        result_isInside = result_isInside.operator_and (GALGAS_bool (kIsEqual, enumerator_33296.current_value (HERE).objectCompare (cast_33251_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1194)))) COMMA_SOURCE_FILE ("implementation_types.galgas", 1194)) ;
        enumerator_33296.gotoNextObject () ;
      }
    }else{
      result_isInside = GALGAS_bool (false) ;
      TC_Array <C_FixItDescription> fixItArray0 ;
      inCompiler->emitSemanticError (constinArgument_obj.getter_location (SOURCE_FILE ("implementation_types.galgas", 1198)), GALGAS_string ("UINT64 expected"), fixItArray0  COMMA_SOURCE_FILE ("implementation_types.galgas", 1198)) ;
    }
  }
//---
  return result_isInside ;
...
static GALGAS_string extensionGetter_uint_36__34_AttributeSet_string (const cPtr_attributeRange * inObject,
  ...
  macroValidSharedObject (object, cPtr_uint_36__34_AttributeSet) ;
  result_desc = GALGAS_string::makeEmptyString () ;
  cEnumerator_uint_36__34_List enumerator_33525 (object->mProperty_valueList, kENUMERATION_UP) ;
  while (enumerator_33525.hasCurrentObject ()) {
    result_desc.plusAssign_operation(enumerator_33525.current_value (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 1206)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1206)) ;
    if (enumerator_33525.hasNextObject ()) {
      result_desc.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1208)) ;
    }
...
static GALGAS_bool extensionGetter_uint_36__34_AttributeMinMax_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_36__34__5F_class) {
      GALGAS_uint_36__34__5F_class cast_33726_intVal ((cPtr_uint_36__34__5F_class *) constinArgument_obj.ptr ()) ;
      GALGAS_bool test_0 = GALGAS_bool (kIsInfOrEqual, object->mProperty_min.objectCompare (cast_33726_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1218)))) ;
      if (kBoolTrue == test_0.boolEnum ()) {
        test_0 = GALGAS_bool (kIsInfOrEqual, cast_33726_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1218)).objectCompare (object->mProperty_max)) ;
      }
      result_isInside = test_0 ;
    }else{
      result_isInside = GALGAS_bool (false) ;
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_obj.getter_location (SOURCE_FILE ("implementation_types.galgas", 1221)), GALGAS_string ("UINT64 expected"), fixItArray1  COMMA_SOURCE_FILE ("implementation_types.galgas", 1221)) ;
    }
  }
//---
  return result_isInside ;
...
static GALGAS_string extensionGetter_uint_36__34_AttributeMinMax_string (const cPtr_attributeRange * inObject,
  ...
  const cPtr_uint_36__34_AttributeMinMax * object = (const cPtr_uint_36__34_AttributeMinMax *) inObject ;
  macroValidSharedObject (object, cPtr_uint_36__34_AttributeMinMax) ;
  result_desc = object->mProperty_min.getter_string (SOURCE_FILE ("implementation_types.galgas", 1227)).add_operation (GALGAS_string (".."), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1227)).add_operation (object->mProperty_max.getter_string (SOURCE_FILE ("implementation_types.galgas", 1227)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1227)) ;
//---
  return result_desc ;
}
...
static GALGAS_bool extensionGetter_sint_36__34_AttributeSet_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_36__34__5F_class) {
      GALGAS_sint_36__34__5F_class cast_34101_intVal ((cPtr_sint_36__34__5F_class *) constinArgument_obj.ptr ()) ;
      result_isInside = GALGAS_bool (true) ;
      cEnumerator_sint_36__34_List enumerator_34146 (object->mProperty_valueList, kENUMERATION_UP) ;
      while (enumerator_34146.hasCurrentObject ()) {
        result_isInside = result_isInside.operator_and (GALGAS_bool (kIsEqual, enumerator_34146.current_value (HERE).objectCompare (cast_34101_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1238)))) COMMA_SOURCE_FILE ("implementation_types.galgas", 1238)) ;
        enumerator_34146.gotoNextObject () ;
      }
    }else{
      result_isInside = GALGAS_bool (false) ;
      TC_Array <C_FixItDescription> fixItArray0 ;
      inCompiler->emitSemanticError (constinArgument_obj.getter_location (SOURCE_FILE ("implementation_types.galgas", 1242)), GALGAS_string ("SINT64 expected"), fixItArray0  COMMA_SOURCE_FILE ("implementation_types.galgas", 1242)) ;
    }
  }
//---
  return result_isInside ;
...
static GALGAS_string extensionGetter_sint_36__34_AttributeSet_string (const cPtr_attributeRange * inObject,
  ...
  macroValidSharedObject (object, cPtr_sint_36__34_AttributeSet) ;
  result_desc = GALGAS_string::makeEmptyString () ;
  cEnumerator_sint_36__34_List enumerator_34375 (object->mProperty_valueList, kENUMERATION_UP) ;
  while (enumerator_34375.hasCurrentObject ()) {
    result_desc.plusAssign_operation(enumerator_34375.current_value (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 1250)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1250)) ;
    if (enumerator_34375.hasNextObject ()) {
      result_desc.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1252)) ;
    }
    enumerator_34375.gotoNextObject () ;
  }
//---
  return result_desc ;
}
...
static GALGAS_bool extensionGetter_sint_36__34_AttributeMinMax_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_36__34__5F_class) {
      GALGAS_sint_36__34__5F_class cast_34577_intVal ((cPtr_sint_36__34__5F_class *) constinArgument_obj.ptr ()) ;
      GALGAS_bool test_0 = GALGAS_bool (kIsInfOrEqual, object->mProperty_min.objectCompare (cast_34577_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1263)))) ;
      if (kBoolTrue == test_0.boolEnum ()) {
        test_0 = GALGAS_bool (kIsInfOrEqual, cast_34577_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1263)).objectCompare (object->mProperty_max)) ;
      }
      result_isInside = test_0 ;
    }else{
      result_isInside = GALGAS_bool (false) ;
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_obj.getter_location (SOURCE_FILE ("implementation_types.galgas", 1266)), GALGAS_string ("SINT64 expected"), fixItArray1  COMMA_SOURCE_FILE ("implementation_types.galgas", 1266)) ;
    }
  }
//---
  return result_isInside ;
...
static GALGAS_string extensionGetter_sint_36__34_AttributeMinMax_string (const cPtr_attributeRange * inObject,
  ...
  const cPtr_sint_36__34_AttributeMinMax * object = (const cPtr_sint_36__34_AttributeMinMax *) inObject ;
  macroValidSharedObject (object, cPtr_sint_36__34_AttributeMinMax) ;
  result_desc = object->mProperty_min.getter_string (SOURCE_FILE ("implementation_types.galgas", 1272)).add_operation (GALGAS_string (".."), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1272)).add_operation (object->mProperty_max.getter_string (SOURCE_FILE ("implementation_types.galgas", 1272)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1272)) ;
//---
  return result_desc ;
}
...
static GALGAS_bool extensionGetter_floatAttributeSet_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_float_5F_class) {
      GALGAS_float_5F_class cast_34950_intVal ((cPtr_float_5F_class *) constinArgument_obj.ptr ()) ;
      result_isInside = GALGAS_bool (true) ;
      cEnumerator_floatList enumerator_34995 (object->mProperty_valueList, kENUMERATION_UP) ;
      while (enumerator_34995.hasCurrentObject ()) {
        result_isInside = result_isInside.operator_and (GALGAS_bool (kIsEqual, enumerator_34995.current_value (HERE).objectCompare (cast_34950_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1283)))) COMMA_SOURCE_FILE ("implementation_types.galgas", 1283)) ;
        enumerator_34995.gotoNextObject () ;
      }
    }else{
      result_isInside = GALGAS_bool (false) ;
      TC_Array <C_FixItDescription> fixItArray0 ;
      inCompiler->emitSemanticError (constinArgument_obj.getter_location (SOURCE_FILE ("implementation_types.galgas", 1287)), GALGAS_string ("FLOAT expected"), fixItArray0  COMMA_SOURCE_FILE ("implementation_types.galgas", 1287)) ;
    }
  }
//---
  return result_isInside ;
...
static GALGAS_string extensionGetter_floatAttributeSet_string (const cPtr_attributeRange * inObject,
  ...
  macroValidSharedObject (object, cPtr_floatAttributeSet) ;
  result_desc = GALGAS_string::makeEmptyString () ;
  cEnumerator_floatList enumerator_35222 (object->mProperty_valueList, kENUMERATION_UP) ;
  while (enumerator_35222.hasCurrentObject ()) {
    result_desc.plusAssign_operation(enumerator_35222.current_value (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 1295)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1295)) ;
    if (enumerator_35222.hasNextObject ()) {
      result_desc.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1297)) ;
    }
    enumerator_35222.gotoNextObject () ;
  }
//---
  return result_desc ;
}
...
static GALGAS_bool extensionGetter_floatAttributeMinMax_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_float_5F_class) {
      GALGAS_float_5F_class cast_35421_intVal ((cPtr_float_5F_class *) constinArgument_obj.ptr ()) ;
      GALGAS_bool test_0 = GALGAS_bool (kIsInfOrEqual, object->mProperty_min.objectCompare (cast_35421_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1307)))) ;
      if (kBoolTrue == test_0.boolEnum ()) {
        test_0 = GALGAS_bool (kIsInfOrEqual, cast_35421_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1307)).objectCompare (object->mProperty_max)) ;
      }
      result_isInside = test_0 ;
    }else{
      result_isInside = GALGAS_bool (false) ;
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_obj.getter_location (SOURCE_FILE ("implementation_types.galgas", 1310)), GALGAS_string ("FLOAT expected"), fixItArray1  COMMA_SOURCE_FILE ("implementation_types.galgas", 1310)) ;
    }
  }
//---
  return result_isInside ;
...
static GALGAS_string extensionGetter_floatAttributeMinMax_string (const cPtr_attributeRange * inObject,
  ...
  const cPtr_floatAttributeMinMax * object = (const cPtr_floatAttributeMinMax *) inObject ;
  macroValidSharedObject (object, cPtr_floatAttributeMinMax) ;
  result_desc = object->mProperty_min.getter_string (SOURCE_FILE ("implementation_types.galgas", 1316)).add_operation (GALGAS_string (".."), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1316)).add_operation (object->mProperty_max.getter_string (SOURCE_FILE ("implementation_types.galgas", 1316)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1316)) ;
//---
  return result_desc ;
}
