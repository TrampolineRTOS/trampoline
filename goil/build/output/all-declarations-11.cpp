...
static void extensionMethod_gtlWatchpointDeleteAllInstruction_execute (const cPtr_gtlInstruction * /* inObject */,
  ...
  cPtr_gtlContext * ptr_52229 = (cPtr_gtlContext *) ioArgument_context.ptr () ;
  callExtensionSetter_deleteAllWatchpoints ((cPtr_gtlContext *) ptr_52229, inCompiler COMMA_SOURCE_FILE ("gtl_debugger.galgas", 1780)) ;
  }
}
...
void routine_multiError (GALGAS_locationList inArgument_locations,
                         ...
                         C_Compiler * inCompiler
                         COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_locationList enumerator_14834 (inArgument_locations, kENUMERATION_UP) ;
  while (enumerator_14834.hasCurrentObject ()) {
    TC_Array <C_FixItDescription> fixItArray0 ;
    inCompiler->emitSemanticError (enumerator_14834.current_location (HERE), inArgument_errorMessage, fixItArray0  COMMA_SOURCE_FILE ("implementation_types.galgas", 545)) ;
...
static GALGAS_impType extensionGetter_refType_mergeWithType (const cPtr_impType * inObject,
  ...
  GALGAS_refType var_castTypeToMerge_15067 = temp_0 ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = GALGAS_bool (kIsNotEqual, object->mProperty_ref.getter_string (SOURCE_FILE ("implementation_types.galgas", 558)).objectCompare (var_castTypeToMerge_15067.getter_ref (SOURCE_FILE ("implementation_types.galgas", 558)).getter_string (SOURCE_FILE ("implementation_types.galgas", 558)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      object->mProperty_ref.log ("ref"  COMMA_SOURCE_FILE ("implementation_types.galgas", 559)) ;
      GALGAS_lstring var_csatRef_15183 = var_castTypeToMerge_15067.getter_ref (SOURCE_FILE ("implementation_types.galgas", 560)) ;
      var_csatRef_15183.log ("csatRef"  COMMA_SOURCE_FILE ("implementation_types.galgas", 561)) ;
      {
...
GALGAS_string function_valueList (const GALGAS_enumValues & constinArgument_values,
  ...
  GALGAS_string result_result ; // Returned variable
  result_result = GALGAS_string::makeEmptyString () ;
  cEnumerator_enumValues enumerator_16161 (constinArgument_values, kENUMERATION_UP) ;
  while (enumerator_16161.hasCurrentObject ()) {
    result_result.plusAssign_operation(enumerator_16161.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 599)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 599)) ;
    if (enumerator_16161.hasNextObject ()) {
...
static GALGAS_impType extensionGetter_impRangedType_mergeWithType (const cPtr_impType * inObject,
  ...
  GALGAS_impRangedType var_castTypeToMerge_16435 = temp_0 ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    const GALGAS_impRangedType temp_2 = object ;
    test_1 = function_checkRanged (temp_2, var_castTypeToMerge_16435, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 614)).boolEnum () ;
    if (kBoolTrue == test_1) {
      result_mergedType = inArgument_typeToMerge ;
    }
  }
...
static GALGAS_impType extensionGetter_impBoolType_mergeWithType (const cPtr_impType * inObject,
  ...
  GALGAS_impBoolType var_castTypeToMerge_16841 = temp_0 ;
  GALGAS_implementationObjectMap var_mergedTrueAttributes_16919 = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_types.galgas", 631)) ;
  GALGAS_implementationObjectMap var_mergedFalseAttributes_16980 = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_types.galgas", 632)) ;
  cEnumerator_implementationObjectMap enumerator_17022 (object->mProperty_trueSubAttributes, kENUMERATION_UP) ;
  while (enumerator_17022.hasCurrentObject ()) {
    GALGAS_impType var_mergedAttr_17049 = enumerator_17022.current_type (HERE) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = var_castTypeToMerge_16841.getter_trueSubAttributes (SOURCE_FILE ("implementation_types.galgas", 635)).getter_hasKey (enumerator_17022.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 635)) COMMA_SOURCE_FILE ("implementation_types.galgas", 635)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_impType var_subTypeToMerge_17206 ;
        var_castTypeToMerge_16841.getter_trueSubAttributes (SOURCE_FILE ("implementation_types.galgas", 636)).method_get (enumerator_17022.current_lkey (HERE), var_subTypeToMerge_17206, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 636)) ;
        var_mergedAttr_17049 = callExtensionGetter_mergeWithType ((const cPtr_impType *) enumerator_17022.current_type (HERE).ptr (), var_subTypeToMerge_17206, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 637)) ;
      }
    }
    {
    var_mergedTrueAttributes_16919.setter_put (enumerator_17022.current_lkey (HERE), var_mergedAttr_17049, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 639)) ;
    }
    enumerator_17022.gotoNextObject () ;
  }
  cEnumerator_implementationObjectMap enumerator_17415 (var_castTypeToMerge_16841.getter_trueSubAttributes (SOURCE_FILE ("implementation_types.galgas", 642)), kENUMERATION_UP) ;
  while (enumerator_17415.hasCurrentObject ()) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = object->mProperty_trueSubAttributes.getter_hasKey (enumerator_17415.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 643)) COMMA_SOURCE_FILE ("implementation_types.galgas", 643)).operator_not (SOURCE_FILE ("implementation_types.galgas", 643)).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        var_mergedTrueAttributes_16919.setter_put (enumerator_17415.current_lkey (HERE), enumerator_17415.current_type (HERE), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 644)) ;
        }
      }
    }
    enumerator_17415.gotoNextObject () ;
  }
  cEnumerator_implementationObjectMap enumerator_17571 (object->mProperty_falseSubAttributes, kENUMERATION_UP) ;
  while (enumerator_17571.hasCurrentObject ()) {
    GALGAS_impType var_mergedAttr_17598 = enumerator_17571.current_type (HERE) ;
    enumGalgasBool test_3 = kBoolTrue ;
    if (kBoolTrue == test_3) {
      test_3 = var_castTypeToMerge_16841.getter_falseSubAttributes (SOURCE_FILE ("implementation_types.galgas", 650)).getter_hasKey (enumerator_17571.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 650)) COMMA_SOURCE_FILE ("implementation_types.galgas", 650)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_impType var_subTypeToMerge_17757 ;
        var_castTypeToMerge_16841.getter_falseSubAttributes (SOURCE_FILE ("implementation_types.galgas", 651)).method_get (enumerator_17571.current_lkey (HERE), var_subTypeToMerge_17757, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 651)) ;
        var_mergedAttr_17598 = callExtensionGetter_mergeWithType ((const cPtr_impType *) enumerator_17571.current_type (HERE).ptr (), var_subTypeToMerge_17757, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 652)) ;
      }
    }
    {
    var_mergedFalseAttributes_16980.setter_put (enumerator_17571.current_lkey (HERE), var_mergedAttr_17598, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 654)) ;
    }
    enumerator_17571.gotoNextObject () ;
  }
  cEnumerator_implementationObjectMap enumerator_17968 (var_castTypeToMerge_16841.getter_falseSubAttributes (SOURCE_FILE ("implementation_types.galgas", 657)), kENUMERATION_UP) ;
  while (enumerator_17968.hasCurrentObject ()) {
    enumGalgasBool test_4 = kBoolTrue ;
    if (kBoolTrue == test_4) {
      test_4 = object->mProperty_falseSubAttributes.getter_hasKey (enumerator_17968.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 658)) COMMA_SOURCE_FILE ("implementation_types.galgas", 658)).operator_not (SOURCE_FILE ("implementation_types.galgas", 658)).boolEnum () ;
      if (kBoolTrue == test_4) {
        {
        var_mergedTrueAttributes_16919.setter_put (enumerator_17968.current_lkey (HERE), enumerator_17968.current_type (HERE), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 659)) ;
        }
      }
    }
    enumerator_17968.gotoNextObject () ;
  }
  result_mergedType = GALGAS_impBoolType::constructor_new (object->mProperty_locations.add_operation (inArgument_typeToMerge.getter_locations (SOURCE_FILE ("implementation_types.galgas", 664)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 664)), object->mProperty_type, object->mProperty_name, object->mProperty_multiple, object->mProperty_descs.add_operation (inArgument_typeToMerge.getter_descs (SOURCE_FILE ("implementation_types.galgas", 668)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 668)), object->mProperty_withAuto, var_castTypeToMerge_16841.getter_defaultValue (SOURCE_FILE ("implementation_types.galgas", 670)), var_mergedTrueAttributes_16919, var_mergedFalseAttributes_16980  COMMA_SOURCE_FILE ("implementation_types.galgas", 663)) ;
//---
  return result_mergedType ;
}
...
static void extensionMethod_impBoolType_setDefault (const cPtr_impAutoDefaultType * inObject,
  ...
  if (object->mProperty_defaultValue.isValid ()) {
    if (object->mProperty_defaultValue.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_void) {
      ...
      GALGAS_boolAttribute cast_18576_b ((cPtr_boolAttribute *) object->mProperty_defaultValue.ptr ()) ;
      enumGalgasBool test_0 = kBoolTrue ;
      if (kBoolTrue == test_0) {
        ...
        if (kBoolTrue == test_0) {
          GALGAS_identifierMap var_userAttributes_18852 = ioArgument_attributes.getter_objectParams (SOURCE_FILE ("implementation_types.galgas", 687)) ;
          GALGAS_object_5F_t var_value_18904 ;
          var_userAttributes_18852.method_get (object->mProperty_name, var_value_18904, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 689)) ;
          if (var_value_18904.isValid ()) {
            if (var_value_18904.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_boolAttribute) {
              GALGAS_boolAttribute cast_19006_boolValue ((cPtr_boolAttribute *) var_value_18904.ptr ()) ;
              GALGAS_implementationObjectMap var_subImpAttributes_19060 ;
              enumGalgasBool test_1 = kBoolTrue ;
              if (kBoolTrue == test_1) {
                test_1 = cast_19006_boolValue.getter_value (SOURCE_FILE ("implementation_types.galgas", 693)).boolEnum () ;
                if (kBoolTrue == test_1) {
                  var_subImpAttributes_19060 = object->mProperty_trueSubAttributes ;
                }
              }
              if (kBoolFalse == test_1) {
                var_subImpAttributes_19060 = object->mProperty_falseSubAttributes ;
              }
              GALGAS_objectAttributes var_subAttributes_19266 = cast_19006_boolValue.getter_subAttributes (SOURCE_FILE ("implementation_types.galgas", 698)) ;
              {
              routine_setDefaultsForType (var_subImpAttributes_19060, var_subAttributes_19266, inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 699)) ;
              }
              GALGAS_boolAttribute var_bv_19421 = cast_19006_boolValue ;
              {
              var_bv_19421.setter_setSubAttributes (var_subAttributes_19266 COMMA_SOURCE_FILE ("implementation_types.galgas", 702)) ;
              }
              {
              var_userAttributes_18852.setter_setValueForKey (var_bv_19421, object->mProperty_name.getter_string (SOURCE_FILE ("implementation_types.galgas", 703)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 703)) ;
              }
              {
              ioArgument_attributes.setter_setObjectParams (var_userAttributes_18852 COMMA_SOURCE_FILE ("implementation_types.galgas", 704)) ;
              }
            }
          }
        }
      ...
      if (kBoolFalse == test_0) {
        GALGAS_implementationObjectMap var_subImpAttributes_19680 ;
        enumGalgasBool test_2 = kBoolTrue ;
        if (kBoolTrue == test_2) {
          test_2 = cast_18576_b.getter_value (SOURCE_FILE ("implementation_types.galgas", 708)).boolEnum () ;
          if (kBoolTrue == test_2) {
            var_subImpAttributes_19680 = object->mProperty_trueSubAttributes ;
          }
        }
        if (kBoolFalse == test_2) {
          var_subImpAttributes_19680 = object->mProperty_falseSubAttributes ;
        }
        GALGAS_objectAttributes var_subAttributes_19866 = function_emptyObject (inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 713)) ;
        {
        routine_setDefaultsForType (var_subImpAttributes_19680, var_subAttributes_19866, inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 714)) ;
        }
        GALGAS_boolAttribute var_defaults_19978 = GALGAS_boolAttribute::constructor_new (cast_18576_b.getter_oil_5F_desc (SOURCE_FILE ("implementation_types.galgas", 715)), cast_18576_b.getter_location (SOURCE_FILE ("implementation_types.galgas", 715)), cast_18576_b.getter_value (SOURCE_FILE ("implementation_types.galgas", 715)), var_subAttributes_19866  COMMA_SOURCE_FILE ("implementation_types.galgas", 715)) ;
        GALGAS_identifierMap var_attr_20085 = ioArgument_attributes.getter_objectParams (SOURCE_FILE ("implementation_types.galgas", 716)) ;
        {
        var_attr_20085.setter_put (object->mProperty_name, var_defaults_19978, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 717)) ;
        }
        {
        ioArgument_attributes.setter_setObjectParams (var_attr_20085 COMMA_SOURCE_FILE ("implementation_types.galgas", 718)) ;
        }
      }
    }
  }
...
void routine_verifyEnum (const GALGAS_impType constinArgument_anEnum,
  ...
  if (constinArgument_anEnum.isValid ()) {
    if (constinArgument_anEnum.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impEnumType) {
      GALGAS_impEnumType cast_21493_realEnum ((cPtr_impEnumType *) constinArgument_anEnum.ptr ()) ;
      if (cast_21493_realEnum.getter_defaultValue (SOURCE_FILE ("implementation_types.galgas", 774)).isValid ()) {
        if (cast_21493_realEnum.getter_defaultValue (SOURCE_FILE ("implementation_types.galgas", 774)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_string_5F_class) {
          GALGAS_string_5F_class cast_21567_defaultValue ((cPtr_string_5F_class *) cast_21493_realEnum.getter_defaultValue (SOURCE_FILE ("implementation_types.galgas", 774)).ptr ()) ;
          enumGalgasBool test_0 = kBoolTrue ;
          if (kBoolTrue == test_0) {
            test_0 = cast_21493_realEnum.getter_valuesMap (SOURCE_FILE ("implementation_types.galgas", 776)).getter_hasKey (cast_21567_defaultValue.getter_value (SOURCE_FILE ("implementation_types.galgas", 776)) COMMA_SOURCE_FILE ("implementation_types.galgas", 776)).operator_not (SOURCE_FILE ("implementation_types.galgas", 776)).boolEnum () ;
            if (kBoolTrue == test_0) {
              TC_Array <C_FixItDescription> fixItArray1 ;
              inCompiler->emitSemanticError (cast_21567_defaultValue.getter_location (SOURCE_FILE ("implementation_types.galgas", 777)), GALGAS_string ("Default enum value does not match any enum value"), fixItArray1  COMMA_SOURCE_FILE ("implementation_types.galgas", 777)) ;
            }
          }
        }
      }
    }else{
      cEnumerator_locationList enumerator_21792 (constinArgument_anEnum.getter_locations (SOURCE_FILE ("implementation_types.galgas", 781)), kENUMERATION_UP) ;
      while (enumerator_21792.hasCurrentObject ()) {
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (enumerator_21792.current_location (HERE), GALGAS_string ("Internal, not an @impEnumType"), fixItArray2  COMMA_SOURCE_FILE ("implementation_types.galgas", 782)) ;
...
void routine_checkTypeForAttribute (const GALGAS_implementationObjectMap constinArgument_obj,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_impType var_type_25178 ;
      constinArgument_obj.method_get (function_lstringWith (constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 897)), var_type_25178, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 897)) ;
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = GALGAS_bool (kIsNotEqual, var_type_25178.getter_type (SOURCE_FILE ("implementation_types.galgas", 898)).objectCompare (constinArgument_expectedType)).boolEnum () ;
        if (kBoolTrue == test_1) {
          cEnumerator_locationList enumerator_25300 (var_type_25178.getter_locations (SOURCE_FILE ("implementation_types.galgas", 899)), kENUMERATION_UP) ;
          while (enumerator_25300.hasCurrentObject ()) {
            TC_Array <C_FixItDescription> fixItArray2 ;
            inCompiler->emitSemanticError (enumerator_25300.current_location (HERE), constinArgument_attributeName.add_operation (GALGAS_string (" is a "), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 900)).add_operation (extensionGetter_oilType (var_type_25178.getter_type (SOURCE_FILE ("implementation_types.galgas", 900)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 900)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 900)), fixItArray2  COMMA_SOURCE_FILE ("implementation_types.galgas", 900)) ;
            TC_Array <C_FixItDescription> fixItArray3 ;
...
GALGAS_implementationObjectMap function_boolSubAttributes (const GALGAS_implementationObject & constinArgument_obj,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_impType var_type_25759 ;
      constinArgument_obj.getter_attributes (SOURCE_FILE ("implementation_types.galgas", 915)).method_get (function_lstringWith (constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 915)), var_type_25759, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 915)) ;
      if (var_type_25759.isValid ()) {
        if (var_type_25759.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impBoolType) {
          GALGAS_impBoolType cast_25869_boolType ((cPtr_impBoolType *) var_type_25759.ptr ()) ;
          enumGalgasBool test_1 = kBoolTrue ;
          if (kBoolTrue == test_1) {
            test_1 = constinArgument_boolValue.boolEnum () ;
            if (kBoolTrue == test_1) {
              result_subImplementation = cast_25869_boolType.getter_trueSubAttributes (SOURCE_FILE ("implementation_types.galgas", 919)) ;
            }
          }
          if (kBoolFalse == test_1) {
            result_subImplementation = cast_25869_boolType.getter_falseSubAttributes (SOURCE_FILE ("implementation_types.galgas", 921)) ;
          }
        }
      }
    }
...
GALGAS_implementationObjectMap function_enumSubAttributes (const GALGAS_implementationObject & constinArgument_obj,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_impType var_type_26338 ;
      constinArgument_obj.getter_attributes (SOURCE_FILE ("implementation_types.galgas", 935)).method_get (function_lstringWith (constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 935)), var_type_26338, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 935)) ;
      if (var_type_26338.isValid ()) {
        if (var_type_26338.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_impEnumType) {
          GALGAS_impEnumType cast_26448_enumType ((cPtr_impEnumType *) var_type_26338.ptr ()) ;
          enumGalgasBool test_1 = kBoolTrue ;
          if (kBoolTrue == test_1) {
            test_1 = cast_26448_enumType.getter_valuesMap (SOURCE_FILE ("implementation_types.galgas", 938)).getter_hasKey (constinArgument_enumValue COMMA_SOURCE_FILE ("implementation_types.galgas", 938)).boolEnum () ;
            if (kBoolTrue == test_1) {
              cast_26448_enumType.getter_valuesMap (SOURCE_FILE ("implementation_types.galgas", 939)).method_get (function_lstringWith (constinArgument_enumValue, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 939)), result_subImplementation, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 939)) ;
            }
          }
        }
      }
...
void routine_checkFilters (const GALGAS_implementationObject constinArgument_messageProperty,
                           C_Compiler * inCompiler
                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_implementationObjectMap var_filter_26734 = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("MASKEDNEWEQUALSX"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 950)) ;
  {
  routine_checkTypeForAttribute (var_filter_26734, GALGAS_string ("MASK"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 951)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 951)) ;
  }
  {
  routine_checkTypeForAttribute (var_filter_26734, GALGAS_string ("X"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 952)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 952)) ;
  }
  var_filter_26734 = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("MASKEDNEWDIFFERSX"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 953)) ;
  {
  routine_checkTypeForAttribute (var_filter_26734, GALGAS_string ("MASK"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 954)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 954)) ;
  }
  {
  routine_checkTypeForAttribute (var_filter_26734, GALGAS_string ("X"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 955)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 955)) ;
  }
  var_filter_26734 = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("MASKEDNEWEQUALSMASKEDOLD"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 956)) ;
  {
  routine_checkTypeForAttribute (var_filter_26734, GALGAS_string ("MASK"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 957)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 957)) ;
  }
  var_filter_26734 = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("NEWISWITHIN"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 958)) ;
  {
  routine_checkTypeForAttribute (var_filter_26734, GALGAS_string ("MIN"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 959)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 959)) ;
  }
  {
  routine_checkTypeForAttribute (var_filter_26734, GALGAS_string ("MAX"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 960)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 960)) ;
  }
  var_filter_26734 = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("NEWISOUTSIDE"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 961)) ;
  {
  routine_checkTypeForAttribute (var_filter_26734, GALGAS_string ("MIN"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 962)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 962)) ;
  }
  {
  routine_checkTypeForAttribute (var_filter_26734, GALGAS_string ("MAX"), GALGAS_dataType::constructor_uint_36__34_Number (SOURCE_FILE ("implementation_types.galgas", 963)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 963)) ;
  }
  var_filter_26734 = function_enumSubAttributes (constinArgument_messageProperty, GALGAS_string ("FILTER"), GALGAS_string ("ONEEVERYN"), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 964)) ;
  {
  routine_checkTypeForAttribute (var_filter_26734, GALGAS_string ("PERIOD"), GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE ("implementation_types.galgas", 965)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 965)) ;
  }
  {
  routine_checkTypeForAttribute (var_filter_26734, GALGAS_string ("OFFSET"), GALGAS_dataType::constructor_uint_33__32_Number (SOURCE_FILE ("implementation_types.galgas", 966)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 966)) ;
  }
}
...
static void extensionMethod_impBoolType_checkAttributeReferences (const cPtr_impType * inObject,
  ...
  const cPtr_impBoolType * object = (const cPtr_impBoolType *) inObject ;
  macroValidSharedObject (object, cPtr_impBoolType) ;
  cEnumerator_implementationObjectMap enumerator_28624 (object->mProperty_trueSubAttributes, kENUMERATION_UP) ;
  while (enumerator_28624.hasCurrentObject ()) {
    callExtensionMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_28624.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 990)) ;
    enumerator_28624.gotoNextObject () ;
  }
  cEnumerator_implementationObjectMap enumerator_28707 (object->mProperty_falseSubAttributes, kENUMERATION_UP) ;
  while (enumerator_28707.hasCurrentObject ()) {
    callExtensionMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_28707.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 993)) ;
...
static void extensionMethod_impEnumType_checkAttributeReferences (const cPtr_impType * inObject,
  ...
  const cPtr_impEnumType * object = (const cPtr_impEnumType *) inObject ;
  macroValidSharedObject (object, cPtr_impEnumType) ;
  cEnumerator_enumValues enumerator_28867 (object->mProperty_valuesMap, kENUMERATION_UP) ;
  while (enumerator_28867.hasCurrentObject ()) {
    cEnumerator_implementationObjectMap enumerator_28899 (enumerator_28867.current_subAttributes (HERE), kENUMERATION_UP) ;
    while (enumerator_28899.hasCurrentObject ()) {
      callExtensionMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_28899.current_type (HERE).ptr (), constinArgument_imp, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1002)) ;
...
void routine_setDefaultsForType (const GALGAS_implementationObjectMap constinArgument_impObject,
                                 ...
                                 C_Compiler * inCompiler
                                 COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_implementationObjectMap enumerator_29091 (constinArgument_impObject, kENUMERATION_UP) ;
  while (enumerator_29091.hasCurrentObject ()) {
    if (enumerator_29091.current_type (HERE).isValid ()) {
      if (NULL != dynamic_cast <const cPtr_impAutoDefaultType *> (enumerator_29091.current_type (HERE).ptr ())) {
        GALGAS_impAutoDefaultType cast_29152_defaultType ((cPtr_impAutoDefaultType *) enumerator_29091.current_type (HERE).ptr ()) ;
        callExtensionMethod_setDefault ((const cPtr_impAutoDefaultType *) cast_29152_defaultType.ptr (), ioArgument_objectParams, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1014)) ;
      }
    }
...
static GALGAS_bool extensionGetter_uint_33__32_AttributeSet_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_33__32__5F_class) {
      GALGAS_uint_33__32__5F_class cast_31523_intVal ((cPtr_uint_33__32__5F_class *) constinArgument_obj.ptr ()) ;
      result_isInside = GALGAS_bool (false) ;
      cEnumerator_uint_33__32_List enumerator_31569 (object->mProperty_valueList, kENUMERATION_UP) ;
      while (enumerator_31569.hasCurrentObject ()) {
        result_isInside = result_isInside.operator_or (GALGAS_bool (kIsEqual, enumerator_31569.current_value (HERE).objectCompare (cast_31523_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1102)))) COMMA_SOURCE_FILE ("implementation_types.galgas", 1102)) ;
...
static GALGAS_string extensionGetter_uint_33__32_AttributeSet_string (const cPtr_attributeRange * inObject,
  ...
  cEnumerator_uint_33__32_List enumerator_31798 (object->mProperty_valueList, kENUMERATION_UP) ;
  while (enumerator_31798.hasCurrentObject ()) {
    result_desc.plusAssign_operation(enumerator_31798.current_value (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 1114)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1114)) ;
...
static GALGAS_bool extensionGetter_uint_33__32_AttributeMinMax_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_33__32__5F_class) {
      GALGAS_uint_33__32__5F_class cast_31999_intVal ((cPtr_uint_33__32__5F_class *) constinArgument_obj.ptr ()) ;
      GALGAS_bool test_0 = GALGAS_bool (kIsInfOrEqual, object->mProperty_min.objectCompare (cast_31999_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1126)))) ;
      if (kBoolTrue == test_0.boolEnum ()) {
        test_0 = GALGAS_bool (kIsInfOrEqual, cast_31999_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1126)).objectCompare (object->mProperty_max)) ;
      }
...
static GALGAS_bool extensionGetter_sint_33__32_AttributeSet_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_33__32__5F_class) {
      GALGAS_sint_33__32__5F_class cast_32374_intVal ((cPtr_sint_33__32__5F_class *) constinArgument_obj.ptr ()) ;
      result_isInside = GALGAS_bool (true) ;
      cEnumerator_sint_33__32_List enumerator_32419 (object->mProperty_valueList, kENUMERATION_UP) ;
      while (enumerator_32419.hasCurrentObject ()) {
        result_isInside = result_isInside.operator_and (GALGAS_bool (kIsEqual, enumerator_32419.current_value (HERE).objectCompare (cast_32374_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1146)))) COMMA_SOURCE_FILE ("implementation_types.galgas", 1146)) ;
...
static GALGAS_string extensionGetter_sint_33__32_AttributeSet_string (const cPtr_attributeRange * inObject,
  ...
  macroValidSharedObject (object, cPtr_sint_33__32_AttributeSet) ;
  result_desc = GALGAS_string::makeEmptyString () ;
  cEnumerator_sint_33__32_List enumerator_32648 (object->mProperty_valueList, kENUMERATION_UP) ;
  while (enumerator_32648.hasCurrentObject ()) {
    result_desc.plusAssign_operation(enumerator_32648.current_value (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 1158)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1158)) ;
    if (enumerator_32648.hasNextObject ()) {
...
static GALGAS_bool extensionGetter_sint_33__32_AttributeMinMax_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_33__32__5F_class) {
      GALGAS_sint_33__32__5F_class cast_32849_intVal ((cPtr_sint_33__32__5F_class *) constinArgument_obj.ptr ()) ;
      GALGAS_bool test_0 = GALGAS_bool (kIsInfOrEqual, object->mProperty_min.objectCompare (cast_32849_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1170)))) ;
      if (kBoolTrue == test_0.boolEnum ()) {
        test_0 = GALGAS_bool (kIsInfOrEqual, cast_32849_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1170)).objectCompare (object->mProperty_max)) ;
      }
      result_isInside = test_0 ;
    }else{
      result_isInside = GALGAS_bool (false) ;
...
static GALGAS_bool extensionGetter_uint_36__34_AttributeSet_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_36__34__5F_class) {
      GALGAS_uint_36__34__5F_class cast_33224_intVal ((cPtr_uint_36__34__5F_class *) constinArgument_obj.ptr ()) ;
      result_isInside = GALGAS_bool (true) ;
      cEnumerator_uint_36__34_List enumerator_33269 (object->mProperty_valueList, kENUMERATION_UP) ;
      while (enumerator_33269.hasCurrentObject ()) {
        result_isInside = result_isInside.operator_and (GALGAS_bool (kIsEqual, enumerator_33269.current_value (HERE).objectCompare (cast_33224_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1190)))) COMMA_SOURCE_FILE ("implementation_types.galgas", 1190)) ;
        enumerator_33269.gotoNextObject () ;
      }
    }else{
      result_isInside = GALGAS_bool (false) ;
      TC_Array <C_FixItDescription> fixItArray0 ;
...
static GALGAS_string extensionGetter_uint_36__34_AttributeSet_string (const cPtr_attributeRange * inObject,
  ...
  macroValidSharedObject (object, cPtr_uint_36__34_AttributeSet) ;
  result_desc = GALGAS_string::makeEmptyString () ;
  cEnumerator_uint_36__34_List enumerator_33498 (object->mProperty_valueList, kENUMERATION_UP) ;
  while (enumerator_33498.hasCurrentObject ()) {
    result_desc.plusAssign_operation(enumerator_33498.current_value (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 1202)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1202)) ;
    if (enumerator_33498.hasNextObject ()) {
...
static GALGAS_bool extensionGetter_uint_36__34_AttributeMinMax_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_36__34__5F_class) {
      GALGAS_uint_36__34__5F_class cast_33699_intVal ((cPtr_uint_36__34__5F_class *) constinArgument_obj.ptr ()) ;
      GALGAS_bool test_0 = GALGAS_bool (kIsInfOrEqual, object->mProperty_min.objectCompare (cast_33699_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1214)))) ;
      if (kBoolTrue == test_0.boolEnum ()) {
        test_0 = GALGAS_bool (kIsInfOrEqual, cast_33699_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1214)).objectCompare (object->mProperty_max)) ;
      }
      result_isInside = test_0 ;
    }else{
      result_isInside = GALGAS_bool (false) ;
...
static GALGAS_bool extensionGetter_sint_36__34_AttributeSet_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_36__34__5F_class) {
      GALGAS_sint_36__34__5F_class cast_34074_intVal ((cPtr_sint_36__34__5F_class *) constinArgument_obj.ptr ()) ;
      result_isInside = GALGAS_bool (true) ;
      cEnumerator_sint_36__34_List enumerator_34119 (object->mProperty_valueList, kENUMERATION_UP) ;
      while (enumerator_34119.hasCurrentObject ()) {
        result_isInside = result_isInside.operator_and (GALGAS_bool (kIsEqual, enumerator_34119.current_value (HERE).objectCompare (cast_34074_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1234)))) COMMA_SOURCE_FILE ("implementation_types.galgas", 1234)) ;
        enumerator_34119.gotoNextObject () ;
      }
    }else{
      result_isInside = GALGAS_bool (false) ;
      TC_Array <C_FixItDescription> fixItArray0 ;
...
static GALGAS_string extensionGetter_sint_36__34_AttributeSet_string (const cPtr_attributeRange * inObject,
  ...
  macroValidSharedObject (object, cPtr_sint_36__34_AttributeSet) ;
  result_desc = GALGAS_string::makeEmptyString () ;
  cEnumerator_sint_36__34_List enumerator_34348 (object->mProperty_valueList, kENUMERATION_UP) ;
  while (enumerator_34348.hasCurrentObject ()) {
    result_desc.plusAssign_operation(enumerator_34348.current_value (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 1246)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1246)) ;
    if (enumerator_34348.hasNextObject ()) {
      result_desc.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1248)) ;
    }
    enumerator_34348.gotoNextObject () ;
  }
//---
  return result_desc ;
}
...
static GALGAS_bool extensionGetter_sint_36__34_AttributeMinMax_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_sint_36__34__5F_class) {
      GALGAS_sint_36__34__5F_class cast_34550_intVal ((cPtr_sint_36__34__5F_class *) constinArgument_obj.ptr ()) ;
      GALGAS_bool test_0 = GALGAS_bool (kIsInfOrEqual, object->mProperty_min.objectCompare (cast_34550_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1259)))) ;
      if (kBoolTrue == test_0.boolEnum ()) {
        test_0 = GALGAS_bool (kIsInfOrEqual, cast_34550_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1259)).objectCompare (object->mProperty_max)) ;
      }
      result_isInside = test_0 ;
    }else{
      result_isInside = GALGAS_bool (false) ;
...
static GALGAS_bool extensionGetter_floatAttributeSet_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_float_5F_class) {
      GALGAS_float_5F_class cast_34923_intVal ((cPtr_float_5F_class *) constinArgument_obj.ptr ()) ;
      result_isInside = GALGAS_bool (true) ;
      cEnumerator_floatList enumerator_34968 (object->mProperty_valueList, kENUMERATION_UP) ;
      while (enumerator_34968.hasCurrentObject ()) {
        result_isInside = result_isInside.operator_and (GALGAS_bool (kIsEqual, enumerator_34968.current_value (HERE).objectCompare (cast_34923_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1279)))) COMMA_SOURCE_FILE ("implementation_types.galgas", 1279)) ;
...
static GALGAS_string extensionGetter_floatAttributeSet_string (const cPtr_attributeRange * inObject,
  ...
  macroValidSharedObject (object, cPtr_floatAttributeSet) ;
  result_desc = GALGAS_string::makeEmptyString () ;
  cEnumerator_floatList enumerator_35195 (object->mProperty_valueList, kENUMERATION_UP) ;
  while (enumerator_35195.hasCurrentObject ()) {
    result_desc.plusAssign_operation(enumerator_35195.current_value (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 1291)), inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 1291)) ;
    if (enumerator_35195.hasNextObject ()) {
...
static GALGAS_bool extensionGetter_floatAttributeMinMax_contains (const cPtr_attributeRange * inObject,
  ...
  if (constinArgument_obj.isValid ()) {
    if (constinArgument_obj.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_float_5F_class) {
      GALGAS_float_5F_class cast_35394_intVal ((cPtr_float_5F_class *) constinArgument_obj.ptr ()) ;
      GALGAS_bool test_0 = GALGAS_bool (kIsInfOrEqual, object->mProperty_min.objectCompare (cast_35394_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1303)))) ;
      if (kBoolTrue == test_0.boolEnum ()) {
        test_0 = GALGAS_bool (kIsInfOrEqual, cast_35394_intVal.getter_value (SOURCE_FILE ("implementation_types.galgas", 1303)).objectCompare (object->mProperty_max)) ;
      }
      result_isInside = test_0 ;
    }else{
      result_isInside = GALGAS_bool (false) ;
...
static void extensionSetter_multipleAttribute_mergeSubAttributes (cPtr_object_5F_t * inObject,
  ...
  if (inArgument_withObject.isValid ()) {
    if (inArgument_withObject.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_multipleAttribute) {
      GALGAS_multipleAttribute cast_2248_multipleObject ((cPtr_multipleAttribute *) inArgument_withObject.ptr ()) ;
      object->mProperty_items.plusAssign_operation(cast_2248_multipleObject.getter_items (SOURCE_FILE ("goil_basic_types.galgas", 93)), inCompiler  COMMA_SOURCE_FILE ("goil_basic_types.galgas", 93)) ;
    }
  }
}
//----------------------------------------------------------------------------------------------------------------------
...
GALGAS_identifierList function_multipleAttributeOrError (const GALGAS_object_5F_t & constinArgument_t,
  ...
  if (constinArgument_t.isValid ()) {
    if (constinArgument_t.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_multipleAttribute) {
      GALGAS_multipleAttribute cast_2465_l ((cPtr_multipleAttribute *) constinArgument_t.ptr ()) ;
      result_v = cast_2465_l.getter_items (SOURCE_FILE ("goil_basic_types.galgas", 104)) ;
    }else{
      TC_Array <C_FixItDescription> fixItArray0 ;
...
GALGAS_objectAttributes function_osObject (const GALGAS_objectsMap & constinArgument_objects,
  ...
  GALGAS_objectKind var_objectsForKind_1575 ;
  constinArgument_objects.method_get (function_lstringWith (GALGAS_string ("OS"), inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 67)), var_objectsForKind_1575, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 67)) ;
  GALGAS_lstringlist var_names_1648 = var_objectsForKind_1575.getter_objects (SOURCE_FILE ("goil_types_root.galgas", 68)).getter_keyList (SOURCE_FILE ("goil_types_root.galgas", 68)) ;
  GALGAS_lstring var_name_1701 ;
  var_names_1648.method_first (var_name_1701, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 70)) ;
  var_objectsForKind_1575.getter_objects (SOURCE_FILE ("goil_types_root.galgas", 71)).method_get (var_name_1701, result_os, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 71)) ;
//---
  return result_os ;
}
...
GALGAS_objectAttributes function_objectForKindAndName (const GALGAS_objectsMap & constinArgument_objects,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_objectKind var_kindObj_1950 ;
      constinArgument_objects.method_get (function_lstringWith (constinArgument_kind, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 81)), var_kindObj_1950, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 81)) ;
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = var_kindObj_1950.getter_objects (SOURCE_FILE ("goil_types_root.galgas", 82)).getter_hasKey (constinArgument_name COMMA_SOURCE_FILE ("goil_types_root.galgas", 82)).boolEnum () ;
        if (kBoolTrue == test_1) {
          var_kindObj_1950.getter_objects (SOURCE_FILE ("goil_types_root.galgas", 83)).method_get (function_lstringWith (constinArgument_name, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 83)), result_object, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 83)) ;
        }
      }
      if (kBoolFalse == test_1) {
...
void routine_setObjectForKindAndName (GALGAS_objectsMap & ioArgument_objects,
                                      ...
                                      C_Compiler * inCompiler
                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_lkind_2409 = function_lstringWith (constinArgument_kind, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 97)) ;
  GALGAS_lstring var_lname_2447 = function_lstringWith (constinArgument_name, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 98)) ;
  GALGAS_objectKind var_kindObj_2490 = GALGAS_objectKind::constructor_new (GALGAS_objectKindMap::constructor_emptyMap (SOURCE_FILE ("goil_types_root.galgas", 99))  COMMA_SOURCE_FILE ("goil_types_root.galgas", 99)) ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = ioArgument_objects.getter_hasKey (constinArgument_kind COMMA_SOURCE_FILE ("goil_types_root.galgas", 100)).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      ioArgument_objects.setter_del (var_lkind_2409, var_kindObj_2490, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 101)) ;
      }
    }
  }
  GALGAS_objectKindMap var_kindMap_2638 = var_kindObj_2490.getter_objects (SOURCE_FILE ("goil_types_root.galgas", 103)) ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = var_kindMap_2638.getter_hasKey (constinArgument_name COMMA_SOURCE_FILE ("goil_types_root.galgas", 104)).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
      GALGAS_objectAttributes joker_2719 ; // Joker input parameter
      var_kindMap_2638.setter_del (var_lname_2447, joker_2719, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 105)) ;
      }
    }
  }
  {
  var_kindMap_2638.setter_put (var_lname_2447, constinArgument_object, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 107)) ;
  }
  {
  var_kindObj_2490.setter_setObjects (var_kindMap_2638 COMMA_SOURCE_FILE ("goil_types_root.galgas", 108)) ;
  }
  {
  ioArgument_objects.setter_put (var_lkind_2409, var_kindObj_2490, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 109)) ;
  }
}
...
GALGAS_identifierList function_listInOS (const GALGAS_objectsMap & constinArgument_objects,
  ...
  GALGAS_object_5F_t var_itemsContainer_3204 ;
  GALGAS_objectAttributes var_os_3227 = function_osObject (constinArgument_objects, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 128)) ;
  var_os_3227.getter_objectParams (SOURCE_FILE ("goil_types_root.galgas", 129)).method_get (function_lstringWith (constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 129)), var_itemsContainer_3204, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 129)) ;
  result_items = function_multipleAttributeOrError (var_itemsContainer_3204, constinArgument_attributeName, inCompiler COMMA_SOURCE_FILE ("goil_types_root.galgas", 130)) ;
//---
  return result_items ;
}
