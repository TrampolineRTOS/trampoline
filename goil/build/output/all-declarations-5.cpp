...
static void extensionMethod_impAutoDefaultType_setDefault (const cPtr_impAutoDefaultType * inObject,
  ...
  if (kBoolTrue == test_0) {
    test_0 = ioArgument_attributes.getter_objectParams (SOURCE_FILE ("implementation_types.galgas", 530)).getter_hasKey (object->mProperty_name.getter_string (SOURCE_FILE ("implementation_types.galgas", 530)) COMMA_SOURCE_FILE ("implementation_types.galgas", 530)).operator_not (SOURCE_FILE ("implementation_types.galgas", 530)).boolEnum () ;
    if (kBoolTrue == test_0) {
      if (object->mProperty_defaultValue.isValid ()) {
        if (object->mProperty_defaultValue.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_void) {
          ...
          GALGAS_identifierMap var_attr_14450 = ioArgument_attributes.getter_objectParams (SOURCE_FILE ("implementation_types.galgas", 534)) ;
          {
          var_attr_14450.setter_put (object->mProperty_name, object->mProperty_defaultValue, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 535)) ;
          }
          {
          ioArgument_attributes.setter_setObjectParams (var_attr_14450 COMMA_SOURCE_FILE ("implementation_types.galgas", 536)) ;
          }
        }else{
          GALGAS_identifierMap var_attr_14646 = ioArgument_attributes.getter_objectParams (SOURCE_FILE ("implementation_types.galgas", 539)) ;
          {
          var_attr_14646.setter_put (object->mProperty_name, object->mProperty_defaultValue, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 540)) ;
          }
          {
          ioArgument_attributes.setter_setObjectParams (var_attr_14646 COMMA_SOURCE_FILE ("implementation_types.galgas", 541)) ;
          }
        }
      }
    }
...
static GALGAS_implementationObject extensionGetter_implementationObject_mergeImplementationObjectWith (const cPtr_implementationObject * inObject,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsNotEqual, object->mProperty_multiple.objectCompare (constinArgument_objToMerge.getter_multiple (SOURCE_FILE ("implementation_types.galgas", 1028)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      ...
      if (kBoolTrue == test_1) {
        ...
        if (kBoolTrue == test_1) {
          ...
          inCompiler->emitSemanticWarning (constinArgument_objToMerge.getter_multiple (SOURCE_FILE ("implementation_types.galgas", 1030)).getter_location (SOURCE_FILE ("implementation_types.galgas", 1030)), GALGAS_string ("multiple redefinition"), fixItArray2  COMMA_SOURCE_FILE ("implementation_types.galgas", 1030)) ;
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticWarning (object->mProperty_multiple.getter_location (SOURCE_FILE ("implementation_types.galgas", 1031)), GALGAS_string ("was defined here"), fixItArray3  COMMA_SOURCE_FILE ("implementation_types.galgas", 1031)) ;
        }
      }
    }
  }
  result_mergedObj = GALGAS_implementationObject::constructor_new (object->mProperty_multiple, extensionGetter_mergeImplementationObjectAttributesWith (object->mProperty_attributes, constinArgument_objToMerge.getter_attributes (SOURCE_FILE ("implementation_types.galgas", 1044)), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1044))  COMMA_SOURCE_FILE ("implementation_types.galgas", 1044)) ;
//---
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_implementation_5F_definition_i0_ (GALGAS_implementation & ioArgument_implementation,
  ...
  inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_IMPLEMENTATION COMMA_SOURCE_FILE ("implementation_parser.galgas", 57)) ;
  GALGAS_lstring var_implementationName_1955 = inCompiler->synthetizedAttribute_att_5F_token () ;
  inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_idf COMMA_SOURCE_FILE ("implementation_parser.galgas", 57)) ;
  inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 57)) ;
  nt_implementation_5F_object_5F_list_ (ioArgument_implementation, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 59)) ;
  inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__3B_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 59)) ;
}
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_implementation_5F_object_5F_list_i1_ (GALGAS_implementation & ioArgument_implementation,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__3B_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 66)) ;
    } break ;
    case 3: {
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_include_5F_implementation_5F_level_i2_ (GALGAS_implementation & ioArgument_implementation,
  ...
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_include COMMA_SOURCE_FILE ("implementation_parser.galgas", 76)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_includeifexists COMMA_SOURCE_FILE ("implementation_parser.galgas", 78)) ;
  ...
  case 1: {
    ...
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_g_5F_string COMMA_SOURCE_FILE ("implementation_parser.galgas", 82)) ;
    {
  ...
  case 2: {
    var_file_5F_name_2424 = inCompiler->synthetizedAttribute_a_5F_string () ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_string COMMA_SOURCE_FILE ("implementation_parser.galgas", 85)) ;
  } break ;
  default:
    break ;
  }
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    GALGAS_bool test_1 = var_includeIfExists_2316.operator_not (SOURCE_FILE ("implementation_parser.galgas", 87)) ;
    if (kBoolTrue != test_1.boolEnum ()) {
      GALGAS_bool test_2 = var_includeIfExists_2316 ;
      if (kBoolTrue == test_2.boolEnum ()) {
        test_2 = var_file_5F_name_2424.getter_string (HERE).getter_fileExists (SOURCE_FILE ("implementation_parser.galgas", 87)) ;
      }
      test_1 = test_2 ;
    }
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_include_5F_type_5F_level_i3_ (GALGAS_implementationObjectMap & ioArgument_objectAttributes,
  ...
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_include COMMA_SOURCE_FILE ("implementation_parser.galgas", 97)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_includeifexists COMMA_SOURCE_FILE ("implementation_parser.galgas", 99)) ;
  ...
  case 1: {
    ...
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_g_5F_string COMMA_SOURCE_FILE ("implementation_parser.galgas", 103)) ;
    {
  ...
  case 2: {
    var_file_5F_name_2896 = inCompiler->synthetizedAttribute_a_5F_string () ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_string COMMA_SOURCE_FILE ("implementation_parser.galgas", 106)) ;
  } break ;
  default:
    break ;
  }
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    GALGAS_bool test_1 = var_includeIfExists_2788.operator_not (SOURCE_FILE ("implementation_parser.galgas", 108)) ;
    if (kBoolTrue != test_1.boolEnum ()) {
      GALGAS_bool test_2 = var_includeIfExists_2788 ;
      if (kBoolTrue == test_2.boolEnum ()) {
        test_2 = var_file_5F_name_2896.getter_string (HERE).getter_fileExists (SOURCE_FILE ("implementation_parser.galgas", 108)) ;
      }
      test_1 = test_2 ;
    }
    test_0 = test_1.boolEnum () ;
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_implementation_5F_objects_i4_ (GALGAS_implementation & ioArgument_implementation,
  ...
  inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_idf COMMA_SOURCE_FILE ("implementation_parser.galgas", 140)) ;
  GALGAS_lbool var_multiple_4017 ;
  switch (select_implementation_5F_parser_5 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 144)) ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 144)) ;
  ...
  inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 151)) ;
  nt_implementation_5F_list_ (var_objectAttributes_4234, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 153)) ;
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = callExtensionGetter_hasKey ((const cPtr_implementation *) ioArgument_implementation.ptr (), var_objectName_3977.getter_string (SOURCE_FILE ("implementation_parser.galgas", 160)), inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 160)).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_implementation_5F_list_i5_ (GALGAS_implementationObjectMap & ioArgument_objectAttributes,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = ioArgument_objectAttributes.getter_hasKey (var_attributeName_5239.getter_string (SOURCE_FILE ("implementation_parser.galgas", 191)) COMMA_SOURCE_FILE ("implementation_parser.galgas", 191)).boolEnum () ;
        if (kBoolTrue == test_1) {
          ...
          if (kBoolTrue == test_2) {
            test_2 = var_previousType_5394.getter_multiple (SOURCE_FILE ("implementation_parser.galgas", 196)).boolEnum () ;
            if (kBoolTrue == test_2) {
              ...
              if (kBoolTrue == test_3) {
                test_3 = GALGAS_bool (var_previousDefaultValue_5740.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_multipleAttribute).boolEnum () ;
                if (kBoolTrue == test_3) {
              ...
              if (kBoolFalse == test_3) {
                ...
                if (kBoolTrue == test_4) {
                  test_4 = GALGAS_bool (var_defaultValue_5804.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_multipleAttribute).boolEnum () ;
                  if (kBoolTrue == test_4) {
                    var_oneIsMultiple_5857 = GALGAS_bool (true) ;
                  }
                }
              ...
              if (kBoolTrue == test_5) {
                test_5 = var_oneIsMultiple_5857.boolEnum () ;
                if (kBoolTrue == test_5) {
                  ...
                  if (var_defaultValue_5804.isValid ()) {
                    if (var_defaultValue_5804.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_multipleAttribute) {
                      ...
                      if (kBoolTrue == test_6) {
                        test_6 = GALGAS_bool (kIsEqual, var_desc_6315.getter_string (SOURCE_FILE ("implementation_parser.galgas", 227)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                        if (kBoolTrue == test_6) {
                      ...
                      if (kBoolTrue == test_7) {
                        test_7 = GALGAS_bool (kIsEqual, var_location_6361.objectCompare (GALGAS_location::constructor_nowhere (SOURCE_FILE ("implementation_parser.galgas", 230)))).boolEnum () ;
                        if (kBoolTrue == test_7) {
                  ...
                  callExtensionSetter_setDefValue ((cPtr_impType *) ptr_7222, var_newDefault_7116, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 239)) ;
                  }
                  {
                  GALGAS_impType joker_7299 ; // Joker input parameter
                  ioArgument_objectAttributes.setter_del (var_attributeName_5239, joker_7299, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 241)) ;
                  }
                  {
          ...
          if (kBoolTrue == test_8) {
            test_8 = function_checkNewTypeWithinPreviousType (var_attributeName_5239, var_previousType_5394, var_type_5257, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 246)).boolEnum () ;
            if (kBoolTrue == test_8) {
              {
              GALGAS_impType joker_7585 ; // Joker input parameter
              ioArgument_objectAttributes.setter_del (var_attributeName_5239, joker_7585, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 249)) ;
              }
              {
      ...
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__3B_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 255)) ;
    } break ;
    case 3: {
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_implementation_5F_type_i6_ (GALGAS_lstring & outArgument_attributeName,
  ...
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_UINT_33__32_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 265)) ;
  ...
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_INT_33__32_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 267)) ;
  ...
  case 3: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_UINT_36__34_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 269)) ;
  ...
  case 4: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_INT_36__34_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 271)) ;
  ...
  case 5: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_FLOAT COMMA_SOURCE_FILE ("implementation_parser.galgas", 273)) ;
  ...
  case 6: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_ENUM COMMA_SOURCE_FILE ("implementation_parser.galgas", 275)) ;
    nt_enum_5F_options_ (outArgument_attributeName, outArgument_type, inCompiler) ;
  } break ;
  case 7: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_BOOLEAN COMMA_SOURCE_FILE ("implementation_parser.galgas", 277)) ;
    nt_boolean_5F_options_ (outArgument_attributeName, outArgument_type, inCompiler) ;
  } break ;
  case 8: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_STRING COMMA_SOURCE_FILE ("implementation_parser.galgas", 279)) ;
    nt_string_5F_options_ (outArgument_attributeName, outArgument_type, inCompiler) ;
  } break ;
  case 9: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_IDENTIFIER COMMA_SOURCE_FILE ("implementation_parser.galgas", 281)) ;
  ...
  case 10: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_STRUCT COMMA_SOURCE_FILE ("implementation_parser.galgas", 283)) ;
    nt_struct_5F_options_ (outArgument_attributeName, outArgument_type, inCompiler) ;
  } break ;
  case 11: {
    GALGAS_lstring var_typeName_8600 ;
    var_typeName_8600 = inCompiler->synthetizedAttribute_att_5F_token () ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_idf COMMA_SOURCE_FILE ("implementation_parser.galgas", 285)) ;
    nt_objref_5F_option_ (outArgument_attributeName, outArgument_type, var_typeName_8600, inCompiler) ;
  } break ;
  default:
    break ;
  }
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_struct_5F_options_i7_ (GALGAS_lstring & outArgument_name,
  ...
  GALGAS_implementationObjectMap var_structAttributes_8756 = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_parser.galgas", 292)) ;
  switch (select_implementation_5F_parser_8 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 294)) ;
    nt_implementation_5F_list_ (var_structAttributes_8756, inCompiler) ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 296)) ;
  } break ;
  case 2: {
  } break ;
  default:
  ...
  GALGAS_bool var_multiple_8924 ;
  nt_multiple_ (var_multiple_8924, inCompiler) ;
  GALGAS_lstring var_description_8970 ;
  nt_description_ (var_description_8970, inCompiler) ;
  ...
  temp_1.addAssign_operation (var_description_8970  COMMA_SOURCE_FILE ("implementation_parser.galgas", 303)) ;
  outArgument_options = GALGAS_impStructType::constructor_new (temp_0, GALGAS_dataType::constructor_structType (SOURCE_FILE ("implementation_parser.galgas", 303)), outArgument_name, var_multiple_8924, temp_1, var_structAttributes_8756  COMMA_SOURCE_FILE ("implementation_parser.galgas", 303)) ;
}
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_objref_5F_option_i8_ (GALGAS_lstring & outArgument_name,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsNotEqual, inArgument_ref.getter_string (SOURCE_FILE ("implementation_parser.galgas", 310)).getter_rightSubString (GALGAS_uint ((uint32_t) 5U) COMMA_SOURCE_FILE ("implementation_parser.galgas", 310)).objectCompare (GALGAS_string ("_TYPE"))).boolEnum () ;
    if (kBoolTrue == test_0) {
  ...
  nt_identifier_5F_or_5F_attribute_ (outArgument_name, inCompiler) ;
  GALGAS_bool var_multiple_9471 ;
  nt_multiple_ (var_multiple_9471, inCompiler) ;
  GALGAS_lstring var_description_9517 ;
  nt_description_ (var_description_9517, inCompiler) ;
  ...
  temp_3.addAssign_operation (var_description_9517  COMMA_SOURCE_FILE ("implementation_parser.galgas", 320)) ;
  outArgument_options = GALGAS_refType::constructor_new (temp_2, GALGAS_dataType::constructor_objectType (SOURCE_FILE ("implementation_parser.galgas", 320)), outArgument_name, var_multiple_9471, temp_3, inArgument_ref  COMMA_SOURCE_FILE ("implementation_parser.galgas", 320)) ;
}
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_string_5F_options_i9_ (GALGAS_lstring & outArgument_name,
  ...
  outArgument_name.drop () ; // Release 'out' argument
  outArgument_options.drop () ; // Release 'out' argument
  GALGAS_bool var_withAuto_9738 ;
  nt_with_5F_auto_ (var_withAuto_9738, inCompiler) ;
  nt_identifier_5F_or_5F_attribute_ (outArgument_name, inCompiler) ;
  GALGAS_bool var_multiple_9813 ;
  nt_multiple_ (var_multiple_9813, inCompiler) ;
  GALGAS_object_5F_t var_defaultValue_9861 ;
  GALGAS_lstring var_oil_5F_desc_9881 ;
  switch (select_implementation_5F_parser_9 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 335)) ;
    switch (select_implementation_5F_parser_10 (inCompiler)) {
    case 1: {
      GALGAS_lstring var_stringValue_9950 = inCompiler->synthetizedAttribute_a_5F_string () ;
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_string COMMA_SOURCE_FILE ("implementation_parser.galgas", 337)) ;
      nt_description_ (var_oil_5F_desc_9881, inCompiler) ;
      GALGAS_object_5F_t var_val_10000 = GALGAS_stringAttribute::constructor_new (var_oil_5F_desc_9881, var_stringValue_9950.getter_location (SOURCE_FILE ("implementation_parser.galgas", 339)), var_stringValue_9950.getter_string (SOURCE_FILE ("implementation_parser.galgas", 339))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 339)) ;
      enumGalgasBool test_0 = kBoolTrue ;
      if (kBoolTrue == test_0) {
        test_0 = var_multiple_9813.boolEnum () ;
        if (kBoolTrue == test_0) {
          var_defaultValue_9861 = GALGAS_multipleAttribute::constructor_new (var_oil_5F_desc_9881, var_stringValue_9950.getter_location (SOURCE_FILE ("implementation_parser.galgas", 341)), GALGAS_identifierList::constructor_listWithValue (var_val_10000  COMMA_SOURCE_FILE ("implementation_parser.galgas", 341))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 341)) ;
        }
      }
      if (kBoolFalse == test_0) {
        var_defaultValue_9861 = var_val_10000 ;
      }
    } break ;
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_AUTO COMMA_SOURCE_FILE ("implementation_parser.galgas", 346)) ;
      nt_description_ (var_oil_5F_desc_9881, inCompiler) ;
      var_defaultValue_9861 = GALGAS_auto::constructor_new (var_oil_5F_desc_9881, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 348))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 348)) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_NO_5F_DEFAULT COMMA_SOURCE_FILE ("implementation_parser.galgas", 350)) ;
      nt_description_ (var_oil_5F_desc_9881, inCompiler) ;
      var_defaultValue_9861 = GALGAS_void::constructor_new (var_oil_5F_desc_9881, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 352))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 352)) ;
    } break ;
    default:
      break ;
    }
  ...
  case 2: {
    nt_description_ (var_oil_5F_desc_9881, inCompiler) ;
    var_defaultValue_9861 = GALGAS_void::constructor_new (var_oil_5F_desc_9881, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 356))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 356)) ;
  } break ;
  default:
    break ;
  }
  ...
  temp_2.addAssign_operation (var_oil_5F_desc_9881  COMMA_SOURCE_FILE ("implementation_parser.galgas", 358)) ;
  outArgument_options = GALGAS_impAutoDefaultType::constructor_new (temp_1, GALGAS_dataType::constructor_string (SOURCE_FILE ("implementation_parser.galgas", 358)), outArgument_name, var_multiple_9813, temp_2, var_withAuto_9738, var_defaultValue_9861  COMMA_SOURCE_FILE ("implementation_parser.galgas", 358)) ;
}
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_boolean_5F_options_i10_ (GALGAS_lstring & outArgument_name,
  ...
  outArgument_name.drop () ; // Release 'out' argument
  outArgument_options.drop () ; // Release 'out' argument
  GALGAS_bool var_withAuto_10818 ;
  nt_with_5F_auto_ (var_withAuto_10818, inCompiler) ;
  GALGAS_implementationObjectMap var_trueSubAttributes_10866 = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_parser.galgas", 366)) ;
  GALGAS_implementationObjectMap var_falseSubAttributes_10928 = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_parser.galgas", 367)) ;
  switch (select_implementation_5F_parser_11 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 369)) ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_TRUE COMMA_SOURCE_FILE ("implementation_parser.galgas", 370)) ;
    switch (select_implementation_5F_parser_12 (inCompiler)) {
    case 1: {
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 372)) ;
      nt_implementation_5F_list_ (var_trueSubAttributes_10866, inCompiler) ;
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 374)) ;
    } break ;
    case 2: {
      var_trueSubAttributes_10866 = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_parser.galgas", 376)) ;
    } break ;
    default:
      break ;
    }
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 378)) ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_FALSE COMMA_SOURCE_FILE ("implementation_parser.galgas", 379)) ;
    switch (select_implementation_5F_parser_13 (inCompiler)) {
    case 1: {
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 381)) ;
      nt_implementation_5F_list_ (var_falseSubAttributes_10928, inCompiler) ;
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 383)) ;
    } break ;
    case 2: {
      var_falseSubAttributes_10928 = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_parser.galgas", 385)) ;
    } break ;
    default:
      break ;
    }
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 387)) ;
  } break ;
  case 2: {
  } break ;
  default:
  ...
  nt_identifier_5F_or_5F_attribute_ (outArgument_name, inCompiler) ;
  GALGAS_bool var_multiple_11395 ;
  nt_multiple_ (var_multiple_11395, inCompiler) ;
  GALGAS_object_5F_t var_defaultValue_11443 ;
  GALGAS_lstring var_oil_5F_desc_11463 ;
  switch (select_implementation_5F_parser_14 (inCompiler)) {
  case 1: {
    GALGAS_lbool var_boolValue_11493 ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 396)) ;
    nt_boolean_ (var_boolValue_11493, inCompiler) ;
    nt_description_ (var_oil_5F_desc_11463, inCompiler) ;
    var_defaultValue_11443 = GALGAS_boolAttribute::constructor_new (var_oil_5F_desc_11463, var_boolValue_11493.getter_location (SOURCE_FILE ("implementation_parser.galgas", 398)), var_boolValue_11493.getter_bool (SOURCE_FILE ("implementation_parser.galgas", 398)), GALGAS_objectAttributes::constructor_new (GALGAS_identifierMap::constructor_emptyMap (SOURCE_FILE ("implementation_parser.galgas", 398))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 398))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 398)) ;
  } break ;
  case 2: {
    nt_description_ (var_oil_5F_desc_11463, inCompiler) ;
    var_defaultValue_11443 = GALGAS_void::constructor_new (var_oil_5F_desc_11463, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 401))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 401)) ;
  } break ;
  default:
    break ;
  }
  ...
  temp_1.addAssign_operation (var_oil_5F_desc_11463  COMMA_SOURCE_FILE ("implementation_parser.galgas", 403)) ;
  outArgument_options = GALGAS_impBoolType::constructor_new (temp_0, GALGAS_dataType::constructor_boolean (SOURCE_FILE ("implementation_parser.galgas", 403)), outArgument_name, var_multiple_11395, temp_1, var_withAuto_10818, var_defaultValue_11443, var_trueSubAttributes_10866, var_falseSubAttributes_10928  COMMA_SOURCE_FILE ("implementation_parser.galgas", 403)) ;
}
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_enum_5F_item_i11_ (GALGAS_enumValues & ioArgument_items,
                                                                                        C_Lexique_goil_5F_lexique * inCompiler) {
  GALGAS_lstring var_enumItem_12020 ;
  GALGAS_implementationObjectMap var_subAttributes_12040 = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_parser.galgas", 409)) ;
  nt_identifier_5F_or_5F_enum_5F_value_ (var_enumItem_12020, inCompiler) ;
  switch (select_implementation_5F_parser_15 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 412)) ;
    nt_implementation_5F_list_ (var_subAttributes_12040, inCompiler) ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 414)) ;
  } break ;
  case 2: {
  } break ;
  default:
  ...
  {
  ioArgument_items.setter_put (var_enumItem_12020, var_subAttributes_12040, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 416)) ;
  }
}
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_enum_5F_options_i12_ (GALGAS_lstring & outArgument_name,
  ...
  outArgument_name.drop () ; // Release 'out' argument
  outArgument_options.drop () ; // Release 'out' argument
  GALGAS_bool var_withAuto_12312 ;
  nt_with_5F_auto_ (var_withAuto_12312, inCompiler) ;
  GALGAS_enumValues var_items_12348 = GALGAS_enumValues::constructor_emptyMap (SOURCE_FILE ("implementation_parser.galgas", 424)) ;
  inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 425)) ;
  nt_enum_5F_item_ (var_items_12348, inCompiler) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_implementation_5F_parser_16 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 429)) ;
      nt_enum_5F_item_ (var_items_12348, inCompiler) ;
    } break ;
    default:
      repeatFlag_0 = false ;
  ...
  inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 431)) ;
  nt_identifier_5F_or_5F_attribute_ (outArgument_name, inCompiler) ;
  GALGAS_bool var_multiple_12508 ;
  nt_multiple_ (var_multiple_12508, inCompiler) ;
  GALGAS_lstring var_oil_5F_desc_12551 ;
  GALGAS_object_5F_t var_defaultValue_12576 ;
  switch (select_implementation_5F_parser_17 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 438)) ;
    switch (select_implementation_5F_parser_18 (inCompiler)) {
    case 1: {
      GALGAS_lstring var_stringValue_12631 ;
      var_stringValue_12631 = inCompiler->synthetizedAttribute_att_5F_token () ;
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_idf COMMA_SOURCE_FILE ("implementation_parser.galgas", 441)) ;
      nt_description_ (var_oil_5F_desc_12551, inCompiler) ;
      GALGAS_object_5F_t var_val_12706 = GALGAS_enumAttribute::constructor_new (var_oil_5F_desc_12551, var_stringValue_12631.getter_location (SOURCE_FILE ("implementation_parser.galgas", 443)), var_stringValue_12631.getter_string (SOURCE_FILE ("implementation_parser.galgas", 443)), GALGAS_objectAttributes::constructor_new (GALGAS_identifierMap::constructor_emptyMap (SOURCE_FILE ("implementation_parser.galgas", 443))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 443))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 443)) ;
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = var_multiple_12508.boolEnum () ;
        if (kBoolTrue == test_1) {
          var_defaultValue_12576 = GALGAS_multipleAttribute::constructor_new (var_oil_5F_desc_12551, var_stringValue_12631.getter_location (SOURCE_FILE ("implementation_parser.galgas", 445)), GALGAS_identifierList::constructor_listWithValue (var_val_12706  COMMA_SOURCE_FILE ("implementation_parser.galgas", 445))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 445)) ;
        }
      }
      if (kBoolFalse == test_1) {
        var_defaultValue_12576 = var_val_12706 ;
      }
    } break ;
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_AUTO COMMA_SOURCE_FILE ("implementation_parser.galgas", 450)) ;
      nt_description_ (var_oil_5F_desc_12551, inCompiler) ;
      var_defaultValue_12576 = GALGAS_auto::constructor_new (var_oil_5F_desc_12551, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 452))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 452)) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_NO_5F_DEFAULT COMMA_SOURCE_FILE ("implementation_parser.galgas", 454)) ;
      nt_description_ (var_oil_5F_desc_12551, inCompiler) ;
      var_defaultValue_12576 = GALGAS_void::constructor_new (var_oil_5F_desc_12551, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 456))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 456)) ;
    } break ;
    default:
      break ;
    }
  ...
  case 2: {
    nt_description_ (var_oil_5F_desc_12551, inCompiler) ;
    var_defaultValue_12576 = GALGAS_void::constructor_new (var_oil_5F_desc_12551, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 460))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 460)) ;
  } break ;
  default:
    break ;
  }
  ...
  temp_3.addAssign_operation (var_oil_5F_desc_12551  COMMA_SOURCE_FILE ("implementation_parser.galgas", 462)) ;
  outArgument_options = GALGAS_impEnumType::constructor_new (temp_2, GALGAS_dataType::constructor_enumeration (SOURCE_FILE ("implementation_parser.galgas", 462)), outArgument_name, var_multiple_12508, temp_3, var_withAuto_12312, var_defaultValue_12576, var_items_12348  COMMA_SOURCE_FILE ("implementation_parser.galgas", 462)) ;
  {
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_number_5F_options_i13_ (GALGAS_lstring & outArgument_name,
  ...
  outArgument_name.drop () ; // Release 'out' argument
  outArgument_options.drop () ; // Release 'out' argument
  GALGAS_bool var_withAuto_13629 ;
  nt_with_5F_auto_ (var_withAuto_13629, inCompiler) ;
  GALGAS_attributeRange var_range_13677 ;
  nt_range_ (var_range_13677, constinArgument_type, inCompiler) ;
  nt_identifier_5F_or_5F_attribute_ (outArgument_name, inCompiler) ;
  GALGAS_bool var_multiple_13751 ;
  nt_multiple_ (var_multiple_13751, inCompiler) ;
  GALGAS_lstring var_oil_5F_desc_13794 ;
  GALGAS_object_5F_t var_defaultValue_13819 ;
  switch (select_implementation_5F_parser_19 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 480)) ;
    switch (select_implementation_5F_parser_20 (inCompiler)) {
    case 1: {
      GALGAS_object_5F_t var_val_13883 ;
      nt_int_5F_or_5F_float_ (var_val_13883, constinArgument_type, inCompiler) ;
      var_oil_5F_desc_13794 = var_val_13883.getter_oil_5F_desc (SOURCE_FILE ("implementation_parser.galgas", 483)) ;
      enumGalgasBool test_0 = kBoolTrue ;
      if (kBoolTrue == test_0) {
        test_0 = var_multiple_13751.boolEnum () ;
        if (kBoolTrue == test_0) {
          var_defaultValue_13819 = GALGAS_multipleAttribute::constructor_new (var_oil_5F_desc_13794, var_val_13883.getter_location (SOURCE_FILE ("implementation_parser.galgas", 485)), GALGAS_identifierList::constructor_listWithValue (var_val_13883  COMMA_SOURCE_FILE ("implementation_parser.galgas", 485))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 485)) ;
        }
      }
      if (kBoolFalse == test_0) {
        var_defaultValue_13819 = var_val_13883 ;
      }
    } break ;
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_NO_5F_DEFAULT COMMA_SOURCE_FILE ("implementation_parser.galgas", 490)) ;
      nt_description_ (var_oil_5F_desc_13794, inCompiler) ;
      var_defaultValue_13819 = GALGAS_void::constructor_new (var_oil_5F_desc_13794, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 492))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 492)) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_AUTO COMMA_SOURCE_FILE ("implementation_parser.galgas", 494)) ;
      nt_description_ (var_oil_5F_desc_13794, inCompiler) ;
      var_defaultValue_13819 = GALGAS_auto::constructor_new (var_oil_5F_desc_13794, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 496))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 496)) ;
    } break ;
    default:
      break ;
    }
  ...
  case 2: {
    nt_description_ (var_oil_5F_desc_13794, inCompiler) ;
    var_defaultValue_13819 = GALGAS_void::constructor_new (var_oil_5F_desc_13794, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 500))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 500)) ;
  } break ;
  default:
    break ;
  }
  ...
  temp_2.addAssign_operation (var_oil_5F_desc_13794  COMMA_SOURCE_FILE ("implementation_parser.galgas", 502)) ;
  outArgument_options = GALGAS_impRangedType::constructor_new (temp_1, constinArgument_type, outArgument_name, var_multiple_13751, temp_2, var_withAuto_13629, var_defaultValue_13819, var_range_13677  COMMA_SOURCE_FILE ("implementation_parser.galgas", 502)) ;
}
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_type_5F_options_i14_ (GALGAS_lstring & outArgument_name,
  ...
  outArgument_name.drop () ; // Release 'out' argument
  outArgument_options.drop () ; // Release 'out' argument
  GALGAS_bool var_withAuto_14659 ;
  nt_with_5F_auto_ (var_withAuto_14659, inCompiler) ;
  nt_identifier_5F_or_5F_attribute_ (outArgument_name, inCompiler) ;
  GALGAS_bool var_multiple_14734 ;
  nt_multiple_ (var_multiple_14734, inCompiler) ;
  GALGAS_object_5F_t var_defaultValue_14782 ;
  GALGAS_lstring var_oil_5F_desc_14802 ;
  switch (select_implementation_5F_parser_21 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 517)) ;
    switch (select_implementation_5F_parser_22 (inCompiler)) {
    case 1: {
      GALGAS_lstring var_ident_14851 ;
      nt_identifier_5F_or_5F_attribute_ (var_ident_14851, inCompiler) ;
      nt_description_ (var_oil_5F_desc_14802, inCompiler) ;
      GALGAS_object_5F_t var_val_14940 = GALGAS_stringAttribute::constructor_new (var_oil_5F_desc_14802, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 522)), var_ident_14851.getter_string (SOURCE_FILE ("implementation_parser.galgas", 522))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 522)) ;
      enumGalgasBool test_0 = kBoolTrue ;
      if (kBoolTrue == test_0) {
        test_0 = var_multiple_14734.boolEnum () ;
        if (kBoolTrue == test_0) {
          var_defaultValue_14782 = GALGAS_multipleAttribute::constructor_new (var_oil_5F_desc_14802, var_val_14940.getter_location (SOURCE_FILE ("implementation_parser.galgas", 524)), GALGAS_identifierList::constructor_listWithValue (var_val_14940  COMMA_SOURCE_FILE ("implementation_parser.galgas", 524))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 524)) ;
        }
      }
      if (kBoolFalse == test_0) {
        var_defaultValue_14782 = var_val_14940 ;
      }
    } break ;
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_NO_5F_DEFAULT COMMA_SOURCE_FILE ("implementation_parser.galgas", 529)) ;
      nt_description_ (var_oil_5F_desc_14802, inCompiler) ;
      var_defaultValue_14782 = GALGAS_void::constructor_new (var_oil_5F_desc_14802, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 531))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 531)) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_AUTO COMMA_SOURCE_FILE ("implementation_parser.galgas", 533)) ;
      nt_description_ (var_oil_5F_desc_14802, inCompiler) ;
      var_defaultValue_14782 = GALGAS_auto::constructor_new (var_oil_5F_desc_14802, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 535))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 535)) ;
    } break ;
    default:
      break ;
    }
  ...
  case 2: {
    nt_description_ (var_oil_5F_desc_14802, inCompiler) ;
    var_defaultValue_14782 = GALGAS_void::constructor_new (var_oil_5F_desc_14802, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 539))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 539)) ;
  } break ;
  default:
    break ;
  }
  ...
  temp_2.addAssign_operation (var_oil_5F_desc_14802  COMMA_SOURCE_FILE ("implementation_parser.galgas", 541)) ;
  outArgument_options = GALGAS_impAutoDefaultType::constructor_new (temp_1, constinArgument_type, outArgument_name, var_multiple_14734, temp_2, var_withAuto_14659, var_defaultValue_14782  COMMA_SOURCE_FILE ("implementation_parser.galgas", 541)) ;
}
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_with_5F_auto_i15_ (GALGAS_bool & outArgument_withAuto,
  ...
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_WITH_5F_AUTO COMMA_SOURCE_FILE ("implementation_parser.galgas", 547)) ;
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_int_5F_or_5F_float_i16_ (GALGAS_object_5F_t & outArgument_num,
  ...
  GALGAS_bool var_signed_15836 ;
  nt_sign_ (var_signed_15836, inCompiler) ;
  switch (select_implementation_5F_parser_24 (inCompiler)) {
  case 1: {
    GALGAS_luint_36__34_ var_number_15882 ;
    var_number_15882 = inCompiler->synthetizedAttribute_integerNumber () ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_uint_5F_number COMMA_SOURCE_FILE ("implementation_parser.galgas", 560)) ;
    GALGAS_lstring var_oil_5F_desc_15950 ;
    nt_description_ (var_oil_5F_desc_15950, inCompiler) ;
    outArgument_num = function_checkAndGetIntegerNumber (var_oil_5F_desc_15950, constinArgument_type, var_number_15882, var_signed_15836, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 562)) ;
  } break ;
  case 2: {
    GALGAS_ldouble var_number_16043 ;
    var_number_16043 = inCompiler->synthetizedAttribute_floatNumber () ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_float_5F_number COMMA_SOURCE_FILE ("implementation_parser.galgas", 565)) ;
    GALGAS_lstring var_oil_5F_desc_16111 ;
    nt_description_ (var_oil_5F_desc_16111, inCompiler) ;
    outArgument_num = function_checkAndGetFloatNumber (var_oil_5F_desc_16111, constinArgument_type, var_number_16043, var_signed_15836, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 567)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_set_5F_followup_i17_ (GALGAS_numberList & ioArgument_numbers,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 576)) ;
      GALGAS_object_5F_t var_num_16297 ;
      nt_int_5F_or_5F_float_ (var_num_16297, constinArgument_type, inCompiler) ;
      ioArgument_numbers.addAssign_operation (GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 579)), var_num_16297  COMMA_SOURCE_FILE ("implementation_parser.galgas", 579)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_range_5F_content_i18_ (GALGAS_attributeRange & outArgument_range,
  ...
  GALGAS_object_5F_t var_start_16460 = GALGAS_void::constructor_new (function_emptyLString (inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 586)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 586))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 586)) ;
  GALGAS_object_5F_t var_stop_16525 = GALGAS_void::constructor_new (function_emptyLString (inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 587)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 587))  COMMA_SOURCE_FILE ("implementation_parser.galgas", 587)) ;
  GALGAS_bool var_signed_16588 ;
  nt_sign_ (var_signed_16588, inCompiler) ;
  switch (select_implementation_5F_parser_26 (inCompiler)) {
  case 1: {
    GALGAS_luint_36__34_ var_number_16634 ;
    var_number_16634 = inCompiler->synthetizedAttribute_integerNumber () ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_set_5F_start_5F_uint_5F_number COMMA_SOURCE_FILE ("implementation_parser.galgas", 592)) ;
    var_start_16460 = function_checkAndGetIntegerNumber (function_emptyLString (inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 593)), constinArgument_type, var_number_16634, var_signed_16588, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 593)) ;
    nt_int_5F_or_5F_float_ (var_stop_16525, constinArgument_type, inCompiler) ;
    outArgument_range = function_buildRange (constinArgument_type, var_start_16460, var_stop_16525, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 595)) ;
  } break ;
  case 2: {
    GALGAS_luint_36__34_ var_number_16845 ;
    var_number_16845 = inCompiler->synthetizedAttribute_integerNumber () ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_uint_5F_number COMMA_SOURCE_FILE ("implementation_parser.galgas", 598)) ;
    var_start_16460 = function_checkAndGetIntegerNumber (function_emptyLString (inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 599)), constinArgument_type, var_number_16845, var_signed_16588, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 599)) ;
    switch (select_implementation_5F_parser_27 (inCompiler)) {
    case 1: {
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__2E__2E_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 601)) ;
      nt_int_5F_or_5F_float_ (var_stop_16525, constinArgument_type, inCompiler) ;
      outArgument_range = function_buildRange (constinArgument_type, var_start_16460, var_stop_16525, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 602)) ;
    } break ;
    case 2: {
      GALGAS_numberList var_numbers_17074 = GALGAS_numberList::constructor_listWithValue (GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 604)), var_start_16460  COMMA_SOURCE_FILE ("implementation_parser.galgas", 604)) ;
      nt_set_5F_followup_ (var_numbers_17074, constinArgument_type, inCompiler) ;
      outArgument_range = function_attributeRangeWithNumberList (var_numbers_17074, constinArgument_type, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 606)) ;
    } break ;
    default:
      break ;
    }
  ...
  case 3: {
    GALGAS_ldouble var_number_17258 ;
    var_number_17258 = inCompiler->synthetizedAttribute_floatNumber () ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_float_5F_number COMMA_SOURCE_FILE ("implementation_parser.galgas", 610)) ;
    var_start_16460 = function_checkAndGetFloatNumber (function_emptyLString (inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 611)), constinArgument_type, var_number_17258, var_signed_16588, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 611)) ;
    switch (select_implementation_5F_parser_28 (inCompiler)) {
    case 1: {
      inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__2E__2E_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 613)) ;
      nt_int_5F_or_5F_float_ (var_stop_16525, constinArgument_type, inCompiler) ;
      outArgument_range = function_buildRange (constinArgument_type, var_start_16460, var_stop_16525, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 614)) ;
    } break ;
    case 2: {
      GALGAS_numberList var_numbers_17486 = GALGAS_numberList::constructor_listWithValue (GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_parser.galgas", 616)), var_start_16460  COMMA_SOURCE_FILE ("implementation_parser.galgas", 616)) ;
      nt_set_5F_followup_ (var_numbers_17486, constinArgument_type, inCompiler) ;
      outArgument_range = function_attributeRangeWithNumberList (var_numbers_17486, constinArgument_type, inCompiler COMMA_SOURCE_FILE ("implementation_parser.galgas", 618)) ;
    } break ;
    default:
      break ;
    }
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_range_i19_ (GALGAS_attributeRange & outArgument_range,
  ...
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 627)) ;
    nt_range_5F_content_ (outArgument_range, constinArgument_rangeType, inCompiler) ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 627)) ;
  } break ;
  case 2: {
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_multiple_i20_ (GALGAS_bool & outArgument_multi,
  ...
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 636)) ;
    inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("implementation_parser.galgas", 636)) ;
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_identifier_5F_or_5F_attribute_i21_ (GALGAS_lstring & outArgument_name,
  ...
  inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_idf COMMA_SOURCE_FILE ("implementation_parser.galgas", 645)) ;
}
...
void cParser_implementation_5F_parser::rule_implementation_5F_parser_identifier_5F_or_5F_enum_5F_value_i22_ (GALGAS_lstring & outArgument_name,
  ...
  outArgument_name.drop () ; // Release 'out' argument
  outArgument_name = inCompiler->synthetizedAttribute_att_5F_token () ;
  inCompiler->acceptTerminal (C_Lexique_goil_5F_lexique::kToken_idf COMMA_SOURCE_FILE ("implementation_parser.galgas", 653)) ;
}
