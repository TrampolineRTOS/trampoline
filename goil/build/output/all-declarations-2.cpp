...
GALGAS_enumValues extensionGetter_mergeWithEnum (const GALGAS_enumValues & inObject,
  ...
  result_mergedEnum = GALGAS_enumValues::constructor_emptyMap (SOURCE_FILE ("implementation_types.galgas", 737)) ;
  const GALGAS_enumValues temp_0 = inObject ;
  cEnumerator_enumValues enumerator_20466 (temp_0, kENUMERATION_UP) ;
  while (enumerator_20466.hasCurrentObject ()) {
    GALGAS_implementationObjectMap var_attributes_20509 = enumerator_20466.current_subAttributes (HERE) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = constinArgument_enumToMerge.getter_hasKey (enumerator_20466.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 740)) COMMA_SOURCE_FILE ("implementation_types.galgas", 740)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_implementationObjectMap var_attributesToMerge_20646 ;
        constinArgument_enumToMerge.method_get (enumerator_20466.current_lkey (HERE), var_attributesToMerge_20646, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 741)) ;
        var_attributes_20509 = extensionGetter_mergeImplementationObjectAttributesWith (enumerator_20466.current_subAttributes (HERE), var_attributesToMerge_20646, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 742)) ;
      }
    }
    {
    result_mergedEnum.setter_put (enumerator_20466.current_lkey (HERE), var_attributes_20509, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 744)) ;
    }
    enumerator_20466.gotoNextObject () ;
  }
  cEnumerator_enumValues enumerator_20820 (constinArgument_enumToMerge, kENUMERATION_UP) ;
  while (enumerator_20820.hasCurrentObject ()) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      const GALGAS_enumValues temp_3 = inObject ;
      test_2 = temp_3.getter_hasKey (enumerator_20820.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 747)) COMMA_SOURCE_FILE ("implementation_types.galgas", 747)).operator_not (SOURCE_FILE ("implementation_types.galgas", 747)).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        result_mergedEnum.setter_put (enumerator_20820.current_lkey (HERE), enumerator_20820.current_subAttributes (HERE), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 748)) ;
        }
      }
    }
    enumerator_20820.gotoNextObject () ;
  }
//---
...
static GALGAS_bool extensionGetter_implementation_hasKey (const cPtr_implementation * inObject,
  ...
  result_result = object->mProperty_imp.getter_hasKey (constinArgument_key COMMA_SOURCE_FILE ("implementation_types.galgas", 806)) ;
//---
...
static GALGAS_bool extensionGetter_implementation_hasLKey (const cPtr_implementation * inObject,
  ...
  const cPtr_implementation * object = inObject ;
  macroValidSharedObject (object, cPtr_implementation) ;
  result_result = object->mProperty_imp.getter_hasKey (constinArgument_key.getter_string (SOURCE_FILE ("implementation_types.galgas", 812)) COMMA_SOURCE_FILE ("implementation_types.galgas", 812)) ;
//---
  return result_result ;
}
...
static GALGAS_implementationObject extensionGetter_implementation_impObject (const cPtr_implementation * inObject,
  ...
  const cPtr_implementation * object = inObject ;
  macroValidSharedObject (object, cPtr_implementation) ;
  result_obj = GALGAS_implementationObject::constructor_new (GALGAS_lbool::constructor_new (GALGAS_bool (false), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 818))  COMMA_SOURCE_FILE ("implementation_types.galgas", 818)), GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_types.galgas", 818))  COMMA_SOURCE_FILE ("implementation_types.galgas", 818)) ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = object->mProperty_imp.getter_hasKey (constinArgument_objKind COMMA_SOURCE_FILE ("implementation_types.galgas", 819)).boolEnum () ;
    if (kBoolTrue == test_0) {
      object->mProperty_imp.method_get (function_lstringWith (constinArgument_objKind, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 820)), result_obj, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 820)) ;
    }
  }
//---
  return result_obj ;
...
static void extensionMethod_implementation_checkTypeForKind (const cPtr_implementation * inObject,
  ...
  GALGAS_implementationObject var_obj_22798 = callExtensionGetter_impObject ((const cPtr_implementation *) temp_0.ptr (), constinArgument_objKind, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 828)) ;
  {
  routine_checkTypeForAttribute (var_obj_22798.getter_attributes (SOURCE_FILE ("implementation_types.galgas", 829)), constinArgument_attributeName, constinArgument_expectedType, inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 829)) ;
  }
}
//----------------------------------------------------------------------------------------------------------------------
...
static void extensionMethod_implementation_checkObjectReferences (const cPtr_implementation * inObject,
  ...
  const cPtr_implementation * object = inObject ;
  macroValidSharedObject (object, cPtr_implementation) ;
  cEnumerator_implementationMap enumerator_22967 (object->mProperty_imp, kENUMERATION_UP) ;
  while (enumerator_22967.hasCurrentObject ()) {
    cEnumerator_implementationObjectMap enumerator_23002 (enumerator_22967.current_obj (HERE).getter_attributes (SOURCE_FILE ("implementation_types.galgas", 834)), kENUMERATION_UP) ;
    while (enumerator_23002.hasCurrentObject ()) {
      const GALGAS_implementation temp_0 = object ;
      callExtensionMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_23002.current_type (HERE).ptr (), temp_0, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 835)) ;
...
GALGAS_implementationObjectMap extensionGetter_mergeImplementationObjectAttributesWith (const GALGAS_implementationObjectMap & inObject,
  ...
  result_mergedAttributes = GALGAS_implementationObjectMap::constructor_emptyMap (SOURCE_FILE ("implementation_types.galgas", 1057)) ;
  const GALGAS_implementationObjectMap temp_0 = inObject ;
  cEnumerator_implementationObjectMap enumerator_30576 (temp_0, kENUMERATION_UP) ;
  while (enumerator_30576.hasCurrentObject ()) {
    GALGAS_impType var_merged_30599 = enumerator_30576.current_type (HERE) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = constinArgument_attributesToMerge.getter_hasKey (enumerator_30576.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 1060)) COMMA_SOURCE_FILE ("implementation_types.galgas", 1060)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_impType var_typeToMerge_30717 ;
        constinArgument_attributesToMerge.method_get (enumerator_30576.current_lkey (HERE), var_typeToMerge_30717, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1061)) ;
        enumGalgasBool test_2 = kBoolTrue ;
        if (kBoolTrue == test_2) {
          test_2 = GALGAS_bool (kIsEqual, enumerator_30576.current_type (HERE).getter_dynamicType (SOURCE_FILE ("implementation_types.galgas", 1062)).objectCompare (var_typeToMerge_30717.getter_dynamicType (SOURCE_FILE ("implementation_types.galgas", 1062)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            var_merged_30599 = callExtensionGetter_mergeWithType ((const cPtr_impType *) enumerator_30576.current_type (HERE).ptr (), var_typeToMerge_30717, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1063)) ;
          }
        }
        if (kBoolFalse == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (enumerator_30576.current_lkey (HERE).getter_location (SOURCE_FILE ("implementation_types.galgas", 1066)), GALGAS_string ("Redefined type"), fixItArray3  COMMA_SOURCE_FILE ("implementation_types.galgas", 1066)) ;
        }
      }
    }
    {
    result_mergedAttributes.setter_put (enumerator_30576.current_lkey (HERE), var_merged_30599, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1069)) ;
    }
    enumerator_30576.gotoNextObject () ;
  }
  cEnumerator_implementationObjectMap enumerator_31006 (constinArgument_attributesToMerge, kENUMERATION_UP) ;
  while (enumerator_31006.hasCurrentObject ()) {
    enumGalgasBool test_4 = kBoolTrue ;
    if (kBoolTrue == test_4) {
      const GALGAS_implementationObjectMap temp_5 = inObject ;
      test_4 = temp_5.getter_hasKey (enumerator_31006.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 1072)) COMMA_SOURCE_FILE ("implementation_types.galgas", 1072)).operator_not (SOURCE_FILE ("implementation_types.galgas", 1072)).boolEnum () ;
      if (kBoolTrue == test_4) {
        {
        result_mergedAttributes.setter_put (enumerator_31006.current_lkey (HERE), enumerator_31006.current_type (HERE), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1073)) ;
        }
      }
    }
