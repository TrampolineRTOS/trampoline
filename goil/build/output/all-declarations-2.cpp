...
GALGAS_enumValues extensionGetter_mergeWithEnum (const GALGAS_enumValues & inObject,
  ...
  cEnumerator_enumValues enumerator_20438 (temp_0, kENUMERATION_UP) ;
  while (enumerator_20438.hasCurrentObject ()) {
    GALGAS_implementationObjectMap var_attributes_20481 = enumerator_20438.current_subAttributes (HERE) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = constinArgument_enumToMerge.getter_hasKey (enumerator_20438.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 736)) COMMA_SOURCE_FILE ("implementation_types.galgas", 736)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_implementationObjectMap var_attributesToMerge_20618 ;
        constinArgument_enumToMerge.method_get (enumerator_20438.current_lkey (HERE), var_attributesToMerge_20618, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 737)) ;
        var_attributes_20481 = extensionGetter_mergeImplementationObjectAttributesWith (enumerator_20438.current_subAttributes (HERE), var_attributesToMerge_20618, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 738)) ;
      }
    }
    {
    result_mergedEnum.setter_put (enumerator_20438.current_lkey (HERE), var_attributes_20481, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 740)) ;
    }
    enumerator_20438.gotoNextObject () ;
  }
  cEnumerator_enumValues enumerator_20792 (constinArgument_enumToMerge, kENUMERATION_UP) ;
  while (enumerator_20792.hasCurrentObject ()) {
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      const GALGAS_enumValues temp_3 = inObject ;
      test_2 = temp_3.getter_hasKey (enumerator_20792.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 743)) COMMA_SOURCE_FILE ("implementation_types.galgas", 743)).operator_not (SOURCE_FILE ("implementation_types.galgas", 743)).boolEnum () ;
      if (kBoolTrue == test_2) {
        {
        result_mergedEnum.setter_put (enumerator_20792.current_lkey (HERE), enumerator_20792.current_subAttributes (HERE), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 744)) ;
        }
      }
    }
...
static GALGAS_implementationObject extensionGetter_implementation_impObject (const cPtr_implementation * inObject,
  ...
  if (kBoolTrue == test_0) {
    test_0 = object->mProperty_imp.getter_hasKey (constinArgument_objKind COMMA_SOURCE_FILE ("implementation_types.galgas", 815)).boolEnum () ;
    if (kBoolTrue == test_0) {
...
static void extensionMethod_implementation_checkTypeForKind (const cPtr_implementation * inObject,
  ...
  GALGAS_implementationObject var_obj_22771 = callExtensionGetter_impObject ((const cPtr_implementation *) temp_0.ptr (), constinArgument_objKind, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 824)) ;
  {
  routine_checkTypeForAttribute (var_obj_22771.getter_attributes (SOURCE_FILE ("implementation_types.galgas", 825)), constinArgument_attributeName, constinArgument_expectedType, inCompiler  COMMA_SOURCE_FILE ("implementation_types.galgas", 825)) ;
  }
}
//----------------------------------------------------------------------------------------------------------------------
...
static void extensionMethod_implementation_checkObjectReferences (const cPtr_implementation * inObject,
  ...
  const cPtr_implementation * object = inObject ;
  macroValidSharedObject (object, cPtr_implementation) ;
  cEnumerator_implementationMap enumerator_22940 (object->mProperty_imp, kENUMERATION_UP) ;
  while (enumerator_22940.hasCurrentObject ()) {
    cEnumerator_implementationObjectMap enumerator_22975 (enumerator_22940.current_obj (HERE).getter_attributes (SOURCE_FILE ("implementation_types.galgas", 830)), kENUMERATION_UP) ;
    while (enumerator_22975.hasCurrentObject ()) {
      const GALGAS_implementation temp_0 = object ;
      callExtensionMethod_checkAttributeReferences ((const cPtr_impType *) enumerator_22975.current_type (HERE).ptr (), temp_0, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 831)) ;
...
GALGAS_implementationObjectMap extensionGetter_mergeImplementationObjectAttributesWith (const GALGAS_implementationObjectMap & inObject,
  ...
  cEnumerator_implementationObjectMap enumerator_30549 (temp_0, kENUMERATION_UP) ;
  while (enumerator_30549.hasCurrentObject ()) {
    GALGAS_impType var_merged_30572 = enumerator_30549.current_type (HERE) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = constinArgument_attributesToMerge.getter_hasKey (enumerator_30549.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 1056)) COMMA_SOURCE_FILE ("implementation_types.galgas", 1056)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_impType var_typeToMerge_30690 ;
        constinArgument_attributesToMerge.method_get (enumerator_30549.current_lkey (HERE), var_typeToMerge_30690, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1057)) ;
        enumGalgasBool test_2 = kBoolTrue ;
        if (kBoolTrue == test_2) {
          test_2 = GALGAS_bool (kIsEqual, enumerator_30549.current_type (HERE).getter_dynamicType (SOURCE_FILE ("implementation_types.galgas", 1058)).objectCompare (var_typeToMerge_30690.getter_dynamicType (SOURCE_FILE ("implementation_types.galgas", 1058)))).boolEnum () ;
          if (kBoolTrue == test_2) {
            var_merged_30572 = callExtensionGetter_mergeWithType ((const cPtr_impType *) enumerator_30549.current_type (HERE).ptr (), var_typeToMerge_30690, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1059)) ;
          }
        }
        if (kBoolFalse == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (enumerator_30549.current_lkey (HERE).getter_location (SOURCE_FILE ("implementation_types.galgas", 1062)), GALGAS_string ("Redefined type"), fixItArray3  COMMA_SOURCE_FILE ("implementation_types.galgas", 1062)) ;
        }
      }
    }
    {
    result_mergedAttributes.setter_put (enumerator_30549.current_lkey (HERE), var_merged_30572, inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1065)) ;
    }
    enumerator_30549.gotoNextObject () ;
  }
  cEnumerator_implementationObjectMap enumerator_30979 (constinArgument_attributesToMerge, kENUMERATION_UP) ;
  while (enumerator_30979.hasCurrentObject ()) {
    enumGalgasBool test_4 = kBoolTrue ;
    if (kBoolTrue == test_4) {
      const GALGAS_implementationObjectMap temp_5 = inObject ;
      test_4 = temp_5.getter_hasKey (enumerator_30979.current_lkey (HERE).getter_string (SOURCE_FILE ("implementation_types.galgas", 1068)) COMMA_SOURCE_FILE ("implementation_types.galgas", 1068)).operator_not (SOURCE_FILE ("implementation_types.galgas", 1068)).boolEnum () ;
      if (kBoolTrue == test_4) {
        {
        result_mergedAttributes.setter_put (enumerator_30979.current_lkey (HERE), enumerator_30979.current_type (HERE), inCompiler COMMA_SOURCE_FILE ("implementation_types.galgas", 1069)) ;
        }
      }
    }
...
static void extensionSetter_objectAttributes_mergeAttributes (cPtr_objectAttributes * inObject,
  ...
  cEnumerator_identifierMap enumerator_1485 (inArgument_withAttributes.getter_objectParams (SOURCE_FILE ("goil_basic_types.galgas", 59)), kENUMERATION_UP) ;
  while (enumerator_1485.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = object->mProperty_objectParams.getter_hasKey (enumerator_1485.current_lkey (HERE).getter_string (SOURCE_FILE ("goil_basic_types.galgas", 60)) COMMA_SOURCE_FILE ("goil_basic_types.galgas", 60)).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_object_5F_t var_object_1623 ;
        {
        object->mProperty_objectParams.setter_del (enumerator_1485.current_lkey (HERE), var_object_1623, inCompiler COMMA_SOURCE_FILE ("goil_basic_types.galgas", 62)) ;
        }
        {
        var_object_1623.insulate (HERE) ;
        cPtr_object_5F_t * ptr_1640 = (cPtr_object_5F_t *) var_object_1623.ptr () ;
        callExtensionSetter_mergeSubAttributes ((cPtr_object_5F_t *) ptr_1640, enumerator_1485.current_value (HERE), inCompiler COMMA_SOURCE_FILE ("goil_basic_types.galgas", 63)) ;
        }
        {
        object->mProperty_objectParams.setter_put (enumerator_1485.current_lkey (HERE), var_object_1623, inCompiler COMMA_SOURCE_FILE ("goil_basic_types.galgas", 64)) ;
        }
      }
    }
    if (kBoolFalse == test_0) {
      {
      object->mProperty_objectParams.setter_put (enumerator_1485.current_lkey (HERE), enumerator_1485.current_value (HERE), inCompiler COMMA_SOURCE_FILE ("goil_basic_types.galgas", 67)) ;
      }
    }
