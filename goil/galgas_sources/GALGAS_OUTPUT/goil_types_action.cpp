...
method_generate (C_Compiler & inLexique,
  ...
  ::routine_retrieveTemplateString (inLexique,  var_cas_res,  GGS_string ("notification_setevent") COMMA_SOURCE_FILE_AT_LINE (44)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION_NAME$"),  ((var_cas_err).operator_concat (GGS_string (" of message "))).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (46))) COMMA_SOURCE_FILE_AT_LINE (46)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION$"),  (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (47))).operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (47)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$TASK$"),  (task_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (48))).operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (48)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$EVENT$"),  (event_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (49))).operator_concat (GGS_string ("_mask")) COMMA_SOURCE_FILE_AT_LINE (49)) ;
  ::routine_doReplace (inLexique,  var_cas_i_res,  var_cas_key,  ((GGS_string ("&")).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (51)))).operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (51)) ;
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@setevent_action:"
           << location.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << task_name.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << event_name.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
method_generate (C_Compiler & inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_res ;
  ::routine_retrieveTemplateString (inLexique,  var_cas_res,  GGS_string ("notification_activatetask") COMMA_SOURCE_FILE_AT_LINE (68)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION_NAME$"),  ((var_cas_err).operator_concat (GGS_string (" of message "))).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (70))) COMMA_SOURCE_FILE_AT_LINE (70)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION$"),  (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (71))).operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (71)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$TASK$"),  (task_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (72))).operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
  ::routine_doReplace (inLexique,  var_cas_i_res,  var_cas_key,  ((GGS_string ("&")).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (74)))).operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
  var_cas_i_res = ((var_cas_res).operator_concat (GGS_string ("\n"))).operator_concat (var_cas_i_res) ;
}
...
method_generate (C_Compiler & inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_res ;
  ::routine_retrieveTemplateString (inLexique,  var_cas_res,  GGS_string ("notification_callback") COMMA_SOURCE_FILE_AT_LINE (91)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION_NAME$"),  ((var_cas_err).operator_concat (GGS_string (" of message "))).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (93))) COMMA_SOURCE_FILE_AT_LINE (93)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION$"),  (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (94))).operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (94)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$CALLBACK$"),  (function_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (95))).operator_concat (GGS_string ("_callback")) COMMA_SOURCE_FILE_AT_LINE (95)) ;
  ::routine_doReplace (inLexique,  var_cas_i_res,  var_cas_key,  ((GGS_string ("&")).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (97)))).operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (97)) ;
  var_cas_i_res = ((var_cas_res).operator_concat (GGS_string ("\n"))).operator_concat (var_cas_i_res) ;
}
...
method_generate (C_Compiler & inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_res ;
  ::routine_retrieveTemplateString (inLexique,  var_cas_res,  GGS_string ("notification_flag") COMMA_SOURCE_FILE_AT_LINE (113)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION_NAME$"),  ((var_cas_err).operator_concat (GGS_string (" of message "))).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (115))) COMMA_SOURCE_FILE_AT_LINE (115)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION$"),  (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (116))).operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$FLAGFUNCTION$"),  (GGS_string ("tpl_set_flag_")).operator_concat (flag_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (117))) COMMA_SOURCE_FILE_AT_LINE (117)) ;
  ::routine_doReplace (inLexique,  var_cas_i_res,  var_cas_key,  ((GGS_string ("&")).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (119)))).operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (119)) ;
  var_cas_i_res = ((var_cas_res).operator_concat (GGS_string ("\n"))).operator_concat (var_cas_i_res) ;
}
...
method_flag (C_Compiler & inLexique,
                                GGS_stringset & var_cas_f COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_f._addAssign_operation (flag_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (125))) ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@flag_action:"
           << location.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << flag_name.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
method_generate (C_Compiler & inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_res ;
  ::routine_retrieveTemplateString (inLexique,  var_cas_res,  GGS_string ("notification_incrementcounter") COMMA_SOURCE_FILE_AT_LINE (139)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION_NAME$"),  ((var_cas_err).operator_concat (GGS_string (" of message "))).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (141))) COMMA_SOURCE_FILE_AT_LINE (141)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION$"),  (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (142))).operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (142)) ;
  ::routine_doReplace (inLexique,  var_cas_res,  GGS_string ("$COUNTER$"),  (counter_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (143))).operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (143)) ;
  ::routine_doReplace (inLexique,  var_cas_i_res,  var_cas_key,  ((GGS_string ("&")).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (145)))).operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (145)) ;
  var_cas_i_res = ((var_cas_res).operator_concat (GGS_string ("\n"))).operator_concat (var_cas_i_res) ;
}
