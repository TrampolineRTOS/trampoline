...
method_flag (C_Compiler & /* _inLexique */,
...
GGS_action_obj::
GGS_action_obj (cPtr__AC_galgas_class * inPointer) {
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_action_obj (inPointer) ;
    }else{
...
AC_galgasClassRunTimeInformation * GGS_action_obj::_galgasObjectRunTimeInfo (void) const {
...
C_galgasRootClassRunTimeInformation gClassInfoFor__action_obj ("action_obj") ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    const cPtr_void_action * _p = dynamic_cast <const cPtr_void_action *> (inOperand) ;
...
method_generate (C_Compiler & _inLexique,
  ...
  ::routine_doReplace (_inLexique,  var_cas_i_res,  var_cas_key,  GGS_string ("NULL_PTR") COMMA_SOURCE_FILE_AT_LINE (28)) ;
}
...
GGS_void_action::
GGS_void_action (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_void_action (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__void_action ("void_action", gClassInfoFor__action_obj) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_setevent_action * _p = dynamic_cast <const cPtr_setevent_action *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = location._operator_isEqual (_p->location).boolValue ()
         && task_name._operator_isEqual (_p->task_name).boolValue ()
         && event_name._operator_isEqual (_p->event_name).boolValue () ;
  }
  return equal ;
}
...
method_generate (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_res,  GGS_string ("notification_setevent") COMMA_SOURCE_FILE_AT_LINE (44)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION_NAME$"),  ((var_cas_err)._operator_concat (GGS_string (" of message ")))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (46))) COMMA_SOURCE_FILE_AT_LINE (46)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (47)))._operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (47)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$TASK$"),  (task_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (48)))._operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (48)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$EVENT$"),  (event_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (49)))._operator_concat (GGS_string ("_mask")) COMMA_SOURCE_FILE_AT_LINE (49)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  var_cas_key,  ((GGS_string ("&"))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (51))))._operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (51)) ;
  var_cas_i_res = ((var_cas_res)._operator_concat (GGS_string ("\n")))._operator_concat (var_cas_i_res) ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@setevent_action:"
           << location.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << task_name.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << event_name.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
GGS_setevent_action::
GGS_setevent_action (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_setevent_action (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__setevent_action ("setevent_action", gClassInfoFor__action_obj) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_activatetask_action * _p = dynamic_cast <const cPtr_activatetask_action *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = location._operator_isEqual (_p->location).boolValue ()
         && task_name._operator_isEqual (_p->task_name).boolValue () ;
  }
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_res,  GGS_string ("notification_activatetask") COMMA_SOURCE_FILE_AT_LINE (68)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION_NAME$"),  ((var_cas_err)._operator_concat (GGS_string (" of message ")))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (70))) COMMA_SOURCE_FILE_AT_LINE (70)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (71)))._operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (71)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$TASK$"),  (task_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (72)))._operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (72)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  var_cas_key,  ((GGS_string ("&"))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (74))))._operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (74)) ;
  var_cas_i_res = ((var_cas_res)._operator_concat (GGS_string ("\n")))._operator_concat (var_cas_i_res) ;
}
...
GGS_activatetask_action (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_activatetask_action _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_activatetask_action (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__activatetask_action ("activatetask_action", gClassInfoFor__action_obj) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_callback_action * _p = dynamic_cast <const cPtr_callback_action *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = location._operator_isEqual (_p->location).boolValue ()
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_res,  GGS_string ("notification_callback") COMMA_SOURCE_FILE_AT_LINE (91)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION_NAME$"),  ((var_cas_err)._operator_concat (GGS_string (" of message ")))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (93))) COMMA_SOURCE_FILE_AT_LINE (93)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (94)))._operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (94)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$CALLBACK$"),  (function_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (95)))._operator_concat (GGS_string ("_callback")) COMMA_SOURCE_FILE_AT_LINE (95)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  var_cas_key,  ((GGS_string ("&"))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (97))))._operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (97)) ;
  var_cas_i_res = ((var_cas_res)._operator_concat (GGS_string ("\n")))._operator_concat (var_cas_i_res) ;
}
...
GGS_callback_action::
GGS_callback_action (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_callback_action (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__callback_action ("callback_action", gClassInfoFor__action_obj) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_flag_action * _p = dynamic_cast <const cPtr_flag_action *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = location._operator_isEqual (_p->location).boolValue ()
         && flag_name._operator_isEqual (_p->flag_name).boolValue () ;
  }
  return equal ;
}
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_res,  GGS_string ("notification_flag") COMMA_SOURCE_FILE_AT_LINE (113)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION_NAME$"),  ((var_cas_err)._operator_concat (GGS_string (" of message ")))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (115))) COMMA_SOURCE_FILE_AT_LINE (115)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (116)))._operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (116)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$FLAGFUNCTION$"),  (GGS_string ("tpl_set_flag_"))._operator_concat (flag_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (117))) COMMA_SOURCE_FILE_AT_LINE (117)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  var_cas_key,  ((GGS_string ("&"))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (119))))._operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (119)) ;
  var_cas_i_res = ((var_cas_res)._operator_concat (GGS_string ("\n")))._operator_concat (var_cas_i_res) ;
}
...
method_flag (C_Compiler & _inLexique,
                                GGS_stringset & var_cas_f COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_f._addAssign_operation (flag_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (125))) ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@flag_action:"
           << location.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
           << flag_name.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
GGS_flag_action::
GGS_flag_action (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_flag_action (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__flag_action ("flag_action", gClassInfoFor__action_obj) ;
...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  bool equal = typeid (this) == typeid (inOperand) ;
  if (equal) {
    const cPtr_incrementcounter_action * _p = dynamic_cast <const cPtr_incrementcounter_action *> (inOperand) ;
    macroValidPointer (_p) ;
    equal = location._operator_isEqual (_p->location).boolValue ()
...
method_generate (C_Compiler & _inLexique,
                                ...
                                GGS_string& var_cas_i_res COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_string var_cas_res ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_res,  GGS_string ("notification_incrementcounter") COMMA_SOURCE_FILE_AT_LINE (139)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION_NAME$"),  ((var_cas_err)._operator_concat (GGS_string (" of message ")))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (141))) COMMA_SOURCE_FILE_AT_LINE (141)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$NOTIFICATION$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (142)))._operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (142)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string ("$COUNTER$"),  (counter_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (143)))._operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (143)) ;
  ::routine_doReplace (_inLexique,  var_cas_i_res,  var_cas_key,  ((GGS_string ("&"))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (145))))._operator_concat (GGS_string ("_notification")) COMMA_SOURCE_FILE_AT_LINE (145)) ;
  var_cas_i_res = ((var_cas_res)._operator_concat (GGS_string ("\n")))._operator_concat (var_cas_i_res) ;
}
...
GGS_incrementcounter_action (cPtr__AC_galgas_class * inPointer) {
  macroAssignPointer (mPointer, inPointer) ;
}
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_incrementcounter_action _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_incrementcounter_action (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
C_galgasClassRunTimeInformation gClassInfoFor__incrementcounter_action ("incrementcounter_action", gClassInfoFor__action_obj) ;
