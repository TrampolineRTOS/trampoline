  ...
  while (_condition_4169.isBuiltAndTrue ()) {
    ...
    if (_condition_4169.isBuiltAndTrue ()) {
      if (_variant_4169.uintValue () == 0) {
            ...
            { const GGS_resource_property_obj _var_3876 = var_cas_res_prop ; // CAST instruction
              if (_var_3876.getPtr () != NULL) {
                ...
                if (typeid (cPtr_resource_property_linked_obj) == typeid (* (_var_3876.getPtr ()))) {
                  ...
                  const GGS_bool cond_3701 = var_cas_resolved.reader_hasKey (inLexique, var_cas_rplo.reader_linked_resource (inLexique COMMA_SOURCE_FILE_AT_LINE (90)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (90)) COMMA_SOURCE_FILE_AT_LINE (90)) ;
        ...
        const GGS_bool cond_4159 = (var_cas_unresolved.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (124))).operator_isEqual (var_cas_unresolved_next.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (124))) ;
