...
void routine_resolve_5F_linked_5F_resources (GALGAS_resource_5F_map & ioArgument_resources,
  ...
  if (var_unresolved.reader_count (SOURCE_FILE_AT_LINE (72)).substract_operation (var_unresolved_5F_next.reader_count (SOURCE_FILE_AT_LINE (72)), inCompiler COMMA_SOURCE_FILE_AT_LINE (72)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (72)).isValid ()) {
    ...
    while (loop_1638) {
        ...
        if (var_first_5F_loop.isValidAndTrue ()) {
      ...
      if (loop_1638) {
        ...
        while (enumerator_1905.hasCurrentObject ()) {
          ...
          if (var_res_5F_prop.isValid ()) {
            if (var_res_5F_prop.dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_resource_5F_property_5F_linked_5F_obj) {
              ...
              //-------- @ifInstructionForGeneration
              if (var_resolved.reader_hasKey (cast_2162_rplo.reader_linked_5F_resource (SOURCE_FILE_AT_LINE (90)).reader_string (SOURCE_FILE_AT_LINE (90)) COMMA_SOURCE_FILE_AT_LINE (90)).isValidAndTrue ()) {
                //-------- @localVariableDeclarationForGeneration
        ...
        //-------- @ifInstructionForGeneration
        if (GALGAS_bool (kIsEqual, var_unresolved.reader_count (SOURCE_FILE_AT_LINE (124)).objectCompare (var_unresolved_5F_next.reader_count (SOURCE_FILE_AT_LINE (124)))).isValidAndTrue ()) {
          //-------- @errorInstructionForGeneration
          ...
          while (enumerator_4025.hasCurrentObject ()) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_0 (enumerator_4025.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_0, GALGAS_string ("Involved in cycle") COMMA_SOURCE_FILE_AT_LINE (128)) ;
