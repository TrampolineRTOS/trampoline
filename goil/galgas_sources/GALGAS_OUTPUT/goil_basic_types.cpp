...
//                    november 12th, 2009, at 11h41'16"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
GGS_string function_bool_class_define (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  { const GGS_basic_type _var_9590 = var_cas_t ; // CAST instruction
    if (_var_9590.getPtr () != NULL) {
      macroValidPointer (_var_9590.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_9590.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_9590.getPtr ()) ;
        var_cas_res = function_bool_define (inLexique, var_cas_flag, var_cas_b.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (410)) COMMA_SOURCE_FILE_AT_LINE (410)) ;
      }else{
        var_cas_res = function_bool_define (inLexique, var_cas_flag, var_cas_def COMMA_SOURCE_FILE_AT_LINE (412)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_bool_flag (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_9993 = var_cas_b ; // CAST instruction
    if (_var_9993.getPtr () != NULL) {
      macroValidPointer (_var_9993.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_9993.getPtr ()))) {
      }else if (typeid (cPtr_bool_class) == typeid (* (_var_9993.getPtr ()))) {
        const GGS_bool_class var_cas_bo (_var_9993.getPtr ()) ;
        const GGS_bool cond_9863 = var_cas_bo.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (425)) ;
        if (cond_9863.isBuiltAndTrue ()) {
          var_cas_res.appendCString ("#define ") ;
          var_cas_res.dotAssign_operation (var_cas_flag) ;
          var_cas_res.appendCString ("\n") ;
        }
      }else{
        var_cas_b.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (431)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("Internal error, wrong datatype") COMMA_SOURCE_FILE_AT_LINE (432)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_p_bt (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  const GGS_basic_type  temp_10077 = var_cas_bt ;
  if (temp_10077.isBuilt ()) {
    temp_10077 (HERE)->method_string (inLexique, var_cas_res COMMA_SOURCE_FILE_AT_LINE (439)) ;
  }
  inLexique.printMessage ((((var_cas_bt.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (440)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (440))).operator_concat (GGS_string (": "))).operator_concat (var_cas_res)).operator_concat (GGS_string ("\n")) COMMA_SOURCE_FILE_AT_LINE (440)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_luint64  function_luint64_value (C_Compiler & inLexique,
  ...
  var_cas_v = GGS_luint64 ::constructor_new (inLexique, var_cas_c.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (447)), var_cas_c.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (447)) COMMA_HERE) ;
  #ifdef DEBUG_TRACE_ENABLED
