...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.prefix.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.tag_to_rep.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.ids.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.objs.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
  ...
  { const GGS_basic_type _var_6380 = var_cas_t ; // CAST instruction
    if (_var_6380.getPtr () != NULL) {
      ...
      if (typeid (cPtr_void) == typeid (* (_var_6380.getPtr ()))) {
        ...
        var_cas_i.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Redefinition of "))._operator_concat (var_cas_att) COMMA_SOURCE_FILE_AT_LINE (258)) ;
        var_cas_t.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (258)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (259)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
  ...
  { const GGS_basic_type _var_6982 = var_cas_t ; // CAST instruction
    if (_var_6982.getPtr () != NULL) {
      ...
      if (typeid (cPtr_void) == typeid (* (_var_6982.getPtr ()))) {
        ...
        var_cas_i.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Redefinition of "))._operator_concat (var_cas_att) COMMA_SOURCE_FILE_AT_LINE (282)) ;
        var_cas_t.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (282)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (283)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_set_lstring (C_Compiler & _inLexique,
                                GGS_basic_type  & var_cas_t,
  ...
  #endif
  { const GGS_basic_type _var_7593 = var_cas_t ; // CAST instruction
    if (_var_7593.getPtr () != NULL) {
      macroValidPointer (_var_7593.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_7593.getPtr ()))) {
        var_cas_t = GGS_string_class ::constructor_new (_inLexique, var_cas_s.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (303)), var_cas_s.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (303)) COMMA_HERE) ;
      }else{
        var_cas_s.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Redefinition of "))._operator_concat (var_cas_att) COMMA_SOURCE_FILE_AT_LINE (306)) ;
        var_cas_t.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (306)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (307)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_set_bool (C_Compiler & _inLexique,
  ...
  { const GGS_basic_type _var_8184 = var_cas_t ; // CAST instruction
    if (_var_8184.getPtr () != NULL) {
      ...
      if (typeid (cPtr_bool_class) == typeid (* (_var_8184.getPtr ()))) {
        var_cas_b.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Redefinition of "))._operator_concat (var_cas_att) COMMA_SOURCE_FILE_AT_LINE (328)) ;
        var_cas_t.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (328)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (329)) ;
      }else{
        var_cas_t = GGS_bool_class ::constructor_new (_inLexique, var_cas_b.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (330)), var_cas_b.reader_bool (_inLexique COMMA_SOURCE_FILE_AT_LINE (330)) COMMA_HERE) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_bool function_get_bool (C_Compiler & _inLexique,
  ...
  #endif
  GGS_bool var_cas_b ;
  { const GGS_basic_type _var_8371 = var_cas_t ; // CAST instruction
    if (_var_8371.getPtr () != NULL) {
      macroValidPointer (_var_8371.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_8371.getPtr ()))) {
        const GGS_bool_class var_cas_bc (_var_8371.getPtr ()) ;
        var_cas_b = var_cas_bc.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (341)) ;
      }else{
...
GGS_string function_bool_define (C_Compiler & _inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  var_cas_res = ((((GGS_string ("#define    "))._operator_concat (var_cas_flag))._operator_concat (GGS_string ("    ")))._operator_concat (function_yes_no (_inLexique, var_cas_b COMMA_SOURCE_FILE_AT_LINE (356))))._operator_concat (GGS_string ("\n")) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_string function_bool_class_define (C_Compiler & _inLexique,
                                GGS_string  var_cas_flag,
                                GGS_basic_type   var_cas_t,
  ...
  #endif
  GGS_string var_cas_res ;
  { const GGS_basic_type _var_8883 = var_cas_t ; // CAST instruction
    if (_var_8883.getPtr () != NULL) {
      macroValidPointer (_var_8883.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_8883.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_8883.getPtr ()) ;
        var_cas_res = function_bool_define (_inLexique, var_cas_flag, var_cas_b.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (367)) COMMA_SOURCE_FILE_AT_LINE (367)) ;
      }else{
        var_cas_res = function_bool_define (_inLexique, var_cas_flag, var_cas_def COMMA_SOURCE_FILE_AT_LINE (369)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_bool_flag (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_basic_type _var_9286 = var_cas_b ; // CAST instruction
    if (_var_9286.getPtr () != NULL) {
      macroValidPointer (_var_9286.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_9286.getPtr ()))) {
      }else if (typeid (cPtr_bool_class) == typeid (* (_var_9286.getPtr ()))) {
        const GGS_bool_class var_cas_bo (_var_9286.getPtr ()) ;
        if ((var_cas_bo.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (382))).isBuiltAndTrue ()) {
          var_cas_res.appendCString ("#define ") ;
          var_cas_res._dotAssign_operation (var_cas_flag) ;
          var_cas_res.appendCString ("\n") ;
        }
      }else{
        var_cas_b.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (388)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Internal error, wrong datatype") COMMA_SOURCE_FILE_AT_LINE (389)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
