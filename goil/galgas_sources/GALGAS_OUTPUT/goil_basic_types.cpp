...
GGS_string function_bool_define (C_Compiler & _inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  var_cas_res = ((((GGS_string (true, "#define    "))._operator_concat (var_cas_flag))._operator_concat (GGS_string (true, "    ")))._operator_concat (function_yes_no (_inLexique, var_cas_b COMMA_SOURCE_FILE_AT_LINE (332))))._operator_concat (GGS_string (true, "\n")) ;
  #ifdef DEBUG_TRACE_ENABLED
  ...
  { const GGS_basic_type _var_8677 = var_cas_b ; // CAST instruction
    if (_var_8677.getPtr () != NULL) {
      ...
      if (typeid (cPtr_void) == typeid (* (_var_8677.getPtr ()))) {
        ...
        var_cas_b.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (364)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Internal error, wrong datatype") COMMA_SOURCE_FILE_AT_LINE (365)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
