...
GGS_uint  function_uint32_or_error (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_1071 = var_cas_t ; // CAST instruction
    if (_var_1071.getPtr () != NULL) {
      macroValidPointer (_var_1071.getPtr ()) ;
      if (typeid (cPtr_uint32_class) == typeid (* (_var_1071.getPtr ()))) {
        const GGS_uint32_class var_cas_ui (_var_1071.getPtr ()) ;
        var_cas_v = var_cas_ui.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (55)) ;
      }else{
        var_cas_t.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (57)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (var_cas_att).operator_concat (GGS_string (" is not defined")) COMMA_SOURCE_FILE_AT_LINE (58)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
method_string (C_Compiler & inLexique,
                                GGS_string& var_cas_s COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_s = value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (71)) ;
}
...
GGS_uint64  function_uint64_or_error (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_1619 = var_cas_t ; // CAST instruction
    if (_var_1619.getPtr () != NULL) {
      macroValidPointer (_var_1619.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_1619.getPtr ()))) {
        const GGS_uint64_class var_cas_ui (_var_1619.getPtr ()) ;
        var_cas_v = var_cas_ui.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ;
      }else{
        var_cas_t.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (85)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("Internal error, ")).operator_concat (var_cas_att)).operator_concat (GGS_string (" has a wrong datatype")) COMMA_SOURCE_FILE_AT_LINE (86)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
method_string (C_Compiler & inLexique,
                                GGS_string& var_cas_s COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_s = value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (92)) ;
}
...
method_string (C_Compiler & /* inLexique */,
                                GGS_string& var_cas_s COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_bool cond_2202 = value ;
  if (cond_2202.isBuiltAndTrue ()) {
    var_cas_s = GGS_string ("true") ;
  }else if (cond_2202.isBuiltAndFalse ()) {
...
void routine_set_uint32 (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_7038 = var_cas_t ; // CAST instruction
    if (_var_7038.getPtr () != NULL) {
      macroValidPointer (_var_7038.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_7038.getPtr ()))) {
        var_cas_t = GGS_uint32_class ::constructor_new (inLexique, var_cas_i.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (296)), var_cas_i.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (296)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (296)) COMMA_HERE) ;
      }else{
        var_cas_i.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (var_cas_att).operator_concat (GGS_string (" Redefinition")) COMMA_SOURCE_FILE_AT_LINE (299)) ;
        var_cas_t.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (299)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (300)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_set_uint64 (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_7637 = var_cas_t ; // CAST instruction
    if (_var_7637.getPtr () != NULL) {
      macroValidPointer (_var_7637.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_7637.getPtr ()))) {
        var_cas_t = GGS_uint64_class ::constructor_new (inLexique, var_cas_i.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (320)), var_cas_i.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (320)) COMMA_HERE) ;
      }else{
        var_cas_i.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (var_cas_att).operator_concat (GGS_string (" Redefinition")) COMMA_SOURCE_FILE_AT_LINE (323)) ;
        var_cas_t.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (323)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (324)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_set_lstring (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_8243 = var_cas_t ; // CAST instruction
    if (_var_8243.getPtr () != NULL) {
      macroValidPointer (_var_8243.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_8243.getPtr ()))) {
        var_cas_t = GGS_string_class ::constructor_new (inLexique, var_cas_s.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (344)), var_cas_s.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (344)) COMMA_HERE) ;
      }else{
        var_cas_s.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (var_cas_att).operator_concat (GGS_string (" Redefinition")) COMMA_SOURCE_FILE_AT_LINE (347)) ;
        var_cas_t.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (347)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (348)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_set_bool (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_8834 = var_cas_t ; // CAST instruction
    if (_var_8834.getPtr () != NULL) {
      macroValidPointer (_var_8834.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_8834.getPtr ()))) {
        var_cas_b.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("Redefinition of ")).operator_concat (var_cas_att) COMMA_SOURCE_FILE_AT_LINE (369)) ;
        var_cas_t.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (369)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (370)) ;
      }else{
        var_cas_t = GGS_bool_class ::constructor_new (inLexique, var_cas_b.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (371)), var_cas_b.reader_bool (inLexique COMMA_SOURCE_FILE_AT_LINE (371)) COMMA_HERE) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_bool function_get_bool (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_b ;
  { const GGS_basic_type _var_9021 = var_cas_t ; // CAST instruction
    if (_var_9021.getPtr () != NULL) {
      macroValidPointer (_var_9021.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_9021.getPtr ()))) {
        const GGS_bool_class var_cas_bc (_var_9021.getPtr ()) ;
        var_cas_b = var_cas_bc.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (382)) ;
      }else{
...
GGS_string function_yes_no (C_Compiler &,
  ...
  const GGS_bool cond_9116 = var_cas_b ;
  if (cond_9116.isBuiltAndTrue ()) {
    var_cas_res = GGS_string ("YES") ;
  }else if (cond_9116.isBuiltAndFalse ()) {
...
GGS_string function_bool_define (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  var_cas_res = ((((GGS_string ("#define    ")).operator_concat (var_cas_flag)).operator_concat (GGS_string ("    "))).operator_concat (function_yes_no (inLexique, var_cas_b COMMA_SOURCE_FILE_AT_LINE (397)))).operator_concat (GGS_string ("\n")) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_string function_bool_class_define (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  { const GGS_basic_type _var_9533 = var_cas_t ; // CAST instruction
    if (_var_9533.getPtr () != NULL) {
      macroValidPointer (_var_9533.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_9533.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_9533.getPtr ()) ;
        var_cas_res = function_bool_define (inLexique, var_cas_flag, var_cas_b.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (408)) COMMA_SOURCE_FILE_AT_LINE (408)) ;
      }else{
        var_cas_res = function_bool_define (inLexique, var_cas_flag, var_cas_def COMMA_SOURCE_FILE_AT_LINE (410)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_bool_flag (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_9936 = var_cas_b ; // CAST instruction
    if (_var_9936.getPtr () != NULL) {
      macroValidPointer (_var_9936.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_9936.getPtr ()))) {
      }else if (typeid (cPtr_bool_class) == typeid (* (_var_9936.getPtr ()))) {
        const GGS_bool_class var_cas_bo (_var_9936.getPtr ()) ;
        const GGS_bool cond_9806 = var_cas_bo.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (423)) ;
        ...
        var_cas_b.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (429)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("Internal error, wrong datatype") COMMA_SOURCE_FILE_AT_LINE (430)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_p_bt (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  const GGS_basic_type  temp_10020 = var_cas_bt ;
  if (temp_10020.isBuilt ()) {
    temp_10020 (HERE)->method_string (inLexique, var_cas_res COMMA_SOURCE_FILE_AT_LINE (437)) ;
  }
  inLexique.printMessage ((((var_cas_bt.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (438)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (438))).operator_concat (GGS_string (": "))).operator_concat (var_cas_res)).operator_concat (GGS_string ("\n")) COMMA_SOURCE_FILE_AT_LINE (438)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_luint64  function_luint64_value (C_Compiler & inLexique,
  ...
  var_cas_v = GGS_luint64 ::constructor_new (inLexique, var_cas_c.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (445)), var_cas_c.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (445)) COMMA_HERE) ;
  #ifdef DEBUG_TRACE_ENABLED
