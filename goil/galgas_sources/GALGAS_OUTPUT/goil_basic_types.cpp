...
const C_galgas_type_descriptor kTypeDescriptor_GGS_basic_type ("basic_type", true, NULL) ;
...
C_galgasRootClassRunTimeInformation gClassInfoFor__basic_type ("basic_type", & kTypeDescriptor_GGS_basic_type) ;
...
const C_galgas_type_descriptor * GGS_basic_type::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_void ("void", true, & kTypeDescriptor_GGS_basic_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__void ("void", gClassInfoFor__basic_type, & kTypeDescriptor_GGS_void) ;
...
const C_galgas_type_descriptor * GGS_void::typeDescriptor (void) const {
...
method_string (C_Compiler & inLexique,
                                GGS_string& var_cas_s COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_s = value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (41)) ;
}
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_uint32_class ("uint32_class", true, & kTypeDescriptor_GGS_basic_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__uint32_class ("uint32_class", gClassInfoFor__basic_type, & kTypeDescriptor_GGS_uint32_class) ;
...
const C_galgas_type_descriptor * GGS_uint32_class::typeDescriptor (void) const {
...
GGS_uint  function_uint32_or_error (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_1012 = var_cas_t ; // CAST instruction
    if (_var_1012.getPtr () != NULL) {
      macroValidPointer (_var_1012.getPtr ()) ;
      if (typeid (cPtr_uint32_class) == typeid (* (_var_1012.getPtr ()))) {
        const GGS_uint32_class var_cas_ui (_var_1012.getPtr ()) ;
        var_cas_v = var_cas_ui.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (53)) ;
      }else{
        var_cas_t.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (55)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (var_cas_att).operator_concat (GGS_string (" is not defined")) COMMA_SOURCE_FILE_AT_LINE (56)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
method_string (C_Compiler & inLexique,
                                GGS_string& var_cas_s COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_s = value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (62)) ;
}
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_sint32_class ("sint32_class", true, & kTypeDescriptor_GGS_basic_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__sint32_class ("sint32_class", gClassInfoFor__basic_type, & kTypeDescriptor_GGS_sint32_class) ;
...
const C_galgas_type_descriptor * GGS_sint32_class::typeDescriptor (void) const {
...
method_string (C_Compiler & inLexique,
                                GGS_string& var_cas_s COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_s = value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (69)) ;
}
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_uint64_class ("uint64_class", true, & kTypeDescriptor_GGS_basic_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__uint64_class ("uint64_class", gClassInfoFor__basic_type, & kTypeDescriptor_GGS_uint64_class) ;
...
const C_galgas_type_descriptor * GGS_uint64_class::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_uint64_class ;
}

//---------------------------------------------------------------------------*
//                                                                           *
//               Implementation of function "uint64_or_error"                *
//                                                                           *
//---------------------------------------------------------------------------*

GGS_uint64  function_uint64_or_error (C_Compiler & inLexique,
                                GGS_basic_type   var_cas_t,
                                GGS_string  var_cas_att COMMA_UNUSED_LOCATION_ARGS) {
  #ifdef DEBUG_TRACE_ENABLED
    printf ("ENTER function_uint64_or_error at %s:%d\n", __FILE__, __LINE__) ;
  #endif
  GGS_uint64  var_cas_v ;
  var_cas_v = GGS_uint64 (0ULL) ;
  { const GGS_basic_type _var_1560 = var_cas_t ; // CAST instruction
    if (_var_1560.getPtr () != NULL) {
      macroValidPointer (_var_1560.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_1560.getPtr ()))) {
        const GGS_uint64_class var_cas_ui (_var_1560.getPtr ()) ;
        var_cas_v = var_cas_ui.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (81)) ;
      }else{
        var_cas_t.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (83)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("Internal error, ")).operator_concat (var_cas_att)).operator_concat (GGS_string (" has a wrong datatype")) COMMA_SOURCE_FILE_AT_LINE (84)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE function_uint64_or_error\n") ;
  #endif
  return var_cas_v ;
}
...
static GGS_object functionForGenericCall_uint64_or_error (C_Compiler & inLexique,
                           const GGS_objectlist & inEffectiveParameterArray,
                           const GGS_location & inErrorLocation
                           COMMA_LOCATION_ARGS) {
  const GGS_basic_type  arg_0 = GGS_basic_type ::castFromObject (inLexique, inEffectiveParameterArray.reader_mValueAtIndex (inLexique, GGS_uint (0) COMMA_THERE), inErrorLocation COMMA_THERE) ;
  const GGS_string arg_1 = GGS_string::castFromObject (inLexique, inEffectiveParameterArray.reader_mValueAtIndex (inLexique, GGS_uint (1) COMMA_THERE), inErrorLocation COMMA_THERE) ;
  const GGS_uint64  result = function_uint64_or_error (inLexique,
                            arg_0,
                            arg_1
                            COMMA_THERE) ;
  return result.reader_object () ;
...
static const C_galgas_type_descriptor *
kArgumentTypeList_uint64_or_error [2] = {& kTypeDescriptor_GGS_basic_type ,
                              & kTypeDescriptor_GGS_string} ;

const C_galgas_function_descriptor
kFunction_descriptor_uint64_or_error ("uint64_or_error",
                              functionForGenericCall_uint64_or_error,
                              & kTypeDescriptor_GGS_uint64 ,
                              2,
                              kArgumentTypeList_uint64_or_error) ;
...
method_string (C_Compiler & inLexique,
                                GGS_string& var_cas_s COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_s = value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (90)) ;
}
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_sint64_class ("sint64_class", true, & kTypeDescriptor_GGS_basic_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__sint64_class ("sint64_class", gClassInfoFor__basic_type, & kTypeDescriptor_GGS_sint64_class) ;
...
const C_galgas_type_descriptor * GGS_sint64_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_float_class ("float_class", true, & kTypeDescriptor_GGS_basic_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__float_class ("float_class", gClassInfoFor__basic_type, & kTypeDescriptor_GGS_float_class) ;
...
const C_galgas_type_descriptor * GGS_float_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_string_class ("string_class", true, & kTypeDescriptor_GGS_basic_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__string_class ("string_class", gClassInfoFor__basic_type, & kTypeDescriptor_GGS_string_class) ;
...
const C_galgas_type_descriptor * GGS_string_class::typeDescriptor (void) const {
...
method_string (C_Compiler & /* inLexique */,
                                GGS_string& var_cas_s COMMA_UNUSED_LOCATION_ARGS) const {
  const GGS_bool cond_2143 = value ;
  if (cond_2143.isBuiltAndTrue ()) {
    var_cas_s = GGS_string ("true") ;
  }else if (cond_2143.isBuiltAndFalse ()) {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_bool_class ("bool_class", true, & kTypeDescriptor_GGS_basic_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__bool_class ("bool_class", gClassInfoFor__basic_type, & kTypeDescriptor_GGS_bool_class) ;
...
const C_galgas_type_descriptor * GGS_bool_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_void_uint32_class ("void_uint32_class", true, & kTypeDescriptor_GGS_uint32_class) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__void_uint32_class ("void_uint32_class", gClassInfoFor__uint32_class, & kTypeDescriptor_GGS_void_uint32_class) ;
...
const C_galgas_type_descriptor * GGS_void_uint32_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_void_sint32_class ("void_sint32_class", true, & kTypeDescriptor_GGS_sint32_class) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__void_sint32_class ("void_sint32_class", gClassInfoFor__sint32_class, & kTypeDescriptor_GGS_void_sint32_class) ;
...
const C_galgas_type_descriptor * GGS_void_sint32_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_void_uint64_class ("void_uint64_class", true, & kTypeDescriptor_GGS_uint64_class) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__void_uint64_class ("void_uint64_class", gClassInfoFor__uint64_class, & kTypeDescriptor_GGS_void_uint64_class) ;
...
const C_galgas_type_descriptor * GGS_void_uint64_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_void_sint64_class ("void_sint64_class", true, & kTypeDescriptor_GGS_sint64_class) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__void_sint64_class ("void_sint64_class", gClassInfoFor__sint64_class, & kTypeDescriptor_GGS_void_sint64_class) ;
...
const C_galgas_type_descriptor * GGS_void_sint64_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_void_float_class ("void_float_class", true, & kTypeDescriptor_GGS_float_class) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__void_float_class ("void_float_class", gClassInfoFor__float_class, & kTypeDescriptor_GGS_void_float_class) ;
...
const C_galgas_type_descriptor * GGS_void_float_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_void_string_class ("void_string_class", true, & kTypeDescriptor_GGS_string_class) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__void_string_class ("void_string_class", gClassInfoFor__string_class, & kTypeDescriptor_GGS_void_string_class) ;
...
const C_galgas_type_descriptor * GGS_void_string_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_void_bool_class ("void_bool_class", true, & kTypeDescriptor_GGS_bool_class) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__void_bool_class ("void_bool_class", gClassInfoFor__bool_class, & kTypeDescriptor_GGS_void_bool_class) ;
...
const C_galgas_type_descriptor * GGS_void_bool_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_auto_uint32_class ("auto_uint32_class", true, & kTypeDescriptor_GGS_uint32_class) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__auto_uint32_class ("auto_uint32_class", gClassInfoFor__uint32_class, & kTypeDescriptor_GGS_auto_uint32_class) ;
...
const C_galgas_type_descriptor * GGS_auto_uint32_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_auto_sint32_class ("auto_sint32_class", true, & kTypeDescriptor_GGS_sint32_class) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__auto_sint32_class ("auto_sint32_class", gClassInfoFor__sint32_class, & kTypeDescriptor_GGS_auto_sint32_class) ;
...
const C_galgas_type_descriptor * GGS_auto_sint32_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_auto_uint64_class ("auto_uint64_class", true, & kTypeDescriptor_GGS_uint64_class) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__auto_uint64_class ("auto_uint64_class", gClassInfoFor__uint64_class, & kTypeDescriptor_GGS_auto_uint64_class) ;
...
const C_galgas_type_descriptor * GGS_auto_uint64_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_auto_sint64_class ("auto_sint64_class", true, & kTypeDescriptor_GGS_sint64_class) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__auto_sint64_class ("auto_sint64_class", gClassInfoFor__sint64_class, & kTypeDescriptor_GGS_auto_sint64_class) ;
...
const C_galgas_type_descriptor * GGS_auto_sint64_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_auto_string_class ("auto_string_class", true, & kTypeDescriptor_GGS_string_class) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__auto_string_class ("auto_string_class", gClassInfoFor__string_class, & kTypeDescriptor_GGS_auto_string_class) ;
...
const C_galgas_type_descriptor * GGS_auto_string_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_auto_bool_class ("auto_bool_class", true, & kTypeDescriptor_GGS_bool_class) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__auto_bool_class ("auto_bool_class", gClassInfoFor__bool_class, & kTypeDescriptor_GGS_auto_bool_class) ;
...
const C_galgas_type_descriptor * GGS_auto_bool_class::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_list_uint32 ("list_uint32", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_list_uint32::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_list_sint32 ("list_sint32", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_list_sint32::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_list_uint64 ("list_uint64", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_list_uint64::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_list_sint64 ("list_sint64", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_list_sint64::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_number_set ("number_set", true, NULL) ;
...
C_galgasRootClassRunTimeInformation gClassInfoFor__number_set ("number_set", & kTypeDescriptor_GGS_number_set) ;
...
const C_galgas_type_descriptor * GGS_number_set::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_uint32_set ("uint32_set", true, & kTypeDescriptor_GGS_number_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__uint32_set ("uint32_set", gClassInfoFor__number_set, & kTypeDescriptor_GGS_uint32_set) ;
...
const C_galgas_type_descriptor * GGS_uint32_set::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_sint32_set ("sint32_set", true, & kTypeDescriptor_GGS_number_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__sint32_set ("sint32_set", gClassInfoFor__number_set, & kTypeDescriptor_GGS_sint32_set) ;
...
const C_galgas_type_descriptor * GGS_sint32_set::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_uint64_set ("uint64_set", true, & kTypeDescriptor_GGS_number_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__uint64_set ("uint64_set", gClassInfoFor__number_set, & kTypeDescriptor_GGS_uint64_set) ;
...
const C_galgas_type_descriptor * GGS_uint64_set::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_sint64_set ("sint64_set", true, & kTypeDescriptor_GGS_number_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__sint64_set ("sint64_set", gClassInfoFor__number_set, & kTypeDescriptor_GGS_sint64_set) ;
...
const C_galgas_type_descriptor * GGS_sint64_set::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_float_set ("float_set", true, & kTypeDescriptor_GGS_number_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__float_set ("float_set", gClassInfoFor__number_set, & kTypeDescriptor_GGS_float_set) ;
...
const C_galgas_type_descriptor * GGS_float_set::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_uint32_empty_set ("uint32_empty_set", true, & kTypeDescriptor_GGS_uint32_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__uint32_empty_set ("uint32_empty_set", gClassInfoFor__uint32_set, & kTypeDescriptor_GGS_uint32_empty_set) ;
...
const C_galgas_type_descriptor * GGS_uint32_empty_set::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_sint32_empty_set ("sint32_empty_set", true, & kTypeDescriptor_GGS_sint32_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__sint32_empty_set ("sint32_empty_set", gClassInfoFor__sint32_set, & kTypeDescriptor_GGS_sint32_empty_set) ;
...
const C_galgas_type_descriptor * GGS_sint32_empty_set::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_uint64_empty_set ("uint64_empty_set", true, & kTypeDescriptor_GGS_uint64_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__uint64_empty_set ("uint64_empty_set", gClassInfoFor__uint64_set, & kTypeDescriptor_GGS_uint64_empty_set) ;
...
const C_galgas_type_descriptor * GGS_uint64_empty_set::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_sint64_empty_set ("sint64_empty_set", true, & kTypeDescriptor_GGS_sint64_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__sint64_empty_set ("sint64_empty_set", gClassInfoFor__sint64_set, & kTypeDescriptor_GGS_sint64_empty_set) ;
...
const C_galgas_type_descriptor * GGS_sint64_empty_set::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_float_empty_set ("float_empty_set", true, & kTypeDescriptor_GGS_float_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__float_empty_set ("float_empty_set", gClassInfoFor__float_set, & kTypeDescriptor_GGS_float_empty_set) ;
...
const C_galgas_type_descriptor * GGS_float_empty_set::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_uint32_range ("uint32_range", true, & kTypeDescriptor_GGS_uint32_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__uint32_range ("uint32_range", gClassInfoFor__uint32_set, & kTypeDescriptor_GGS_uint32_range) ;
...
const C_galgas_type_descriptor * GGS_uint32_range::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_uint32_list ("uint32_list", true, & kTypeDescriptor_GGS_uint32_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__uint32_list ("uint32_list", gClassInfoFor__uint32_set, & kTypeDescriptor_GGS_uint32_list) ;
...
const C_galgas_type_descriptor * GGS_uint32_list::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_sint32_range ("sint32_range", true, & kTypeDescriptor_GGS_sint32_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__sint32_range ("sint32_range", gClassInfoFor__sint32_set, & kTypeDescriptor_GGS_sint32_range) ;
...
const C_galgas_type_descriptor * GGS_sint32_range::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_sint32_list ("sint32_list", true, & kTypeDescriptor_GGS_sint32_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__sint32_list ("sint32_list", gClassInfoFor__sint32_set, & kTypeDescriptor_GGS_sint32_list) ;
...
const C_galgas_type_descriptor * GGS_sint32_list::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_uint64_range ("uint64_range", true, & kTypeDescriptor_GGS_uint64_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__uint64_range ("uint64_range", gClassInfoFor__uint64_set, & kTypeDescriptor_GGS_uint64_range) ;
...
const C_galgas_type_descriptor * GGS_uint64_range::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_uint64_list ("uint64_list", true, & kTypeDescriptor_GGS_uint64_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__uint64_list ("uint64_list", gClassInfoFor__uint64_set, & kTypeDescriptor_GGS_uint64_list) ;
...
const C_galgas_type_descriptor * GGS_uint64_list::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_sint64_range ("sint64_range", true, & kTypeDescriptor_GGS_sint64_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__sint64_range ("sint64_range", gClassInfoFor__sint64_set, & kTypeDescriptor_GGS_sint64_range) ;
...
const C_galgas_type_descriptor * GGS_sint64_range::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_sint64_list ("sint64_list", true, & kTypeDescriptor_GGS_sint64_set) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__sint64_list ("sint64_list", gClassInfoFor__sint64_set, & kTypeDescriptor_GGS_sint64_list) ;
...
const C_galgas_type_descriptor * GGS_sint64_list::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_imp_type ("imp_type", true, NULL) ;
...
C_galgasRootClassRunTimeInformation gClassInfoFor__imp_type ("imp_type", & kTypeDescriptor_GGS_imp_type) ;
...
const C_galgas_type_descriptor * GGS_imp_type::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_imp_sca_type ("imp_sca_type", true, & kTypeDescriptor_GGS_imp_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__imp_sca_type ("imp_sca_type", gClassInfoFor__imp_type, & kTypeDescriptor_GGS_imp_sca_type) ;
...
const C_galgas_type_descriptor * GGS_imp_sca_type::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_imp_obj_ref ("imp_obj_ref", true, & kTypeDescriptor_GGS_imp_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__imp_obj_ref ("imp_obj_ref", gClassInfoFor__imp_type, & kTypeDescriptor_GGS_imp_obj_ref) ;
...
const C_galgas_type_descriptor * GGS_imp_obj_ref::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_void_type ("void_type", true, & kTypeDescriptor_GGS_imp_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__void_type ("void_type", gClassInfoFor__imp_type, & kTypeDescriptor_GGS_void_type) ;
...
const C_galgas_type_descriptor * GGS_void_type::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_uint32_type ("uint32_type", true, & kTypeDescriptor_GGS_imp_sca_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__uint32_type ("uint32_type", gClassInfoFor__imp_sca_type, & kTypeDescriptor_GGS_uint32_type) ;
...
const C_galgas_type_descriptor * GGS_uint32_type::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_sint32_type ("sint32_type", true, & kTypeDescriptor_GGS_imp_sca_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__sint32_type ("sint32_type", gClassInfoFor__imp_sca_type, & kTypeDescriptor_GGS_sint32_type) ;
...
const C_galgas_type_descriptor * GGS_sint32_type::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_uint64_type ("uint64_type", true, & kTypeDescriptor_GGS_imp_sca_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__uint64_type ("uint64_type", gClassInfoFor__imp_sca_type, & kTypeDescriptor_GGS_uint64_type) ;
...
const C_galgas_type_descriptor * GGS_uint64_type::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_sint64_type ("sint64_type", true, & kTypeDescriptor_GGS_imp_sca_type) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__sint64_type ("sint64_type", gClassInfoFor__imp_sca_type, & kTypeDescriptor_GGS_sint64_type) ;
...
const C_galgas_type_descriptor * GGS_sint64_type::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_ident_map ("ident_map", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_ident_map::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_string_map ("string_map", false, NULL) ;
...
GGS_object GGS_string_map::reader_object (void) const {
  GGS_object result ;
  if (isBuilt ()) {
    GGS_string_map * p = NULL ;
    macroMyNew (p, GGS_string_map (*this)) ;
    result = GGS_object (p) ;
  }
  return result ;
}
...
GGS_string_map GGS_string_map::castFromObject (C_Compiler & inLexique,
                                   const GGS_object & inObject,
                                   const GGS_location & inErrorLocation
                                   COMMA_LOCATION_ARGS) {
  GGS_string_map result ;
  const GGS__root * embeddedObject = inObject.embeddedObject () ;
  if (NULL != embeddedObject) {
    const GGS_string_map * p = dynamic_cast <const GGS_string_map *> (embeddedObject) ;
    if (NULL != p) {
      result = * p ;
    }else{
      castFromObjectErrorSignaling (inLexique, inErrorLocation, & kTypeDescriptor_GGS_string_map, embeddedObject COMMA_THERE) ;
    }
  }
  return result ;
}
...
const C_galgas_type_descriptor * GGS_string_map::typeDescriptor (void) const {
  return & kTypeDescriptor_GGS_string_map ;
}
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_prefix_map ("prefix_map", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_prefix_map::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_stringset_map ("stringset_map", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_stringset_map::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_ident_list ("ident_list", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_ident_list::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_ident_list_map ("ident_list_map", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_ident_list_map::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_oil_obj ("oil_obj", true, NULL) ;
...
C_galgasRootClassRunTimeInformation gClassInfoFor__oil_obj ("oil_obj", & kTypeDescriptor_GGS_oil_obj) ;
...
const C_galgas_type_descriptor * GGS_oil_obj::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_autostart_obj ("autostart_obj", true, NULL) ;
...
C_galgasRootClassRunTimeInformation gClassInfoFor__autostart_obj ("autostart_obj", & kTypeDescriptor_GGS_autostart_obj) ;
...
const C_galgas_type_descriptor * GGS_autostart_obj::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_autostart_void ("autostart_void", true, & kTypeDescriptor_GGS_autostart_obj) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__autostart_void ("autostart_void", gClassInfoFor__autostart_obj, & kTypeDescriptor_GGS_autostart_void) ;
...
const C_galgas_type_descriptor * GGS_autostart_void::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_autostart_false ("autostart_false", true, & kTypeDescriptor_GGS_autostart_obj) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__autostart_false ("autostart_false", gClassInfoFor__autostart_obj, & kTypeDescriptor_GGS_autostart_false) ;
...
const C_galgas_type_descriptor * GGS_autostart_false::typeDescriptor (void) const {
...
const C_galgas_function_descriptor kFunction_descriptor_empty_lstring ("empty_lstring",
...
const C_galgas_function_descriptor kFunction_descriptor_void_obj ("void_obj",
...
void routine_set_uint32 (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_6979 = var_cas_t ; // CAST instruction
    if (_var_6979.getPtr () != NULL) {
      macroValidPointer (_var_6979.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_6979.getPtr ()))) {
        var_cas_t = GGS_uint32_class ::constructor_new (inLexique, var_cas_i.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (294)), var_cas_i.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (294)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (294)) COMMA_HERE) ;
      }else{
        var_cas_i.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (var_cas_att).operator_concat (GGS_string (" Redefinition")) COMMA_SOURCE_FILE_AT_LINE (297)) ;
        var_cas_t.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (297)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (298)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_set_uint64 (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_7578 = var_cas_t ; // CAST instruction
    if (_var_7578.getPtr () != NULL) {
      macroValidPointer (_var_7578.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_7578.getPtr ()))) {
        var_cas_t = GGS_uint64_class ::constructor_new (inLexique, var_cas_i.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (318)), var_cas_i.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (318)) COMMA_HERE) ;
      }else{
        var_cas_i.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (var_cas_att).operator_concat (GGS_string (" Redefinition")) COMMA_SOURCE_FILE_AT_LINE (321)) ;
        var_cas_t.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (321)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (322)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_set_lstring (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_8184 = var_cas_t ; // CAST instruction
    if (_var_8184.getPtr () != NULL) {
      macroValidPointer (_var_8184.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_8184.getPtr ()))) {
        var_cas_t = GGS_string_class ::constructor_new (inLexique, var_cas_s.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (342)), var_cas_s.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (342)) COMMA_HERE) ;
      }else{
        var_cas_s.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (var_cas_att).operator_concat (GGS_string (" Redefinition")) COMMA_SOURCE_FILE_AT_LINE (345)) ;
        var_cas_t.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (345)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (346)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_set_bool (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_8775 = var_cas_t ; // CAST instruction
    if (_var_8775.getPtr () != NULL) {
      macroValidPointer (_var_8775.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_8775.getPtr ()))) {
        var_cas_b.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("Redefinition of ")).operator_concat (var_cas_att) COMMA_SOURCE_FILE_AT_LINE (367)) ;
        var_cas_t.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (367)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (368)) ;
      }else{
        var_cas_t = GGS_bool_class ::constructor_new (inLexique, var_cas_b.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (369)), var_cas_b.reader_bool (inLexique COMMA_SOURCE_FILE_AT_LINE (369)) COMMA_HERE) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_bool function_get_bool (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_b ;
  { const GGS_basic_type _var_8962 = var_cas_t ; // CAST instruction
    if (_var_8962.getPtr () != NULL) {
      macroValidPointer (_var_8962.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_8962.getPtr ()))) {
        const GGS_bool_class var_cas_bc (_var_8962.getPtr ()) ;
        var_cas_b = var_cas_bc.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (380)) ;
      }else{
...
static GGS_object functionForGenericCall_get_bool (C_Compiler & inLexique,
                           const GGS_objectlist & inEffectiveParameterArray,
                           const GGS_location & inErrorLocation
                           COMMA_LOCATION_ARGS) {
  const GGS_basic_type  arg_0 = GGS_basic_type ::castFromObject (inLexique, inEffectiveParameterArray.reader_mValueAtIndex (inLexique, GGS_uint (0) COMMA_THERE), inErrorLocation COMMA_THERE) ;
  ...
  const GGS_bool result = function_get_bool (inLexique,
                            arg_0,
                            arg_1
                            COMMA_THERE) ;
  return result.reader_object () ;
...
static const C_galgas_type_descriptor *
kArgumentTypeList_get_bool [2] = {& kTypeDescriptor_GGS_basic_type ,
                              & kTypeDescriptor_GGS_bool} ;

const C_galgas_function_descriptor
kFunction_descriptor_get_bool ("get_bool",
                              functionForGenericCall_get_bool,
                              & kTypeDescriptor_GGS_bool,
                              2,
                              kArgumentTypeList_get_bool) ;
...
GGS_string function_yes_no (C_Compiler &,
  ...
  const GGS_bool cond_9057 = var_cas_b ;
  if (cond_9057.isBuiltAndTrue ()) {
    var_cas_res = GGS_string ("YES") ;
  }else if (cond_9057.isBuiltAndFalse ()) {
...
GGS_string function_true_false (C_Compiler &,
  ...
  #endif
  GGS_string var_cas_res ;
  const GGS_bool cond_9171 = var_cas_b ;
  if (cond_9171.isBuiltAndTrue ()) {
    var_cas_res = GGS_string ("true") ;
  }else if (cond_9171.isBuiltAndFalse ()) {
...
GGS_string function_bool_define (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  var_cas_res = ((((GGS_string ("#define    ")).operator_concat (var_cas_flag)).operator_concat (GGS_string ("    "))).operator_concat (function_yes_no (inLexique, var_cas_b COMMA_SOURCE_FILE_AT_LINE (399)))).operator_concat (GGS_string ("\n")) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_string function_bool_make_define (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  var_cas_res = (((var_cas_flag).operator_concat (GGS_string (" = "))).operator_concat (function_true_false (inLexique, var_cas_b COMMA_SOURCE_FILE_AT_LINE (407)))).operator_concat (GGS_string ("\n")) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_string function_bool_class_define (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  { const GGS_basic_type _var_9732 = var_cas_t ; // CAST instruction
    if (_var_9732.getPtr () != NULL) {
      macroValidPointer (_var_9732.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_9732.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_9732.getPtr ()) ;
        var_cas_res = function_bool_define (inLexique, var_cas_flag, var_cas_b.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (418)) COMMA_SOURCE_FILE_AT_LINE (418)) ;
      }else{
        var_cas_res = function_bool_define (inLexique, var_cas_flag, var_cas_def COMMA_SOURCE_FILE_AT_LINE (420)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_string function_bool_class_make_define (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  { const GGS_basic_type _var_10002 = var_cas_t ; // CAST instruction
    if (_var_10002.getPtr () != NULL) {
      macroValidPointer (_var_10002.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_10002.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_10002.getPtr ()) ;
        var_cas_res = function_bool_make_define (inLexique, var_cas_flag, var_cas_b.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (432)) COMMA_SOURCE_FILE_AT_LINE (432)) ;
      }else{
        var_cas_res = function_bool_make_define (inLexique, var_cas_flag, var_cas_def COMMA_SOURCE_FILE_AT_LINE (434)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_bool_flag (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_basic_type _var_10405 = var_cas_b ; // CAST instruction
    if (_var_10405.getPtr () != NULL) {
      macroValidPointer (_var_10405.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_10405.getPtr ()))) {
      }else if (typeid (cPtr_bool_class) == typeid (* (_var_10405.getPtr ()))) {
        const GGS_bool_class var_cas_bo (_var_10405.getPtr ()) ;
        const GGS_bool cond_10275 = var_cas_bo.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (447)) ;
        ...
        var_cas_b.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (453)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("Internal error, wrong datatype") COMMA_SOURCE_FILE_AT_LINE (454)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_p_bt (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_res ;
  const GGS_basic_type  temp_10489 = var_cas_bt ;
  if (temp_10489.isBuilt ()) {
    temp_10489 (HERE)->method_string (inLexique, var_cas_res COMMA_SOURCE_FILE_AT_LINE (461)) ;
  }
  inLexique.printMessage ((((var_cas_bt.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (462)).reader_locationString (inLexique COMMA_SOURCE_FILE_AT_LINE (462))).operator_concat (GGS_string (": "))).operator_concat (var_cas_res)).operator_concat (GGS_string ("\n")) COMMA_SOURCE_FILE_AT_LINE (462)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_luint64  function_luint64_value (C_Compiler & inLexique,
  ...
  var_cas_v = GGS_luint64 ::constructor_new (inLexique, var_cas_c.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (469)), var_cas_c.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (469)) COMMA_HERE) ;
  #ifdef DEBUG_TRACE_ENABLED
