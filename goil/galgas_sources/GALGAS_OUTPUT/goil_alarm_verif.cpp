...
void routine_counters_of_alarms_defined (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_320 = enumerator_320.nextObject ()))) {
      ...
      var_cas_counter = operand_320->mInfo.alarm.reader_counter_name (inLexique COMMA_SOURCE_FILE_AT_LINE (16)) ;
      if ((((var_cas_counters.reader_hasKey (inLexique, var_cas_counter.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (17)) COMMA_SOURCE_FILE_AT_LINE (17))).operator_not ()).operator_and ((var_cas_counter.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (17))).operator_isNotEqual (GGS_string ("SystemCounter")))).isBuiltAndTrue ()) {
        ...
        { const GGS_autostart_obj _var_1836 = operand_320->mInfo.alarm.reader_autostart_params (inLexique COMMA_SOURCE_FILE_AT_LINE (25)) ; // CAST instruction
          if (_var_1836.getPtr () != NULL) {
            ...
            if (typeid (cPtr_alarm_autostart_true) == typeid (* (_var_1836.getPtr ()))) {
              ...
              if (((var_cas_alarm_time).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
                if (((GGS_bool (inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (33)))).operator_isEqual (GGS_bool (true))).isBuiltAndTrue ()) {
              ...
              const GGS_counter_map  temp_1411 = var_cas_counters ;
              if (temp_1411.isBuilt ()) {
                temp_1411 (HERE)->method_getCounter (inLexique, var_cas_counter, var_cas_ct COMMA_SOURCE_FILE_AT_LINE (41)) ;
              }
              { const GGS_basic_type _var_1814 = var_cas_ct.reader_max_allowed_value (inLexique COMMA_SOURCE_FILE_AT_LINE (42)) ; // CAST instruction
