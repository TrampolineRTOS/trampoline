...
pr_factor_goil_template_expression_parser_1241_13_ (goil_template_scanner & inLexique,
  ...
  switch (select_goil_template_expression_parser_7 (inLexique)) {
    ...
    case 2 : {
      ...
      const GGS_bool cond_47131 = (var_cas_formalParameterList.reader_length ()).operator_isNotEqual (var_cas_actualArgumentList.reader_length ()) ;
      if (cond_47131.isBuiltAndTrue ()) {
        ...
        var_cas_outResultType.drop () ;
      }else if (cond_47131.isBuiltAndFalse ()) {
        GGS_uint  var_cas_idx = GGS_uint (1U) ;
        {
          GGS_typelist::cEnumerator enumerator_47188 (var_cas_formalParameterList, true) ;
          const GGS_typelist::cElement * operand_47188 = NULL ;
          GGS_goilTemplateExpressionList::cEnumerator enumerator_47227 (var_cas_actualArgumentList, true) ;
          const GGS_goilTemplateExpressionList::cElement * operand_47227 = NULL ;
          while (((operand_47188 = enumerator_47188.nextObject ()))
              && ((operand_47227 = enumerator_47227.nextObject ()))) {
            macroValidPointer (operand_47188) ;
            macroValidPointer (operand_47227) ;
            switch (operand_47227->mType.enumValue ()) {
            case GGS_goilTemplateType::enum_boolType:
              {
              const GGS_bool cond_47436 = (operand_47188->mValue).operator_isNotEqual (GGS_type  (& kTypeDescriptor_GGS_bool)) ;
              if (cond_47436.isBuiltAndTrue ()) {
                ::routine_typeError (inLexique,  var_cas_functionOrVariableName,  operand_47188->mValue,  GGS_string ("boolean"),  var_cas_idx COMMA_SOURCE_FILE_AT_LINE (1307)) ;
              }
              var_cas_actualArgumentObjectList.addAssign_operation ((((operand_47227->mValue.reader_mUnsigned64Value (inLexique COMMA_SOURCE_FILE_AT_LINE (1309))).operator_isEqual (GGS_uint64 (0ULL))).isBuiltAndTrue () ? (GGS_bool (false)) : (GGS_bool (true))).reader_object ()) ;
              }
              break ;
            case GGS_goilTemplateType::enum_unsignedType:
              {
              const GGS_bool cond_47724 = (operand_47188->mValue).operator_isNotEqual (GGS_type  (& kTypeDescriptor_GGS_uint64)) ;
              if (cond_47724.isBuiltAndTrue ()) {
                ::routine_typeError (inLexique,  var_cas_functionOrVariableName,  operand_47188->mValue,  GGS_string ("unsigned"),  var_cas_idx COMMA_SOURCE_FILE_AT_LINE (1312)) ;
              }
              var_cas_actualArgumentObjectList.addAssign_operation (operand_47227->mValue.reader_mUnsigned64Value (inLexique COMMA_SOURCE_FILE_AT_LINE (1314)).reader_object ()) ;
              }
              break ;
            case GGS_goilTemplateType::enum_stringType:
              {
              const GGS_bool cond_47974 = (operand_47188->mValue).operator_isNotEqual (GGS_type  (& kTypeDescriptor_GGS_string)) ;
              if (cond_47974.isBuiltAndTrue ()) {
                ::routine_typeError (inLexique,  var_cas_functionOrVariableName,  operand_47188->mValue,  GGS_string ("string"),  var_cas_idx COMMA_SOURCE_FILE_AT_LINE (1317)) ;
              }
              var_cas_actualArgumentObjectList.addAssign_operation (operand_47227->mValue.reader_mStringValue (inLexique COMMA_SOURCE_FILE_AT_LINE (1319)).reader_object ()) ;
              }
              break ;
            case GGS_goilTemplateType::enum_listType:
              {
              ::routine_typeError (inLexique,  var_cas_functionOrVariableName,  operand_47188->mValue,  GGS_string ("string"),  var_cas_idx COMMA_SOURCE_FILE_AT_LINE (1321)) ;
              }
              break ;
            case GGS_goilTemplateType::kNotBuilt:
              break ;
        ...
        var_cas_outResultType = GGS_goilTemplateType::constructor_unsignedType (inLexique COMMA_HERE) ;
        var_cas_outValue = GGS_goilTemplateValue::constructor_new (GGS_uint64 (0ULL), GGS_string (""), GGS_goilTemplateFieldMapList ::constructor_emptyList ()) ;
        const GGS_bool cond_49371 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
        if (cond_49371.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_48794 = (var_cas_result.reader_objectStaticType ()).operator_isEqual (GGS_type  (& kTypeDescriptor_GGS_uint64)) ;
          if (cond_48794.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_goilTemplateType::constructor_unsignedType (inLexique COMMA_HERE) ;
          ...
          }else if (cond_48794.isBuiltAndFalse ()) {
            const GGS_bool cond_49017 = (var_cas_result.reader_objectStaticType ()).operator_isEqual (GGS_type  (& kTypeDescriptor_GGS_bool)) ;
            if (cond_49017.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_goilTemplateType::constructor_boolType (inLexique COMMA_HERE) ;
            ...
            }else if (cond_49017.isBuiltAndFalse ()) {
              const GGS_bool cond_49232 = (var_cas_result.reader_objectStaticType ()).operator_isEqual (GGS_type  (& kTypeDescriptor_GGS_string)) ;
              if (cond_49232.isBuiltAndTrue ()) {
                var_cas_outResultType = GGS_goilTemplateType::constructor_stringType (inLexique COMMA_HERE) ;
              ...
              }else if (cond_49232.isBuiltAndFalse ()) {
