...
//                    september 1st, 2009, at 16h46'37"                      *
//                                                                           *
//---------------------------------------------------------------------------*
    ...
    ::routine_object_not_in_any (inLexique,  var_cas_resources.reader_keyList (inLexique COMMA_SOURCE_FILE_AT_LINE (158)),  var_cas_all_rezs_in_app,  GGS_string ("RESOURCE") COMMA_SOURCE_FILE_AT_LINE (158)) ;
    {
      ...
      while (((operand_6120 = enumerator_6120.nextObject ()))) {
        ...
        if ((((operand_6120->mInfo.app.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (163)).reader_keyList (inLexique COMMA_SOURCE_FILE_AT_LINE (163)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (163))).operator_isEqual (GGS_uint (0U))).operator_and ((operand_6120->mInfo.app.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (163)).reader_keyList (inLexique COMMA_SOURCE_FILE_AT_LINE (163)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (163))).operator_isEqual (GGS_uint (0U)))).isBuiltAndTrue ()) {
          operand_6120->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("OS445 - An application should have at least one Task OR ISR2. \n") COMMA_SOURCE_FILE_AT_LINE (165)) ;
        }
      }
    }
  }
