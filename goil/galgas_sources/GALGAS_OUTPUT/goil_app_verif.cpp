...
void routine_object_exists (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_452 = enumerator_452.nextObject ()))) {
      ...
      const GGS_bool cond_588 = (var_cas_def.reader_hasKey (inLexique, operand_452->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (16)) COMMA_SOURCE_FILE_AT_LINE (16))).operator_not () ;
...
void routine_object_not_in_any (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_1237 = enumerator_1237.nextObject ()))) {
      ...
      const GGS_bool cond_1423 = (var_cas_app_objs.reader_hasKey (inLexique, var_cas_name COMMA_SOURCE_FILE_AT_LINE (49))).operator_not () ;
...
void routine_apps_well_formed (C_Compiler & inLexique,
  ...
  const GGS_bool cond_17649 = (var_cas_apps.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (75))).operator_strictSup (GGS_uint (0U)) ;
