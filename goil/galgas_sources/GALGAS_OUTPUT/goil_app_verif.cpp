...
void routine_apps_well_formed (C_Compiler & inLexique,
  ...
  const GGS_bool cond_17706 = (var_cas_apps.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
          ...
          while (((operand_14222 = enumerator_14222.nextObject ()))) {
            ...
            var_cas_eps_action = operand_14222->point.reader_actions (inLexique COMMA_SOURCE_FILE_AT_LINE (319)) ;
            {
              ...
              while (((operand_14462 = enumerator_14462.nextObject ()))) {
                ...
                { const GGS_action_obj _var_17616 = operand_14462->actionobj ; // CAST instruction
                  if (_var_17616.getPtr () != NULL) {
                    macroValidPointer (_var_17616.getPtr ()) ;
                    if (typeid (cPtr_setevent_action) == typeid (* (_var_17616.getPtr ()))) {
                      const GGS_setevent_action var_cas_sea (_var_17616.getPtr ()) ;
                      {
                        GGS_app_map::cEnumerator enumerator_14654 (var_cas_apps, true) ;
                        const GGS_app_map::cElement * operand_14654 = NULL ;
                        while (((operand_14654 = enumerator_14654.nextObject ()))) {
                          macroValidPointer (operand_14654) ;
                          {
                            GGS_ident_map::cEnumerator enumerator_14741 (operand_14654->mInfo.app.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (325)), true) ;
                            const GGS_ident_map::cElement * operand_14741 = NULL ;
                            while (((operand_14741 = enumerator_14741.nextObject ()))) {
                              macroValidPointer (operand_14741) ;
                              const GGS_bool cond_15985 = (operand_14741->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (326))).operator_isEqual (var_cas_sea.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (326)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (326))) ;
                              if (cond_15985.isBuiltAndTrue ()) {
                                {
                                  GGS_ident_map::cEnumerator enumerator_15003 (operand_14654->mInfo.app.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (328)), true) ;
                                  const GGS_ident_map::cElement * operand_15003 = NULL ;
                                  while (((operand_15003 = enumerator_15003.nextObject ()))) {
                                    macroValidPointer (operand_15003) ;
                                    const GGS_bool cond_15222 = (operand_15003->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (329))).operator_isEqual (operand_12671->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (329))) ;
                                    if (cond_15222.isBuiltAndTrue ()) {
                                      var_cas_right_app = GGS_bool (true) ;
                                    }
                                  }
                                }
                                const GGS_bool cond_15903 = (var_cas_right_app).operator_isEqual (GGS_bool (false)) ;
                                if (cond_15903.isBuiltAndTrue ()) {
                                  {
                                    GGS_lstringlist::cEnumerator enumerator_15359 (operand_12671->mInfo.scheduletable.reader_acc_apps (inLexique COMMA_SOURCE_FILE_AT_LINE (334)), true) ;
                                    const GGS_lstringlist::cElement * operand_15359 = NULL ;
                                    while (((operand_15359 = enumerator_15359.nextObject ()))) {
                                      macroValidPointer (operand_15359) ;
                                      const GGS_bool cond_15539 = (operand_15359->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (335))).operator_isEqual (operand_14654->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (335))) ;
                                      if (cond_15539.isBuiltAndTrue ()) {
                                        var_cas_access_app = GGS_bool (true) ;
                                      }
                                    }
                                  }
                                  const GGS_bool cond_15827 = (var_cas_access_app).operator_isEqual (GGS_bool (false)) ;
                                  if (cond_15827.isBuiltAndTrue ()) {
                    ...
                    }else if (typeid (cPtr_activatetask_action) == typeid (* (_var_17616.getPtr ()))) {
                      const GGS_activatetask_action var_cas_ata (_var_17616.getPtr ()) ;
                      {
                        GGS_app_map::cEnumerator enumerator_16169 (var_cas_apps, true) ;
                        const GGS_app_map::cElement * operand_16169 = NULL ;
                        while (((operand_16169 = enumerator_16169.nextObject ()))) {
                          macroValidPointer (operand_16169) ;
                          {
                            GGS_ident_map::cEnumerator enumerator_16256 (operand_16169->mInfo.app.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (351)), true) ;
                            const GGS_ident_map::cElement * operand_16256 = NULL ;
                            while (((operand_16256 = enumerator_16256.nextObject ()))) {
                              macroValidPointer (operand_16256) ;
                              const GGS_bool cond_17522 = (operand_16256->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (352))).operator_isEqual (var_cas_ata.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (352)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (352))) ;
                              if (cond_17522.isBuiltAndTrue ()) {
                                {
                                  GGS_ident_map::cEnumerator enumerator_16518 (operand_16169->mInfo.app.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (354)), true) ;
                                  const GGS_ident_map::cElement * operand_16518 = NULL ;
                                  while (((operand_16518 = enumerator_16518.nextObject ()))) {
                                    macroValidPointer (operand_16518) ;
                                    const GGS_bool cond_16737 = (operand_16518->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (355))).operator_isEqual (operand_12671->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (355))) ;
                                    if (cond_16737.isBuiltAndTrue ()) {
                                      var_cas_right_app = GGS_bool (true) ;
                                    }
                                  }
                                }
                                const GGS_bool cond_17440 = (var_cas_right_app).operator_isEqual (GGS_bool (false)) ;
                                if (cond_17440.isBuiltAndTrue ()) {
                                  {
                                    GGS_lstringlist::cEnumerator enumerator_16874 (operand_12671->mInfo.scheduletable.reader_acc_apps (inLexique COMMA_SOURCE_FILE_AT_LINE (360)), true) ;
                                    const GGS_lstringlist::cElement * operand_16874 = NULL ;
                                    while (((operand_16874 = enumerator_16874.nextObject ()))) {
                                      macroValidPointer (operand_16874) ;
                                      const GGS_bool cond_17054 = (operand_16874->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (361))).operator_isEqual (operand_16169->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (361))) ;
                                      if (cond_17054.isBuiltAndTrue ()) {
                                        var_cas_access_app = GGS_bool (true) ;
                                      }
                                    }
                                  }
                                  const GGS_bool cond_17364 = (var_cas_access_app).operator_isEqual (GGS_bool (false)) ;
                                  if (cond_17364.isBuiltAndTrue ()) {
