...
void routine_generate_flags (C_Compiler & inLexique,
  ...
  const GGS_trace  temp_11235 = var_cas_os.reader_trace (inLexique COMMA_SOURCE_FILE_AT_LINE (289)) ;
  if (temp_11235.isBuilt ()) {
    temp_11235 (HERE)->method_generate_c (inLexique, var_cas_tr COMMA_SOURCE_FILE_AT_LINE (289)) ;
  }
...
void routine_generate_makefile (C_Compiler & inLexique,
  ...
  var_cas_flags = GGS_string ("") ;
  GGS_string var_cas_tr ;
  const GGS_trace  temp_15229 = var_cas_os.reader_trace (inLexique COMMA_SOURCE_FILE_AT_LINE (386)) ;
  if (temp_15229.isBuilt ()) {
    temp_15229 (HERE)->method_generate_make (inLexique, var_cas_tr COMMA_SOURCE_FILE_AT_LINE (386)) ;
  }
  var_cas_flags.dotAssign_operation (var_cas_tr) ;
  ...
  const GGS_string temp_15495 = var_cas_makefileStr ;
  if (temp_15495.isBuilt ()) {
    temp_15495 (HERE)->method_writeToFile (inLexique, (var_cas_directory).operator_concat (GGS_string ("/Makefile")) COMMA_SOURCE_FILE_AT_LINE (394)) ;
  }
  ...
  { const GGS_basic_type _var_16561 = var_cas_os.reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (413)) ; // CAST instruction
    if (_var_16561.getPtr () != NULL) {
      ...
      if (typeid (cPtr_bool_class) == typeid (* (_var_16561.getPtr ()))) {
        ...
        const GGS_bool_class  temp_16445 = var_cas_b ;
        if (temp_16445.isBuilt ()) {
          temp_16445 (HERE)->method_string (inLexique, var_cas_s COMMA_SOURCE_FILE_AT_LINE (416)) ;
        }
  ...
  if (((var_cas_filename.reader_fileExists (inLexique COMMA_SOURCE_FILE_AT_LINE (432))).operator_not ()).isBuiltAndTrue ()) {
    const GGS_string temp_17040 = var_cas_makerulesStr ;
    if (temp_17040.isBuilt ()) {
      temp_17040 (HERE)->method_writeToFile (inLexique, var_cas_filename COMMA_SOURCE_FILE_AT_LINE (433)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
        ...
        if (_var_22738.getPtr () != NULL) {
          ...
          if (typeid (cPtr_app_trusted_true) == typeid (* (_var_22738.getPtr ()))) {
            const GGS_app_trusted_true var_cas_t (_var_22738.getPtr ()) ;
            {
              ...
              while (enumerator_22657.hasCurrentObject ()) {
...
void routine_generate_alarms (C_Compiler & inLexique,
    ...
    while (((operand_24282 = enumerator_24282.nextObject ()))) {
      ...
      if ((GGS_bool (inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (720)))).isBuiltAndTrue ()) {
        if (((var_cas_app_for_obj.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (721))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
          ...
          const GGS_string_map  temp_26780 = var_cas_app_for_obj ;
          if (temp_26780.isBuilt ()) {
            temp_26780 (HERE)->method_get (inLexique, operand_24282->mKey, var_cas_app_name COMMA_SOURCE_FILE_AT_LINE (723)) ;
          }
  ...
  var_cas_alarm_imp = GGS_string ("") ;
  {
    ...
    if (enumerator_27070 .hasCurrentObject ()) {
      ...
      do{
        ...
        _foreach_loop_27070 = (enumerator_27070 .hasCurrentObject ()) ;
...
void routine_compute_actual_task_priority (C_Compiler & inLexique,
  ...
  if (((var_cas_tl.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (797))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    ...
    const GGS_objs_by_prio  temp_29123 = var_cas_tl ;
    if (temp_29123.isBuilt ()) {
      temp_29123 (HERE)->method_smallest (inLexique, var_cas_cur_rel_prio, automatic_var_0, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (798)) ;
    }
  }
  {
  ...
  if (((var_cas_isrs.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (830))).operator_isNotEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    {
      ...
      while (((operand_30297 = enumerator_30297.nextObject ()))) {
        ...
        const GGS_isr_obj  temp_30545 = operand_30297->mInfo.isr ;
        if (temp_30545.isBuilt ()) {
          temp_30545 (HERE)->method_get_activation (inLexique, var_cas_act COMMA_SOURCE_FILE_AT_LINE (843)) ;
        }
    ...
    if (((var_cas_il.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (863))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      const GGS_objs_by_prio  temp_31207 = var_cas_il ;
      if (temp_31207.isBuilt ()) {
        temp_31207 (HERE)->method_smallest (inLexique, var_cas_cur_rel_prio, automatic_var_2, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (864)) ;
      }
    }
    {
      ...
      var_cas_rez_comment = GGS_string ("") ;
      {
        ...
        while (((operand_32884 = enumerator_32884.nextObject ()))) {
          ...
          if ((var_cas_owned).isBuiltAndTrue ()) {
            GGS_uint  var_cas_prio ;
            GGS_uint  var_cas_act ;
            const GGS_prio_map  temp_33169 = var_cas_prio_for_task ;
            if (temp_33169.isBuilt ()) {
              temp_33169 (HERE)->method_get (inLexique, operand_32884->mKey, var_cas_prio, var_cas_act COMMA_SOURCE_FILE_AT_LINE (922)) ;
            }
      ...
      }
      {
        ...
        while (((operand_33478 = enumerator_33478.nextObject ()))) {
          ...
          if ((var_cas_owned).isBuiltAndTrue ()) {
            GGS_uint  var_cas_prio ;
            GGS_uint  var_cas_act ;
            const GGS_prio_map  temp_33762 = var_cas_prio_for_isr ;
            if (temp_33762.isBuilt ()) {
              temp_33762 (HERE)->method_get (inLexique, operand_33478->mKey, var_cas_prio, var_cas_act COMMA_SOURCE_FILE_AT_LINE (937)) ;
            }
            if (((var_cas_prio).operator_strictSup (var_cas_rez_prio)).isBuiltAndTrue ()) {
              var_cas_rez_prio = var_cas_prio ;
            }
      ...
      }
      {
        ...
        while (((operand_34325 = enumerator_34325.nextObject ()))) {
          ...
          if ((var_cas_owned).isBuiltAndTrue ()) {
            GGS_uint  var_cas_prio ;
            GGS_uint  var_cas_act ;
            const GGS_prio_map  temp_34610 = var_cas_prio_for_task ;
            if (temp_34610.isBuilt ()) {
              temp_34610 (HERE)->method_get (inLexique, operand_34325->mKey, var_cas_prio, var_cas_act COMMA_SOURCE_FILE_AT_LINE (961)) ;
            }
      ...
      }
      {
        ...
        while (((operand_34800 = enumerator_34800.nextObject ()))) {
          ...
          if ((var_cas_owned).isBuiltAndTrue ()) {
            GGS_uint  var_cas_prio ;
            GGS_uint  var_cas_act ;
            const GGS_prio_map  temp_35084 = var_cas_prio_for_isr ;
            if (temp_35084.isBuilt ()) {
              temp_35084 (HERE)->method_get (inLexique, operand_34800->mKey, var_cas_prio, var_cas_act COMMA_SOURCE_FILE_AT_LINE (974)) ;
            }
            if (((var_cas_prio).operator_isEqual (var_cas_rez_prio)).isBuiltAndTrue ()) {
...
void routine_generate_tasks (C_Compiler & inLexique,
  ...
  var_cas_non_preemptable_exists = GGS_bool (false) ;
  {
    ...
    while (((operand_38822 = enumerator_38822.nextObject ()))) {
      ...
      const GGS_prio_map  temp_40489 = var_cas_actual_priorities ;
      if (temp_40489.isBuilt ()) {
        temp_40489 (HERE)->method_get (inLexique, operand_38822->mKey, var_cas_actual_prio, automatic_var_8 COMMA_SOURCE_FILE_AT_LINE (1132)) ;
      }
        ...
        var_cas_no_internal_rez_found = GGS_bool (true) ;
        {
          ...
          while (((operand_41157 = enumerator_41157.nextObject ()))) {
            ...
            if ((var_cas_no_internal_rez_found).isBuiltAndTrue ()) {
              ...
              const GGS_resource_map  temp_41300 = var_cas_resources ;
              if (temp_41300.isBuilt ()) {
                temp_41300 (HERE)->method_get (inLexique, operand_41157->mValue, var_cas_rez COMMA_SOURCE_FILE_AT_LINE (1150)) ;
              }
      ...
      const GGS_timing_prot  temp_43012 = var_cas_timing_prot ;
      if (temp_43012.isBuilt ()) {
        temp_43012 (HERE)->method_generate (inLexique, var_cas_cfg, var_cas_tp, var_cas_tp_ref, operand_38822->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1190)), var_cas_resources COMMA_SOURCE_FILE_AT_LINE (1190)) ;
      }
      ...
      if ((GGS_bool (inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (1195)))).isBuiltAndTrue ()) {
        if (((var_cas_app_for_obj.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (1196))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
          GGS_string var_cas_app_name ;
          const GGS_string_map  temp_43428 = var_cas_app_for_obj ;
          if (temp_43428.isBuilt ()) {
            temp_43428 (HERE)->method_get (inLexique, operand_38822->mKey, var_cas_app_name COMMA_SOURCE_FILE_AT_LINE (1198)) ;
          }
          ...
          const GGS_app_map  temp_43642 = var_cas_apps ;
          if (temp_43642.isBuilt ()) {
            temp_43642 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_app_name, GGS_location (inLexique) COMMA_HERE), var_cas_app COMMA_SOURCE_FILE_AT_LINE (1203)) ;
          }
...
void routine_generate_isrs (C_Compiler & inLexique,
  ...
  ::routine_retrieveTemplateString (inLexique,  var_cas_tpl_isr,  GGS_string ("isr") COMMA_SOURCE_FILE_AT_LINE (1249)) ;
  {
    ...
    while (((operand_45317 = enumerator_45317.nextObject ()))) {
      ...
      const GGS_prio_map  temp_46139 = var_cas_actual_priorities ;
      if (temp_46139.isBuilt ()) {
        temp_46139 (HERE)->method_get (inLexique, operand_45317->mKey, var_cas_actual_prio, automatic_var_9 COMMA_SOURCE_FILE_AT_LINE (1270)) ;
      }
      ...
      GGS_uint  var_cas_act ;
      const GGS_isr_obj  temp_46302 = operand_45317->mInfo.isr ;
      if (temp_46302.isBuilt ()) {
        temp_46302 (HERE)->method_get_activation (inLexique, var_cas_act COMMA_SOURCE_FILE_AT_LINE (1274)) ;
      }
      ...
      GGS_string var_cas_tp ;
      GGS_string var_cas_tp_ref ;
      const GGS_timing_prot  temp_46545 = var_cas_timing_prot ;
      if (temp_46545.isBuilt ()) {
        temp_46545 (HERE)->method_generate (inLexique, var_cas_cfg, var_cas_tp, var_cas_tp_ref, operand_45317->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1281)), var_cas_resources COMMA_SOURCE_FILE_AT_LINE (1281)) ;
      }
      ...
      if ((GGS_bool (inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (1286)))).isBuiltAndTrue ()) {
        if (((var_cas_app_for_obj.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (1287))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
          GGS_string var_cas_app_name ;
          const GGS_string_map  temp_46896 = var_cas_app_for_obj ;
          if (temp_46896.isBuilt ()) {
            temp_46896 (HERE)->method_get (inLexique, operand_45317->mKey, var_cas_app_name COMMA_SOURCE_FILE_AT_LINE (1289)) ;
          }
          ...
          var_cas_trust = GGS_uint (0U) ;
          GGS_app_obj  var_cas_app ;
          const GGS_app_map  temp_47109 = var_cas_apps ;
          if (temp_47109.isBuilt ()) {
            temp_47109 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_app_name, GGS_location (inLexique) COMMA_HERE), var_cas_app COMMA_SOURCE_FILE_AT_LINE (1294)) ;
          }
      ...
      if ((GGS_bool (inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (1380)))).isBuiltAndTrue ()) {
        ...
        if (((operand_48447->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1389))).operator_isEqual (GGS_string ("SystemCounter"))).isBuiltAndTrue ()) {
          ...
          if (((var_cas_app_for_obj.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (1392))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
            GGS_string var_cas_app_name ;
            const GGS_string_map  temp_50914 = var_cas_app_for_obj ;
            if (temp_50914.isBuilt ()) {
              temp_50914 (HERE)->method_get (inLexique, operand_48447->mKey, var_cas_app_name COMMA_SOURCE_FILE_AT_LINE (1394)) ;
            }
...
void routine_generate_resources (C_Compiler & inLexique,
  ...
  ::routine_retrieveTemplateString (inLexique,  var_cas_tpl_internal_resource,  GGS_string ("internal_resource") COMMA_SOURCE_FILE_AT_LINE (1454)) ;
  {
    ...
    while (((operand_53283 = enumerator_53283.nextObject ()))) {
      ...
      const GGS_prio_map  temp_53564 = var_cas_rez_prio ;
      if (temp_53564.isBuilt ()) {
        temp_53564 (HERE)->method_get (inLexique, operand_53283->mKey, var_cas_prio, automatic_var_10 COMMA_SOURCE_FILE_AT_LINE (1466)) ;
      }
      const GGS_string_map  temp_53616 = var_cas_rez_comments ;
      if (temp_53616.isBuilt ()) {
        temp_53616 (HERE)->method_get (inLexique, operand_53283->mKey, var_cas_usage COMMA_SOURCE_FILE_AT_LINE (1467)) ;
      }
      ...
      if ((GGS_bool (inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (1489)))).isBuiltAndTrue ()) {
        if (((var_cas_app_for_obj.reader_count (inLexique COMMA_SOURCE_FILE_AT_LINE (1490))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
          GGS_string var_cas_app_name ;
          const GGS_string_map  temp_54528 = var_cas_app_for_obj ;
          if (temp_54528.isBuilt ()) {
            temp_54528 (HERE)->method_get (inLexique, operand_53283->mKey, var_cas_app_name COMMA_SOURCE_FILE_AT_LINE (1492)) ;
          }
  ...
  var_cas_rez_imp = GGS_string ("") ;
  {
    ...
    while (enumerator_54837.hasCurrentObject ()) {
  ...
  var_cas_regular_rez._addAssign_operation (GGS_string ("res_sched")) ;
  {
    ...
    if (enumerator_55068 .hasCurrentObject ()) {
      GGS_uint var_cas_n (true, 0) ;
      ...
      do{
        ...
        _foreach_loop_55068 = (enumerator_55068 .hasCurrentObject ()) ;
    ...
    while (((operand_56811 = enumerator_56811.nextObject ()))) {
      ...
      var_cas_event_mask = GGS_uint64 (0U) ;
      {
        ...
        while (((operand_56984 = enumerator_56984.nextObject ()))) {
          ...
          const GGS_event_map  temp_57061 = var_cas_events ;
          if (temp_57061.isBuilt ()) {
            temp_57061 (HERE)->method_get (inLexique, operand_56984->mValue, var_cas_event COMMA_SOURCE_FILE_AT_LINE (1566)) ;
          }
  ...
  }
  {
    ...
    while (((operand_59188 = enumerator_59188.nextObject ()))) {
      ...
      if ((var_cas_tasks_for_event.reader_hasKey (inLexique, operand_59188->event_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1635)) COMMA_SOURCE_FILE_AT_LINE (1635))).isBuiltAndTrue ()) {
        ...
        const GGS_stringset_map  temp_59300 = var_cas_tasks_for_event ;
        if (temp_59300.isBuilt ()) {
          temp_59300 (HERE)->method_get (inLexique, operand_59188->event_name, var_cas_tasks COMMA_SOURCE_FILE_AT_LINE (1637)) ;
        }
        GGS_uint64  var_cas_mask ;
        var_cas_mask = GGS_uint64 (0U) ;
        {
          GGS_stringset::cEnumerator enumerator_59367 (var_cas_tasks, true) ;
          while (enumerator_59367.hasCurrentObject ()) {
            GGS_uint64  var_cas_tm ;
            const GGS_task_mask  temp_59430 = var_cas_task_mask ;
            if (temp_59430.isBuilt ()) {
              temp_59430 (HERE)->method_get_mask (inLexique, GGS_lstring ::constructor_new (inLexique, enumerator_59367._key (HERE), GGS_location (inLexique) COMMA_HERE), var_cas_tm COMMA_SOURCE_FILE_AT_LINE (1641)) ;
            }
        ...
        }
        {
          ...
          while (enumerator_60052.hasCurrentObject ()) {
            GGS_uint64  var_cas_tm ;
...
void routine_generate_ready_list (C_Compiler & inLexique,
  ...
  if ((var_cas_config.reader_hasKey (inLexique, GGS_string ("POWEROF2QUEUE") COMMA_SOURCE_FILE_AT_LINE (1766))).isBuiltAndTrue ()) {
    ...
    const GGS_ident_map  temp_63695 = var_cas_config ;
    if (temp_63695.isBuilt ()) {
      temp_63695 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("POWEROF2QUEUE"), GGS_location (inLexique) COMMA_HERE), var_cas_pw COMMA_SOURCE_FILE_AT_LINE (1768)) ;
    }
...
void routine_generate_all (C_Compiler & inLexique,
  ...
  if (((var_cas_temp_dir).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
    ...
    if (((var_cas_target).operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
      ...
      const GGS_com  temp_68142 = var_cas_cpu.reader_com (inLexique COMMA_SOURCE_FILE_AT_LINE (1922)) ;
      if (temp_68142.isBuilt ()) {
        temp_68142 (HERE)->method_generate (inLexique, var_cas_obj_header COMMA_SOURCE_FILE_AT_LINE (1922)) ;
      }
      ...
      if (((var_cas_error_count).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
        ...
        const GGS_string temp_73464 = var_cas_header ;
        if (temp_73464.isBuilt ()) {
          temp_73464 (HERE)->method_makeDirectoryAndWriteToFile (inLexique, var_cas_header_file COMMA_SOURCE_FILE_AT_LINE (2090)) ;
        }
        ...
        const GGS_string temp_73666 = var_cas_obj_header ;
        if (temp_73666.isBuilt ()) {
          temp_73666 (HERE)->method_makeDirectoryAndWriteToFile (inLexique, var_cas_obj_header_file COMMA_SOURCE_FILE_AT_LINE (2094)) ;
        }
        ...
        const GGS_string temp_73880 = var_cas_implementation ;
        if (temp_73880.isBuilt ()) {
          temp_73880 (HERE)->method_makeDirectoryAndWriteToFile (inLexique, var_cas_implementation_file COMMA_SOURCE_FILE_AT_LINE (2098)) ;
        }
        ...
        const GGS_string temp_74080 = var_cas_types ;
        if (temp_74080.isBuilt ()) {
          temp_74080 (HERE)->method_makeDirectoryAndWriteToFile (inLexique, var_cas_types_file COMMA_SOURCE_FILE_AT_LINE (2102)) ;
        }
