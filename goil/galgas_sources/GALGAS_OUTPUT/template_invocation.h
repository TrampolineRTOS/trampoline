...
GALGASap_string function_fullPrefix (GALGASap_goilTemplateVariableMap & constinArgument0,
...
//---------------------------------------------------------------------------*
//                                                                           *
//                       Routine 'displayTypeAndValue'                       *
//                                                                           *
//---------------------------------------------------------------------------*

GALGASap_string function_displayTypeAndValue (GALGASap_goilTemplateType & constinArgument0,
...
void routine_displayTemplateVariableMap (GALGASap_goilTemplateVariableMap constinArgument0,
                                         C_Compiler * inCompiler
                                         COMMA_LOCATION_ARGS) ;
...
void routine_displayPathList (GALGASap_stringlist constinArgument0,
                              C_Compiler * inCompiler
                              COMMA_LOCATION_ARGS) ;
...
void routine_findFileInHierarchy (GALGASap_string constinArgument0,
                                  GALGASap_string constinArgument1,
                                  GALGASap_string constinArgument2,
                                  GALGASap_stringlist & ioArgument3,
                                  GALGASap_bool & ioArgument4,
...
void routine_findAllFilesInHierarchy (GALGASap_string constinArgument0,
                                      GALGASap_string constinArgument1,
                                      GALGASap_string constinArgument2,
                                      GALGASap_stringlist & ioArgument3,
                                      GALGASap_stringlist & ioArgument4,
                                      C_Compiler * inCompiler
                                      COMMA_LOCATION_ARGS) ;
...
void routine_findFileInPathList (GALGASap_string constinArgument0,
                                 GALGASap_stringlist constinArgument1,
                                 GALGASap_string constinArgument2,
                                 GALGASap_stringlist & outArgument3,
                                 GALGASap_bool & outArgument4,
                                 GALGASap_string & outArgument5,
                                 C_Compiler * inCompiler
                                 COMMA_LOCATION_ARGS) ;
...
void routine_findAllFilesInPathList (GALGASap_string constinArgument0,
                                     GALGASap_stringlist constinArgument1,
                                     GALGASap_string constinArgument2,
                                     GALGASap_stringlist & outArgument3,
                                     GALGASap_stringlist & outArgument4,
                                     C_Compiler * inCompiler
                                     COMMA_LOCATION_ARGS) ;
...
void routine_goilTemplateInvocation (GALGASap_lstring constinArgument0,
                                     GALGASap_string constinArgument1,
                                     GALGASap_string constinArgument2,
                                     GALGASap_string constinArgument3,
                                     GALGASap_bool constinArgument4,
                                     GALGASap_goilTemplateVariableMap constinArgument5,
                                     GALGASap_string & ioArgument6,
                                     GALGASap_bool & outArgument7,
                                     C_Compiler * inCompiler
                                     COMMA_LOCATION_ARGS) ;
