...
class goil_obj_resource {
  ...
  protected : void pr_resource_goil_obj_resource_41_15_ (goil_lexique &,
                                GGS_resource_map  &) ;

  protected : void pr_resource_attributes_goil_obj_resource_71_26_ (goil_lexique &,
                                GGS_resource_property_obj  &,
                                GGS_lstringlist  &) ;
