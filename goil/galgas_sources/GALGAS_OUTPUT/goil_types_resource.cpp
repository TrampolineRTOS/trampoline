...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@resource_property_linked_obj:"
           << location.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << linked_resource.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@resource_obj:"
           ...
           << property.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.resource.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.linked_resource.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
