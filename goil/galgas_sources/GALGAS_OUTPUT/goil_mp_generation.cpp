...
void routine_generate_mp (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_tpl_mp,  GGS_string ("mp") COMMA_SOURCE_FILE_AT_LINE (49)) ;
  ::routine_doReplace (_inLexique,  var_cas_tpl_mp,  GGS_string ("$TIMESTAMP$"),  GGS_string::constructor_stringWithCurrentDateTime (_inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (50)) ;
  ...
  var_cas_known_osapp = GGS_stringset ::constructor_emptySet () ;
  {
    ...
    while (((operand_1270 = enumerator_1270.nextObject ()))) {
      ...
      var_cas_ext.appendCString ("_STACK_RGN;\n") ;
      if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (60)))).isBuiltAndTrue ()) {
        if (((var_cas_app_for_obj.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (61)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      var_cas_init._dotAssign_operation (operand_1270->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (74))) ;
      var_cas_init.appendCString ("_STACK_RGN;\n") ;
      if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (75)))).isBuiltAndTrue ()) {
        if (((var_cas_app_for_obj.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (76)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
          GGS_string var_cas_app_name ;
  ...
  }
  {
    ...
    while (((operand_2985 = enumerator_2985.nextObject ()))) {
      ...
      if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (93)))).isBuiltAndTrue ()) {
        if (((var_cas_app_for_obj.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (94)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
          GGS_string var_cas_app_name ;
      ...
      var_cas_init._dotAssign_operation (operand_2985->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (107))) ;
      var_cas_init.appendCString ("_STACK_RGN;\n") ;
      if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (108)))).isBuiltAndTrue ()) {
        if (((var_cas_app_for_obj.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (109)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
          GGS_string var_cas_app_name ;
  ...
  var_cas_stasks = GGS_tasks_by_type ::constructor_emptySortedList () ;
  {
    ...
    while (((operand_4789 = enumerator_4789.nextObject ()))) {
      ...
      if (((operand_4789->mInfo.task.reader_events (_inLexique COMMA_SOURCE_FILE_AT_LINE (123)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (123)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
        var_cas_stasks._addAssign_operation (GGS_uint (0U), operand_4789->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (124))) ;
      }else{
        var_cas_stasks._addAssign_operation (GGS_uint (1U), operand_4789->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (126))) ;
      }
    }
  }
  ...
  var_cas_mp_table = GGS_string ("CONSTP2VAR(tpl_mem_prot_desc, AUTOMATIC, OS_VAR) tpl_mp_table[TASK_COUNT + ISR_COUNT + 1] = {\n") ;
  {
    ...
    while (((operand_5079 = enumerator_5079.nextObject ()))) {
      ...
      if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (134)))).isBuiltAndTrue ()) {
        if (((var_cas_app_for_obj.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (135)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
          GGS_string var_cas_app_name ;
  ...
  var_cas_directory = function_project_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (158)) ;
  ::routine_doReplace (_inLexique,  var_cas_tpl_mp,  GGS_string ("$APPLICATION$"),  var_cas_directory COMMA_SOURCE_FILE_AT_LINE (160)) ;
  ::routine_doReplace (_inLexique,  var_cas_tpl_mp,  GGS_string ("$LINKER_SYM$"),  var_cas_ext COMMA_SOURCE_FILE_AT_LINE (161)) ;
  ::routine_doReplace (_inLexique,  var_cas_tpl_mp,  GGS_string ("$REGION_DESC$"),  var_cas_dec COMMA_SOURCE_FILE_AT_LINE (162)) ;
  ::routine_doReplace (_inLexique,  var_cas_tpl_mp,  GGS_string ("$INIT_CODE$"),  var_cas_init COMMA_SOURCE_FILE_AT_LINE (163)) ;
  ::routine_doReplace (_inLexique,  var_cas_tpl_mp,  GGS_string ("$DESC_TABLE$"),  var_cas_mp_table COMMA_SOURCE_FILE_AT_LINE (164)) ;
  if (((GGS_uint ::constructor_errorCount (_inLexique COMMA_HERE))._operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
    if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("generic_galgas_cli_options", "verbose_output" COMMA_SOURCE_FILE_AT_LINE (167)))).isBuiltAndTrue ()) {
      _inLexique.printMessage (GGS_string ("creating tpl_generated_mp.c\n") COMMA_SOURCE_FILE_AT_LINE (168)) ;
    }
    const GGS_string _temp_6291 = var_cas_tpl_mp ;
    if (_temp_6291.isBuilt ()) {
      _temp_6291 (HERE)->method_makeDirectoryAndWriteToFile (_inLexique, (var_cas_directory)._operator_concat (GGS_string ("/tpl_generated_mp.c")) COMMA_SOURCE_FILE_AT_LINE (170)) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
