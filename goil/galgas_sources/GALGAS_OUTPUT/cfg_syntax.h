...
//--- Non terminal declarations
  protected : virtual void nt_cfg_5F_attrs_ (GALGAS_cfg_5F_attrs & ioArgument0,
                                             C_Lexique_cfg_5F_lexique * inLexique) = 0 ;

  protected : virtual void nt_cfg_5F_attrs_parse (C_Lexique_cfg_5F_lexique * inLexique) = 0 ;

  protected : virtual void nt_cfg_5F_start_ (GALGAS_config & outArgument0,
                                             C_Lexique_cfg_5F_lexique * inLexique) = 0 ;

  protected : virtual void nt_cfg_5F_start_parse (C_Lexique_cfg_5F_lexique * inLexique) = 0 ;

  protected : virtual void nt_interrupts_ (GALGAS_basic_5F_type & ioArgument0,
                                           C_Lexique_cfg_5F_lexique * inLexique) = 0 ;

  protected : virtual void nt_interrupts_parse (C_Lexique_cfg_5F_lexique * inLexique) = 0 ;


//--- Rule declarations
  protected : void rule_cfg_5F_syntax_cfg_5F_start_i0_ (GALGAS_config & outArgument0,
                                                        C_Lexique_cfg_5F_lexique * inLexique) ;

  protected : void rule_cfg_5F_syntax_cfg_5F_start_i0_parse (C_Lexique_cfg_5F_lexique * inLexique) ;

  protected : void rule_cfg_5F_syntax_cfg_5F_attrs_i1_ (GALGAS_cfg_5F_attrs & ioArgument0,
                                                        C_Lexique_cfg_5F_lexique * inLexique) ;

  protected : void rule_cfg_5F_syntax_cfg_5F_attrs_i1_parse (C_Lexique_cfg_5F_lexique * inLexique) ;

  protected : void rule_cfg_5F_syntax_interrupts_i2_ (GALGAS_basic_5F_type & ioArgument0,
                                                      C_Lexique_cfg_5F_lexique * inLexique) ;

  protected : void rule_cfg_5F_syntax_interrupts_i2_parse (C_Lexique_cfg_5F_lexique * inLexique) ;
