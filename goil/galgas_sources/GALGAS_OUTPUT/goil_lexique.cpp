  ...
  if (ptr == NULL) {
    ...
    case  goil_lexique_1_string:
      s << "$"
        ...
        << "$" ;
    s << " " ;
    s.appendCLiteralStringConstant (ptr->a_string) ;
      break;
    ...
    case  goil_lexique_1_uint_5Fnumber:
      s << "$"
        ...
        << "$" ;
      s << " " ;
      s.appendUnsigned64 (ptr->integerNumber) ;
      break;
    case  goil_lexique_1_float_5Fnumber:
      s << "$"
        ...
        << "$" ;
      s << " " ;
      s.appendDouble (ptr->floatNumber) ;
      break;
      ...
      if (testForInputUTF32String (kUnicodeString__2F__2F_, 2, true)) {
        ...
        do {
          if (testForInputUTF32CharRange (TO_UNICODE (' '), TO_UNICODE ('!')) ||
            ...
            ::scanner_routine_enterCharacterIntoString (*this, token.a_string, previousChar ()) ;
          }else{
            loop = false ;
          }
        }while (loop) ;
        ...
        do {
          if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9')) ||
              ...
              testForInputUTF32CharRange (TO_UNICODE ('A'), TO_UNICODE ('F'))) {
            ::scanner_routine_enterHexDigitIntoUInt64 (*this, previousChar (), token.integerNumber, gErrorMessage_2, gErrorMessage_1) ;
          }else{
            loop = false ;
          }
        }while (loop) ;
        ...
        do {
          ...
          ::scanner_routine_enterDigitIntoUInt64 (*this, previousChar (), token.integerNumber, gErrorMessage_2, gErrorMessage_1) ;
          if (testForInputUTF32CharRange (TO_UNICODE ('0'), TO_UNICODE ('9'))) {
          }else{
            loop = false ;
          }
        ...
        if (testForInputUTF32Char (TO_UNICODE ('.'))) {
          if (testForInputUTF32Char (TO_UNICODE ('.'))) {
            ...
            loop = true ;
            ::scanner_routine_convertStringToDouble (*this, token.number, token.floatNumber, gErrorMessage_4) ;
...
void goil_lexique::enterToken (const cTokenFor_goil_lexique & inToken) {
  ...
  ptr->a_string = inToken.a_string ;
  ptr->integerNumber = inToken.integerNumber ;
  ptr->floatNumber = inToken.floatNumber ;
...
_assignFromAttribute_a_string (GGS_lstring & outValue) const {
  cTokenFor_goil_lexique * ptr = (cTokenFor_goil_lexique *) mCurrentTokenPtr ;
  outValue = GGS_lstring (* this, ptr->a_string) ;
}
...
_assignFromAttribute_integerNumber (GGS_luint64 & outValue) const {
  cTokenFor_goil_lexique * ptr = (cTokenFor_goil_lexique *) mCurrentTokenPtr ;
  outValue = GGS_luint64 (* this, ptr->integerNumber) ;
}
...
_assignFromAttribute_floatNumber (GGS_ldouble & outValue) const {
  cTokenFor_goil_lexique * ptr = (cTokenFor_goil_lexique *) mCurrentTokenPtr ;
  outValue = GGS_ldouble (* this, ptr->floatNumber) ;
}
