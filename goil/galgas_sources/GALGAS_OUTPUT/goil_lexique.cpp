...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [245] = {"end of source",
...
const sint16 goil_lexique::goil_lexique_table_size_os_attributes = 11 ;

const C_lexique_table_entry goil_lexique::goil_lexique_table_for_os_attributes [11] = {
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [245] = {0,
