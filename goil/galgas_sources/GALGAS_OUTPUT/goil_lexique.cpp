...
appendTerminalMessageToSyntaxErrorMessage (const sint16 inTerminalIndex,
  ...
  static const char * syntaxErrorMessageArray [255] = {"end of source",
...
const sint16 goil_lexique::goil_lexique_table_size_trace_attributes = 8 ;

const C_lexique_table_entry goil_lexique::goil_lexique_table_for_trace_attributes [8] = {
...
terminalStyleIndex (const sint32 inTerminal) {
  static const uint8 kTerminalSymbolStyles [255] = {0,
