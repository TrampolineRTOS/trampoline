...
void cGrammar_cfg_5F_grammar::nt_cfg_5F_start_parse (C_Lexique_cfg_5F_lexique * inLexique) {
  rule_cfg_5F_syntax_cfg_5F_start_i0_parse(inLexique) ;
}
...
void cGrammar_cfg_5F_grammar::_performSourceStringParsing_ (C_Compiler * inCompiler,
  ...
  if (inSourceString.isValid ()) {
    ...
    C_Lexique_cfg_5F_lexique * scanner = NULL ;
    macroMyNew (scanner, C_Lexique_cfg_5F_lexique (inCompiler, inCompiler->ioParametersPtr (), sourceString, "" COMMA_HERE)) ;
    scanner->mPerformGeneration = inCompiler->mPerformGeneration ;
    const bool ok = scanner->performTopDownParsing (gProductions, gProductionNames, gProductionIndexes,
                                                    gFirstProductionIndexes, gDecision, gDecisionIndexes, 71) ;
    if (ok && ! scanner->mParseOnlyFlag) {
...
void cGrammar_cfg_5F_grammar::nt_cfg_5F_attrs_parse (C_Lexique_cfg_5F_lexique * inLexique) {
  rule_cfg_5F_syntax_cfg_5F_attrs_i1_parse(inLexique) ;
}
...
void cGrammar_cfg_5F_grammar::nt_interrupts_parse (C_Lexique_cfg_5F_lexique * inLexique) {
  rule_cfg_5F_syntax_interrupts_i2_parse(inLexique) ;
}
