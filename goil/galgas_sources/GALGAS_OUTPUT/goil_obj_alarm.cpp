...
pr_alarm_goil_obj_alarm_47_12_ (goil_lexique & _inLexique,
  ...
  if ((var_cas_alarms.reader_hasKey (_inLexique, var_cas_alarm_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (60)) COMMA_SOURCE_FILE_AT_LINE (60))).isBuiltAndTrue ()) {
    ...
    var_cas_counter_name = GGS_lstring ::constructor_new (_inLexique, GGS_string (""), GGS_location (_inLexique) COMMA_HERE) ;
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_repeat_goil_obj_alarm_0 (_inLexique)) {
        case 2 : {
          if (((var_cas_counter_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (94)))._operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("COUNTER attribute already defined for this alarm") COMMA_SOURCE_FILE_AT_LINE (96)) ;
            var_cas_counter_name.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (96)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (97)) ;
          }
          ...
          { const GGS_action_obj _var_2738 = var_cas_alarm_action ; // CAST instruction
            if (_var_2738.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void_action) == typeid (* (_var_2738.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("ACTION attribute already defined for this alarm") COMMA_SOURCE_FILE_AT_LINE (104)) ;
                var_cas_alarm_action.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (104)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (105)) ;
              }
            }
          }
          ...
          { const GGS_autostart_obj _var_3063 = var_cas_alarm_autostart ; // CAST instruction
            if (_var_3063.getPtr () != NULL) {
              ...
              if (typeid (cPtr_autostart_void) == typeid (* (_var_3063.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("AUTOSTART attribute already defined for this alarm") COMMA_SOURCE_FILE_AT_LINE (112)) ;
                var_cas_alarm_autostart.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (112)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (113)) ;
              }
            }
          }
        ...
        case 5 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_add_lstring_unique (_inLexique,  var_cas_acc_apps,  var_cas_app,  GGS_string ("ACCESSING_APPLICATION") COMMA_SOURCE_FILE_AT_LINE (127)) ;
          } break ;
        case 6 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
...
pr_alarm_action_params_goil_obj_alarm_133_26_ (goil_lexique & _inLexique,
  ...
  switch (select_goil_obj_alarm_3 (_inLexique)) {
      ...
      { bool syntaxRepeat_4 = true ;
        while (syntaxRepeat_4) {
          switch (select_repeat_goil_obj_alarm_4 (_inLexique)) {
            case 2 : {
              if (((var_cas_task_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (142)))._operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("TASK attribute already defined for this alarm action") COMMA_SOURCE_FILE_AT_LINE (144)) ;
                var_cas_task_name.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (144)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (145)) ;
              }
            ...
            case 3 : {
              if (((var_cas_event_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (151)))._operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("EVENT attribute already defined for this alarm action") COMMA_SOURCE_FILE_AT_LINE (153)) ;
                var_cas_event_name.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (153)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (154)) ;
              }
    ...
    case 3 : {
      if ((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (168)))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("AUTOSAR flag is on. AUTOSAR spec does not allow alarm callback") COMMA_SOURCE_FILE_AT_LINE (170)) ;
      }
    ...
    case 4 : {
      if (((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (177))))._operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("AUTOSAR flag is off. Turn it on to allow an INCREMENTCOUNTER action in alarm") COMMA_SOURCE_FILE_AT_LINE (179)) ;
      }
      GGS_lstring  var_cas_counter_name ;
...
pr_alarm_autostart_params_goil_obj_alarm_189_29_ (goil_lexique & _inLexique,
  ...
  var_cas_alarm_time = GGS_luint64 ::constructor_new (_inLexique, GGS_uint64 (0U), GGS_location (_inLexique) COMMA_HERE) ;
  GGS_luint64  var_cas_cycle_time ;
  var_cas_cycle_time = GGS_luint64 ::constructor_new (_inLexique, GGS_uint64 (0U), GGS_location (_inLexique) COMMA_HERE) ;
      ...
      switch (select_repeat_goil_obj_alarm_5 (_inLexique)) {
        case 2 : {
          if ((var_cas_alarm_time_known).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("ALARMTIME attribute already defined for this alarm autostart") COMMA_SOURCE_FILE_AT_LINE (204)) ;
            var_cas_alarm_time.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (204)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (205)) ;
          }
        ...
        case 3 : {
          if ((var_cas_cycle_time_known).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("CYCLETIME attribute already defined for this alarm autostart") COMMA_SOURCE_FILE_AT_LINE (211)) ;
            var_cas_cycle_time.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (211)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (212)) ;
          }
  ...
  if (((var_cas_alarm_time_known)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("ALARMTIME attribute is missing") COMMA_SOURCE_FILE_AT_LINE (223)) ;
  }
