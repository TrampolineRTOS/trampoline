...
void api_parser::rule_api_5F_parser_api_5F_start_i0_ (C_Lexique_api_5F_scanner & inLexique,
  ...
  GGS_goilTemplateType automatic_var_716_0 ;
  const GGS_goilTemplateVariableMap  temp_673 = var_cas_cfg ;
  if (temp_673.isBuilt ()) {
    temp_673 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOM"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (29)), automatic_var_716_0, var_cas_value COMMA_SOURCE_FILE_AT_LINE (29)) ;
  }
  ...
  GGS_goilTemplateType automatic_var_830_0 ;
  const GGS_goilTemplateVariableMap  temp_786 = var_cas_cfg ;
  if (temp_786.isBuilt ()) {
    temp_786 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("AUTOSAR"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (31)), automatic_var_830_0, var_cas_value COMMA_SOURCE_FILE_AT_LINE (31)) ;
  }
  ...
  GGS_goilTemplateType automatic_var_954_0 ;
  const GGS_goilTemplateVariableMap  temp_901 = var_cas_cfg ;
  if (temp_901.isBuilt ()) {
    temp_901 (HERE)->method_searchKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("SCALABILITYCLASS"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (33)), automatic_var_954_0, var_cas_value COMMA_SOURCE_FILE_AT_LINE (33)) ;
  }
  GGS_uint64  var_cas_scalabilityclass = var_cas_value.reader_mUnsigned64Value (inLexique COMMA_SOURCE_FILE_AT_LINE (34)) ;
  GGS_goilTemplateFieldMap  var_cas_api = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (36)) ;
        ...
        case 2 : {
          ...
          switch (select_api_5F_parser_1 (inLexique)) {
            case 1 : {
              ...
              const GGS_bool cond_2053 = var_cas_valid ;
              if (cond_2053.isBuiltAndTrue ()) {
                GGS_goilTemplateFieldMap  var_cas_fileEntry = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (55)) ;
          ...
          const GGS_bool cond_2218 = var_cas_valid ;
          if (cond_2218.isBuiltAndTrue ()) {
  ...
  ::routine_addListFieldValue (inLexique,  var_cas_api,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEDAPI"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (66)),  var_cas_usedApi COMMA_SOURCE_FILE_AT_LINE (66)) ;
  ::routine_addListFieldValue (inLexique,  var_cas_api,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEDFILES"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (67)),  var_cas_usedFiles COMMA_SOURCE_FILE_AT_LINE (67)) ;
  ::routine_addStructValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("APICONFIG"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (69)),  var_cas_api COMMA_SOURCE_FILE_AT_LINE (69)) ;
}
    ...
    while (syntaxRepeat_2) {
      switch (select_api_5F_parser_2 (inLexique)) {
        case 2 : {
          ...
          GGS_goilTemplateFieldMap  var_cas_apiEntry = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (86)) ;
