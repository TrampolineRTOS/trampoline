...
void goil_imp_def::
pr_implementation_definition_goil_imp_def_85_32_ (goil_lexique & inLexique,
  ...
  inLexique._assignFromAttribute_att_token (var_cas_imp_name) ;
...
void goil_imp_def::
pr_implementation_spec_list_goil_imp_def_99_31_ (goil_lexique & inLexique,
                                GGS_implementation  &var_cas_imp) {
...
void goil_imp_def::
pr_implementation_spec_goil_imp_def_105_26_ (goil_lexique & inLexique,
                                GGS_implementation  &var_cas_imp) {
...
void goil_imp_def::
pr_implementation_list_goil_imp_def_125_26_ (goil_lexique & inLexique,
                                GGS_string var_cas_obj_kind,
                                GGS_implementation  &var_cas_imp) {
  GGS_implementation_spec  var_cas_spec ;
  GGS_lstring  var_cas_key ;
  var_cas_key = GGS_lstring ::constructor_new (inLexique, var_cas_obj_kind, GGS_location (inLexique) COMMA_HERE) ;
  if ((var_cas_imp.reader_hasKey (inLexique, var_cas_obj_kind COMMA_SOURCE_FILE_AT_LINE (131))).isBuiltAndTrue ()) {
    var_cas_imp.modifier_del (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_obj_kind, GGS_location (inLexique) COMMA_HERE), var_cas_spec COMMA_SOURCE_FILE_AT_LINE (132)) ;
  }else{
    ...
    while (syntaxRepeat_2) {
      switch (select_repeat_goil_imp_def_2 (inLexique)) {
        case 2 : {
          ...
          var_cas_spec.modifier_put (inLexique, var_cas_attr_name, var_cas_attr COMMA_SOURCE_FILE_AT_LINE (143)) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          } break ;
        default :
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
  var_cas_imp.modifier_put (inLexique, var_cas_key, var_cas_spec COMMA_SOURCE_FILE_AT_LINE (148)) ;
}
...
void goil_imp_def::
pr_impl_attr_def_goil_imp_def_151_20_ (goil_lexique & inLexique,
                                GGS_lstring  &var_cas_attr_name,
                                GGS_imp_type  &var_cas_attr) {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_UINT32) COMMA_HERE) ;
  ...
  { const GGS_uint32_class _var_5064 = var_cas_default_number ; // CAST instruction
    if (_var_5064.getPtr () != NULL) {
      ...
      if (typeid (cPtr_uint32_class) == typeid (* (_var_5064.getPtr ()))) {
        ...
        ::routine_check_uint32_range (inLexique,  var_cas_set,  var_cas_dn.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (173)),  var_cas_dn.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (173)) COMMA_SOURCE_FILE_AT_LINE (173)) ;
      }else{
      }
    }
  }
...
void goil_imp_def::
pr_impl_attr_def_goil_imp_def_188_20_ (goil_lexique & inLexique,
                                GGS_lstring  &var_cas_attr_name,
                                GGS_imp_type  &var_cas_attr) {
  GGS_bool var_cas_with_auto ;
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_INT32) COMMA_HERE) ;
  nt_auto_specifier_ (inLexique, var_cas_with_auto) ;
...
void goil_imp_def::
pr_impl_attr_def_goil_imp_def_218_20_ (goil_lexique & inLexique,
                                GGS_lstring  &var_cas_attr_name,
                                GGS_imp_type  &var_cas_attr) {
  ...
  GGS_lstring  var_cas_type ;
  inLexique._assignFromAttribute_att_token (var_cas_type) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_UINT64) COMMA_HERE) ;
...
void goil_imp_def::
pr_impl_attr_def_goil_imp_def_238_20_ (goil_lexique & inLexique,
                                GGS_lstring  &var_cas_attr_name,
                                GGS_imp_type  &var_cas_attr) {
  GGS_bool var_cas_auto ;
  GGS_bool var_cas_multiple ;
  ...
  GGS_lstring  var_cas_type ;
  inLexique._assignFromAttribute_att_token (var_cas_type) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_INT64) COMMA_HERE) ;
  nt_auto_specifier_ (inLexique, var_cas_auto) ;
  nt_attribute_name_ (inLexique, var_cas_attr_name) ;
  nt_multiple_specifier_ (inLexique, var_cas_multiple) ;
  nt_default_number_ (inLexique, var_cas_has_default, var_cas_default_number) ;
...
void goil_imp_def::
pr_impl_attr_def_goil_imp_def_257_20_ (goil_lexique & inLexique,
                                GGS_lstring  &var_cas_attr_name,
                                GGS_imp_type  &var_cas_attr) {
  GGS_lstring  var_cas_type ;
  GGS_bool var_cas_auto ;
...
void goil_imp_def::
pr_impl_attr_def_goil_imp_def_271_20_ (goil_lexique & inLexique,
                                GGS_lstring  &var_cas_attr_name,
                                GGS_imp_type  &var_cas_attr) {
  GGS_lstring  var_cas_type ;
  GGS_bool var_cas_auto ;
...
void goil_imp_def::
pr_auto_specifier_goil_imp_def_287_21_ (goil_lexique & inLexique,
                                GGS_bool &var_cas_auto) {
  switch (select_goil_imp_def_3 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_WITH_5FAUTO) COMMA_HERE) ;
...
void goil_imp_def::
pr_uint32_number_set_goil_imp_def_298_24_ (goil_lexique & inLexique,
                                GGS_uint32_set  &var_cas_set) {
  switch (select_goil_imp_def_4 (inLexique)) {
    case 1 : {
      GGS_luint64  var_cas_first ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__5B) COMMA_HERE) ;
      switch (select_goil_imp_def_5 (inLexique)) {
        case 1 : {
          GGS_luint64  var_cas_last ;
          inLexique._assignFromAttribute_integerNumber (var_cas_first) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_set_5Fstart_5Fuint_5Fnumber) COMMA_HERE) ;
          inLexique._assignFromAttribute_integerNumber (var_cas_last) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
          var_cas_set = GGS_uint32_range ::constructor_new (inLexique, GGS_location (inLexique), var_cas_first.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (310)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (310)), var_cas_last.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (311)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (311)) COMMA_HERE) ;
          } break ;
        case 2 : {
          inLexique._assignFromAttribute_integerNumber (var_cas_first) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
          switch (select_goil_imp_def_6 (inLexique)) {
            case 1 : {
              GGS_luint64  var_cas_last ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__2E_2E) COMMA_HERE) ;
              inLexique._assignFromAttribute_integerNumber (var_cas_last) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
              if (((var_cas_first.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (320))).operator_strictSup (var_cas_last.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (320)))).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("Empty range") COMMA_SOURCE_FILE_AT_LINE (321)) ;
              }
              var_cas_set = GGS_uint32_range ::constructor_new (inLexique, GGS_location (inLexique), var_cas_first.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (326)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (326)), var_cas_last.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (327)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (327)) COMMA_HERE) ;
              } break ;
            case 2 : {
              GGS_list_uint32  var_cas_numList ;
              var_cas_numList = GGS_list_uint32 ::constructor_emptyList () ;
              var_cas_numList._addAssign_operation (var_cas_first.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (331)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (331))) ;
              { bool syntaxRepeat_7 = true ;
                while (syntaxRepeat_7) {
                  switch (select_repeat_goil_imp_def_7 (inLexique)) {
                    case 2 : {
                      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__2C) COMMA_HERE) ;
                      inLexique._assignFromAttribute_integerNumber (var_cas_first) ;
                      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
                      var_cas_numList._addAssign_operation (var_cas_first.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (336)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (336))) ;
                      } break ;
                    default :
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__5D) COMMA_HERE) ;
      } break ;
    case 2 : {
...
void goil_imp_def::
pr_sint32_number_set_goil_imp_def_347_24_ (goil_lexique & inLexique,
                                GGS_sint32_set  &var_cas_set) {
  switch (select_goil_imp_def_8 (inLexique)) {
    case 1 : {
      ...
      switch (select_goil_imp_def_9 (inLexique)) {
        case 1 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__2D) COMMA_HERE) ;
      ...
      switch (select_goil_imp_def_10 (inLexique)) {
        case 1 : {
          ...
          inLexique._assignFromAttribute_integerNumber (var_cas_ssfirst) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_set_5Fstart_5Fuint_5Fnumber) COMMA_HERE) ;
          var_cas_first = var_cas_fs.multiply_operation (inLexique, var_cas_ssfirst.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (357)).reader_sint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (357)) COMMA_SOURCE_FILE_AT_LINE (357)) ;
          nt_signed_number_ (inLexique, var_cas_last) ;
          var_cas_set = GGS_sint32_range ::constructor_new (inLexique, GGS_location (inLexique), var_cas_first.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (361)), var_cas_last.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (362)) COMMA_HERE) ;
          } break ;
        case 2 : {
          inLexique._assignFromAttribute_integerNumber (var_cas_ssfirst) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
          var_cas_first = var_cas_fs.multiply_operation (inLexique, var_cas_ssfirst.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (366)).reader_sint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (366)) COMMA_SOURCE_FILE_AT_LINE (366)) ;
          switch (select_goil_imp_def_11 (inLexique)) {
            case 1 : {
              GGS_sint64  var_cas_last ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__2E_2E) COMMA_HERE) ;
              nt_signed_number_ (inLexique, var_cas_last) ;
              var_cas_set = GGS_sint32_range ::constructor_new (inLexique, GGS_location (inLexique), var_cas_first.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (373)), var_cas_last.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (374)) COMMA_HERE) ;
              } break ;
            case 2 : {
              GGS_list_sint32  var_cas_numList ;
              var_cas_numList = GGS_list_sint32 ::constructor_emptyList () ;
              var_cas_numList._addAssign_operation (var_cas_first.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (378))) ;
                ...
                while (syntaxRepeat_12) {
                  switch (select_repeat_goil_imp_def_12 (inLexique)) {
                    case 2 : {
                      ...
                      var_cas_numList._addAssign_operation (var_cas_first.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (383))) ;
                      } break ;
                    default :
...
void goil_imp_def::
pr_uint64_number_set_goil_imp_def_394_24_ (goil_lexique & inLexique,
...
void goil_imp_def::
pr_sint64_number_set_goil_imp_def_398_24_ (goil_lexique & inLexique,
...
void goil_imp_def::
pr_float_number_set_goil_imp_def_402_23_ (goil_lexique & inLexique,
...
void goil_imp_def::
pr_default_uint32_number_goil_imp_def_407_28_ (goil_lexique & inLexique,
  ...
  switch (select_goil_imp_def_13 (inLexique)) {
    case 1 : {
      ...
      switch (select_goil_imp_def_14 (inLexique)) {
        case 1 : {
          GGS_luint64  var_cas_default_number ;
          inLexique._assignFromAttribute_integerNumber (var_cas_default_number) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
          var_cas_def = GGS_uint32_class ::constructor_new (inLexique, GGS_location (inLexique), var_cas_default_number.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (413)).reader_uint (inLexique COMMA_SOURCE_FILE_AT_LINE (413)) COMMA_HERE) ;
          } break ;
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_NO_5FDEFAULT) COMMA_HERE) ;
...
void goil_imp_def::
pr_default_sint32_number_goil_imp_def_427_28_ (goil_lexique & inLexique,
    ...
    case 1 : {
      ...
      switch (select_goil_imp_def_16 (inLexique)) {
        case 1 : {
          ...
          var_cas_def = GGS_sint32_class ::constructor_new (inLexique, GGS_location (inLexique), var_cas_default_number.reader_sint (inLexique COMMA_SOURCE_FILE_AT_LINE (433)) COMMA_HERE) ;
          } break ;
        case 2 : {
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_NO_5FDEFAULT) COMMA_HERE) ;
...
void goil_imp_def::
pr_default_uint64_number_goil_imp_def_447_28_ (goil_lexique & inLexique,
                                GGS_uint64_class  &var_cas_def) {
  var_cas_def = GGS_void_uint64_class ::constructor_new (inLexique, GGS_location (inLexique), GGS_uint64 (0U) COMMA_HERE) ;
}
...
void goil_imp_def::
pr_default_sint64_number_goil_imp_def_451_28_ (goil_lexique & inLexique,
...
void goil_imp_def::
pr_default_float_number_goil_imp_def_455_27_ (goil_lexique & inLexique,
...
void goil_imp_def::
pr_default_string_goil_imp_def_459_21_ (goil_lexique & inLexique,
...
void goil_imp_def::
pr_default_enum_goil_imp_def_463_19_ (goil_lexique & inLexique,
...
void goil_imp_def::
pr_default_bool_goil_imp_def_467_19_ (goil_lexique & inLexique,
...
void goil_imp_def::
pr_signed_number_goil_imp_def_471_20_ (goil_lexique & inLexique,
                                GGS_sint64  &var_cas_num) {
  GGS_luint64  var_cas_number ;
  GGS_sint64  var_cas_sign ;
  var_cas_sign = GGS_sint64 (1LL) ;
  ...
  inLexique._assignFromAttribute_integerNumber (var_cas_number) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
  var_cas_num = var_cas_sign.multiply_operation (inLexique, var_cas_number.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (476)).reader_sint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (476)) COMMA_SOURCE_FILE_AT_LINE (476)) ;
}
...
void goil_imp_def::
pr_uint32_attribute_name_goil_imp_def_482_28_ (goil_lexique & inLexique,
  ...
  switch (select_goil_imp_def_18 (inLexique)) {
    ...
    case 8 : {
      inLexique._assignFromAttribute_att_token (var_cas_name) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
      } break ;
    default :
      break ;
...
void goil_imp_def::
pr_attribute_name_goil_imp_def_502_21_ (goil_lexique & inLexique,
                                GGS_lstring  &var_cas_name) {
...
void goil_imp_def::
pr_multiple_specifier_goil_imp_def_510_25_ (goil_lexique & inLexique,
                                GGS_bool &var_cas_multiple) {
...
void goil_imp_def::
pr_default_number_goil_imp_def_519_21_ (goil_lexique & inLexique,
                                GGS_bool &var_cas_has_default,
                                GGS_luint64  &var_cas_default_number) {
  switch (select_goil_imp_def_21 (inLexique)) {
    ...
    case 2 : {
      var_cas_default_number = GGS_luint64 ::constructor_new (inLexique, GGS_uint64 (0U), GGS_location (inLexique) COMMA_HERE) ;
...
void goil_imp_def::
pr_default_name_goil_imp_def_530_19_ (goil_lexique & inLexique,
                                GGS_bool &var_cas_has_default,
                                GGS_lstring  &var_cas_default_name) {
  switch (select_goil_imp_def_22 (inLexique)) {
    case 1 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
      inLexique._assignFromAttribute_att_token (var_cas_default_name) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
      var_cas_has_default = GGS_bool (true) ;
      } break ;
    case 2 : {
...
void goil_imp_def::
pr_enumeration_goil_imp_def_544_18_ (goil_lexique & inLexique,
                                GGS_stringset  &var_cas_en) {
...
void goil_imp_def::
pr_enumerator_goil_imp_def_558_17_ (goil_lexique & inLexique,
                                GGS_stringset  &var_cas_en) {
  switch (select_goil_imp_def_24 (inLexique)) {
    case 1 : {
      ...
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("EXTENDED") COMMA_SOURCE_FILE_AT_LINE (561)) ;
      } break ;
    case 2 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_STANDARD) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("STANDARD") COMMA_SOURCE_FILE_AT_LINE (562)) ;
      } break ;
    case 3 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_NON) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("NON") COMMA_SOURCE_FILE_AT_LINE (563)) ;
      } break ;
    case 4 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_FULL) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("FULL") COMMA_SOURCE_FILE_AT_LINE (564)) ;
      } break ;
    case 5 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_SEND_5FSTATIC_5FINTERNAL) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("SEND_STATIC_INTERNAL") COMMA_SOURCE_FILE_AT_LINE (565)) ;
      } break ;
    case 6 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_SEND_5FSTATIC_5FEXTERNAL) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("SEND_STATIC_EXTERNAL") COMMA_SOURCE_FILE_AT_LINE (566)) ;
      } break ;
    case 7 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_SEND_5FDYNAMIC_5FEXTERNAL) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("SEND_DYNAMIC_EXTERNAL") COMMA_SOURCE_FILE_AT_LINE (567)) ;
      } break ;
    case 8 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_SEND_5FZERO_5FINTERNAL) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("SEND_ZERO_INTERNAL") COMMA_SOURCE_FILE_AT_LINE (568)) ;
      } break ;
    case 9 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_SEND_5FZERO_5FEXTERNAL) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("SEND_ZERO_EXTERNAL") COMMA_SOURCE_FILE_AT_LINE (569)) ;
      } break ;
    case 10 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_RECEIVE_5FZERO_5FINTERNAL) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("RECEIVE_ZERO_INTERNAL") COMMA_SOURCE_FILE_AT_LINE (570)) ;
      } break ;
    case 11 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_RECEIVE_5FZERO_5FEXTERNAL) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("RECEIVE_ZERO_EXTERNAL") COMMA_SOURCE_FILE_AT_LINE (571)) ;
      } break ;
    case 12 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_RECEIVE_5FUNQUEUED_5FINTERNAL) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("RECEIVE_UNQUEUED_INTERNAL") COMMA_SOURCE_FILE_AT_LINE (572)) ;
      } break ;
    case 13 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_ALWAYS) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("ALWAYS") COMMA_SOURCE_FILE_AT_LINE (573)) ;
      } break ;
    case 14 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_NEVER) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("NEVER") COMMA_SOURCE_FILE_AT_LINE (574)) ;
      } break ;
    case 15 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_MASKEDNEWEQUALSX) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("MASKEDNEWEQUALSX") COMMA_SOURCE_FILE_AT_LINE (575)) ;
      } break ;
    case 16 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_MASKEDNEWDIFFERSX) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("MASKEDNEWDIFFERSX") COMMA_SOURCE_FILE_AT_LINE (576)) ;
      } break ;
    case 17 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_NEWISEQUAL) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("NEWISEQUAL") COMMA_SOURCE_FILE_AT_LINE (577)) ;
      } break ;
    case 18 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_NEWISDIFFERENT) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("NEWISDIFFERENT") COMMA_SOURCE_FILE_AT_LINE (578)) ;
      } break ;
    case 19 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_MASKEDNEWEQUALSMASKEDOLD) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("MASKEDNEWEQUALSMASKEDOLD") COMMA_SOURCE_FILE_AT_LINE (579)) ;
      } break ;
    case 20 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_MASKEDNEWDIFFERSMASKEDOLD) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("MASKEDNEWDIFFERSMASKEDOLD") COMMA_SOURCE_FILE_AT_LINE (580)) ;
      } break ;
    case 21 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_NEWISWITHIN) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("NEWISWITHIN") COMMA_SOURCE_FILE_AT_LINE (581)) ;
      } break ;
    case 22 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_NEWISOUTSIDE) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("NEWISOUTSIDE") COMMA_SOURCE_FILE_AT_LINE (582)) ;
      } break ;
    case 23 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_NEWISGREATER) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("NEWISGREATER") COMMA_SOURCE_FILE_AT_LINE (583)) ;
      } break ;
    case 24 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_NEWISLESSOREQUAL) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("NEWISLESSOREQUAL") COMMA_SOURCE_FILE_AT_LINE (584)) ;
      } break ;
    case 25 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_NEWISLESS) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("NEWISLESS") COMMA_SOURCE_FILE_AT_LINE (585)) ;
      } break ;
    case 26 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_NEWISGREATEROREQUAL) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("NEWISGREATEROREQUAL") COMMA_SOURCE_FILE_AT_LINE (586)) ;
      } break ;
    case 27 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_ONEEVERYN) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("ONEEVERYN") COMMA_SOURCE_FILE_AT_LINE (587)) ;
      } break ;
    case 28 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_NONE) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("NONE") COMMA_SOURCE_FILE_AT_LINE (588)) ;
      } break ;
    case 29 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_ACTIVATETASK) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("ACTIVATETASK") COMMA_SOURCE_FILE_AT_LINE (589)) ;
      } break ;
    case 30 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_SETEVENT) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("SETEVENT") COMMA_SOURCE_FILE_AT_LINE (590)) ;
      } break ;
    case 31 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_COMCALLBACK) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("COMCALLBACK") COMMA_SOURCE_FILE_AT_LINE (591)) ;
      } break ;
    case 32 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_FLAG) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("FLAG") COMMA_SOURCE_FILE_AT_LINE (592)) ;
      } break ;
    case 33 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_INMCALLBACK) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("INMCALLBACK") COMMA_SOURCE_FILE_AT_LINE (593)) ;
      } break ;
    case 34 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_STATIC) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("STATIC") COMMA_SOURCE_FILE_AT_LINE (594)) ;
      } break ;
    case 35 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_DYNAMIC) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("DYNAMIC") COMMA_SOURCE_FILE_AT_LINE (595)) ;
      } break ;
    case 36 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_COMSTANDARD) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("COMSTANDARD") COMMA_SOURCE_FILE_AT_LINE (597)) ;
      } break ;
    case 37 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_COMEXTENDED) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("COMEXTENDED") COMMA_SOURCE_FILE_AT_LINE (598)) ;
      } break ;
    case 38 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_SENT) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("SENT") COMMA_SOURCE_FILE_AT_LINE (599)) ;
      } break ;
    case 39 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_RECEIVED) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("RECEIVED") COMMA_SOURCE_FILE_AT_LINE (600)) ;
      } break ;
    case 40 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_DIRECT) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("DIRECT") COMMA_SOURCE_FILE_AT_LINE (601)) ;
      } break ;
    case 41 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_PERIODIC) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("PERIODIC") COMMA_SOURCE_FILE_AT_LINE (602)) ;
      } break ;
    case 42 : {
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_MIXED) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  GGS_string ("MIXED") COMMA_SOURCE_FILE_AT_LINE (603)) ;
      } break ;
    case 43 : {
      GGS_lstring  var_cas_idf ;
      inLexique._assignFromAttribute_att_token (var_cas_idf) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
      ::routine_add_to_stringset (inLexique,  var_cas_en,  var_cas_idf.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (604)) COMMA_SOURCE_FILE_AT_LINE (604)) ;
      } break ;
    default :
      break ;
  }
...
void goil_imp_def::
pr_impl_parameter_list_goil_imp_def_610_26_ (goil_lexique & inLexique) {
...
void goil_imp_def::
pr_implementation_def_goil_imp_def_622_25_ (goil_lexique & inLexique) {
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
}
