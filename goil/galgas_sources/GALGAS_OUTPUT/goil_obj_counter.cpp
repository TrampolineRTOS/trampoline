...
pr_counter_goil_obj_counter_54_14_ (goil_lexique & _inLexique,
  ...
  if ((var_cas_counters.reader_hasKey (_inLexique, var_cas_counter_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (71)) COMMA_SOURCE_FILE_AT_LINE (71))).isBuiltAndTrue ()) {
    var_cas_counters.modifier_del (_inLexique, var_cas_counter_name, var_cas_counter COMMA_SOURCE_FILE_AT_LINE (72)) ;
    var_cas_max_allowed_value = var_cas_counter.reader_max_allowed_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (73)) ;
    var_cas_ticks_per_base = var_cas_counter.reader_ticks_per_base (_inLexique COMMA_SOURCE_FILE_AT_LINE (74)) ;
    var_cas_min_cycle = var_cas_counter.reader_min_cycle (_inLexique COMMA_SOURCE_FILE_AT_LINE (75)) ;
    var_cas_source = var_cas_counter.reader_source (_inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ;
    var_cas_acc_apps = var_cas_counter.reader_acc_apps (_inLexique COMMA_SOURCE_FILE_AT_LINE (77)) ;
    var_cas_type = var_cas_counter.reader_type (_inLexique COMMA_SOURCE_FILE_AT_LINE (78)) ;
    var_cas_unit = var_cas_counter.reader_unit (_inLexique COMMA_SOURCE_FILE_AT_LINE (79)) ;
    var_cas_desc = var_cas_counter.reader_desc (_inLexique COMMA_SOURCE_FILE_AT_LINE (80)) ;
  }else{
  ...
  var_cas_counter = GGS_counter_obj ::constructor_new (_inLexique, var_cas_desc, var_cas_max_allowed_value, var_cas_ticks_per_base, var_cas_min_cycle, var_cas_source, var_cas_acc_apps, var_cas_type, var_cas_unit COMMA_HERE) ;
  var_cas_counters.modifier_put (_inLexique, var_cas_counter_name, var_cas_counter COMMA_SOURCE_FILE_AT_LINE (115)) ;
}
...
void goil_obj_counter::
pr_counter_parameters_goil_obj_counter_118_25_ (goil_lexique & _inLexique,
                                GGS_basic_type  &var_cas_max_allowed_value,
                                GGS_basic_type  &var_cas_ticks_per_base,
                                GGS_basic_type  &var_cas_min_cycle,
                                GGS_lstring  &var_cas_source,
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_goil_obj_counter_0 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_uint32 (_inLexique,  var_cas_max_allowed_value,  var_cas_m,  GGS_string ("MAXALLOWEDVALUE") COMMA_SOURCE_FILE_AT_LINE (131)) ;
          } break ;
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_uint32 (_inLexique,  var_cas_ticks_per_base,  var_cas_t,  GGS_string ("TICKSPERBASE") COMMA_SOURCE_FILE_AT_LINE (135)) ;
          } break ;
        case 4 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_uint32 (_inLexique,  var_cas_min_cycle,  var_cas_c,  GGS_string ("MINCYCLE") COMMA_SOURCE_FILE_AT_LINE (139)) ;
          } break ;
        case 5 : {
          if (((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (141))))._operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("AUTOSAR flag is off, turn it on to use TYPE attribute in COUNTER object") COMMA_SOURCE_FILE_AT_LINE (143)) ;
          }
          ...
          { const GGS_counter_type _var_3998 = var_cas_type ; // CAST instruction
            if (_var_3998.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void_counter) == typeid (* (_var_3998.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Redefinitiion of TYPE") COMMA_SOURCE_FILE_AT_LINE (151)) ;
                var_cas_type.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (151)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (152)) ;
              }
            }
          }
          } break ;
        case 6 : {
          if (((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (154))))._operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("AUTOSAR flag is off, turn it on to use UNIT attribute in COUNTER object") COMMA_SOURCE_FILE_AT_LINE (156)) ;
          }
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          if (((var_cas_unit.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (165)))._operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
            var_cas_unit = var_cas_cpt_unit ;
          }else{
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("UNIT attribute already defined for this counter") COMMA_SOURCE_FILE_AT_LINE (169)) ;
            var_cas_unit.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (170)) ;
          }
          } break ;
        case 7 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_lstring_if_empty (_inLexique,  var_cas_source,  var_cas_src,  GGS_string ("SOURCE") COMMA_SOURCE_FILE_AT_LINE (174)) ;
          } break ;
        case 8 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_add_lstring_unique (_inLexique,  var_cas_acc_apps,  var_cas_app,  GGS_string ("ACCESSING_APPLICATION") COMMA_SOURCE_FILE_AT_LINE (178)) ;
          } break ;
        case 9 : {
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
...
void goil_obj_counter::
pr_counter_type_attrs_goil_obj_counter_184_25_ (goil_lexique & _inLexique,
                                GGS_counter_type  &var_cas_type) {
                    ...
                    while (syntaxRepeat_6) {
                      switch (select_repeat_goil_obj_counter_6 (_inLexique)) {
                        case 2 : {
                          ...
                          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
                          ::routine_set_uint64 (_inLexique,  var_cas_npht,  var_cas_ui,  GGS_string ("NS_PER_HW_TICK") COMMA_SOURCE_FILE_AT_LINE (209)) ;
                          } break ;
                        case 3 : {
                          ...
                          ::routine_set_lstring_if_empty (_inLexique,  var_cas_gcn,  var_cas_cn,  GGS_string ("GPTCHANNELNAME") COMMA_SOURCE_FILE_AT_LINE (213)) ;
                          } break ;
                        default :
                  ...
                  { const GGS_basic_type _var_5984 = var_cas_npht ; // CAST instruction
                    if (_var_5984.getPtr () != NULL) {
                      ...
                      if (typeid (cPtr_void) == typeid (* (_var_5984.getPtr ()))) {
                        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("NS_PER_HW_TICK subattribute not defined for this hardware counter GPT") COMMA_SOURCE_FILE_AT_LINE (219)) ;
                      }else{
                      }
                    }
                  }
                  if (((var_cas_gcn.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (220)))._operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("GPTCHANNELNAME subattribute not defined for this hardware counter GPT") COMMA_SOURCE_FILE_AT_LINE (222)) ;
                  }
              ...
              { const GGS_counter_driver _var_6454 = var_cas_cd ; // CAST instruction
                if (_var_6454.getPtr () != NULL) {
                  ...
                  if (typeid (cPtr_void_driver) == typeid (* (_var_6454.getPtr ()))) {
                    ...
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("DRIVER subattribute already defined for this hardware counter") COMMA_SOURCE_FILE_AT_LINE (231)) ;
                    var_cas_cd.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (231)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (232)) ;
                  }
                }
              }
              } break ;
                ...
                while (syntaxRepeat_7) {
                  switch (select_repeat_goil_obj_counter_7 (_inLexique)) {
                    case 2 : {
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      ::routine_set_uint64 (_inLexique,  var_cas_ns,  var_cas_ui,  GGS_string ("NS") COMMA_SOURCE_FILE_AT_LINE (241)) ;
                      } break ;
                    case 3 : {
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_string) COMMA_HERE) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      ::routine_set_lstring_if_empty (_inLexique,  var_cas_cn,  var_cas_c,  GGS_string ("CONSTNAME") COMMA_SOURCE_FILE_AT_LINE (245)) ;
                      } break ;
                    default :
