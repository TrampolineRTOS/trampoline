...
enumComparisonResult cSortedListElement_action_5F_list::compare (const cCollectionElement * inOperand) const {
...
enumComparisonResult cSortedListElement_action_5F_list::compareForSorting (const cSortedListElement * inOperand) const {
...
enumComparisonResult cSortedListElement_expiry_5F_point_5F_list::compare (const cCollectionElement * inOperand) const {
  enumComparisonResult result = kOperandNotValid ;
  if (NULL != inOperand) {
    result = kOperandEqual ;
...
enumComparisonResult cSortedListElement_expiry_5F_point_5F_list::compareForSorting (const cSortedListElement * inOperand) const {
  enumComparisonResult result = kOperandEqual ;
...
enumComparisonResult cMapElement_scheduletable_5F_map::compare (const cCollectionElement * inOperand) const {
...
GALGAS_scheduletable_5F_obj function_default_5F_scheduletable_5F_obj (C_Compiler * inCompiler
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_scheduletable_5F_obj result_scheduletable_5F_obj ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_scheduletable_5F_obj = GALGAS_scheduletable_5F_obj::constructor_new (function_empty_5F_lstring (inCompiler COMMA_SOURCE_FILE_AT_LINE (313)), function_empty_5F_lstring (inCompiler COMMA_SOURCE_FILE_AT_LINE (314)), GALGAS_autostart_5F_void::constructor_new (inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (315)), GALGAS_ltgt_5F_sync_5F_void::constructor_new (inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (316)), GALGAS_void::constructor_new (inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (317)), GALGAS_void::constructor_new (inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (318)), GALGAS_expiry_5F_point_5F_list::constructor_emptySortedList (SOURCE_FILE_AT_LINE (319)), GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (320)) COMMA_SOURCE_FILE_AT_LINE (312)) ;
//---
...
enumComparisonResult GALGAS_sd_5F_autostart_5F_false::objectCompare (const GALGAS_sd_5F_autostart_5F_false & inOperand) const {
...
enumComparisonResult GALGAS_sd_5F_autostart_5F_true::objectCompare (const GALGAS_sd_5F_autostart_5F_true & inOperand) const {
  ...
  macroNullOrValidSharedObject (p, const cPtr_sd_5F_autostart_5F_true) ;
  const cPtr_sd_5F_autostart_5F_true * q = (const cPtr_sd_5F_autostart_5F_true *) inOperand.mObjectPtr ;
  macroNullOrValidSharedObject (q, const cPtr_sd_5F_autostart_5F_true) ;
  if (kOperandEqual == result) {
...
enumComparisonResult GALGAS_sd_5F_autostart_5F_absolute::objectCompare (const GALGAS_sd_5F_autostart_5F_absolute & inOperand) const {
  enumComparisonResult result = GALGAS_sd_5F_autostart_5F_true::objectCompare (inOperand) ;
  const cPtr_sd_5F_autostart_5F_absolute * p = (const cPtr_sd_5F_autostart_5F_absolute *) mObjectPtr ;
  macroNullOrValidSharedObject (p, const cPtr_sd_5F_autostart_5F_absolute) ;
  const cPtr_sd_5F_autostart_5F_absolute * q = (const cPtr_sd_5F_autostart_5F_absolute *) inOperand.mObjectPtr ;
  macroNullOrValidSharedObject (q, const cPtr_sd_5F_autostart_5F_absolute) ;
  if (kOperandEqual == result) {
...
enumComparisonResult GALGAS_sd_5F_autostart_5F_relative::objectCompare (const GALGAS_sd_5F_autostart_5F_relative & inOperand) const {
  enumComparisonResult result = GALGAS_sd_5F_autostart_5F_true::objectCompare (inOperand) ;
  const cPtr_sd_5F_autostart_5F_relative * p = (const cPtr_sd_5F_autostart_5F_relative *) mObjectPtr ;
  macroNullOrValidSharedObject (p, const cPtr_sd_5F_autostart_5F_relative) ;
  const cPtr_sd_5F_autostart_5F_relative * q = (const cPtr_sd_5F_autostart_5F_relative *) inOperand.mObjectPtr ;
  macroNullOrValidSharedObject (q, const cPtr_sd_5F_autostart_5F_relative) ;
  if (kOperandEqual == result) {
...
enumComparisonResult GALGAS_sd_5F_autostart_5F_synchron::objectCompare (const GALGAS_sd_5F_autostart_5F_synchron & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_ltgt_5F_sync_5F_obj::objectCompare (const GALGAS_ltgt_5F_sync_5F_obj & inOperand) const {
  enumComparisonResult result = kOperandEqual ;
  const cPtr_ltgt_5F_sync_5F_obj * p = (const cPtr_ltgt_5F_sync_5F_obj *) mObjectPtr ;
  macroNullOrValidSharedObject (p, const cPtr_ltgt_5F_sync_5F_obj) ;
  const cPtr_ltgt_5F_sync_5F_obj * q = (const cPtr_ltgt_5F_sync_5F_obj *) inOperand.mObjectPtr ;
  macroNullOrValidSharedObject (q, const cPtr_ltgt_5F_sync_5F_obj) ;
  if (kOperandEqual == result) {
...
enumComparisonResult GALGAS_ltgt_5F_sync_5F_false::objectCompare (const GALGAS_ltgt_5F_sync_5F_false & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_ltgt_5F_sync_5F_true::objectCompare (const GALGAS_ltgt_5F_sync_5F_true & inOperand) const {
  enumComparisonResult result = GALGAS_ltgt_5F_sync_5F_obj::objectCompare (inOperand) ;
  const cPtr_ltgt_5F_sync_5F_true * p = (const cPtr_ltgt_5F_sync_5F_true *) mObjectPtr ;
  macroNullOrValidSharedObject (p, const cPtr_ltgt_5F_sync_5F_true) ;
  const cPtr_ltgt_5F_sync_5F_true * q = (const cPtr_ltgt_5F_sync_5F_true *) inOperand.mObjectPtr ;
  macroNullOrValidSharedObject (q, const cPtr_ltgt_5F_sync_5F_true) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_strategy.objectCompare (q->mAttribute_strategy) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_precision.objectCompare (q->mAttribute_precision) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_ltgt_5F_sync_5F_void::objectCompare (const GALGAS_ltgt_5F_sync_5F_void & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_adjustable_5F_obj::objectCompare (const GALGAS_adjustable_5F_obj & inOperand) const {
  ...
  macroNullOrValidSharedObject (p, const cPtr_adjustable_5F_obj) ;
  const cPtr_adjustable_5F_obj * q = (const cPtr_adjustable_5F_obj *) inOperand.mObjectPtr ;
  macroNullOrValidSharedObject (q, const cPtr_adjustable_5F_obj) ;
  if (kOperandEqual == result) {
...
enumComparisonResult GALGAS_adjustable_5F_false::objectCompare (const GALGAS_adjustable_5F_false & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_adjustable_5F_true::objectCompare (const GALGAS_adjustable_5F_true & inOperand) const {
  enumComparisonResult result = GALGAS_adjustable_5F_obj::objectCompare (inOperand) ;
  const cPtr_adjustable_5F_true * p = (const cPtr_adjustable_5F_true *) mObjectPtr ;
  macroNullOrValidSharedObject (p, const cPtr_adjustable_5F_true) ;
  const cPtr_adjustable_5F_true * q = (const cPtr_adjustable_5F_true *) inOperand.mObjectPtr ;
  macroNullOrValidSharedObject (q, const cPtr_adjustable_5F_true) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_max_5F_retard.objectCompare (q->mAttribute_max_5F_retard) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_max_5F_advance.objectCompare (q->mAttribute_max_5F_advance) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_adjustable_5F_void::objectCompare (const GALGAS_adjustable_5F_void & inOperand) const {
  return (isValid () && inOperand.isValid ()) ? kOperandEqual : kOperandNotValid ;
}
...
enumComparisonResult GALGAS_expiry_5F_point_5F_obj::objectCompare (const GALGAS_expiry_5F_point_5F_obj & inOperand) const {
  enumComparisonResult result = GALGAS_oil_5F_obj::objectCompare (inOperand) ;
  const cPtr_expiry_5F_point_5F_obj * p = (const cPtr_expiry_5F_point_5F_obj *) mObjectPtr ;
  macroNullOrValidSharedObject (p, const cPtr_expiry_5F_point_5F_obj) ;
  const cPtr_expiry_5F_point_5F_obj * q = (const cPtr_expiry_5F_point_5F_obj *) inOperand.mObjectPtr ;
  macroNullOrValidSharedObject (q, const cPtr_expiry_5F_point_5F_obj) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_offset.objectCompare (q->mAttribute_offset) ;
  }
  if (kOperandEqual == result) {
  ...
  if (kOperandEqual == result) {
    result = p->mAttribute_adjust.objectCompare (q->mAttribute_adjust) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_actions.objectCompare (q->mAttribute_actions) ;
  }
  return result ;
}
...
enumComparisonResult GALGAS_scheduletable_5F_obj::objectCompare (const GALGAS_scheduletable_5F_obj & inOperand) const {
  enumComparisonResult result = GALGAS_oil_5F_obj::objectCompare (inOperand) ;
  const cPtr_scheduletable_5F_obj * p = (const cPtr_scheduletable_5F_obj *) mObjectPtr ;
  macroNullOrValidSharedObject (p, const cPtr_scheduletable_5F_obj) ;
  const cPtr_scheduletable_5F_obj * q = (const cPtr_scheduletable_5F_obj *) inOperand.mObjectPtr ;
  macroNullOrValidSharedObject (q, const cPtr_scheduletable_5F_obj) ;
  if (kOperandEqual == result) {
    result = p->mAttribute_counter.objectCompare (q->mAttribute_counter) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_autostart.objectCompare (q->mAttribute_autostart) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_ltgt_5F_sync.objectCompare (q->mAttribute_ltgt_5F_sync) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_periodic.objectCompare (q->mAttribute_periodic) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_length.objectCompare (q->mAttribute_length) ;
  }
  if (kOperandEqual == result) {
    result = p->mAttribute_exp_5F_points.objectCompare (q->mAttribute_exp_5F_points) ;
  }
  if (kOperandEqual == result) {
