...
void routine_set_adjustable (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_adjustable_obj _var_2709 = var_cas_adj ; // CAST instruction
    if (_var_2709.getPtr () != NULL) {
      macroValidPointer (_var_2709.getPtr ()) ;
      if (typeid (cPtr_adjustable_void) == typeid (* (_var_2709.getPtr ()))) {
