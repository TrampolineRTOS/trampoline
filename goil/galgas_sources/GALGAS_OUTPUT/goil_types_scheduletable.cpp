...
isEqualToObject (const cSortedListElement * inOperand) const {
  ...
  if (! equal) {
    ...
    equal = offset._operator_isEqual (_p->offset).boolValue ()
         && order._operator_isEqual (_p->order).boolValue ()
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
  ioString << order.reader_description  (_inLexique COMMA_THERE, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-" ;
...
void routine_expiry_point (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_exp_st,  GGS_string ("expiry_point") COMMA_SOURCE_FILE_AT_LINE (72)) ;
  var_cas_exp_st = var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$EXPIRY_POINT$"), (((var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (73)))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_expiry.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (73))))._operator_concat (GGS_string ("_expirypoint")) COMMA_SOURCE_FILE_AT_LINE (73)) ;
  var_cas_exp_st = var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$OFFSET$"), var_cas_expiry._substract_operation (_inLexique, var_cas_previous_expiry COMMA_SOURCE_FILE_AT_LINE (75)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (75)) COMMA_SOURCE_FILE_AT_LINE (75)) ;
  var_cas_exp_st = var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$ACTION_COUNT$"), var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (77)) COMMA_SOURCE_FILE_AT_LINE (77)) ;
  var_cas_exp_st = var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$ACTION_ARRAY$"), ((var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (78)))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_expiry.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (78))) COMMA_SOURCE_FILE_AT_LINE (78)) ;
  GGS_string var_cas_res ;
  var_cas_res = ((((((GGS_string ("\n"
    "tpl_action *"))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (81))))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_expiry.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (81))))._operator_concat (GGS_string ("[")))._operator_concat (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (81))))._operator_concat (GGS_string ("] = {\n")) ;
  GGS_uint  var_cas_i ;
  var_cas_i = GGS_uint (0U) ;
  GGS_uint _variant_2601 = var_cas_index ;
  GGS_bool _condition_2601 (_variant_2601.isBuilt (), true) ;
  while (_condition_2601.isBuiltAndTrue ()) {
    _condition_2601 = (var_cas_i)._operator_strictInf (var_cas_index) ;
    if (_condition_2601.isBuiltAndTrue ()) {
      if (_variant_2601.uintValue () == 0) {
        _inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (92)) ;
        _condition_2601 = GGS_bool (false) ;
      }else{
        _variant_2601._decrement_operation (_inLexique COMMA_HERE) ;
        var_cas_res.appendCString ("    (tpl_action *)&") ;
        var_cas_res._dotAssign_operation (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (85))) ;
        var_cas_res.appendCString ("_") ;
        var_cas_res._dotAssign_operation (var_cas_i.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (85))) ;
        var_cas_res.appendCString ("_") ;
        var_cas_res._dotAssign_operation (var_cas_expiry.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (85))) ;
        var_cas_res.appendCString ("_expirypoint_action") ;
        if (((var_cas_i)._operator_strictInf (var_cas_index._substract_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (86)))).isBuiltAndTrue ()) {
          var_cas_res.appendCString (",\n") ;
        }else{
          var_cas_res.appendCString ("\n") ;
        }
        var_cas_i._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (91)) ;
      }
    }
  }
  var_cas_res.appendCString ("};\n") ;
  var_cas_i_res._dotAssign_operation (var_cas_exp_st.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$EXPIRY_POINT_ACTIONS$"), var_cas_res COMMA_SOURCE_FILE_AT_LINE (95))) ;
  #ifdef DEBUG_TRACE_ENABLED
...
method_generate (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_stres,  GGS_string ("schedule_table") COMMA_SOURCE_FILE_AT_LINE (114)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_NAME$"),  var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (116)) COMMA_SOURCE_FILE_AT_LINE (116)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (117)))._operator_concat (GGS_string ("_sched_table")) COMMA_SOURCE_FILE_AT_LINE (117)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$COUNTER$"),  ((GGS_string ("&"))._operator_concat (counter.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (118))))._operator_concat (GGS_string ("_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (118)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$EXPIRY_TABLE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (119)))._operator_concat (GGS_string ("_expiry_table")) COMMA_SOURCE_FILE_AT_LINE (119)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$APP_ID$"),  (var_cas_app_name)._operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (120)) ;
  GGS_string var_cas_perio ;
  var_cas_perio = GGS_string ("") ;
  { const GGS_basic_type _var_4112 = periodic ; // CAST instruction
    if (_var_4112.getPtr () != NULL) {
      macroValidPointer (_var_4112.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_4112.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_4112.getPtr ()) ;
        if (((var_cas_b.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (130)))._operator_isEqual (GGS_bool (true))).isBuiltAndTrue ()) {
          var_cas_perio = GGS_string ("TRUE") ;
        }else{
          var_cas_perio = GGS_string ("FALSE") ;
        }
      }else{
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Internal error, unexpected type for PERIODIC attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (135))) COMMA_SOURCE_FILE_AT_LINE (136)) ;
      }
    }
  }
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$PERIODIC$"),  var_cas_perio COMMA_SOURCE_FILE_AT_LINE (138)) ;
  { const GGS_autostart_obj _var_4708 = autostart ; // CAST instruction
    if (_var_4708.getPtr () != NULL) {
      macroValidPointer (_var_4708.getPtr ()) ;
      if (typeid (cPtr_sd_autostart_false) == typeid (* (_var_4708.getPtr ()))) {
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_DATE$"),  GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (142)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_STATE$"),  GGS_string ("SCHEDULETABLE_STOPPED") COMMA_SOURCE_FILE_AT_LINE (143)) ;
      }else if (typeid (cPtr_sd_autostart_true) == typeid (* (_var_4708.getPtr ()))) {
        const GGS_sd_autostart_true var_cas_sa (_var_4708.getPtr ()) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_DATE$"),  var_cas_sa.reader_offset (_inLexique COMMA_SOURCE_FILE_AT_LINE (145)).reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (145)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (145)) COMMA_SOURCE_FILE_AT_LINE (145)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SCHEDTABLE_STATE$"),  GGS_string ("SCHEDULETABLE_AUTOSTART") COMMA_SOURCE_FILE_AT_LINE (146)) ;
      }else{
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Internal error, unexpected type for AUTOSTART attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (147))) COMMA_SOURCE_FILE_AT_LINE (148)) ;
      }
    }
  }
  GGS_string var_cas_expiry_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_expiry_tpl,  GGS_string ("expiry_point") COMMA_SOURCE_FILE_AT_LINE (152)) ;
  GGS_string var_cas_setevent_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_setevent_tpl,  GGS_string ("notification_setevent") COMMA_SOURCE_FILE_AT_LINE (154)) ;
  GGS_string var_cas_activatetask_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_activatetask_tpl,  GGS_string ("notification_activatetask") COMMA_SOURCE_FILE_AT_LINE (156)) ;
  GGS_string var_cas_incrementcounter_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_incrementcounter_tpl,  GGS_string ("notification_incrementcounter") COMMA_SOURCE_FILE_AT_LINE (158)) ;
  GGS_string var_cas_finalizescheduletable_tpl ;
  ::routine_retrieveTemplateString (_inLexique,  var_cas_finalizescheduletable_tpl,  GGS_string ("notification_finalizescheduletable") COMMA_SOURCE_FILE_AT_LINE (160)) ;
  ...
  var_cas_expiry_table = ((GGS_string ("tpl_expiry_point *"))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (168))))._operator_concat (GGS_string ("_expiry_table[$EXPIRY_TABLE_SIZE$] = {\n")) ;
  GGS_bool var_cas_first_time ;
  var_cas_first_time = GGS_bool (true) ;
  {
    GGS_action_list::cEnumerator enumerator_5744 (actions, true) ;
    const GGS_action_list::cElement * operand_5744 = NULL ;
    while (((operand_5744 = enumerator_5744.nextObject ()))) {
      macroValidPointer (operand_5744) ;
      if ((((operand_5744->offset)._operator_isNotEqual (var_cas_cur_offset))._operator_or (((operand_5744->offset)._operator_isEqual (GGS_uint64 (0U)))._operator_and ((var_cas_first_time)._operator_isEqual (GGS_bool (true))))).isBuiltAndTrue ()) {
        if (((var_cas_first_time)._operator_not ()).isBuiltAndTrue ()) {
          ::routine_expiry_point (_inLexique,  var_cas_name,  var_cas_cur_offset,  var_cas_previous_offset,  var_cas_index,  var_cas_act_table COMMA_SOURCE_FILE_AT_LINE (175)) ;
          var_cas_expiry_table.appendCString ("    &") ;
          var_cas_expiry_table._dotAssign_operation (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (176))) ;
          var_cas_expiry_table.appendCString ("_") ;
          var_cas_expiry_table._dotAssign_operation (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (176))) ;
        ...
        var_cas_cur_offset = operand_5744->offset ;
        var_cas_index = GGS_uint (0U) ;
        var_cas_expiry_count._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (183)) ;
      }
      GGS_string var_cas_res ;
      var_cas_res = GGS_string ("") ;
      { const GGS_action_obj _var_7209 = operand_5744->act ; // CAST instruction
        if (_var_7209.getPtr () != NULL) {
          macroValidPointer (_var_7209.getPtr ()) ;
          if (typeid (cPtr_activatetask_action) == typeid (* (_var_7209.getPtr ()))) {
            const GGS_activatetask_action var_cas_ata (_var_7209.getPtr ()) ;
            var_cas_res = var_cas_activatetask_tpl.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$TASK$"), (var_cas_ata.reader_task_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (189)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (189)))._operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (189)) ;
          }else if (typeid (cPtr_setevent_action) == typeid (* (_var_7209.getPtr ()))) {
            const GGS_setevent_action var_cas_sea (_var_7209.getPtr ()) ;
            var_cas_res = var_cas_setevent_tpl.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$TASK$"), (var_cas_sea.reader_task_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (191)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (191)))._operator_concat (GGS_string ("_id")) COMMA_SOURCE_FILE_AT_LINE (191)) ;
            var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$EVENT$"), (var_cas_sea.reader_event_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (192)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (192)))._operator_concat (GGS_string ("_mask")) COMMA_SOURCE_FILE_AT_LINE (192)) ;
          }else if (typeid (cPtr_incrementcounter_action) == typeid (* (_var_7209.getPtr ()))) {
            const GGS_incrementcounter_action var_cas_ica (_var_7209.getPtr ()) ;
            var_cas_res = var_cas_incrementcounter_tpl.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$COUNTER$"), (var_cas_ica.reader_counter_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (194)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (194)))._operator_concat (GGS_string ("_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (194)) ;
          }else{
            var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Internal error, unexpected type for ACTION attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (195))) COMMA_SOURCE_FILE_AT_LINE (196)) ;
          }
        }
      }
      var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$NOTIFICATION_NAME$"), (((GGS_string ("expiry point at offset "))._operator_concat (operand_5744->offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (199))))._operator_concat (GGS_string (" of schedule table ")))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (199))) COMMA_SOURCE_FILE_AT_LINE (197)) ;
      var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$NOTIFICATION$"), (((((var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (202)))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (202))))._operator_concat (GGS_string ("_")))._operator_concat (operand_5744->offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (202))))._operator_concat (GGS_string ("_expirypoint_action")) COMMA_SOURCE_FILE_AT_LINE (200)) ;
  ...
  { const GGS_basic_type _var_8308 = length ; // CAST instruction
    if (_var_8308.getPtr () != NULL) {
      macroValidPointer (_var_8308.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_8308.getPtr ()))) {
        const GGS_uint64_class var_cas_len (_var_8308.getPtr ()) ;
        if (((var_cas_cur_offset)._operator_isNotEqual (var_cas_len.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (213)))).isBuiltAndTrue ()) {
          ::routine_expiry_point (_inLexique,  var_cas_name,  var_cas_cur_offset,  var_cas_previous_offset,  var_cas_index,  var_cas_act_table COMMA_SOURCE_FILE_AT_LINE (214)) ;
          var_cas_expiry_table.appendCString ("    &") ;
          var_cas_expiry_table._dotAssign_operation (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (215))) ;
          var_cas_expiry_table.appendCString ("_") ;
          var_cas_expiry_table._dotAssign_operation (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (215))) ;
          var_cas_expiry_table.appendCString ("_expirypoint,\n") ;
          var_cas_previous_offset = var_cas_cur_offset ;
          var_cas_cur_offset = var_cas_len.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)) ;
          var_cas_index = GGS_uint (0U) ;
          var_cas_expiry_count._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (219)) ;
        }
      }else{
      }
    }
  ...
  GGS_string var_cas_res ;
  var_cas_res = GGS_string ("") ;
  var_cas_res = var_cas_finalizescheduletable_tpl.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$SCHEDTABLE$"), (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (223)))._operator_concat (GGS_string ("_sched_table")) COMMA_SOURCE_FILE_AT_LINE (223)) ;
  var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$NOTIFICATION_NAME$"), (((GGS_string ("expiry point at offset "))._operator_concat (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (226))))._operator_concat (GGS_string (" of schedule table ")))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (226))) COMMA_SOURCE_FILE_AT_LINE (224)) ;
  var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$NOTIFICATION$"), (((((var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (229)))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (229))))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (229))))._operator_concat (GGS_string ("_expirypoint_action")) COMMA_SOURCE_FILE_AT_LINE (227)) ;
  var_cas_index._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (230)) ;
  var_cas_act_structs._dotAssign_operation (var_cas_res) ;
  var_cas_act_structs.appendCString ("\n") ;
  ::routine_expiry_point (_inLexique,  var_cas_name,  var_cas_cur_offset,  var_cas_previous_offset,  var_cas_index,  var_cas_act_table COMMA_SOURCE_FILE_AT_LINE (232)) ;
  var_cas_expiry_table.appendCString ("    &") ;
  var_cas_expiry_table._dotAssign_operation (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (233))) ;
  var_cas_expiry_table.appendCString ("_") ;
  var_cas_expiry_table._dotAssign_operation (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (233))) ;
  var_cas_expiry_table.appendCString ("_expirypoint\n"
    "};") ;
  GGS_uint64  var_cas_lastOffset ;
  GGS_uint  automatic_var_2 ;
  GGS_action_obj  automatic_var_3 ;
  const GGS_action_list  _temp_9263 = actions ;
  if (_temp_9263.isBuilt ()) {
    _temp_9263 (HERE)->method_greatest (_inLexique, var_cas_lastOffset, automatic_var_2, automatic_var_3 COMMA_SOURCE_FILE_AT_LINE (238)) ;
  }
  { const GGS_basic_type _var_9737 = length ; // CAST instruction
    if (_var_9737.getPtr () != NULL) {
      macroValidPointer (_var_9737.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_9737.getPtr ()))) {
        const GGS_uint64_class var_cas_len (_var_9737.getPtr ()) ;
        GGS_uint64  var_cas_delay ;
        var_cas_delay = var_cas_len.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (241))._substract_operation (_inLexique, var_cas_lastOffset COMMA_SOURCE_FILE_AT_LINE (241)) ;
        var_cas_act_table = var_cas_act_table.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$OFFSET$"), var_cas_delay.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (242)) COMMA_SOURCE_FILE_AT_LINE (242)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$LENGTH$"),  var_cas_len.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (244)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (244)) ;
      }else{
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Internal error, unexpected type for LENGTH attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (246))) COMMA_SOURCE_FILE_AT_LINE (247)) ;
      }
    }
  }
  { const GGS_ltgt_sync_obj _var_10541 = ltgt_sync ; // CAST instruction
    if (_var_10541.getPtr () != NULL) {
      macroValidPointer (_var_10541.getPtr ()) ;
      if (typeid (cPtr_ltgt_sync_void) == typeid (* (_var_10541.getPtr ()))) {
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  GGS_string ("SCHEDTABLE_NO_SYNC") COMMA_SOURCE_FILE_AT_LINE (252)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (253)) ;
      }else if (typeid (cPtr_ltgt_sync_false) == typeid (* (_var_10541.getPtr ()))) {
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  GGS_string ("SCHEDTABLE_NO_SYNC") COMMA_SOURCE_FILE_AT_LINE (255)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (256)) ;
      }else if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_10541.getPtr ()))) {
        const GGS_ltgt_sync_true var_cas_sst (_var_10541.getPtr ()) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  ((GGS_string ("SCHEDTABLE_"))._operator_concat (var_cas_sst.reader_strategy (_inLexique COMMA_SOURCE_FILE_AT_LINE (258)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (258))))._operator_concat (GGS_string ("_SYNC")) COMMA_SOURCE_FILE_AT_LINE (258)) ;
        { const GGS_basic_type _var_10517 = var_cas_sst.reader_precision (_inLexique COMMA_SOURCE_FILE_AT_LINE (259)) ; // CAST instruction
          if (_var_10517.getPtr () != NULL) {
            macroValidPointer (_var_10517.getPtr ()) ;
            if (typeid (cPtr_uint64_class) == typeid (* (_var_10517.getPtr ()))) {
              const GGS_uint64_class var_cas_p (_var_10517.getPtr ()) ;
              ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  var_cas_p.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (261)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (261)) COMMA_SOURCE_FILE_AT_LINE (261)) ;
            }else{
              var_cas_sst.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (263)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Internal error, wrong type for PRECISION") COMMA_SOURCE_FILE_AT_LINE (264)) ;
            }
          }
        }
      }else{
  ...
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$EXPIRY_POINTS$"),  ((var_cas_act_structs)._operator_concat (var_cas_act_table))._operator_concat (var_cas_expiry_table) COMMA_SOURCE_FILE_AT_LINE (267)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$EXPIRY_TABLE_SIZE$"),  var_cas_expiry_count.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (268)) COMMA_SOURCE_FILE_AT_LINE (268)) ;
