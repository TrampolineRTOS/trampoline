    ...
    "tpl_action *")).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (133)))).operator_concat (GGS_string ("_"))).operator_concat (var_cas_off.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (133)))).operator_concat (GGS_string ("["))).operator_concat (var_cas_actions.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (133)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (133)))).operator_concat (GGS_string ("] = {\n")) ;
  {
    ...
    if ((operand_3659 != NULL)) {
      ...
      do{
        ...
        { const GGS_action_obj _var_4466 = operand_3659->action ; // CAST instruction
          if (_var_4466.getPtr () != NULL) {
            macroValidPointer (_var_4466.getPtr ()) ;
            if (typeid (cPtr_activatetask_action) == typeid (* (_var_4466.getPtr ()))) {
              const GGS_activatetask_action var_cas_ata (_var_4466.getPtr ()) ;
            ...
            }else if (typeid (cPtr_setevent_action) == typeid (* (_var_4466.getPtr ()))) {
              const GGS_setevent_action var_cas_sea (_var_4466.getPtr ()) ;
            ...
            }else if (typeid (cPtr_finalize_st_action) == typeid (* (_var_4466.getPtr ()))) {
...
method_generate (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_7419 = length ; // CAST instruction
    if (_var_7419.getPtr () != NULL) {
      macroValidPointer (_var_7419.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_7419.getPtr ()))) {
        const GGS_uint64_class var_cas_len (_var_7419.getPtr ()) ;
        ...
        const GGS_bool cond_6696 = (var_cas_last_offset).operator_isEqual (var_cas_len.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (199))) ;
        if (cond_6696.isBuiltAndTrue ()) {
          GGS_action_list  var_cas_acts = var_cas_last_point.reader_actions (inLexique COMMA_SOURCE_FILE_AT_LINE (201)) ;
        ...
        }else if (cond_6696.isBuiltAndFalse ()) {
          ...
          var_cas_epl.addAssign_operation (var_cas_len.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (216)), var_cas_finalize_ep) ;
        }
  ...
  { const GGS_basic_type _var_7869 = periodic ; // CAST instruction
    if (_var_7869.getPtr () != NULL) {
      macroValidPointer (_var_7869.getPtr ()) ;
      if (typeid (cPtr_bool_class) == typeid (* (_var_7869.getPtr ()))) {
        const GGS_bool_class var_cas_b (_var_7869.getPtr ()) ;
        const GGS_bool cond_7702 = (var_cas_b.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (228))).operator_isEqual (GGS_bool (true)) ;
        if (cond_7702.isBuiltAndTrue ()) {
          var_cas_perio = GGS_string ("TRUE") ;
        }else if (cond_7702.isBuiltAndFalse ()) {
  ...
  { const GGS_autostart_obj _var_8811 = autostart ; // CAST instruction
    if (_var_8811.getPtr () != NULL) {
      macroValidPointer (_var_8811.getPtr ()) ;
      if (typeid (cPtr_sd_autostart_false) == typeid (* (_var_8811.getPtr ()))) {
      ...
      }else if (typeid (cPtr_sd_autostart_synchron) == typeid (* (_var_8811.getPtr ()))) {
      ...
      }else if (typeid (cPtr_sd_autostart_relative) == typeid (* (_var_8811.getPtr ()))) {
        const GGS_sd_autostart_relative var_cas_sa (_var_8811.getPtr ()) ;
      ...
      }else if (typeid (cPtr_sd_autostart_absolute) == typeid (* (_var_8811.getPtr ()))) {
        const GGS_sd_autostart_absolute var_cas_sa (_var_8811.getPtr ()) ;
  ...
  GGS_string var_cas_expiry_table = ((GGS_string ("tpl_expiry_point *")).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (258)))).operator_concat (GGS_string ("_expiry_table[$EXPIRY_TABLE_SIZE$] = {\n")) ;
  GGS_uint64  var_cas_prev_offset = GGS_uint64 (0ULL) ;
  {
    GGS_expiry_point_list::cEnumerator enumerator_9038 (var_cas_epl, true) ;
    const GGS_expiry_point_list::cElement * operand_9038 = enumerator_9038.nextObject () ;
    if ((operand_9038 != NULL)) {
      bool _foreach_loop_9038 ;
      do{
        ...
        ::routine_doReplace (inLexique,  var_cas_exp_st,  GGS_string ("$EXPIRY_POINT$"),  (((var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265))).operator_concat (GGS_string ("_"))).operator_concat (operand_9038->off.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (265)))).operator_concat (GGS_string ("_expirypoint")) COMMA_SOURCE_FILE_AT_LINE (265)) ;
        ::routine_doReplace (inLexique,  var_cas_exp_st,  GGS_string ("$OFFSET$"),  operand_9038->off.substract_operation (inLexique, var_cas_prev_offset COMMA_SOURCE_FILE_AT_LINE (266)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (266)) COMMA_SOURCE_FILE_AT_LINE (266)) ;
        ::routine_doReplace (inLexique,  var_cas_exp_st,  GGS_string ("$ACTION_COUNT$"),  operand_9038->point.reader_actions (inLexique COMMA_SOURCE_FILE_AT_LINE (267)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (267)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (267)) COMMA_SOURCE_FILE_AT_LINE (267)) ;
        ::routine_doReplace (inLexique,  var_cas_exp_st,  GGS_string ("$ACTION_ARRAY$"),  ((var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (268))).operator_concat (GGS_string ("_"))).operator_concat (operand_9038->off.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (268))) COMMA_SOURCE_FILE_AT_LINE (268)) ;
        ::routine_expiry_point_actions (inLexique,  var_cas_name,  operand_9038->off,  operand_9038->point.reader_actions (inLexique COMMA_SOURCE_FILE_AT_LINE (271)),  var_cas_exp_st COMMA_SOURCE_FILE_AT_LINE (271)) ;
        const GGS_adjustable_obj  temp_9627 = operand_9038->point.reader_adjust (inLexique COMMA_SOURCE_FILE_AT_LINE (272)) ;
        if (temp_9627.isBuilt ()) {
          temp_9627 (HERE)->method_generate (inLexique, var_cas_exp_st COMMA_SOURCE_FILE_AT_LINE (272)) ;
        }
        ...
        var_cas_expiry_table.dotAssign_operation (operand_9038->off.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (274))) ;
        var_cas_expiry_table.appendCString ("_expirypoint") ;
        var_cas_prev_offset = operand_9038->off ;
        operand_9038 = enumerator_9038.nextObject () ;
        _foreach_loop_9038 = ((operand_9038 != NULL)) ;
        if (_foreach_loop_9038) {
          var_cas_expiry_table.appendCString (",\n") ;
        }
      }while (_foreach_loop_9038) ;
      var_cas_expiry_table.appendCString ("\n"
        "};\n") ;
    }
  }
  { const GGS_ltgt_sync_obj _var_10591 = ltgt_sync ; // CAST instruction
    if (_var_10591.getPtr () != NULL) {
      macroValidPointer (_var_10591.getPtr ()) ;
      if (typeid (cPtr_ltgt_sync_void) == typeid (* (_var_10591.getPtr ()))) {
      ...
      }else if (typeid (cPtr_ltgt_sync_false) == typeid (* (_var_10591.getPtr ()))) {
      ...
      }else if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_10591.getPtr ()))) {
        const GGS_ltgt_sync_true var_cas_sst (_var_10591.getPtr ()) ;
        ...
        { const GGS_basic_type _var_10572 = var_cas_sst.reader_precision (inLexique COMMA_SOURCE_FILE_AT_LINE (292)) ; // CAST instruction
          if (_var_10572.getPtr () != NULL) {
            macroValidPointer (_var_10572.getPtr ()) ;
            if (typeid (cPtr_uint64_class) == typeid (* (_var_10572.getPtr ()))) {
              const GGS_uint64_class var_cas_p (_var_10572.getPtr ()) ;
