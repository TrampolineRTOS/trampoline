...
method_generate (C_Compiler & _inLexique,
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_incrementcounter_tpl,  GGS_string ("notification_incrementcounter") COMMA_SOURCE_FILE_AT_LINE (157)) ;
  ...
  var_cas_expiry_table = ((GGS_string ("tpl_expiry_point *"))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (165))))._operator_concat (GGS_string ("_expiry_table[$EXPIRY_TABLE_SIZE$] = {\n")) ;
  GGS_bool var_cas_first_time ;
  var_cas_first_time = GGS_bool (true) ;
  {
    GGS_action_list::cEnumerator enumerator_5573 (actions, true) ;
    const GGS_action_list::cElement * operand_5573 = NULL ;
    while (((operand_5573 = enumerator_5573.nextObject ()))) {
      macroValidPointer (operand_5573) ;
      _inLexique.printMessage ((operand_5573->offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (169)))._operator_concat (GGS_string ("\n")) COMMA_SOURCE_FILE_AT_LINE (169)) ;
      if (((operand_5573->offset)._operator_isNotEqual (var_cas_cur_offset)).isBuiltAndTrue ()) {
        ...
        var_cas_cur_offset = operand_5573->offset ;
        var_cas_index = GGS_uint (0U) ;
        var_cas_expiry_count._increment_operation (_inLexique COMMA_SOURCE_FILE_AT_LINE (181)) ;
      }
      GGS_string var_cas_res ;
      var_cas_res = GGS_string ("") ;
      { const GGS_action_obj _var_7051 = operand_5573->act ; // CAST instruction
        if (_var_7051.getPtr () != NULL) {
          macroValidPointer (_var_7051.getPtr ()) ;
          if (typeid (cPtr_activatetask_action) == typeid (* (_var_7051.getPtr ()))) {
            const GGS_activatetask_action var_cas_ata (_var_7051.getPtr ()) ;
          ...
          }else if (typeid (cPtr_setevent_action) == typeid (* (_var_7051.getPtr ()))) {
            const GGS_setevent_action var_cas_sea (_var_7051.getPtr ()) ;
          ...
          }else if (typeid (cPtr_incrementcounter_action) == typeid (* (_var_7051.getPtr ()))) {
            const GGS_incrementcounter_action var_cas_ica (_var_7051.getPtr ()) ;
      ...
      var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$NOTIFICATION_NAME$"), (((GGS_string ("expiry point at offset "))._operator_concat (operand_5573->offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (197))))._operator_concat (GGS_string (" of schedule table ")))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (197))) COMMA_SOURCE_FILE_AT_LINE (195)) ;
      var_cas_res = var_cas_res.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$NOTIFICATION$"), (((((var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (200)))._operator_concat (GGS_string ("_")))._operator_concat (var_cas_index.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (200))))._operator_concat (GGS_string ("_")))._operator_concat (operand_5573->offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (200))))._operator_concat (GGS_string ("_expirypoint_action")) COMMA_SOURCE_FILE_AT_LINE (198)) ;
  ...
  ::routine_expiry_point (_inLexique,  var_cas_name,  var_cas_cur_offset,  var_cas_previous_offset,  var_cas_index,  var_cas_act_table COMMA_SOURCE_FILE_AT_LINE (205)) ;
  var_cas_expiry_table.appendCString ("    &") ;
  var_cas_expiry_table._dotAssign_operation (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (206))) ;
  var_cas_expiry_table.appendCString ("_") ;
  var_cas_expiry_table._dotAssign_operation (var_cas_cur_offset.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (206))) ;
  var_cas_expiry_table.appendCString ("_expirypoint\n"
    "};") ;
  GGS_uint64  var_cas_lastOffset ;
  GGS_action_obj  automatic_var_1 ;
  const GGS_action_list  _temp_7926 = actions ;
  if (_temp_7926.isBuilt ()) {
    _temp_7926 (HERE)->method_greatest (_inLexique, var_cas_lastOffset, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (211)) ;
  }
  { const GGS_basic_type _var_8397 = length ; // CAST instruction
    if (_var_8397.getPtr () != NULL) {
      macroValidPointer (_var_8397.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_8397.getPtr ()))) {
        const GGS_uint64_class var_cas_len (_var_8397.getPtr ()) ;
        GGS_uint64  var_cas_delay ;
        var_cas_delay = var_cas_len.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (214))._substract_operation (_inLexique, var_cas_lastOffset COMMA_SOURCE_FILE_AT_LINE (214)) ;
        var_cas_act_table = var_cas_act_table.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$OFFSET$"), var_cas_delay.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (215)) COMMA_SOURCE_FILE_AT_LINE (215)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$LENGTH$"),  var_cas_len.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (217)) COMMA_SOURCE_FILE_AT_LINE (217)) ;
      }else{
        var_cas_name.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Internal error, unexpected type for LENGTH attribute of schedule table "))._operator_concat (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (219))) COMMA_SOURCE_FILE_AT_LINE (220)) ;
      }
    }
  }
  { const GGS_ltgt_sync_obj _var_9201 = ltgt_sync ; // CAST instruction
    if (_var_9201.getPtr () != NULL) {
      macroValidPointer (_var_9201.getPtr ()) ;
      if (typeid (cPtr_ltgt_sync_void) == typeid (* (_var_9201.getPtr ()))) {
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  GGS_string ("SCHEDTABLE_NO_SYNC") COMMA_SOURCE_FILE_AT_LINE (225)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (226)) ;
      }else if (typeid (cPtr_ltgt_sync_false) == typeid (* (_var_9201.getPtr ()))) {
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  GGS_string ("SCHEDTABLE_NO_SYNC") COMMA_SOURCE_FILE_AT_LINE (228)) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (229)) ;
      }else if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_9201.getPtr ()))) {
        const GGS_ltgt_sync_true var_cas_sst (_var_9201.getPtr ()) ;
        ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$SYNC_STRATEGY$"),  ((GGS_string ("SCHEDTABLE_"))._operator_concat (var_cas_sst.reader_strategy (_inLexique COMMA_SOURCE_FILE_AT_LINE (231)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (231))))._operator_concat (GGS_string ("_SYNC")) COMMA_SOURCE_FILE_AT_LINE (231)) ;
        { const GGS_basic_type _var_9177 = var_cas_sst.reader_precision (_inLexique COMMA_SOURCE_FILE_AT_LINE (232)) ; // CAST instruction
          if (_var_9177.getPtr () != NULL) {
            macroValidPointer (_var_9177.getPtr ()) ;
            if (typeid (cPtr_uint64_class) == typeid (* (_var_9177.getPtr ()))) {
              const GGS_uint64_class var_cas_p (_var_9177.getPtr ()) ;
              ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$PRECISION$"),  var_cas_p.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (234)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (234)) COMMA_SOURCE_FILE_AT_LINE (234)) ;
            }else{
              var_cas_sst.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (236)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Internal error, wrong type for PRECISION") COMMA_SOURCE_FILE_AT_LINE (237)) ;
            }
          }
        }
      }else{
  ...
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$EXPIRY_POINTS$"),  ((var_cas_act_structs)._operator_concat (var_cas_act_table))._operator_concat (var_cas_expiry_table) COMMA_SOURCE_FILE_AT_LINE (240)) ;
  ::routine_doReplace (_inLexique,  var_cas_stres,  GGS_string ("$EXPIRY_TABLE_SIZE$"),  var_cas_expiry_count.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (241)) COMMA_SOURCE_FILE_AT_LINE (241)) ;
