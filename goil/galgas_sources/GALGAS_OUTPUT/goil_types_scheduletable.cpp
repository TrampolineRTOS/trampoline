...
method_generate (C_Compiler & _inLexique,
  ...
  var_cas_first_time = GGS_bool (true) ;
  {
    ...
    while (((operand_5573 = enumerator_5573.nextObject ()))) {
      ...
      GGS_string var_cas_res ;
      var_cas_res = GGS_string ("") ;
      { const GGS_action_obj _var_7052 = operand_5573->act ; // CAST instruction
        if (_var_7052.getPtr () != NULL) {
          macroValidPointer (_var_7052.getPtr ()) ;
          if (typeid (cPtr_activatetask_action) == typeid (* (_var_7052.getPtr ()))) {
            const GGS_activatetask_action var_cas_ata (_var_7052.getPtr ()) ;
          ...
          }else if (typeid (cPtr_setevent_action) == typeid (* (_var_7052.getPtr ()))) {
            const GGS_setevent_action var_cas_sea (_var_7052.getPtr ()) ;
          ...
          }else if (typeid (cPtr_incrementcounter_action) == typeid (* (_var_7052.getPtr ()))) {
            const GGS_incrementcounter_action var_cas_ica (_var_7052.getPtr ()) ;
  ...
  const GGS_action_list  _temp_7927 = actions ;
  if (_temp_7927.isBuilt ()) {
    _temp_7927 (HERE)->method_greatest (_inLexique, var_cas_lastOffset, automatic_var_1 COMMA_SOURCE_FILE_AT_LINE (211)) ;
  }
  { const GGS_basic_type _var_8398 = length ; // CAST instruction
    if (_var_8398.getPtr () != NULL) {
      macroValidPointer (_var_8398.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_8398.getPtr ()))) {
        const GGS_uint64_class var_cas_len (_var_8398.getPtr ()) ;
  ...
  { const GGS_ltgt_sync_obj _var_9202 = ltgt_sync ; // CAST instruction
    if (_var_9202.getPtr () != NULL) {
      macroValidPointer (_var_9202.getPtr ()) ;
      if (typeid (cPtr_ltgt_sync_void) == typeid (* (_var_9202.getPtr ()))) {
      ...
      }else if (typeid (cPtr_ltgt_sync_false) == typeid (* (_var_9202.getPtr ()))) {
      ...
      }else if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_9202.getPtr ()))) {
        const GGS_ltgt_sync_true var_cas_sst (_var_9202.getPtr ()) ;
        ...
        { const GGS_basic_type _var_9178 = var_cas_sst.reader_precision (_inLexique COMMA_SOURCE_FILE_AT_LINE (232)) ; // CAST instruction
          if (_var_9178.getPtr () != NULL) {
            macroValidPointer (_var_9178.getPtr ()) ;
            if (typeid (cPtr_uint64_class) == typeid (* (_var_9178.getPtr ()))) {
              const GGS_uint64_class var_cas_p (_var_9178.getPtr ()) ;
