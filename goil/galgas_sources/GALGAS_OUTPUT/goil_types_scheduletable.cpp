...
//                    november 12th, 2009, at 11h41'29"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_expiry_point_actions (C_Compiler & inLexique,
  ...
  GGS_string var_cas_res = ((((((GGS_string ("\n"
    "tpl_action *")).operator_concat (var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130)))).operator_concat (GGS_string ("_"))).operator_concat (var_cas_off.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130)))).operator_concat (GGS_string ("["))).operator_concat (var_cas_actions.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (130)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (130)))).operator_concat (GGS_string ("] = {\n")) ;
  {
...
method_generate (C_Compiler & inLexique,
  ...
  GGS_uint64  var_cas_prev_offset = GGS_uint64 (0ULL) ;
  {
    ...
    if ((operand_8978 != NULL)) {
      ...
      do{
        ...
        ::routine_doReplace (inLexique,  var_cas_exp_st,  GGS_string ("$ACTION_COUNT$"),  operand_8978->point.reader_actions (inLexique COMMA_SOURCE_FILE_AT_LINE (262)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (262)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (262)) COMMA_SOURCE_FILE_AT_LINE (262)) ;
  ...
  ::routine_doReplace (inLexique,  var_cas_stres,  GGS_string ("$EXPIRY_TABLE_SIZE$"),  var_cas_epl.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (296)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (296)) COMMA_SOURCE_FILE_AT_LINE (296)) ;
