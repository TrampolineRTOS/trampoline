...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_sd_autostart_synchron _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_sd_autostart_synchron (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_sd_autostart_relative _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_sd_autostart_relative (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
...
_castFrom (C_Compiler & inLexique,
           ...
           const GGS_location & inErrorLocation
           COMMA_LOCATION_ARGS) {
  GGS_sd_autostart_absolute _result ;
  if (inPointer != NULL) {
    macroValidPointer (inPointer) ;
    const bool ok = inUseKindOfClass
    ...
    if (ok) {
      _result = GGS_sd_autostart_absolute (inPointer) ;
    }else{
      inErrorLocation.signalCastError (inLexique,
