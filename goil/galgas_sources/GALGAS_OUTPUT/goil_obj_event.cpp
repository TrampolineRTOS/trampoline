...
void goil_obj_event::rule_goil_5F_obj_5F_event_event_i0_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  const GGS_bool cond_1152 = var_cas_events.reader_hasKey (var_cas_event_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (53))) ;
  if (cond_1152.isBuiltAndTrue ()) {
  ...
  }else if (cond_1152.isBuiltAndFalse ()) {
    var_cas_mask = GGS_event_mask_void_obj ::constructor_new (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (58)) ;
    var_cas_desc = GGS_lstring ::constructor_new (inLexique, GGS_string (""), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (59)) ;
    var_cas_event = GGS_event_obj ::constructor_new (inLexique, var_cas_desc, var_cas_mask COMMA_SOURCE_FILE_AT_LINE (60)) ;
  }
  ...
  var_cas_event = GGS_event_obj ::constructor_new (inLexique, var_cas_desc, var_cas_mask COMMA_SOURCE_FILE_AT_LINE (68)) ;
        ...
        case 2 : {
          ...
          switch (select_goil_5F_obj_5F_event_1 (inLexique)) {
            case 1 : {
              ...
              { const GGS_event_mask_obj _var_1935 = var_cas_mask ; // CAST instruction
                if (_var_1935.getPtr () != NULL) {
                  macroValidPointer (_var_1935.getPtr ()) ;
                  if (typeid (cPtr_event_mask_void_obj) == typeid (* (_var_1935.getPtr ()))) {
                    var_cas_mask = GGS_event_mask_auto_obj ::constructor_new (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (82)) ;
                  }else{
            ...
            case 2 : {
              ...
              { const GGS_event_mask_obj _var_3052 = var_cas_mask ; // CAST instruction
                if (_var_3052.getPtr () != NULL) {
                  macroValidPointer (_var_3052.getPtr ()) ;
                  if (typeid (cPtr_event_mask_void_obj) == typeid (* (_var_3052.getPtr ()))) {
                    var_cas_mask = GGS_event_mask_user_obj ::constructor_new (inLexique, GGS_location (inLexique), var_cas_mask_value COMMA_SOURCE_FILE_AT_LINE (92)) ;
                    const GGS_bool cond_2332 = (var_cas_mask_value.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (93))).operator_strictSup (GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (93)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (93))) ;
                    if (cond_2332.isBuiltAndTrue ()) {
                      ...
                      GGS_uint _variant_2679 = GGS_uint (32U) ;
                      GGS_bool _condition_2679 (_variant_2679.isBuilt (), true) ;
                      while (_condition_2679.isBuiltAndTrue ()) {
                        _condition_2679 = (var_cas_pof2).operator_strictInf (GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (99)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (99))) ;
                        if (_condition_2679.isBuiltAndTrue ()) {
                          if (_variant_2679.uintValue () == 0) {
                            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (104)) ;
                            _condition_2679 = GGS_bool (false) ;
                          }else{
                            _variant_2679.decrement_operation (inLexique COMMA_HERE) ;
                            const GGS_bool cond_2612 = ((var_cas_pof2).operator_and (var_cas_mask_value.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (100)))).operator_isNotEqual (GGS_uint64 (0ULL)) ;
                            if (cond_2612.isBuiltAndTrue ()) {
                      ...
                      const GGS_bool cond_2820 = (var_cas_nbbits).operator_strictSup (GGS_uint (1U)) ;
          ...
          GGS_lstring  automatic_var_3107_0 ;
          nt_description_ (inLexique, automatic_var_3107_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
          } break ;
        default :
