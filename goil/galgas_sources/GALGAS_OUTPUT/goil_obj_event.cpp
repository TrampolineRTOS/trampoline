...
//                    september 21th, 2009, at 18h18'3"                      *
//                                                                           *
//---------------------------------------------------------------------------*
        ...
        case 2 : {
          ...
          switch (select_goil_obj_event_1 (inLexique)) {
            case 1 : {
              ...
              { const GGS_event_mask_obj _var_1821 = var_cas_mask ; // CAST instruction
                if (_var_1821.getPtr () != NULL) {
                  macroValidPointer (_var_1821.getPtr ()) ;
                  if (typeid (cPtr_event_mask_void_obj) == typeid (* (_var_1821.getPtr ()))) {
            ...
            case 2 : {
              ...
              { const GGS_event_mask_obj _var_2938 = var_cas_mask ; // CAST instruction
                if (_var_2938.getPtr () != NULL) {
                  macroValidPointer (_var_2938.getPtr ()) ;
                  if (typeid (cPtr_event_mask_void_obj) == typeid (* (_var_2938.getPtr ()))) {
                    ...
                    if (((var_cas_mask_value.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (91))).operator_strictSup (GGS_uint ::constructor_max (inLexique COMMA_HERE).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (91)))).isBuiltAndTrue ()) {
                      ...
                      var_cas_pof2 = GGS_uint64 (1ULL) ;
                      GGS_uint _variant_2565 = GGS_uint (32U) ;
                      GGS_bool _condition_2565 (_variant_2565.isBuilt (), true) ;
                      while (_condition_2565.isBuiltAndTrue ()) {
                        _condition_2565 = (var_cas_pof2).operator_strictInf (GGS_uint ::constructor_max (inLexique COMMA_HERE).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (97))) ;
                        if (_condition_2565.isBuiltAndTrue ()) {
                          if (_variant_2565.uintValue () == 0) {
                            inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (102)) ;
                            _condition_2565 = GGS_bool (false) ;
                          }else{
                            _variant_2565.decrement_operation (inLexique COMMA_HERE) ;
                            if ((((var_cas_pof2).operator_and (var_cas_mask_value.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (98)))).operator_isNotEqual (GGS_uint64 (0ULL))).isBuiltAndTrue ()) {
