...
void routine_getAbsoluteSourceFilePath (GALGASap_string constinArgument0,
...
void routine_checkFileExists (GALGASap_lstring constinArgument0,
                              C_Compiler * inCompiler
                              COMMA_LOCATION_ARGS) ;
...
void routine_checkFileDoesNotExists (GALGASap_lstring constinArgument0,
                                     C_Compiler * inCompiler
                                     COMMA_LOCATION_ARGS) ;
...
void routine_checkTrampolinePath (GALGASap_lstring constinArgument0,
                                  C_Compiler * inCompiler
                                  COMMA_LOCATION_ARGS) ;
...
void routine_check_5F_target (GALGASap_string constinArgument0,
                              C_Compiler * inCompiler
                              COMMA_LOCATION_ARGS) ;
