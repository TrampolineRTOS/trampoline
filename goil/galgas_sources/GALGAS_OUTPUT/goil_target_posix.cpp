...
void routine_generate_target_posix (C_Compiler & _inLexique,
  ...
  #endif
  ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$STACK_ZONE$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (15)))._operator_concat (GGS_string (true, "_stack_zone")) COMMA_SOURCE_FILE_AT_LINE (15)) ;
  ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$STACK$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (16)))._operator_concat (GGS_string (true, "_stack")) COMMA_SOURCE_FILE_AT_LINE (16)) ;
  ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$EXEC_ALL_CONTEXT$"),  (var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (17)))._operator_concat (GGS_string (true, "_int_context")) COMMA_SOURCE_FILE_AT_LINE (17)) ;
  GGS_uint  var_cas_stack_size ;
  ::routine_additional_int_key_required (_inLexique,  GGS_string (true, "STACKSIZE"),  var_cas_others,  var_cas_name,  var_cas_stack_size COMMA_SOURCE_FILE_AT_LINE (20)) ;
  ::routine_doReplace (_inLexique,  var_cas_result,  GGS_string (true, "$STACK_SIZE$"),  var_cas_stack_size.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (21)) COMMA_SOURCE_FILE_AT_LINE (21)) ;
  { const GGS_oil_obj _var_980 = var_cas_exe ; // CAST instruction
    if (_var_980.getPtr () != NULL) {
      ...
      if (typeid (cPtr_isr_obj) == typeid (* (_var_980.getPtr ()))) {
        ...
        ::routine_additional_string_key_required (_inLexique,  GGS_string (true, "SOURCE"),  var_cas_others,  var_cas_name,  var_cas_sig COMMA_SOURCE_FILE_AT_LINE (28)) ;
      }else{
      }
    }
  }
...
void routine_generate_isr_posix (C_Compiler & _inLexique,
  ...
  if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "posix_it" COMMA_SOURCE_FILE_AT_LINE (41))))._operator_not ()).isBuiltAndTrue ()) {
    {
          ...
          { const GGS_basic_type _var_1915 = var_cas_value ; // CAST instruction
            if (_var_1915.getPtr () != NULL) {
              ...
              if (typeid (cPtr_string_class) == typeid (* (_var_1915.getPtr ()))) {
                ...
                var_cas_result = ((var_cas_result)._operator_concat (GGS_string (true, "\t")))._operator_concat (var_cas_s.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (60))) ;
              }else{
                operand_1356->key.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (var_cas_key)._operator_concat (GGS_string (true, " should be a string")) COMMA_SOURCE_FILE_AT_LINE (63)) ;
              }
            }
          }
        }else{
          operand_1356->key.reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, ((GGS_string (true, "no "))._operator_concat (var_cas_key))._operator_concat (GGS_string (true, " specified")) COMMA_SOURCE_FILE_AT_LINE (66)) ;
        }
      }
    }
  }
  var_cas_code = var_cas_code.reader_stringByReplacingStringByString (_inLexique, GGS_string (true, "$ISR_SIGNAL_LIST$"), var_cas_result COMMA_SOURCE_FILE_AT_LINE (69)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generate_counter_posix (C_Compiler & _inLexique,
      ...
      { const GGS_counter_type _var_2542 = operand_2242->mInfo.counter.reader_type (_inLexique COMMA_SOURCE_FILE_AT_LINE (78)) ; // CAST instruction
        if (_var_2542.getPtr () != NULL) {
          ...
          if (typeid (cPtr_software_counter) == typeid (* (_var_2542.getPtr ()))) {
            ...
            ::routine_retrieveTemplateString (_inLexique,  var_cas_tmp,  GGS_string (true, "counter_list_specific") COMMA_SOURCE_FILE_AT_LINE (82)) ;
            ::routine_doReplace (_inLexique,  var_cas_tmp,  GGS_string (true, "$COUNTER$"),  (operand_2242->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (83)))._operator_concat (GGS_string (true, "_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (83)) ;
  ...
  ::routine_doReplace (_inLexique,  var_cas_code,  GGS_string (true, "$COUNTER_LIST$"),  var_cas_result COMMA_SOURCE_FILE_AT_LINE (88)) ;
  #ifdef DEBUG_TRACE_ENABLED
