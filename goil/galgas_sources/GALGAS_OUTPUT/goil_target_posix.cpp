    ...
    }
    {
      ...
      while (((operand_1356 = enumerator_1356.nextObject ()))) {
        ...
        if (_temp_1417.isBuilt ()) {
          _temp_1417 (HERE)->method_get (inLexique, operand_1356->key, var_cas_isr COMMA_SOURCE_FILE_AT_LINE (48)) ;
        }
        ...
        if ((var_cas_others.reader_hasKey (inLexique, var_cas_key COMMA_SOURCE_FILE_AT_LINE (54))).isBuiltAndTrue ()) {
          ...
          if (_temp_1682.isBuilt ()) {
            _temp_1682 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, var_cas_key, GGS_location (inLexique) COMMA_HERE), var_cas_value COMMA_SOURCE_FILE_AT_LINE (57)) ;
          }
