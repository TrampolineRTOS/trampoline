...
GGS_string function_trueFalse (C_Compiler &,
  ...
  const GGS_bool cond_989 = var_cas_inBool ;
  if (cond_989.isBuiltAndTrue ()) {
    var_cas_result = GGS_string ("true") ;
  }else if (cond_989.isBuiltAndFalse ()) {
...
GGS_string function_yesNo (C_Compiler &,
  ...
  #endif
  GGS_string var_cas_result ;
  const GGS_bool cond_1130 = var_cas_inBool ;
  if (cond_1130.isBuiltAndTrue ()) {
    var_cas_result = GGS_string ("YES") ;
  }else if (cond_1130.isBuiltAndFalse ()) {
...
GGS_string function_TRUEFALSE (C_Compiler &,
  ...
  #endif
  GGS_string var_cas_result ;
  const GGS_bool cond_1273 = var_cas_inBool ;
  if (cond_1273.isBuiltAndTrue ()) {
    var_cas_result = GGS_string ("TRUE") ;
  }else if (cond_1273.isBuiltAndFalse ()) {
    var_cas_result = GGS_string ("FALSE") ;
  }
  #ifdef DEBUG_TRACE_ENABLED
    printf ("LEAVE function_TRUEFALSE\n") ;
