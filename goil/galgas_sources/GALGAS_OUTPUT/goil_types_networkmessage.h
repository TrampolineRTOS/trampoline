...
//--- Comparison methods
  public : GGS_bool _operator_isEqual (const GGS_netmess_map & inOperand) const ;
  public : GGS_bool _operator_isNotEqual (const GGS_netmess_map & inOperand) const ;
...
//--- Modifiers "set'Value'ForKey"
  public : void modifier_setNetmessForKey (C_Compiler & inLexique,
