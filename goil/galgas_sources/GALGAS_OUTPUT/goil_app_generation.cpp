...
//                    november 30th, 2009, at 10h44'38"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_generate_apps (C_Compiler & inLexique,
  ...
  const GGS_bool cond_11005 = (var_cas_apps.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
      ...
      while (((operand_2736 = enumerator_2736.nextObject ()))) {
        ...
        var_cas_vec = GGS_string ("") ;
        {
          ...
          while (((operand_4658 = enumerator_4658.nextObject ()))) {
            ...
            const GGS_bool cond_4744 = operand_2736->mInfo.app.reader_alarms (inLexique COMMA_SOURCE_FILE_AT_LINE (169)).reader_hasKey (operand_4658->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (169))) ;
        ...
        var_cas_vec = GGS_string ("") ;
        {
          ...
          while (((operand_5407 = enumerator_5407.nextObject ()))) {
            ...
            const GGS_bool cond_5496 = operand_2736->mInfo.app.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (192)).reader_hasKey (operand_5407->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (192))) ;
        ...
        var_cas_vec = GGS_string ("") ;
        {
          ...
          while (((operand_6207 = enumerator_6207.nextObject ()))) {
            ...
            const GGS_bool cond_6298 = operand_2736->mInfo.app.reader_schedtables (inLexique COMMA_SOURCE_FILE_AT_LINE (219)).reader_hasKey (operand_6207->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (219))) ;
        ...
        var_cas_vec = GGS_string ("") ;
        {
          ...
          while (((operand_6921 = enumerator_6921.nextObject ()))) {
            ...
            const GGS_bool cond_7009 = operand_2736->mInfo.app.reader_counters (inLexique COMMA_SOURCE_FILE_AT_LINE (241)).reader_hasKey (operand_6921->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (241))) ;
        ...
        GGS_string var_cas_table = GGS_string ("") ;
        {
          ...
          if ((operand_7745 != NULL)) {
            var_cas_table = ((((GGS_string ("tpl_proc_id ")).operator_concat (operand_2736->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (266)))).operator_concat (GGS_string ("_proc_own ["))).operator_concat (var_cas_procs.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (266)))).operator_concat (GGS_string ("] = {")) ;
        ...
        ::routine_doReplace (inLexique,  var_cas_tpl,  GGS_string ("$PROC_COUNT$"),  var_cas_procs.reader_length ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (272)) COMMA_SOURCE_FILE_AT_LINE (272)) ;
        ...
        var_cas_ownership_vec.dotAssign_operation (var_cas_table) ;
        ::routine_doReplace (inLexique,  var_cas_tpl,  GGS_string ("$ALARM_COUNT$"),  operand_2736->mInfo.app.reader_alarms (inLexique COMMA_SOURCE_FILE_AT_LINE (287)).reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (287)) COMMA_SOURCE_FILE_AT_LINE (287)) ;
        ...
        var_cas_ownership_vec.dotAssign_operation (var_cas_table) ;
        ::routine_doReplace (inLexique,  var_cas_tpl,  GGS_string ("$REZ_COUNT$"),  operand_2736->mInfo.app.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (302)).reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (302)) COMMA_SOURCE_FILE_AT_LINE (302)) ;
        ...
        var_cas_ownership_vec.dotAssign_operation (var_cas_table) ;
        ::routine_doReplace (inLexique,  var_cas_tpl,  GGS_string ("$ST_COUNT$"),  operand_2736->mInfo.app.reader_schedtables (inLexique COMMA_SOURCE_FILE_AT_LINE (317)).reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (317)) COMMA_SOURCE_FILE_AT_LINE (317)) ;
        ...
        var_cas_ownership_vec.dotAssign_operation (var_cas_table) ;
        ::routine_doReplace (inLexique,  var_cas_tpl,  GGS_string ("$CNT_COUNT$"),  operand_2736->mInfo.app.reader_counters (inLexique COMMA_SOURCE_FILE_AT_LINE (332)).reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (332)) COMMA_SOURCE_FILE_AT_LINE (332)) ;
