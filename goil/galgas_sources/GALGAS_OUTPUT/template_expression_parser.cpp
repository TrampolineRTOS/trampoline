...
void routine_checkNotOperatorForTemplate (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_7298 = (var_cas_inOperandType).operator_isNotEqual (GGS_goilTemplateType::constructor_boolType (inLexique COMMA_HERE)) ;
...
void routine_checkBitComplementOperatorForTemplate (C_Compiler & inLexique,
  ...
  #endif
  var_cas_outResultType = var_cas_inOperandType ;
  const GGS_bool cond_8074 = (var_cas_inOperandType).operator_isNotEqual (GGS_goilTemplateType::constructor_unsignedType (inLexique COMMA_HERE)) ;
  if (cond_8074.isBuiltAndTrue ()) {
...
GGS_string function_argumentListSignature (C_Compiler & inLexique,
  ...
  {
    GGS_goilTemplateExpressionList::cEnumerator enumerator_17751 (var_cas_inParameterTypeList, true) ;
    const GGS_goilTemplateExpressionList::cElement * operand_17751 = enumerator_17751.nextObject () ;
    if ((operand_17751 != NULL)) {
      var_cas_outResult.appendCString (": ") ;
      bool _foreach_loop_17751 ;
      do{
        macroValidPointer (operand_17751) ;
        var_cas_outResult.dotAssign_operation (operand_17751->mType.reader_messageGoilTemplateType (inLexique COMMA_SOURCE_FILE_AT_LINE (432))) ;
        operand_17751 = enumerator_17751.nextObject () ;
        _foreach_loop_17751 = ((operand_17751 != NULL)) ;
        if (_foreach_loop_17751) {
          var_cas_outResult.appendCString (", ") ;
        }
      }while (_foreach_loop_17751) ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_checkInvocationHasNoArgument (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_18676 = (var_cas_inParameterTypeList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_18676.isBuiltAndTrue ()) {
...
void routine_templateMethodInvocation (C_Compiler & inLexique,
  ...
  case GGS_goilTemplateType::enum_boolType:
    {
    const GGS_bool cond_19699 = (var_cas_inMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (471))).operator_isEqual (GGS_string ("trueOrFalse")) ;
    if (cond_19699.isBuiltAndTrue ()) {
    ...
    }else if (cond_19699.isBuiltAndFalse ()) {
      const GGS_bool cond_20004 = (var_cas_inMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (477))).operator_isEqual (GGS_string ("yesOrNo")) ;
      if (cond_20004.isBuiltAndTrue ()) {
      ...
      }else if (cond_20004.isBuiltAndFalse ()) {
        const GGS_bool cond_20223 = (var_cas_inMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (483))).operator_isEqual (GGS_string ("unsigned")) ;
        if (cond_20223.isBuiltAndTrue ()) {
        ...
        }else if (cond_20223.isBuiltAndFalse ()) {
  ...
  case GGS_goilTemplateType::enum_unsignedType:
    {
    const GGS_bool cond_20624 = (var_cas_inMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (491))).operator_isEqual (GGS_string ("string")) ;
    if (cond_20624.isBuiltAndTrue ()) {
    ...
    }else if (cond_20624.isBuiltAndFalse ()) {
      const GGS_bool cond_20892 = (var_cas_inMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (495))).operator_isEqual (GGS_string ("hexString")) ;
      if (cond_20892.isBuiltAndTrue ()) {
      ...
      }else if (cond_20892.isBuiltAndFalse ()) {
  ...
  case GGS_goilTemplateType::enum_stringType:
    {
    const GGS_bool cond_21311 = (var_cas_inMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (503))).operator_isEqual (GGS_string ("HTMLRepresentation")) ;
    if (cond_21311.isBuiltAndTrue ()) {
    ...
    }else if (cond_21311.isBuiltAndFalse ()) {
      const GGS_bool cond_21606 = (var_cas_inMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (507))).operator_isEqual (GGS_string ("identifierRepresentation")) ;
      if (cond_21606.isBuiltAndTrue ()) {
      ...
      }else if (cond_21606.isBuiltAndFalse ()) {
        const GGS_bool cond_21883 = (var_cas_inMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (511))).operator_isEqual (GGS_string ("lowercaseString")) ;
        if (cond_21883.isBuiltAndTrue ()) {
        ...
        }else if (cond_21883.isBuiltAndFalse ()) {
          const GGS_bool cond_22155 = (var_cas_inMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (515))).operator_isEqual (GGS_string ("length")) ;
          if (cond_22155.isBuiltAndTrue ()) {
          ...
          }else if (cond_22155.isBuiltAndFalse ()) {
            const GGS_bool cond_22470 = (var_cas_inMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (519))).operator_isEqual (GGS_string ("stringByCapitalizingFirstCharacter")) ;
            if (cond_22470.isBuiltAndTrue ()) {
            ...
            }else if (cond_22470.isBuiltAndFalse ()) {
              const GGS_bool cond_22746 = (var_cas_inMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (523))).operator_isEqual (GGS_string ("uppercaseString")) ;
              if (cond_22746.isBuiltAndTrue ()) {
              ...
              }else if (cond_22746.isBuiltAndFalse ()) {
  ...
  case GGS_goilTemplateType::enum_listType:
    {
    const GGS_bool cond_23152 = (var_cas_inMethodName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (531))).operator_isEqual (GGS_string ("length")) ;
...
void routine_typeError (C_Compiler & inLexique,
  ...
  const GGS_bool cond_46469 = (var_cas_inActualType).operator_isEqual (GGS_type  (& kTypeDescriptor_GGS_bool)) ;
  if (cond_46469.isBuiltAndTrue ()) {
    var_cas_m.appendCString ("boolean") ;
  }else if (cond_46469.isBuiltAndFalse ()) {
    const GGS_bool cond_46528 = (var_cas_inActualType).operator_isEqual (GGS_type  (& kTypeDescriptor_GGS_uint64)) ;
    if (cond_46528.isBuiltAndTrue ()) {
      var_cas_m.appendCString ("unsigned") ;
    }else if (cond_46528.isBuiltAndFalse ()) {
      const GGS_bool cond_46584 = (var_cas_inActualType).operator_isEqual (GGS_type  (& kTypeDescriptor_GGS_string)) ;
      if (cond_46584.isBuiltAndTrue ()) {
        var_cas_m.appendCString ("string") ;
      }else if (cond_46584.isBuiltAndFalse ()) {
...
void template_expression_parser::rule_template_5F_expression_5F_parser_factor_i13_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  switch (select_template_5F_expression_5F_parser_7 (inLexique)) {
    case 1 : {
      const GGS_goilTemplateVariableMap  temp_47052 = var_cas_inVariableMap ;
      if (temp_47052.isBuilt ()) {
        temp_47052 (HERE)->method_searchKey (inLexique, var_cas_functionOrVariableName, var_cas_outResultType, var_cas_outValue COMMA_SOURCE_FILE_AT_LINE (1286)) ;
      }
      } break ;
    case 2 : {
      ...
      const GGS_goilTemplateVariableMap  temp_47211 = var_cas_inVariableMap ;
      if (temp_47211.isBuilt ()) {
        temp_47211 (HERE)->method_searchKey (inLexique, var_cas_functionOrVariableName, var_cas_varType, var_cas_varValue COMMA_SOURCE_FILE_AT_LINE (1291)) ;
      }
      const GGS_bool cond_47402 = (var_cas_varType).operator_isNotEqual (GGS_goilTemplateType::constructor_structType (inLexique COMMA_HERE)) ;
    ...
    case 3 : {
      ...
      const GGS_bool cond_47751 = (GGS_function::constructor_isFunctionDefined (var_cas_functionOrVariableName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1299)))).operator_not () ;
      if (cond_47751.isBuiltAndTrue ()) {
        ...
        var_cas_f.drop () ;
      }else if (cond_47751.isBuiltAndFalse ()) {
      ...
      const GGS_bool cond_48885 = (var_cas_formalParameterList.reader_length ()).operator_isNotEqual (var_cas_actualArgumentList.reader_length ()) ;
      if (cond_48885.isBuiltAndTrue ()) {
        ...
        var_cas_outResultType.drop () ;
      }else if (cond_48885.isBuiltAndFalse ()) {
        GGS_uint  var_cas_idx = GGS_uint (1U) ;
        {
          GGS_typelist::cEnumerator enumerator_48941 (var_cas_formalParameterList, true) ;
          const GGS_typelist::cElement * operand_48941 = NULL ;
          GGS_goilTemplateExpressionList::cEnumerator enumerator_48980 (var_cas_actualArgumentList, true) ;
          const GGS_goilTemplateExpressionList::cElement * operand_48980 = NULL ;
          while (((operand_48941 = enumerator_48941.nextObject ()))
              && ((operand_48980 = enumerator_48980.nextObject ()))) {
            macroValidPointer (operand_48941) ;
            macroValidPointer (operand_48980) ;
            switch (operand_48980->mType.enumValue ()) {
            case GGS_goilTemplateType::enum_boolType:
              {
              const GGS_bool cond_49188 = (operand_48941->mValue).operator_isNotEqual (GGS_type  (& kTypeDescriptor_GGS_bool)) ;
              if (cond_49188.isBuiltAndTrue ()) {
                ::routine_typeError (inLexique,  var_cas_functionOrVariableName,  operand_48941->mValue,  GGS_string ("boolean"),  var_cas_idx COMMA_SOURCE_FILE_AT_LINE (1340)) ;
              }
              var_cas_actualArgumentObjectList.addAssign_operation ((((operand_48980->mValue.reader_mUnsigned64Value (inLexique COMMA_SOURCE_FILE_AT_LINE (1342))).operator_isEqual (GGS_uint64 (0ULL))).isBuiltAndTrue () ? (GGS_bool (false)) : (GGS_bool (true))).reader_object ()) ;
              }
              break ;
            case GGS_goilTemplateType::enum_unsignedType:
              {
              const GGS_bool cond_49473 = (operand_48941->mValue).operator_isNotEqual (GGS_type  (& kTypeDescriptor_GGS_uint64)) ;
              if (cond_49473.isBuiltAndTrue ()) {
                ::routine_typeError (inLexique,  var_cas_functionOrVariableName,  operand_48941->mValue,  GGS_string ("unsigned"),  var_cas_idx COMMA_SOURCE_FILE_AT_LINE (1345)) ;
              }
              var_cas_actualArgumentObjectList.addAssign_operation (operand_48980->mValue.reader_mUnsigned64Value (inLexique COMMA_SOURCE_FILE_AT_LINE (1347)).reader_object ()) ;
              }
              break ;
            case GGS_goilTemplateType::enum_stringType:
              {
              const GGS_bool cond_49720 = (operand_48941->mValue).operator_isNotEqual (GGS_type  (& kTypeDescriptor_GGS_string)) ;
              if (cond_49720.isBuiltAndTrue ()) {
                ::routine_typeError (inLexique,  var_cas_functionOrVariableName,  operand_48941->mValue,  GGS_string ("string"),  var_cas_idx COMMA_SOURCE_FILE_AT_LINE (1350)) ;
              }
              var_cas_actualArgumentObjectList.addAssign_operation (operand_48980->mValue.reader_mStringValue (inLexique COMMA_SOURCE_FILE_AT_LINE (1352)).reader_object ()) ;
              }
              break ;
            case GGS_goilTemplateType::enum_listType:
            case GGS_goilTemplateType::enum_structType:
              {
              ::routine_typeError (inLexique,  var_cas_functionOrVariableName,  operand_48941->mValue,  GGS_string ("string"),  var_cas_idx COMMA_SOURCE_FILE_AT_LINE (1354)) ;
              }
              break ;
            case GGS_goilTemplateType::kNotBuilt:
              break ;
        ...
        const GGS_bool cond_51020 = (GGS_uint ::constructor_errorCount (inLexique COMMA_HERE)).operator_isEqual (GGS_uint (0U)) ;
        if (cond_51020.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_50447 = (var_cas_result.reader_objectDynamicType ()).operator_isEqual (GGS_type  (& kTypeDescriptor_GGS_uint64)) ;
          if (cond_50447.isBuiltAndTrue ()) {
            var_cas_outResultType = GGS_goilTemplateType::constructor_unsignedType (inLexique COMMA_HERE) ;
          ...
          }else if (cond_50447.isBuiltAndFalse ()) {
            const GGS_bool cond_50669 = (var_cas_result.reader_objectDynamicType ()).operator_isEqual (GGS_type  (& kTypeDescriptor_GGS_bool)) ;
            if (cond_50669.isBuiltAndTrue ()) {
              var_cas_outResultType = GGS_goilTemplateType::constructor_boolType (inLexique COMMA_HERE) ;
            ...
            }else if (cond_50669.isBuiltAndFalse ()) {
              const GGS_bool cond_50883 = (var_cas_result.reader_objectDynamicType ()).operator_isEqual (GGS_type  (& kTypeDescriptor_GGS_string)) ;
              if (cond_50883.isBuiltAndTrue ()) {
                var_cas_outResultType = GGS_goilTemplateType::constructor_stringType (inLexique COMMA_HERE) ;
              ...
              }else if (cond_50883.isBuiltAndFalse ()) {
...
void template_expression_parser::rule_template_5F_expression_5F_parser_factor_i14_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  switch (select_template_5F_expression_5F_parser_9 (inLexique)) {
    case 1 : {
      ...
      nt_expression_ (inLexique, var_cas_inPrefix, var_cas_inPath, var_cas_inTemplateDirectory, var_cas_inVariableMap, var_cas_expression, var_cas_resultType) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_template_5F_scanner::kToken__29_) COMMA_HERE) ;
      const GGS_bool cond_51774 = var_cas_inVariableMap.reader_hasKey (var_cas_variableName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1404))) ;
      if (cond_51774.isBuiltAndTrue ()) {
        const GGS_goilTemplateVariableMap  temp_51726 = var_cas_inVariableMap ;
        if (temp_51726.isBuilt ()) {
          temp_51726 (HERE)->method_searchKey (inLexique, var_cas_variableName, var_cas_resultType, var_cas_expression COMMA_SOURCE_FILE_AT_LINE (1405)) ;
        }
      }
    ...
    case 2 : {
      const GGS_bool cond_51953 = var_cas_inVariableMap.reader_hasKey (var_cas_variableName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1410))) ;
      ...
      }else if (cond_51953.isBuiltAndFalse ()) {
...
void template_expression_parser::rule_template_5F_expression_5F_parser_factor_i16_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  var_cas_outValue = GGS_goilTemplateValue::constructor_new (GGS_uint64 (0ULL), GGS_string (""), GGS_goilTemplateFieldMapList ::constructor_emptyList (), GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_HERE)) ;
...
void template_expression_parser::rule_template_5F_expression_5F_parser_struct_5F_member_i17_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  const GGS_goilTemplateFieldMap  temp_53504 = var_cas_inValue ;
  if (temp_53504.isBuilt ()) {
    temp_53504 (HERE)->method_searchKey (inLexique, var_cas_memberName, var_cas_memberType, var_cas_memberInt, var_cas_memberString, var_cas_memberList, var_cas_memberStruct COMMA_SOURCE_FILE_AT_LINE (1467)) ;
  }
  switch (select_template_5F_expression_5F_parser_11 (inLexique)) {
    case 1 : {
      const GGS_bool cond_53717 = (var_cas_memberType).operator_isNotEqual (GGS_goilTemplateType::constructor_structType (inLexique COMMA_HERE)) ;
      if (cond_53717.isBuiltAndTrue ()) {
