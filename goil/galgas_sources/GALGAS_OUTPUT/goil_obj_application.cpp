...
pr_appli_goil_obj_application_43_12_ (goil_lexique & inLexique,
  ...
  const GGS_bool cond_1080 = (gOption_goil_5F_options_autosar_5F_on.value ()).operator_isEqual (GGS_bool (false)) ;
  if (cond_1080.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_1192 = var_cas_applis.reader_hasKey (inLexique, var_cas_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (57)) COMMA_SOURCE_FILE_AT_LINE (57)) ;
  if (cond_1192.isBuiltAndTrue ()) {
    var_cas_applis.modifier_del (inLexique, var_cas_name, var_cas_app COMMA_SOURCE_FILE_AT_LINE (58)) ;
  }else if (cond_1192.isBuiltAndFalse ()) {
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_goil_obj_application_0 (inLexique)) {
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          { const GGS_app_trusted_obj _var_3280 = var_cas_trusted ; // CAST instruction
            if (_var_3280.getPtr () != NULL) {
              macroValidPointer (_var_3280.getPtr ()) ;
              if (typeid (cPtr_app_trusted_void) == typeid (* (_var_3280.getPtr ()))) {
        ...
        case 3 : {
          ...
          { const GGS_basic_type _var_3752 = var_cas_startuphook ; // CAST instruction
            if (_var_3752.getPtr () != NULL) {
              macroValidPointer (_var_3752.getPtr ()) ;
              if (typeid (cPtr_void) == typeid (* (_var_3752.getPtr ()))) {
        ...
        case 4 : {
          ...
          { const GGS_basic_type _var_4261 = var_cas_shutdownhook ; // CAST instruction
            if (_var_4261.getPtr () != NULL) {
              macroValidPointer (_var_4261.getPtr ()) ;
              if (typeid (cPtr_void) == typeid (* (_var_4261.getPtr ()))) {
        ...
        case 5 : {
          ...
          { const GGS_basic_type _var_4756 = var_cas_errorhook ; // CAST instruction
            if (_var_4756.getPtr () != NULL) {
              macroValidPointer (_var_4756.getPtr ()) ;
              if (typeid (cPtr_void) == typeid (* (_var_4756.getPtr ()))) {
        ...
        case 6 : {
          ...
          { const GGS_basic_type _var_5413 = var_cas_restart ; // CAST instruction
            if (_var_5413.getPtr () != NULL) {
              macroValidPointer (_var_5413.getPtr ()) ;
              if (typeid (cPtr_void) == typeid (* (_var_5413.getPtr ()))) {
        ...
        while (syntaxRepeat_7) {
          switch (select_repeat_goil_obj_application_7 (inLexique)) {
            case 2 : {
              ...
              const GGS_bool cond_7948 = var_cas_tfok ;
