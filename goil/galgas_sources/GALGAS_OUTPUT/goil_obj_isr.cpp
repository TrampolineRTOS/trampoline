    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_goil_obj_isr_0 (_inLexique)) {
          ...
          { const GGS_basic_type _var_3503 = var_cas_category ; // CAST instruction
            if (_var_3503.getPtr () != NULL) {
              ...
              if (typeid (cPtr_uint64_class) == typeid (* (_var_3503.getPtr ()))) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("ISR category attribute already defined for this ISR") COMMA_SOURCE_FILE_AT_LINE (119)) ;
                var_cas_category.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (119)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (120)) ;
              }else{
                if ((((var_cas_cat.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (121)))._operator_isNotEqual (GGS_uint64 (1U)))._operator_and ((var_cas_cat.reader_uint64 (_inLexique COMMA_SOURCE_FILE_AT_LINE (121)))._operator_isNotEqual (GGS_uint64 (2U)))).isBuiltAndTrue ()) {
                  GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("ISR category should be 1 ou 2") COMMA_SOURCE_FILE_AT_LINE (123)) ;
                }
          ...
          { const GGS_basic_type _var_3860 = var_cas_priority ; // CAST instruction
            if (_var_3860.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void) == typeid (* (_var_3860.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("PRIORITY already defined for this ISR") COMMA_SOURCE_FILE_AT_LINE (134)) ;
                var_cas_priority.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (134)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was previouly defined here") COMMA_SOURCE_FILE_AT_LINE (135)) ;
              }
            }
          }
          } break ;
        case 4 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_add_lstring_unique (_inLexique,  var_cas_resources,  var_cas_rez,  GGS_string ("RESOURCE") COMMA_SOURCE_FILE_AT_LINE (139)) ;
          } break ;
        case 5 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_add_lstring_unique (_inLexique,  var_cas_messages,  var_cas_mess,  GGS_string ("MESSAGE") COMMA_SOURCE_FILE_AT_LINE (143)) ;
          } break ;
        case 6 : {
          if (((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (145))))._operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("AUTOSAR flag is off, turn it on to use TIMINGPROTECTION attribute in ISR object") COMMA_SOURCE_FILE_AT_LINE (147)) ;
          }
              ...
              { const GGS_basic_type _var_4906 = var_cas_count_limit ; // CAST instruction
                if (_var_4906.getPtr () != NULL) {
                  ...
                  if (typeid (cPtr_void) == typeid (* (_var_4906.getPtr ()))) {
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("COUNTLIMIT not declared") COMMA_SOURCE_FILE_AT_LINE (164)) ;
                  }else{
                  }
                }
              }
              { const GGS_basic_type _var_5017 = var_cas_exe_time ; // CAST instruction
                if (_var_5017.getPtr () != NULL) {
                  ...
                  if (typeid (cPtr_void) == typeid (* (_var_5017.getPtr ()))) {
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("EXECUTIONTIME not declared") COMMA_SOURCE_FILE_AT_LINE (167)) ;
                  }else{
                  }
                }
              }
              { const GGS_basic_type _var_5191 = var_cas_exe_budget ; // CAST instruction
                if (_var_5191.getPtr () != NULL) {
                  ...
                  if (typeid (cPtr_uint64_class) == typeid (* (_var_5191.getPtr ()))) {
                    ...
                    var_cas_eb.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (170)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("EXECUTIONBUDGET is not an attribute of isr timing protection") COMMA_SOURCE_FILE_AT_LINE (171)) ;
                  }else{
                  }
                }
              }
        ...
        case 7 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_add_lstring_unique (_inLexique,  var_cas_acc_apps,  var_cas_app,  GGS_string ("ACCESSING_APPLICATION") COMMA_SOURCE_FILE_AT_LINE (187)) ;
          } break ;
        case 8 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
          var_cas_other_fields.modifier_put (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("SOURCE"), GGS_location (_inLexique) COMMA_HERE), GGS_string_class ::constructor_new (_inLexique, var_cas_src.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (191)), var_cas_src.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (191)) COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (191)) ;
