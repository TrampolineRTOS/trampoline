...
class GGS_number_set {
  ...
  public : inline bool isEqualTo (const GGS_number_set & operand_) const {
    return mPointer == operand_.mPointer ;
  }
  public : void operator = (cPtr_number_set * inSource) ;
  public : GGS_number_set (cPtr_number_set * inSource) ;
  ...
  #else
    public : inline cPtr_number_set * operator () (LOCATION_ARGS) const { return mPointer ; }
  #endif
} ;
...
class GGS_uint_range {
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : static cPtr_uint_range * constructor_new (C_Lexique & inLexique,
                                const GGS_luint & argument_0,
                                const GGS_luint & argument_1 COMMA_LOCATION_ARGS) ;
  #else
    public : inline static cPtr_uint_range * constructor_new (C_Lexique & /* inLexique */,
                                const GGS_luint & argument_0,
                                const GGS_luint & argument_1 COMMA_LOCATION_ARGS) {
      return new cPtr_uint_range(argument_0,
...
class GGS_uint_list {
  #ifndef DO_NOT_GENERATE_CHECKINGS
    public : static cPtr_uint_list * constructor_new (C_Lexique & inLexique,
                                const GGS_number_list & argument_0 COMMA_LOCATION_ARGS) ;
  #else
    public : inline static cPtr_uint_list * constructor_new (C_Lexique & /* inLexique */,
                                const GGS_number_list & argument_0 COMMA_LOCATION_ARGS) {
      return new cPtr_uint_list(argument_0 COMMA_THERE) ;
    }
  #endif
} ;
