...
void goil_obj_appmode::rule_goil_5F_obj_5F_appmode_appmode_i0_ (C_Lexique_goil_5F_lexique & inLexique) {
  GGS_ident_map  var_cas_others = GGS_ident_map ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (42)) ;
    ...
    while (syntaxRepeat_0) {
      switch (select_goil_5F_obj_5F_appmode_0 (inLexique)) {
        case 2 : {
          ...
          GGS_lstring  automatic_var_932_0 ;
          nt_description_ (inLexique, automatic_var_932_0) ;
  ...
  GGS_lstring  automatic_var_988_0 ;
  nt_description_ (inLexique, automatic_var_988_0) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
}
