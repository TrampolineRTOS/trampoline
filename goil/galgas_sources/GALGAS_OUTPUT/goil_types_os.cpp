...
method_generate_c (C_Compiler & _inLexique,
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  var_cas_res = ((GGS_string ("#define    TRACE_FILE             \""))._operator_concat (name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (43))))._operator_concat (GGS_string ("\"\n")) ;
}
...
method_generate_c (C_Compiler & _inLexique,
  ...
  var_cas_res._dotAssign_operation (function_bool_class_define (_inLexique, GGS_string ("TRACE_TASK"), trace_task, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (77))) ;
  var_cas_res._dotAssign_operation (function_bool_class_define (_inLexique, GGS_string ("TRACE_ISR"), trace_isr, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (78))) ;
  var_cas_res._dotAssign_operation (function_bool_class_define (_inLexique, GGS_string ("TRACE_RES"), trace_resource, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (79))) ;
  var_cas_res._dotAssign_operation (function_bool_class_define (_inLexique, GGS_string ("TRACE_ALARM"), trace_alarm, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (80))) ;
  var_cas_res._dotAssign_operation (function_bool_class_define (_inLexique, GGS_string ("TRACE_U_EVENT"), trace_user_event, GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (81))) ;
  var_cas_res.appendCString ("#define    TRACE_FORMAT()         tpl_trace_format_") ;
  var_cas_res._dotAssign_operation (form.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (82))) ;
  var_cas_res.appendCString ("();\n") ;
  GGS_string var_cas_m ;
  const GGS_trace_method  _temp_2195 = meth ;
  if (_temp_2195.isBuilt ()) {
    _temp_2195 (HERE)->method_generate_c (_inLexique, var_cas_m COMMA_SOURCE_FILE_AT_LINE (84)) ;
  }
...
void routine_set_method (C_Compiler & _inLexique,
  ...
  #endif
  { const GGS_trace_method _var_3484 = var_cas_t ; // CAST instruction
    if (_var_3484.getPtr () != NULL) {
      macroValidPointer (_var_3484.getPtr ()) ;
      if (typeid (cPtr_trace_void) == typeid (* (_var_3484.getPtr ()))) {
        var_cas_t = var_cas_s ;
      }else{
        var_cas_s.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (135)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string ("Redefinition of "))._operator_concat (var_cas_att) COMMA_SOURCE_FILE_AT_LINE (136)) ;
        var_cas_t.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (136)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (137)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
