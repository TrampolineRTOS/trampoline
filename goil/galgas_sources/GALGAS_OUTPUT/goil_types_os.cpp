...
GGS_string function_compiler (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_6582 = var_cas_os_memmap ; // CAST instruction
    if (_var_6582.getPtr () != NULL) {
      macroValidPointer (_var_6582.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6582.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_6582.getPtr ()) ;
        var_cas_cc = var_cas_s.reader_compiler (inLexique COMMA_SOURCE_FILE_AT_LINE (257)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (257)) ;
        var_cas_cc = (GGS_string ("compiler/")).operator_concat (var_cas_cc) ;
        GGS_string var_cas_rtd = function_root_templates_directory (inLexique COMMA_SOURCE_FILE_AT_LINE (259)) ;
        const GGS_bool cond_6531 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
        if (cond_6531.isBuiltAndTrue ()) {
          GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_cc) ;
          const GGS_bool cond_6518 = (var_cas_path.reader_directoryExists ()).operator_not () ;
          if (cond_6518.isBuiltAndTrue ()) {
            GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, (GGS_string ("no compiler found at path: ")).operator_concat (var_cas_path) COMMA_SOURCE_FILE_AT_LINE (263)) ;
            var_cas_cc = GGS_string ("") ;
          }
        }else if (cond_6531.isBuiltAndFalse ()) {
          var_cas_cc = GGS_string ("") ;
        }
      }else{
        var_cas_cc = GGS_string ("") ;
...
GGS_string function_linker (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_6982 = var_cas_os_memmap ; // CAST instruction
    if (_var_6982.getPtr () != NULL) {
      macroValidPointer (_var_6982.getPtr ()) ;
      if (typeid (cPtr_memmap_true) == typeid (* (_var_6982.getPtr ()))) {
        const GGS_memmap_true var_cas_s (_var_6982.getPtr ()) ;
        { const GGS_basic_type _var_6953 = var_cas_s.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (283)) ; // CAST instruction
          if (_var_6953.getPtr () != NULL) {
            macroValidPointer (_var_6953.getPtr ()) ;
            if (typeid (cPtr_no_linker) == typeid (* (_var_6953.getPtr ()))) {
              var_cas_lk = GGS_string ("") ;
            }else if (typeid (cPtr_yes_linker) == typeid (* (_var_6953.getPtr ()))) {
              const GGS_yes_linker var_cas_l (_var_6953.getPtr ()) ;
  ...
  const GGS_bool cond_7250 = (var_cas_lk).operator_isNotEqual (GGS_string ("")) ;
  if (cond_7250.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_7216 = (var_cas_rtd).operator_isNotEqual (GGS_string ("")) ;
    if (cond_7216.isBuiltAndTrue ()) {
      GGS_string var_cas_path = ((var_cas_rtd).operator_concat (GGS_string ("/"))).operator_concat (var_cas_lk) ;
      const GGS_bool cond_7203 = (var_cas_path.reader_directoryExists ()).operator_not () ;
      if (cond_7203.isBuiltAndTrue ()) {
        var_cas_lk = GGS_string ("") ;
      }
    }else if (cond_7216.isBuiltAndFalse ()) {
      var_cas_lk = GGS_string ("") ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
