...
method_generate_c (C_Compiler & _inLexique,
  ...
  var_cas_res._dotAssign_operation (function_bool_class_define (_inLexique, GGS_string (true, "TRACE_TASK"), trace_task, GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (77))) ;
  var_cas_res._dotAssign_operation (function_bool_class_define (_inLexique, GGS_string (true, "TRACE_ISR"), trace_isr, GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (78))) ;
  var_cas_res._dotAssign_operation (function_bool_class_define (_inLexique, GGS_string (true, "TRACE_RES"), trace_resource, GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (79))) ;
  var_cas_res._dotAssign_operation (function_bool_class_define (_inLexique, GGS_string (true, "TRACE_ALARM"), trace_alarm, GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (80))) ;
  var_cas_res._dotAssign_operation (function_bool_class_define (_inLexique, GGS_string (true, "TRACE_U_EVENT"), trace_user_event, GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (81))) ;
  ...
  { const GGS_trace_method _var_3538 = var_cas_t ; // CAST instruction
    if (_var_3538.getPtr () != NULL) {
      ...
      if (typeid (cPtr_trace_void) == typeid (* (_var_3538.getPtr ()))) {
        ...
        var_cas_s.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (135)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (GGS_string (true, "Redefinition of "))._operator_concat (var_cas_att) COMMA_SOURCE_FILE_AT_LINE (136)) ;
        var_cas_t.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (136)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "was defined here") COMMA_SOURCE_FILE_AT_LINE (137)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
