  ...
  while ((token.mTokenCode < 0) && (UNICODE_VALUE (mCurrentChar) != '\0')) {
    ...
    try{
      if (testForInputUTF32String (kUnicodeString__2F__2F_, 2, true)) {
        ...
        do {
          ::scanner_action_enterCharacterIntoString (*this, token.keyword, previousChar ()) ;
        ...
        do {
          if (testForInputUTF32CharRange (TO_UNICODE (' '), TO_UNICODE ('!')) ||
            ...
            ::scanner_action_enterCharacterIntoString (*this, token.string, previousChar ()) ;
          }else{
            loop = false ;
          }
        }while (loop) ;
        ...
        do {
          ...
          ::scanner_action_enterDigitIntoUInt64 (*this, previousChar (), token.integer, gErrorMessage_2, gErrorMessage_3) ;
