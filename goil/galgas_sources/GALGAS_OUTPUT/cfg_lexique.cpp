...
static const C_unicode_lexique_table_entry ktable_for_cfg_delimiters [ktable_size_cfg_delimiters] = {
  C_unicode_lexique_table_entry (kUnicodeString__3B_, 1, cfg_lexique::cfg_lexique_1__3B_),
  C_unicode_lexique_table_entry (kUnicodeString__3D_, 1, cfg_lexique::cfg_lexique_1__3D_),
  C_unicode_lexique_table_entry (kUnicodeString__5B_, 1, cfg_lexique::cfg_lexique_1__5B_),
  C_unicode_lexique_table_entry (kUnicodeString__5D_, 1, cfg_lexique::cfg_lexique_1__5D_),
  C_unicode_lexique_table_entry (kUnicodeString__7B_, 1, cfg_lexique::cfg_lexique_1__7B_),
  C_unicode_lexique_table_entry (kUnicodeString__7D_, 1, cfg_lexique::cfg_lexique_1__7D_)
} ;
...
static const C_unicode_lexique_table_entry ktable_for_cfg_keywords [ktable_size_cfg_keywords] = {
  C_unicode_lexique_table_entry (kUnicodeString_isr, 3, cfg_lexique::cfg_lexique_1_isr),
  C_unicode_lexique_table_entry (kUnicodeString_task, 4, cfg_lexique::cfg_lexique_1_task),
  C_unicode_lexique_table_entry (kUnicodeString_isr_5F_code, 8, cfg_lexique::cfg_lexique_1_isr_5F_code),
  C_unicode_lexique_table_entry (kUnicodeString_interrupts, 10, cfg_lexique::cfg_lexique_1_interrupts),
  C_unicode_lexique_table_entry (kUnicodeString_counter_5F_code, 12, cfg_lexique::cfg_lexique_1_counter_5F_code),
  C_unicode_lexique_table_entry (kUnicodeString_stack_5F_alignment, 15, cfg_lexique::cfg_lexique_1_stack_5F_alignment),
  C_unicode_lexique_table_entry (kUnicodeString_tp_5F_ns_5F_per_5F_counter_5F_tick, 22, cfg_lexique::cfg_lexique_1_tp_5F_ns_5F_per_5F_counter_5F_tick)
} ;
...
static const C_unicode_lexique_table_entry ktable_for_cfg_type [ktable_size_cfg_type] = {
  C_unicode_lexique_table_entry (kUnicodeString_sint_38_, 5, cfg_lexique::cfg_lexique_1_sint_38_),
  C_unicode_lexique_table_entry (kUnicodeString_uint_38_, 5, cfg_lexique::cfg_lexique_1_uint_38_),
  C_unicode_lexique_table_entry (kUnicodeString_sint_31__36_, 6, cfg_lexique::cfg_lexique_1_sint_31__36_),
  C_unicode_lexique_table_entry (kUnicodeString_sint_33__32_, 6, cfg_lexique::cfg_lexique_1_sint_33__32_),
  C_unicode_lexique_table_entry (kUnicodeString_sint_36__34_, 6, cfg_lexique::cfg_lexique_1_sint_36__34_),
  C_unicode_lexique_table_entry (kUnicodeString_uint_31__36_, 6, cfg_lexique::cfg_lexique_1_uint_31__36_),
  C_unicode_lexique_table_entry (kUnicodeString_uint_33__32_, 6, cfg_lexique::cfg_lexique_1_uint_33__32_),
  C_unicode_lexique_table_entry (kUnicodeString_uint_36__34_, 6, cfg_lexique::cfg_lexique_1_uint_36__34_)
} ;
...
getCurrentTokenString (const cToken * inTokenPtr) const {
  ...
  if (ptr == NULL) {
    ...
    case cfg_lexique_1__7D_:
      ...
      s.appendCString("$ ") ;
      break ;
    case cfg_lexique_1__5B_:
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      s.appendCString ("[") ;
      s.appendCString("$ ") ;
      break ;
    case cfg_lexique_1__5D_:
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      s.appendCString ("]") ;
      s.appendCString("$ ") ;
      break ;
  ...
  while ((token.mTokenCode < 0) && (UNICODE_VALUE (mCurrentChar) != '\0')) {
    ...
    try{
      if (testForInputUTF32String (kUnicodeString__2F__2F_, 2, true)) {
        ...
        token.mTokenCode = cfg_lexique_1__5D_ ;
        enterToken (token) ;
      }else if (testForInputUTF32String (kUnicodeString__5B_, 1, true)) {
        token.mTokenCode = cfg_lexique_1__5B_ ;
        enterToken (token) ;
