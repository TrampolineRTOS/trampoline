...
GGS_string function_goil_template (C_Compiler & inLexique,
  ...
  ::routine_goilTemplateInvocation (inLexique,  GGS_lstring ::constructor_new (inLexique, var_cas_name, GGS_location (inLexique) COMMA_HERE),  var_cas_prefix,  GGS_string ("templates"),  function_emptySystemConfig (inLexique COMMA_SOURCE_FILE_AT_LINE (15)),  var_cas_cfg,  var_cas_result COMMA_SOURCE_FILE_AT_LINE (11)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_string function_computeTemplate (C_Compiler & inLexique,
  ...
  GGS_string var_cas_result ;
  var_cas_result = GGS_string ("") ;
  ::routine_goilTemplateInvocation (inLexique,  GGS_lstring ::constructor_new (inLexique, var_cas_name, GGS_location (inLexique) COMMA_HERE),  var_cas_prefix,  GGS_string ("templates"),  function_emptySystemConfig (inLexique COMMA_SOURCE_FILE_AT_LINE (31)),  var_cas_cfg,  var_cas_result COMMA_SOURCE_FILE_AT_LINE (27)) ;
  #ifdef DEBUG_TRACE_ENABLED
