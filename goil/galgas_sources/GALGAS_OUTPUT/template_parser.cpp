...
void template_parser::rule_template_5F_parser_template_5F_instruction_i0_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  case GGS_goilTemplateType::enum_boolType:
    {
    const GGS_bool cond_3349 = (var_cas_expression.reader_mUnsigned64Value (inLexique COMMA_SOURCE_FILE_AT_LINE (96))).operator_isEqual (GGS_uint64 (0ULL)) ;
    if (cond_3349.isBuiltAndTrue ()) {
      var_cas_ioResultingString.appendCString ("false") ;
    }else if (cond_3349.isBuiltAndFalse ()) {
...
void template_parser::rule_template_5F_parser_template_5F_instruction_i1_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  const GGS_bool cond_4294 = var_cas_templateVariableMap.reader_hasKey (GGS_string ("FILENAME")) ;
  if (cond_4294.isBuiltAndTrue ()) {
    GGS_goilTemplateType automatic_var_4287_0 ;
    GGS_goilTemplateValue automatic_var_4287_1 ;
    var_cas_templateVariableMap.modifier_removeKey (inLexique, function_lstringWith (inLexique, GGS_string ("FILENAME") COMMA_SOURCE_FILE_AT_LINE (131)), automatic_var_4287_0, automatic_var_4287_1 COMMA_SOURCE_FILE_AT_LINE (131)) ;
  }
  const GGS_bool cond_4426 = var_cas_templateVariableMap.reader_hasKey (GGS_string ("FILEPATH")) ;
  if (cond_4426.isBuiltAndTrue ()) {
    GGS_goilTemplateType automatic_var_4419_0 ;
    GGS_goilTemplateValue automatic_var_4419_1 ;
    var_cas_templateVariableMap.modifier_removeKey (inLexique, function_lstringWith (inLexique, GGS_string ("FILEPATH") COMMA_SOURCE_FILE_AT_LINE (134)), automatic_var_4419_0, automatic_var_4419_1 COMMA_SOURCE_FILE_AT_LINE (134)) ;
  }
  ...
  const GGS_bool cond_5009 = (var_cas_expressionType).operator_isNotEqual (GGS_goilTemplateType::constructor_stringType (inLexique COMMA_SOURCE_FILE_AT_LINE (141))) ;
  if (cond_5009.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_5320 = (var_cas_fileNameOk).operator_and ((GGS_uint ::constructor_errorCount (inLexique COMMA_SOURCE_FILE_AT_LINE (154))).operator_isEqual (GGS_uint (0U))) ;
  if (cond_5320.isBuiltAndTrue ()) {
    const GGS_string temp_5285 = var_cas_writeBlockResult ;
    if (temp_5285.isBuilt ()) {
      temp_5285 (HERE)->method_makeDirectoryAndWriteToFile (inLexique, var_cas_expression.reader_mStringValue (inLexique COMMA_SOURCE_FILE_AT_LINE (155)) COMMA_SOURCE_FILE_AT_LINE (155)) ;
    }
  }
...
void template_parser::rule_template_5F_parser_template_5F_instruction_i2_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  switch (select_template_5F_parser_0 (inLexique)) {
      ...
      switch (select_template_5F_parser_2 (inLexique)) {
        case 1 : {
          ...
          if (((var_cas_found).operator_not ()).isBuiltAndTrue ()) {
            GGS_goilTemplateVariableMap  var_cas_templateVariableMap = GGS_goilTemplateVariableMap ::constructor_mapWithMapToOverride (inLexique, var_cas_ioTemplateVariableMap COMMA_SOURCE_FILE_AT_LINE (194)) ;
    ...
    case 2 : {
      ...
      GGS_bool automatic_var_7021_0 ;
      ::routine_goilTemplateInvocation (inLexique,  var_cas_templateName,  var_cas_nextPrefix,  var_cas_inPath,  var_cas_inTemplateDirectory,  GGS_bool (true),  var_cas_ioTemplateVariableMap,  var_cas_ioResultingString,  automatic_var_7021_0 COMMA_SOURCE_FILE_AT_LINE (216)) ;
      } break ;
    default :
      break ;
  }
...
void template_parser::rule_template_5F_parser_template_5F_instruction_i3_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  GGS_uint _variant_7714 = var_cas_ioResultingString.reader_length () ;
  GGS_bool _condition_7714 (_variant_7714.isBuilt (), true) ;
  while (_condition_7714.isBuiltAndTrue ()) {
    _condition_7714 = ((var_cas_idx).operator_strictSup (GGS_uint (0U))).operator_and (var_cas_searchEndOfLine) ;
    if (_condition_7714.isBuiltAndTrue ()) {
      if (_variant_7714.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (251)) ;
        _condition_7714 = GGS_bool (false) ;
      }else{
        _variant_7714.decrement_operation (inLexique COMMA_HERE) ;
        ...
        const GGS_bool cond_7704 = var_cas_searchEndOfLine ;
  ...
  var_cas_ioTemplateVariableMap.modifier_insertKey (inLexique, var_cas_columnConstantName, GGS_goilTemplateType::constructor_stringType (inLexique COMMA_SOURCE_FILE_AT_LINE (254)), function_valueWithString (inLexique, var_cas_value COMMA_SOURCE_FILE_AT_LINE (255)) COMMA_SOURCE_FILE_AT_LINE (252)) ;
}
...
void template_parser::rule_template_5F_parser_template_5F_instruction_i4_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  { bool syntaxRepeat_4 = true ;
    while (syntaxRepeat_4) {
        if (((var_cas_currentCondition).operator_not ()).isBuiltAndTrue ()) {
          ...
          GGS_goilTemplateType var_cas_expressionType ;
          nt_expression_ (inLexique, var_cas_inPrefix, var_cas_inPath, var_cas_inTemplateDirectory, var_cas_ioTemplateVariableMap, var_cas_expression, var_cas_expressionType) ;
          const GGS_bool cond_9905 = (var_cas_expressionType).operator_isNotEqual (GGS_goilTemplateType::constructor_boolType (inLexique COMMA_SOURCE_FILE_AT_LINE (329))) ;
          if (cond_9905.isBuiltAndTrue ()) {
          ...
          if ((var_cas_currentCondition).isBuiltAndTrue ()) {
            GGS_goilTemplateVariableMap  var_cas_templateVariableMap = GGS_goilTemplateVariableMap ::constructor_mapWithMapToOverride (inLexique, var_cas_ioTemplateVariableMap COMMA_SOURCE_FILE_AT_LINE (336)) ;
  ...
  switch (select_template_5F_parser_5 (inLexique)) {
    ...
    case 2 : {
      ...
      if (((var_cas_currentCondition).operator_not ()).isBuiltAndTrue ()) {
        GGS_goilTemplateVariableMap  var_cas_templateVariableMap = GGS_goilTemplateVariableMap ::constructor_mapWithMapToOverride (inLexique, var_cas_ioTemplateVariableMap COMMA_SOURCE_FILE_AT_LINE (362)) ;
        nt_template_5F_instruction_5F_list_ (inLexique, var_cas_inPrefix, var_cas_inPath, var_cas_inTemplateDirectory, var_cas_templateVariableMap, var_cas_ioResultingString) ;
...
void template_parser::rule_template_5F_parser_template_5F_instruction_5F_list_i5_ (C_Lexique_template_5F_scanner & inLexique,
                                ...
                                GGS_goilTemplateVariableMap  &var_cas_ioTemplateVariableMap,
                                GGS_string &var_cas_ioResultingString) {
  var_cas_ioResultingString.dotAssign_operation (GGS_lstring ::constructor_retrieveAndResetTemplateString (inLexique COMMA_SOURCE_FILE_AT_LINE (389)).ggs_string ()) ;
    ...
    while (syntaxRepeat_6) {
      switch (select_template_5F_parser_6 (inLexique)) {
        case 2 : {
          ...
          var_cas_ioResultingString.dotAssign_operation (GGS_lstring ::constructor_retrieveAndResetTemplateString (inLexique COMMA_SOURCE_FILE_AT_LINE (399)).ggs_string ()) ;
          } break ;
        default :
...
void template_parser::rule_template_5F_parser_template_5F_instruction_5F_list_i5_parseAndResetTemplateString (C_Lexique_template_5F_scanner & inLexique) {
  ...
  GGS_lstring  var_cas_s = GGS_lstring ::constructor_retrieveAndResetTemplateString (inLexique COMMA_SOURCE_FILE_AT_LINE (407)) ;
}
...
void template_parser::rule_template_5F_parser_template_5F_instruction_i7_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  GGS_uint  var_cas_shortestListLentgh = GGS_uint ::constructor_max (inLexique COMMA_SOURCE_FILE_AT_LINE (438)) ;
  ...
  { bool syntaxRepeat_7 = true ;
    while (syntaxRepeat_7) {
        ...
        const GGS_bool cond_13112 = (var_cas_expressionType).operator_isNotEqual (GGS_goilTemplateType::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (453))) ;
        if (cond_13112.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_13258 = (var_cas_shortestListLentgh).operator_strictSup (var_cas_enumeratedValue.reader_mMapListValue (inLexique COMMA_SOURCE_FILE_AT_LINE (455)).reader_length ()) ;
  ...
  GGS_uint _variant_15593 = var_cas_shortestListLentgh ;
  const C_parsingContext context_15593 = inLexique.parsingContext () ;
  nt_template_5F_instruction_5F_list_parse (inLexique) ;
  ...
  GGS_bool _condition_15593 ;
  if (_variant_15593.isBuilt ()) {
    _condition_15593 = (var_cas_idx).operator_strictInf (var_cas_shortestListLentgh) ;
  }
  while (_condition_15593.isBuiltAndTrue ()) {
    inLexique.setParsingContext (context_15593) ;
    if (_variant_15593.uintValue () == 0) {
      inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (538)) ;
      _condition_15593 = GGS_bool (false) ;
    }else{
      _variant_15593.decrement_operation (inLexique COMMA_HERE) ;
      GGS_goilTemplateVariableMap  var_cas_templateVariableMap = GGS_goilTemplateVariableMap ::constructor_mapWithMapToOverride (inLexique, var_cas_ioTemplateVariableMap COMMA_SOURCE_FILE_AT_LINE (492)) ;
      {
        GGS_goilTemplateEnumationList::cEnumerator enumerator_14135 (var_cas_enumerationList, true) ;
        const GGS_goilTemplateEnumationList::cElement * operand_14135 = NULL ;
        while (((operand_14135 = enumerator_14135.nextObject ()))) {
          macroValidPointer (operand_14135) ;
          const GGS_goilTemplateFieldMap  var_cas_fieldMap = operand_14135->mEnumeratedValue.reader_mMapListValue (inLexique COMMA_SOURCE_FILE_AT_LINE (494)).reader_mMapAtIndex (inLexique, var_cas_idx COMMA_SOURCE_FILE_AT_LINE (494)) ;
          {
            GGS_goilTemplateFieldMap::cEnumerator enumerator_14260 (var_cas_fieldMap, true) ;
            const GGS_goilTemplateFieldMap::cElement * operand_14260 = NULL ;
            while (((operand_14260 = enumerator_14260.nextObject ()))) {
              macroValidPointer (operand_14260) ;
              GGS_lstring  var_cas_varName = GGS_lstring ::constructor_new (inLexique, (operand_14135->mPrefix).operator_concat (operand_14260->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (496))), operand_14260->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (496)) COMMA_SOURCE_FILE_AT_LINE (496)) ;
              var_cas_templateVariableMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, (operand_14135->mPrefix).operator_concat (operand_14260->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (501))), operand_14260->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (501)) COMMA_SOURCE_FILE_AT_LINE (501)), operand_14260->mInfo.mType, GGS_goilTemplateValue::constructor_new (operand_14260->mInfo.mUnsigned64Value, operand_14260->mInfo.mStringValue, operand_14260->mInfo.mListValue, operand_14260->mInfo.mStructValue) COMMA_SOURCE_FILE_AT_LINE (500)) ;
            }
          }
        }
      }
      ::routine_addUnsignedValue (inLexique,  var_cas_templateVariableMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("INDEX"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (511)),  var_cas_idx.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (511)) COMMA_SOURCE_FILE_AT_LINE (511)) ;
      nt_template_5F_instruction_5F_list_ (inLexique, var_cas_inPrefix, var_cas_inPath, var_cas_inTemplateDirectory, var_cas_templateVariableMap, var_cas_ioResultingString) ;
  ...
  GGS_lstring  var_cas_s = GGS_lstring ::constructor_retrieveAndResetTemplateString (inLexique COMMA_SOURCE_FILE_AT_LINE (539)) ;
...
void template_parser::rule_template_5F_parser_template_5F_instruction_i8_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  { bool syntaxRepeat_12 = true ;
    while (syntaxRepeat_12) {
        ...
        GGS_goilTemplateType var_cas_expressionType ;
        nt_expression_ (inLexique, var_cas_inPrefix, var_cas_inPath, var_cas_inTemplateDirectory, var_cas_ioTemplateVariableMap, var_cas_enumeratedValue, var_cas_expressionType) ;
        const GGS_bool cond_17078 = (((var_cas_expressionType).operator_isNotEqual (GGS_goilTemplateType::constructor_boolType (inLexique COMMA_SOURCE_FILE_AT_LINE (588)))).operator_and ((var_cas_expressionType).operator_isNotEqual (GGS_goilTemplateType::constructor_unsignedType (inLexique COMMA_SOURCE_FILE_AT_LINE (589))))).operator_and ((var_cas_expressionType).operator_isNotEqual (GGS_goilTemplateType::constructor_stringType (inLexique COMMA_SOURCE_FILE_AT_LINE (590)))) ;
        if (cond_17078.isBuiltAndTrue ()) {
  ...
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_template_5F_scanner::kToken_do) COMMA_HERE) ;
  GGS_uint  var_cas_idx = GGS_uint (0U) ;
  GGS_uint _variant_18428 = var_cas_enumerationList.reader_length () ;
  const C_parsingContext context_18428 = inLexique.parsingContext () ;
  nt_template_5F_instruction_5F_list_parse (inLexique) ;
  ...
  GGS_bool _condition_18428 ;
  if (_variant_18428.isBuilt ()) {
    _condition_18428 = (var_cas_enumerationList.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  }
  while (_condition_18428.isBuiltAndTrue ()) {
    inLexique.setParsingContext (context_18428) ;
    if (_variant_18428.uintValue () == 0) {
      inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (641)) ;
      _condition_18428 = GGS_bool (false) ;
    }else{
      _variant_18428.decrement_operation (inLexique COMMA_HERE) ;
      GGS_goilTemplateVariableMap  var_cas_templateVariableMap = GGS_goilTemplateVariableMap ::constructor_mapWithMapToOverride (inLexique, var_cas_ioTemplateVariableMap COMMA_SOURCE_FILE_AT_LINE (602)) ;
      ...
      ::routine_addUnsignedValue (inLexique,  var_cas_templateVariableMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("INDEX"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (614)),  var_cas_idx.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (614)) COMMA_SOURCE_FILE_AT_LINE (614)) ;
      nt_template_5F_instruction_5F_list_ (inLexique, var_cas_inPrefix, var_cas_inPath, var_cas_inTemplateDirectory, var_cas_templateVariableMap, var_cas_ioResultingString) ;
  ...
  GGS_lstring  var_cas_s = GGS_lstring ::constructor_retrieveAndResetTemplateString (inLexique COMMA_SOURCE_FILE_AT_LINE (642)) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_template_5F_scanner::kToken_end) COMMA_HERE) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_template_5F_scanner::kToken_for) COMMA_HERE) ;
}
...
void template_parser::rule_template_5F_parser_template_5F_instruction_i9_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  const GGS_bool cond_19175 = (var_cas_startType).operator_isNotEqual (GGS_goilTemplateType::constructor_unsignedType (inLexique COMMA_SOURCE_FILE_AT_LINE (669))) ;
  if (cond_19175.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_19485 = (var_cas_endType).operator_isNotEqual (GGS_goilTemplateType::constructor_unsignedType (inLexique COMMA_SOURCE_FILE_AT_LINE (683))) ;
  if (cond_19485.isBuiltAndTrue ()) {
  ...
  GGS_uint _variant_20988 = var_cas_stop.substract_operation (inLexique, var_cas_start COMMA_SOURCE_FILE_AT_LINE (708)).add_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (708)) ;
  const C_parsingContext context_20988 = inLexique.parsingContext () ;
  nt_template_5F_instruction_5F_list_parse (inLexique) ;
  ...
  GGS_bool _condition_20988 ;
  if (_variant_20988.isBuilt ()) {
    _condition_20988 = (var_cas_idx).operator_infOrEqual (var_cas_stop) ;
  }
  while (_condition_20988.isBuiltAndTrue ()) {
    inLexique.setParsingContext (context_20988) ;
    if (_variant_20988.uintValue () == 0) {
      inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (741)) ;
      _condition_20988 = GGS_bool (false) ;
    }else{
      _variant_20988.decrement_operation (inLexique COMMA_HERE) ;
      GGS_goilTemplateVariableMap  var_cas_templateVariableMap = GGS_goilTemplateVariableMap ::constructor_mapWithMapToOverride (inLexique, var_cas_ioTemplateVariableMap COMMA_SOURCE_FILE_AT_LINE (710)) ;
  ...
  GGS_lstring  var_cas_s = GGS_lstring ::constructor_retrieveAndResetTemplateString (inLexique COMMA_SOURCE_FILE_AT_LINE (742)) ;
...
void template_parser::rule_template_5F_parser_template_5F_instruction_i10_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  switch (select_template_5F_parser_17 (inLexique)) {
    case 1 : {
      ...
      nt_expression_ (inLexique, var_cas_inPrefix, var_cas_inPath, var_cas_inTemplateDirectory, var_cas_ioTemplateVariableMap, var_cas_enumeratedValue, var_cas_expressionType) ;
      const GGS_bool cond_22264 = var_cas_ioTemplateVariableMap.reader_hasKey (var_cas_variableName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (787))) ;
      if (cond_22264.isBuiltAndTrue ()) {
      ...
      }else if (cond_22264.isBuiltAndFalse ()) {
    ...
    case 2 : {
      ...
      nt_expression_ (inLexique, var_cas_inPrefix, var_cas_inPath, var_cas_inTemplateDirectory, var_cas_ioTemplateVariableMap, var_cas_enumeratedValue, var_cas_expressionType) ;
      const GGS_bool cond_22647 = (var_cas_expressionType).operator_isNotEqual (GGS_goilTemplateType::constructor_stringType (inLexique COMMA_SOURCE_FILE_AT_LINE (803))) ;
      if (cond_22647.isBuiltAndTrue ()) {
      ...
      }else if (cond_22647.isBuiltAndFalse ()) {
        GGS_goilTemplateValue var_cas_variableValue ;
        GGS_goilTemplateType var_cas_variableType ;
        const GGS_goilTemplateVariableMap  temp_22764 = var_cas_ioTemplateVariableMap ;
        if (temp_22764.isBuilt ()) {
          temp_22764 (HERE)->method_searchKey (inLexique, var_cas_variableName, var_cas_variableType, var_cas_variableValue COMMA_SOURCE_FILE_AT_LINE (808)) ;
        }
        const GGS_bool cond_22929 = (var_cas_variableType).operator_isNotEqual (GGS_goilTemplateType::constructor_listType (inLexique COMMA_SOURCE_FILE_AT_LINE (809))) ;
        if (cond_22929.isBuiltAndTrue ()) {
        ...
        }else if (cond_22929.isBuiltAndFalse ()) {
          GGS_goilTemplateFieldMap  var_cas_fieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (812)) ;
          var_cas_fieldMap.modifier_insertKey (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (813)), var_cas_expressionType, GGS_uint64 (0ULL), var_cas_enumeratedValue.reader_mStringValue (inLexique COMMA_SOURCE_FILE_AT_LINE (813)), GGS_goilTemplateFieldMapList ::constructor_emptyList (), GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (813)) COMMA_SOURCE_FILE_AT_LINE (813)) ;
...
void template_parser::rule_template_5F_parser_template_5F_instruction_i12_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  GGS_goilTemplateType var_cas_expressionType ;
  nt_expression_ (inLexique, var_cas_inPrefix, var_cas_inPath, var_cas_inTemplateDirectory, var_cas_ioTemplateVariableMap, var_cas_enumeratedValue, var_cas_expressionType) ;
  const GGS_bool cond_24508 = (var_cas_expressionType).operator_isNotEqual (GGS_goilTemplateType::constructor_stringType (inLexique COMMA_SOURCE_FILE_AT_LINE (859))) ;
  if (cond_24508.isBuiltAndTrue ()) {
  ...
  }else if (cond_24508.isBuiltAndFalse ()) {
...
void template_parser::rule_template_5F_parser_template_5F_instruction_i13_ (C_Lexique_template_5F_scanner & inLexique,
  ...
  GGS_goilTemplateType var_cas_expressionType ;
  nt_expression_ (inLexique, var_cas_inPrefix, var_cas_inPath, var_cas_inTemplateDirectory, var_cas_ioTemplateVariableMap, var_cas_enumeratedValue, var_cas_expressionType) ;
  const GGS_bool cond_25272 = (var_cas_expressionType).operator_isNotEqual (GGS_goilTemplateType::constructor_stringType (inLexique COMMA_SOURCE_FILE_AT_LINE (888))) ;
  if (cond_25272.isBuiltAndTrue ()) {
  ...
  }else if (cond_25272.isBuiltAndFalse ()) {
