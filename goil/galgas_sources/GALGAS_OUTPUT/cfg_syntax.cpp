    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_cfg_syntax_0 (inLexique)) {
        case 2 : {
          ...
          const GGS_bool cond_1221 = var_cas_cfg.reader_hasKey (inLexique, GGS_string ("wd_ticks_per_ns") COMMA_SOURCE_FILE_AT_LINE (52)) ;
        ...
        case 3 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (cfg_lexique::cfg_lexique_1_uint) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (cfg_lexique::cfg_lexique_1__3B_) COMMA_HERE) ;
          const GGS_bool cond_1615 = var_cas_cfg.reader_hasKey (inLexique, GGS_string ("stack_align") COMMA_SOURCE_FILE_AT_LINE (63)) ;
    ...
    while (syntaxRepeat_2) {
      switch (select_repeat_cfg_syntax_2 (inLexique)) {
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (cfg_lexique::cfg_lexique_1_uint) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (cfg_lexique::cfg_lexique_1__3B_) COMMA_HERE) ;
          var_cas_it_src.modifier_put (inLexique, var_cas_src, GGS_uint64_class ::constructor_new (inLexique, var_cas_id.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (134)), var_cas_id.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (134)) COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (134)) ;
          } break ;
        default :
