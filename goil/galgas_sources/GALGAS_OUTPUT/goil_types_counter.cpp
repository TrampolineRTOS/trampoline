...
typeComparisonResult cCollectionElement_time_5F_constants::compare (const cCollectionElement * inOperand) const {
...
typeComparisonResult cMapElement_counter_5F_map::compare (const cCollectionElement * inOperand) const {
...
typeComparisonResult cSortedListElement_counter_5F_by_5F_source::compare (const cCollectionElement * inOperand) const {
...
typeComparisonResult cSortedListElement_counter_5F_by_5F_source::compareForSorting (const cSortedListElement * inOperand) const {
  typeComparisonResult result = kOperandEqual ;
...
GALGAS_uint_36__34_ function_maxAllowedValue (const GALGAS_counter_5F_obj & constinArgument_counter,
                                              C_Compiler * inCompiler
                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_uint_36__34_ result_value ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_value = GALGAS_uint_36__34_ ((PMUInt64) 0ULL) ;
  ...
  if (constinArgument_counter.reader_max_5F_allowed_5F_value (SOURCE_FILE_AT_LINE (68)).isValid ()) {
    if (constinArgument_counter.reader_max_5F_allowed_5F_value (SOURCE_FILE_AT_LINE (68)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_33__32__5F_class) {
      ...
      //-------- @assignmentInstructionForGeneration
      result_value = cast_1537_max.reader_value (SOURCE_FILE_AT_LINE (69)).reader_uint_36__34_ (SOURCE_FILE_AT_LINE (69)) ;
    }else{
...
GALGAS_uint_36__34_ function_minCycle (const GALGAS_counter_5F_obj & constinArgument_counter,
  ...
  if (constinArgument_counter.reader_min_5F_cycle (SOURCE_FILE_AT_LINE (76)).isValid ()) {
    if (constinArgument_counter.reader_min_5F_cycle (SOURCE_FILE_AT_LINE (76)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_33__32__5F_class) {
      ...
      //-------- @assignmentInstructionForGeneration
      result_value = cast_1827_min.reader_value (SOURCE_FILE_AT_LINE (77)).reader_uint_36__34_ (SOURCE_FILE_AT_LINE (77)) ;
    }else{
      //-------- @errorInstructionForGeneration
...
GALGAS_uint_36__34_ function_ticksPerBase (const GALGAS_counter_5F_obj & constinArgument_counter,
  ...
  if (constinArgument_counter.reader_ticks_5F_per_5F_base (SOURCE_FILE_AT_LINE (84)).isValid ()) {
    if (constinArgument_counter.reader_ticks_5F_per_5F_base (SOURCE_FILE_AT_LINE (84)).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_uint_33__32__5F_class) {
      ...
      //-------- @assignmentInstructionForGeneration
      result_value = cast_2113_ticks.reader_value (SOURCE_FILE_AT_LINE (85)).reader_uint_36__34_ (SOURCE_FILE_AT_LINE (85)) ;
    }else{
      //-------- @errorInstructionForGeneration
...
typeComparisonResult GALGAS_counter_5F_driver::objectCompare (const GALGAS_counter_5F_driver & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
...
typeComparisonResult cPtr_gpt_5F_driver::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_gpt_5F_driver * p = (const cPtr_gpt_5F_driver *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_gpt_5F_driver) ;
  if (kOperandEqual == result) {
    result = mAttribute_location.objectCompare (p->mAttribute_location) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_ns_5F_per_5F_hw_5F_tick.objectCompare (p->mAttribute_ns_5F_per_5F_hw_5F_tick) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_gpt_5F_channel_5F_name.objectCompare (p->mAttribute_gpt_5F_channel_5F_name) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_gpt_5F_driver::objectCompare (const GALGAS_gpt_5F_driver & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
typeComparisonResult cPtr_os_5F_internal_5F_driver::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_os_5F_internal_5F_driver * p = (const cPtr_os_5F_internal_5F_driver *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_os_5F_internal_5F_driver) ;
  if (kOperandEqual == result) {
    result = mAttribute_location.objectCompare (p->mAttribute_location) ;
  }
  return result ;
...
typeComparisonResult GALGAS_os_5F_internal_5F_driver::objectCompare (const GALGAS_os_5F_internal_5F_driver & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
typeComparisonResult cPtr_void_5F_driver::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_void_5F_driver * p = (const cPtr_void_5F_driver *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_void_5F_driver) ;
  if (kOperandEqual == result) {
    result = mAttribute_location.objectCompare (p->mAttribute_location) ;
  }
  return result ;
...
typeComparisonResult GALGAS_void_5F_driver::objectCompare (const GALGAS_void_5F_driver & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
typeComparisonResult GALGAS_counter_5F_type::objectCompare (const GALGAS_counter_5F_type & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
typeComparisonResult cPtr_hardware_5F_counter::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_hardware_5F_counter * p = (const cPtr_hardware_5F_counter *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_hardware_5F_counter) ;
  if (kOperandEqual == result) {
    result = mAttribute_location.objectCompare (p->mAttribute_location) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_driver.objectCompare (p->mAttribute_driver) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_time_5F_consts.objectCompare (p->mAttribute_time_5F_consts) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_hardware_5F_counter::objectCompare (const GALGAS_hardware_5F_counter & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
typeComparisonResult cPtr_software_5F_counter::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_software_5F_counter * p = (const cPtr_software_5F_counter *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_software_5F_counter) ;
  if (kOperandEqual == result) {
    result = mAttribute_location.objectCompare (p->mAttribute_location) ;
  }
  return result ;
...
typeComparisonResult GALGAS_software_5F_counter::objectCompare (const GALGAS_software_5F_counter & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
typeComparisonResult cPtr_void_5F_counter::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_void_5F_counter * p = (const cPtr_void_5F_counter *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_void_5F_counter) ;
  if (kOperandEqual == result) {
    result = mAttribute_location.objectCompare (p->mAttribute_location) ;
  }
  return result ;
...
typeComparisonResult GALGAS_void_5F_counter::objectCompare (const GALGAS_void_5F_counter & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
typeComparisonResult cPtr_counter_5F_obj::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_counter_5F_obj * p = (const cPtr_counter_5F_obj *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_counter_5F_obj) ;
  if (kOperandEqual == result) {
    result = mAttribute_desc.objectCompare (p->mAttribute_desc) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_max_5F_allowed_5F_value.objectCompare (p->mAttribute_max_5F_allowed_5F_value) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_ticks_5F_per_5F_base.objectCompare (p->mAttribute_ticks_5F_per_5F_base) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_min_5F_cycle.objectCompare (p->mAttribute_min_5F_cycle) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_source.objectCompare (p->mAttribute_source) ;
  }
  if (kOperandEqual == result) {
  ...
  if (kOperandEqual == result) {
    result = mAttribute_unit.objectCompare (p->mAttribute_unit) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_counter_5F_obj::objectCompare (const GALGAS_counter_5F_obj & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
