...
class goil_syntax {
  ...
  protected : virtual PMSInt16 select_repeat_goil_syntax_0 (goil_lexique &) = 0 ;
  ...
  protected : virtual PMSInt16 select_repeat_goil_syntax_2 (goil_lexique &) = 0 ;
