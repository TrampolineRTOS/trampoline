...
void routine_add_system_counter (C_Compiler & inLexique,
  ...
  const GGS_bool cond_5818 = var_cas_counters.reader_hasKey (GGS_string ("SystemCounter")) ;
  if (cond_5818.isBuiltAndTrue ()) {
    ...
    if (cond_5807.isBuiltAndTrue ()) {
      const GGS_bool cond_5628 = (var_cas_sys_cnt.reader_acc_apps (inLexique COMMA_SOURCE_FILE_AT_LINE (193)).reader_length ()).operator_isEqual (GGS_uint (0U)) ;
...
void routine_set_defaults (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_6940 = var_cas_imp.reader_hasKey (GGS_string ("task")) ;
  ...
  const GGS_bool cond_7201 = var_cas_imp.reader_hasKey (GGS_string ("isr")) ;
