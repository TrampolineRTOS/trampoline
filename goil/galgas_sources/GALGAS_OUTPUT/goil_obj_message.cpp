    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_goil_obj_message_0 (_inLexique)) {
          ...
          { const GGS_mess_prop_obj _var_4084 = var_cas_mess_prop ; // CAST instruction
            if (_var_4084.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void_mess_prop) == typeid (* (_var_4084.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "MESSAGEPROPERTY attribute already defined") COMMA_SOURCE_FILE_AT_LINE (180)) ;
                var_cas_mess_prop.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (180)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "previously defined here") COMMA_SOURCE_FILE_AT_LINE (181)) ;
              }
            }
          }
          ...
          { const GGS_action_obj _var_4373 = var_cas_notif ; // CAST instruction
            if (_var_4373.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void_action) == typeid (* (_var_4373.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "NOTIFICATION attribute already defined") COMMA_SOURCE_FILE_AT_LINE (188)) ;
                var_cas_notif.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (188)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "previously defined here") COMMA_SOURCE_FILE_AT_LINE (189)) ;
              }
            }
          }
          ...
          { const GGS_action_obj _var_4683 = var_cas_notif_error ; // CAST instruction
            if (_var_4683.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void_action) == typeid (* (_var_4683.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "NOTIFICATIONERROR attribute already defined") COMMA_SOURCE_FILE_AT_LINE (196)) ;
                var_cas_notif_error.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (196)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "was previously defined here") COMMA_SOURCE_FILE_AT_LINE (197)) ;
              }
            }
          }
        ...
        case 5 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_add_lstring_unique (_inLexique,  var_cas_acc_apps,  var_cas_app,  GGS_string (true, "ACCESSING_APPLICATION") COMMA_SOURCE_FILE_AT_LINE (202)) ;
          } break ;
        case 6 : {
...
pr_notification_property_goil_obj_message_227_28_ (goil_lexique & _inLexique,
  ...
  switch (select_goil_obj_message_2 (_inLexique)) {
    ...
    case 2 : {
      ...
      var_cas_has_task = GGS_bool (true, false) ;
      ...
      var_cas_has_event = GGS_bool (true, false) ;
          ...
          switch (select_repeat_goil_obj_message_3 (_inLexique)) {
            case 2 : {
              if ((var_cas_has_task).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "TASK already defined for SETEVENT notification") COMMA_SOURCE_FILE_AT_LINE (243)) ;
              }
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              var_cas_has_task = GGS_bool (true, true) ;
              } break ;
            case 3 : {
              if ((var_cas_has_event).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "EVENT already defined for SETEVENT notification") COMMA_SOURCE_FILE_AT_LINE (252)) ;
              }
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              var_cas_has_event = GGS_bool (true, true) ;
              } break ;
            default :
      ...
      if (((var_cas_has_task)._operator_not ()).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Task not defined for SETEVENT notification") COMMA_SOURCE_FILE_AT_LINE (262)) ;
      }
      if (((var_cas_has_event)._operator_not ()).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Event not defined for SETEVENT notification") COMMA_SOURCE_FILE_AT_LINE (265)) ;
      }
    ...
    case 6 : {
      ...
      var_cas_has_function = GGS_bool (true, false) ;
      GGS_lstring  var_cas_function_name ;
      var_cas_function_name = GGS_lstring ::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) ;
      GGS_bool var_cas_has_ipdu ;
      var_cas_has_ipdu = GGS_bool (true, false) ;
      GGS_luint64  var_cas_ipdu ;
      var_cas_ipdu = GGS_luint64 ::constructor_new (_inLexique, GGS_uint64 (true, 0LLU), GGS_location (_inLexique) COMMA_HERE) ;
          ...
          switch (select_repeat_goil_obj_message_4 (_inLexique)) {
            case 2 : {
              if ((var_cas_has_function).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Callback routine already defined for NMCALLBACK notification") COMMA_SOURCE_FILE_AT_LINE (298)) ;
              }
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              var_cas_has_function = GGS_bool (true, true) ;
              } break ;
            case 3 : {
              if ((var_cas_has_ipdu).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Callback routine already defined for NMCALLBACK notification") COMMA_SOURCE_FILE_AT_LINE (304)) ;
              }
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              var_cas_has_ipdu = GGS_bool (true, true) ;
              } break ;
            default :
      ...
      if (((var_cas_has_function)._operator_not ()).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Callback not defined for NMCALLBACK notification") COMMA_SOURCE_FILE_AT_LINE (311)) ;
      }
      if (((var_cas_has_ipdu)._operator_not ()).isBuiltAndTrue ()) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "IPDU not defined for NMCALLBACK notification") COMMA_SOURCE_FILE_AT_LINE (314)) ;
      }
...
pr_sse_attributes_goil_obj_message_330_21_ (goil_lexique & _inLexique,
  ...
  var_cas_has_cdatatype = GGS_bool (true, false) ;
  GGS_lstring  var_cas_cdatatype ;
  var_cas_cdatatype = GGS_lstring ::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) ;
  GGS_bool var_cas_has_transferproperty ;
  var_cas_has_transferproperty = GGS_bool (true, false) ;
  GGS_lstring  var_cas_transferproperty ;
  var_cas_transferproperty = GGS_lstring ::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) ;
  GGS_bool var_cas_has_net_message ;
  var_cas_has_net_message = GGS_bool (true, false) ;
  GGS_lstring  var_cas_net_message ;
  var_cas_net_message = GGS_lstring ::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) ;
  GGS_bool var_cas_has_filter ;
  var_cas_has_filter = GGS_bool (true, false) ;
  ...
  var_cas_has_net_order_callout = GGS_bool (true, false) ;
  GGS_lstring  var_cas_net_order_callout ;
  var_cas_net_order_callout = GGS_lstring ::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) ;
  GGS_bool var_cas_has_cpu_order_callout ;
  var_cas_has_cpu_order_callout = GGS_bool (true, false) ;
  GGS_lstring  var_cas_cpu_order_callout ;
  var_cas_cpu_order_callout = GGS_lstring ::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) ;
  GGS_bool var_cas_has_initial_value ;
  var_cas_has_initial_value = GGS_bool (true, false) ;
      ...
      switch (select_repeat_goil_obj_message_5 (_inLexique)) {
        case 2 : {
          if ((var_cas_has_cdatatype).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "CDATATYPE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (353)) ;
          }
          nt_cdatatype_ (_inLexique, var_cas_cdatatype) ;
          var_cas_has_cdatatype = GGS_bool (true, true) ;
          } break ;
        case 3 : {
          if ((var_cas_has_transferproperty).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "TRANSFERPROPERTY subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (359)) ;
          }
          nt_transferproperty_ (_inLexique, var_cas_transferproperty) ;
          var_cas_has_transferproperty = GGS_bool (true, true) ;
          } break ;
        case 4 : {
          if ((var_cas_has_net_message).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "NETWORKMESSAGE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (365)) ;
          }
          nt_networkmessage_ (_inLexique, var_cas_net_message) ;
          var_cas_has_net_message = GGS_bool (true, true) ;
          } break ;
        case 5 : {
          if ((var_cas_has_filter).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "FILTER subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (371)) ;
          }
          nt_filter_ (_inLexique, var_cas_filter) ;
          var_cas_has_filter = GGS_bool (true, true) ;
          } break ;
        case 6 : {
          if ((var_cas_has_net_order_callout).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "NETWORKORDERCALLOUT subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (377)) ;
          }
          nt_networkordercallout_ (_inLexique, var_cas_net_order_callout) ;
          var_cas_has_net_order_callout = GGS_bool (true, true) ;
          } break ;
        case 7 : {
          if ((var_cas_has_cpu_order_callout).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "CPUORDERCALLOUT subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (383)) ;
          }
          nt_cpuordercallout_ (_inLexique, var_cas_cpu_order_callout) ;
          var_cas_has_cpu_order_callout = GGS_bool (true, true) ;
          } break ;
        case 8 : {
          if ((var_cas_has_initial_value).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "INITIALVALUE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (389)) ;
          }
          nt_initialvalue_ (_inLexique, var_cas_initial_value) ;
          var_cas_has_initial_value = GGS_bool (true, true) ;
          } break ;
        default :
  ...
  if (((var_cas_has_cdatatype)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "CDATATYPE is missing in the message") COMMA_SOURCE_FILE_AT_LINE (396)) ;
  }
  if (((var_cas_has_transferproperty)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "TRANSFERPROPERTY is missing in the message") COMMA_SOURCE_FILE_AT_LINE (399)) ;
  }
  if (((var_cas_has_net_message)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "NETWORKMESSAGE is missing in the message") COMMA_SOURCE_FILE_AT_LINE (402)) ;
  }
  ...
  { bool syntaxRepeat_6 = true ;
    while (syntaxRepeat_6) {
      switch (select_repeat_goil_obj_message_6 (_inLexique)) {
        case 2 : {
          if ((var_cas_has_transferproperty).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "TRANSFERPROPERTY subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (435)) ;
          }
          nt_transferproperty_ (_inLexique, var_cas_transferproperty) ;
          var_cas_has_transferproperty = GGS_bool (true, true) ;
          } break ;
        case 3 : {
          if ((var_cas_has_net_message).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "NETWORKMESSAGE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (441)) ;
          }
          nt_networkmessage_ (_inLexique, var_cas_net_message) ;
          var_cas_has_net_message = GGS_bool (true, true) ;
          } break ;
        case 4 : {
          if ((var_cas_has_net_order_callout).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "NETWORKORDERCALLOUT subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (447)) ;
          }
          nt_networkordercallout_ (_inLexique, var_cas_net_order_callout) ;
          var_cas_has_net_order_callout = GGS_bool (true, true) ;
          } break ;
        case 5 : {
          if ((var_cas_has_cpu_order_callout).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "CPUORDERCALLOUT subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (453)) ;
          }
          nt_cpuordercallout_ (_inLexique, var_cas_cpu_order_callout) ;
          var_cas_has_cpu_order_callout = GGS_bool (true, true) ;
          } break ;
        case 6 : {
          if ((var_cas_has_initial_value).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "INITIALVALUE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (459)) ;
          }
          nt_initialvalue_ (_inLexique, var_cas_initial_value) ;
          var_cas_has_initial_value = GGS_bool (true, true) ;
          } break ;
...
pr_sze_attributes_goil_obj_message_474_21_ (goil_lexique & _inLexique,
  ...
  { bool syntaxRepeat_7 = true ;
    while (syntaxRepeat_7) {
      switch (select_repeat_goil_obj_message_7 (_inLexique)) {
        case 2 : {
          if ((var_cas_has_net_message).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "NETWORKMESSAGE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (489)) ;
          }
          nt_networkmessage_ (_inLexique, var_cas_net_message) ;
          var_cas_has_net_message = GGS_bool (true, true) ;
          } break ;
        case 3 : {
          if ((var_cas_has_net_order_callout).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "NETWORKORDERCALLOUT subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (495)) ;
          }
          nt_networkordercallout_ (_inLexique, var_cas_net_order_callout) ;
          var_cas_has_net_order_callout = GGS_bool (true, true) ;
          } break ;
        case 4 : {
          if ((var_cas_has_cpu_order_callout).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "CPUORDERCALLOUT subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (501)) ;
          }
          nt_cpuordercallout_ (_inLexique, var_cas_cpu_order_callout) ;
          var_cas_has_cpu_order_callout = GGS_bool (true, true) ;
          } break ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
  if (((var_cas_has_net_message)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "NETWORKMESSAGE subattribute missing") COMMA_SOURCE_FILE_AT_LINE (508)) ;
  }
...
pr_rze_attributes_goil_obj_message_531_21_ (goil_lexique & _inLexique,
  ...
  { bool syntaxRepeat_8 = true ;
    while (syntaxRepeat_8) {
      switch (select_repeat_goil_obj_message_8 (_inLexique)) {
        case 2 : {
          if ((var_cas_has_net_message).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "NETWORKMESSAGE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (546)) ;
          }
          nt_networkmessage_ (_inLexique, var_cas_net_message) ;
          var_cas_has_net_message = GGS_bool (true, true) ;
          } break ;
        case 3 : {
          if ((var_cas_has_net_order_callout).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "NETWORKORDERCALLOUT subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (552)) ;
          }
          nt_networkordercallout_ (_inLexique, var_cas_net_order_callout) ;
          var_cas_has_net_order_callout = GGS_bool (true, true) ;
          } break ;
        case 4 : {
          if ((var_cas_has_cpu_order_callout).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "CPUORDERCALLOUT subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (558)) ;
          }
          nt_cpuordercallout_ (_inLexique, var_cas_cpu_order_callout) ;
          var_cas_has_cpu_order_callout = GGS_bool (true, true) ;
          } break ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
  if (((var_cas_has_net_message)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "NETWORKMESSAGE subattribute missing") COMMA_SOURCE_FILE_AT_LINE (565)) ;
  }
...
pr_rui_attributes_goil_obj_message_574_21_ (goil_lexique & _inLexique,
  ...
  var_cas_has_sending_message = GGS_bool (true, false) ;
  GGS_lstring  var_cas_sending_message ;
  var_cas_sending_message = GGS_lstring ::constructor_new (_inLexique, GGS_string (true, ""), GGS_location (_inLexique) COMMA_HERE) ;
  GGS_bool var_cas_has_filter ;
  var_cas_has_filter = GGS_bool (true, false) ;
  GGS_filter_prop_obj  var_cas_filter ;
  var_cas_filter = GGS_void_filter ::constructor_new (_inLexique COMMA_HERE) ;
      ...
      switch (select_repeat_goil_obj_message_9 (_inLexique)) {
        case 2 : {
          if ((var_cas_has_sending_message).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "SENDINGMESSAGE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (589)) ;
          }
          nt_sendingmessage_ (_inLexique, var_cas_sending_message) ;
          var_cas_has_sending_message = GGS_bool (true, true) ;
          } break ;
        case 3 : {
          if ((var_cas_has_filter).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "FILTER subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (595)) ;
          }
          nt_filter_ (_inLexique, var_cas_filter) ;
          var_cas_has_filter = GGS_bool (true, true) ;
          } break ;
        case 4 : {
          if ((var_cas_has_initial_value).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "INITIALVALUE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (601)) ;
          }
          nt_initialvalue_ (_inLexique, var_cas_initial_value) ;
          var_cas_has_initial_value = GGS_bool (true, true) ;
          } break ;
  ...
  if (((var_cas_has_sending_message)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "SENDINGMESSAGE subattribute missing") COMMA_SOURCE_FILE_AT_LINE (608)) ;
  }
...
pr_rqi_attributes_goil_obj_message_617_21_ (goil_lexique & _inLexique,
  ...
  var_cas_has_queue_size = GGS_bool (true, false) ;
  GGS_luint64  var_cas_queue_size ;
  var_cas_queue_size = GGS_luint64 ::constructor_new (_inLexique, GGS_uint64 (true, 0LLU), GGS_location (_inLexique) COMMA_HERE) ;
  GGS_bool var_cas_has_initial_value ;
  var_cas_has_initial_value = GGS_bool (true, false) ;
  GGS_basic_type  var_cas_initial_value ;
  var_cas_initial_value = GGS_void ::constructor_new (_inLexique, GGS_location (_inLexique) COMMA_HERE) ;
  ...
  { bool syntaxRepeat_10 = true ;
    while (syntaxRepeat_10) {
      switch (select_repeat_goil_obj_message_10 (_inLexique)) {
        case 2 : {
          if ((var_cas_has_sending_message).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "SENDINGMESSAGE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (634)) ;
          }
          nt_sendingmessage_ (_inLexique, var_cas_sending_message) ;
          var_cas_has_sending_message = GGS_bool (true, true) ;
          } break ;
        case 3 : {
          if ((var_cas_has_filter).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "FILTER subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (640)) ;
          }
          nt_filter_ (_inLexique, var_cas_filter) ;
          var_cas_has_filter = GGS_bool (true, true) ;
          } break ;
        case 4 : {
          if ((var_cas_has_queue_size).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "QUEUESIZE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (646)) ;
          }
          nt_queuesize_ (_inLexique, var_cas_queue_size) ;
          var_cas_has_queue_size = GGS_bool (true, true) ;
          } break ;
        case 5 : {
          if ((var_cas_has_initial_value).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "INITIALVALUE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (652)) ;
          }
          nt_initialvalue_ (_inLexique, var_cas_initial_value) ;
          var_cas_has_initial_value = GGS_bool (true, true) ;
          } break ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
  if (((var_cas_has_sending_message)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "SENDINGMESSAGE subattribute missing") COMMA_SOURCE_FILE_AT_LINE (659)) ;
  }
  if (((var_cas_has_queue_size)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "QUEUESIZE subattribute missing") COMMA_SOURCE_FILE_AT_LINE (662)) ;
  }
...
pr_rue_attributes_goil_obj_message_672_21_ (goil_lexique & _inLexique,
  ...
  { bool syntaxRepeat_11 = true ;
    while (syntaxRepeat_11) {
      switch (select_repeat_goil_obj_message_11 (_inLexique)) {
        case 2 : {
          if ((var_cas_has_cdatatype).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "CDATATYPE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (688)) ;
          }
          nt_cdatatype_ (_inLexique, var_cas_cdatatype) ;
          var_cas_has_cdatatype = GGS_bool (true, true) ;
          } break ;
        case 3 : {
          if ((var_cas_has_filter).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "FILTER subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (694)) ;
          }
          nt_filter_ (_inLexique, var_cas_filter) ;
          var_cas_has_filter = GGS_bool (true, true) ;
          } break ;
          ...
          { const GGS_link_obj _var_20284 = var_cas_link ; // CAST instruction
            if (_var_20284.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void_link) == typeid (* (_var_20284.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "LINK subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (701)) ;
              }
            }
          }
        ...
        case 5 : {
          if ((var_cas_has_initial_value).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "INITIALVALUE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (706)) ;
          }
          nt_initialvalue_ (_inLexique, var_cas_initial_value) ;
          var_cas_has_initial_value = GGS_bool (true, true) ;
          } break ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
  if (((var_cas_has_cdatatype)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "CDATATYPE is missing in the message") COMMA_SOURCE_FILE_AT_LINE (713)) ;
  }
  { const GGS_link_obj _var_20759 = var_cas_link ; // CAST instruction
    if (_var_20759.getPtr () != NULL) {
      ...
      if (typeid (cPtr_void_link) == typeid (* (_var_20759.getPtr ()))) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "LINK subattribute missing") COMMA_SOURCE_FILE_AT_LINE (717)) ;
      }else{
      }
    }
  }
...
pr_rqe_attributes_goil_obj_message_729_21_ (goil_lexique & _inLexique,
  ...
  { bool syntaxRepeat_12 = true ;
    while (syntaxRepeat_12) {
      switch (select_repeat_goil_obj_message_12 (_inLexique)) {
        case 2 : {
          if ((var_cas_has_cdatatype).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "CDATATYPE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (747)) ;
          }
          nt_cdatatype_ (_inLexique, var_cas_cdatatype) ;
          var_cas_has_cdatatype = GGS_bool (true, true) ;
          } break ;
        case 3 : {
          if ((var_cas_has_filter).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "FILTER subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (753)) ;
          }
          nt_filter_ (_inLexique, var_cas_filter) ;
          var_cas_has_filter = GGS_bool (true, true) ;
          } break ;
        case 4 : {
          if ((var_cas_has_queue_size).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "QUEUESIZE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (759)) ;
          }
          nt_queuesize_ (_inLexique, var_cas_queue_size) ;
          var_cas_has_queue_size = GGS_bool (true, true) ;
          } break ;
          ...
          { const GGS_link_obj _var_22069 = var_cas_link ; // CAST instruction
            if (_var_22069.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void_link) == typeid (* (_var_22069.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "LINK subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (766)) ;
              }
            }
          }
          nt_link_ (_inLexique, var_cas_link) ;
        ...
        case 6 : {
          if ((var_cas_has_initial_value).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "INITIALVALUE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (771)) ;
          }
          nt_initialvalue_ (_inLexique, var_cas_initial_value) ;
          var_cas_has_initial_value = GGS_bool (true, true) ;
          } break ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
  if (((var_cas_has_cdatatype)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "CDATATYPE is missing in the message") COMMA_SOURCE_FILE_AT_LINE (779)) ;
  }
  if (((var_cas_has_queue_size)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "QUEUESIZE subattribute missing") COMMA_SOURCE_FILE_AT_LINE (782)) ;
  }
  { const GGS_link_obj _var_22641 = var_cas_link ; // CAST instruction
    if (_var_22641.getPtr () != NULL) {
      ...
      if (typeid (cPtr_void_link) == typeid (* (_var_22641.getPtr ()))) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "LINK subattribute missing") COMMA_SOURCE_FILE_AT_LINE (786)) ;
      }else{
      }
    }
  }
  ...
  { bool syntaxRepeat_13 = true ;
    while (syntaxRepeat_13) {
      switch (select_repeat_goil_obj_message_13 (_inLexique)) {
          ...
          { const GGS_link_obj _var_23165 = var_cas_link ; // CAST instruction
            if (_var_23165.getPtr () != NULL) {
              ...
              if (typeid (cPtr_void_link) == typeid (* (_var_23165.getPtr ()))) {
                ...
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "LINK subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (813)) ;
              }
            }
          }
          nt_link_ (_inLexique, var_cas_link) ;
        ...
        case 3 : {
          if ((var_cas_has_initial_value).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "INITIALVALUE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (818)) ;
          }
          nt_initialvalue_ (_inLexique, var_cas_initial_value) ;
          var_cas_has_initial_value = GGS_bool (true, true) ;
          } break ;
  ...
  { const GGS_link_obj _var_23537 = var_cas_link ; // CAST instruction
    if (_var_23537.getPtr () != NULL) {
      ...
      if (typeid (cPtr_void_link) == typeid (* (_var_23537.getPtr ()))) {
        GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "LINK subattribute missing") COMMA_SOURCE_FILE_AT_LINE (827)) ;
      }else{
      }
    }
  }
...
pr_rzs_attributes_goil_obj_message_838_21_ (goil_lexique & _inLexique,
  ...
  { bool syntaxRepeat_14 = true ;
    while (syntaxRepeat_14) {
      switch (select_repeat_goil_obj_message_14 (_inLexique)) {
        case 2 : {
          if ((var_cas_has_cdatatype).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "CDATATYPE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (851)) ;
          }
          nt_cdatatype_ (_inLexique, var_cas_cdatatype) ;
          var_cas_has_cdatatype = GGS_bool (true, true) ;
          } break ;
        case 3 : {
          if ((var_cas_has_initial_value).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "INITIALVALUE subattribute already defined") COMMA_SOURCE_FILE_AT_LINE (857)) ;
          }
          nt_initialvalue_ (_inLexique, var_cas_initial_value) ;
          var_cas_has_initial_value = GGS_bool (true, true) ;
          } break ;
  ...
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
  if (((var_cas_has_cdatatype)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "CDATATYPE is missing in the message") COMMA_SOURCE_FILE_AT_LINE (865)) ;
  }
...
pr_transferproperty_goil_obj_message_883_23_ (goil_lexique & _inLexique,
  ...
  switch (select_goil_obj_message_15 (_inLexique)) {
    case 1 : {
      ...
      var_cas_transferproperty = GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "triggered"), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    case 2 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_PENDING) COMMA_HERE) ;
      var_cas_transferproperty = GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "pending"), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    case 3 : {
      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_AUTO) COMMA_HERE) ;
      var_cas_transferproperty = GGS_lstring ::constructor_new (_inLexique, GGS_string (true, "auto"), GGS_location (_inLexique) COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
...
pr_mask_x_attribute_goil_obj_message_974_23_ (goil_lexique & _inLexique,
  ...
  var_cas_has_mask = GGS_bool (true, false) ;
  GGS_bool var_cas_has_x ;
  var_cas_has_x = GGS_bool (true, false) ;
  var_cas_mask = GGS_luint64 ::constructor_new (_inLexique, GGS_uint64 (true, 0LLU), GGS_location (_inLexique) COMMA_HERE) ;
  var_cas_x = GGS_luint64 ::constructor_new (_inLexique, GGS_uint64 (true, 0LLU), GGS_location (_inLexique) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7B) COMMA_HERE) ;
      ...
      switch (select_repeat_goil_obj_message_17 (_inLexique)) {
        case 2 : {
          if ((var_cas_has_mask).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "MASK is already defined for the filter") COMMA_SOURCE_FILE_AT_LINE (988)) ;
          }
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          var_cas_has_mask = GGS_bool (true, true) ;
          } break ;
        case 3 : {
          if ((var_cas_has_x).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "X is already defined for the filter") COMMA_SOURCE_FILE_AT_LINE (994)) ;
          }
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          var_cas_has_x = GGS_bool (true, true) ;
          } break ;
        default :
  ...
  if (((var_cas_has_mask)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "MASK is missing in the filter") COMMA_SOURCE_FILE_AT_LINE (1001)) ;
  }
  if (((var_cas_has_x)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "X is missing in the filter") COMMA_SOURCE_FILE_AT_LINE (1004)) ;
  }
}
...
pr_min_max_attribute_goil_obj_message_1015_24_ (goil_lexique & _inLexique,
  ...
  var_cas_has_min = GGS_bool (true, false) ;
  GGS_bool var_cas_has_max ;
  var_cas_has_max = GGS_bool (true, false) ;
  var_cas_min = GGS_luint64 ::constructor_new (_inLexique, GGS_uint64 (true, 0LLU), GGS_location (_inLexique) COMMA_HERE) ;
  var_cas_max = GGS_luint64 ::constructor_new (_inLexique, GGS_uint64 (true, 0LLU), GGS_location (_inLexique) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7B) COMMA_HERE) ;
      ...
      switch (select_repeat_goil_obj_message_18 (_inLexique)) {
        case 2 : {
          if ((var_cas_has_min).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "MIN is already defined for the filter") COMMA_SOURCE_FILE_AT_LINE (1029)) ;
          }
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          var_cas_has_min = GGS_bool (true, true) ;
          } break ;
        case 3 : {
          if ((var_cas_has_max).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "MAX is already defined for the filter") COMMA_SOURCE_FILE_AT_LINE (1035)) ;
          }
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          var_cas_has_max = GGS_bool (true, true) ;
          } break ;
        default :
  ...
  if (((var_cas_has_min)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "MIN is missing in the filter") COMMA_SOURCE_FILE_AT_LINE (1042)) ;
  }
  if (((var_cas_has_max)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "MAX is missing in the filter") COMMA_SOURCE_FILE_AT_LINE (1045)) ;
  }
}
...
pr_period_offset_attribute_goil_obj_message_1048_30_ (goil_lexique & _inLexique,
  ...
  var_cas_has_period = GGS_bool (true, false) ;
  GGS_bool var_cas_has_offset ;
  var_cas_has_offset = GGS_bool (true, false) ;
  var_cas_period = GGS_luint64 ::constructor_new (_inLexique, GGS_uint64 (true, 0LLU), GGS_location (_inLexique) COMMA_HERE) ;
  var_cas_offset = GGS_luint64 ::constructor_new (_inLexique, GGS_uint64 (true, 0LLU), GGS_location (_inLexique) COMMA_HERE) ;
  _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7B) COMMA_HERE) ;
      ...
      switch (select_repeat_goil_obj_message_19 (_inLexique)) {
        case 2 : {
          if ((var_cas_has_period).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "PERIOD is already defined for the filter") COMMA_SOURCE_FILE_AT_LINE (1062)) ;
          }
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          var_cas_has_period = GGS_bool (true, true) ;
          } break ;
        case 3 : {
          if ((var_cas_has_offset).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "OFFSET is already defined for the filter") COMMA_SOURCE_FILE_AT_LINE (1068)) ;
          }
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          var_cas_has_offset = GGS_bool (true, true) ;
          } break ;
        default :
  ...
  if (((var_cas_has_period)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "PERIOD is missing in the filter") COMMA_SOURCE_FILE_AT_LINE (1075)) ;
  }
  if (((var_cas_has_offset)._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "OFFSET is missing in the filter") COMMA_SOURCE_FILE_AT_LINE (1078)) ;
  }
}
