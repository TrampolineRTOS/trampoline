...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@root_obj:"
           << os.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << com.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           ...
           << net_messages.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << scheduletables.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << applis.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
