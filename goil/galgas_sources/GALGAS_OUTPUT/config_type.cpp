...
//                    september 3rd, 2010, at 11h12'34"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
GGS_os_config  function_os_cfg (C_Compiler & inLexique,
  ...
  {
    GGS_task_map::cEnumerator enumerator_4339 (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (158)), true) ;
    const GGS_task_map::cElement * operand_4339 = NULL ;
    while (((operand_4339 = enumerator_4339.nextObject ()))) {
      macroValidPointer (operand_4339) ;
      { const GGS_timing_prot _var_4439 = operand_4339->mInfo.task.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (159)) ; // CAST instruction
        if (_var_4439.getPtr () != NULL) {
          macroValidPointer (_var_4439.getPtr ()) ;
          if (typeid (cPtr_timing_prot_task) == typeid (* (_var_4439.getPtr ()))) {
  ...
  {
    GGS_isr_map::cEnumerator enumerator_4472 (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (163)), true) ;
    const GGS_isr_map::cElement * operand_4472 = NULL ;
    while (((operand_4472 = enumerator_4472.nextObject ()))) {
      macroValidPointer (operand_4472) ;
      { const GGS_timing_prot _var_4569 = operand_4472->mInfo.isr.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (164)) ; // CAST instruction
        if (_var_4569.getPtr () != NULL) {
          macroValidPointer (_var_4569.getPtr ()) ;
          if (typeid (cPtr_timing_prot_isr) == typeid (* (_var_4569.getPtr ()))) {
            var_cas_tp = GGS_bool (true) ;
          }else{
          }
        }
  ...
  var_cas_cfg = GGS_os_config ::constructor_new (inLexique, GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), var_cas_tp, GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), var_cas_itt, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (169)) ;
  #ifdef DEBUG_TRACE_ENABLED
