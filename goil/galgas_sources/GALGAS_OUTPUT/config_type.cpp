...
GGS_os_config  function_os_cfg (C_Compiler & _inLexique,
  ...
  var_cas_itt = GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "posix_it" COMMA_SOURCE_FILE_AT_LINE (151))) ;
  GGS_bool var_cas_tp ;
  ...
  var_cas_cfg = GGS_os_config ::constructor_new (_inLexique, GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), var_cas_tp, GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), GGS_bool (false), var_cas_itt, GGS_uint (1U) COMMA_HERE) ;
  #ifdef DEBUG_TRACE_ENABLED
