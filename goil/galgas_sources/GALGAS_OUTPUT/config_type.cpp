...
isEqualToObject (const cPtr__AC_galgas_class * inOperand) const {
  ...
  if (equal) {
    const cPtr_os_config * _p = dynamic_cast <const cPtr_os_config *> (inOperand) ;
    ...
    equal = with_compilersettings._operator_isEqual (_p->with_compilersettings).boolValue ()
         ...
         && with_it_table._operator_isEqual (_p->with_it_table).boolValue ()
...
method_generate (C_Compiler & _inLexique,
  ...
  var_cas_res._dotAssign_operation (scalability_class.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (135))) ;
}
...
appendForDescription (C_Compiler & _inLexique,
  ...
  ioString << "->@os_config:"
           ...
           << with_it_table.reader_description  (_inLexique COMMA_THERE, inIndentation + 1)
...
GGS_os_config::
GGS_os_config (cPtr__AC_galgas_class * inPointer) {
...
_castFrom (C_Compiler & inLexique,
  ...
  if (inPointer != NULL) {
    ...
    if (ok) {
      _result = GGS_os_config (inPointer) ;
    }else{
...
AC_galgasClassRunTimeInformation * GGS_os_config::_galgasObjectRunTimeInfo (void) const {
...
GGS_os_config  function_os_cfg (C_Compiler & _inLexique,
  ...
  var_cas_itt = GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "posix_it" COMMA_SOURCE_FILE_AT_LINE (151))) ;
  GGS_bool var_cas_tp ;
  var_cas_tp = GGS_bool (true, false) ;
  {
    GGS_task_map::cEnumerator enumerator_4251 (var_cas_cpu.reader_tasks (_inLexique COMMA_SOURCE_FILE_AT_LINE (154)), true) ;
    const GGS_task_map::cElement * operand_4251 = NULL ;
    while (((operand_4251 = enumerator_4251.nextObject ()))) {
      macroValidPointer (operand_4251) ;
      { const GGS_timing_prot _var_4351 = operand_4251->mInfo.task.reader_timing_prot (_inLexique COMMA_SOURCE_FILE_AT_LINE (155)) ; // CAST instruction
        if (_var_4351.getPtr () != NULL) {
          macroValidPointer (_var_4351.getPtr ()) ;
          if (typeid (cPtr_timing_prot_task) == typeid (* (_var_4351.getPtr ()))) {
            var_cas_tp = GGS_bool (true, true) ;
          }else{
          }
        }
      }
  ...
  {
    GGS_isr_map::cEnumerator enumerator_4384 (var_cas_cpu.reader_isrs (_inLexique COMMA_SOURCE_FILE_AT_LINE (159)), true) ;
    const GGS_isr_map::cElement * operand_4384 = NULL ;
    while (((operand_4384 = enumerator_4384.nextObject ()))) {
      macroValidPointer (operand_4384) ;
      { const GGS_timing_prot _var_4481 = operand_4384->mInfo.isr.reader_timing_prot (_inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ; // CAST instruction
        if (_var_4481.getPtr () != NULL) {
          macroValidPointer (_var_4481.getPtr ()) ;
          if (typeid (cPtr_timing_prot_isr) == typeid (* (_var_4481.getPtr ()))) {
            var_cas_tp = GGS_bool (true, true) ;
          }else{
          }
        }
  ...
  var_cas_cfg = GGS_os_config ::constructor_new (_inLexique, GGS_bool (true, false), GGS_bool (true, false), GGS_bool (true, false), GGS_bool (true, false), GGS_bool (true, false), var_cas_tp, GGS_bool (true, false), GGS_bool (true, false), GGS_bool (true, false), GGS_bool (true, false), GGS_bool (true, false), GGS_bool (true, false), GGS_bool (true, false), GGS_bool (true, false), GGS_bool (true, false), GGS_bool (true, false), var_cas_itt, GGS_uint (true, 1U) COMMA_HERE) ;
  #ifdef DEBUG_TRACE_ENABLED
