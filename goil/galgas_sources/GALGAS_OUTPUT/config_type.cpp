...
//                    november 30th, 2009, at 10h44'30"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_os_config ("os_config", true, NULL) ;
...
C_galgasRootClassRunTimeInformation gClassInfoFor__os_config ("os_config", & kTypeDescriptor_GGS_os_config) ;
...
const C_galgas_type_descriptor * GGS_os_config::typeDescriptor (void) const {
...
GGS_os_config  function_os_cfg (C_Compiler & inLexique,
  ...
  {
    GGS_task_map::cEnumerator enumerator_4261 (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (154)), true) ;
    const GGS_task_map::cElement * operand_4261 = NULL ;
    while (((operand_4261 = enumerator_4261.nextObject ()))) {
      macroValidPointer (operand_4261) ;
      { const GGS_timing_prot _var_4361 = operand_4261->mInfo.task.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (155)) ; // CAST instruction
        if (_var_4361.getPtr () != NULL) {
          macroValidPointer (_var_4361.getPtr ()) ;
          if (typeid (cPtr_timing_prot_task) == typeid (* (_var_4361.getPtr ()))) {
  ...
  {
    GGS_isr_map::cEnumerator enumerator_4394 (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (159)), true) ;
    const GGS_isr_map::cElement * operand_4394 = NULL ;
    while (((operand_4394 = enumerator_4394.nextObject ()))) {
      macroValidPointer (operand_4394) ;
      { const GGS_timing_prot _var_4491 = operand_4394->mInfo.isr.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ; // CAST instruction
        if (_var_4491.getPtr () != NULL) {
          macroValidPointer (_var_4491.getPtr ()) ;
          if (typeid (cPtr_timing_prot_isr) == typeid (* (_var_4491.getPtr ()))) {
            var_cas_tp = GGS_bool (true) ;
          }else{
          }
        }
