...
GGS_os_config  function_os_cfg (C_Compiler & inLexique,
  ...
  var_cas_itt = GGS_bool (inLexique.boolOptionValueFromKeys ("goil_options", "posix_it" COMMA_SOURCE_FILE_AT_LINE (151))) ;
  GGS_bool var_cas_tp ;
  var_cas_tp = GGS_bool (false) ;
  {
    GGS_task_map::cEnumerator enumerator_4251 (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (154)), true) ;
    const GGS_task_map::cElement * operand_4251 = NULL ;
    while (((operand_4251 = enumerator_4251.nextObject ()))) {
      macroValidPointer (operand_4251) ;
      { const GGS_timing_prot _var_4351 = operand_4251->mInfo.task.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (155)) ; // CAST instruction
  ...
  {
    GGS_isr_map::cEnumerator enumerator_4384 (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (159)), true) ;
    const GGS_isr_map::cElement * operand_4384 = NULL ;
    while (((operand_4384 = enumerator_4384.nextObject ()))) {
      macroValidPointer (operand_4384) ;
      { const GGS_timing_prot _var_4481 = operand_4384->mInfo.isr.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ; // CAST instruction
