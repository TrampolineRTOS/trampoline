...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@static_netprop:"
           << loc.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << size_in_bits.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << bit_ordering.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << bit_position.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << data_interpretation.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << initial_value.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << direction.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@dynamic_netprop:"
           << loc.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << max_size_in_bits.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << bit_ordering.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << bit_position.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << initial_value.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << direction.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@netmess_obj:"
           ...
           << netprop.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.netmess.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
