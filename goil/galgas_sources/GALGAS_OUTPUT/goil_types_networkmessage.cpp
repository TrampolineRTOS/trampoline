...
method_generate (C_Compiler & _inLexique,
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_retrieveTemplateString (_inLexique,  var_cas_res,  (direction.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (25)))._operator_concat (GGS_string (true, "_nm")) COMMA_SOURCE_FILE_AT_LINE (25)) ;
}
...
method_generate (C_Compiler & _inLexique,
                                GGS_string& var_cas_res COMMA_UNUSED_LOCATION_ARGS) const {
  ::routine_retrieveTemplateString (_inLexique,  var_cas_res,  (direction.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (43)))._operator_concat (GGS_string (true, "_nm")) COMMA_SOURCE_FILE_AT_LINE (43)) ;
}
...
method_generate (C_Compiler & _inLexique,
  ...
  if (_temp_1349._isBuilt ()) {
    _temp_1349 (HERE)->method_generate (_inLexique, var_cas_res COMMA_SOURCE_FILE_AT_LINE (51)) ;
  }
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string (true, "$NAME$"),  var_cas_name.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (52)) COMMA_SOURCE_FILE_AT_LINE (52)) ;
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string (true, "$CTYPE$"),  var_cas_ctype COMMA_SOURCE_FILE_AT_LINE (53)) ;
  if (((var_cas_inval)._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    var_cas_inval = (GGS_string (true, " = "))._operator_concat (var_cas_inval) ;
  }
  ::routine_doReplace (_inLexique,  var_cas_res,  GGS_string (true, "$INITIALVALUE$"),  var_cas_inval COMMA_SOURCE_FILE_AT_LINE (57)) ;
}
...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "|-value " << inElementIndex << ":" << mInfo.netmess.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
