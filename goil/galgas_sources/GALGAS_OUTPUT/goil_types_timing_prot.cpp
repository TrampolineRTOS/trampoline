...
void routine_gen_rez_table (C_Compiler & inLexique,
  ...
  {
    GGS_resource_map::cEnumerator enumerator_703 (var_cas_rez, true) ;
    const GGS_resource_map::cElement * operand_703 = NULL ;
    while (((operand_703 = enumerator_703.nextObject ()))) {
      macroValidPointer (operand_703) ;
      const GGS_bool cond_914 = var_cas_rezlocks.reader_hasKey (operand_703->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (24))) ;
      if (cond_914.isBuiltAndTrue ()) {
        GGS_uint64  var_cas_time ;
        const GGS_rezlock_map  temp_834 = var_cas_rezlocks ;
        if (temp_834.isBuilt ()) {
          temp_834 (HERE)->method_get (inLexique, operand_703->mKey, var_cas_time COMMA_SOURCE_FILE_AT_LINE (26)) ;
        }
      ...
      }else if (cond_914.isBuiltAndFalse ()) {
        var_cas_table.appendCString ("    0") ;
      }
      const GGS_bool cond_1040 = (var_cas_i).operator_strictInf (var_cas_rez.reader_count ().substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (31))) ;
      if (cond_1040.isBuiltAndTrue ()) {
        var_cas_table.appendCString (",\n") ;
      }else if (cond_1040.isBuiltAndFalse ()) {
        var_cas_table.appendCString ("\n") ;
      }
...
method_generate (C_Compiler & inLexique,
  ...
  const GGS_bool cond_2700 = var_cas_cfg.reader_hasKey (GGS_string ("wd_ticks_per_ns")) ;
  if (cond_2700.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_val ;
    const GGS_config  temp_2528 = var_cas_cfg ;
    if (temp_2528.isBuilt ()) {
      temp_2528 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("wd_ticks_per_ns"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (93)), var_cas_val COMMA_SOURCE_FILE_AT_LINE (93)) ;
    }
    { const GGS_basic_type _var_2681 = var_cas_val ; // CAST instruction
      if (_var_2681.getPtr () != NULL) {
        macroValidPointer (_var_2681.getPtr ()) ;
        if (typeid (cPtr_uint64_class) == typeid (* (_var_2681.getPtr ()))) {
          const GGS_uint64_class var_cas_ui (_var_2681.getPtr ()) ;
  ...
  { const GGS_basic_type _var_2958 = exe_budget ; // CAST instruction
    if (_var_2958.getPtr () != NULL) {
      macroValidPointer (_var_2958.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_2958.getPtr ()))) {
        const GGS_uint64_class var_cas_eb (_var_2958.getPtr ()) ;
  ...
  { const GGS_basic_type _var_3151 = time_frame ; // CAST instruction
    if (_var_3151.getPtr () != NULL) {
      macroValidPointer (_var_3151.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_3151.getPtr ()))) {
        const GGS_uint64_class var_cas_tf (_var_3151.getPtr ()) ;
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$TIME_FRAME$"), var_cas_tf.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (107)).divide_operation (inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (107)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (107)) ;
      }else{
      }
    }
  }
  { const GGS_basic_type _var_3346 = os_it_lock ; // CAST instruction
    if (_var_3346.getPtr () != NULL) {
      macroValidPointer (_var_3346.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_3346.getPtr ()))) {
        const GGS_uint64_class var_cas_oil (_var_3346.getPtr ()) ;
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$OS_IT_LOCK$"), var_cas_oil.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (111)).divide_operation (inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (111)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (111)) COMMA_SOURCE_FILE_AT_LINE (111)) ;
      }else{
      }
    }
  }
  { const GGS_basic_type _var_3542 = all_it_lock ; // CAST instruction
    if (_var_3542.getPtr () != NULL) {
      macroValidPointer (_var_3542.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_3542.getPtr ()))) {
        const GGS_uint64_class var_cas_ail (_var_3542.getPtr ()) ;
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$ALL_IT_LOCK$"), var_cas_ail.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (115)).divide_operation (inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (115)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (115)) COMMA_SOURCE_FILE_AT_LINE (115)) ;
      }else{
      }
    }
  }
  var_cas_st_name = ((GGS_string ("task_")).operator_concat (var_cas_name)).operator_concat (GGS_string ("_timing_prot")) ;
  var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$TIMING_PROT$"), var_cas_st_name COMMA_SOURCE_FILE_AT_LINE (119)) ;
  ...
  ::routine_gen_rez_table (inLexique,  rezlocks,  var_cas_rez,  var_cas_tpn,  var_cas_table COMMA_SOURCE_FILE_AT_LINE (123)) ;
  const GGS_bool cond_3990 = (var_cas_rez.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_3990.isBuiltAndTrue ()) {
    var_cas_table = ((((((GGS_string ("tpl_time ")).operator_concat (var_cas_table_name)).operator_concat (GGS_string ("["))).operator_concat (var_cas_rez.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (126)))).operator_concat (GGS_string ("] = {\n"))).operator_concat (var_cas_table)).operator_concat (GGS_string ("};")) ;
  }
  var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$LOCK_TIME_TABLE$"), var_cas_table COMMA_SOURCE_FILE_AT_LINE (129)) ;
  const GGS_bool cond_4227 = (var_cas_rez.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_4227.isBuiltAndTrue ()) {
    var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$REZ_LOCK_TIME$"), var_cas_table_name COMMA_SOURCE_FILE_AT_LINE (132)) ;
  }else if (cond_4227.isBuiltAndFalse ()) {
    var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$REZ_LOCK_TIME$"), GGS_string ("NULL") COMMA_SOURCE_FILE_AT_LINE (134)) ;
  }
...
method_generate (C_Compiler & inLexique,
                                ...
                                GGS_resource_map  var_cas_rez COMMA_UNUSED_LOCATION_ARGS) const {
  GGS_uint64  var_cas_tpn = GGS_uint64 (1ULL) ;
  const GGS_bool cond_5054 = var_cas_cfg.reader_hasKey (GGS_string ("wd_ticks_per_ns")) ;
  if (cond_5054.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_val ;
    const GGS_config  temp_4882 = var_cas_cfg ;
    if (temp_4882.isBuilt ()) {
      temp_4882 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("wd_ticks_per_ns"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (158)), var_cas_val COMMA_SOURCE_FILE_AT_LINE (158)) ;
    }
    { const GGS_basic_type _var_5035 = var_cas_val ; // CAST instruction
      if (_var_5035.getPtr () != NULL) {
        macroValidPointer (_var_5035.getPtr ()) ;
        if (typeid (cPtr_uint64_class) == typeid (* (_var_5035.getPtr ()))) {
          const GGS_uint64_class var_cas_ui (_var_5035.getPtr ()) ;
          var_cas_tpn = var_cas_ui.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (160)) ;
        }else{
        }
      }
    }
  }
  var_cas_result = function_template_string (inLexique, GGS_string ("code"), GGS_string ("timing_protection") COMMA_SOURCE_FILE_AT_LINE (164)) ;
  { const GGS_basic_type _var_5310 = exe_time ; // CAST instruction
    if (_var_5310.getPtr () != NULL) {
      macroValidPointer (_var_5310.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_5310.getPtr ()))) {
        const GGS_uint64_class var_cas_et (_var_5310.getPtr ()) ;
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$EXE_BUDGET$"), var_cas_et.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (168)).divide_operation (inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (168)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (168)) COMMA_SOURCE_FILE_AT_LINE (168)) ;
      }else{
      }
    }
  }
  { const GGS_basic_type _var_5503 = time_frame ; // CAST instruction
    if (_var_5503.getPtr () != NULL) {
      macroValidPointer (_var_5503.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_5503.getPtr ()))) {
        const GGS_uint64_class var_cas_tf (_var_5503.getPtr ()) ;
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$TIME_FRAME$"), var_cas_tf.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (172)).divide_operation (inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (172)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (172)) COMMA_SOURCE_FILE_AT_LINE (172)) ;
      }else{
      }
    }
  }
  { const GGS_basic_type _var_5698 = os_it_lock ; // CAST instruction
    if (_var_5698.getPtr () != NULL) {
      macroValidPointer (_var_5698.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_5698.getPtr ()))) {
        const GGS_uint64_class var_cas_oil (_var_5698.getPtr ()) ;
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$OS_IT_LOCK$"), var_cas_oil.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (176)).divide_operation (inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (176)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (176)) COMMA_SOURCE_FILE_AT_LINE (176)) ;
      }else{
      }
    }
  }
  { const GGS_basic_type _var_5894 = all_it_lock ; // CAST instruction
    if (_var_5894.getPtr () != NULL) {
      macroValidPointer (_var_5894.getPtr ()) ;
      if (typeid (cPtr_uint64_class) == typeid (* (_var_5894.getPtr ()))) {
        const GGS_uint64_class var_cas_ail (_var_5894.getPtr ()) ;
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$ALL_IT_LOCK$"), var_cas_ail.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (180)).divide_operation (inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (180)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (180)) COMMA_SOURCE_FILE_AT_LINE (180)) ;
      }else{
      }
    }
  }
  var_cas_st_name = ((GGS_string ("isr_")).operator_concat (var_cas_name)).operator_concat (GGS_string ("_timing_prot")) ;
  var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$TIMING_PROT$"), var_cas_st_name COMMA_SOURCE_FILE_AT_LINE (184)) ;
  GGS_string var_cas_table_name = ((GGS_string ("isr_")).operator_concat (var_cas_name)).operator_concat (GGS_string ("_rez_lock_time")) ;
  GGS_string var_cas_table = GGS_string ("") ;
  ::routine_gen_rez_table (inLexique,  rezlocks,  var_cas_rez,  var_cas_tpn,  var_cas_table COMMA_SOURCE_FILE_AT_LINE (188)) ;
  const GGS_bool cond_6339 = (var_cas_rez.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_6339.isBuiltAndTrue ()) {
    var_cas_table = ((((((GGS_string ("tpl_time ")).operator_concat (var_cas_table_name)).operator_concat (GGS_string ("["))).operator_concat (var_cas_rez.reader_count ().reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (191)))).operator_concat (GGS_string ("] = {\n"))).operator_concat (var_cas_table)).operator_concat (GGS_string ("};")) ;
  }
  var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$LOCK_TIME_TABLE$"), var_cas_table COMMA_SOURCE_FILE_AT_LINE (194)) ;
  const GGS_bool cond_6576 = (var_cas_rez.reader_count ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_6576.isBuiltAndTrue ()) {
    var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$REZ_LOCK_TIME$"), var_cas_table_name COMMA_SOURCE_FILE_AT_LINE (197)) ;
  }else if (cond_6576.isBuiltAndFalse ()) {
    var_cas_result = var_cas_result.reader_stringByReplacingStringByString (inLexique, GGS_string ("$REZ_LOCK_TIME$"), GGS_string ("NULL") COMMA_SOURCE_FILE_AT_LINE (199)) ;
  }
  var_cas_st_name = (GGS_string ("&")).operator_concat (var_cas_st_name) ;
}
