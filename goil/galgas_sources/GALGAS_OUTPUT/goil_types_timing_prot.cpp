  ...
  var_cas_i = GGS_uint (0U) ;
  {
    ...
    while (((operand_675 = enumerator_675.nextObject ()))) {
      ...
      if ((var_cas_rezlocks.reader_hasKey (inLexique, operand_675->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (24)) COMMA_SOURCE_FILE_AT_LINE (24))).isBuiltAndTrue ()) {
        ...
        if (_temp_806.isBuilt ()) {
          _temp_806 (HERE)->method_get (inLexique, operand_675->mKey, var_cas_time COMMA_SOURCE_FILE_AT_LINE (26)) ;
        }
...
method_generate (C_Compiler & inLexique,
  ...
  if ((var_cas_cfg.reader_hasKey (inLexique, GGS_string ("wd_ticks_per_ns") COMMA_SOURCE_FILE_AT_LINE (91))).isBuiltAndTrue ()) {
    ...
    if (_temp_2500.isBuilt ()) {
      _temp_2500 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("wd_ticks_per_ns"), GGS_location (inLexique) COMMA_HERE), var_cas_val COMMA_SOURCE_FILE_AT_LINE (93)) ;
    }
...
method_generate (C_Compiler & inLexique,
  ...
  if ((var_cas_cfg.reader_hasKey (inLexique, GGS_string ("wd_ticks_per_ns") COMMA_SOURCE_FILE_AT_LINE (158))).isBuiltAndTrue ()) {
    ...
    if (_temp_4964.isBuilt ()) {
      _temp_4964 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("wd_ticks_per_ns"), GGS_location (inLexique) COMMA_HERE), var_cas_val COMMA_SOURCE_FILE_AT_LINE (160)) ;
    }
