...
appendForMapDescription (C_Compiler & _inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.time.reader_description  (_inLexique COMMA_THERE, inIndentation + 1) ;
}
...
void routine_gen_rez_table (C_Compiler & _inLexique,
  ...
  var_cas_i = GGS_uint (0U) ;
  {
    ...
    while (((operand_675 = enumerator_675.nextObject ()))) {
      ...
      if (((var_cas_i)._operator_strictInf (var_cas_rez.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (31))._substract_operation (_inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (31)))).isBuiltAndTrue ()) {
        var_cas_table.appendCString (",\n") ;
      }else{
        var_cas_table.appendCString ("\n") ;
      }
...
method_generate (C_Compiler & _inLexique,
  ...
  if ((var_cas_cfg.reader_hasKey (_inLexique, GGS_string ("wd_ticks_per_ns") COMMA_SOURCE_FILE_AT_LINE (91))).isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_val ;
    const GGS_config  _temp_2500 = var_cas_cfg ;
    if (_temp_2500.isBuilt ()) {
      _temp_2500 (HERE)->method_get (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("wd_ticks_per_ns"), GGS_location (_inLexique) COMMA_HERE), var_cas_val COMMA_SOURCE_FILE_AT_LINE (93)) ;
    }
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_result,  GGS_string ("timing_protection") COMMA_SOURCE_FILE_AT_LINE (99)) ;
  { const GGS_basic_type _var_2927 = exe_budget ; // CAST instruction
    if (_var_2927.getPtr () != NULL) {
      ...
      if (typeid (cPtr_uint64_class) == typeid (* (_var_2927.getPtr ()))) {
        ...
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$EXE_BUDGET$"), var_cas_eb.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (103))._divide_operation (_inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (103)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (103)) COMMA_SOURCE_FILE_AT_LINE (103)) ;
      }else{
      }
    }
  }
  var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$COUNT_LIMIT$"), GGS_string ("0") COMMA_SOURCE_FILE_AT_LINE (105)) ;
  ...
  { const GGS_basic_type _var_3398 = os_it_lock ; // CAST instruction
    if (_var_3398.getPtr () != NULL) {
      ...
      if (typeid (cPtr_uint64_class) == typeid (* (_var_3398.getPtr ()))) {
        ...
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$OS_IT_LOCK$"), var_cas_oil.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (112))._divide_operation (_inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (112)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (112)) COMMA_SOURCE_FILE_AT_LINE (112)) ;
      }else{
      }
    }
  }
  { const GGS_basic_type _var_3594 = all_it_lock ; // CAST instruction
    if (_var_3594.getPtr () != NULL) {
      ...
      if (typeid (cPtr_uint64_class) == typeid (* (_var_3594.getPtr ()))) {
        ...
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$ALL_IT_LOCK$"), var_cas_ail.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (116))._divide_operation (_inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (116)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (116)) COMMA_SOURCE_FILE_AT_LINE (116)) ;
      }else{
      }
    }
  }
  var_cas_st_name = ((GGS_string ("task_"))._operator_concat (var_cas_name))._operator_concat (GGS_string ("_timing_prot")) ;
  var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$TIMING_PROT$"), var_cas_st_name COMMA_SOURCE_FILE_AT_LINE (120)) ;
  GGS_string var_cas_table_name ;
  var_cas_table_name = ((GGS_string ("task_"))._operator_concat (var_cas_name))._operator_concat (GGS_string ("_rez_lock_time")) ;
  ...
  if (((var_cas_rez.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (126)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    var_cas_table = ((((((GGS_string ("tpl_time "))._operator_concat (var_cas_table_name))._operator_concat (GGS_string ("[")))._operator_concat (var_cas_rez.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (127)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (127))))._operator_concat (GGS_string ("] = {\n")))._operator_concat (var_cas_table))._operator_concat (GGS_string ("};")) ;
  }
  var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$LOCK_TIME_TABLE$"), var_cas_table COMMA_SOURCE_FILE_AT_LINE (130)) ;
  if (((var_cas_rez.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (132)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$REZ_LOCK_TIME$"), var_cas_table_name COMMA_SOURCE_FILE_AT_LINE (133)) ;
  }else{
    var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$REZ_LOCK_TIME$"), GGS_string ("NULL") COMMA_SOURCE_FILE_AT_LINE (135)) ;
  }
  var_cas_st_name = (GGS_string ("&"))._operator_concat (var_cas_st_name) ;
}
...
method_generate (C_Compiler & _inLexique,
  ...
  GGS_uint64  var_cas_tpn ;
  var_cas_tpn = GGS_uint64 (1U) ;
  if ((var_cas_cfg.reader_hasKey (_inLexique, GGS_string ("wd_ticks_per_ns") COMMA_SOURCE_FILE_AT_LINE (158))).isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_val ;
    const GGS_config  _temp_4964 = var_cas_cfg ;
    if (_temp_4964.isBuilt ()) {
      _temp_4964 (HERE)->method_get (_inLexique, GGS_lstring ::constructor_new (_inLexique, GGS_string ("wd_ticks_per_ns"), GGS_location (_inLexique) COMMA_HERE), var_cas_val COMMA_SOURCE_FILE_AT_LINE (160)) ;
    }
  ...
  ::routine_retrieveTemplateString (_inLexique,  var_cas_result,  GGS_string ("timing_protection") COMMA_SOURCE_FILE_AT_LINE (166)) ;
  { const GGS_basic_type _var_5389 = exe_time ; // CAST instruction
    if (_var_5389.getPtr () != NULL) {
      ...
      if (typeid (cPtr_uint64_class) == typeid (* (_var_5389.getPtr ()))) {
        ...
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$EXE_BUDGET$"), var_cas_et.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (170))._divide_operation (_inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (170)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (170)) COMMA_SOURCE_FILE_AT_LINE (170)) ;
      }else{
      }
    }
  }
  { const GGS_basic_type _var_5579 = count_limit ; // CAST instruction
    if (_var_5579.getPtr () != NULL) {
      ...
      if (typeid (cPtr_uint32_class) == typeid (* (_var_5579.getPtr ()))) {
        ...
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$COUNT_LIMIT$"), var_cas_cl.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (174)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (174)) ;
      }else{
      }
    }
  }
  ...
  { const GGS_basic_type _var_5967 = os_it_lock ; // CAST instruction
    if (_var_5967.getPtr () != NULL) {
      ...
      if (typeid (cPtr_uint64_class) == typeid (* (_var_5967.getPtr ()))) {
        ...
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$OS_IT_LOCK$"), var_cas_oil.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (182))._divide_operation (_inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (182)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)) ;
      }else{
      }
    }
  }
  { const GGS_basic_type _var_6163 = all_it_lock ; // CAST instruction
    if (_var_6163.getPtr () != NULL) {
      ...
      if (typeid (cPtr_uint64_class) == typeid (* (_var_6163.getPtr ()))) {
        ...
        var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$ALL_IT_LOCK$"), var_cas_ail.reader_value (_inLexique COMMA_SOURCE_FILE_AT_LINE (186))._divide_operation (_inLexique, var_cas_tpn COMMA_SOURCE_FILE_AT_LINE (186)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (186)) ;
      }else{
      }
    }
  }
  var_cas_st_name = ((GGS_string ("isr_"))._operator_concat (var_cas_name))._operator_concat (GGS_string ("_timing_prot")) ;
  var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$TIMING_PROT$"), var_cas_st_name COMMA_SOURCE_FILE_AT_LINE (190)) ;
  GGS_string var_cas_table_name ;
  var_cas_table_name = ((GGS_string ("isr_"))._operator_concat (var_cas_name))._operator_concat (GGS_string ("_rez_lock_time")) ;
  GGS_string var_cas_table ;
  var_cas_table = GGS_string ("") ;
  ::routine_gen_rez_table (_inLexique,  rezlocks,  var_cas_rez,  var_cas_tpn,  var_cas_table COMMA_SOURCE_FILE_AT_LINE (194)) ;
  if (((var_cas_rez.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (196)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    var_cas_table = ((((((GGS_string ("tpl_time "))._operator_concat (var_cas_table_name))._operator_concat (GGS_string ("[")))._operator_concat (var_cas_rez.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (197)).reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (197))))._operator_concat (GGS_string ("] = {\n")))._operator_concat (var_cas_table))._operator_concat (GGS_string ("};")) ;
  }
  var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$LOCK_TIME_TABLE$"), var_cas_table COMMA_SOURCE_FILE_AT_LINE (200)) ;
  if (((var_cas_rez.reader_count (_inLexique COMMA_SOURCE_FILE_AT_LINE (202)))._operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
    var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$REZ_LOCK_TIME$"), var_cas_table_name COMMA_SOURCE_FILE_AT_LINE (203)) ;
  }else{
    var_cas_result = var_cas_result.reader_stringByReplacingStringByString (_inLexique, GGS_string ("$REZ_LOCK_TIME$"), GGS_string ("NULL") COMMA_SOURCE_FILE_AT_LINE (205)) ;
  }
  var_cas_st_name = (GGS_string ("&"))._operator_concat (var_cas_st_name) ;
}
