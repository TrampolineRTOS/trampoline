...
pr_free_field_goil_syntax_339_17_ (goil_lexique & inLexique,
  ...
  var_cas_ids.modifier_put (inLexique, var_cas_idf, var_cas_val COMMA_SOURCE_FILE_AT_LINE (357)) ;
}
...
void goil_syntax::
pr_include_file_level_goil_syntax_360_25_ (goil_lexique & inLexique,
                                GGS_implementation  &var_cas_imp,
                                GGS_root_obj  &var_cas_cpu) {
  ...
  switch (select_goil_syntax_5 (inLexique)) {
    case 1 : {
      ...
      ::routine_file_in_path (inLexique,  var_cas_file_name COMMA_SOURCE_FILE_AT_LINE (368)) ;
      } break ;
    case 2 : {
      inLexique.assignFromAttribute_a_string (var_cas_file_name) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_string) COMMA_HERE) ;
...
void goil_syntax::
pr_include_cpu_level_goil_syntax_378_24_ (goil_lexique & inLexique,
                                GGS_os_obj  &var_cas_os,
                                GGS_com  &var_cas_com,
                                GGS_task_map  &var_cas_tasks,
                                GGS_counter_map  &var_cas_counters,
  ...
  switch (select_goil_syntax_6 (inLexique)) {
    case 1 : {
      inLexique.assignFromAttribute_a_string (var_cas_file_name) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_g_5F_string) COMMA_HERE) ;
      ::routine_file_in_path (inLexique,  var_cas_file_name COMMA_SOURCE_FILE_AT_LINE (396)) ;
      } break ;
    case 2 : {
      inLexique.assignFromAttribute_a_string (var_cas_file_name) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_string) COMMA_HERE) ;
