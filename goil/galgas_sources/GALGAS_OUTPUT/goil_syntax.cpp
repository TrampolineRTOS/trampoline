...
void cParser_goil_5F_syntax::rule_goil_5F_syntax_start_i0_ (C_Lexique_goil_5F_lexique * inCompiler) {
  ...
  inCompiler->setParsingContext (parsingContext_0) ; // rewind
    ...
    if (GALGAS_bool (kIsNotEqual, var_oilConfigFile.objectCompare (GALGAS_string (""))).isValidAndTrue ()) {
      ...
      //-------- @ifInstructionForGeneration
      if (GALGAS_bool (kIsEqual, var_appli_5F_exist.objectCompare (GALGAS_bool (true))).isValidAndTrue ()) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @ifInstructionForGeneration
  if (GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (inCompiler COMMA_SOURCE_FILE_AT_LINE (232)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).isValidAndTrue ()) {
    { //-------- @routineCallInstructionForGeneration
...
void cParser_goil_5F_syntax::rule_goil_5F_syntax_file_i1_ (GALGAS_implementation & ioArgument_imp,
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_lstring var_version = GALGAS_lstring::constructor_new (GALGAS_string (""), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (242)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_lstring var_desc = GALGAS_lstring::constructor_new (GALGAS_string (""), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (243)) ;
...
void cParser_goil_5F_syntax::rule_goil_5F_syntax_description_i2_ (GALGAS_lstring & outArgument_desc,
  ...
  case 1: {
    //-------- @assignmentInstructionForGeneration
    outArgument_desc = GALGAS_lstring::constructor_new (GALGAS_string (""), inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (279)) ;
  } break ;
  case 2: {
