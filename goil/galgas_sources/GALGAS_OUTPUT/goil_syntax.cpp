...
pr_application_definition_goil_syntax_216_29_ (goil_lexique & inLexique,
  ...
  inLexique.assignFromAttribute_att_token (var_cas_cpuName) ;
  ...
  GGS_lstring  automatic_var_7041_0 ;
  nt_description_ (inLexique, automatic_var_7041_0) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
...
void goil_syntax::
pr_object_definition_list_goil_syntax_270_29_ (goil_lexique & inLexique,
    ...
    while (syntaxRepeat_2) {
      switch (select_goil_syntax_2 (inLexique)) {
        ...
        case 6 : {
          ...
          GGS_lstring  automatic_var_7918_0 ;
          nt_description_ (inLexique, automatic_var_7918_0) ;
          } break ;
        case 7 : {
          nt_resource_ (inLexique, var_cas_resources) ;
          GGS_lstring  automatic_var_7970_0 ;
          nt_description_ (inLexique, automatic_var_7970_0) ;
          } break ;
        case 8 : {
          nt_event_ (inLexique, var_cas_events) ;
          GGS_lstring  automatic_var_8016_0 ;
          nt_description_ (inLexique, automatic_var_8016_0) ;
          } break ;
        case 9 : {
          nt_isr_ (inLexique, var_cas_isrs) ;
          GGS_lstring  automatic_var_8058_0 ;
          nt_description_ (inLexique, automatic_var_8058_0) ;
          } break ;
        case 10 : {
          nt_mess_ (inLexique, var_cas_messages) ;
          GGS_lstring  automatic_var_8105_0 ;
          nt_description_ (inLexique, automatic_var_8105_0) ;
          } break ;
        case 11 : {
          nt_networkmess_ (inLexique, var_cas_net_messages) ;
          GGS_lstring  automatic_var_8163_0 ;
          nt_description_ (inLexique, automatic_var_8163_0) ;
          } break ;
        case 12 : {
          nt_com_ (inLexique, var_cas_com) ;
          GGS_lstring  automatic_var_8204_0 ;
          nt_description_ (inLexique, automatic_var_8204_0) ;
          } break ;
        case 13 : {
          nt_ipdu_ (inLexique) ;
          GGS_lstring  automatic_var_8240_0 ;
          nt_description_ (inLexique, automatic_var_8240_0) ;
          } break ;
        case 14 : {
          nt_nm_ (inLexique) ;
          GGS_lstring  automatic_var_8274_0 ;
          nt_description_ (inLexique, automatic_var_8274_0) ;
          } break ;
        case 15 : {
          nt_scheduletable_ (inLexique, var_cas_scheduletables) ;
          GGS_lstring  automatic_var_8336_0 ;
          nt_description_ (inLexique, automatic_var_8336_0) ;
          } break ;
        case 16 : {
          nt_appli_ (inLexique, var_cas_applis) ;
          GGS_lstring  automatic_var_8382_0 ;
          nt_description_ (inLexique, automatic_var_8382_0) ;
          } break ;
        case 17 : {
...
void goil_syntax::
pr_nm_goil_syntax_318_9_ (goil_lexique & inLexique) {
...
void goil_syntax::
pr_boolean_goil_syntax_329_14_ (goil_lexique & inLexique,
...
void goil_syntax::
pr_free_field_goil_syntax_339_17_ (goil_lexique & inLexique,
  ...
  switch (select_goil_syntax_4 (inLexique)) {
    case 1 : {
      ...
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
      var_cas_val = GGS_string_class ::constructor_new (inLexique, var_cas_value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (347)), var_cas_value.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (347)) COMMA_HERE) ;
      } break ;
    case 2 : {
      ...
      var_cas_val = GGS_uint64_class ::constructor_new (inLexique, var_cas_value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (351)), var_cas_value.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (351)) COMMA_HERE) ;
      } break ;
    case 3 : {
      GGS_lbool  var_cas_value ;
      nt_boolean_ (inLexique, var_cas_value) ;
      var_cas_val = GGS_bool_class ::constructor_new (inLexique, var_cas_idf.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (355)), var_cas_value.reader_bool (inLexique COMMA_SOURCE_FILE_AT_LINE (355)) COMMA_HERE) ;
      } break ;
    default :
      break ;
  }
  var_cas_ids.modifier_put (inLexique, var_cas_idf, var_cas_val COMMA_SOURCE_FILE_AT_LINE (359)) ;
}
...
void goil_syntax::
pr_include_file_level_goil_syntax_362_25_ (goil_lexique & inLexique,
                                GGS_implementation  &var_cas_imp,
                                GGS_root_obj  &var_cas_cpu) {
  ...
  switch (select_goil_syntax_5 (inLexique)) {
    case 1 : {
      ...
      ::routine_file_in_path (inLexique,  var_cas_file_name COMMA_SOURCE_FILE_AT_LINE (370)) ;
      } break ;
    case 2 : {
      inLexique.assignFromAttribute_a_string (var_cas_file_name) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_string) COMMA_HERE) ;
...
void goil_syntax::
pr_include_cpu_level_goil_syntax_380_24_ (goil_lexique & inLexique,
                                GGS_os_obj  &var_cas_os,
                                GGS_com  &var_cas_com,
                                GGS_task_map  &var_cas_tasks,
                                GGS_counter_map  &var_cas_counters,
  ...
  switch (select_goil_syntax_6 (inLexique)) {
    case 1 : {
      inLexique.assignFromAttribute_a_string (var_cas_file_name) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_g_5F_string) COMMA_HERE) ;
      ::routine_file_in_path (inLexique,  var_cas_file_name COMMA_SOURCE_FILE_AT_LINE (398)) ;
      } break ;
    case 2 : {
      inLexique.assignFromAttribute_a_string (var_cas_file_name) ;
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_string) COMMA_HERE) ;
