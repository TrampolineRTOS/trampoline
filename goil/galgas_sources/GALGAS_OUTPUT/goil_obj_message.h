...
class goil_obj_message {
  ...
  protected : void pr_rue_attributes_goil_obj_message_667_21_ (goil_lexique &,
                                GGS_mess_prop_obj  &) ;

  protected : virtual PMSInt16 select_goil_obj_message_11 (goil_lexique &) = 0 ;

  protected : void pr_rqe_attributes_goil_obj_message_724_21_ (goil_lexique &,
                                GGS_mess_prop_obj  &) ;

  protected : virtual PMSInt16 select_goil_obj_message_12 (goil_lexique &) = 0 ;

  protected : void pr_rde_attributes_goil_obj_message_789_21_ (goil_lexique &,
                                GGS_mess_prop_obj  &) ;

  protected : virtual PMSInt16 select_goil_obj_message_13 (goil_lexique &) = 0 ;

  protected : void pr_rzs_attributes_goil_obj_message_827_21_ (goil_lexique &,
                                GGS_mess_prop_obj  &) ;

  protected : virtual PMSInt16 select_goil_obj_message_14 (goil_lexique &) = 0 ;

  protected : void pr_cdatatype_goil_obj_message_863_16_ (goil_lexique &,
                                GGS_lstring  &) ;

  protected : void pr_transferproperty_goil_obj_message_872_23_ (goil_lexique &,
                                GGS_lstring  &) ;

  protected : virtual PMSInt16 select_goil_obj_message_15 (goil_lexique &) = 0 ;

  protected : void pr_networkmessage_goil_obj_message_888_21_ (goil_lexique &,
                                GGS_lstring  &) ;

  protected : void pr_filter_goil_obj_message_897_13_ (goil_lexique &,
                                GGS_filter_prop_obj  &) ;

  protected : virtual PMSInt16 select_goil_obj_message_16 (goil_lexique &) = 0 ;

  protected : void pr_mask_x_attribute_goil_obj_message_970_23_ (goil_lexique &,
                                GGS_luint64  &,
                                GGS_luint64  &) ;

  protected : virtual PMSInt16 select_goil_obj_message_17 (goil_lexique &) = 0 ;

  protected : void pr_mask_attribute_goil_obj_message_1003_21_ (goil_lexique &,
                                GGS_luint64  &) ;

  protected : void pr_min_max_attribute_goil_obj_message_1011_24_ (goil_lexique &,
                                GGS_luint64  &,
                                GGS_luint64  &) ;

  protected : virtual PMSInt16 select_goil_obj_message_18 (goil_lexique &) = 0 ;

  protected : void pr_period_offset_attribute_goil_obj_message_1044_30_ (goil_lexique &,
                                GGS_luint64  &,
                                GGS_luint64  &) ;

  protected : virtual PMSInt16 select_goil_obj_message_19 (goil_lexique &) = 0 ;

  protected : void pr_networkordercallout_goil_obj_message_1077_26_ (goil_lexique &,
                                GGS_lstring  &) ;

  protected : void pr_cpuordercallout_goil_obj_message_1086_22_ (goil_lexique &,
                                GGS_lstring  &) ;

  protected : void pr_initialvalue_goil_obj_message_1095_19_ (goil_lexique &,
                                GGS_basic_type  &) ;

  protected : virtual PMSInt16 select_goil_obj_message_20 (goil_lexique &) = 0 ;

  protected : void pr_sendingmessage_goil_obj_message_1116_21_ (goil_lexique &,
                                GGS_lstring  &) ;

  protected : void pr_queuesize_goil_obj_message_1125_16_ (goil_lexique &,
                                GGS_luint64  &) ;

  protected : void pr_link_goil_obj_message_1134_11_ (goil_lexique &,
                                GGS_link_obj  &) ;
