...
void routine_setTraceFlag (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_trace _var_54779 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1323)).reader_trace (inLexique COMMA_SOURCE_FILE_AT_LINE (1323)) ; // CAST instruction
    if (_var_54779.getPtr () != NULL) {
      macroValidPointer (_var_54779.getPtr ()) ;
      if (typeid (cPtr_trace) == typeid (* (_var_54779.getPtr ()))) {
        const GGS_trace var_cas_noTrace (_var_54779.getPtr ()) ;
      ...
      }else if (typeid (cPtr_trace_off) == typeid (* (_var_54779.getPtr ()))) {
        const GGS_trace_off var_cas_traceOff (_var_54779.getPtr ()) ;
      ...
      }else if (typeid (cPtr_trace_on) == typeid (* (_var_54779.getPtr ()))) {
        const GGS_trace_on var_cas_traceOn (_var_54779.getPtr ()) ;
        ...
        ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACETASK"), var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1331)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1331)) COMMA_HERE),  function_getBool (inLexique, var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1331)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1331)) COMMA_SOURCE_FILE_AT_LINE (1331)) ;
        ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACEISR"), var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1332)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1332)) COMMA_HERE),  function_getBool (inLexique, var_cas_traceOn.reader_trace_isr (inLexique COMMA_SOURCE_FILE_AT_LINE (1332)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1332)) COMMA_SOURCE_FILE_AT_LINE (1332)) ;
        ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACERESOURCE"), var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1333)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1333)) COMMA_HERE),  function_getBool (inLexique, var_cas_traceOn.reader_trace_resource (inLexique COMMA_SOURCE_FILE_AT_LINE (1333)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1333)) COMMA_SOURCE_FILE_AT_LINE (1333)) ;
        ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACEALARM"), var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1334)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1334)) COMMA_HERE),  function_getBool (inLexique, var_cas_traceOn.reader_trace_alarm (inLexique COMMA_SOURCE_FILE_AT_LINE (1334)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1334)) COMMA_SOURCE_FILE_AT_LINE (1334)) ;
        ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACEUSEREVENT"), var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1335)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1335)) COMMA_HERE),  function_getBool (inLexique, var_cas_traceOn.reader_trace_user_event (inLexique COMMA_SOURCE_FILE_AT_LINE (1335)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1335)) COMMA_SOURCE_FILE_AT_LINE (1335)) ;
        { const GGS_trace_method _var_54762 = var_cas_traceOn.reader_meth (inLexique COMMA_SOURCE_FILE_AT_LINE (1336)) ; // CAST instruction
          if (_var_54762.getPtr () != NULL) {
            macroValidPointer (_var_54762.getPtr ()) ;
            if (typeid (cPtr_trace_file) == typeid (* (_var_54762.getPtr ()))) {
              const GGS_trace_file var_cas_traceFile (_var_54762.getPtr ()) ;
              ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACEMETHOD"), var_cas_traceOn.reader_meth (inLexique COMMA_SOURCE_FILE_AT_LINE (1338)).reader_loc (inLexique COMMA_SOURCE_FILE_AT_LINE (1338)) COMMA_HERE),  GGS_string ("file") COMMA_SOURCE_FILE_AT_LINE (1338)) ;
              ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACEFILE"), var_cas_traceFile.reader_name (inLexique COMMA_SOURCE_FILE_AT_LINE (1339)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1339)) COMMA_HERE),  var_cas_traceFile.reader_name (inLexique COMMA_SOURCE_FILE_AT_LINE (1339)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1339)) COMMA_SOURCE_FILE_AT_LINE (1339)) ;
            }else{
            }
          }
        }
...
void routine_setLinkScript (C_Compiler & inLexique,
  ...
  #endif
  GGS_string var_cas_linkScriptName = function_link_script_name (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1348)).reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (1348)) COMMA_SOURCE_FILE_AT_LINE (1348)) ;
  GGS_bool var_cas_useLinkScript = (var_cas_linkScriptName).operator_isNotEqual (GGS_string ("")) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USELINKSCRIPT"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1350)).reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (1350)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1350)) COMMA_HERE),  var_cas_useLinkScript COMMA_SOURCE_FILE_AT_LINE (1350)) ;
  const GGS_bool cond_55252 = var_cas_useLinkScript ;
  if (cond_55252.isBuiltAndTrue ()) {
    ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("LINKSCRIPT"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1352)).reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (1352)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1352)) COMMA_HERE),  var_cas_linkScriptName COMMA_SOURCE_FILE_AT_LINE (1352)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setMemoryMapping (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_56232 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1362)).reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (1362)) ; // CAST instruction
    if (_var_56232.getPtr () != NULL) {
      macroValidPointer (_var_56232.getPtr ()) ;
      if (typeid (cPtr_memmap_false) == typeid (* (_var_56232.getPtr ()))) {
        var_cas_useMemoryMapping = GGS_bool (false) ;
        var_cas_useCompilerSettings = GGS_bool (false) ;
      }else if (typeid (cPtr_memmap_true) == typeid (* (_var_56232.getPtr ()))) {
        const GGS_memmap_true var_cas_trueMemmap (_var_56232.getPtr ()) ;
        var_cas_useMemoryMapping = GGS_bool (true) ;
        GGS_lstring  var_cas_compiler = var_cas_trueMemmap.reader_compiler (inLexique COMMA_SOURCE_FILE_AT_LINE (1368)) ;
        const GGS_bool cond_55818 = (var_cas_compiler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1369))).operator_isNotEqual (GGS_string ("")) ;
        if (cond_55818.isBuiltAndTrue ()) {
          var_cas_useCompilerSettings = GGS_bool (true) ;
          ::routine_addLStringValue (inLexique,  var_cas_cfg,  GGS_string ("COMPILER"),  var_cas_compiler COMMA_SOURCE_FILE_AT_LINE (1371)) ;
        }
        GGS_lstring  var_cas_assembler = var_cas_trueMemmap.reader_assembler (inLexique COMMA_SOURCE_FILE_AT_LINE (1373)) ;
        const GGS_bool cond_55970 = (var_cas_assembler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1374))).operator_isNotEqual (GGS_string ("")) ;
        if (cond_55970.isBuiltAndTrue ()) {
          ::routine_addLStringValue (inLexique,  var_cas_cfg,  GGS_string ("ASSEMBLER"),  var_cas_assembler COMMA_SOURCE_FILE_AT_LINE (1375)) ;
        }
        { const GGS_basic_type _var_56215 = var_cas_trueMemmap.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (1377)) ; // CAST instruction
          if (_var_56215.getPtr () != NULL) {
            macroValidPointer (_var_56215.getPtr ()) ;
            if (typeid (cPtr_no_linker) == typeid (* (_var_56215.getPtr ()))) {
            }else if (typeid (cPtr_yes_linker) == typeid (* (_var_56215.getPtr ()))) {
              const GGS_yes_linker var_cas_yesLinker (_var_56215.getPtr ()) ;
              GGS_lstring  var_cas_linker = var_cas_yesLinker.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (1380)) ;
              ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("LINKER"), var_cas_linker.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1381)) COMMA_HERE),  var_cas_linker.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1381)) COMMA_SOURCE_FILE_AT_LINE (1381)) ;
            }else{
            }
          }
        }
  ...
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEMEMORYMAPPING"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1384)).reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (1384)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1384)) COMMA_HERE),  var_cas_useMemoryMapping COMMA_SOURCE_FILE_AT_LINE (1384)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOMPILERSETTINGS"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1385)).reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (1385)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1385)) COMMA_HERE),  var_cas_useCompilerSettings COMMA_SOURCE_FILE_AT_LINE (1385)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setCompiler (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_compiler = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1392)).reader_compiler (inLexique COMMA_SOURCE_FILE_AT_LINE (1392)) ;
  GGS_string var_cas_actualCompiler = GGS_string ("gcc") ;
  const GGS_bool cond_56725 = (var_cas_compiler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1394))).operator_isNotEqual (GGS_string ("")) ;
  if (cond_56725.isBuiltAndTrue ()) {
    var_cas_actualCompiler = var_cas_compiler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1394)) ;
  }
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("COMPILEREXE"), var_cas_compiler.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1395)) COMMA_HERE),  var_cas_actualCompiler COMMA_SOURCE_FILE_AT_LINE (1395)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setAssembler (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_assembler = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1402)).reader_assembler (inLexique COMMA_SOURCE_FILE_AT_LINE (1402)) ;
  GGS_string var_cas_actualAssembler = GGS_string ("as") ;
  const GGS_bool cond_57097 = (var_cas_assembler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1404))).operator_isNotEqual (GGS_string ("")) ;
  if (cond_57097.isBuiltAndTrue ()) {
    var_cas_actualAssembler = var_cas_assembler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1404)) ;
  }
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("ASSEMBLEREXE"), var_cas_assembler.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1405)) COMMA_HERE),  var_cas_actualAssembler COMMA_SOURCE_FILE_AT_LINE (1405)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setLinker (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_linker = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1412)).reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (1412)) ;
  GGS_string var_cas_actualLinker = GGS_string ("gcc") ;
  const GGS_bool cond_57449 = (var_cas_linker.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1414))).operator_isNotEqual (GGS_string ("")) ;
  if (cond_57449.isBuiltAndTrue ()) {
    var_cas_actualLinker = var_cas_linker.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1414)) ;
  }
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("LINKEREXE"), var_cas_linker.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1415)) COMMA_HERE),  var_cas_actualLinker COMMA_SOURCE_FILE_AT_LINE (1415)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setTarget (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("TARGET") COMMA_SOURCE_FILE_AT_LINE (1422)),  gOption_goil_5F_options_target_5F_platform.reader_value () COMMA_SOURCE_FILE_AT_LINE (1422)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("ARCH") COMMA_SOURCE_FILE_AT_LINE (1423)),  function_arch (inLexique COMMA_SOURCE_FILE_AT_LINE (1423)) COMMA_SOURCE_FILE_AT_LINE (1423)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("CHIP") COMMA_SOURCE_FILE_AT_LINE (1424)),  function_chip (inLexique COMMA_SOURCE_FILE_AT_LINE (1424)) COMMA_SOURCE_FILE_AT_LINE (1424)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("BOARD") COMMA_SOURCE_FILE_AT_LINE (1425)),  function_board (inLexique COMMA_SOURCE_FILE_AT_LINE (1425)) COMMA_SOURCE_FILE_AT_LINE (1425)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setTemplatePath (C_Compiler & inLexique,
  ...
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("TEMPLATEPATH") COMMA_SOURCE_FILE_AT_LINE (1433)),  var_cas_templatePath COMMA_SOURCE_FILE_AT_LINE (1433)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setTrampolinePath (C_Compiler & inLexique,
  ...
  #endif
  GGS_lstring  var_cas_trampolinePath = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1440)).reader_tpl_base_path (inLexique COMMA_SOURCE_FILE_AT_LINE (1440)) ;
  const GGS_bool cond_58502 = (var_cas_trampolinePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1441))).operator_isEqual (GGS_string ("")) ;
  if (cond_58502.isBuiltAndTrue ()) {
    var_cas_trampolinePath = GGS_lstring ::constructor_new (inLexique, GGS_string (".."), var_cas_trampolinePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1442)) COMMA_HERE) ;
  }
  ::routine_checkTrampolinePath (inLexique,  var_cas_trampolinePath COMMA_SOURCE_FILE_AT_LINE (1444)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRAMPOLINEPATH"), var_cas_trampolinePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1445)) COMMA_HERE),  var_cas_trampolinePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1445)) COMMA_SOURCE_FILE_AT_LINE (1445)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setSystemCall (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESYSTEMCALL"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1452)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1452)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1452)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1452)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1452)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1452)) COMMA_SOURCE_FILE_AT_LINE (1452)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setUseInterruptTable (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEINTERRUPTTABLE") COMMA_SOURCE_FILE_AT_LINE (1459)),  gOption_goil_5F_options_posix_5F_it.reader_value () COMMA_SOURCE_FILE_AT_LINE (1459)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setBuildConfig (C_Compiler & inLexique,
  ...
  #endif
  ::routine_setSourceFileList (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1466)) ;
  ::routine_setCFlagsList (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1467)) ;
  ::routine_setAsFlagsList (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1468)) ;
  ::routine_setLdFlagsList (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1469)) ;
  ::routine_setTraceFlag (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1470)) ;
  ::routine_setLinkScript (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1471)) ;
  ::routine_setMemoryMapping (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1472)) ;
  ::routine_setCompiler (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1473)) ;
  ::routine_setAssembler (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1474)) ;
  ::routine_setLinker (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1475)) ;
  ::routine_setTarget (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1476)) ;
  ::routine_setTemplatePath (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1477)) ;
  ::routine_setTrampolinePath (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1478)) ;
  ::routine_setSystemCall (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1479)) ;
  ::routine_setUseInterruptTable (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1480)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_bool function_useCommunication (C_Compiler & inLexique,
  ...
  GGS_com  var_cas_comObject = var_cas_cpu.reader_com (inLexique COMMA_SOURCE_FILE_AT_LINE (1485)) ;
  const GGS_bool cond_59867 = var_cas_comObject.reader_usecom (inLexique COMMA_SOURCE_FILE_AT_LINE (1486)) ;
  if (cond_59867.isBuiltAndTrue ()) {
    var_cas_useCom = GGS_bool (true) ;
  }else if (cond_59867.isBuiltAndFalse ()) {
    var_cas_useCom = ((var_cas_cpu.reader_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (1489)).reader_count ()).operator_strictSup (GGS_uint (0U))).operator_or ((var_cas_cpu.reader_net_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (1490)).reader_count ()).operator_strictSup (GGS_uint (0U))) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setUseCom (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_useCom = function_useCommunication (inLexique, var_cas_cpu COMMA_SOURCE_FILE_AT_LINE (1500)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOM"), GGS_location (inLexique) COMMA_HERE),  var_cas_useCom COMMA_SOURCE_FILE_AT_LINE (1501)) ;
  const GGS_bool cond_61557 = var_cas_useCom ;
  if (cond_61557.isBuiltAndTrue ()) {
    GGS_uint64  var_cas_timeBaseInNanoseconds = GGS_uint64 (1000000ULL) ;
    GGS_com  var_cas_comObject = var_cas_cpu.reader_com (inLexique COMMA_SOURCE_FILE_AT_LINE (1504)) ;
    { const GGS_basic_type _var_60579 = var_cas_comObject.reader_timebase (inLexique COMMA_SOURCE_FILE_AT_LINE (1505)) ; // CAST instruction
      if (_var_60579.getPtr () != NULL) {
        macroValidPointer (_var_60579.getPtr ()) ;
        if (typeid (cPtr_float_class) == typeid (* (_var_60579.getPtr ()))) {
          const GGS_float_class var_cas_timeBase (_var_60579.getPtr ()) ;
          var_cas_timeBaseInNanoseconds = var_cas_timeBase.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (1507)).multiply_operation (inLexique, GGS_double (1.000000e+09) COMMA_SOURCE_FILE_AT_LINE (1507)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (1507)) ;
        }else{
        }
      }
    }
    ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("COMTIMEBASE"), var_cas_comObject.reader_timebase (inLexique COMMA_SOURCE_FILE_AT_LINE (1510)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1510)) COMMA_HERE),  var_cas_timeBaseInNanoseconds COMMA_SOURCE_FILE_AT_LINE (1510)) ;
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOMERRORHOOK"), var_cas_comObject.reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1511)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1511)) COMMA_HERE),  function_getBool (inLexique, var_cas_comObject.reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1511)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1511)) COMMA_SOURCE_FILE_AT_LINE (1511)) ;
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOMGETSERVICEID"), var_cas_comObject.reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1512)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1512)) COMMA_HERE),  function_getBool (inLexique, var_cas_comObject.reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1512)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1512)) COMMA_SOURCE_FILE_AT_LINE (1512)) ;
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOMPARAMETERACCESS"), var_cas_comObject.reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1513)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1513)) COMMA_HERE),  function_getBool (inLexique, var_cas_comObject.reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1513)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1513)) COMMA_SOURCE_FILE_AT_LINE (1513)) ;
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESTARTCOMEXTENSION"), var_cas_comObject.reader_startcomextension (inLexique COMMA_SOURCE_FILE_AT_LINE (1514)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1514)) COMMA_HERE),  function_getBool (inLexique, var_cas_comObject.reader_startcomextension (inLexique COMMA_SOURCE_FILE_AT_LINE (1514)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1514)) COMMA_SOURCE_FILE_AT_LINE (1514)) ;
    GGS_lstring  var_cas_comStatus = var_cas_comObject.reader_status (inLexique COMMA_SOURCE_FILE_AT_LINE (1516)) ;
    GGS_bool var_cas_comExtended = GGS_bool (false) ;
    const GGS_bool cond_61456 = (var_cas_comStatus.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1518))).operator_isEqual (GGS_string ("extended")) ;
    if (cond_61456.isBuiltAndTrue ()) {
      var_cas_comExtended = GGS_bool (true) ;
    }
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("COMEXTENDED"), var_cas_comStatus.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1521)) COMMA_HERE),  var_cas_comExtended COMMA_SOURCE_FILE_AT_LINE (1521)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setExtended (C_Compiler & inLexique,
  ...
  #endif
  GGS_bool var_cas_extended = (var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1530)).reader_status (inLexique COMMA_SOURCE_FILE_AT_LINE (1530)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1530))).operator_isEqual (GGS_string ("extended")) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("EXTENDED"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1531)).reader_status (inLexique COMMA_SOURCE_FILE_AT_LINE (1531)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1531)) COMMA_HERE),  var_cas_extended COMMA_SOURCE_FILE_AT_LINE (1531)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_scalabilityClass (C_Compiler & inLexique,
  ...
  const GGS_bool cond_65074 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_65074.isBuiltAndTrue ()) {
    {
      GGS_task_map::cEnumerator enumerator_62160 (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (1546)), true) ;
      const GGS_task_map::cElement * operand_62160 = NULL ;
      while (((operand_62160 = enumerator_62160.nextObject ()))) {
        macroValidPointer (operand_62160) ;
        { const GGS_timing_prot _var_62283 = operand_62160->mInfo.task.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (1547)) ; // CAST instruction
          if (_var_62283.getPtr () != NULL) {
            macroValidPointer (_var_62283.getPtr ()) ;
            if (typeid (cPtr_timing_prot_task) == typeid (* (_var_62283.getPtr ()))) {
    ...
    {
      GGS_isr_map::cEnumerator enumerator_62327 (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1552)), true) ;
      const GGS_isr_map::cElement * operand_62327 = NULL ;
      while (((operand_62327 = enumerator_62327.nextObject ()))) {
        macroValidPointer (operand_62327) ;
        { const GGS_timing_prot _var_62447 = operand_62327->mInfo.isr.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (1553)) ; // CAST instruction
          if (_var_62447.getPtr () != NULL) {
            macroValidPointer (_var_62447.getPtr ()) ;
            if (typeid (cPtr_timing_prot_isr) == typeid (* (_var_62447.getPtr ()))) {
              var_cas_useTimingProtection = GGS_bool (true) ;
            }else{
            }
          }
    ...
    var_cas_useOSApplication = (var_cas_cpu.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (1558)).reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    { const GGS_basic_type _var_62650 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1560)).reader_protectionhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1560)) ; // CAST instruction
      if (_var_62650.getPtr () != NULL) {
        macroValidPointer (_var_62650.getPtr ()) ;
        if (typeid (cPtr_bool_class) == typeid (* (_var_62650.getPtr ()))) {
          const GGS_bool_class var_cas_ph (_var_62650.getPtr ()) ;
          var_cas_useProtectionHook = var_cas_ph.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (1562)) ;
        }else{
        }
      }
    }
    var_cas_sc = GGS_uint64 (1ULL) ;
    GGS_string var_cas_setSC = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1566)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1566)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1566)) ;
    const GGS_bool cond_63295 = ((var_cas_setSC).operator_isEqual (GGS_string (""))).operator_or ((var_cas_setSC).operator_isEqual (GGS_string ("AUTO"))) ;
    if (cond_63295.isBuiltAndTrue ()) {
      const GGS_bool cond_63005 = (var_cas_useTimingProtection).operator_or (var_cas_useProtectionHook) ;
      if (cond_63005.isBuiltAndTrue ()) {
        var_cas_sc = GGS_uint64 (2ULL) ;
      }
      const GGS_bool cond_63275 = (function_memory_protection_on (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1579)) COMMA_SOURCE_FILE_AT_LINE (1579))).operator_or ((var_cas_cpu.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (1579)).reader_count ()).operator_strictSup (GGS_uint (0U))) ;
      if (cond_63275.isBuiltAndTrue ()) {
        var_cas_sc = var_cas_sc.add_operation (inLexique, GGS_uint64 (2ULL) COMMA_SOURCE_FILE_AT_LINE (1580)) ;
      }
    }else if (cond_63295.isBuiltAndFalse ()) {
      const GGS_bool cond_64095 = (var_cas_setSC).operator_isEqual (GGS_string ("sc1")) ;
      if (cond_64095.isBuiltAndTrue ()) {
        const GGS_bool cond_63846 = var_cas_useTimingProtection ;
        if (cond_63846.isBuiltAndTrue ()) {
          const GGS_bool cond_63681 = var_cas_useOSApplication ;
          if (cond_63681.isBuiltAndTrue ()) {
            var_cas_sc = GGS_uint64 (4ULL) ;
            var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1590)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1590)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 4 because Timing Protection and OS Application are used") COMMA_SOURCE_FILE_AT_LINE (1590)) ;
          }else if (cond_63681.isBuiltAndFalse ()) {
            var_cas_sc = GGS_uint64 (2ULL) ;
            var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1593)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1593)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 2 because Timing Protection is used") COMMA_SOURCE_FILE_AT_LINE (1593)) ;
          }
        }else if (cond_63846.isBuiltAndFalse ()) {
          const GGS_bool cond_64027 = var_cas_useOSApplication ;
          if (cond_64027.isBuiltAndTrue ()) {
            var_cas_sc = GGS_uint64 (3ULL) ;
            var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1598)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1598)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 3 because OS Application is used") COMMA_SOURCE_FILE_AT_LINE (1598)) ;
          }else if (cond_64027.isBuiltAndFalse ()) {
            var_cas_sc = GGS_uint64 (1ULL) ;
          }
        }
      }else if (cond_64095.isBuiltAndFalse ()) {
        const GGS_bool cond_64657 = (var_cas_setSC).operator_isEqual (GGS_string ("sc2")) ;
        if (cond_64657.isBuiltAndTrue ()) {
          const GGS_bool cond_64408 = var_cas_useTimingProtection ;
          if (cond_64408.isBuiltAndTrue ()) {
            const GGS_bool cond_64355 = var_cas_useOSApplication ;
            if (cond_64355.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (4ULL) ;
              var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1607)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1607)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 4 because Timing Protection and OS Application are used") COMMA_SOURCE_FILE_AT_LINE (1607)) ;
            }else if (cond_64355.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (2ULL) ;
            }
          }else if (cond_64408.isBuiltAndFalse ()) {
            const GGS_bool cond_64589 = var_cas_useOSApplication ;
            if (cond_64589.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (3ULL) ;
              var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1614)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1614)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 3 because OS Application is used") COMMA_SOURCE_FILE_AT_LINE (1614)) ;
            }else if (cond_64589.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (2ULL) ;
            }
          }
        }else if (cond_64657.isBuiltAndFalse ()) {
          const GGS_bool cond_65018 = (var_cas_setSC).operator_isEqual (GGS_string ("sc3")) ;
          if (cond_65018.isBuiltAndTrue ()) {
            const GGS_bool cond_64970 = var_cas_useTimingProtection ;
            if (cond_64970.isBuiltAndTrue ()) {
              const GGS_bool cond_64917 = var_cas_useOSApplication ;
              if (cond_64917.isBuiltAndTrue ()) {
                var_cas_sc = GGS_uint64 (4ULL) ;
                var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1623)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1623)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 4 because Timing Protection and OS Application are used") COMMA_SOURCE_FILE_AT_LINE (1623)) ;
              }else if (cond_64917.isBuiltAndFalse ()) {
                var_cas_sc = GGS_uint64 (3ULL) ;
              }
            }else if (cond_64970.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (3ULL) ;
            }
          }else if (cond_65018.isBuiltAndFalse ()) {
            const GGS_bool cond_65052 = (var_cas_setSC).operator_isEqual (GGS_string ("sc4")) ;
            if (cond_65052.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (4ULL) ;
            }
          }
        }
...
void routine_setScalabilityClass (C_Compiler & inLexique,
  ...
  ::routine_scalabilityClass (inLexique,  var_cas_cpu,  var_cas_sc,  var_cas_useTimingProtection,  var_cas_useProtectionHook COMMA_SOURCE_FILE_AT_LINE (1643)) ;
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("SCALABILITYCLASS") COMMA_SOURCE_FILE_AT_LINE (1644)),  var_cas_sc COMMA_SOURCE_FILE_AT_LINE (1644)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USETIMINGPROTECTION") COMMA_SOURCE_FILE_AT_LINE (1645)),  var_cas_useTimingProtection COMMA_SOURCE_FILE_AT_LINE (1645)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEPROTECTIONHOOK") COMMA_SOURCE_FILE_AT_LINE (1646)),  var_cas_useProtectionHook COMMA_SOURCE_FILE_AT_LINE (1646)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEMEMORYPROTECTION") COMMA_SOURCE_FILE_AT_LINE (1647)),  function_memory_protection_on (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1647)) COMMA_SOURCE_FILE_AT_LINE (1647)) COMMA_SOURCE_FILE_AT_LINE (1647)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEOSAPPLICATION") COMMA_SOURCE_FILE_AT_LINE (1648)),  ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) COMMA_SOURCE_FILE_AT_LINE (1648)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setUseHooks (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESTARTUPHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1655)).reader_startuphook (inLexique COMMA_SOURCE_FILE_AT_LINE (1655)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1655)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1655)).reader_startuphook (inLexique COMMA_SOURCE_FILE_AT_LINE (1655)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1655)) COMMA_SOURCE_FILE_AT_LINE (1655)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESHUTDOWNHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1656)).reader_shutdownhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1656)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1656)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1656)).reader_shutdownhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1656)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1656)) COMMA_SOURCE_FILE_AT_LINE (1656)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEERRORHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1657)).reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1657)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1657)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1657)).reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1657)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1657)) COMMA_SOURCE_FILE_AT_LINE (1657)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPRETASKHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1658)).reader_pretaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1658)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1658)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1658)).reader_pretaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1658)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1658)) COMMA_SOURCE_FILE_AT_LINE (1658)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPOSTTASKHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1659)).reader_posttaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1659)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1659)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1659)).reader_posttaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1659)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1659)) COMMA_SOURCE_FILE_AT_LINE (1659)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEGETSERVICEID"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)).reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)).reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1660)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1660)) COMMA_SOURCE_FILE_AT_LINE (1660)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPARAMETERACCESS"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1661)).reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1661)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1661)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1661)).reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1661)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1661)) COMMA_SOURCE_FILE_AT_LINE (1661)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USERESSCHEDULER"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1662)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1662)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1662)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1662)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1662)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1662)) COMMA_SOURCE_FILE_AT_LINE (1662)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESTACKMONITORING"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)).reader_stackmonitoring (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1663)) COMMA_SOURCE_FILE_AT_LINE (1663)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setOsConfig (C_Compiler & inLexique,
  ...
  #endif
  ::routine_setExtended (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1667)) ;
  ::routine_setUseCom (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1668)) ;
  ::routine_setScalabilityClass (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1669)) ;
  ::routine_setUseHooks (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1670)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setInterruptSources (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_68330 = var_cas_targetConfiguration.reader_hasKey (GGS_string ("it_sources")) ;
  if (cond_68330.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_interruptSources ;
    const GGS_config  temp_67627 = var_cas_targetConfiguration ;
    if (temp_67627.isBuilt ()) {
      temp_67627 (HERE)->method_get (inLexique, function_lstringWith (inLexique, GGS_string ("it_sources") COMMA_SOURCE_FILE_AT_LINE (1679)), var_cas_interruptSources COMMA_SOURCE_FILE_AT_LINE (1679)) ;
    }
    { const GGS_basic_type _var_68318 = var_cas_interruptSources ; // CAST instruction
      if (_var_68318.getPtr () != NULL) {
        macroValidPointer (_var_68318.getPtr ()) ;
        if (typeid (cPtr_interrupts) == typeid (* (_var_68318.getPtr ()))) {
          const GGS_interrupts var_cas_interrupts (_var_68318.getPtr ()) ;
          ::routine_addLUnsignedValue (inLexique,  var_cas_cfg,  GGS_string ("ITSOURCESLENGTH"),  var_cas_interrupts.reader_it_count (inLexique COMMA_SOURCE_FILE_AT_LINE (1682)) COMMA_SOURCE_FILE_AT_LINE (1682)) ;
          GGS_goilTemplateFieldMapList  var_cas_interruptSourcesList = GGS_goilTemplateFieldMapList ::constructor_emptyList () ;
          {
            GGS_ident_map::cEnumerator enumerator_67895 (var_cas_interrupts.reader_it_sources (inLexique COMMA_SOURCE_FILE_AT_LINE (1684)), true) ;
            const GGS_ident_map::cElement * operand_67895 = NULL ;
            while (((operand_67895 = enumerator_67895.nextObject ()))) {
              macroValidPointer (operand_67895) ;
              GGS_goilTemplateFieldMap  var_cas_fieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
              ::routine_addLStringFieldValue (inLexique,  var_cas_fieldMap,  GGS_string ("NAME"),  operand_67895->mKey COMMA_SOURCE_FILE_AT_LINE (1686)) ;
              ::routine_addUnsignedFieldValue (inLexique,  var_cas_fieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NUMBER"), operand_67895->mInfo.value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1687)) COMMA_HERE),  function_uint64OrError (inLexique, operand_67895->mInfo.value, GGS_string ("interrupt source number") COMMA_SOURCE_FILE_AT_LINE (1687)) COMMA_SOURCE_FILE_AT_LINE (1687)) ;
              var_cas_interruptSourcesList.addAssign_operation (var_cas_fieldMap) ;
            }
          }
          ::routine_addListValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("INTERRUPTSOURCES") COMMA_SOURCE_FILE_AT_LINE (1690)),  var_cas_interruptSourcesList COMMA_SOURCE_FILE_AT_LINE (1690)) ;
        }else{
        }
      }
    }
...
void routine_addDirectoryAndFile (C_Compiler & inLexique,
  ...
  #endif
  GGS_goilTemplateFieldMap  var_cas_fieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("DIRECTORY") COMMA_SOURCE_FILE_AT_LINE (1702)),  var_cas_directory COMMA_SOURCE_FILE_AT_LINE (1702)) ;
  ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("FILE") COMMA_SOURCE_FILE_AT_LINE (1703)),  var_cas_file COMMA_SOURCE_FILE_AT_LINE (1703)) ;
...
void routine_setEnvData (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("OILFILENAME") COMMA_SOURCE_FILE_AT_LINE (1711)),  GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_lastPathComponent () COMMA_SOURCE_FILE_AT_LINE (1711)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("CPUNAME"), GGS_location (inLexique) COMMA_HERE),  var_cas_cpu.reader_name (inLexique COMMA_SOURCE_FILE_AT_LINE (1712)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1712)) COMMA_SOURCE_FILE_AT_LINE (1712)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TIMESTAMP"), GGS_location (inLexique) COMMA_HERE),  GGS_string::constructor_stringWithCurrentDateTime (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1713)) ;
  GGS_lstring  var_cas_appName = function_applicationName (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1714)) COMMA_SOURCE_FILE_AT_LINE (1714)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("APPNAME"), var_cas_appName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1715)) COMMA_HERE),  var_cas_appName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1715)) COMMA_SOURCE_FILE_AT_LINE (1715)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("PROJECT") COMMA_SOURCE_FILE_AT_LINE (1716)),  function_projectName (inLexique COMMA_SOURCE_FILE_AT_LINE (1716)).reader_lastPathComponent () COMMA_SOURCE_FILE_AT_LINE (1716)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("PROJECTPATH") COMMA_SOURCE_FILE_AT_LINE (1717)),  function_projectName (inLexique COMMA_SOURCE_FILE_AT_LINE (1717)) COMMA_SOURCE_FILE_AT_LINE (1717)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEBUILDFILE") COMMA_SOURCE_FILE_AT_LINE (1718)),  gOption_goil_5F_options_generate_5F_makefile.reader_value () COMMA_SOURCE_FILE_AT_LINE (1718)) ;
  GGS_goilTemplateFieldMapList  var_cas_fileList = GGS_goilTemplateFieldMapList ::constructor_emptyList () ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_alarm_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1724)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_event_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1725)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_it_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1726)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_rez_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1727)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_task_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1728)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_timeobj_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1729)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1730)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_action.c") COMMA_SOURCE_FILE_AT_LINE (1731)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_error.c") COMMA_SOURCE_FILE_AT_LINE (1732)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_dispatch_table.c") COMMA_SOURCE_FILE_AT_LINE (1733)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os.c") COMMA_SOURCE_FILE_AT_LINE (1734)) ;
  const GGS_bool cond_70587 = function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1735)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1735)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1735)) ;
  if (cond_70587.isBuiltAndTrue ()) {
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_alarm.c") COMMA_SOURCE_FILE_AT_LINE (1736)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_event.c") COMMA_SOURCE_FILE_AT_LINE (1737)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_it.c") COMMA_SOURCE_FILE_AT_LINE (1738)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_rez.c") COMMA_SOURCE_FILE_AT_LINE (1739)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_task.c") COMMA_SOURCE_FILE_AT_LINE (1740)) ;
  }
  { const GGS_trace _var_70707 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1742)).reader_trace (inLexique COMMA_SOURCE_FILE_AT_LINE (1742)) ; // CAST instruction
    if (_var_70707.getPtr () != NULL) {
      macroValidPointer (_var_70707.getPtr ()) ;
      if (typeid (cPtr_trace_on) == typeid (* (_var_70707.getPtr ()))) {
        ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_trace.c") COMMA_SOURCE_FILE_AT_LINE (1744)) ;
      }else{
      }
    }
  }
  const GGS_bool cond_71357 = function_useCommunication (inLexique, var_cas_cpu COMMA_SOURCE_FILE_AT_LINE (1746)) ;
  if (cond_71357.isBuiltAndTrue ()) {
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_app_copy.c") COMMA_SOURCE_FILE_AT_LINE (1747)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_filtering.c") COMMA_SOURCE_FILE_AT_LINE (1748)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_filters.c") COMMA_SOURCE_FILE_AT_LINE (1749)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_internal_com.c") COMMA_SOURCE_FILE_AT_LINE (1750)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_external_com.c") COMMA_SOURCE_FILE_AT_LINE (1751)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_notification.c") COMMA_SOURCE_FILE_AT_LINE (1752)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_queue.c") COMMA_SOURCE_FILE_AT_LINE (1753)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_message_management.c") COMMA_SOURCE_FILE_AT_LINE (1754)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_errorhook.c") COMMA_SOURCE_FILE_AT_LINE (1755)) ;
  }
  const GGS_bool cond_72630 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_72630.isBuiltAndTrue ()) {
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_counter_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1758)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_st_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1759)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_isr_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1760)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_stack_monitor.c") COMMA_SOURCE_FILE_AT_LINE (1761)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_timing_protec.c") COMMA_SOURCE_FILE_AT_LINE (1762)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_action.c") COMMA_SOURCE_FILE_AT_LINE (1763)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_protec_hook.c") COMMA_SOURCE_FILE_AT_LINE (1764)) ;
    GGS_uint64  var_cas_sc ;
    GGS_bool automatic_var_71959_0 ;
    GGS_bool automatic_var_71959_1 ;
    ::routine_scalabilityClass (inLexique,  var_cas_cpu,  var_cas_sc,  automatic_var_71959_0,  automatic_var_71959_1 COMMA_SOURCE_FILE_AT_LINE (1766)) ;
    const GGS_bool cond_72152 = ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) ;
    if (cond_72152.isBuiltAndTrue ()) {
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_app_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1768)) ;
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_trusted_fct_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1769)) ;
    }
    const GGS_bool cond_72620 = function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1771)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1771)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1771)) ;
    if (cond_72620.isBuiltAndTrue ()) {
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_counter.c") COMMA_SOURCE_FILE_AT_LINE (1772)) ;
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_isr.c") COMMA_SOURCE_FILE_AT_LINE (1773)) ;
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_schedtable.c") COMMA_SOURCE_FILE_AT_LINE (1774)) ;
      const GGS_bool cond_72608 = ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) ;
      if (cond_72608.isBuiltAndTrue ()) {
        ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_trusted_fct.c") COMMA_SOURCE_FILE_AT_LINE (1776)) ;
        ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_application.c") COMMA_SOURCE_FILE_AT_LINE (1777)) ;
      }
    }
  }
  ::routine_addListValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("TRAMPOLINESOURCES") COMMA_SOURCE_FILE_AT_LINE (1781)),  var_cas_fileList COMMA_SOURCE_FILE_AT_LINE (1781)) ;
  #ifdef DEBUG_TRACE_ENABLED
