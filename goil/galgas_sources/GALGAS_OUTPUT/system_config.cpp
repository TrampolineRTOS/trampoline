...
//                    september 13th, 2010, at 11h20'13"                     *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_scalabilityClass (C_Compiler & inLexique,
  ...
  const GGS_bool cond_71727 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_71727.isBuiltAndTrue ()) {
    {
      GGS_task_map::cEnumerator enumerator_68570 (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (1694)), true) ;
      const GGS_task_map::cElement * operand_68570 = NULL ;
      while (((operand_68570 = enumerator_68570.nextObject ()))) {
        macroValidPointer (operand_68570) ;
        { const GGS_timing_prot _var_68693 = operand_68570->mInfo.task.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (1695)) ; // CAST instruction
          if (_var_68693.getPtr () != NULL) {
            macroValidPointer (_var_68693.getPtr ()) ;
            if (typeid (cPtr_timing_prot_task) == typeid (* (_var_68693.getPtr ()))) {
    ...
    {
      GGS_isr_map::cEnumerator enumerator_68737 (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1700)), true) ;
      const GGS_isr_map::cElement * operand_68737 = NULL ;
      while (((operand_68737 = enumerator_68737.nextObject ()))) {
        macroValidPointer (operand_68737) ;
        { const GGS_timing_prot _var_68857 = operand_68737->mInfo.isr.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)) ; // CAST instruction
          if (_var_68857.getPtr () != NULL) {
            macroValidPointer (_var_68857.getPtr ()) ;
            if (typeid (cPtr_timing_prot_isr) == typeid (* (_var_68857.getPtr ()))) {
              var_cas_useTimingProtection = GGS_bool (true) ;
            }else{
            }
          }
    ...
    {
      GGS_scheduletable_map::cEnumerator enumerator_68899 (var_cas_cpu.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (1706)), true) ;
      const GGS_scheduletable_map::cElement * operand_68899 = NULL ;
      while (((operand_68899 = enumerator_68899.nextObject ()))) {
        macroValidPointer (operand_68899) ;
        { const GGS_ltgt_sync_obj _var_69030 = operand_68899->mInfo.scheduletable.reader_ltgt_sync (inLexique COMMA_SOURCE_FILE_AT_LINE (1707)) ; // CAST instruction
          if (_var_69030.getPtr () != NULL) {
            macroValidPointer (_var_69030.getPtr ()) ;
            if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_69030.getPtr ()))) {
    ...
    var_cas_useOSApplication = (var_cas_cpu.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (1712)).reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    { const GGS_basic_type _var_69233 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1714)).reader_protectionhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1714)) ; // CAST instruction
      if (_var_69233.getPtr () != NULL) {
        macroValidPointer (_var_69233.getPtr ()) ;
        if (typeid (cPtr_bool_class) == typeid (* (_var_69233.getPtr ()))) {
          const GGS_bool_class var_cas_ph (_var_69233.getPtr ()) ;
          var_cas_useProtectionHook = var_cas_ph.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (1716)) ;
        }else{
        }
      }
    }
    var_cas_sc = GGS_uint64 (1ULL) ;
    GGS_string var_cas_setSC = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1723)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1723)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1723)) ;
    const GGS_bool cond_69948 = ((var_cas_setSC).operator_isEqual (GGS_string (""))).operator_or ((var_cas_setSC).operator_isEqual (GGS_string ("AUTO"))) ;
    if (cond_69948.isBuiltAndTrue ()) {
      const GGS_bool cond_69658 = ((var_cas_useTimingProtection).operator_or (var_cas_useProtectionHook)).operator_or (var_cas_useGlobalTime) ;
      if (cond_69658.isBuiltAndTrue ()) {
        var_cas_sc = GGS_uint64 (2ULL) ;
      }
      const GGS_bool cond_69928 = (function_memory_protection_on (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1737)) COMMA_SOURCE_FILE_AT_LINE (1737))).operator_or ((var_cas_cpu.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (1737)).reader_count ()).operator_strictSup (GGS_uint (0U))) ;
      if (cond_69928.isBuiltAndTrue ()) {
        var_cas_sc = var_cas_sc.add_operation (inLexique, GGS_uint64 (2ULL) COMMA_SOURCE_FILE_AT_LINE (1738)) ;
      }
    }else if (cond_69948.isBuiltAndFalse ()) {
      const GGS_bool cond_70748 = (var_cas_setSC).operator_isEqual (GGS_string ("sc1")) ;
      if (cond_70748.isBuiltAndTrue ()) {
        const GGS_bool cond_70499 = var_cas_useTimingProtection ;
        if (cond_70499.isBuiltAndTrue ()) {
          const GGS_bool cond_70334 = var_cas_useOSApplication ;
          if (cond_70334.isBuiltAndTrue ()) {
            var_cas_sc = GGS_uint64 (4ULL) ;
            var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1748)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1748)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 4 because Timing Protection and OS Application are used") COMMA_SOURCE_FILE_AT_LINE (1748)) ;
          }else if (cond_70334.isBuiltAndFalse ()) {
            var_cas_sc = GGS_uint64 (2ULL) ;
            var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1751)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1751)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 2 because Timing Protection is used") COMMA_SOURCE_FILE_AT_LINE (1751)) ;
          }
        }else if (cond_70499.isBuiltAndFalse ()) {
          const GGS_bool cond_70680 = var_cas_useOSApplication ;
          if (cond_70680.isBuiltAndTrue ()) {
            var_cas_sc = GGS_uint64 (3ULL) ;
            var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1756)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1756)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 3 because OS Application is used") COMMA_SOURCE_FILE_AT_LINE (1756)) ;
          }else if (cond_70680.isBuiltAndFalse ()) {
            var_cas_sc = GGS_uint64 (1ULL) ;
          }
        }
      }else if (cond_70748.isBuiltAndFalse ()) {
        const GGS_bool cond_71310 = (var_cas_setSC).operator_isEqual (GGS_string ("sc2")) ;
        if (cond_71310.isBuiltAndTrue ()) {
          const GGS_bool cond_71061 = var_cas_useTimingProtection ;
          if (cond_71061.isBuiltAndTrue ()) {
            const GGS_bool cond_71008 = var_cas_useOSApplication ;
            if (cond_71008.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (4ULL) ;
              var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1765)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1765)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 4 because Timing Protection and OS Application are used") COMMA_SOURCE_FILE_AT_LINE (1765)) ;
            }else if (cond_71008.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (2ULL) ;
            }
          }else if (cond_71061.isBuiltAndFalse ()) {
            const GGS_bool cond_71242 = var_cas_useOSApplication ;
            if (cond_71242.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (3ULL) ;
              var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1772)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1772)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 3 because OS Application is used") COMMA_SOURCE_FILE_AT_LINE (1772)) ;
            }else if (cond_71242.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (2ULL) ;
            }
          }
        }else if (cond_71310.isBuiltAndFalse ()) {
          const GGS_bool cond_71671 = (var_cas_setSC).operator_isEqual (GGS_string ("sc3")) ;
          if (cond_71671.isBuiltAndTrue ()) {
            const GGS_bool cond_71623 = var_cas_useTimingProtection ;
            if (cond_71623.isBuiltAndTrue ()) {
              const GGS_bool cond_71570 = var_cas_useOSApplication ;
              if (cond_71570.isBuiltAndTrue ()) {
                var_cas_sc = GGS_uint64 (4ULL) ;
                var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1781)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1781)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 4 because Timing Protection and OS Application are used") COMMA_SOURCE_FILE_AT_LINE (1781)) ;
              }else if (cond_71570.isBuiltAndFalse ()) {
                var_cas_sc = GGS_uint64 (3ULL) ;
              }
            }else if (cond_71623.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (3ULL) ;
            }
          }else if (cond_71671.isBuiltAndFalse ()) {
            const GGS_bool cond_71705 = (var_cas_setSC).operator_isEqual (GGS_string ("sc4")) ;
            if (cond_71705.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (4ULL) ;
            }
          }
        }
...
void routine_setScalabilityClass (C_Compiler & inLexique,
  ...
  GGS_bool var_cas_useTimingProtection ;
  GGS_bool var_cas_useProtectionHook ;
  ::routine_scalabilityClass (inLexique,  var_cas_cpu,  var_cas_sc,  var_cas_useTimingProtection,  var_cas_useProtectionHook COMMA_SOURCE_FILE_AT_LINE (1801)) ;
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("SCALABILITYCLASS") COMMA_SOURCE_FILE_AT_LINE (1802)),  var_cas_sc COMMA_SOURCE_FILE_AT_LINE (1802)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USETIMINGPROTECTION") COMMA_SOURCE_FILE_AT_LINE (1803)),  var_cas_useTimingProtection COMMA_SOURCE_FILE_AT_LINE (1803)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEPROTECTIONHOOK") COMMA_SOURCE_FILE_AT_LINE (1804)),  var_cas_useProtectionHook COMMA_SOURCE_FILE_AT_LINE (1804)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEMEMORYPROTECTION") COMMA_SOURCE_FILE_AT_LINE (1805)),  function_memory_protection_on (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1805)) COMMA_SOURCE_FILE_AT_LINE (1805)) COMMA_SOURCE_FILE_AT_LINE (1805)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEOSAPPLICATION") COMMA_SOURCE_FILE_AT_LINE (1806)),  ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) COMMA_SOURCE_FILE_AT_LINE (1806)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setUseHooks (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESTARTUPHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1813)).reader_startuphook (inLexique COMMA_SOURCE_FILE_AT_LINE (1813)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1813)) COMMA_SOURCE_FILE_AT_LINE (1813)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1813)).reader_startuphook (inLexique COMMA_SOURCE_FILE_AT_LINE (1813)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1813)) COMMA_SOURCE_FILE_AT_LINE (1813)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESHUTDOWNHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1814)).reader_shutdownhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1814)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1814)) COMMA_SOURCE_FILE_AT_LINE (1814)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1814)).reader_shutdownhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1814)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1814)) COMMA_SOURCE_FILE_AT_LINE (1814)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEERRORHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1815)).reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1815)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1815)) COMMA_SOURCE_FILE_AT_LINE (1815)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1815)).reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1815)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1815)) COMMA_SOURCE_FILE_AT_LINE (1815)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPRETASKHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1816)).reader_pretaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1816)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1816)) COMMA_SOURCE_FILE_AT_LINE (1816)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1816)).reader_pretaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1816)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1816)) COMMA_SOURCE_FILE_AT_LINE (1816)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPOSTTASKHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1817)).reader_posttaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1817)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1817)) COMMA_SOURCE_FILE_AT_LINE (1817)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1817)).reader_posttaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1817)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1817)) COMMA_SOURCE_FILE_AT_LINE (1817)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEGETSERVICEID"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1818)).reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1818)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1818)) COMMA_SOURCE_FILE_AT_LINE (1818)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1818)).reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1818)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1818)) COMMA_SOURCE_FILE_AT_LINE (1818)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPARAMETERACCESS"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1819)).reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1819)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1819)) COMMA_SOURCE_FILE_AT_LINE (1819)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1819)).reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1819)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1819)) COMMA_SOURCE_FILE_AT_LINE (1819)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USERESSCHEDULER"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1820)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1820)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1820)) COMMA_SOURCE_FILE_AT_LINE (1820)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1820)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1820)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1820)) COMMA_SOURCE_FILE_AT_LINE (1820)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESTACKMONITORING"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1821)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1821)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1821)) COMMA_SOURCE_FILE_AT_LINE (1821)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1821)).reader_stackmonitoring (inLexique COMMA_SOURCE_FILE_AT_LINE (1821)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1821)) COMMA_SOURCE_FILE_AT_LINE (1821)) ;
  GGS_uint64  var_cas_osapp_startuphook_count = GGS_uint64 (0ULL) ;
  GGS_uint64  var_cas_osapp_shutdownhook_count = GGS_uint64 (0ULL) ;
  {
    GGS_app_map::cEnumerator enumerator_74008 (var_cas_cpu.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (1826)), true) ;
    const GGS_app_map::cElement * operand_74008 = NULL ;
    while (((operand_74008 = enumerator_74008.nextObject ()))) {
      macroValidPointer (operand_74008) ;
      { const GGS_basic_type _var_74177 = operand_74008->mInfo.app.reader_startuphook (inLexique COMMA_SOURCE_FILE_AT_LINE (1827)) ; // CAST instruction
        if (_var_74177.getPtr () != NULL) {
          macroValidPointer (_var_74177.getPtr ()) ;
          if (typeid (cPtr_bool_class) == typeid (* (_var_74177.getPtr ()))) {
            const GGS_bool_class var_cas_startup (_var_74177.getPtr ()) ;
            const GGS_bool cond_74160 = var_cas_startup.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (1829)) ;
            if (cond_74160.isBuiltAndTrue ()) {
              var_cas_osapp_startuphook_count.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1830)) ;
            }
          }else{
          }
        }
      }
      { const GGS_basic_type _var_74342 = operand_74008->mInfo.app.reader_shutdownhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1833)) ; // CAST instruction
        if (_var_74342.getPtr () != NULL) {
          macroValidPointer (_var_74342.getPtr ()) ;
          if (typeid (cPtr_bool_class) == typeid (* (_var_74342.getPtr ()))) {
            const GGS_bool_class var_cas_shutdown (_var_74342.getPtr ()) ;
            const GGS_bool cond_74325 = var_cas_shutdown.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (1835)) ;
            if (cond_74325.isBuiltAndTrue ()) {
              var_cas_osapp_shutdownhook_count.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1836)) ;
            }
          }else{
          }
        }
  ...
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("OSAPPLICATIONSTARTUPHOOK"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1840)),  var_cas_osapp_startuphook_count COMMA_SOURCE_FILE_AT_LINE (1840)) ;
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("OSAPPLICATIONSHUTDOWNHOOK"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1841)),  var_cas_osapp_shutdownhook_count COMMA_SOURCE_FILE_AT_LINE (1841)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setOsConfig (C_Compiler & inLexique,
  ...
  #endif
  ::routine_setExtended (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1845)) ;
  ::routine_setUseCom (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1846)) ;
  ::routine_setScalabilityClass (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1847)) ;
  ::routine_setUseHooks (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1848)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setInterruptSources (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_75737 = var_cas_targetConfiguration.reader_hasKey (GGS_string ("it_sources")) ;
  if (cond_75737.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_interruptSources ;
    if (var_cas_targetConfiguration.isBuilt ()) {
      var_cas_targetConfiguration (HERE)->method_get (inLexique, function_lstringWith (inLexique, GGS_string ("it_sources") COMMA_SOURCE_FILE_AT_LINE (1857)), var_cas_interruptSources COMMA_SOURCE_FILE_AT_LINE (1857)) ;
    }
    { const GGS_basic_type _var_75725 = var_cas_interruptSources ; // CAST instruction
      if (_var_75725.getPtr () != NULL) {
        macroValidPointer (_var_75725.getPtr ()) ;
        if (typeid (cPtr_interrupts) == typeid (* (_var_75725.getPtr ()))) {
          const GGS_interrupts var_cas_interrupts (_var_75725.getPtr ()) ;
          ::routine_addLUnsignedValue (inLexique,  var_cas_cfg,  GGS_string ("ITSOURCESLENGTH"),  var_cas_interrupts.reader_it_count (inLexique COMMA_SOURCE_FILE_AT_LINE (1860)) COMMA_SOURCE_FILE_AT_LINE (1860)) ;
          GGS_goilTemplateFieldMapList  var_cas_interruptSourcesList = GGS_goilTemplateFieldMapList ::constructor_emptyList () ;
          {
            GGS_ident_map::cEnumerator enumerator_75301 (var_cas_interrupts.reader_it_sources (inLexique COMMA_SOURCE_FILE_AT_LINE (1862)), true) ;
            const GGS_ident_map::cElement * operand_75301 = NULL ;
            while (((operand_75301 = enumerator_75301.nextObject ()))) {
              macroValidPointer (operand_75301) ;
              GGS_goilTemplateFieldMap  var_cas_fieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1863)) ;
              ::routine_addLStringFieldValue (inLexique,  var_cas_fieldMap,  GGS_string ("NAME"),  operand_75301->mKey COMMA_SOURCE_FILE_AT_LINE (1864)) ;
              ::routine_addUnsignedFieldValue (inLexique,  var_cas_fieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NUMBER"), operand_75301->mInfo.value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1865)) COMMA_SOURCE_FILE_AT_LINE (1865)),  function_uint64OrError (inLexique, operand_75301->mInfo.value, GGS_string ("interrupt source number") COMMA_SOURCE_FILE_AT_LINE (1865)) COMMA_SOURCE_FILE_AT_LINE (1865)) ;
              var_cas_interruptSourcesList.addAssign_operation (var_cas_fieldMap) ;
            }
          }
          ::routine_addListValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("INTERRUPTSOURCES") COMMA_SOURCE_FILE_AT_LINE (1868)),  var_cas_interruptSourcesList COMMA_SOURCE_FILE_AT_LINE (1868)) ;
        }else{
        }
      }
    }
...
void routine_addDirectoryAndFile (C_Compiler & inLexique,
  ...
  #endif
  GGS_goilTemplateFieldMap  var_cas_fieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1879)) ;
  ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("DIRECTORY") COMMA_SOURCE_FILE_AT_LINE (1880)),  var_cas_directory COMMA_SOURCE_FILE_AT_LINE (1880)) ;
  ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("FILE") COMMA_SOURCE_FILE_AT_LINE (1881)),  var_cas_file COMMA_SOURCE_FILE_AT_LINE (1881)) ;
...
void routine_setEnvData (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("OILFILENAME") COMMA_SOURCE_FILE_AT_LINE (1889)),  GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_SOURCE_FILE_AT_LINE (1889)).reader_lastPathComponent () COMMA_SOURCE_FILE_AT_LINE (1889)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("CPUNAME"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1890)),  var_cas_cpu.reader_name (inLexique COMMA_SOURCE_FILE_AT_LINE (1890)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1890)) COMMA_SOURCE_FILE_AT_LINE (1890)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TIMESTAMP"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1891)),  GGS_string::constructor_stringWithCurrentDateTime (inLexique COMMA_SOURCE_FILE_AT_LINE (1891)) COMMA_SOURCE_FILE_AT_LINE (1891)) ;
  GGS_lstring  var_cas_appName = function_applicationName (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1892)) COMMA_SOURCE_FILE_AT_LINE (1892)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("APPNAME"), var_cas_appName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1893)) COMMA_SOURCE_FILE_AT_LINE (1893)),  var_cas_appName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1893)) COMMA_SOURCE_FILE_AT_LINE (1893)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("PROJECT") COMMA_SOURCE_FILE_AT_LINE (1894)),  function_projectName (inLexique COMMA_SOURCE_FILE_AT_LINE (1894)).reader_lastPathComponent () COMMA_SOURCE_FILE_AT_LINE (1894)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("PROJECTPATH") COMMA_SOURCE_FILE_AT_LINE (1895)),  function_projectName (inLexique COMMA_SOURCE_FILE_AT_LINE (1895)) COMMA_SOURCE_FILE_AT_LINE (1895)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEBUILDFILE") COMMA_SOURCE_FILE_AT_LINE (1896)),  gOption_goil_5F_options_generate_5F_makefile.reader_value () COMMA_SOURCE_FILE_AT_LINE (1896)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USELOGFILE") COMMA_SOURCE_FILE_AT_LINE (1897)),  gOption_goil_5F_options_generate_5F_log.reader_value () COMMA_SOURCE_FILE_AT_LINE (1897)) ;
  GGS_goilTemplateFieldMapList  var_cas_fileList = GGS_goilTemplateFieldMapList ::constructor_emptyList () ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_alarm_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1902)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_event_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1903)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_it_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1904)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_rez_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1905)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_task_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1906)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_timeobj_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1907)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1908)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_action.c") COMMA_SOURCE_FILE_AT_LINE (1909)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_error.c") COMMA_SOURCE_FILE_AT_LINE (1910)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_dispatch_table.c") COMMA_SOURCE_FILE_AT_LINE (1911)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os.c") COMMA_SOURCE_FILE_AT_LINE (1912)) ;
  const GGS_bool cond_78087 = (function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1913)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1913)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1913))).operator_not () ;
  if (cond_78087.isBuiltAndTrue ()) {
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_alarm.c") COMMA_SOURCE_FILE_AT_LINE (1914)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_event.c") COMMA_SOURCE_FILE_AT_LINE (1915)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_it.c") COMMA_SOURCE_FILE_AT_LINE (1916)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_rez.c") COMMA_SOURCE_FILE_AT_LINE (1917)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_task.c") COMMA_SOURCE_FILE_AT_LINE (1918)) ;
  }
  { const GGS_trace _var_78207 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1920)).reader_trace (inLexique COMMA_SOURCE_FILE_AT_LINE (1920)) ; // CAST instruction
    if (_var_78207.getPtr () != NULL) {
      macroValidPointer (_var_78207.getPtr ()) ;
      if (typeid (cPtr_trace_on) == typeid (* (_var_78207.getPtr ()))) {
        ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_trace.c") COMMA_SOURCE_FILE_AT_LINE (1922)) ;
      }else{
      }
    }
  }
  const GGS_bool cond_78857 = function_useCommunication (inLexique, var_cas_cpu COMMA_SOURCE_FILE_AT_LINE (1924)) ;
  if (cond_78857.isBuiltAndTrue ()) {
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_app_copy.c") COMMA_SOURCE_FILE_AT_LINE (1925)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_filtering.c") COMMA_SOURCE_FILE_AT_LINE (1926)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_filters.c") COMMA_SOURCE_FILE_AT_LINE (1927)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_internal_com.c") COMMA_SOURCE_FILE_AT_LINE (1928)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_external_com.c") COMMA_SOURCE_FILE_AT_LINE (1929)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_notification.c") COMMA_SOURCE_FILE_AT_LINE (1930)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_queue.c") COMMA_SOURCE_FILE_AT_LINE (1931)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_message_management.c") COMMA_SOURCE_FILE_AT_LINE (1932)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_errorhook.c") COMMA_SOURCE_FILE_AT_LINE (1933)) ;
  }
  const GGS_bool cond_80134 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_80134.isBuiltAndTrue ()) {
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_counter_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1936)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_st_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1937)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_isr_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1938)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_stack_monitor.c") COMMA_SOURCE_FILE_AT_LINE (1939)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_timing_protec.c") COMMA_SOURCE_FILE_AT_LINE (1940)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_action.c") COMMA_SOURCE_FILE_AT_LINE (1941)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_protec_hook.c") COMMA_SOURCE_FILE_AT_LINE (1942)) ;
    GGS_uint64  var_cas_sc ;
    GGS_bool automatic_var_79459_0 ;
    GGS_bool automatic_var_79459_1 ;
    ::routine_scalabilityClass (inLexique,  var_cas_cpu,  var_cas_sc,  automatic_var_79459_0,  automatic_var_79459_1 COMMA_SOURCE_FILE_AT_LINE (1944)) ;
    const GGS_bool cond_79652 = ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) ;
    if (cond_79652.isBuiltAndTrue ()) {
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_app_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1946)) ;
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_trusted_fct_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1947)) ;
    }
    const GGS_bool cond_80124 = (function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1949)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1949)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1949))).operator_not () ;
    if (cond_80124.isBuiltAndTrue ()) {
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_counter.c") COMMA_SOURCE_FILE_AT_LINE (1950)) ;
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_isr.c") COMMA_SOURCE_FILE_AT_LINE (1951)) ;
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_schedtable.c") COMMA_SOURCE_FILE_AT_LINE (1952)) ;
      const GGS_bool cond_80112 = ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) ;
      if (cond_80112.isBuiltAndTrue ()) {
        ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_trusted_fct.c") COMMA_SOURCE_FILE_AT_LINE (1954)) ;
        ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_application.c") COMMA_SOURCE_FILE_AT_LINE (1955)) ;
      }
    }
  }
  ::routine_addListValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("TRAMPOLINESOURCEFILES") COMMA_SOURCE_FILE_AT_LINE (1959)),  var_cas_fileList COMMA_SOURCE_FILE_AT_LINE (1959)) ;
  #ifdef DEBUG_TRACE_ENABLED
