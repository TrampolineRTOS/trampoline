...
void routine_scalabilityClass (C_Compiler & inLexique,
  ...
  const GGS_bool cond_66438 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_66438.isBuiltAndTrue ()) {
    {
      GGS_task_map::cEnumerator enumerator_63281 (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (1576)), true) ;
      const GGS_task_map::cElement * operand_63281 = NULL ;
      while (((operand_63281 = enumerator_63281.nextObject ()))) {
        macroValidPointer (operand_63281) ;
        { const GGS_timing_prot _var_63404 = operand_63281->mInfo.task.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (1577)) ; // CAST instruction
          if (_var_63404.getPtr () != NULL) {
            macroValidPointer (_var_63404.getPtr ()) ;
            if (typeid (cPtr_timing_prot_task) == typeid (* (_var_63404.getPtr ()))) {
    ...
    {
      GGS_isr_map::cEnumerator enumerator_63448 (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1582)), true) ;
      const GGS_isr_map::cElement * operand_63448 = NULL ;
      while (((operand_63448 = enumerator_63448.nextObject ()))) {
        macroValidPointer (operand_63448) ;
        { const GGS_timing_prot _var_63568 = operand_63448->mInfo.isr.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (1583)) ; // CAST instruction
          if (_var_63568.getPtr () != NULL) {
            macroValidPointer (_var_63568.getPtr ()) ;
            if (typeid (cPtr_timing_prot_isr) == typeid (* (_var_63568.getPtr ()))) {
              var_cas_useTimingProtection = GGS_bool (true) ;
            }else{
            }
          }
    ...
    {
      GGS_scheduletable_map::cEnumerator enumerator_63610 (var_cas_cpu.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (1588)), true) ;
      const GGS_scheduletable_map::cElement * operand_63610 = NULL ;
      while (((operand_63610 = enumerator_63610.nextObject ()))) {
        macroValidPointer (operand_63610) ;
        { const GGS_ltgt_sync_obj _var_63741 = operand_63610->mInfo.scheduletable.reader_ltgt_sync (inLexique COMMA_SOURCE_FILE_AT_LINE (1589)) ; // CAST instruction
          if (_var_63741.getPtr () != NULL) {
            macroValidPointer (_var_63741.getPtr ()) ;
            if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_63741.getPtr ()))) {
    ...
    var_cas_useOSApplication = (var_cas_cpu.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (1594)).reader_count ()).operator_strictSup (GGS_uint (0U)) ;
    { const GGS_basic_type _var_63944 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1596)).reader_protectionhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1596)) ; // CAST instruction
      if (_var_63944.getPtr () != NULL) {
        macroValidPointer (_var_63944.getPtr ()) ;
        if (typeid (cPtr_bool_class) == typeid (* (_var_63944.getPtr ()))) {
          const GGS_bool_class var_cas_ph (_var_63944.getPtr ()) ;
          var_cas_useProtectionHook = var_cas_ph.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (1598)) ;
        }else{
        }
      }
    }
    var_cas_sc = GGS_uint64 (1ULL) ;
    GGS_string var_cas_setSC = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1605)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1605)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1605)) ;
    const GGS_bool cond_64659 = ((var_cas_setSC).operator_isEqual (GGS_string (""))).operator_or ((var_cas_setSC).operator_isEqual (GGS_string ("AUTO"))) ;
    if (cond_64659.isBuiltAndTrue ()) {
      const GGS_bool cond_64369 = ((var_cas_useTimingProtection).operator_or (var_cas_useProtectionHook)).operator_or (var_cas_useGlobalTime) ;
      if (cond_64369.isBuiltAndTrue ()) {
        var_cas_sc = GGS_uint64 (2ULL) ;
      }
      const GGS_bool cond_64639 = (function_memory_protection_on (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1619)) COMMA_SOURCE_FILE_AT_LINE (1619))).operator_or ((var_cas_cpu.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (1619)).reader_count ()).operator_strictSup (GGS_uint (0U))) ;
      if (cond_64639.isBuiltAndTrue ()) {
        var_cas_sc = var_cas_sc.add_operation (inLexique, GGS_uint64 (2ULL) COMMA_SOURCE_FILE_AT_LINE (1620)) ;
      }
    }else if (cond_64659.isBuiltAndFalse ()) {
      const GGS_bool cond_65459 = (var_cas_setSC).operator_isEqual (GGS_string ("sc1")) ;
      if (cond_65459.isBuiltAndTrue ()) {
        const GGS_bool cond_65210 = var_cas_useTimingProtection ;
        if (cond_65210.isBuiltAndTrue ()) {
          const GGS_bool cond_65045 = var_cas_useOSApplication ;
          if (cond_65045.isBuiltAndTrue ()) {
            var_cas_sc = GGS_uint64 (4ULL) ;
            var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1630)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1630)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 4 because Timing Protection and OS Application are used") COMMA_SOURCE_FILE_AT_LINE (1630)) ;
          }else if (cond_65045.isBuiltAndFalse ()) {
            var_cas_sc = GGS_uint64 (2ULL) ;
            var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1633)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1633)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 2 because Timing Protection is used") COMMA_SOURCE_FILE_AT_LINE (1633)) ;
          }
        }else if (cond_65210.isBuiltAndFalse ()) {
          const GGS_bool cond_65391 = var_cas_useOSApplication ;
          if (cond_65391.isBuiltAndTrue ()) {
            var_cas_sc = GGS_uint64 (3ULL) ;
            var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1638)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1638)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 3 because OS Application is used") COMMA_SOURCE_FILE_AT_LINE (1638)) ;
          }else if (cond_65391.isBuiltAndFalse ()) {
            var_cas_sc = GGS_uint64 (1ULL) ;
          }
        }
      }else if (cond_65459.isBuiltAndFalse ()) {
        const GGS_bool cond_66021 = (var_cas_setSC).operator_isEqual (GGS_string ("sc2")) ;
        if (cond_66021.isBuiltAndTrue ()) {
          const GGS_bool cond_65772 = var_cas_useTimingProtection ;
          if (cond_65772.isBuiltAndTrue ()) {
            const GGS_bool cond_65719 = var_cas_useOSApplication ;
            if (cond_65719.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (4ULL) ;
              var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1647)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1647)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 4 because Timing Protection and OS Application are used") COMMA_SOURCE_FILE_AT_LINE (1647)) ;
            }else if (cond_65719.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (2ULL) ;
            }
          }else if (cond_65772.isBuiltAndFalse ()) {
            const GGS_bool cond_65953 = var_cas_useOSApplication ;
            if (cond_65953.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (3ULL) ;
              var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1654)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1654)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 3 because OS Application is used") COMMA_SOURCE_FILE_AT_LINE (1654)) ;
            }else if (cond_65953.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (2ULL) ;
            }
          }
        }else if (cond_66021.isBuiltAndFalse ()) {
          const GGS_bool cond_66382 = (var_cas_setSC).operator_isEqual (GGS_string ("sc3")) ;
          if (cond_66382.isBuiltAndTrue ()) {
            const GGS_bool cond_66334 = var_cas_useTimingProtection ;
            if (cond_66334.isBuiltAndTrue ()) {
              const GGS_bool cond_66281 = var_cas_useOSApplication ;
              if (cond_66281.isBuiltAndTrue ()) {
                var_cas_sc = GGS_uint64 (4ULL) ;
                var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)).reader_scalabilityclass (inLexique COMMA_SOURCE_FILE_AT_LINE (1663)).reader_location (inLexique COMMA_HERE).signalGGSSemanticWarning (inLexique, GGS_string ("SCALABILITYCLASS set to 4 because Timing Protection and OS Application are used") COMMA_SOURCE_FILE_AT_LINE (1663)) ;
              }else if (cond_66281.isBuiltAndFalse ()) {
                var_cas_sc = GGS_uint64 (3ULL) ;
              }
            }else if (cond_66334.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (3ULL) ;
            }
          }else if (cond_66382.isBuiltAndFalse ()) {
            const GGS_bool cond_66416 = (var_cas_setSC).operator_isEqual (GGS_string ("sc4")) ;
            if (cond_66416.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (4ULL) ;
            }
          }
        }
...
void routine_setScalabilityClass (C_Compiler & inLexique,
  ...
  ::routine_scalabilityClass (inLexique,  var_cas_cpu,  var_cas_sc,  var_cas_useTimingProtection,  var_cas_useProtectionHook COMMA_SOURCE_FILE_AT_LINE (1683)) ;
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("SCALABILITYCLASS") COMMA_SOURCE_FILE_AT_LINE (1684)),  var_cas_sc COMMA_SOURCE_FILE_AT_LINE (1684)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USETIMINGPROTECTION") COMMA_SOURCE_FILE_AT_LINE (1685)),  var_cas_useTimingProtection COMMA_SOURCE_FILE_AT_LINE (1685)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEPROTECTIONHOOK") COMMA_SOURCE_FILE_AT_LINE (1686)),  var_cas_useProtectionHook COMMA_SOURCE_FILE_AT_LINE (1686)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEMEMORYPROTECTION") COMMA_SOURCE_FILE_AT_LINE (1687)),  function_memory_protection_on (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1687)) COMMA_SOURCE_FILE_AT_LINE (1687)) COMMA_SOURCE_FILE_AT_LINE (1687)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEOSAPPLICATION") COMMA_SOURCE_FILE_AT_LINE (1688)),  ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) COMMA_SOURCE_FILE_AT_LINE (1688)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setUseHooks (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESTARTUPHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1695)).reader_startuphook (inLexique COMMA_SOURCE_FILE_AT_LINE (1695)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1695)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1695)).reader_startuphook (inLexique COMMA_SOURCE_FILE_AT_LINE (1695)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1695)) COMMA_SOURCE_FILE_AT_LINE (1695)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESHUTDOWNHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1696)).reader_shutdownhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1696)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1696)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1696)).reader_shutdownhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1696)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1696)) COMMA_SOURCE_FILE_AT_LINE (1696)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEERRORHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1697)).reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1697)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1697)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1697)).reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1697)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1697)) COMMA_SOURCE_FILE_AT_LINE (1697)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPRETASKHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1698)).reader_pretaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1698)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1698)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1698)).reader_pretaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1698)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1698)) COMMA_SOURCE_FILE_AT_LINE (1698)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPOSTTASKHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1699)).reader_posttaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1699)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1699)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1699)).reader_posttaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1699)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1699)) COMMA_SOURCE_FILE_AT_LINE (1699)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEGETSERVICEID"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1700)).reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1700)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1700)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1700)).reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1700)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1700)) COMMA_SOURCE_FILE_AT_LINE (1700)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPARAMETERACCESS"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)).reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)).reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1701)) COMMA_SOURCE_FILE_AT_LINE (1701)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USERESSCHEDULER"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1702)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1702)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1702)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1702)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1702)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1702)) COMMA_SOURCE_FILE_AT_LINE (1702)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESTACKMONITORING"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1703)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1703)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1703)) COMMA_HERE),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1703)).reader_stackmonitoring (inLexique COMMA_SOURCE_FILE_AT_LINE (1703)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1703)) COMMA_SOURCE_FILE_AT_LINE (1703)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setOsConfig (C_Compiler & inLexique,
  ...
  #endif
  ::routine_setExtended (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1707)) ;
  ::routine_setUseCom (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1708)) ;
  ::routine_setScalabilityClass (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1709)) ;
  ::routine_setUseHooks (inLexique,  var_cas_cpu,  var_cas_cfg COMMA_SOURCE_FILE_AT_LINE (1710)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setInterruptSources (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_69694 = var_cas_targetConfiguration.reader_hasKey (GGS_string ("it_sources")) ;
  if (cond_69694.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_interruptSources ;
    const GGS_config  temp_68991 = var_cas_targetConfiguration ;
    if (temp_68991.isBuilt ()) {
      temp_68991 (HERE)->method_get (inLexique, function_lstringWith (inLexique, GGS_string ("it_sources") COMMA_SOURCE_FILE_AT_LINE (1719)), var_cas_interruptSources COMMA_SOURCE_FILE_AT_LINE (1719)) ;
    }
    { const GGS_basic_type _var_69682 = var_cas_interruptSources ; // CAST instruction
      if (_var_69682.getPtr () != NULL) {
        macroValidPointer (_var_69682.getPtr ()) ;
        if (typeid (cPtr_interrupts) == typeid (* (_var_69682.getPtr ()))) {
          const GGS_interrupts var_cas_interrupts (_var_69682.getPtr ()) ;
          ::routine_addLUnsignedValue (inLexique,  var_cas_cfg,  GGS_string ("ITSOURCESLENGTH"),  var_cas_interrupts.reader_it_count (inLexique COMMA_SOURCE_FILE_AT_LINE (1722)) COMMA_SOURCE_FILE_AT_LINE (1722)) ;
          GGS_goilTemplateFieldMapList  var_cas_interruptSourcesList = GGS_goilTemplateFieldMapList ::constructor_emptyList () ;
          {
            GGS_ident_map::cEnumerator enumerator_69259 (var_cas_interrupts.reader_it_sources (inLexique COMMA_SOURCE_FILE_AT_LINE (1724)), true) ;
            const GGS_ident_map::cElement * operand_69259 = NULL ;
            while (((operand_69259 = enumerator_69259.nextObject ()))) {
              macroValidPointer (operand_69259) ;
              GGS_goilTemplateFieldMap  var_cas_fieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
              ::routine_addLStringFieldValue (inLexique,  var_cas_fieldMap,  GGS_string ("NAME"),  operand_69259->mKey COMMA_SOURCE_FILE_AT_LINE (1726)) ;
              ::routine_addUnsignedFieldValue (inLexique,  var_cas_fieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NUMBER"), operand_69259->mInfo.value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1727)) COMMA_HERE),  function_uint64OrError (inLexique, operand_69259->mInfo.value, GGS_string ("interrupt source number") COMMA_SOURCE_FILE_AT_LINE (1727)) COMMA_SOURCE_FILE_AT_LINE (1727)) ;
              var_cas_interruptSourcesList.addAssign_operation (var_cas_fieldMap) ;
            }
          }
          ::routine_addListValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("INTERRUPTSOURCES") COMMA_SOURCE_FILE_AT_LINE (1730)),  var_cas_interruptSourcesList COMMA_SOURCE_FILE_AT_LINE (1730)) ;
        }else{
        }
      }
    }
...
void routine_addDirectoryAndFile (C_Compiler & inLexique,
  ...
  #endif
  GGS_goilTemplateFieldMap  var_cas_fieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_HERE) ;
  ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("DIRECTORY") COMMA_SOURCE_FILE_AT_LINE (1742)),  var_cas_directory COMMA_SOURCE_FILE_AT_LINE (1742)) ;
  ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("FILE") COMMA_SOURCE_FILE_AT_LINE (1743)),  var_cas_file COMMA_SOURCE_FILE_AT_LINE (1743)) ;
...
void routine_setEnvData (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("OILFILENAME") COMMA_SOURCE_FILE_AT_LINE (1751)),  GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_HERE).reader_lastPathComponent () COMMA_SOURCE_FILE_AT_LINE (1751)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("CPUNAME"), GGS_location (inLexique) COMMA_HERE),  var_cas_cpu.reader_name (inLexique COMMA_SOURCE_FILE_AT_LINE (1752)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1752)) COMMA_SOURCE_FILE_AT_LINE (1752)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TIMESTAMP"), GGS_location (inLexique) COMMA_HERE),  GGS_string::constructor_stringWithCurrentDateTime (inLexique COMMA_HERE) COMMA_SOURCE_FILE_AT_LINE (1753)) ;
  GGS_lstring  var_cas_appName = function_applicationName (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1754)) COMMA_SOURCE_FILE_AT_LINE (1754)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("APPNAME"), var_cas_appName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1755)) COMMA_HERE),  var_cas_appName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1755)) COMMA_SOURCE_FILE_AT_LINE (1755)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("PROJECT") COMMA_SOURCE_FILE_AT_LINE (1756)),  function_projectName (inLexique COMMA_SOURCE_FILE_AT_LINE (1756)).reader_lastPathComponent () COMMA_SOURCE_FILE_AT_LINE (1756)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("PROJECTPATH") COMMA_SOURCE_FILE_AT_LINE (1757)),  function_projectName (inLexique COMMA_SOURCE_FILE_AT_LINE (1757)) COMMA_SOURCE_FILE_AT_LINE (1757)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USEBUILDFILE") COMMA_SOURCE_FILE_AT_LINE (1758)),  gOption_goil_5F_options_generate_5F_makefile.reader_value () COMMA_SOURCE_FILE_AT_LINE (1758)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("USELOGFILE") COMMA_SOURCE_FILE_AT_LINE (1759)),  gOption_goil_5F_options_generate_5F_log.reader_value () COMMA_SOURCE_FILE_AT_LINE (1759)) ;
  GGS_goilTemplateFieldMapList  var_cas_fileList = GGS_goilTemplateFieldMapList ::constructor_emptyList () ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_alarm_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1764)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_event_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1765)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_it_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1766)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_rez_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1767)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_task_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1768)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_timeobj_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1769)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1770)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_action.c") COMMA_SOURCE_FILE_AT_LINE (1771)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_error.c") COMMA_SOURCE_FILE_AT_LINE (1772)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_dispatch_table.c") COMMA_SOURCE_FILE_AT_LINE (1773)) ;
  ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os.c") COMMA_SOURCE_FILE_AT_LINE (1774)) ;
  const GGS_bool cond_72044 = (function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1775)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1775)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1775))).operator_not () ;
  if (cond_72044.isBuiltAndTrue ()) {
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_alarm.c") COMMA_SOURCE_FILE_AT_LINE (1776)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_event.c") COMMA_SOURCE_FILE_AT_LINE (1777)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_it.c") COMMA_SOURCE_FILE_AT_LINE (1778)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_rez.c") COMMA_SOURCE_FILE_AT_LINE (1779)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_os_task.c") COMMA_SOURCE_FILE_AT_LINE (1780)) ;
  }
  { const GGS_trace _var_72164 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1782)).reader_trace (inLexique COMMA_SOURCE_FILE_AT_LINE (1782)) ; // CAST instruction
    if (_var_72164.getPtr () != NULL) {
      macroValidPointer (_var_72164.getPtr ()) ;
      if (typeid (cPtr_trace_on) == typeid (* (_var_72164.getPtr ()))) {
        ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("os"),  GGS_string ("tpl_trace.c") COMMA_SOURCE_FILE_AT_LINE (1784)) ;
      }else{
      }
    }
  }
  const GGS_bool cond_72814 = function_useCommunication (inLexique, var_cas_cpu COMMA_SOURCE_FILE_AT_LINE (1786)) ;
  if (cond_72814.isBuiltAndTrue ()) {
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_app_copy.c") COMMA_SOURCE_FILE_AT_LINE (1787)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_filtering.c") COMMA_SOURCE_FILE_AT_LINE (1788)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_filters.c") COMMA_SOURCE_FILE_AT_LINE (1789)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_internal_com.c") COMMA_SOURCE_FILE_AT_LINE (1790)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_external_com.c") COMMA_SOURCE_FILE_AT_LINE (1791)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_notification.c") COMMA_SOURCE_FILE_AT_LINE (1792)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_queue.c") COMMA_SOURCE_FILE_AT_LINE (1793)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_message_management.c") COMMA_SOURCE_FILE_AT_LINE (1794)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("com"),  GGS_string ("tpl_com_errorhook.c") COMMA_SOURCE_FILE_AT_LINE (1795)) ;
  }
  const GGS_bool cond_74091 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_74091.isBuiltAndTrue ()) {
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_counter_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1798)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_st_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1799)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_isr_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1800)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_stack_monitor.c") COMMA_SOURCE_FILE_AT_LINE (1801)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_timing_protec.c") COMMA_SOURCE_FILE_AT_LINE (1802)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_action.c") COMMA_SOURCE_FILE_AT_LINE (1803)) ;
    ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_protec_hook.c") COMMA_SOURCE_FILE_AT_LINE (1804)) ;
    GGS_uint64  var_cas_sc ;
    GGS_bool automatic_var_73416_0 ;
    GGS_bool automatic_var_73416_1 ;
    ::routine_scalabilityClass (inLexique,  var_cas_cpu,  var_cas_sc,  automatic_var_73416_0,  automatic_var_73416_1 COMMA_SOURCE_FILE_AT_LINE (1806)) ;
    const GGS_bool cond_73609 = ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) ;
    if (cond_73609.isBuiltAndTrue ()) {
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_app_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1808)) ;
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_trusted_fct_kernel.c") COMMA_SOURCE_FILE_AT_LINE (1809)) ;
    }
    const GGS_bool cond_74081 = (function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1811)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1811)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1811))).operator_not () ;
    if (cond_74081.isBuiltAndTrue ()) {
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_counter.c") COMMA_SOURCE_FILE_AT_LINE (1812)) ;
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_isr.c") COMMA_SOURCE_FILE_AT_LINE (1813)) ;
      ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_schedtable.c") COMMA_SOURCE_FILE_AT_LINE (1814)) ;
      const GGS_bool cond_74069 = ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) ;
      if (cond_74069.isBuiltAndTrue ()) {
        ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_trusted_fct.c") COMMA_SOURCE_FILE_AT_LINE (1816)) ;
        ::routine_addDirectoryAndFile (inLexique,  var_cas_fileList,  GGS_string ("autosar"),  GGS_string ("tpl_as_application.c") COMMA_SOURCE_FILE_AT_LINE (1817)) ;
      }
    }
  }
  ::routine_addListValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("TRAMPOLINESOURCEFILES") COMMA_SOURCE_FILE_AT_LINE (1821)),  var_cas_fileList COMMA_SOURCE_FILE_AT_LINE (1821)) ;
  #ifdef DEBUG_TRACE_ENABLED
