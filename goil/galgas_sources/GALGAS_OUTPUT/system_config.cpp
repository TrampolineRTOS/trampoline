...
void routine_setAction (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_action_obj _var_15215 = var_cas_action ; // CAST instruction
    if (_var_15215.getPtr () != NULL) {
      macroValidPointer (_var_15215.getPtr ()) ;
      if (typeid (cPtr_setevent_action) == typeid (* (_var_15215.getPtr ()))) {
        const GGS_setevent_action var_cas_setEvent (_var_15215.getPtr ()) ;
      ...
      }else if (typeid (cPtr_activatetask_action) == typeid (* (_var_15215.getPtr ()))) {
        const GGS_activatetask_action var_cas_activateTask (_var_15215.getPtr ()) ;
      ...
      }else if (typeid (cPtr_callback_action) == typeid (* (_var_15215.getPtr ()))) {
        const GGS_callback_action var_cas_callback (_var_15215.getPtr ()) ;
      ...
      }else if (typeid (cPtr_incrementcounter_action) == typeid (* (_var_15215.getPtr ()))) {
        const GGS_incrementcounter_action var_cas_incrementCounter (_var_15215.getPtr ()) ;
      ...
      }else if (typeid (cPtr_finalize_st_action) == typeid (* (_var_15215.getPtr ()))) {
        const GGS_finalize_st_action var_cas_finalizeScheduletable (_var_15215.getPtr ()) ;
...
void routine_setAlarmsList (C_Compiler & inLexique,
  ...
  {
    GGS_alarm_map::cEnumerator enumerator_15442 (var_cas_cpu.reader_alarms (inLexique COMMA_SOURCE_FILE_AT_LINE (443)), true) ;
    const GGS_alarm_map::cElement * operand_15442 = NULL ;
    while (((operand_15442 = enumerator_15442.nextObject ()))) {
      macroValidPointer (operand_15442) ;
      ...
      ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("NAME") COMMA_SOURCE_FILE_AT_LINE (445)),  operand_15442->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (445)) COMMA_SOURCE_FILE_AT_LINE (445)) ;
      ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("COUNTER") COMMA_SOURCE_FILE_AT_LINE (446)),  operand_15442->mInfo.alarm.reader_counter_name (inLexique COMMA_SOURCE_FILE_AT_LINE (446)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (446)) COMMA_SOURCE_FILE_AT_LINE (446)) ;
      ::routine_setAction (inLexique,  var_cas_fieldMap,  operand_15442->mInfo.alarm.reader_action_params (inLexique COMMA_SOURCE_FILE_AT_LINE (448)) COMMA_SOURCE_FILE_AT_LINE (448)) ;
      { const GGS_autostart_obj _var_16670 = operand_15442->mInfo.alarm.reader_autostart_params (inLexique COMMA_SOURCE_FILE_AT_LINE (450)) ; // CAST instruction
        if (_var_16670.getPtr () != NULL) {
          macroValidPointer (_var_16670.getPtr ()) ;
          if (typeid (cPtr_alarm_autostart_true) == typeid (* (_var_16670.getPtr ()))) {
            const GGS_alarm_autostart_true var_cas_autostart (_var_16670.getPtr ()) ;
            ...
            {
              GGS_stringset::cEnumerator enumerator_16143 (var_cas_autostart.reader_app_modes (inLexique COMMA_SOURCE_FILE_AT_LINE (456)), true) ;
              while (enumerator_16143.hasCurrentObject ()) {
                ...
                ::routine_addStringFieldValue (inLexique,  var_cas_appModeFields,  function_lstringWith (inLexique, GGS_string ("APPMODE") COMMA_SOURCE_FILE_AT_LINE (458)),  enumerator_16143._key (HERE) COMMA_SOURCE_FILE_AT_LINE (458)) ;
                var_cas_appmodesList.addAssign_operation (var_cas_appModeFields) ;
                enumerator_16143.next () ;
              }
            }
          ...
          }else if (typeid (cPtr_autostart_false) == typeid (* (_var_16670.getPtr ()))) {
          ...
          }else if (typeid (cPtr_autostart_void) == typeid (* (_var_16670.getPtr ()))) {
      ...
      ::routine_setAppRelatedAttributes (inLexique,  var_cas_fieldMap,  var_cas_cpu,  var_cas_appForObj,  operand_15442->mKey COMMA_SOURCE_FILE_AT_LINE (468)) ;
...
void routine_setResourcesList (C_Compiler & inLexique,
  ...
  {
    GGS_resource_map::cEnumerator enumerator_17167 (var_cas_cpu.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (486)), true) ;
    const GGS_resource_map::cElement * operand_17167 = NULL ;
    while (((operand_17167 = enumerator_17167.nextObject ()))) {
      macroValidPointer (operand_17167) ;
      ...
      ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (488)),  operand_17167->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (488)) COMMA_SOURCE_FILE_AT_LINE (488)) ;
      GGS_uint  var_cas_priority ;
      GGS_string var_cas_usage ;
      GGS_uint  automatic_var_17392_0 ;
      const GGS_prio_map  temp_17373 = var_cas_resourcesPrio ;
      if (temp_17373.isBuilt ()) {
        temp_17373 (HERE)->method_get (inLexique, operand_17167->mKey, var_cas_priority, automatic_var_17392_0 COMMA_SOURCE_FILE_AT_LINE (491)) ;
      }
      ...
      {
        GGS_task_map::cEnumerator enumerator_17552 (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (495)), true) ;
        const GGS_task_map::cElement * operand_17552 = NULL ;
        while (((operand_17552 = enumerator_17552.nextObject ()))) {
          macroValidPointer (operand_17552) ;
          const GGS_bool cond_17805 = function_isInLstringlist (inLexique, operand_17552->mInfo.task.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (496)), operand_17167->mKey COMMA_SOURCE_FILE_AT_LINE (496)) ;
          if (cond_17805.isBuiltAndTrue ()) {
            ...
            ::routine_addStringFieldValue (inLexique,  var_cas_usage,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (498)),  operand_17552->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (498)) COMMA_SOURCE_FILE_AT_LINE (498)) ;
      ...
      {
        GGS_isr_map::cEnumerator enumerator_17982 (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (506)), true) ;
        const GGS_isr_map::cElement * operand_17982 = NULL ;
        while (((operand_17982 = enumerator_17982.nextObject ()))) {
          macroValidPointer (operand_17982) ;
          const GGS_bool cond_18232 = function_isInLstringlist (inLexique, operand_17982->mInfo.isr.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (507)), operand_17167->mKey COMMA_SOURCE_FILE_AT_LINE (507)) ;
          if (cond_18232.isBuiltAndTrue ()) {
            ...
            ::routine_addStringFieldValue (inLexique,  var_cas_usage,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (509)),  operand_17982->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (509)) COMMA_SOURCE_FILE_AT_LINE (509)) ;
      ...
      ::routine_setAppRelatedAttributes (inLexique,  var_cas_fieldMap,  var_cas_cpu,  var_cas_appForObj,  operand_17167->mKey COMMA_SOURCE_FILE_AT_LINE (516)) ;
      { const GGS_resource_property_obj _var_18784 = operand_17167->mInfo.resource.reader_property (inLexique COMMA_SOURCE_FILE_AT_LINE (519)) ; // CAST instruction
        if (_var_18784.getPtr () != NULL) {
          macroValidPointer (_var_18784.getPtr ()) ;
          if (typeid (cPtr_resource_property_standard_obj) == typeid (* (_var_18784.getPtr ()))) {
            var_cas_regularList.addAssign_operation (var_cas_fieldMap) ;
          }else if (typeid (cPtr_resource_property_linked_obj) == typeid (* (_var_18784.getPtr ()))) {
            var_cas_regularList.addAssign_operation (var_cas_fieldMap) ;
          }else if (typeid (cPtr_resource_property_internal_obj) == typeid (* (_var_18784.getPtr ()))) {
            var_cas_internalList.addAssign_operation (var_cas_fieldMap) ;
          }else{
            operand_17167->mInfo.resource.reader_property (inLexique COMMA_SOURCE_FILE_AT_LINE (527)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (527)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error, RESOURCEPROPERTY type is undefined") COMMA_SOURCE_FILE_AT_LINE (528)) ;
          }
        }
      }
    }
...
void routine_setFilter (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_filter_prop_obj _var_22591 = var_cas_filter ; // CAST instruction
    if (_var_22591.getPtr () != NULL) {
      macroValidPointer (_var_22591.getPtr ()) ;
      if (typeid (cPtr_always_filter) == typeid (* (_var_22591.getPtr ()))) {
      ...
      }else if (typeid (cPtr_never_filter) == typeid (* (_var_22591.getPtr ()))) {
      ...
      }else if (typeid (cPtr_maskednewequalsx_filter) == typeid (* (_var_22591.getPtr ()))) {
        const GGS_maskednewequalsx_filter var_cas_maskedNewEqualsXFilter (_var_22591.getPtr ()) ;
      ...
      }else if (typeid (cPtr_maskednewdiffersx_filter) == typeid (* (_var_22591.getPtr ()))) {
        const GGS_maskednewdiffersx_filter var_cas_maskedNewDiffersXFilter (_var_22591.getPtr ()) ;
      ...
      }else if (typeid (cPtr_newisequal_filter) == typeid (* (_var_22591.getPtr ()))) {
      ...
      }else if (typeid (cPtr_newisdifferent_filter) == typeid (* (_var_22591.getPtr ()))) {
      ...
      }else if (typeid (cPtr_maskednewequalsmaskedold_filter) == typeid (* (_var_22591.getPtr ()))) {
        const GGS_maskednewequalsmaskedold_filter var_cas_maskedNewEqualsMaskedOldFilter (_var_22591.getPtr ()) ;
      ...
      }else if (typeid (cPtr_maskednewdiffersmaskedold_filter) == typeid (* (_var_22591.getPtr ()))) {
        const GGS_maskednewdiffersmaskedold_filter var_cas_maskedNewDiffersMaskedOldFilter (_var_22591.getPtr ()) ;
      ...
      }else if (typeid (cPtr_newiswithin) == typeid (* (_var_22591.getPtr ()))) {
        const GGS_newiswithin var_cas_newIsWithinFilter (_var_22591.getPtr ()) ;
      ...
      }else if (typeid (cPtr_newisoutside) == typeid (* (_var_22591.getPtr ()))) {
        const GGS_newisoutside var_cas_newIsOutsideFilter (_var_22591.getPtr ()) ;
      ...
      }else if (typeid (cPtr_newisgreater_filter) == typeid (* (_var_22591.getPtr ()))) {
      ...
      }else if (typeid (cPtr_newislessorequal_filter) == typeid (* (_var_22591.getPtr ()))) {
      ...
      }else if (typeid (cPtr_newisless_filter) == typeid (* (_var_22591.getPtr ()))) {
      ...
      }else if (typeid (cPtr_newisgreaterorequal_filter) == typeid (* (_var_22591.getPtr ()))) {
      ...
      }else if (typeid (cPtr_oneeveryn_filter) == typeid (* (_var_22591.getPtr ()))) {
        const GGS_oneeveryn_filter var_cas_oneEveryNFilter (_var_22591.getPtr ()) ;
...
void routine_setMessagesList (C_Compiler & inLexique,
  ...
  {
    GGS_message_map::cEnumerator enumerator_22975 (var_cas_cpu.reader_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (618)), true) ;
    const GGS_message_map::cElement * operand_22975 = NULL ;
    while (((operand_22975 = enumerator_22975.nextObject ()))) {
      macroValidPointer (operand_22975) ;
      { const GGS_mess_prop_obj _var_23787 = operand_22975->mInfo.mess.reader_messageproperty (inLexique COMMA_SOURCE_FILE_AT_LINE (619)) ; // CAST instruction
        if (_var_23787.getPtr () != NULL) {
          macroValidPointer (_var_23787.getPtr ()) ;
          if (typeid (cPtr_rzi_mess_prop) == typeid (* (_var_23787.getPtr ()))) {
            const GGS_rzi_mess_prop var_cas_receiveZeroInternalMessage (_var_23787.getPtr ()) ;
            ...
            var_cas_internalReceiversList.addAssign_operation (operand_22975->mInfo.mess, var_cas_sendMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (622)), var_cas_sendMessage.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (622)), operand_22975->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (622)), operand_22975->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (622))) ;
          }else if (typeid (cPtr_rui_mess_prop) == typeid (* (_var_23787.getPtr ()))) {
            const GGS_rui_mess_prop var_cas_receiveUnqueuedInternalMessage (_var_23787.getPtr ()) ;
            ...
            var_cas_internalReceiversList.addAssign_operation (operand_22975->mInfo.mess, var_cas_sendMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (625)), var_cas_sendMessage.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (625)), operand_22975->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (625)), operand_22975->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (625))) ;
          }else if (typeid (cPtr_rqi_mess_prop) == typeid (* (_var_23787.getPtr ()))) {
            const GGS_rqi_mess_prop var_cas_receiveQueuedInternalMessage (_var_23787.getPtr ()) ;
            ...
            var_cas_internalReceiversList.addAssign_operation (operand_22975->mInfo.mess, var_cas_sendMessage.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (628)), var_cas_sendMessage.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (628)), operand_22975->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (628)), operand_22975->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (628))) ;
          }else{
          }
        }
      }
  ...
  {
    GGS_receiverSortedList::cEnumerator enumerator_24536 (var_cas_internalReceiversList, true) ;
    const GGS_receiverSortedList::cElement * operand_24536 = NULL ;
    while (((operand_24536 = enumerator_24536.nextObject ()))) {
      macroValidPointer (operand_24536) ;
      const GGS_bool cond_24705 = (var_cas_internalTargets.reader_hasKey (operand_24536->senderName)).operator_not () ;
      if (cond_24705.isBuiltAndTrue ()) {
        var_cas_internalTargets.modifier_put (inLexique, function_lstringWith (inLexique, operand_24536->senderName COMMA_SOURCE_FILE_AT_LINE (648)), GGS_lstring ::constructor_new (inLexique, operand_24536->receiverName, operand_24536->receiverLocation COMMA_SOURCE_FILE_AT_LINE (648)) COMMA_SOURCE_FILE_AT_LINE (648)) ;
      }
      const GGS_bool cond_24865 = (operand_24536->senderName).operator_isEqual (var_cas_previousSender) ;
      if (cond_24865.isBuiltAndTrue ()) {
        var_cas_nextTargets.modifier_put (inLexique, function_lstringWith (inLexique, var_cas_previousReceiver COMMA_SOURCE_FILE_AT_LINE (651)), GGS_lstring ::constructor_new (inLexique, operand_24536->receiverName, operand_24536->receiverLocation COMMA_SOURCE_FILE_AT_LINE (651)) COMMA_SOURCE_FILE_AT_LINE (651)) ;
      }
      var_cas_previousSender = operand_24536->senderName ;
      var_cas_previousReceiver = operand_24536->receiverName ;
      var_cas_actualInternalReceiverList.addAssign_operation (operand_24536->mess, operand_24536->senderName, operand_24536->senderLocation, operand_24536->receiverName, operand_24536->receiverLocation) ;
    }
  }
  ...
  {
    GGS_receiverReverseSortedList::cEnumerator enumerator_25359 (var_cas_actualInternalReceiverList, true) ;
    const GGS_receiverReverseSortedList::cElement * operand_25359 = NULL ;
    while (((operand_25359 = enumerator_25359.nextObject ()))) {
      ...
      ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), operand_25359->receiverLocation COMMA_SOURCE_FILE_AT_LINE (667)),  operand_25359->receiverName COMMA_SOURCE_FILE_AT_LINE (667)) ;
      const GGS_bool cond_25832 = var_cas_nextTargets.reader_hasKey (operand_25359->receiverName) ;
      if (cond_25832.isBuiltAndTrue ()) {
        GGS_lstring  var_cas_nextReceiveMessage ;
        const GGS_lstringMap  temp_25632 = var_cas_nextTargets ;
        if (temp_25632.isBuilt ()) {
          temp_25632 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, operand_25359->receiverName, operand_25359->receiverLocation COMMA_SOURCE_FILE_AT_LINE (671)), var_cas_nextReceiveMessage COMMA_SOURCE_FILE_AT_LINE (671)) ;
        }
      ...
      GGS_mess_prop_obj  var_cas_messageProperty = operand_25359->mess.reader_messageproperty (inLexique COMMA_SOURCE_FILE_AT_LINE (674)) ;
      { const GGS_mess_prop_obj _var_28393 = var_cas_messageProperty ; // CAST instruction
        if (_var_28393.getPtr () != NULL) {
          macroValidPointer (_var_28393.getPtr ()) ;
          if (typeid (cPtr_rzi_mess_prop) == typeid (* (_var_28393.getPtr ()))) {
            const GGS_rzi_mess_prop var_cas_receiveZeroInternalMessage (_var_28393.getPtr ()) ;
          ...
          }else if (typeid (cPtr_rui_mess_prop) == typeid (* (_var_28393.getPtr ()))) {
            const GGS_rui_mess_prop var_cas_receiveUnqueuedInternalMessage (_var_28393.getPtr ()) ;
            ...
            const GGS_message_map  temp_26584 = var_cas_cpu.reader_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (684)) ;
            if (temp_26584.isBuilt ()) {
              temp_26584 (HERE)->method_get (inLexique, var_cas_senderName, var_cas_sender COMMA_SOURCE_FILE_AT_LINE (684)) ;
            }
            { const GGS_mess_prop_obj _var_27341 = var_cas_sender.reader_messageproperty (inLexique COMMA_SOURCE_FILE_AT_LINE (685)) ; // CAST instruction
              if (_var_27341.getPtr () != NULL) {
                macroValidPointer (_var_27341.getPtr ()) ;
                if (typeid (cPtr_ssi_mess_prop) == typeid (* (_var_27341.getPtr ()))) {
                  const GGS_ssi_mess_prop var_cas_sendStaticInternalSender (_var_27341.getPtr ()) ;
                  ...
                  const GGS_basic_type  temp_26936 = var_cas_initialValue ;
                  if (temp_26936.isBuilt ()) {
                    temp_26936 (HERE)->method_string (inLexique, var_cas_initialValueString COMMA_SOURCE_FILE_AT_LINE (690)) ;
                  }
                  const GGS_bool cond_27130 = (var_cas_initialValueString).operator_isNotEqual (GGS_string ("")) ;
          ...
          }else if (typeid (cPtr_rqi_mess_prop) == typeid (* (_var_28393.getPtr ()))) {
            const GGS_rqi_mess_prop var_cas_receiveQueuedInternalMessage (_var_28393.getPtr ()) ;
            ...
            GGS_message_obj  var_cas_sender ;
            const GGS_message_map  temp_27889 = var_cas_cpu.reader_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (705)) ;
            if (temp_27889.isBuilt ()) {
              temp_27889 (HERE)->method_get (inLexique, var_cas_senderName, var_cas_sender COMMA_SOURCE_FILE_AT_LINE (705)) ;
            }
            { const GGS_mess_prop_obj _var_28300 = var_cas_sender.reader_messageproperty (inLexique COMMA_SOURCE_FILE_AT_LINE (706)) ; // CAST instruction
              if (_var_28300.getPtr () != NULL) {
                macroValidPointer (_var_28300.getPtr ()) ;
                if (typeid (cPtr_ssi_mess_prop) == typeid (* (_var_28300.getPtr ()))) {
                  const GGS_ssi_mess_prop var_cas_sendStaticInternalSender (_var_28300.getPtr ()) ;
      ...
      ::routine_setAction (inLexique,  var_cas_fieldMap,  operand_25359->mess.reader_notification (inLexique COMMA_SOURCE_FILE_AT_LINE (717)) COMMA_SOURCE_FILE_AT_LINE (717)) ;
  ...
  {
    GGS_message_map::cEnumerator enumerator_28550 (var_cas_cpu.reader_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (722)), true) ;
    const GGS_message_map::cElement * operand_28550 = NULL ;
    while (((operand_28550 = enumerator_28550.nextObject ()))) {
      ...
      GGS_mess_prop_obj  var_cas_messageProperty = operand_28550->mInfo.mess.reader_messageproperty (inLexique COMMA_SOURCE_FILE_AT_LINE (724)) ;
      GGS_bool var_cas_okMessage = GGS_bool (true) ;
      GGS_bool var_cas_isSendMessage = GGS_bool (true) ;
      { const GGS_mess_prop_obj _var_31723 = var_cas_messageProperty ; // CAST instruction
        if (_var_31723.getPtr () != NULL) {
          macroValidPointer (_var_31723.getPtr ()) ;
          if (typeid (cPtr_ssi_mess_prop) == typeid (* (_var_31723.getPtr ()))) {
            const GGS_ssi_mess_prop var_cas_sendStaticInternalMessage (_var_31723.getPtr ()) ;
            ...
            const GGS_lstringMap  temp_29088 = var_cas_internalTargets ;
            if (temp_29088.isBuilt ()) {
              temp_29088 (HERE)->method_get (inLexique, operand_28550->mKey, var_cas_targetMessage COMMA_SOURCE_FILE_AT_LINE (732)) ;
            }
          ...
          }else if (typeid (cPtr_szi_mess_prop) == typeid (* (_var_31723.getPtr ()))) {
            ...
            GGS_lstring  var_cas_targetMessage ;
            const GGS_lstringMap  temp_29384 = var_cas_internalTargets ;
            if (temp_29384.isBuilt ()) {
              temp_29384 (HERE)->method_get (inLexique, operand_28550->mKey, var_cas_targetMessage COMMA_SOURCE_FILE_AT_LINE (737)) ;
            }
          ...
          }else if (typeid (cPtr_rzs_mess_prop) == typeid (* (_var_31723.getPtr ()))) {
            const GGS_rzs_mess_prop var_cas_receiveZeroSendersMessage (_var_31723.getPtr ()) ;
            ...
            GGS_string var_cas_initialValueString ;
            const GGS_basic_type  temp_31458 = var_cas_initialValue ;
            if (temp_31458.isBuilt ()) {
              temp_31458 (HERE)->method_string (inLexique, var_cas_initialValueString COMMA_SOURCE_FILE_AT_LINE (765)) ;
            }
            const GGS_bool cond_31646 = (var_cas_initialValueString).operator_isNotEqual (GGS_string ("")) ;
            if (cond_31646.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_32000 = var_cas_okMessage ;
      if (cond_32000.isBuiltAndTrue ()) {
        ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("NAME") COMMA_SOURCE_FILE_AT_LINE (774)),  operand_28550->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (774)) COMMA_SOURCE_FILE_AT_LINE (774)) ;
        var_cas_messagesList.addAssign_operation (var_cas_fieldMap) ;
        const GGS_bool cond_31936 = var_cas_isSendMessage ;
        if (cond_31936.isBuiltAndTrue ()) {
          var_cas_sendMessagesList.addAssign_operation (var_cas_fieldMap) ;
        }else if (cond_31936.isBuiltAndFalse ()) {
          var_cas_receiveMessagesList.addAssign_operation (var_cas_fieldMap) ;
        }
      }
    }
...
void routine_setScheduletablesList (C_Compiler & inLexique,
  ...
  {
    GGS_scheduletable_map::cEnumerator enumerator_32459 (var_cas_cpu.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (797)), true) ;
    const GGS_scheduletable_map::cElement * operand_32459 = NULL ;
    while (((operand_32459 = enumerator_32459.nextObject ()))) {
      macroValidPointer (operand_32459) ;
      ...
      ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("NAME") COMMA_SOURCE_FILE_AT_LINE (799)),  operand_32459->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (799)) COMMA_SOURCE_FILE_AT_LINE (799)) ;
      ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("COUNTER") COMMA_SOURCE_FILE_AT_LINE (800)),  operand_32459->mInfo.scheduletable.reader_counter (inLexique COMMA_SOURCE_FILE_AT_LINE (800)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (800)) COMMA_SOURCE_FILE_AT_LINE (800)) ;
      GGS_bool var_cas_periodic = GGS_bool (false) ;
      { const GGS_basic_type _var_32829 = operand_32459->mInfo.scheduletable.reader_periodic (inLexique COMMA_SOURCE_FILE_AT_LINE (803)) ; // CAST instruction
        if (_var_32829.getPtr () != NULL) {
          macroValidPointer (_var_32829.getPtr ()) ;
          if (typeid (cPtr_bool_class) == typeid (* (_var_32829.getPtr ()))) {
            const GGS_bool_class var_cas_p (_var_32829.getPtr ()) ;
      ...
      { const GGS_ltgt_sync_obj _var_33367 = operand_32459->mInfo.scheduletable.reader_ltgt_sync (inLexique COMMA_SOURCE_FILE_AT_LINE (810)) ; // CAST instruction
        if (_var_33367.getPtr () != NULL) {
          macroValidPointer (_var_33367.getPtr ()) ;
          if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_33367.getPtr ()))) {
            const GGS_ltgt_sync_true var_cas_syncStrategyTrue (_var_33367.getPtr ()) ;
      ...
      { const GGS_autostart_obj _var_34531 = operand_32459->mInfo.scheduletable.reader_autostart (inLexique COMMA_SOURCE_FILE_AT_LINE (821)) ; // CAST instruction
        if (_var_34531.getPtr () != NULL) {
          macroValidPointer (_var_34531.getPtr ()) ;
          if (typeid (cPtr_sd_autostart_false) == typeid (* (_var_34531.getPtr ()))) {
            const GGS_sd_autostart_false var_cas_autostartFalse (_var_34531.getPtr ()) ;
          ...
          }else if (typeid (cPtr_sd_autostart_synchron) == typeid (* (_var_34531.getPtr ()))) {
            const GGS_sd_autostart_synchron var_cas_autostartSynchron (_var_34531.getPtr ()) ;
          ...
          }else if (typeid (cPtr_sd_autostart_relative) == typeid (* (_var_34531.getPtr ()))) {
            const GGS_sd_autostart_relative var_cas_autostartRelative (_var_34531.getPtr ()) ;
          ...
          }else if (typeid (cPtr_sd_autostart_absolute) == typeid (* (_var_34531.getPtr ()))) {
            const GGS_sd_autostart_absolute var_cas_autostartAbsolute (_var_34531.getPtr ()) ;
            ...
            operand_32459->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, (GGS_string ("Internal error, unexpected type for AUTOSTART attribute of schedule table ")).operator_concat (operand_32459->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (832))) COMMA_SOURCE_FILE_AT_LINE (833)) ;
          }
        }
      }
      ...
      { const GGS_basic_type _var_34954 = operand_32459->mInfo.scheduletable.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (838)) ; // CAST instruction
        if (_var_34954.getPtr () != NULL) {
          macroValidPointer (_var_34954.getPtr ()) ;
          if (typeid (cPtr_uint64_class) == typeid (* (_var_34954.getPtr ()))) {
            const GGS_uint64_class var_cas_len (_var_34954.getPtr ()) ;
            ...
            operand_32459->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal, wrong type for LENGTH attribute") COMMA_SOURCE_FILE_AT_LINE (843)) ;
          }
        }
      }
      GGS_expiry_point_list  var_cas_expiryPoints = operand_32459->mInfo.scheduletable.reader_exp_points (inLexique COMMA_SOURCE_FILE_AT_LINE (847)) ;
      ...
      const GGS_bool cond_35481 = (var_cas_lastOffset).operator_isEqual (var_cas_length) ;
      if (cond_35481.isBuiltAndTrue ()) {
        GGS_action_list  var_cas_actions = var_cas_lastPoint.reader_actions (inLexique COMMA_SOURCE_FILE_AT_LINE (853)) ;
        var_cas_actions.addAssign_operation (GGS_uint (10U), GGS_finalize_st_action ::constructor_new (inLexique, GGS_location (inLexique), operand_32459->mKey COMMA_SOURCE_FILE_AT_LINE (854))) ;
        var_cas_lastPoint.modifier_setActions (inLexique, var_cas_actions COMMA_SOURCE_FILE_AT_LINE (855)) ;
      }else if (cond_35481.isBuiltAndFalse ()) {
        GGS_action_list  var_cas_finalizeExpiryPointActions = GGS_action_list ::constructor_emptySortedList () ;
        var_cas_finalizeExpiryPointActions.addAssign_operation (GGS_uint (10U), GGS_finalize_st_action ::constructor_new (inLexique, GGS_location (inLexique), operand_32459->mKey COMMA_SOURCE_FILE_AT_LINE (859))) ;
      ...
      {
        GGS_expiry_point_list::cEnumerator enumerator_36258 (var_cas_expiryPoints, true) ;
        const GGS_expiry_point_list::cElement * operand_36258 = NULL ;
        while (((operand_36258 = enumerator_36258.nextObject ()))) {
          ...
          ::routine_addUnsignedFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("ABSOLUTEOFFSET") COMMA_SOURCE_FILE_AT_LINE (877)),  operand_36258->off COMMA_SOURCE_FILE_AT_LINE (877)) ;
          ::routine_addUnsignedFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("RELATIVEOFFSET") COMMA_SOURCE_FILE_AT_LINE (878)),  operand_36258->off.substract_operation (inLexique, var_cas_previousOffset COMMA_SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (878)) ;
          var_cas_previousOffset = operand_36258->off ;
          GGS_goilTemplateFieldMapList  var_cas_actionsList = GGS_goilTemplateFieldMapList ::constructor_emptyList () ;
          {
            GGS_action_list::cEnumerator enumerator_36693 (operand_36258->point.reader_actions (inLexique COMMA_SOURCE_FILE_AT_LINE (883)), true) ;
            const GGS_action_list::cElement * operand_36693 = NULL ;
            while (((operand_36693 = enumerator_36693.nextObject ()))) {
              macroValidPointer (operand_36693) ;
              ...
              ::routine_setAction (inLexique,  var_cas_fieldMap,  operand_36693->action COMMA_SOURCE_FILE_AT_LINE (885)) ;
          ...
          { const GGS_adjustable_obj _var_37319 = operand_36258->point.reader_adjust (inLexique COMMA_SOURCE_FILE_AT_LINE (892)) ; // CAST instruction
            if (_var_37319.getPtr () != NULL) {
              macroValidPointer (_var_37319.getPtr ()) ;
              if (typeid (cPtr_adjustable_true) == typeid (* (_var_37319.getPtr ()))) {
                const GGS_adjustable_true var_cas_adjustableExpiryPoint (_var_37319.getPtr ()) ;
      ...
      ::routine_setAppRelatedAttributes (inLexique,  var_cas_fieldMap,  var_cas_cpu,  var_cas_appForObj,  operand_32459->mKey COMMA_SOURCE_FILE_AT_LINE (904)) ;
...
void routine_computeBinaryVector (C_Compiler & inLexique,
  ...
  const GGS_bool cond_38159 = (var_cas_vec.reader_length ().modulo_operation (inLexique, GGS_uint (8U) COMMA_SOURCE_FILE_AT_LINE (925))).operator_isNotEqual (GGS_uint (0U)) ;
  if (cond_38159.isBuiltAndTrue ()) {
  ...
  GGS_uint _variant_38710 = var_cas_byteCount ;
  GGS_bool _condition_38710 (_variant_38710.isBuilt (), true) ;
  while (_condition_38710.isBuiltAndTrue ()) {
    _condition_38710 = (var_cas_i).operator_strictInf (var_cas_byteCount) ;
    if (_condition_38710.isBuiltAndTrue ()) {
      if (_variant_38710.uintValue () == 0) {
        inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (950)) ;
        _condition_38710 = GGS_bool (false) ;
      }else{
        _variant_38710.decrement_operation (inLexique COMMA_HERE) ;
        ...
        GGS_uint _variant_38634 = GGS_uint (8U) ;
        GGS_bool _condition_38634 (_variant_38634.isBuilt (), true) ;
        while (_condition_38634.isBuiltAndTrue ()) {
          _condition_38634 = (var_cas_bitPos).operator_strictInf (var_cas_byte.reader_length ()) ;
          if (_condition_38634.isBuiltAndTrue ()) {
            if (_variant_38634.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (946)) ;
              _condition_38634 = GGS_bool (false) ;
            }else{
              _variant_38634.decrement_operation (inLexique COMMA_HERE) ;
              ...
              const GGS_bool cond_38604 = (var_cas_bit).operator_isEqual (GGS_char (TO_UNICODE ('1'))) ;
              if (cond_38604.isBuiltAndTrue ()) {
...
void routine_computeVector (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_39030 = function_isInLstringlist (inLexique, var_cas_ownedObjects, var_cas_objectName COMMA_SOURCE_FILE_AT_LINE (961)) ;
  if (cond_39030.isBuiltAndTrue ()) {
    var_cas_vector.appendCString ("11") ;
  }else if (cond_39030.isBuiltAndFalse ()) {
    var_cas_vector.appendCString ("0") ;
    const GGS_bool cond_39182 = function_isInLstringlist (inLexique, var_cas_accessingObjects, var_cas_applicationName COMMA_SOURCE_FILE_AT_LINE (966)) ;
    if (cond_39182.isBuiltAndTrue ()) {
      var_cas_vector.appendCString ("1") ;
    }else if (cond_39182.isBuiltAndFalse ()) {
      var_cas_vector.appendCString ("0") ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setOsapplicationsList (C_Compiler & inLexique,
  ...
  {
    GGS_app_map::cEnumerator enumerator_39528 (var_cas_cpu.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (983)), true) ;
    const GGS_app_map::cElement * operand_39528 = NULL ;
    while (((operand_39528 = enumerator_39528.nextObject ()))) {
      macroValidPointer (operand_39528) ;
      ...
      ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("NAME") COMMA_SOURCE_FILE_AT_LINE (985)),  operand_39528->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (985)) COMMA_SOURCE_FILE_AT_LINE (985)) ;
      { const GGS_basic_type _var_39949 = operand_39528->mInfo.app.reader_restart (inLexique COMMA_SOURCE_FILE_AT_LINE (988)) ; // CAST instruction
        if (_var_39949.getPtr () != NULL) {
          macroValidPointer (_var_39949.getPtr ()) ;
          if (typeid (cPtr_string_class) == typeid (* (_var_39949.getPtr ()))) {
            const GGS_string_class var_cas_restartTask (_var_39949.getPtr ()) ;
      ...
      {
        GGS_tasks_by_type::cEnumerator enumerator_40186 (var_cas_allTaskList, true) ;
        const GGS_tasks_by_type::cElement * operand_40186 = NULL ;
        while (((operand_40186 = enumerator_40186.nextObject ()))) {
          macroValidPointer (operand_40186) ;
          GGS_task_obj  var_cas_taskItem ;
          const GGS_task_map  temp_40235 = var_cas_allTasks ;
          if (temp_40235.isBuilt ()) {
            temp_40235 (HERE)->method_get (inLexique, function_lstringWith (inLexique, operand_40186->name COMMA_SOURCE_FILE_AT_LINE (1002)), var_cas_taskItem COMMA_SOURCE_FILE_AT_LINE (1002)) ;
          }
          ::routine_computeVector (inLexique,  var_cas_vector,  function_lstringWith (inLexique, operand_40186->name COMMA_SOURCE_FILE_AT_LINE (1003)),  operand_39528->mKey,  operand_39528->mInfo.app.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (1003)).reader_keyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1003)),  var_cas_taskItem.reader_acc_apps (inLexique COMMA_SOURCE_FILE_AT_LINE (1003)) COMMA_SOURCE_FILE_AT_LINE (1003)) ;
        }
      }
      {
        GGS_isr_map::cEnumerator enumerator_40458 (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1006)), true) ;
        const GGS_isr_map::cElement * operand_40458 = NULL ;
        while (((operand_40458 = enumerator_40458.nextObject ()))) {
          macroValidPointer (operand_40458) ;
          ::routine_computeVector (inLexique,  var_cas_vector,  operand_40458->mKey,  operand_39528->mKey,  operand_39528->mInfo.app.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1007)).reader_keyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1007)),  operand_40458->mInfo.isr.reader_acc_apps (inLexique COMMA_SOURCE_FILE_AT_LINE (1007)) COMMA_SOURCE_FILE_AT_LINE (1007)) ;
        }
      }
      ...
      {
        GGS_alarm_map::cEnumerator enumerator_41094 (var_cas_cpu.reader_alarms (inLexique COMMA_SOURCE_FILE_AT_LINE (1018)), true) ;
        const GGS_alarm_map::cElement * operand_41094 = NULL ;
        while (((operand_41094 = enumerator_41094.nextObject ()))) {
          macroValidPointer (operand_41094) ;
          ::routine_computeVector (inLexique,  var_cas_vector,  operand_41094->mKey,  operand_39528->mKey,  operand_39528->mInfo.app.reader_alarms (inLexique COMMA_SOURCE_FILE_AT_LINE (1019)).reader_keyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1019)),  operand_41094->mInfo.alarm.reader_acc_apps (inLexique COMMA_SOURCE_FILE_AT_LINE (1019)) COMMA_SOURCE_FILE_AT_LINE (1019)) ;
        }
      }
      ...
      var_cas_vector = GGS_string ("") ;
      {
        GGS_resource_map::cEnumerator enumerator_41625 (var_cas_cpu.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (1028)), true) ;
        const GGS_resource_map::cElement * operand_41625 = NULL ;
        while (((operand_41625 = enumerator_41625.nextObject ()))) {
          macroValidPointer (operand_41625) ;
          ::routine_computeVector (inLexique,  var_cas_vector,  operand_41625->mKey,  operand_39528->mKey,  operand_39528->mInfo.app.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (1029)).reader_keyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1029)),  operand_41625->mInfo.resource.reader_acc_apps (inLexique COMMA_SOURCE_FILE_AT_LINE (1029)) COMMA_SOURCE_FILE_AT_LINE (1029)) ;
        }
      }
      ...
      var_cas_vector = GGS_string ("") ;
      {
        GGS_scheduletable_map::cEnumerator enumerator_42285 (var_cas_cpu.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (1041)), true) ;
        const GGS_scheduletable_map::cElement * operand_42285 = NULL ;
        while (((operand_42285 = enumerator_42285.nextObject ()))) {
          macroValidPointer (operand_42285) ;
          ::routine_computeVector (inLexique,  var_cas_vector,  operand_42285->mKey,  operand_39528->mKey,  operand_39528->mInfo.app.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (1042)).reader_keyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1042)),  operand_42285->mInfo.scheduletable.reader_acc_apps (inLexique COMMA_SOURCE_FILE_AT_LINE (1042)) COMMA_SOURCE_FILE_AT_LINE (1042)) ;
        }
      }
      ...
      var_cas_vector = GGS_string ("") ;
      {
        GGS_counter_map::cEnumerator enumerator_42867 (var_cas_cpu.reader_counters (inLexique COMMA_SOURCE_FILE_AT_LINE (1051)), true) ;
        const GGS_counter_map::cElement * operand_42867 = NULL ;
        while (((operand_42867 = enumerator_42867.nextObject ()))) {
          macroValidPointer (operand_42867) ;
          ::routine_computeVector (inLexique,  var_cas_vector,  operand_42867->mKey,  operand_39528->mKey,  operand_39528->mInfo.app.reader_counters (inLexique COMMA_SOURCE_FILE_AT_LINE (1052)).reader_keyList (inLexique COMMA_SOURCE_FILE_AT_LINE (1052)),  operand_42867->mInfo.counter.reader_acc_apps (inLexique COMMA_SOURCE_FILE_AT_LINE (1052)) COMMA_SOURCE_FILE_AT_LINE (1052)) ;
        }
      }
      ...
      GGS_goilTemplateFieldMapList  var_cas_isrList = GGS_goilTemplateFieldMapList ::constructor_emptyList () ;
      {
        GGS_ident_map::cEnumerator enumerator_43539 (operand_39528->mInfo.app.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (1063)), true) ;
        const GGS_ident_map::cElement * operand_43539 = NULL ;
        while (((operand_43539 = enumerator_43539.nextObject ()))) {
          macroValidPointer (operand_43539) ;
          ...
          ::routine_addStringFieldValue (inLexique,  var_cas_taskFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), operand_43539->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1065)) COMMA_SOURCE_FILE_AT_LINE (1065)),  operand_43539->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1065)) COMMA_SOURCE_FILE_AT_LINE (1065)) ;
          var_cas_procList.addAssign_operation (var_cas_taskFieldMap) ;
          var_cas_taskList.addAssign_operation (var_cas_taskFieldMap) ;
        }
      }
      {
        GGS_ident_map::cEnumerator enumerator_43806 (operand_39528->mInfo.app.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1069)), true) ;
        const GGS_ident_map::cElement * operand_43806 = NULL ;
        while (((operand_43806 = enumerator_43806.nextObject ()))) {
          macroValidPointer (operand_43806) ;
          ...
          ::routine_addStringFieldValue (inLexique,  var_cas_isrFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), operand_43806->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1071)) COMMA_SOURCE_FILE_AT_LINE (1071)),  operand_43806->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1071)) COMMA_SOURCE_FILE_AT_LINE (1071)) ;
      ...
      {
        GGS_ident_map::cEnumerator enumerator_44357 (operand_39528->mInfo.app.reader_alarms (inLexique COMMA_SOURCE_FILE_AT_LINE (1081)), true) ;
        const GGS_ident_map::cElement * operand_44357 = NULL ;
        while (((operand_44357 = enumerator_44357.nextObject ()))) {
          macroValidPointer (operand_44357) ;
          GGS_goilTemplateFieldMap  var_cas_alarmFieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1082)) ;
          ::routine_addStringFieldValue (inLexique,  var_cas_alarmFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), operand_44357->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1083)) COMMA_SOURCE_FILE_AT_LINE (1083)),  operand_44357->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1083)) COMMA_SOURCE_FILE_AT_LINE (1083)) ;
      ...
      {
        GGS_ident_map::cEnumerator enumerator_44888 (operand_39528->mInfo.app.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (1092)), true) ;
        const GGS_ident_map::cElement * operand_44888 = NULL ;
        while (((operand_44888 = enumerator_44888.nextObject ()))) {
          macroValidPointer (operand_44888) ;
          GGS_goilTemplateFieldMap  var_cas_resourceFieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1093)) ;
          ::routine_addStringFieldValue (inLexique,  var_cas_resourceFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), operand_44888->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1094)) COMMA_SOURCE_FILE_AT_LINE (1094)),  operand_44888->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1094)) COMMA_SOURCE_FILE_AT_LINE (1094)) ;
          ...
          GGS_resource_obj  var_cas_resource ;
          const GGS_resource_map  temp_45219 = var_cas_allResources ;
          if (temp_45219.isBuilt ()) {
            temp_45219 (HERE)->method_get (inLexique, operand_44888->mKey, var_cas_resource COMMA_SOURCE_FILE_AT_LINE (1098)) ;
          }
          { const GGS_resource_property_obj _var_45441 = var_cas_resource.reader_property (inLexique COMMA_SOURCE_FILE_AT_LINE (1099)) ; // CAST instruction
            if (_var_45441.getPtr () != NULL) {
              macroValidPointer (_var_45441.getPtr ()) ;
              if (typeid (cPtr_resource_property_internal_obj) == typeid (* (_var_45441.getPtr ()))) {
      ...
      {
        GGS_ident_map::cEnumerator enumerator_45840 (operand_39528->mInfo.app.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (1112)), true) ;
        const GGS_ident_map::cElement * operand_45840 = NULL ;
        while (((operand_45840 = enumerator_45840.nextObject ()))) {
          macroValidPointer (operand_45840) ;
          GGS_goilTemplateFieldMap  var_cas_scheduletableFieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1113)) ;
          ::routine_addStringFieldValue (inLexique,  var_cas_scheduletableFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), operand_45840->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1114)) COMMA_SOURCE_FILE_AT_LINE (1114)),  operand_45840->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1114)) COMMA_SOURCE_FILE_AT_LINE (1114)) ;
      ...
      {
        GGS_ident_map::cEnumerator enumerator_46295 (operand_39528->mInfo.app.reader_counters (inLexique COMMA_SOURCE_FILE_AT_LINE (1121)), true) ;
        const GGS_ident_map::cElement * operand_46295 = NULL ;
        while (((operand_46295 = enumerator_46295.nextObject ()))) {
          macroValidPointer (operand_46295) ;
          GGS_goilTemplateFieldMap  var_cas_counterFieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1122)) ;
          ::routine_addStringFieldValue (inLexique,  var_cas_counterFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), operand_46295->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1123)) COMMA_SOURCE_FILE_AT_LINE (1123)),  operand_46295->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1123)) COMMA_SOURCE_FILE_AT_LINE (1123)) ;
      ...
      {
        GGS_ident_map::cEnumerator enumerator_46708 (operand_39528->mInfo.app.reader_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (1130)), true) ;
        const GGS_ident_map::cElement * operand_46708 = NULL ;
        while (((operand_46708 = enumerator_46708.nextObject ()))) {
          macroValidPointer (operand_46708) ;
          GGS_goilTemplateFieldMap  var_cas_messageFieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1131)) ;
          ::routine_addStringFieldValue (inLexique,  var_cas_messageFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NAME"), operand_46708->mKey.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1132)) COMMA_SOURCE_FILE_AT_LINE (1132)),  operand_46708->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1132)) COMMA_SOURCE_FILE_AT_LINE (1132)) ;
      ...
      { const GGS_app_trusted_obj _var_47278 = operand_39528->mInfo.app.reader_trusted (inLexique COMMA_SOURCE_FILE_AT_LINE (1139)) ; // CAST instruction
        if (_var_47278.getPtr () != NULL) {
          macroValidPointer (_var_47278.getPtr ()) ;
          if (typeid (cPtr_app_trusted_true) == typeid (* (_var_47278.getPtr ()))) {
            const GGS_app_trusted_true var_cas_t (_var_47278.getPtr ()) ;
            {
              GGS_stringset::cEnumerator enumerator_47146 (var_cas_t.reader_trusted_fcts (inLexique COMMA_SOURCE_FILE_AT_LINE (1141)), true) ;
              while (enumerator_47146.hasCurrentObject ()) {
                var_cas_trustedFunctionSet.addAssign_operation (enumerator_47146._key (HERE)) ;
                enumerator_47146.next () ;
              }
            }
          }else{
          }
  ...
  {
    GGS_stringset::cEnumerator enumerator_47467 (var_cas_trustedFunctionSet, true) ;
    while (enumerator_47467.hasCurrentObject ()) {
      GGS_goilTemplateFieldMap  var_cas_fieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1150)) ;
      ::routine_addStringFieldValue (inLexique,  var_cas_fieldMap,  function_lstringWith (inLexique, GGS_string ("NAME") COMMA_SOURCE_FILE_AT_LINE (1151)),  enumerator_47467._key (HERE) COMMA_SOURCE_FILE_AT_LINE (1151)) ;
      var_cas_trustedfunctionsList.addAssign_operation (var_cas_fieldMap) ;
      enumerator_47467.next () ;
    }
  }
...
void routine_setReadyList (C_Compiler & inLexique,
  ...
  const GGS_bool cond_48422 = var_cas_config.reader_hasKey (GGS_string ("POWEROF2QUEUE")) ;
  if (cond_48422.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_pw ;
    const GGS_ident_map  temp_48211 = var_cas_config ;
    if (temp_48211.isBuilt ()) {
      temp_48211 (HERE)->method_get (inLexique, GGS_lstring ::constructor_new (inLexique, GGS_string ("POWEROF2QUEUE"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1174)), var_cas_pw COMMA_SOURCE_FILE_AT_LINE (1174)) ;
    }
    { const GGS_basic_type _var_48410 = var_cas_pw ; // CAST instruction
      if (_var_48410.getPtr () != NULL) {
        macroValidPointer (_var_48410.getPtr ()) ;
        if (typeid (cPtr_bool_class) == typeid (* (_var_48410.getPtr ()))) {
          const GGS_bool_class var_cas_b (_var_48410.getPtr ()) ;
  ...
  {
    GGS_prio_list::cEnumerator enumerator_48449 (var_cas_readyList, true) ;
    const GGS_prio_list::cElement * operand_48449 = NULL ;
    while (((operand_48449 = enumerator_48449.nextObject ()))) {
      macroValidPointer (operand_48449) ;
      GGS_goilTemplateFieldMap  var_cas_fifoFieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1184)) ;
      GGS_uint  var_cas_maxSize ;
      const GGS_bool cond_48680 = var_cas_powerof2 ;
      if (cond_48680.isBuiltAndTrue ()) {
        var_cas_maxSize = GGS_uint (1U) ;
        GGS_uint _variant_48665 = GGS_uint (32U) ;
        GGS_bool _condition_48665 (_variant_48665.isBuilt (), true) ;
        while (_condition_48665.isBuiltAndTrue ()) {
          _condition_48665 = (operand_48449->fifosize).operator_strictSup (var_cas_maxSize) ;
          if (_condition_48665.isBuiltAndTrue ()) {
            if (_variant_48665.uintValue () == 0) {
              inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (1191)) ;
              _condition_48665 = GGS_bool (false) ;
            }else{
              _variant_48665.decrement_operation (inLexique COMMA_HERE) ;
              var_cas_maxSize = var_cas_maxSize.left_shift_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (1190)) ;
            }
          }
        }
      }else if (cond_48680.isBuiltAndFalse ()) {
        var_cas_maxSize = operand_48449->fifosize ;
      }
...
void routine_setProcessCount (C_Compiler & inLexique,
  ...
  {
    GGS_task_map::cEnumerator enumerator_49274 (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (1213)), true) ;
    const GGS_task_map::cElement * operand_49274 = NULL ;
    while (((operand_49274 = enumerator_49274.nextObject ()))) {
      macroValidPointer (operand_49274) ;
      const GGS_bool cond_49357 = (operand_49274->mInfo.task.reader_events (inLexique COMMA_SOURCE_FILE_AT_LINE (1214)).reader_length ()).operator_strictSup (GGS_uint (0U)) ;
      if (cond_49357.isBuiltAndTrue ()) {
  ...
  {
    GGS_isr_map::cEnumerator enumerator_49415 (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1219)), true) ;
    const GGS_isr_map::cElement * operand_49415 = NULL ;
    while (((operand_49415 = enumerator_49415.nextObject ()))) {
      macroValidPointer (operand_49415) ;
      { const GGS_basic_type _var_49616 = operand_49415->mInfo.isr.reader_category (inLexique COMMA_SOURCE_FILE_AT_LINE (1220)) ; // CAST instruction
        if (_var_49616.getPtr () != NULL) {
          macroValidPointer (_var_49616.getPtr ()) ;
          if (typeid (cPtr_uint64_class) == typeid (* (_var_49616.getPtr ()))) {
            const GGS_uint64_class var_cas_cat (_var_49616.getPtr ()) ;
            const GGS_bool cond_49548 = (var_cas_cat.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (1222))).operator_isEqual (GGS_uint64 (2ULL)) ;
            if (cond_49548.isBuiltAndTrue ()) {
              var_cas_isr2Count.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1223)) ;
            }
          }else{
            operand_49415->mKey.reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("missing CATEGORY attribute") COMMA_SOURCE_FILE_AT_LINE (1227)) ;
          }
        }
      }
    }
  }
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TASKCOUNT"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1229)),  var_cas_taskCount COMMA_SOURCE_FILE_AT_LINE (1229)) ;
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("EXTENDEDTASKCOUNT"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1230)),  var_cas_extendedCount COMMA_SOURCE_FILE_AT_LINE (1230)) ;
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("BASICTASKCOUNT"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1231)),  var_cas_taskCount.substract_operation (inLexique, var_cas_extendedCount COMMA_SOURCE_FILE_AT_LINE (1231)) COMMA_SOURCE_FILE_AT_LINE (1231)) ;
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("PROCESSCOUNT"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1232)),  var_cas_taskCount.add_operation (inLexique, var_cas_isr2Count COMMA_SOURCE_FILE_AT_LINE (1232)) COMMA_SOURCE_FILE_AT_LINE (1232)) ;
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("ISRCOUNT"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1233)),  var_cas_isrCount COMMA_SOURCE_FILE_AT_LINE (1233)) ;
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("ISR2COUNT"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1234)),  var_cas_isr2Count COMMA_SOURCE_FILE_AT_LINE (1234)) ;
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("ISR1COUNT"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1235)),  var_cas_isrCount.substract_operation (inLexique, var_cas_isr2Count COMMA_SOURCE_FILE_AT_LINE (1235)) COMMA_SOURCE_FILE_AT_LINE (1235)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setResourceCount (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("RESOURCECOUNT"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1242)),  var_cas_cpu.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (1242)).reader_count ().reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (1242)) COMMA_SOURCE_FILE_AT_LINE (1242)) ;
  GGS_uint64  var_cas_regularCount = GGS_uint64 (0ULL) ;
  GGS_uint64  var_cas_internalCount = GGS_uint64 (0ULL) ;
  {
    GGS_resource_map::cEnumerator enumerator_50536 (var_cas_cpu.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (1245)), true) ;
    const GGS_resource_map::cElement * operand_50536 = NULL ;
    while (((operand_50536 = enumerator_50536.nextObject ()))) {
      macroValidPointer (operand_50536) ;
      { const GGS_resource_property_obj _var_50905 = operand_50536->mInfo.resource.reader_property (inLexique COMMA_SOURCE_FILE_AT_LINE (1246)) ; // CAST instruction
        if (_var_50905.getPtr () != NULL) {
          macroValidPointer (_var_50905.getPtr ()) ;
          if (typeid (cPtr_resource_property_standard_obj) == typeid (* (_var_50905.getPtr ()))) {
            var_cas_regularCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1248)) ;
          }else if (typeid (cPtr_resource_property_linked_obj) == typeid (* (_var_50905.getPtr ()))) {
            var_cas_regularCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1250)) ;
          }else if (typeid (cPtr_resource_property_internal_obj) == typeid (* (_var_50905.getPtr ()))) {
            var_cas_internalCount.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (1252)) ;
          }else{
            operand_50536->mInfo.resource.reader_property (inLexique COMMA_SOURCE_FILE_AT_LINE (1254)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1254)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("internal error, RESOURCEPROPERTY type is undefined") COMMA_SOURCE_FILE_AT_LINE (1255)) ;
          }
        }
      }
    }
  }
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("REGULARRESOURCECOUNT"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1257)),  var_cas_regularCount COMMA_SOURCE_FILE_AT_LINE (1257)) ;
  ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("INTERNALRESOURCECOUNT"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1258)),  var_cas_internalCount COMMA_SOURCE_FILE_AT_LINE (1258)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setSourceFileList (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_51291 (var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1266)).reader_app_src (inLexique COMMA_SOURCE_FILE_AT_LINE (1266)), true) ;
    const GGS_lstringlist::cElement * operand_51291 = NULL ;
    while (((operand_51291 = enumerator_51291.nextObject ()))) {
      macroValidPointer (operand_51291) ;
      GGS_goilTemplateFieldMap  var_cas_sourceFileFieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1267)) ;
      ::routine_addStringFieldValue (inLexique,  var_cas_sourceFileFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("FILE"), operand_51291->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1268)) COMMA_SOURCE_FILE_AT_LINE (1268)),  operand_51291->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1268)) COMMA_SOURCE_FILE_AT_LINE (1268)) ;
...
void routine_setCFlagsList (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_51806 (var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1279)).reader_cflags (inLexique COMMA_SOURCE_FILE_AT_LINE (1279)), true) ;
    const GGS_lstringlist::cElement * operand_51806 = NULL ;
    while (((operand_51806 = enumerator_51806.nextObject ()))) {
      macroValidPointer (operand_51806) ;
      const GGS_bool cond_52089 = (function_stripString (inLexique, operand_51806->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1280)) COMMA_SOURCE_FILE_AT_LINE (1280))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_52089.isBuiltAndTrue ()) {
        GGS_goilTemplateFieldMap  var_cas_cFlagFieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1281)) ;
        ::routine_addStringFieldValue (inLexique,  var_cas_cFlagFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("CFLAG"), operand_51806->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1282)) COMMA_SOURCE_FILE_AT_LINE (1282)),  operand_51806->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1282)) COMMA_SOURCE_FILE_AT_LINE (1282)) ;
...
void routine_setAsFlagsList (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_52346 (var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1294)).reader_asflags (inLexique COMMA_SOURCE_FILE_AT_LINE (1294)), true) ;
    const GGS_lstringlist::cElement * operand_52346 = NULL ;
    while (((operand_52346 = enumerator_52346.nextObject ()))) {
      macroValidPointer (operand_52346) ;
      const GGS_bool cond_52639 = (function_stripString (inLexique, operand_52346->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1295)) COMMA_SOURCE_FILE_AT_LINE (1295))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_52639.isBuiltAndTrue ()) {
        GGS_goilTemplateFieldMap  var_cas_asFlagFieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1296)) ;
        ::routine_addStringFieldValue (inLexique,  var_cas_asFlagFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("ASFLAG"), operand_52346->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1297)) COMMA_SOURCE_FILE_AT_LINE (1297)),  operand_52346->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1297)) COMMA_SOURCE_FILE_AT_LINE (1297)) ;
...
void routine_setLdFlagsList (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_52898 (var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1309)).reader_ldflags (inLexique COMMA_SOURCE_FILE_AT_LINE (1309)), true) ;
    const GGS_lstringlist::cElement * operand_52898 = NULL ;
    while (((operand_52898 = enumerator_52898.nextObject ()))) {
      macroValidPointer (operand_52898) ;
      const GGS_bool cond_53191 = (function_stripString (inLexique, operand_52898->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1310)) COMMA_SOURCE_FILE_AT_LINE (1310))).operator_isNotEqual (GGS_string ("")) ;
      if (cond_53191.isBuiltAndTrue ()) {
        GGS_goilTemplateFieldMap  var_cas_ldFlagFieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1311)) ;
        ::routine_addStringFieldValue (inLexique,  var_cas_ldFlagFieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("LDFLAG"), operand_52898->mValue.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1312)) COMMA_SOURCE_FILE_AT_LINE (1312)),  operand_52898->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1312)) COMMA_SOURCE_FILE_AT_LINE (1312)) ;
...
void routine_setTraceFlag (C_Compiler & inLexique,
  ...
  #endif
  { const GGS_trace _var_55639 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1323)).reader_trace (inLexique COMMA_SOURCE_FILE_AT_LINE (1323)) ; // CAST instruction
    if (_var_55639.getPtr () != NULL) {
      macroValidPointer (_var_55639.getPtr ()) ;
      if (typeid (cPtr_trace) == typeid (* (_var_55639.getPtr ()))) {
        const GGS_trace var_cas_noTrace (_var_55639.getPtr ()) ;
        ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USETRACE"), var_cas_noTrace.reader_loc (inLexique COMMA_SOURCE_FILE_AT_LINE (1325)) COMMA_SOURCE_FILE_AT_LINE (1325)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1325)) ;
      }else if (typeid (cPtr_trace_off) == typeid (* (_var_55639.getPtr ()))) {
        const GGS_trace_off var_cas_traceOff (_var_55639.getPtr ()) ;
        ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USETRACE"), var_cas_traceOff.reader_loc (inLexique COMMA_SOURCE_FILE_AT_LINE (1327)) COMMA_SOURCE_FILE_AT_LINE (1327)),  GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1327)) ;
      }else if (typeid (cPtr_trace_on) == typeid (* (_var_55639.getPtr ()))) {
        const GGS_trace_on var_cas_traceOn (_var_55639.getPtr ()) ;
        ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USETRACE"), var_cas_traceOn.reader_loc (inLexique COMMA_SOURCE_FILE_AT_LINE (1329)) COMMA_SOURCE_FILE_AT_LINE (1329)),  GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1329)) ;
        ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACEFORMAT"), var_cas_traceOn.reader_form (inLexique COMMA_SOURCE_FILE_AT_LINE (1330)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1330)) COMMA_SOURCE_FILE_AT_LINE (1330)),  var_cas_traceOn.reader_form (inLexique COMMA_SOURCE_FILE_AT_LINE (1330)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1330)) COMMA_SOURCE_FILE_AT_LINE (1330)) ;
        const GGS_bool cond_54048 = (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (1332)).reader_count ().reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (1332))).operator_strictSup (GGS_uint64 (0ULL)) ;
        if (cond_54048.isBuiltAndTrue ()) {
          ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACETASK"), var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1333)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1333)) COMMA_SOURCE_FILE_AT_LINE (1333)),  function_getBool (inLexique, var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1333)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1333)) COMMA_SOURCE_FILE_AT_LINE (1333)) ;
        }else if (cond_54048.isBuiltAndFalse ()) {
          ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACETASK"), var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1335)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1335)) COMMA_SOURCE_FILE_AT_LINE (1335)),  function_getBool (inLexique, var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1335)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1335)) COMMA_SOURCE_FILE_AT_LINE (1335)) ;
        }
        const GGS_bool cond_54377 = (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1338)).reader_count ().reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (1338))).operator_strictSup (GGS_uint64 (0ULL)) ;
        if (cond_54377.isBuiltAndTrue ()) {
          ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACEISR"), var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1339)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1339)) COMMA_SOURCE_FILE_AT_LINE (1339)),  function_getBool (inLexique, var_cas_traceOn.reader_trace_isr (inLexique COMMA_SOURCE_FILE_AT_LINE (1339)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1339)) COMMA_SOURCE_FILE_AT_LINE (1339)) ;
        }else if (cond_54377.isBuiltAndFalse ()) {
          ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACEISR"), var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1341)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1341)) COMMA_SOURCE_FILE_AT_LINE (1341)),  function_getBool (inLexique, var_cas_traceOn.reader_trace_isr (inLexique COMMA_SOURCE_FILE_AT_LINE (1341)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1341)) COMMA_SOURCE_FILE_AT_LINE (1341)) ;
        }
        const GGS_bool cond_54724 = (var_cas_cpu.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (1344)).reader_count ().reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (1344))).operator_strictSup (GGS_uint64 (0ULL)) ;
        if (cond_54724.isBuiltAndTrue ()) {
          ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACERESOURCE"), var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1345)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1345)) COMMA_SOURCE_FILE_AT_LINE (1345)),  function_getBool (inLexique, var_cas_traceOn.reader_trace_resource (inLexique COMMA_SOURCE_FILE_AT_LINE (1345)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1345)) COMMA_SOURCE_FILE_AT_LINE (1345)) ;
        }else if (cond_54724.isBuiltAndFalse ()) {
          ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACERESOURCE"), var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1347)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1347)) COMMA_SOURCE_FILE_AT_LINE (1347)),  function_getBool (inLexique, var_cas_traceOn.reader_trace_resource (inLexique COMMA_SOURCE_FILE_AT_LINE (1347)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1347)) COMMA_SOURCE_FILE_AT_LINE (1347)) ;
        }
        const GGS_bool cond_55069 = (var_cas_cpu.reader_alarms (inLexique COMMA_SOURCE_FILE_AT_LINE (1350)).reader_count ().reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (1350))).operator_strictSup (GGS_uint64 (0ULL)) ;
        if (cond_55069.isBuiltAndTrue ()) {
          ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACEALARM"), var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1351)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1351)) COMMA_SOURCE_FILE_AT_LINE (1351)),  function_getBool (inLexique, var_cas_traceOn.reader_trace_alarm (inLexique COMMA_SOURCE_FILE_AT_LINE (1351)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1351)) COMMA_SOURCE_FILE_AT_LINE (1351)) ;
        }else if (cond_55069.isBuiltAndFalse ()) {
          ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACEALARM"), var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1353)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1353)) COMMA_SOURCE_FILE_AT_LINE (1353)),  function_getBool (inLexique, var_cas_traceOn.reader_trace_alarm (inLexique COMMA_SOURCE_FILE_AT_LINE (1353)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1353)) COMMA_SOURCE_FILE_AT_LINE (1353)) ;
        }
        ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACEUSEREVENT"), var_cas_traceOn.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (1355)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1355)) COMMA_SOURCE_FILE_AT_LINE (1355)),  function_getBool (inLexique, var_cas_traceOn.reader_trace_user_event (inLexique COMMA_SOURCE_FILE_AT_LINE (1355)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (1355)) COMMA_SOURCE_FILE_AT_LINE (1355)) ;
        { const GGS_trace_method _var_55622 = var_cas_traceOn.reader_meth (inLexique COMMA_SOURCE_FILE_AT_LINE (1356)) ; // CAST instruction
          if (_var_55622.getPtr () != NULL) {
            macroValidPointer (_var_55622.getPtr ()) ;
            if (typeid (cPtr_trace_file) == typeid (* (_var_55622.getPtr ()))) {
              const GGS_trace_file var_cas_traceFile (_var_55622.getPtr ()) ;
              ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACEMETHOD"), var_cas_traceOn.reader_meth (inLexique COMMA_SOURCE_FILE_AT_LINE (1358)).reader_loc (inLexique COMMA_SOURCE_FILE_AT_LINE (1358)) COMMA_SOURCE_FILE_AT_LINE (1358)),  GGS_string ("file") COMMA_SOURCE_FILE_AT_LINE (1358)) ;
              ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRACEFILE"), var_cas_traceFile.reader_name (inLexique COMMA_SOURCE_FILE_AT_LINE (1359)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1359)) COMMA_SOURCE_FILE_AT_LINE (1359)),  var_cas_traceFile.reader_name (inLexique COMMA_SOURCE_FILE_AT_LINE (1359)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1359)) COMMA_SOURCE_FILE_AT_LINE (1359)) ;
            }else{
            }
          }
        }
...
void routine_setLinkScript (C_Compiler & inLexique,
  ...
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USELINKSCRIPT"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1370)).reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (1370)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1370)) COMMA_SOURCE_FILE_AT_LINE (1370)),  var_cas_useLinkScript COMMA_SOURCE_FILE_AT_LINE (1370)) ;
  const GGS_bool cond_56112 = var_cas_useLinkScript ;
  if (cond_56112.isBuiltAndTrue ()) {
    ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("LINKSCRIPT"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1372)).reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (1372)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1372)) COMMA_SOURCE_FILE_AT_LINE (1372)),  var_cas_linkScriptName COMMA_SOURCE_FILE_AT_LINE (1372)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setMemoryMapping (C_Compiler & inLexique,
  ...
  { const GGS_basic_type _var_57092 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1382)).reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (1382)) ; // CAST instruction
    if (_var_57092.getPtr () != NULL) {
      macroValidPointer (_var_57092.getPtr ()) ;
      if (typeid (cPtr_memmap_false) == typeid (* (_var_57092.getPtr ()))) {
        var_cas_useMemoryMapping = GGS_bool (false) ;
        var_cas_useCompilerSettings = GGS_bool (false) ;
      }else if (typeid (cPtr_memmap_true) == typeid (* (_var_57092.getPtr ()))) {
        const GGS_memmap_true var_cas_trueMemmap (_var_57092.getPtr ()) ;
        ...
        const GGS_bool cond_56678 = (var_cas_compiler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1389))).operator_isNotEqual (GGS_string ("")) ;
        if (cond_56678.isBuiltAndTrue ()) {
        ...
        const GGS_bool cond_56830 = (var_cas_assembler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1394))).operator_isNotEqual (GGS_string ("")) ;
        if (cond_56830.isBuiltAndTrue ()) {
          ::routine_addLStringValue (inLexique,  var_cas_cfg,  GGS_string ("ASSEMBLER"),  var_cas_assembler COMMA_SOURCE_FILE_AT_LINE (1395)) ;
        }
        { const GGS_basic_type _var_57075 = var_cas_trueMemmap.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (1397)) ; // CAST instruction
          if (_var_57075.getPtr () != NULL) {
            macroValidPointer (_var_57075.getPtr ()) ;
            if (typeid (cPtr_no_linker) == typeid (* (_var_57075.getPtr ()))) {
            }else if (typeid (cPtr_yes_linker) == typeid (* (_var_57075.getPtr ()))) {
              const GGS_yes_linker var_cas_yesLinker (_var_57075.getPtr ()) ;
              GGS_lstring  var_cas_linker = var_cas_yesLinker.reader_linker (inLexique COMMA_SOURCE_FILE_AT_LINE (1400)) ;
              ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("LINKER"), var_cas_linker.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1401)) COMMA_SOURCE_FILE_AT_LINE (1401)),  var_cas_linker.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1401)) COMMA_SOURCE_FILE_AT_LINE (1401)) ;
            }else{
            }
          }
        }
  ...
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEMEMORYMAPPING"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1404)).reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (1404)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1404)) COMMA_SOURCE_FILE_AT_LINE (1404)),  var_cas_useMemoryMapping COMMA_SOURCE_FILE_AT_LINE (1404)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOMPILERSETTINGS"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1405)).reader_memmap (inLexique COMMA_SOURCE_FILE_AT_LINE (1405)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1405)) COMMA_SOURCE_FILE_AT_LINE (1405)),  var_cas_useCompilerSettings COMMA_SOURCE_FILE_AT_LINE (1405)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setCompiler (C_Compiler & inLexique,
  ...
  const GGS_bool cond_57585 = (var_cas_compiler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1414))).operator_isNotEqual (GGS_string ("")) ;
  if (cond_57585.isBuiltAndTrue ()) {
    var_cas_actualCompiler = var_cas_compiler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1414)) ;
  }
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("COMPILEREXE"), var_cas_compiler.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1415)) COMMA_SOURCE_FILE_AT_LINE (1415)),  var_cas_actualCompiler COMMA_SOURCE_FILE_AT_LINE (1415)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setAssembler (C_Compiler & inLexique,
  ...
  const GGS_bool cond_57957 = (var_cas_assembler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1424))).operator_isNotEqual (GGS_string ("")) ;
  if (cond_57957.isBuiltAndTrue ()) {
    var_cas_actualAssembler = var_cas_assembler.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1424)) ;
  }
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("ASSEMBLEREXE"), var_cas_assembler.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1425)) COMMA_SOURCE_FILE_AT_LINE (1425)),  var_cas_actualAssembler COMMA_SOURCE_FILE_AT_LINE (1425)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setLinker (C_Compiler & inLexique,
  ...
  const GGS_bool cond_58309 = (var_cas_linker.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1434))).operator_isNotEqual (GGS_string ("")) ;
  if (cond_58309.isBuiltAndTrue ()) {
    var_cas_actualLinker = var_cas_linker.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1434)) ;
  }
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("LINKEREXE"), var_cas_linker.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1435)) COMMA_SOURCE_FILE_AT_LINE (1435)),  var_cas_actualLinker COMMA_SOURCE_FILE_AT_LINE (1435)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setTrampolinePath (C_Compiler & inLexique,
  ...
  const GGS_bool cond_59362 = (var_cas_trampolinePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1461))).operator_isEqual (GGS_string ("")) ;
  if (cond_59362.isBuiltAndTrue ()) {
    var_cas_trampolinePath = GGS_lstring ::constructor_new (inLexique, GGS_string (".."), var_cas_trampolinePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1462)) COMMA_SOURCE_FILE_AT_LINE (1462)) ;
  }
  ::routine_checkTrampolinePath (inLexique,  var_cas_trampolinePath COMMA_SOURCE_FILE_AT_LINE (1464)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TRAMPOLINEPATH"), var_cas_trampolinePath.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1465)) COMMA_SOURCE_FILE_AT_LINE (1465)),  var_cas_trampolinePath.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1465)) COMMA_SOURCE_FILE_AT_LINE (1465)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setSystemCall (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESYSTEMCALL"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1472)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1472)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1472)) COMMA_SOURCE_FILE_AT_LINE (1472)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1472)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1472)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1472)) COMMA_SOURCE_FILE_AT_LINE (1472)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setDebug (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEDEBUG"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1479)).reader_debug (inLexique COMMA_SOURCE_FILE_AT_LINE (1479)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1479)) COMMA_SOURCE_FILE_AT_LINE (1479)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1479)).reader_debug (inLexique COMMA_SOURCE_FILE_AT_LINE (1479)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1479)) COMMA_SOURCE_FILE_AT_LINE (1479)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_bool function_useCommunication (C_Compiler & inLexique,
  ...
  const GGS_bool cond_60974 = var_cas_comObject.reader_usecom (inLexique COMMA_SOURCE_FILE_AT_LINE (1514)) ;
  if (cond_60974.isBuiltAndTrue ()) {
    var_cas_useCom = GGS_bool (true) ;
  }else if (cond_60974.isBuiltAndFalse ()) {
...
void routine_setUseCom (C_Compiler & inLexique,
  ...
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOM"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1529)),  var_cas_useCom COMMA_SOURCE_FILE_AT_LINE (1529)) ;
  const GGS_bool cond_62664 = var_cas_useCom ;
  if (cond_62664.isBuiltAndTrue ()) {
    ...
    { const GGS_basic_type _var_61686 = var_cas_comObject.reader_timebase (inLexique COMMA_SOURCE_FILE_AT_LINE (1533)) ; // CAST instruction
      if (_var_61686.getPtr () != NULL) {
        macroValidPointer (_var_61686.getPtr ()) ;
        if (typeid (cPtr_float_class) == typeid (* (_var_61686.getPtr ()))) {
          const GGS_float_class var_cas_timeBase (_var_61686.getPtr ()) ;
    ...
    ::routine_addUnsignedValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("COMTIMEBASE"), var_cas_comObject.reader_timebase (inLexique COMMA_SOURCE_FILE_AT_LINE (1538)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1538)) COMMA_SOURCE_FILE_AT_LINE (1538)),  var_cas_timeBaseInNanoseconds COMMA_SOURCE_FILE_AT_LINE (1538)) ;
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOMERRORHOOK"), var_cas_comObject.reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1539)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1539)) COMMA_SOURCE_FILE_AT_LINE (1539)),  function_getBool (inLexique, var_cas_comObject.reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1539)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1539)) COMMA_SOURCE_FILE_AT_LINE (1539)) ;
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOMGETSERVICEID"), var_cas_comObject.reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1540)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1540)) COMMA_SOURCE_FILE_AT_LINE (1540)),  function_getBool (inLexique, var_cas_comObject.reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1540)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1540)) COMMA_SOURCE_FILE_AT_LINE (1540)) ;
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USECOMPARAMETERACCESS"), var_cas_comObject.reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1541)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1541)) COMMA_SOURCE_FILE_AT_LINE (1541)),  function_getBool (inLexique, var_cas_comObject.reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1541)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1541)) COMMA_SOURCE_FILE_AT_LINE (1541)) ;
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESTARTCOMEXTENSION"), var_cas_comObject.reader_startcomextension (inLexique COMMA_SOURCE_FILE_AT_LINE (1542)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1542)) COMMA_SOURCE_FILE_AT_LINE (1542)),  function_getBool (inLexique, var_cas_comObject.reader_startcomextension (inLexique COMMA_SOURCE_FILE_AT_LINE (1542)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1542)) COMMA_SOURCE_FILE_AT_LINE (1542)) ;
    ...
    const GGS_bool cond_62563 = (var_cas_comStatus.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1546))).operator_isEqual (GGS_string ("extended")) ;
    if (cond_62563.isBuiltAndTrue ()) {
      var_cas_comExtended = GGS_bool (true) ;
    }
    ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("COMEXTENDED"), var_cas_comStatus.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1549)) COMMA_SOURCE_FILE_AT_LINE (1549)),  var_cas_comExtended COMMA_SOURCE_FILE_AT_LINE (1549)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setExtended (C_Compiler & inLexique,
  ...
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("EXTENDED"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1559)).reader_status (inLexique COMMA_SOURCE_FILE_AT_LINE (1559)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1559)) COMMA_SOURCE_FILE_AT_LINE (1559)),  var_cas_extended COMMA_SOURCE_FILE_AT_LINE (1559)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_scalabilityClass (C_Compiler & inLexique,
  ...
  const GGS_bool cond_66459 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_66459.isBuiltAndTrue ()) {
    {
      GGS_task_map::cEnumerator enumerator_63302 (var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (1576)), true) ;
      const GGS_task_map::cElement * operand_63302 = NULL ;
      while (((operand_63302 = enumerator_63302.nextObject ()))) {
        macroValidPointer (operand_63302) ;
        { const GGS_timing_prot _var_63425 = operand_63302->mInfo.task.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (1577)) ; // CAST instruction
          if (_var_63425.getPtr () != NULL) {
            macroValidPointer (_var_63425.getPtr ()) ;
            if (typeid (cPtr_timing_prot_task) == typeid (* (_var_63425.getPtr ()))) {
    ...
    {
      GGS_isr_map::cEnumerator enumerator_63469 (var_cas_cpu.reader_isrs (inLexique COMMA_SOURCE_FILE_AT_LINE (1582)), true) ;
      const GGS_isr_map::cElement * operand_63469 = NULL ;
      while (((operand_63469 = enumerator_63469.nextObject ()))) {
        macroValidPointer (operand_63469) ;
        { const GGS_timing_prot _var_63589 = operand_63469->mInfo.isr.reader_timing_prot (inLexique COMMA_SOURCE_FILE_AT_LINE (1583)) ; // CAST instruction
          if (_var_63589.getPtr () != NULL) {
            macroValidPointer (_var_63589.getPtr ()) ;
            if (typeid (cPtr_timing_prot_isr) == typeid (* (_var_63589.getPtr ()))) {
              var_cas_useTimingProtection = GGS_bool (true) ;
            }else{
            }
          }
    ...
    {
      GGS_scheduletable_map::cEnumerator enumerator_63631 (var_cas_cpu.reader_scheduletables (inLexique COMMA_SOURCE_FILE_AT_LINE (1588)), true) ;
      const GGS_scheduletable_map::cElement * operand_63631 = NULL ;
      while (((operand_63631 = enumerator_63631.nextObject ()))) {
        macroValidPointer (operand_63631) ;
        { const GGS_ltgt_sync_obj _var_63762 = operand_63631->mInfo.scheduletable.reader_ltgt_sync (inLexique COMMA_SOURCE_FILE_AT_LINE (1589)) ; // CAST instruction
          if (_var_63762.getPtr () != NULL) {
            macroValidPointer (_var_63762.getPtr ()) ;
            if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_63762.getPtr ()))) {
    ...
    { const GGS_basic_type _var_63965 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1596)).reader_protectionhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1596)) ; // CAST instruction
      if (_var_63965.getPtr () != NULL) {
        macroValidPointer (_var_63965.getPtr ()) ;
        if (typeid (cPtr_bool_class) == typeid (* (_var_63965.getPtr ()))) {
          const GGS_bool_class var_cas_ph (_var_63965.getPtr ()) ;
    ...
    const GGS_bool cond_64680 = ((var_cas_setSC).operator_isEqual (GGS_string (""))).operator_or ((var_cas_setSC).operator_isEqual (GGS_string ("AUTO"))) ;
    if (cond_64680.isBuiltAndTrue ()) {
      const GGS_bool cond_64390 = ((var_cas_useTimingProtection).operator_or (var_cas_useProtectionHook)).operator_or (var_cas_useGlobalTime) ;
      if (cond_64390.isBuiltAndTrue ()) {
        var_cas_sc = GGS_uint64 (2ULL) ;
      }
      const GGS_bool cond_64660 = (function_memory_protection_on (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1619)) COMMA_SOURCE_FILE_AT_LINE (1619))).operator_or ((var_cas_cpu.reader_applis (inLexique COMMA_SOURCE_FILE_AT_LINE (1619)).reader_count ()).operator_strictSup (GGS_uint (0U))) ;
      if (cond_64660.isBuiltAndTrue ()) {
        var_cas_sc = var_cas_sc.add_operation (inLexique, GGS_uint64 (2ULL) COMMA_SOURCE_FILE_AT_LINE (1620)) ;
      }
    }else if (cond_64680.isBuiltAndFalse ()) {
      const GGS_bool cond_65480 = (var_cas_setSC).operator_isEqual (GGS_string ("sc1")) ;
      if (cond_65480.isBuiltAndTrue ()) {
        const GGS_bool cond_65231 = var_cas_useTimingProtection ;
        if (cond_65231.isBuiltAndTrue ()) {
          const GGS_bool cond_65066 = var_cas_useOSApplication ;
          if (cond_65066.isBuiltAndTrue ()) {
          ...
          }else if (cond_65066.isBuiltAndFalse ()) {
            var_cas_sc = GGS_uint64 (2ULL) ;
        ...
        }else if (cond_65231.isBuiltAndFalse ()) {
          const GGS_bool cond_65412 = var_cas_useOSApplication ;
      ...
      }else if (cond_65480.isBuiltAndFalse ()) {
        const GGS_bool cond_66042 = (var_cas_setSC).operator_isEqual (GGS_string ("sc2")) ;
        if (cond_66042.isBuiltAndTrue ()) {
          const GGS_bool cond_65793 = var_cas_useTimingProtection ;
          if (cond_65793.isBuiltAndTrue ()) {
            const GGS_bool cond_65740 = var_cas_useOSApplication ;
            if (cond_65740.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (4ULL) ;
            ...
            }else if (cond_65740.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (2ULL) ;
            }
          }else if (cond_65793.isBuiltAndFalse ()) {
            const GGS_bool cond_65974 = var_cas_useOSApplication ;
            if (cond_65974.isBuiltAndTrue ()) {
              var_cas_sc = GGS_uint64 (3ULL) ;
            ...
            }else if (cond_65974.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (2ULL) ;
            }
          }
        }else if (cond_66042.isBuiltAndFalse ()) {
          const GGS_bool cond_66403 = (var_cas_setSC).operator_isEqual (GGS_string ("sc3")) ;
          if (cond_66403.isBuiltAndTrue ()) {
            const GGS_bool cond_66355 = var_cas_useTimingProtection ;
            if (cond_66355.isBuiltAndTrue ()) {
              const GGS_bool cond_66302 = var_cas_useOSApplication ;
              if (cond_66302.isBuiltAndTrue ()) {
                var_cas_sc = GGS_uint64 (4ULL) ;
              ...
              }else if (cond_66302.isBuiltAndFalse ()) {
                var_cas_sc = GGS_uint64 (3ULL) ;
              }
            }else if (cond_66355.isBuiltAndFalse ()) {
              var_cas_sc = GGS_uint64 (3ULL) ;
            }
          }else if (cond_66403.isBuiltAndFalse ()) {
            const GGS_bool cond_66437 = (var_cas_setSC).operator_isEqual (GGS_string ("sc4")) ;
...
void routine_setUseHooks (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESTARTUPHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1695)).reader_startuphook (inLexique COMMA_SOURCE_FILE_AT_LINE (1695)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1695)) COMMA_SOURCE_FILE_AT_LINE (1695)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1695)).reader_startuphook (inLexique COMMA_SOURCE_FILE_AT_LINE (1695)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1695)) COMMA_SOURCE_FILE_AT_LINE (1695)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESHUTDOWNHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1696)).reader_shutdownhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1696)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1696)) COMMA_SOURCE_FILE_AT_LINE (1696)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1696)).reader_shutdownhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1696)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1696)) COMMA_SOURCE_FILE_AT_LINE (1696)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEERRORHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1697)).reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1697)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1697)) COMMA_SOURCE_FILE_AT_LINE (1697)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1697)).reader_errorhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1697)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1697)) COMMA_SOURCE_FILE_AT_LINE (1697)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPRETASKHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1698)).reader_pretaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1698)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1698)) COMMA_SOURCE_FILE_AT_LINE (1698)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1698)).reader_pretaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1698)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1698)) COMMA_SOURCE_FILE_AT_LINE (1698)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPOSTTASKHOOK"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1699)).reader_posttaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1699)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1699)) COMMA_SOURCE_FILE_AT_LINE (1699)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1699)).reader_posttaskhook (inLexique COMMA_SOURCE_FILE_AT_LINE (1699)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1699)) COMMA_SOURCE_FILE_AT_LINE (1699)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEGETSERVICEID"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1700)).reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1700)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1700)) COMMA_SOURCE_FILE_AT_LINE (1700)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1700)).reader_usegetserviceid (inLexique COMMA_SOURCE_FILE_AT_LINE (1700)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1700)) COMMA_SOURCE_FILE_AT_LINE (1700)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USEPARAMETERACCESS"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)).reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)) COMMA_SOURCE_FILE_AT_LINE (1701)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)).reader_useparameteraccess (inLexique COMMA_SOURCE_FILE_AT_LINE (1701)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1701)) COMMA_SOURCE_FILE_AT_LINE (1701)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USERESSCHEDULER"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1702)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1702)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1702)) COMMA_SOURCE_FILE_AT_LINE (1702)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1702)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1702)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1702)) COMMA_SOURCE_FILE_AT_LINE (1702)) ;
  ::routine_addBoolValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("USESTACKMONITORING"), var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1703)).reader_useresscheduler (inLexique COMMA_SOURCE_FILE_AT_LINE (1703)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1703)) COMMA_SOURCE_FILE_AT_LINE (1703)),  function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1703)).reader_stackmonitoring (inLexique COMMA_SOURCE_FILE_AT_LINE (1703)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1703)) COMMA_SOURCE_FILE_AT_LINE (1703)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_setInterruptSources (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_69715 = var_cas_targetConfiguration.reader_hasKey (GGS_string ("it_sources")) ;
  if (cond_69715.isBuiltAndTrue ()) {
    GGS_basic_type  var_cas_interruptSources ;
    const GGS_config  temp_69012 = var_cas_targetConfiguration ;
    if (temp_69012.isBuilt ()) {
      temp_69012 (HERE)->method_get (inLexique, function_lstringWith (inLexique, GGS_string ("it_sources") COMMA_SOURCE_FILE_AT_LINE (1719)), var_cas_interruptSources COMMA_SOURCE_FILE_AT_LINE (1719)) ;
    }
    { const GGS_basic_type _var_69703 = var_cas_interruptSources ; // CAST instruction
      if (_var_69703.getPtr () != NULL) {
        macroValidPointer (_var_69703.getPtr ()) ;
        if (typeid (cPtr_interrupts) == typeid (* (_var_69703.getPtr ()))) {
          const GGS_interrupts var_cas_interrupts (_var_69703.getPtr ()) ;
          ...
          {
            GGS_ident_map::cEnumerator enumerator_69280 (var_cas_interrupts.reader_it_sources (inLexique COMMA_SOURCE_FILE_AT_LINE (1724)), true) ;
            const GGS_ident_map::cElement * operand_69280 = NULL ;
            while (((operand_69280 = enumerator_69280.nextObject ()))) {
              macroValidPointer (operand_69280) ;
              GGS_goilTemplateFieldMap  var_cas_fieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1725)) ;
              ::routine_addLStringFieldValue (inLexique,  var_cas_fieldMap,  GGS_string ("NAME"),  operand_69280->mKey COMMA_SOURCE_FILE_AT_LINE (1726)) ;
              ::routine_addUnsignedFieldValue (inLexique,  var_cas_fieldMap,  GGS_lstring ::constructor_new (inLexique, GGS_string ("NUMBER"), operand_69280->mInfo.value.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1727)) COMMA_SOURCE_FILE_AT_LINE (1727)),  function_uint64OrError (inLexique, operand_69280->mInfo.value, GGS_string ("interrupt source number") COMMA_SOURCE_FILE_AT_LINE (1727)) COMMA_SOURCE_FILE_AT_LINE (1727)) ;
...
void routine_addDirectoryAndFile (C_Compiler & inLexique,
  ...
  #endif
  GGS_goilTemplateFieldMap  var_cas_fieldMap = GGS_goilTemplateFieldMap ::constructor_emptyMap (inLexique COMMA_SOURCE_FILE_AT_LINE (1741)) ;
...
void routine_setEnvData (C_Compiler & inLexique,
  ...
  #endif
  ::routine_addStringValue (inLexique,  var_cas_cfg,  function_lstringWith (inLexique, GGS_string ("OILFILENAME") COMMA_SOURCE_FILE_AT_LINE (1751)),  GGS_string::constructor_stringWithSourceFilePath (inLexique COMMA_SOURCE_FILE_AT_LINE (1751)).reader_lastPathComponent () COMMA_SOURCE_FILE_AT_LINE (1751)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("CPUNAME"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1752)),  var_cas_cpu.reader_name (inLexique COMMA_SOURCE_FILE_AT_LINE (1752)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1752)) COMMA_SOURCE_FILE_AT_LINE (1752)) ;
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("TIMESTAMP"), GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (1753)),  GGS_string::constructor_stringWithCurrentDateTime (inLexique COMMA_SOURCE_FILE_AT_LINE (1753)) COMMA_SOURCE_FILE_AT_LINE (1753)) ;
  ...
  ::routine_addStringValue (inLexique,  var_cas_cfg,  GGS_lstring ::constructor_new (inLexique, GGS_string ("APPNAME"), var_cas_appName.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (1755)) COMMA_SOURCE_FILE_AT_LINE (1755)),  var_cas_appName.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (1755)) COMMA_SOURCE_FILE_AT_LINE (1755)) ;
  ...
  const GGS_bool cond_72065 = (function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1775)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1775)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1775))).operator_not () ;
  if (cond_72065.isBuiltAndTrue ()) {
  ...
  { const GGS_trace _var_72185 = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1782)).reader_trace (inLexique COMMA_SOURCE_FILE_AT_LINE (1782)) ; // CAST instruction
    if (_var_72185.getPtr () != NULL) {
      macroValidPointer (_var_72185.getPtr ()) ;
      if (typeid (cPtr_trace_on) == typeid (* (_var_72185.getPtr ()))) {
  ...
  const GGS_bool cond_72835 = function_useCommunication (inLexique, var_cas_cpu COMMA_SOURCE_FILE_AT_LINE (1786)) ;
  if (cond_72835.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_74112 = gOption_goil_5F_options_autosar_5F_on.reader_value () ;
  if (cond_74112.isBuiltAndTrue ()) {
    ...
    GGS_uint64  var_cas_sc ;
    GGS_bool automatic_var_73437_0 ;
    GGS_bool automatic_var_73437_1 ;
    ::routine_scalabilityClass (inLexique,  var_cas_cpu,  var_cas_sc,  automatic_var_73437_0,  automatic_var_73437_1 COMMA_SOURCE_FILE_AT_LINE (1806)) ;
    const GGS_bool cond_73630 = ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) ;
    if (cond_73630.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_74102 = (function_getBool (inLexique, var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (1811)).reader_systemcall (inLexique COMMA_SOURCE_FILE_AT_LINE (1811)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (1811))).operator_not () ;
    if (cond_74102.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_74090 = ((var_cas_sc).operator_isEqual (GGS_uint64 (3ULL))).operator_or ((var_cas_sc).operator_isEqual (GGS_uint64 (4ULL))) ;
      if (cond_74090.isBuiltAndTrue ()) {
