...
void routine_generate_counter_arm7 (C_Compiler & _inLexique,
      ...
      { const GGS_counter_type _var_2228 = operand_1928->mInfo.counter.reader_type (_inLexique COMMA_SOURCE_FILE_AT_LINE (72)) ; // CAST instruction
        if (_var_2228.getPtr () != NULL) {
          ...
          if (typeid (cPtr_software_counter) == typeid (* (_var_2228.getPtr ()))) {
            ...
            ::routine_retrieveTemplateString (_inLexique,  var_cas_tmp,  GGS_string ("counter_list_specific") COMMA_SOURCE_FILE_AT_LINE (76)) ;
            ::routine_doReplace (_inLexique,  var_cas_tmp,  GGS_string ("$COUNTER$"),  (operand_1928->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (77)))._operator_concat (GGS_string ("_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (77)) ;
  ...
  ::routine_doReplace (_inLexique,  var_cas_code,  GGS_string ("$COUNTER_LIST$"),  var_cas_result COMMA_SOURCE_FILE_AT_LINE (82)) ;
  #ifdef DEBUG_TRACE_ENABLED
