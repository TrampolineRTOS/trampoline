        ...
        if ((function_get_bool (_inLexique, var_cas_to.reader_desc (_inLexique COMMA_SOURCE_FILE_AT_LINE (37)), GGS_bool (true, false) COMMA_SOURCE_FILE_AT_LINE (37))).isBuiltAndTrue ()) {
          ...
          var_cas_stasks = GGS_tasks_by_type ::constructor_emptySortedList () ;
          {
            ...
            while (((operand_1019 = enumerator_1019.nextObject ()))) {
              ...
              if (((operand_1019->mInfo.task.reader_events (_inLexique COMMA_SOURCE_FILE_AT_LINE (44)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (44)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                var_cas_stasks._addAssign_operation (GGS_uint (true, 0U), operand_1019->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (45))) ;
              }else{
                var_cas_stasks._addAssign_operation (GGS_uint (true, 1U), operand_1019->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (47))) ;
              }
            }
          }
          GGS_uint  var_cas_id ;
          ...
          if ((function_get_bool (_inLexique, var_cas_to.reader_trace_task (_inLexique COMMA_SOURCE_FILE_AT_LINE (52)), GGS_bool (true, true) COMMA_SOURCE_FILE_AT_LINE (52))).isBuiltAndTrue ()) {
            ...
            var_cas_stasks = GGS_tasks_by_type ::constructor_emptySortedList () ;
            {
              ...
              while (((operand_1424 = enumerator_1424.nextObject ()))) {
                ...
                if (((operand_1424->mInfo.task.reader_events (_inLexique COMMA_SOURCE_FILE_AT_LINE (57)).reader_length (_inLexique COMMA_SOURCE_FILE_AT_LINE (57)))._operator_strictSup (GGS_uint (true, 0U))).isBuiltAndTrue ()) {
                  var_cas_stasks._addAssign_operation (GGS_uint (true, 0U), operand_1424->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (58))) ;
                }else{
                  var_cas_stasks._addAssign_operation (GGS_uint (true, 1U), operand_1424->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (60))) ;
                }
              }
            }
            {
          ...
          var_cas_desc_file_name = (function_project_name (_inLexique COMMA_SOURCE_FILE_AT_LINE (103)))._operator_concat (GGS_string (true, ".desc")) ;
          const GGS_string _temp_2804 = var_cas_res ;
          if (_temp_2804._isBuilt ()) {
