...
void routine_generate_description (C_Compiler & inLexique,
  ...
  var_cas_tr = var_cas_cpu.reader_os (inLexique COMMA_SOURCE_FILE_AT_LINE (34)).reader_trace (inLexique COMMA_SOURCE_FILE_AT_LINE (34)) ;
  { const GGS_trace _var_2844 = var_cas_tr ; // CAST instruction
    if (_var_2844.getPtr () != NULL) {
      ...
      if (typeid (cPtr_trace_on) == typeid (* (_var_2844.getPtr ()))) {
        ...
        if ((function_get_bool (inLexique, var_cas_to.reader_desc (inLexique COMMA_SOURCE_FILE_AT_LINE (37)), GGS_bool (false) COMMA_SOURCE_FILE_AT_LINE (37))).isBuiltAndTrue ()) {
          GGS_string var_cas_res ;
          var_cas_res = GGS_string ("<\?xml version=\"1.0\" encoding=\"ISO-8859-1\"\?>\n") ;
          var_cas_res.appendCString ("<app name=\"") ;
          var_cas_res.dotAssign_operation (function_project_name (inLexique COMMA_SOURCE_FILE_AT_LINE (39)).reader_lastPathComponent (inLexique COMMA_SOURCE_FILE_AT_LINE (39))) ;
          ...
          var_cas_stasks = GGS_tasks_by_type ::constructor_emptySortedList () ;
          {
            ...
            while (((operand_1019 = enumerator_1019.nextObject ()))) {
              ...
              if (((operand_1019->mInfo.task.reader_events (inLexique COMMA_SOURCE_FILE_AT_LINE (44)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (44))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                var_cas_stasks._addAssign_operation (GGS_uint (0U), operand_1019->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (45))) ;
              }else{
                var_cas_stasks._addAssign_operation (GGS_uint (1U), operand_1019->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (47))) ;
              }
            }
          }
          GGS_uint  var_cas_id ;
          var_cas_id = GGS_uint (0U) ;
          if ((function_get_bool (inLexique, var_cas_to.reader_trace_task (inLexique COMMA_SOURCE_FILE_AT_LINE (52)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (52))).isBuiltAndTrue ()) {
            ...
            var_cas_stasks = GGS_tasks_by_type ::constructor_emptySortedList () ;
            {
              ...
              while (((operand_1424 = enumerator_1424.nextObject ()))) {
                ...
                if (((operand_1424->mInfo.task.reader_events (inLexique COMMA_SOURCE_FILE_AT_LINE (57)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (57))).operator_strictSup (GGS_uint (0U))).isBuiltAndTrue ()) {
                  var_cas_stasks._addAssign_operation (GGS_uint (0U), operand_1424->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (58))) ;
                }else{
                  var_cas_stasks._addAssign_operation (GGS_uint (1U), operand_1424->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (60))) ;
                }
              }
            }
            {
          ...
          var_cas_id = var_cas_stasks.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (71)) ;
          if ((function_get_bool (inLexique, var_cas_to.reader_trace_isr (inLexique COMMA_SOURCE_FILE_AT_LINE (72)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (72))).isBuiltAndTrue ()) {
          ...
          if ((function_get_bool (inLexique, var_cas_to.reader_trace_resource (inLexique COMMA_SOURCE_FILE_AT_LINE (81)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (81))).isBuiltAndTrue ()) {
            var_cas_id = GGS_uint (0U) ;
          ...
          if ((function_get_bool (inLexique, var_cas_to.reader_trace_alarm (inLexique COMMA_SOURCE_FILE_AT_LINE (91)), GGS_bool (true) COMMA_SOURCE_FILE_AT_LINE (91))).isBuiltAndTrue ()) {
            var_cas_id = GGS_uint (0U) ;
          ...
          var_cas_desc_file_name = (function_project_name (inLexique COMMA_SOURCE_FILE_AT_LINE (103))).operator_concat (GGS_string (".desc")) ;
          const GGS_string _temp_2804 = var_cas_res ;
          if (_temp_2804.isBuilt ()) {
            _temp_2804 (HERE)->method_writeToFile (inLexique, var_cas_desc_file_name COMMA_SOURCE_FILE_AT_LINE (104)) ;
          }
        }
      }else{
      }
