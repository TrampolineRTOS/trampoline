...
//                    november 15th, 2010, at 11h53'18"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_check_target (C_Compiler & inLexique,
  ...
  const GGS_bool cond_4137 = (var_cas_arch_path.reader_directoryExists ()).operator_not () ;
  if (cond_4137.isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("Architecture '")).operator_concat (var_cas_arch_path)).operator_concat (GGS_string ("' does not exist")) COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }else if (cond_4137.isBuiltAndFalse ()) {
    const GGS_bool cond_4239 = (var_cas_chip_path.reader_directoryExists ()).operator_not () ;
    if (cond_4239.isBuiltAndTrue ()) {
      GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("Chip '")).operator_concat (var_cas_chip_path)).operator_concat (GGS_string ("' does not exist")) COMMA_SOURCE_FILE_AT_LINE (121)) ;
    }else if (cond_4239.isBuiltAndFalse ()) {
      const GGS_bool cond_4342 = (var_cas_board_path.reader_directoryExists ()).operator_not () ;
      if (cond_4342.isBuiltAndTrue ()) {
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("Board '")).operator_concat (var_cas_board_path)).operator_concat (GGS_string ("' does not exist")) COMMA_SOURCE_FILE_AT_LINE (123)) ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
