...
void routine_getAbsoluteSourceFilePath (C_Compiler & _inLexique,
  ...
  if (((var_cas_sourceFilePath)._operator_isEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
    if (((GGS_string::constructor_stringWithSourceFilePath (_inLexique COMMA_HERE).reader_firstCharacterOrNul (_inLexique COMMA_SOURCE_FILE_AT_LINE (37)))._operator_isNotEqual (GGS_char (true, '/'))).isBuiltAndTrue ()) {
...
void routine_checkFileExists (C_Compiler & _inLexique,
  ...
  if (((var_cas_absoluteFilePath.reader_fileExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (50)))._operator_not ()).isBuiltAndTrue ()) {
    var_cas_fileName.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (51)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "The file '"))._operator_concat (var_cas_absoluteFilePath))._operator_concat (GGS_string (true, "' does not exists!")) COMMA_SOURCE_FILE_AT_LINE (51)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_checkFileDoesNotExists (C_Compiler & _inLexique,
  ...
  if ((var_cas_fileName.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (65)).reader_directoryExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (65))).isBuiltAndTrue ()) {
    ...
    var_cas_projectDir = function_getProjectName (_inLexique COMMA_SOURCE_FILE_AT_LINE (71)) ;
...
void routine_checkTrampolinePath (C_Compiler & _inLexique,
  ...
  if (((var_cas_osPath.reader_directoryExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (91)))._operator_not ()).isBuiltAndTrue ()) {
    var_cas_path.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (92)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((GGS_string (true, "The directory '"))._operator_concat (var_cas_absolutePath))._operator_concat (GGS_string (true, "' does not seem to be the Trampoline base path.")))._operator_concat (GGS_string (true, " I can't find the os/ subfolder.")) COMMA_SOURCE_FILE_AT_LINE (94)) ;
  }
  ...
  if (((var_cas_machinesPath.reader_directoryExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (97)))._operator_not ()).isBuiltAndTrue ()) {
    var_cas_path.reader_location (_inLexique COMMA_SOURCE_FILE_AT_LINE (98)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, (((GGS_string (true, "The directory '"))._operator_concat (var_cas_absolutePath))._operator_concat (GGS_string (true, "' does not seem to be the Trampoline base path.")))._operator_concat (GGS_string (true, "I can't find the machines/ subfolder.")) COMMA_SOURCE_FILE_AT_LINE (100)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_check_target (C_Compiler & _inLexique,
  ...
  var_cas_arch_path = ((var_cas_machines_path)._operator_concat (GGS_string (true, "/")))._operator_concat (function_arch (_inLexique COMMA_SOURCE_FILE_AT_LINE (111))) ;
  GGS_string var_cas_chip_path ;
  var_cas_chip_path = ((var_cas_arch_path)._operator_concat (GGS_string (true, "/")))._operator_concat (function_chip (_inLexique COMMA_SOURCE_FILE_AT_LINE (112))) ;
  GGS_string var_cas_board_path ;
  var_cas_board_path = ((var_cas_chip_path)._operator_concat (GGS_string (true, "/")))._operator_concat (function_board (_inLexique COMMA_SOURCE_FILE_AT_LINE (113))) ;
  if (((var_cas_arch_path.reader_directoryExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (114)))._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "The directory '"))._operator_concat (var_cas_arch_path))._operator_concat (GGS_string (true, "' does not exist")) COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }else if (((var_cas_chip_path.reader_directoryExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (116)))._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "The directory '"))._operator_concat (var_cas_chip_path))._operator_concat (GGS_string (true, "' does not exist")) COMMA_SOURCE_FILE_AT_LINE (117)) ;
  }else if (((var_cas_board_path.reader_directoryExists (_inLexique COMMA_SOURCE_FILE_AT_LINE (118)))._operator_not ()).isBuiltAndTrue ()) {
    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticWarning (_inLexique, ((GGS_string (true, "The directory '"))._operator_concat (var_cas_board_path))._operator_concat (GGS_string (true, "' does not exist")) COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
