...
//                    november 10th, 2009, at 14h57'29"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_generate_isr_avr (C_Compiler & inLexique,
  ...
  GGS_string var_cas_result = GGS_string ("") ;
  {
    ...
    while (((operand_1737 = enumerator_1737.nextObject ()))) {
      ...
      GGS_string var_cas_tmp = function_template_string (inLexique, GGS_string ("code"), GGS_string ("isr_list_specific") COMMA_SOURCE_FILE_AT_LINE (69)) ;
      ::routine_doReplace (inLexique,  var_cas_tmp,  GGS_string ("$EXEC_NAME$"),  operand_1737->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (71)) COMMA_SOURCE_FILE_AT_LINE (71)) ;
      var_cas_result.dotAssign_operation (var_cas_tmp) ;
    }
  }
  ::routine_doReplace (inLexique,  var_cas_code,  GGS_string ("$ISR_LIST$"),  var_cas_result COMMA_SOURCE_FILE_AT_LINE (74)) ;
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_generate_counter_avr (C_Compiler & inLexique,
  ...
  GGS_string var_cas_result = GGS_string ("") ;
  {
    GGS_counter_map::cEnumerator enumerator_2231 (var_cas_counters, true) ;
    const GGS_counter_map::cElement * operand_2231 = NULL ;
    while (((operand_2231 = enumerator_2231.nextObject ()))) {
      macroValidPointer (operand_2231) ;
      { const GGS_counter_type _var_2530 = operand_2231->mInfo.counter.reader_type (inLexique COMMA_SOURCE_FILE_AT_LINE (83)) ; // CAST instruction
        if (_var_2530.getPtr () != NULL) {
          macroValidPointer (_var_2530.getPtr ()) ;
          if (typeid (cPtr_software_counter) == typeid (* (_var_2530.getPtr ()))) {
          }else{
            ...
            ::routine_doReplace (inLexique,  var_cas_tmp,  GGS_string ("$COUNTER$"),  (operand_2231->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (87))).operator_concat (GGS_string ("_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (87)) ;
            var_cas_result.dotAssign_operation (var_cas_tmp) ;
          }
        }
      }
