    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_goil_obj_scheduletable_0 (_inLexique)) {
        ...
        case 3 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          { const GGS_autostart_obj _var_3516 = var_cas_st_autostart ; // CAST instruction
            if (_var_3516.getPtr () != NULL) {
              macroValidPointer (_var_3516.getPtr ()) ;
              if (typeid (cPtr_autostart_void) == typeid (* (_var_3516.getPtr ()))) {
        ...
        case 4 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          { const GGS_ltgt_sync_obj _var_4092 = var_cas_st_ltgt_sync ; // CAST instruction
            if (_var_4092.getPtr () != NULL) {
              macroValidPointer (_var_4092.getPtr ()) ;
              if (typeid (cPtr_ltgt_sync_void) == typeid (* (_var_4092.getPtr ()))) {
        ...
        case 5 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          { const GGS_basic_type _var_4504 = var_cas_st_periodic ; // CAST instruction
            if (_var_4504.getPtr () != NULL) {
              macroValidPointer (_var_4504.getPtr ()) ;
              if (typeid (cPtr_void) == typeid (* (_var_4504.getPtr ()))) {
        ...
        case 6 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          { const GGS_basic_type _var_4893 = var_cas_st_length ; // CAST instruction
            if (_var_4893.getPtr () != NULL) {
              macroValidPointer (_var_4893.getPtr ()) ;
              if (typeid (cPtr_void) == typeid (* (_var_4893.getPtr ()))) {
      ...
      switch (select_repeat_goil_obj_scheduletable_4 (_inLexique)) {
        case 2 : {
          if ((var_cas_offset_known).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("OS442 - OFFSET attribute already defined for this schedule table autostart") COMMA_SOURCE_FILE_AT_LINE (205)) ;
...
pr_ltgt_sync_params_goil_obj_scheduletable_223_23_ (goil_lexique & _inLexique,
    ...
    while (syntaxRepeat_5) {
      switch (select_repeat_goil_obj_scheduletable_5 (_inLexique)) {
        case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
          { const GGS_basic_type _var_6859 = var_cas_precision ; // CAST instruction
            if (_var_6859.getPtr () != NULL) {
              macroValidPointer (_var_6859.getPtr ()) ;
              if (typeid (cPtr_void) == typeid (* (_var_6859.getPtr ()))) {
  ...
  { const GGS_basic_type _var_7279 = var_cas_precision ; // CAST instruction
    if (_var_7279.getPtr () != NULL) {
      macroValidPointer (_var_7279.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_7279.getPtr ()))) {
        ...
        while (syntaxRepeat_7) {
          switch (select_repeat_goil_obj_scheduletable_7 (_inLexique)) {
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              if ((var_cas_offset_known).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("OS442 - OFFSET attribute already defined for this schedule table ACTIVATETASK action") COMMA_SOURCE_FILE_AT_LINE (281)) ;
        ...
        while (syntaxRepeat_8) {
          switch (select_repeat_goil_obj_scheduletable_8 (_inLexique)) {
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              if ((var_cas_offset_known).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("OS442 - OFFSET attribute already defined for this schedule table SETEVENT action") COMMA_SOURCE_FILE_AT_LINE (319)) ;
            ...
            case 3 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              if ((var_cas_task_known).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("TASK attribute already defined for this schedule table SETEVENT action") COMMA_SOURCE_FILE_AT_LINE (329)) ;
        ...
        while (syntaxRepeat_9) {
          switch (select_repeat_goil_obj_scheduletable_9 (_inLexique)) {
            case 2 : {
              ...
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              if ((var_cas_offset_known).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("OS442 - OFFSET attribute already defined for this schedule table INCREMENTCOUNTER action") COMMA_SOURCE_FILE_AT_LINE (365)) ;
