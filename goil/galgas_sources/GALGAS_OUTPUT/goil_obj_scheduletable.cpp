    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_goil_obj_scheduletable_0 (inLexique)) {
        case 2 : {
          ...
          inLexique._assignFromAttribute_att_token (var_cas_counter) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
        ...
        case 4 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_LOCAL_5FTO_5FGLOBAL_5FTIME_5FSYNCHRONIZATION) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
        ...
        case 6 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          inLexique._assignFromAttribute_integerNumber (var_cas_length) ;
    ...
    while (syntaxRepeat_4) {
      switch (select_repeat_goil_obj_scheduletable_4 (inLexique)) {
        ...
        case 3 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          inLexique._assignFromAttribute_att_token (var_cas_app_mode) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
    ...
    while (syntaxRepeat_5) {
      switch (select_repeat_goil_obj_scheduletable_5 (inLexique)) {
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          inLexique._assignFromAttribute_integerNumber (var_cas_start) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
...
pr_ltgt_sync_params_goil_obj_scheduletable_290_23_ (goil_lexique & inLexique,
    ...
    while (syntaxRepeat_7) {
      switch (select_repeat_goil_obj_scheduletable_7 (inLexique)) {
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          inLexique._assignFromAttribute_integerNumber (var_cas_prec) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
        ...
        case 3 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_SYNC_5FSTRATEGY) COMMA_HERE) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          inLexique._assignFromAttribute_att_token (var_cas_strat) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
  ...
  { const GGS_basic_type _var_8861 = var_cas_precision ; // CAST instruction
    if (_var_8861.getPtr () != NULL) {
      macroValidPointer (_var_8861.getPtr ()) ;
      if (typeid (cPtr_void) == typeid (* (_var_8861.getPtr ()))) {
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("PRECISION attribute is missing") COMMA_SOURCE_FILE_AT_LINE (323)) ;
      }else{
      }
    }
  }
  if (((var_cas_strategy.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (325))).operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
    GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("SYNC_STRATEGY attribute is missing") COMMA_SOURCE_FILE_AT_LINE (327)) ;
  }
...
void goil_obj_scheduletable::
pr_st_action_params_goil_obj_scheduletable_332_23_ (goil_lexique & inLexique,
  ...
  switch (select_goil_obj_scheduletable_8 (inLexique)) {
    case 1 : {
        ...
        while (syntaxRepeat_9) {
          switch (select_repeat_goil_obj_scheduletable_9 (inLexique)) {
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_OFFSET) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
              inLexique._assignFromAttribute_integerNumber (var_cas_new_offset) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_uint_5Fnumber) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              if ((var_cas_offset_known).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("OS442 - OFFSET attribute already defined for this schedule table ACTIVATETASK action") COMMA_SOURCE_FILE_AT_LINE (348)) ;
                var_cas_offset.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (348)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (349)) ;
              }else{
            ...
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
              inLexique._assignFromAttribute_att_token (var_cas_new_task) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              if ((var_cas_task_known).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("TASK attribute already defined for this schedule table ACTIVATETASK action") COMMA_SOURCE_FILE_AT_LINE (358)) ;
                var_cas_task.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (358)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (359)) ;
              }else{
      ...
      if (((var_cas_task_known).operator_and (var_cas_offset_known)).isBuiltAndTrue ()) {
        ...
        var_cas_actions._addAssign_operation (var_cas_offset.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (366)), GGS_uint (1U), var_cas_sdata) ;
      }else{
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("incomplete expiry point") COMMA_SOURCE_FILE_AT_LINE (369)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
      } break ;
    case 2 : {
        ...
        while (syntaxRepeat_10) {
          switch (select_repeat_goil_obj_scheduletable_10 (inLexique)) {
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              if ((var_cas_offset_known).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("OS442 - OFFSET attribute already defined for this schedule table SETEVENT action") COMMA_SOURCE_FILE_AT_LINE (386)) ;
                var_cas_offset.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (386)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (387)) ;
              }else{
                var_cas_offset = var_cas_new_offset ;
                var_cas_offset_known = GGS_bool (true) ;
              }
            ...
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              if ((var_cas_task_known).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("TASK attribute already defined for this schedule table SETEVENT action") COMMA_SOURCE_FILE_AT_LINE (396)) ;
                var_cas_task.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (396)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (397)) ;
              }else{
                var_cas_task = var_cas_new_task ;
                var_cas_task_known = GGS_bool (true) ;
              }
            ...
            case 4 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
              inLexique._assignFromAttribute_att_token (var_cas_new_event) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              if ((var_cas_event_known).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("EVENT attribute already defined for this schedule table ACTIVATETASK action") COMMA_SOURCE_FILE_AT_LINE (406)) ;
                var_cas_event.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (406)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (407)) ;
              }else{
      ...
      if ((((var_cas_task_known).operator_and (var_cas_offset_known)).operator_and (var_cas_event_known)).isBuiltAndTrue ()) {
        ...
        var_cas_actions._addAssign_operation (var_cas_offset.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (414)), GGS_uint (2U), var_cas_sdata) ;
      }else{
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("incomplete expiry point") COMMA_SOURCE_FILE_AT_LINE (417)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
      } break ;
    case 3 : {
        ...
        while (syntaxRepeat_11) {
          switch (select_repeat_goil_obj_scheduletable_11 (inLexique)) {
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              if ((var_cas_offset_known).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("OS442 - OFFSET attribute already defined for this schedule table INCREMENTCOUNTER action") COMMA_SOURCE_FILE_AT_LINE (432)) ;
                var_cas_offset.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (432)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (433)) ;
              }else{
                var_cas_offset = var_cas_new_offset ;
                var_cas_offset_known = GGS_bool (true) ;
              }
            ...
            case 3 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_COUNTER) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
              inLexique._assignFromAttribute_att_token (var_cas_new_counter) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
              if ((var_cas_counter_known).isBuiltAndTrue ()) {
                GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("COUNTER attribute already defined for this schedule table INCREMENTCOUNTER action") COMMA_SOURCE_FILE_AT_LINE (442)) ;
                var_cas_counter.reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (442)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("was previously defined here") COMMA_SOURCE_FILE_AT_LINE (443)) ;
              }else{
      ...
      if (((var_cas_counter_known).operator_and (var_cas_offset_known)).isBuiltAndTrue ()) {
        ...
        var_cas_actions._addAssign_operation (var_cas_offset.reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (450)), GGS_uint (3U), var_cas_sdata) ;
      }else{
        GGS_location (inLexique).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, GGS_string ("incomplete expiry point") COMMA_SOURCE_FILE_AT_LINE (453)) ;
      }
      inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
      } break ;
    default :
