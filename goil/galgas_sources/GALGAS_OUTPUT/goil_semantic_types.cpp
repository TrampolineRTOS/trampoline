...
//                    september 3rd, 2010, at 11h11'33"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
GGS_implementation_spec GGS_implementation_spec::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_imp_type & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_implementation_spec result = constructor_emptyMap (inLexique COMMA_THERE) ;
...
GGS_implementation GGS_implementation::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_implementation_spec & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_implementation result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
GGS_os_imp GGS_os_imp::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_lstring & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_os_imp result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
GGS_event_map GGS_event_map::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_event_obj & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_event_map result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
GGS_eventMaskMap GGS_eventMaskMap::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uint64 & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_eventMaskMap result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
GGS_event_usage_map GGS_event_usage_map::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_uint & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_event_usage_map result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
GGS_alarm_map GGS_alarm_map::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_alarm_obj & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_alarm_map result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
...
GGS_message_map GGS_message_map::constructor_mapWithKeyAndValue (C_Compiler & inLexique,
                                             const GGS_lstring & inKey,
                                             const GGS_message_obj & inValue0
                                             COMMA_LOCATION_ARGS) {
  GGS_message_map result = constructor_emptyMap (inLexique COMMA_THERE) ;
  result.insertElement (inLexique,
                        0,
                        NULL,
                        inKey,
