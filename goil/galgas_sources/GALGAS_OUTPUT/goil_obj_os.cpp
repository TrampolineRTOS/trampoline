    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_goil_obj_os_0 (_inLexique)) {
        case 2 : {
          ...
          switch (select_goil_obj_os_1 (_inLexique)) {
            case 1 : {
              ...
              var_cas_st = GGS_lstring ::constructor_new (_inLexique, GGS_string ("extended"), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_STANDARD) COMMA_HERE) ;
              var_cas_st = GGS_lstring ::constructor_new (_inLexique, GGS_string ("standard"), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            default :
              break ;
          }
          ...
          ::routine_set_lstring_if_empty (_inLexique,  var_cas_status,  var_cas_st,  GGS_string ("STATUS") COMMA_SOURCE_FILE_AT_LINE (86)) ;
          } break ;
        case 3 : {
          ...
          ::routine_set_bool (_inLexique,  var_cas_startuphook,  var_cas_suh,  GGS_string ("STARTUPHOOK") COMMA_SOURCE_FILE_AT_LINE (90)) ;
        ...
        case 4 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_bool (_inLexique,  var_cas_shutdownhook,  var_cas_sdh,  GGS_string ("SHUTDOWNHOOK") COMMA_SOURCE_FILE_AT_LINE (95)) ;
          } break ;
        case 5 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_bool (_inLexique,  var_cas_errorhook,  var_cas_eh,  GGS_string ("ERRORHOOK") COMMA_SOURCE_FILE_AT_LINE (99)) ;
          } break ;
        case 6 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_bool (_inLexique,  var_cas_pretaskhook,  var_cas_preth,  GGS_string ("PRETASKHOOK") COMMA_SOURCE_FILE_AT_LINE (103)) ;
          } break ;
        case 7 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_bool (_inLexique,  var_cas_posttaskhook,  var_cas_posth,  GGS_string ("POSTTASKHOOK") COMMA_SOURCE_FILE_AT_LINE (107)) ;
          } break ;
        case 8 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          if (((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (111))))._operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("AUTOSAR flag is off, turn it on to use PROTECTIONHOOK attribute in OS object") COMMA_SOURCE_FILE_AT_LINE (113)) ;
          }
          ::routine_set_bool (_inLexique,  var_cas_protectionhook,  var_cas_proth,  GGS_string ("PROTECTIONHOOK") COMMA_SOURCE_FILE_AT_LINE (114)) ;
          } break ;
        case 9 : {
          if (((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (116))))._operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("AUTOSAR flag is off, turn it on to use SCALABILITYCLASS attribute in OS object") COMMA_SOURCE_FILE_AT_LINE (118)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_SCALABILITYCLASS) COMMA_HERE) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          if (((var_cas_scalabilityclass.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (120)))._operator_isNotEqual (GGS_string (""))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("SCALABILITYCLASS already defined for OS object") COMMA_SOURCE_FILE_AT_LINE (122)) ;
          }
          switch (select_goil_obj_os_2 (_inLexique)) {
            case 1 : {
              ...
              var_cas_scalabilityclass = GGS_lstring ::constructor_new (_inLexique, GGS_string ("sc1"), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            case 2 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_SC2) COMMA_HERE) ;
              var_cas_scalabilityclass = GGS_lstring ::constructor_new (_inLexique, GGS_string ("sc2"), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            case 3 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_SC3) COMMA_HERE) ;
              var_cas_scalabilityclass = GGS_lstring ::constructor_new (_inLexique, GGS_string ("sc3"), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            case 4 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_SC4) COMMA_HERE) ;
              var_cas_scalabilityclass = GGS_lstring ::constructor_new (_inLexique, GGS_string ("sc4"), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            case 5 : {
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_AUTO) COMMA_HERE) ;
              var_cas_scalabilityclass = GGS_lstring ::constructor_new (_inLexique, GGS_string ("auto"), GGS_location (_inLexique) COMMA_HERE) ;
              } break ;
            default :
              break ;
          }
        ...
        case 10 : {
          if (((GGS_bool (_inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (136))))._operator_isEqual (GGS_bool (false))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("AUTOSAR flag is off, turn it on to use STACKMONITORING attribute in OS object") COMMA_SOURCE_FILE_AT_LINE (138)) ;
          }
          ...
          ::routine_set_bool (_inLexique,  var_cas_stackmonitoring,  var_cas_stackmon,  GGS_string ("STACKMONITORING") COMMA_SOURCE_FILE_AT_LINE (141)) ;
        ...
        case 11 : {
          ...
          ::routine_set_bool (_inLexique,  var_cas_usegetserviceid,  var_cas_ugsi,  GGS_string ("USEGETSERVICEID") COMMA_SOURCE_FILE_AT_LINE (146)) ;
        ...
        case 12 : {
          ...
          ::routine_set_bool (_inLexique,  var_cas_useparameteraccess,  var_cas_upa,  GGS_string ("USEPARAMETERACCESS") COMMA_SOURCE_FILE_AT_LINE (151)) ;
        ...
        case 13 : {
          ...
          ::routine_set_bool (_inLexique,  var_cas_useresscheduler,  var_cas_urs,  GGS_string ("USERESSCHEDULER") COMMA_SOURCE_FILE_AT_LINE (156)) ;
        ...
        case 14 : {
          ...
          ::routine_set_bool (_inLexique,  var_cas_systemcall,  var_cas_sc,  GGS_string ("SYSTEM_CALL") COMMA_SOURCE_FILE_AT_LINE (161)) ;
        ...
        case 19 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_lstring_if_empty (_inLexique,  var_cas_app_name,  var_cas_an,  GGS_string ("APP_NAME") COMMA_SOURCE_FILE_AT_LINE (183)) ;
          } break ;
        case 20 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_lstring_if_empty (_inLexique,  var_cas_tpl_base_path,  var_cas_tbp,  GGS_string ("TRAMPOLINE_BASE_PATH") COMMA_SOURCE_FILE_AT_LINE (187)) ;
          } break ;
        case 21 : {
          GGS_trace  var_cas_t ;
          ...
          switch (select_goil_obj_os_3 (_inLexique)) {
            case 1 : {
                ...
                while (syntaxRepeat_4) {
                  switch (select_repeat_goil_obj_os_4 (_inLexique)) {
                    case 2 : {
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_string) COMMA_HERE) ;
                      ::routine_set_method (_inLexique,  var_cas_m,  GGS_trace_file ::constructor_new (_inLexique, GGS_location (_inLexique), var_cas_file COMMA_HERE),  GGS_string ("NAME") COMMA_SOURCE_FILE_AT_LINE (207)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                    ...
                    case 3 : {
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
                      ::routine_set_lstring_if_empty (_inLexique,  var_cas_f,  var_cas_fmt,  GGS_string ("FORMAT") COMMA_SOURCE_FILE_AT_LINE (213)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    case 4 : {
                      GGS_lbool  var_cas_b ;
                      ...
                      ::routine_set_bool (_inLexique,  var_cas_tt,  var_cas_b,  GGS_string ("TRACE_TASK") COMMA_SOURCE_FILE_AT_LINE (217)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    case 5 : {
                      GGS_lbool  var_cas_b ;
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
                      nt_boolean_ (_inLexique, var_cas_b) ;
                      ::routine_set_bool (_inLexique,  var_cas_ti,  var_cas_b,  GGS_string ("TRACE_ISR") COMMA_SOURCE_FILE_AT_LINE (221)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    case 6 : {
                      GGS_lbool  var_cas_b ;
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
                      nt_boolean_ (_inLexique, var_cas_b) ;
                      ::routine_set_bool (_inLexique,  var_cas_tr,  var_cas_b,  GGS_string ("TRACE_RESOURCE") COMMA_SOURCE_FILE_AT_LINE (225)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    case 7 : {
                      GGS_lbool  var_cas_b ;
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
                      nt_boolean_ (_inLexique, var_cas_b) ;
                      ::routine_set_bool (_inLexique,  var_cas_ta,  var_cas_b,  GGS_string ("TRACE_ALARM") COMMA_SOURCE_FILE_AT_LINE (229)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    case 8 : {
                      GGS_lbool  var_cas_b ;
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
                      nt_boolean_ (_inLexique, var_cas_b) ;
                      ::routine_set_bool (_inLexique,  var_cas_tu,  var_cas_b,  GGS_string ("TRACE_USER") COMMA_SOURCE_FILE_AT_LINE (233)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    case 9 : {
                      GGS_lbool  var_cas_b ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_DESCRIPTION) COMMA_HERE) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
                      nt_boolean_ (_inLexique, var_cas_b) ;
                      ::routine_set_bool (_inLexique,  var_cas_ds,  var_cas_b,  GGS_string ("DESCRIPTION") COMMA_SOURCE_FILE_AT_LINE (237)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    default :
              ...
              if (((var_cas_f.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (239)))._operator_isEqual (GGS_string (""))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Missing FORMAT in TRACE") COMMA_SOURCE_FILE_AT_LINE (241)) ;
              }
              { const GGS_trace_method _var_7711 = var_cas_m ; // CAST instruction
                if (_var_7711.getPtr () != NULL) {
                  ...
                  if (typeid (cPtr_trace_void) == typeid (* (_var_7711.getPtr ()))) {
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Missing METHOD in TRACE") COMMA_SOURCE_FILE_AT_LINE (245)) ;
                  }else{
                  }
                }
              }
              var_cas_t = GGS_trace_on ::constructor_new (_inLexique, GGS_location (_inLexique), var_cas_f, var_cas_m, var_cas_tt, var_cas_ti, var_cas_tr, var_cas_ta, var_cas_tu, var_cas_ds COMMA_HERE) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
              } break ;
            case 2 : {
          ...
          { const GGS_trace _var_8118 = var_cas_trace ; // CAST instruction
            if (_var_8118.getPtr () != NULL) {
              ...
              if (typeid (cPtr_trace) == typeid (* (_var_8118.getPtr ()))) {
                ...
                var_cas_t.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (265)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("Redefinition of TRACE") COMMA_SOURCE_FILE_AT_LINE (266)) ;
                var_cas_trace.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (266)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string ("was defined here") COMMA_SOURCE_FILE_AT_LINE (267)) ;
              }
            }
          }
          } break ;
