        ...
        case 21 : {
          ...
          switch (select_goil_obj_os_3 (_inLexique)) {
            case 1 : {
              ...
              var_cas_t = GGS_trace_on ::constructor_new (_inLexique, GGS_location (_inLexique), var_cas_file COMMA_HERE) ;
              } break ;
            case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          { const GGS_trace _var_6402 = var_cas_trace ; // CAST instruction
            if (_var_6402.getPtr () != NULL) {
              macroValidPointer (_var_6402.getPtr ()) ;
              if (typeid (cPtr_trace) == typeid (* (_var_6402.getPtr ()))) {
                var_cas_trace = var_cas_t ;
              }else{
                var_cas_t.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (202)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Redefinition of TRACE") COMMA_SOURCE_FILE_AT_LINE (203)) ;
                var_cas_trace.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (203)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "was defined here") COMMA_SOURCE_FILE_AT_LINE (204)) ;
              }
            }
          }
          } break ;
