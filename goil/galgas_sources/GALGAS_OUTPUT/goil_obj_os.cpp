...
//                    september 21th, 2009, at 18h17'5"                      *
//                                                                           *
//---------------------------------------------------------------------------*
        ...
        case 21 : {
          ...
          switch (select_goil_obj_os_3 (inLexique)) {
            case 1 : {
              ...
              { const GGS_trace_method _var_7720 = var_cas_m ; // CAST instruction
                if (_var_7720.getPtr () != NULL) {
                  macroValidPointer (_var_7720.getPtr ()) ;
                  if (typeid (cPtr_trace_void) == typeid (* (_var_7720.getPtr ()))) {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          { const GGS_trace _var_8127 = var_cas_trace ; // CAST instruction
            if (_var_8127.getPtr () != NULL) {
              macroValidPointer (_var_8127.getPtr ()) ;
              if (typeid (cPtr_trace) == typeid (* (_var_8127.getPtr ()))) {
