...
pr_os_goil_obj_os_48_9_ (goil_lexique & _inLexique,
  ...
  var_cas_others = var_cas_os.reader_others (_inLexique COMMA_SOURCE_FILE_AT_LINE (70)) ;
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_goil_obj_os_0 (_inLexique)) {
        case 2 : {
          ...
          ::routine_set_lstring_if_empty (_inLexique,  var_cas_status,  var_cas_st,  GGS_string (true, "STATUS") COMMA_SOURCE_FILE_AT_LINE (85)) ;
          } break ;
        case 3 : {
          ...
          ::routine_set_bool (_inLexique,  var_cas_startuphook,  var_cas_suh,  GGS_string (true, "STARTUPHOOK") COMMA_SOURCE_FILE_AT_LINE (89)) ;
        ...
        case 4 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_bool (_inLexique,  var_cas_shutdownhook,  var_cas_sdh,  GGS_string (true, "SHUTDOWNHOOK") COMMA_SOURCE_FILE_AT_LINE (94)) ;
          } break ;
        case 5 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_bool (_inLexique,  var_cas_errorhook,  var_cas_eh,  GGS_string (true, "ERRORHOOK") COMMA_SOURCE_FILE_AT_LINE (98)) ;
          } break ;
        case 6 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_bool (_inLexique,  var_cas_pretaskhook,  var_cas_preth,  GGS_string (true, "PRETASKHOOK") COMMA_SOURCE_FILE_AT_LINE (102)) ;
          } break ;
        case 7 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_bool (_inLexique,  var_cas_posttaskhook,  var_cas_posth,  GGS_string (true, "POSTTASKHOOK") COMMA_SOURCE_FILE_AT_LINE (106)) ;
          } break ;
        case 8 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (110))))._operator_isEqual (GGS_bool (true, false))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "AUTOSAR flag is off, turn it on to use PROTECTIONHOOK attribute in OS object") COMMA_SOURCE_FILE_AT_LINE (112)) ;
          }
          ::routine_set_bool (_inLexique,  var_cas_protectionhook,  var_cas_proth,  GGS_string (true, "PROTECTIONHOOK") COMMA_SOURCE_FILE_AT_LINE (113)) ;
          } break ;
        case 9 : {
          if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (115))))._operator_isEqual (GGS_bool (true, false))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "AUTOSAR flag is off, turn it on to use SCALABILITYCLASS attribute in OS object") COMMA_SOURCE_FILE_AT_LINE (117)) ;
          }
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_SCALABILITYCLASS) COMMA_HERE) ;
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3D) COMMA_HERE) ;
          if (((var_cas_scalabilityclass.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (119)))._operator_isNotEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "SCALABILITYCLASS already defined for OS object") COMMA_SOURCE_FILE_AT_LINE (121)) ;
          }
        ...
        case 10 : {
          if (((GGS_bool (true, _inLexique.boolOptionValueFromKeys ("goil_options", "autosar_on" COMMA_SOURCE_FILE_AT_LINE (135))))._operator_isEqual (GGS_bool (true, false))).isBuiltAndTrue ()) {
            GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "AUTOSAR flag is off, turn it on to use STACKMONITORING attribute in OS object") COMMA_SOURCE_FILE_AT_LINE (137)) ;
          }
          ...
          ::routine_set_bool (_inLexique,  var_cas_stackmonitoring,  var_cas_stackmon,  GGS_string (true, "STACKMONITORING") COMMA_SOURCE_FILE_AT_LINE (140)) ;
        ...
        case 11 : {
          ...
          ::routine_set_bool (_inLexique,  var_cas_usegetserviceid,  var_cas_ugsi,  GGS_string (true, "USEGETSERVICEID") COMMA_SOURCE_FILE_AT_LINE (145)) ;
        ...
        case 12 : {
          ...
          ::routine_set_bool (_inLexique,  var_cas_useparameteraccess,  var_cas_upa,  GGS_string (true, "USEPARAMETERACCESS") COMMA_SOURCE_FILE_AT_LINE (150)) ;
        ...
        case 13 : {
          ...
          ::routine_set_bool (_inLexique,  var_cas_useresscheduler,  var_cas_urs,  GGS_string (true, "USERESSCHEDULER") COMMA_SOURCE_FILE_AT_LINE (155)) ;
        ...
        case 14 : {
          ...
          ::routine_set_bool (_inLexique,  var_cas_systemcall,  var_cas_sc,  GGS_string (true, "SYSTEM_CALL") COMMA_SOURCE_FILE_AT_LINE (160)) ;
        ...
        case 15 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_checkFileExists (_inLexique,  var_cas_src COMMA_SOURCE_FILE_AT_LINE (165)) ;
        ...
        case 19 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_lstring_if_empty (_inLexique,  var_cas_app_name,  var_cas_an,  GGS_string (true, "APP_NAME") COMMA_SOURCE_FILE_AT_LINE (182)) ;
          } break ;
        case 20 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          ::routine_set_lstring_if_empty (_inLexique,  var_cas_tpl_base_path,  var_cas_tbp,  GGS_string (true, "TRAMPOLINE_BASE_PATH") COMMA_SOURCE_FILE_AT_LINE (186)) ;
          } break ;
        case 21 : {
