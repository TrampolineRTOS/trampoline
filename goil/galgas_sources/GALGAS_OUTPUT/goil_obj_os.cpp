        ...
        case 21 : {
          ...
          switch (select_goil_obj_os_3 (_inLexique)) {
            case 1 : {
                ...
                while (syntaxRepeat_4) {
                  switch (select_repeat_goil_obj_os_4 (_inLexique)) {
                    case 2 : {
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_string) COMMA_HERE) ;
                      ::routine_set_method (_inLexique,  var_cas_m,  GGS_trace_file ::constructor_new (_inLexique, GGS_location (_inLexique), var_cas_file COMMA_HERE),  GGS_string (true, "NAME") COMMA_SOURCE_FILE_AT_LINE (200)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                    ...
                    case 3 : {
                      ...
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1_idf) COMMA_HERE) ;
                      ::routine_set_lstring_if_empty (_inLexique,  var_cas_f,  var_cas_fmt,  GGS_string (true, "FORMAT") COMMA_SOURCE_FILE_AT_LINE (206)) ;
                      _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
                      } break ;
                    default :
              ...
              if (((var_cas_f.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (209)))._operator_isEqual (GGS_string (true, ""))).isBuiltAndTrue ()) {
                GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Missing FORMAT in TRACE") COMMA_SOURCE_FILE_AT_LINE (211)) ;
              }
              { const GGS_trace_method _var_6735 = var_cas_m ; // CAST instruction
                if (_var_6735.getPtr () != NULL) {
                  macroValidPointer (_var_6735.getPtr ()) ;
                  if (typeid (cPtr_trace_void) == typeid (* (_var_6735.getPtr ()))) {
                    GGS_location (_inLexique).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Missing METHOD in TRACE") COMMA_SOURCE_FILE_AT_LINE (215)) ;
                  }else{
                  }
                }
              }
              var_cas_t = GGS_trace_on ::constructor_new (_inLexique, GGS_location (_inLexique), var_cas_f, var_cas_m COMMA_HERE) ;
              _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__7D) COMMA_HERE) ;
              } break ;
            case 2 : {
          ...
          _inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B) COMMA_HERE) ;
          { const GGS_trace _var_7039 = var_cas_trace ; // CAST instruction
            if (_var_7039.getPtr () != NULL) {
              macroValidPointer (_var_7039.getPtr ()) ;
              if (typeid (cPtr_trace) == typeid (* (_var_7039.getPtr ()))) {
                var_cas_trace = var_cas_t ;
              }else{
                var_cas_t.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (225)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "Redefinition of TRACE") COMMA_SOURCE_FILE_AT_LINE (226)) ;
                var_cas_trace.reader_loc (_inLexique COMMA_SOURCE_FILE_AT_LINE (226)).reader_location (_inLexique COMMA_HERE).signalGGSSemanticError (_inLexique, GGS_string (true, "was defined here") COMMA_SOURCE_FILE_AT_LINE (227)) ;
              }
            }
          }
          } break ;
