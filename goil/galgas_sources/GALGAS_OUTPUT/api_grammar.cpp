...
void cGrammar_api_5F_grammar::_performSourceFileParsing_ (C_Compiler * inCompiler,
  ...
  if (inFilePath.isValid ()) {
    ...
    macroMyNew (scanner, C_Lexique_api_5F_scanner (inCompiler, "", "", inCompiler->ioParametersPtr (), filePath COMMA_HERE)) ;
...
void cGrammar_api_5F_grammar::_performSourceStringParsing_ (C_Compiler * inCompiler,
  ...
  if (inSourceString.isValid ()) {
    ...
    C_Lexique_api_5F_scanner * scanner = NULL ;
    macroMyNew (scanner, C_Lexique_api_5F_scanner (inCompiler, inCompiler->ioParametersPtr (), sourceString, "" COMMA_HERE)) ;
    scanner->mPerformGeneration = inCompiler->mPerformGeneration ;
    const bool ok = scanner->performTopDownParsing (gProductions, gProductionNames, gProductionIndexes,
                                                    gFirstProductionIndexes, gDecision, gDecisionIndexes, 31) ;
    if (ok && ! scanner->mParseOnlyFlag) {
