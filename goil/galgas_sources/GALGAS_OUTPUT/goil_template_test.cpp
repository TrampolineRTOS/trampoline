...
void routine_testTemplate (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  #endif
  const GGS_bool cond_7007 = gOption_goil_5F_options_run_5F_goil_5F_template_5F_test.reader_value () ;
  if (cond_7007.isBuiltAndTrue ()) {
    ...
    goil_template_grammar::_performSourceStringParsing_ (inLexique,
                                    ...
                                    GGS_string ("code"),
                                    GGS_string (""),
                                    GGS_systemConfig ::constructor_new (inLexique, GGS_string ("Version 1") COMMA_HERE),
                                    var_cas_sampleMap,
    ...
    {
      GGS_functionlist::cEnumerator enumerator_6420 (GGS_function::constructor_functionList (), true) ;
      const GGS_functionlist::cElement * operand_6420 = NULL ;
      while (((operand_6420 = enumerator_6420.nextObject ()))) {
        macroValidPointer (operand_6420) ;
        const GGS_bool cond_6534 = var_cas_allowedFunctionSet.reader_hasKey (operand_6420->mValue.reader_name ()) ;
        if (cond_6534.isBuiltAndTrue ()) {
          inLexique.printMessage (C_String ("LOGGING mValue: ") + operand_6420->mValue.reader_description ().string () + "\n" COMMA_SOURCE_FILE_AT_LINE (124)) ;
        }
      }
    }
