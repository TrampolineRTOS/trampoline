...
typeComparisonResult cMapElement_isr_5F_map::compare (const cCollectionElement * inOperand) const {
...
typeComparisonResult cSortedListElement_isr_5F_list::compare (const cCollectionElement * inOperand) const {
...
typeComparisonResult cSortedListElement_isr_5F_list::compareForSorting (const cSortedListElement * inOperand) const {
...
typeComparisonResult cPtr_isr_5F_obj::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_isr_5F_obj * p = (const cPtr_isr_5F_obj *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_isr_5F_obj) ;
  if (kOperandEqual == result) {
    result = mAttribute_desc.objectCompare (p->mAttribute_desc) ;
  }
  if (kOperandEqual == result) {
    result = mAttribute_category.objectCompare (p->mAttribute_category) ;
  }
  if (kOperandEqual == result) {
...
typeComparisonResult GALGAS_isr_5F_obj::objectCompare (const GALGAS_isr_5F_obj & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
