...
const C_galgas_type_descriptor kTypeDescriptor_GGS_isr_obj ("isr_obj", true, & kTypeDescriptor_GGS_oil_obj) ;
...
C_galgasClassRunTimeInformation gClassInfoFor__isr_obj ("isr_obj", gClassInfoFor__oil_obj, & kTypeDescriptor_GGS_isr_obj) ;
...
const C_galgas_type_descriptor * GGS_isr_obj::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_isr_map ("isr_map", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_isr_map::typeDescriptor (void) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GGS_isr_list ("isr_list", false, NULL) ;
...
const C_galgas_type_descriptor * GGS_isr_list::typeDescriptor (void) const {
