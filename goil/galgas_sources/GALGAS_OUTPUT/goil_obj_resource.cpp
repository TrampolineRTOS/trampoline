...
void goil_obj_resource::rule_goil_5F_obj_5F_resource_resource_i0_ (C_Lexique_goil_5F_lexique & inLexique,
  ...
  const GGS_bool cond_1244 = (var_cas_resource_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (54))).operator_isEqual (GGS_string ("res_sched")) ;
  if (cond_1244.isBuiltAndTrue ()) {
  ...
  const GGS_bool cond_1365 = var_cas_resources.reader_hasKey (var_cas_resource_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (58))) ;
  if (cond_1365.isBuiltAndTrue ()) {
    var_cas_resources.modifier_del (inLexique, var_cas_resource_name, var_cas_resource COMMA_SOURCE_FILE_AT_LINE (59)) ;
  }else if (cond_1365.isBuiltAndFalse ()) {
  ...
  var_cas_resource = GGS_resource_obj ::constructor_new (inLexique, var_cas_desc, var_cas_property, var_cas_acc_apps COMMA_SOURCE_FILE_AT_LINE (69)) ;
...
void goil_obj_resource::rule_goil_5F_obj_5F_resource_resource_5F_attributes_i1_ (C_Lexique_goil_5F_lexique & inLexique,
    ...
    while (syntaxRepeat_0) {
      switch (select_goil_5F_obj_5F_resource_0 (inLexique)) {
        case 2 : {
          ...
          switch (select_goil_5F_obj_5F_resource_1 (inLexique)) {
            case 1 : {
              ...
              { const GGS_resource_property_obj _var_2209 = var_cas_property ; // CAST instruction
                if (_var_2209.getPtr () != NULL) {
                  macroValidPointer (_var_2209.getPtr ()) ;
                  if (typeid (cPtr_resource_property_void_obj) == typeid (* (_var_2209.getPtr ()))) {
                    var_cas_property = GGS_resource_property_standard_obj ::constructor_new (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (84)) ;
                  }else{
            ...
            case 2 : {
              ...
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
              inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__7D_) COMMA_HERE) ;
              { const GGS_resource_property_obj _var_2661 = var_cas_property ; // CAST instruction
                if (_var_2661.getPtr () != NULL) {
                  macroValidPointer (_var_2661.getPtr ()) ;
                  if (typeid (cPtr_resource_property_void_obj) == typeid (* (_var_2661.getPtr ()))) {
                    var_cas_property = GGS_resource_property_linked_obj ::constructor_new (inLexique, GGS_location (inLexique), var_cas_linked_resource COMMA_SOURCE_FILE_AT_LINE (94)) ;
                  }else{
            ...
            case 3 : {
              ...
              { const GGS_resource_property_obj _var_2997 = var_cas_property ; // CAST instruction
                if (_var_2997.getPtr () != NULL) {
                  macroValidPointer (_var_2997.getPtr ()) ;
                  if (typeid (cPtr_resource_property_void_obj) == typeid (* (_var_2997.getPtr ()))) {
                    var_cas_property = GGS_resource_property_internal_obj ::constructor_new (inLexique, GGS_location (inLexique) COMMA_SOURCE_FILE_AT_LINE (103)) ;
                  }else{
        ...
        case 3 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken_idf) COMMA_HERE) ;
          GGS_lstring  automatic_var_3113_0 ;
          nt_description_ (inLexique, automatic_var_3113_0) ;
          inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
  ...
  GGS_lstring  automatic_var_3221_0 ;
  nt_description_ (inLexique, automatic_var_3221_0) ;
  inLexique.acceptTerminal (ACCEPT_TERMINAL (C_Lexique_goil_5F_lexique::kToken__3B_) COMMA_HERE) ;
}
