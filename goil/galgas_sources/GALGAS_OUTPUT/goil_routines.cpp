...
GGS_lstring  function_extra_config_file (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  const GGS_bool cond_6342 = (var_cas_cfg.reader_fileExists ()).operator_not () ;
  if (cond_6342.isBuiltAndTrue ()) {
...
void routine_prefix (C_Compiler & inLexique,
  ...
  GGS_string automatic_var_6543_0 ;
  const GGS_prefix_map  temp_6528 = var_cas_p ;
  if (temp_6528.isBuilt ()) {
    temp_6528 (HERE)->method_prefix (inLexique, var_cas_lkey, var_cas_val, automatic_var_6543_0 COMMA_SOURCE_FILE_AT_LINE (203)) ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_performReplace (C_Compiler & inLexique,
  ...
  const GGS_prefix_map  temp_6750 = var_cas_p ;
  if (temp_6750.isBuilt ()) {
    temp_6750 (HERE)->method_prefix (inLexique, var_cas_lkey, var_cas_prefix, var_cas_tag_to_rep COMMA_SOURCE_FILE_AT_LINE (210)) ;
  }
...
void routine_do_replace_default (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_7140 = (var_cas_n).operator_isNotEqual (GGS_string ("")) ;
  if (cond_7140.isBuiltAndTrue ()) {
    var_cas_s = var_cas_s.reader_stringByReplacingStringByString (inLexique, var_cas_o, var_cas_n COMMA_SOURCE_FILE_AT_LINE (220)) ;
  }else if (cond_7140.isBuiltAndFalse ()) {
...
void routine_replace_no_prefix (C_Compiler & inLexique,
  ...
  GGS_lstring  var_cas_lkey = GGS_lstring ::constructor_new (inLexique, var_cas_key, GGS_location (inLexique) COMMA_HERE) ;
  GGS_string var_cas_tag_to_rep ;
  GGS_string automatic_var_7433_0 ;
  const GGS_prefix_map  temp_7411 = var_cas_p ;
  if (temp_7411.isBuilt ()) {
    temp_7411 (HERE)->method_prefix (inLexique, var_cas_lkey, automatic_var_7433_0, var_cas_tag_to_rep COMMA_SOURCE_FILE_AT_LINE (230)) ;
  }
...
void routine_table_core (C_Compiler & inLexique,
  ...
  {
    GGS_stringset::cEnumerator enumerator_7893 (var_cas_names, true) ;
    while (enumerator_7893.hasCurrentObject ()) {
      var_cas_header = (((((((var_cas_header).operator_concat (GGS_string ("#define "))).operator_concat (var_cas_varname)).operator_concat (GGS_string ("_id_of_"))).operator_concat (enumerator_7893._key (HERE))).operator_concat (GGS_string ("  "))).operator_concat (var_cas_n.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (251)))).operator_concat (GGS_string ("\n")) ;
      var_cas_header = (((((((var_cas_header).operator_concat (GGS_string ("#define "))).operator_concat (enumerator_7893._key (HERE))).operator_concat (GGS_string ("  "))).operator_concat (var_cas_varname)).operator_concat (GGS_string ("_id_of_"))).operator_concat (enumerator_7893._key (HERE))).operator_concat (GGS_string ("\n")) ;
      var_cas_implementation = (((((var_cas_implementation).operator_concat (GGS_string ("    (tpl_"))).operator_concat (var_cas_typename)).operator_concat (GGS_string (" *)&"))).operator_concat (var_cas_obj_prefix)).operator_concat (enumerator_7893._key (HERE)) ;
      var_cas_n.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (261)) ;
      const GGS_bool cond_8544 = (var_cas_n).operator_isNotEqual (var_cas_names.reader_count ()) ;
      if (cond_8544.isBuiltAndTrue ()) {
        var_cas_implementation = (var_cas_implementation).operator_concat (GGS_string (",\n")) ;
      }else if (cond_8544.isBuiltAndFalse ()) {
        var_cas_implementation = (var_cas_implementation).operator_concat (GGS_string ("\n")) ;
      }
      enumerator_7893.next () ;
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_add_to_stringset (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_11667 = var_cas_ss.reader_hasKey (var_cas_new) ;
  if (cond_11667.isBuiltAndTrue ()) {
  ...
  }else if (cond_11667.isBuiltAndFalse ()) {
...
void routine_file_in_path (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_11986 (var_cas_path_list, true) ;
    const GGS_stringlist::cElement * operand_11986 = NULL ;
    while (((operand_11986 = enumerator_11986.nextObject ()))) {
      macroValidPointer (operand_11986) ;
      GGS_string var_cas_full_file_path = operand_11986->mValue ;
      const GGS_bool cond_12247 = (var_cas_full_file_path).operator_isNotEqual (GGS_string ("")) ;
      if (cond_12247.isBuiltAndTrue ()) {
        const GGS_bool cond_12230 = (var_cas_full_file_path.reader_characterAtIndex (inLexique, var_cas_full_file_path.reader_length ().substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (386)) COMMA_SOURCE_FILE_AT_LINE (386))).operator_isNotEqual (GGS_char (TO_UNICODE ('/'))) ;
        if (cond_12230.isBuiltAndTrue ()) {
          var_cas_full_file_path.appendCString ("/") ;
        }
      }
      var_cas_full_file_path.dotAssign_operation (var_cas_file_name.ggs_string ()) ;
      const GGS_bool cond_12457 = (var_cas_full_file_path.reader_fileExists ()).operator_and (var_cas_not_found) ;
...
void routine_is_in_lstringlist (C_Compiler & inLexique,
  ...
  {
    GGS_lstringlist::cEnumerator enumerator_12656 (var_cas_l, true) ;
    const GGS_lstringlist::cElement * operand_12656 = NULL ;
    while (((operand_12656 = enumerator_12656.nextObject ()))) {
      macroValidPointer (operand_12656) ;
      const GGS_bool cond_12750 = (operand_12656->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (407))).operator_isEqual (var_cas_e.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (407))) ;
      if (cond_12750.isBuiltAndTrue ()) {
        var_cas_p = GGS_bool (true) ;
        var_cas_f = operand_12656->mValue ;
      }
    }
  }
  #ifdef DEBUG_TRACE_ENABLED
...
GGS_bool function_isInLstringlist (C_Compiler & inLexique,
  ...
  var_cas_p = GGS_bool (false) ;
  {
    GGS_lstringlist::cEnumerator enumerator_12894 (var_cas_l, true) ;
    const GGS_lstringlist::cElement * operand_12894 = NULL ;
    while (((operand_12894 = enumerator_12894.nextObject ()))) {
      macroValidPointer (operand_12894) ;
      const GGS_bool cond_12973 = (operand_12894->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (421))).operator_isEqual (var_cas_e.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (421))) ;
      if (cond_12973.isBuiltAndTrue ()) {
        var_cas_p = GGS_bool (true) ;
      }
    }
  }
...
void routine_add_lstring_unique (C_Compiler & inLexique,
  ...
  const GGS_bool cond_13279 = var_cas_found ;
  if (cond_13279.isBuiltAndTrue ()) {
  ...
  }else if (cond_13279.isBuiltAndFalse ()) {
...
void routine_set_lstring_if_empty (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_13443 = (var_cas_s.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (448))).operator_isEqual (GGS_string ("")) ;
  if (cond_13443.isBuiltAndTrue ()) {
    var_cas_s = var_cas_ns ;
  }else if (cond_13443.isBuiltAndFalse ()) {
...
void routine_add_makefile_flag_if_not_empty (C_Compiler &,
  ...
  #endif
  const GGS_bool cond_13732 = (var_cas_flag_value).operator_isNotEqual (GGS_string ("")) ;
  if (cond_13732.isBuiltAndTrue ()) {
...
GGS_string function_stripString (C_Compiler & inLexique,
  ...
  const GGS_bool cond_14721 = (var_cas_s.reader_length ()).operator_strictSup (GGS_uint (0U)) ;
  if (cond_14721.isBuiltAndTrue ()) {
    GGS_uint  var_cas_first = GGS_uint (0U) ;
    GGS_uint  var_cas_last = var_cas_s.reader_length () ;
    GGS_bool var_cas_finished = GGS_bool (false) ;
    GGS_uint _variant_14272 = var_cas_s.reader_length () ;
    GGS_bool _condition_14272 (_variant_14272.isBuilt (), true) ;
    while (_condition_14272.isBuiltAndTrue ()) {
      _condition_14272 = (var_cas_finished).operator_not () ;
      if (_condition_14272.isBuiltAndTrue ()) {
        if (_variant_14272.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (482)) ;
          _condition_14272 = GGS_bool (false) ;
        }else{
          _variant_14272.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_14237 = (var_cas_s.reader_characterAtIndex (inLexique, var_cas_first COMMA_SOURCE_FILE_AT_LINE (478))).operator_isEqual (GGS_char (TO_UNICODE (' '))) ;
          if (cond_14237.isBuiltAndTrue ()) {
            var_cas_first.increment_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (479)) ;
            const GGS_bool cond_14222 = (var_cas_first).operator_isEqual (var_cas_s.reader_length ()) ;
            if (cond_14222.isBuiltAndTrue ()) {
              var_cas_finished = GGS_bool (true) ;
            }
          }else if (cond_14237.isBuiltAndFalse ()) {
            var_cas_finished = GGS_bool (true) ;
          }
        }
      }
    ...
    GGS_uint _variant_14569 = var_cas_s.reader_length () ;
    GGS_bool _condition_14569 (_variant_14569.isBuilt (), true) ;
    while (_condition_14569.isBuiltAndTrue ()) {
      _condition_14569 = (var_cas_finished).operator_not () ;
      if (_condition_14569.isBuiltAndTrue ()) {
        if (_variant_14569.uintValue () == 0) {
          inLexique.onTheFlyRunTimeError ("loop variant error" COMMA_SOURCE_FILE_AT_LINE (491)) ;
          _condition_14569 = GGS_bool (false) ;
        }else{
          _variant_14569.decrement_operation (inLexique COMMA_HERE) ;
          const GGS_bool cond_14534 = (var_cas_s.reader_characterAtIndex (inLexique, var_cas_last.substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (487)) COMMA_SOURCE_FILE_AT_LINE (487))).operator_isEqual (GGS_char (TO_UNICODE (' '))) ;
          if (cond_14534.isBuiltAndTrue ()) {
            var_cas_last.decrement_operation (inLexique COMMA_SOURCE_FILE_AT_LINE (488)) ;
            const GGS_bool cond_14519 = (var_cas_last).operator_isEqual (GGS_uint (0U)) ;
            if (cond_14519.isBuiltAndTrue ()) {
              var_cas_finished = GGS_bool (true) ;
            }
          }else if (cond_14534.isBuiltAndFalse ()) {
            var_cas_finished = GGS_bool (true) ;
          }
        }
      }
    }
    const GGS_bool cond_14687 = (var_cas_first).operator_strictInf (var_cas_last) ;
    ...
    }else if (cond_14687.isBuiltAndFalse ()) {
      var_cas_r = GGS_string ("") ;
    }
  }else if (cond_14721.isBuiltAndFalse ()) {
    var_cas_r = GGS_string ("") ;
  }
  #ifdef DEBUG_TRACE_ENABLED
...
void routine_errorNoFileFound (C_Compiler & inLexique,
  ...
  {
    GGS_stringlist::cEnumerator enumerator_14980 (var_cas_searchedPaths, true) ;
    ...
    while (((operand_14980 = enumerator_14980.nextObject ()))) {
      ...
      var_cas_m.appendCString ("\n"
        "  - '") ;
      var_cas_m.dotAssign_operation (operand_14980->mValue) ;
      var_cas_m.appendCString ("'") ;
    }
  }
