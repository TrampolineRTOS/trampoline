...
GGS_string function_arch (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_stringlist  var_cas_components = gOption_goil_5F_options_target_5F_platform.value ().reader_componentsSeparatedByString (GGS_string ("/")) ;
...
GGS_string function_chip (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_stringlist  var_cas_components = gOption_goil_5F_options_target_5F_platform.value ().reader_componentsSeparatedByString (GGS_string ("/")) ;
  const GGS_bool cond_1219 = (var_cas_components.reader_length ()).operator_strictSup (GGS_uint (1U)) ;
...
GGS_string function_board (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  GGS_stringlist  var_cas_components = gOption_goil_5F_options_target_5F_platform.value ().reader_componentsSeparatedByString (GGS_string ("/")) ;
  const GGS_bool cond_1550 = (var_cas_components.reader_length ()).operator_strictSup (GGS_uint (2U)) ;
...
GGS_string function_add_path_component (C_Compiler & inLexique,
  ...
  const GGS_bool cond_1844 = (var_cas_path.reader_characterAtIndex (inLexique, var_cas_path.reader_length ().substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (60)) COMMA_SOURCE_FILE_AT_LINE (60))).operator_isNotEqual (GGS_char (TO_UNICODE ('/'))) ;
...
GGS_string function_templates_directory (C_Compiler & inLexique,
  ...
  if (cond_3029.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_3016 = (var_cas_temp_dir.reader_characterAtIndex (inLexique, var_cas_temp_dir.reader_length ().substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (90)) COMMA_SOURCE_FILE_AT_LINE (90))).operator_isNotEqual (GGS_char (TO_UNICODE ('/'))) ;
...
GGS_string function_template_string_if_exist (C_Compiler & inLexique,
  ...
  const GGS_bool cond_3668 = var_cas_targ_tpl.reader_fileExists () ;
  if (cond_3668.isBuiltAndTrue ()) {
    ...
    const GGS_bool cond_3834 = var_cas_targ_tpl.reader_fileExists () ;
    if (cond_3834.isBuiltAndTrue ()) {
      ...
      const GGS_bool cond_3997 = var_cas_targ_tpl.reader_fileExists () ;
      if (cond_3997.isBuiltAndTrue ()) {
        ...
        const GGS_bool cond_4208 = var_cas_targ_tpl.reader_fileExists () ;
        if (cond_4208.isBuiltAndTrue ()) {
          ...
          const GGS_bool cond_4376 = var_cas_targ_tpl.reader_fileExists () ;
...
GGS_lstring  function_config_file (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  const GGS_bool cond_5159 = (var_cas_cfg.reader_fileExists ()).operator_not () ;
...
GGS_lstring  function_extra_config_file (C_Compiler & inLexique COMMA_UNUSED_LOCATION_ARGS) {
  ...
  const GGS_bool cond_5378 = (var_cas_cfg.reader_fileExists ()).operator_not () ;
...
void routine_table_core (C_Compiler & inLexique,
  ...
  GGS_uint  var_cas_n = GGS_uint (0U) ;
  {
    ...
    while (enumerator_6929.hasCurrentObject ()) {
      ...
      const GGS_bool cond_7580 = (var_cas_n).operator_isNotEqual (var_cas_names.reader_count ()) ;
...
void routine_obj_table (C_Compiler & inLexique,
  ...
  var_cas_implementation = (var_cas_implementation).operator_concat (GGS_string ("};\n")) ;
  const GGS_bool cond_8457 = (var_cas_names.reader_count ()).operator_isEqual (GGS_uint (0U)) ;
...
void routine_additional_int_key_required (C_Compiler & inLexique,
  ...
  const GGS_bool cond_9310 = var_cas_others.reader_hasKey (var_cas_key) ;
...
void routine_additional_string_key_required (C_Compiler & inLexique,
  ...
  const GGS_bool cond_9832 = var_cas_others.reader_hasKey (var_cas_key) ;
...
void routine_additional_bool_key_required (C_Compiler & inLexique,
  ...
  const GGS_bool cond_10366 = var_cas_others.reader_hasKey (var_cas_key) ;
...
void routine_add_to_stringset (C_Compiler & inLexique,
  ...
  #endif
  const GGS_bool cond_10603 = var_cas_ss.reader_hasKey (var_cas_new) ;
  ...
  GGS_bool var_cas_not_found = GGS_bool (true) ;
  {
    ...
    while (((operand_10922 = enumerator_10922.nextObject ()))) {
      ...
      if (cond_11183.isBuiltAndTrue ()) {
        const GGS_bool cond_11166 = (var_cas_full_file_path.reader_characterAtIndex (inLexique, var_cas_full_file_path.reader_length ().substract_operation (inLexique, GGS_uint (1U) COMMA_SOURCE_FILE_AT_LINE (362)) COMMA_SOURCE_FILE_AT_LINE (362))).operator_isNotEqual (GGS_char (TO_UNICODE ('/'))) ;
      ...
      const GGS_bool cond_11393 = (var_cas_full_file_path.reader_fileExists ()).operator_and (var_cas_not_found) ;
