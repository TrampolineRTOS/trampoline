      ...
      { const GGS_counter_type _var_2239 = operand_1940->mInfo.counter.reader_type (_inLexique COMMA_SOURCE_FILE_AT_LINE (73)) ; // CAST instruction
        if (_var_2239.getPtr () != NULL) {
          ...
          if (typeid (cPtr_software_counter) == typeid (* (_var_2239.getPtr ()))) {
            ...
            ::routine_doReplace (_inLexique,  var_cas_tmp,  GGS_string (true, "$COUNTER$"),  (operand_1940->mKey.reader_string (_inLexique COMMA_SOURCE_FILE_AT_LINE (78)))._operator_concat (GGS_string (true, "_counter_desc")) COMMA_SOURCE_FILE_AT_LINE (78)) ;
