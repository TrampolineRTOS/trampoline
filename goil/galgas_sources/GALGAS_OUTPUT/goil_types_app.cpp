...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@app_trusted_true:"
           << location.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << trusted_fcts.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
...
appendForDescription (C_Compiler & inLexique,
  ...
  ioString << "->@app_obj:"
           ...
           << trusted.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           ...
           << restart.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << tasks.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << isrs.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << alarms.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << schedtables.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
           << counters.reader_description  (inLexique COMMA_THERE, inIndentation + 1)
...
appendForMapDescription (C_Compiler & inLexique,
  ...
  ioString << "|-value " ;
  ioString.appendSigned (inElementIndex) ;
  ioString << ":" << mInfo.app.reader_description  (inLexique COMMA_THERE, inIndentation + 1) ;
}
