...
//                    november 12th, 2009, at 11h41'48"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
pr_task_goil_obj_task_66_11_ (goil_lexique & inLexique,
  ...
  const GGS_bool cond_2513 = var_cas_tasks.reader_hasKey (inLexique, var_cas_task_name.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (85)) COMMA_SOURCE_FILE_AT_LINE (85)) ;
  ...
  { bool syntaxRepeat_0 = true ;
    while (syntaxRepeat_0) {
      switch (select_goil_obj_task_0 (inLexique)) {
        ...
        case 9 : {
          const GGS_bool cond_5694 = (gOption_goil_5F_options_autosar_5F_on.value ()).operator_isEqual (GGS_bool (false)) ;
          if (cond_5694.isBuiltAndTrue ()) {
          ...
          switch (select_goil_obj_task_3 (inLexique)) {
            ...
            case 2 : {
              ...
              { const GGS_basic_type _var_6337 = var_cas_count_limit ; // CAST instruction
                if (_var_6337.getPtr () != NULL) {
                  macroValidPointer (_var_6337.getPtr ()) ;
                  if (typeid (cPtr_uint32_class) == typeid (* (_var_6337.getPtr ()))) {
                    const GGS_uint32_class var_cas_uc (_var_6337.getPtr ()) ;
              ...
              { const GGS_basic_type _var_6452 = var_cas_exe_budget ; // CAST instruction
                if (_var_6452.getPtr () != NULL) {
                  macroValidPointer (_var_6452.getPtr ()) ;
                  if (typeid (cPtr_void) == typeid (* (_var_6452.getPtr ()))) {
              ...
              { const GGS_basic_type _var_6623 = var_cas_exe_time ; // CAST instruction
                if (_var_6623.getPtr () != NULL) {
                  macroValidPointer (_var_6623.getPtr ()) ;
                  if (typeid (cPtr_uint64_class) == typeid (* (_var_6623.getPtr ()))) {
                    const GGS_uint64_class var_cas_et (_var_6623.getPtr ()) ;
    ...
    while (syntaxRepeat_4) {
      switch (select_goil_obj_task_4 (inLexique)) {
        case 2 : {
          ...
          inLexique.acceptTerminal (ACCEPT_TERMINAL (goil_lexique::goil_lexique_1__3B_) COMMA_HERE) ;
          const GGS_bool cond_7464 = var_cas_appmodes.reader_hasKey (inLexique, var_cas_appmode.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (267)) COMMA_SOURCE_FILE_AT_LINE (267)) ;
