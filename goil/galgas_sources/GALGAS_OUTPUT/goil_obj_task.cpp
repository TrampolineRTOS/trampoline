...
//                    september 21th, 2009, at 18h17'14"                     *
//                                                                           *
//---------------------------------------------------------------------------*
    ...
    while (syntaxRepeat_0) {
      switch (select_repeat_goil_obj_task_0 (inLexique)) {
        ...
        case 4 : {
          ...
          { const GGS_task_autostart_obj _var_4792 = var_cas_autostart ; // CAST instruction
            if (_var_4792.getPtr () != NULL) {
              macroValidPointer (_var_4792.getPtr ()) ;
              if (typeid (cPtr_task_autostart_void) == typeid (* (_var_4792.getPtr ()))) {
        ...
        case 9 : {
          ...
          switch (select_goil_obj_task_3 (inLexique)) {
            ...
            case 2 : {
              ...
              { const GGS_basic_type _var_6230 = var_cas_count_limit ; // CAST instruction
                if (_var_6230.getPtr () != NULL) {
                  macroValidPointer (_var_6230.getPtr ()) ;
                  if (typeid (cPtr_uint32_class) == typeid (* (_var_6230.getPtr ()))) {
                    const GGS_uint32_class var_cas_uc (_var_6230.getPtr ()) ;
              ...
              { const GGS_basic_type _var_6345 = var_cas_exe_budget ; // CAST instruction
                if (_var_6345.getPtr () != NULL) {
                  macroValidPointer (_var_6345.getPtr ()) ;
                  if (typeid (cPtr_void) == typeid (* (_var_6345.getPtr ()))) {
              ...
              { const GGS_basic_type _var_6516 = var_cas_exe_time ; // CAST instruction
                if (_var_6516.getPtr () != NULL) {
                  macroValidPointer (_var_6516.getPtr ()) ;
                  if (typeid (cPtr_uint64_class) == typeid (* (_var_6516.getPtr ()))) {
                    const GGS_uint64_class var_cas_et (_var_6516.getPtr ()) ;
