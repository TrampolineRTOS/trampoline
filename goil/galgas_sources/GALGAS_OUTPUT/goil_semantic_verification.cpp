...
//                    november 12th, 2009, at 11h41'28"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_all_events_and_resources_and_messages_defined_and_used (C_Compiler & inLexique,
    ...
    while (((operand_3572 = enumerator_3572.nextObject ()))) {
      ...
      var_cas_task_events = operand_3572->mInfo.task.reader_events (inLexique COMMA_SOURCE_FILE_AT_LINE (133)) ;
      {
        ...
        while (((operand_3742 = enumerator_3742.nextObject ()))) {
          ...
          const GGS_bool cond_3949 = (var_cas_events.reader_hasKey (inLexique, operand_3742->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (136))).operator_not () ;
      ...
      var_cas_task_resources = operand_3572->mInfo.task.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (143)) ;
      {
        ...
        while (((operand_4116 = enumerator_4116.nextObject ()))) {
          ...
          const GGS_bool cond_4322 = (var_cas_resources.reader_hasKey (inLexique, operand_4116->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (146)) COMMA_SOURCE_FILE_AT_LINE (146))).operator_not () ;
      ...
      var_cas_task_messages = operand_3572->mInfo.task.reader_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (153)) ;
      {
        ...
        while (((operand_4484 = enumerator_4484.nextObject ()))) {
          ...
          const GGS_bool cond_4694 = (var_cas_messages.reader_hasKey (inLexique, operand_4484->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (156)) COMMA_SOURCE_FILE_AT_LINE (156))).operator_not () ;
    ...
    while (((operand_4806 = enumerator_4806.nextObject ()))) {
      ...
      GGS_lstringlist  var_cas_isr_resources = operand_4806->mInfo.isr.reader_resources (inLexique COMMA_SOURCE_FILE_AT_LINE (166)) ;
      {
        ...
        while (((operand_4965 = enumerator_4965.nextObject ()))) {
          ...
          const GGS_bool cond_5164 = (var_cas_resources.reader_hasKey (inLexique, operand_4965->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (169)) COMMA_SOURCE_FILE_AT_LINE (169))).operator_not () ;
      ...
      var_cas_isr_messages = operand_4806->mInfo.isr.reader_messages (inLexique COMMA_SOURCE_FILE_AT_LINE (176)) ;
      {
        ...
        while (((operand_5322 = enumerator_5322.nextObject ()))) {
          ...
          const GGS_bool cond_5522 = (var_cas_messages.reader_hasKey (inLexique, operand_5322->mValue.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (179)) COMMA_SOURCE_FILE_AT_LINE (179))).operator_not () ;
  ...
  }
  {
    ...
    while (((operand_5630 = enumerator_5630.nextObject ()))) {
      ...
      const GGS_bool cond_5806 = (var_cas_used_events.reader_hasKey (inLexique, operand_5630->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (188)) COMMA_SOURCE_FILE_AT_LINE (188))).operator_not () ;
  ...
  }
  {
    ...
    while (((operand_5912 = enumerator_5912.nextObject ()))) {
      ...
      const GGS_bool cond_6086 = (var_cas_used_resources.reader_hasKey (inLexique, operand_5912->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (195)) COMMA_SOURCE_FILE_AT_LINE (195))).operator_not () ;
  ...
  }
  {
    ...
    while (((operand_6190 = enumerator_6190.nextObject ()))) {
      ...
      const GGS_bool cond_6366 = (var_cas_used_messages.reader_hasKey (inLexique, operand_6190->mKey.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (202)) COMMA_SOURCE_FILE_AT_LINE (202))).operator_not () ;
      ...
      { const GGS_event_mask_obj _var_6947 = var_cas_mask ; // CAST instruction
        if (_var_6947.getPtr () != NULL) {
          ...
          if (typeid (cPtr_event_mask_user_obj) == typeid (* (_var_6947.getPtr ()))) {
            ...
            const GGS_bool cond_6868 = var_cas_defined_masks.reader_hasKey (inLexique, var_cas_mask_in_string COMMA_SOURCE_FILE_AT_LINE (219)) ;
      ...
      { const GGS_action_obj _var_9038 = var_cas_alarm_action ; // CAST instruction
        if (_var_9038.getPtr () != NULL) {
          ...
          if (typeid (cPtr_setevent_action) == typeid (* (_var_9038.getPtr ()))) {
            ...
            const GGS_bool cond_7542 = (var_cas_defined_task_names.reader_hasKey (inLexique, var_cas_act.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (242)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (242)) COMMA_SOURCE_FILE_AT_LINE (242))).operator_not () ;
            if (cond_7542.isBuiltAndTrue ()) {
              ...
              const GGS_bool cond_7914 = (var_cas_known_events.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (249))).operator_isEqual (GGS_uint (0U)) ;
            ...
            const GGS_bool cond_8417 = (var_cas_defined_task_names.reader_hasKey (inLexique, var_cas_act.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (259)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (259)) COMMA_SOURCE_FILE_AT_LINE (259))).operator_not () ;
            ...
            const GGS_bool cond_8895 = var_cas_counters.reader_hasKey (inLexique, var_cas_act.reader_counter_name (inLexique COMMA_SOURCE_FILE_AT_LINE (263)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (263)) COMMA_SOURCE_FILE_AT_LINE (263)) ;
