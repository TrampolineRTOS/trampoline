            ...
            if (cond_15270.isBuiltAndTrue ()) {
              ...
              if (cond_15254.isBuiltAndTrue ()) {
                ...
                if (_depExtension.isBuilt () && _depPath.isBuilt ()) {
                  template_grammar::_performSourceFileParsing_ (inLexique,
...
C_PrologueEpilogue prologueEpilogueObjectFor_template_invocation (NULL,
                                   epilogueRoutineFor_template_invocation) ;
