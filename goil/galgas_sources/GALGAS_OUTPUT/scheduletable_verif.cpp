...
void routine_schedule_tables_well_formed (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_502 = enumerator_502.nextObject ()))) {
      ...
      var_cas_len = function_uint64_or_error (inLexique, operand_502->mInfo.st.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (20)), GGS_string ("LENGTH") COMMA_SOURCE_FILE_AT_LINE (20)) ;
      { const GGS_ltgt_sync_obj _var_1304 = operand_502->mInfo.st.reader_ltgt_sync (inLexique COMMA_SOURCE_FILE_AT_LINE (23)) ; // CAST instruction
        if (_var_1304.getPtr () != NULL) {
          ...
          if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_1304.getPtr ()))) {
            ...
            GGS_uint64  var_cas_prec ;
            var_cas_prec = function_uint64_or_error (inLexique, var_cas_sync.reader_precision (inLexique COMMA_SOURCE_FILE_AT_LINE (28)), GGS_string ("PRECISION") COMMA_SOURCE_FILE_AT_LINE (28)) ;
            if (((var_cas_prec).operator_strictSup (var_cas_len.add_operation (inLexique, GGS_uint64 (1U) COMMA_SOURCE_FILE_AT_LINE (29)))).isBuiltAndTrue ()) {
      ...
      var_cas_eps = operand_502->mInfo.st.reader_exp_points (inLexique COMMA_SOURCE_FILE_AT_LINE (39)) ;
      GGS_uint  var_cas_exp_pt_number ;
      var_cas_exp_pt_number = var_cas_eps.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (42)) ;
      if (((var_cas_exp_pt_number).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      }
      {
        ...
        while (((operand_1855 = enumerator_1855.nextObject ()))) {
          ...
          if (((operand_1855->point.reader_actions (inLexique COMMA_SOURCE_FILE_AT_LINE (49)).reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (49))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
      ...
      GGS_uint64  var_cas_first_delay ;
      var_cas_first_delay = GGS_uint64 (0U) ;
      GGS_uint64  var_cas_first_maxret ;
      var_cas_first_maxret = GGS_uint64 (0U) ;
      GGS_uint64  var_cas_first_maxadv ;
      var_cas_first_maxadv = GGS_uint64 (0U) ;
      GGS_uint64  var_cas_last_delay ;
      var_cas_last_delay = GGS_uint64 (0U) ;
      GGS_bool var_cas_first_time ;
      var_cas_first_time = GGS_bool (true) ;
      GGS_uint64  var_cas_previous_delay ;
      var_cas_previous_delay = GGS_uint64 (0U) ;
      GGS_uint64  var_cas_maxret ;
      var_cas_maxret = GGS_uint64 (0U) ;
      GGS_uint64  var_cas_maxadv ;
      var_cas_maxadv = GGS_uint64 (0U) ;
      GGS_uint  var_cas_i ;
      ...
      if ((var_cas_counters.reader_hasKey (inLexique, operand_502->mInfo.st.reader_counter (inLexique COMMA_SOURCE_FILE_AT_LINE (72)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (72)) COMMA_SOURCE_FILE_AT_LINE (72))).isBuiltAndTrue ()) {
        ...
        var_cas_mav = function_uint32_or_error (inLexique, var_cas_cnt.reader_max_allowed_value (inLexique COMMA_SOURCE_FILE_AT_LINE (75)), GGS_string ("MAXALLOWEDVALUE") COMMA_SOURCE_FILE_AT_LINE (75)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (75)) ;
        GGS_uint64  var_cas_mc ;
        var_cas_mc = function_uint32_or_error (inLexique, var_cas_cnt.reader_min_cycle (inLexique COMMA_SOURCE_FILE_AT_LINE (76)), GGS_string ("MINCYCLE") COMMA_SOURCE_FILE_AT_LINE (76)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (76)) ;
        ...
        var_cas_previous_offset = GGS_uint64 (0U) ;
        {
          ...
          while (((operand_3023 = enumerator_3023.nextObject ()))) {
            ...
            var_cas_offset = function_uint64_or_error (inLexique, operand_3023->point.reader_offset (inLexique COMMA_SOURCE_FILE_AT_LINE (86)), GGS_string ("OS442 - OFFSET") COMMA_SOURCE_FILE_AT_LINE (86)) ;
            GGS_location  var_cas_off_loc ;
            var_cas_off_loc = operand_3023->point.reader_offset (inLexique COMMA_SOURCE_FILE_AT_LINE (87)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (87)) ;
            ...
            if (((var_cas_previous_offset).operator_isEqual (GGS_uint64 (0U))).isBuiltAndTrue ()) {
              var_cas_first_delay = var_cas_offset ;
            }
            GGS_location  var_cas_adj_loc ;
            var_cas_adj_loc = operand_3023->point.reader_adjust (inLexique COMMA_SOURCE_FILE_AT_LINE (100)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (100)) ;
              ...
              if (_var_5098.getPtr () != NULL) {
                ...
                if (typeid (cPtr_adjustable_true) == typeid (* (_var_5098.getPtr ()))) {
                  ...
                  if (((var_cas_previous_offset).operator_isEqual (GGS_uint64 (0U))).isBuiltAndTrue ()) {
                    ...
                    if (((var_cas_maxret).operator_strictSup (var_cas_previous_delay.substract_operation (inLexique, var_cas_mc COMMA_SOURCE_FILE_AT_LINE (111)))).isBuiltAndTrue ()) {
                    ...
                    if (((var_cas_maxadv).operator_strictSup (var_cas_len.substract_operation (inLexique, var_cas_previous_delay COMMA_SOURCE_FILE_AT_LINE (114)))).isBuiltAndTrue ()) {
            ...
            if (((var_cas_offset.substract_operation (inLexique, var_cas_previous_offset COMMA_SOURCE_FILE_AT_LINE (123))).operator_strictInf (var_cas_mc)).isBuiltAndTrue ()) {
            ...
            if (((var_cas_offset.substract_operation (inLexique, var_cas_previous_offset COMMA_SOURCE_FILE_AT_LINE (132))).operator_strictSup (var_cas_mav)).isBuiltAndTrue ()) {
              if ((var_cas_first_ep).isBuiltAndTrue ()) {
            ...
            if (((var_cas_i).operator_isEqual (var_cas_exp_pt_number)).isBuiltAndTrue ()) {
              { const GGS_adjustable_obj _var_7212 = operand_3023->point.reader_adjust (inLexique COMMA_SOURCE_FILE_AT_LINE (145)) ; // CAST instruction
                if (_var_7212.getPtr () != NULL) {
                  ...
                  if (typeid (cPtr_adjustable_true) == typeid (* (_var_7212.getPtr ()))) {
                    ...
                    if (((var_cas_first_maxret).operator_strictSup (var_cas_last_delay.substract_operation (inLexique, var_cas_mc COMMA_SOURCE_FILE_AT_LINE (148)))).isBuiltAndTrue ()) {
                    ...
                    if (((var_cas_first_maxadv).operator_strictSup (var_cas_len.substract_operation (inLexique, var_cas_first_delay COMMA_SOURCE_FILE_AT_LINE (151)))).isBuiltAndTrue ()) {
              ...
              var_cas_final_delay = var_cas_len.substract_operation (inLexique, var_cas_previous_offset COMMA_SOURCE_FILE_AT_LINE (156)) ;
              if (((var_cas_final_delay).operator_isEqual (GGS_uint64 (0U))).isBuiltAndTrue ()) {
                ...
                if ((((var_cas_final_delay).operator_strictInf (var_cas_mc)).operator_or ((var_cas_final_delay).operator_strictSup (var_cas_mav))).isBuiltAndTrue ()) {
        ...
        { const GGS_ltgt_sync_obj _var_9289 = operand_502->mInfo.st.reader_ltgt_sync (inLexique COMMA_SOURCE_FILE_AT_LINE (175)) ; // CAST instruction
          if (_var_9289.getPtr () != NULL) {
            ...
            if (typeid (cPtr_ltgt_sync_true) == typeid (* (_var_9289.getPtr ()))) {
              ...
              if (((var_cas_sst.reader_strategy (inLexique COMMA_SOURCE_FILE_AT_LINE (177)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (177))).operator_isEqual (GGS_string ("IMPLICIT"))).isBuiltAndTrue ()) {
                ...
                if (((var_cas_len).operator_isNotEqual (var_cas_mav.add_operation (inLexique, GGS_uint64 (1U) COMMA_SOURCE_FILE_AT_LINE (185)))).isBuiltAndTrue ()) {
                  operand_502->mInfo.st.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (186)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (186)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("OS429 - An IMPLICIT schedule table should have a duration equal to OSMAXALLOWEDVALUE + 1 (")).operator_concat (var_cas_mav.add_operation (inLexique, GGS_uint64 (1U) COMMA_SOURCE_FILE_AT_LINE (186)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (186)))).operator_concat (GGS_string (") of its counter.")) COMMA_SOURCE_FILE_AT_LINE (187)) ;
                }
              }
              if (((var_cas_sst.reader_strategy (inLexique COMMA_SOURCE_FILE_AT_LINE (189)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (189))).operator_isEqual (GGS_string ("EXPLICIT"))).isBuiltAndTrue ()) {
                if (((var_cas_len).operator_strictSup (var_cas_mav.add_operation (inLexique, GGS_uint64 (1U) COMMA_SOURCE_FILE_AT_LINE (190)))).isBuiltAndTrue ()) {
                  operand_502->mInfo.st.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (191)).reader_location (inLexique COMMA_SOURCE_FILE_AT_LINE (191)).reader_location (inLexique COMMA_HERE).signalGGSSemanticError (inLexique, ((GGS_string ("OS431 - An EXPLICIT schedule table shouldn't have a duration greater than OSMAXALLOWEVALUE + 1 (")).operator_concat (var_cas_mav.add_operation (inLexique, GGS_uint64 (1U) COMMA_SOURCE_FILE_AT_LINE (191)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (191)))).operator_concat (GGS_string (") of its counter.")) COMMA_SOURCE_FILE_AT_LINE (192)) ;
                }
              }
            }else{
            }
        ...
        { const GGS_autostart_obj _var_10238 = operand_502->mInfo.st.reader_autostart (inLexique COMMA_SOURCE_FILE_AT_LINE (198)) ; // CAST instruction
          if (_var_10238.getPtr () != NULL) {
            ...
            if (typeid (cPtr_sd_autostart_relative) == typeid (* (_var_10238.getPtr ()))) {
              ...
              if (((var_cas_relative_data.reader_offset (inLexique COMMA_SOURCE_FILE_AT_LINE (200)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (200))).operator_isEqual (GGS_uint64 (0U))).isBuiltAndTrue ()) {
              ...
              }else if (((var_cas_relative_data.reader_offset (inLexique COMMA_SOURCE_FILE_AT_LINE (202)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (202))).operator_strictSup (var_cas_mav.substract_operation (inLexique, var_cas_first_delay COMMA_SOURCE_FILE_AT_LINE (202)))).isBuiltAndTrue ()) {
              ...
              if (((var_cas_absolute_data.reader_value (inLexique COMMA_SOURCE_FILE_AT_LINE (206)).reader_uint64 (inLexique COMMA_SOURCE_FILE_AT_LINE (206))).operator_strictSup (var_cas_mav)).isBuiltAndTrue ()) {
...
void routine_schedule_tables_counters_exist_and_compatible (C_Compiler & inLexique,
  ...
  #endif
  {
    ...
    while (((operand_10415 = enumerator_10415.nextObject ()))) {
      ...
      var_cas_cnt = operand_10415->mInfo.st.reader_counter (inLexique COMMA_SOURCE_FILE_AT_LINE (220)) ;
      if ((((var_cas_cnts.reader_hasKey (inLexique, var_cas_cnt.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222)) COMMA_SOURCE_FILE_AT_LINE (222))).operator_not ()).operator_and ((var_cas_cnt.reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (222))).operator_isNotEqual (GGS_string ("SystemCounter")))).isBuiltAndTrue ()) {
    ...
    while (((operand_11586 = enumerator_11586.nextObject ()))) {
      macroValidPointer (operand_11586) ;
      {
        ...
        while (((operand_11662 = enumerator_11662.nextObject ()))) {
          ...
          var_cas_ep_name = operand_11662->point.reader_name (inLexique COMMA_SOURCE_FILE_AT_LINE (258)) ;
          {
              ...
              { const GGS_action_obj _var_12944 = operand_11735->action ; // CAST instruction
                if (_var_12944.getPtr () != NULL) {
                  ...
                  if (typeid (cPtr_activatetask_action) == typeid (* (_var_12944.getPtr ()))) {
                    ...
                    if (((var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (262)).reader_hasKey (inLexique, var_cas_ata.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (262)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (262)) COMMA_SOURCE_FILE_AT_LINE (262))).operator_not ()).isBuiltAndTrue ()) {
                    ...
                    if (((var_cas_cpu.reader_tasks (inLexique COMMA_SOURCE_FILE_AT_LINE (266)).reader_hasKey (inLexique, var_cas_sea.reader_task_name (inLexique COMMA_SOURCE_FILE_AT_LINE (266)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (266)) COMMA_SOURCE_FILE_AT_LINE (266))).operator_not ()).isBuiltAndTrue ()) {
                    ...
                    if (((var_cas_known_events.reader_length (inLexique COMMA_SOURCE_FILE_AT_LINE (273))).operator_isEqual (GGS_uint (0U))).isBuiltAndTrue ()) {
                    ...
                    if (((var_cas_cpu.reader_events (inLexique COMMA_SOURCE_FILE_AT_LINE (276)).reader_hasKey (inLexique, var_cas_sea.reader_event_name (inLexique COMMA_SOURCE_FILE_AT_LINE (276)).reader_string (inLexique COMMA_SOURCE_FILE_AT_LINE (276)) COMMA_SOURCE_FILE_AT_LINE (276))).operator_not ()).isBuiltAndTrue ()) {
